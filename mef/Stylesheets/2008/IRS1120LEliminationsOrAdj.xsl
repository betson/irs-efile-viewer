  ...
  <xsl:template match="/">
    <html lang="EN-US">
      ...
      <xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/@section1291InterestIndicator"/>
      </xsl:call-template>
      <xsl:call-template name="LinkToLeftoverDataTableInline">
       ...
       -->
        ...
        <span style="width: 18mm;border-bottom:1 solid black;">
         ...
         See separate instructions.
          ...
          <!-- Form to Form Link
          <xsl:call-template name="SetFormLinkInline">
            <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/IsNonlifeInsuranceCompaniesInd"/>
          </xsl:call-template>   -->
                  </label>
                </div>
                <div class="styGenericDiv">
    ...
    <div class="styLNDesc" style="width:26mm;height:4mm;">
      ...
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/GrossReceiptsOrSales"/>
      </xsl:call-template>
    </div> -->
    ...
    name="PopulateAmount"><xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/ReturnsAndAllowances" />
    </xsl:call-template></span></div> -->
    ...
    <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/GrossReceiptsOrSalesBalance" />
      ...
      Life insurance company gross income. Add lines 1 through 7
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/NetGainLoss"/>
        </xsl:call-template>
      ...
      Deductible policyholder dividends (Schedule F, line 18e)
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/BadDebts"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
      ...
      Assumption by another person of liabilities under insurance, etc., contracts
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/Rents"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
    ...
    Add lines 9 through 18
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/CharitableContributions"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
       ...
       Dividends-received deduction (Schedule A, line 16, column (c))
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/Depreciation"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
              </div>
      ...
      <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
            <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/Depletion" />
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
   ...
   2008 special estimated tax payments<i> (Do not include on line 29f)</i>
       ...
       If line 29k is larger than the total of lines 28 and 30, enter amount overpaid
        <span class="styBoldText">
          ...
          <span style="width:16px"/>.
              ...
              <div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/OverpaymentAmount"/>
                </xsl:call-template>
              </div>
            </div>
            <!-- line 33 -->
         ...
         Enter amount from line 32: 
          <!--span style="width:17px;vertical-align:top;"-->
              ...
              <div class="styGenericDiv" style="width:35mm;height:4mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/CreditElect"/>
                </xsl:call-template>
              </div>
              <div class="styLNDesc" style="width:20mm;height:4mm;font-size:6pt;">
                ...
                <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/Refund"/>
                </xsl:call-template>
              </div>
    ...
    <span class="styNormalText">(section 812(d)) (see instructions)</span>
      ...
      <span style="width:2px;"/>
              <!-- Form to Form Link
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/AdditionalSection263ACosts"/>
      </xsl:call-template> -->
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
      ...
      <span style="width:2px;"/>
              <!-- Form to Form Link 
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120LEliminationsOrAdj/OtherCosts"/>
      </xsl:call-template>-->
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.

      ...
      <body class="styBodyClass">
        <form name="Form6781">
            ...
            <table class="styTable" cellspacing="0" style="font-size:7pt;border-color:black;">
              <thead class="styTableThead">
                <tr>
                  ...
                  <th class="styTableCellHeader" scope="col" style="width:107mm;">
                    <span style="font-weight:bold;">(a)</span>
                    <span class="styNormalText"> Identification of account</span>
                  </th>
                  <th class="styTableCellHeader" scope="col" style="width:36mm;">
                    <span style="font-weight:bold;">(b) (Loss)</span>
                  </th>
                  <th class="styTableCellHeader" scope="col" style="width:36mm;border-right-width:0px;">
              ...
              <tbody>
                ...
                <xsl:if test="count($Form6781Data/Sect1256ContractsAccountInfo) &lt; 1 or ((count($Form6781Data/Sect1256ContractsAccountInfo) &gt; 3) and ($Print = $Separated))">
                  <tr>
                    ...
                    <td class="styTableCell" style="width:107mm;text-align:left;">
                ...
                <xsl:if test="count($Form6781Data/Sect1256ContractsAccountInfo) &lt; 2 or ((count($Form6781Data/Sect1256ContractsAccountInfo) &gt; 3) and ($Print = $Separated))">
                  <tr>
                    ...
                    <td class="styTableCell" style="width:107mm;">
                      <span class="styTableCellPad"/>
                    </td>
                    <td class="styTableCell" style="width:36mm;">
                      <span class="styTableCellPad"/>
                ...
                <xsl:if test="count($Form6781Data/Sect1256ContractsAccountInfo) &lt; 3 or ((count($Form6781Data/Sect1256ContractsAccountInfo) &gt; 3) and ($Print = $Separated))">
                  <tr>
                    ...
                    <td class="styTableCell" style="width:107mm;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                    <td class="styTableCell" style="width:36mm;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;height:4.5mm;">Combine lines 3 and 4
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
            <span style="width:16px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;height:7.5mm;">
...
and S corporations, see instructions.          </span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;padding-top:1mm;height:7.5mm;">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;height:1mm;"/>
         ...
         Enter the long-term portion of losses from line 10, column (h), here and include on the appropriate line of Schedule D (see instructions)
          ...
          <div class="styTableContainer" style="height:12mm;" id="GFSctn">
            ...
            <table class="styTable" cellspacing="0" style="border-color:black;">
              <thead class="styTableThead">
                <tr>
                  <th class="styTableCellHeader" scope="col" style="width:52mm;" colspan="2"> (a)<span class="styNormalText"> Description of property</span>
                  </th>
                  ...
                  <th class="styTableCellHeader" scope="col" style="width:30mm;border-right-width:0px;"> (f) Gain. <span class="styNormalText"> If column (d) is more than (e), enter difference. Otherwise, enter -0-</span>
                  </th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>
                <xsl:if test="($Print != $Separated) or (count($Form6781Data/GainsFromStraddlesInfo) &lt;= 2) ">
                  <xsl:for-each select="$Form6781Data/GainsFromStraddlesInfo">
                    <tr style="height:5mm;">
                      <td class="styTableCellTextSmall" style="width:46mm;border-right-width:0px;">
                      ...
                      <td class="styTableCellSmallArial" style="width:30mm;font-family:verdana;border-right-width:0px;">
                        <xsl:if test="(position() = count($Form6781Data/GainsFromStraddlesInfo)) and (position() &gt;= 2)">
                ...
                <xsl:if test="count($Form6781Data/GainsFromStraddlesInfo) &lt; 1 or ((count($Form6781Data/GainsFromStraddlesInfo) &gt; 2) and ($Print = $Separated))">
                  <tr>
                    <td class="styTableCellTextSmall" colspan="2" style="width:52mm;">
                      <span class="styBoldText">
                        <xsl:if test="position()=1">12</xsl:if>
                      </span>
                      <span class="styTableCellPad"/>
                    ...
                    <td class="styTableCellSmallArial" style="width:30mm;border-right-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                  </tr>
                </xsl:if>
                <xsl:if test="count($Form6781Data/GainsFromStraddlesInfo) &lt; 2 or ((count($Form6781Data/GainsFromStraddlesInfo) &gt; 2) and ($Print = $Separated))">
                  <tr>
                    <td class="styTableCellTextSmall" colspan="2" style="width:52mm;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                    ...
                    <td class="styTableCellSmallArial" style="width:30mm;border-right-width:0px;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                  </tr>
                </xsl:if>
      ...
      -->
       ...
       <span style="width:40mm"/>  
          Form <span class="styBoldText" style="font-size:8pt">6781</span> (2008)
</div>
          <div class="pageEnd"/>
                ...
                <xsl:for-each select="$Form6781Data/UnrcgnzdGainsLastDayPosOfTY">
                  <tr>
                    ...
                    <td class="styDepTblCell" style="width:64mm;text-align:left;">
                      <span class="styBoldText" style="width:4mm;">
                        <xsl:number value="position()+ 13" format="1"/>
                      </span>
                      <span class="styTableCellPad"/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="PropertyDescription"/>

...
<html>
  <head>
    <title>Schedule B (Form 990, 990-EZ, or 990-PF) (2008)</title>      
    <!-- No Browser Caching -->
  ...
  <body class="styBodyClass">    
    <form style="font-family:arial; font-size:8.5pt" name="Form990ScheduleB">
      ...
      <div class="styTBB" style="width:187mm">
        ...
        <div class="styFTBox" style="width:125mm">
          ...
          <img src="{$ImagePath}/990SchB_Bullet.gif" alt="Arrow Bullet"/> 
            Attach to Form 990, 990-EZ, and 990-PF.<br />
      ...
      <div style="width:187mm; padding-top:1mm">
        Check if your organization is covered by the <b>General Rule</b> or a <b>Special Rule.</b> &nbsp; (<b>Note.</b>&nbsp;<i>Only a section 501(c)(7), (8), or (10)<br/>organization can check boxes for both the General Rule and a Special Rule. See instructions.</i>)        
      </div>
      ...
      <div style="padding-left:5mm; width:187mm">
        ...
        <div style="float:right; width:177mm">
          <label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/GeneralRule" /></xsl:call-template>
            For organizations filing Form 990, 990-EZ, or 990-PF that received, during the year, $5,000 or more (in money or<br />property) from any one contributor. Complete Parts I and II.
          </label>
        </div>
      </div>
      ...
      <div style="padding-left:5mm; width:187mm">
        ...
        <div style="float:right;width:177mm;">
          <label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/SpclRuleMetOneThirdSuprtTest" /></xsl:call-template>
            For a section 501(c)(3) organization filing Form 990, or Form 990-EZ, that met the 
            33<font style="font-family: 'Arial Narrow'; font-size: smaller;"><sup>1</sup>/3</font>% 
            support test of the regulations <br/>under sections 509(a)(1)/170(b)(1)(A)(vi), and received from any one contributor, during the year, a contribution of the <br/>greater of <b>(1)</b> $5,000 or <b>(2)</b> 2% of the amount onForm 990, Part VIII, line 1h or 2% of the amount on Form 990-EZ, line<br/>1. Complete Parts I and II. 
         </label>
        </div>
      </div>
      ...
      <div style="padding-left:5mm; margin-top:5mm; width:187mm">
        ...
        <div style="float:right; width:177mm">
          <label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/SpclRuleRcvdTotContriMore1000" /></xsl:call-template>
            For a section 501(c)(7), (8), or (10) organization filing Form 990, or Form 990-EZ, that received from any one contributor,<br />during the year, aggregate contributions or bequests of more than $1,000 for use <i>exclusively</i> for religious, charitable,<br />scientific, literary, or educational purposes, or the prevention of cruelty to children or animals. Complete Parts I, II, and<br />III.
          </label>
        </div>
      </div>
      ...
      <div style="border-bottom:1 solid black; width:187mm; margin-top:5mm; padding-bottom:3mm">      
        <b>Caution.</b>&#160;Organizations that are not covered by the General Rule and/or the Special Rules do not file Schedule B (Form 990,<br />990-EZ, or 990-PF), but they <b>must</b> answer “No” on Part IV, line 2 of their Form 990, or check the box in the heading of their<br />Form 990-EZ, or on line 2 of their Form 990-PF, to certify that they do not meet the filing requirements of Schedule B (Form 990,<br/>990-EZ, or 990-PF).
      </div>      
    ...
    <!-- END Part III -->              
      ...
      <xsl:if test="($Print = $Separated) and (count($Form990ScheduleBData/ContributorInfo) &gt; 6)">
        <span class="styRepeatingDataTitle">Form 990 Schedule B, Part I - Contributors (see Instructions)</span>
      ...
      <xsl:if test="($Print = $Separated) and (count($Form990ScheduleBData/NoncashProperty) &gt; 6)"> <br/>
        <span class="styRepeatingDataTitle">Form 990 Schedule B, Part II - Noncash Property (see Instructions:</span>
        <table class="styDepTbl" cellspacing="0" cellpadding="0" border="0" style="width:187mm;font-size:7pt;">  
    ...
    <xsl:if test="$index mod 6 = 1">
      ...
      <tr style="height:8mm">
        ...
        <th style="width:90mm; border-bottom:1 solid black">            
          <div class="styPartDesc" style="width:90mm">Contributors <span style="font-weight:normal">(see Instructions)</span></div>              
        </th>  
    ...
    <xsl:if test="$index mod 6 = 1">
      ...
      <tr style="height:8mm">
        ...
        <th style="width:95mm; border-bottom:1 solid black">            
          <div class="styPartDesc" style="width:95mm">Noncash Property <span style="font-weight:normal">(see Instructions)</span></div>                
        </th>  
  ...
  <!--div style="width:187mm; font-size:7pt; border-top:1 solid black; page-break-after:always"-->   
    <xsl:if test="$showAll = 0">
      <div style="float:left; font-size:7pt; padding-top:0.5mm">
        <b>For Paperwork Reduction Act Notice, see the Instructions<br/>for Form 990. These instructions will be issued separately.</b>
      </div>    
    </xsl:if>       
    <div style="float:right; padding-top:0.5mm; padding-right:0.5mm">      
      ...
      <b>Schedule B (Form 990, 990-EZ, or 990-PF) (2008)</b>
    </div>
  <!--/div-->    
</xsl:template>
    ...
    <xsl:if test="$index = 1">
      <thead class="styTableThead">  
        <tr class="styDepTblHdr" align="center">                            
          ...
          <th class="styDepTblCell" nowrap="nowrap" colspan="2">(c)<br />Aggregate contributions</th>

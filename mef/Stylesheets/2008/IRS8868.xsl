...
<title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($IRS8868Data)"></xsl:with-param></xsl:call-template></title>
...
<style type="text/css">
  <xsl:if test="not($Print) or $Print=''">
    ...
    <xsl:call-template name="IRS8868Style"></xsl:call-template>
...
<div class="styBB" style="width:187mm; height:22mm;">
  <div class="styFNBox" style="width:31mm;height:22mm; border-right-width: 2px">
    <div style="padding-top:1mm;">
      Form<span class="styFormNumber">&#160;&#160;8868</span>(Rev. April 2008)    </div>
  ...
  <div class="styFTBox" style="width:125mm;height:22mm">
    ...
    <div class="styFBT" style="height:5mm; font-size: 7pt; font-weight: normal;padding-top: 2mm">
      <img src="{$ImagePath}/8868_Bullet_Title.gif"  alt="bullet"/> File a separate application for each return.<span style="width: 5mm"></span>
    </div>
  </div>
...
<div style="width: 187mm">
  <img src="{$ImagePath}/8868_Bullet_Round.gif" alt="bullet"/><label for="3MonthExtension"> If you are filing for an <b>Automatic 3-Month Extension, complete only Part I </b> and check this box</label>
  <b>
  <span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.
  <span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.
  <span class="styIRS8868NBSP"></span>.
  </b>
  <img src="{$ImagePath}/8868_Bullet_Lg.gif" alt="bullet"/> <span style="width: 2mm"></span>
...
<div class="styIRS8868NoteHdr" style="border-top-width: 0px; font-style:normal;border-bottom-width: 0px;">
    <span class="styItalicText">Do not complete Part II unless </span><span style="font-weight:normal">you have already been granted an automatic 3-month extension on a previously filed Form 8868.</span>
</div>
...
<div class="styIRS8868PartHdr" style="border-bottom-width: 0px">
   ...
   <span class="styPartDesc">Automatic 3-Month Extension of Time.<span style="font-weight: normal">  Only submit original (no copies needed).</span></span> 
</div>
<div style="width:187mm;" />
<div class="styIRS8868NoteHdr" style="border-bottom-width: 0px">
  <span><label for="6MonthExtension"><span style="font-style:normal; font-weight: normal">A corporation required to file Form 990-T and requesting an automatic 6-month extension&#151;check this box and complete<br /> Part I only</span></label></span>
  <span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span style="width: 11px"></span>
  <img src="{$ImagePath}/8868_Bullet_Lg.gif" alt="bullet"/> <span style="width: 2mm"></span>
...
<span class="styBB" style="font-style: italic; font-weight:normal; width: 187mm;padding-top:1mm;height:18mm;">All other corporations (including 1120-C filers), partnerships, REMICs, and trusts must use Form 7004 to request an extension of time to file income tax returns.<br />
  <span style="font-style:normal;padding-top:1mm;height:12mm;"><b>Electronic Filing (e-file).</b> Generally, you can electronically file Form 8868 if you want a 3-month automatic extension of time to file
...
2 (Part II) of Form 8868. For more details on the electronic filing of this form, visit <i>www.irs.gov/efile</i> and click on <i>e-file for Charities and Nonprofits.</i></span>
...
<div style="width:187mm;float:left;clear:none;">
    <div class="styUseLbl" style="width:18mm;height:33mm; font-size: 7pt; border-top-width: 0px"><b>Type or print</b><br/><span style="font-size: 6pt; font-weight: normal">File by the due date for filing your return. See instructions.</span></div>
    <div class="styNameAddr" style=" border-bottom-width: 0px; border-top-width: 0px; border-right-width: 1px;width:110mm;height:8mm;font-size: 7pt">
      ...
      <span style="font-family:verdana;font-size:6pt;">      
        ...
        <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">InCareOfName</xsl:with-param></xsl:call-template>
      </span>
    </div>
    <div class="styEINBox" style="padding-left:2mm;font-weight:bold;font-size:7pt;">Employer identification number<br/><br/>
      <span style="text-align:left;font-size: 7pt; font-weight:normal;">
        ...
        <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="EINChanged">true</xsl:with-param><xsl:with-param name="TargetNode">EIN</xsl:with-param></xsl:call-template>      
      </span>
    </div>
...
<div style="width: 187mm; border-style:solid; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px; font-size: 8pt"><b>Check type of return to be filed</b> (file a separate application for each return):</div>
...
<div style="width: 187mm; font-size: 8pt">
  ...
  <span class="styIRS8868CkboxText"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990" /></xsl:call-template>Form 990</label></span>
<!-- End Form 990  -->
...
<!-- Begin Form 990T Corporation -->
  ...
  <span class="styIRS8868CkboxText" style="width:72mm"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990T" /></xsl:call-template>Form 990-T (corporation)</label></span>
<!--  End Form 990T  -->
...
<!-- Begin Form 4720  -->  
  ...
  <span class="styIRS8868CkboxText"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form4720" /></xsl:call-template>Form 4720</label></span>
</div>
<!-- End Form 4720  -->
...
<!-- Begin Form 990BL  -->
  <span style="float: left; clear: none">
    ...
    <span class="styIRS8868CkboxText" style="width: 47.50mm; float: none; clear: none; padding-bottom: .75mm"><label for="Form990BL">Form 990-BL</label></span><span style="width: .25mm"></span>
  </span>
      <!--xsl:call-template name="PopulateCheckbox">
...
<!-- Begin Form 990T (sec. 401(a) or 408(a)trust -->  
  ...
  <span class="styIRS8868CkboxText" style="width:72mm"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990TSection401a408Trust" /></xsl:call-template>Form 990-T (sec. 401(a) or 408(a) trust)</label></span>
...
<!-- Begin Form 5227 -->  
  ...
  <span class="styIRS8868CkboxText"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form5227" /></xsl:call-template>Form 5227</label></span>
</div>
<!-- End Form 5227 -->
...
<div style="width: 187mm; font-size: 8pt">
  ...
  <span class="styIRS8868CkboxText"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990EZ" /></xsl:call-template>Form 990-EZ</label></span>
<!-- End Form 990EZ -->  
...
<!-- Begin Form 990TTrustOthThan401aOr408a -->
  ...
  <span class="styIRS8868CkboxText" style="width:72mm"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990TTrustOthThan401aOr408a" /></xsl:call-template>Form 990-T (trust other than above)</label></span>
...
<!-- Begin Form 6069 -->  
  <span style="float:left; clear: none">
    ...
    <span class="styIRS8868CkboxText" style="width: 15mm; float: none; clear: none; padding-bottom: .75mm"><label for="Form6069"> Form 6069</label></span><span style="width: 1mm"></span>
  </span>
      <!--xsl:call-template name="PopulateCheckbox">
...
<!-- Begin Form 990PF -->
  ...
  <span class="styIRS8868CkboxText"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form990PF" /></xsl:call-template>Form 990-PF</label></span>
<!-- End Form 990PF-->
...
<!-- Begin Form 1041A -->
  ...
  <span class="styIRS8868CkboxText" style="width:72mm"><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/Form1041A" /></xsl:call-template>Form 1041-A</label></span>
<!-- End Form 1041A -->

<!-- Begin Form 8870 -->
  <span style="float:left; clear: none">
    <input type="checkbox" class="styIRS8868Ckbox" name="Form8870" id="Form8870" TabIndex="-1"  onclick="return false;"/>
    <span class="styIRS8868CkboxText" style="width: 15mm; float: none; clear: none; padding-bottom: .75mm"><label for="Form8870"> Form 8870</label></span><span style="width: 1mm"></span>
  </span>
      <!--xsl:call-template name="PopulateCheckbox">
...
<!-- End Form 8870 -->
  ...
  <div style="width: 187mm;">
    <div class="styGenericDiv">
      ...
      <img src="{$ImagePath}/8868_Bullet_Lg.gif" alt="bullet"/><span style="width: 2mm" />
    </div>
        ...
        <xsl:otherwise>
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" 
              select="$IRS8868Data/TheBooksAreInCareOf/NameBusiness/BusinessNameLine1" />
          </xsl:call-template>
          <xsl:if test="$IRS8868Data/TheBooksAreInCareOf/NameBusiness/BusinessNameLine2 != '' ">
             <br/>
             <xsl:call-template name="PopulateText">
             <xsl:with-param name="TargetNode" 
             select="$IRS8868Data/TheBooksAreInCareOf/NameBusiness/BusinessNameLine2" />
             </xsl:call-template>
          </xsl:if> 
         </xsl:otherwise>
      </xsl:choose>
...
<div style="width: 187mm">
  <img src="{$ImagePath}/8868_Bullet_Round.gif" alt="bullet"/><label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$IRS8868Data/OrgDoesNotHaveAnOfficeInUS" /></xsl:call-template> If the organization does not have an office or place of business in the United States, check this box</label>
  <b>
  <span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.
  <span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.<span class="styIRS8868NBSP"></span>.
  </b>
...
<div style="width: 187mm">
  <img src="{$ImagePath}/8868_Bullet_Round.gif" alt="bullet"/> If this is for a Group Return, enter the organization's four digit Group Exemption Number (GEN)_____________.
    <label for="WholeGroup">If this is for the whole group, check this box</label><span style="width: 2mm"></span><img src="{$ImagePath}/8868_Bullet_Lg.gif" alt="bullet"/> <span style="width: 2mm"></span>
    <input type="checkbox" class="styIRS8868Ckbox" name="WholeGroup" TabIndex="-1" id="WholeGroup" onclick="return false">
    </input>. <label for="PartGroup"> If it is for part of the group, check this box</label><span style="width: 2mm"></span><img src="{$ImagePath}/8868_Bullet_Lg.gif" alt="bullet"/> <span style="width: 2mm"></span>
    <input type="checkbox" class="styIRS8868Ckbox" name="PartGroup" TabIndex="-1" id="PartGroup" onclick="return false">
    </input> and attach a list with the names and EINs of all members the extension will cover.
</div>
  ...
  <img src="{$ImagePath}/8868_Bullet_Lg.gif"  alt="bullet"/> <span style="width: 2mm"></span>
    <xsl:choose>
     <xsl:when test="$RtnHdrData/TaxYear != '' ">
        ...
        <input type="checkbox" class="styIRS8868Ckbox" name="CalendarYearCheckBox" id="CalendarYearCheckBox" onclick="return false" checked="checked"></input>
      </xsl:when>
      <xsl:otherwise>
    ...
    <span class="styIRS8868CkboxText" style="float: none; clear:none"><label for="CalendarYearCheckBox"> calendar year 
  ...
  <img src="{$ImagePath}/8868_Bullet_Lg.gif"  alt="bullet"/> <span style="width: 2mm"></span>
    <xsl:choose>
      <xsl:when test="substring($RtnHdrData/TaxPeriodEndDate,6,5) != '12-31'">
        <input type="checkbox" class="styIRS8868Ckbox" name="TaxYearCheckBox" id="TaxYearCheckBox" onclick="return false" checked="checked"></input>
      </xsl:when>
      <xsl:otherwise>
    ...
    <span class="styIRS8868CkboxText" style="width: 160mm; float: none; clear: none">
      <label for="TaxYearCheckBox"> tax year beginning         
        <xsl:choose>          
          ...
          <xsl:otherwise>
            <span style="width:20mm;border-style:solid;float:none;clear:none;" class="styBB"></span>
            <span style="width:4px;"></span>,<span style="width:4px;"></span>
            <span style="width:8mm;border-style:solid;float:none;clear:none;padding-left: .5mm" class="styBB"></span>
...
<div class="styIRS8868LineItem">
  ...
  <span class="styIRS8868LNDesc"  style="width: 180mm">If this tax year is for less than 12 months, check reason: <span style="width: 1mm"></span>
    <input type="checkbox" class="styIRS8868Ckbox" name="InitialReturn" TabIndex="-1" id="InitialReturn" onclick="return false;"/> 
    <span class="styIRS8868CkboxText" style="width: 20mm; float: none; clear: none"><label for="InitialReturn"> Initial return</label></span><span style="width: 1mm"></span>
    <input type="checkbox" class="styIRS8868Ckbox" name="FinalReturn" TabIndex="-1" id="FinalReturn" onclick="return false;"/> 
    <span class="styIRS8868CkboxText" style="width: 20mm; float: none; clear: none"><label for="FinalReturn"> Final return</label> </span><span style="width: 1mm"></span>
    ...
    <span class="styIRS8868CkboxText" style="width:40mm; float: none; clear: none"><label for="ChangeAccountingPeriod"> Change in accounting period</label></span>    
  </span>  
</div>
<!--  END LINE 2  -->
...
<!--  BEGIN LINE 3a  -->
 <div class="styBB" style="width:187mm;border-top-width:1">
  <div style="width:187mm;">
    ...
    <div class="styLNDesc" style="border: 0 solid black;border-bottom-width:1px;height:7.5mm;width:136mm">If this application is for Form 990-BL, 990-PF, 990-T, 4720, or 6069, enter the tentative tax, less any nonrefundable credits. See instructions.      <span style="width:2px;"></span>
      <!-- Form to Form Link -->
    
    </div>
    <div class="styLNRightNumBox" style="padding-top:3.75mm;height:7.5mm;">3a</div>
    <div class="styLNAmountBox" style="height:7.5mm; padding-top:3.75mm;width:34mm"><span class="styBoldText" style="padding-left:1mm;float:left;">$</span>
...
<!--  BEGIN LINE 3b  -->
  ...
  <div style="width:187mm;">
    <div class="styLNLeftNumBox" style="height:4mm;"><span style="width:2mm"></span>b</div>
    <div class="styLNDesc" style="border: 0 solid black;border-bottom-width:1px;height:7.5mm;width:136mm">If this application is for Form 990-PF or 990-T, enter any refundable credits and estimated tax payments made. Include any prior year overpayment allowed as a credit.      <span style="width:2px;"></span>
      <!-- Form to Form Link -->
...
<!--  BEGIN LINE 3c  -->
  ...
  <div style="width:187mm;">
    <div class="styLNLeftNumBox" style="height:4mm;"><span style="width:2mm"></span>c</div>
    <div class="styLNDesc" style="border: 0 solid black;height:6mm;width:136mm"><b>Balance Due.</b> Subtract line 3b from line 3a. Include your payment with this form, or, if required, deposit with FTD coupon or, if required, by using EFTPS (Electronic Federal Tax Payment System). See instructions.      <span style="width:2px;"></span>
      <!-- Form to Form Link -->
    
    </div>
    <div class="styLNRightNumBox" style="border-bottom-width:0; height:6mm;background-color:lightgrey"></div>
    <div class="styLNAmountBox" style="height:6mm;border-bottom-width:0;width:34mm"></div>
    <div class="styLNRightNumBox" style="border-bottom-width:0">3c</div>
    <div class="styLNAmountBox" style="border-bottom-width:0;width:34mm"><span class="styBoldText" style="padding-left:1mm;float:left">$</span>
     <xsl:call-template name="PopulateAmount">
...
<!--BEGIN FOOTER-->
<div style="width:187mm">
  <div style="float: left; clear: none;"><span class="styBoldText">For Paperwork Reduction Act Notice, see Instructions.</span></div>        
  <div style="float:right">
    Cat. No. 27916D 
    <span style="width:70px"></span>
    Form<span class="styBoldText" style="font-size: 8pt"> 8868 </span>(Rev. 4-2008)
  </div>      
</div>     
<!--END FOOTER-->  

...
<html lang="EN-US">
  <head>
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form8874Data)"></xsl:with-param></xsl:call-template></title>
    <!-- No Browser Caching -->
    ...
    <style type="text/css">
      <xsl:if test="not($Print) or $Print=''"> 
        <xsl:call-template name="IRS8874Style"></xsl:call-template>    
...
<body class="styBodyClass">
  <form name="Form8874">
    ...
    <div class="styTYBox" style="width:32mm;height:21mm;">
      ...
      <div style="text-align: left; padding-top: 10mm; padding-left: 4mm">Attachment<br/> Sequence No.<span class="styBoldText"><span style="width:4px;"></span>127</span></div>
    </div>
  </div>    
 ...
 <!--     <span style="width:122mm;"></span>
  ...
  <div class="styTableContainer" id="TPctn" >
    ...
    <thead class="styTableThead">
      <tr>
        <th scope="col" class="styTableCell" rowspan="3" style="width:7mm;border-right:none;font-weight:bold;"><span style="width:1mm;"/></th>
    ...
    <xsl:if test="($Print != $Separated) or (count($Form8874Data/CurrentYearCreditInfo) &lt;= 3) ">
      <xsl:for-each select="$Form8874Data/CurrentYearCreditInfo">
        <tr>
          <td class="styTableCell" style="width:7mm;font-size:7pt;text-align:center;vertical-align:top;border-right:none;font-weight:bold;">
            <xsl:if test="position()=1">1</xsl:if><span style="width:1px;"></span>
          </td> 
         ...
         <span style="font-family:verdana;font-size:6pt">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="NameOfCDE/BusinessNameLine1"/>
            </xsl:call-template>
            <xsl:if test="NameOfCDE/BusinessNameLine2 !=''">
            <br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="NameOfCDE/BusinessNameLine2"/>
              </xsl:call-template>          
            </xsl:if>
          </span>
          ...
          <xsl:choose>
           <xsl:when test="IdentificationNumberOfCDE">
          ...
          <td class="styTableCell" style="width:20mm;text-align:center;font-size:7pt;font-weight:normal;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="DateOfInitialInvestment"/>
            </xsl:call-template>
          </td>
          <td class="styTableCell" style="width:30mm;text-align:right;font-size:7pt;font-weight:normal;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="AmountOfQlfyEquityInvestment"/>
            </xsl:call-template>          
          </td>
          ...
          <td class="styTableCell" style="text-align:right;width:30mm;border-right:none;font-size:7pt;font-weight:normal;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="CreditByRatio"/>
            </xsl:call-template>
          </td>
        </tr>
        </xsl:for-each>
      ...
      <xsl:if test="count($Form8874Data/CurrentYearCreditInfo) &lt; 1 or
         (($Print = $Separated) and (count($Form8874Data/CurrentYearCreditInfo)&gt;3)) ">
        <tr>
          ...
          <td class="styTableCell" style="width:25mm;text-align:center;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:20mm;text-align:left;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:30mm;text-align:right;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:12mm;text-align:right;font-size:7pt;">%</td>
          <td class="styTableCell" style="text-align:right;width:30mm;border-right:none;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
        </tr>
      </xsl:if>  
      <xsl:if test="count($Form8874Data/CurrentYearCreditInfo) &lt; 2 or
         (($Print = $Separated) and (count($Form8874Data/CurrentYearCreditInfo)&gt;3)) ">
        <tr height="8mm">
          <td class="styTableCell" style="width:7mm;font-size:7pt;text-align:center;vertical-align:top;border-right:none;font-weight:bold;height:8mm"><span style="width:1px;"/></td>
          <td class="styTableCell" rowspan="1" style="width:63mm;text-align:left;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:25mm;text-align:center;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:20mm;text-align:left;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:30mm;text-align:right;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
          <td class="styTableCell" style="width:12mm;text-align:right;font-size:7pt;">%</td>
      ...
      <xsl:if test="count($Form8874Data/CurrentYearCreditInfo) &lt; 3 or
         (($Print = $Separated) and (count($Form8874Data/CurrentYearCreditInfo)&gt;3)) ">
        <tr height="8mm">
          <td class="styTableCell" style="width:7mm;font-size:7pt;text-align:center;vertical-align:top;border-right:none;font-weight:bold;height:8mm"><span style="width:1px;"/></td>
          <td class="styTableCell" rowspan="1" style="width:63mm;text-align:left;font-size:7pt;font-weight:normal;"><span style="width:1px;"/></td>
...
<!-- Line 2 caption -->
    <div style="width:187mm; float: none; clear: none;">
      <div class="styLNLeftNumBox" style="width:5mm;height:4mm;padding-left: 2mm"></div>
...
3800)
        ...
        <div class="styLNRightNumBox" style="height:6mm;width:8.75mm;text-align:center;border-bottom:none;padding-top:0mm;">
          <div class="styLNRightNumBoxNBB" style="height: 4.5mm; width:8.75mm;text-align:center;border-left-width:0px;background-color:lightgrey;"/>
          3    
        </div>        
        <div class="styLNAmountBox" style="height:8.25mm;width:30mm;border-bottom:none;padding-top:4mm;">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form8874Data/TotalCredit"/>
          </xsl:call-template>
        </div>
      </div>
    ...
    <div style="width:187mm;">
      ...
      Form <span class="styBoldText">8874</span> (Rev. 12-2006)    </div>
    <br class="pageEnd"/> 

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
	  ...
	  <xsl:call-template name="IRS8849Schedule1Style"></xsl:call-template>            
      ...
      <body class="styBodyClass">
		...
		<div class="styFNBox" style="height: 23.5mm; width:31mm;font-size: 7pt">
			<br/>
			...
			<br/>
			<span class="styAgency" style="font-size: 7.5pt; font-weight:bold">(Rev. February 2007)</span>
		...
		<div class="styMainTitle" style="height:9mm; font-weight: bold; padding-top: 2mm">Nontaxable Use of Fuels</div>
		...
		<div class="styTYBox" style="width:31mm; height: 23.5mm">
		...
		<tr>
		<td class="styNameBox" style="width:95mm;font-size:7pt;font-weight:normal; height:10mm">Name as shown on Form 8849<br/>
		<xsl:choose>
		...
		<span class="BoldText"  style="width:40mm;">EIN or SSN</span>
		...
		<tr>
          		...
          		<span style="padding-left:4mm; padding-right:2mm"></span></td>
				...
				<b>Caution.</b>
				<span style="width:2px;"></span><i>Claimant has the name and address of the person who sold the fuel to the claimant and the dates of purchases.  For claims on lines 1a and 2b (type of use 13 and 14), 3e, 4c, and 5, claimant has not waived the right to make the claim.  For claims on lines 1a and 2b (types of use 13 and 14), claimant certifies that a certificate has not been provided to the credit card issuer.</i>  <br /><br />
				...
				<b>From  </b> <img src="{$ImagePath}/8849Sch1_Bullet.gif" alt="MediumBullet"/></span>
				...
				<b>To  </b> <img src="{$ImagePath}/8849Sch1_Bullet.gif" alt="MediumBullet"/></span>
						<xsl:call-template name="PopulateMonthDayYear">
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom-width:0px; border-color: black" scope="col">
             	 		<span class="styTableCellPad">1</span></th>
			<th class="styTableCellHeader" style="width:63mm; font-weight:normal; text-align:left; border-bottom-width:0px; border-color: black" scope="col">
              		<b>Nontaxable Use of Gasoline</b></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom-width:0px; border-color: black" scope="col">
              		<b>(a) Type of use</b></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom-width:0px; border-color: black" scope="col">
              		<b>(b)Rate</b></th>
              	<th colspan="2" class="styTableCellHeader" style="width:25mm; font-weight:normal; border-bottom-width:0px; border-color: black" scope="col">
              		<b>(c) Gallons</b></th>
              	<th class="styTableCellHeader" style="width:40mm; font-weight:normal; border-bottom-width:0px; border-color: black" scope="col">
              		<b>(d) Amount of refund</b><br /><i>Multiply col. <b>(b)</b> by col. <b>(c)</b></i></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom-width:0px; border-color: black; border-right:0px" scope="col">
              		<b>(e) CRN</b>
             		</th>
		</tr>
          	</thead>
		...
		<tbody style="font-size:7pt;">
			...
			<tr>
				...
				<td style="border-top: 1px black solid"><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
					</xsl:when>
					<xsl:otherwise>
						<td><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
					</xsl:otherwise>
				</xsl:choose>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">2</span></th>
			<th colspan="7" style="width:63mm; font-weight:bold; text-align:left; border-top:1px black solid;  border-bottom:0px;" scope="col">Nontaxable Use of Aviation Gasoline</th>
		</tr>
		<!-- Begin Table 2, section a  -->
		<tr>
          		<td style="border-top:1px black solid; padding-bottom:3mm"><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
			...
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseOfAviationGas/ComAir/TypeOfUse"/>
          			</xsl:call-template>           		
          			-->
          		</td>
		...
		<tr>
          		<td style="padding-bottom:3mm"><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				Other nontaxable use (see <br /><b>Caution</b> above line 1)
			</td>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>c</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Exported</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background=lightgrey">
			<span style="width:1px"></span>
			<!--
		...
		<tr>
         <td style="padding-bottom:3mm"><span style="padding-left:4mm; padding-right:2mm"><b>d</b></span></td>
		...
		<tr>
			...
			<th colspan="7" style="width:63mm; font-weight:bold; text-align:left; border-top:1px black solid;  border-bottom:0px;" scope="col">				<b>Nontaxable Use of Undyed Diesel Fuel</b>		
			</th>
		</tr>
		<tr>
				...
				<b>Exception.</b> If any of the diesel fuel included in this claim <b>did</b> contain visible evidence of dye, attach 
				a detailed explanation and check here
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom:0px; border-right:0px solid black; border-top: 0px solid black" scope="col">
             	 		<span class="styTableCellPad" style="width:1px"></span></th>
			<th class="styTableCellHeader" style="width:63mm; font-weight:normal; text-align:left; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<span class="styTableCellPad" style="width:1px"></span></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(a) Type of use</b></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(b)Rate</b></th>
              	<th colspan="2" class="styTableCellHeader" style="width:25mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(c) Gallons</b></th>
              	<th class="styTableCellHeader" style="width:40mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(d) Amount of refund</b><br /><i>Multiply col. <b>(b)</b> by col. <b>(c)</b></i></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom:0px; border-right:0px solid black; border-top: 1px solid black;" scope="col">
              		<b>(e) CRN</b></th>
		</tr>
		...
		<tr>
				...
				<xsl:when test="position()= 1">
					<td style="border-top: 0px black solid">
						<span style="padding-left:4mm; padding-right:2mm"><b>a</b></span>
					</td>
				</xsl:when>
				<xsl:otherwise>
					<td><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
				...
				<xsl:call-template name="PopulateText">
          		...
          		<td style="width: 27mm; text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<xsl:choose>
				<xsl:when test="position()=count($FormData/NontaxableUseUndyedDieselFuel/NontaxableUse)">
				...
				<xsl:otherwise>
	          		<xsl:choose>
					<xsl:when test="position()= 1">
						<td style="width: 1mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px"><span style="width:1px"></span></td>
					</xsl:when>
					<xsl:otherwise>
						<td style="width: 1mm; text-align: center; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px"><span style="width:1px"></span></td>
					</xsl:otherwise>
				</xsl:choose>
				</xsl:otherwise>
			</xsl:choose>		          		
          		<xsl:choose>
				<xsl:when test="position()= 1">
					<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px"><span style="float:left;"></span></td>
				</xsl:when>
				<xsl:otherwise>
					<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px"><span style="padding-left:4mm; padding-right:2mm"></span></td>
				</xsl:otherwise>
			</xsl:choose>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">	
				<xsl:call-template name="PopulateText">
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>c</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Use in trains (before January 1, 2007)</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background:lightgrey">
				<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsBeforeJan2007/TypeOfUse"/>
          			</xsl:call-template>   	
          			-->
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsBeforeJan2007/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsBeforeJan2007/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsBeforeJan2007/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">			
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsBeforeJan2007/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>d</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Use in trains (after December 31, 2006)</td>

          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background:lightgrey">
				<span style="width:1px;"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsAfterDec312006/TypeOfUse"/>
          			</xsl:call-template>   	
          			-->
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsAfterDec312006/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsAfterDec312006/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsAfterDec312006/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">			
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/UseInTrainsAfterDec312006/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		<!-- End Table 3, section d -->	
		<!-- Begin Table 3, section e -->					
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>e</b></span></td>
			...
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/IntercityAndLocalBuses/TypeOfUse"/>  	
    				-->
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
		...
		<!-- Begin Table 3, section e -->	
		<!-- End Table 3, section f -->					
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>f</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Exported</td>
			...
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/NontaxableUseUndyedDieselFuel/Exported/TypeOfUse"/>
          			</xsl:call-template>   	
    				-->
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">4</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:1px black solid;" scope="col">
              		<b>Nontaxable use of Undyed Kerosene (Other Than Kerosene Used in Aviation)</b></th>
		</tr>
		<tr>
          		<td style="border-top:1px black solid">
          		<span style="padding-left:4mm; padding-right:2mm"></span></td>
				...
				<b>Exception.</b> If any of the kerosene included in this claim <b>did</b> contain visible evidence of dye, 
				attach a detailed explanation and check here 
				...
				<span style="width:11px"></span>.
   				...
   				<img src="{$ImagePath}/8849Sch1_Bullet.gif" alt="MediumBullet"/>
   				<br />
   				<b>Caution. </b> <i> Claims cannot be made on line 4 for kerosene sales from a blocked pump. 
   				Only registered ultimate vendors may make those claims using Schedule 2.</i>
			</td>
		...
		<!-- Begin Table 4, section a  -->		
          	<xsl:for-each select="$FormData/UndyedKerosene/NontaxableUse">
		<tr>
          		<xsl:choose>
				<xsl:when test="position()= 1">
					<td style="border-top: 0px black solid">
				...
				<xsl:call-template name="PopulateAmount">
          		...
          		<xsl:choose>
				<xsl:when test="position()=count($FormData/UndyedKerosene/NontaxableUse)">
          				<td rowspan="2" style="width: 1mm; text-align: center; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
						<img src="{$ImagePath}/8849Sch1_Bracket.gif" alt="Bracket"/>
      		          		</td>
				</xsl:when>
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">5</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:1px black solid;" scope="col">
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom:0px; border-right:0px solid black; border-top: 0px solid black" scope="col">
             	 		<span class="styTableCellPad" style="width:1px"></span></th>
			<th class="styTableCellHeader" style="width:78mm; font-weight:normal; text-align:left; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<span class="styTableCellPad" style="width:1px"></span></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(a) Type of use</b></th>
              	<th class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(b)Rate</b></th>
              	<th colspan="2" class="styTableCellHeader" style="width:20mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(c) Gallons</b></th>
              	<th class="styTableCellHeader" style="width:30mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(d) Amount of refund</b><br /><i>Multiply col. <b>(b)</b> by col. <b>(c)</b></i></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom:0px; border-right:0px solid black; border-top: 1px solid black;" scope="col">
              		<b>(e) CRN</b></th>
		</tr>
		...
		<tr>
          		<xsl:choose>
				<xsl:when test="position()= 1">
					<td valign="top" style="border-top: 0px black solid"><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
				</xsl:when>
				<xsl:otherwise>
					<td valign="top"><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
				</xsl:otherwise>
			</xsl:choose>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;font-size:6pt">Kerosene used in commercial aviation <br /> (other than foreign trade) taxed at $.244</td>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; font-size:6pt">Kerosene used in commercial aviation <br /> (other than foreign trade) taxed at $.219</td>
          		<td style="padding-top:4mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background: lightgrey">
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/KeroseneUsedInAviation/KeroseneTaxedAt219/TypeOfUse"/>
          			</xsl:call-template>   	
				-->          			
          		</td>          	
          		<td style="padding-top:4mm; text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>c</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;font-size:6pt">Nontaxable use (other than use by state or <br /> local government) taxed at $.244</td>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>d</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;font-size:6pt">Nontaxable use (other than by state or local <br /> government) taxed at $.219</td>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>e</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; font-size:6pt">LUST tax on aviation fuels used in foreign trade</td>
          		<td style="padding-top:4mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background: lightgrey">
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
		...
		<tr>
			...
			<div style="float: left; clear: none;">
       			...
       			<span style="padding-left:4mm;width:27mm; font-size:6pt">Cat. No. 27454M </span>
          			<span class="styBoldText"><span style="width:2px"></span> Schedule 1 (Form 8849) </span>(Rev. 2-2007)
     			</div>        
			</td>
		</tr>
		</tbody>
		...
		<div style="border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px; border-bottom-width: 2px">
  			<div style="float: left; clear: none">Schedule 1 (Form 8849) (Rev. 2-2007)</div>        
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:0px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">6</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:0px black solid;" scope="col">
              		<b>Nontaxable Use of Liquefied Petroleum Gas (LPG) (before October 1, 2006)</b></th>
		</tr>
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom:0px; border-right:0px solid black; border-top: 1px solid black" scope="col">
             	 		<span class="styTableCellPad" style="width:1px"></span></th>
			<th class="styTableCellHeader" style="width:60mm; font-weight:normal; text-align:left; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<span class="styTableCellPad" style="width:1px"></span></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(a) Type of use</b></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(b)Rate</b></th>
              	<th colspan="2" class="styTableCellHeader" style="width:43mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(c) Gallons</b></th>
              	<th class="styTableCellHeader" style="width:35mm; font-weight:normal; border-bottom:0px; border-right:1px solid black; border-top: 1px solid black" scope="col">
              		<b>(d) Amount of refund</b><br /><i>Multiply col. <b>(b)</b> by col. <b>(c)</b></i></th>
              	<th class="styTableCellHeader" style="width:15mm; font-weight:normal; border-bottom:0px; border-right:0px solid black; border-top: 1px solid black;" scope="col">
              		<b>(e) CRN</b></th>
		</tr>
		...
		<tr>
          		<xsl:choose>
				<xsl:when test="position()= 1">
					<td style="border-top: 0px black solid"><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
				</xsl:when>
				<xsl:otherwise>
					<td><span style="padding-left:4mm; padding-right:2mm"><b>a</b></span></td>
				</xsl:otherwise>
			</xsl:choose>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Use in certain intercity and local buses</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background:lightgrey">
			<span style="width:1px"></span>
			<!--
				<xsl:call-template name="PopulateText">
          		...
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;">$</span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/IntercityAndLocalBuses/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/IntercityAndLocalBuses/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;">$</span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/IntercityAndLocalBuses/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">	
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/IntercityAndLocalBuses/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Use in qualified local buses and in <br />school buses</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background: lightgrey">
				<span style="width:1px"></span>
<!--
				<xsl:call-template name="PopulateText">
...
-->          			
          		...
          		<td style="padding-top:4mm; text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/QualifiedLocalBusesSchoolBuses/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="padding-top:4mm; text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/QualifiedLocalBusesSchoolBuses/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="padding-top:4mm; text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/QualifiedLocalBusesSchoolBuses/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="padding-top:4mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">			
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/LiquefiedPetroleumGas/QualifiedLocalBusesSchoolBuses/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		<!-- End Table 6, section b -->		
		<!-- Begin Table 6, section c -->		
          	<xsl:for-each select="$FormData/LiquefiedPetroleumGas/OtherNontaxableUse">
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>c</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Other nontaxable use</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">7</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:1px black solid;" scope="col">
              		<b>Nontaxable Use of Alternative Fuel (after September 30, 2006)</b></th>
		</tr>
		<tr>
          		<td style="border-top:1px black solid">
          		<span style="padding-left:4mm; padding-right:2mm"></span></td>
          		<td colspan="7" style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">
   				...
   				<b>Caution. </b> <i> There is a reduced credit rate for use in certain intercity and local buses (type of use 5).  
   				See page 4 for the credit rate. </i>
   			</td>
   		</tr>
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom:0px; border-right:0px solid black; border-top: 0px solid black" scope="col">
		...
		<tr>
				...
				<xsl:otherwise>
          		...
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Liquefied petroleum gas (LPG)</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">"P Series" fuels</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
				<span style="width:1px"></span>
		...
		<!-- Begin Table 7, section c -->		
          	<xsl:for-each select="$FormData/AlternativeFuels/CNG">			
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>c</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Compressed natural gas (CNG)<br /> (GGE=126.67 cu. ft.)</td>
          		<td style="padding-top:4mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<!-- End Table 7, section c -->			
		<!-- Begin Table 7, section d -->		
          	<xsl:for-each select="$FormData/AlternativeFuels/LiquefiedHydrogen">				
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>d</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Liquefied hydrogen</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<!-- End Table 7, section d -->			
			
		<!-- Begin Table 7, section e -->		
          	<xsl:for-each select="$FormData/AlternativeFuels/LiquidFuelFromCoal">			
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>e</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Any liquid fuel derived from <br />coal (including peat) through the<br /> Fischer-Tropsch process</td>
          		<td style="padding-top:4mm; text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<!-- End Table 7, section e -->			
			
		<!-- Begin Table 7, section f -->		
          	<xsl:for-each select="$FormData/AlternativeFuels/LiquidFuelFromBiomass">		
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>f</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Liquid fuel derived from biomass</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<!-- End Table 7, section f -->			
		<!-- Begin Table 7, section g -->		
          	<xsl:for-each select="$FormData/AlternativeFuels/LNG">		
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>g</b></span></td>
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Liquefied natural gas (LNG)</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
          			</xsl:call-template>   	
		...
		<!-- End Table 7, section g -->		
		<!-- End Table 7 -->			
		<!--  Begin Table 8   -->
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">8</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:1px black solid;" scope="col">
              		<b>Nontaxable Use of a Diesel-Water Fuel Emulsion</b></th>
		</tr>
		<tr>
          		<td style="border-top:1px black solid">
          		<span style="padding-left:4mm; padding-right:2mm"></span></td>
		...
		<tr>
				...
				<xsl:otherwise>
          		...
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Nontaxable use</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
			<span style="width:1px"></span>
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="TypeOfUse"/>
		...
		<tr>
				...
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/DieselWaterFuelEmulsion/Exported/TypeOfUse"/>
          			</xsl:call-template>   	
				--> 			
          		</td>          	
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
		...
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px;border-top:1px black solid; border-bottom:0px; " scope="col">
             	 		<span class="styTableCellPad">9</span></th>
			<th  colspan="7" style="width:183mm; font-weight:normal; text-align:left; border-top:1px black solid;" scope="col">
              		<b>Exported Dyed Fuel</b></th>
		</tr>
		<tr>
             		<th class="styTableCellHeader" style="width:4mm;border-right-width:0px; border-bottom:0px; border-right:0px solid black; border-top: 1px solid black" scope="col">
             	 		<span class="styTableCellPad" style="width:1px"></span></th>
		...
		<tr>
				...
				<xsl:otherwise>
          		...
          		<td style="text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">Exported dyed diesel fuel</td>

          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background:lightgrey">
			<span style="width:1px"></span>
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedDieselFuel/TypeOfUse"/>
          			</xsl:call-template>
          			-->   	
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;">$</span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedDieselFuel/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedDieselFuel/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;">$</span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedDieselFuel/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">	
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedDieselFuel/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		<!-- End Table 9, section a -->		
		<!-- Begin Table 9, section b -->			
		<tr>
          		<td><span style="padding-left:4mm; padding-right:2mm"><b>b</b></span></td>
				...
				<!--
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedKerosene/TypeOfUse"/>
          			</xsl:call-template>   	
				--> 			
          		</td>          	
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
          			<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedKerosene/Rate"/>
				</xsl:call-template>
          		</td>
          		<td colspan="2" style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
				<xsl:call-template name="PopulateAmount">
    					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedKerosene/Gallons"/>
          			</xsl:call-template>          		
          		</td>
          		<td style="text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px">
          			<span style="float:left;"></span>
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedKerosene/Amount"/>
          			</xsl:call-template>
          		</td>
          		<td style="text-align: center; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px">			
				<xsl:call-template name="PopulateText">
          				<xsl:with-param name="TargetNode" select="$FormData/ExportedDyedFuels/ExportedDyedKerosene/CRN"/>
          			</xsl:call-template>
          		</td>
		</tr>
		<!-- End Table 9, section b -->		
		<!-- End Table 9 -->
		<!-- Begin Page 2 Footer -->
		<tr>
			<td colspan="8" style="border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 2px; border-bottom-width: 0px">
			<div style="float: right; clear: none;">
          			<span class="styBoldText"><span style="width:4px"></span> Schedule 1 (Form 8849) </span>(Rev. 2-2007)
     			</div>        
			</td>
		</tr>

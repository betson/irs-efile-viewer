        ...
        <form name="Form1120S">
          ...
          <div class="styTBB" style="width:187mm;height:20mm;">
            ...
            Form<span class="styFormNumber">1120S</span>
                ...
                <span style="width:1mm;"/>
                <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 1120S, Top Left Margin - Change Annual Accounting Period 2</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$Form1120SData/@changeAnnualAccountingPeriod2"/>
                </xsl:call-template>
                <span style="width:1mm;"/>
                <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 1120S, Top Left Margin - Section 301.9100-2 Election Indicator</xsl:with-param>
              ...
              <div style="padding-top:0mm;">
                ...
                <br/>
                <span class="styAgency">Internal Revenue Service <span style="padding-left:4mm;">(77)</span>
                </span>
              </div>
            </div>
            ...
            <div class="styTYBox" style="width:30mm;height:20mm;">
              ...
              <div class="styTY" style="height:11mm;padding-top:3mm;">20<span class="styTYColor">08</span>
              </div>
            </div>
          </div>
...
ending         
          ...
          <div class="styBB" style="width:187mm;float:left;clear:left;">
            <div style="width:31mm;height:11.75mm;float:left;clear:left;">
              ...
              <div class="styComType" style="width:31mm;height:9mm;border-bottom-width:1px;">
                ...
                <div style="height:7mm;width:27mm;float:left;">Business activity code number (see instructions)</div>
            ...
            <div class="styLblNameAddr" style="width:109mm;height:28.5mm;">
              <div class="styUseLbl" style="width:12mm;height:26mm;border-right-width:0px;">Use the IRS label. Other-wise, print or type.</div>
        ...
        <xsl:call-template name="PopulateAmount">
          ...
          No
            ...
            <span style="width:1mm"/>If “Yes,” attach Form 2553 if not already filed 
      </div>
          <div class="styBB" style="width:187mm;">
        ...
        Check if: 
          ...
          Enter the number of shareholders who were shareholders during any part of the tax year 
            ...
            <!--
        <div class="styGenericDiv" style="width:21mm;text-align:right;">
           <xsl:call-template name="PopulateAmount">
           <xsl:with-param name="TargetNode" select="$Form1120SData/NumberOfShareHolders" /></xsl:call-template></div>
       </div>
       -->
          </div>
          <div class="styBB" style="width:187mm;">
...
<span style="width:16px"/>.
      ...
      <!--Dotted Line-->
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:181mm;float:right;">
              ...
              <div class="styLNDesc" style="width:93.25mm;height:8.5mm;">
                <span> Excess net passive income tax or LIFO recapture tax (see <br/> instructions)
            <xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        <span style="width:16px"/>.
              ...
              <div class="styLNAmountBoxNBB" style="height:8.5mm;width:31.75mm;"/>
            </div>
            <div style="width:181mm;float:right;">
      ...
      <span style="width:2px;"/>
        ...
        <span style="width:16px"/>.
            ...
            <div style="width:181mm;float:right;">
              ...
              <div class="styLNDesc" style="width:82.3mm;height:4.5mm;font-size:6pt;padding-bottom:0;padding-top:1mm;">
      Add lines 22a and 22b <i>(see instructions for additional taxes)</i>
              </div>
              <div class="styLNDesc" style="width:50.93mm;height:4.5mm;font-size:6pt;padding-top:0;padding-bottom:0;">
                <span style="width:2px;"/>
                <xsl:call-template name="SetFormLinkInline">
            ...
            <div style="width:181mm;float:right;">
              ...
              <div class="styLNDesc" style="width:93.25mm;height:4.5mm;font-size:6.5pt;">
                <span style="font-family:arial;"> 2008 estimated tax payments and 2007 overpayment credited to 2008</span>
                <span class="styBoldText">
                  <span style="width:16px"/>.
        <span style="width:16px"/>.
      </span>
            ...
            <tr>
              ...
              <td style="width:32mm;border-bottom:1 solid black;">
                ...
                <span class="styGenericDiv" style="border:0 solid red;">
                  <img src="{$ImagePath}/1120S_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/>
                </span>
              </td>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120S</span> (2008)
    </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 1120S (2008)<span style="width:148mm;"/>
            </div>
    ...
    <span style="width:2px;"/>
              <xsl:call-template name="SetFormLinkInline">
                <xsl:with-param name="TargetNode" select="$Form1120SScheduleA/InventoryAtBeginningOfYear"/>
              </xsl:call-template>
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
      ...
      <span style="width:16px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="height:4mm;">Other costs <i>(attach statement)</i>
              <span style="width:2px;"/>
              <xsl:call-template name="SetFormLinkInline">
                <xsl:with-param name="TargetNode" select="$Form1120SScheduleA/OtherCosts"/>
              </xsl:call-template>
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
    ...
    <span style="width:2px;"/>
        ...
        No
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:119mm;height:4.5mm;">Check method of accounting:
    <span style="width:8px"/>
      ...
      Accrual
       ...
       Other (specify)
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:159mm;height:10.5mm;">At the end of the tax year, did the corporation own, directly or indirectly, 50% or more of the voting stock of a 
    domestic corporation? (For rules of attribution, see section 267(c).) If “Yes,” attach a statement showing: <span class="styBoldText">(a)</span> name and
    employer identification number (EIN), <span class="styBoldText">(b)</span> percentage owned, and  <span class="styBoldText">(c)</span> if 100% owned, was a QSub election made?  <span style="width:2px;"/>
              <xsl:call-template name="SetFormLinkInline">
      ...
      <span style="width:16px"/>.
            ...
            <div class="styIRS1120SLNYesNoBox" style="height:10.75mm;padding-top:6mm;">
    ...
    Has this corporation filed, or is it required to file, a return under section 6111 to provide information on any reportable
transaction?
 <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
      ...
      <span style="width:16px"/>.
            ...
            <div class="styIRS1120SLNYesNoBox" style="height:7.5mm;padding-top:3.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form1120SScheduleB/FiledOrRequiredToFileUnder6111"/>
              </xsl:call-template>
            </div>
    ...
    Issue Discount Instruments.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:159mm;height:14mm">If the corporation:
    <span class="styBoldText">(a)</span> was a C corporation before it elected to be an S corporation <span class="styBoldText">or</span> the corporation acquired an<br/>
asset with a basis determined by reference to its basis (or the basis of any other property) in the hands of a<br/>
C corporation <span class="styBoldText">and (b)</span> has net unrealized built-in gain (defined in section 1374(d)(1)) in excess of the net recognized<br/>
    ...
    the tax year less than $250,000? If "Yes," the corporation is not required to complete Schedules L and M-1.
     ...
     <span style="width:16px"/>.
      ...
      <span style="width:16px"/>.
            ...
            <div class="styIRS1120SLNYesNoBox" style="height:7.5mm;padding-top:4mm;border-bottom-width:0px;">
              <xsl:call-template name="PopulateYesBoxText">
              ...
              <xsl:with-param name="TargetNode" select="$Form1120SScheduleK/OtherRentalCredit" />
                ...
                <tr>
                  <td>
                    ...
                    <span class="styIRS1120SLNDesc">Alcohol and cellulosic biofuel fuels credit <i>(attach Form 6478) </i>
                      <xsl:call-template name="SetFormLinkInline">
                ...
                <tr>
                  <td style="border-bottom:1px solid black;">
                    ...
                    <span class="styIRS1120SLNDesc">Other credits <i>(see instructions)</i>
                      ...
                      <xsl:call-template name="LinkToLeftoverDataTableInline">
                        <xsl:with-param name="Desc">Schedule K, Line 13g - Other Credit Type
              </xsl:with-param>
               ...
               Type <img src="{$ImagePath}/1120S_Bullet_Md.gif" alt="MidSizeBullet"/>
                      ...
                      <!--               <span style="width:32mm;padding-left:1mm;background:green;">
                   <xsl:call-template name="PopulateAmount">
                       <xsl:with-param name="TargetNode" select="$Form1120SScheduleK/OtherCreditsTotal/@otherCreditType " />
                   </xsl:call-template>
            </span>   -->
          ...
          <span style="width:5mm;">
            ...
            <xsl:call-template name="SetFormLinkInline">
                ...
                <tr>
                  <td>
                    <span class="styIRS1120SLNLeftLtrBoxTD">d</span>
                    <span class="styIRS1120SLNDesc">Property distributions</span>
                    <span style="float:right;">
                      <span class="styIRS1120SDotLn">.......................</span>
                    </span>
                  </td>
                  <td>
                    ...
                    <span class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="$Form1120SScheduleK/PropDistriOtherThanDividends"/>
                      </xsl:call-template>
                    </span>
                  </td>
                </tr>

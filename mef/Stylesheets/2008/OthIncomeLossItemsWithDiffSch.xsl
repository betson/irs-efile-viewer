...
<xsl:template name="OthIncomeLossItemsWithDiffSchTemp">
    <table id="OthIncomeLossItemsWithDiffSchTbl" class="styDepTbl">
    ...
    <html>
      ...
      <xsl:call-template name="DocumentHeaderDependency"></xsl:call-template>
        ...
        <!--The xsl: choose code block below enables this stylesheet to display data from more then one schema version -->
                       ...
                       <xsl:call-template name="OthIncomeLossItemsWithDiffSchTemp" />
                    <br/>                      

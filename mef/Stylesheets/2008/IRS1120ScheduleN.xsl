      ...
      <body class="styBodyClass">
        <form name="Form1120ScheduleN">
         ...
         an entity separate from its owner under Regulations sections 301.7701-2 and 301.7701-3 (see instructions)?
          ...
          <!--Dotted Line-->
            ...
            <!--UnderLine-->
            <div class="styIRS1120ScheduleNUnderlineAmount" style="padding-left:2mm;padding-right:3.75mm;width:42.75mm;">
          ...
          <!--Dotted Line-->
            ...
            <!--UnderLine-->
            <div class="styIRS1120ScheduleNUnderlineAmount" style="padding-left:2mm;width:42.75mm;padding-right:3.75mm;">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="MaxSize" select="3"/>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:4.5mm;"/>
            <div class="styLNDesc" style="width:158mm;height:4.5mm;">under Regulations section 301.7701-2 or 301.7701-3)?
          <span style="width:2px;"/>
              <xsl:call-template name="SetFormLinkInline">
          ...
          <!--Dotted Line-->
            ...
            <div class="styIRS1120ScheduleNUnderlineAmount" style="padding-right:3.75mm;padding-left:2mm;width:42.75mm;">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="MaxSize" select="3"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:158mm;height:4.5mm;">
          At any time during the 2008 calendar year, did the corporation have an interest in or a signature or other authority
        </div>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
          </div>
          ...
          <!-- <div style="height:4.5mm;width:187mm;">
        <div class="styLNDesc" style="width:166mm;height:4.5mm;"></div>
        ...
        <div class="styShadingCell" style="height:4.5mm;width:10mm;"></div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:158mm;height:4.5mm;">
          Enter the total of the amounts from line 52 (extraterritorial income exclusion
        </div>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
          </div>
          <div class="styBB" style="width:187mm;">
            <div class="styLNLeftLtrBox" style="height:4.5mm;"/>
            <div class="styLNDesc" style="width:126mm;height:4.5mm;">
              <span style="width:120mm;">
          (net of disallowed deductions)) of <span class="styBoldText">all</span> Forms 8873 attached to the tax return
          <!--Dotted Line-->
                <!--<span class="styBoldText">
          ...
          <div class="stySmallText" style="width:120mm;">
            <span class="styBoldText">For Privacy Act and Paperwork Reduction Act Notice, see the Instructions for Form 1120.</span>
          </div>
          <div class="stySmallText" style="width:25mm;">Cat. No. 26294K</div>
          <div class="stySmallText" style="width:41mm;text-align:right;">
            <span class="styBoldText">Schedule N (Form 1120) (2008)</span>
          </div>
          <br/>
          <br/>
          <br/>

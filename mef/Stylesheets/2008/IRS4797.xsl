...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
        ...
        <form name="Form4797">
          ...
          Identifying number<br/>
              ...
              <span style="font-weight:normal;">
                <xsl:choose>
                  <xsl:when test="$Form4797Data/EIN">
          ...
          exchanges reported to you for 2008 on Form(s) 1099-B or 1099-S (or substitute
          ...
          <div class="styTableContainer" style="height:25.5mm;" id="PSOctn">
            ...
            <table class="styTable" cellspacing="0">
              <thead class="styTableThead">
                <tr>
                  <th class="styTableCellHeader" style="width:4mm;border-right-width:0px;" scope="col">
                    ...
                    <tr>
                      ...
                      <td class="styTableCellText" style="width:16mm;">
                        ...
                        <xsl:if test="DateAcquiredInherited">
                          ...
                          <!--xsl:call-template name="PopulateMonth"><xsl:with-param name="TargetNode" select="DateAcquiredInherited" /></xsl:call-template>-<xsl:call-template name="PopulateDay"><xsl:with-param name="TargetNode" select="DateAcquiredInherited" /></xsl:call-template>-<xsl:call-template name="PopulateYear"><xsl:with-param name="TargetNode" select="DateAcquiredInherited" /></xsl:call-template-->
                        </xsl:if>
                      </td>
                      <td class="styTableCellText" style="width:16mm;">
                        <span style="width:1px;"/>
                        ...
                        <xsl:if test="DateSoldVarious">
                          ...
                          <!--xsl:call-template name="PopulateMonth"><xsl:with-param name="TargetNode" select="DateSoldVarious" /></xsl:call-template>-<xsl:call-template name="PopulateDay"><xsl:with-param name="TargetNode" select="DateSoldVarious" /></xsl:call-template>-<xsl:call-template name="PopulateYear"><xsl:with-param name="TargetNode" select="DateSoldVarious" /></xsl:call-template-->
                        </xsl:if>
                      </td>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Gain, if any, from Form 4684, line 39
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Section 1231 gain from installment sales from Form 6252, line 26 or 37
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Section 1231 gain or (loss) from like-kind exchanges from Form 8824
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Gain, if any, from line 32, from other than casualty or theft
          <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          Combine lines 2 through 6.  Enter the 
          gain or (loss) here and on the appropriate line as follows:
          <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Nonrecaptured net section 1231 losses from prior years (see instructions)
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          Subtract line 8 from line 7. If zero or less, enter -0-. If line 9 is zero, enter the gain from line 7
           ...
           and enter the gain from line 9 as a long-term capital gain on the Schedule D  filed with your 
      ...
      styTBB" style="width:187mm;"><br/></div-->
          <div class="styBB" style="width:187mm">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Loss, if any, from line 7
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Gain, if any, from line 31
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Net gain or (loss) from Form 4684, lines 31 and 38a
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Ordinary gain from installment sales from Form 6252, line 25 or 36
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Ordinary gain or (loss) from like-kind exchanges from Form 8824
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Combine lines 10 through 16. 
        ...
        If the loss on line 11 includes a loss from Form 4684,
         ...
         on Schedule A (Form 1040), line 28, and the part  of the loss  from property used as an employee on Schedule A (Form 1040), line 23. Identify as from “Form 4797, line 18a.”
         See instructions 
...
<!--Dotted Line-->
            ...
            <div style="height:8mm;float:right;">
              ...
              <div class="styLNRightNumBox" style="width:8mm;height:5.7mm;">18a</div>
              <div class="styIRS4797LNAmountBoxSmall" style="height:5.7mm;">
                <xsl:call-template name="PopulateAmount">
...
line 14          <!--Dotted Line-->
            ...
            <div class="styLNRightNumBox" style="width:8mm;height:8mm;">18b</div>
            <div class="styIRS4797LNAmountBoxSmall" style="height:8mm;">
              <xsl:call-template name="PopulateAmount">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2008)
    </div>
          </div>
          ...
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 4797 (2008)<span style="width:148mm;"/>
            </div>
          ...
          1252, 1254, and 1255<br/>
            ...
            <div class="styBB" style="width:187mm;">
              <div class="styPartDesc" style="float:left;width:187mm;font-weight:normal;
           padding-left:17mm;">(see instructions)
           </div>
            </div>
          ...
          <xsl:if test="not($Form4797Data/PropertyDispositionGain)  or ((count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated))">
            <xsl:if test="(position() mod 4) = 1">
              ...
              <div class="styBB" style="width:187mm;height:4.5mm;">
                ...
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
              Enter the <span class="styBoldText">smaller</span> of line 24 or 25a
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <span class="styBoldText">smaller</span> of line 24 or line 26a (see instructions)
              <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <span class="styBoldText">or</span> line 24 is not more than line 26a,
              skip lines 26d and 26e
              <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <div style="width:187mm;height:4.5mm;">
                ...
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
              Enter the <span class="styBoldText">smaller</span> of line 26c or 26d
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <div style="width:187mm;height:4.5mm;">
                ...
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
              Sections 291 amount (corporations only)
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <div style="width:187mm;height:4.5mm;">
                <div class="styLNLeftLtrBox">b</div>
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
                  <span class="styArialText">Line 27a multiplied by applicable percentage (see instructions)</span>
                  <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
              </span>
                </div>
                <div class="styLNRightNumBox" style="height:4.5mm;">27b</div>
                <div class="styLNAmountBoxSmall" style="height:4.5mm;">
                  <span style="width:4px;"/>
                </div>
                <div class="styLNAmountBoxSmall" style="height:4.5mm;">
              ...
              <div class="styBB" style="width:187mm;height:4.5mm;">
                ...
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
              Enter the <span class="styBoldText">smaller</span> of line 24 or 27b
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
              ...
              <div class="styBB" style="width:187mm;height:4.5mm;">
                <div class="styLNLeftLtrBox">b</div>
                <div class="styLNDesc" style="width:66mm;height:4.5mm;">
              Enter the <span class="styBoldText">smaller</span> of line 24 or 28a
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="height:4mm;">Total gains for all properties.
          Add property columns A through D, line 24
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="height:8mm;padding-top:3mm;">Add property columns A through D,
          ...
          <table style="width:187mm; font-size:7pt; border-bottom:1 solid black" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <td class="styLNDesc" style="width:106mm;height:4.5mm;" valign="top" nowrap="nowrap">Recomputed depreciation (see instructions)
            <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:11px"/>.
              <span style="width:11px"/>.
      ...
      Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2008)
          ...
          <br/>
          <!-- Repeating vertical table for Part III lines 20 through 29 -->
          <xsl:if test="(count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated)">
            <span class="styRepeatingDataTitle">Form 4797, Part III, Lines 20 throught 29 - Gain From Disposition of Property Under Sections 1245, 1250, 1252, 1254, and 1255:</span>
            <xsl:for-each select="$Form4797Data/PropertyDispositionGain">
              <xsl:if test="(position() mod 4) = 1">
                <xsl:variable name="curPos">
                  <xsl:value-of select="position()"/>

      ...
      <span style="padding-left: 10mm;"/>collection of the PHC tax is any time within 6 years after the return is filed.  See section 6501(f).
       ...
       <b>
        ...
        <span style="width:18mm;"/>
              <span class="styBoldText">Schedule PH (Form 1120) (2008)</span>
            </div>
          </div>
          <div class="pageEnd"/>
          <!--END FOOTER-->
          ...
          <div class="styBB" style="width:187mm;border-bottom:0px solid black;">
            <div style="float: left; clear: none">Schedule PH (Form 1120) (2008)</div>
            <div style="float:right">
        ...
        <br/>
          ...
          <!--   END PART IV TABLE   -->
          <!--   BEGIN LINE 2   -->
          <div class="styIRS1120SchedulePHLineItem" style="float: none; clear: both;width:185.25mm">
            <span class="styIRS1120SchedulePHLN" style="padding-top:4.5mm;">2</span>
            <span class="styIRS1120SchedulePHLNLtMargin"/>
            <span class="styIRS1120SchedulePHLNDesc" style="width: 137.25mm;padding-top:4.5mm">Add the amounts in columns (c) and (d) and enter the totals here
      <b>
                <span class="styIRS1120SchedulePHNBSP"/>.
        <span class="styIRS1120SchedulePHNBSP"/>.
        <span class="styIRS1120SchedulePHNBSP"/>.
      ...
      <b>
       ...
       <b>
          ...
          <div style="width: 187mm">
            ...
            <span class="styBoldText" style="float: right">Schedule PH (Form 1120) (2008)</span>
          </div>
          <!--   END FORM FOOTER   -->
          <br/>
          <div class="pageEnd"/>

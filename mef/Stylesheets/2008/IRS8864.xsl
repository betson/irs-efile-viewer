        ...
        <form name="Form8864" id="Form8864">
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:97.7mm;height:4mm;">
                Biodiesel (other than agri-biodiesel) produced, or sold or used, before 
            </div>
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:97.7mm;height:4mm;">
              <span style="float:left">2009 </span>
              <!--Dotted Line-->
            ...
            <div class="styLNAmountBox" style="width:32mm;padding-right:1mm;">
              <!-- populate 'Straight biodiesel' number of gallons sold or used -->
              <!-- Generated code start -->
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$FormData/BiodieselGallons"/>
                <xsl:with-param name="BackupName">IRS8864BiodieselGallonss</xsl:with-param>
              </xsl:call-template>
              <!-- Generated code end -->
            </div>
            <!-- Text is aligned center as it is in center aligned in the PDF -->
            <div class="styLNAmountBox" style="width:12mm;text-align:center;">
              ...
              <span style="padding-left:2.6mm;">.50</span>
            </div>
            <div class="styLNAmountBox">
              <!-- populate 'Straight biodiesel' number of gallons sold or used multiplied by .5  -->
              <!-- Generated code start -->
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/BiodieselAmount"/>
                <xsl:with-param name="BackupName">IRS8864BiodieselAmount</xsl:with-param>
              </xsl:call-template>
              <!-- Generated code end -->
            </div>
          </div>
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:97.7mm;height:4mm;">
                Biodiesel (other than agri-biodiesel) produced, and sold or used, after 
            </div>
            <div class="styLNAmountBox" style="border-bottom-width:0px;width:5mm;padding-right:2mm;"/>
            <div class="styLNAmountBox" style="width:32mm;border-bottom-width:0px;"/>
            <!-- Text is aligned center as it is in center aligned in the PDF -->
          ...
          <div style="width:187mm">
            <div class="styLNLeftNumBox" style="height:4mm;"/>
            <div class="styLNDesc" style="width:97.7mm;height:4mm;">
              <span style="float:left">produced, or sold or used, before 2009 </span>
              <!--Dotted Line-->
              <span class="styBoldText" style="float:right;padding-right:1mm">
                <span style="width:7px;"/>.
            <span style="width:16px;"/>.
            ...
            <div class="styLNAmountBox" style="width:32mm;padding-right:1mm;">
              <!-- Generated code start -->
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$FormData/BiodieselIncldGals"/>
                <xsl:with-param name="BackupName">IRS8864BiodieselIncldGals</xsl:with-param>
              </xsl:call-template>
              <!-- Generated code end -->
            </div>
            <!-- Text is aligned center as it is in center aligned in the PDF -->
            <div class="styLNAmountBox" style="width:12mm;text-align:center;">
              <span style="padding-left:1mm;">$</span>
              <span style="padding-left:1mm;">.50</span>
            </div>
            <div class="styLNAmountBox">
              <!-- Generated code start -->
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/BiodieselIncldAmt"/>
                <xsl:with-param name="BackupName">IRS8864BiodieselIncldAmt</xsl:with-param>
              </xsl:call-template>
              <!-- Generated code end -->
            </div>
          </div>
          ...
          <div style="width:187mm">
            <div class="styLNLeftNumBox" style="height:4mm;"/>
            <div class="styLNDesc" style="width:97.7mm;height:4mm;">
              <span style="float:left">produced, and sold or used, after 2008 </span>
              <!--Dotted Line-->
              <span class="styBoldText" style="float:right;padding-right:1mm">
                <span style="width:7px;"/>.
            <span style="width:16px;"/>.
          ...
          <div style="width:187mm">
            ...
            <div class="styLNAmountBox" style="width:5mm;padding-right:1mm;">8</div>
            <div class="styLNAmountBox" style="width:32mm;padding-right:1mm;">
              <!-- Generated code start -->
              <xsl:call-template name="PopulateText">
          ...
          <div style="width:187mm">
            ...
            <div class="styLNAmountBox" style="width:5mm;padding-right:1mm;">9</div>
            <div class="styLNAmountBox" style="width:32mm;padding-right:1mm;">
              <!-- Generated code start -->
              <xsl:call-template name="PopulateText">
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:138.75mm;height:4mm;font-size:2.5mm;">
              <span style="float:left">Add lines 1 through 9. Include this amount in your income for 2008 (see instructions)</span>
              <!--Dotted Line-->
              <span class="styBoldText" style="float:right;padding-right:1mm">
                <span style="width:7px;"/>.
            <span style="width:16px;"/>.
            ...
            <div class="styLNAmountBox">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/BiodieselPlusAgriBiodiesel"/>
                <xsl:with-param name="BackupName">IRS8864BiodieselPlusAgriBiodiesel</xsl:with-param>
              </xsl:call-template>
            </div>
          </div>
          <!-- Text is aligned center as it is in center aligned in the PDF -->
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:138.75mm;height:4mm;font-size:2.5mm;">
              <span style="float:left">Add lines 10 and 11. Cooperatives, estates, and trusts, go to line 13; partnerships and S corporations, </span>
            </div>
            <div class="styLNAmountBox" style="border-bottom-width:0px;width:8mm;padding-right:2mm;"/>
            <div class="styLNAmountBox" style="width:30mm;border-bottom-width:0px;"/>
            <!-- Text is aligned center as it is in center aligned in the PDF -->
          ...
          <div style="width:187mm">
            ...
            <div class="styLNAmountBox">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/AddLines10and11"/>
                <xsl:with-param name="BackupName">IRS8864AddLines10and11</xsl:with-param>
              </xsl:call-template>
            </div>
          </div>
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:138.75mm;height:4mm;font-size:2.5mm;">
              <span style="float:left">Amount allocated to patrons of the cooperative or beneficiaries of the estate or trust</span>
              <!--Dotted Line-->
              <span class="styBoldText" style="float:right;padding-right:1mm">
                <span style="width:7px;"/>.
            <span style="width:16px;"/>.
            ...
            <div class="styLNAmountBox">
              <xsl:call-template name="PopulateAmount">
                ...
                <xsl:with-param name="BackupName">IRS8864AmountAllocatedtoBeneficiaries</xsl:with-param>
              </xsl:call-template>
            </div>
          </div>
          <!-- Text is aligned center as it is in center aligned in the PDF -->
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:138.75mm;height:4mm;font-size:2.5mm;">
              <span style="float:left">Cooperatives, estates, and trusts. Subtract line 13 from line 12. Report this amount on Form 3800, </span>
            </div>
            <div class="styLNAmountBox" style="border-bottom-width:0px;width:8mm;padding-right:2mm;"/>
            <div class="styLNAmountBox" style="width:30mm;border-bottom-width:0px;"/>
            <!-- Text is aligned center as it is in center aligned in the PDF -->
          ...
          <div class="styBB" style="width:187mm">
            ...
            <div class="styLNAmountBoxNBB">
              <!-- Generated code start -->
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/EstatesTrustsAndCoopsCredit"/>
                <xsl:with-param name="BackupName">IRS8864EstatesTrustsAndCoopsCredit</xsl:with-param>
              </xsl:call-template>
              <!-- Generated code end -->
            </div>
          </div>

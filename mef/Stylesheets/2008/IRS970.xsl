...
<html>
  <head>
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form970)"></xsl:with-param></xsl:call-template></title>
    <!-- No Browser Caching -->
    ...
    <style type="text/css">
      <xsl:if test="not($Print) or $Print=''">
        <xsl:call-template name="IRS970Style"></xsl:call-template>    
    ...
    <form name="Form970">
      ...
      <div class="styTBB" style="width:187mm;">
        ...
        <div class="styTYBox" style="width:30mm;height:19mm;">
          ...
          <br/>
          <div ><span style="padding-right:30px;">Attachment </span><br/>Sequence No.<span class="styBoldText"><span style="width:4px;"></span>122</span></div>
        </div>
      </div>
      ...
      <div class="styBB" style="width:187mm;height:8mm;clear:both;">
          ...
          <xsl:for-each select="$Form970/ApplicantInformation">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="NameOfApplicant/BusinessNameLine1" />
            </xsl:call-template>
            <xsl:if test="NameOfApplicant/BusinessNameLine2"><br /> 
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="NameOfApplicant/BusinessNameLine2" />
              </xsl:call-template>
            </xsl:if>,
            <xsl:choose>
              <xsl:when test="SSN">
      ...
      <div style="width:187mm;height:4.5mm;">
        ...
        <div class="styLNDesc" style="width:158mm;height:4.5mm;">
          ...
          <span style="width:2px"></span><img src="{$ImagePath}/970_Bullet.gif" alt="Bullet"/>          
          ...
          <span class="styUnderlineAmount" style="width:108mm;float:none;text-align:left;">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form970/LIFOMthdGoodsForFirstTY" /></xsl:call-template>
          </span>
        </div>
        <div class="styShadingCell" style="height:100%;width:10mm;"></div>
        <div class="styShadingCell" style="height:100%;width:10mm;"></div>
      </div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/LIFOMthdCurrUsedForOthGoods" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/LIFOMthdCurrUsedForOthGoods" /></xsl:call-template></div>
      </div>
      <!--L3b -->
      ...
      <div style="width:187mm;">
        ...
        <div class="styIRS970LNYesNoBox" style="height:6mm;padding-top:2mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/LIFOInventoryMethodUsedBefore" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:6mm;padding-top:2mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/LIFOInventoryMethodUsedBefore" /></xsl:call-template></div>
      </div>
      <!--L4b -->
      <div style="width:187mm;height:8mm;">
        <div class="styLNLeftNumBoxSD" style="padding-left:4mm;">b</div>
      ...
      <div class="styBB" style="width:187mm;height:4.5mm;">
        ...
        <div class="styLNDesc" style="width:158mm;height:4.5mm;">
          ...
          <span style="width:2px"></span><img src="{$ImagePath}/970_Bullet.gif" alt="Bullet"/>          
          <span style="width:4px;"></span>
          <span class="styUnderlineAmount" style="width:19mm; float:none;text-align:left;"/>
          <br/>
      ...
      <div style="width:187mm;">
        ...
        <div class="styIRS970LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/ClsInventoriesValuedForPriorTY" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/ClsInventoriesValuedForPriorTY" /></xsl:call-template></div>
      </div>
      <!--L6b -->
      <div style="width:187mm;height:4mm;">
        ...
        <div class="styShadingCell" style="height:3.3mm;width:10mm;"></div>
        <div class="styShadingCell" style="height:3.3mm;width:10mm;"></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/BegngInventoryValuedForFirstTY" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/BegngInventoryValuedForFirstTY" /></xsl:call-template></div>
      </div>
      <div style="width:187mm;height:4mm;">
      ...
      <div style="width:187mm;">
        ...
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/AdjIncludedInIncomeOver3Years" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/AdjIncludedInIncomeOver3Years" /></xsl:call-template></div>
      </div>
      <!--L6c Row 2 -->
      <div style="width:187mm;height:4mm;">
        <div class="styLNLeftNumBoxSD" style="padding-top:0mm;padding-left:4mm;"></div>
      ...
      <div style="width:187mm;height:3mm;">
        <div class="styGenericDiv" style="width:166mm;"></div>
        <div class="styShadingCell" style="height:100%;width:10mm;"></div>
        <div class="styShadingCell" style="height:100%;width:10mm;"></div>
      </div>
      <!--L7a -->
      <div style="width:187mm;">
        ...
        <div class="styShadingCell" style="height:3.3mm;width:10mm;"></div>
        <div class="styShadingCell" style="height:3.3mm;width:10mm;"></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/ItemAGoodsTreatedAsAcquired" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/ItemAGoodsTreatedAsAcquired" /></xsl:call-template></div>
      </div>
      <!--L7b -->
      <div style="width:187mm;height:4mm;">
      ...
      <div style="width:187mm;">
        ...
        <div class="styShadingCell" style="height:6mm;width:10mm;"></div>
        <div class="styShadingCell" style="height:6mm;width:10mm;"></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/CrStatementsOrReportsIssued" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:3.2mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/CrStatementsOrReportsIssued" /></xsl:call-template></div>
      </div>
      <!--L8b -->
      <div style="width:187mm;height:4mm;">
        <div class="styLNLeftNumBoxSD" style="padding-top:0mm;padding-left:4mm;">b</div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/InventoryNotTakenAtActualCost" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:4.5mm;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/InventoryNotTakenAtActualCost" /></xsl:call-template></div>
      </div>
      <!--L9b -->
      <div style="width:187mm;height:4mm;">
        <div class="styLNLeftNumBoxSD" style="padding-top:0mm;padding-left:4mm;">b</div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styShadingCell" style="height:9.5mm;width:10mm;"></div>
        <div class="styShadingCell" style="height:9.5mm;width:10mm;"></div>
        <div class="styIRS970LNYesNoBox" style="height:4mm;border-bottom-width:0px;"><xsl:call-template name="PopulateYesBoxText"><xsl:with-param name="TargetNode" select="$Form970/Sect14724AdjustmentAgreement" /></xsl:call-template></div>
        <div class="styIRS970LNYesNoBox" style="height:4mm;border-bottom-width:0px;"><xsl:call-template name="PopulateNoBoxText"><xsl:with-param name="TargetNode" select="$Form970/Sect14724AdjustmentAgreement" /></xsl:call-template></div>
      </div>
      <!--L10b -->
      ...
      <div class="styBB" style="width:187mm;padding-top:.5mm;">  
        <div style="float:left;">Form 970 (Rev. 12-2005)<span style="width:100mm;"></span></div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styUnderlineAmount" style="width:54mm;text-align:left;">
            <xsl:call-template name="PopulateText">
        ...
        <div class="styGenericDiv" style="font-weight:bold;width:14mm;">
          <span>
            ...
            <input type="checkbox" class="styCkbox" name="Checkbox">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/TenPercentMethod" />
                <xsl:with-param name="BackupName" select="IRS970TenPercentMethod" />
              </xsl:call-template>
            </input>
          </span>
          <label>
        ...
        <div class="styGenericDiv" style="font-weight:bold;width:14mm;padding-top:3mm;">
          <span>
            ...
            <input type="checkbox" class="styCkbox" name="Checkbox">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/CnsntChgValuingInventoriesMthd" />
                <xsl:with-param name="BackupName" select="IRS970CnsntChgValuingInventoriesMthd" />
              </xsl:call-template>
            </input>
          </span>
          <label>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<!-- set to separated, then a message is displayed indicating that the data is in an additional data table.              -->
		...
		<xsl:choose>
			...
			<xsl:otherwise>
			<tr>
		          <td style="width:4.9mm;height:8mm;font-size:7pt;font-family:Verdana;border-right:1px solid black;border-bottom:1px solid lightgrey;text-align:center;border-left:0px;padding-top:4mm;"> <span class="styTableCellPad"></span>	
		          </td>
	...
	<xsl:template match="/">
				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right; width: 186mm;">651105</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="width: 186mm;">
							   ...
							   <xsl:call-template name="PopulateCheckbox">
					              <xsl:with-param name="TargetNode" select="$FormData/AmmendedK1"/>
								       ...
								       <span style="vertical-align: bottom;">Ammended K-1</span>
								     </label>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="width: 93mm;">
										<div style="width: 93mm;">
											...
											<div class="styTY" style="float: right; clear: none; padding-right: 2mm;">20<span class="styTYColor">06</span>
											</div>
											<!-- 2006 -->
										</div>
									</td>
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2006, or tax <br/>year beginning
        ...
        <br/>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 9mm;">
										<!-- Line C -->
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 6mm;  padding-top: 0mm;">
										<!-- Line D -->
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 6mm; padding-bottom: 0px; border-top: 0pt;  padding-top: 0mm;">
										<!-- Line E -->
										<div style="float: left; clear: none;">
											<span style="font-weight: bold; width: 2mm;">E</span>
											<span style="width: 1mm;"/>
											<span style="width: 56mm;">
												<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="$FormData/TaxShelterRegistration"/>
													</xsl:call-template>
												</input>
												<label>
										        <xsl:call-template name="PopulateLabel">
										          <xsl:with-param name="TargetNode" select="$FormData/TaxShelterRegistration" />
										          <xsl:with-param name="BackupName">IRS1065ScheduleK1TaxShelterRegistration</xsl:with-param>
										        </xsl:call-template>
								             Tax shelter registration number, if any
								          </label>
                         </span>
										</div>
										<span style="border-bottom: 1px solid black; width:27mm;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/TaxShelterRegistration/@note"/>
												</xsl:call-template>
										</span>
							    </td>
								</tr>
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 6mm; border-top: 0pt; padding-top: 0mm;">
										<!-- Line F -->
										<div style="float: left; clear: none;">
											<span style="font-weight: bold; width: 2mm;">F</span>
											<span style="width: 1mm;"/>
											<span style="width: 80mm;">
												<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="$FormData/Form8271Attached"/>
													</xsl:call-template>
												</input>
												<label>
										        <xsl:call-template name="PopulateLabel">
										          <xsl:with-param name="TargetNode" select="$FormData/Form8271Attached" />
										          <xsl:with-param name="BackupName">IRS1065ScheduleK1Form8271Attached</xsl:with-param>
										        </xsl:call-template>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height:10mm;">
										<!-- Line I -->
										<div style="float:left;clear:none;">
											<span style="font-weight: bold; width: 2mm;height:8mm;">I</span>
											<span style="width: 1mm;"/>
											<span style="width: 40mm;height:8mm;">
								             ...
								             General partner or LLC<br /><span style="width:5mm;" />member-manager
								          </label>
											</span>
										</div>
										<div style="float:right;clear:all;">
											<span style="width: 50mm;height:8mm;">
								             ...
								             Limited partner or other LLC<br /><span style="width:5mm;" />member
								          </label>
											</span>
										</div>
									</td>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 4mm;border-top-width:0;">
										<!-- Line J-->
										<div style="float:left;clear:none;">
											<span style="font-weight: bold; width: 2mm;height:4mm;">J</span>
											<span style="width: 1mm;"/>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<span style="width: 3mm;"/>What type of entity is this partner?
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<span style="width: 3mm;"/>Partner’s share of profit, loss, and capital:
									    <xsl:call-template name="SetFormLinkInline">
                         <xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital"/>
                    </xsl:call-template>
										<br />
										<table style="font-size:7pt;margin-left:5mm;" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <tr>
   						<th></th>
                       <th style="width:36mm;">Beginning</th>
                       <th style="width:36mm;">Ending</th>
                     </tr>
                     <tr>
                       ...
                       <td style="border:1px black solid;border-top:0px;border-left:0;font-size:6pt" align="right">%
         					  <span style="width:16mm;text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfProfitBOY"/>
								</xsl:call-template>
							</span>
                  </td>
                  <td style="border:1px black solid;border-top:0px;border-left:0;text-align:right;font-size:6pt">%
                  	<span style="width:32mm;text-align:right;font-size:6pt">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfProfitEOY"/>
								</xsl:call-template>
							</span>
							</td>
              </tr>          
                  <tr>
                    ...
                    <td style="border:1px black solid;border-top:0px;border-left:0;font-size:6pt" align="right">%
         				  <span style="width:16mm;text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfLossBOY"/>
								</xsl:call-template>
							</span>
                 </td>
                 <td style="border:1px black solid;border-top:0px;border-left:0;text-align:right;font-size:6pt">%
                 	<span style="width:32mm;text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfLossEOY"/>
								</xsl:call-template>
							</span>
							</td>
                </tr>       
                 <tr>
                   ...
                   <td style="border:1px black solid;border-top:0px;border-left:0;font-size:6pt" align="right">%
         			  <span style="width:16mm;text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfCapitalBOY"/>
								</xsl:call-template>
							</span>
                 </td>
                 <td style="border:1px black solid;border-top:0px;border-left:0;text-align:right;font-size:6pt">%
                 	<span style="width:32mm;text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfCapitalEOY"/>
								</xsl:call-template>
							</span>
							</td>
                    </tr>   
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 12mm;border-top-width:0;">
										<!-- Line M -->
										<span style="font-weight: bold;">M</span>
										<span style="width: 3mm;"/>Partner’s share of liabilities at year end:
										<xsl:call-template name="SetFormLinkInline">
                                    ...
                                    <span style="width:8px;"/>.
														...
														<td>
														<span style="font-size:7pt;">$</span><span style="width: 33mm; border-bottom: 1px solid black; text-align: right; font-size:7pt;">
															<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 40mm;border-bottom:1px solid black;">
										<!-- Line N -->
										<span style="font-weight: bold;">N</span>
										<span style="width: 3mm;"/>Partner’s capital account analysis:<br/>
						...
						<br/>		
				             ...
				             <span style="vertical-align: bottom;padding-right:3mm;">Tax basis</span>
								  </label>
					            ...
					            <xsl:call-template name="PopulateCheckbox">
					             ...
					             <span style="vertical-align: bottom;padding-right:3mm;">GAAP</span>
								  </label>
				             ...
				             <span style="vertical-align: bottom;padding-right:3mm;">Section 704(b) book</span>
								  </label><br/>
				             ...
				             <span style="vertical-align: bottom;padding-right:3mm;">Other (explain)</span>
								  </label>
								</td>
								</tr>
								</table>
						...
						<td width="93mm" style="width: 93mm;" valign="top">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Other net rental income (loss)</span>
														<br/>
							...
							<!-- Line 4 -->
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 7pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Guaranteed payments</span><br/>
							...
							<!-- Line 5 -->
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 7pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Interest income</span><br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
											...
											<tr>												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
							<!-- Line 6a -->
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;height:3.5mm">6a</span>
														<span style="font-size: 7pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Ordinary dividends</span><br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm">
															<xsl:call-template name="PopulateAmount">
						...
						<!-- Line 6b -->
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 7pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Qualified dividends</span><br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm">
															<xsl:call-template name="PopulateAmount">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 7pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Royalties</span><br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm">
															<xsl:call-template name="PopulateAmount">
					...
					<!-- Line 8 -->
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Net short-term capital gain (loss)</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm">
															<xsl:call-template name="PopulateAmount">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight"  style="height:4mm;">
													<!-- Line 9a -->
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;height:3.5mm">9a</span>
														<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Net long-term capital gain (loss)</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm">
															<xsl:call-template name="PopulateAmount">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													<!-- Line 9b -->
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;height:3.5mm">9b</span>
														<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Collectibles (28%) gain (loss)</span><br/>
														<span class="IRS1065ScheduleK1_codeBox"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm;">
															<xsl:call-template name="PopulateAmount">
												...
												<td colspan="3" class="IRS1065ScheduleK1_tdRight"  style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align:center;height:3.5mm;">9c</span>
															<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Unrecaptured section 1250 gain</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox" />
														<span class="IRS1065ScheduleK1_amountBox" style="text-align:right;height:3.5mm;">
														<span style="float:left;padding-left:2px;">
							...
							<!-- Line 10 -->
													<div style="width: 46.5mm;">
														...
														<span style="font-size: 6pt;height:3.5mm;width:40mm;"><span style="width:1mm"/>Net section 1231 gain (loss)</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox" />
															<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;height:3.5mm;">
															<span style="float:left;padding-left:2px;">
                                           ...
                                           <td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:7pt;"><span style="width:1mm;"/>Other income (loss)</td>
												          </tr>
												...
												<xsl:for-each select="$FormData/OtherIncomeLoss/Item">												  
								                        <xsl:choose>
                 										            <xsl:when test="position() = 1">
                    													...
                    													<xsl:call-template name="PopulateAmount">
                    														<xsl:with-param name="TargetNode" select="Amount" />
                    													</xsl:call-template><span style="width:1.5mm;" />
										                               </span>
                                                                                  </td>
                                                                                  </tr>
															</xsl:when>
	                                ...
	                                <td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:7pt;"><span style="width:1mm;"/>Other deductions</td>
												          </tr>
								...
								<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:6pt;"><span style="width:1mm;"/>Self-employment earnings (loss)</td>
												          </tr>
			...
			<!-- Line 15 -->		
								...
								<tr>
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:7pt;"><span style="width:1mm;"/>Credits</td>
												          </tr>
				...
				<!-- Line 17 -->
									          ...
									          <tr>
									              ...
									              <td style="font-size:6pt;"><span style="width:0.5mm;"/>Alternative minimum tax (AMT) items</td>
									          </tr>
				...
				<!-- Line 19 -->
											<tr>											
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:7pt;"><span style="width:1mm;"/>Distributions</td>
												          </tr>
			         	...
			         	<tr>											
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												          ...
												          <tr>
												              ...
												              <td style="float:left;font-size:7pt;"><span style="width:1mm;"/>Other information</td>
												          </tr>
         		   ...
         		   * See attached statement for additional information.
								...
								<tr>
									<td colspan="2" style="height:100%;height:45mm;border-bottom:2px solid black;">
										<!-- IRS Use Only box -->
					...
					<tr>
						<td width="189mm" colspan="2" style="width: 189mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 2px solid black;">
							<span style="width: 116mm;">For Privacy Act and Paperwork Reduction Act Notice, see Instructions for Form 1065.</span>
							<span style="font-weight: normal; width: 31mm;">Cat. No. 11394R</span>
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2006</span>
						</td>
					</tr>
				</table>

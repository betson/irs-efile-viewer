...
<div style="width:187mm;">
  <div style="width:122mm;float:left;"></div>
    <div class="styLNCtrNumBox" style="width:11.5mm;border-top-width:1px;border-right-width:0px;">Code</div>
  <div class="styLNCtrNumBox" style="width:53mm;border-top-width:1px;border-right-width:0px;">Description</div>
</div>
<div style="width:187mm;">
  <div class="styLNLeftLtrBox" style="height:4.5mm;">c</div>
    ...
    <div class="styLNCtrNumBox" style="width:11.25mm;border-top-width:0px;border-right-width:0px;font-weight:normal;">
    <xsl:call-template name="PopulateText">
    ...
    <div class="styLNCtrNumBox" style="width:53mm;border-top-width:0px;border-right-width:0px;
                                                                  font-weight:normal;text-align:left;padding-left:1mm">
...
<div class="styBB" style="width:187mm;">
  <div class="styLNLeftLtrBox" style="height:4.5mm;">d</div>
    ...
    <div class="styLNCtrNumBox" style="width:11.5mm;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;font-weight:normal">
        
        <xsl:call-template name="PopulateText">
        <xsl:with-param name="TargetNode" select="$Form5713Data/PrincipalProductCode"/>
      </xsl:call-template>
    </div>
  <div class="styLNCtrNumBox" style="width:36mm;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;font-weight:normal;text-align:left;padding-left:1mm">
        ...
        <tbody>
          <xsl:for-each select="$Form5713Data/BoycottRequestsAndAgreements">
            <tr>
              ...
              <td class="styDepTblCell" style="text-align:center,background-color:yellow;" nowrap="nowrap">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="MaxSize" select="12" />          
                  <xsl:with-param name="TargetNode" select="TotalNumberOfBoycottAgreements"/>
                </xsl:call-template>

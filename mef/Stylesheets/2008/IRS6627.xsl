        ...
        <form name="Form6627">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:21mm;padding-top:2mm;">
              ...
              <br/>      
              <span class="styAgency" style="font-weight:normal;padding-top:1.5mm;">(Rev. January 2007)<br/> Department of the Treasury</span><br /><span class="styAgency" style="font-weight:normal;padding-top:1.5mm;">Internal Revenue Service</span>
            </div>
          ...
          <div style="width:187mm">
            <table cellpadding="0" cellspacing="0" style="width:187mm;border-color:black;font-size:7pt">
              <tbody>
                <tr>
                  <th class="styTableCell" style="width:98mm;border-right-width:0px">
                  ...
                  <th class="styTableCell" style="width:18mm;font-weight:bold;text-align:center">
                    (b)<br />Rate
                  </th>
                  <th class="styTableCell" style="width:40mm:font-weight:bold;border-right-width:0;text-align:center">
                    (c)<br />Tax
                  </th>
                </tr>
                <tr style="padding-top:1mm">
                  <td class="styTableCell" style="width:98mm;border-right-width:0px;text-align:left">
                    ...
                    <div class="styDotLn" style="width:38mm;height:5mm;clear:none;padding-top:1mm">..........</div>
                  </td>
                  <td class="styTableCell" style="width:31mm;border-left-width:1px;padding-right:1mm">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$FormData/USRefineryBarrels"></xsl:with-param>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:18mm;background-color:lightgrey;text-align:center"><span style="width:1px" /></td>
                ...
                <tr style="padding-top:1mm">
                  <td class="styTableCell" style="width:98mm;border-right-width:0px;text-align:left">
                    ...
                    <div class="styDotLn" style="width:27mm;height:5mm;clear:none;padding-top:1mm;padding-left:3mm">........</div>
                  </td>
                  <td class="styTableCell" style="width:31mm;border-left-width:1px;padding-right:1mm">
                    <xsl:call-template name="PopulateAmount">
                  ...
                  <td class="styTableCell" style="width:18mm;background-color:lightgrey"><span style="width:1px" /></td>
                  <td class="styTableCell" style="width:40mm;background-color:lightgrey"><span style="width:1px" /></td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCell" style="width:31mm;border-left-width:1px;padding-right:1mm;padding-top:4mm">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$FormData/TaxableCrudeOil/TaxableCrudeOilBBL"></xsl:with-param>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:18mm;text-align:center;padding-top:4mm">
                ...
                <tr>
                  ...
                  <td class="styTableCell" style="width:31mm;border-left-width:1px;padding-right:1mm;padding-top:7mm">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$FormData/USCrudeB4Tax/USCrudeB4TaxBBL"></xsl:with-param>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:18mm;text-align:center;padding-top:7mm">
                    <span style="padding-left:2mm;float:left;clear:none">$</span>
                    <xsl:call-template name="PopulateText">
                ...
                <tr>
                  ...
                  <td class="styTableCell" style="width:31mm;border-left-width:1px;padding-right:1mm;padding-top:10mm">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$FormData/ImprtOilSpillTax/ImprtOilSpillTaxBBL"></xsl:with-param>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:18mm;text-align:center;padding-top:10mm">
                    <span style="padding-left:2mm;float:left;clear:none">$</span>
                    <xsl:call-template name="PopulateText">
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  ...
                  <th style="width=33mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(b) <br/>Number of pounds<br/></th>
                  <th style="width=45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(c) <br/>Tax per pound<br/>(see Part II instructions)<br/></th>
                  <th style="width=45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(d) <br/>Tax (multiply column (b) <br/>by column (c))<br/>
                  </th>
                </tr>
            ...
            <table class="styTable" cellspacing="0" cellpadding="0">
              <tbody>
                <tr style="height:12mm">
                  <th class="styTableCellHeader" style="width:58mm;font-weight:bold;border-color:black">(a)<br />Imported product and the<br />applicable ODC</th>
                  <th class="styTableCellHeader" style="width:23mm;font-weight:bold;border-color:black">(b)<br />Number of<br />products</th>
                  <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black">(c)<br />ODC weight of<br />product</th>
                  <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black">(d)<br />Tax per pound</th>
                  <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black">(e)<br />Entry value</th>
                  <th class="styTableCellHeader" style="width:28mm;font-weight:bold;border-color:black;border-right-width:0px">(f)<br />Tax<br />(see Part III instructions)</th>
                </tr>
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>							
                  ...
                  <th style="width:33mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(b) <br/>Number of pounds<br/></th>
                  <th style="width:45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(c) <br/>Tax per pound<br/>(see Part IV instructions)<br/></th>
                  <th style="width:45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(d) <br/>Tax (multiply column (b) <br/>by column (c))<br/></th>
                </tr>
              ...
              <table class="styDepTbl" style="font-size:7pt;border-collapse:collapse;">
                <thead class="styTableThead">
                  <tr class="styDepTblHdr">
                    <th class="styDepTblCell" colspan= "2" style="width=64mm;height:12mm;font-size:8pt;border-top:1px black solid;">(a)<br/>ODC<br/></th>
                    <th class="styDepTblCell" style="width=33mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(b) <br/>Number of pounds<br/></th>
                    <th class="styDepTblCell" style="width=45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(c) <br/>Tax per pound<br/>(see Part II instructions)<br/></th>
                    <th class="styDepTblCell" style="width=45mm;height:12mm;border-left:1px black solid;border-bottom:1px black solid;border-top:1px black solid;">(d) <br/>Tax (multiply column (b) <br/>by column (c))<br/>
                    </th>
                  </tr>
                </thead>
                <tbody>
              ...
              <table class="styDepTbl" style="font-size:6pt">
                <thead class="styTableThead">
                  <tr class="styDepTblHdr" style="height:12mm">
                    <th class="styTableCellHeader" style="width:58mm;font-weight:bold;border-color:black;color:white">(a)<br />Imported product and the<br />applicable ODC</th>
                    <th class="styTableCellHeader" style="width:23mm;font-weight:bold;border-color:black;color:white">(b)<br />Number of<br />products</th>
                    <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black;color:white">(c)<br />ODC weight of<br />product</th>
                    <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black;color:white">(d)<br />Tax per pound</th>
                    <th class="styTableCellHeader" style="width:26mm;font-weight:bold;border-color:black;color:white">(e)<br />Entry value</th>
                    <th class="styTableCellHeader" style="width:28mm;font-weight:bold;border-color:black;color:white;border-right-width:0px">(f)<br />Tax<br />(see Part III instructions)</th>	
                  </tr>
                </thead>
                <tbody>
                  <xsl:for-each select="$FormData/IRS19">

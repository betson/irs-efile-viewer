    ...
    <table id="ItemizedOtherAssetsTbl" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          ...
          <th class="styDepTblCell" scope="col">Other Assets Description</th>
        ...
        <tfoot></tfoot>
        <tbody>
        <xsl:for-each select="$DependencyData/ItemizedOtherAsset">  
          <tr>
            ...
            <td class="styDepTblCell" scope="col"  style="text-align:left;font-size:7pt;width:35mm;">
              <xsl:attribute name="rowspan">
                <xsl:value-of select="count(OtherAssetLineItem)"/>
              </xsl:attribute>
            ...
            <xsl:for-each select="OtherAssetLineItem">

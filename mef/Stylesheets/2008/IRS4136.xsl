...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <html>
      ...
      Department of the Treasury Internal Revenue Service
            ...
            <div class="styIRS4136TYBox" style="height: 25mm;">
              ...
              <div class="styIRS4136TY">20<span class="styTYColor">08</span>
              </div>
 ...
 <br/>
  ...
  Claimant certifies that the kerosene did not contain visible evidence of dye.
    ...
    Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2008)
  </div>
          </div>
          <div class="pageEnd"/>
          <!--END FOOTER-->
          ...
          <div class="styBB" style="width:187mm">
            <div style="float: left; clear: none">Form 4136 (2008)</div>
            <div style="float:right">
   ...
   .218/.043*</td>
    ...
    .001</td>
        ...
        <span class="styIRS4136TableCellPad"/>
          ...
          *This rate applies after March 31, 2009.</div>
          <!--   END LINE 5   -->
          <!--   BEGIN BLOCK 6   -->
          <!--   BEGIN LINE 6   -->
...
of the buyer to make the claim. Claimant certifies that the kerosene did not contain visible evidence of dye.
  ...
  <div style="width:182mm;border:solid black 1; border-top-width:0px;border-right-width:0px;border-left-width:0px;float:right;clear:none;">-->
    ...
    by the claimant.
            ...
            <table class="styIRS4136Table" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="styIRS4136TableCellB" style="text-align: center">$ .51/.45*</td>
                  <td class="styIRS4136TableCellC">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="9"/>
          ...
          <div style="width:187mm;height:2mm;padding-left:6mm">
              *This rate applies after December 31, 2008.</div>
          <!--   END LINE 09   -->
          <!--   BEGIN LINE 10   -->
          <div class="styIRS4136NumLine" style="float: none; clear: both">
            <br/>
  ...
  <div style="width:182mm;border:solid black 1; border-top-width:0px;border-right-width:0px;border-left-width:0px;float:right;clear:none;">-->
      ...
      diesel with diesel fuel (other than renewable diesel). The renewable diesel used to produce the renewable
      diesel mixture was derived from biomass (as defined in section 45K(c)(3)) using a thermal 
      depolymerization process, met EPA’s registration requirements for fuels and fuel additives, and met 
      ASTM D975 or D396. The mixture was sold by the claimant to any person for use as a fuel or was used 
      ...
      4136. See the instructions for line 10 for details.
   </div>
          <!--</div>-->
          <div style="width:187mm;float:left;clear:left;" id="UVctn">
            <table class="styIRS4136Table" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="styIRS4136TableCellB" style="text-align: center">$ .50/1.00*</td>
                  <td class="styIRS4136TableCellC">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="9"/>
          ...
          $<xsl:call-template name="PopulateAmount">
                ...
                <tr>
                  ...
                  <td class="styIRS4136TableCellB" style="padding-left:4.5mm;">1.00</td>
                  <td class="styIRS4136TableCellC">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="9"/>
    ...
    <br/>-->
            ...
            <table class="styIRS4136Table" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">$ .50</td>
                  <td class="styIRS4136TableCellC">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="9"/>
          ...
          $<xsl:call-template name="PopulateAmount">
                ...
                <tr>
                  ...
                  <td class="styIRS4136TableCellB" style="padding-left:7.5mm;text-align:center:">.50</td>
                  <td class="styIRS4136TableCellC">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="9"/>
                ...
                <xsl:if test="($Print != $Separated) or (count($IRS4136Data/LiqfdGasBiomass) &lt;= 1) ">
                  <xsl:for-each select="$IRS4136Data/LiqfdGasBiomass">
                    <tr>
                      ...
                      <td class="styIRS4136TableCellB" style="padding-left:3mm;text-align:center;">.50</td>
                      <td class="styIRS4136TableCellC">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="MaxSize" select="9"/>
                          <xsl:with-param name="TargetNode" select="Gallons"/>
                ...
                <xsl:if test="($Print != $Separated) or (count($IRS4136Data/CompressedGasBiomass) &lt;= 1) ">
                  <xsl:for-each select="$IRS4136Data/CompressedGasBiomass">
                    <tr>
                      ...
                      <td class="styIRS4136TableCellB" style="padding-left:7mm;">.50</td>
                      <td class="styIRS4136TableCellC">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="MaxSize" select="9"/>
                          <xsl:with-param name="TargetNode" select="Gallons"/>
  ...
  <div style="width187mm'">
      ...
      right:1mm;border-left:1 solid black;">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:.5mm;">
            <div style="float:right">
              <span style="width:80px"/>Form <span class="styBoldText">4136</span> (2008)
  </div>
          </div>
          <!--   END FORM FOOTER   -->
          <!-- <br/>

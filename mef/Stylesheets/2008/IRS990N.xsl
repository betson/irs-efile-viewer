...
<title>
	<xsl:call-template name="FormTitle">
		<xsl:with-param name="RootElement" select="local-name($IRS990NData)"></xsl:with-param>
	</xsl:call-template>
</title>
...
<style type="text/css">
  <xsl:if test="not($Print) or $Print=''">
    <xsl:call-template name="IRS990NStyle"></xsl:call-template>  
...
<div class="styBB" style="width:187mm; height:16mm;">
  <div class="styFNBox" style="width:33mm;height:16mm; border-right-width: 2px">
    <div style="padding-top:1mm;">
      Form<span class="styFormNumber">990-N</span><br/>
   ...
   <div class="styFTBox" style="width:122mm;padding-top:2mm;">
    ...
    <div class="styFBT" style="font-size: 7pt; font-weight: normal; margin-top: 0px">
      <img src="{$ImagePath}/990N_Bullet_Sm.gif" alt="bullet"/><span style="width:1mm"></span>For Tax-Exempt Organizations not Required to File Form 990 or 990EZ.<span style="width: 5mm"></span>
    </div>
    <!--<div class="styFBT" style="font-size: 7pt; font-weight: normal; margin-top: 0px">
...
<div style="width:187mm;float:left;clear:left;">
	<div style="width:44.25mm;height:37mm;float:left;clear:left;">
       ...
       <div class="styComType" style="width:44.25mm;border-bottom:0px;"> 
            <div style="width:42mm;">
               <input type="checkbox" class="styIRS990NCkBox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$IRS990NData/Termination" />
       ...
       <div class="styComType" style="width:44.25mm;border-bottom:0px;"> 
           <div style="width:42mm;">
              <input type="checkbox" class="styIRS990NCkBox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$IRS990NData/GrossReceipts25000OrLess" />
                  <xsl:with-param name="BackupName">IRS990NGrossReceipts25000OrLess</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
              	<xsl:call-template name="PopulateLabel">
	   ...
	   <!--Box B End-->    
          ...
          <!-- Box E -->
        	<div style="width:44.25mm;border-top:2px solid black;border-bottom:0px solid white; ">
        		<span class="styBoldText" style="width:4mm;">E </span>Website Address: <br/>
          		...
          		<span style="text-align: left; width:33mm">
   	 				...
   	 				<xsl:with-param name="TargetNode" select="$IRS990NData/WebsiteAddress"/>
    		 		</xsl:call-template>
    	    		</span>
         	</div>
         </div>
        ...
        <!--Box C -->
        	<div class="styLblNameAddr" style="width:98mm;height:28mm;border-bottom-width: 0px;">
        ...
        <!-- Box D -->
        <div class="styEINDateAssets" style="width:43mm;height:4.5mm;border-top-width: 1px"><span class="styBoldText">D Employer ID number</span><br /><br /><span style="width: 3mm"></span><span class="styEINFld" style="">
          <xsl:call-template name="PopulateReturnHeaderFiler">
	...
	<!--Box F -->
       ...
       <div class="styNameAddr" style="width:98mm;height:8mm;border-left-width:0px;border-top-width:None;">
            ...
            <span class="stySmallText" style="padding-left:2mm;">
            <xsl:choose>
			<xsl:when test="$IRS990NData/PersonName">
            			<xsl:call-template name="PopulateText">
   	 				<xsl:with-param name="TargetNode" select="$IRS990NData/PersonName"/>
    		  		</xsl:call-template>
    	    		 </xsl:when>
    	    		 <xsl:otherwise>
                		<xsl:call-template name="PopulateText">
          ...
          <div class="styNameAddr" style="width:98mm;height:10mm;border-left-width:0px;">
            <span style="width: 96.5mm; height: 10mm">
              ...
              <span class="stySmallText" style="width: 96.5m;padding-left:2mm;">
              	<xsl:if test="$IRS990NData/AddressUS">
                  		<xsl:call-template name="PopulateText">
                    		<xsl:with-param name="TargetNode" select="$IRS990NData/AddressUS/AddressLine1"/>
                  		</xsl:call-template>
                  		<xsl:if test="normalize-space($IRS990NData/AddressUS/AddressLine2)!=''">    
                    		<br />
                    		<xsl:call-template name="PopulateText">
                      			<xsl:with-param name="TargetNode" select="$IRS990NData/AddressUS/AddressLine2"/>
                    		</xsl:call-template>          
                  		</xsl:if>
                	</xsl:if>
                	<xsl:if test="$IRS990NData/AddressForeign">
                  		<xsl:call-template name="PopulateText">
                    		<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/AddressLine1"/>
                  		</xsl:call-template>
                  		<xsl:if test="normalize-space($IRS990NData/AddressForeign/AddressLine2)!=''">    
                    		<br />
                    		<xsl:call-template name="PopulateText">
                      			<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/AddressLine2"/>
                    		</xsl:call-template>          
                  		</xsl:if>
                	</xsl:if>
    		   </span>
              ...
              <!-- Choose between Shareholder US or Foreign Address -->
              	<xsl:if test="$IRS990NData/AddressUS">
                		<div style=" font-family:'verdana';font-size:7pt;padding-top:1mm">
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressUS/City"/>
                			</xsl:call-template>, 
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressUS/State"/>
                			</xsl:call-template><span style="width:1mm;"/> 
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressUS/ZIPCode"/>
                			</xsl:call-template>
                		</div>       
              	</xsl:if>
              	<xsl:if test="$IRS990NData/AddressForeign">
                		<div style="font-family:'verdana';font-size:7pt;">
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/City"/>
                			</xsl:call-template>,<br/>
                			<span class="stySmallText" style="padding-left:1mm;" />
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/ProvinceOrState"/>
                			</xsl:call-template>,<br/>
                			<span class="stySmallText" style="padding-left:1mm;" />
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/PostalCode"/>
                			</xsl:call-template>,<br/>
                			<span class="stySmallText" style="padding-left:1mm;" />
                			<xsl:call-template name="PopulateText">
                  				<xsl:with-param name="TargetNode" select="$IRS990NData/AddressForeign/Country"/>
                			</xsl:call-template>
                		</div>  
              	</xsl:if>
          	</div>
...
<div style="width:187mm;">
  <span style="float: right">Form <span class="styBoldText">990-N</span> (2008)</span>
</div>
<!--   END FORM FOOTER   -->

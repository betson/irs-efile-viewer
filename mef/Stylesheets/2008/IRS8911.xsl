        ...
        <body class="styBodyClass">
            <form name="Form8911">
              ...
              <div class="styBB" style="width:187mm;">
                  ...
                  </div><!-- Close right tax return header box -->
              </div><!-- Close left tax return header box -->    
               ...
               <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/TotalQualifiedPropertyCost"></xsl:with-param>
                      </xsl:call-template>
                  </div>
               </div>
    	        <div class="styBB" style="width:187mm;height:3.75mm;border-top-width:1;padding-top:1.5mm;padding-bottom:1.5mm;">
	        ...
	        <!-- L2-->
              <div style="width:187mm;">
                  <div class="styLNLeftNumBox" style="height:4.5mm;">2</div>
                      ...
                      <div class="styLNAmountBox" style="height:4.5mm;">
                          <xsl:call-template name="PopulateAmount">
                              <xsl:with-param name="TargetNode" select="$Form8911/BusInvstUsePart">
              ...
              <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/Section179ExpenseDeduction"></xsl:with-param>
                      </xsl:call-template>
                  </div>
              </div>
              <!-- L4 -->
              <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/NetBusUsePart"></xsl:with-param>
                      </xsl:call-template>
                   </div>
              </div>
              <!-- L5-->
              <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/AdjBusUsePrt"></xsl:with-param>
                      </xsl:call-template>
                   </div>
              </div>
              <!-- L6 -->
              <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/MxBusUsePrt"></xsl:with-param>
                      </xsl:call-template>
                  </div>
              </div>
              <!-- L7 -->
              <div style="width:187mm;">
	            ...
	            <div class="styLNDesc" style="width:137mm;height:4.5mm;">Enter the <span class="styBoldText">smaller</span> of line 5 or line 6
                  ...
                  <div class="styLNAmountBox" style="height:4.5mm;">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/AdjBusUsePrtOrMxBusUsePrt"></xsl:with-param>
                      </xsl:call-template>
                   </div>
              </div>
              <!-- L8 -->
              <div style="width:187mm;">
	           ...
	           <div class="styLNRightNumBox" style="height:4.5mm;">8</div>
                  <div class="styLNAmountBox" style="height:4.5mm;">
		        <xsl:call-template name="PopulateAmount">
			     <xsl:with-param name="TargetNode" select="$Form8911/FinalGulfBondCredit"></xsl:with-param>
		        </xsl:call-template>
                  </div>
              </div>
              <!-- L9 -->
              <div style="width:187mm;">
	           ...
	           <div class="styLNDesc" style="width:137mm;height:4.5mm;">
		        <span class="styBoldText">
			     Business/investment use part of credit.
		            ...
		            Add lines 7 and 8. Partnerships and S corporations, report this amount on Schedule K; all others, report this amount on Form 3800, line 1t
                     <span style="width:2px;"></span>
                     <!--Dotted Line-->
                     <span class="styBoldText">
                        <span style="width:16px"></span>.
	           ...
	           <div class="styLNAmountBox" style=";border-bottom-width:0"></div>
                  ...
                  <div class="styLNAmountBox" style="border-bottom-width:0">
                      <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="$Form8911/BusInvstUsePartOfCredit"></xsl:with-param>
                      </xsl:call-template>
                  </div>
              </div>
              <!-- Part III header -->
	       <div class="styBB" style="width:187mm;height:3.75mm;padding-top:1.5mm;padding-bottom:1.5mm;border-top-width:1">
	        ...
	        <div class="styLNDesc" style="width:137mm;height:4.5mm;">
		     Subtract line 2 from line 1. If zero, stop here; <span class="styBoldText">do not</span> file this form unless you are claiming a credit on line 9
                  <span style="width:2px;"></span>
                  <!--Dotted Line-->
                  <span class="styBoldText">
                      <span style="width:16px"></span>.
	           ...
	           <div class="styLNRightNumBox" style="height:8mm;padding-top:4mm">10</div>
		         ...
		         <xsl:call-template name="PopulateAmount">
		             <xsl:with-param name="TargetNode" select="$Form8911/PersnlUsePartOfCredit"></xsl:with-param>
		          </xsl:call-template>
                  </div>
              </div>
              <!-- L11 -->
              <div style="width:187mm;">
	            ...
	            <div class="styLNDesc" style="width:137mm;height:4.5mm;">
	             ...
	             <div class="styLNRightNumBox" style="height:4.5mm;">11</div>
                    <div class="styLNAmountBox" style="height:4.5mm;">
		           <xsl:call-template name="PopulateAmount">
			        <xsl:with-param name="TargetNode" select="$Form8911/AdjPersnlUsePrt"></xsl:with-param>
		           </xsl:call-template>
	             </div>
	        </div>
	        <!-- L12 -->
		    ...
		    <div class="styLNAmountBox" style="height:4.5mm;">
		        <xsl:call-template name="PopulateAmount">
			      <xsl:with-param name="TargetNode" select="$Form8911/MxPersnlUsePrt"></xsl:with-param>
			  </xsl:call-template>
		    </div>
	        </div>
               <!-- L13 -->
		    ...
		    <div class="styLNAmountBox" style="height:4.5mm;">
		        <xsl:call-template name="PopulateAmount">
			    <xsl:with-param name="TargetNode" select="$Form8911/AdjPersnlUsePrt-MxPersnlUsePrt"></xsl:with-param>
			  </xsl:call-template>
		     </div>
	        </div>
	        <!-- L14 R1 -->
	        <div style="width:187mm;">
		     ...
		     <div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0"></div>
	        </div>
              <!-- L14 R2-->
              <div style="width:187mm;">
                  ...
                  <div class="styLNAmountBox">
	               <xsl:call-template name="PopulateAmount">
		            <xsl:with-param name="TargetNode" select="$Form8911/RegularTaxBeforeCredits"></xsl:with-param>
	              </xsl:call-template>
                  </div>
                  <div class="styLNRightNumBoxNBB" style="width:8.25mm;height:4.5mm;background-color:gray;border-right-width:1px;padding-top:0;padding-bottom:0;"></div>
             </div>
             <!-- L15-->
	      <div style="width:187mm;">
	      ...
	      <div style="width:187mm;">
		    <div class="styLNLeftNumBox" style="height:4.5mm;">
		        <span style="width:6px;padding-left:3mm"></span>
		            a
		    </div>
		    <div class="styLNDesc" style="width:97mm;height:4.5mm;">
			 ...
			 <span class="styBoldText">
		        ...
		        <div class="styLNAmountBox" style="height:4.5mm;">
			    <!-- <xsl:call-template name="PopulateAmount">
			         <xsl:with-param name="TargetNode" select="$Form8911/CreditFromForm1040"></xsl:with-param>
			     </xsl:call-template>-->
                     </div>
		        <div class="styLNRightNumBox" style="height:4.5mm;background:gray;border-bottom-width:0"></div>
		        <div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0"></div>
	           ...
	           <div style="width:187mm;">
		        <div class="styLNLeftNumBox" style="height:4.5mm;">
			     <span style="width:6px;padding-left:3mm">b</span>
		        </div>
		        <div class="styLNDesc" style="width:97mm;height:4.5mm;">
		            Foreign tax credit
			     <span style="width:2px;"></span>
	           ...
	           <div style="width:187mm;">
		        <div class="styLNLeftNumBox" style="height:4.5mm;">
			     <span style="width:6px;padding-left:3mm">e</span>
		        </div>
		        <div class="styLNDesc" style="width:137mm;height:4.5mm;">
		        ...
		        <div class="styLNAmountBox" style="height:4.5mm;">
			     <xsl:call-template name="PopulateAmount">
			         <xsl:with-param name="TargetNode" select="$Form8911/TotalTaxCredits"></xsl:with-param>
			     </xsl:call-template>	
		        </div>
	            </div>
	            <!-- L16 -->
	            <div style="width:187mm;">
		         ...
		         <div class="styLNDesc" style="width:137mm;height:4.5mm;">
			      Net regular tax. Subtract line 15e from line 14. If zero or less, stop here; 
			      <span class="styBoldText">do not</span> file this form unless you are claiming a credit on line 9
			      <span style="width:2px;"></span>
			      <!--Dotted Line-->
			      <span class="styBoldText">
			          <span style="width:16px"></span>.
		          ...
		          <div class="styLNAmountBox" style="height:8mm;padding-top:4mm">
			       <xsl:call-template name="PopulateAmount">
			           <xsl:with-param name="TargetNode" select="$Form8911/NetRegularTax"></xsl:with-param>
			       </xsl:call-template>	
		          </div>
	             </div>
	             <!-- L17 R1-->
	             ...
	             <div style="width:187mm;">
	                 ...
	                 <div class="styLNDesc" style="width:137mm; height:4mm;">
	                     <table border="0" cellspacing="0" cellpadding="0" style="padding:0mm">
	                         <tr>
			                   ...
			                   <br/>
				            <span style="padding-left: 2mm;">form or schedule</span>
                                       <span class="styBoldText">
				                <span style="width:16px"></span>.
				                <span style="width:16px"></span>.
				                <span style="width:16px"></span>.
	                 ...
	                 <div class="styLNAmountBox">
		              <xsl:call-template name="PopulateAmount">
			           <xsl:with-param name="TargetNode" select="$Form8911/TentativeMinimumTax"></xsl:with-param>
		              </xsl:call-template>
	                 </div>
	  	      ...
	  	      <!-- L18-->
	             <div style="width:187mm;">
		          ...
		          <div class="styLNDesc" style="width:137mm;height:4.5mm;">
			       ...
			       file this form unless you are claiming a credit on line 9
			       <span style="width:2px;"></span>
				<!--Dotted Line-->
				<span class="styBoldText">
				    <span style="width:16px"></span>.
		          ...
		          <div class="styLNAmountBox" style="height:4.5mm;">
			       <xsl:call-template name="PopulateAmount">
			           <xsl:with-param name="TargetNode" select="$Form8911/AdjustedRegularTax"></xsl:with-param>
			       </xsl:call-template>	
		          </div>
	             </div>
                    <!-- L19-->
		          ...
		          <div class="styLNDesc" style="width:137mm;height:4.5mm;">
			       ...
			       <span class="styBoldText">
				    smaller
			          ...
			          of line 13 or 18 here and on Form 1040, line 54; Form 1040NR, line 49; or the appropriate line of your return. If line 18 is smaller than line 13, see instructions
			       <span style="width:2px;"></span>
				<!--Dotted Line-->
				<span class="styBoldText">
				    <span style="width:16px"></span>.
		          ...
		          <div class="styLNRightNumBox" style="height:6mm;background:gray;border-bottom-width:0"></div>
		          <div class="styLNAmountBox" style="height:6mm;border-bottom-width:0"></div>
		          <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">19</div>
		          <div class="styLNAmountBox" style="height:4.5;border-bottom-width:0">
			       <xsl:call-template name="PopulateAmount">
			           <xsl:with-param name="TargetNode" select="$Form8911/TotalPersnlUsePartOfCredit"></xsl:with-param>
			       </xsl:call-template>	
		          </div>
	              </div>
	              <!-- End of Page -->
		           ...
		           <span style="width:32mm; text-align:right;">
                     ...
                     <table class="styLeftOverTbl">
                         <xsl:call-template name="PopulateCommonLeftover">
                             <xsl:with-param name="TargetNode" select="$Form8911" /></xsl:call-template>
                     </table>
                     <!-- END Left Over Table -->  

  ...
  <xsl:template match="/">
    <html lang="EN-US">
      ...
      <xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        <xsl:with-param name="TargetNode" select="$Form1120LData/@section1291InterestIndicator"/>
      </xsl:call-template>
      <xsl:call-template name="LinkToLeftoverDataTableInline">
       ...
       -->
        ...
        <span style="width: 18mm;border-bottom:1 solid black;">
         ...
         See separate instructions.
          ...
          <!-- Form to Form Link
          <xsl:call-template name="SetFormLinkInline">
            <xsl:with-param name="TargetNode" select="$Form1120LData/IsNonlifeInsuranceCompaniesInd"/>
          </xsl:call-template>   -->
                  </label>
                </div>
                <div class="styGenericDiv">
            ...
            Schedule M-3 (Form 1120L)attached
          ...
          <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLblNameAddr" style="width:106mm;height:28mm;
      ...
      Please<br/> print<br/> or<br/> type</div>
        ...
        <!-- span class="stySmallText" style="padding-left:2mm;">
          <xsl:call-template name="PopulateReturnHeaderFiler">
          <xsl:with-param name="TargetNode">AddressLine1</xsl:with-param></xsl:call-template><br />
          <xsl:call-template name="PopulateReturnHeaderFiler">
          <xsl:with-param name="TargetNode">AddressLine2</xsl:with-param></xsl:call-template>
        </span-->
                <!-- Address -->
                <!-- USA Address -->
                <br/>
        ...
        953(c)(3)(C)
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:000mm;float:right;clear:none;">
              <!-- <div class="styLNLeftNumBox" style="height:4mm;"><span class="styBoldText" style="font-size:7pt;
    padding-left: 1.25mm">1a</span></div>
    <div class="styLNDesc" style="width:26mm;height:4mm;">
      <span class="styArialText">Gross receipts or sales</span>
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$Form1120LData/GrossReceiptsOrSales"/>
      </xsl:call-template>
    </div> -->
              <!--<div class="styLNAmountBox" style="width:30mm;border-bottom-width:1px;border-right-width:1px;height:4mm;">
    <span style="text-align:right;font-family:arial;font-size:8pt;"><xsl:call-template name="PopulateAmount">
    <xsl:with-param name="TargetNode" select="$Form1120LData/GrossReceiptsOrSales" />
    </xsl:call-template></span></div> -->
              <!--<div class="styLNDesc" style="width:35mm;height:4mm;padding-left:2mm;"><span class="styBoldText" 
    style="width:3mm;float:left;clear:none;">b</span> <span class="styArialText" style="float:left;clear:none;">
    Less returns and allowances</span></div> -->
              <!-- <div class="styLNAmountBox" style="width:28mm;text-align:right;border-bottom-width:1px;border-right-width
    :1px;height:4mm;font-family:arial;font-size:8pt;"><span style="text-align:right;"><xsl:call-template 
    name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1120LData/ReturnsAndAllowances" />
    </xsl:call-template></span></div> -->
              <!-- <div class="styLNDesc" style="width:13.25mm;height:4mm;padding-left:2mm;"><span class="styBoldText">
    c</span> Bal <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="MidSizeBullet"/></div> -->
              <!-- <div class="styLNRightNumBox" style="height:5mm;">1c</div>
    <div class="styLNAmountBox" style="height:5mm;"><xsl:call-template name="PopulateAmount">
    <xsl:with-param name="TargetNode" select="$Form1120LData/GrossReceiptsOrSalesBalance" />
      ...
      Life insurance company gross income. Add lines 1 through 7
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/NetGainLoss"/>
        </xsl:call-template>
      ...
      Deductible policyholder dividends (Schedule F, line 18e)
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/BadDebts"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
      ...
      Assumption by another person of liabilities under insurance, etc., contracts
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/Rents"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
      ...
      border-left-width:1px; border-right-width: 1px;">
              ...
              <div class="styLNAmountBox" style="width:30mm;height:4.5mm;border-top-width:1px; 
    ...
    Add lines 9 through 18
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/CharitableContributions"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
       ...
       Dividends-received deduction (Schedule A, line 16, column (c))
        <span style="width:2px;"/>
                <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/Depreciation"/>
        </xsl:call-template>  -->
                <!--Dotted Line-->
              </div>
      ...
      <!-- Form to Form Link
        <xsl:call-template name="SetFormLinkInline">
            <xsl:with-param name="TargetNode" select="$Form1120LData/Depletion" />
        </xsl:call-template>  -->
                <!--Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
   ...
   2008 special estimated tax payments<i> (Do not include on line 29f)</i>
              </div>
    ...
    Less 2008 refund applied for on Form 4466
        <span style="width:2px;"/>
              </div>
      ...
      <xsl:call-template name="PopulateAmount">
              ...
              <div class="styLNRightNumBoxNBB" style="border-bottom-width: 0px;border-right-width: 1px;border-left-width: 0px;

    ;background-color:lightgrey;height:8mm;"/>
            </div>
            <!-- line 29g -->
            <div style="width:181mm;float:right;clear:none;">
        ...
        <xsl:call-template name="LinkToLeftoverDataTableInline">
          ...
          <xsl:with-param name="Style">padding-left:2mm;</xsl:with-param>
              ...
              <div style="width:181mm;float:right;clear:none;height:4.5mm;">
                ...
                <div class="styLNDesc" style="width:21mm;height:4.5mm;">
                ...
                <div class="styGenericDiv" style="height:4.5mm;font-weight:bold;width:22.1mm;">
                  <!--xsl:call-template name="SetFormLinkInline">
          <xsl:with-param name="TargetNode" select="$Form1120LData/CreditForFederalTaxOnFuels"/>
        </xsl:call-template -->
                </div>
                <div class="styLNRightNumBox" style="height:5mm;">29h</div>
    ...
    U.S. income tax paid or withheld at source (attach Form 1042-S)
         <xsl:call-template name="SetFormLinkInline">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:92mm;height:8mm;">
               Refundable credits from Form 3800, line 19c, and Form 8827,<br/> line 8c 
         <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$Form1120LData/RefundableCredits"/>
                </xsl:call-template>
              </div>
              <div class="styLNRightNumBox" style="height:8mm;padding-top:3mm">29j</div>
              <div class="styLNAmountBox" style="height:8mm;padding-top:3mm">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form1120LData/RefundableCredits"/>
                </xsl:call-template>
              </div>
              <div class="styLNRightNumBoxNBB" style="height:8mm;border-bottom-width:1px;padding-top:3mm">29k</div>
       ...
       If line 29k is larger than the total of lines 28 and 30, enter amount overpaid
        <span class="styBoldText">
          ...
          <span style="width:16px"/>.
              ...
              <div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form1120LData/OverpaymentAmount"/>
                </xsl:call-template>
              </div>
            </div>
            <!-- line 33 -->
         ...
         Enter amount from line 32: 
          <!--span style="width:17px;vertical-align:top;"-->
              ...
              <div class="styGenericDiv" style="width:35mm;height:4mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form1120LData/CreditElect"/>
                </xsl:call-template>
              </div>
              <div class="styLNDesc" style="width:20mm;height:4mm;font-size:6pt;">
                ...
                <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$Form1120LData/Refund"/>
                </xsl:call-template>
              </div>
      ...
      <input class="styCkbox" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;">
            <tr>
              ...
              <td style="width:30mm;border-right:1 solid black;border-bottom:1 solid black;padding-left:1mm;text-align:left">
		    Date <br/>
              ...
              <td style="width:35mm;border-bottom:1 solid black;padding-left:1mm;text-align:center">Preparer's SSN or PTIN
  		  <br/>
                <xsl:call-template name="PopulateReturnHeaderPreparer">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2008)
    </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 1120-L (2008)<span style="width:148mm;"/>
            </div>
    ...
    <span class="styNormalText">(see instructions)</span>
          ...
          <table class="styTable" style="font-size:7pt;border-bottom:1 solid black;width:187mm;" cellspacing="0">
            <thead>
              <tr scope="col">
                <th class="styBB" colspan="2" style="width:84mm;border-bottom-width:0px;">
                  <div class="styPartDesc" style="width:84mm;text-align:center;">Dividends subject to proration
             
           </div>
                </th>
                <th class="styLNAmountBox" style="width:45mm;height:8mm;text-align:center;font-size:7pt;
               padding-top:1mm;font-weight:normal;border-left-width:0px;" colspan="2">
                  <b>(a)</b> Dividends received
        </th>
                <th class="styIRS1120LNPercentBox" style="height:8mm;font-size:7pt;
        padding-top:0mm;font-weight:normal;width:15mm;text-align:center;">
                  <b>(b)</b>%
      </th>
                <th class="styLNAmountBox" style="width:40mm;height:8mm;text-align:center;font-size:7pt;
       ...
       Domestic corporations, 20%-or-more-owned (other than debt-financed stock)
        ...
        Debt-financed stock of domestic and foreign corporations
                ...
                <td class="styLNAmountBox" style="width:40mm;height:5mm;vertical-align:bottom;">
                  <span style="width:1px;"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$IRS1120LScheduleA/PubUtilBelow20PrefStkDiv"/>
                  </xsl:call-template>
                </td>
    ...
    <span class="styNormalText">(section 812(d)) (see instructions)</span>
      ...
      <span style="width:2px;"/>
              <!-- Form to Form Link
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$Form1120LData/AdditionalSection263ACosts"/>
      </xsl:call-template> -->
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
      ...
      <span style="width:2px;"/>
              <!-- Form to Form Link 
      <xsl:call-template name="SetFormLinkInline">
        <xsl:with-param name="TargetNode" select="$Form1120LData/OtherCosts"/>
      </xsl:call-template>-->
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"/>.
    ...
    Subtract line 15 from line 14 
       ...
       <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNAmountBoxNBB" style="height:5mm;border-top-width:1px;border-rieght-width:1px">
              <xsl:call-template name="PopulateText">
   ...
   Company share of net investment income. Subtract line 29 from line 28 
       ...
       <span class="styBoldText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNAmountBox" style="height:4.5mm;text-align:center;border-top-width:1px">
              <xsl:call-template name="PopulateText">
       ...
       <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNRightNumBoxNBB" style="height:4.5mm;">33</div>
            <div class="styLNAmountBoxNBB" style="height:4.5mm;text-align:center">
              <xsl:call-template name="PopulateText">
    ...
    policies as defined in section 805(a)(4)(F). Multiply line 13 by line 33
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2008)
       ...
       (a) </span> Annuity</div>
            <div class="styLNAmountBox" style="height:8mm;width:32mm;text-align:center;border-bottom-width:2px">
              <span class="styBoldText">
        (b) </span> Group life<br/> insurance</div>
            <div class="styLNAmountBox" style="height:8mm;width:32mm;text-align:center;border-bottom-width:2px">
              <span class="styBoldText">
       (c) </span> Other </div>
          </div>
       ...
       <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNAmountBox" style="height:5mm;font-size:6.0pt">(
      <xsl:call-template name="PopulateAmount">
       ...
       <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNAmountBox" style="width:40mm;border-bottom-width:1px;height:5mm;">
              <!--xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS1120LScheduleG/DepreciationScheduleA" />
      </xsl:call-template -->
              <i>$10,000,000</i>
            </div>
...
Net controlled group tentative LICTI. Subtract line 6, column (b) from line 6, column (a). Enter here and on line 11 below 
   <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNAmountBox" style="height:10mm;width:32mm;padding-top:2mm;background-color:lightgrey
      ;border-bottom-width: 0px;"/>
      ...
      Tentative small life insurance company deduction. Subtract line 14c from line 13 
       <span class="styBoldText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:126mm;height:8mm;">
      Taxpayer’s share. Divide line 10c by the total of line 6, column (a) and line 10c. If line 10c is zero or
       ...
       <span class="styBoldText">
          ...
          <span style="width:16px"/>.
            ...
            <div class="styLNRightNumBox" style="height:8mm;padding-top:4mm;border-top-width:1px">16</div>
            <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;border-top-width:1px">
              <xsl:call-template name="PopulateText">
       ...
       <span class="styBoldText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:139mm;height:4mm;">
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$IRS1120LScheduleK/Form2220Attached"/>
                  <xsl:with-param name="BackupName">IRS1120Form2220Attached</xsl:with-param>
                </xsl:call-template>
  ...
  (section 842(b)(2)(B)(i)) (see instructions)</span>
       ...
       <span class="styBoldText">
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:8mm;padding-top:4mm">2 </div>
            <div class="styLNDesc" style="width:107mm;height:8mm;padding-top:4mm">
              <span class="styBoldText">Total assets </span>(line 26)
       <span class="styBoldText">
                <span style="width:16px"/>.
          <span style="width:16px"/>.
          <span style="width:16px"/>.
   ...
   Other Information  <span class="styNormalText">(see instructions)</span>
                    ...
                    <div class="styLNDesc" style="width:42mm;height:4.5mm;">
                      ...
                      <input type="checkbox" class="styCkbox">
                        <xsl:call-template name="PopulateCheckbox">
                          ...
                          <xsl:with-param name="BackupName">IRS1120ScheduleMethodOfAccountingAccrual</xsl:with-param>
                        </xsl:call-template>
                      </input>
                      <label>
                        <xsl:call-template name="PopulateLabel">
                    ...
                    <div class="styLNDesc" style="width:42mm;height:4.5mm;padding-left:2mm">
                      ...
                      <input type="checkbox" class="styCkbox">
                        <xsl:call-template name="PopulateCheckbox">
                          ...
                          <xsl:with-param name="BackupName">IRS1120ScheduleMStockCompany</xsl:with-param>
                        </xsl:call-template>
                      </input>
                      <label>
                        <xsl:call-template name="PopulateLabel">
         ...
         or accident policies not included in life insurance reserves bears to the corporation’s total reserves (section 816 (c) )
          ...
          <!-- Form to Form Link  -->
                        <xsl:call-template name="SetFormLinkInline">
                          <xsl:with-param name="TargetNode" select="$IRS1120LScheduleM
            /TotalCorpLifeInsuranceReserves"/>
                        </xsl:call-template>
                        <span style="width:3px;"/>
                        <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
                        <span style="width:3px;"/>
       ...
       domestic corporation? (For rules of attribution, see section 267(c).)
        ...
        If “Yes,” enter name and EIN of the parent corporation.
           <span style="width:3px;"/>
                    ...
                    <div class="styShadingCell" style="width:6mm;height:8mm;border-bottom-width:0px;"/>
                    <div class="styShadingCell" style="width:6mm;height:8mm;border-bottom-width:0px;;border-right-width:1px;"/>
                  </div>
                  <!-- Line 7 -->
                  <div class="styGenericDiv" style="width:93mm;">
        ...
        Enter percentage owned
           <span style="width:3px;"/>
                    ...
                    <div class="styShadingCell" style="width:6mm;height:8mm;border-bottom-width:1px;border-bottom-width:0mm"/>
                    <div class="styShadingCell" style="width:6mm;height:8mm;border-bottom-width:1px;border-right-width:1px;border-bottom-width:0mm"/>
                  </div>
                </td>
      ...
      <!--Dotted Line-->
        ...
        <span style="width:16px"/>.
                  ...
                  <div class="styGenericDiv" style="width:93mm;">
                    <div class="styLNLeftNumBox" style="height:4.5mm;"/>
                    <div class="styLNDesc" style="width:45mm;height:4.5mm;">If "Yes," Enter: <span class="styBoldText">a </span>
                    ...
                    <div class="styLNDesc" style="width:72mm;height:7mm;font-size:6pt;">
                      <label>
                        <xsl:call-template name="PopulateLabel">
                          ...
                          <xsl:with-param name="BackupName">IRS1120ScheduleM/OLDForegoCarryback</xsl:with-param>
                        </xsl:call-template>
          ...
          <!-- xsl:call-template name="SetFormLinkInline">        
            <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/ExcessDividendsPaid"/>        
                    ...
                    padding-bottom:0mm;padding-left:5mm">b</div>
                      <div class="styLNDesc" style="width:72mm;padding-top:0mm;padding-bottom:0mm;">
                  Was the annual statement used to prepare the tax return filed with the same state?
                    ...
                    <!-- <div class="styShadingCell" style="width:6mm;height:38mm;
                   border-bottom-width:1px;border-bottom-width:0mm"/>
                    <div class="styShadingCell" style="width:6mm;height:38mm;
                    border-bottom-width:1px;border-bottom-width:0mm"/>  -->
                  </div>
                </td>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2008)
        ...
        Additional Data        
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Schedule J Line 3 - Section 1291 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTax/@section1291Indicator"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Schedule J Line 3 - Section 1291 Amount</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTax/@section1291Amount"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Schedule J Line 3 - Section 197 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTax/@section197Indicator"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Schedule J Line 3 - Section 197 Amount</xsl:with-param>
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Schedule J Line 10 - Form 8693 Approval Date</xsl:with-param>

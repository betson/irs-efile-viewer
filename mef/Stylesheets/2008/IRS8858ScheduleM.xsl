...
<html>
  <head>
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form8858SchMData)"></xsl:with-param></xsl:call-template></title>
    <!-- No Browser Caching -->
    ...
    <style type="text/css">
      <xsl:if test="not($Print) or $Print=''">
        <xsl:call-template name="IRS8858ScheduleMStyle"></xsl:call-template>        
      ...
      <!-- Names and ID's -->
        ...
        <div class="styBB" style="width:187mm;">
          <div class="styNameBox" style="width:144mm;height:8mm;font-size:7pt;">
           Name of person filing Form 8858<br/><br />
           <xsl:call-template name="PopulateText">
             <xsl:with-param name="TargetNode" select="$Form8858SchMData/NameOfPersonFilingForm8858" />
           </xsl:call-template>
          </div>
     ...
     <div class="styBB" style="width:187mm;">
       ...
       <div class="styNameBox" style="width:100mm;height:8mm;font-size:7pt;">
        Name of foreign disregarded entity<br/>
         <div style="font-family:verdana;font-size:6pt;height:12.5mm">
           <xsl:call-template name="PopulateText">
		...
		<thead class="stythead">
			<tr>
				...
				<th style="border-color:black;font-weight:normal;" class="styTablecellHeader">
					<span style="width:2px;"></span><span class="styBoldText">(b) </span> U.S. person filing this return
				</th>

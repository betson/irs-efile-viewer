 ...
 Attachment 
      ...
      <div class="styBB" style="width:187mm;">
        ...
        <div class="styNumberBox" style="height:8mm;font-size:7pt;padding-left:8mm;">
         ...
         <!-- 
          <xsl:if test="$Form8594Data/AddressOfOtherParty/City ">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form8594Data/AddressOfOtherParty/City" />
            </xsl:call-template>
          </xsl:if>,
          <span style="width:4px;"></span>
          <xsl:if test="$Form8594Data/AddressOfOtherParty/State ">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form8594Data/AddressOfOtherParty/State" />
            </xsl:call-template>
          </xsl:if>
          <span style="width:4px;"></span>
          <xsl:if test="$Form8594Data/AddressOfOtherParty/ZIPCode">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form8594Data/AddressOfOtherParty/ZIPCode" />
            </xsl:call-template>
          </xsl:if>
          -->
        </div>

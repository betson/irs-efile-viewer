...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      <br/>Internal Revenue Service
						...
						<div class="sty990ScheduleNFTBox" style="width:163mm;border-right-width:1px;height:18mm">
							<div class="styMainTitle">Liquidation, Termination, Dissolution or Significant Disposition of Assets</div>
							<span class="sty990ScheduleNFST">
								<br/>To be completed by organizations that answer "Yes" to Form 990, Part IV, lines 31 or 32 or Form 990-EZ, line 36.
    <br/>
      ...
      <br/>
       ...
       <span class="styNormalText">Complete this part if the organization answered "Yes" to Form 990, Part IV, line 31, or Form 990-EZ, line<br/> 36. Use Schedule N-1 if </span>
...
<xsl:call-template name="SetFormLinkInline">
            ...
            (($Print = $Separated) and (count($FormData/LiquidationTable/LiquidationDetail) &gt; 11)) ">
					...
					<div style="width:256mm;">
						...
						<!--<div class="styLNAmountBox"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$FormData/ForeignOilGasExtractionIncome" /></xsl:call-template></div>-->
					</div>
					<div style="width:256mm;">
...
<span style="width:16px"/>.
  ...
  Paperwork Reduction Act Notice, see the Instructions for Form 990.</div>
						<div style="width:60mm;font-weight:normal; float: left; clear: none;">Cat. No. 50087Z</div>
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;">Schedule N (Form 990 or 990-EZ) 2008</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
					<br/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left">Schedule N (Form 990 or 990-EZ) 2008</div>
          ...
          <span style="width:16px"/>.
            <span style="width:16px"/>.
             <span style="width:16px"/>.
						...
						<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">5a</div>
						<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;">
							<xsl:call-template name="PopulateYesBoxText">
...
<span style="width:16px"/>.
						...
						<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">5b</div>
						<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;">
							<xsl:call-template name="PopulateYesBoxText">
...
<span style="width:16px"/>.
 ...
 <span style="width:16px"/>.
						...
						<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">6</div>
						<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;">
							<xsl:call-template name="PopulateYesBoxText">
...
<span style="width:16px"/>.
						...
						<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">7a</div>
						<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;">
							<xsl:call-template name="PopulateYesBoxText">
 ...
 <span style="width:16px"/>.
           ...
           <span style="width:16px"/>.
						...
						<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">7b</div>
						<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;">
							<xsl:call-template name="PopulateYesBoxText">
...
<!--Dotted Line-->
       ...
       <span style="font-weight:normal;">Complete this part if the organization answered "Yes" to Form 990, Part IV, line 32, or Form 990-EZ, line 36. Use Schedule N-1 if additional space is needed.
  </span>
							</div>
							<!--==============================Part II Table ======================================-->
...
<span style="font-weight:normal;border-top-width:1px;padding-top:1mm;border-bottom-width:1px;border-right-width:0px;padding-left:2mm;border-top-width:1px">
 Complete this part to provide the information required by Part I, lines<br/>
2e, 7c; or Part II, line 2e; and any additional information.</span>
						</div>
						<xsl:variable name="pos" select="position()"/>
						<xsl:if test="(position() mod 5)=1">
							<span style="float:right">
								<xsl:call-template name="SetDynamicTableToggleButton">
									<xsl:with-param name="TargetNode" select="$FormData/ExplanatoryText"/>
								...
								<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
									...
									<tbody valign="top">
										...
										<tr>
											<td class="styTableCell" style="border-right-width: 0px; width:187mm;text-align:left ">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ExplanatoryText[$pos + 1]"/>
												</xsl:call-template>
											</td>
										</tr>
										<tr>
											<td class="styTableCell" style="border-right-width: 0px; width:187mm;text-align:left ">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ExplanatoryText[$pos + 2]"/>
												</xsl:call-template>
											</td>
										</tr>
										<tr>
											<td class="styTableCell" style="border-right-width: 0px; width:187mm;text-align:left ">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ExplanatoryText[$pos + 3]"/>
												</xsl:call-template>
											</td>
										</tr>
										<tr>
											<td class="styTableCell" style="border-right-width: 0px; width:187mm;text-align:left ">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ExplanatoryText[$pos + 4]"/>
												</xsl:call-template>
											</td>
										</tr>
									</tbody>
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule N (Form 990 or 990-EZ) 2008</span>
						</div>
					</div>
					<!--END Page Footer-->
					<br/>

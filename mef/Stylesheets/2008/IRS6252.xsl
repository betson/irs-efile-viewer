        ...
        <form name="Form6252">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNAmountBox" style="border-bottom-width:1px;border-right-width:1px;text-align:center;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form6252Data/DateAcquired"/>
                </xsl:call-template>
              </div>
              <div class="styLNDesc" style="width:62.75mm;padding-left:14mm;">
                <span class="styBoldText">b</span> Date sold (month, day, year) 
                  <img src="{$ImagePath}/6252_Bullet.gif" alt="Bullet Image"/>
                <br/>
              </div>
              <div class="styLNAmountBox" style="border-bottom-width:1px; border-right-width:1px;text-align:center;">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;">
              ...
              <div style="float:right;clea:none;">
                ...
                <div class="styLNRightNumBoxNBB" style="width=8.25mm;background-color:lightgrey;border-right-width:1px;padding-top:4mm;height:8.5mm;"/>
            ...
            <div style="width:187mm;">
              ...
              <div style="float:right;clear:none;">
                ...
                <div class="styLNRightNumBoxNBB" style="width=8.25mm;background-color:lightgrey;border-right-width:1px;height:4.5mm;"/>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNAmountBox" style="width:32mm;height:4.5mm;border-bottom-width:1px;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNRightNumBoxNBB" style="width:8.25mm;background-color:lightgrey;height:8mm;padding-top:4mm;border-right-width:1px;"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">
              ...
              <label>
                ...
                <span style="float:left;width:12px;"/>marketable securities).  If this box is checked, enter the date of disposition (month, day, year)     
                <img src="{$ImagePath}/6252_Bullet.gif" alt="Bullet Image"/>
              </label>
            </div>
            <div class="styLNAmountBox" style="width:32mm;border-bottom-width:1px; border-right-width:1px;padding-top:4mm;text-align:center;">
            ...
            <div class="styLNDesc" style="width:178mm;">
              ...
              <label>
                <xsl:call-template name="PopulateLabel">
                  ...
                  It can be established to the satisfaction of the Internal Revenue Service that tax avoidance was not a principal purpose for either of
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:139mm;">
                <span style="float:left;">Total payments received by the end of your 2008 tax year (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:2mm;">
                  <span style="width:16px;"/>.
                  <span style="width:16px;"/>.
          ...
          <div style="width:187mm;">
            ...
            <span style="width:16px;"/>
            <span style="width:16px;"/>
                Form <span class="styBoldText">6252</span> (2008)
            </div>
          <br/>
          <br class="pageEnd"/>
          ...
          <!-- END Left Over Table -->
          <xsl:if test="($Print = $Separated) and (count($Form6252Data/RelatedParty) &gt;1)">
            <br/>

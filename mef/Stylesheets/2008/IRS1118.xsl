...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		<html>
            ...
            <!--xsl:call-template name="SetFormLinkInline">
              <xsl:with-param name="TargetNode" select="$Form1118Data" />
							...
							<div style="text-align:center;margin-top:2mm">For calendar year  20
        ...
        listed below. See <span class="styBoldText">Categories of Income</span> on page 1 of instructions.
        Also, see <span class="styBoldText">Specific Instructions</span> on page 5.<br/>
        Check only one box on each form.<br/>
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all amounts in U.S. dollars. See page 5 of instructions.)</span>
						</div>
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:21mm;height:27mm;" rowspan="3" scope="col">1. <span class="styNormalText">Foreign Country or U.S. Possession (Enter two-letter code from list beginning on page 11 of instructions. Use a separate line for each.)*</span>
									</th>
							...
							<tbody>
								...
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 1) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:choose>
										<xsl:when test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated)">
								...
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 2) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">B</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 3) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">C</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 4) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">D</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 5) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">E</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &lt; 6) or ((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
					...
					<div class="styBB" style="width:256mm">* For section 863(b) income, NOLS, income from RICs, and high taxed income, use a single line (see Schedule A on page 5 of the instructions). </div>
          ...
          Form <b style="font-size:8pt;">1118</b> (Rev. 12-2008)
        </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					<!--BEGIN HEADER-->
					<div class="styBB" style="width:256mm">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2008)</div>
						<div style="float:right">
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all foreign tax amounts in U.S. dollars.)</span>
           ...
           <span class="styItalicText" style="font-weight:normal">(see page 6 of instructions)</span>
          ...
          Taxes reclassified under high-tax kickout
					...
					<div style="width:256mm;">
						...
						<div class="styLNDescLandscape" style="width:184mm">Total carryover of foreign taxes (attach
          schedule showing computation in detail-see page 6 of the instructions)
          <!-- Form to Form links -->
							<xsl:call-template name="SetFormLinkInline">
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<div style="width:256mm;">
						...
						<div class="styLNDescLandscape">Enter the amount from the applicable column of Schedule J, Part I, line 11 (see page 6 of instructions). If Schedule J is <b>not</b> required
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<div style="width:256mm;">
						...
						<div class="styLNDescLandscape" style="width:184mm">Adjustments to line 8a (see page 6 of instructions)
          <!--Dotted Line-->
							<span class="styNoAudioRead" style="font-weight:bold;">
								<span style="width:16px"/>.
            <span style="width:16px"/>.
          ...
          liability (see section 26(b)) minus American Samoa economic development credit)
					...
					<div style="width:256mm;">
						...
						<div class="styLNDescLandscape">Credit limitation (multiply line 9 by line 10) (see page 6 of instructions)
          <!--Dotted Line-->
							<span class="styNoAudioRead" style="font-weight:bold;">
								<span style="width:16px"/>.
             <span style="width:16px"/>.
          ...
          <span style="font-weight:normal">(Enter amounts from Part II, line 11 for </span>each
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<!--     <div style="width:256mm;">
        <div class="styLNLeftNumBoxSD">2</div>
        <div class="styLNDescLandscape" style="width:184mm">Credit for taxes on high withholding tax interest
        ...
        <div class="styLNAmountBox"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/HighWithholdingTaxInterestTxCr" /></xsl:call-template></div>
        <div class="styShadingCell" style="height:4.5mm;"></div>
      </div>
      <div style="width:256mm;">
        <div class="styLNLeftNumBoxSD">3</div>
        <div class="styLNDescLandscape" style="width:184mm">Credit for taxes on financial services income
        ...
        <div class="styLNAmountBox"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/FinancialServicesIncomeTaxCr" /></xsl:call-template></div>
        <div class="styShadingCell" style="height:4.5mm;"></div>
      </div>
      <div style="width:256mm;">
        <div class="styLNLeftNumBoxSD">4</div>
        <div class="styLNDescLandscape" style="width:184mm">Credit for taxes on shipping income
        ...
        <div class="styLNAmountBox"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/ShippingIncomeTaxCredit" /></xsl:call-template></div>
        <div class="styShadingCell" style="height:4.5mm;"></div>
      </div>
      <div style="width:256mm;">
        <div class="styLNLeftNumBoxSD">5</div>
        <div class="styLNDescLandscape" style="width:184mm">Credit for taxes on dividends from a DISC or former DISC
        ...
        <div class="styLNAmountBox"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/DISCOrFormerDISCDividendsTaxCr" /></xsl:call-template></div>
        <div class="styShadingCell" style="height:4.5mm;"></div>
      </div>
      <div style="width:256mm;">
        <div class="styLNLeftNumBoxSD">6</div>
        <div class="styLNDescLandscape" style="width:184mm">Credit for taxes on certain distributions from a FSC or former FSC
        ...
        <div class="styLNAmountBox"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/FSCOrFormerFSCDistriTaxCredit" /></xsl:call-template></div>
        <div class="styShadingCell" style="height:4.5mm;"></div>
      </div>    -->
					<div style="width:256mm;">
						<div class="styLNLeftNumBoxSD">2</div>
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/GeneralLimitationIncomeTaxCr"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="height:4.5mm;"/>
					</div>
...
two-letter code from Schedule A, column 1. Use a separate line for each.)</span>
											...
											<xsl:for-each select="$Form1118ScheduleF/ForeignGrossIncmAndAllcblDed">
												<tr style="height:6mm;">
													...
													<td class="styTableCellSmall" style="width:39mm;text-align:left;">
														<span style="width:4px;"/>
														<xsl:call-template name="SetFormLinkInline">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleF/ForeignGrossIncmAndAllcblDed/ForeignCountryOrUSPossession"/>
														</xsl:call-template>
														<span style="width:4px;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="ForeignCountryOrUSPossession"/>
              ...
              <xsl:call-template name="SetFormLinkInline">
							...
							<div style="width:127mm;">
								...
								<div class="styIRS1118LNDescRed" style="height:8mm;">Reduction of Oil and Gas Extraction Taxes—Enter
amount from Schedule I, Part II, line 6</div>
               ...
               requires the corporation to complete Schedule F under the authority of section 905(b).
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2008)</div>
						</div>
					</div>
					<!--BEGIN HEADER-->
					<div class="styBB" style="width:256mm">
          ...
          <span class="styItalicText">
                ...
                Product line #2 <br/>(SIC Code: <xsl:call-template name="PopulateText">
									...
									<tr>
										<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-left:1mm;">1</td>
										<td class="styIRS1118LNDescRD" style="height:8mm;font-size:5pt;">Totals (see page 9 of instructions)</td>
										<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
									...
									<tr>
										...
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[1]/GrossSalesGeneralLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[1]/RDDeductionsGeneralLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[2]/GrossSalesGeneralLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[2]/RDDeductionsGeneralLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethodTotRDDedGenLmtIncm"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncomeGeneralLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncmTotRDDedGenLmtIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotRDDedGeneralLimitationIncm"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[1]/GrossSalesPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[1]/RDDeductionsPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[2]/GrossSalesPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[2]/RDDeductionsPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
										...
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncomePassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
										...
										<td class="styLNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotRDDedPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									...
									<div style="width:256mm;clear:both;">
										<table class="styTable" cellspacing="0">
											...
											<tbody>
												...
												<tr>
													<td class="styLNLeftNumBox" style="height:8mm;">3</td>
													<td class="styIRS1118LNDescRD" style="border-bottom-width:0px;height:8mm;">Appointment among statutory groupings:</td>
													<td class="styShadingCellSmall" style="height:8mm;padding-top:4mm;">
														<span style="width:4px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:8mm;padding-top:4mm;">
												...
												<tr>
													...
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossSalesGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDeductionsGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDeductionsGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDeductionsGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDeductionsGeneralLmtIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossSalesPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDeductionsPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDeductionsPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDeductionsPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styLNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDeductionsPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
                      ...
                      corresponding Schedule A.
									...
									<tbody>
										<tr>
											...
											<td class="styIRS1118LNDescDed" style="height:4.5mm;">Totals (see pages 9 and 10 of instructions)</td>
...
and 1d from line 1a)</td>
										...
										<tr>
											...
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AvgAstValNonfinclGenLmtIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AvgAstValFinclGenLmtIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/IntDedNonfinclGenLmtIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/IntDedFinclGenLmtIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OthNotAllcblDedGeneralLmtIncm"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalsGeneralLimitationIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
										</tr>
										<tr>
											...
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AvgAstValFinclPassiveIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/IntDedNonfinclPassiveIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/IntDedFinclPassiveIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
											...
											<td class="styLNAmountBoxSmall" style="height:4.5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalsPassiveIncome"/>
												</xsl:call-template>
												<span style="width:1px;"/>
											</td>
										</tr>
								...
								<div style="width:256mm;clear:both;">
									<table class="styDepTblLandscape" cellspacing="0" style="font-size:6pt;">
										...
										<tbody>
											...
											<tr class="styDepTblRow1">
												<td class="styLNLeftLtrBoxBB">c</td>
												<td class="styIRS1118LNDescRD">High withholding tax interest</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GrossSalesHighWthldTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="RDDedHighWitholdingTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesHighWthldTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDedHighWitholdingTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesHighWthldTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDedHighWitholdingTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesHighWthldTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDedHighWitholdingTaxInterest"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
											</tr>
											<tr class="styDepTblRow2">
												<td class="styLNLeftLtrBoxBB">d</td>
												<td class="styIRS1118LNDescRD">Financial services income</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GrossSalesFinancialSrvcIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="RDDedFinancialServicesIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesFinancialSrvcIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDedFinancialServicesIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesFinancialSrvcIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDedFinancialServicesIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesFinancialSrvcIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDedFinancialServicesIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
											</tr>
											<tr class="styDepTblRow1">
												<td class="styLNLeftLtrBoxBB">e</td>
												<td class="styIRS1118LNDescRD">Shipping income</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GrossSalesShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="RDDeductionsShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDeductionsShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDeductionsShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:4.5mm">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDeductionsShippingIncome"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
											</tr>
											<tr class="styDepTblRow2">
												<td class="styLNLeftLtrBoxBB" style="height:8mm;">f</td>
												<td class="styIRS1118LNDescRD" style="height:8mm;">Taxable income attributable to foreign trade income</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GrossSalesForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="RDDedForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/GrossSalesForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 1]/RDDedForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/GrossSalesForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 2]/RDDedForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/GrossSalesForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLineGrossSalesAndRDDed[$curPos + 3]/RDDedForeignTradeTxblIncm"/>
													</xsl:call-template>
													<span style="width:1px;"/>
												</td>
											</tr>
											<tr class="styDepTblRow1">
												<td class="styLNLeftLtrBoxBB">g</td>
												<td class="styIRS1118LNDescRD">Section 901(j) income*</td>
												<xsl:call-template name="AddRowsForSchH">
													<xsl:with-param name="RowCount" select="count(GrossSalesSection901jIncome)"/>
													<xsl:with-param name="TargetNode" select="GrossSalesSection901jIncome"/>
											...
											<tr class="styDepTblRow2">
												<td class="styLNLeftLtrBoxBB" style="height:8mm;">h</td>
												<td class="styIRS1118LNDescRD" style="height:8mm;">Income re-sourced by treaty*</td>
												<xsl:call-template name="AddRowsForSchH">
													<xsl:with-param name="RowCount" select="count(GrossSalesTreatyRscIncome)"/>
													<xsl:with-param name="TargetNode" select="GrossSalesTreatyRscIncome"/>
											...
											<tr class="styDepTblRow1">
												<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-left:1mm;">4</td>
												<td class="styIRS1118LNDescRD" style="height:8mm;">Total foreign (add lines 3a through 3h)</td>
												<td class="styLNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GrossSalesTotalForeign"/>
													</xsl:call-template>

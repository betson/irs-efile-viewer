												...
												<xsl:if test="ForeignCountryOrUSPossession != ' '">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode"
														 select="ForeignCountryOrUSPossession"/>
													</xsl:call-template>
												</xsl:if>
          ...
          <span class="styItalicText">
                ...
                Product line #2 <br/>(SIC Code: <xsl:call-template name="PopulateText">
									...
									<tr>
										...
										<td class="styIRS1118LNDescRD" style="height:8mm;">Totals (see page 9 of instructions)</td>
                ...
                Product line #2 <br/>(SIC Code: <xsl:call-template name="PopulateText">
									...
									<tr>
										...
										<td class="styIRS1118LNDescRD" style="height:4.5mm;">Totals (see page 9 of instructions)</td>
										<td class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">

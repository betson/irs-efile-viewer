  ...
  <html>
    ...
    <body class="styBodyClass">
      <form name="Form8275">
        ...
        <div style="width:187mm;" class="styBB">
          ...
          <div style="width:55mm;height:4mm;padding-left:2mm;font-size:7pt;font-weight:bold;" class="styEINBox">
            Identifying number shown on return<br /><br />
        ...
        <div class="styTableContainer" id="TPctn" style="height:27mm;">
          ...
          <table class="styTable" cellspacing="0" name="TYTable" id="TYTable" >
            ...
            <tfoot></tfoot>
            <tbody>
            <!-- Choice when Separated Print is not selected and Part I, General Information data count is less than or equal to 6  -->
              <xsl:choose>
                <xsl:when test="$Form8275Data/GeneralInformation">
                    ...
                    <!-- Part I, Column a -->
                      <td class="styTableCell" style="width:45mm;vertical-align:top;text-align:left;border-color:black;">
                        ...
                        <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="RevRulRevProcEtc" />
                        </xsl:call-template>
                      </td>
                      <!-- Part 2, Column b -->
                  ...
                  <!-- Begin Part I, General Information Table empty cell -->
                  <!--Check when Part I, General Information count of data is less than 1 or greater than 6 and Print separated is selected -->
        ...
        <div style="width:187mm;height:6mm;" class="styBB">
          ...
          <div style="float:right;margin-top:2.8mm">
            <xsl:call-template name="SetDynamicTableToggleButton">
              <xsl:with-param name="TargetNode" select="$Form8275Data/GeneralInformation/DetailExplanation"/>
            <xsl:with-param name="containerHeight" select="6"/>
        ...
        <!--Part II, Begin Detailed Explanation table -->
        <xsl:choose>
          <xsl:when test="$Form8275Data/GeneralInformation/DetailExplanation">
            <div class="styTableContainer" id="DEctn" style="height:30mm;">
              ...
              <table class="styTable" cellspacing="0" name="TYTable" id="TYTable" style="font-size:7pt;" >
                ...
                <tfoot></tfoot>
                <tbody>
                <!-- Check when Print separated is not selected and count of Detail Explanation data is less than or equal to 6 -->
                  <xsl:if test="($Print != $Separated) or (count($Form8275Data/GeneralInformation/DetailExplanation) &lt;=6) "> 
                      <xsl:for-each select="$Form8275Data/GeneralInformation/DetailExplanation">
                        <tr style="height:12mm;">
                  ...
                  <!-- Begin Part II, Detail Explanation Empty table -->
                  <!-- Check count of Part II Detail Explanation is less than 1 or greater than 6 and Print Separated is selected -->  
                  <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 1 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                   ...
                   <!-- Check count of Part II Detail Explanation is less than 2 or greater than 6 and Print Separated is selected -->
                  <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 2 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;border-color:black;">
                   ...
                   <!-- Check count of Part II Detail Explanation is less than 3 or greater than 3 and Print Separated is selected -->
                  <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 3 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;border-color:black;">
                    ...
                    <tr style="height:5mm;">
                     ...
                     <!-- Check count of Part II Detail Explanation is less than 4 or greater than 3 and Print Separated is selected -->
                    <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 4 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;border-color:black;">
                    ...
                    <!-- Check count of Part II Detail Explanation is less than 5 or greater than 3 and Print Separated is selected -->
                    <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 5 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;border-color:black;">
                    ...
                    <tr style="height:5mm;">
                     ...
                     <!-- Check count of Part II Detail Explanation is less than 6 or greater than 3 and Print Separated is selected -->
                    <xsl:if test="count($Form8275Data/GeneralInformation/DetailExplanation) &lt; 6 or ((count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;border-color:black;">
      ...
      <div class="styBB" style="width:187mm;float:none;">
        <div class="styIRS8275LeftLine" style="width:93mm;height:27mm;">
          ...
          <div class="styGenericDiv">
            ...
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form8275Data/PassThroughEntityName/BusinessNameLine1" />
            </xsl:call-template>
            <xsl:if test="$Form8275Data/PassThroughEntityName/BusinessNameLine2"><br />
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8275Data/PassThroughEntityName/BusinessNameLine2" />
              </xsl:call-template>
            </xsl:if>
            <br />
            <xsl:choose>
      ...
      <div style="width:187mm;clear:both;padding-top:1mm;" >
        ...
        <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">8275</span> (Rev. 12-2008)</div>
      </div>
     ...
     <!-- Part I, General Information Data Separated fomat Table-->
     <!-- Check if print separated is selected and count of General Informaion data is greater than 3 --> 
    <xsl:if test="($Print = $Separated) and (count($Form8275Data/GeneralInformation) &gt; 6)">
    ...
    <!-- Part II, Detail Explanation Data Separated fomat Table-->
    <!-- Check if print separated is selected and count of Detail Explanation Data is greater than 3 -->
    <xsl:if test="($Print = $Separated) and (count($Form8275Data/GeneralInformation/DetailExplanation) &gt; 6)">
...
<xsl:template name="populateirs8275partiemptycells">
  ...
  <tr style="height:12mm;">
    ...
    <!--Part I, General Information column a of separated format empty table -->
      <td class="styTableCell" style="width:45mm;vertical-align:top;text-align:left;border-color:black;">

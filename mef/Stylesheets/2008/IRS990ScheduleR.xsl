	...
	<xsl:template match="/">
					...
					<div class="styTBB" style="width:256mm;">
						...
						<div class="styFTBox" style="width:180mm;">
							...
							<div class="styFBT" style="height:5mm;">
								...
								</span>Attach to Form 990. To be completed by organizations that answerd "Yes" to Form 990, Part IV, lines 33, 34, 35, 36, or 37.<br/>
								<span style="padding-right:2mm">
									<img src="{$ImagePath}/990SchR_Bullet_Md.gif" alt="MediumBullet"/>
        ...
        <!-- <span class="styItalicText">(See the instructions.)</span> -->
              ...
              (C)<br/>
									...
									<th class="styTableCellHeader" scope="col" style="width:65mm;padding-right:2mm;">
              (D)<br/>
              ...
              (F)<br/>
					...
					<xsl:call-template name="SetInitialDynamicTableHeight">
						...
						<xsl:with-param name="containerHeight" select="6"/>
						<xsl:with-param name="containerID" select=" 'IRTctn' "/>
					</xsl:call-template>
					<!-- End Set Initial Height of Above Table -->
					<!-- END Part I Table -->
					<!-- Putting manual page break as the form does not display play properly when the break occurs inside the signature section -->
					<!-- Please DO NOT remove this manual break unless a solution to this problem is found. -->
					...
					<div class="styBB" style="width:256mm;padding-top:1mm;padding-bottom:1mm;clear:both; border-top:1 solid black">
						...
						<div class="styPartDesc" style="width:236mm;">
        Identification of Related Tax-Exempt Organizations         <!-- <span class="styItalicText">(See the instructions.)</span> -->
						</div>
						<div class="styGenericDiv" style="float:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
              ...
              (F)<br/>
							...
							<tbody>
								<xsl:for-each select="$Form990ScheduleRData/Form990ScheduleRPartII">
									<xsl:if test="($Print != $Separated) or (count($Form990ScheduleRData/Form990ScheduleRPartII) &lt;= 6) ">
										<tr>
								...
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 1 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated)) ">
									<tr>
										<td class="styTableCellText" style="width:60mm;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form990ScheduleRData/Form990ScheduleRPartII"/>
								...
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 2 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartIandIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 3 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartIandIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 4 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartIandIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 5 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartIandIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartII) &lt; 6 or ((count($Form990ScheduleRData/Form990ScheduleRPartII) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartIandIITableFillerRow"/>
								</xsl:if>
							</tbody>
						</table>
					...
					<div style="width:256mm;float:none;clear:both;padding-top:.2mm;border-top:1px;" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;padding-right:4mm">
							<span class="styBoldText">Schedule R (Form 990) 2008</span>
						</div>
					</div>
					<!-- *********BEGIN NEW PAGE 2********** -->
					<!-- header -->
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule R (Form 990) 2008</div>
        ...
        Identification of Related Organizations Taxable as a Partnership  
         <!-- <span class="styItalicText">(See the instructions.)</span> -->
					...
					<!-- END Part III Title -->
					<!--      <div class="styBB" style="width:255mm;"> </div> -->
					<!-- Solid line across -->
              ...
              (D)<br/>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;border-right-width:1px" rowspan="2">
              (E)<br/>
										<span class="styNormalText">Predominant<br/>income(related,<br/>investment,<br/>unrelated)<br/>
											<br/>
											<br/>
										</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:30mm;border-right-width:1px" rowspan="2">
                (F)<br/>
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or (count($Form990ScheduleRData/Form990ScheduleRPartIII) &lt;= 7) ">
									<xsl:for-each select="$Form990ScheduleRData/Form990ScheduleRPartIII">
										<tr>
											<td class="styTableCellText" style="padding-left:1mm;width:35mm">
												<!--span style="width:4px"></span-->
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCell" style="padding-left:.5mm;border-right-width:1px;width:30mm">
												<xsl:call-template name="PopulateAmount">
											...
											<td class="styTableCellText" style="border-right-width:0px;border-top-width:0px;width:7mm">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="GeneralOrManagingPartner"/>
												</xsl:call-template>
											</td>
								...
								<xsl:if test="count($Form990ScheduleRData/Form990ScheduleRPartIII) &lt; 1 or ((count($Form990ScheduleRData/Form990ScheduleRPartIII) &gt; 7) and ($Print = $Separated)) ">
									<tr>
										<td class="styTableCellText" style="width:35mm">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form990ScheduleRData/Form990ScheduleRPartIII"/>
											</xsl:call-template>
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-right-width:1px;width:25mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-right-width:1px;width:10mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-right-width:1px;width:25mm">
											<span style="width:4px"/>
										...
										<td class="styTableCell" style="border-right-width:1px;width:30mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-right-width:1px;width:30mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-right-width:1px;width:7mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style=";border-right-width:1px;width:7mm">
											<span style="width:4px"/>
										...
										<td class="styTableCell" style="border-right-width:1px;width7mm">
											<span style="width:4px"/>
										</td>
										<td class="styTableCell" style="border-top-width:0px;border-right-width:0px;width:7mm">
											<span style="width:4px"/>
										</td>
									</tr>
								</xsl:if>
       ...
       Identification of Related Organizations Taxable as a Corporation or Trust
         <!-- <span class="styItalicText">(See the instructions.)</span> -->
              ...
              (A)<br/>
									...
									<th class="styTableCellHeader" scope="col" style="width:22mm;border-right-width:1px;padding-top:1mm;">
              (B)<br/>
										<span class="styNormalText">Primary activity<br/>
											<br/>
											<br/>
        ...
        Transactions with Related Organizations 
						...
						<!-- button display logic -->
						<!-- <xsl:call-template name="SetDynamicTableToggleButton">
          <xsl:with-param name="TargetNode" select="$Form990ScheduleRData/IRS990ScheduleRPartV"/>
          <xsl:with-param name="containerHeight" select="7"/>
 ...
 Complete line 1 if any entity is listed in Parts II, III or IV.     <span style="width:2px;"/>
         ...
         <span style="width:2px;"/>
          ...
          <!--Dotted Line-->
					...
					<div class="styTableContainerLandscape" id="IRT5ctn" style="width:256mm;height:70mm;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:196mm;padding-right:10mm;">(A)      
              <br/>
										<span class="styNormalText"> Name of other organization(s)
              
               </span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:30mm;padding-right:2mm;">
              (B)<br/>
										<span class="styNormalText">Transaction<br/>type(a-r)</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:30mm;padding-right:2mm;border-right-width:0px">
              (C)<br/>
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or (count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &lt;= 6) ">
									<xsl:for-each select="$Form990ScheduleRData/TransactionsRelatedOrgsTable">
										<tr>
											...
											<td class="styTableCell" style="width:30mm;border-right-width:0px;padding-right:4mm">
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &lt; 1 or ((count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &gt; 6) and ($Print = $Separated)) ">
									<tr>
										<td class="styTableCellText" style="width:196mm;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form990ScheduleRData/TransactionsRelatedOrgsTable"/>
											</xsl:call-template>
										</td>
								...
								<xsl:if test="count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &lt; 2 or ((count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartVTableFillerRow"/>
								</xsl:if>
					...
					<div style="width:256mm;float:none;clear:both;padding-top:1mm;">
						<!--    <div class="styGenericDiv" style="width:190mm;"><span class="styBoldText"></span></div>
    <div class="styGenericDiv" style="width:25mm;"></div>
    <div class="styGenericDiv" style="float:right;">Schedule R (Form 990) (2008)</div>-->
					</div>
					<!-- END Part V -->
					<!-- *********BEGIN NEW PAGE 4********** -->
					<!-- header -->
...
or gross revenue) that was not a related organization. See instructions regarding exclusion for certain investment partnerships.
              ...
              (G)<br/>
										<span class="styNormalText">Code V&#151;UBI <br/>amount on Box<br/> 20 of Schedule K-1<br/>(Form 1065)</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="vertical-align:top;width:14mm;border-right-width:0px;" colspan="2">
              (H) <br/>
								...
								<xsl:if test="($Print != $Separated) or (count($Form990ScheduleRData/Form990ScheduleRPartVI) &lt;=9) ">
									<xsl:for-each select="$Form990ScheduleRData/Form990ScheduleRPartVI">
										<tr>
											...
											<td class="styTableCellText" style="width:7mm;border-right-width:0px;border-top-width:0px">
												<div>
													<xsl:call-template name="PopulateNoBoxText">
														<xsl:with-param name="TargetNode" select="GeneralOrManagingPartner"/>
														<span style="padding-top:2mm;"/>
        ...
        Additional Data        
                ...
                (H)<br/>
					...
					<xsl:if test="($Print = $Separated) and (count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &gt;= 6) ">
						...
						<table class="styLeftOverTblLandscape" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styTableCellHeader" scope="col" style="width:196mm;padding-right:10mm;">
              (A)      
							...
							<tbody>
								<xsl:for-each select="$Form990ScheduleRData/TransactionsRelatedOrgsTable">
									<tr>
										...
										<td class="styTableCell" style="width:30mm;padding-left:1mm;border-right-width:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="AmountInvolved"/>
											</xsl:call-template>
										</td>
              ...
              (E)<br/>
                ...
                (F)<br/>
									...
									<th class="styTableCellHeader" scope="col" style="width:45mm;border-right-width:1px;" rowspan="2">
              (G)<br/>
										<span class="styNormalText">Code V-UBI <br/>amount on Box<br/> 20 of K-1<br/>($)<br/>
											<br/>
										</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:14mm;border-right-width:0px;" colspan="2">
	...
	<xsl:template name="IRS990PartIIITableFillerRow">
		<tr>
			...
			<td class="styTableCell" style="width:7mm;border-right-width:0px;border-top:1px"/>
			<!-- <td class="styTableCell" style="width:25mm;"><span style="width:4px;"></span></td>
    
     <td class="styTableCell" style="width:25mm;border-right-width:0px;"><span style="width:8mm;border-right-width:1mm;border-color:orange;"></span></td>
-->
		</tr>
	</xsl:template>
	...
	<xsl:template name="IRS990PartVTableFillerRow">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;border-right-width:0px;">
				<span style="width:4px;height:4.5px;"/>
			</td>
		</tr>
	</xsl:template>
	<xsl:template name="IRS990PartVTableFillerRow2">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()+1" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">
	...
	<xsl:template name="IRS990PartVTableFillerRow3">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()+2" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">
	...
	<xsl:template name="IRS990PartVTableFillerRow4">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()+3" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">
	...
	<xsl:template name="IRS990PartVTableFillerRow5">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()+4" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">
	...
	<xsl:template name="IRS990PartVTableFillerRow6">
		<tr>
			<td class="styTableCellText" style="width:196mm;height:4.5px;font-weight:bold;padding-left:2mm">(<xsl:number value="position()+5" format="1"/>)<br/>
				<br/>
				<span style="width:4px;height:4.5px;"/>
			</td>
			<td class="styTableCell" style="width:30mm;height:4.5px;">

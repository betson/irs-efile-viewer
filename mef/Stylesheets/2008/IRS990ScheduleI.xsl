...
<div class="sty990ScheduleIBB" style="width:256mm;height:18mm">
  ...
  <div class="sty990ScheduleIFTBox" style="width:180mm;border-right-width:1px;height:18mm;padding-top:4mm">
    <div class="styMainTitle">Grants and Other Assistance to Organizations,<br />Governments and Individuals in the U.S.</div>
...
<div class="styBB" style="width: 256mm;border-top-width:1px;border-bottom-width:1px">
  ...
  <div class="styPartDesc" style="width: 242mm;">Grants and Other Assistance to Governments and Organizations in the United States.<span style="font-weight:normal"> Complete if the organization answered "Yes" on <br />Form 990, Part IV, line 21 for any recipient that received more than $5,000. Check this box if no one recipient received more than $5,000. Use <br />Part IV and Schedule I-1 (Form 990) if additional space is needed </span>    
...
<!--   BEGIN LINE 1   -->
	...
	<xsl:if test="($Print != $Separated) or count($FormData/RecipientTable) &lt;= 7">
          <xsl:for-each select="$FormData/RecipientTable">
            <tr>
            <td class="sty990ScheduleILNCol" style="padding-top: 1mm;width:42mm;font-size:7pt;padding-left: 2.5mm;vertical-align:top">
...
<!-- Employer Identification Number -->
        ...
        <xsl:if  test="count($FormData/RecipientTable) &lt; 3 or
            (($Print = $Separated) and (count($FormData/RecipientTable) &gt; 7)) ">
          <tr>
...
<div class="sty990ScheduleIFormFooter" style="padding-top:1mm;">
  ...
  <span class="styBoldText"> Schedule I (Form 990) 2008</span> 
</div>
</div>
<!--     END FORM FOOTER   -->
...
<br/>      
  ...
  <div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">  
    <div style="float:left">Schedule I (Form 990) 2008</div>
...
<div class="styBB"  style="width: 256mm;border-top-width:1px">
 ...
 <div class="sty990ScheduleIPartDesc" >Grants and Other Assistance to Individuals in the United States. 
       <span style="font-weight:normal;">Complete if the organization answered "Yes" on Form 990, Part IV, line 22.<br />Use Schedule I-1 (Form 990) if additional space is needed.
</span> </div>
...
<div class="pageEnd" style="width:256mm">
    ...
    <span class="styBoldText" style="text-align:right;width:80mm;padding-right:2mm;float:right;clear:none"> Schedule I (Form 990) 2008</span> 

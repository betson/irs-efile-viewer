    ...
    <xsl:call-template name="SetFormLinkInline">
      <xsl:with-param name="TargetNode" select="$FormData"/>
          ...
          <div class="IRS1120POL_FormTitleBlock">
            <!-- Form Title -->
            <span class="styMainTitle">U.S. Income Tax Return<br/> for Certain Political Organizations</span>
            <!-- Form Subtitle -->
          </div>
          <!-- Tax Year Box -->
        ...
        <div class="styBB" style="width:187mm;float:none;">
          <div class="styIRS1120POLRightLine" style="width:27.5mm;height:30mm;border-right-width:0px;">
            ...
            <br/>
             <!--
            <input class="IRS1120POL_Checkbox" type="checkbox" TabIndex="-1"  id="IRS1120POL_Finalreturn" onclick="return false">
                --> 
              <!--xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
              </xsl:call-template-->
              <!--
              <label for="IRS1120POL_Finalreturn">
              -->
                <!--xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
                </xsl:call-template-->
            ...
            <br/>
            <!--     
           <input class="IRS1120POL_Checkbox" type="checkbox" TabIndex="-1" id="IRS1120POL_Namechange" onclick="return false"-->
              <!--xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
              </xsl:call-template-->
              <!--
              <label for="IRS1120POL_Namechange"-->
                <!--xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
                </xsl:call-template-->
                <!--
            ...
            <!--
            <input class="IRS1120POL_Checkbox" TabIndex="-1" type="checkbox" id="IRS1120POL_Amendedreturn" onclick="return false"-->
              <!--xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
              </xsl:call-template-->
              <!--
              <label for="IRS1120POL_Amendedreturn"-->
                <!--xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$FormData/xxxx"/>
                </xsl:call-template-->
                <!--
          ...
          <div class="styIRS1120POLRightLine" style="width:98mm;height:30mm;">
            ...
            <div class="styNameBox" style="width:98mm;height:10mm;border-right-width:0px;border-bottom-width:1px;padding-left:4px;border-left-width:1px;">
							...
							<span style="font-size:6pt;"> (If a P.O. box, see page 5 of instructions.)</span>
							<br/>
            ...
            <div class="" style="width:61mm;height:8mm;padding-left:4px;">
              ...
              <span style="font-size:5pt;">
                <label>  
                  ...
                  </xsl:call-template>If this is a principal campaign committee, but is NOT the only political committee, check here and attach a copy of designation (See instruction on p.2)
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" select="$FormData/USCongressPrinPltclCommittee"/>
                  </xsl:call-template>
</label>  
...
<span style="width:14px"/>.
        ...
        Subtract line 23d from line 22. See instructions on page 4 for depository method of payment
                 <!--span class="IRS1120POL_DotSpacing">..</span-->
          </div>
        ...
        <!-- additional info line 1 -->
              ...
              At any time during the 2008 calendar year, did the organization have an interest in or a signature or other 
              </div>
 </div>
        ...
        <div class="IRS1120POL_LineContainer">
          <div class="IRS1120POL_LabelSpaceWide"/>
          <div class="IRS1120POL_LineIndex">3</div>
          <div class="IRS1120POL_LineDescLong" style="width:134mm;">
        ...
        <!-- add info line 5ab -->
        <div class="IRS1120POL_LineContainer">
					<div class="IRS1120POL_LabelSpaceWide" style="padding-bottom:2mm;"/>
					<div class="IRS1120POL_SubLineIndex" style="padding-bottom:2mm;">5a</div>
...
border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
					<div class="IRS1120POL_LabelSpaceWide" style="padding-bottom:2mm;height:14mm"/>
					<div class="IRS1120POL_SubLineIndex" style="padding-bottom:2mm;padding-left:2mm;height:14mm">c</div>
					<div class="IRS1120POL_GenericDesc" style="width:36mm;padding-bottom:2mm;height:14mm">The books are located at</div>
					<div class="IRS1120POL_GenericDesc" style="width:4mm;height:14mm">
    <img src="{$ImagePath}/1120POL_Bullet_Sm.gif" alt="right arrow"/>
  </div>
					<div class="IRS1120POL_GenericDesc" style="width:40mm;border-bottom-width:1px;">
    ...
    <!-- end address type -->
					...
					<div class="IRS1120POL_GenericDesc" style="width:8mm;font-weight:bold;padding-left:4mm;height:14mm">d</div>
					<div class="IRS1120POL_GenericDesc" style="width:20mm;height:14mm">Telephone No.</div>
					<div class="IRS1120POL_GenericDesc" style="width:4mm;height:14mm">
    <img src="{$ImagePath}/1120POL_Bullet_Sm.gif" alt="right arrow"/>
  </div>
					<div class="IRS1120POL_GenericDesc" style="width:56mm;border-bottom-width:1px;">
...
<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;clear:both;">
	<tr>
		...
		<td style="width:75mm;border-bottom:1 solid black;border-right:1 solid black;">
							...
							<span class="styGenericDiv" style="border:0 solid red;">
								<img src="{$ImagePath}/1120POL_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/>
							</span>
	...
	<tr>
		<td rowspan="2" colspan="3" style="border-bottom:1 solid black;padding-left:1mm;border-right:1 solid black;">
							<span class="styGenericDiv" style="padding-right:.5mm;">Firm’s name (or <br/>
yours if self-employed),<br/>
address, and ZIP code</span>
    		<span class="styGenericDiv" style="padding-left:1mm;">
    		  <img src="{$ImagePath}/1120POL_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/>
        </span> 
       <span style="padding-left:.5mm;" class="styGenericDiv">
								<div style="border-bottom:1 solid black;width:88mm;">
...
<!-- END PREPARER SIGNATURE SECTION -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2008)</div>
        </div>
        <!-- leftover data table -->
				<br/>
				<br/>

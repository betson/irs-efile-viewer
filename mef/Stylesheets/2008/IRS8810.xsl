...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" >
   ...
   <xsl:template match="/">   
      <html>
         <head>
            <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form8810Data)"></xsl:with-param></xsl:call-template></title>
            <!-- No Browser Caching  -->
           ...
           <xsl:if test="not($Print) or $Print=''">
                  <xsl:call-template name="IRS8810Style"></xsl:call-template>
               ...
               <div class="styTBB" style="width:187mm;">
                  ...
                  <div class="styTYBox" style="width:32mm;height:18.5mm;">
                     ...
                     <div class="styTY" style="height:9mm;font-size:21pt;padding-top:2mm;">
                        20<span class="stytycolor">07</span>
                     </div>
                  </div>
               </div>
        ...
        <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">EIN</xsl:with-param></xsl:call-template>                     
               ...
               <div style="width:187mm;" class="styBB">
                  <div style="width:187mm;height:7mm;">            
                     <div class="styLNLeftNumBoxSD" style="height:7mm;padding-top:3.5mm;">1a</div>
                     ...
                     <div style="float:right;">
                        ...
                        <div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;height:7.5mm;padding-top:3.5mm;"></div>
                        <div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.5mm;">
                        </div>
                     </div>            
                  </div>
                  <div style="width:187mm;height:6mm;">            
                     <div class="styLNLeftLtrBox" style="padding-left:4.1mm;height:6mm;padding-top:2mm;">b</div>
                  ...
                  <div style="width:187mm">            
                     <div class="styLNLeftLtrBox" style="padding-left:4.1mm;height:6mm;padding-top:2mm;">c</div>
                  ...
                  <div style="width:187mm">            
                     <div class="styLNLeftLtrBox" style="padding-left:4.1mm;height:6mm;padding-top:2mm;">d</div>
                  ...
                  Personal service corporations                  
                     ...
                     <div style="float:right;">
                        <div class="styLNRightNumBoxNBB" style="height:6mm;padding-top:2mm;"></div>
               ...
               <div style="width:187mm;" class="styBB">
                  ...
                  <div class="styPartDesc" style="padding-left:3mm;">
                     2007 Passive Activity Credits <br />
                     Caution:<span class="styItalicText" style="font-weight:normal;"> 
               ...
               <div style="width:187mm;" class="styBB">
                  <div style="width:187mm">            
                     <div class="styLNLeftNumBoxSD" style="height:7mm;padding-top:3.5mm;">5a</div>
                     <div style="float:left;padding-top:3.5mm;padding-bottom:.5mm;height:7mm;">
                     ...
                     <div style="float:right;">
                        ...
                        <div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;height:7.5mm;"></div>
               ...
               <div style="width:187mm;height:6mm;" class="styBB">
                  <div class="styPartName" style="width:15mm;margin-top:1mm;margin-bottom:1mm;">Part III</div>
                  <div class="styPartDesc" style="width:132mm;padding-left:3mm;margin-top:1mm;margin-bottom:1mm;">
                     Election To Increase Basis of Credit Property
                  </div>
                  <div class="styGenericDiv" style="float:right;margin-top:1mm; ">
                     ...
                     <tbody>
                        <tr>
                           <td class="styTableCell" style="width:8mm;font-weight:bold;text-align:left;border:0;vertical-align:top;">
                              10<span class="styTableCellPad"></span>
                           </td>
                        ...
                        <xsl:choose>
                          <xsl:when test="$Form8810Data/CreditPropForWhichElectIsMade">							
	                          		<xsl:if test="($Print != $Separated) or count($Form8810Data/CreditPropForWhichElectIsMade) = 1">
			                            <xsl:for-each select="$Form8810Data/CreditPropForWhichElectIsMade">                     
			                              ...
			                              <td class="styTableCell" style="width:179mm;text-align:left;vertical-align:top;border:0;">
			                                 <span style="float:left;width:53mm;">
			                                       Name of passive activity disposed of <span style="width:4px;"></span>
			                                       <img src="{$ImagePath}/8810_Bullet_Md.gif" width="7" alt="bullet image" />
			                                 </span>               
			                           ...
			                           <tr style="height:6mm;">
			                              ...
			                              <td class="styTableCell" style="width:179mm;text-align:left;vertical-align:top;border-bottom-width:0px;border-right-width:0px;">
			                                 <span style="float:left;padding-top:0mm;width:97mm;">   
			                                    Description of the credit property for which the election is being made <span style="width:7px;"></span>
			                                    <img src="{$ImagePath}/8810_Bullet_Md.gif" width="7" alt="bullet image"/>
			                                   </span>
			                           ...
			                           <tr style="height:6mm;">
			                              ...
			                              <td class="styTableCell" style="width:179mm;text-align:left;text-align:left;vertical-align:bottom;border:0;">
			                                 <span style="float:left;">Amount of unallowed credit that reduced the property’s basis <span style="width:3px;"></span>   
			                                 </span>   
			                                 <span style="float:left;">
			                                    <span class="styDotLn">
			                                       .............
			                                    </span>
			                                    <img src="{$ImagePath}/8810_Bullet_Md.gif" width="7" alt="bullet image"/><span style="width:6px;">	</span>$
			                                 </span>
			                              ...
			                              <td class="styTableCell" style="width:179mm;text-align:left;vertical-align:bottom;border-bottom-width:0px;border-right-width:0px;">
			                                 <span style="float:left;padding-top:0mm;width:97mm;">   
			                                   ...
			                                   <span style="border-bottom:1 solid black; width:80mm;float:right;">
				                                 <xsl:call-template name="PopulateAdditionalDataTableMessage">
				                                 		<xsl:with-param name="TargetNode" 																					select="$Form8810Data/CreditPropForWhichElectIsMade/Description"/>
				                                 </xsl:call-template>
				                          </span>        
			                              </td>
			                           </tr>
			                              ...
			                              <td class="styTableCell" style="width:179mm;text-align:left;text-align:left;vertical-align:bottom;border:0;">
			                                 ...
			                                 <span style="float:left;">
			                                   ...
			                                   <img src="{$ImagePath}/8810_Bullet_Md.gif" width="7" alt="bullet image"/><span style="width:6px;"></span>$
				                                 	...
				                                 	<xsl:call-template name="PopulateAdditionalDataTableMessage">
				                                 		<xsl:with-param name="TargetNode" 																					select="$Form8810Data/CreditPropForWhichElectIsMade/Amount"/>
				                                 </xsl:call-template>
			                              </td>
			                           </tr> 
		                          </xsl:if>	            
               ...
               <div style="width:187mm;clear:both;padding-top:1mm;">
                  ...
                  <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">8810</span> (2007)</div>
               </div> 
               <p class="pageend"></p>            
               ...
               <xsl:if test="($Print = $Separated) and count($Form8810Data/CreditPropForWhichElectIsMade) &gt; 1">
               <br/><br/>
               	  <span class="styRepeatingDataTitle">Form 8810 - Lines 11, 12, and 13:</span><br/>               	  
	               <xsl:for-each select="$Form8810Data/CreditPropForWhichElectIsMade">             
			     <table class="styDepTbl" style="font-size:7pt;">
		              <thead class="styTableThead">
			        	<tr class="styDepTblHdr">		        	
						<th  class="styDepTblCell" colspan="2" style="width: 93mm; text-align: left; height:4mm; padding-top: 2.5mm"></th>			             
                    		</tr>
	              </thead>
	              <tfoot/>
	              <tbody>     	                       

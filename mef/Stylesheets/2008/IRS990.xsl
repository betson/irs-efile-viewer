...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <html>
      ...
      <body class="styBodyClass">
        <form name="Form990">
          ...
          <div style="width:187mm;font-weight:bold;">
            <span class="styBoldText" style="width:3mm;">A</span> For the 
      ...
      -->
              ...
              <span style="width:3.5mm;padding-top:2mm">
                <input type="checkbox" class="styCkbox">
                  <xsl:call-template name="PopulateCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form990Data/TerminationReturn"/>
                    <xsl:with-param name="BackupName">IRS990TerminationReturn</xsl:with-param>
                  </xsl:call-template>
                </input>
              </span>
              <span style="width:21.4mm;padding-top:2mm">
          ...
          -->
            ...
            <div class="styGenericDiv" style="width:112mm;">
              <div class="styLblNameAddr" style="width:112mm;height:27mm;">
                ...
                <div class="styNameAddr" style="width:96.25mm;height:4.5mm;border-left-width:1px;">
                ...
                <div class="styNameAddr" style="width:14mm;height:9mm;">
                      Room/suite<br/>
                </div>
                <div class="styNameAddr" style="width:96.25mm;height:9mm;border-left-width:1px;">
            ...
            <div class="styEINDateAssets" style="width:50mm;height:9mm;border-top-width:1px;">
            ...
            <div class="styEINDateAssets" style="width:50mm;height:9mm;">
              <span class="styBoldText">E Telephone number</span>
              <br/>
              <br/>
            ...
            <!--  Begin Sections G -->
            <div class="styEINDateAssets" style="width:50mm;height:5.3mm;padding-top:1mm;">
          ...
          <div class="styBB" style="width:187mm;float:none;">
            ...
            <!--  F   -->
            <div class="styGenericDiv" style="width:93mm;height:17mm;padding-left:5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 1px; border-right-width: 0px;">
        ...
        <br/>
            ...
            <div style="width:118.9mm;float:left; clear:left;">
              <div class="styBB" style="width:118.9mm;padding-top:1mm;padding-bottom:1mm;float:left;border-top-width:1px;">
 ...
 <xsl:call-template name="PopulateText">
  ...
  527 
              ...
              <!--  J   -->
              <div class="styBB" style="width:118.9mm;float:left;height:4.5mm;padding-top:1mm;padding-bottom:1mm;border-bottom-width:0px;">
            ...
            <div class="styIRS990RightSideSection" style="width:67.5mm;height:29mm;">
              <!--  H(a)   -->
  ...
  <span style="width:71px;"/>
                    ...
                    <span style="height:3.0mm;width:3.0mm;padding-left:1.5mm">
                      ...
                      <input type="checkbox" class="styCkbox" name="Checkbox">
                        <xsl:call-template name="PopulateYesCheckbox">
                          <xsl:with-param name="TargetNode" select="$Form990Data/GroupReturnForAffiliates"/>
                          <xsl:with-param name="BackupName">IRS990GroupReturnForAffiliatesYes</xsl:with-param>
                        </xsl:call-template>
                      </input>
                    </span>
                    <label>
                      <xsl:call-template name="PopulateLabelYes">
                        <xsl:with-param name="TargetNode" select="$Form990Data/GroupReturn"/>
                        <xsl:with-param name="BackupName">IRS990GroupReturnForAffiliatesYes</xsl:with-param>
                      </xsl:call-template>
  Yes 
  </label>
                    ...
                    <span style="height:3.0mm;width:3.0mm;">
                      ...
                      <input type="checkbox" class="styCkbox" name="Checkbox">
                        <xsl:call-template name="PopulateNoCheckbox">
                          <xsl:with-param name="TargetNode" select="$Form990Data/GroupReturnForAffiliates"/>
                          <xsl:with-param name="BackupName">IRS990GroupReturnForAffiliatesNo</xsl:with-param>
                        </xsl:call-template>
                      </input>
                    </span>
                    <label>
              ...
              <div class="styGenericDiv" style="width:67mm;padding-left:2mm;">
                ...
                <div class="styGenericDiv" style="width:35mm;padding-top:0.95mm;">
                  <span class="stySmallText">
                    <b>Are all affiliates included?</b>
                    <!-- <span style="width:2px;" /> -->
                    <xsl:call-template name="SetFormLinkInline">
                ...
                <div class="styGenericDiv" style="width:22mm;padding-top:0.85mm;padding-left:4.5mm;font-size:6pt;">
                  <span style="height:3.0mm;width:3.0mm;">
                    <xsl:call-template name="PopulateSpan">
                      <xsl:with-param name="TargetNode" select="$Form990Data/AllAffiliatesIncluded"/>
                    </xsl:call-template>
  ...
  No 
              ...
              <div class="styGenericDiv" style="width:67mm;padding-left:2mm;">
                ...
                <div class="styGenericDiv" style="width:54mm;padding-top:0.5mm">
                  <span class="styNormalText">If "No," attach a list. (see instructions)</span>
                </div>
              </div>
              <!--  H(c)  -->
              <div class="styBB" style="width:67mm;float:left;padding-left:2mm;border-bottom-width:0px;">
                <div class="styIRS990RightSideLeftNumBox">H(c)</div>
                <span class="styNormalText" style="padding-top:0.75mm;padding-bottom:0.75mm">
 ...
 <input type="checkbox" class="styCkbox" name="Checkbox">
                <xsl:call-template name="PopulateCheckbox">
                  ...
                  <xsl:with-param name="BackupName">TypeOfOrganizationCorporation</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
  ...
  Corporation 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox">
                <xsl:call-template name="PopulateCheckbox">
                  ...
                  <xsl:with-param name="BackupName">TypeOfOrganizationTrust</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
  ...
  Trust 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox">
                <xsl:call-template name="PopulateCheckbox">
                  ...
                  <xsl:with-param name="BackupName">TypeOfOrganizationAssociation</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
  ...
  Association 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox">
                <xsl:call-template name="PopulateCheckbox">
                  ...
                  <xsl:with-param name="BackupName">TypeOfOrganizationOther</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
 ...
 <xsl:call-template name="PopulateText">
      ...
      <xsl:if test="$Form990Data/StateLegalDomicile">
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
            <thead>
              <tr scope="col">
                <th class="styBB" colspan="4" style="padding-top:0;padding-bottom:0;">
                  <!-- <div class="styBB" style="width:187mm;float:none;height:9mm;">-->
...
-->
              <tr>
                ...
                <td class="styLNDesc" style="width:156mm;height:4.5mm;" colspan="2">
  ...
  <span style="width: 173mm; border-style:solid; border-color:black; border-left-width:0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 1px">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:176mm;height:4.5mm;" colspan="2">
  Check this box <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                  <input type="checkbox" class="styCkbox" name="Checkbox">
                    ...
                    </xsl:call-template> if the organization discontinued its operations or disposed of more than 25% of its assets.
               </input>
                </td>
              </tr>
              <tr>
      ...
      <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.......</span>
                ...
                <td style="height:4.5mm;width:37mm;text-align:right;">
                  <span class="styBoldText" style="padding-right:2mm;">3</span>
                  <span style="width:30mm;font-size:7pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                ...
                <td style="height:4.5mm;width:37mm;text-align:right">
                  <span class="styBoldText" style="padding-right:2mm;">4</span>
                  <span style="width:30mm;font-size:7pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                ...
                <td style="height:4.5mm;width:37mm;text-align:right">
                  <span class="styBoldText" style="padding-right:2mm;">5</span>
                  <span style="width:30mm;font-size:7pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                ...
                <td style="height:4.5mm;width:37mm;text-align:right">
                  <span class="styBoldText" style="padding-right:2mm;">6</span>
                  <span style="width:30mm;font-size:7pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">..</span>
                ...
                <td style="height:4.5mm;width:37mm;text-align:right">
                  <span class="styBoldText" style="padding-right:1mm;">7a</span>
                  <span style="width:30mm;font-size:7pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">..</span>
                ...
                <td class="styBB" style="height:4.5mm;width:37mm;text-align:right">
                  <span class="styBoldText" style="padding-right:1mm;">7b</span>
                  <span style="width:30mm;font-size:7pt;">
                    <xsl:call-template name="PopulateAmount">
  ...
  Other revenue (Part VIII, column (A), lines 5, 6d, 8c, 9c, 10c, and 11e) 
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Grants and similar amounts paid (Part IX, column (A), lines 1–3 )<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">...</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Benefits paid to or for members (Part IX, column (A), line 4)
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Salaries, other compensation, employee benefits (Part IX, column (A), lines 5–10)
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;padding-top:3mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Professional fundraising fees (Part IX, column (A), line 11e)<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;font-size:6pt;height:4.5mm;" colspan="2">Total fundraising expenses (Part IX, column (D), line 25) <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Other expenses (Part IX, column (A), lines 11a–11d, 11f–24f)<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styBB" style="width:112mm;height:4.5mm;" colspan="2">Revenue less expenses. Subtract line 18 from line 12<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">......</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;"/>
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2"/>
                <td class="styLNAmountBox" style="height:4.5mm;font-weight:bold;text-align:center;">Beginning of Year</td>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Total assets (Part X, line 16)<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">............</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Total liabilities (Part X, line 26)<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">............</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Net assets or fund balances. Subtract line 21 from line 20<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
...
and belief, it is true, correct, and complete. Declaration of preparer (other than officer) is based on all information of which preparer has any knowledge. </td>
            ...
            <tr>
              ...
              <td style="width:75mm;border-bottom:1 solid black;border-right:1 solid black;">
                ...
                <span class="styGenericDiv" style="border:0 solid red;">
                  <img src="{$ImagePath}/990_Bullet_Jumbo.gif" align="middle" alt="Big Right Arrow" border="0"/>
                </span>
        ...
        Date <br/>
              ...
              <td style="width:20mm;border-right:1 solid black;border-bottom:1 solid black;padding-left:1mm;">
                ...
                <span style="width:2px;"/>
                <img src="{$ImagePath}/990_Bullet_Sm.gif" width="4" height="7" alt="right pointing bullet image" border="0"/>
              ...
              <td style="width:50mm;border-bottom:1 solid black;padding-left:1mm;vertical-align:top;padding-top:1mm;">Preparer’s identifying number<br/>
(see instructions)
<br/>
                <xsl:call-template name="PopulateReturnHeaderPreparer">
...
<span style="width:2px;"/>
          ...
          May the IRS discuss this return with the preparer shown above? (see instructions) 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox" id="dummyidexempt">
                <xsl:call-template name="PopulateYesCheckbox">
                  ...
                  <xsl:with-param name="BackupName">IRS990AuthorizeThirdPartyYes</xsl:with-param>
                </xsl:call-template>
              </input>
            ...
            Yes
              ...
              <!-- NO -->
              <input type="checkbox" class="styCkbox" name="Checkbox" id="dummyidnonexempt">
                <xsl:call-template name="PopulateNoCheckbox">
                  <xsl:with-param name="TargetNode" select="$RtnHdrData/Officer/AuthorizeThirdParty"/>
                  <xsl:with-param name="BackupName">IRS990AuthorizeThirdPartyNo</xsl:with-param>
                </xsl:call-template>
              </input>
          ...
          <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
            <div class="styGenericDiv" style="width:117mm;font-weight:bold;">For Privacy Act and Paperwork Reduction Act Notice, see the separate instructions.</div>
          ...
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2008)</div>
...
the prior Form 990 or 990-EZ? 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox" id="dummyidexempt">
                <xsl:call-template name="PopulateYesCheckbox">
                  ...
                  <xsl:with-param name="BackupName">IRS990SignificantNewProgramServicesYes</xsl:with-param>
                </xsl:call-template>
              </input>
              <label for="dummyidexempt">
                <xsl:call-template name="PopulateLabelYes">
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox" onclick="return false;" id="dummyidnonexempt">
                <xsl:call-template name="PopulateNoCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantNewProgramServices"/>
                  <xsl:with-param name="BackupName">IRS990SignificantNewProgramServicesNo</xsl:with-param>
                </xsl:call-template>
              </input>
              <label for="dummyidnonexempt">
                <xsl:call-template name="PopulateLabelNo">
          ...
          Did the organization cease conducting, or make significant changes in how it conducts, any program services? 
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox" onclick="return false;" id="dummyidexempt">
                <xsl:call-template name="PopulateYesCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantChange"/>
                  <xsl:with-param name="BackupName">IRS990SignificantChangeYes</xsl:with-param>
                </xsl:call-template>
              </input>
              <label for="dummyidexempt">
                <xsl:call-template name="PopulateLabelYes">
              ...
              <input type="checkbox" class="styCkbox" name="Checkbox" onclick="return false;" id="dummyidnonexempt">
                <xsl:call-template name="PopulateNoCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantChange"/>
                  <xsl:with-param name="BackupName">IRS990SignificantChangeNo</xsl:with-param>
                </xsl:call-template>
              </input>
              <label for="dummyidnonexempt">
                <xsl:call-template name="PopulateLabelNo">
      ...
      Section 501(c)(3) and 501(c)(4) organizations and section 4947(a)(1) trusts are required to report the amount of grants and allocations to others, the total expenses, and revenue, if any, for each program service reported.
        ...
        Other program services. (Describe in Schedule O.)
              ...
              <tr style="font-size:7pt;">
                ...
                <td style="width:178mm;border-style:solid; border-color:black; border-left-width:0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 2px">
                  <span style="font-style:bold">
                    <b>Total program service expenses</b>
                    <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>$
        </span>
                  <span style="width:30mm;text-align:right;">
                    <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">1</div>
         ...
         <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">3</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
...
<span class="styItalicText"> If “Yes,” complete Schedule C, Part I</span>
        ...
        Did the organization engage in lobbying activities?
              ...
              <span class="styItalicText"> If “Yes,” complete Schedule C, <br/>Part II</span>
              <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">5</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styBoldText" style="padding-top:0.0mm;">
        Section 501(c)(4), 501(c)(5), and 501(c)(6) organizations.
         ...
         Is the organization subject to the section 6033(e) notice and reporting requirement and proxy tax?
              ...
              <span class="styItalicText">  If “Yes,” complete Schedule C, Part III</span>
              <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:10.5mm;">6</div>
...
<span class="styItalicText">  If “Yes,” complete <br/> Schedule D, Part I</span>
                <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">7</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
...
<span class="styItalicText"> If “Yes,” complete Schedule D, Part II</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">8</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        ...
        <span class="styItalicText"> If “Yes,” complete Schedule D, Part III </span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:10.5mm;">9</div>
            <div class="styLNDesc" style="width:150mm;height:10.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Did the organization report an amount in Part X, line 21; serve as a custodian for amounts not listed in Part
X; or provide credit counseling, debt management, credit repair, or debt negotiation services?<span class="styItalicText"> If “Yes,” <br/>complete Schedule D, Part IV</span>
                <xsl:call-template name="SetFormLinkInline">
    ...
    Did the organization hold assets in term, permanent,or quasi-endowments?
    <span class="styItalicText"> If “Yes,” complete Schedule D, Part V</span>
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:2mm;">10</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/TermOrPermanentEndowments"/>
              </xsl:call-template>
...
<span class="styItalicText"> If “Yes,” complete Schedule D,<br/> Parts VI, VII, VIII, IX, or X as applicable</span>
              </span>
              <!--Dotted Line-->
       ...
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">11</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/BalanceSheetAmountsReported"/>
              </xsl:call-template>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">12</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Did the organization receive an audited financial statement for the year for which it is completing this return <br/> that was prepared in accordance with GAAP?
<span class="styItalicText"> If “Yes,” complete Schedule D, Parts XI, XII, and XIII</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.
       <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$Form990Data/AuditedFinancialStatements"/>
                </xsl:call-template>
              </span>
            </div>
    ...
    <span class="styItalicText"> If “Yes,” complete Schedule E</span>
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:2.5mm;">13</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/School"/>
              </xsl:call-template>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization maintain an office, employees, or agents outside of the U.S.?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.........</span>
            </div>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Did the organization have aggregate revenues or expenses of more than $10,000 from grantmaking, fundraising, business, and program service activities outside the U.S.?
<span class="styItalicText"> If “Yes,” complete Schedule F, Part I</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">14b</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/ForeignActivities"/>
              </xsl:call-template>
...
<span class="styItalicText">  If “Yes,” complete Schedule F, Part II</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..
       <xsl:call-template name="SetFormLinkInline">
...
<span class="styItalicText"> If “Yes,” complete Schedule F, Part III</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..
       <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:5.5mm;">
              <span class="stySmallText" style="padding-top:0.0mm;">
    Did the organization report more than $15,000 on Part IX, column (A), line 11e?
    <span class="styItalicText">  If “Yes,” complete Schedule G, Part I</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">
                <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:5.5mm;padding-top:1.5mm;">17</div>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization report more than $15,000 total on Part VIII, lines 1c and 8a?
    ...
    <span class="styItalicText"> If “Yes,” complete Schedule G, Part III</span>
            ...
            <div class="styLNRightNumBox" style="height:5.5mm;padding-top:1.5mm;">19</div>
            <div class="styIRS990LNYesNoBox" style="height:5.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/Gaming"/>
              </xsl:call-template>
    ...
    <span class="styItalicText"> If “Yes,” complete Schedule H</span>
       ...
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:5.5mm;padding-top:1.5mm;">20</div>
            <div class="styIRS990LNYesNoBox" style="height:5.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/Hospital"/>
              </xsl:call-template>
    ...
    Did the organization report more than $5,000 on Part IX, column (A), line 1?
     <span class="styItalicText">  If “Yes,” complete Schedule I, Parts I and II</span>
            ...
            <div class="styLNRightNumBox" style="height:5.5mm;padding-top:1.5mm;">21</div>
            <div class="styIRS990LNYesNoBox" style="height:5.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/GrantsToOrganizations"/>
              </xsl:call-template>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:5.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization report more than $5,000 on Part IX, column (A), line 2?
    <span class="styItalicText"> If “Yes,” complete Schedule I, Parts I and III</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">23</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Did the organization answer “Yes” to Part VII, Section A, questions 3, 4, or 5?
       ...
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">23</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/ScheduleJRequired"/>
              </xsl:call-template>
...
<span class="styItalicText"> If “Yes,” answer questions 24b–24d and complete Schedule K. If “No,” go to question 25</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">................
       <xsl:call-template name="SetFormLinkInline">
    ...
    Section 501(c)(3) and 501(c)(4) organizations. </span>
       ...
       <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Did the organization become aware that it had engaged in an excess benefit transaction with a disqualified person from a prior year?
<span class="styItalicText"> If “Yes,” complete Schedule L, Part I</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.............
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">25b</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/PriorExcessBenefitTransaction"/>
              </xsl:call-template>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        Was a loan to or by a current or former officer, director, trustee, key employee, highly compensated employee, or disqualified person outstanding as of the end of the organization’s tax year?
...
<span class="styItalicText"> If “Yes,” complete Schedule L, Part III</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:10.5mm;padding-left:4mm;">a</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <!-- <span class="styNormalText" style="padding-top:0.0mm;"> -->
        Have a direct business relationship with the organization (other than as an officer, director, trustee, or employee), or an indirect business relationship through ownership of more than 35% in another entity (individually or collectively with other person(s) listed in Part VII, Section A)?
...
sections 301.7701-2 and 301.7701-3?    <span class="styItalicText">  If “Yes,” complete Schedule R, Part I</span>
    ...
    <span class="styItalicText"> If “Yes,” complete Schedule R, Parts II, III, IV, and V, line 1</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.......................
       <xsl:call-template name="SetFormLinkInline">
    ...
    <span class="styItalicText"> If “Yes,” complete <br/>Schedule R, Part V, line 2</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...................
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">35</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/RelatedOrgControlledEntity"/>
              </xsl:call-template>
...
<span class="styItalicText">  If “Yes,” complete Schedule R, Part VI</span>
          ...
          <div class="styBB" style="width:187mm;float:none;">
            <div class="styPartName" style="float:left;height:4.3mm">Part V</div>
            <div class="styPartDesc" style="float:left;width:152mm;">Statements Regarding Other IRS Filings and Tax Compliance </div>
          </div>
          <div style="width: 187mm">
            <div class="styLNLeftNumBox"/>
            <div class="styLNDesc" style="width: 150mm"/>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">1a</div>
        ...
        Enter the number reported in Box 3 of Form 1096, <span class="styItalicText">Annual Summary and Transmittal of U.S. Information Returns. Enter -0- </span> if not applicable   
            ...
            <div class="styLNRightNumBox" style="height:12.5mm;padding-top:8mm;">1a</div>
            ...
            <div class="styShadingCell" style="width:8mm;height:12.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:12.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:12.5mm;"/>
          </div>
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:4mm;">b</div>
...
if not applicable
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3mm;">1b</div>
            <div class="styLNAmountBox" style="height:7.5mm;padding-right:0.5mm;padding-top:3mm;">
              <xsl:call-template name="PopulateAmount">
        ...
        Did the organization comply with backup withholding rules for reportable payments to vendors and reportable gaming (gambling) winnings to prize winners?  
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:9.5mm;">2a</div>
            <div class="styLNDesc" style="width:110mm;height:9.5mm;">
       Enter the number of employees reported on Form W-3, <span class="styItalicText">Transmittal of Wage and Tax
Statements</span> filed for the calendar year ending with or within the year covered by this return   
                                             <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.....................</span>
            </div>
    ...
    If at least one is reported on line 2a, did the organization file all required federal employment tax returns?</span>
              ...
              <span class="styNormalText" style="padding-top:0.0mm;">
                ...
                <span class="styNormalText"> If the sum of lines 1a and 2a is greater than 250, you may be required to e-file this return. (see
instructions)</span>
              </span>
            </div>
            <div class="styLNRightNumBox" style="height:4.5mm;padding-top:3.5mm;">2b</div>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">3a</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization have unrelated business gross income of $1,000 or more during the year covered by this return?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.............................</span>
              <br/>
            </div>
    ...
    If “Yes,” has it filed a Form 990-T for this year?<span class="styItalicText"> If “No,” provide an explanation in Schedule O</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:10.5mm;">4a</div>
            <div class="styLNDesc" style="width:150mm;height:10.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    At any time during the calendar year, did the organization have an interest in, or a signature or other authority over, a financial account in a foreign country (such as a bank account, securities account, or other financial account)?</span>
        ...
        If "Yes," enter the name of the foreign country: <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
              ...
              <br/>
              <span class="styNormalText" style="padding-top:0.0mm;">
See the instructions for exceptions and filing requirements for Form TD F 90-22.1, Report of Foreign Bank and Financial Accounts.</span>
            </div>
  ...
  Did any taxable party notify the organization that it was or is a party to a prohibited tax shelter transaction?</span>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
 If “Yes,” to question 5a or 5b, did the organization file Form 8886-T, <span class="styNormalText"> Disclosure by Tax-Exempt Entity Regarding Prohibited Tax Shelter Transaction?</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..................</span>
            </div>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
Did the organization solicit any contributions that were not tax deductible?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..........</span>
            </div>
...
Organizations that may receive deductible contributions under section 170(c).</span>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
 Did the organization provide goods or services in exchange for any quid pro quo contribution of more than $75?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............................</span>
            </div>
...
required to file Form 8282?</span>
        ...
        If “Yes,” indicate the number of Forms 8282 filed during the year
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
  Did the organization, during the year, receive any funds, directly or indirectly, to pay premiums on a personal benefit contract?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..........................</span>
            </div>
 ...
 Did the organization, during the year, pay premiums, directly or indirectly, on a personal benefit contract?</span>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
 For all contributions of qualified intellectual property, did the organization file Form 8899 as required?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...</span>
            </div>
            <div class="styLNRightNumBox" style="height:4.5mm;">7g</div>
            <div class="styIRS990LNYesNoBox" style="height:4.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
For contributions of cars, boats, airplanes, and other vehicles, did the organization file a Form 1098-C as required?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............................</span>
            </div>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styBoldText" style="padding-top:0.0mm;">
Section 501(c)(3) and other sponsoring organizations maintaining donor advised funds.</span>
            </div>
            <div class="styShadingCell" style="width:8mm;height:4.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:4.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:4.5mm;"/>
...
If “Yes,” enter the amount of tax-exempt interest received or accrued during the year.
          ...
          <div class="styBB" style="width:187mm;float:none;">
            ...
            <div class="styPartDesc" style="float:left;width:152mm;">Governance, Management, and Disclosure <span class="styItalicText">(Sections A, B, and C request information about policies not required by the Internal Revenue Code.) </span>
            </div>
          </div>
          <div class="styBB" style="width:187mm;float:none;">
...
Section A. Governing Body and Management 
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styItalicText"> For each “Yes” response to lines 2-7b below, and for a “No” response to lines 8 or 9b below, describe the circumstances, process, or changes in Schedule O. See instructions. </span>
            </div>
            <div class="styShadingCell" style="width:8mm;height:7.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
       ...
       Enter the number of voting members of the governing body    
        ...
        Does the organization have members or stockholders?
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;">7a</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
...
Did the organization contemporaneously document the meetings held or written actions undertaken during the year by the following:</span>
      ...
      The governing body?
       ...
       Does the organization have local chapters, branches, or affiliates?   
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;">b</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
        If “Yes,” does the organization have written policies and procedures governing the activities of such chapters, affiliates, and branches to ensure their operations are consistent with those of the organization?
                                           <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">....</span>
            </div>
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">9b</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
        Was a copy of the Form 990 provided to the organization’s governing body before it was filed? All organizations must describe in Schedule O the process, if any, the organization uses to review the Form 990     
                                      <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.....</span>
            </div>
...
Section B. Policies 
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:4.5mm;">12a</div>
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
       Does the organization have a written conflict of interest policy? <span class="styItalicText">If “No,” go to line 13</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.......</span>
            </div>
            <div class="styLNRightNumBox" style="height:4.5mm;">12a</div>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:4mm;">b</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">Are officers, directors or trustees, and key employees required to disclose annually interests that could give
rise to conflicts?
                                            <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...........................</span>
            </div>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:4mm;">c</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">Does the organization regularly and consistently monitor and enforce compliance with the policy? If “Yes,”
...
Did the process for determining compensation of the following persons include a review and approval by independent persons, comparability data, and contemporaneous substantiation of the deliberation and decision:  </span>
       ...
       Other officers or key employees of the organization?
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
Describe the process in Schedule O. (see instructions)</span>
            </div>
            <div class="styShadingCell" style="width:8mm;height:7.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
...
available for public inspection. Indicate how you make these available. Check all that apply.    </div>
          </div>
          <span style="width:2mm;padding-left:8mm;"/>
          <input type="checkbox" class="styCkbox" name="Checkbox" onclick="return false;" id="dummyidexempt">
            <xsl:call-template name="PopulateYesCheckbox">
...
-->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:175mm;height:4.5mm;">
         State the name, physical address, and telephone number of the person who 
         possesses the books and records of the organization: <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
            </div>
          </div>
          <div class="styGenericDiv" style="width:187mm;padding-left:8mm;">
            <xsl:choose>
     ...
     Section A.    Officers, Directors, Trustees, Key Employees, and Highest Compensated Employees 
          ...
          <div class="styLNDesc" style="width:187mm;">
            <span class="styBoldText">1a</span>  Complete this table for all persons required to be listed. Use Schedule J-2 if additional space is needed. <br/>
            <div class="styLNLeftNumBox" style="width:2mm;"/>
           <img src="{$ImagePath}/990_Bullet_Round.gif" alt="RoundBullet"/>
  List all of the organization’s <span class="styBoldText">current</span> officers, directors, trustees (whether individuals or organizations), regardless of amount<br/>
  of compensation, and <span class="styBoldText">current</span> key employees. Enter -0- in columns (D), (E), and (F) if no compensation was paid.</div>
            <br/>
          <div class="styLNDesc" style="width:187mm;">
          <div class="styLNLeftNumBox" style="width:2mm;"/>
          <img src="{$ImagePath}/990_Bullet_Round.gif" alt="RoundBullet"/>
 List the organization’s five <span class="styBoldText">current</span> highest compensated employees (other than an officer, director, trustee or key employee)<br/> who received reportable compensation (Box 5 of Form W-2 and/or Box 7 of Form 1099-MISC) of more than $100,000 from the<br/><span class="styNormalText"><div class="styLNLeftNumBox" style="width:2mm;"/>organization and any related organizations.
 </span>
 </div>
          <br/>
          <div class="styLNDesc" style="width:187mm;">
 ...
 List all of the organization’s <span class="styBoldText">former directors or trustees</span> that received, in the capacity as a former director or trustee of the <br/>organization, more than $10,000 of reportable compensation from the organization and any related organizations.</div>
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styGenericDiv" style="width:180mm;text-align:left;">
              <input type="checkbox" class="styCkbox" name="Checkbox" onclick="return false;" id="dummyidexempt">
                <xsl:call-template name="PopulateCheckbox">
          ...
          <div class="styBB" style="width:187mm;float:none;">
            ...
            <table class="styTable" cellspacing="0">
              <thead class="styTableThead" style="font-size:7pt;border-left-width:0;border-top-width:0;">
                <tr>
                  <th class="styDepTblCell" scope="col" style="width:72mm;border-top-width:0;border-left-width:0;text-align:center;" rowspan="2">
      (A) 
      <br/>
                    <span class="styNormalText"> Name and Title</span>
                  </th>
                  <th class="styDepTblCell" scope="col" style="width:10mm;border-left-width:0;border-top-width:0;text-align:center;" rowspan="2">
      (B) 
      <br/>
                    <span class="styNormalText">Average hours per week</span>
                  </th>
                  <th class="styDepTblCell" scope="col" style="width:30mm;border-left-width:0;border-top-width:0;text-align:center;" colspan="6">
      (C) 
      <br/>
                    <span class="styNormalText"> Position (check all that apply)</span>
                  </th>
      ...
      <br/>
                ...
                <tr>
                  <th class="styIRS990VTImageBox" style="width:5mm;border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px" rowspan="1" valign="middle">
          ...
          <div class="styBB" style="width:187mm;float:none;">
            ...
            <div class="styPartDesc" style="float:left;font-size:7.5pt;width:172mm;">Section A. Officers, Directors, Trustees, Key Employees, and Highest Compensated Employees <span class="styNormalText"> (continued)</span>
            </div>
      ...
      <br/>
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
            <tbody valign="top">
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;border-style: solid;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">1b</td>
          ...
          Total number of individuals (including those in 1a) who received more than $100,000 in reportable compensation from the organization<img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
              <xsl:call-template name="PopulateAmount">
...
the organization and related organizations greater than $150,000?<span class="styItalicText"> If “Yes,” complete Schedule J for such individual</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:4.5mm;">5</div>
            <div class="styLNDesc" style="width:150mm;height:4.5mm;">
          Did any person listed on line 1a receive or accrue compensation from any unrelated organization for services rendered to the organization?<span class="styItalicText"> If “Yes,” complete Schedule J for such person </span>
              <!-- Dotted Line -->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:8pt; margin-left:2mm;">..........</span>
            </div>
            <div class="styShadingCell" style="width:8mm;height:4.5mm;"/>
        ...
        Section B. Independent Contractors 
          ...
          <table class="styTable" cellspacing="0" style="width:187mm;border-color:black">
            ...
            <tbody>
              ...
              Total number of independent contractors (including those in 1) who received more than $100,000 in compensation from the organization  <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                  <xsl:call-template name="PopulateAmount">
  ...
  512, 513, or 514 
              ...
              <!-- 1c -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;padding-left:3mm;">c</td>
                <td class="styGenericDiv" colspan="2" style="width:50mm;height:4.5mm;">
              ...
              <!-- 1e -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;padding-left:3mm;">e</td>
                <td class="styGenericDiv" colspan="2" style="width:50mm;height:4.5mm;">
                ...
                <!-- 1f -->
                <tr/>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;padding-left:3mm;">f</td>
                <td class="styGenericDiv" colspan="2" style="width:50mm;height:4.5mm;">
  ...
  <span style="width:25mm;height:4.5mm;font-size:6pt;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
              ...
              <!-- 1h -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
  ...
  <span class="styNormalText">Add lines 1a-1f</span>
              ...
              <xsl:for-each select="$Form990Data/ProgramServiceRevenue">
                <tr>
                  <xsl:if test="position()=1">
                    <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">2a</td>
                  </xsl:if>
                  <xsl:if test="position()!=1">
   ...
   <span class="styTableCellPad"/>
              ...
              <tr>
                ...
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">3</td>
                <td class="styLNDesc" colspan="3" style="width:72mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">Investment income (including dividends, interest</td>
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;">
                  <span class="styTableCellPad"/>
                </td>
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;">
              ...
              <!-- Line 4 -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;">4</td>
              ...
              <!-- 5 -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;">5</td>
                <td class="styLNDesc" colspan="3" style="width:72mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
              ...
              <!-- 6a -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">6a</td>
                <td class="styGenericDiv" style="width:17mm;height:4.5mm;">
  Gross Rents 
  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
                </td>
  ...
  Rental income or (loss)   
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">7a</td>
                <td class="styGenericDiv" style="width:17mm;height:4.5mm;font-size:6pt;">
  ...
  Gain or (loss)   
              ...
              <!-- 8a -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">8a</td>
...
<!-- This element is the second of two but according to TEGE and Schema person it should go on the line -->
  ...
  <span class="NormalText"> See Part IV, line 18 <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">...</span>
                ...
                <td class="styTableCell" style="width:25mm;height:10.5mm;font-size:6pt;border-bottom-width:0px;">
                  <span class="styTableCellPad"/>
                </td>
  ...
  c 
              ...
              <!-- 9a -->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;">9a</td>
                <td class="styLNDesc" colspan="2" style="width:52mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
...
<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
  ...
  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.......</span>
              ...
              <!--12-->
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:10.5mm;padding-top:.3mm;">12</td>
                <td class="styLNDesc" colspan="3" style="width:72mm;height:10.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
                  <span class="styBoldText" style="float:left;">Total Revenue.</span> Add lines 1h, 2g, 3, 4, 5, 6d, 7d, 8c, 
  <span class="styNormalText" style="float:left;">9c, 10c, and 11e</span>
                  <span style="float:left;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">......</span>
                  <span style="float:right;padding-right:.5mm;">
                    <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                  </span>
                  <td class="styTableCell" style="width:25mm;height:7.5mm;font-size:6pt;">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
         ...
         <div class="styBB" style="width:187mm;clear:both;border-top-width:1px;"/>
          ...
          <div class="styBB" style="width:187mm;float:none;height:1mm;">
            <div class="styGenericDiv" style="width:187mm;">
              <span style="width:170mm;font-size: 7pt; font-weight:bold;padding-left:37mm;">Section 501(c)(3) and 501(c)(4) organizations must complete all columns. </span>
              <span style="width:187mm;font-size: 7pt; font-weight:bold;padding-left:5mm;">All other organizations must complete column (A) but are not required to complete columns (B), (C), and (D).          
        </span>
            </div>
          </div>
          <!-- END Part IX Title -->
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
            ...
            <tbody valign="top">
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:9mm;padding-left:2mm;">1</td>
...
organizations in the U.S. See Part IV, line 21 
        <xsl:call-template name="SetFormLinkInline">
                ...
                <td class="styShadingCell" style="width:26mm;height:9mm;">
                  <span style="width:1px"/>
                </td>
                <td class="styShadingCell" style="width:26mm;height:9mm;">
                  <span style="width:1px"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:9mm;padding-left:2mm;">2</td>
...
the U.S. See Part IV, line 22 
        <xsl:call-template name="SetFormLinkInline">
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">3</td>
...
See Part IV, lines 15 and 16
       <!-- </span>-->
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">4</td>
                <td class="styLNDesc" style="width:69mm;height:4.5mm;">
       Benefits paid to or for members
        <span style="width:1px"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">5</td>
...
trustees, and key employees
        <span style="width:1px"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">6</td>
                <td class="styLNDesc" style="width:79mm;height:4.5mm;">
...
persons described in section 4958(c)(3)(B)
        <span style="width:1px"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">7</td>
       ...
       Other salaries and wages<span style="width:1px"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">8</td>
...
and section 403(b) employer contributions)
        <!--Dotted Line-->
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:6mm;height:4.5mm;padding-left:2mm;">9</td>
                <td class="styLNDesc" style="width:79mm;height:4.5mm;">
   Other employee benefits  
        ...
        <!--Dotted Line-->
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:69mm;height:4.5mm;">
        Professional fundraising. <span class="styItalicText">See Part IV, line 17</span>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">..</span>
                </td>
                <td class="styLNAmountBoxSmall" style="width:26mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
       ...
       Depreciation, depletion, and amortization
        ...
        Insurance
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:104mm;height:4.5mm;">
        Other expenses. Itemize expenses not covered above. (Expenses grouped together
and labeled miscellaneous may not exceed 5% of total expenses shown on line 25 below.)       
 <xsl:call-template name="SetFormLinkInline">
              ...
              <tr>
                ...
                <td class="styIRS990LNDescBB" style="width:69mm;height:4.5mm;font-size:7pt;padding-bottom:3;">
                  <span class="styBoldText">Total functional expenses.</span> Add lines 1 through 24f
     </td>
                <td class="styLNAmountBoxSmall" style="width:26mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styIRS990LNDescBB" style="width:79mm;height:9mm;font-size:7pt;padding-bottom:0;">
                  ...
                  <span class="styNormalText"> Check here <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                  </span>
                  <span style="width:6px;"/>
                  <input type="checkbox" class="styCkbox" name="Checkbox">
                    <xsl:call-template name="PopulateCheckbox">
  ...
  if following SOP 98-2. Complete this line only if the organization reported in column (B) joint costs from a combined educational campaign and fundraising solicitation
     </td>
                <td class="styLNAmountBoxSmall" style="width:26mm;height:9mm;vertical-align:bottom;padding-right:0.75mm;">
                  <xsl:call-template name="PopulateText">
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
            <thead>
              <tr scope="col">
                <th class="styBB" colspan="8" style="">
              ...
              <tr scope="col" style="border-bottom:1 solid black;">
                <th colspan="2" class="styBB" style="padding-bottom:3mm;width:13mm;">
                  <span class="styTableCellPad"/>
                </th>
                <th colspan="3" class="styBB" style="width:100mm;">
                  <span class="styTableCellPad"/>
                </th>
            ...
            <tbody valign="top">
              ...
              <tr>
                ...
                <td class="styIRS990VTImageBox" rowspan="17" valign="middle">
   ...
   Receivables from current and former officers, directors, trustees, key employees or other related parties. <span class="styItalicText">Complete Part II of Schedule L</span>
                  <span style="width:2px;"/>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">......</span>
                </td>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:125mm;height:4.5mm;" colspan="3">
  Receivables from other disqualified persons (as defined under section 4958(f)(1)) and persons described in section 4958(c)(3)(B). <span class="styItalicText">Complete Part II of Schedule L</span>
                  <span style="width:2px;"/>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
                </td>
            ...
            Less: accumulated depreciation. <span class="styItalicText">Complete Part VI of Schedule D</span>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                  <span style="width:2px;"/>
                </td>
 ...
 <!--Dotted Line-->
            ...
            <!--Dotted Line-->
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:95mm;height:4.5mm;border-bottom: solid black 1px;" colspan="3">
            ...
            Tax-exempt bond liabilities
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">
            Escrow account liability. <span class="styItalicText">Complete Part IV of Schedule D</span>
                  <span style="width:2px;"/>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                </td>
            ...
            Payables to current and former officers, directors, trustees, key<br/> employees, highest compensated employees, and disqualified <span style="width:2px;"/>
                </td>
                <td class="styLNAmountBoxNBB" style="height:4.5mm;background-color:lightgrey;">
                  <span style="width:1px;"/>
                </td>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">
            persons. <span class="styItalicText">Complete Part II of Schedule L</span>
                  <span style="width:2px;"/>
                  <!--   Dotted Line -->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">..........</span>
                </td>
            ...
            <span style="width:2px;"/>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">Unsecured notes and loans payable
            <span style="width:2px;"/>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                </td>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">
            Other liabilities. <span class="NormalText">Complete Part X of Schedule D</span>
                  <span style="width:2px;"/>
                  <!--Dotted Line-->
                  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                </td>
              ...
              <tr>
                ...
                <td class="styLNLeftNumBox" style="height:4.5mm;"/>
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">
                  <span class="styBoldText">Organizations that follow SFAS 117, <span>check here <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                      <span style="width:2mm;"/>
                      <input type="checkbox" class="styCkbox" name="Checkbox">
                        <xsl:call-template name="PopulateCheckbox">
 ...
 and complete lines 27 through 29, and lines 33 and 34.</span>
            ...
            <span style="width:2px;"/>
              ...
              <tr>
                <td class="styLNLeftNumBox" style="height:4.5mm;"/>
                <td class="styLNDesc" style="width:105mm;height:4.5mm;" colspan="3">
                  <span class="styBoldText">Organizations that do not follow SFAS 117, <span>check here <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                      <span style="width:2mm;"/>
                      <input type="checkbox" class="styCkbox" name="Checkbox">
                        <xsl:call-template name="PopulateCheckbox">
 ...
 and complete lines 30 through 34.
          ...
          <!-- End Part X Table-->
          <!-- BEGIN PART XI FINANCIAL STATEMENTS AND REPORTING-->
          <div class="styBB" style="width:187mm;clear:both;border-top-width:1px;">
            <div class="styPartName" style="width:15mm; height:4.5mm">Part XI</div>
            <div class="styPartDesc" style="width:171mm;">
      Financial Statements and Reporting
        ...
        Were the organization’s financial statements audited by an independent accountant?</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;">c</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
        If “Yes” to 2a or 2b, does the organization have a committee that assumes responsibility for oversight of the
audit, review, or compilation of its financial statements and selection of an independent accountant?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...</span>
            </div>
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">2c</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
...
the Single Audit Act and OMB Circular A-133?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...................</span>
            </div>
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">3a</div>
      ...
      others, the total expenses, and revenue, if any, for each program service reported.</th>
          ...
          <!-- Begin Part VIII - Statement of Revenue - 2a - Program Service Revenue -->
          ...
          <!-- Begin Part IX - Statement of Functional Expenses - 24a - 24e Other Expenses-->

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/CreditCardClaimStatement" />
  ...
  <xsl:template name="CreditCardClaimStatementTemp">

  <table id="GeneralDependencyTbl" class="styDepTbl">
    <tr class="styDepTblHdr">
      <th class="styDepTblCell" style="width:93mm;">Amount of Claim</th>
      <th class="styDepTblCell" style="width:93mm;">CRN</th>
    </tr>
      ...
      <tr>
        ...
        <td class="styDepTblCell" style="text-align:right;font-size:7pt">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="AmountOfClaim" />
          </xsl:call-template>
        </td>
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="CreditCardClaimStatementTemp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

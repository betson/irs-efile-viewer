...
<!--Created by Sandy Mathews  12-17-2007     Using Schema 2008v2.0    and PDF  dated 12/19/07 -->
...
<!-- BEGIN FORM HEADER -->
      <div class="styTBB" style="width:187mm;">
        ...
        <div class="styFTBox" style="width:122mm;height:22mm;">
          <div class="styMainTitle" style="height:11mm;padding-top:1mm;padding-bottom:2mm;">
            Supplemental Information Regarding<br />
            Fundraising or Gaming Activities
          </div>
          <div class="styFBT" style="margin-top:0mm;font-weight:bold;padding-bottom:1mm;padding-top:1mm;" >
     ...
     <div class="styNBB" style="width:187mm">
       <div class="styLNLeftNumBox" style="font-weight:bold;padding-top:.75mm;width:7.5mm;">1</div>
        <div style="float:left; width:178mm; padding-bottom:0.5mm;padding-top:1mm;">
          Indicate whether the organization raised funds through any of the following activities. Check all that apply.</div>
          </div> 
            
            <div class="styBB" style="width:187mm;">
        <div class="styGenericDiv" style="width:10px;padding-top:.5mm;"></div>
           <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
           <span class="styBoldText">a</span>
            ...
            <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/MailSolicitations"/>
                </xsl:call-template>Mail solicitations</label>
            </div>
            ...
            <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
              ...
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/SolicitationOfNonGovtGrants"/>
                </xsl:call-template>Solicitation of non-government grants</label>
                  </div>
                    
            <div class="styGenericDiv" style="width:10px;padding-top:.5mm;"/>
            <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
              ...
              <span style="width:9.5px;"/>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EmailSolicitations"/>
                </xsl:call-template>Email solicitations</label>
            </div>
            ...
            <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
              ...
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/SolicitationOfGovtGrants"/>
                </xsl:call-template>Solicitation of government grants</label>
            </div>
        ...
        <div class="styGenericDiv" style="width:10px;padding-top:.5mm;"></div>
           ...
           <span class="styBoldText">c</span>
            ...
            <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PhoneSolicitations"/>
                </xsl:call-template>Phone solicitations</label>
            </div>
            ...
            <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
              ...
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/SpecialFundraisingEvents"/>
                </xsl:call-template>Special fundraising events</label>
                </div>
            ...
            <div class="styGenericDiv" style="width:92mm;padding-top:.5mm;">
              ...
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/InPersonSolicitations"/>
                </xsl:call-template>In-person solicitations</label>
            </div>
...
<div class="IRS990ScheduleG_LineContainer">
  ...
  <div class="IRS990ScheduleG_LineDesc" style="width:150mm;border-right-width:0px;">
    or key employees listed in Form 990, Part VII) or entity in connection with professional fundraising activities?
    </div>
 ...
 <div class="IRS990ScheduleG_TableContainer" style="border-top-width: 0px" id="P1ctn"> 
   ...
   <table class="styTable" cellspacing="0" cellpadding="0" style="font-size:7pt;overflow-y:auto;">
     <thead class="styTableThead">
      ...
      <tr>
        <th class="IRS990ScheduleG_TableCell" style="width:42mm;font-weight:normal;font-size:7pt;text-align:center;" scope="col" rowspan="2">
          <b>(i)</b> Name of individual <br /> or entity (fundraiser)
        </th>
        <th class="IRS990ScheduleG_TableCell" style="width:27mm;text-align:center;font-size:7pt;font-weight:normal;" scope="col" rowspan="2"><span style="font-weight:bold;">(ii)</span> Activity</th>
        <th class="IRS990ScheduleG_TableCell" style="width:22mm;text-align:center;font-size:7pt;font-weight:normal;" scope="col" colspan="2"><span style="font-weight:bold;" colspan="2" >(iii)</span> Did fundraiser have custody or control of contributions?</th>
        <th class="IRS990ScheduleG_TableCell" style="width:32mm;text-align:center;font-size:7pt;font-weight:normal;" scope="col" rowspan="2"><span style="font-weight:bold;">(iv)</span> Gross receipts <br />  from activity</th>
        <th class="IRS990ScheduleG_TableCell" style="width:32mm;text-align:center;font-size:7pt;font-weight:normal;" scope="col" rowspan="2"><span style="font-weight:bold;">(v)</span> Amount paid to <br/>(or retained by)<br/> fundraiser listed in <br/>col. <b>(i)</b></th>
        <th class="IRS990ScheduleG_TableCell" style="width:32mm;border-right-width:0px;text-align:center;font-size:7pt;font-weight:normal;" scope="col" rowspan="2"><span style="font-weight:bold;">(vi)</span> Amount paid to <br />  (or retained by) <br /> organization</th>
      </tr>
      <tr>
        <th class="IRS990ScheduleG_TableCell" style="width:11mm;font-size:7pt;border-right-width:1px;text-align:center" scope="col">Yes</th>
        <th class="IRS990ScheduleG_TableCell" style="width:11mm;font-size:7pt;border-right-width:1px;text-align:center" scope="col"  >No</th>
      </tr>
      </thead>    
      <tfoot></tfoot>
      <tbody>
  ...
  <!--  LINE 3  -->
   ...
   <!-- BEGIN TABLE FOR LicensedStates   PART I  -->
<!-- Test for size of LicensedStates collection, don't display table expand / colapse toggle button if not needed -->
<!--<xsl:if test="$StatesSize&gt; $RowsToShow">-->
...
<div style="width:187mm;">
      <div class="styLNLeftNumBox" style="font-weight:bold;width:5mm;padding-top:1.5mm;">3</div>
      <div class="styLNDesc" style="width:180mm;padding-left:2mm;padding-top:1.5mm;clear:both;float:right;"> List all states in which the organization is registered or licensed to solicit funds or has been notified it is exempt from registration or licensing.
     </div>
   </div>


<div class="IRS990ScheduleG_TableContainer" id="Part1">
  <xsl:call-template name="SetInitialState"/>
  <table cellspacing="0" class="styTable" cellpadding="0">
  <thead class="styTableThead">  
    <tr>
      <th class="styTableCell" scope="col" style="width:187mm;border-right-width:0px;text-align:center;font-size:7pt;font-weight:normal;border-color:black;padding-left::4mm;"></th>
   </tr>
  </thead>      
  <tbody>
    <xsl:if test="($Print = $Separated) and (count($Form990ScheduleGData/LicensedStates) &gt; 60) ">
      ...
      <xsl:call-template name="EmptyIteratorTemp">
        <xsl:with-param name="NumEmptyRows" select="$RowsToShow - $StatesSize" />
        <xsl:with-param name="TempToCall" select="'StatesTemp'" />
      </xsl:call-template>
    </xsl:if>
    <xsl:if test="($Print != $Separated) or (count($Form990ScheduleGData/LicensedStates) &lt; 60) "> 
     <xsl:for-each select="$Form990ScheduleGData/LicensedStates">
     <xsl:call-template name="PopulateText">
        <xsl:with-param name="TargetNode" select="." />
      </xsl:call-template><xsl:if test="position()!=last()"><span style="width: 2px;">, </span></xsl:if>
      </xsl:for-each>
...
<div class="pageEnd" style="width:187mm;float:none;clear:both;">
   ...
   <div style="font-weight:bold;width:95mm;font-size:6.5pt;padding-top:1mm;float:left;border-top-width:0px;">
      For Paperwork Reduction Act Notice, see the Instructions for Form 990.</div>
    <div style="width:33mm;padding-left:9mm;padding-top:1mm;font-size:6.5pt;float:left;">
      Cat. No. 50083H
    </div>
    <div style="width:58mm;font-size:6.5pt;text-align:right;padding-top:1mm;float:right;font-weight:bold;">Schedule G (Form 990 or 990-EZ) 2008</div>
  </div>
 
 
     <!-- PAGE 2 HEADER  -->
 <div class="styBB" style="width:187mm; padding-bottom:.5mm;">  
    <div style="float:left;">Schedule G (Form 990 or 990-EZ) 2008</div>
...
<!--  BEGIN  PART II   EVENTS  -->
  ...
  <thead >
    ...
    <!-- Begin Part II Table-->
       ...
       <b>(a)</b> <span class="styNormalText"> Event #1</span><br /><br />
       ...
       <th class="styLNAmountBox" scope="col" style=" width:32mm;vertical-align:top;padding-top:.5mm;text-align:center;" >
        <b>(b)</b><span class="styNormalText"> Event #2</span><br /><br />
           <span class="styIRS990ScheduleGUnderlinedBox" style="text-align:left;">
           <xsl:call-template name="PopulateText">
        ...
        <b>(c)</b><span class="styNormalText"> Other Events<br/><br/></span>
        ...
        <b>(d)</b><span class="styNormalText"> Total Events<br />(Add col. <b>(a) </b>through col. <b>(c)</b>)</span>
      </th>
              </tr>
            </thead>
            <tfoot/>
      ...
      <!--   BEGIN PART II  LINE 1   -->
       ...
       <tr>
         ...
         <img src="{$ImagePath}/990SchG_Revenue.gif" alt="VerticalRevenue"/></td>
    <td>
          <span class="styLNLeftLtrBox" style="width: 5mm;text-align:left;padding-left:1.25mm;">1</span>
        </td>
      
                <td class="styLNDesc" style="width: 50mm;padding-top:3mm;border-bottom-width:1px;">Gross receipts 
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/GrossReceiptsOtherEvents" /></xsl:call-template></td>      
     ...
     <tr>
         <td>
             <span class="styLNLeftLtrBox" style="width: 5mm;text-align:left;padding-left:1mm;">2</span>
                ...
                <td class="styLNDesc" style="width: 50mm">Less: Charitable<br/>contributions
           <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
       ...
       <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode"
               select="$Form990ScheduleGData/EventsInformation/CharitableContributionsEvent1" />
              </xsl:call-template>
        </td>                 
        
       <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/CharitableContributionsEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount">
     ...
     <tr>
      <td style="border-color:black; border-style:solid; border-bottom-width: 1px; border-top-width: 0px; border-left-width: 0px; border-right-width: 0px">
                ...
                <td class="styLNDesc" style="border-color: black; border-style:solid; border-left-width: 0px; border-right-width: 0px; height:5mm;border-top-width: 0px; width: 50mm; border-bottom-width: 1px">Gross revenue (line 1 <br/>minus line 2)
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
    ...
    <td class="styLNAmountBox" style="width:32mm;text-align:right;height:5mm;" > 
                <xsl:call-template name="PopulateAmount">
      ...
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > 
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/GrossRevenueEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" >
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/GrossRevenueOtherEvents" />
        </xsl:call-template>
</td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
        <xsl:call-template name="PopulateAmount">
 ...
 <!--   PART II  Lines 4 - 9 -->   
  ...
  <tr>
        <td class="styIRS990ScheduleGVTImageBox" rowspan="6" style="width: 6mm; padding-top:7mm;border-bottom-width:0px;" ><img src="{$ImagePath}/990SchG_DirectExpenses.gif" alt="VerticalDirectExpenses"/></td>

    <td>
             <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">4</span>
        </td>
            <td class="styLNDesc" style="width: 50mm;padding-top:2mm;">Cash Prizes
           <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
      ...
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > 
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/CashPrizesEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" >
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/CashPrizesOtherEvents" />
        </xsl:call-template>
</td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
        <xsl:call-template name="PopulateAmount">
 ...
 <!-- PART II   Line 5 -->  
  ...
  <td>
       ...
       <td class="styLNDesc" style="width: 50mm;padding-top:2mm;">Non-cash Prizes
           <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
      ...
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
       <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode"
               select="$Form990ScheduleGData/EventsInformation/NonCashPrizesEvent1" />
              </xsl:call-template>
</td>      
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/NonCashPrizesEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount">
...
<!-- PART II   Line 6 -->
 ...
 <tr>
      <td>
       ...
       <td class="styLNDesc" style="width: 50mm;padding-top:2mm;">Rent/Facility costs
           <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
     ...
     <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      ...
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/RentFacilityCostsEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/RentFacilityCostsOtherEvents" />
        </xsl:call-template>
</td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
        <xsl:call-template name="PopulateAmount">
    ...
    <tr>
      <td>
       ...
       <td class="styLNDesc" style="width: 50mm;padding-top:2mm;">Other direct expenses
           <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
     ...
     <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      ...
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/OtherDirectExpensesEvent2" />
        </xsl:call-template>
</td>
      <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
       <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/EventsInformation/OtherDirectExpensesOtherEvents" />
        </xsl:call-template>
</td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
        <xsl:call-template name="PopulateAmount">
   ...
   <!--  PART II  Line 8  -->
       <tr>
      <td>
          <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:3mm;text-align:left;padding-left:1.25mm;">8</span>
    </td>
        <td style="height:7mm;padding-top:3mm;" colspan="4"><span class="styNormalText" style="font-size:7pt;">Direct expense summary. Add lines 4 through 7 in column (d) </span>          
        <span class="IRS990ScheduleG_Dotspacing">........... </span>
       <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
         </td>
     <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
    ...
    <!--  PART II  Line 9  -->
       <tr>
      <td>
          <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:.5mm;text-align:left;padding-left:1.25mm;">9</span>
    </td>
        <td style="height:4mm;padding-top:.5mm;" colspan="4"><span class="styNormalText" style="font-size:7pt;">Net income summary. Combine lines 3 and 8 in column (d)</span>          
        <span class="IRS990ScheduleG_Dotspacing">............ </span>
       <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
         </td>
     <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;border-bottom-width:0px;">
        <xsl:call-template name="PopulateAmount">
 ...
 <!--</form>   -->
  ...
  <thead >
    <div class="styBB" style="width:187mm;border-top-width:2px;">
      ...
      <div class="styPartDesc" style="width:170mm;padding-bottom:.5mm;"><b>Gaming. </b> <span class="styNormalText">Complete if the organization answered "Yes" to Form 990, Part IV, line 19, or reported more than $15,000 on Form 990-EZ, line 6a. </span></div>
</div>

      <tr>
      
             <th class="styIRS990ScheduleGVTImageBox" style="width:6mm;padding-top:1mm;border-bottom-width:0px;" rowspan="2" scope="col">
         <img src="{$ImagePath}/990SchG_Revenue.gif" alt="VerticalRevenue"/></th>
            <th colspan="2" >
                  <span style="width: 1px;"/>
                </th>               
            <th class="styLNAmountBox" scope="col" style="width:32mm; border-right-width: 0px;vertical-align:top;text-align:center;padding-top:1mm;" >
        <b>(a)</b><span class="styNormalText"> Bingo</span>
           ...
           <th class="styLNAmountBox" scope="col" style="width:32mm; border-right-width: 0px;vertical-align:top;text-align:center;padding-top:1mm;" >
        <b>(b)</b><span class="styNormalText"> Pull tabs/Instant<br />bingo/progressive <br/>bingo</span>
      </th>
        ...
        <b>(c)</b><span class="styNormalText"> Other gaming</span>
           ...
           <th class="styLNAmountBox" scope="col" style="font-size:6.25pt;width:32mm; border-right-width: 0px;vertical-align:top;text-align:center;padding-top:1mm;">
        <b>(d)</b><span class="styNormalText"> Total gaming (Add<br />col. <b>(a)</b> through col. <b>(c)</b>)</span>
      </th>
     </tr>
    </thead>
    <tfoot/>
   <tbody valign="top">
     ...
     <td style="border-color:black; border-style:solid; border-bottom-width: 1px; border-top-width: 0px; border-left-width: 0px; border-right-width: 0px">
        ...
        <td class="styLNDesc" style="border-color: black; border-style:solid; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; width: 50mm; border-bottom-width: 1px">Gross revenue 
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/GrossRevenueOtherGaming" /></xsl:call-template></td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px; text-align:right;">
        <xsl:call-template name="PopulateAmount">
...
<!--  PART III   Line 2  -->
     <tr>
         ...
         <img src="{$ImagePath}/990SchG_DirectExpenses.gif" alt="VerticalDirectExpenses"/></td>
              <td>
                  <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">2</span>  </td>
            <td class="styLNDesc" style="width: 50mm;padding-top:2mm;border-bottom-width:1px;">Cash prizes
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/CashPrizesOtherGaming" /></xsl:call-template></td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px; text-align:right;">
        <xsl:call-template name="PopulateAmount">
    ...
    <!--  PART III   Line 3  -->
     <tr>
          <td>
            <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">3</span>        </td>
            <td class="styLNDesc" style="width: 50mm;padding-top:2mm;border-bottom-width:1px;">Non-cash prizes
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/NonCashPrizesOtherGaming" /></xsl:call-template></td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px; text-align:right;">
        <xsl:call-template name="PopulateAmount">
    ...
    <!--  PART III   Line 4  -->
     <tr>
          <td>
            <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">4</span>        </td>
            <td class="styLNDesc" style="width: 50mm;padding-top:2mm;border-bottom-width:1px;">Rent/facility costs
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/RentFacilityCostsOtherGaming" /></xsl:call-template></td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px; text-align:right;">
        <xsl:call-template name="PopulateAmount">
      ...
      <tr>
            <td style="border-color:black; border-style:solid; border-bottom-width: 1px; border-top-width: 0px; border-left-width: 0px; border-right-width: 0px">
            <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">5</span>  </td>
                 <td class="styLNDesc" style="border-color: black; border-style:solid; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; width: 50mm; border-bottom-width: 1px;padding-top:2mm;">Other direct expenses
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
          </b>
              ...
              <td class="styLNAmountBox" style="width: 32mm;">
               ...
               <td class="styLNAmountBox" style="width:32mm;text-align:right;" > <span class ="styTableCellPad"></span>
      <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/OtherDirectExpensesOtherGaming" /></xsl:call-template></td>      
      <td class="styLNAmountBox" style="width:32mm; border-right-width:0px; text-align:right;">
        <xsl:call-template name="PopulateAmount">
      ...
      <!--  PART III   Line 6   Yes/No boxes for Line 6 -->
       <tr>
               <td style="width: 6mm; border-color: black; border-style: solid; border-right-width: 1px; border-left-width: 0px; border-bottom-width: 0px; border-top-width: 0px">
                ...
                <td>
                 <span class="styLNLeftLtrBox" style="width: 5mm;padding-top:2mm;text-align:left;padding-left:1.25mm;">6</span>  </td>
            <td class="styLNDesc" style="width: 50mm;padding-top:2mm;border-bottom-width:1px;">Volunteer labor
          <b>
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
            <span class="styNBSP"/>.
             ...
             <!-- Line 6  col a  -->
              <td class="styLNAmountBox" style="float:left;width: 32mm;height:8mm;padding-left:0mm;padding-right:2mm;">
          ...
          Yes
            ...
            <span  class="styIRS990ScheduleGUnderlinedText" style="padding-right:1mm;text-align: right;width:17mm;">  
          <xsl:call-template name="PopulatePercent">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/VolunteerLaborPercentageBingo" />
                </xsl:call-template></span>
             <span style="width: 1mm"></span>
                       
             <span style="float:left;padding-left:2mm;padding-top:.5mm;">
                    <xsl:call-template name="PopulateSpan">
                       <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/VolunteerLaborBingo"/>
                      </xsl:call-template>
                        <input type="checkbox" class="styCkbox" name="Checkbox">
             ...
             <span style="width:19mm;padding-right:1mm;" />
        </td>
                
        
          <!-- Line 6  col b  -->        
         <td class="styLNAmountBox" style="width: 32mm;padding-right:1mm;">
             <span style="padding-right:1mm;">
                <xsl:call-template name="PopulateSpan">
        ...
        <!--   Line 6 col c  -->        
         <td class="styLNAmountBox" style="width:33mm;padding-right:1.5mm;border-right-width:1px;" > 
                 <span style="padding-right:1mm;">
                <xsl:call-template name="PopulateSpan">
          ...
          <xsl:call-template name="PopulatePercent">
            ...
            <td class="styShadingCell" style="width:32mm;height:6mm; border-right-width:0px;border-bottom-width:1px;border-color:black; ">
            <!-- <xsl:call-template name="PopulateAmount">
             <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformation/OtherDirectExpensesTotalGaming" />
            </xsl:call-template>-->
          </td>
       ...
       <tr>
        ...
        <td style="height:7mm;padding-top:3mm;" colspan="4"><span class="styNormalText" style="font-size:7pt;">Direct expense summary. Add lines 2 through 5 in column (d) </span>          
        <span class="IRS990ScheduleG_Dotspacing">............ </span>
       <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
         </td>
     ...
     <!--  PART III   Line 8  -->
       ...
       <tr>
        ...
        <td class="styBB" style="padding-top:3mm;" colspan="4"><span class="styNormalText" style="font-size:7pt;">Net gaming income summary. Combine lines 1 and 7 in column (d) </span>          
        <span class="IRS990ScheduleG_Dotspacing">........... </span>
       <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
         </td>
     <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;">
  ...
  <div class="IRS990ScheduleG_LineIndexMid" style="border-top-width:0px;width:8mm;padding-top:.25mm;border-bottom-width:0px;height:4mm;"></div>
  <div class="IRS990ScheduleG_LineIndexMid" style="border-top-width:0px;width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;font-size:7pt;">Yes</div>
  <div class="IRS990ScheduleG_LineIndexMid" style="border-right-width:0px;width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;font-size:7pt;border-top-width:0px;">No</div>
</div>
     
     <!-- LINE 9  -->
 <div style="width:187mm;">
      <div class="styLNLeftNumBox" style="height:2mm;padding-bottom:.5mm;padding-left:1mm;font-size:7pt;">9</div>
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:.5mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
          Enter the state(s) in which the organization operates gaming activities: </span>
           <span class="styIRS990ScheduleGUnderlinedText" style="font-size: 7pt; width:50mm;text-align: left">
           
         <xsl:if test="($Print = $Separated) and (count($Form990ScheduleGData/StatesWhereGamingConducted) &gt;10)">
              <xsl:call-template name="PopulateAdditionalDataTableMessage">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/StatesWhereGamingConducted" />
                </xsl:call-template>
                 </xsl:if>
            <xsl:if test="($Print != $Separated) or (($Print = $Separated) and (count($Form990ScheduleGData/StatesWhereGamingConducted) &lt;11))">
                        <xsl:for-each select="$Form990ScheduleGData/StatesWhereGamingConducted">
                        <xsl:call-template name="PopulateText">
                         <xsl:with-param name="TargetNode" select="." />
                          </xsl:call-template>
                          <xsl:if test="position()!=last()">, <span style="width: 1mm"></span>    
                            </xsl:if>
            </xsl:for-each>
                      </xsl:if>
              </span>
     </div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:1px;"></div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:1px;"></div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:1px;"></div>
    </div></div>
    ...
    <!-- Line 9a  -->
      ...
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:.25mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
           Is the organization licensed to operate gaming activities in each of these states?<span style="letter-spacing:3mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............</span>
        </span></div>
           <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;width:8.25mm;border-left-width:1px;padding-top:1mm;font-size:7pt;"><b>9a</b></div>
  <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;padding-top:1mm;font-size:7pt;">
  ...
  <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;width:7.5mm;padding-top:1mm;border-right-width:0px;border-bottom-width:1px;fong-size:7pt;">
     <span style="font-weight: normal;">
         <xsl:call-template name="PopulateNoBoxText">
        <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/Licensed"/>
      </xsl:call-template>
...
<!--  Line 9b  --> 
  <div style="width:187mm">
     <div class="styLNLeftNumBox" style="height:3mm;padding-left:3mm;">b</div>
       <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:.25mm;padding-bottom:0mm;">
         If "No," Explain:
     </div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;height:100%;"></div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;height:100%;"></div>
      <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;height:100%;"></div>

      <div class="IRS990ScheduleG_LineContainer" style="height:4mm">
      <div class="IRS990ScheduleG_LineIndex"></div>
      <div class="IRS990ScheduleG_LineDesc" style="width:155mm;border-bottom-style:solid;border-bottom-width:1px;border-right-width:0px;">
       <xsl:call-template name="PopulateText">
 ...
 <xsl:if test="string-length($Form990ScheduleGData/ExplanationIfNo) &lt;1">
   <div class="IRS990ScheduleG_LineContainer">
    <div class="IRS990ScheduleG_LineIndex"></div>
    <div class="IRS990ScheduleG_LineDesc" style="width:155mm;border-bottom-style:solid;border-bottom-width:1px;"></div>
    <div class="styShadingCell" style="width:8mm;height:3mm;height:100%;padding-bottom:1mm;border-top-width:0px;"></div>
    <div class="styShadingCell" style="width:8mm;height:3mm;height:100%;padding-bottom:1mm;border-top-width:0px;"></div>
    <div class="styShadingCell" style="width:8mm;height:3mm;height:100%;padding-bottom:1mm;border-top-width:0px;"></div>
</div>
</xsl:if>
...
<!-- LINE  10a  -->
 ...
 <div style="width:187mm">
      <div class="styLNLeftNumBox" style="height:3mm;padding-left:0mm;">10a</div>
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:.5mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
          Were any of the organization's gaming licenses revoked, suspended or terminated during the tax year?
        </span></div>
           <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;width:8.25mm;border-left-width:1px;padding-top:1mm;font-size:7pt;"><b>10a</b></div>
  <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;padding-top:1mm;font-size:7pt;">
    <span style="font-weight: normal;">
         <xsl:call-template name="PopulateYesBoxText">
...
<!--  Line 10b  --> 
 ...
 <xsl:if test="string-length($Form990ScheduleGData/ExplanationIfYes) &lt;1">
      ...
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:1mm;padding-bottom:0mm;">
        <span class="styNormalText">
          Does the organization operate gaming activities with nonmembers? <span style="letter-spacing:3mm; font-weight:bold; margin-left:2mm;">..............</span>
           ...
           <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;width:8.25mm;border-left-width:1px;padding-top:1mm;font-size:7pt;"><b>11</b></div>
  <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;padding-top:1mm;;">
    <span style="font-weight: normal;">
         <xsl:call-template name="PopulateYesBoxText">
  ...
  <div class="IRS990ScheduleG_LineIndexMid" style="height:4.5mm;width:7.5mm;padding-top:1mm;border-right-width:0px;border-bottom-width:1px;">
     <span style="font-weight: normal;">
         <xsl:call-template name="PopulateNoBoxText">
        <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingWithNonmembers"/>
      </xsl:call-template>
...
<!--  LINE  12  -->
    ...
    <div class="styBB">
     <div style="width:187mm;">
      <div class="styLNLeftNumBox" style="height:3mm;padding-left:0mm;">12</div>
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:.5mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
         Is the organization a grantor, beneficiary or trustee of a trust or a member of a partnership or other entity
        </span></div>
       <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;"></div>
       <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;"></div>
       <div class="styShadingCell" style="width:8mm;height:3mm;padding-bottom:1mm;border-top-width:0px;"></div>
    </div>
  ...
  <div style="width:187mm">
      ...
      <div class="styLNDesc" style="width:155mm;height:4mm;padding-top:0mm;font-size:7pt;">
        <span class="styNormalText">
          formed to administer charitable gaming? <span style="letter-spacing:3mm; font-weight:bold; font-size:7pt; margin-left:2mm;">..........................</span>
           ...
           <div class="IRS990ScheduleG_LineIndexMid" style="height:3mm;width:8.25mm;border-left-width:1px;padding-top:1.5mm;font-size:7pt;border-bottom-width:0px;"><b>12</b></div>
            <div class="IRS990ScheduleG_LineIndexMid" style="height:3mm;padding-top:1.5mm;font-size:7pt;border-bottom-width:0px;">
             <span style="font-weight: normal;">
            <xsl:call-template name="PopulateYesBoxText">
   ...
   <div class="IRS990ScheduleG_LineIndexMid" style="height:3mm;width:7.5mm;padding-top:1.5mm;border-right-width:0px;border-bottom-width:0px;font-size:7pt;">
     <span style="font-weight: normal;">
         <xsl:call-template name="PopulateNoBoxText">
        <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/MemberOfOtherEntity"/>
      </xsl:call-template>
    ...
    <div class="pageEnd" style="width:187mm;">
      <span style="width:132mm;"></span>
      <span style="font-weight:bold;font-size:7pt;">Schedule G (Form 990 or 990-EZ) 2008</span>
    </div>
     ...
     <!-- PAGE 3 HEADER  -->
 <div class="styBB" style="width:187mm; padding-bottom:.5mm;">  
    <div style="float:left;font-size;7pt;">Schedule G (Form 990 or 990-EZ) 2008</div>
    <div style="float:right;font-size:7pt;">Page <span style="font-weight:bold;font-size:9pt;">3</span></div>                    
  </div> 
<!-- END Page Header  -->  
...
<div class="styBB" style="width:187mm;">  
  ...
  <div class="IRS990ScheduleG_LineIndexMid" style="border-top-width:0px;width:8mm;padding-top:.25mm;border-bottom-width:1px;height:4mm;"></div>
  <div class="IRS990ScheduleG_LineIndexMid" style="border-top-width:0px;width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;font-size:7pt;">Yes</div>
  <div class="IRS990ScheduleG_LineIndexMid" style="border-right-width:0px;width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;font-size:7pt;border-top-width:0px;">No</div>
</div>
...
<div style="width:187mm;">
      ...
      <div class="styShadingCell" style="width:8mm;height:8mm;"></div>
      <div class="styShadingCell" style="width:8mm;height:8mm;"></div>
      <div class="styShadingCell" style="width:8mm;height:8mm;"></div>
     ...
     <div class="IRS990ScheduleG_LineContainer" style="height:8mm;"> 
       <div class="styLNDesc" style="width:24mm;height:8mm;padding-left:8mm;padding-right:2.5mm;">
        Name  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
          ...
          <div class="styFixedUnderline" style="width:139mm;padding-left:2mm;border-bottom-style:solid;border-bottom-width:1px;border-right-width:0px;">
         <xsl:choose>
         ...
         <div class="styShadingCell" style="width:8mm;height:8mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
         <div class="styShadingCell" style="width:8mm;height:8mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
         <div class="styShadingCell" style="width:8mm;height:8mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
        </div>
     ...
     <div class="IRS990ScheduleG_LineContainer" style="height:8mm;"> 
       <div class="styLNDesc" style="width:25mm;height:8mm;padding-left:8mm;padding-right:2.5mm;">
        Address  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>  </div>
          <div class="styFixedUnderline" style="width:138mm;padding-left:2mm;border-bottom-style:solid;border-bottom-width:1px;border-right-width:0px;">
...
<!--  LINE  15a  -->
  ...
  <div style="width:187mm">
      ...
      <div class="styLNDesc" style="width:155mm;height:4mm;padding-top:0mm;font-size:7pt;">
        <span class="styNormalText">
         revenue? <span style="letter-spacing:3mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.....................................</span>
           ...
           <div class="IRS990ScheduleG_LineIndexMid" style="height:4mm;width:8.25mm;border-left-width:1px;padding-top:1.5mm;font-size:7pt;border-bottom-width:1px;"><b>15a</b></div>
            <div class="IRS990ScheduleG_LineIndexMid" style="height:4mm;padding-top:1.5mm;font-size:7pt;border-bottom-width:1px;">
             <span style="font-weight: normal;">
            <xsl:call-template name="PopulateYesBoxText">
   ...
   <div class="IRS990ScheduleG_LineIndexMid" style="height:4mm;width:7.5mm;padding-top:1.5mm;border-right-width:0px;border-bottom-width:1px;font-size:7pt;">
     <span style="font-weight: normal;">
         <xsl:call-template name="PopulateNoBoxText">
        <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ContractWith3rdPartyForGamRev"/>
      </xsl:call-template>
...
<!--  Line 15b  -->  
 <div style="width: 187mm">
    ...
    <div class="styShadingCell" style="width:8mm;height:4.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
    <div class="styShadingCell" style="width:8mm;height:4.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
    <div class="styShadingCell" style="width:8mm;height:4.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
  </div>
...
<!-- LINE  15c  -->
      ...
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:1mm;border-top-width:0px;"></div>
   </div>
   <div class="styLNLeftNumBox" style="height:4mm;"></div>
  ...
  <!-- Line 15c  Address  -->
    <div style="width:187mm">
     <div class="IRS990ScheduleG_LineContainer" style="height:8mm;"> 
      ...
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
      <div class="styShadingCell" style="width:8mm;height:5mm;padding-bottom:0mm;border-top-width:0px;height:100%;"></div>
 </div>
...
<!-- LINE  16  -->
      ...
      <div class="styShadingCell" style="width:8mm;height:6.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:6.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:6.5mm;padding-bottom:1mm;border-top-width:0px;"></div>
   </div>
   <div class="styLNLeftNumBox" style="height:4mm;"></div>
     ...
     <div class="IRS990ScheduleG_LineContainer" style="height:8mm;"> 
       <div class="styLNDesc" style="width:24mm;height:7mm;padding-left:8mm;padding-right:2mm;padding-top:1mm;">
        Name  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>
          ...
          <div class="styFixedUnderline" style="width:139mm;padding-left:1mm;border-bottom-style:solid;border-bottom-width:1px;border-right-width:0px;">
        <xsl:choose>
...
<!-- <xsl:if test="string-length($Form990ScheduleGData/GamingManagerNamePerson) &lt;1">
      ...
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:0mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
          Gaming manager compensation  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/> $ </span>
           <span class="styIRS990ScheduleGUnderlinedBox" style="font-size: 7pt; width:40mm;text-align: right;padding-right:1mm;">
          <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingManagerCompensation" />
                </xsl:call-template>
              </span>
     </div>
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;border-top-width:0px;"></div>
    </div>
  ...
  <div style="width:187mm">
     <div class="IRS990ScheduleG_LineContainer" style="height:8mm;"> 
       ...
       <div class="styFixedUnderline" style="width:107mm;padding-left:0mm;border-bottom-style:solid;border-bottom-width:1px;border-right-width:0px;">
           <xsl:call-template name="PopulateText">
 ...
 <!-- line 16 check boxes --> 
    ...
    <div style="width:187mm">
     <div class="styLNLeftNumBox" style="height:4mm;"></div>
      ...
      <div class="styShadingCell" style="width:8mm;height:8mm;padding-bottom:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:8mm;padding-bottom:1mm;border-top-width:0px;"></div>
     ...
     <!-- LINE  17  -->
      ...
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;padding-top:1mm;border-top-width:0px;"></div>
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;border-top-width:0px;padding-top:1mm;"></div>
      <div class="styShadingCell" style="width:8mm;height:4mm;padding-bottom:1mm;border-top-width:0px;padding-top:1mm;"></div>
      ...
      <div class="styLNDesc" style="width:155mm;height:4mm;padding-top:0mm;font-size:7pt;">
        <span class="styNormalText">
         retain the state gaming license? <span style="letter-spacing:3mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............................</span>
           ...
           <div class="IRS990ScheduleG_LineIndexMid" style="height:4mm;width:8.25mm;border-left-width:1px;padding-top:1.5mm;font-size:7pt;border-bottom-width:1px;"><b>17a</b></div>
            <div class="IRS990ScheduleG_LineIndexMid" style="height:4mm;padding-top:1.5mm;font-size:7pt;border-bottom-width:1px;">
             <span style="font-weight: normal;">
            <xsl:call-template name="PopulateYesBoxText">

	...
	<xsl:template match="/">
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="Form1120X"><!--Form 1120X-->
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:31mm;height:19.5mm;border-right-width:.5mm;">
							...
							<div style="font-size:7pt;line-height:175%">(Rev. December 2007)
...
(other than taxpayer) is based on all information of which preparer has any knowledge.</td>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120X</span> (Rev. 12-2007)
    </div>
					</div>
					...
					<div style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120X (Rev. 12-2007)<span style="width:130mm;"/>
						</div>

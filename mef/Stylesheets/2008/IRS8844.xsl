      ...
      <body class="styBodyClass">
        <form id="Form8844">
          ...
          <div style="width:187mm;">
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                Enter the total qualified wages paid or incurred during <span class="styBoldText">calendar year 2008</span> only (see instructions)
              </div>
              </div>
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" >
                  <span style="width:48mm;float:left;">Qualified renewal community wages  </span>  
                  <span class="styDotLn" style="float:left;padding-right:1mm;">......</span>
                  <div style="width:3mm;float:left;clear:none;">
                $   
              </div>
                ...
                <div style="width:18mm;float:left;Clear:none;">
                  <span style="width:4px;"/>X 15% (.15)</div>
                <div style="width:12mm;float:left;Clear:none;"/>
                  </div>
                </div>
              <div style="float:right;">
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                    <span style="float:left;">Add lines 1a and 1b. See instructions for the adjustment you must make to salaries and wages</span>
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                    ...
                    <span style="float:left;">continue on to line 5 </span>
                    <span class="styDotLn" style="float:right;padding-right:2mm;">...........................</span>
                </div>
              </div>
              <div style="float:right;">
                ...
                <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form8844Data/TotalCurrentYearEZRCECredit"/>
                  </xsl:call-template>
                </div>
              </div>
            </div>
            ...
            <div style="width:187mm;">
              ...
              <div style="float:right;">
                ...
                <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form8844Data/EZRCECreditFromPassiveActy"/>
                  </xsl:call-template>
                </div>
              </div>
            </div>
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                    <span style="float:left;">Passive activity credit allowed for 2008 (see instructions) </span>
                    <span class="styDotLn" style="float:right;padding-right:2mm;">...............</span>
                </div>
              </div>
              <div style="float:right;">
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                    <span style="float:left;">Carryforward of empowerment zone and renewal community employment credit to 2008 </span>
                    <span class="styDotLn" style="float:right;padding-right:2mm;">......</span>
                </div>
              </div>
              <div style="float:right;">
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                  <span style="float:left;font-size:6pt;">Carryback of empowerment zone and renewal community employment credit from 2009 (see instructions) </span>
                  <!--<span class="styDotLn" style="padding-right:2mm;">......</span>--> 
                </div>
              </div>
              ...
              <div style="width:40mm:">
                ...
                <div class="styLNAmountBox">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form8844Data/CarrybackEZECRAndRCECr"/>
                  </xsl:call-template>
                </div>
                </div>
              </div>
            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;">
                    Add lines 6 through 9. Cooperatives, estates, and trusts, continue on to line 11. All others, report this  
          ...
          <div style="width:186mm;clear:both;padding-top:1mm;">
            ...
            <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8844</span> (2008)</div>
          </div>
          <p class="pageend"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="DependencyTemplate">    
    <table id="UCCCTbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      ...
      <tfoot></tfoot>
      <tbody>    
      <xsl:for-each select="$DependencyData/UnusedCapitalLossCarryoverProp">
        <tr>
          ...
          <td class="styDepTblCell" valign="top" align="right">
  ...
  <xsl:template match="/">
    <html>
      <head>
         <title>
           <!--Unused Capital Loss Carryover Schedule-->
      ...
      <body class="styBodyClass">
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:115mm">
            <!--TY 2003 Unused Capital Loss Carryover Schedule-->
            <xsl:value-of select="$depDocTitle" />
          </div>
        </div>      

...
<!-- Since this is a main form, we must check for and display an updated EIN.  To do this, we use the EINChanged parameter PopulateReturnHeaderFiler.-->
						...
						<span class="styBoldText">D Employer identification number</span><br /><br /><br/>
						<span class="styEINFld">
						<xsl:call-template name="PopulateReturnHeaderFiler">
								<xsl:with-param name="EINChanged">true</xsl:with-param>
						<xsl:with-param name="TargetNode">EIN</xsl:with-param></xsl:call-template></span></div>
      ...
      Check applicable boxes: <span style="width:1mm;"/>
      ...
      Check accounting method: 
         ...
         Other (specify)
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:120mm;font-size:6pt;">
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
						...
						<div class="styBB" style="width:60mm;float:right;text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BData/NumberOfSchedulesK1"/>
							</xsl:call-template>
						</div>
					...
					<div style="width:187mm;padding-bottom:2mm;">
						...
						<div class="styGenericDiv" style="width:117mm;font-size:7pt;float:left;">
      Check if Schedule M-3 (Form 1065) is attached
						...
						<div class="styGenericDiv" style="width:3mm;float:left;">
							<img src="{$ImagePath}/1065B_Bullet_Sm.gif" alt="MidSizeBullet"/>
						</div>
        ...
        <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm;height:4mm;">Excess of net short-term capital gain over net long-term capital loss (Schedule D, line 14)
        <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:16px"/>.
                                <span style="width:16px"/>.
        ...
        <!--Dotted Line-->
               ...
               <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;font-size:6.5pt">
							...
							<div class="styLNDesc" style="width:92mm;height:2.5mm;">Depreciation and section 179 expense deduction
                            <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form1065BData/Depreciation"/>
								</xsl:call-template>
								<div class="styLNDesc" style="width:60mm;">(see instructions)
						 </div>
							</div>
    ...
    May the IRS discuss this return<br/> with the preparer shown below <br/>(see instructions)?
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2008)
                    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065-B (2008)<span style="width:148mm;"/>
						</div>
        ...
        <!--Dotted Line-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:138mm;height:4mm;">Excess of net short-term capital gain over net long-term capital loss (Schedule D, line 17)
                            <span style="width:2px;"/>
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:16px"/>.
        ...
        Other (specify method used and attach explanation.)
						...
						<div style="width:187mm;float:right;clear:none;">
							<div class="styLNLeftLtrBox" style="height:4mm;">
								<span style="width:4px;"/>b</div>
							<div class="styLNDesc" style="width:175mm;height:4mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
        ...
        Check this box if there was a writedown of “subnormal” goods as described in Regulations section 1.471-2(c)
						...
						<div style="width:187mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:175mm;weight:4mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
        ...
        Check this box if the LIFO inventory method was adopted this tax year for any goods <span class="styItalicText">(if checked, attach Form 970) </span>
									...
									<span style="width:4.0mm;"/>
									<img src="{$ImagePath}/1065B_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="width:1.0mm;"/>
								</label>
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleA/LIFOAdopted"/>
...
and 8813. (See instructions.)
    ...
    reportable transaction?
							...
							<div class="styIRS1065BLNYesNoBox" style="height:7.5mm;padding-top:3.5mm">
								<xsl:call-template name="PopulateNoBoxText">
									<xsl:with-param name="TargetNode" select="($Form1065BData)/IRS1065BScheduleB/HasThisPrtshpFiledForm8264"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:187mm">
							<div class="styLNLeftNumBox" style="height:4mm">7</div>
							<div class="styLNDesc" style="width:167mm">At any time during calendar year 2008, did the partnership have an interest in or a signature or other authority
...
name of the foreign country.   
    ...
    to this return.
                            ...
                            <span style="width:2mm;"/>
								...
								<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleB/NumberOfForms8865Attached/@NumberOfForms8865"/>
							</xsl:call-template>
    ...
    <img src="{$ImagePath}/1065B_Bullet_Sm.gif" alt="MidSizeBullet"/>
      ...
      <xsl:with-param name="TargetNode" select="($Form1065BData)/IRS1065BScheduleB/ReceivedDistriFromForeignTrust"></xsl:with-param>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
                        ...
                        <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2008)
                    </div>
					</div>
					<!-- END Page Break and Footer-->
					<!-- Page Header -->
					...
					<div class="styBB" style="width:187mm;height:3.75mm;">
						...
						<div class="styPartDesc" style="float:left;width:167mm;"> Capital Gains and Losses</div>
					</div>
					<div class="styBB" style="width:187mm;height: 3mm; ">
						<div class="styPartDesc" style="width:182mm;text-align:center;padding-top:.5mm;">
            Part I—Short-Term Capital Gains and Losses—Assets Held 1 Year or Less
								...
								<tbody style="font-size:7pt">
									<xsl:if test="($Print != $Separated) or (count($Form1065BData/IRS1065BScheduleD/AssetsHeld1YearOrLess) &lt;= 4) ">
										<xsl:for-each select="$Form1065BData/IRS1065BScheduleD/AssetsHeld1YearOrLess">
											<tr>
												<td class="styTableCell" style="width:5mm;text-align:left;border-right-width:0px;font-weight:bold;vertical-align:top;" scope="col">
              ...
              <!--Dotted Line-->
							...
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="height:4mm;">4</div>
								<div class="styLNDesc" style="width:138mm;height:4mm;">
									<span class="styBoldText">Net short-term capital gain or (loss).</span> Combine lines 1 through 3 in column (f)
              <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
                                    <span style="width:16px"/>.
								...
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">4</div>
								<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0">
									<xsl:call-template name="PopulateAmount">
        ...
        <!--Dotted Line-->
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">
									<span class="styBoldText">Net long-term capital gain or (loss).</span> Combine lines 5 through 8 in column (f)       
        <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
                                    <span style="width:16px"/>.
								...
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">9</div>
								<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styBB" style="width:187mm">
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">Combine lines 4 and 9 and enter the net gain (loss)
        <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
                                    <span style="width:16px"/>.
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">Enter excess of net short-term capital gain (line 4) over net long-term capital loss (line 9)
        <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
                                    <span style="width:16px"/>.
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">
									<span class="styBoldText">Net capital gain or (loss).</span> Subtract line 11 from line 10
       <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
                                    <span style="width:16px"/>.
								...
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">12</div>
								<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styBB" style="width:187mm">
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">Redetermine the amount on line 11 by taking into account only gains and losses from passive
loss limitation activities
        <!--Dotted Line-->
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">
									<span class="styBoldText">Excess of net short-term capital gain over net long-term capital loss.</span> Enter the <b>smaller</b> of
the amount on line 11 or line 13. Enter here and on page 1, Part I, line 8
        <!--Dotted Line-->
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">Redetermine the amount on line 12 by taking into account only gains and losses from passive
loss limitation activities
        <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">
									<span class="styBoldText">Net capital gain or (loss) from passive loss limitation activities.</span> If lines 12 and 15 are both
          positive or both negative, enter the <b>smaller</b> of line 12 or line 15. Otherwise, enter -0-. Enter here
        ...
        <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height:10.5mm;padding-top:6.5mm;">16</div>
							...
							<div style="width:187mm;float:right;clear:none;">
								...
								<div class="styLNDesc" style="width:137mm;height:4mm;">
									...
									<!--<span class="styBoldText">Note.</span>-->
									<span class="styItalicText">When figuring whether line 12 or line 15 is <b>smaller</b>, treat both numbers as positive.</span>
									<!--Dotted Line-->
								</div>
						...
						<div style="width:187mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm;">
								<span class="styBoldText">Excess of net short-term capital gain over net long-term capital loss.</span> Subtract line 14 from
        ...
        <!--Dotted Line-->
						...
						<div style="width:187mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="height:7.5mm;padding-left: 2.25mm">18</div>
							<div class="styLNDesc" style="width:137mm;height:7.5mm;">
								<span class="styBoldText">Net capital gain or (loss) from other activities.</span> Subtract line 16 from line 12. Enter here and on Schedule K, line 4b       
       <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:16px"/>.
                                <span style="width:16px"/>.
							...
							<div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;border-bottom-width:0">18</div>
      ...
      Form
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065-B (2008)
					...
					<div class="styBB" style="width:187mm;height:3.75mm;">
						<div class="styPartDesc" style="width:145mm;border-right:1px solid black;text-align:center;"> (a) Distributive share items. </div>
						<div class="styPartDesc" style="width:42mm;text-align:center;"> (b) Total amount 			</div>
					</div>
					<!--Line 1a-->
      ...
      line 1c from line 1a (report on Schedules K-1, box 1)
                    ...
                    <span style="width:2px;"/>
						...
						<div class="styLNDesc" style="width:137mm;height:4mm;">Net capital gain (loss) from passive loss limitation activities (Schedule D, line 16)
                        <span style="width:2px;"/>
							<!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:16px"/>.
					...
					<div style="width:187mm;float:left;">
						...
						<div class="styLNDesc" style="width:137mm;height:4mm;">Net capital gain (loss) from other activities (Schedule D, line 18)
                        <span style="width:2px;"/>
							<!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:16px"/>.
      ...
      Analysis of Partners' Capital Accounts
           ...
           <!--Dotted Line-->
            ...
            SECTION Interest:
						...
						<xsl:if test="$Form1065BData/IRS1065BScheduleB/NumberOfForms8865Attached/@NumberOfForms8865">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
						...
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead" style="font-size:7pt">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:5mm;border-right-width:0px;" scope="col">
										<span class="styTableCellPad"/>
									</th>

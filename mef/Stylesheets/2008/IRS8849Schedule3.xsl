...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
 ...
 <xsl:template match="/">
  <html>
      ...
      <!--END WARNING LINE -->
        ...
        <div class="styTBB" style="width:187mm;">
 	    ...
 	    <div class="styFNBox" style="width:31mm;height:20mm;border-right-width:2px;border-bottom:1px;">
 	       ...
 	       <span class="styAgency">(Rev. March 2008)</span>
 	    ...
 	    <div class="styMainTitle" style="height:8mm;border-right-width:2px;padding-top:1mm;">Certain Fuel Mixtures<br/>and the Alternative Fuel Credit</div>
		   ...
		   <span style="width:8px"/>
			<xsl:choose>
			  ...
			  <xsl:otherwise>
				...
				<span style="width:2px;clear:none"/>$<span style="width:40mm;text-align:right;clear:none">
	...
	<!--Begin Header 1 -->
      <div style="border-bottom:1px black solid;width:187mm;">
       <div class="styLNLeftNumBox" style="height:5mm;width:8mm;">
      </div>
      <div class="styLNDesc" style="width:179mm;height:5mm;padding-top:1.5mm;padding-bottom:1.5mm;">
	   <span class="styBoldText">Caution. </span>
         <span class="styNormalText">The alcohol fuel mixture credit, biodiesel or renewable diesel mixture credit, alternative fuel credit, and alternative fuel <br/>mixture credit must first be taken on Schedule C (Form 720) to reduce your taxable fuel liability reported on Form 720, Quarterly Federal Excise Tax Return. If you did not make these claims on Schedule C (Form 720), you must make them on Form 720X, Amended Quarterly Federal Excise Tax Return before making them on Form 8849. You cannot claim any amounts on Form 8849 that you claimed (or will claim) on Schedule C (Form 720) or Form 4136, Credit for Federal Tax Paid on Fuels.
       </span>
	</div>
     </div>
    ...
    <span class="styText">Enter your registration number, including the prefix, on the entry line above. Line 3 claimants must enter their AL or AM registration number. </span>
    </div>
   </div>
    <div style="width:187mm;">
   ...
   <div class="styBB" style="width:187mm;">
    ...
    <span class="styText">Claimant produced an alcohol fuel mixture by mixing taxable fuel with alcohol. The alcohol fuel mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. </span>
    </div>
   </div>
   <!--Line 1 Table--> 
   <div style="width:187mm;">
    <table style="font-size:7pt;border-collapse:collapse;">
	 ...
	 <tr>
	   ...
	   <td style="border-left:1px black solid;border-bottom:1px black solid;padding-right:2mm;">$ <span style="width=0mm;"/>
	    <xsl:call-template name="PopulateText">
	...
	<!--Line 1b-->
	<tr>
        <td style="width: 7mm;text-align:center;font-weight=bold;border-bottom:1px black solid;">b</td>
        <td style="text-align:left;border-bottom:1px black solid;">Alcohol fuel mixtures containing alcohol (other than ethanol)</td>
	 <td style="border-left:1px black solid;border-bottom:1px black solid;padding-right:0mm;">
	...
	<b>Biodiesel mixtures.</b> Claimant produced a mixture by mixing biodiesel with diesel fuel. The biodiesel used to produce the mixture met ASTM D6751 and met EPA's registration requirements for fuels and fuel additives. The mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has attached the Certificate for Biodiesel and, if applicable, the Statement of Biodiesel Reseller. <b>Renewable diesel mixtures.</b> Claimant produced a mixture by mixing renewable diesel with diesel fuel (other than renewable diesel). The renewable diesel used to produce the renewable diesel mixture was derived from biomass (as defined in section 45K(c)(3)) using a thermal depolymerization process, met EPA's registration requirements for fuels and fuel additives, and met ASTM D975 or D396.  The mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has attached the Certificate for Biodiesel and, if applicable, Statement of Biodiesel Reseller, both of which have been edited as discussed in the instructions for line 2.
     </div>
    </div>
	...
	<tr>
	  ...
	  <td style="border-left:1px black solid;border-bottom:1px black solid;"><span style="width:1mm;">$</span>
	    <span style="text-align:right:;padding-left:1.8mm;">
	     <xsl:call-template name="PopulateText">
     ...
     <!--Line 2c-->
      <tr>
	 <td style="width=6mm;text-align:center;font-weight=bold;border-bottom:1px black solid;">c</td>
  ...
  <!--Line 3g-->
  <tr>
     <td style="width:6mm;text-align:center;font-weight:bold;border-bottom:1px black solid;">g</td>
  ...
  <div style="width:187mm">
    ...
    <span style="text-align:right;width:33mm;font-weight:bold;font-size:6pt;">Schedule 3 (Form 8849)</span><span style="font-weight:normal;font-size:6pt;" >(Rev. 3-2008)</span>
 </div>
   <br class="pageEnd"/>

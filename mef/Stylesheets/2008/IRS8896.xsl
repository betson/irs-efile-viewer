...
<html>
<head>  
  <title><xsl:call-template name="FormTitle" ><xsl:with-param name="RootElement" select="local-name($Form8896Data)"></xsl:with-param></xsl:call-template></title>
  <!-- No Browser Caching -->
  ...
  <style type="text/css">  
    ...
    <xsl:if test="not($Print) or $Print=''">  
      ...
      <xsl:call-template name="IRS8896Style"></xsl:call-template>
      ...
      <div class="styBB" style="width:187mm;">
        <div class="styFNBox" style="width:34mm; height:21mm;">
          <div style="height:13mm;">
            Form<span class="styFormNumber">  8896</span><br/><div class="styAgency">( Rev. January 2008)</div>
          </div>
        ...
        <div class="styTYBox" style="width:30mm;height:21mm;">
          ...
          <div class="styTaxYear" style="height:9mm;padding-top:0;"></div>
          <div style="text-align:left;padding-left:4mm;">Attachment <br/>Sequence No. <span class="styBoldText" style="font-size:11;">142</span></div>
        </div>
      </div>
...
<!--Line 8  -->         <!--****************************************************************   -->
        ...
        <div style="width:187mm;float:left;clear:none;">
               ...
               <div class="styLNRightNumBoxNBB" style="height:7.3mm;background-color:lightgrey;"></div>
               <div class="styLNAmountBoxNBB" style="height:7.3mm;"></div>
...
<!-- line 10 -->
           <div style="width:187mm;">
                ...
                <div class="styLNDesc" >   Subtract line 9 from line 8. Report this amount on the applicable line of Form 3800 (e.g., line 1n </div>   
                 <div class="styGenericDiv"> of the 2007 Form 3800)
                      <span class="styBoldText">
                         <span style="width:16px;"></span>.
                         <span style="width:16px;"></span>.
                         <span style="width:16px;"></span>.
 ...
 <!-- End Part I -->
    ...
    <div style="width:187mm;clear:both;padding-top:1mm;" class="pageend">
      ...
      <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">8896 </span> (Rev. 12-2006)</div>
    </div>      

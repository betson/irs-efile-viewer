        ...
        <form name="Form5471_ScheduleO">
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;">
              ...
              <div style="height:6mm;">(Rev. December 2006)</div>
         ...
         <!--       <xsl:choose>
                          <xsl:when test="EIN">
                            <xsl:call-template name="PopulateEIN">
                              <xsl:with-param name="TargetNode" select="FilerEIN"/>
                            </xsl:call-template>
                          </xsl:when>
                          <xsl:when test="SSN">
                            <xsl:call-template name="PopulateSSN">
                          ...
                          <xsl:otherwise>
                            <xsl:call-template name="PopulateText">
                              <xsl:with-param name="TargetNode" select="$Form5471ScheduleO/MissingSSNEINReason"/>
                            </xsl:call-template>
                          </xsl:otherwise>
                        </xsl:choose> -->
        ...
        for which information must be reported</span>
          ...
          <div style="width:187mm;float:none;clear:both;" class="pageend">
            ...
            <div class="styGenericDiv" style="float:right;">
              <span class="styBoldText">Schedule O (Form 5471)</span> (Rev. 12-2006)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Schedule O (Form 5471) (Rev. 12-2006)</div>

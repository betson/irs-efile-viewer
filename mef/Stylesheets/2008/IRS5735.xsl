...
<div class="styBB" style="width:187mm;">
	       ...
	       <xsl:otherwise>
	          <td class="styTableCell">
	          	<xsl:call-template name="PopulateAdditionalDataTableMessage">
	          		<xsl:with-param 
	          		name="TargetNode" select="$FormData/GrossIncomeInApplicablePeriod/TaxYearBeginning"/>
	          	</xsl:call-template>
	          </td>
	          <td class="styTableCell"><span class="styTableCellPad"></span></td>
	          <td class="styTableCell"><span class="styTableCellPad"></span></td>
  ...
  <div class="styIRS5735TableContainer" style="border-bottom-width: 0px" id="GIctn">
    ...
    <tr>
      <th class="styTableCellHeader" colspan="2"><b>(e)</b><br/>
      <span class="styNormalText">From sources in American Samoa</span></th>
      <th class="styTableCellHeader" style="width: 140mm;"><b>(f)</b><br/>
      ...
      <th class="styTableCellHeader" style="width: 100mm;"><b>(h)</b><br/><span class="styNormalText">From sources in American
Samoa</span></th>
      <th class="styTableCellHeader" style="width: 100mm;"><b>(i)</b><br/><span class="styNormalText">From all other sources
outside the U.S.</span></th>
      <th class="styTableCellHeader"  style="border-right-width: 0px;width: 100mm;"><b>(j)</b><br/><span class="styNormalText">From sources in the U.S.</span></th>
    </tr>
    </thead>
    <tfoot/>
    <tbody style="border-color:black">
 ...
 <!-- ***************************************************************************************************************** --> 
  ...
  <div style="width: 187mm">
    ...
    <div class="styLNDesc" style="width:139mm;">
      Total gross income in applicable period. Enter the total of columns (e) through (j)
  ...
  <div style="width: 187mm">
    ...
    <div class="styLNDesc" style="width:139mm;">
      Divide line 2 by line 1. If less than 80%, <b>stop here.</b>
       The American Samo economic development credit is not allowed
      <span class="styBoldText">
        <span class="styNBSP"></span>.
        <span class="styNBSP"></span>.
         <span class="styNBSP"></span>.
  ...
  <div style="width: 187mm">
    ...
    <div class="styLNDesc" style="width:139mm;">
      Gross income from the active conduct of a trade or business in America Samoa. Enter the total of (e), (f), and (g)
      <span class="styBoldText">
        <span class="styNBSP"></span>.
        <span class="styNBSP"></span>.
        <span class="styNBSP"></span>.
  ...
  <div style="width: 187mm">
    ...
    <div class="styIRS5735LNDescBB" style="height:8mm;width:139mm;">Divide line 4 by line 1. If less than 75%, 
    <b>stop here.</b>  The American Samoa economic development credit is not allowed
      ...
      <span class="styNormalText">All other gross income</span></th>
        ...
        <xsl:for-each select="$FormData/GrossIncomeDuringPeriods">
          ...
          <tr>
            ...
            <!--td class="styTableCell" style="background-color:yellow">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="GrossQlfyPossSourceInvstIncome" />
              </xsl:call-template>
              <span class="styTableCellPad"></span>

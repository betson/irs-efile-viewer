...
<html lang="EN-US">
  <head>
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form8865ScheduleOData)"></xsl:with-param></xsl:call-template></title>
    <!-- No Browser Caching -->
    ...
    <!-- Remember to remove comment before checked-in your code -->
      <xsl:if test="not($Print) or $Print=''">   
          <xsl:call-template name="IRS8865ScheduleOStyle"></xsl:call-template>
...
<!--Declare variable OPCount -->
  <xsl:variable name="OPCount" >
    ...
    <xsl:call-template name="SetInitialState"></xsl:call-template>
      <!--Part I table -->
      <table class="styTable" cellspacing="0" cellpadding="0" summary="Table for Transfers Reportable Under Section 6038B">
        <thead class="styTableThead">
          <tr>
            ...
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(a)</b><br/> Date of <br/> transfer </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(b)</b><br/> Number of <br/> items <br/> transferred </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(c)</b><br/> Fair market <br/> value on date <br/>   of transfer </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 27mm; text-align: center;"><b>(d)</b><br/> Cost or other <br/> basis  </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 17mm; text-align: center;"><b>(e)</b><br/> Section 704(c) <br/> allocation <br/>  method </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(f)</b><br/> Gain <br/> recognized on <br/> transfer </th>
            <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 27mm; text-align: center;border-right:0px;"><b>(g)</b><br/> Percentage interest  <br/> in partnership after <br/> transfer </th>
        </tr>
         </thead>
          <tfoot></tfoot>
          <tbody>
...
<!-- JMI: 09/23/04: imped repeating data trying to maintain the index loop from above -->
   <xsl:choose>
      ...
      <!-- Part I: Rows of Cash - Begin -->
            <tr>
                ...
                <td class="styForm8865ScheduleOTablesCells" style="width: 27mm; text-align: right;border-right:0px;"><span style="width:4px;"/></td>           
      </tr>  
          ...
          <tr>
            ...
            <xsl:choose>
               <xsl:when test="$Form8865ScheduleOData/CashIntInPrtshpAfterTransfer=''">
                ...
                <xsl:otherwise>          
                <td class="styForm8865ScheduleOTablesCells" style="width: 27mm; text-align: right;border-right:0px;">
                  <xsl:call-template name="PopulatePercent"><xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/CashIntInPrtshpAfterTransfer"/>  </xsl:call-template>
                </td>
              </xsl:otherwise>
            </xsl:choose>
            </tr>         
  ...
  <!-- Supplemental Information Line Title -->      
 ...
 <!-- Supplemental Information Table -->
  ...
  <!-- 4 -->
    ...
    <div class="styTableContainerNBB" name="Dispositions6038B" id="DTPctn">
      ...
      <table class="styTable" style="float:none" cellspacing="0" name="Dispositions6038B" id="DTPctn" summary="Table for Dispositions Reportable Under Section 6038B">      
        <thead class="styTableThead">
        <tr>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(a)</b><br/> Type of <br/> property</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(b)</b><br/> Date of <br/> original <br/> transfer</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 20mm; text-align: center;"><b>(c)</b><br/> Date of <br/> disposition</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 20mm; text-align: center;"><b>(d)</b><br/> Manner of <br/> disposition</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 27mm; text-align: center;"><b>(e)</b><br/> Gain <br/> recognized by <br/> partnership</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(f)</b><br/> Depreciation <br/> recapture <br/> recognized by partnership</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(g)</b><br/> Gain allocated <br/> to partner</th>
          <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 27mm; text-align: center;border-right:0px;"><b>(h)</b><br/> Depreciation <br/> recapture<br/> allocated<br/> to partner</th>
        </tr>        
         </thead>
          <tfoot></tfoot>
          <tbody>
        ...
        <!--Part II Table display with 1st  line of empty data -->
        ...
        <!--Part II Table display with 2nd line of empty data -->
        ...
        <!--Part II Table display with 3rd line of empty data -->
        ...
        <!--Part II Table display with 4th line of empty data -->
  ...
  <!--END Part II-->
    ...
    <div style="width:187mm;">
      ...
      <span class="styBoldText">Schedule O (Form 8865) 2008</span>
    </div>    
        <br/>
        <!-- Page END-->
        <br class="pageEnd"/>
  ...
  <!-- JMI: Additional Data Table-->
          ...
          <xsl:if test="($Print = $Separated) and  (($p1RecCount1 &gt; $defaultRows) or ($p1RecCount2 &gt; $defaultRows) or ($p1RecCount3 &gt; $defaultRows) or ($p1RecCount4 &gt; $defaultRows) or ($p1RecCount5 &gt; $defaultRows))">          
            ...
            <table class="styDepTbl" style="font-size:7pt;">
              ...
              <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 17mm; text-align: center;"><b>(e)</b><br/> Section 704(c) <br/> allocation <br/> method</th>
              <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(f)</b><br/> Gain <br/> recognized on <br/> transfer</th>
              <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 27mm; text-align: center;border-right:0px;"><b>(g)</b><br/> Percentage interest <br> </br>in partnership after <br/> transfer</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>              
     ...
     <xsl:if test="($Print = $Separated) and  (count($Form8865ScheduleOData/SupplementalInfoStatement) &gt; 4)"> 
            ...
            <table class="styDepTbl" style="font-size:7pt;">
              <thead class="styTableThead">
                <!-- JMI: Label the Column Headers -->
                <tr class="styDepTblHdr">
                  <th class="styDepTblCell" scope="col" style="padding-left:5mm; padding-bottom:4mm"><br/>Supplemental Information Required To Be Reported (see instructions)<br/></th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>               
          ...
          <xsl:if test="($Print = $Separated) and  (count($Form8865ScheduleOData/DispositionsReportable) &gt; 4)">
            ...
            <table class="styDepTbl" style="font-size:7pt;">
              <thead class="styTableThead">
                ...
                <tr class="styDepTblHdr">
                  <th class="styForm8865ScheduleOTablesCells"  scope="col" style="width: 23mm; text-align: center;"><b>(a)</b><br/> Type of <br/> property</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(b)</b><br/> Date of <br/> original <br>/ </br> transfer</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(c)</b><br/> Date of disposition</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(d)</b><br/> Manner of disposition</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 27mm; text-align: center;"><b>(e)</b><br/> Gain recognized by partnership</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 17mm; text-align: center;"><b>(f)</b><br/> Depreciation recapture recognized by partnership</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 23mm; text-align: center;"><b>(g)</b><br/> Gain allocated to partner</th>
                  <th class="styForm8865ScheduleOTablesCells" scope="col" style="width: 27mm; text-align: center;border-right:0px;"><b>(h)</b><br/> Depreciation <br/> recapture<br/> allocated<br/> to partner</th>
                </tr>
              </thead>
              <tfoot/>
    ...
    <tr>  
      <xsl:if test="$index = 1">                
        <td class="styForm8865ScheduleOTablesCells" scope="row" style="text-align:left">
          <xsl:attribute name="rowspan">
            <xsl:value-of select="$max" /> 
          </xsl:attribute><xsl:value-of select="$PropertyType"/>
        </td>
      </xsl:if>  
      <td class="styForm8865ScheduleOTablesCells" style="text-align:left">
        <span style="width:4px"/>

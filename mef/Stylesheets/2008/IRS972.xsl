...
<html>
  ...
  <div class="styTBB" style="width:187mm;height: 26mm">
    <div class="styFNBox" style="height: 26.5mm; width:33mm;font-size: 7pt; padding-top:2mm">
      ...
      <br/>
      <br/>
      <span class="styAgency">(Rev. February 2006)</span>
      <span>
  ...
  <div class="styBB" style="width:187mm">
     <div class="styNameBox" style="font-size:7pt; width:132mm; height:8mm">Name of shareholder
       <div style="padding-left:5mm; line-height:110%;font-family:verdana;font-size:6pt;">
  ...
  <div style="width:187mm;" class="styBB">
    <div style="width:187mm" class="styBB">        
      ...
      <div style="float:left;padding-top:1mm;padding-bottom:.5mm;padding-left:8mm;valign:top;"><span style="float:left;valign:top">shareholder on the stock of the </span>
        <span class="styUnderlineAmount" style="float:right;padding-top:0mm;width:136mm;text-align:left;font-family:verdana;font-size:6pt;">
          <xsl:call-template name="PopulateText">
      ...
      <div style="padding-top:3mm;padding-bottom:.5mm;padding-left:8mm;">
        <span class="styUnderlineAmount" style="float:none;width:179mm;text-align:left;">
  ...
  <div class="styIRS972TableContainer " id="CDctn">
   ...
   <table class="styTable" style="font-size:7pt;"  cellspacing="0">
    ...
    <tr>
      <th class="styTableCellHeader" style="font-weight:normal;width:35mm;">Class of stock</th>
      <th class="styTableCellHeader" style="font-weight:normal;width:40mm;">Number of shares</th>
      <th class="styTableCellHeader" style="font-weight:normal;width:75mm;">Certificate numbers</th>
      <th class="styTableCellHeader" style="font-weight:normal;border-right-width: 0px;width:35mm;">Amount of consent<br/>distribution allocable to<br/>each class of stock<br/>owned</th>
    </tr>
    </thead>
    <tfoot/>
...
<div style="width:187mm;clear:both;border-top:1px solid black;">
  ...
  <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">972</span> (Rev. 2-2006)</div>
</div>
      ...
      <table class="styDepTbl" style="font-size:7pt">
        <thead class="styTableHead">
          <tr class="styDepTblHdr">
            <th class="styDepTblCell" style="width:38mm;">Class of stock</th>
            <th class="styDepTblCell" style="width:37mm;">Number of shares</th>
            <th class="styDepTblCell" style="width:78mm;">Certificate numbers</th>
            <th class="styDepTblCell" style="width:34mm;">
              Amount of consent<br/>distribution allocable to<br/>each class of stock<br/>owned
            </th>
          </tr>
        </thead>
        <tfoot></tfoot>
        <tbody>
          <xsl:for-each select="$FormData/ConsentDistribution">
            <tr>
              ...
              <td class="styDepTblCell" style="text-align: left; width:38mm;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="ClassOfStock" />
                </xsl:call-template>
              </td>
              <td class="styDepTblCell" style="text-align: right; width:37mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="NumberOfShares" />
                </xsl:call-template>
              </td>
              <td class="styDepTblCell" style="text-align: left; width:78mm;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="CertificateNumbers" />
                </xsl:call-template>
              </td>
              <td class="styDepTblCell" style="width:34mm;">
          ...
          <tr class="styDepTblHdr">
            <td class="styDepTblCell" colspan="3" style="text-align:left;font-weight:bold;width:153mm;border-top-width:1px;">
              Total consent distribution
              <span style="letter-spacing:4mm">.......................</span>
              <img src="{$ImagePath}/972_Bullet_Md.gif" alt="Right Arrow Bullet"/> 
            </td>
            <td class="styDepTblCell"  style="width:34mm;border-top-width:1px;">
              <span class="styBoldText"><div style="float:left">$</div></span>
              <div style="text-align:right;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$FormData/TotalConsentDistribution" />
                  <xsl:with-param name="WhiteFont" select="'true'" />
                </xsl:call-template>
              </div>
            </td>
          </tr>

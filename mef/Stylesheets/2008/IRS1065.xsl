...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
          ...
          See separate instructions.
                ...
                <br/>
                        ...
                        <div class="styLblNameAddr" style="width:106mm;height:29mm;">
                            <div class="styUseLbl" style="width:15mm;height:29mm;border-right-width:0px;font-size:6pt;">Use the IRS label.        <br/>Otherwise,<br/> print or type.
            </div>
      ...
      Check applicable boxes: <span style="width:1px;"/>
         ...
         Amended return
                    ...
                    <div class="styNBB" style="width:187mm;">
                        <div class="styBoldText" style="width:6mm;float:left;clear:none;padding-left:3mm;"></div>
                        <div class="styGenericDiv" style="width:178mm;">
                            <span style="width:33.5mm;"></span>
      ...
      Check accounting method: 
         ...
         Other (specify)
                        ...
                        <div class="styBB" style="width:60mm;float:right;">
                            <xsl:call-template name="PopulateText">
                                <xsl:with-param name="TargetNode" select="$Form1065Data/MethodOfAccountingOther/@note"/>
                            </xsl:call-template>
                        </div>
                    </div>
      ...
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
                    ...
                    <div class="styBB" style="width:187mm;height:6mm">
                        ...
                        <div class="styGenericDiv" style="width:175mm;">
                            <label>
                                <xsl:call-template name="PopulateLabel">
                                    <xsl:with-param name="TargetNode" select="$Form1065Data/ScheduleM3Required"/>
                                    <xsl:with-param name="BackupName">IRS1065ScheduleM3Required</xsl:with-param>
                                </xsl:call-template>
         Check if Schedule M-3 attached 
            ...
            <span class="styBoldText">only</span> trade or business income and expenses on lines 1a through 22 below. See the instructions for more information.
        </span>
                    </div>
                    <!--BEGIN Main Form Income Section-->
                    <div class="styBB" style="width:187mm;">
                        <div class="styIRS1065VTImageBox" style="height:40.5mm;padding-top:15mm;">
                            <img src="{$ImagePath}/1065_Income.gif" alt="VerticalIncome"/>
                        </div>
                        <div style="width:181mm;float:right;clear:none;">
                            <div class="styLNLeftNumBox" style="padding-left: 2.25mm;height:4mm;">1a
            </div>
                            <div class="styLNDesc" style="width:92mm;height:4mm;">Gross receipts or sales        
                <span style="width:2px;"/>
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:92mm;height:4mm;">Less returns and allowances     
        <!--Dotted Line-->
                                <span class="styBoldText">
                                    <span style="width:16px"/>.
                    <span style="width:16px"/>.
                    ...
                    <span style="width:16px"/>.
                            ...
                            <div class="styLNAmountBox" style="height:4.5mm;">
                                <xsl:call-template name="PopulateAmount">
                                    <xsl:with-param name="TargetNode" select="$Form1065Data/GrossReceiptsOrSalesBalance"/>
                                </xsl:call-template>
                            </div>
                        </div>
                        <div style="width:181mm;float:right;clear:none;">
                ...
                <span class="styItalicText">(attach statement)</span>
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">Net farm profit (loss) 
                <span class="styItalicText">(attach Schedule F (Form 1040))</span>
                                <!-- Form to Form Link -->
                                <xsl:call-template name="SetFormLinkInline">
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">Net gain (loss) from Form 4797, Part II, line 17 (attach Form 4797)
                <span style="width:2px;"/>
                                <!-- Form to Form Link -->
                                <xsl:call-template name="SetFormLinkInline">
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            <div class="styLNLeftNumBox" style="padding-left: 2.25mm;height:4mm;">7
            </div>
                            <div class="styLNDesc" style="width:132mm;height:4mm;">
        Other income (loss) 
                <span class="styItalicText">(attach statement)</span>
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            <div class="styLNLeftNumBox" style="padding-left: 2.25mm;height:4mm;">8</div>
                            <div class="styLNDesc" style="width:132mm;height:4mm;">
        ...
        <!--Dotted Line-->
                    ...
                    <div class="styBB" style="width:187mm;">
                        <div class="styIRS1065VTImageBox" style="height:63mm;padding-top:3mm;">
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">Salaries and wages (other than to partners) (less employment credits)
        <!--Dotted Line-->
                                <span class="styBoldText">
                                    <span style="width:16px"/>.
                    <span style="width:16px"/>.
        ...
        <!--Dotted Line-->
                    ...
                    <span style="width:16px"/>.
                            ...
                            <div class="styLNAmountBox" style="height:4.5mm;">
                                <xsl:call-template name="PopulateAmount">
                                    <xsl:with-param name="TargetNode" select="$Form1065Data/GuaranteedPaymentsToPartners"/>
                                </xsl:call-template>
                            </div>
                        </div>
                        <div style="width:181mm;float:right;clear:none;">
                ...
                <span style="width:2px;"/>
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:92mm;height:4.5mm;">Depreciation 
                <span class="styItalicText"> (if required, attach Form 4562)</span>
                                <span style="width:2px;"/>
                                <!-- Form to Form Link -->
                                <xsl:call-template name="SetFormLinkInline">
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:92mm;height:4mm;">Less depreciation reported on Schedule A and elsewhere on return
            </div>
                            <div class="styLNRightNumBox" style="height:4mm;">16b</div>
                            <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;">
                                <xsl:call-template name="PopulateAmount">
        ...
        <!--Dotted Line-->
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">Other deductions 
                <span class="styItalicText"> (attach statement)</span>
                                <span style="width:2px;"/>
                                <!-- Form to Form Link -->
                                <xsl:call-template name="SetFormLinkInline">
                    ...
                    <span style="width:16px"/>.
                        ...
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">
                                <span class="styBoldText">Total deductions.</span> Add the amounts shown in the far right column for lines 9 through 20
        <!--Dotted Line-->
                                <span class="styBoldText">
                                    <span style="width:16px"/>.
                    <span style="width:16px"/>.
                            ...
                            <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0;">21</div>
                    ...
                    <div class="styBB" style="width:187mm;border-bottom-width:0;">
                        <div style="width:181mm;float:right;clear:none;">
                            ...
                            <div class="styLNDesc" style="width:132mm;height:4mm;">
                                <span class="styBoldText" style="font-size:7pt;">Ordinary business income (loss).</span> Subtract line 21 from line 8     
        <!--Dotted Line-->
                                <span class="styBoldText">
                                    <span style="width:16px"/>.
                    <span style="width:16px"/>.
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;">
                        <tr>
                            <td rowspan="3" style="width:10mm;font-size: 8pt;font-weight:bold;border-right:1 solid black;border-bottom:1 solid black;text-align:left;">Sign Here</td>
      ...
      of which preparer has any knowledge.
                        ...
                        <tr>
                            ...
                            <td rowspan="2" style="width:40mm;border-bottom:1 solid black;padding-bottom:1mm;">
                                ...
                                <div style="border-right:3 solid black;border-left:3 solid black;border-bottom:3 solid black;border-top:3 solid black;float:right;text-align:center;" class="styGenericDiv">    
    May the IRS discuss this return
                    <br/> with the preparer shown below 
                    <br/>(see instructions)?
                        ...
                        <tr>
                            ...
                            <td style="width:32mm;border-bottom:1 solid black;">
                                ...
                                <span class="styGenericDiv" style="border:0 solid red;">
                                    <img src="{$ImagePath}/1065_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/>
                                </span>
                            </td>
        ...
        <br/>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom:1 solid black;padding-left:1mm;">EIN <img src="{$ImagePath}/1065_Bullet_Sm.gif" alt="SmallBullet"/>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2008)
    </div>
                    </div>
                    ...
                    <div class="styBB" style="width:187mm;padding-top:.5mm;">
                        <div style="float:left;">Form 1065 (2008)<span style="width:148mm;"/>
                        </div>
                    ...
                    <div class="styBB" style="width:187mm;">
                        ...
                        <div class="styPartDesc" style="width:164mm;">Cost of Goods Sold <span class="styNormalText">(see the instructions)</span>
                        </div>
                    </div>
      ...
      <span style="width:2px;"/>
                            <!-- Form to Form Link -->
                            <xsl:call-template name="SetFormLinkInline">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/InventoryAtBeginningOfYear"/>
                            </xsl:call-template>
                            <!--Dotted Line-->
                            <span class="styBoldText">
                                <span style="width:16px"/>.
        ...
        <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="height:4mm;">Purchases less cost of items withdrawn for personal use
      <!--Dotted Line-->
                            <span class="styBoldText">
                                <span style="width:16px"/>.
        <span style="width:16px"/>.
        ...
        <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBox" style="height:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/Purchases"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <div style="width:187mm;">
      ...
      <!--Dotted Line-->
        ...
        <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBox" style="height:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/CostOfLabor"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="height:4mm;">Additional section 263A costs <i>(attach statement)</i>
                            ...
                            <!-- Form to Form Link -->
                            <xsl:call-template name="SetFormLinkInline">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/AdditionalSection263ACosts"/>
                            </xsl:call-template>
                            <!--Dotted Line-->
                            <span class="styBoldText">
                                <span style="width:16px"/>.
        ...
        <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="height:4mm;">Other costs <i>(attach statement)</i>
                            ...
                            <!-- Form to Form Link -->
                            <xsl:call-template name="SetFormLinkInline">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/OtherCosts"/>
                            </xsl:call-template>
                            <!--Dotted Line-->
                            <span class="styBoldText">
                                <span style="width:16px"/>.
      ...
      <!--Dotted Line-->
                        ...
                        <div class="styLNAmountBox" style="height:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/TotalCosts"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <div style="width:187mm;">
      ...
      <!--Dotted Line-->
        ...
        <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBox" style="height:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/InventoryAtEndOfYear"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <div style="width:187mm;">
      ...
      <!--Dotted Line-->
        ...
        <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBox" style="height:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/CostOfGoodsSold"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <div style="width:187mm;">
                        <div class="styLNLeftNumBox" style="height:4mm;padding-top:1.5mm;">9a</div>
                        <div class="styLNDesc" style="width:178mm;height:4mm;padding-top:1.5mm;">Check all methods used for valuing closing inventory:
    </div>
                    </div>
                    <div style="width:187mm;">
                        <div class="styLNLeftNumBox" style="height:4mm;"/>
                        <div class="styGenericDiv" style="height:4mm; text-align:right; width:5mm; padding-top:1.8mm; font-weight:bold;">
      (i)
    </div>
                        <div class="styLNDesc" style="width:173mm;height:4mm;vertical-align:baseline;">
                            <input type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/CostAsDescribedInSection14713"/>
      ...
      (ii)
                        ...
                        <div class="styLNDesc" style="width:173mm;height:4mm;vertical-align:baseline;">
                            <input type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/LowerOfCostOrMrktAsInSect14714"/>
      ...
      (iii)
                        ...
                        <div class="styLNDesc" style="width:86mm;height:4mm;vertical-align:baseline;">
                            <input type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/OtherMethodUsedBox"/>
        ...
        Other (specify method used and attach explanation)
                        ...
                        <div class="styBB" style="width:87mm;height:4mm;clear:none;">
                            <xsl:call-template name="PopulateText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/OtherMethodUsedBox/@otherMethodUsed"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <!-- line 9b -->
                    <div style="width:187mm;">
                        <div class="styLNLeftLtrBox" style="height:4mm;padding-top:1mm;">b</div>
                        <div style="float:left;width:145mm;">
                            <div style="height:4mm;padding-top:1mm;">
                                <label for="SubnormalGoodsCheck">
                                    <xsl:call-template name="PopulateLabel">
                                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/SubnormalGoods"/>
                                        <xsl:with-param name="BackupName">IRS1065ScheduleASubnormalGoods</xsl:with-param>
                                    </xsl:call-template>Check this box if there was a writedown of “subnormal” goods as described in Regulations section 1.471-2(c)
     </label>
                            </div>
                        </div>
         ...
         <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        <div class="styLNLeftLtrBox" style="height:4mm;padding-top:1mm;">c</div>
                        <div style="float:left;width:157mm;">
                            <div style="height:4mm;padding-top:1mm;">
                                <label for="LIFOCheck">
                                    <xsl:call-template name="PopulateLabel">
                                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/LIFOAdopted"/>
                                        <xsl:with-param name="BackupName">IRS1065ScheduleALIFOAdopted</xsl:with-param>
                                    </xsl:call-template>
        Check this box if the LIFO inventory method was adopted this tax year for any goods <i>(if checked, attach Form 970)</i>
                                </label>
                                <xsl:call-template name="SetFormLinkInline">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/LIFOAdopted"/>
                                </xsl:call-template>
         ...
         <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:150mm;height:4mm;padding-top:1.5mm;">
       ...
       <span class="styBoldText">
        ...
        <span style="width:15px"/>.
         <span style="width:15px"/>.
                        ...
                        <div class="styLNDesc" style="width:13mm;height:4mm;padding-top:1.5mm;text-align:right;">
                            <span>
                                <xsl:call-template name="PopulateSpan">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/Section263ARulesApply"/>
                                </xsl:call-template>
                                <input type="checkbox" class="styCkbox" name="Checkbox">
                                    <xsl:call-template name="PopulateYesCheckbox">
                                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/Section263ARulesApply"/>
                                        <xsl:with-param name="BackupName">IRS1065ScheduleASection263ARulesApply</xsl:with-param>
                                    </xsl:call-template>
                                </input>
                            </span>
                            <label>
          ...
          Yes
                        ...
                        <div class="styLNDesc" style="width:15mm;height:4mm;padding-top:1.5mm;text-align:right;">
                            <span>
                                <xsl:call-template name="PopulateSpan">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/Section263ARulesApply"/>
                                </xsl:call-template>
          ...
          No
                    ...
                    <div class="styBB" style="width:187mm;">
                        <div class="styLNLeftLtrBox" style="height:7mm;padding-top:1.5mm;">e</div>
...
<br/>      If "Yes," attach explanation
      <span style="width:2px;"/>
                            <!-- Form to Form Link -->
                            <xsl:call-template name="SetFormLinkInline">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/InventoryDeterminationChange"/>
                            </xsl:call-template>
                            <span class="styBoldText">
        <span style="width:16px"/>.
        <span style="width:16px"/>.
                        ...
                        <div class="styLNDesc" style="width:13mm;height:7mm;padding-top:4.5mm;text-align:right;">
                            <span>
                                ...
                                <input type="checkbox" class="styCkbox" name="Checkbox">
                                    <xsl:call-template name="PopulateYesCheckbox">
                                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleA/InventoryDeterminationChange"/>
                                        <xsl:with-param name="BackupName">IRS1065ScheduleAInventoryDeterminationChange</xsl:with-param>
                                    </xsl:call-template>
                                </input>
                            </span>
                            <label>
      ...
      What type of entity is filing this return? Check the applicable box:
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="width:65mm">
                            <input class="styCkBox" type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/DomesticGeneralPartnership"/>
                                    <xsl:with-param name="BackupName">IRS1065DomesticGeneralPartnership</xsl:with-param>
                                </xsl:call-template>
                            </input>
        ...
        Domestic general partnership
                        ...
                        <div class="styLNDesc" style="width:94mm">
                            <input class="styCkBox" type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/DomesticLimitedPartnership"/>
                                    <xsl:with-param name="BackupName">IRS1065DomesticLimitedPartnership</xsl:with-param>
                                </xsl:call-template>
                            </input>
                            <span style="width:1mm;"/>
        ...
        Domestic limited partnership
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm; width:65mm">
                            <input class="styCkBox" type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/DomesticLimitedLiabilityCo"/>
                                    <xsl:with-param name="BackupName">IRS1065DomesticLimitedLiabilityCo</xsl:with-param>
                                </xsl:call-template>
                            </input>
                            <span style="width:1mm;"/>
        ...
        Domestic limited liability company
                        ...
                        <div class="styLNDesc" style="height:4mm; width:94mm">
                            <input class="styCkBox" type="checkbox" name="Checkbox">
                                <xsl:call-template name="PopulateCheckbox">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/DomesticLimitedLiabilityPrtshp"/>
                                    <xsl:with-param name="BackupName">IRS1065DomesticLimitedLiabilityPrtshp</xsl:with-param>
                                </xsl:call-template>
                            </input>
                            <span style="width:1mm;"/>
        ...
        Other 
                            ...
                            <span style="height:4mm;width:74mm;border-bottom:1 solid black;">
                                <xsl:call-template name="PopulateText">
                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/TypeOfEntityOther/@note"/>
                                </xsl:call-template>
                            </span>
                        </div>
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm;">At any time during the tax year, was any partner in the partnership
                        a disregarded entity, a partnership (including an entity<br/> treated as a partnership), a trust, an S corporation, an estate (other than
                        an estate of a deceased partner), or a nominee<br/> or similar person?
    <span class="styBoldText">
                                <span style="width:16px"/>.
          <span style="width:16px"/>.
          <span style="width:16px"/>.
          ...
          <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:5mm;border-bottom-width:0;"/>
                        <div class="styIRS1065LNYesNoBox" style="height:5.5mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/PrtnerInPrtshpOfAnotherEntity"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:5.5mm; border-left-width:1; border-bottom-width:1;">
                    ...
                    <div style="width:187mm">
                           ...
                           <div class="styLNDesc" style="width:167mm">
                                  Did any foreign or domestic corporation, partnership (including any entity treated as a partnership), or trust own, directly or indirectly, an interest
                                  of 50% or more in the profit, loss, or capital of the partnership?  For rules of constructive ownership, see instructions.  If "Yes," complete (i) through (v) below
                                  <xsl:call-template name="SetFormLinkInline">
                                             <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityOwnIntGrp"/>
                                  </xsl:call-template>
                                  <span class="styBoldText">
                                             <span style="width:16px"/>.
                                             <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:1;">
                           <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityOwnIntOf50PercentOrMore"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div class="styBB" style="width:187mm;">
                            ...
                            <table class="styTable" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="styTableCellHeader" style="width:26mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                            <span class="styBoldText">(ii) 
                                                      <span class="styNormalText"> Employer <br/>Identification <br/>Number (if any)</span>
                                            </span>
                                        </th>
                                        <th class="styTableCellHeader" style="width:26mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                        ...
                                        <th class="styTableCellHeader" style="width:33mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                            <span class="styBoldText">(v) 
                                                      <span class="styNormalText"> Maximum <br/>Percentage Owned in <br/>Profit, Loss, or Capital</span>
                                            </span>
                                        </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                     <xsl:for-each select="$Form1065ScheduleB/EntityOwnIntGrp">
                                        <xsl:if test="($Print != $Separated) or (count($Form1065ScheduleB/EntityOwnIntGrp) &lt;=2)">
                                             <tr style="font-size: 6.5pt;">
                                               ...
                                               <td class="styTableCellText" style="width:26mm;text-align:center;">
                                                ...
                                                <td class="styTableCellText" style="width:26mm;text-align:left;">
                                                    <xsl:call-template name="PopulateText">
                                    ...
                                    <!-- Table Filler Rows -->
                                    <xsl:if test="count($Form1065ScheduleB/EntityOwnIntGrp) &lt; 1 or ((count($Form1065ScheduleB/EntityOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                        <tr>
                                            <td class="styTableCellText" style="width:76mm;height:1mm;font-size:6.5pt;">
                                                <span style="width:4px"/>
                                                <xsl:if test="((count($Form1065ScheduleB/EntityOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                    ...
                                    <xsl:if test="count($Form1065ScheduleB/EntityOwnIntGrp) &lt; 2 or ((count($Form1065ScheduleB/EntityOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                        <tr>
                       ...
                       <!-- SCHEDULE B Line 3b-->
                        <div style="width:187mm">
                           ...
                           <div class="styLNDesc" style="width:167mm">
                                  Did any individual or estate own, directly or indirectly, an interest of 50% or more in the profit, loss, or capital of the <br/>
                                  partnership? For rules of constructive ownership, see instructions.  If "Yes," complete (i) through (iv) below
                                  <xsl:call-template name="SetFormLinkInline">
                                             <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndivOrEstateOwnIntGrp"/>
                                  </xsl:call-template>
                                  <span class="styBoldText">
                                             <span style="width:16px"/>.
                                             <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:6mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndivOrEstateOwnIntOfThePrtshp"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:6mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateNoBoxText">
                            ...
                            <table class="styTable" cellspacing="0">
                                <thead class="styTableThead">
                                    <tr>
                                        ...
                                        <th class="styTableCellHeader" style="width:46mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                            <span class="styBoldText">(ii) 
                                                      <span class="styNormalText"> Social Security Number or <br/>Employer Identification Number<br/>(if any)</span>
                                            </span>
                                        </th>
                                        <th class="styTableCellHeader" style="width:29mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                            <span class="styBoldText">(iii)
                                                      <span class="styNormalText"> Country of<br/>Citizenship<br/>(see instructions)</span>
                                            </span>
                                        </th>
                                        <th class="styTableCellHeader" style="width:33mm;vertical-align:top;font-size:6.5pt;" scope="col">
                                            <span class="styBoldText">(iv) 
                                ...
                                <tbody>
                                    <xsl:for-each select="$Form1065ScheduleB/IndivOrEstateOwnIntGrp">
                                        <xsl:if test="($Print != $Separated) or (count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &lt;=2)">
                                            <tr style="font-size: 6.5pt;">
                                    ...
                                    <!-- Table Filler Rows -->
                                    <xsl:if test="count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &lt; 1 or ((count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                        <tr>
                                            <td class="styTableCellText" style="width:78mm;height:1mm;font-size:6.5pt;">
                                                <span style="width:4px"/>
                                                <xsl:if test="((count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                                    <xsl:call-template name="PopulateAdditionalDataTableMessage">
                                                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndivOrEstateOwnIntGrp"/>
                                                    </xsl:call-template>
                                                </xsl:if>
                                    ...
                                    <xsl:if test="count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &lt; 2 or ((count($Form1065ScheduleB/IndivOrEstateOwnIntGrp) &gt;2) and ($Print = $Separated))">
                                        <tr>
                                            <td class="styTableCellText" style="width:78mm;height:1mm;">
                                                <!--<span style="width:4px"/>-->
                                            </td>
                    ...
                    <div style="width:187mm">
                           <div class="styLNLeftNumBox" style="height:4mm; padding-left:3.5mm;">a</div>
                           <div class="styLNDesc" style="width:167mm">
                                  Own directly 20% or more, or own, directly or indirectly, 50% or more of the total voting power of all classes of stock entitled <br/>
                                  to vote of any foreign or domestic corporation? For rules of constructive ownership, see instructions.  If "Yes," complete (i) <br/>
                                  through (iv) below 
                                  <xsl:call-template name="SetFormLinkInline">
                       ...
                       <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:1;">
                           <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/PctTotalVotingPowerOwnOfStock"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateNoBoxText">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2008)
                    ...
                    <!-- END Page Header -->
                        ...
                        <div style="width:187mm">
                           ...
                           <div class="styLNDesc" style="width:167mm">
                                  Own directly an interest of 20% or more, or own, directly or indirectly, an interest of 50% or more in the profit, loss,
                                   or capital <br/>in any foreign or domestic partnership (including an entity treated as a partnership) or in the beneficial
                                  interest of a trust? For <br/>rules of constructive ownership, see instructions.  If "Yes," complete (i) through (v) below
                                  <xsl:call-template name="SetFormLinkInline">
                       ...
                       <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/OwnForeignOrDomesticPrtshp"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:1;">
                            <xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div class="styBB" style="width:187mm;">
                        ...
                        <!-- SCHEDULE B Line 5-->
                         <div class="styBB" style="width:187mm">
                               ...
                               <div class="styLNDesc" style="height:4mm;width:167mm;">Did the partnership file the Form 8893, Election of Partnership Level Tax Treatment,
                               or an election statement under 
                               <br/>section 6231(a)(1)(B)(ii) for partnership-level tax treatment, that is in effect for this tax year?  See Form 8893 for more
                               <br/>details
                               <xsl:call-template name="SetFormLinkInline">
                                      <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/ElectionPrtshpLevelTaxTrtmnt"/>
                               </xsl:call-template>
                               <span class="styBoldText">
                                         <span style="width:16px"/>.
                                         <span style="width:16px"/>.
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm; width:167mm">Does the partnership satisfy <span class="styBoldText">all four </span> of the following conditions?</div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"></div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"></div>
                    </div>
                    <div style="width:187mm">
                        <div class="styLNLeftLtrBox" style="height:4mm;padding-left:3.5mm">a</div>
                        <div class="styLNDesc" style="height:4mm;width:167mm">The partnership's total receipts for the tax year were less than $250,000.</div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                    </div>
                    <div style="width:187mm">
                        <div class="styLNLeftLtrBox" style="height:4mm;padding-left:3.5mm">b</div>
                        <div class="styLNDesc" style="height:4mm;width:167mm">The partnership's total assets at the end of the tax year were less than $1 million.</div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                    </div>
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">
      Schedules K-1 are filed with the return and furnished to the partners on or before the due date (including extensions) <br/>
        for the partnership return.
                        ...
                        <div style="width:187mm">
                               ...
                               <div class="styLNDesc" style="height:4mm;width:167mm">The partnership is not filing and is not required to file Schedule M-3
                                       <span class="styBoldText">
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                               ...
                               <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:1;">
                                       <xsl:call-template name="PopulateYesBoxText">
                                              <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/SchK1FiledAndFurnishedToPrtnr">
                                              </xsl:with-param>
                                       </xsl:call-template>
                               </div>
                               <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:1;">
                        ...
                        <div class="styBB" style="width:187mm">
                                ...
                                <div class="styLNDesc" style="height:4mm;width:167mm">
                                       ...
                                       <br/>or Item L on Schedule K-1.</div>
                                       <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                                       <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                                       <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                                       <div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">Is this partnership a publicly traded partnership as defined in section 469(k)(2)?
       <span class="styBoldText">
                                <span style="width:16px"/>.
           <span style="width:16px"/>.
           <span style="width:16px"/>.
           ...
           <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IsPartnershipPubliclyTraded"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">During the tax year, did the partnership have any debt that was cancelled, was forgiven, or had the terms
                                <br/> modified so as to reduce the principal amount of the debt?
                                <span class="styBoldText">
                                           <span style="width:16px"/>.
                                           <span style="width:16px"/>.
                                           <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/DidPartnershipHaveAnyDebt"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">Has this partnership filed, or is it required to file, Form 8918, Material Advisor Disclosure Statement, to provide
                                <br/> information on any reportable transaction?
                                <span class="styBoldText">
                                           <span style="width:16px"/>.
                                           <span style="width:16px"/>.
                                           <span style="width:16px"/>.
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">At any time during calendar year 2008, did the partnership have an interest in or a signature or other authority over a 
                                <br/>financial account in a foreign country (such as a bank account, securities account, or other financial account)? See the
                                <br/>instructions for exceptions and filing requirements for Form TD F 90-22.1, Report of Foreign Bank and Financial Accounts. If "Yes," enter the name of the foreign country.
                                <span style="width:8px"/>
      <img src="{$ImagePath}/1065_Bullet_Sm.gif" alt="MidSizeBullet"/>
                        <!--<span style="width:1mm;"/>
                           <span style="width:15mm;border-bottom:1 solid black;">
                                    <xsl:call-template name="PopulateText">
                                           <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/AnyForeignAccounts/@NameOfForeignCountry"/>
                                    </xsl:call-template> 
                            </span> -->
                            <xsl:call-template name="LinkToLeftoverDataTableInline">
                                <xsl:with-param name="Desc">Schedule B Line 10 Name of Foreign country</xsl:with-param>
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/AnyForeignAccounts/@NameOfForeignCountry"/>
                            </xsl:call-template>
                            <span style="width:1mm;"/>
                            <xsl:call-template name="SetFormLinkInline">
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-bottom:0; padding-bottom:.0mm; padding-top:.0mm;"/>
                        <div class="styIRS1065LNYesNoBox" style="border-bottom:0;height:4mm;padding-bottom:.0mm;padding-top:.0mm;"/>
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm; width:167mm">At any time during the tax year, did the partnership receive a distribution from, or was it the grantor of, or transferor
                                 <br/>to, a foreign trust? If "Yes," the partnership may have to file Form 3520, Annual Return To Report Transactions With
                                 <br/>Foreign Trusts and Receipt of Certain Foreign Gifts. See instructions
                                 <xsl:call-template name="LinkToLeftoverDataTableInline">
                                          <xsl:with-param name="Desc">Form 1065, Schedule B, Line 10 - Form 3250 Indicator</xsl:with-param>
                                          <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/ReceivedDistriFromForeignTrust/@form3520Indicator"/>
                                 </xsl:call-template>
                                <span class="styBoldText">
                                           <span style="width:16px"/>.
                                           <span style="width:16px"/>.
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateYesBoxText">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/ReceivedDistriFromForeignTrust"/>
                            </xsl:call-template>
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">Is the partnership making, or had it previously made (and not revoked), a section 754 election?
                               ...
                               <!-- <xsl:call-template name="LinkToLeftoverDataTableInline">
                                          <xsl:with-param name="Desc">Form 1065, Schedule B, Line 12a - Section 754 Election</xsl:with-param>
                                          <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Section754ElectionMade/@referenceDocumentId"/>
                                 </xsl:call-template>-->
                        </div>
                        <div class="styIRS1065LNYesNoBox" style="height:5mm; border-left-width:1; border-bottom-width:0;">
                            <xsl:call-template name="PopulateYesBoxText">
                    ...
                    <div style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">Did the partnership make for this tax year an optional basis adjustment under section 743(b) or 734(b)? If "Yes,"
                                <br/>attach a statement showing the computation and allocation of the basis adjustment.  See instructions
                                <xsl:call-template name="SetFormLinkInline">
                                      <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/OptionalBasisAdjustment"/>
                                </xsl:call-template>                                
                                <span class="styBoldText">
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm;width:167mm">Is the partnership required to adjust the basis of partnership assets under section 743(b) or 734(b) because of a 
                               <br/>substantial built-in loss (as defined under section 743(d) or substantial basis reduction (as defined under section 734(d))? 
                               <br/> If "Yes," attach a statement showing the computation and allocation of the basis adjustment.  See instructions 
                               <xsl:call-template name="SetFormLinkInline">
                                      <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/PrtshipRequiredToAdjustBasis"/>
                               </xsl:call-template>
                               <span class="styBoldText">
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                    ...
                    <div class="styBB" style="width:187mm">
                        <div class="styLNLeftNumBox" style="height:4mm;">13</div>
                        <div class="styLNDesc" style="height:4mm; width:167mm">Check this box if, during the current or prior tax year, the partnership distributed any property received in a 
                                <br/>like-kind exchange or contributed such property to another entity (including a disregarded entity).
                                <span class="styBoldText">
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                                ...
                                <span style="width:4mm"/>
                                 ...
                                 <input class="styCkBox" type="checkbox" name="Checkbox">
                                            <xsl:call-template name="PopulateCheckbox">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Section761aElection"/>
                                                    <xsl:with-param name="BackupName">IRS1065Section761aElection</xsl:with-param>
                                            </xsl:call-template>
                                 </input>
                        </div>
                    ...
                    <div class="styBB" style="width:187mm">
                        <div class="styLNLeftNumBox" style="height:4mm;">14</div>
                        <div class="styLNDesc" style="height:4mm; width:167mm">At any time during the tax year, did the partnership distribute to any partner a tenancy-in-common or other
                               <br/> undivided interest in partnership property?
                                <span class="styBoldText">
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                                                 <span style="width:16px"/>.
                    ...
                    <div class="styBB" style="width:187mm">
                        <div class="styLNLeftNumBox" style="height:4mm;">15</div>
                        <div class="styLNDesc" style="height:4mm; width:167mm">If the partnership is required to file Form 8858, Information Return of U.S. Persons With Respect To Foreign
                               <br/>Disregarded Entities, enter the number of Forms 8858 attached.  See instructions
                                <span style="width:4mm"/>
                                 <img src="{$ImagePath}/1065_Bullet_Sm.gif" alt="MidSizeBullet"/>
                                 <span style="width:1mm"/>
                                 <xsl:call-template name="SetFormLinkInline">
                    ...
                    <div class="styBB" style="width:187mm">
                        ...
                        <div class="styLNDesc" style="height:4mm; width:167mm">Does the partnership have any foreign partners? If "Yes," enter the number of Forms 8805, Foreign Partner's
                                <br/>Information Statement of Section 1446 Withholding Tax, filed for this partnership.
                                <span style="width:4mm"/>
                                <img src="{$ImagePath}/1065_Bullet_Sm.gif" alt="MidSizeBullet"/>
                                <span style="width:1mm;"/>
                        ...
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
								    	<xsl:call-template name="PopulateYesBoxText">
												<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/PrtshpHasAnyForeignPartners"/>
									    </xsl:call-template>
					    </div> 
                        <div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;">
								    	<xsl:call-template name="PopulateNoBoxText">
                    ...
                    <div class="styBB" style="width:187mm">
                        <div class="styLNLeftNumBox" style="height:4mm">17</div>
                        <div class="styLNDesc" style="height:4mm;width:167mm">
      Enter the number of Forms 8865, Return of U.S. Persons With Respect to 
      Certain Foreign Partnerships, attached to this 
                               <br/>
      return
                               ...
                               <span style="width:1mm;"/>
                               <xsl:call-template name="SetFormLinkInline">
                                      <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/NumberOfForms8865Attached"/>
                               </xsl:call-template>
    ...
    Enter below the general partner designated as the tax matters partner (TMP) for the tax year of this return:
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2008)
                    ...
                    <div class="styBB" style="width:187mm;">
                        ...
                        <div class="styPartDesc" style="width:121.5mm;height:4mm;">
    Partners' Distributive Share Items
                            <xsl:call-template name="SetFormLinkInline">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK"/>
                            </xsl:call-template>
                        </div>
                        <span class="styBoldText" style="width:40mm;height:4mm;border-left:1 solid black;padding-left:13mm;">Total Amount</span>
                    </div>
                    <!-- END Schedule K Title -->
                    <!-- BEGIN Schedule K Line Items -->
                    <!-- BEGIN Schedule K Income (Loss) Line Items -->
                    <div class="styBB" style="width:187mm;">
                        <table class="styTable" style="height:4mm; width:187mm ;font-size:7pt;" cellspacing="0" cellpadding="0" id="schK">
                            <thead/>
                            <tfoot/>
                            <tbody>
                                ...
                                <tr>
                                    <td class="styIRS1065VTImageBox" style="width:7.5mm;height:54mm;padding-left:2mm;border-bottom:1px solid black;" rowspan="16">
                                    ...
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Ordinary business income (loss) (page 1, line 22)
          </span>
                                    ...
                                    <td>
                                        ...
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OrdinaryBusinessIncomeLoss"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Net rental real estate income (loss)<i> (attach Form 8825)</i>
                                            <span style="width:2px;"/>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetRentalRealEstateIncomeLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;height:4mm;">
                                            <span class="styIRS1065DotLn">............</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">2</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetRentalRealEstateIncomeLoss"/>
                                            </xsl:call-template>
      ...
      <!-- Form to Form Link -->
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherGrossRentalIncomeLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">.........</span>
                                            <span class="styLNRightNumBox" style="height:4mm;">3a</span>
                                            <span class="styLNAmountBox" style="height:4mm;">
                                                <xsl:call-template name="PopulateAmount">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherGrossRentalIncomeLoss"/>
                                                </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Expenses from other rental activities <i>(attach statement)</i>
                                            <span style="width:2px;"/>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/ExpensesFromOtherRentalActy"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                    ...
                                    <td>
                                        <span class="styLNRightNumBoxNBB" style="width:12mm; background-color:lightgrey; height:4mm; border-bottom-width:0px;"/>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Other net rental income (loss). Subtract line 3b from line 3a</span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">...........</span>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">3c</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherNetRentalIncomeLoss"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">4</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/GuaranteedPayments"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">5</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">6a</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OrdinaryDividends"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span style="float:right;">
                                            ...
                                            <span class="styLNAmountBox" style="height:4mm;">
                                                <xsl:call-template name="PopulateAmount">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/QualifiedDividends"/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">7</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Net short-term capital gain (loss) <i>(attach Schedule D (Form 1065))</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetSTCapitalGainLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">.........</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">8</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetSTCapitalGainLoss"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Net long-term capital gain (loss) <i>(attach Schedule D (Form 1065))</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetLTCapitalGainLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">.........</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">9a</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetLTCapitalGainLoss"/>
                                            </xsl:call-template>
           ...
           <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/CollectiblesGainLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">..........</span>
                                            <span class="styLNRightNumBox" style="height:4mm;">9b</span>
                                            <span class="styLNAmountBox" style="height:4mm;">
                                                <xsl:call-template name="PopulateAmount">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/CollectiblesGainLoss"/>
                                                </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        <span>
                                            <span class="styIRS1065LNLeftLtrBoxTD" style="height:4mm;">c</span>
                                            <span class="styIRS1065LNDesc" style="height:4mm;">Unrecaptured section 1250 gain <i>(attach statement) </i>
                                                <xsl:call-template name="SetFormLinkInline">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/UnrecapturedSection1250Gain"/>
                                                </xsl:call-template>
                                            </span>
                                            <span style="float:right;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Net section 1231 gain (loss) <i>(attach Form 4797)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetSection1231GainLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">..............</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">10</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetSection1231GainLoss"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid black;">
                                        ...
                                        <span class="styIRS1065LNDesc" style="height:4mm;">Other income (loss) <i>(see instructions) </i>
                                            <xsl:call-template name="SetFormLinkInline">
              ...
              <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            ...
                                            <span style="width:32mm;padding-left:1mm;">
                                                <xsl:call-template name="PopulateText">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherIncomeLoss/@note"/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                    <td style="height:4mm;border-bottom:1px solid black;">
                                        <span class="styLNRightNumBoxNBB" style="width:12mm;height:4mm;">11</span>
                                        <span class="styLNAmountBoxNBB" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherIncomeLoss"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td class="styIRS1065VTImageBox" rowspan="5" style="width:7.5mm;height:16mm;padding-left:2mm;border-bottom:1px solid black;">
                                        <img src="{$ImagePath}/1065_Deductions.gif" alt="VertDeductions"/>
                                    </td>
                                    <td>
                                        <span class="styLNLeftNumBox">12</span>
                                        <span class="styIRS1065LNDesc">Section 179 deduction <i>(attach Form 4562)</i>
                                            <span style="width:2px;"/>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Section179Deduction"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">................</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">12</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Section179Deduction"/>
                                            </xsl:call-template>
            ...
            <span style="width:2px;"/>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">13a</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Contributions"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc">Investment interest expense
          </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">.....................</span>
                                        </span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">13b</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/InvestmentInterestExpense"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc" style="width:58mm;height:4mm;">Section 59(e)(2) expenditures:
            <span class="styBoldText">(1)</span> Type <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                        </span>
                                        <span class="styIRS1065BBText" style="width:40mm;height:4mm;">
                                            <xsl:call-template name="PopulateText">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Section59e2ExpendituresType"/>
                                            </xsl:call-template>
                                        </span>
                                        <span class="styLNDesc" style="width:25mm;height:4mm;text-align:center;">
                                            <span class="styBoldText">(2)</span> Amount <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Section59e2ExpendituresAmount"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                    <td style="height:4mm;">
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm">13c(2)</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Section59e2ExpendituresAmount"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid black;">
                                        ...
                                        <span class="styIRS1065LNDesc" style="padding-bottom:0mm;padding-top:0mm;">Other deductions <i>(see instructions)</i>
                                            <span style="width:2px;"/>
                                            <xsl:call-template name="SetFormLinkInline">
              ...
              <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            ...
                                            <span style="width:32mm;padding-left:1mm;">
                                                <xsl:call-template name="PopulateText">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherDeductions/@note"/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                    <td style="border-bottom:1px solid black;height:4mm;">
                                        <span class="styLNRightNumBoxNBB" style="width:12mm;height:4mm;">13d</span>
                                        <span class="styLNAmountBoxNBB" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherDeductions"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td class="styIRS1065VTImageBox" rowspan="3" style="width:7.5mm;height:11mm;padding-left:2mm;border-bottom:1px solid black;">
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">14a</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NetEarningsLossFromSelfEmplmn"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">14b</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/GrossFarmingOrFishingIncome"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">14c</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/GrossNonfarmIncome"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="styIRS1065VTImageBox" rowspan="7" style="width:7.5mm;height:26mm;padding-left:2mm;border-bottom:1px solid black;">
            ...
            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/LowIncomeHousingCredit"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">...............</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">15a</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/LowIncomeHousingCredit"/>
                                            </xsl:call-template>
            ...
            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/LowIncomeHousingCreditOther"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">...................</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">15b</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/LowIncomeHousingCreditOther"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        <span class="styIRS1065LNLeftLtrBoxTD">c</span>
                                        <span class="styIRS1065LNDesc">Qualified rehabilitation expenditures (rental real estate) <i>(attach Form 3468)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/QualifiedRehabilitationExpend"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">......</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">15c</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/QualifiedRehabilitationExpend"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        <span class="styIRS1065LNLeftLtrBoxTD">d</span>
                                        <span class="styIRS1065LNDesc">Other rental real estate credits <i>(see instructions)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherRentalRealEstateCredits"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:left;">
                                            <span class="styIRS1065DotLn"> ..</span>
                ...
                <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            ...
                                            <span style="width:32mm;border-bottom:1 solid black;padding-left:1mm;">
                                                <xsl:call-template name="PopulateText">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherRentalRealEstateCredits/@note"/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                    <td style="height:4mm;">
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">15d</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherRentalRealEstateCredits"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="styIRS1065LNDesc">Other rental credits <i>(see instructions)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                 ...
                 Type 
                    <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            ...
                                            <span style="width:32mm;border-bottom:1 solid black;padding-left:1mm;">
                                                <xsl:call-template name="PopulateText">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherRentalCredits/@note"/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                    <td style="height:4mm">
                                        <span class="styLNRightNumBox" style="width:12mm;height:4mm;">15e</span>
                                        <span class="styLNAmountBox" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherRentalCredits"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid black;">
                                        ...
                                        <span class="styIRS1065LNDesc">Other credits <i>(see instructions)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherCreditsAndCreditRecapture "/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:left;">
                                            <span class="styBoldText" style="float:left">
                ...
                <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
                                            ...
                                            <span style="width:32mm;padding-left:1mm;border-bottom:1 solid black;">
                                                <xsl:call-template name="PopulateText">
                                                    <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherCreditsAndCreditRecapture/@note "/>
                                                </xsl:call-template>
                                            </span>
                                        </span>
                                    </td>
                                    <td style="border-bottom:1px solid black;height:4mm;">
                                        <span class="styLNRightNumBoxNBB" style="width:12mm;height:4mm;;">15f</span>
                                        <span class="styLNAmountBoxNBB" style="height:4mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherCreditsAndCreditRecapture "/>
                                            </xsl:call-template>
                            ...
                            <xsl:choose>
                                <xsl:when test="count($Form1065ScheduleK/ForeignTransactions) &gt; 0">
                                    <xsl:for-each select="$Form1065ScheduleK/ForeignTransactions">
                                        <xsl:call-template name="FrnTran"></xsl:call-template>
                                    </xsl:for-each>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:call-template name="FrnTran"></xsl:call-template>
                                ...
                                <tr>
                                    <td class="styIRS1065VTImageBox" rowspan="7" style="width:7.5mm;height:27mm;padding-top:5mm;border-bottom:1px solid black;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Post1986DepreciationAdjustment"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
            ...
            <xsl:call-template name="LinkToLeftoverDataTableInline">
                                                <xsl:with-param name="Desc">Form 1065, Schedule K, Line 17b - Adjusted gain or loss</xsl:with-param>
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/AdjustedGainOrLoss/@note"/>
                                            </xsl:call-template>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/AdjustedGainOrLoss"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">......................</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DepletionOtherThanOilAndGas"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <span class="styIRS1065LNLeftLtrBoxTD">d</span>
                                        <span class="styIRS1065LNDesc">Oil, gas, and geothermal properties—gross income </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">..............</span>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">17d</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OilGasGthrmlPropertiesGroIncm"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <span class="styIRS1065LNLeftLtrBoxTD">e</span>
                                        <span class="styIRS1065LNDesc">Oil, gas, and geothermal properties—deductions </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">...............</span>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">17e</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OilGasGthrmlPropertiesDed"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid black;">
                                        ...
                                        <span class="styIRS1065LNDesc">Other AMT items <i>(attach statement) </i>
                                            <xsl:call-template name="SetFormLinkInline">
                                    ...
                                    <td style="border-bottom:1px solid black;">
                                        <span class="styLNRightNumBoxNBB" style="width:12mm;height:4.5mm;">17f</span>
                               ...
                               <tr>
                                    <td class="styIRS1065VTImageBox" rowspan="9" style="width:7.5mm;height:22.5mm;padding-left:2mm;">
                                      <img src="{$ImagePath}/1065_Information.gif" alt="Other information" style="height:28.5mm;"/>
                                    </td>
                                </tr>
                                <!-- Schedule K, Line 18a -->
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">18a</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/TaxExemptInterestIncome"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">18b</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherTaxExemptIncome"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">18c</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/NondeductibleExpenses"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
            ...
            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DistributionsOfCashMrktblSec"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">.............</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">19a</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DistributionsOfCashMrktblSec"/>
                                            </xsl:call-template>
            ...
            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DistributionsOfOtherProperty"/>
                                            </xsl:call-template>
                                        </span>
                                        <span style="float:right;">
                                            <span class="styIRS1065DotLn">....................</span>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">19b</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DistributionsOfOtherProperty"/>
                                            </xsl:call-template>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">20a</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/InvestmentIncome"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="styLNRightNumBox" style="width:12mm;height:4.5mm;">20b</span>
                                        <span class="styLNAmountBox" style="height:4.5mm;">
                                            <xsl:call-template name="PopulateAmount">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/InvestmentExpenses"/>
                                            </xsl:call-template>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td valign="top">
                                        <span class="styIRS1065LNLeftLtrBoxTD">c</span>
                                        <span class="styIRS1065LNDesc">Other items and amounts <i>(attach statement)</i>
                                            <xsl:call-template name="SetFormLinkInline">
                                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleK"/>
                                            </xsl:call-template>
                                        </span>
                                    ...
                                    <td valign="top">
                                        <span class="styLNRightNumBoxNBB" style="width:12mm;height:4.5mm;border-bottom-width: 0px; background-color:lightgrey"/>
                                        <span class="styLNAmountBoxNBB" style="height:4.5mm;border-bottom-width: 0px;background-color:lightgrey">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2008)
                    ...
                    <div style="width: 187mm">
                        ...
                        <div class="styLNDesc">Net income (loss). Combine Schedule K, lines 1 through 11. From the result, subtract the sum of
      ...
      <span class="styBoldText">
         ...
         <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBoxNBB" style="height:8mm;padding-top:4mm;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065Data/AnalysisOfNetIncomeLoss/NetIncomeLoss"/>
                            </xsl:call-template>
                        </div>
                    </div>
                    <!--  Line 1 -->
                            ...
                            <xsl:choose>
                                <xsl:when test="count($Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeGenPartners) &gt; 0">
                                    <xsl:for-each select="$Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeGenPartners">
                                        <xsl:call-template name="GenPart"></xsl:call-template>
                                    </xsl:for-each>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:call-template name="GenPart"></xsl:call-template>
                            ...
                            <xsl:choose>
                                <xsl:when test="count($Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeLtdPartners) &gt; 0">
                                    <xsl:for-each select="$Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeLtdPartners">
                                        <xsl:call-template name="LtdPart"></xsl:call-template>
                                    </xsl:for-each>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:call-template name="LtdPart"></xsl:call-template>
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:5.5mm;font-size:7pt;">Other investments
        (attach statement)
        <span class="styBoldText">
                                <span style="width:16px"/>.
        </span>
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:5.5mm;">Other assets<i> (attach statement)</i>
                            <!--Dotted Line-->
                            <span class="styBoldText">
                                <span style="width:16px"/>.
          <span style="width:16px"/>.
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:7mm;">
          ...
          <span style="width:16px"/>.
                        ...
                        <div class="styShadingCell" style="width:28mm;height:7.5mm;"/>
                        <div class="styLNAmountBox" style="width:28mm;height:7.5mm;padding-top:3mm;font-family:arial;font-size:7pt;">
                            <xsl:call-template name="PopulateAmount">
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:5.5mm;font-size:7pt;padding-top:1mm;">
                            <span>Other current liabilities<i> (attach statement)</i>
                            </span>
                            <span class="styBoldText">
                                <span style="width:16px"/>.
        </span>
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:7mm;">
                            <span style="font-family:arial; font-size:7pt;">Mortgages, notes, bonds payable in 1 year or more</span>
                        </div>
                        <div class="styShadingCell" style="width:28mm;height:7.5mm;"/>
                        <div class="styLNAmountBox" style="width:28mm;height:7.5mm;padding-top:3mm;font-family:arial;font-size:7pt;">
                            <xsl:call-template name="PopulateAmount">
                    ...
                    <div style="width:187mm;">
                        ...
                        <div class="styLNDesc" style="width:66mm;height:5.5mm;">Other liabilities
        <i>(attach statement)</i>
             ...
             <span style="width:16px"/>.
                        ...
                        <div class="styLNAmountBoxFormLink" style="width:22mm;height:5.5mm;font-family:arial;font-size:7pt;">
                            <xsl:call-template name="PopulateAmount">
                                <xsl:with-param name="TargetNode" select="$Form1065ScheduleL/OtherLiabilitiesEOY"/>
                            </xsl:call-template>
                        </div>
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
                    ...
                    <div class="styBB" style="width:187mm;">
                        ...
                        <div class="styPartDesc" style="width:158mm;">Reconciliation of Income (Loss) per Books With Income (Loss) per Return
    <br/>Note. <span style="font-weight:normal">Schedule M-3 may be required instead of Schedule M-1 (see instructions).</span>
                        </div>
                    </div>
              ...
              <!--Dotted Line-->
                ...
                <span style="width:16px"/>.
                                    ...
                                    <td class="styLNAmountBoxNBB" style="height:4.5mm;border-right-width:1px;width:31.5mm;padding-top:1.5mm;padding-bottom:1mm;">
                                        <xsl:call-template name="PopulateAmount">
            ...
            <!--Dotted Line-->
              ...
              <span style="width:16px"/>.
                            ...
                            <tr class="styGenericDiv">
                                ...
                                <td class="styGenericDiv" style="width:52mm;font-size:7pt;height:9mm;" colspan="2">Balance at end of year. Subtract line 8 from line 5</td>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2008)
        ...
        Additional Data        
              ...
              Form 1065, Top Left Margin - Section 761(a) election:
             </label>
                                </td>
              ...
              Form 1065, Top Left Margin - Common Trust:
             </label>
                                </td>
                                <td class="styLeftOverTableRowAmount" style="width:87mm;">
                                    <input type="checkbox" class="styCkbox">
              ...
              Form 1065, Top Left Margin - Nominee:
             </label>
                                </td>
                                <td class="styLeftOverTableRowAmount" style="width:87mm;">
                                    <input type="checkbox" class="styCkbox">
              ...
              Form 1065, Top Left Margin - IRC 6114:
             </label>
                                </td>
                                <td class="styLeftOverTableRowAmount" style="width:87mm;">
                                    <input type="checkbox" class="styCkbox">
                        ...
                        <xsl:call-template name="PopulateLeftoverRow">
                            <xsl:with-param name="Desc">Form 1065, Schedule B, Line 11 - Form 3250 Indicator</xsl:with-param>
                            <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/ReceivedDistriFromForeignTrust/@form3520Indicator"/>
                            <xsl:with-param name="DescWidth" select="100"/>
                        </xsl:call-template>
                        <!--<xsl:call-template name="PopulateLeftoverRow">
                        ...
                        <xsl:call-template name="PopulateLeftoverRow">
                            <xsl:with-param name="Desc">Form 1065, Schedule B, Line 15 - Number of Forms 8858</xsl:with-param>
                            <xsl:with-param name="TargetNode" select="$Form1065ScheduleB/NumberOfF8858/@referenceDocumentId"/>
                        ...
                        <table class="styDepTbl" style="font-size:7pt;">
                            <thead class="styTableThead">
                                ...
                                <tr class="styDepTblHdr">
                                    ...
                                    <th class="styDepTblCell" scope="col" align="center" valign="middle">(v) Maximum Percentage Owned in Profit, Loss, or Capital</th>
                                </tr>
                            </thead>
                            <tfoot/>
                            <tbody>
                        ...
                        <table class="styDepTbl" style="font-size:7pt;">
                            <thead class="styTableThead">
                                ...
                                <tr class="styDepTblHdr">
                                    ...
                                    <th class="styDepTblCell" scope="col" valign="middle">(ii) Social Security Number or Employer Identification Number (if any)</th>
                                    <th class="styDepTblCell" scope="col" valign="middle">(iii) Country of Citizenship <br/>(see instructions)</th>
                                    <th class="styDepTblCell" scope="col" align="center" valign="middle">(iv) Maximum Percentage Owned in Profit, Loss, or Capital</th>
                                </tr>
                            </thead>
                            <tfoot/>
                            <tbody>
                        ...
                        <table class="styDepTbl" style="font-size:7pt;">
                            <thead class="styTableThead">
                                ...
                                <tr class="styDepTblHdr">
                                    ...
                                    <th class="styDepTblCell" scope="col" align="center" valign="middle">(iv) Percentage Owned in Voting Stock</th>
                                </tr>
                            </thead>
                            <tfoot/>
                            <tbody>
    ...
    <xsl:template name="FrnTran">
        <tr>
            <td class="styIRS1065VTImageBox" rowspan="13" style="width:7.5mm;height:43mm;border-bottom:1px solid black;padding-left:2mm;">
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBoxNBB" style="width:12mm;height:5mm;background-color:lightgrey;"/>
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:4mm;">16b</span>
                <span class="styLNAmountBox" style="height:4mm;">
                    <xsl:call-template name="PopulateAmount">
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:4mm;">16c</span>
                <span class="styLNAmountBox" style="height:4mm;">
                    <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="GrossIncmSrcdAtPartnerLevel"/>
                    </xsl:call-template>
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:5.5mm;">16f</span>
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:5.6mm;">16h</span>
        ...
        <tr>
            <td>
                ...
                <span class="styGenericDiv" style="height:4mm;">
                    <i>Deductions allocated and apportioned at partnership level to foreign source income</i>
                </span>
            </td>
            <td>
                <span class="styLNRightNumBoxNBB" style="width:12mm;height:5.3mm;background-color:lightgrey;"/>
        ...
        <tr>
            <td>
                ...
                </span><span style="font-size:7pt; font-weight:bold; padding-left:3mm; height:4mm; padding-top:1.2mm;">k</span>
                <span style="width:1mm;"/>
                <span style="font-size:7pt; height:4mm; vertical-align:bottom;padding-top:1.2mm;">Other
                          <xsl:call-template name="SetFormLinkInline">
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:5.5mm;">16k</span>
                <span class="styLNAmountBox" style="height:5.5mm;">
                    <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="DedAllocAndApprtnPrtshpLvlOth"/>
                    </xsl:call-template>
        ...
        <tr>
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm; height:7mm; padding-top:2mm;">16l</span>
        ...
        <tr>
            <td>
                ...
                <span class="styIRS1065LNDesc" style="height:4mm;">Reduction in taxes available for credit <i>(attach statement)</i>
                    <xsl:call-template name="SetFormLinkInline">
            ...
            <td>
                <span class="styLNRightNumBox" style="width:12mm;height:5.5mm;">16m</span>
                <span class="styLNAmountBox" style="height:5.5mm;">
                    <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="ReductionInTaxesAvailableForCr"/>
                    </xsl:call-template>
        ...
        <tr>
            <td style="border-bottom:1px solid black;">
                ...
                <span class="styIRS1065LNDesc" style="height:4mm;">Other foreign tax information <i>(attach statement)</i>
                    <xsl:call-template name="SetFormLinkInline">
                        <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/ForeignTransactions"/>
                    </xsl:call-template>
                </span>
                <span style="float:right;">
                    <span class="styIRS1065DotLn">...............</span>

      ...
      <body class="styBodyClass">    
        ...
        <div class="styTopSectionLine" style="clear:both">
          ...
          <div style="float:left">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form5471Deps6Data/Explanation" /></xsl:call-template>                             
          </div>                  
        </div>  
        ...
        <div class="styTopSectionLine" style="clear:both">
          ...
          <div style="float:left">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form5471Deps6Data/PriorName/BusinessNameLine1" /></xsl:call-template>     
            <xsl:if test="normalize-space($Form5471Deps6Data/PriorName/BusinessNameLine2) != ''">
              <br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form5471Deps6Data/PriorName/BusinessNameLine2" /></xsl:call-template>     
            </xsl:if>
          </div>                  
        </div>  

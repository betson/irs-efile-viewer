...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/GoodsAcqAtBelowMrktPricesStmt"/>
  <xsl:param name="depDocTitle">
		  <!--970 - Display Name - Goods Acquired at Below-Market Prices Statement-->
		...
		<html>
		    ...
		    <body class="styBodyClass">
		        ...
		        <xsl:call-template name="GlobalStylesDep"/>
				    ...
				    <div style="float:left;clear:none;"><span class="styTopSectionLineLbl" style="display:block;">Explanation:</span></div>

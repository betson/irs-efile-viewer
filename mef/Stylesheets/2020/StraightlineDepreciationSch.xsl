		...
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					...
					<th class="styDepTblCell" scope="col" style="width:11mm;">Year acquired</th>
					<th class="styDepTblCell" scope="col" style="width:28mm;">Useful life - years</th>
					<th class="styDepTblCell" scope="col" style="width:28mm;">Years remaining</th>

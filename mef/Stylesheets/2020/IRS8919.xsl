...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<body class="styBodyClass" style="margin-bottom:10px">
				<form name="Form8919">
					...
					<!--			<span style="width:5.2mm;font-weight:bold;float:left;">F<br/></span>
								...
								<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC and/or 1099-NEC from this firm for 2020. The amount on Form 1099-MISC and/or 1099-NEC should have been included as wages on Form W-2. <b>(Don't file Form SS-8 if you select reason code H.)</b>
								</span>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
								<div style="float:left;">Add lines 11 and 12. Enter here. Include as tax on your annual tax return (Schedule 2 (Form 1040), line 5; Form 1040-PR, Part I, line 6; Form 1040-SS, Part I, line 6). See the instructions there.
									<!--Dotted Line-->
					...
					<div style="float:left;">
								...
								<div style="float:right;">
								  ...
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2020)
								</div>						
					</div>
	...
	<xsl:template name="CreateTableHeaders">
		<tr class="styDepTblHdr">
			...
			<th scope="col" class="styTableCell" 
				style="width:43mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
	...
	<xsl:template name="CreateEmptyTableRows">
		...
		<tr class="">
			...
			<th scope="col" class="styTableCell" 
				style="width:37mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
				<b>(f)</b>Total wages<br/>received with<br/>no social security<br/>or Medicare tax<br/>withholding and not<br/>reported on Form W-2
			</th>
		</tr>
	</xsl:template>

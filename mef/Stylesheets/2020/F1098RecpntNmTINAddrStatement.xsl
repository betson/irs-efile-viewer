  ...
  <xsl:template match="/">
    ...
    <body class="styBodyClass">
      ...
      <div class="styDepTitleLine">
        ...
        <xsl:call-template name="Form1098RecipientNmTINAddrStmt"/>
      </body>
    </html>
  </xsl:template>

  <!-- Template to display Additional Information for Recipient Name Address Statement -->
  <xsl:template name="Form1098RecipientNmTINAddrStmt">
    <table id="F1098RecpntNmTINAddrStmtTbl" class="styDepTbl">
      ...
      <tfoot/>
      <tbody>
        <xsl:for-each select="$DependencyData/Form1098RecipientNmTINAddrStmt">
          <tr>

...
<!-- 04/07/17 - Created per UWR #191363 - Jeremy Nichols -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/VINCorrectionExplanationStmt" />
  ...
  <xsl:template name="VINCorrectionExplanationStmtTmp">
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="VINCorrectionExplanationStmtTmp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

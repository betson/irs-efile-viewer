		...
		<html>
            ...
            Sequence No. <span class="styBoldText">178</span>
					...
					<div class="styBB" style="width:187mm;">
						...
						<span style="float:left;">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(a) 2019</div><br/>
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(b) 2018</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(c) 2017</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(d) 2016</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(e) 2015</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width: 187mm"></div>
						...
						Form <b style="font-size:9pt">4970</b> (2020)
						</div>
					<div class="pageEnd"/>

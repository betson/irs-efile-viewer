...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- <table id="DataTbl" class="styDepTbl" style="border:none;">-->
               ...
               <!-- <div class="styFST" style="height:3.5mm;font-size:10pt;padding-left:38mm;border:0px;" >Name of QDD:-->
                <div class="styFST" style="height:5mm;min-height:5mm;font-size:10pt;padding-left:38mm;border:0px" >Name of QDD:
							...
							<br/><span style="padding-left:31mm;font-weight:normal;height:5mm;min-height:5mm">
							 <xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="$DependencyData/QDDDetailGrp[$pos]/BusinessName/BusinessNameLine2Txt"/>
							</xsl:call-template></span>
			             </div><br/><br/>
                <div class="styFST" style="height:5mm;min-height:5mm;font-size:10pt;padding-left:50mm;border:0px;padding-top:3mm" >QI-EIN:
                <span style="padding-left:2mm;font-weight:normal">
                <xsl:call-template name="PopulateEIN">
									<xsl:with-param name="TargetNode" select="$DependencyData/QDDDetailGrp[$pos]/QualifiedIntermediaryEIN"/>
								</xsl:call-template></span>
                </div><br/>
               	 <div class="styFST" style="height:5mm;min-height:5mm;font-size:10pt;padding-left:24mm;border:0px;padding-top:5mm" >Tax Period End Date:
               	      <span style="padding-left:2mm;font-weight:normal">
			...
			<tbody>
					...
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 1 = 2">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow1</xsl:otherwise></xsl:choose></xsl:attribute>
						...
						<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 1 = 2">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2
		...
		<html>
			...
			<body class="styBodyClass" style="width:256mm;">
				...
				<div class="styDepTitleLine">
					<span class="styDepTitle" style="padding-right:2mm;width:256mm;">
						<xsl:value-of select="$depDocTitle"/>
					</span>
				</div>

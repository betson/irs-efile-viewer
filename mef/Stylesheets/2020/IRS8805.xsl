						...
						<div class="styLNDesc" style="width:178mm;height:auto;">
							...
							<span style="float:right;">
								...
								<input type="checkbox" class="styCkboxNM"
									alt="Own Int Greater Than One Partnership Indicator">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" 
											select="$FormData/OwnIntGreaterOnePartnershipInd"/>
										<xsl:with-param name="BackupName">IRS8805OwnIntGreaterOnePartnershipInd</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="width:178mm;height:auto;">
							<label>
								...
								</xsl:call-template>Check if any of the partnership's effectively connected taxable
									income (ECTI) is exempt from U.S. tax for the partner identified on line 1a</label>
							<!-- dots -->
							<span style="float:right;">
								<input type="checkbox" class="styCkboxNM" alt="ECTI Exempt Indicator">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/ECTIExemptInd"/>
										<xsl:with-param name="BackupName">IRS8805ECTIExemptInd</xsl:with-param>
									</xsl:call-template>

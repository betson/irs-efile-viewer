...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/AmendedReturnChanges2" />
		...
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					<th class="styDepTblCell" scope="col" style="width:22mm;">Part <br/>Number</th>        
					<th class="styDepTblCell" scope="col" style="width:22mm;">Line <br/>Number</th>  
					<th class="styDepTblCell" scope="col" style="width:28mm;">Amount On <br/>Previous Return</th>        
					<th class="styDepTblCell" scope="col" style="width:28mm;">Amount On <br/>Amended Return</th>  
					<th class="styDepTblCell" scope="col" style="width:87mm;">Explanation</th>       
				</tr>
			</thead>
			<tbody>
				<xsl:for-each select="$DependencyData/AmendedReturnChanges2Grp">
					<tr>

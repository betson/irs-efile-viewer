...
<!DOCTYPE xsl:stylesheet [
	<!ENTITY nbsp "&#160;">
]><!-- Last Modified by Iskilu Lawal on 4/20/2020 UWR # 230731 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form8916A">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:34mm;font-size: 7pt;height:18.5mm;">
      Form <span class="styFormNumber">8916-A</span>
						...
						<div class="styFTBox" style="height:18.5mm;width:122mm;padding-top:1mm;">
       ...
       Go to 
        <a href="http://www.irs.gov/Form 1120" title="Link to IRS.gov"><i>www.irs.gov/Form 1120  </i></a> for the latest information.
						...
						<div class="styTYBox" style="width:30mm;height:18.5mm; border-left-width: 1px;">
							<div class="styOMB" style="height:0mm;padding-top:8mm;border-bottom-width:0px;">OMB No. 1545-0123</div>
						
							<!--<div class="styTY" style="height:10mm;">20<span class="styTYColor">18</span>
							</div>-->
						</div>
					</div>
					<!--  End title of Form  -->
	...
	<div class="styEINBox" style="width:46mm;height:auto;padding-left:2mm;font-size:7pt;">
     ...
     <div class="styPartDesc" style="width:164mm;font-size:9pt;padding-left:4mm;height:4.5mm">Cost of Goods Sold</div>
					...
					<!-- END Part I Title -->
					<!--start table-->
					<div class="styBB" style="height:12mm;font-size:7pt;width:187mm;">
							<div style="height:12mm;font-weight:normal;padding-top:5mm;width:85.3mm;font-size:8.5pt;text-align:center;">
							   Cost of Goods Sold Items
							</div>
							<div style="height:12mm;width:24mm;padding-top:1.5mm;text-align:center;border-style:solid;border-color:black;border-width:0px 0px 0px 1px;">
					...
					<table class="styTable" id="IRS8916ATableData" summary="Cost of Goods Sold Items" cellspacing="0" cellpadding="0" style="font-size:8.5pt;width:187mm;">
						<!-- line 1 -->
						<tr valign="middle" style="height:8mm;width:187mm;">
    ...
    <xsl:with-param name="TargetNode" select="$FormData/AmtAttrblCostFlowAssumptionGrp/ExpensePerIncomeStmtAmt"/>
						...
						<tr valign="middle" style="height:8mm;">
							...
							<td class="styIRS8916ACell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AmountsAttributableGrp/CorpOwnedLifeInsurancePremiums/ExpensePerIncomeStmtAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
							<!-- col 2 -->
							<td class="styIRS8916ACell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AmountsAttributableGrp/CorpOwnedLifeInsurancePremiums/TemporaryDifferenceAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
							<!-- col 3 -->
							<td class="styIRS8916ACell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AmountsAttributableGrp/CorpOwnedLifeInsurancePremiums/PermanentDifferenceAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
							<!-- col 4 -->
							<td class="styIRS8916ACell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AmountsAttributableGrp/CorpOwnedLifeInsurancePremiums/DeductionPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
       ...
       Cat. No. 48657X 
        ...
        Form <span class="styBoldText" style="font-size:8pt;">8916-A </span> (Rev. 11- 2020)
    </div>
                    </div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 8916-A (Rev. 11- 2020)<span style="width:148mm;"/>
						</div>
					...
					<table class="styTable" id="IRS8916ATable" summary="Interest Income [header]" cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm">
						<tr class="styIRS8916ATheadCellPt2" style="height:auto;width:187mm;">
							<th class="styIRS8916ALnNumCell" style="height:10mm"/>
							<th class="styIRS8916ATxCell" style=" border-style: solid;border-color: black;border-bottom-width:1px;border-right-width:1px;width:50mm;text-align:center;vertical-align:middle;
							font-size:8.5pt;font-weight:normal;" scope="col">Interest Income Item</th>
            ...
            <!-- pushpin data -->
							...
							<!-- col 4 -->
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/HybridSecuritiesIntIncomeGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
            ...
            <!-- pushpin data -->
							...
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SaleLeaseInterestIncomeGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
            ...
            <!-- pushpin data -->
							...
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IntercompanyIntIncOutsideGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
            ...
            <!-- pushpin data -->
							...
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IntercompanyIntIncAffldGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
            ...
            <!-- pushpin data -->
							...
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/OtherInterestIncomeGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="styIRS8916AamtCell" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotalInterestIncomeGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
								<span style="width:1px;"/>
							</td>
						</tr>
            ...
            <!-- pushpin data -->
						...
						<tr>
							...
							<!-- col 1 -->
							<td class="styIRS8916AamtCell" style="border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
							...
							<!-- col 4 -->
							<td class="styIRS8916AamtCell" style="border-right-width:0px;border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">

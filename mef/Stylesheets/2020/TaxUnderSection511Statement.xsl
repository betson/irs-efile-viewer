...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Display name - 990PF - Tax Under Section 511 Statement -->
  ...
  <xsl:template match="/">
    ...
    <!-- NameDisplay - IRS990PF - Tax Under Section 511 Statement -->
      <body class="styBodyClass">  
        ...
        <xsl:call-template name="PopulateDepCommonLeftover">
          ...
          <div style="float:left;clear:none; padding-right:2mm;">          

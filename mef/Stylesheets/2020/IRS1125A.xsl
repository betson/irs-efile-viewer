...
-->
	<xsl:template match="/">
				...
				<form name="IRS1125A">
                    ...
                    Form <span class="styFormNumber" style="font-size:14pt;">1125-A</span>
						...
						<div class="styFTBox" style="width:125mm;height:18mm;">
							<div class="styMainTitle" style="height:8mm;font-size:13pt;">Cost of Goods Sold</div>
							<div class="styFST" style="height:4mm;font-size:7pt;padding-top:1mm">
								...
								Attach to Form 1120, 1120-C, 1120-F, 1120S, or 1065.<br/>
								<img src="{$ImagePath}/8825_Bullet_Title.gif" width="4" height="7" alt="Bullet Image"/>
								Go to <i><a href="http://www.irs.gov/form1125a">www.irs.gov/Form1125a</a></i> for the latest information.
								</div>
						</div>
						...
						<div style="float:right;">
							<div class="styLNDesc" style="width:11mm;height:4.5mm;padding-top:1.5mm;text-align:right;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox" alt="Section 263A Rules Apply Indictoe Yes" >
				  ...
				  Yes
							...
							<div class="styLNDesc" style="width:15mm;height:4.5mm;padding-top:1.5mm;text-align:right;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox"  alt="Section 263A Rules Apply Indictoe No">
						...
						<div style="float:right;">
							<div class="styLNDesc" style="width:11mm;height:7mm;padding-top:4.5mm;text-align:right;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox"  alt="Inventory Determination Change Indictor Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form1125AData/InventoryDeterminationChgInd"/>
				  ...
				  Yes
							...
							<div class="styLNDesc" style="width:15mm;height:7mm;padding-top:4.5mm;text-align:right;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox"  alt="Inventory Determination Change Indictor No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form1125AData/InventoryDeterminationChgInd"/>
											<xsl:with-param name="BackupName">IRS1125AScheduleAInventoryDeterminationChange</xsl:with-param>
										</xsl:call-template>
       ...
       Cat. No. 55988R 
        ...
        Form <span class="styBoldText" style="font-size:8pt;">1125-A</span> (11-2018)
    </div>
					</div>
					<!-- END PAGE I FOOTER -->

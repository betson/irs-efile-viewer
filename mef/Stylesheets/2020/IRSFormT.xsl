<?xml version="1.0" encoding="UTF-8" ?>
 ...
 <!-- Last modified on 08/14/2015 by Robert Jones for IBM Defect 43872 IE11 issues-->
  <!-- Last modified on 10/27/2015 by Robert Jones Removed Part IV Scroll Functionality-->
   ...
   <xsl:if test="not($Print) or $Print=''">
    ...
    <link rel="stylesheet" type="text/css" name="General" href="{$CSSPath}/general.css"/>
			...
			<body class="styBodyClass">
                ...
                (Rev. December 2019)
                  ...
                  Forest Activities Schedule
								...
								<div class="styFBT" style="padding-bottom:1.75mm;font-size:6pt;">
									<img src="{$ImagePath}/T_Bullet.gif" alt="Bullet Image"/> Attach to your tax return. <span style="width:10mm;"/><br></br>
          ...
          <div class="styGenericDiv" style="width:187mm;">
            <div class="styNameBox" style="width:140mm;height:auto;font-size:7pt;">
              Name(s) as shown on return<br/>
               <xsl:choose>
            <!--Business Name from FormTData-->
		    <xsl:when test="$FormTData/ShownOnReturnName">
		      <xsl:call-template name="PopulateText">
		            <xsl:with-param name="TargetNode" select="$FormTData/ShownOnReturnName/BusinessNameLine1Txt"/>
              </xsl:call-template>
		      <br/>
		      <xsl:call-template name="PopulateText">
		            <xsl:with-param name="TargetNode" select="$FormTData/ShownOnReturnName/BusinessNameLine2Txt"/>
              </xsl:call-template>
            </xsl:when>
          </xsl:choose>
            ...
            <div class="styEINBox" style="width:45mm;height:auto;font-size:7pt;padding-left:2mm;font-weight:bold;">
              ...
              <span style="font-weight:normal;">
                <span style="width:4px;"> </span>  
            <!--Identifying Numnber from FormTData-->
		    <xsl:if test="$FormTData/EIN">
		      <xsl:call-template name="PopulateEIN">
		            <xsl:with-param name="TargetNode" select="$FormTData/EIN"/>
              </xsl:call-template>
            </xsl:if>
			  <br/>
			 <xsl:if test="$FormTData/SSN">
		      <xsl:call-template name="PopulateSSN">
		            <xsl:with-param name="TargetNode" select="$FormTData/SSN"/>
              </xsl:call-template>
            </xsl:if>
            <xsl:if test="$FormTData/MissingEINReasonCd">
		      <xsl:call-template name="PopulateText">
          ...
          <div class="styBB" style="width:187mm;padding-bottom:.5mm;">
            <div style="float:left;">Form T (Timber) (Rev. 12-2019)<span style="width:128mm;"></span></div>
          ...
          <div style="width:187mm;clear:both;padding-top:1mm;">
            ...
            <span style="float:right;" class="styGenericDiv">Form <span class="styBoldText">T (Timber)</span> (Rev. 12-2019)</span>
          </div>
       	 ...
       	 <xsl:otherwise>
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px;border-top-width:0px">
                    ...
                    <span style="width:21.5mm" /><span class="styBoldText">b</span>
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;border-top-width:0px;">
                    <div class="styLNLeftNumBox" style="height:4mm;"></div>
                    <span style="width:21.5mm" /><span class="styBoldText">c </span>
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;vertical-align:top;">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">7</div>
                     <div  class="styLNDesc" style="width:130mm;">Cruising, surveying, and other acquisition expenses
                    <span style="letter-spacing:4mm;font-weight:bold">...........</span></div>
                  </td>    
                  <td class="styDepTblCell" style="text-align:right;" >    
                    <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;vertical-align:top;">
                   ...
                   <div  class="styLNDesc" style="width:130mm;"> Total cost or other basis of property. Add lines 4a through 7
                    <span style="letter-spacing:4mm;font-weight:bold">......</span></div>
                  </td>
                  <td class="styDepTblCell" style="text-align:right;" >    
                    <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" style="width: 80mm;font-size:7pt;text-align:left;font-weight:normal;" scope="col">
                    <div style="height:4mm;text-align:left;vertical-align:center;" class="styLNLeftNumBoxSD">9</div>
                  <div  class="styLNDesc" style="width:65mm;">Allocation of total cost or other basis on books:</div>
                  </td>
                ...
                <tr class="styDepTblRow1">
                  ...
                  <td style="width: 31.5mm; text-align: right" class="styFormTTablesCells "><nobr>
                    ...
                    <span style="width:1px;"></span></nobr>
                  </td>
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow1">
                  ...
                  <td style="width: 25mm;height: 4mm;vertical-align:center;" class="styFormTTablesCells "><nobr>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="12" />
                      <xsl:with-param name="TargetNode" select="ImprovedLand/UnitQty" />
                    </xsl:call-template><span style="width:1px;"></span></nobr>
                  </td>
                  <td style="width: 31.5mm; text-align: right;vertical-align:center;" class="styFormTTablesCells "><nobr>
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                  ...
                  <td style="width: 32.5mm; height: 4mm; border-right:0;vertical-align:center;" class="styFormTTablesCells "><nobr>
                    <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 80mm;text-align: left;vertical-align:top;height:auto;" scope="row" class="styFormTTablesCells ">
                    ...
                    <div style="float:left;font-size:7pt;width:76mm;padding-left:1.5mm;">
                      ...
                      <img src="{$ImagePath}/T_Bracket_Lg.gif" alt="Curly Bracket Image" height="85" width="6" />
                    </div>
                  ...
                  <td style="width: 25mm;height: 4mm;vertical-align:top;" class="styFormTTablesCells "><nobr>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="MaxSize" select="12" />
                      <xsl:with-param name="TargetNode" select="MerchantableTimber[1]/UnitQty" />
                    </xsl:call-template><span style="width:1px;"></span></nobr>
                  </td>
                  <td style="width: 31.5mm; text-align: right;vertical-align:top;" class="styFormTTablesCells "><nobr>
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                  ...
                  <td style="width: 32.5mm; height: 4mm; border-right:0;vertical-align:top;" class="styFormTTablesCells "><nobr>
                    <xsl:call-template name="PopulateAmount">
               ...
               <td style="width: 80mm;text-align: left;vertical-align:center;" scope="row" class="styFormTTablesCells ">
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 80mm;text-align: left;vertical-align:top" scope="row" class="styFormTTablesCells ">
                    ...
                    <div style="float:left;">
                      <img src="{$ImagePath}/T_Bracket_Sm.gif" alt="Curly Bracket Image" height="56" width="6"  />
                    </div>
                  </td>
                  <td style="width: 18mm; text-align: left;vertical-align:top;" class="styFormTTablesCells ">
                    <xsl:call-template name="PopulateText">
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                    ...
                    <td style="width: 31.5mm; height: 4mm; border-right:0;vertical-align:top;" class="styFormTTablesCells "><nobr>
                      <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="TotalCostOrOtherBasisAmt" />
                      </xsl:call-template><span style="width:1px;"></span></nobr>
                     </td>
        ...
        <xsl:choose>
            ...
            <xsl:for-each select="$FormTADataII">
              <table class="styDepTbl" style="font-size:7pt;display:table;">
                ...
                <tr class="styDepTblRow2">
                  ...
                  <th class="styDepTblHdr" style="width:29mm;text-align:center;border-right-width:1px;">(a) <br /><b>Quantity</b></th>
                  <th class="styDepTblHdr" style="width:34mm;text-align:center;border-left-width:1px;">(b) <br /><b>Cost or other basis</b></th>
                </tr>
                <!-- Line 2 -->
                <tr class="styDepTblRow1">
                ...
                <tr class="styDepTblRow1">
                  ...
                  <td class="styDepTblCell" style="text-align:left;border-left-width:0px">
                    <span>Addition to capital during tax year</span>
                    <span style="letter-spacing:4mm;font-weight:bold">............</span>
                  </td>
          ...
          <xsl:if test="($Print = $Separated) and (count($FormTADataIII)&gt;1 or count($FormTADataIII/MerchantableTimber)&gt;6 or count($FormTADataIII/PremerchantableTimber)&gt;4 or count($FormTADataIII/Improvement)&gt;6) ">
       	 ...
       	 <xsl:otherwise>
              ...
              <tr class="styDepTblRow2">
                <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px">
                  <div class="styLNLeftNumBox" style="height:4mm;text-align:left;vertical-align:bottom;">4</div>
                  <div  class="styLNDesc" style="width:130mm;">Amount received:<span style="width:7px;vertical-align:bottom;" />a
                  <span style="width:5px;vertical-align:bottom;" />In cash
                  <span style="letter-spacing:4mm;font-weight:bold;vertical-align:bottom;">..........</span></div>
                </td>
              ...
              <tr class="styDepTblRow2">
                <td style="width: 80mm;font-size:7pt;text-align:left;font-weight:normal;" scope="col" class="styFormTTablesHeaders ">
                  <div style="height:4mm;text-align:left;" class="styLNLeftNumBox">7</div>
                   <div  class="styLNDesc" style="width:65mm;">Cost or other basis of property:</div>
              ...
              <tr class="styDepTblRow1">
                <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
                  <div style="height:4mm;" class="styLNLeftLtrBox">a</div>
                    <div  class="styLNDesc" style="width:65mm;">Forested land
                  <span style="letter-spacing:4mm; font-weight:bold;">.....</span></div>
                </td>
                <td style="width: 18mm; text-align: center;" class="styFormTTablesCells ">
                  Acre<span style="width:1px;"></span>
              ...
              <tr class="styDepTblRow2">
                <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
                  <div style="float:left;font-size:7pt;">
                    <div style="height:4mm;" class="styLNLeftLtrBox">b</div>
                   <div  class="styLNDesc" style="width:65mm;"> Nonforested land
                ...
                <td style="width: 32.5mm; text-align: right" class="styFormTTablesCells "><nobr>
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
              ...
              <tr class="styDepTblRow1">
                ...
                <td style="width:  32.5mm; text-align: right;vertical-align:bottom;" class="styFormTTablesCells "><nobr>
              ...
              <tr class="styDepTblRow2">
                <td style="width: 80mm;text-align: left;vertical-align:top;" scope="row" class="styFormTTablesCells ">
                  ...
                  <div style="float:left;font-size:7pt;width:76mm;">
                    ...
                    <div  class="styLNDesc" style="width:65mm;"> Merchantable timber. Estimate in detail the quantity of merchantable timber on the date of sale or exchange. Include the quantity of timber in each species of timber by diameter at breast height (DBH) classes. State the log rule used if the unit of measure is thousand 
                      board feet (MBF), log scale. If another unit of measure is used, provide details. <img  src="{$ImagePath}/T_Bullet.gif" alt="Bullet Image" /><br />
                       </div>            
                  </div>
                  <div style="float:left;">
                    <img  src="{$ImagePath}/T_Bracket_Lg.gif" alt="Curly Bracket Image" height="85" width="6"   />
       	 ...
       	 <xsl:call-template name="PopulateAmount">
             ...
             <tr class="styDepTblRow1">
               <td style="width: 80mm;text-align: left;vertical-align:center;" scope="row" class="styFormTTablesCells ">
                 ...
                 <div style="float:left;">
                   <img alt="Curly Bracket Image" src="{$ImagePath}/T_Bracket_Sm.gif" height="56" width="6"  />
                 </div>
               </td>
               ...
               <td style="width: 155mm;text-align: left;" scope="row" class="styFormTTablesCells " colspan="4">
                 <div style="float:left;font-size:7pt;">
                   <div style="height:4mm;" class="styLNLeftLtrBox">h</div>
                    <div  class="styLNDesc" style="width:130mm;">Total cost or other basis. Add lines 7a through 7g
             ...
             <tr class="styDepTblRow1">
               <td style="width: 155mm;text-align: left;" scope="row" class="styFormTTablesCells " colspan="4">
                 <div style="float:left;font-size:7pt;">
                  ...
                  <div  class="styLNDesc" style="width:130mm;"> Direct sale expenses (cruising, marking, selling)
          ...
          <table class="styDepTbl" style="font-size:7pt;display:table;">
            <thead class="styTableHead">
              <tr class="styDepTblHdr">
                ...
                <th class="styDepTblCell" style="width:32mm"><b>Number of <br />acres treated</b></th>
                <th class="styDepTblCell" style="width:32mm"><b>Total <br />expenditures</b></th>
              </tr>
            </thead>
            <tbody>
          ...
          <xsl:for-each select="$FormTADataV">
            <table cellpadding="0" cellspacing="0" class="styDepTbl" style="font-size:7pt;display:table;">
              ...
              <tbody>
                <!-- Line 2 -->
                <tr class="styDepTblRow1">
                  <td style="width: 90mm;text-align:left;font-weight:normal;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 90mm;text-align:left;font-weight:normal;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
                    ...
                    <div style="height:4mm;" class="styLNLeftNumBox">3</div>
                      <div  class="styLNDesc" style="width:65mm;text-align:left;text-align:left;">Acquisitions during year</div>
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 90mm;text-align:left;font-weight:normal;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
                    ...
                    <div style="height:4mm;" class="styLNLeftNumBox">4</div>
                      <div  class="styLNDesc" style="width:65mm;text-align:left;text-align:left;">Sales during year</div>
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 90mm;text-align:left;font-weight:normal;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
                    ...
                    <div style="height:4mm;" class="styLNLeftNumBox">5</div>
                      <div  class="styLNDesc" style="width:65mm;text-align:left;text-align:left;"> Other changes</div>
                ...
                <!-- Line 6 -->
                <tr class="styDepTblRow1">
                  <td style="width: 90mm;text-align:left;font-weight:normal;height:auto;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;">
  ...
  <xsl:template name="populateparti">
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <div style="width:187mm;height:100%;border:0 solid red;background-color:lightgrey;">
        ...
        <div class="styShadingCell" style="float:right;" ></div>
      </div>
    </div>  
      ...
      <tbody>
        ...
        <tr>
          <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
            <div style="float:left;font-size:7pt;">
              ...
              <div class="styBB" style="width:70mm;float:left;clear:none;vertical-align:bottom;padding-left:0mm;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="ImprovedLand/@desc" />
                </xsl:call-template>
                <xsl:if test="not(ImprovedLand/@desc) or (ImprovedLand/@desc !='')">
        ...
        <tr>
          <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells " rowspan="6">
            ...
            <div style="float:left;font-size:7pt;width:76mm;">
              <div style="" class="styLNLeftLtrBox">d</div>
             Merchantable timber. Estimate the quantity of merchantable timber present on the acquisition date
            <span style="width:29px;"/>(see Regulations section 1.611-3(e)). Details of the  
            <span style="width:29px;"/>timber estimate, made for purposes of the acquisition, 
            <span style="width:29px;"/>should be available if your return is examined.
        ...
        <tr>
          <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells " rowspan="4">
            ...
            <div style="float:left;font-size:7pt;width:76mm;">
              <div style="height:4mm;padding-bottom:1mm;" class="styLNLeftLtrBox">e</div>
              Premerchantable timber. Make an allocation
                here only if it is a factor in the total cost or value of the land.</div>
               <div style="float:left;">
              <img src="{$ImagePath}/T_Bracket_Sm.gif" alt="Curly Bracket Image" height="56" width="6"  />
            </div>
          </td>
        ...
        <tr>
          ...
          <td style="width: 32.5mm;  border-right:0;border-bottom-width:0px;" class="styFormTTablesCells ">
            <span style="width:1px;"></span>
          </td>
        </tr>
        <xsl:for-each select="Improvement">
          <tr>
            <td style="width:80mm;text-align: left;border-bottom-width:0px;height:9mm;" scope="row" class="styFormTTablesCells " >
              <xsl:if test="position() = last() and position() &gt;= 6">
                <xsl:attribute name="style">width:80mm;text-align: left;height:9mm;</xsl:attribute>
              </xsl:if>
              <div style="float:left;font-size:7pt;height:9mm;">
                <div style="height:9mm;" class="styLNLeftLtrBox"></div>
                <xsl:choose>
                  <xsl:when test="position() = last() and position() &gt;= 6">
                    <div style="width:70mm;height:9mm;float:left;clear:none;" class="styGenericDiv">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="Desc" />
                      </xsl:call-template>
                    </div>
                  ...
                  <xsl:otherwise>
                    <div style="width:70mm;height:9mm;float:left;clear:none;" class="styBB">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="Desc" />
                      </xsl:call-template>
                    </div>
            ...
            <td style="width: 25mm;vertical-align:bottom;" class="styFormTTablesCells ">
               <xsl:call-template name="PopulateAmount">
                 <xsl:with-param name="MaxSize" select="12" />
                  <xsl:with-param name="TargetNode" select="UnitQty" />
              </xsl:call-template>
        ...
        <xsl:choose>
            ...
            <td style="width: 32.5mm; border-right:0;vertical-align:bottom;" class="styFormTTablesCells ">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="TotalCostOrOtherBasisAmt" />
              </xsl:call-template><span style="width:1px;"></span>
            </td>
    ...
    <div class="styBB" style="width:187mm;height:6mm;">
      <div style="width:187mm;height:6mm;">
        <div style="float:left">
          ...
          <div class="styGenericDiv" style="width:50mm;padding-top:.5mm;height:8.5mm;">
   ...
   <!-- </div> -->   
    <div class="styBB" style="width:187mm;height:12mm;">
      <div style="width:187mm;height:12mm;">
        <div style="width:123mm; height:12mm; border-top-width:1px; border-right-width:25px; float:left;">
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <div style="width: 187mm; float: left;">
		<div class="styLNLeftNumBoxSD" style="width: 8mm; height: 7mm; padding-top: 3.5mm;">
			6
		</div>
			<div style="width: 48mm; height: 7mm; padding-top: 3.5mm; float: left;">
				Addition to capital during tax year
			</div>
				<div class="styFormTDotLnForPartII" style="width: 67mm; float: left;">
					 ................
				</div>
        ...
        <tr>
          <td style="width: 80mm;text-align: left;vertical-align:top;" scope="row" class="styFormTTablesCells " rowspan="12">
           ...
           <b>d</b> Merchantable timber. Estimate in detail the quantity of merchantable timber on the date of sale or exchange. Include the quantity of
            ...
            <div style="float:left;">
              <img alt="Curly Bracket Image" src="{$ImagePath}/T_Bracket_Lg.gif" height="85" width="6"  />
            </div>
            <xsl:for-each select="LogRuleUsedTxt">
...
<!-- Part IV -->
  ...
  <!-- Start the table -->
   ...
   <xsl:call-template name="SetInitialDynamicTableHeight">
    ...
    <div class="styBB" style="width:187mm;">
      <div style="width:187mm;">
        <div style="float:left">
          <div class="styLNLeftNumBox" style="height:auto;">2</div>
    ...
    <div class="styNBB" style="width:187mm;">
      <div style="width:187mm;">
        <div style="float:left">
          ...
          <span style="padding-top:.5mm;height:4mm;">Amount to be amortized under IRC 194(a), including remaining reforestation <br/>expenditures not expensed under section 194(b)
				<span style="letter-spacing:4mm; font-weight:bold;padding-top:.5mm;height:4mm;">
              ..........
				  </span> 
			</span>
        </div>
        <div style="float:right">
          <div class="styLNAmountBoxNBB" style="height:7mm;width:32mm;padding-right:0.5mm;border-right-width:1px;background-color:lightgrey;" ></div>
          <div class="styLNAmountBoxNBB" style="height:7mm;width:32mm;padding-right:0.5mm;border-left-width:0px;" >
    ...
    <div class="styBB" style="width:187mm;">
      <div style="width:187mm;">
        <div style="float:left">
          <div class="styLNLeftNumBox" style="height:4mm;"></div>
          <span style="padding-top:.5mm;height:4mm;"></span>
        </div>
        <div style="float:right">   
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width:32mm;padding-right:0.5mm;border-right-width:1px;background-color:lightgrey;" ></div>
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width:32mm;padding-right:0.5mm;border-left-width:0px;" >
  ...
  <xsl:template name="populatepartv">
    ...
    <table cellpadding="0" cellspacing="0" class="styFormTTable" style="display:table;">
      ...
      <tbody>
        <tr>
          <td style="width: 90mm;font-size:7pt;text-align:left;font-weight:normal;border-bottom-width:0px;" scope="col" class="styFormTTablesCells ">
            <div style="float:left;font-size:7pt;">
              <div style="height:4mm;" class="styLNLeftNumBox">2</div>
          ...
          <div class="styNBB" style="width:187mm;">
            ...
            <xsl:choose>
              <xsl:when test="AdditionalInformationTxt and AdditionalInformationTxt != '' ">
                <div class="styBB" style="width:187mm;text-align:left;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="AdditionalInformationTxt" />
                  </xsl:call-template>
                </div>

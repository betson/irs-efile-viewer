...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/TaxReductionExplanation"/>
		...
		<table id="AccountingFeesScheduleTbl" class="styDepTbl">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">
					<th class="styDepTblCell" scope="col">Form 8865 Tax Reduction Explanation</th>
				</tr>
			</thead>
			<xsl:for-each select="$DependencyData/TaxReduction">
				<tr>

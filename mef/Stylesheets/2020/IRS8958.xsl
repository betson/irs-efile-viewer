			...
			<body class="styBodyClass">
				<form id="IRS8958">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:30mm;height:20mm;">
							<div style="width:29mm;height:13mm;">
								...
								<span class="styAgency">(November 2019)</span>
						...
						<div class="styFTBox" style="width:126.8mm;">
							<span class="styMainTitle" style="font-size:9pt;">Allocation of Tax Amounts Between <br/>Certain Individuals in Community Property States</span><br/>
							<div class="styFBT">
							<img alt="Bullet" src="{$ImagePath}/8867_Bullet.gif" height="9" width="9"/>
							Attach to Form 1040, Form 1040-SR, or Form 1040-NR. <br/>	
								<img alt="Bullet" src="{$ImagePath}/8867_Bullet.gif" height="9" width="9"/>
								Go to <i>www.irs.gov/Form8958</i> for the latest information.							
							</div>
						</div>
					...
					<div class="pageEnd" style="width:187mm;float:none;clear:both;">
						...
						<span style="float:right;clear:none;">Form <span style="font-weight:bold;font-size:9pt;">8958</span> (11-2019)</span>
					</div>
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
						<span style="float:left;clear:none;">Form 8958 (11-2019)</span>
					...
					<xsl:call-template name="LineTableGroup">
						...
						<xsl:with-param name="description">Other items such as: Social Security Benefits, Unemployment Compensation, Deductions, Credits, etc.</xsl:with-param>						  <xsl:with-param name="lines" select="14"/>
					</xsl:call-template>
					...
					<xsl:if test="$Print = $Separated">
						...
						<xsl:if test="count($FormData/OtherItemAllocnGrp) &gt; 14">
							<xsl:call-template name="SeparatedTableGroup">
								<xsl:with-param name="target" select="$FormData/OtherItemAllocnGrp"/>
								<xsl:with-param name="number" select="12"/>
								<xsl:with-param name="description">Other items such as: Social Security Benefits, Unemployment Compensation, Deductions, Credits, etc.</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
					</xsl:if>
				</form>
								...
								<tr>															
									<td class="sty8958LCell" style="width:85mm;height:10mm;">
										<xsl:if test="position() = 1">																			
											<div style="width:6mm;font-weight:bold;padding-left:1mm;float:none;"><xsl:value-of select="$number"/></div><div style="float:none;width:77mm;">
											<xsl:value-of select="$description"/></div>											
										</xsl:if>										
										<span style="padding-left:6mm;width:78mm;padding-top:2.5mm;">
											<xsl:call-template name="PopulateText">											   

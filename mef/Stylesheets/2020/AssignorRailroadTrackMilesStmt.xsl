...
<!--          <td class="styDepTblCell" style="text-align:center;" >
          ...
          <td class="styDepTblCell" style="text-align:left;">
               <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="AssignorName/BusinessNameLine1Txt"/>
                </xsl:call-template>
                <xsl:if test="AssignorName/BusinessNameLine2Txt !=''">
                <br/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="AssignorName/BusinessNameLine2Txt"/>
                  </xsl:call-template>
                </xsl:if>
         </td>          

				...
				<form name="IRS8814">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem" style="height:11mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									Add lines 1a, 2a, and 3. If the total is $2,200 or less, skip lines 5 through 12 and go to line 13. If<br/>
									the total is $11,000 or more, <b>do not</b> file this form. Your child <b>must</b> file his or her own return to<br/>
						...
						<div class="styIRS8814LineItem" style="height:11mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									Subtract line 11 from line 6. Include this amount in the total on Schedule 1 (Form 1040), line 8. In the space<br/>
					...
					<div style="width:187mm;" class="styBB">
						<span style="width:100%;height:auto;padding:7px 0px 7px 0px;">
							...
							<div class="styPartDesc" style="padding-left:3mm;">
								Tax on the First $2,200 of Child's Interest and Dividends
							</div>
						</span>
					</div>
					<!-- Body -->
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem" style="height:15mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									<b>Tax.</b> Is the amount on line 14 less than $1,100?<br/>
									<div class="styIRS8814LNDesc" style="width:auto;height:auto;padding:0px 0px 0px 0px;">
										...
										<label>
											...
											<span class="styBoldText">No.</span> Enter $110 here and see the <b>Note</b> below.
										</label>
										<br/>
										<span>
											<xsl:call-template name="PopulateSpan">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:7pt;"> 8814 </span> (2020)
						</div>
					</div>

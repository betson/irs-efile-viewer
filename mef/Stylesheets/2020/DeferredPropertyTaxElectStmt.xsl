...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/DeferredPropertyTaxElectStmt"/>
				...
				<xsl:call-template name="PopulateDepCommonLeftover">
					<xsl:with-param name="TargetNode" select="$FormData"/>
						...
						<table class="styDepTbl" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:for-each select="$FormData/DeferredPropertyTaxElectGrp">
									<tr style="border-color:black;vertical-align:top;">
										...
										<td class="styDepTblCell" style="width:32mm;font-size: 7pt; text-align:right;">
											<span class="styDepTableCellPad"/>
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="TaxEligibleForDeferralAmt"/>
											</xsl:call-template>
										</td>
										<td class="styDepTblCell" style="width:32mm;font-size: 7pt; text-align:right;">
											<span class="styDepTableCellPad"/>

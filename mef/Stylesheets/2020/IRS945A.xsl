			...
			<body class="styBodyClass" style="width:187mm;" >
				<form name="Form945A">
					...
					<div class="styBB" style="width:187mm;height:auto;">
						<div class="styFNBox" style="width:29mm;height:auto;">Form <span class="styFormNumber">945-A</span>
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$Form945AData"/>
							</xsl:call-template><br/>
							<div class="styAgency" style="height:auto;font-size:7.5pt;padding-bottom:2mm;padding-top:1mm;">(Rev. December 2020)</div>
						...
						<div class="styFTBox" style="width:128mm;height:auto; ">
							...
							<div class="styFBT" style="width:128mm;height:auto;margin-top:4mm;font-size:6.5pt;">
								<img src="{$ImagePath}/945A_Bullet_Sm.gif"  alt="Bullet Image"/> Go to <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form945a" title="Link to 	IRS.gov"><i>www.irs.gov/Form945A</i> for instructions and the latest information.</a><br/>
						...
						<div class="styTYBox" style="width:30mm;height:auto;">
							<div class="styOMB" style="height:auto;padding-top:2mm;">OMB No. 1545-1430</div>
							<div class="styTaxYear" style="width:20mm;height:auto;padding-top:0.5mm;border-bottom:1px dashed black;margin-bottom:1.4mm;">
								<xsl:variable name="RHTaxYear">
									<xsl:call-template name="PopulateReturnHeaderTaxYear"/>
								</xsl:variable>
								<xsl:value-of select="substring($RHTaxYear, 1, 2)"/>
								<span class="styTYColor">
									<xsl:value-of select="substring($RHTaxYear, 3, 2)"/>
								</span> 
							</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:130mm;height:auto;padding-bottom:1mm;font-size:7pt;">
						...
						<div class="styEINBox" style="width:55mm;height:auto;padding-bottom:1mm;font-size:7pt;padding-left:2mm;">
					...
					<div style="width:187mm;font-size:7pt;float:left;clear:both;">
						<div class="styLNDesc" style="height:12mm;width:187mm;border-left-width:0px;border-right-width:0px;">You must complete this form if you're a semiweekly schedule
							depositor or became one because your accumulated tax liability during any month was $100,000 or more. Show tax liability here, not deposits. (The IRS gets deposit
							data from electronic funds transfers.) Don't change your current year tax liability by adjustments reported on any Form 945-X, CT-1 X, or 944-X.
						</div>
					</div>
					<div style="float:left;clear:both;width:187mm;">
						<!--January-->
						<div class="styIRS945ACalBox" style="width:235px;font-size:7pt;border-left-width:0px;">
							<div style="height:4mm;width:235px;text-align:center;font-weight:bold;font-size:8pt;">
					...
					<div class="pageEnd" style="width:187mm;border: black solid 1px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;">
						<div class="styGenericDiv" style="float:left;width:auto;text-align:left;font-weight:bold">For Paperwork Reduction Act Notice, see the separate instructions.</div>
						<div class="styGenericDiv" style="float:left;width:50mm;text-align:right;">Cat. No. 14733M</div>                        
						<div class="styGenericDiv" style="float:right" >Form <span style="font-weight:bold;font-size:8.5pt;">945-A</span> (Rev. 12-2020)</div>
					</div>
					<p style="page-break-before: always"/>
					<div class="styBB" style="width:187mm;float:left;clear:both;">  
						<div style="float:left;">Form 945-A (Rev. 12-2020)<span style="width:130mm;"/></div>
					...
					<div style="width:187mm;float:left;font-size:7pt">
						<div class="styLNAmountBox" style="width:187mm;height:auto;float:left;border-left-width:0px;border-right-width:0px;font-weight:bold;text-align:left;">
							<span style="float:left;">M <span style="padding-left: 1.4mm; font-weight:normal;">Total tax liability for the year (add lines <b>A</b> through 
								<b>L</b>). This must equal line 3 on Form 945 (line 19</span><br/>
								<span style="float:left;padding-left:4.5mm;font-weight:normal;">on Form CT-1, line 9 on Form 944)</span>
								<!--Dotted Line-->
					...
					<div class="pageEnd" style="width:187mm;float:left;border:1px solid black;border-right-width:0px;border-bottom-width:0px;border-left-width:0px;">
						<div class="styGenericDiv" style="float:right" >Form <b><span style="font-size:8pt;">945-A</span></b> (Rev. 12-2020)</div>
					</div>
		...
		<html lang="EN-US">
			<body class="styBodyClass" >
				...
				<div style="float:right;width:117px;">
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">17</div>
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">18</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">19</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">20</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">21</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">22</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">23</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">24</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">25</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">26</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">27</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">28</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">29</div>
					<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
						<xsl:call-template name="PopulateAmount">
					...
					<xsl:if test="$NumDays = 29">
						<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;background-color:lightgrey;"/>
					...
					<xsl:if test="$NumDays = 30">
						<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">30</div>
						<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
							<xsl:call-template name="PopulateAmount">
					...
					<xsl:if test="$NumDays = 31">
						...
						<div class="styIRS945ACalNumBox" style="height:4.3mm;width:19px;">31</div>
						<div class="styLNAmountBox" style="border-top-width:1px;height:4.3mm;width:98px;border-bottom-width:0px;border-left-width:0px;font-size:6pt;padding-top:1mm;padding-bottom:0px;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styLNAmountBox" style="height:4mm;width:234px;font-weight:bold;text-align:left;border-bottom-width:0px;border-top-width:1px;border-left-width:0px;">
					<span style="float:left;">
						<span style="width:.5mm"/><xsl:value-of select="$Letter"/><span style="width:2mm"/>Total for month <img src="{$ImagePath}/945A_Bullet_Sm.gif"  alt="Bullet Image"/>
					</span>

					...
					<div class="styStdDiv" style="border:1px solid black;overflow:hidden;">
						<div style="width:187mm;float:left;">
							...
							<div class="styRRB1042SLineDiv styRRB1042SDesc"
								...
								<span style="font-weight:bold;font-size:15pt;padding-left:15mm;">2020</span>
								<br />
							...
							<div class="styRRB1042SLineDiv styRRB1042SDesc"
								...
								<span>Gross Benefit Paid in 2020</span>
								<br />
							...
							<div class="styRRB1042SLineDiv styRRB1042SDesc"
								...
								<span>Benefit Repaid to RRB in 2020</span>
								<br />
								<br />
							...
							<div class="styRRB1042SLineDiv styRRB1042SDesc"
								...
								<span>Net Benefit Paid in 2020</span>
								<br />
								<br />
								<span style="width:48mm;padding-top:3.5mm;text-align:right;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm;height:12.5mm;float:left;">
								...
								<div class="styRRB1042SLineDiv styRRB1042SDesc"
									...
									<span style="font-weight:bold;font-size:11pt;">FORM RRB-1042S (01-20)</span>
								</div>
								</div>
						</div>
					</div>

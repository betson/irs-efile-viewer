	...
	<xsl:template match="/">
		...
		Enter the relevant functional currency and the exchange rate used throughout this schedule <img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="bullet image"/>
					...
					<table cellpadding="0" cellspacing="0" class="styTable" style="width:187mm;font-weight:normal;font-size:7pt;border:1px solid black;">
						...
						<tbody>
							<tr>
								...
								<xsl:if test="$Form8858SchMData/ControlledForeignPrtshpInd or $Form8858SchMData/ControlledForeignCorpInd">
									<td class="styIRS8858SchMTableCell">
										<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:0px;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Other</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Add lines 1 through 8</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:0px;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Purchases of inventory</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:0px;">
									...
									<span style="float:left;">Purchases of tangible prop-<br/>erty other than inventory</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:0px;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Purchases of property rights</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:0px;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Interest paid</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:47mm;text-align:left;border-color:black;border-bottom-width:1px;">
									...
									<span style="float:left;padding-top:.5mm;padding-bottom:.5mm;">Add lines 10 through 16</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
								</td>
								<td class="styIRS8858SchMTableCell">
									<xsl:call-template name="PopulateAmount">
					...
					<div  class="pageEnd" style="width:187mm;padding-top:1mm;float:none;">
						...
						<div style="float:right;font-weight:bold;"> Schedule M (Form 8858) (Rev. 12-2018)</div>
					</div>

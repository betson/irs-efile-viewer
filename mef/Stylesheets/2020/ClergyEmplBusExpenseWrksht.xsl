...
<!-- Last Modified by Eugenia McDonald on 03/12/2020 -->
      ...
      <body class="styBodyClass">
				...
				<br/>
					<div  class="styLNDesc" style="width:187mm;height:6mm;font-size: 10pt;font-family: 'Arial';">Worksheet 3. 
							<b>Figuring the Allowable Deduction for Form 2106 Expenses</b>
					</div>
				...
				<table class="styTable" style="width:187mm;clear:both;font-size:7pt;border-collapse:collapse;">
					<tbody style="border-left:1px solid black;">
						...
						<xsl:for-each select="$DependencyData/OtherExpenseDetail">
							<tr>
						...
						<tr>
							...
							<td class="styTableCell" style="width:112mm;text-align:left;">Total expenses. In Column A, add lines 2 and 4a and enter the result. In column B, enter the amount from line 3.</td>
							<td class="styTableCell" style="width:6mm;font-weight:bold;text-align:center;">5</td>
							<td class="styTableCell" style="width:32mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="styTableCell" style="width:112mm;text-align:left;">Total Form 2106 unreimbursed expenses (subtract line 6 from line 5)</td>
							<td class="styTableCell" style="width:6mm;font-weight:bold;text-align:center;">7</td>
							<td class="styTableCell" style="width:32mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="styTableCell" style="width:112mm;text-align:left;">Nondeductible part of Form 2106 expenses (multiply line 9 by the percent in line 1)</td>
							<td class="styTableCell" style="width:6mm;font-weight:bold;text-align:center;">10</td>
							<td class="styTableCell" style="width:32mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="styTableCell" style="width:112mm;text-align:left;"><b>Ministerial employee business expense deduction allowed.* </b> Subtract line 10 from line 9. Enter the result here and on Form 2106, line 10.</td>
							<td class="styTableCell" style="width:6mm;font-weight:bold;text-align:center;">11</td>
							<td class="styTableCell" style="width:32mm;background-color:lightgrey;"></td>
							<td class="styTableCell" style="width:32mm;">
								<xsl:call-template name="PopulateAmount">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass" style="width:256mm">
				<form name="Form8975ScheduleA">
							...
							, and ending 
								...
								<span style="font-size:7pt;">
								  ...
								  Go to 
									...
									href="http://www.irs.gov/form8975" title="Link to IRS.gov">
										<i>www.irs.gov/form8975</i> for instructions and the latest information.
									</a>
								</span>
								<br/>
							</div>
							...
							<table class="styTable" cellspacing="0" style="width:256mm;font-size:7pt;">
								...
								<thead class="styTableThead" style="font-weight:normal;width:256mm;">
									<tr>
										...
										<th class="styIRS8975SchATableCell" style="vertical-align: top; width: 20mm;" rowspan="2" scope="col">
											<b>2.</b> Entity Role
										</th>
										<th class="styIRS8975SchATableCell" style="vertical-align: top; width: 55mm;" rowspan="2" scope="col">
											<b>3.</b> TIN
										</th>
										<th class="styIRS8975SchATableCell" style="width:28mm;vertical-align: top;" rowspan="2" scope="col">
											<b>4.</b> Tax jurisdiction of <br/>organization or <br/>incorporation if<br/>different from tax<br/>jurisdiction of<br/>residence
										</th>
										<th class="styIRS8975SchATableCell" style="border-right: 0; vertical-align: top;height:7mm;" colspan="4" scope="col">
											<b>5.</b> Main business activities
										</th>
									</tr>
									<tr>
										...
										<xsl:for-each select="$FormData/ConstituentEntityInfoGrp">
											<tr style="vertical-align: top;">
												...
												<td class="styTableCell" style="text-align:left;width:20mm;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="ConstituentEntityRoleCd"/>
													</xsl:call-template>													
												</td>
					...
					<div style="width:256mm;clear:both;">
						...
						<div style="float:right;font-weight: bold; " class="styGenericDiv">Schedule A (Form 8975) (Rev. 12-2020)</div>
					</div>
					<!-- This is an example where electronic display is different from paper display.  Therefore, page 2 is not required for electronic display.  It is only for paper display. -->
					...
					<div style="width:256mm;border-bottom:solid black 2px;padding-top:2mm;">
						<span style="float:left;">Schedule A (Form 8975) (Rev. 12-2020)</span>
					...
					<div style="width:256mm;border-top:solid black 1.5px;">
						<span style="float:right;">
							<b>Schedule A (Form 8975) (Rev. 12-2020)</b>
						</span>
					</div>
					<!-- Recycle Image -->
						...
						<table cellspacing="0" class="styDepTblLandscape" cellpadding="0" style="font-size:7pt;">
							<thead class="styTableThead" style="width:256mm;">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="vertical-align:top;width:20mm;" rowspan="2" scope="col">
										<b>2.</b> Entity Role
									</th>
									<th class="styDepTblCell" style="vertical-align:top;width:55mm;" rowspan="2" scope="col">
										<b>3.</b> TIN
									</th>
	...
	<xsl:template name="ConstituentEntityInfoGrpTemp">
		...
		<tr style="vertical-align: top;">
			...
			<td class="styTableCell" style="font-size:7pt;border-color:black;text-align:left;">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="ConstituentEntityRoleCd"/>
				</xsl:call-template>													
			</td>

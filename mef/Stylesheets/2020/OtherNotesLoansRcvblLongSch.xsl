      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:left">
            ...
            <xsl:if test="BorrowerNameGrp/BusinessName/BusinessNameLine1Txt != ''">
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BorrowerNameGrp/BusinessName/BusinessNameLine1Txt"/>
              </xsl:call-template> 
            </xsl:if>  
            <xsl:if test="BorrowerNameGrp/BusinessName/BusinessNameLine2Txt != ''"><br/>          
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BorrowerNameGrp/BusinessName/BusinessNameLine2Txt"/>
              </xsl:call-template>
            </xsl:if>                     
          </td>
          <td class="styDepTblCell" style="text-align:left">
...
<!-- change -->  
        <!--tr class="styDepTblRow2">  
          ...
          <td class="styDepTblCell" style="text-align:left">          
            ...
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BorrowersName/Business/BusinessNameLine1Txt" />
            </xsl:call-template> 
            &nbsp;              
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BorrowersName/Business/BusinessNameLine2Txt" />
            </xsl:call-template>             
          </td>  
        </tr>
        <tr class="styDepTblRow1">  

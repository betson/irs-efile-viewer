...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="CGATSData" select="$RtnDoc/ControlledGroupAddnlTaxStmt"/>
	  <!-- - Form 1120 Schedule O displays as - Controlled Group Additional Tax Statement - -->
  <xsl:template name="ShowCGATS">    
    <table id="CGATSTbl" class="styDepTbl">    
      <thead class="styTableThead">
        <tr class="styDepTblHdr">           
           <th class="styDepTblCell" style="width:50mm;" scope="col">Corporation Name </th>        
           <th class="styDepTblCell" style="width:12mm;" scope="col">Corporation EIN </th>  
           <th class="styDepTblCell" style="width:36mm;" scope="col">Taxable Income Amount </th>        
           <th class="styDepTblCell" style="width:95mm;" scope="col">Computation </th>        
        </tr>
      </thead>
        <tfoot/>
       <tbody>    
        <xsl:for-each select="$CGATSData/ControlledGroupAddnlTaxDtl">  
          <tr>
            ...
            <td class="styDepTblCell" style="width:12mm;text-align:left;">
             <xsl:choose>
            ...
            <td class="styDepTblCell" style="width:95mm;text-align:left;">
              <xsl:call-template name="PopulateText">

							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/TestateInd"/>
										<xsl:with-param name="BackupName">Form56DataTestateInd</xsl:with-param>
									</xsl:call-template>Court appointment of testate estate (valid will exists)
							   </label>
							</span>   
</div>
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/IntestateInd"/>
										<xsl:with-param name="BackupName">Form56DataIntestateInd</xsl:with-param>
									</xsl:call-template>Court appointment of intestate estate (no valid will exists)
							   </label>
							</span>   
</div>
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/GuardianOrConservatorInd"/>
										<xsl:with-param name="BackupName">Form56DataGuardianOrConservatorInd</xsl:with-param>
									</xsl:call-template>Court appointment as guardian or conservator 
							   </label>
							</span>   
</div>      
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/FiduciaryIntestateEstateInd"/>
										<xsl:with-param name="BackupName">Form56DataFiduciaryIntestateEstateInd</xsl:with-param>
									</xsl:call-template>Fiduciary of intestate estate 
							   </label>
							</span>   
</div>      
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/ValidTrustOrAmendmentInd"/>
										<xsl:with-param name="BackupName">Form56DataValidTrustOrAmendmentInd</xsl:with-param>
									</xsl:call-template>Valid trust instrument and amendments  
							   </label>
							</span>   
</div>      
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/BankruptcyOrAssignmentInd"/>
										<xsl:with-param name="BackupName">Form56DataBankruptcyOrAssignmentInd</xsl:with-param>
									</xsl:call-template>Bankruptcy or assignment for the benefit of creditors  
							   </label>
							</span>   
</div>      
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/OtherFiduciaryAuthorityGrp/OtherAuthorityInd"/>
										<xsl:with-param name="BackupName">Form56OtherFiduciaryAuthorityGrpOtherAuthorityInd</xsl:with-param>
									</xsl:call-template>Other. Describe  
							   </label>
							</span>   
...
<span style="width:8px"/>
<span>
<input type="Checkbox" title="Generation-skipping transfer" id="Generation-skipping transfer" alt="Checkbox" class="styCkbox" onclick="return false">
</input>
</span>
<label for="Generation-skipping transfer">Generation-skipping transfer </label>
<span style="width:8px"/>
<span>
...
<span style="width:8px"/>
<span>
<input type="Checkbox" title="Other (describe)" id="Other (describe)" alt="Checkbox" class="styCkbox"
onclick="return false">
</input>
</span>
...
<input type="Checkbox" alt="Checkbox" title="form706Series" id="form706Series" class="styCkbox" onclick="return false">
</input>
</span>
<label for="form706Series">706 Series </label>
<span style="width:8px"/>
<span><b>b</b>
<span style="width:5px"/>
...
<span><b>d</b>
<span style="width:5px"/>
<input type="Checkbox" alt="Checkbox" title="forms941, 943, 944" id="forms941, 943, 944" class="styCkbox" onclick="return false">
</input>
</span>
<label for="forms941, 943, 944">941, 943, 944 </label>
<span style="width:8px"/>
<span><b>e</b>
<span style="width:5px"/>
<input type="Checkbox" title="form1040 or 1040-SR"  id="form1040 or 1040-SR" class="styCkbox">
<xsl:call-template name="PopulateCheckbox">
...
<span><b>h</b>
<span style="width:5px"/>
<input type="Checkbox" title="Other (list)" id="Other (list)" alt="Checkbox" class="styCkbox"
onclick="return false">
</input>
</span>
<label for="Other (list)">Other (list) </label>
<span style="width:5px"/>
<span><img src="{$ImagePath}/56_Bullet.gif" alt="MediumBullet"/></span><span style="width:5px"/>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/CourtOrderRevocationInd"/>
										<xsl:with-param name="BackupName">Form56DataCourtOrderRevocationInd</xsl:with-param>
									</xsl:call-template>Court order revoking fiduciary authority  
							   </label>
							</span>   
</div>
</div>
							...
							<span style="padding-left:0.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form56Data/CertDissolutionOrTermInd"/>
										<xsl:with-param name="BackupName">Form56DataCertDissolutionOrTermInd</xsl:with-param>
									</xsl:call-template>Certificate of dissolution or termination of a business entity  
							   </label>
							</span>   
</div>
</div>
...
<span style="width:5px;padding-top:0mm;">
<img src="{$ImagePath}/56_Bullet.gif" alt="MediumBullet"/>
</span>

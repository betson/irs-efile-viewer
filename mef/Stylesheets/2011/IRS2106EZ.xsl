...
<li>If you are claiming vehicle expense, you are using the standard mileage rate for 2011.</li><br/>
<span style="font-weight:bold">Caution:</span> <span style="font-style:italic;">You can use the standard mileage rate for 2011 <span style="font-weight:bold">only if: (a)</span> you owned the vehicle and used the standard mileage rate for the first year
you placed the vehicle in service, <span style="font-weight:bold">or (b)</span> you leased the vehicle and used the standard mileage rate for the portion of the lease period after 1997.</span>
					...
					<div style="width:187mm;height:8mm;">
						<div class="styLNLeftNumBox" style="height:8mm;padding-left:1mm;width:5mm;">1</div>
						<div class="styLNDesc" style="height:8mm;width:132mm;padding-right:2mm;">Complete Part II. Multiply line 8a by 51¢ (.51) for miles driven <b>before</b> July 1, 2011, and by 55.5¢ (.555) for miles driven <b>after</b> June 30, 2011. Add the amounts, then enter the result here
<span style="letter-spacing:3mm;">....</span></div>
						<div class="styLNRightNumBox" style="width:8mm;height:8mm;position:relative;"><span style="position:absolute;bottom:0;">1</span></div>
...
instructions for special rules on where to enter this amount.)<span style="letter-spacing:3mm;">....................</span></div>
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">2106-EZ</b> (2011)
						</div>
					</div>
					<!--END Page Footer-->

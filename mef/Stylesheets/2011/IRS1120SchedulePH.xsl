      ...
      <!--   BEGIN WARNING LINE  -->
        ...
        <div class="styIRS1120SchedulePHBB">
          ...
          <div class="styTYBox" style="width:47mm;height:12mm;">
            ...
            <div class="styTY" style="height:15mm;padding-top:3mm;"><span class="styTYColor"></span></div>
          </div>
        </div>
        <!--  END FORM HEADER   -->
        <!--   BEGIN TAXPAYER INFO   -->
        ...
        <div style="width:187mm;float:none;clear:none; border-style: solid; border-top-width: 1px; border-bottom-width: 0px; border-right-width: 0px; border-left-width: 0px;">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            <span style="float:left;clear:none;">
              ...
              <span class="styLNDesc" style="width:92.50mm;">
                <span style="float:left;">Net capital gain from Schedule D (Form 1120), line 13 </span>  
                <!--Dotted Line-->
			    <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">.....</span>
              </span>
            </span>
          ...
          <div class="styGenericDiv" style="width:181mm;">
            <span style="float:left;clear:none;">
              <span class="styLNLeftNumBoxSD" style="padding-left:4mm;"></span>          
              <span class="styLNDesc" style="width:92.50mm;">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              ...
              <span class="styLNAmountBox" style="border-bottom-width:1px; height:">
                <xsl:call-template name="PopulateAmount">
        ...
        <div class="styBB" style="width:187mm;">
          <div style="float:left;clear:none">
            ...
            <div class="styLNDesc" style="width:139mm;">
              <b>PHC tax.</b>  Multiply the amount on line 13 by the tax rate for undistributed PHC
			  income (see instructions). 
              <span style="float:left;">Enter the result here and on Schedule J, line 8, or on the proper line of the appropriate tax return.</span>
              <!--Dotted Line-->
			  <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">..</span>
			</div> 
          </div>
        ...
        <div style="width:187mm;font-size:6pt;">
          ...
          <div style="float:right;">
            ...
            <span class="styBoldText">Schedule PH (Form 1120) (Rev. 12-2011)</span>
          </div>      
        </div>     
        <div class="pageEnd"/>
        <!--END FOOTER-->  
        ...
        <div class="styBB" style="width:187mm;border-bottom:0px solid black;">
          <div style="float: left; clear: none">Schedule PH (Form 1120) (Rev. 12-2011)</div>        
          <div style="float:right">
...
<div style="width: 187mm">
  ...
  <span class="styBoldText" style="float: right">Schedule PH (Form 1120) (Rev. 12-2011)</span>
</div>
<!--   END FORM FOOTER   -->
<br/>
<div class="pageEnd"/>

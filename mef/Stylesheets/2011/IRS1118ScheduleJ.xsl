...
<!-- This stylesheet was last modified 9/8/2010 by Kelly Hytrek per defect #27034 -->
<!-- This stylesheet was last modified 12/1/2010 by Kelly Hytrek per Package 2 Review -->
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="font-size:9px;border-width:2px;" valign="bottom">
                   ...
                   <xsl:call-template name="LinkToLeftoverDataTableInline">
                      ...
                      <xsl:with-param name="TargetNode" select="$FormData/USIncomeColm[1]/RecaptureOverallDomesticLosses/@allocationDomesticLosses"/>
                    </xsl:call-template>
                    </span>
                    <xsl:call-template name="PopulateNegativeNumber">

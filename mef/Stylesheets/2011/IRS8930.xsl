	...
	<xsl:template match="/">
		<html>
				...
				<form name="Form8930">
					...
					<div class="styTBB" style="width:183mm;height:23mm;">
						...
						<xsl:call-template name="LinkToLeftoverDataTableInline">
							<xsl:with-param name="Desc">Top Left Margin - Qualified Disaster Qualified Taxpayer Name</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$FormData/QlfyDsstrQualifiedTaxpayerName"/>
						</xsl:call-template>
						<xsl:call-template name="LinkToLeftoverDataTableInline">
							<xsl:with-param name="Desc">Top Left Margin - Qualified Disaster Qualified Taxpayer SSN</xsl:with-param>
            ...
            Form <span class="styFormNumber">8930<br/>
						...
						<div class="styFTBox" style="width:105mm;height:23mm;">
					...
					<div style="width:187mm;height:7mm;">
						<div class="styLNLeftNumBox" style="height:7mm;padding-left:1mm;width:5mm;">1</div>
						<div class="styLNDesc" style="height:7mm;width:130mm;">
						Enter the amount, if any, from your 2009 Form 8930, line 11, only if you did not check the box on that line
						
						<span style="letter-spacing:3mm;font-weight:bold;">................................</span>
						</div>
						<div style="float:left;">
							<div style="height:3.5mm;width:8mm;border-left:1px solid black;"/>
							<div style="height:4mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">1</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:7.5mm;width:38mm;position:relative;padding-top:3.5mm;padding-bottom:0;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/QlfyDsstrDistriRtrPlnTxblAmt" />
									</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;height:4.5mm;">
						...
						Enter the amount, if any, from your 2010 Form 8930, line 8
						<span style="letter-spacing:3mm;font-weight:bold;"> .</span>
						</div>
						<div style="float:left;">
						...
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:40mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
						...
						<div style="float:left;">
								<div style="height:4.5mm;width:8.1mm;text-align:center;font-weight:bold;border-right:1px solid black;border-left:1px solid black;background-color:lightgrey;"/>
						</div>
					</div>
					<!-- Line 3 -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:4.5mm;width:82mm;">
							Enter the amount, if any, from your 2010 Form 8930, line 3
							<span style="letter-spacing:3mm;font-weight:bold;">.</span>
						</div>
						<div style="float:left;">
					...
					<div style="width:187mm;">
						...
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">4</div>
						</div>
						<div style="float:left;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:8mm;width:130mm;">
							Enter the total amount of any repayments you made before filing your 2011 tax return. But do
							not include repayments made later than the due date (including extensions) for that return. See<br/>
							instructions
							<span style="letter-spacing:3mm;font-weight:bold;"> ..............................</span>
						</div>
						<div style="float:left;">
							<div style="height:8mm;width:8mm;border-left:1px solid black;background-color:lightgrey;"/>
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">5</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:8mm;width:38mm;border-bottom:none;"/>
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/QlfyDsstrPYNetPlusTotRepymtAmt" />
									</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;height:8mm;">
						<div class="styLNLeftNumBox" style="height:8mm;padding-left:1mm;width:5mm;">7</div>
						<div class="styLNDesc" style="height:8mm;width:130mm;">
						Amount subject to tax in 2011. Subtract line 6 from line 1. If zero or less, enter -0-. Include this
amount in the total on Form 1040, line 16b; Form 1040A, line 12b; or Form 1040NR, line 17b
						<span style="letter-spacing:3mm;font-weight:bold;">..</span>
						</div>
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;border-left:1px solid black;background-color:lightgrey;"/>
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;">7</div>
						</div>
						<div style="float:left;">
					...
					<div style="width:187mm;height:9mm;">
						<div class="styLNLeftNumBox" style="height:8mm;padding-left:1mm;width:5mm;">8</div>
						<div class="styLNDesc" style="height:8mm;width:130mm;">
						Enter the amount, if any, from your 2009 Form 8930, line 26, only if you did not check the box on
						that line
						<span style="letter-spacing:3mm;font-weight:bold;">...............................</span>
						</div>
						<div style="float:left;">
						...
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;border-bottom:none;"/>
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;border-bottom:1px solid black;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/QlfyDsstrDistriIRASEPTxblAmt" />
									</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<!-- Line 9 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:1mm;width:5mm;">9</div>
						<div class="styLNDesc" style="height:4mm;width:82mm;">
							Enter the amount, if any, from your 2010 Form 8930, line 17
						</div>
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">9</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:40mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
...
<!--					<div style="width:187mm;">
					...
					<!-- Line 10 -->
				<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:1mm;width:5mm;">10</div>
						<div class="styLNDesc" style="height:4mm;width:82mm;">
							Enter the amount, if any, from your 2010 Form 8930, line 12
						</div>
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">10</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:40mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
					...
					<!-- Line 11 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:1mm;width:5mm;">11</div>
						<div class="styLNDesc" style="height:4mm;width:130mm;">
							Subtract line 10 from line 9. If zero or less, enter -0-
							<span style="letter-spacing:3mm;font-weight:bold;">...............</span>
						</div>
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">11</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;height:12mm;">
						<div class="styLNLeftNumBox" style="height:12mm;padding-left:1mm;width:5mm;">12</div>
						<div class="styLNDesc" style="height:12mm;width:130mm;">
						Enter the total amount of any repayments you made before filing your 2011 tax return. But do
...
instructions
						...
						<div style="float:left;">
							<div style="height:8mm;width:8mm;border-left:1px solid black;background-color:lightgrey;"/>
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">12</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:8mm;width:38mm;border-bottom:none;"/>
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;">
					...
					<!-- Line 13 -->
					<div style="width:183mm;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:1mm;width:5mm;">13</div>
						<div class="styLNDesc" style="height:4mm;width:130mm;">
							Add lines 11 and 12
							<span style="letter-spacing:3mm;font-weight:bold;">............................</span>
						</div>
						<div style="float:left;">
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-bottom:1px solid black;border-left:1px solid black;">13</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/QlfyDsstrPYNetSumTotRepymtAmt" />
									</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<!-- Line 14 -->
					<div style="width:183mm;height:12mm;border-bottom:1px solid black;">
						<div class="styLNLeftNumBox" style="height:12mm;padding-left:1mm;width:5mm;">14</div>
						<div class="styLNDesc" style="height:12mm;width:130mm;">
						<b>Amount subject to tax in 2011.</b> Subtract line 13 from line 8. If zero or less, enter -0-. Include
this amount in the total on Form 1040, line 15b; Form 1040A, line 11b; or Form 1040NR, line 16b
						<span style="letter-spacing:3mm;font-weight:bold;">.................................</span>
						</div>
						<div style="float:left;">
							<div style="height:8mm;width:8mm;border-left:1px solid black;background-color:lightgrey;"/>
							<div style="height:4.5mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;">14</div>
						</div>
						<div style="float:left;">
							<div class="styLNAmountBox" style="height:8mm;width:38mm;border-bottom:none;"/>
							<div class="styLNAmountBox" style="height:4.5mm;width:38mm;position:relative;border-bottom:none;">
						...
						<div style="float:left;clear:none;width:146mm;border-left:1px solid black;">
							...
							<div style="width:140mm;margin-top:4mm">
								...
								<div style="float:right;clear:none;width:58mm;margin-left:1mm;">
									...
									<div style="width:52mm;border-top:1px solid black;font-size:7pt;clear:none">Date</div>
								</div>
							</div>
						</div>
						<!-- END Right Column -->
					...
					<div class="styGenericDiv" style="width:184mm;font-size:6pt;">
						...
						<div style="width:161mm;float:left;clear:none;border-left:1px solid black;">
							...
							<div style="width:161mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								...
								<div class="styLNDesc" style="height:6mm;width:29mm;padding-left:1mm;">Firm's EIN
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
									<span style="width:4px;"/>
							...
							<div style="width:161mm;float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:29mm;padding-left:1mm;border-bottom-width:0"> Phone no. 
 								<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
					...
					<div style="width:183mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm">
						...
						<div style="float:left;margin-left:6mm">
						Cat. No. 37744P
						<span style="width:5mm"/>
						Form <b style="font-size:9pt">8930</b> (2011)
						</div>
					</div>
					<!--END Page Footer-->

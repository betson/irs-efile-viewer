			...
			<body class="styBodyClass">
				...
				<form name="Form1120-PC">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:33.3mm;height:19.5mm;">
      Form <span class="styFormNumber" style="font-size:18pt">1120-PC</span>
        ...
        <span style="width: 18mm;border-bottom:1 solid black;">
        	 ...
        	 See separate instructions.
					...
					<div style="width:187mm;float:left;clear:left;">
						...
						<div class="styLblNameAddr" style="width:106mm;height:26mm; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 1px; border-right-width: 1px;">
							<div class="styUseLbl" style="width:11.5mm;height:29mm;border-right-width:0px;padding-top:5mm;">
    			...
    			To do this, we use the EINChanged parameter PopulateReturnHeaderFiler.-->
					...
					<div class="styBB" style="width:187mm;border-right-width:0px">
						<div class="styBB" style="border-right-width:1px;border-bottom-width:0px;">
							<!-- E 1 -->
							<div class="styGenericDiv" style="width:138.9mm;">
		...
		<!-- Form to Form Link (Push Pin) -->
						...
						<div style="width:181mm;">
							...
							<div style="width:40mm;float:right;clear:none;">
								<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4.51mm;"/>
								<div class="styLNAmountBoxNBB" style="height:4.50mm;"/>
							</div>
						</div>
						<!-- line 8d -->
		          ...
		          <span style="width:16px"/>.
						...
						<div style="width:181mm;">
							<div style="float:left; clear:none;">
								...
								<div class="styLNDesc" style="width:53mm;height:4mm;font-size:6pt;"> 2011 estimated tax payments (see instructions)</div>
						...
						<div style="width:181mm;">
							<div style="float:left;clear:none;">
								<div class="styLNLeftLtrBox" style="height:4mm;padding-left: 4.25mm;">d</div>
								<div class="styLNDesc" style="width:93mm;height:4mm;"> 2011 special estimated tax payments (Do not include on line 14f)</div>
							</div>
							<div style="float:right;clear:none;">
						...
						<div style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:53mm;height:4mm;font-size:6pt;">2011 refund applied for on Form 4466
								   	  <!-- Form to Form Link (Push Pin) -->
									<xsl:call-template name="SetFormLinkInline">
         	  ...
         	  Credit by reciprocal for tax paid by attorney-in-fact under section 835(d)
						...
						<div style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:93mm;height:4mm;">
         	                                          Refundable credits from Form 3800, line 17c, and Form 8827, line 8c
         	                                          <!-- Form to Form Link (Push Pin) -->
									<xsl:call-template name="SetFormLinkInline">
       ...
       Cat. No. 64270Q 
        ...
        Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2011)
    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120-PC (2011)<span style="width:146mm;"/>
						</div>

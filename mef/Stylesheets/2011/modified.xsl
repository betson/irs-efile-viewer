...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html xmlns="http://www.irs.gov/efile" xmlns:efile="http://www.irs.gov/efile">
        ...
        <form name="Form8283">
          ...
          <div style="width:187mm;">
            <div class="styFNBox" style="width:32mm;height:27mm;">
              ...
              <div class="styAgency" style="width:30mm;padding-bottom:2mm;">(Rev. December 2006)
        <span style="width:3px;" /><xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$Form8283Data" /><xsl:with-param name="IDstring">Form8283Data</xsl:with-param><xsl:with-param name="Desc" select="$Form8283Data/@referenceDocumentName" /></xsl:call-template></div>
              <div>
      ...
      of over $500 for all contributed property.
            ...
            <div class="styTYBox" style="width:30mm;height:6mm;">
              <br />
              <div style="font-size:7pt;text-align:left;">
                <span style="width:6px;" />Attachment<br /><span style="width:6px;" />Sequence No.
      <span style="font-family:Arial;font-size:9pt;font-weight:bold;">155</span></div>
            </div>
            <!-- Name(s) & EIN Box  -->
 ...
 <!-- WARNING: Return Type will need to be update with various future form 1040 return type--><xsl:choose><xsl:when test="$RtnHdrData/ReturnType='1040'"><br /><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">Name</xsl:with-param></xsl:call-template></xsl:when><xsl:otherwise><br /><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine1</xsl:with-param></xsl:call-template><br /><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param></xsl:call-template></xsl:otherwise></xsl:choose></div>
              <div class="styEINBox" style="font-size:7pt;width:47mm;height:4mm;padding-left:2mm;">Identifying number<br /><span style="font-weight:normal;"><!-- WARNING: Return Type will need to be update with various future form 1040 return type--><xsl:choose><xsl:when test="$RtnHdrData/ReturnType='1040'"><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">PrimarySSN</xsl:with-param></xsl:call-template></xsl:when><xsl:otherwise><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">EIN</xsl:with-param></xsl:call-template></xsl:otherwise></xsl:choose></span></div>
            </div>
          </div>
          <!--Name(s) & EIN Box -->
          <!--Note -->
        ...
        List in this section <b>only</b><span style="width:19.45mm;" />items (or groups of similar items) for which you claimed a deduction of $5,000 or less. Also, list certain publicly traded
        <span style="width:19.45mm;" />securities even if the deduction is more than $5,000 (see instructions).
          ...
          <div class="styBB" style="width:187mm;border-top-width:1px">
            ...
            <div class="styPartDesc" style="padding-left:3mm;width:150mm;border-top-width:1px;">
              Information on Donated Property<span class="styNormalText">If you need more space, attach a statement.</span></div>
            ...
            <table cellspacing="0" summary="Part I Information on Donated Property" style="" name="TYTable" id="TYTable" class="styTable">
              <thead class="styTableThead">
                <tr>
                  ...
                  <th scope="col" class="styTableCell" style="width:81mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;" colspan="3">
                    <span class="styBoldText">(a)</span>
                    <span style="width:1mm;" />
                    <span style="font-size:7pt;">Name and address of the <br />donee organization</span>
                  </th>
                  <th scope="col" class="styTableCell" style="width:100mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;" colspan="3">
                    <span class="styBoldText">(b)</span>
                    <span style="width:1mm;" />
                    <span style="font-size:7pt;">Description of donated property <br /> (For a donated vehicle, enter the year, make, model, condition, and mileage, and attach Form 1098-C if required.)</span>
                  </th>
                </tr>
              </thead>
              <tfoot />
              <tbody>
                    ...
                    <tr>
                      <td class="styTableCell" style="width:10mm;text-align:left;padding-left:3mm;font-size:7pt;font-weight:bold;border-color:black;">
                        ...
                        <xsl:call-template name="SetFormLinkInline">
                          <xsl:with-param name="TargetNode" select="$Form8283Data/InformationOnDonatedProperty" />
                          <xsl:with-param name="Desc" select="$Form8283Data/InformationOnDonatedProperty/@referenceDocumentName" />
                        </xsl:call-template>
                      </td>
                      <td class="styTableCell" style="width:81mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;" colspan="3">
                        <xsl:call-template name="PopulateText">
                      ...
                      <td class="styTableCell" style="width:100mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;border-right:none;" colspan="3">
                        <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="DescriptionOfDonatedProperty" />
                        </xsl:call-template>,
                                                    <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="VehicleYear" /></xsl:call-template></td>
                    </tr>
                  </xsl:for-each>
                </xsl:if>
                <xsl:if test="(count($Form8283Data/InformationOnDonatedProperty) &lt; 1) or&#xD;&#xA;        (($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5))">
                  <tr>
                    <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">A<span class="styTableCellPad" /></td>
                    <xsl:if test="($Print != $Separated) or (count($Form8283Data/InformationOnDonatedProperty) &lt; 1)">
                      <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3">
                        <span class="styTableCellPad" />
                      </td>
                    </xsl:if>
                    ...
                    <xsl:if test="($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                      <td class="styTableCell" style="width:100mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;" colspan="3">
                        <xsl:call-template name="PopulateAdditionalDataTableMessage">
                          <xsl:with-param name="TargetNode" select="$Form8283Data/InformationOnDonatedProperty" />
                        </xsl:call-template>
                      </td>
                    </xsl:if>
                    <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3">
                      <span class="styTableCellPad" />
                    </td>
                  </tr>
                </xsl:if>
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 2 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">B<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 3 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">C<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 4 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">D<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 5 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">E<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3">
          ...
          <div style="width:187mm;" id="TP1ctn" class="styTableContainerNBB">
            ...
            <table cellspacing="0" summary="Part I Information on Donated Property If the amount you claimed as a deduction for an item is $500 or less, you do not have to complete columns (d), (e), and (f)." class="styTable" style="" name="TYTable1" id="TYTable1">
              <thead class="styTableThead">
                <tr>
                  <th scope="col" colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;font-weight:normal;border-top-width:0px;border-color:black;">
                    ...
                    <span style="width:1mm;" />
                    <span style="font-size: 7pt;">If the amount you claimed as a deduction for an item is $500 or less, you do not have to complete columns (d), (e), and (f).</span>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                      ...
                      <td class="styTableCell" style="width:27mm;font-size: 7pt;font-weight:normal;border-color:black;">
                        <span style="width:0.1mm;float:left;">
                          <xsl:call-template name="SetFormLinkInline">
                            ...
                            <xsl:with-param name="Desc" select="DonorLineDetail/DateAcquiredByDonor/@referenceDocumentName" />
                          </xsl:call-template>
                        </span>
                          ...
                          <xsl:choose>
                            ...
                            <xsl:otherwise>
                              <xsl:call-template name="PopulateMonth">
                                <xsl:with-param name="TargetNode" select="DonorLineDetail/DateAcquiredByDonor" />
                              </xsl:call-template>-<xsl:call-template name="PopulateYear"><xsl:with-param name="TargetNode" select="DonorLineDetail/DateAcquiredByDonor" /></xsl:call-template></xsl:otherwise>
                          </xsl:choose>
                        </span>
                      ...
                      <td class="styTableCell" style="width:36mm;text-align:right;font-size: 7pt;font-weight:normal;border-color:black;">
                        ...
                        <div class="styGenericDiv" style="text-align:left;">
                          <xsl:call-template name="SetFormLinkInline">
                            ...
                            <xsl:with-param name="Desc" select="DonorLineDetail/DonorsCostOrAdjustedBasis/@referenceDocumentName" />
                          </xsl:call-template>
                        </div>
                      ...
                      <td class="styTableCell" style="width:36mm;text-align:right;font-size: 7pt;font-weight:normal;border-color:black;">
                        <div class="styGenericDiv" style="text-align:left;">
                          <xsl:call-template name="SetFormLinkInline">
                            ...
                            <xsl:with-param name="Desc" select="FairMarketValue/@referenceDocumentName" />
                          </xsl:call-template>
                        </div>
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="FairMarketValue" />
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 1 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">A<span class="styTableCellPad" /></td>
                    <xsl:choose>
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 2 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">B<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 3 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">C<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 4 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">D<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                ...
                <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 5 or&#xD;&#xA;        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">E<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;">
          ...
          <div style="width:187mm;height:34mm;" id="TPXctn">
                  ...
                  Total amount claimed as a deduction for the property listed in Part I:
                    ...
                    <div style="width:187mm;">
                      ...
                      <div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept
												<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:7mm;" /><span style="width: 2mm;" /><span style="border-bottom: 1px solid black; width: 20mm;" /></div>
                    </div>
                    <div style="width:187mm;">
			...
			<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:5mm;" /><span style="border-bottom: 1px solid black; width: 20mm;" /></div>
                    </div>
                    <div class="styBB" style="width:180mm;margin-left:4mm;float:left;" />
                    <xsl:choose>
                 ...
                 property?
                <span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:8px;">.</span></div>
                      ...
                      <xsl:otherwise>
                        ...
                        <div style="width:186mm;float:left;">
                          ...
                          <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;padding-bottom:0mm;padding-top:0mm">
            property?
        <span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span></div>
                ...
                <span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
                  ...
                  <span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
                  ...
                  <tr>
                    <th scope="col" colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
                      <div style="width:187mm;border-top-width:0px">
                        ...
                        <span style="font-family:verdana;font-size:8pt;font-weight:normal;">
                  Complete lines 2a through 2e if you gave less than an <br /><span style="width:18mm;" />entire interest in a property listed in Part I. Complete lines 3a through 3c if conditions were placed on a <br /><span style="width:18mm;" />contribution listed in Part I; also attach the required statement (see instructions).
      </span>
                      </div>
                    </th>
                  </tr>
              ...
              property?   
                <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RestrictionOnDonatedProperty" /><xsl:with-param name="Desc" select="RestrictionOnDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span></div>
                  ...
                  Did you give to anyone (other than the donee organization or another organization participating with the donee
                      ...
                      <div style="width:187mm;">
                        ...
                        <div class="styShadingCell" style="width:6mm;height:5mm;border-bottom-width:1px;" />
                        <div class="styShadingCell" style="width:6mm;height:5mm;border-bottom-width:1px;" />
                      </div>
                      <div style="width:187mm;">
                        <div class="styLNLeftLtrBox" style="height:4.5mm;" />
                ...
                <span style="width:2px;" /><xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RightsGivenToDonatedProperty" /><xsl:with-param name="Desc" select="RightsGivenToDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
                ...
                <span style="width:2px;" /><xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RstrLimitingDonatedProperty" /><xsl:with-param name="Desc" select="RstrLimitingDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">8283</span>  (Rev. 12-2006)
    </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 8283 (Rev. 12-2006)<span style="width:130mm;" /></div>
          ...
          <div style="width:187mm;border-top:none;">
            <div class="styNameBox" style="font-size:7pt;width:133mm;height:7mm;border-left:none;border-top:none;border-bottom:none;">Name(s) shown on your income tax return
						  <br /><!-- WARNING: Return Type will need to be update with various future form 1040 return type--><xsl:choose><xsl:when test="$RtnHdrData/ReturnType='1040'"><br /><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">Name</xsl:with-param></xsl:call-template></xsl:when><xsl:otherwise><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine1</xsl:with-param></xsl:call-template><br /><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param></xsl:call-template></xsl:otherwise></xsl:choose></div>
            <div class="styNameBox" style="padding-left:2mm;font-size:7pt;width:47mm;height:7mm;border-right:none;border-left:none;border-top:none;border-bottom:none;font-weight:bold;">Identifying number
						  <br /><br /><span style="font-weight:normal;"><!-- WARNING: Return Type will need to be update with various future form 1040 return type--><xsl:choose><xsl:when test="$RtnHdrData/ReturnType='1040'"><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">PrimarySSN</xsl:with-param></xsl:call-template></xsl:when><xsl:otherwise><xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">EIN</xsl:with-param></xsl:call-template></xsl:otherwise></xsl:choose></span></div>
          </div>
          <!--Section B -->
          <div style="width:187mm;">
        ...
        <br /><span style="width:20mm;" />items (or groups of similar items) for which you claimed a deduction of more than $5,000 per item or group (except 
        <br /><span style="width:20mm;" />contributions of certain publicly traded securities reported in Section A). An appraisal is generally required for property listed 
        <br /><span style="width:20mm;" />in Section B (see instructions).
          ...
          <div style="width:187mm;">
            ...
            <span style="width:70mm;height:4.5mm;text-align:left;">
            ...
            <span style="width:67mm;height:4.5mm;text-align:left;">
            ...
            <span style="width:30mm;height:4.5mm;text-align:left;">
              <input type="checkbox" class="styCkbox" name="Checkbox">
                <xsl:call-template name="PopulateCheckbox">
        ...
        <div style="width:180mm;"><b>Note.  </b>  In certain cases, you must attach a qualified appraisal of the property.  See instructions.
...
--></div><!--Table expand/collapse toggle button--><div class="styGenericDiv" style="float:right;clear:none;width:7mm;text-align:right;"><xsl:call-template name="SetDynamicTableToggleButton"><xsl:with-param name="TargetNode" select="$Form8283Data/PropertyInformation" /><xsl:with-param name="containerHeight" select="4" /><xsl:with-param name="headerHeight" select="1" /><xsl:with-param name="containerID" select=" 'TP2ctn' " /></xsl:call-template></div><!--Table expand/collapse toggle button end--></div>
            ...
            <table cellspacing="0" Summary="Section B. Part I. Information on Donated Property" style="" class="styTable">
              ...
              <tbody>
                      ...
                      <td class="styTableCell" style="width:68mm;text-align:left;border-color:black;font-size:7pt;">
                        ...
                        <div style="text-align:bottom;padding-top:0mm;">
                          ...
                          <xsl:call-template name="SetFormLinkInline">
                            ...
                            <xsl:with-param name="Desc" select="$Form8283Data/PropertyInformation/@referenceDocumentName" />
                          </xsl:call-template>
                        </div>
                      </td>
                ...
                <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 1 or&#xD;&#xA;        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">A<span class="styTableCellPad" /></td>
                    <xsl:choose>
                ...
                <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 2 or&#xD;&#xA;        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">B<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;">
                ...
                <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 3 or&#xD;&#xA;        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">C<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;">
                ...
                <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 4 or&#xD;&#xA;        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
                  <tr>
                    <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">D<span class="styTableCellPad" /></td>
                    <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;">
                      <span class="styTableCellPad" />
                    </td>
                    <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;">
                            ...
                            <xsl:when test="DateAcquiredByDonor">
                              <span style="width:3px;float:left;">
                                <xsl:call-template name="SetFormLinkInline">
                                  ...
                                  <xsl:with-param name="Desc" select="DateAcquiredByDonor/@referenceDocumentName" />
                                </xsl:call-template>
                              </span>
                              <xsl:choose>
                                ...
                                <xsl:otherwise>
                                  <xsl:call-template name="PopulateMonth">
                                    <xsl:with-param name="TargetNode" select="DateAcquiredByDonor" />
                                  </xsl:call-template>-<xsl:call-template name="PopulateYear"><xsl:with-param name="TargetNode" select="DateAcquiredByDonor" /></xsl:call-template></xsl:otherwise>
                              </xsl:choose>
                            </xsl:when>
                            <xsl:otherwise>
                            </xsl:otherwise>
                        ...
                        <td class="styTableCell" style="text-align:left;width:20mm;font-size:7pt;border-color:black;">
                          <span style="width:3px;float:left;">
                            <xsl:call-template name="SetFormLinkInline">
                              ...
                              <xsl:with-param name="Desc" select="HowAcquiredByDonor/@referenceDocumentName" />
                            </xsl:call-template>
                          </span>
                          <xsl:call-template name="PopulateText">
                            <xsl:with-param name="TargetNode" select="HowAcquiredByDonor" />
                        ...
                        <td class="styTableCell" style="width:35mm;text-align:right;font-size:7pt;border-color:black;">
                          <span style="float:left;">
                            <xsl:call-template name="SetFormLinkInline">
                              ...
                              <xsl:with-param name="Desc" select="DonorsCostOrAdjustedBasis/@referenceDocumentName" />
                            </xsl:call-template>
                          </span>
          ...
          <div class="styBB" style="width:187mm;border-top-width:0px">
            ...
            <span style="font-family:verdana;font-size:8pt;">List each item included in Part I above that the appraisal identifies as<br /><span style="width:19mm;" />having a value of $500 or less. See instructions.</span>
          </div>
          <div style="width:187mm;" />
          <div style="width:187mm;">
            ...
            <div style="width:138mm;float:left;" class="styGenericDiv">$500 (per item). Enter identifying letter from Part I and describe the specific item. See instructions.<span style="width:2mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /></div>
          ...
          <div style="width:187mm;" />
          <div class="styBB" style="width:187mm;">Signature of taxpayer (donor)<span style="width:2mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:105mm;" />Date<span style="width:2mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /></div>
          <br />
          <br />
          <br />
          <br />
      ...
      Also, I declare that I hold myself out to the public as an appraiser or perform appraisals on a regular basis; and that because of my qualifications as described in the appraisal, I am qualified to make appraisals of the type of property being valued. I certify that the appraisal fees were not based on a percentage of the appraised property value. Furthermore, I understand that a false or fraudulent overstatement of the property value as described in the qualified appraisal or this Form 8283 may subject me to the penalty under section 6701(a) (aiding and abetting the understatement of tax liability).  In addition, I understand that a substantial or gross valuation misstatement resulting from the appraisal of the value of the property that I know, or reasonably should know, would be used in connection with a return or claim for refund, may subject me to the penalty under section 6695A.  I affirm that I have not been barred from presenting evidence or testimony by the Office of Professional Responsibility.
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <span class="styIRS8283SignatureBox" style="width:57mm;border-right-width:0px;&#xD;&#xA;            padding-left: 2mm;border-bottom-width:0px;">Signature            
            <span style="width:1mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserName/PersonFirstName" /></xsl:call-template><span style="width:2px;" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserName/PersonLastName" /></xsl:call-template></span>
            <span class="styIRS8283SignatureBox" style="width:43mm;border-right-width:0px;border-bottom-width:0px;">
            Title<span style="width:1mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserTitle" /></xsl:call-template></span>
            <span class="styIRS8283SignatureBox" style="width:77mm;border-right-width:0px;border-bottom-width:0px;">
        Date <span style="width:1mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserDateSigned" /></xsl:call-template></span>
          </div>
          <div style="width:187mm;border-top-width:1px">
            <div class="styNameBox" style="font-family:Arial;font-size:7pt;width:135mm;height:8mm;">Business address (including room or suite no.)
        <div><choice><when test="$Form8283Data/USAddressOfAppraiser"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfAppraiser/AddressLine1" /></xsl:call-template><div><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfAppraiser/AddressLine2" /></xsl:call-template></div></when><Otherwise><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/AddressLine1" /></xsl:call-template><br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/AddressLine2" /></xsl:call-template></Otherwise></choice></div></div>
            <div class="styEINBox" style="font-family:Arial;font-size:7pt;width:47mm;height:4mm;padding-left: 2mm">
        ...
        <div><choice><when test="$Form8283Data/USAddressOfAppraiser"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfAppraiser/City" /></xsl:call-template>,
										<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfAppraiser/State" /></xsl:call-template><span style="width:1mm;" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfAppraiser/ZIPCode" /></xsl:call-template></when><Otherwise><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/City" /></xsl:call-template><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/ProvinceOrState" /></xsl:call-template><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/Country" /></xsl:call-template><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfAppraiser/PostalCode" /></xsl:call-template></Otherwise></choice></div></div>
          </div>
          <div class="styBB" style="width:187mm;border-top-width:0px">
          ...
          <div style="width:187mm;">This charitable organization acknowledges that it is a qualified organization under section  170(c) and that it received the donated property as described in Section B, Part I, above on the following date<span style="width:2mm;" /><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><!-- A straight Line --><span style="width:75mm;border-bottom:solid 1px;"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/DateReceived" /></xsl:call-template></span></div>
          <br />
          ...
          <span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><img src="{$ImagePath}/8283_Bullet_Lg.gif" alt="bullet image pointing to right" /><span style="width:1px;" /><span><xsl:call-template name="PopulateSpan"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /></xsl:call-template><input type="checkbox" class="styCkbox" name="Checkbox"><xsl:call-template name="PopulateYesCheckbox"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /><xsl:with-param name="BackupName">Form8283DataUsePropertyForUnrelatedUseYes</xsl:with-param></xsl:call-template></input></span><label><xsl:call-template name="PopulateLabelYes"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /><xsl:with-param name="BackupName">Form8283DataUsePropertyForUnrelatedUseYes</xsl:with-param></xsl:call-template>Yes
            </label><span style="width:3mm;" /><span><xsl:call-template name="PopulateSpan"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /></xsl:call-template><input type="checkbox" class="styCkbox" name="Checkbox"><xsl:call-template name="PopulateNoCheckbox"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /><xsl:with-param name="BackupName">Form8283DataUsePropertyForUnrelatedUseNo</xsl:with-param></xsl:call-template></input></span><label><xsl:call-template name="PopulateLabelNo"><xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" /><xsl:with-param name="BackupName">Form8283DataUsePropertyForUnrelatedUseNo</xsl:with-param></xsl:call-template>No
          </label></div>
          </div>
          <div class="styBB" style="width:187mm;border-top-width:1px;">
            <div class="styNameBox" style="font-face:Arial;font-size:7pt;width:94mm;height:8mm;">Name of charitable organization (donee)<br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/DoneeName/BusinessNameLine1" /></xsl:call-template><xsl:if test="$Form8283Data/DoneeName/BusinessNameLine2"><br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/DoneeName/BusinessNameLine2" /></xsl:call-template></xsl:if></div>
          ...
          <div style="width:187mm;border-top-width:1px">
            <div class="styNameBox" style="font-family:Arial;font-size:7pt;width:94mm;height:8mm;">Address (number, street, and room or suite no.) <br /><xsl:if test="$Form8283Data/USAddressOfDonee"><xsl:if test="$Form8283Data/USAddressOfDonee/AddressLine1!=''"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfDonee/AddressLine1" /></xsl:call-template></xsl:if><xsl:if test="$Form8283Data/USAddressOfDonee/AddressLine2!=''"><br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfDonee/AddressLine2" /></xsl:call-template></xsl:if></xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee"><xsl:if test="$Form8283Data/ForeignAddressOfDonee/AddressLine1!=''"><br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/AddressLine1" /></xsl:call-template></xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee/AddressLine2!=''"><br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/AddressLine2" /></xsl:call-template></xsl:if></xsl:if></div>
            <div class="styEINBox" style="font-family:Arial;font-size:7pt;width:93mm;height:4mm;font-weight:normal;">City or town, state, and ZIP code <br /><br /><xsl:if test="$Form8283Data/USAddressOfDonee"><xsl:if test="$Form8283Data/USAddressOfDonee/City!=''"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfDonee/City" /></xsl:call-template>,
            </xsl:if><xsl:if test="$Form8283Data/USAddressOfDonee/State!=''"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfDonee/State" /></xsl:call-template></xsl:if><xsl:if test="$Form8283Data/USAddressOfDonee/ZIPCode!=''"><span style="width:1mm;" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/USAddressOfDonee/ZIPCode" /></xsl:call-template></xsl:if></xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee"><xsl:if test="$Form8283Data/ForeignAddressOfDonee/City!=''"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/City" /></xsl:call-template>,
            </xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee/ProvinceOrState!=''"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/ProvinceOrState" /></xsl:call-template></xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee/PostalCode!=''"><span style="width:1mm;" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/PostalCode" /></xsl:call-template></xsl:if><xsl:if test="$Form8283Data/ForeignAddressOfDonee/Country!=''"><span style="width:1mm;" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8283Data/ForeignAddressOfDonee/Country" /></xsl:call-template></xsl:if></xsl:if></div>
          </div>
          <div class="styBB" style="width:187mm;border-top-width:1px">
        ...
        Additional Data        
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Section A Part I Line 1 Columns (c) - (f) Donor line detail</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form8283Data/InformationOnDonatedProperty/DonorLineDetail/@scheduleK-1Indicator" />
              ...
              <table class="styDepTbl" style="width:187mm;" id="donatedPrptyInfo">
                <thead class="styTableThead">
                  <tr class="styDepTblHdr">
                    ...
                    <th scope="col" class="styDepTblCell" style="width:90mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;" colspan="3">
                      <span class="styBoldText">(a)</span>
                      <span style="width:1mm;" />
                      <span style="font-size:7pt;">Name and address of the <br /> donee organization</span>
                    </th>
                    <th scope="col" class="styDepTblCell" style="width:90mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;" colspan="3">
                      <span class="styBoldText">(b)</span>
                      <span style="width:1mm;" />Description of donated property </th>
                  </tr>
                </thead>
                <tfoot />
                <tbody>
                  <xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
                    <tr>
                      ...
                      <td class="styTableCell" style="width:7mm;text-align:left;padding-left:3mm;font-size:7pt;font-weight:bold;border-color:black;">
                        <xsl:choose>
                          <xsl:when test="PropertyIdentifier">
                            ...
                            <xsl:call-template name="SetFormLinkInline">
                              <xsl:with-param name="TargetNode" select="." />
                              <xsl:with-param name="Desc" select="./@referenceDocumentName" />
                            </xsl:call-template>
                          </xsl:when>
                        </xsl:choose>
                      </td>
                      ...
                      <td class="styTableCell" style="width:80mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;border-right:none;" colspan="3">
                        <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="DescriptionOfDonatedProperty" />
                        </xsl:call-template>,
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="VehicleYear" /></xsl:call-template></td>
                ...
                <thead class="styTableThead">
                  <tr class="styDepTblHdr">
                    <th scope="col" colspan="7" class="styDepTblCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;font-weight:normal;border-top-width:0px;border-color:black;">
                      <span class="styBoldText">Note:</span>
                      <span style="width:1mm;" />
                      <span style="font-style: italic; font-size: 7pt;">If the amount you claimed as a deduction for an item is $500 or less, you do not have to complete columns (d), (e), and (f).</span>
                    </th>
                  </tr>
                  <tr class="styDepTblHdr">
                ...
                Total amount claimed as a deduction for the property listed in Part I:
                    ...
                    <div class="styDepTblRow2" style="width:187mm;">
                      ...
                      <div class="styLNDesc" style="width:108mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept
												<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:5mm;" /></div>
                    ...
                    <div style="width:187mm;">
                      ...
                      <div class="styLNLeftLtrBox" style="height:4.5mm;">e</div>
                      <div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">Name of any person, other than the donee organization, having actual possession of the property
			<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:2mm;" /><choice><when test="BusNameOfPersonPossessingProp"><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BusNameOfPersonPossessingProp/BusinessNameLine1" /></xsl:call-template><br /><span style="width:133mm" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BusNameOfPersonPossessingProp/BusinessNameLine2" /></xsl:call-template><span class="styUnderlineAmount" style="width:47mm;float:right" /></when><Otherwise><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select=" NameOfPersonPossessingProperty/BusinessNameLine1" /></xsl:call-template><br /><span style="width:133mm" /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select=" NameOfPersonPossessingProperty/BusinessNameLine2" /></xsl:call-template></Otherwise></choice></div>
                    </div>
                    <div class="styFixedUnderline" style="width:180mm;margin-left:4mm;" />
                    <!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^  -->
                    <!-- Line 3a -->
                    ...
                    <div class="styDepTblRow2" style="width:187mm;float:left;">
                      ...
                      <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal">
              property?   
                <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RestrictionOnDonatedProperty" /><xsl:with-param name="Desc" select="RestrictionOnDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:20px;">.</span><span class="styBoldText" style="width:8px;">.</span></div>
                    ...
                    <div class="styDepTblRow1" style="width:187mm;">
                      <div class="styLNLeftLtrBox" style="height:4.5mm;" />
                      <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;"> or to designate the person having such income, possession, or right to acquire?
                <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RightsGivenToDonatedProperty" /><xsl:with-param name="Desc" select="RightsGivenToDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
                      <div class="styLNAmountBox" style="width:6mm;height:4.5mm; text-align: center;">
                        <xsl:call-template name="PopulateYesBoxText">
                          <xsl:with-param name="TargetNode" select="RightsGivenToDonatedProperty" />
                        </xsl:call-template>
                    ...
                    <div class="styDepTblRow2" style="width:187mm;">
                      <div class="styLNLeftLtrBox" style="height:4.5mm;">c</div>
                      <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;">Is there a restriction limiting the donated property for a particular use?
                <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="RstrLimitingDonatedProperty" /><xsl:with-param name="Desc" select="RstrLimitingDonatedProperty/@referenceDocumentName" /></xsl:call-template><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span><span class="styBoldText" style="width:19px;">.</span></div>
                      <div class="styLNAmountBox" style="width:6mm;height:4.5mm;border-bottom:none; text-align: center;">
                        <xsl:call-template name="PopulateYesBoxText">
                          <xsl:with-param name="TargetNode" select="RstrLimitingDonatedProperty" />
                        </xsl:call-template>

		...
		<html lang="EN-US">
          ...
          20<span class="styTYColor">11</span>
                    ...
                    <b> Form 4835</b> on page 2, line 40.</span>
						...
						<div class="styTableContainer" style="width:187mm;border-bottom-width:1px;" id="PICctn">
							...
							<table class="styTable" style="border-bottom-width:1px;" cellspacing="0" id="PICTable">
                                ...
                                1
									...
									<td class="styTableCell" scope="col" style="width:26mm;border-right-width:1px;border-color:black;text-align:center;padding:1px;font-size:7.5pt;">
                              ...
                              2
									...
									<td class="styTableCell" scope="col" rowspan="4" colspan="1" style="vertical-align:top;padding-top:1mm;font-size:8pt;width:30mm;border-bottom-width:0px;text-align:left;border-color:black;border-right-width:0px;">
										<span class="styNormalText">
									For each rental real
									...
									<td class="styTableCell" scope="col" style="width:12mm;border-right-width:1px; border-color:black;height:4mm;text-align:center;">
									...
									<td class="styTableCell" scope="col" style="width:6mm;border-right-width:0px; border-color:black;height:4mm;text-align:center;">
                             ...
                             <xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroupPropertyType</xsl:with-param>
                                    ...
                                    <br/>-->
											...
											<!-- Column C -->
											<td class="styTableCell" style="width:26mm;border-color:black;font-size:7pt;padding:2px;text-align:left;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="PropertyType"/>
												</xsl:call-template>
												<span style="width:2px;"/>
												<xsl:call-template name="LinkToLeftoverDataTableInline">
													<xsl:with-param name="Desc">Other Property Type Description Text</xsl:with-param>
											...
											<xsl:if test="(position() &gt; 3) ">
												<td class="styTableCell" style="width:35.9mm;border-right-width:1px;border-bottom-width:0px; ">
													<span class="styTableCellPad"/>
												</td>
											</xsl:if>
											<!-- Column F -->
											...
											<!-- Column G -->
											<td class="styTableCell" style="width:12mm;border-right-width:1px;text-align:center; border-color:black;vertical-align:center;color:darkblue;font-size:7pt;">
												<xsl:call-template name="PopulateText">
											...
											<!-- Column I -->
											<td class="styTableCell" style="width:6mm;border-right-width:0px;text-align:center; border-color:black;vertical-align:center;">
												<input type="checkbox" class="styCkbox" alt="Checkbox">
								...
								<xsl:if test="count($FormData/PropertyRealEstAndRoyaltyGroup) &lt; 1 or ((count($FormData/PropertyRealEstAndRoyaltyGroup) &gt; 3) and ($Print = $Separated))">
									<tr>
										...
										<td class="styTableCell" style="width:85mm;border-right-width:1px;border-bottom-width:1px;border-style: solid; border-color: black;text-align:left">
											<span class="styTableCellPad"/>
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup"/>
											</xsl:call-template>
										</td>
										<td class="styTableCell" style="width:26mm;border-color:black;border-right-width:1px;border-bottom-width:1px;">
											<span class="styTableCellPad"/>
										</td>
										...
										<td class="styTableCell" style="width:6mm;border-right-width:0px;text-align:center; border-color:black;vertical-align:center;">
											<input type="checkbox" class="styCkbox" alt="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup[1]/QualifiedJointVentureInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroup1QualifiedJointVentureInd</xsl:with-param>
												</xsl:call-template>
											</input>
											<label style="display:none">
												<xsl:call-template name="PopulateLabel">
								...
								<xsl:if test="count($FormData/PropertyRealEstAndRoyaltyGroup) &lt; 2 or ((count($FormData/PropertyRealEstAndRoyaltyGroup) &gt; 3) and ($Print = $Separated))">
									<tr>
										...
										<td class="styTableCell" style="width:85mm;border-right-width:1px;border-style: solid; border-color: black;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:26mm;border-color:black;border-right-width:1px;border-bottom-width:1px;">
											<span class="styTableCellPad"/>
										...
										<td class="styTableCell" style="width:6mm;border-right-width:0px;text-align:center; border-color:black;vertical-align:center;">
											<input type="checkbox" class="styCkbox" alt="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup[2]/QualifiedJointVentureInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroup2QualifiedJointVentureInd</xsl:with-param>
												</xsl:call-template>
											</input>
											<label style="display:none">
												<xsl:call-template name="PopulateLabel">
								...
								<xsl:if test="count($FormData/PropertyRealEstAndRoyaltyGroup) &lt; 3 or ((count($FormData/PropertyRealEstAndRoyaltyGroup) &gt; 3) and ($Print = $Separated))">
									<tr>
										...
										<td class="styTableCell" style="width:6mm;border-right-width:0px;text-align:center; border-color:black;vertical-align:center;">
											<input type="checkbox" class="styCkbox" alt="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup[3]/QualifiedJointVentureInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroup3QualifiedJointVentureInd</xsl:with-param>
												</xsl:call-template>
											</input>
											<label style="display:none">
												<xsl:call-template name="PopulateLabel">
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or (count($FormData/PropertyRealEstAndRoyaltyGroup) &lt;=3) ">
                                    ...
                                    + count($FormData/PropertyRealEstAndRoyaltyGroup[$pos+2]/Other))"/>
											<tr>
												<td class="styTableCell" rowspan="2" colspan="2" style="text-align:left;width:89mm;border-right-width:0px;border-bottom-width:0px;border-color: black;padding-top:0mm;">
											...
											<tr>
												...
												<td class="styTableCell" style="width:36mm;border-right-width:1px;border-color: black;text-align:right;">
													<xsl:call-template name="PopulateAmount">
														...
														<xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroupMerchantCardAndThrdPrtyPymtAmt</xsl:with-param>
													</xsl:call-template>
												</td>
												<!-- Column 5 -->
												<td class="styTableCell" style="width:36mm;border-right-width:1px;border-color: black;text-align:right;">
											...
											<tr>
												<!-- Column 1 -->
												<td class="styTableCell" style="width:6.9mm;border-right-width:0px;border-bottom-width:0px;border-color: black;border-top-width:0px;">
													<span class="styBoldText" style="text-align:left;padding-left:3.5mm;padding-right:2mm;font-size:7pt;">
                                                b
                                                </span>
												</td>
												<!-- Column 2 -->
                                    ...
                                    + count($FormData/PropertyRealEstAndRoyaltyGroup[$pos+2]/Other))"/>
												...
												<tr class="styFixedUnderline">
													<xsl:choose>
														<xsl:when test="position() mod 3=1">
															...
															<td class="styTableCell" style="width:64mm;text-align:right;border-bottom-width:0px;border-right-width:1px;border-color: black;">
                                                      Other (list)<span style="width:1mm;"/>
																<img src="{$ImagePath}/1040_Bullet.gif" align="bottom" alt="Bullet Image"/>
											...
											<tr>
                                             ...
                                             22
												...
												<!-- Column 4 -->
												<td class="styTableCell" style="width:26.9mm;border-right-width:1px;border-color: black;vertical-align:bottom;">
													<xsl:call-template name="PopulateNegativeNumber">
														<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup[$pos]/DedRentalRealEstateLossAmt"/>
														<xsl:with-param name="BackupName">IRS1040ScheduleEPropertyRealEstAndRoyaltyGroupTotalExpensesAmt</xsl:with-param>
													</xsl:call-template>
						...
						23a
							...
							<div class="styLnDesc" style="padding-top:.5mm;width:104.2mm;padding-left:2mm;height:5mm;">
								<span style="float:left;">Total of all amounts reported on line 3a for all rental properties</span>
						...
						23a
							...
							<div class="styLNAmountBox" style="padding-right:.5mm;width:32mm;font-size:6.5pt;height:5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotRntlPropMrchnt3rdPrtyAmt"/>
								</xsl:call-template>
							</div>
						...
						b
							...
							<div class="styLnDesc" style="padding-top:.5mm;width:104.2mm;padding-left:2mm;height:5mm;">
								<span style="float:left;">Total of all amounts reported on line 3a for all royalty properties</span>
								<span class="styDotLn" style="padding-right:2mm;float:right;clear:none;">....</span>
							</div>
							<div class="styLNRightNumBox" style="width:5.5mm;height:5mm;">
						23b
							...
							<div class="styLNAmountBox" style="padding-right:.5mm;width:32mm;font-size:6.5pt;height:5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotRyltyPropMrchnt3rdPrtyAmt"/>
								</xsl:call-template>
							</div>
							<div class="styShadingCell" style="width:37.2mm;height:5mm;"/>
						</div>
						...
						c
							...
							<div class="styLnDesc" style="padding-top:.5mm;width:104.2mm;padding-left:2mm;height:5mm;">
								<span style="float:left;">Total of all amounts reported on line 4 for all rental properties</span>
								<span class="styDotLn" style="padding-right:2mm;float:right;clear:none;">.....</span>
							</div>
							<div class="styLNRightNumBox" style="width:5.5mm;height:5mm;">
						23c
                  ...
                  For Paperwork Reduction Act Notice, see instructions.
						...
						<span class="styBoldText" style="font-size:8pt;padding-left:10mm;float:right;">Schedule E (Form 1040) 2011</span>
					</div>
					<br/>
					<br class="pageEnd"/>
					<!-- Page 2 -->
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2011</span>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div style="width:187mm;border-right-width:0px;">
							<div style="float:left;clear:none;">
								...
								<div class="styShadingCell" style="width:29mm;border-bottom-width:1px;height:5mm;"/>
								<!-- Column 29a (g) total -->
								...
								<div class="styShadingCell" style="height:4.5mm;width:32.6mm;border-bottom-width:1px;"/>
								...
								<div class="styShadingCell" style="height:4.5mm;width:37.4mm;border-bottom-width:1px;"/>
							</div>
						</div>
					</div>
					<!-- End line 29 -->
                  ...
                  lncome or Loss From Estates and Trusts 
					...
					<div class="styBB" style="width:187mm;border-bottom-width: 1px;">
                        ...
                        Totals
								...
								<!-- greyed box -->
								<div class="styShadingCell" style="height:4.5mm;width:38mm;border-bottom-width:1px;"/>
								<!-- Column 34a (d) total -->
								...
								<div style="float:left;clear:none;">
									<!-- greyed box -->
									<div class="styShadingCell" style="height:4.5mm;width:37.9mm;border-bottom-width:1px;border-left-width:0px;"/>
									<!-- Column 34a (f) total -->
                        ...
                        Totals
									...
									<!-- greyed box -->
									<div style="float:left;clear:none;">
										<div class="styShadingCell" style="height:4.5mm;width:45.7mm;border-bottom-width:1px;border-right-width:1px;"/>
										<!-- Column 34b (e) total -->
										...
										<!-- greyed box -->
										<div class="styShadingCell" style="height:4.5mm;width:46mm;border-bottom-width:1px;"/>
									</div>
								</div>
								<!-- end Totals (left) -->
							</div>
                  ...
                  Summary 
					...
					<div class="pageEnd" style="height:6mm;width:187mm;">
						...
						<div class="stySmallText" style="width:46mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2011</span>
						</div>
					</div>
					<!-- end page 2 footer -->

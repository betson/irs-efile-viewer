...
<!-- Last Modified by Eugenia McDonald on 01/13/2012 -->
		...
		<html>
          ...
          Internal Revenue Service</span>
						...
						<div class="styTYBox" style="width:30mm;height:12mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="height:7mm;padding-top:1mm;">20<span class="styTYColor">11</span>
							</div>
						</div>
					</div>
         ...
         statement been restated for any of the five income statement periods preceding
          ...
          (If “Yes,” attach an explanation and the amount of each item restated.)
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:3mm">
								<span class="styBoldText">Net income (loss) per income statement of the partnership.</span> 
								Combine lines 4 through 10<span class="styDotLn" 
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;font-size:6pt;height:3mm">Schedule M-3 (Form 1065) 2011</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1065) 2011</div>
...
Analysis of Net Income (Loss), line 1.</div>
					<div class="styBB" style="width:187mm;"/>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1065) 2011</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styBB" style="width:187mm;">

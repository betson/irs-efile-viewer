      ...
      <tr  class="styDepTblRow2">
        ...
        <td class="styDepTblCell" style="text-align:left;">
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="Category1FilerName/BusinessNameLine1" />
          </xsl:call-template>
          <xsl:if test="Category1FilerName/BusinessNameLine2 != ''">
            <br /><xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="Category1FilerName/BusinessNameLine2" />
              </xsl:call-template>
          </xsl:if>          
        </td>
      </tr>

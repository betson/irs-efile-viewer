    ...
    <html>
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$RtnDoc/SelfChargedInterestElection/NameOfPartnership/BusinessNameLine1"/>
            </xsl:call-template><br/>
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$RtnDoc/SelfChargedInterestElection/NameOfPartnership/BusinessNameLine2"/>
            </xsl:call-template>
          </div>
        </div>
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$RtnDoc/SelfChargedInterestElection/RegulationSection14697gDcl"/>
            </xsl:call-template>
          </div>
        </div>
        <br /> 

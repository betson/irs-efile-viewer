...
amount from Schedule I, Part II, line 6</div>
              ...
              <xsl:call-template name="SetFormLinkInline">
                ...
                <xsl:call-template name="SetFormLinkInline">
							...
							<div style="width:127mm;height:26mm;">
								<div class="styIRS1118LNDescRed" style="width:92mm;height:24mm;border-left-width:0px;border-bottom-width:0px;padding-top:19mm;font-size:6pt;">
            ...
            Additional Data        
              ...
              Net Operating Loss Deduction</span>
                ...
                1. <span class="styNormalText">Credit is Claimed for Taxes:</span>
                    ...
                    <div style="width:256mm;">
                      <div class="styLNLeftNumBoxSD">6</div>
                      <div class="styLNDescLandscape" style="text-align:left;">Form 1118 Line 6 - Total foreign taxes: HTKO
                              <!--Dotted Line-->
                              <span class="styNoAudioRead" style="font-weight:bold;">
                              <span style="width:16px"/>.
                              <span style="width:16px"/>.

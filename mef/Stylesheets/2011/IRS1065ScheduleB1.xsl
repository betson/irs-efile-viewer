...
<!-- Last Modified by Eugenia McDonald on 09/19/2011 -->
		...
		<html>
			...
			<body class="styBodyClass">
				<form name="Form1065ScheduleB1">
					...
					<!-- Part I - Header -->
					<div style="width:187mm;height:3mm;border-style:solid; border-bottom-width:1px;
					  border-top-width:0px;border-right-width:0px;border-left-width:0px;padding-top:1.5mm;
					  padding-bottom:1.5mm;float:left;">
						...
						<div class="styGenericDiv" style="width:3.2mm;float:right;" align="right">
							...
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" 
							    	select="$Form1065SchB1Data/PartnersOwning50PctOrMoreGrp"/>
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" style="width:35mm;vertical-align:top;font-size:6.5pt;"
									  scope="col">
							...
							<tbody>
								<xsl:for-each select="$Form1065SchB1Data/PartnersOwning50PctOrMoreGrp">
									<xsl:if test="($Print != $Separated) or
									 (count($Form1065SchB1Data/PartnersOwning50PctOrMoreGrp) &lt;=2)">
								...
								<xsl:if test="count($Form1065SchB1Data/PartnersOwning50PctOrMoreGrp) &lt; 1 
								  or ((count($Form1065SchB1Data/PartnersOwning50PctOrMoreGrp) &gt;7) and 
								  ($Print = $Separated))">
									<tr style="height:8mm">
					...
					<!-- Part II - Header -->
					<div style="width:187.3mm;height:3mm;border-style:solid; border-bottom-width:1px;
					  border-top-width:0px;border-right-width:0px;border-left-width:0px;padding-top:1.5mm;
					  padding-bottom:1.5mm;float:left;">
					...
					<div class="styBB" style="width:187mm;border-bottom:none">
						<div class="styGenericDiv" style="width:3.2mm;float:right;" align="right">
							...
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" 
							      select="$Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp"/>
								<xsl:with-param name="containerHeight" select="7"/>
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								<xsl:for-each select="$Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp">
									<xsl:if test="($Print != $Separated) or
									 (count($Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp) &lt;=7)">
										<tr style="font-size: 6.5pt;height:8mm">
											<td class="styTableCellText" style="width:60mm;text-align:left;vertical-align:top">
								...
								<xsl:if test="count($Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp) &lt; 1 
								  or ((count($Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp) &gt;7) and 
								  ($Print = $Separated))">
									<tr style="height:8mm">
										<td class="styTableCellText" style="width:60mm;font-size:6.5pt;">
											<span style="width:4px"/>
											<xsl:if test="((count($Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp) &gt;7) and
											 ($Print = $Separated))">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode"
													  select="$Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp"/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;font-size:7pt">
						...
						<div class="styBoldText" style="float:right;height:3mm;">
						     Schedule B-1 (Form 1065) (Rev. 12-2011)</div>
					</div>
					...
					<xsl:if test="($Print = $Separated) and
					  (count($Form1065SchB1Data/PartnersOwning50PctOrMoreGrp) &gt;7)">
						<br/>
						<span class="styRepeatingDataTitle">
						Form 1065 Schedule B-1, Part I Entities owning 50% or more</span>
										...
										<td class="styDepTblCell" style="text-align:right;vertical-align:top">
											<div style="width:29mm;">
												<span style="">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode"
														  select="MaxPctOwnedInProfitLossOrCap"/>
													</xsl:call-template>
												</span>
											</div>
										</td>
					...
					<xsl:if test="($Print = $Separated) and 
					 (count($Form1065SchB1Data/IndivOrEstOwn50PctOrMoreGrp) &gt;7)">
						<br/>
						<span class="styRepeatingDataTitle">
						  Form 1065 Schedule B-1, Part II, Individuals or Estates owning 50% or more</span>
						<table class="styDepTbl" style="font-size:6.5pt;">
							<thead class="styTableThead">
								<!-- Label the Column Headers -->
								<tr class="styDepTblHdr">

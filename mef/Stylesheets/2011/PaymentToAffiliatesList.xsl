...
<!-- change -->    
  <xsl:param name="Form990DepsData" select="$RtnDoc/PaymentToAffiliatesList" />
<!-- end change -->
  ...
  <xsl:template name="ShowDS">
    ...
    <table id="DSTbl" class="styDepTbl" style="font-size:7pt;">
...
<!-- change -->    
        ...
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Purpose</th>
      </tr>          
      <xsl:for-each select="$Form990DepsData/PaymentToAffiliate">
<!-- end change -->
        <tr>
...
<!-- change -->    
          <td class="styDepTblCell" style="text-align:left">          
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="Name/BusinessNameLine1" />
            </xsl:call-template> 
            <br/>              
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="Name/BusinessNameLine2" />
            </xsl:call-template>             
          </td>              
          <td class="styDepTblCell" style="text-align:left">
          <!-- US address -->

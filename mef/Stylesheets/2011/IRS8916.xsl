			    ...
			    <div style="float:left;clear:none;">
			      ...
			      <div class="styLNDesc" style="width:139mm;height:5mm;padding-top:4mm;">
				    <span style="font-weight:bold">Total.</span> 
					  Combine lines 6 and 7. This amount must equal the amount reported on the "Taxable
			        <span style="float:left;"> Income" on the "Taxable Income"</span>
				    <!--Dotted Line-->
				    <div class="styDotLn" style="float:right;padding-right:1mm;">......................</div>
			      </div>
			    </div>
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:13mm;padding-top:8mm;">8</div>
			      <div class="styLNAmountBox" style="height:13mm;padding-top:8mm;">
				    <xsl:call-template name="PopulateAmount">

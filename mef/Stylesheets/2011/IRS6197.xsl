...
<table cellspacing="0">
	<tbody>
		<!--Begin Header Rows-->
		<tr>
			<th class="styIRS6197TableCellVerticalText" style="height:28mm;width:5mm" rowspan="2"><img src="{$ImagePath}/6197_LineNumber.gif" alt=""></img></th>
			...
			<th class="styIRS6197TableCellVerticalText" style="width:6mm" rowspan="2"><img src="{$ImagePath}/6197_LineNumber.gif" alt=""></img></th>
			<th class="styIRS6197TableCellHeaderText" style="width:41mm;font-family:arial;font-weight:bold" colspan="3">If the fuel economy (mpg) of<br/>the automobile model type is:</th>
			<th class="styIRS6197TableCellHeaderText" style="width:23mm" rowspan="2"><b>(d)</b><br/>Number<br/>of cars<br/>sold</th>

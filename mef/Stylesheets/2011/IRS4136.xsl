			...
			<body class="styBodyClass">
				<form name="IRS4136">
					...
					<div class="styIRS4136BB" style="width:187mm;">
    					...
    					<div >
								<img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/> For information about Form 4136 and its instructions, go to www.irs.gov/form4136.
    </div>
						</div>
						<div class="styIRS4136TYBox" style="height: 21mm;">
							<div class="styIRS4136OMB">OMB No. 1545-0162</div>
							<div class="styIRS4136TY">20<span class="styTYColor">11</span>
							</div>
   ...
   <xsl:call-template name="PopulateAmount">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center"> /.043*</td>
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<div style="width:187mm;height:2mm;padding-left:8mm">
						*There rates apply after Septemper 30, 2011
					</div>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4mm;">/.000*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<!-- END LINE 2   -->
					<div style="width:187mm;height:2mm;padding-left:8mm">
					* These rates apply after September 30, 2011
					 </div>
					<!--   BEGIN BLOCK 3  -->
					<!--   BEGIN LINE 3   -->
          ...
          <span class="styIRS4136NBSP" style="padding-right:3mm;"/> Nontaxable Use of Undyed Diesel Fuel <br/>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseOfUndyedDiesel">
										<tr>
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>
													<span style="padding-right:28mm">$</span>
													<span class="styIRS4136TableCellPad"/>
												</td>
												<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:5mm;">/.043*</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:5mm;">/.000*</td>
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<!--  END LINE 3  -->
					<div style="width:187mm;height:2mm;padding-left:8mm">
* These rates apply after September 30, 2011</div>
					<!--   BEGIN BLOCK 4 -->
					<!--   BEGIN LINE 4  -->
							...
							<tbody>
								...
								<xsl:if test="$AGRowCount = 0 or ((count($IRS4136Data/NontaxableUseOfUndyedKerosene) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellLine">Nontaxable use taxed at $/.043*</td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseOfUndyedKerosene">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>Nontaxable use taxed at $/.043*
        </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>
													<span style="padding-right:30mm">$</span>
												</td>
												<td class="styIRS4136TableCellE">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4.5mm;">/.000*</td>
									<td class="styIRS4136TableCellC" style="padding-top:2mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4mm;">/.043*</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellLine">Nontaxable use taxed at $/.218*</td>
									<td class="styIRS4136TableCellA">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
...
* These rates apply after September 30, 2011</div>
    ...
    <span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2011)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styBB" style="width:187mm">
						<div style="float: left; clear: none">Form 4136 (2011)</div>
    ...
    <span class="styIRS4136NBSP" style="padding-right:3mm;"/>
						...
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellLine">Kerosene used in commercial aviation (other than foreign trade) taxed at $/.043*</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellB" style="padding-left:1mm;text-align:center;">$/.000*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
        ...
        border-bottom-width:10mm;border-color:white">
                  ...
                  Kerosene used in commercial aviation (other than foreign trade) taxed at $/.218*<br/>
									</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<xsl:if test="$AGRowCount = 0 or ((count($IRS4136Data/NontaxableUseTaxedAt244) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Nontaxable use (other than use by state or local government) taxed at $/.043*
      </td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
										<td class="styIRS4136TableCellB" style="text-align:center;padding:1.25mm;">/.043*</td>
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseTaxedAt244">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>Nontaxable use (other than use by state or local government) taxed at $/.043*
        </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$AGRowCount2 = 0 or ((count($IRS4136Data/NontaxableUseTaxedAt219) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Nontaxable use (other than use by state or local government) taxed at $/.218*
      </td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseTaxedAt219">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount2"/></xsl:attribute>Nontaxable use (other than use by state or local government) taxed at $/.218*
                       </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
...
<!--													<xsl:call-template name="LinkToLeftoverDataTableInline">
              ...
              <span class="styIRS4136TableCellPad"/>
                    ...
                    padding-left:4mm;padding-right:1.5mm;">
											<b>e</b>
										</td>
										...
										<td class="styIRS4136TableCellB" style="text-align:center;padding:1.25mm;">/.000*
                    </td>
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/LUSTTaxAvnFuel) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/LUSTTaxAvnFuel">
										<tr>
											...
											<td class="styIRS4136TableCellB" style="padding-left:3mm;">/.000*</td>
											<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="MaxSize" select="9"/>
...
<!--													<xsl:call-template name="LinkToLeftoverDataTableInline">
              ...
              <span class="styIRS4136TableCellPad"/>
					...
					<div class="styBB" style="width:187mm;height:2mm;padding-left:8mm;">* These rates apply after Septemper 30, 2011</div>
					<!--   END LINE 5   -->
					<!--   BEGIN BLOCK 6   -->
					<!--   BEGIN LINE 6   -->
					<div class="styIRS4136NumLine" style="width:186mm;float: none; clear: both;padding-left:2mm;">
						<br/>6
          <span class="styIRS4136NBSP" style="padding-right:3mm;"/>  Sales by Registered Ultimate Vendors of Undyed Diesel Fuel <span style="width:2mm;"/>
						 Registration No.
  <img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/>
...
consent of the buyer to make the claim. Claimant certifies that the diesel fuel did not contain visible evidence of dye.
      ...
      visible evidence of dye, attach an explanation and check here<span class="styDotLn" style="float:none;clear:none;">......</span>
							...
							<input alt="UndyedDieselSalesException" type="checkbox" class="styIRS4136Ckbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedDieselSalesException"/>
                  ...
                  <xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:7mm;">/.000*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
					...
					<!--  END LINE 6  -->
					<div style="width:187mm;height:2mm;padding-left:8mm;">* These rates apply after Septemper 30, 2011</div>
					<!--   BEGIN BLOCK 7   -->
					<!--   BEGIN LINE 7   -->
					<div class="styBB">
						<br/>
...
of the buyer to make the claim. Claimant certifies that the kerosene did not contain visible evidence of dye.
					...
					<div style="width:183mm;margin-left:2.75mm;font-size:6.3pt;">
						...
						<div style="float:right;padding-right:.5mm;">
							...
							<input alt="UndyedKeroseneSalesException" type="checkbox" class="styIRS4136Ckbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedKeroseneSalesException"/>
...
<!--										<xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<!--   END LINE 7    -->
					<div class="styBB" style="width:187mm;height:2mm;padding-left:5mm;">* These rates apply after Septemper 30, 2011</div>
					<!--   BEGIN LINE 8   -->
					<!--   BEGIN BLOCK DESCRIPTION   -->
					<div class="styIRS4136NumLine" style="float: none; clear: both;padding-top:1px;padding-left:2mm;padding-bottom:2mm;">
						<br/>8
...
<span style="width:72mm"/>
    ...
    the amount of tax to the buyer, or has obtained the written consent of the buyer to make the claim. See the instructions for additional information to be submitted.
					...
					<div style="width:187mm;float:left;clear:left;styBB;border-top:1px solid black;" id="8bFctn">
						<table class="styIRS4136Table" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									<th style="width:3mm;height:4mm;"/>
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellLine">Use in commercial aviation (other than foreign trade) taxed at $/.218*</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
                  ...
                  <xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styIRS4136LetterCell" style="padding-left:4mm;padding-right:1.5mm;
									 border-bottom-width:4mm;border-color:white">
									 <b>b</b>
									</td>
									<td class="styIRS4136TableCellLine" style="width:90mm;">
                  Use in commercial aviation (other than foreign trade) taxed at $/.043*<br/>
									</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">/.000*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
                  ...
                  Nonexempt use in noncommercial aviation<br/>
								...
								<xsl:if test="$Line8DRowCount = 0 or ((count($IRS4136Data/OtherNontaxableUseTaxedAt244) &gt; 1) and
								 ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>d</b>
										</td>
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Other nontaxable uses taxed at $/.043*</td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
										<td class="styIRS4136TableCellB" style="text-align:center;padding:1.25mm;">/.043*</td>
        ...
        <span class="styIRS4136TableCellPad"/>
										...
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													...
													<xsl:value-of select="$Line8DRowCount"/>
													</xsl:attribute>Other nontaxable uses taxed at $/.043*
												</td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$Line8ERowCount = 0 or ((count($IRS4136Data/OtherNontaxableUseTaxedAt219) &gt; 1) and
								 ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>e</b>
										</td>
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Other nontaxable uses taxed at $/.218*</td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
										<td class="styIRS4136TableCellB" style="text-align:center;padding:1.25mm;">.218
									...
									<xsl:for-each select="$IRS4136Data/OtherNontaxableUseTaxedAt219">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$Line8ERowCount"/>
													</xsl:attribute>Other nontaxable uses taxed at $/.218*</td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="TypeOfUse"/>
											...
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellE">
													<xsl:attribute name="rowspan">
													<xsl:value-of select="$Line8ERowCount"/>
													</xsl:attribute>369
              <span class="styIRS4136TableCellPad"/>
												</td>
											</xsl:if>
    ...
    Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2011)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styIRS4136NumLine" style="float: none; clear: both">
						<br/>
						<br/>9
    <span class="styIRS4136NBSP"/>Alcohol Fuel Mixture Credit
            <span style="width:60mm;"/>Registration No.
    <img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/>
						<span style="width:8px;"/>
						<span style="font-weight:normal">
							<xsl:call-template name="PopulateText">
    ...
    fuel mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant.
						...
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4.5mm">$.45*
                    <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
                  ...
                  <xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:6mm;">.60*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
					...
					<!--   END LINE 09   -->
				<div style="width:187mm;height:2mm;padding-left:6mm;">* These credits expire after December 31, 2011</div>
					<!--   BEGIN LINE 10   -->
					<div class="styIRS4136NumLine" style="float: none; clear: both">
						<br/>
						<br/>10
    ...
    <span style="width:182mm;"/>
        ...
        <span class="styIRS4136TableCellPad"/>
             ...
             <span class="styIRS4136TableCellPad"/>
                          ...
                          $
                            <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
                ...
                ((count($IRS4136Data/NontxPSeriesFuels) + count($IRS4136Data/BusNontxPSeriesFuels)  &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellB" style="text-align:center;padding:1.25mm;">/.043*
                    </td>
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxCompressedNaturalGas/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedHydrogen/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/FuelTaxLocalBusCd"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/FuelTaxLocalBusCd"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/FuelTaxLocalBusCd"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
...
<!--															<xsl:call-template name="LinkToLeftoverDataTableInline">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusLiquefiedGasBiomass/FuelTaxLocalBusCd"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusLiquefiedGasBiomass/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusLiquefiedGasBiomass/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
    ...
    Alternative Fuel Credit and Alternative Fuel Mixture Credit 
            <span style="padding-left:2mm;">Registration No.</span>
...
<!--										<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:if test="$AGRowCount12h = 0 or ((count($IRS4136Data/LiqfdGasBiomass) &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:2mm;">
											<b>h</b>
										</td>
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Liquefied gas derived from biomass
                    </td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/LiqfdGasBiomass) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/LiqfdGasBiomass">
										<tr>
											<xsl:if test="position()=1">
												<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:3mm;padding-right:1.5mm;">
...
<!--													<xsl:call-template name="LinkToLeftoverDataTableInline">
					...
					<!--BEGIN FOOTER-->
					<div style="width:187mm; padding-top:1mm;padding-bottom:2mm;">
						<div style="float: left; clear: none;padding-left:8mm">* These credits expire after December 31, 2011
							<span class="styBoldText"/>
						</div>
						<div style="float:right">
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2011)
...
<!--										<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:6.5mm;text-align:center:">/.043*</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
...
<!--										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  ...
                  Kerosene for use in aviation sold for the exclusive use of a state or local government taxed at $/.218*
                   <span style="width:3px;"/>
									</td>
									<td class="styIRS4136TableCellB" style="padding-left:7.5mm;padding-top:3mm;">.218</td>
...
<!--										<xsl:call-template name="LinkToLeftoverDataTableInline">
			...
			<div class="styBB" style="width:187mm;height:2mm;padding-left:6mm;">* These rates apply after Septemper 30, 2011</div>
					<!--   END LINE 13   -->
					<!--   BEGIN BLOCK 14   -->
					<!--   BEGIN LINE 14   -->
    ...
    <span class="styIRS4136NBSP">
      ...
      <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="($Line14aCount  + count($IRS4136Data/BusNontxUseDieselWtrEmulsion)) =1 or
								 (($Line14aCount  + count($IRS4136Data/BusNontxUseDieselWtrEmulsion) &gt;1)  and ($Print != $Separated))">
                              ...
                              <xsl:call-template name="PopulateAmount">
														...
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
															<xsl:attribute name="rowspan"><xsl:value-of select="$Line14aCount"/>
															</xsl:attribute> 309<span class="styIRS4136TableCellPad"/>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td class="styIRS4136TableCellD">
										...
										<xsl:choose>
											<xsl:when test="$Line14aCount = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-top:1mm;">
                            ...
                            <xsl:call-template name="PopulateAmount">
												...
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															...
															select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/FuelTaxLocalBusCd"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellB" style="padding-top:1mm;">
														...
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/CreditRate"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
														<xsl:call-template name="PopulateText">
								...
								<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">/.043*
        <span class="styIRS4136TableCellPad"/>
								</td>
													<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
									<xsl:call-template name="PopulateText">
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<!--   END LINE 14   -->
					<div style="width:187mm;height:2mm;padding-left:6mm;">* These rates apply after Septemper 30, 2011</div>
					<!--   BEGIN BLOCK 15   -->
					<!--   BEGIN LINE 15   -->
					<div class="styIRS4136NumLine" style="float: none; clear: both">
						<br/>15   
          ...
          $<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;font-size:7pt;float:none;clear:both;">
						...
						<div class="styGenericDiv" style="width:129.7mm;height:11mm;padding-left:5px;padding-top:3px;">
							<b>Total income tax credit claimed. </b>Add lines 1 through 16, column (d). Enter here and on Form 1040, line 70; Form 1120, Schedule J, line 19b; Form 1120S, line 23c; Form 1041, line 24g; or the proper line of other returns.
        <span style="padding-left:2mm">
          ...
          <xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2011)
  </div>
					</div>
					<!--   END FORM FOOTER   -->
					<!-- <br/>
								...
								<xsl:for-each select="$IRS4136Data/NontaxableUseOfUndyedKerosene">
									<tr>
										...
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="vertical-align:top;border-left-width:0px;text-align:left;width:77mm;border-right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount"/></xsl:attribute>Nontaxable use taxed at $/.043*
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
  ...
  <span style="font-weight:normal">(see </span>
            ...
            right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount8"/></xsl:attribute>Nontaxable use (Other than use by state or local government) taxed at $/.043*
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
  ...
  <span style="font-weight:normal">(see </span>
								...
								<xsl:for-each select="$IRS4136Data/NontaxableUseTaxedAt219">
									<tr>
										...
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="vertical-align:top;border-left-width:0px;text-align:left;width:77mm;border-right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount8"/></xsl:attribute>Nontaxable use (Other than use by state or local government) taxed at $/.218*
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
								...
								<xsl:for-each select="$IRS4136Data/OtherNontaxableUseTaxedAt244">
									<tr>
										...
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="vertical-align:top;border-left-width:0px;text-align:left;width:77mm;border-right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount8"/></xsl:attribute>Other nontaxable uses taxed at $/.043
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
								...
								<xsl:for-each select="$IRS4136Data/OtherNontaxableUseTaxedAt219">
									<tr>
										...
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="vertical-align:top;border-left-width:0px;text-align:left;width:77mm;border-right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount8"/></xsl:attribute>Other nontaxable uses taxed at $/.218*
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
            ...
            <span class="styIRS4136TableCellPad"/>
              ...
              <span class="styIRS4136TableCellPad"/>
					...
					<xsl:if test="(count($IRS4136Data/NontxLqfdFuelDerivedFromCoal) + count($IRS4136Data/BusNontxLqfdFuelDerivedFromCoal) &gt;1) and ($Print = $Separated)">
						<span class="styRepeatingDataTitle">Form 4136, Line 11 - Nontaxable Use of Alternative Fuel</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">

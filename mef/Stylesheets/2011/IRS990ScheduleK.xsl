 ...
 <span class="styNBSP"/>.
                  ...
                  -->
					...
					<div class="sty990ScheduleKFormFooter" style="padding-top:1mm">
						...
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;"> Schedule K (Form 990) 2011</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left"> Schedule K (Form 990) 2011</div>
...
<span class="styNBSP"/>.
                ...
                -->
							...
							<tr>
								<td class="styTableCellText" style=" border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; width:128mm;padding-top:0mm;height:10mm">
									<span class="styLNLeftLtrBox" style="padding-left:1mm;height:10mm">c</span>
 ...
 <span class="styNBSP"/>.
               ...
               -->
							...
							<tr>
								<td class="styTableCellText" style=" border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; width:128mm;padding-top:0mm;height:10mm">
									<span class="styLNLeftLtrBox" style="padding-left:1mm;height:10mm">d</span>
...
<span class="styNBSP"/>.
 ...
 <span class="styNBSP"/>.
                 ...
                 -->
							...
							<tr>
								<td class="styTableCellText" style=" border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; width:128mm;padding-top:0mm">
									<span class="styLNLeftLtrBox" style="padding-left:0mm;">8</span>
        ...
        Was the hedge superintegrated?
           <span class="styNoAudioRead">
                 ...
                 -->
							...
							<tr>
								<td class="styTableCellText" style=" border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; width:96mm;padding-top:0mm">
									<span class="styLNLeftLtrBox" style="padding-left:2mm;height:10mm">e</span>
        ...
        Did the bond issue qualify for an exception to rebate?
           <span class="styNoAudioRead">
               ...
               -->
							...
							<tr>
								<td class="styTableCellText" style=" border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; width:96mm;padding-top:0mm">
									<span class="styLNLeftLtrBox" style="padding-left:0mm;height:8mm">7</span>
...
<span class="styNBSP"/>.</span>
               ...
               -->
					...
					<div style="width:256mm;float:none;clear:both;padding-top:.5mm;border-top:solid 1px" class="pageend">
						...
						<div class="styGenericDiv" style="float:right;padding-right:4mm">
							<span class="styBoldText">Schedule K (Form 990) 2011</span>
						</div>
					</div>
					<br/>
					<!-- =========================================================================-->
					...
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule K (Form 990) 2011</div>
  ...
  Procedures To Undertake Corrective Action
						...
						<div class="IRS990ScheduleJLineDesc" style="width:256mm;height:4mm; border-top-width:1px;padding-top:1mm;border-bottom-width:1px;border-right-width:0px;padding-left:21mm">
Has the organization established written procedures to ensure that violations of federal tax requirements are timely identified and corrected through the voluntary closing agreement program if self-remediation is not available under applicable regulations?
 <!-- Dotted Line -->
              ...
              <!-- Schema says "checkboxtype" should be boolean, so both boxes will check at same time. See email from 02-2012 from Tiwana-->

                      <span>
                        <xsl:call-template name="PopulateSpan">
                          <xsl:with-param name="TargetNode" select="$FormData/FedTaxRequirementsCompliance"/>
                        </xsl:call-template>
                        <label>
                        ...
                        <input type="checkbox" class="IRS990ScheduleK_Checkbox">
...
<input type="checkbox" alt="alt" class="styCkbox">
                  <xsl:call-template name="PopulateCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/FedTaxRequirementsCompliance"/>
                    <xsl:with-param name="BackupName">IRS990ScheduleKPartVI</xsl:with-param>
                  </xsl:call-template>
                </input>    
    -->                
						</div>

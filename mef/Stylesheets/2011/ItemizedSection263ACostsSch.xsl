...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/ItemizedSection263ACostsSch" />
      ...
      <tbody>    
        <xsl:for-each select="$AOVSSData/Item">  
          <tr>
            ...
            <!-- First Column -->
            <td class="styDepTblCell" style="text-align:left;width:75%">
            ...
            <!-- Second Column -->
            <td class="styDepTblCell" style="text-align:right;width:25%;">

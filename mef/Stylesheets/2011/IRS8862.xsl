		...
		<div class="styIRS8862LineItem">
			...
			<div class="styIRS8862CleanDiv" style="width:181mm;height:auto;">
				<div class="styIRS8862LNDesc" style="width:auto;height:auto;">
					...
					<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/>
					<span style="width:4px;"/>
					<span style="width:6mm;height:100%;text-align:center;">
	...
	<xsl:template name="CreateLine6ChildItem">
		...
		<div class="styIRS8862LineItem">
			...
			<div class="styIRS8862CleanDiv" style="width:162mm;height:auto;">
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:auto;">
					<div class="styIRS8862LNDesc" style="width:45mm;height:auto;padding-left:0px;">
						City or town, state, and ZIP code
						<span style="width:4px;"/>
					</div>
					<div class="styIRS8862LNDesc" style="width:117mm;height:auto;border-bottom-width:1px;border-color:black;border-style:dashed;word-wrap:break-word;">
						<xsl:if test="$TargetNode">
							<xsl:if test="count($TargetNode/following-sibling::*) = 0">
	...
	<xsl:template name="CreateLine7ChildItem">
		...
		<div class="styIRS8862LineItem">
			...
			<div class="styIRS8862CleanDiv" style="width:129mm;height:auto;">
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:auto;">
					<div class="styIRS8862LNDesc" style="width:9mm;height:auto;padding-left:0px;">
						Name
						<span style="width:4px;"/>
					</div>
				...
				<form name="IRS8862" style="font-family:arial;">
								...
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;padding-left:5px;">
										<div style="width:100%;height:5mm;">
											...
											<br/>
											<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/> 
											Attach to your tax return.<span style="width:20mm;"/>
											<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/> 
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8862LineItem">
							...
							<div class="styIRS8862LNDesc" style="width:37mm;height:100%;padding-left:0px;padding-top:1px;float:right;">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8862LineItem" style="width:20%;float:left;">
							...
							<div class="styIRS8862LNDesc" style="width:auto;height:auto;">
								...
								<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/>
								<span style="width:4px;"/>
								<span style="width:12mm;height:100%;">
						...
						<div class="styIRS8862LineItem">
							...
							<div class="styIRS8862LNDesc" style="width:181mm;height:auto;">
								<b>Caution.</b>
								<span style="width:4px;"/>If you entered less than <b>183</b> for any child, you cannot take the EIC based on that child, unless the special rule for a<br/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8862</span> (Rev. 12-2009)
						</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8862 (Rev. 12-2009)<span style="width:148mm;"/>
						</div>
						<div style="float:right;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8862LineItem">
							<div class="styIRS8862LNLeftNumBox"/>
							<div class="styIRS8862LNDesc" style="width:181mm;height:auto;">
								<b>Caution.</b><span style="width:3px;"/>If you entered less than <b>183, stop.</b> You cannot take the EIC. See the instructions.
							</div>
						</div>
						<!-- (9) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem">
					  ...
					  <div class="pageEnd" style="width:187mm;clear:both;"/>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->

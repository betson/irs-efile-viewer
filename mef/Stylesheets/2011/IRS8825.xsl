            ...
            OMB No. 1545-1186
              ...
              Employer identification number<br/>
											...
											<table class="styTable" cellspacing="0" cellname="TYTable" id="TYTable" summary="Table for displaying the kind and location of each property">
												<thead>
													<tr style="border-bottom:1 solid black;">
														...
														font-size:7pt;border-right:1 solid black;" rowspan="2" colspan="1">1</th>
														<th class="styTableCellHeader" style="width:182mm;border-right-width: 0px;
														font-weight:normal;font-size:7pt;text-align:left;" colspan="4">
				  ...
				  See instructions. See page 2 to list additional properties.</th>
													...
													<tr>
														<th class="styTableCellHeader" style="width:82mm;font-size:7pt;border-bottom:1 solid black;border-right:1 solid black;">
										...
										summary="Table for displaying the rental real estate properties there income and expenses">
											<thead class="styTableThead">
												<tr>
													...
													<th style="width:7mm;height:5mm;border:none;">
														<span class="styTableCellPad"/>
													</th>
                      ...
                      Properties
											...
											<tbody>
												<tr>
													...
													<th class="styForm8825TableCellSmallRB " style="width:5mm;border-left-width: 0px;border-right-width: 0px;">
														<span class="styTableCellPad"/>
													</th>
													<xsl:for-each select="$Form8825Data/RentalIncomeExpenses">
														<xsl:if test="(position() &gt;= $pos and position() &lt; $pos+4)">
           ...
           (($Print = $Separated) and (count($Form8825Data/RentalIncomeExpenses) &gt; 4)) ">
						...
						<div class="styBB" style="width:187mm;clear:both;float;none;border-top:1 solid black;">
							<table class="styTable" cellspacing="0" cellname="TYTable" id="TYTable" summary="Table for displaying the kind and location of each property">
								<thead>
									<tr style="border-bottom:1 solid black;">
										<th class="styTableCellHeader" style="width:5mm;text-align:left;padding-left:3.5mm;font-size:7pt;border-right:1 solid black;" rowspan="2" colspan="1">1</th>
										<th class="styTableCellHeader" style="width:182mm;border-right-width: 0px;font-weight:normal;font-size:7pt;text-align:left;" colspan="4">
                   Show the type and address of each property. For each rental real estate property
				  listed, report the number of days rented at fair rental value and days with personal use.
				  See instructions. See page 2 to list additional properties.</th>
									</tr>
									<tr>
										<th class="styTableCellHeader" style="width:82mm;font-size:7pt;border-bottom:1 solid black;border-right:1 solid black;">(i)<br/>
											<span style="font-weight:normal;">Physical address of each property — street, city, state, ZIP code </span>
										</th>
										<th class="styTableCellHeader" style="width:32mm;font-size:7pt;border-bottom:1 solid black;border-right:1 solid black;">(ii)<br/>
											<span style="font-weight:normal;">Type — see instructions </span>
										</th>
										<th class="styTableCellHeader" style="width:32mm;font-size:7pt;border-bottom:1 solid black;border-right:1 solid black;">(iii)<br/>
											<span style="font-weight:normal;">Fair Rental Days </span>
										</th>
										<th class="styTableCellHeader" style="width:36mm;font-size:7pt;border-bottom:1 solid black;border-right-width:0;">(iv)<br/>
											<span style="font-weight:normal;">Personal Use Days </span>
										</th>
									</tr>
								</thead>
					...
					<xsl:if test="($Print = $Separated) and (count($Form8825Data/IdentifyPartnershipEstateTrust) &gt;3) ">
						...
						<table class="styDepTbl" style="font-size:7pt">
							<thead class="styTableHead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:100mm;">(1) Name</th>

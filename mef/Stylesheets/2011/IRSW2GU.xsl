...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="CreateFormHeader">
    <div class="styIRSW2GUCleanDiv" style="width:187mm;border-width:0px 0px 0px 0px;height:auto;">
      <!-- Left (Top) -->
      <div class="styIRSW2GUCleanDiv" style="width:60%;height:13mm;border-left-width:0px;">
        <div class="styIRSW2GUCleanDiv" style="width:30%;height:100%;border-left-width:0px;">
          <span class="styBoldText" style="width:100%;padding-top:1.5mm;">Form<span style="width:auto;font-family:arial;font-size:20pt;padding-left:3mm;">W-2GU</span></span>
        </div>
      ...
      <div class="styIRSW2GUCleanDiv" style="width:60%;height:11mm;border-left-width:0px;">
        <b>Copy A For Social Security Administration</b><img src="{$ImagePath}/W2GU_Short_Line.gif" alt="Line image"/>Send this entire page with Copy A of<br/>
  ...
  <xsl:template name="CreateLine12TableRows">
    ...
    <tr>
      ...
      <td class="styIRSW2GUTableCell">
        ...
        <div class="styIRSW2GULNDesc" style="width:100%;text-align:center;height:32px">
          <div class="styIRSW2GUCleanDiv" style="width:4%;border-left-width:0px;height:100%;padding:0px 0px 0px 0px;">
            <div class="styUseLbl" style="font-size:5;width:2mm;padding-top:.1mm;border-right-width:0px;padding-bottom:.1mm">c o d e</div>
          </div>
          <div class="styIRSW2GUCleanDiv" style="width:20%;height:100%;padding-top:1mm;border-left-width:0px;">
            <div class="styIRSW2GULNDesc" style="width:auto;text-align:center;padding-left:3mm;">
          ...
          <div class="styIRSW2GUCleanDiv">
            ...
            <div class="styIRSW2GULNDesc" style="width:26mm;">
              <xsl:if test="$TargetNode">
  ...
  <xsl:template name="CreateLine12TableRowsColored">
    ...
    <tr>
      ...
      <td class="styIRSW2GUTableCell" style="width:50%;text-align:center;height:5mm;">
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$TargetNode/EmployersUseCd"/>
        </xsl:call-template>
      </td>
      <td class="styIRSW2GUTableCell" style="width:50%;text-align:center;border-left-width:1px;height:5mm;">
        <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$TargetNode/EmployersUseAmt"/>
        </xsl:call-template>
      </td>
        ...
        <div class="styIRSW2GULNDesc" style="width:100%;text-align:center;padding:0px 0px 0px 0px;height:auto;">
          <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;padding-top:0px;border-left-width:0px;">
            <div class="styIRSW2GULNDesc" style="width:100%;text-align:left;word-wrap:break-word;height:8mm;padding-top:0px;">
              ...
              <xsl:if test="$AddAdditionalMessage">
                <xsl:if test="((count($FormW2GUData/OtherDeductsBenefits) &gt;1) and ($Print = $Separated))">
                  <span style="width:100%;text-align:center;">
                    <xsl:call-template name="PopulateAdditionalDataTableMessage">
                      <xsl:with-param name="TargetNode" select="$FormW2GUData/OtherDeductsBenefits"/>
                    </xsl:call-template>
                  </span>
                </xsl:if>
              </xsl:if>
          ...
          <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;padding-top:0px;text-align:center;border-left-width:0px;">
            <div class="styIRSW2GULNDesc" style="width:100%;padding-top:0px;height:2.5mm;">
              <xsl:if test="$TargetNode">
                <xsl:call-template name="PopulateAmount">
  ...
  <xsl:template name="CreateLine14TableRowsColored">
    ...
    <tr>
      ...
      <td class="styIRSW2GUTableCell" style="width:25%;text-align:center;border-left-width:1px;height:5mm;">
        <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$TargetNode/Amount"/>
        </xsl:call-template>
      </td>
        ...
        <form name="IRSW2GU">
          ...
          <div class="styGenericDiv" style="border:1px black solid;width:187mm;height:auto;">
            ...
            <div class="styIRSW2GULineItemBB">
              <!-- 22222 -->
              <div class="styIRSW2GUCleanDiv" style="width:12%;height:100%;border-left-width:0px;text-align:center;">
                <span class="styBoldText" style="font-size:12pt;width:100%;padding-top:2.5mm;">22222</span>
              </div>
              <!-- Void Checkbox -->
              <div class="styIRSW2GUCleanDiv" style="width:10%;height:100%;text-align:center;border-right-width:1px;">
            ...
            <div class="styIRSW2GULineItemBB">
              ...
              <div class="styIRSW2GUCleanDiv" style="width:25%;height:100%;">
                ...
                <div class="styIRSW2GULNDesc" style="width:100%;text-align:center;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <div class="styIRSW2GUCleanDiv" style="width:24%;height:100%;">
                <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
            ...
            <div class="styIRSW2GULineItemBB">
              ...
              <div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;border-left-width:0px;">
                ...
                <div class="styIRSW2GULNDesc" style="width:100%;padding-left:7.5mm;padding-right:1mm;word-wrap:break-word;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployerName/BusinessNameLine1"/>
                  </xsl:call-template>
                  <xsl:if test="$FormW2GUData/EmployerName/BusinessNameLine2">
                    <br/>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployerName/BusinessNameLine2"/>
                    </xsl:call-template>
                  </xsl:if>
                  <br/>
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <xsl:call-template name="PopulateForeignAddressTemplate">
                        <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployerOtherForeignAddress"/>
                      </xsl:call-template>
                    </xsl:otherwise>
                  </xsl:choose>
                  <br/>
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
                    ...
                    <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployerNameControl"/>
                  </xsl:call-template>
                </div>
              </div>
              <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:100%;border-left-width:0px;">
                ...
                <!-- (7)(8) -->
                <div class="styIRSW2GULineItemBB" style="border-bottom-width:0px;">
            ...
            <div class="styIRSW2GULineItemBB">
              ...
              <div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;border-left-width:0px;">
                ...
                <div class="styIRSW2GULNDesc" style="width:100%;padding-left:1mm;padding-right:1mm;word-wrap:break-word;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$FormW2GUData/ControlNumber"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- (9) -->
              <div class="styIRSW2GUCleanDiv" style="width:25%;height:100%;background-color:lightgrey;">
                ...
                <div class="styIRSW2GULNDesc" style="width:100%;text-align:center;">
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
                    <xsl:with-param name="Desc">Line 9 - Advance EIC Payment Amount</xsl:with-param>
                    <xsl:with-param name="TargetNode" select="$FormW2GUData/AdvanceEICPaymentAmt"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- (10)-->
            ...
            <div class="styIRSW2GULineItemBB">
              <div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;border-left-width:0px;">
                ...
                <div class="styGenericDiv" style="border-bottom:1px black solid;height:13mm;width:100%;">
                  ...
                  <div class="styGenericDiv" style="height:100%;width:39mm;padding-top:.6mm;">
                    ...
                    <br/>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployeeName"/>
                    </xsl:call-template>                    
                  </div>
                  <div class="styGenericDiv" style="height:100%;width:39mm;padding-top:.6mm;padding-left:2mm;">
                    Last name
                  </div>
                ...
                <div class="styIRSW2GUCleanDiv" style="width:100%;height:24mm;border-left-width:0px;">
                  <div class="styIRSW2GULNDesc" style="width:100%;padding-left:7mm;padding-top:2mm;word-wrap:break-word;height:40%;">
                    <xsl:if test="$FormW2GUData/EmployeeUSAddress">
                      <xsl:call-template name="PopulateUSAddressTemplate">
                        <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployeeUSAddress"/>
                      </xsl:call-template>
                    </xsl:if>
                    <xsl:if test="$FormW2GUData/EmployeeOtherForeignAddress">
                      <xsl:call-template name="PopulateForeignAddressTemplate">
                        <xsl:with-param name="TargetNode" select="$FormW2GUData/EmployeeOtherForeignAddress"/>
                      </xsl:call-template>
                    </xsl:if>
                  </div>
              ...
              <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:100%;">
                <!-- (11) Nonqualified plans-->
                <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:13mm;border-bottom-width:1px;border-left-width:0px;">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
                    <div class="styIRSW2GULNLeftNumBox" style="padding-right:9px;">11</div>
                ...
                <div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;float:right;">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
                    <div class="styIRSW2GULNLeftNumBox">12a</div>
                    <div class="styIRSW2GULNDesc" style="width:auto;">See instructions for box 12</div>
                ...
                <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:12.5mm;border-bottom-width:1px;border-left-width:0px;">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
                ...
                <!-- (14) Other-->
                <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:auto;border-left-width:0px;">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
                  ...
                  <div class="styTableContainerNBB" id="OtherDeductsBenefitsDiv">
                    ...
                    <table class="styTable" cellspacing="0" style="width:100%;border-right-width:0px;padding:0px 0px 0px 0px;table-layout:fixed;">
                      ...
                      <tfoot/>
                      <tbody>
                        <xsl:for-each select="$FormW2GUData/OtherDeductsBenefits">
                          <xsl:variable name="Letter">
                            <xsl:number format="a"/>
                          </xsl:variable>
                          <xsl:if test="($Print != $Separated) or (count($FormW2GUData/OtherDeductsBenefits) &lt;=1)">
                      ...
                      <xsl:if test="count($FormW2GUData/OtherDeductsBenefits) &lt; 1 or ((count($FormW2GUData/OtherDeductsBenefits) &gt;1) and ($Print = $Separated))">
                          <xsl:call-template name="CreateLine14TableRows">
                            <xsl:with-param name="Letter">a</xsl:with-param>
                            <xsl:with-param name="AddAdditionalMessage">true</xsl:with-param>
                          </xsl:call-template>
            ...
            <div class="styIRSW2GULineItemBB" style="background-color:lightgrey;height:13mm;border-bottom-width:0px;"/>
          </div>
          <!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:if test="$FormW2GUData/CorrectedW2GuamInd">
              <xsl:call-template name="PopulateLeftOverCheckbox">
                <xsl:with-param name="Desc">Corrected W2 Guam Indicator</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$FormW2GUData/CorrectedW2GuamInd"/>
                <xsl:with-param name="BackupName">FormW2GUDataCorrectedW2GuamInd</xsl:with-param>
                <xsl:with-param name="DescWidth" select="$TableWidth"/>
              </xsl:call-template>
            </xsl:if>
            ...
            <table class="styDepTbl" cellspacing="0">
              <thead>
                <tr class="styDepTblHdr">
                  <th class="styIRSW2GUTableCell" scope="col" style="width:50%;height:5mm;color:white;">Code</th>
                  <th class="styIRSW2GUTableCell" scope="col" style="width:50%;height:5mm;color:white;border-left-width:1px;">Amount</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>
          ...
          <xsl:if test="($Print = $Separated) and  (count($FormW2GUData/OtherDeductsBenefits) &gt; 1)">
            <span class="styRepeatingDataTitle">
            ...
            <table class="styDepTbl" cellspacing="0">
              <thead>
                <tr class="styDepTblHdr">
                  <th class="styIRSW2GUTableCell" scope="col" style="width:75%;height:5mm;color:white;">Description</th>
                  <th class="styIRSW2GUTableCell" scope="col" style="width:25%;height:5mm;color:white;border-left-width:1px;">Amount</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:with-param name="TargetNode" select="$DependencyData" />
    ...
    <div class="styTopSectionLine" style="width:187mm;">        
          ...
          <xsl:with-param name="TargetNode" select="$DependencyData/MonthWhichNew5253WeekTYEnds"/>
          </xsl:call-template>
        </div>
        </div> 
     ...
     <div class="styTopSectionLine" style="width:187mm;">        
          ...
          <div style="float:left;clear:right;">            
          <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$DependencyData/DayWeekWhichTaxYearAlwaysEnds"/>
          </xsl:call-template>
        </div>
     </div> 
     ...
     <div class="styTopSectionLine" style="width:187mm;">        
          ...
          <xsl:with-param name="TargetNode" select="$DependencyData/DateTaxYearEnds"/>
          </xsl:call-template>
        </div>
     </div> 

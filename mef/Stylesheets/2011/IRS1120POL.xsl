...
<span style="width:14px"/>.
        ...
        <!-- additional info line 1 -->
              ...
              At any time during the 2011 calendar year, did the organization have an interest in or a signature or other 
              </div>
 </div>
        ...
        <div class="IRS1120POL_LineContainer" style="border-left-width:1px">
					<div class="IRS1120POL_LabelSpaceWide" style="padding-bottom:2mm;border-right-width:1px;height:18mm"/>
        ...
        <input class="styCkbox" type="checkbox"  id="dummyid1" style="width:4mm;">
          <xsl:call-template name="PopulateReturnHeaderPreparer">
            ...
            <xsl:with-param name="BackupName">PreparerSelfEmployed</xsl:with-param>
						...
						<td style="width:50mm;border-bottom:1 solid black;padding-left:1mm;vertical-align:top;padding-top:1mm;">Preparer’s PTIN  		  <br/>
        <xsl:call-template name="PopulateReturnHeaderPreparer">
...
<!-- END PREPARER SIGNATURE SECTION -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2011)</div>
        </div>
        <!-- leftover data table -->
				<br/>
				<br/>

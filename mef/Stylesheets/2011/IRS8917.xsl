	...
	<xsl:template match="/">
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="Form8917">
					...
					<div class="styBB" style="width:{$pageWidth}mm;border-bottom:{$borderWidth35}mm solid">
						<div class="styFNBox" style="width:31mm;height:17mm;padding-bottom:0mm;border-right:{$borderWidth35}mm solid">
              Form<span style="width:1mm;"/>
                ...
                Department of the Treasury<br/>
						...
						<div class="styFTBox" style="width:125mm;height:17mm;">
							<div class="styMainTitle" style="height:5mm;padding:bottom:0mm;">Tuition and Fees Deduction<br/>
							</div>
							<div class="styFBT" style="font-size:7.5pt;height:5mm;padding-top:1mm;">
								See Instructions.<br/>Attach to Form 1040 or Form 1040A.</div>
						</div>
						<div class="styTYBox" style="width:31mm; height:17mm;border-left:{$borderWidth35}mm solid">
							...
							<div class="stySequence" style="font-size:6.5pt;position:relative">
								...
								<span>
									<b style="font-size:11.5pt;font-family:'Arial';position:absolute;bottom:0">60</b>
								</span>
							</div>
						</div>
					</div>
              ...
              Name(s) shown on return<br/>
					...
					<div style="width:{$pageWidth}mm;height:{$lineHeight}mm;border-bottom-width:0mm;padding:0.8mm">
						...
						<span style="font-size:7pt;height:{$lineHeight * 2}mm">
							...
							<span style="width:5mm"/>1040, line 36. See the 2011 Form 1040 instructions for line 36.
						</span>
					</div>
					<!-- Part I - Body -->
					<!--<div style="width:{$pageWidth}mm;height:0mm;border-style:solid; border-bottom-width:{$borderWidth}mm;border-top-width:{$borderWidth}mm;
          border-right-width:0;border-left-width:0;float:left;line-height:normal;">-->
					...
					<table class="styTable" style="width:180mm;font-size:7pt;border-color:black;border-collapse:collapse;">
						<thead class="styTableThead" style="vertical-align:top;">
							<tr>
								<th class="styTableCellHeader" style="font-weight:normal;width:100mm;">
								...
								<th class="styTableCellHeader" style="font-weight:normal;width:53mm;padding:2px 4px;">
									<b>(b)</b> Student's social security number (as shown on page 1 of your tax return)
								</th>
								<th class="styTableCellHeader" style="font-weight:normal;width:40mm;padding:2px 4px;">
									<b>(c)</b> Qualified expenses (see instructions)
								</th>
							</tr>
						</thead>
						<tbody>
									...
									<tr>
										...
										<td class="styTableCell" style="width:auto;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="QualifiedExpensesAmt"/>
											</xsl:call-template>
										</td>
									</tr>
								</xsl:for-each>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc">
							...
							<span class="styIRS4972DotLn">..............</span>
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:98.2mm;">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc">
							...
							<span class="styIRS4972DotLn"><br/>..............</span>
						</div>
				...
				Form <span class="styBoldText" style="font-size:8pt;">8917</span> (2011)
			</div>
					</div>

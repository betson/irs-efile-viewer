    ...
    <!-- Form Name -->
       ...
       <xsl:call-template name="SetFormLinkInline">
           <xsl:with-param name="TargetNode" select="$FormData"/>
            ...
            <br/>
      <span style="font-size:6pt;">(Rev. December 2010)</span> 
            <br/>
     ...
     <thead style="display:table-header-group;">
      ...
      <tr>
                ...
                <th class="IRS1118ScheduleI_GenericCell" style="height:5mm;text-align:center;" scope="col">
                  <span class="styBoldText">9.</span> Ratable part of deductions not definitely allocable</th>
                <th class="IRS1118ScheduleI_GenericCell" style="height:5mm;text-align:center;" scope="col">
   ...
   <!--BEGIN FOOTER-->
      <div style="width:256mm">
        ...
        <div style="float:right">
          ...
          <span class="styBoldText" style="padding-right:2mm">Schedule I (Form 1118) (Rev. 12-2010)</span>
        </div>      
      </div>     
        <div class="pageEnd"/>
      <!--END FOOTER-->  
      <!--BEGIN HEADER-->
      <div class="styBB" style="width:256mm">
        <div style="float: left; clear: none">Schedule I (Form 1118) (Rev. 12-2010)</div>        

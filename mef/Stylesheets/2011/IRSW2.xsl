        ...
        <form name="FormW2">
			...
			<div class="styGenericDiv" style="width:187mm;">
				...
				<div class="styTableContainer" style="width:187mm;" id="StateLocalTaxTbl">
					...
					<table class="styTable" cellspacing="0" style="width:182mm;border-collapse:collapse;font-size:6pt;border-color:black;">
						<thead class="styTableThead">
							<tr>
								<th class="styTableCellHeader" style="width:10mm;border-right-width:0px;border-bottom-width:0px;font-weight:normal;">
									<span style="font-weight:bold;padding:1px 2px;">15</span>
									<span style="font-family:Arial;">State</span>
								</th>
								<th class="styTableCellHeader" style="width:40mm;font-weight:normal;border-bottom-width:0px;">
									Employer's state ID number
								</th>
								<th class="styTableCellHeader" style="width:25mm;font-weight:normal;border-bottom-width:0px;">
								...
								<th class="styTableCellHeader" style="width:32mm;font-weight:normal;border-right-width:0px;border-bottom-width:0px;text-align:right;">
									<span style="font-weight:bold;padding:1px 3px;">20</span>
									Locality name
							...
							<xsl:if test="($Print != $Separated) or (count($FormW2Data/W2StateLocalTaxGrp) &lt;= 2)">
								<xsl:for-each select="$FormW2Data/W2StateLocalTaxGrp">
									<tr>
										...
										<td class="styTableCell" style="text-align:left;width:auto;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="W2StateTaxGrp/EmployersStateIdNumber"/>
											</xsl:call-template>
											<span style="width:0px;"/>
										</td>
										...
										<td class="styTableCell" style="text-align:left;width:auto;border-right-width:0px;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="W2StateTaxGrp/W2LocalTaxGrp/NameOfLocality"/>
											</xsl:call-template>
											<span style="width:0px;"/>
										</td>
									</tr>
          ...
          <div class="styBB" style="width:187mm;border-bottom:0px solid black;">
            ...
            <div class="styIRSW2leftBox" style="width:50mm;height:6mm;border-left:0px solid black;
              ...
              <span class="styTY" style="height:8mm;">2011</span>
            </div>

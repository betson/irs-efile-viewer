        ...
        <form name="Form8820">
          ...
          <div class="styBB" style="width:187mm;height: 21mm">
            ...
            Form <span class="styFormNumber">8820</span>
              <br/>
              <div class="styAgency" style="padding-top: 1mm">(Rev. December 2011)</div>
...
<!-- BEGIN Part I Title -->
      <div class="styIRS8820BB" style="height:4mm; border-top:1 solid black;border-bottom:1 solid black; width:187mm">
        ...
        <!--<div class="styTitleDesc" style="font-size:10pt"><span class="styNormalText"></span></div>        -->
      </div>
 <!-- END Part I Title -->          
...
<!--                  <span class="styNBSP"/>.
          ...
          <div style="width: 187mm">
            <div style="float:left;clear:none;">
              ...
              Enter the amount from the employer differential wage credit line of Form 3800 (e. g., line 1w of the 2011 Form 3800) that is attributable to employees       
          ...
          <div style="width: 187mm">
            <div style="float:left;clear:none;">
              ...
              applicable line of Form 3800 (e.g., line 1h of the <span style="float:left;">2011 Form 3800) 
          ...
          <div class="styBB" style="width: 187mm">
            <div style="float:left;clear:none;">
              ...
              Form 3800 <span style="float:left;">(e.g., line 1h of the 2011 Form 3800) </span>
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span class="styNBSP"/>.
                <span class="styNBSP"/>.
                <span class="styNBSP"/>.
          ...
          <div style="width:187mm;">
            ...
            <span style="width:100px;"/>                      
              Cat. No. 11208S 
            <span style="width:100px;"/>  
              Form <span class="styBoldText">8820</span> (Rev. 12-2011)
          </div>
          <br/>
          <br class="pageEnd"/>
 ...
 <!--           <div class="styBB" style="float:right; width:4mm; border-bottom-width:1px">
    ...
    <!-- Start Part II Header -->
          <div style="width: 187mm">
            <div style="float:left;clear:none;">
              <span class="styNormalText" style="width: 30mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;"> <b>(a)</b> <br> Letter</br>
              </span>
              <span class="styNormalText" style="width: 60mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;"> <b>(b)</b> <br> Name of orphan drug</br>
              </span>
              <span class="styNormalText" style="width: 60mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;"> <b>(c)</b> <br> Designation number</br>
              </span>
              <span class="styNormalText" style="width: 37mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; text-align:center;"> <b>(d)</b> <br> Date Drug designated</br>
              </span>
            </div>
...
<!--            <div style="float:left;clear:none;">
            ...
            <xsl:variable name="pos" select="position()"/>  
								<tr>
              <span class="styNormalText" style="width: 30mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;"> <xsl:number value="($pos)" format="A"/>
    <!--            <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData/OrphanDrugName"/>
                </xsl:call-template>-->
              </span>
              <span class="styNormalText" style="width: 60mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData2/OrphanDrugName"/>
                </xsl:call-template>
              </span>
              <span class="styNormalText" style="width: 60mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px; text-align:center;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData2/OrphanDrugDesignationNum"/>
                </xsl:call-template>
              </span>

              <span class="styNormalText" style="width: 37mm; border-style:solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; text-align:center;">
                <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode" select="$FormData2/OrphanDrugDesignationDt"/>
                </xsl:call-template>
              </span>
                </tr>
         		</xsl:for-each>

		...
		<html>
          ...
          Your social security number<br/>
					...
					<div class="styBB" style="width:187mm;padding:1mm 0mm;">
						...
						<li>Figure the amounts of any of the following credits you are claiming: Mortgage interest credit, qualified plug-in electric
						...
						for the elderly or disabled.</li>
						<li>If you purchased your home after December 31, 2010, you may be able to take the refundable first-time homebuyer credit
						figured on Form 5405. If you qualify for that credit, you <b>cannot</b> take the District of Columbia first-time homebuyer credit.</li>
						<li>Do not complete Parts I and II if you only have a credit carryforward from 2010.</li>
					</div>
					<!-- BEGIN PART I TITLE -->
					<div class="styBB" style="width:187mm;padding:1mm 0mm;">
					...
					<div class="styBB" style="width:187mm;height:10mm;">
						<span style="font-weight:bold;padding-right:3mm;">A</span> Address of home qualifying for the credit (if different from the address shown on the return) <br/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<div class="styLNDesc" style="height:8.8mm;">
					...
					<div class="styBB" style="width:187mm;padding:1mm 0mm;">
						...
						<div class="styPartDesc">Credit Carryforward From 2010</div>
					</div>
					<!-- END PART III TITLE -->
					<!-- Spacer -->
					<div class="styGenericDiv" style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc"> 
							<span class="styGenericDiv">
								Enter the amount from line 10 of your 2010 Form 8859 
								<xsl:call-template name="SetFormLinkInline">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc">
							<b>Current year credit.</b> If you completed Part II, enter the <b>smaller</b> of line 6 or line 8. If you <br/>
							completed Part III, enter the <b>smaller</b> of line 7 or line 8. Also include this amount on Form 1040, <br/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc">
							<span class="styGenericDiv"><b>Credit carryforward to 2012.</b> Subtract line 9 from line 6 or line 7, whichever applies</span>
							<span class="styIRS8859Dots">.......</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">8859</b> (2011)
						</div>
					</div>
					<!--END Page Footer-->

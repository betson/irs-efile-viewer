			...
			<body class="styBodyClass">
				<form name="IRS8582CR" style="font-family:arial;">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;font-size:8.5pt;">
							...
							<span class="styNormalText">
								<span class="styItalicText">
									If you have credits from a publicly traded partnership, see <b>Publicly Traded Partnerships (PTPs)</b> on page 14 of<br/>
									the instructions.
								</span>
							</span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							<div class="styIRS8582CRLNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;font-size:8.5pt;">
								...
								<b>Credits and Low-Income Housing Credits)</b> (See <b>Lines 1a through 1c</b> on page 9.)
							</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							<div class="styIRS8582CRLNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;font-size:8.5pt;">
								...
								(See <b>Lines 2a through 2c</b> on page 9.)
							</div>
							<xsl:call-template name="CreateBox">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							<div class="styIRS8582CRLNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;font-size:8.5pt;">
								<b>All Other Passive Activity Credits</b> (See <b>Lines 4a through 4c</b> on page 10.)
							</div>
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;background-color:lightgrey;</xsl:with-param>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									Enter the tax attributable to net passive income (see page 10)
								</div>
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 5.6mm 0px 0px;">
									<!--Dotted Line-->
									<span class="styBoldText">
						...
						<div class="styIRS8582CRLineItem">
							<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
								...
								<span style="width:8.5mm;"/>the year, <b>do not</b> complete Part II, III, or IV. Instead, go to line 37.</span>
							</div>
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="Height">8mm</xsl:with-param>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									...
									page 10). If line 10 is equal to or more than line 9, skip lines 11<br/>
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									...
									married filing separately, see page 10
									 <!--Dotted Line-->
									<span class="styBoldText">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									Enter the tax attributable to the amount on line 14 (see page 10)
								</div>
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 5.6mm 0px 0px;">
									<!--Dotted Line-->
									<span class="styBoldText">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						<div style="float:left;">
							<span class="styBoldText">
								For Paperwork Reduction Act Notice, see page 15 of the instructions.
							</span>
						</div>
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8582-CR</span> (Rev. 12-2009)
						</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8582-CR (Rev. 12-2009)<span style="width:138mm;"/>
						</div>
						<div style="float:right;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:100mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									Enter $250,000. If married filing separately, see page 13. (See page<br/>
									13 to find out if you can skip lines 21 through 26.)
									 <!--Dotted Line-->
									<span class="styBoldText">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:100mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									Enter modified adjusted gross income, but not less than zero. (See<br/>
									instructions for line 10 on page 10.) If line 22 is equal to or more<br/>
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									Enter the tax attributable to the amount on line 26 (see page 13)
								</div>
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;float:right;">
									<!--Dotted Line-->
									<span class="styBoldText">.
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									<b>Passive Activity Credit Allowed.</b> Add lines 6, 16, 30, and 36. See page 13 to find out how to<br/>
									...
									from a publicly traded partnership, see <b>Publicly Traded Partnerships (PTPs)</b> on page 14
								</div>
							</div>
							<xsl:call-template name="CreateBox">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;">
									...
									property, check this box. See page 15
									<!--Dotted Line-->
									<span class="styBoldText">.
										<span style="width:11px"/>.
										<span style="width:11px"/>.
									...
									<span>
										<xsl:call-template name="PopulateSpan">
											 <xsl:with-param name="TargetNode" 
												select="$Form8582CRData/ElectToIncreaseBasisInd" />
										  </xsl:call-template>
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
								...
								<div class="styIRS8582CRLNDesc" style="width:123mm;height:100%;border-style:dotted;border-color:black;border-bottom-width:1px;">
									<xsl:call-template name="PopulateText">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:auto;height:10mm;padding:0px 0px 0px 0px;">
								...
								<div class="styIRS8582CRLNDesc" style="width:81mm;height:50%;border-style:dotted;border-color:black;border-bottom-width:1px;"/>
								<div class="styIRS8582CRLNDesc" style="width:100%;height:50%;">
									<div class="styIRS8582CRLNDesc" style="width:100%;height:100%;border-style:dotted;border-color:black;border-bottom-width:1px;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8582CRData/PropertyDescriptionTxt"/>
										</xsl:call-template>
									</div>
								</div>
							</div>

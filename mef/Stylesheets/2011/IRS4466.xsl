  ...
  <div class="styBB" style="width:187mm;">
    ...
    <div style="width:187mm;">
     ...
     <div style="width:187mm;">
        ...
        <span style="float:left;">Enter total tax from the appropriate line of your tax return (for</span>
        <span style="float:left;">example, Form 1120, Schedule J, line 10)  </span>        
          <!-- dotted line -->
         <span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
        </div>

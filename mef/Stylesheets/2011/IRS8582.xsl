...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="Wrksht7PrintWrkshtLossActivityGrp">
		<xsl:param name="TargetNode"/>
			...
			<!-- 1a -->
			<div class="styIRS8582LineItem">
				<div class="styIRS8582CleanDiv" style="width:25%;height:100%;height:8mm;font-size:7pt;padding-left:2px;padding-top:0.5mm;padding-bottom:0.5mm:font-size:8.5pt;clear:none">
					<div class="styIRS8582LNLeftNumBox" style="padding-right:2px;text-align:right;padding-top:0px;">1a</div>
			...
			<div class="styIRS8582LineItem">
				<div class="styIRS8582CleanDiv" style="width:25%;height:100%;">
					<div class="styIRS8582LNLeftNumBox" style="padding-right:2px;text-align:right;padding-top:0px;">b</div>
					<div class="styIRS8582LNDesc" style="width:auto;height:8mm;font-size:7pt;padding-left:2px;">
			...
			<body class="styBodyClass">
				<form name="IRS8582" style="font-family:arial;">
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;font-size:8.5pt;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<!-- (1a) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:2px;text-align:right;">1a</div>
							...
							<div class="styIRS8582LNDesc" style="height:100%;width:81mm;float:right;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="height:4mm;width:40mm;float:right;padding:0px 0px 0px 0px;">
									<xsl:call-template name="CreateBox">
						...
						<!-- (1b) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:0px;text-align:right;">b</div>
							<div class="styIRS8582LNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<!-- (3a) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:2px;text-align:right;">3a</div>
							<div class="styIRS8582LNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="text-align:left;padding-left:5px;">4</div>
							<div class="styIRS8582LNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
									Combine lines 1d, 2c, and 3d. If the result is net income or zero, all losses are allowed,<br/> including
									any prior year unallowed losses entered on line 1c, 2b, or 3c. <b>Do not</b><br/> complete Form 8582.
						...
						<div class="styIRS8582LineItem">
							...
							<div class="styIRS8582LNDesc" style="width:181mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:100%;height:100%;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<!-- (6) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:6px;">6</div>
							<div class="styIRS8582LNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
						...
						<!-- (7) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem" style="height:8.5mm;">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:6px;">7</div>
							<div class="styIRS8582LNDesc" style="width:99mm;height:100%;padding-left:3mm;">
								Enter modified adjusted gross income, but not less than zero (see instructions)
							</div>
							<div class="styIRS8582LNDesc" style="height:8.5mm;width:81mm;float:right;padding:0px 0px 0px 0px;">

									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">100%</xsl:with-param>
										<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;background-color:lightgrey;height:8.5mm</xsl:with-param>
										<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;background-color:lightgrey;height:8.5mm</xsl:with-param>
									</xsl:call-template>
								

									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">8.5mm</xsl:with-param>
										<xsl:with-param name="AmountBoxStyle">padding-top:4.5mm;padding-bottom:0</xsl:with-param>
										<xsl:with-param name="NumberBoxStyle">padding-top:4.5mm;padding-bottom:0</xsl:with-param>
						...
						<!-- (8) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="padding-right:6px;">8</div>
							<div class="styIRS8582LNDesc" style="width:99mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
						...
						<div class="styIRS8582LineItem">
							...
							<div class="styIRS8582LNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								...
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 2.2mm 0px 0px;">
									<!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:11px"/>.
										<span style="width:11px"/>.
						...
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="text-align:left;padding-left:5px;"/>
							<div class="styIRS8582LNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
					...
					<div style="width:187mm;" class="styBB">
						<!-- Content -->
						<div class="styPartName" style="width:15mm;height:4.5mm">Part IV</div>
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;font-size:8.5pt;">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<!-- (16) ////////////////////////////////////////////////////-->
						<div class="styIRS8582LineItem">
							<div class="styIRS8582LNLeftNumBox" style="text-align:left;padding-left:5px;">16</div>
							<div class="styIRS8582LNDesc" style="width:141mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8582LNDesc" style="width:auto;height:100%;">
									<b>Total losses allowed from all passive activities for 2011.</b> Add lines 10, 14, and 15. See 
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8582</span> (2011)
						</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8582 (2011)<span style="width:148mm;"/>
						</div>
						<div style="float:right;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582LineItem">
							<div class="styIRS8582CleanDiv" style="width:24.9%;">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8582LineItem">
							<div class="styIRS8582CleanDiv" style="width:44.035%;height:100%;border-right-width:0px;">
								<span style="width:100%;text-align:left;padding-top:1mm;">
									<b>Total</b>
									<!--Dotted Line-->
									<span class="styBoldText">
							...
							<div class="styIRS8582CleanDiv" style="width:19%;height:100%;border-right-width:0px;border-left-width:1px;">
								<span style="width:100%;text-align:right;padding-top:1mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<div class="styIRS8582CleanDiv" style="width:18%;height:100%;border-right-width:0px;border-left-width:1px;">
								<span style="width:100%;text-align:center;padding-top:1mm;">
									<b>1.00</b>
								</span>
							</div>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtRentalActGrp/WrkshtRentalActGrp) &gt; 5)">
						...
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 1 - For Form 8582, Lines 1a, 1b, and 1c
						</span>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtCommercialGrp/WrkshtCommercialGrp) &gt; 4)">
						...
						<br/>
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 2 - For Form 8582, Lines 2a and 2b
						</span>
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<xsl:call-template name="Wrksht2Headers">
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtPassiveGrp/WrkshtPassiveGrp) &gt; 5)">
						...
						<br/>
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 3 - For Form 8582, Lines 3a, 3b, and 3c
						</span>
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<xsl:call-template name="Wrksht3Headers">
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtAllowanceGrp/WrkshtAllowanceGrp) &gt; 5)">
						...
						<br/>
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 4 - Use this worksheet if an amount is shown on Form 8582, line 10 or 14
						</span>
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<xsl:call-template name="Wrksht4Headers">
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtLossGrp/WrkshtLossGrp) &gt; 5)">
						...
						<br/>
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 5 - Allocation of Unallowed Losses
						</span>
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<xsl:call-template name="Wrksht5Headers">
					...
					<xsl:if test="($Print = $Separated) and  (count($Form8582Data/ParentWrkshtListActivityGrp/WrkshtListActivityGrp) &gt; 5)">
						...
						<br/>
						<span class="styRepeatingDataTitle">
							Form 8582, Part IV - Worksheet 6 - Allowed Losses
						</span>
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<xsl:call-template name="Wrksht6Headers">

				...
				<form id="Form1040">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:18mm;border-right-width:1px;height:42px;padding-top:7px;">
							<span class="styTaxYear">20<span class="styTYColor">11</span></span>
						</div>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS1040HeaderCell" style="width:141.8mm;height:4mm;">
							For the year Jan. 1&#8211;Dec. 31, 2011, or other tax year beginning <span style="width:2mm;"/>
...
-->
                ...
                <xsl:with-param name="containerID" select=" 'depdContainerId' "/>
					...
					<div class="pageEnd" style="width:187mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
						...
						<div style="width:162.5mm;float:left;clear:none;">
                           ...
                           <xsl:call-template name="LinkToLeftoverDataTableInline">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:116.2mm;padding-top:1mm;padding-left:1.5mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
									<span style="width:26.8mm;font-size:6pt;padding-top:1mm;float:left;clear:none;">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:117.8mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									...
									<div class="styUnderlineAmount" style="width:58mm;float:left;clear:none;padding-top:0mm;padding-left:3mm;border-style:dotted;text-align:left;">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 21 - Net Operating Loss Code</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/NetOperatingLossCd"/>
										</xsl:call-template>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 21 - Net Operating Loss Deduction Amount</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/NetOperatingLossDeductionAmt"/>
										</xsl:call-template>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77.8mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									...
									<span class="styAgency" style="font-size:8pt;">
										...
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/EmplrEquivalentPrtnSETaxAmt"/>
										</xsl:call-template>
									</span>
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.</span>
								</div>
								...
								<div class="styLNAmountBox" style="padding-top:1mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EmplrEquivalentPrtnSETaxAmt"/>
										<xsl:with-param name="BackupName">IRS1040EmplrEquivalentPrtnSETaxAmt</xsl:with-param>
									</xsl:call-template>
								</div>
								<div class="styShadingCell" style="height:4mm;width:8.3mm;padding-top:1.8mm;border-right-width:1px;"/>
							</div>
               ...
               Form <span class="styBoldText" style="font-size:10pt;">1040</span> (2011)
               </span>
					</div>
					<!-- end page 1 footer -->
					<!-- page 2 -->
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<span class="" style="float:left;clear:none;">Form 1040 (2011)</span>
					...
					<div class="styBB" style="width:187mm;padding-top:0mm;padding-bottom:0mm;">
						<div style="width:24.5mm;float:left;clear:none;">
							...
							<div class="styGenericDiv" style="width:24.5mm;border:1px solid black;padding-left:8px;">
								<b>Standard<br/>
								Deduction<br/>
								for&#8211;</b><br/>
								&#8226; People who<br/>
						...
						<div style="height:8mm;width:162.5mm;float:left;clear:none;">
                           ...
                           Amount from line 37 (adjusted gross income)
							...
							<div style="width:162.5mm;">
								...
								<div style="width:117.8mm;font-size:6.3pt;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
                           ...
                           Child tax credit (see instructions). 
							...
							<div style="width:162.5mm;">
								...
								<div class="styShadingCell" style="height:4mm;width:8.3mm;padding-top:1.8mm;border-right-width:1px;"/>
								<div class="styLNAmountBox" style="border-width:0px;width:31mm;text-align:left;">
									<xsl:if test="count($FormData/SpecificOtherCreditsInd/@*) &gt; 4">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 53c - Credit Forms Statement Schedule R</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/SpecificOtherCreditsInd/@creditFormsStatementSchR"/>
                     ...
                     Taxes
						...
						<div style="float:left;clear:none;height:8mm;width:162.5mm;">
                           ...
                           Additional tax on IRAs, other qualified retirement plans, etc. Attach Form 5329 if required
							...
							<div style="width:162.5mm;">
								...
								<div style="width:116.2mm;padding-left:1mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										...
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/CombinedFUTATaxPlusNetTaxesAmt"/>
										</xsl:call-template>
									</span>
									<span class="styDotLn" style="float:right;padding-right:2mm;clear:none;">............</span>
								</div>
							...
							<!-- Line 59b -->
							<div style="width:162.5mm;">
								<div class="styLNLeftNumBox" style="padding-left:4mm;width:4mm;">b</div>
								<div style="width:116.5mm;padding-left:1mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:117.8mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									...
									<div class="styUnderlineAmount" style="width:50mm;float:left;clear:none;padding-top:0mm;padding-left:3mm;border-style:dotted;text-align:left;">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 60 - Form 8963 Approved Indicator</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/TotalOtherTaxAmt/@form8936ApprovedInd"/>
										</xsl:call-template>
										<span style="width:4px;"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 60 - Form 8963 Approved Date</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/TotalOtherTaxAmt/@form8936ApprovedDt"/>
										</xsl:call-template>
									</div>
								</div>
						...
						<div style="float:left;clear:none;height:8mm;width:162.5mm;">
                           ...
                           Federal income tax withheld from Forms W-2 and 1099
                               ...
                               <!-- Form to Form Link -->
								...
								<div class="styLNRightNumBox" style="height:4mm;padding-top:1mm;">62</div>
								<div class="styLNAmountBox" style="padding-top:1mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/WithholdingTaxAmt"/>
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77.8mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span class="styAgency" style="font-size:7.5pt;">2011 estimated tax payments and amount applied from 2010 return</span>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<div class="styLNRightNumBox" style="padding-top:1mm;height:8mm">63</div>
								<div class="styLNAmountBox" style="padding-top:1mm;height:8mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPaymentsAmt"/>
										<xsl:with-param name="BackupName">IRS1040EstimatedTaxPaymentsAmt</xsl:with-param>
									</xsl:call-template>
								</div>
								<div class="styShadingCell" style="height:8mm;width:8.3mm;padding-top:1.8mm;border-right-width:1px;"/>
							</div>
							<!--End Line 63 -->
							<!-- Line 64a -->
							<div style="width:162.5mm;">
                           ...
                           Account number
							...
							<div style="width:165mm;">
								...
								<div style="height:4mm;width:77.3mm;padding-left:2.5mm;border-bottom-width:0mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span class="styAgency" style="font-size:8pt;">Amount of line 73 you want<b> applied to your 2012 estimated tax</b>
										</span>
            ...
            <div class="pageEnd" style="width:187mm;" /> -->
					...
					<div class="styBB" style="width:187mm;padding-top:0mm;">
                        ...
                        records.                
							...
							<div style="padding-top:12.7mm;padding-left:9px;padding-right:0px;float:left;clear:none;width:4mm;">
                  ...
                  <span style="width:1mm;height:.25mm;background-color:blue;"></span> 
                        ...
                        Spouse's occupation
								...
								<div class="styGenericDiv" style="height:11mm;width:37mm;border-left-width:0px;">
									<span style="width:100%;padding-left:4px;font-family:Arial Narrow;font-size:larger;">Identity Protection PIN (see Inst.)</span>
            ...
            <xsl:call-template name="PopulateLeftoverRowAmount">
              ...
              Line 42 - Housed Midwestern Displaced Individual Indicator:
					...
					<td class="PopulateLeftoverRow" style="width:87mm;">
						...
						<!-- Had to hardcode the table as a checkbox has to be represented.  There is no predefined template to represent the checkbox -->
						<xsl:if test="$FormData/TotalOtherTaxAmt/@form8936ApprovedInd">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$FormData/TotalOtherTaxAmt/@form8936ApprovedInd"/>
											<xsl:with-param name="BackupName">IRS1040TotalOtherTaxAmtForm8936ApprovedInd</xsl:with-param>
										</xsl:call-template>
									Line 60 - Form 8936 Approved Indicator:
                        </label>
								</td>
								<td class="PopulateLeftoverRow" style="width:87mm;">
									<input type="checkbox" class="styCkbox">

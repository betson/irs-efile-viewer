        ...
        <form name="Form4797">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:134mm;">Enter the gross proceeds from sales or
			  exchanges reported to you for 2011 on Form(s) 1099-B or 
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;height:7.3mm;font-weight:bold;">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:right;">
			  ...
			  Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2011)
			</div>
          </div>
          ...
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 4797 (2011)<span style="width:148mm;"/>
            </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="height:4mm;padding-top:0mm;">
          ...
          <xsl:if test="(count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated)">
            <span class="styRepeatingDataTitle">
            Form 4797, Part III, Lines 20 throught 29b - Gain From Disposition of Property Under Sections 1245, 1250, 1252, 1254, and 1255:</span>
            <xsl:for-each select="$Form4797Data/PropertyDispositionGain">
              <xsl:if test="(position() mod 4) = 1">
                <xsl:variable name="curPos">
                  <xsl:value-of select="position()"/>

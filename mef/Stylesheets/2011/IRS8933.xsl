...
<body class="styBodyClass">
 ...
 <!--  Line 1a -->  
    ...
    <div class="styIRS8933Multiple" style="height:4mm; width:4.9mm;"></div>
  <div class="styLNRightNumBox" style="height:4.6mm; border-bottom-width:0px;background-color:lightgrey;"></div>
  ...
  <div style="width: 187mm">
    ...
    <span class="styBoldText">
      ...
      <div class="styUnderlineAmount" style="height:4mm;padding-top:1mm;text-align:center;">
     $20.37
       <span style="width:2mm;"></span>
    </div>
  ...
  <!--  end Line 4 -->
          ...
          Form <span class="styBoldText">8933</span> (2011)
        </div>
        <br/>
        <br class="pageEnd"/>

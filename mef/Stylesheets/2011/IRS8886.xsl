          ...
          Identify the type of reportable transaction. Check all boxes that apply (see instructions).
           ...
           .<img src="{$ImagePath}/8886_Bullet.gif" alt="Right Arrow Bullet"/>
					...
					<div style="width:187mm; padding-top:2mm">
						...
						<div style="float:left; width:181mm; padding-top:0.5mm">If you participated in this reportable transaction indirectly through a partnership, S corporation, trust, or foreign entity, check the applicable boxes and provide the information below for the entity(s) (see instructions). (Attach additional sheets, if necessary.)    
      </div>
					</div>
...
bar to display in line data. -->
          ...
          Form <b style="font-size:9pt">8886</b> (Rev. 12-2011)
        </div>
					</div>
					<!-- begin page 2 -->
					<div style="width:187mm; font-size:7pt; border-bottom:1 solid black">
						<span style="float:left">Form 8886 (Rev. 12-2011)</span>
            ...
            <span style="width: 5mm;"/>
              ...
              <!-- Push Pin image -->
					...
					<div style="width:187mm; border-top:0mm;border-style:solid black; padding-top:1mm;">
						...
						<div style="float:left; padding-top:0.5mm;">Identify all individuals and entities involved in the transaction that are tax-exempt, foreign, and related.  Check the</div>

        ...
        <xsl:choose>
            <xsl:when test="$TargetNode='BusinessNameLine1' and not($RtnHdrData/Filer/Name/BusinessNameLine1)">
              <xsl:choose>
				...
				<xsl:when test="$RtnHdrData/Filer/PrimaryName">
					<xsl:call-template name="PopulateText">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$TargetNode ='PreparerSSN'">
        <xsl:if test="$RtnHdrData/PaidPreparerInformation/PreparerSSN">
          <xsl:call-template name="PopulateSSN">
            <xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformation/PreparerSSN"/>
          </xsl:call-template>
        </xsl:if>
      </xsl:when>
...
<!--
***************************************************************************************************************************************************************
Name:           SetFormLinkInline (RRD version)
      ...
      <img src="{$NonVersionedImagePath}/attach.gif" style="cursor:auto;">
        ...
        <xsl:if test="not($Print) or $Print=''">
          ...
          <xsl:attribute name="onclick">
            SendRef('<xsl:value-of select="$TargetNode/@referenceDocumentId"/>')
          </xsl:attribute>
        </xsl:if>
      </img>
    </xsl:if>

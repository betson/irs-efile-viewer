...
<!-- Last Modified by Eugenia McDonald on 01/20/2012 -->
				...
				<form name="Form1065ScheduleD">
					...
					<div class="styTBB" style="width:187mm;height:15mm;">
						...
						<div class="styTYBox" style="width:30mm;height:15mm;">
							...
							<div class="styTY" style="height:12.5mm;padding-top:1.5mm;">20<span class="styTYColor">11</span>
							</div>
						</div>
					</div>
         ...
         Employer identification number<br/>
					...
					<div class="styTableContainer" style="height:25.5mm;" id="PSOctn">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody style="font-size:7pt">
								...
								<xsl:if test="($Print != $Separated) 
								    and (count($Form1065SchDData/ShortTermCapitalGainAndLoss) &lt;= 0) ">
									<tr style="height:8mm">
								...
								<xsl:if test="(($Print = $Separated)
								  and (count($Form1065SchDData/ShortTermCapitalGainAndLoss) &gt; 5))">
									<tr style="height:8mm">
										<td class="styTableCell" style="width:4mm; text-align:right;
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody style="font-size:7pt">
								<xsl:for-each select="$Form1065SchDData/LongTermCapitalGainAndLoss">
									<xsl:if test="($Print != $Separated) 
									  or (count($Form1065SchDData/LongTermCapitalGainAndLoss) &lt;= 5) ">
										<tr style="height:8mm">
											<td class="styTableCell" style="width:4mm;text-align:right;border-right-width:0px;
											  font-weight:bold;"
											 scope="col">
								...
								<xsl:if test="($Print != $Separated)
								  and (count($Form1065SchDData/LongTermCapitalGainAndLoss) &lt;= 0) ">
										<tr style="height:8mm">
											<td class="styTableCell" style="width:4mm;text-align:right;border-right-width:0px;
								...
								<xsl:if test="(($Print = $Separated)
								  and (count($Form1065SchDData/LongTermCapitalGainAndLoss) &gt; 5))">
									<tr style="height:8mm">
										<td class="styTableCell" style="width:4mm;text-align:right; border-bottom-width:0px;
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;font-size:7pt">
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule D (Form 1065) 2011</span>
						</div>
					</div>

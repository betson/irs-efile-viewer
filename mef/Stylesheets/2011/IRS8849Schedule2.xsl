  ...
  <xsl:template match="/">
        ...
        <form name="Form8849Schedule2">
          ...
          <div class="styBB" style="width:187mm;border-bottom:2px black solid;">
            <div class="styFNBox" style="width:31mm;height:19mm;border-right:2px black solid;">
              ...
              <br/>
              <span class="styAgency">(Rev. January 2009)</span>
              <br/>
    ...
    <br/>
                ...
                <td valign="top" class="styNameBox" style="padding-left:2mm;font-size:7pt;font-weight:normal;height:10mm; border-right-width:0px">Total refund (see instructions)<br/>
                  <div style="padding-top:1mm">$
      <span style="width:38mm;text-align:right;clear:none;">
    ...
    credit card issued to the state or local government by a credit card issuer.
          ...
          <div style="width:187mm;">
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  <th style="width=8mm;height:8.0mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
                  <th style="width=58mm;height:8.0mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
        ...
        border-top:1px black solid;" valign="top">(b) Gallons<br/>
                  </th>
        ...
        <span style="width:16px"/>.
          ...
          <div style="width:187mm;">
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  <th style="width=8mm;height:8mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
                  <th style="width=58mm;height:8mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
      ...
      For line 3c, 
          ...
          <div style="width:187mm;">
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  <th style="width=8mm;height:6.5mm;">
                    <span style="width=1px;"/>
                  </th>
                  <th style="width=80mm;height:6.5mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  ...
                  <th style="width=95mm;height:6.5mm;border-top:1px black solid;">
                    <span style="width=1px;"/>
                  </th>
                  <th style="width=15mm;height:6.5mm;border-left:1px black solid;
          border-bottom:1px black solid;border-top:1px black solid;">(a) Rate<br/>
                    <br/>
                  </th>
                  <th style="width=20mm;height:6.5mm;border-left:1px black solid;
          border-bottom:1px black solid;border-top:1px black solid;">(b) Gallons<br/>
                    <br/>
                  </th>
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                <tr>
                  ...
                  <th style="width=15mm;height:6.5mm;border-left:1px black solid;
          border-top:1px black solid;border-bottom:1px black solid;">(a) Rate<br/>
                    <br/>
                  </th>
                  <th style="width=20mm;height:6.5mm;border-left:1px black solid;
          border-top:1px black solid;border-bottom:1px black solid;">(b) Gallons<br/>
                    <br/>
                  </th>
    ...
    Schedule 2 (Form 8849) (Rev. 1-2009)
          ...
          <div class="styBB" style="width:187mm;border-top:1px black;">
            ...
            <div class="styLNDesc" style="width:150mm;">
              <span class="styBoldText">
                Government Unit Information</span>
            </div>
          </div>
    ...
    each governmental unit to whom the fuel was sold. If more space is needed, attach additional sheets.
          ...
          <div class="styBB" style="width:187mm;border-top:1px black;">
            ...
            <div class="styLNDesc" style="width:177mm;">
              <span class="styBoldText">
                Nonprofit Educational Organization and Government Unit Information</span>
            </div>
          </div>
          <div style="width:187mm;font-size:7pt;border-bottom:1px black solid;">
            <div class="styLNLeftNumBox" style="height:7mm;width:8mm;"/>
          ...
          <xsl:if test="count($FormData/NonprofitEdOrgAndGovtUnitInfo) &gt; 11 and ($Print = $Separated)">
            ...
            <table class="styDepTbl" style="font-size:7pt;cellspacing:0;">
              <thead class="styTableThead">
                <tr class="styDepTblHdr">
                  <th class="styDepTblCell" style="width=44mm;height:7.7mm;border:0 black solid;
          border-right-width:1;border-bottom-width:1;text-align:center;" scope="col">
          Taxpayer Identification No.
        </th>
                  <th class="styDepTblCell" style="width=99mm;height:7.7mm;border-left:1px black solid;
          border:0 black solid;border-right-width:1;border-bottom-width:1;text-align-center" scope="col">
          Name
        </th>
                  <th class="styDepTblCell" style="width=42mm;height:7.7mm;border-left:1px black solid;
          border:0 black solid;border-bottom-width:1;text-align:center;" scope="col">
          Gallons
        </th>
                </tr>
              </thead>

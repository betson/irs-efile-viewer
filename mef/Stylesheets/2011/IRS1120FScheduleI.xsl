   ...
   <!--Line 7a-->
          ...
          <div style="width:187mm;clear:both;padding-top:0.5mm">
            ...
            <div style="float:right;" class="styGenericDiv">
              <b>Schedule I (Form 1120-F) 2011</b>
            </div>
          </div>
          <br/>
          <div class="pageEnd"/>
          ...
          <div class="styTBB" style="width:187mm">
            ...
            <div>Schedule I (Form 1120-F) 2011</div>
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchIStep3ContSepCurDesc" scope="row">
                      <b>U.S. assets.</b> Enter the corporation’s U.S. assets, using the methodology in Regs. sec. 1.882&#8211;5(e)(1)(i). If more columns are needed, attach schedule  (see  instructions)
                        <xsl:call-template name="SetFormLinkInline">
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchISummaryDescShort"  scope="row">Amount of line 23 that is disallowed as a deduction under section 265 or under an income tax treaty (attach schedule&#8212;see instructions)
                                 <xsl:call-template name="SetFormLinkInline">
                ...
                <tr>
                  ...
                  <td class="sty1120FSchISummaryDescShort" style="padding-top:1.5mm" scope="row">Amount of line 23 that is capitalized under section 263A (attach

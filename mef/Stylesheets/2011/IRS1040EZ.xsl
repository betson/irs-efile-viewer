...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
				<form name="IRS1040EZ">
							...
							<div class="styIRS1040EZCleanDiv" style="width:81.8%;height:100%;">
								...
								<div class="styIRS1040EZLineItemBB">
									...
									<div class="styIRS1040EZLNDesc" style="width:112mm;">
										...
										<br/>
										If no one can claim you (or your spouse if a joint return), enter $9,500 if <b>single;</b>
										<br/>
										$19,000 if <b>married filing jointly.</b> See back for explanation.
									</div>
									<div class="styIRS1040EZCleanDiv" style="width:34mm;float:right;">
										<xsl:call-template name="CreateBox">
							...
							<div class="styIRS1040EZCleanDiv" style="width:81.8%;height:100%;">
								...
								<div class="styIRS1040EZLineItem" style="width:100%;">
									...
									<div class="styIRS1040EZLNDesc" style="width:112mm;">
										...
										the amount you owe. For details on how to pay, see instructions.<span style="width:33mm;"/>
										<img src="{$ImagePath}/1040EZ_Bullet_Sm.gif" alt="Small Bullet"/>
									</div>
									<div class="styIRS1040EZCleanDiv" style="width:34mm;float:right;">
										<xsl:call-template name="CreateBox">
							 ...
							 <div class="styGenericDiv" style="width:10mm;height:20mm;padding-top:4mm">
								...
								<!-- Container -->
									...
									<div class="styGenericDiv" style="width:153mm;height:10mm;border-bottom:1px solid black;">
										<!-- Your Signature -->
										<div class="styIRS1040EZLNDesc" style="width:50mm;height:100%;border-right-width:1px;border-color:black;padding-left:0px;">
											Your signature<br/>
										...
										<!-- Date -->
										<div class="styIRS1040EZLNDesc" style="width:16mm;height:100%;border-right-width:1px;border-color:black;padding-left:0px;">
										...
										<!-- Your occupation -->
										<div class="styIRS1040EZLNDesc" style="width:45mm;height:100%;border-right-width:1px;border-color:black;padding-left:0px;">
										...
										<div class="styIRS1040EZLNDesc" style="width:42mm;height:100%;padding-left:0px;">
									...
									<div class="styGenericDiv" style="width:153mm;height:10mm">
										...
										<div class="styIRS1040EZLNDesc" style="width:42mm;height:100%;padding-left:0px;">
											<span style="width:100%;padding-left:4px;font-family:Arial Narrow;">Identity Protection PIN (see Inst.)</span>
											<span style="width:100%;padding-top:6px;text-align:center;">
												<xsl:call-template name="PopulatePin">
					...
					<div class="styGenericDiv" style="width:187mm;font-size:6.5pt;font-family:arial;border-bottom: 2px solid black;">
						...
						<div class="styGenericDiv" style="height:100%;width:161mm;border-width:0px 0px 0px 1px; border-color:black;border-style:solid;">
							<div class="styGenericDiv" style="width:161mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:7mm;width:46.8mm;padding-top:0mm;border-right:1 solid black;padding-left:3px;">
								...
								<div class="styLNDesc" style="height:7mm;width:46.5mm;padding-top:0mm;border-right:1 solid black;padding-left:1mm;">
								...
								<div class="styLNDesc" style="height:7mm;width:18mm;border-right:1 solid black;padding-top:.5mm;padding-bottom:0mm;padding-left:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">1040EZ</span> (2011)
						</div>
					...
					<table class="styLeftOverTbl">
						...
						<xsl:if test="$Form1040EZData/ProtectiveSec108iELCRecordInd">
							<xsl:call-template name="PopulateLeftOverCheckbox1040EZ">
								<xsl:with-param name="Desc">Protective Security ELC Record Indicator</xsl:with-param>
						...
						<xsl:if test="$Form1040EZData/PersonalRepresentativeInd">
							<xsl:call-template name="PopulateLeftOverCheckbox1040EZ">
								<xsl:with-param name="Desc">Personal Representative Indicator</xsl:with-param>
			...
			<div class="styIRS1040EZLineItem" style="height:11mm;">
				...
				<div class="styIRS1040EZCleanDiv" style="width:32mm;height:100%;">
					<span style="width:100%; height:4mm;padding-top:2px;">					
							<xsl:if test="$Form1040EZData/PrimaryDateOfDeath">
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Primary Date of Death</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1040EZData/PrimaryDateOfDeath"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="$Form1040EZData/SpouseDateOfDeath">
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Spouse Date of Death</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1040EZData/SpouseDateOfDeath"/>
								</xsl:call-template>
	...
	<xsl:template name="PopulateFormLinks">
		...
		<xsl:call-template name="LinkToLeftoverDataTableInline">
			<xsl:with-param name="Desc">Power Of Attorney Signed By</xsl:with-param>
			<xsl:with-param name="TargetNode" select="$Form1040EZData/PowerOfAttorneySignedBy"/>
		</xsl:call-template>
		<xsl:call-template name="LinkToLeftoverDataTableInline">
			<xsl:with-param name="Desc">Power Of Attorney Name</xsl:with-param>

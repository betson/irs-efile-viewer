...
<span style="width:16px"/>.
  ...
  Paperwork Reduction Act Notice, see the Instructions for Form 990 or Form 990-EZ.</div>
						...
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;">Schedule N (Form 990 or 990-EZ) 2011</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
					<br/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left">Schedule N (Form 990 or 990-EZ) 2011</div>
 ...
 and any additional information.</span>
						...
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead>
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:156mm;text-align:center;font-size:7pt;font-weight:normal;border-color:black;">Explanation</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody valign="top">
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule N (Form 990 or 990-EZ) 2011</span>
						</div>
					</div>
					<!--END Page Footer-->
					<br/>

      ...
      <head>
        ...
        <style type="text/css">
          <!--NOTE: Part I table will display 6 rows of data per PDF, prior to displaying scroll bar/separated format.
						  ...
						  There is no page 2 Part III for continuous of part 1 and 2 table 
          ...
          <form name="Form8275R">
            ...
            <div style="width:187mm;height:18mm;" class="styTBB">
              <div style="width:32mm;height:20.5mm;" class="styFNBox">
                ...
                <br/>
                <div style="font-size:normal">(Rev. December 2008) </div>
                <br/>
              </div>
            ...
            <div style="width:125mm;height:20.5mm;" class="styFTBox">
              ...
              <div style="height:7mm;font-size:7pt;padding-top:1mm;font-weight: bold;">
                Use this form only to disclose items or positions that are contrary to Treasury regulations.
                For other disclosures, use Form 8275, Disclosure Statement.
                <div style="height:1mm;padding:1mm;">  See separate instructions.</div>
              </div>    
              ...
              <thead class="styTableThead">
                <tr style="height:6mm;">
                  ...
                  <th class="styTableCellHeader" style="width:23mm;border-color:black;" scope="col">
                    (b)<br/>
                    <div> Item or Group of Items </div> 
                  </th>
        ...
        ((count($Form8275RData/GeneralInformation) &gt;= 6) and ($Print = $Separated))">
          ...
          <xsl:choose>
          <xsl:when test="$Form8275RData/GeneralInformation/DetailedExplanation">
        ...
        (count($Form8275RData/GeneralInformation/DetailedExplanation) &lt;=3) ">
                      <xsl:for-each select="$Form8275RData/GeneralInformation/DetailedExplanation">
              ...
              border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                  ...
                  border-bottom-width:0px;</xsl:attribute>
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 1
           or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) 
           and ($Print = $Separated))">
                      <tr style="height:5mm;">
              ...
              border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                          <xsl:call-template name="PopulateAdditionalDataTableMessage">
                            <xsl:with-param name="TargetNode" select="$Form8275RData/GeneralInformation/DetailedExplanation"/>
                          </xsl:call-template>
                          <span class="styTableCellPad"/>
                        </td>
                      </tr>
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 2 or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                      <tr style="height:5mm;">
                        <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 3 or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                      <tr style="height:5mm;">
                        <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 4 or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                      <tr style="height:5mm;">
                        <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 5 or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                      <tr style="height:5mm;">
                        <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
                    ...
                    <xsl:if test="count($Form8275RData/GeneralInformation/DetailedExplanation) &lt; 6 or ((count($Form8275RData/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                      <tr style="height:5mm;">
                        <td class="styTableCell" style="width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border-color:black;vertical-align:top;">
          ...
          <div class="styBB" style="width:187mm;float:none;">
            <div class="styIRS8275LeftLine" style="width:93mm;height:27mm;">
              ...
              <div class="styGenericDiv">
                ...
                <xsl:choose>
                  <xsl:when test="$Form8275RData/PassThroughEntityBusName/BusinessNameLine1 !=''">
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8275RData/PassThroughEntityBusName/BusinessNameLine1"/>
                    </xsl:call-template>
                    <xsl:if test="$Form8275RData/PassThroughEntityBusName/BusinessNameLine2 !=''">
                      <br/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8275RData/PassThroughEntityBusName/BusinessNameLine2"/>
                      </xsl:call-template>
                    </xsl:if>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8275RData/PassThroughEntityIndName"/>
                    </xsl:call-template>
                  </xsl:otherwise>
                </xsl:choose>
                <br/>                
            ...
            <div class="styIRS8275LeftLine" style="width:93mm;height:27mm;border-right-width:0px;">
              ...
              <div style="width:93mm;height:11mm;">
                ...
                Internal Revenue Service Center where the pass-through entity filed its return<xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        <!-- Begin Separated Repeating Data for Part I table -->
        <xsl:if test="($Print = $Separated) and (count($Form8275RData/GeneralInformation) &gt; 3)">
          ...
          <!-- Begin part II table in separated print -->

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
        ...
        Check only one box on each form.<br/>
          ...
          Form <b style="font-size:8pt;">1118</b> (Rev. 12-2011)
        </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					<!--BEGIN HEADER-->
					<div class="styBB" style="width:256mm">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2011)</div>
						<div style="float:right">
               ...
               requires the corporation to complete Schedule F under the authority of section 905(b).
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2011)</div>
						</div>
					</div>
					<!--END FOOTER-->
					<div class="pageEnd"/>

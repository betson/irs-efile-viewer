...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <form name="IRS8839">
          ...
          <div style="width:187mm;" class="styBB">
            ...
            <div class="styPartDesc" style="padding-left:3mm;">
              Information About Your Eligible Child or Children-<span class="styNormalText">You <b>must</b> complete this part. See instructions for
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 7 more than $185,210?<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  <span>
                  ...
                  <label>
                    ...
                    <span style="width:5px;"/>Subtract $185,210 from line 7
                      <!--Dotted Line-->
                    <span class="styBoldText">
                      <span style="width:10px"/>.
                        <span style="width:11px"/>.
            ...
            <xsl:for-each select="$Form8839Data/AdoptedChild">
              <xsl:if test="position() mod 3 = 1">
                ...
                <div style="width:187mm;">
                  ...
                  <div class="styGenericDiv" style="width:46.7mm;height:4.5mm;">
                  </div>
                ...
                <div style="width:187mm;height:7mm">
                  ...
                  <div class="styGenericDiv" style="width:46.7mm;">
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Add the amounts on line 11. <b>This your Adoption Credit.</b> Include this amount on Form 1040, line 71, or Form 1040NR, line 66. Check box b on that line
                  <!--Dotted Line-->
                  <span class="styBoldText">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8pt;">8839</span> (2011)
            </div>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 19 more than $185,210?<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  ...
                  <label>
                    ...
                    <span class="styBoldText">No.</span>
                    <span style="width:4px;"/>Skip lines 20 and 21, and<br/>
                    <span style="width:6mm;"/>enter -0- on line 22.<br/>
                  </label>
                  <!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
                  <span style="width:1mm;"/>
                  <span>
                  ...
                  <label>
                    ...
                    <span class="styBoldText">Yes.</span>
                    <span style="width:4px;"/>Subtract $185,210 from line<br/>
                    <span style="width:6mm;"/>19
                <!--Dotted Line-->
                    <span class="styBoldText">
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNRightNumBoxNBB" style="height:7mm;padding-top:3mm;">21</div>
            ...
            <xsl:for-each select="$Form8839Data/AdoptedChild">
              <xsl:if test="position() mod 3 = 1">
                ...
                <div style="width:187mm;height:7mm">
                  ...
                  <div class="styGenericDiv" style="width:46.7mm;">
                    Multiply each amount on line 18<br/>
                    by line 21 
                  </div>
                  <div class="styLNRightNumBox" style="height:7mm;padding-top:3mm;">22</div>
                  <div class="styLNAmountBox" style="width:29mm;height:7mm;padding-top:3.5mm;font-size:6pt;padding-right:.5mm;">
                    <xsl:call-template name="PopulateAmount">
                ...
                <div class="styGenericDiv" style="width:187mm;height:7mm">
                  <div class="styLNLeftNumBox" style="height:7mm;">23</div>
                  <div class="styGenericDiv" style="width:46.7mm;">
                    Excluded benefits. Subtract<br/>
            ...
            <div class="styIRS8839LineItem">
              ...
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="TargetNode" select="$Form8839Data/DummyData"/>
            ...
            <!-- (25) ////////////////////////////////////////////////////-->
            <div class="styIRS8839LineItem">
              <div class="styIRS8839LNLeftNumBox">25</div>
              <div class="styIRS8839LNDesc" style="width:142.5mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
                  <b>Taxable benefits.</b> Is line 24 more than line 17?
                  <div style="padding:0px 0px 0px 0px;width:100%;height:100%;">
                    <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
                      ...
                      <label>
                        ...
                        <span class="styBoldText">No.</span>
                        <span style="width:5px;"/>Subtract line 24 from line 17. Also, include this amount, if more than zero, on<br/>
                      ...
                      <label>
                        ...
                        <span class="styBoldText">Yes.</span>
                        <span style="width:5px;"/>Subtract line 17 from line 24. Enter the result as a negative number. Reduce<br/>
                        <span style="width:11mm;"/>the total you would enter on line 7 of Form 1040 or line 8 of Form 1040NR by<br/>
                        <span style="width:11mm;"/>the amount on Form 8839, line 25. Enter the result on line 7 of Form 1040 or<br/>
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:88%;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You paid adoption expenses in 2010, those expenses were not fully reimbursed by your employer or otherwise, and<br/>
                  <span style="width:7px;"/>the adoption was not final by the end of 2010.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>The total adoption expenses you paid in 2011 were not fully reimbursed by your employer or otherwise, and the<br/>
                  <span style="width:7px;"/>adoption became final in 2011 or earlier.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 5px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You adopted a child with special needs and the adoption became final in 2011.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            <div style="float:right;">
              ...
              Form<span class="styBoldText" style="font-size:7pt;"> 8839 </span>(2011)
            </div>
          </div>
          <!-- END Page Break and Footer-->
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:if test="count($Form8839Data/AdoptedChild) > 1">
              <xsl:for-each select="$Form8839Data/AdoptedChild">
                <xsl:call-template name="PopulateLeftoverRow">
                  ...
                  <xsl:with-param name="TargetNode" select="AdoptionCreditSameChildPYInd"/>
                  <xsl:with-param name="DescWidth" select="$TableWidth"/>
                </xsl:call-template>
              </xsl:for-each>
              <xsl:for-each select="$Form8839Data/AdoptedChild">
                <xsl:call-template name="PopulateLeftoverRow">
                  <xsl:with-param name="Desc">Part III, Line 16-Did you receive employer provided adoption benefits for a prior year for the same child?-Child <xsl:number value="position()" format="1"/>
                  </xsl:with-param>
            ...
            <xsl:for-each select="$Form8839Data/AdoptedChild">
              ...
              <xsl:call-template name="PopulateLeftoverRow">
                <xsl:with-param name="Desc">Part III, Line 18-Employer Adoption Benefit Exclusion Prior Year Amount-Child <xsl:value-of select="$num"/>
                </xsl:with-param>
                <xsl:with-param name="TargetNode" select="EmployerAdoptionBnftPerChldAmt/@employerAdoptionBnftExclPYAmt"/>
                <xsl:with-param name="DescWidth" select="$TableWidth"/>
              </xsl:call-template>
              <xsl:call-template name="PopulateLeftoverRow">
                <xsl:with-param name="Desc">Part III, Line 18-Employer Adoption Benefit Exclusion Prior Year Code-Child <xsl:value-of select="$num"/>
                </xsl:with-param>
  ...
  <xsl:template name="CreateEmptyTableRows">
    ...
    <tr style="font-size: 7pt;">
      ...
      <!--(g) adoption became final in 2011 or earlier Indicator-->
    ...
    <tr>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        <xsl:attribute name="style">
          border-color:black;width:4%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
      ...
      <th class="styTableCellHeader" scope="col" rowspan="2" colspan="2">
        <xsl:attribute name="style">
          border-bottom-width:0px;border-color:black;width:40%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
            color:white;font-size:7pt;
          </xsl:if>
        </xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        <xsl:attribute name="style">
          border-color:black;width:11%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
            color:white;font-size:7pt;
          </xsl:if>
        </xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" colspan="3" rowspan="1">
        <xsl:attribute name="style">
          border-color:black;width:24%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
            color:white;font-size:7pt;
          </xsl:if>
        </xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        <xsl:attribute name="style">
          border-color:black;width:13%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
            color:white;font-size:7pt;
          </xsl:if>
        </xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        <xsl:attribute name="style">
          border-color:black;width:8%;font-weight:normal;border-right:0;
          <xsl:if test="$AddColoredHeaders">
            color:white;font-size:7pt;
          </xsl:if>
        </xsl:attribute>
        <span style="font-weight:bold;">(g)</span>
        <br/>Check if<br/>adoption<br/>became final in 2011 or earlier</th>
    </tr>
    <tr>
      <xsl:if test="$AddColoredHeaders">
        <xsl:attribute name="class">styDepTblHdr</xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="2">
        ...
        <br/>born <b>before<br/>1994</b> and<br/>disabled</th>
      <th class="styTableCellHeader" scope="col" rowspan="2">
        <xsl:attribute name="style">
          border-color:black;width:8%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
    ...
    <xsl:param name="AddColorCodeRow"/>
        <tr style="font-size: 7pt;">
          ...
          <td class="styIRS8839TableCell">
            ...
            <xsl:if test="$Form8839Data/AdoptedChild/PersonNameFirstNm">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="PersonNameFirstNm"/>
              </xsl:call-template>
          ...
          <td class="styIRS8839TableCell">
            ...
            <xsl:if test="$Form8839Data/AdoptedChild/PersonNameLastNm">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="PersonNameLastNm"/>
              </xsl:call-template>
          ...
          <td class="styIRS8839TableCell">
            ...
            <label>
              <xsl:call-template name="PopulateLabel">
                <xsl:with-param name="TargetNode" select="$Form8839Data/AdoptedChild/DisabledChildOver18Ind"/>
          ...
          <td class="styIRS8839TableCell">
            ...
            <label>
              <xsl:call-template name="PopulateLabel">
                <xsl:with-param name="TargetNode" select="$Form8839Data/AdoptedChild/ChildWithSpecialNeedsInd"/>
          ...
          <td class="styIRS8839TableCell">
            ...
            <label>
              <xsl:call-template name="PopulateLabel">
                <xsl:with-param name="TargetNode" select="$Form8839Data/AdoptedChild/ForeignChildInd"/>
          ...
          <td class="styIRS8839TableCell">
            ...
            <label>
              <xsl:call-template name="PopulateLabel">
                <xsl:with-param name="TargetNode" select="$Form8839Data/AdoptedChild/AdoptionFinalInd"/>
  ...
  <xsl:template name="PopulatePartIITable">
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="height:100%;width:133mm;float:right;padding:0px 0px 0px 0px;">
        ...
        <xsl:call-template name="CreateBoxRow">
          <xsl:with-param name="Child1StaticText">$13,360</xsl:with-param>
          <xsl:with-param name="Child2StaticText">$13,360</xsl:with-param>
          <xsl:with-param name="Child3StaticText">$13,360</xsl:with-param>
          ...
          <div style="padding:0px 0px 0px 0px;width:100%;height:100%;">
            <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
              ...
              <span>
                ...
                <input type="checkbox" class="styCkbox">
                  <xsl:if test="$Child1/AdoptionCreditSameChildPYInd and (count($Form8839Data/AdoptedChild) = 1)">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Child1/AdoptionCreditSameChildPYInd"/>
  ...
  <xsl:template name="PopulatePartIIITable">
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="width:47mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          Did you receive employerprovided<br/>
          adoption benefits for a<br/>
          prior year for the same child?<br/>
          <div style="padding:0px 0px 0px 0px;width:100%;height:100%;">
            <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
              <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
              ...
              <span>
                ...
                <input type="checkbox" class="styCkbox">
                  <xsl:if test="$Child1/EmployerAdptnBnftSameChldPYInd and (count($Form8839Data/AdoptedChild) = 1)">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Child1/EmployerAdptnBnftSameChldPYInd"/>
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="width:47mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          ...
          benefits you received in 2011.<br/>
          This amount should be shown<br/>
          in box 12 of your 2011 Form(s)<br/>
          W-2 with code <b>T</b>
          <!--Dotted Line-->
          <span class="styBoldText">
            <span style="width:14px"/>.
  ...
  <xsl:template name="PopulatePartIIILine20">
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="width:47mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          Enter the <b>smaller</b> of line 15 or<br/>
          line 16. But if the child was a<br/>
          child with special needs and the<br/>
          adoption became final in 2011,<br/>
          enter the amount from line 15<br/>
        </div>
      </div>
      <div class="styIRS8839LNDesc" style="height:100%;width:133mm;float:right;padding:0px 0px 0px 0px;">
        <xsl:call-template name="CreateBoxRow">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		<html>
            ...
            Sequence No. <span class="styBoldText">62</span>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNAmountBox" style="height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllowableMealsDeductionAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:187mm;">
					...
					<div style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">3903</b> (2011)
						</div>
					</div>
					<div class="pageEnd"/>

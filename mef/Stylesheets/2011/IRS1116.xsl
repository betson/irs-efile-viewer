...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <tr>
    <td style="width:8mm;font-weight:bold;">g</td>
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;">1a</td>
  ...
  <tr>
    ...
    <td class="styGenericDiv" style="width:70mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
      <xsl:call-template name="PopulateText">
    ...
    <td class="styLNAmountBoxSmall" style="border-left-width:1px;">
      <xsl:call-template name="PopulateAmount">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;border-bottom:1 solid black;">b</td>
  ...
  <tr>
    <td class="styGenericDiv" style="width:78mm;" colspan="2">
      ...
      <span class="styItalicText">
        See pages 13 and 14 of the instructions):
      </span>       
    </td>
    <td class="styLNAmountBoxSmallNBB" style="border-left-width:1px;background-color:lightgrey">
      <span style="width:4mm;"></span>
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;">2</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;">3</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">a</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">b</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">c</td>
    <td class="styGenericDiv" style="width:70mm;">
      Add lines 3a and 3b
      <span style="padding-left:2mm;letter-spacing:3.3mm;font-weight:bold; ">..........</span>
    </td>
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">d</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">e</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">f</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">g</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;">4</td>
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:3.5mm;">a</td>
    <td class="styGenericDiv" style="width:70mm;">
      Home mortgage interest (use worksheet on page 14 of the instructions)
      <span style="padding-left:2mm;letter-spacing:3.3mm;font-weight:bold; ">.........</span>
    </td>
    <td class="styLNAmountBoxSmall" style="border-left-width:1px;">
      <xsl:call-template name="PopulateAmount">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;">5</td>
    <td class="styGenericDiv" style="width:70mm;">
  ...
  <tr>
    <td class="styLNLeftNumBox" valign="top" style="padding-left:2mm;border-bottom:1 solid black;">6</td>
    <td class="styGenericDiv" style="width:70mm;border-bottom:1 solid black;">
    ...
    <tr style="font-size: 7pt;">
      ...
      <td class="styIRS1116TableCell">
        ...
        <xsl:choose>
          ...
          <xsl:when test="ForeignTaxesPaidOn1099Cd">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="ForeignTaxesPaidOn1099Cd"/>
            </xsl:call-template>
          </xsl:when>
        </xsl:choose>
      </td>
  ...
  <xsl:template name="CreatePartIIEmptyTableRows">
    ...
    <!-- CommonStyle -->
    <xsl:variable name="CommonStyle">font-size: 7pt; text-align:center;font-family:arial narrow;word-wrap:break-word;</xsl:variable>
    <tr>
      <!-- Country  ++++++++++++++++++++ -->
      <td class="styIRS1116TableCell">
        <xsl:attribute name="style">
      ...
      <body class="styBodyClass">
        <form name="IRS1116">
          ...
          <div class="styBB" style="width:187mm;">
            <!-- (7) ////////////////////////////////////////////////////////////////////// -->
            <div class="styIRS1116LineItem">
              <div class="styIRS1116LNLeftNumBox" style="text-align:left;">7</div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8pt;">1116</span> (2011)
            </div>
          ...
          <div style="width:187mm;" class="styBB">
            ...
            <div class="styIRS1116LineItem">
              <div class="styIRS1116LNLeftNumBox" style="text-align:left;padding-left:5px;">12</div>
              <div class="styIRS1116LNDesc" style="width:110mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS1116LNDesc" style="width:auto;height:100%;">
            ...
            <div class="styIRS1116LineItem">
              ...
              <div class="styIRS1116LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS1116LNDesc" style="width:auto;height:100%;">
                  Combine lines 11, 12, and 13. This is the total amount of foreign taxes available for credit (see<br/>
                  instructions)
            ...
            <div class="styIRS1116LineItem">
              ...
              <div class="styIRS1116LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS1116LNDesc" style="width:auto;height:100%;">
                  <b>Caution:</b><span style="width:4px;"/><span class="styItalicText">If you are completing line 20 for separate category <span class="styBoldText">e</span> (lump-sum distributions), see page 19<br/>
                   of the instructions.</span>
                </div>
              </div>
              <div class="styIRS1116LNDesc" style="height:100%;width:34mm;float:right;padding:0px 0px 0px 0px;">
                <xsl:call-template name="CreateBox">
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:if test="$Form1116Data/AltBasisCompensationSourceInd">
              <xsl:call-template name="PopulateLeftoverRow">
                <xsl:with-param name="Desc">Part I, Line g 1b- Alternative Basis Compensation Source Indicator</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form1116Data/AltBasisCompensationSourceInd"/>
                <xsl:with-param name="DescWidth" select="130"/>
              </xsl:call-template>
            </xsl:if>

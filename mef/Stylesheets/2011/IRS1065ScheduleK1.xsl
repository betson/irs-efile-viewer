				  ...
				  font-size: 7pt;">
					...
					<tr>
						<td style="width: 93mm;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2011, or tax
											<br/>year beginning
										...
										<span style="float: right; clear: none; font-weight: bold; font-size: 7pt; padding-right: 1mm;
										  padding-top: 0.5mm;">
											<img src="{$ImagePath}/1065SchK1_Bullet.gif" width="4" height="7"
											 alt="Right arrow image" border="0"/> See back of form and separate instructions.</span>
									</td>
								</tr>
								<tr>
												...
												<div style="float:right;clear:all;">
													<span style="width: 50mm;height:4mm;">
														...
														<label>
															<xsl:call-template name="PopulateLabel">
																<xsl:with-param name="TargetNode" select="$FormData/ForeignPartner"/>
																<xsl:with-param name="BackupName">IRS1065ScheduleK1ForeignPartner
																</xsl:with-param>
															</xsl:call-template>
															Foreign partner 
														</label>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 23mm;border-top-width:0;">
										...
										<table style="font-size:7pt;margin-left:5.3mm;" cellpadding="0" cellspacing="0">
											<tbody>
												...
												<tr>
													<td width="3" style="width:2mm;border:1px black solid;border-top:0px;border-left:0;
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 30mm;border-bottom:1px solid black;">
										<!-- PART II Line L -->
                          ...
                          <span style="width:8px;"/>.
										...
										<span style="width: 3.5mm;"/>Did the partner contribute property with a built-in gain or loss?
                                                                  <span style="width:6mm;"/>
										<input type="checkbox" class="styCkbox">
										   <xsl:call-template name="PopulateYesCheckbox">
										      <xsl:with-param name="TargetNode" select="$FormData/PropContriWithBuiltInGainLoss"/>
									             <xsl:with-param name="BackupName">IRS1065ScheduleK1PropContriWithBuiltInGainLossYes</xsl:with-param>
									         </xsl:call-template>
										</input>
										<label>
										...
										<input type="checkbox" class="styCkbox">
										   <xsl:call-template name="PopulateNoCheckbox">
										      <xsl:with-param name="TargetNode" select="$FormData/PropContriWithBuiltInGainLoss"/>
									             <xsl:with-param name="BackupName">IRS1065ScheduleK1PropContriWithBuiltInGainLossNo</xsl:with-param>
									         </xsl:call-template>
										</input>
										<label>
						...
						<td width="93mm" style="width: 93mm;" valign="top">
							<table width="93mm" border="0" cellpadding="0" cellspacing="0" style="border-top: 2px solid black; border-bottom: 0px; border-left: 1px solid black; border-right: 2px solid black;">
								...
								<tr>
										...
										<table width="46.5mm" border="0" cellpadding="0" cellspacing="0" style="">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.4mm;">1</span>
														<span style="font-size: 6pt;height:3.4mm;width:40mm;">
															<span style="width:1mm"/>Ordinary business income (loss)</span>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.1mm;">2</span>
														<span style="font-size: 6pt;height:3.1mm;width:40mm;">
															<span style="width:1mm"/>Net rental real estate income (loss)</span>
														<span class="IRS1065ScheduleK1_codeBox" style="height:4mm;"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;
														  height:3.5mm">
															<span style="float:left;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.56mm;">3</span>
														<span style="font-size: 6pt;height:3.56mm;width:40mm;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.4mm">4</span>
														<span style="font-size: 7pt;height:3.4mm;width:40mm;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.7mm">5</span>
														<span style="font-size: 7pt;height:3.7mm;width:40mm;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.3mm">6a</span>
														<span style="font-size: 7pt;height:3.3mm;width:40mm;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:3.6mm">6b</span>
														<span style="font-size: 7pt;height:3.6mm;width:40mm;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:5mm;">
													<!-- Line 9a -->
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align: center;
														  height:4.6mm">9a</span>
														<span style="font-size: 6pt;height:4.6mm;width:40mm;">
															<span style="width:1mm"/>Net long-term capital gain (loss)</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox" style="height:5mm;"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align: right;
														  height:4.6mm">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode"
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4.4mm;">
													...
													<div style="width: 46.5mm;">
														<span class="IRS1065ScheduleK1_itemLabel" style="text-align:center;
														  height:3.5mm;">9c</span>
														<span style="font-size: 6pt;height:3.5mm;width:40mm;">
															<span style="width:1mm"/>Unrecaptured section 1250 gain</span>
														<br/>
														<span class="IRS1065ScheduleK1_codeBox" style="height:4.4mm;"/>
														<span class="IRS1065ScheduleK1_amountBox" style="text-align:right;
														  height:3.5mm;">
															<span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
											...
											<tr>
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" style="height:4mm;">
											    <div style="width:46.5mm;">
												  <span class="IRS1065ScheduleK1_itemLabel" 
												  ...
												  <xsl:if test="count($FormData/Section179ExpenseDeduction) = 0 ">
  												    <span class="IRS1065ScheduleK1_codeBox" style="border-bottom:0px;
													  margin-top:0mm;"/>
													<span class="IRS1065ScheduleK1_amountBox" style="border-bottom:0px;
													  margin-top:0mm;"/>
												  </xsl:if>
												  <!-- Display all rows: If the print parameter is not set to be Separated, OR -->
												  <!-- If the print parameter is separated, but there are fewer elements 
                                                          than the container height (1) -->
												  <xsl:if test="($Print != $Separated) or 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:if test="count($FormData/CreditsAndCreditRecapture/Item) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.4mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.4mm;
														  float:left;border-top:0px solid;width:41.40mm;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
													  </tr>
													...
													<xsl:for-each select="$FormData/CreditsAndCreditRecapture/Item">
													  <xsl:if test="($Print != $Separated) or 
													    ...
													    <xsl:choose>
														  ...
														  <xsl:otherwise>
														    <tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:7.3mm;
															    float:left;border-top:1px solid black;font-size:7pt;" 
															    valign="bottom">
																<xsl:call-template name="PopulateText">
																  <xsl:with-param name="TargetNode" select="Code"/>
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:7.3mm;
															    float:left;border-top:1px solid black;width:41.40mm;
															    font-size:7pt;" valign="bottom">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" select="Amount"/>
											    ...
											    <table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:if test="count($FormData/OtherInformation/Item) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:5mm;float:left;
														  border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:5mm;
														  float:left;border-top:0px solid;width:41.40mm;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
													  </tr>
								    ...
								    <tr>
									  <td colspan="2" style="height:100%;height:45.2mm;border-bottom:1px solid black;">
										<!-- IRS Use Only box -->
					...
					<tr>
					  <td width="187mm" colspan="2" style="width: 187mm; font-family: Verdana; font-size: 6pt; 
						...
						<span style="width: 40mm;">Schedule K-1 (Form 1065) 2011</span>
					  </td>
					</tr>
				</table>

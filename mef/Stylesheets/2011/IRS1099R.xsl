				...
				<form name="Form1099R">
					...
					<div style="width:187mm;height:23mm;">
						...
						<div style="width:98mm;float:left;">
							...
							<span class="styIRS1099RleftBox" style="height:13.85mm;width:98.05mm;border-top:1px solid black;
                                 font-size:6.5pt">
							...
							<span class="styIRS1099RleftBoxWithBottom" style="height:9.2mm;width:98mm;font-size:6.5pt;border-top:1px solid black;">

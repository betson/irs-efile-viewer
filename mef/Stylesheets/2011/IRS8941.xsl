            ...
            Form<span class="styFormNumber">8941</span>
              ...
              Department of the Treasury<br/>Internal Revenue Service 
						...
						<div class="styFTBox" style="width:125mm;text-align:left;">
							<div class="styMainTitle" style="padding-top:2mm;text-align:center;">Credit for Small Employer Health Insurance Premiums</div>
							<div class="styFBT" style="margin-top:3mm;padding-left:1.7mm;width:125mm;font-size:6.5pt;padding-top:3mm;">
								<img src="{$ImagePath}/8941_Bullet.gif" alt="Bullet Image"/>Information about Form 8941 and its instructions is available at <i>www.irs.gov/form8941.</i>
							</div>
 ...
 <xsl:with-param name="TargetNode" select="$Form8941Data/BusinessName/BusinessNameLine2"/>
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Premiums you paid during the tax year for employees included on line 1 for health insurance coverage under a qualifying arrangement (see instructions)
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
        ...
        <!--Dotted Line-->
						...
						<div class="styLNRightNumBox" style="height:4mm;width:6mm;border-right-width:0px">17
                            </div>
						<div class="styLNAmountBox" style="height:4mm;width:36.5mm;border-left-width:1px;">
							<xsl:call-template name="PopulateAmount">
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Enter the amount you paid in 2011 for taxes considered payroll taxes for purposes of this credit (see <br/>instructions) 
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.

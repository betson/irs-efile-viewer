...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
          ...
          border-right-width:0px;border-left-width:0px;float:left;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="font-size:7pt;width:135mm;height:4mm;padding-bottom:0mm;">
								<span style="float:left">Enter your 2011 tax after credits from Form 1040, line 55 (see instructions if not filing Form 1040)</span>
 ...
 child tax credit, American opportunity credit (Form 8863, line 14), first-time homebuyer credit, 
						...
						<div style="width:187mm;height:9mm">
							<div class="styLNLeftNumBox" style="font-size:7pt;height:3mm;padding-bottom:0mm;padding-left: 2.25mm"/>
							<div class="styLNDesc" style="font-size:7pt;width:135mm;height:3mm;padding-bottom:0mm;">
								<span style="float:left">(Form 5405, line 10) credit for federal tax paid on fuels, adoption credit, refundable credit for prior year minimum tax (Form 8801, line 27), health coverage tax credit, and credit determined under section 1341(a)(5)(B)(see instructions)
							...
							<div class="styLNRightNumBox" style="height:7mm;padding-top:12px;padding-bottom:0mm; border-bottom-width:1px;">3</div>
							<div class="styLNAmountBox" style="width:36mm;height:7mm;padding-bottom:0mm;border-bottom-width:1px;padding-top:12px">
       ...
       Current year tax. Combine lines 1, 2, and 3. If less than $1,000, <b>stop</b>; you do not owe a penalty.
		...
		<div class="styLNRightNumBox" style="height:4mm;padding-bottom:0mm;bottom-border-width:1px;">9</div>
						...
						<!-- Creating the base ID for OwePenaltyInd -->
						<xsl:variable name="OwePenaltyIndID">
							...
							<div class="styLNLeftNumBox" style="font-size:7pt;height:4mm;padding-bottom:0mm;padding-left: 2.25mm"/>
							 <input type="checkbox"  alt="alt" class="styCkbox"  name="Checkbox">
								...
								<xsl:attribute name="id">
									<xsl:choose>
										<xsl:when test="OwePenaltyIndID != ''">
											<xsl:value-of select="concat($OwePenaltyIndID, '[1]')"/>
										</xsl:when>
										<xsl:otherwise>IRS2210OwePenaltyNoInd</xsl:otherwise>
									</xsl:choose>
								</xsl:attribute>
							</input>
							<label>
						...
						<div style="width:187mm;">
							...
							<input type="checkbox" alt="alt" class="styCkbox">
								...
								<xsl:attribute name="id">
									<xsl:choose>
										<xsl:when test="OwePenaltyIndID != ''">
											<xsl:value-of select="concat($OwePenaltyIndID, '[2]')"/>
										</xsl:when>
										<xsl:otherwise>IRS2210OwePenaltyYesInd</xsl:otherwise>
									</xsl:choose>
								</xsl:attribute>
							</input>
							<span style="width:4px;"/>
          ...
          border-right-width:0px;border-left-width:0px;">
						...
						<div style="width:187mm;padding-top:0mm;height:8mm;">
							...
							<label>
								...
								You filed or are filing a joint return for either 2010 or 2011, but not for both years, and line 8 above is smaller than<br/>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">2210</span> (2011)
                           </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:0mm;">
						<div style="float:left;">Form 2210 (2011)<span style="width:148mm;"/>
						</div>
...
<div class="styBB" style="width:187mm;height:0mm;border-style:solid; border-bottom-width:1px;border-top-width:0px;
          ...
          border-right-width:0px;border-left-width:0px;float:left;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNAmountBox" style="width:36mm;height:5mm;padding-bottom:0mm;padding-top:1.5mm; border-buttom-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2210Data/WithholdingTaxesAmt"/>
								</xsl:call-template>
							</div>
...
<div class="styLNLeftNumBox" style="font-size:7pt;height:5mm;padding-bottom:0mm;padding-left: 2.25mm">16
	...
	<div class="styLNDesc" style="font-size:7pt;width:135mm;height:5mm;padding-bottom:0mm;">
				<img src="{$ImagePath}/2210_Bullet_Round.gif" alt="RoundBullet"/>
                If the amount on line 14 was paid <b>on or after </b>4/15/12 enter -0-.
                            </div>
	<div class="styLNRightNumBox" style="height:5mm;padding-bottom:0mm; background-color:lightgrey; border-bottom-width:0px; border-right-width:1px;width:8.2mm;"/>
		...
		<div style="width:187mm;">
							...
							<div class="styLNDesc" style="font-size:7pt;width:135mm;height:4mm;padding-bottom:0mm;">
								<img src="{$ImagePath}/2210_Bullet_Round.gif" alt="RoundBullet"/>
                If the amount on line 14 was paid <b>before</b> 4/15/12, make the following computation to find the <br/>amount to enter on line 16.          
                            </div>
						...
						<div style="width:187mm;font-size:7pt;">
							<div class="styLNDesc" style="width:143mm;text-align:top;height:3mm; ">
								<span style="float:left">
                                    ...
                                    <span style="width:7mm;height:2mm;"/>before 4/15/12
                                    <span style="width:7mm;"/>X
                                    <span style="width:5mm;height:2mm;"/>.XXXXX
                                </span>                        
								<span class="styIRS2210DotLn">............</span>								
							</div>							
							<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:1px; border-right-width:1px;width:8.2mm;padding-bottom:0;padding-top:1.5mm">16
                            </div>
...
<!-- Line 17 -->
	<div style="width:187mm;">
      ...
      Form 
                            <span class="styBoldText" style="font-size:8pt;">2210</span> (2011)
                        </div>
					</div>
					<!-- END Page Break and Footer-->
					<!--Begin Page 3 -->
	...
	<div style="width:187mm;">
		...
		<div style="width:187mm;padding-top:0mm;padding-bottom:0mm;height:4mm; ">
					...
					<div class="styBB" style="width:187mm;padding-top:0mm;padding-bottom:0mm; height:4.5mm;">
						...
						<span class="styLNDesc" style="font-size:7pt; width:25mm; height:4.5mm;text-align:center; border-style: solid; border-color:black; border-top-width:0px; border-bottom-width:0px; border-left-width:0px; border-right-width:1px;padding-top:0mm; ">4/15/11
                        </span>
						<span class="styLNDesc" style="font-size:7pt; width:25mm; height:4.5mm;text-align:center;  border-style: solid; border-color:black; border-top-width:0px; border-bottom-width:0px; border-left-width:0px; border-right-width:1px;padding-top:0mm; ">6/15/11
                        </span>
						<span class="styLNDesc" style="font-size:7pt; width:25mm; height:4.5mm; text-align:center; border-style: solid; border-color:black; border-top-width:0px; border-bottom-width:0px; border-left-width:0px; border-right-width:1px; padding-top:0mm;">9/15/11
                        </span>
						<span class="styLNDesc" style="font-size:7pt; width:25mm; height:4.5mm; text-align:center;padding-top:0mm;">1/15/12
                        </span>
					</div>
 ...
 Enter the amount, if any, from line 26 in the previous<br/>
						...
						<span class="styLNDesc" style="font-size:6pt; width:25mm; height:14mm; text-align:right; border-style: solid; border-color:black;border-top-width:0px;border-left-width:0px; border-right-width:0px; border-bottom-width:1px; padding-bottom:0;padding-top:10mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;padding-top:0mm;">
						...
						<span class="styLNDesc" style="font-size:6pt; width:25mm; height:5mm; border-style: solid; border-color:black; border-top-width:0px;border-left-width:0px; border-right-width:0px; border-bottom-width:1px; text-align:right; padding-bottom:0;padding-top:1.5mm;">
							<xsl:call-template name="PopulateAmount">
      ...
      <span style="float:left">column</span>
						...
						<span class="styLNDesc" style="font-size:6pt; width:25mm; height:7.5mm; border-style: solid;text-align:right; border-color:black; border-top-width:0px;border-left-width:0px; border-right-width:0px; border-bottom-width:1px; padding-bottom:0;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
...
<!--Line 30-->
 ...
 line 77; Form 1040A, line 49; Form 1040NR,<br/> line 73; Form 1040NR-EZ, line 26; or Form 1041, 
      ...
      Form 
        ...
        Instead, use the following: 2/28/11, 4/30/11, 7/31/11, and 11/30/11.
                        </div>
...
<div class="styLNDesc" style="font-size:7pt; width:69mm; border-right-width:1px;height:17mm;float:left;clear:none">In each column, enter the full amount of your standard deduction
	...
	<div class="styLNDesc" style="font-size:7pt; width:69mm; border-right-width:1px;height:14mm;">In each column, multiply $3,700 by the total number of exemptions

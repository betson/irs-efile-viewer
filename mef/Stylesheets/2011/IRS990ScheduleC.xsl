...
Complete if the organization is described below.</span>
		...
		Section 501(c)(3) organizations: Complete Parts I-A and B. Do not complete Part I-C.<br/>
		 ...
		 Section 501(c)(3) organizations that have NOT filed Form 5768 (election under section 501(h)): Complete Part II-B. Do not complete Part II-A.<br/>
						<span style="font-weight:bold;">If the organization answered “Yes” to Form 990, Part IV, Line 5 (Proxy Tax) or Form 990-EZ, line 35c (Proxy Tax), then</span>
						<br/>
						<img src="{$ImagePath}/990SchC_Bullet_Round.gif" alt="Round Bullet"/>
...
political action committee (PAC). If additional space is needed, provide information in Part IV.   </div>
            ...
            Cat. No. 50084S
						...
						<div style="width:50mm;text-align:right;float:left;">
							<span style="font-weight:bold;font-size:6pt">Schedule C (Form 990 or 990-EZ) 2011</span>
						</div>
					</div>
					<br/>
					<!--END Page Footer-->
					...
					<div class="styBB" style="width:187mm; float: none; clear:none">
						<div style="float:left">Schedule C (Form 990 or 990-EZ) 2011</div>
...
<span class="IRS990ScheduleC_Dotspacing"> ......................................</span>
        ...
        Calendar year (or fiscal year<br/> beginning in)
								...
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(a) </span>2008</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(b) </span>2009</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(c) </span>2010</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(d) </span>2011</th>
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule C (Form 990 or 990-EZ) 2011</span>
						</div>
					</div>
					<br/>
					<br/>
...
Complete this part to provide the descriptions required for Part l-A, line 1; Part l-B, line 4; Part l-C, Part II-A; line 5; and Part ll-B, line 1.<br/>Also, complete this part for any additional information.
</div>
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							<span style="width:80px;"/>
							<span class="styBoldText"> Schedule C (Form 990 or 990EZ) 2011</span>
						</div>
					</div>
					<!--END Page Footer-->
					<br/>

      ...
      <body class="styBodyClass">
        <form name="Form1040ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
           ...
           <!--<div style="padding-left:7mm;font-size:6pt;width:30mm;font-weight:bold;" >Version A, Cycle 1</div>-->
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;">20<span style="color:green;">11</span>
              </div>
            ...
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                <th class="IRS1040ScheduleD_styTableCellNote" style="font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">Note:</span> Please round and use whole dollars on this form.
                </th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(e)</span> Sales price from <br/>Form(s) 8949, line 2 <br/>column (e)</th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(f)</span> Cost or other basis<br/>from Forms(s) 8949, <br/>line 2, column (f)</th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;border-right-width:0px;" scope="col">
                  <b>(h) Gain or (loss)</b>
                  <br/>Combine columns (e), <br/>(f), and (g)
                </th>
              </tr>
          ...
          <div class="styGenericDiv" id="LTCapGainTableContainer">
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="LTCapGainTable" id="LTCapGainTable">
              ...
              <tr>
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(e)</span> Sales price from <br/>Form(s) 8949, line 4 <br/>column (e)</th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(f)</span> Cost or other basis<br/>from Forms(s) 8949, <br/>line 4, column (f)</th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
			  ...
			  <div class="styLNDesc" style="width:138.8mm;">
				<span style="float:left;">
				  ...
				  <xsl:call-template name="LinkToLeftoverDataTableInline">
					  <xsl:with-param name="Desc">Form 8814 Literal Code</xsl:with-param>
					  <xsl:with-param name="TargetNode" select="$FormData/Form8814LiteralCd"/>
				  </xsl:call-template>
				  <span style="width:4px;"/>
				  <xsl:call-template name="LinkToLeftoverDataTableInline">
					  <xsl:with-param name="Desc">Form 8814 Amount</xsl:with-param>
          ...
          <div class="stySmallText" style="width:110mm;">
           <span class="styBoldText">For Paperwork Reduction Act Notice, see your tax return instructions.</span>
            ...
            <div class="stySmallText" style="width:45mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1040) 2011</span>       </div>
          </div>
          
        <!--Begin Page 2 -->
        <div class="styBB" style="width:187mm;border-bottom-width:1px;">
          <span style="width:65mm;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1040) 2011</span>
       ...
       <div class="styBB" style="width:187mm;border-bottom-width:0px;">
        ...
        <div class="styGenericDiv" style="width:187mm;">
          ...
          <div class="styLNRightNumBox" style="width:8.2mm;">18</div>
        ...
        <span style="font-weight:bold;padding-left:1mm;">Yes.</span>
			...
			<span style="padding-left:7mm;"/> the <b>Qualified Dividends and Capital Gain Tax Worksheet </b>
			  in the instructions for Form 1040,<br/>
		<span style="padding-left:7mm;"/> line 44 (or in the instructions for 
			Form 1040NR, line 42). <b>Do not</b>  complete lines 21 and 22 <br/>
			<span style="padding-left:7mm;"/> below.
          </div>
          <div class="styLNRightNumBox" style="width:8.2mm;background-color:lightgrey;border-bottom-width:0px;height:14mm;"/>
          <div class="styLNAmountBox" style="width:37mm;border-bottom-width:0px;height:14mm;"/>
        </div>
        ...
        <span style="font-weight:bold;padding-left:1mm;">No.</span>
           ...
           Complete Form 1040 through line 43, or Form 1040NR through line 41. Then complete the <br/>
			<span style="padding-left:7mm;"/>  <b>Schedule D Tax Worksheet</b> in the instructions. <b> Do not</b> complete lines 21 and 22 below.
          </div>
        ...
        <span style="font-weight:bold;padding-left:1mm;">Yes.</span>
          ...
          Complete Form 1040 through line 43, or Form 1040NR through line 41. Then complete <br/>
			<div style="padding-left:8mm;">the <b>Qualified Dividends and Capital Gain Tax Worksheet</b> in the Instructions for Form 1040, <br/>
			line 44 (or in the Instructions for Form 1040NR, line 42).</div>
          </div>
        ...
        <div class="styBB" style="width:187mm;border-top-width: 1px;border-bottom-width:0px;">
          <span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1040) 2011</span>
        </div>
        <!--  PART III HEADER -->
        <div class="pageEnd">
        </div>

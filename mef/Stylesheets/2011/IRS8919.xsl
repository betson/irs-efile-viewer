			...
			<body class="styBodyClass" style="margin-bottom:10px">
				<form name="Form8919">
					<xsl:call-template name="DocumentHeader"/>
						...
						<div class="styBB" style="width:187mm;">
							...
							<div class="styTYBox" style="width:32mm;border-left:none;">
								...
								<div class="styTaxYear">20<span class="styTYColor">11</span></div>
								<div style="margin-left:3mm; text-align:left;">
									Attachment<br/>Sequence No. <span class="styBoldText">72</span>
								</div>
							</div>
						</div>					
						...
						<div class="styBB" style="width:187mm;">
							...
							Name of person who must file this form. If married, complete a separate Form 8919 for each spouse who must file this return.<br/>
								<div style="font-family:verdana;font-size:7pt;">
									<xsl:call-template name="PopulateText">
									  <xsl:with-param name="TargetNode" select="$Form8919Data/PersonName"/>
									</xsl:call-template>
								</div>
							</div>
							<div class="styEINBox" style="width:41mm;height:8mm;padding-left:2mm;font-size:7pt;">
								Social security number<br/>
								<span style="font-weight:normal;text-align:center;width:34mm;">
						...
						<div class="styBB" style="width:187mm;">
							<div class="styWhoMustFileBox" style="width:187mm;height:8mm;font-size:8pt;padding-top:2mm;">
								<b>Who Must File.</b><span style="width:5mm;"></span>
									...
									<li style="margin-left:30mm;">Your pay from the firm was not for services as an independent contractor.</li>
									<li style="margin-left:30mm;">One or more of the reasons listed below under <i>Reason codes</i> apply to you.</li>
									</span>
							</div>
						</div>
						...
						<div class="styBB" style="width:187mm;border-bottom:none;">
							<div class="styReasonCodeBox" style="width:187mm;height:8mm;font-size:8pt;">
								<b>Reason codes:  </b><span style="font-size:7pt;">
										For each firm listed below, enter in column (c) the applicable reason code(s) for filing this form. If none of the</span><br/>
										...
										<span style="margin-left:26mm;font-size:7pt;">code G, and file Form SS-8 on or before the date you file your tax return.</span>
										<br/><br/>
							</div>
							<div class="styCodes" style="width:187mm; height:8mm;font-size:7.5pt;margin-left:20mm;">
								<b>A</b><span style="width:2mm;"></span>
								I filed Form SS-8 and received a determination letter stating that I am an employee of this firm.	
								<br/><br/>
								<b>B</b><span style="width:2mm;"></span>
								I was designated as a "section 530 employee" by my employer or by the IRS prior to January 1, 1997.	
								<br/><br/>
								<b>C</b><span style="width:2mm;"></span>
								I received other correspondence from the IRS that states I am an employee.	
								<br/><br/>
								<b>D</b><span style="width:2mm;"></span>
								I was previously treated as an employee by this firm and am performng services in a substantially similar capacity<br/> 
								<span style="margin-left:5mm;">
								and under substantially similar direction and control. (You must also enter reason code G.)</span>
								<br/><br/>
								<b>E</b><span style="width:2mm;"></span>
								My co-workers, performing substantially similar services under substanitally similar direction and control, are treated<br/>
								<span style="margin-left:5mm;">as employees. (You must also enter reason code G.)</span>
								<br/><br/>
								<b>F</b><span style="width:2mm;"></span>
								My co-workers, performing substantially similar services under substanitally similar direction and control, filed Form<br/>
								<span style="margin-left:5mm;">
								SS-8 for this firm and received a determination that they were employees. (You must also enter reason code G.)</span>
								<br/><br/>
								<b>G</b><span style="width:2mm;"></span>
								I filed Form SS-8 with the IRS and have not received a reply.	
								<br/><br/>
								<b>H</b><span style="width:2mm;"></span>
								I received a Form W-2 and a Form 1099-MISC from this firm. The amount on Form 1099-MISC should have<br/>
								<span style="margin-left:5mm;">
								been included as wages on Form W-2.</span>
								<br/>
							</div>
						</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:100.75mm;float:left;height:5mm;padding-top:1mm;">
								<div style="float:left;">Maximum amount of wages subject to social security tax</div>
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">....</span>
								<span style="width:5px;"/>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:100.75mm;float:left;height:14mm;padding-top:1mm;">
								<div style="float:left;">Total social security wages and tips (total of boxes 3 and 7 on<br/>
										Form(s) W-2) or railroad retirement (tier 1) compensation, and<br/>
										unreported tips subject to social security tax from Form 4137,<br/>
										line 10
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">..................</span>
								<span style="width:5px;"/>
							...
							<div style="float:left;width:7.05mm;height:14mm;padding-top:10mm;background-color:lightgrey;border-left:1px solid black;border-right:1px solid black;"/>
						</div>
						
						<!-- Line 9 -->
						<div style="width:187mm;">
							<div class="styLNLeftNumBoxSD" style="height:6.3mm;padding-top:1mm">9</div>
							<div class="styLNDesc" style="width:139.60mm;height:6.3mm;float:left;padding-top:1mm;">
								<div style="float:left;">Subtract line 8 from 7. If line 8 is more than line 7, enter -0- here and on line 10
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">.......</span>
								<span style="width:5px;"/>
								</div>
							</div>									
							<div class="styLNRightNumBox" style="width:7mm;height:6.45mm;border-bottom-width: 1px;padding-top:3mm">9</div>
							<div class="styLNAmountBox" style="height:6.3mm;width:32mm;font-size:7pt;border-bottom-width:1px;padding-top:3mm">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:4mm;float:left;padding-top:1mm;">
								<div style="float:left;">Wages subject to social security tax. Enter the smaller of line 6 or line 9
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">.........</span>
								<span style="width:5px;"/>
								</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:4mm;float:left;padding-top:1mm;">
								<div style="float:left;">Multiply line 10 by .042 (social secuity tax rate)
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">................</span>
								</div>
							</div>									
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:4mm;float:left;padding-top:1mm;">
								<div style="float:left;">Multiply line 6 by .0145 (Medicare tax rate)
								<!--Dotted Line-->
								<span style="margin-left:3mm;letter-spacing:3.5mm;font-weight:bold;">..................</span>
								<span style="width:5px;"/>
								</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:4mm;float:left;padding-top:1mm;">
								<div style="float:left;">Add lines 11 and 12. Enter here and on Form 1040, line 57; Form 1040NR, line 55; or<br/>
					...
					<div style="float:left;">
								  <span class="styBoldText">For Paperwork Reduction Act Notice, see your return instructions.</span>
								  <span style="width:13mm;"/>                        
									Cat. No. 37730B
								</div>
								<div style="float:right;">
								  <span style="width:40px;"/>  
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2011)
								</div>						
					</div>
	...
	<xsl:template name="CreateTableHeaders">
		<tr>
			...
			<th scope="col" class="styTableCell" style="width:20mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;">
				<b>(c)</b>Enter<br/>reason<br/>code(s) from<br/>above
			</th>
			<th scope="col" class="styTableCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;">
				<b>(d)</b>Date IRS<br/>determination or<br/>correspondence<br/><label for="receivedInd">was received</label>
			...
			<th scope="col" class="styTableCell" 
				style="width:40mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
				...
				<tr>
					...
					<td class="styTableCell">
						...
						<xsl:if test="EmployerName">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="EmployerName/BusinessNameLine1"/>
							</xsl:call-template>
							<xsl:if test="EmployerName/BusinessNameLine2">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="EmployerName/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
					...
					<td class="styTableCell">	
						...
						<input class="styCkbox" title="receivedInd" id="receivedInd" type="checkbox" alt="Checkbox">
	...
	<xsl:template name="CreateEmptyTableRows">
		...
		<tr style="font-size: 7pt;">
			...
			<td class="styTableCell" style="width:5%;font-size: 7pt; text-align:center;">
				<!--<input class="styCkbox" type="checkbox" style="width:4mm;"/>--><span style="width:4px"/>
			</td>
			<!--Amount-->

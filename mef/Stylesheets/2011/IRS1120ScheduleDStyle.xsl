...
.IRS1120ScheduleD_styTableHdr {   /* Table Header */
  font-size: 6pt;
  text-align: center;
  border-style: solid; border-color: black;
...
.IRS1120ScheduleD_styTableContainer {   /* Scrollable Table Container */
  width: 707px;
...
.IRS1120ScheduleD_styTableCellA {   /* Table Cell (a) */
  width: 160px;   /* 220px; */
  color: black;
  border-style: solid;
...
.IRS1120ScheduleD_styTableCellB {   /* Table Cell (b) */
...
.IRS1120ScheduleD_styTableCellC {   /* Table Cell (c) */
...
.IRS1120ScheduleD_styTableCellD {   /* Table Cell (d) */
  width: 110px;   /* 91px; */
  color: black;
  text-align: right;
  border-style: solid;
...
.IRS1120ScheduleD_styTableCellE {   /* Table Cell (e) */
  width: 126px;   /* 91px; */
  color: black;
  text-align: right;
  border-style: solid;
...
.IRS1120ScheduleD_styTableCellF {   /* Table Cell (f) */
  /*width: 126px;   /* 109px; */
  color: black;
  text-align: right;
  border-style: solid;
...
.IRS1120ScheduleD_styTableLastCol {   /* Last Table Column */
  width: 15px;
  color: white;
  text-align: right;
  border-style: solid;

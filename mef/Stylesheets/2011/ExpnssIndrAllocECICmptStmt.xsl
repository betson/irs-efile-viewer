...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ExpnssIndrAllocECICmptStmt" />
  ...
  <xsl:template name="ExpnssIndrAllocECICmptStmtTemp">

  <table id="GeneralDependencyTbl" class="styDepTbl">
    <tr class="styDepTblHdr">
      <th class="styDepTblCell" style="width:187mm;text-align:center;" scope="col">Computation</th>
    </tr>
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="ExpnssIndrAllocECICmptStmtTemp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

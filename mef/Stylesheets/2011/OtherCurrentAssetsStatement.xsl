...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherCurrentAssetsStatement" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="OCASTbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      ...
      <body class="styBodyClass">    
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:100mm">
            <!--TY 2003 Other Current Assets Statement-->
            <xsl:value-of select="$depDocTitle" />
          </div>
        </div>        

      ...
      <body class="styBodyClass">
        <form name="Form2555EZ">
			  ...
			  <div style="float:left;clear:none;width:30mm;height:20mm;font-size:9pt;text-align:center;padding-top:4mm">
			   ...
			   <div style="float:left;clear:none;width:60mm;height:20mm;">
				   <div style="width:60mm;">
					...
					<div style="width:60mm;padding-top:1px">
						<div style="float:left;clear:none;width:3mm;"><li/></div><div style="width:50mm;float:left;clear:none;">Had total foreign earned income of $92,900 or less.</div>
					</div>
          ...
          <div style="width:187mm;margin-top:1mm;height:5mm">
            ...
            <div style="float:left;width:156mm;height:8mm;padding-right:1mm;">
              ...
              <div style="width:100mm;float:left;">
                ...
                2011 <b>or</b><br/>
                any other period of 12 months in a row starting or ending in 2011?
              </div>
          ...
          <div style="width:187mm;margin-top:1mm;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;">a</div>
            <div style="float:left;width:176mm;">
              List your tax home(s) during 2011 and date(s) established.<img src="{$ImagePath}/2106EZ_Bullet.gif" width="9" height="9" alt="Bullet" style="margin:0mm 1mm;"/>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:right;">  
              ...
              Form <span class="styBoldText" style="font-size:8pt;">2555-EZ</span> (2011)
            </div>
          </div>
          <!-- Page 2 Header -->
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 2555-EZ (2011)</div>
          ...
          <div style="width:187mm;padding:1mm 0mm;">
            ...
            <div class="styPartDesc">Days Present in the United States - <span style="font-weight:normal;">Complete this part if you were in the United States or its possessions during 2011.</span></div>
          </div>
          <!-- END PART III TITLE -->
          <!-- Line 12 -->
          ...
          <div class="styTableContainer" id="line12divctr">
            ...
            <table style="border-collapse:collapse;font-size:7pt;">
              <thead style="vertical-align:top;">
                <tr>
                <th style="border:1px solid black;border-left:none;font-weight:normal;width:46mm;"><b style="margin-left:3mm;">12</b> <b style="margin-left:5mm;">(a)</b> Date arrived in U.S.</th>
                <th style="border:1px solid black;font-weight:normal;width:46mm;"><b>(b)</b> Date left U.S.</th>
                <th style="border:1px solid black;font-weight:normal;width:46mm;"><b>(c)</b> Number of days in U.S. on business</th>
                <th style="border:1px solid black;border-right:none;font-weight:normal;width:49mm;"><b>(d)</b> Income earned in U.S. on business (attach computation)</th>
                </tr>
              </thead>
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:4.5mm;width:42mm;border-bottom:1px solid black;">$92,900</div>
            </div>
          </div>
          <!-- Line 14 -->
          <div style="width:187mm;">
            ...
            <div style="float:left;height:9mm;width:101mm;">
              ...
              <div class="styLNDesc" style="width:100mm;">
                Enter the number of days in your qualifying period that fall within 2011<span style="letter-spacing:3mm;font-weight:bold;">..</span>
              </div>
            </div>
            <div style="float:left;">
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:126mm;">
              Enter, in U.S. dollars, the total foreign earned income you earned and received in 2011 (see instructions). Be sure to include this amount on Form 1040, line 7
              <span style="font-weight:bold;letter-spacing:3mm;">...........</span>
            </div>
            <div style="float:left;">
              <div style="height:4.5mm;width:8mm;border-left:1px solid black;"/>

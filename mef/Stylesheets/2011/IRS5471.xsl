...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html>
			...
			<body class="styBodyClass">
                ...
                <span class="styFormNumber">5471</span>
							...
							<div class="styAgency">(Rev. December 2011)</div>
						...
						<span class="styNormalText" style="padding-top: 2mm; text-align: left; width: 70mm;padding-left:5mm;">
							<span style="font-weight:normal;">
								...
								<xsl:choose>
									...
									<xsl:when test="$IRS5471Data/MissingEINReason != ''">
										<xsl:call-template name="PopulateText">
							...
							<span style="font-family: verdana, arial, sans-serif;font-size: 7pt; font-weight: normal;">
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/ForeignAddress/City"/>
										</xsl:call-template>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/ForeignAddress/ProvinceOrState"/>
										</xsl:call-template>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/ForeignAddress/PostalCode"/>
										</xsl:call-template>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/ForeignAddress/Country"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
							</span>
    ...
    <span class="styFixedUnderline" style="width:12mm;float:none;">
        ...
        <span style="width: 20mm; ">
					...
					<table class="styTable" cellspacing="0" style="width:187mm;font-size:7pt;">
						...
						<tr>
							<td class="styTableCell" valign="top" style="width: 59.5mm;height: 9.5mm;border-color:black;border-right-width: 0px">
								<span style="width:59.5mm;text-align:left;padding-left:1mm;">
									<b>b(2)</b>
									<span style="padding-left:1mm;">Reference ID number (see inst)
                </span>
								</span>
								<br/>
								<br/>
						...
						<tr>
							<td class="styTableCell" valign="top" style="border-color:black;border-bottom-width: 0px;
							width:59.5mm; height: 9.5mm;border-right-width: 0px">
								<span style="width:59.5mm;text-align:left;padding-left:1mm;">
									<b>c</b>
					...
					<table class="styTable" cellspacing="0" style="width:187mm;border-top:1px solid black;font-size: 7pt">
						<tr>
							<td class="styTableCell" valign="top" style="width: 32mm; height: 10mm; border-color: black;
							...
							<td class="styTableCell" valign="top" style="width: 30mm; height: 10mm; border-color: black;
					...
					<table class="styTable" cellspacing="0" style="width:187mm;font-size:7pt;">
						<tr>
							<th scope="col" class="styTableCellHeader " style="border-color:black;height: 2mm;
							 border-bottom-width: 0px; margin-left: .25mm; width: 102mm" valign="top">
                  ...
                  a<span style="width: 1mm"/>
							...
							<th scope="col" class="styTableCellHeader " style="border-color: black;height: 2mm;
							 width: 70mm;border-right-width: 0px" colspan="2">
                  ...
                  b<span style="width: 1mm"/>
						...
						<tr>
							<td class="styLNAmountBoxNBB" style="text-align: left; border-left-width: 0px;
							border-right-width: 1px; width: 102mm;" valign="top" rowspan="2">
								<xsl:choose>
								...
								<xsl:if test="$IRS5471Data/BranchOfficeInTheUS/AddressInForeign != ''">
									<xsl:call-template name="PopulateForeignAddressTemplate">
										...
										<br/>
								<xsl:choose>
									<xsl:when test="$IRS5471Data/SSNOfAgentInTheUS != ''">
										<xsl:call-template name="PopulateSSN">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/SSNOfAgentInTheUS"/>
										</xsl:call-template>
									</xsl:when>
							...
							<th scope="col" class="styTableCellHeader " style="font-weight: normal; border-color: black;
							 border-right-width: 0px; width: 70mm">
								<i>(ii)</i>
					...
					<table class="styTable" cellspacing="0" style="width:187mm; font-size: 7pt">
						<tr>
							<td class="styTableCell" valign="top" style="width: 102mm; height: 25mm; text-align: left; border-color: black; border-right-width: 0px; border-bottom-width: 0px; border-top-width: 1px">
								<span style="width:102mm;padding-left:1.5mm;text-align:left;">
									<b>c</b>
									<span style="width: 1mm"/>Name and address of foreign corporation's statutory or resident agent in 
							...
							<td class="styTableCell" valign="top" style="width: 97mm; border-color:black; border-left-width: 1px; border-top-width: 1px; height: 25mm;text-align:left; border-right-width: 0px; border-bottom-width: 0px">
								<span style="text-align:left;padding-left:1.5mm;">
									<b>d</b>
									<span style="width:  1mm"/>Name and address (including corporate department, if 
									<span style="width: 83mm;padding-left:4mm;">applicable) of person (or persons) with custody of the books </span>
									<span style="width: 4mm"/>and records of the foreign corporation, and the location of 
									<span style="width:83mm;padding-left:4mm;">such books and records, if different </span>
								</span>
								<br/>
								<!--				Name and Address Type – Choice of Business Name versus Personal + US versus Foreign Address.    -->
								<!--Choice of Business Name versus Name -->
								<xsl:choose>
									<xsl:when test="$IRS5471Data/PersonWithRecordsCustody/BusinessName/BusinessNameLine1 !=''">
										<xsl:call-template name="PopulateText">
									...
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonWithRecordsCustody/PersonName"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
								<br/>
								<!-- Choice of US and Foreign Address block-->
								<xsl:choose>
									<xsl:when test="$IRS5471Data/PersonWithRecordsCustody/AddressInUS">
										<xsl:call-template name="PopulateUSAddressTemplate">
								...
								<br/>
								<xsl:choose>
									<xsl:when test="$IRS5471Data/PersonWithRecordsCustody/LocationAddressInUS">
										<xsl:call-template name="PopulateUSAddressTemplate">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonWithRecordsCustody/LocationAddressInUS"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateForeignAddressTemplate">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonWithRecordsCustody/LocationAddressInForeign"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
    ...
    Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 12-2011)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 5471 (Rev. 12-2011)</div>
						<div style="float:right">
    Page <span class="styBoldText" style="font-size: 8pt">2</span>
					...
					<div class="styIRS5471TableContainer" name="FSctn" id="FSctn">
						...
						<table class="styTable" cellspacing="0" name="FSTable" id="FSTable">
							<thead class="styTableThead">
								<tr>
									<th scope="col" class="styTableCell" style="border-color: black; width: 60mm; text-align: center;">
    					(a)<span class="styNormalText"> Name, address, and identifying number of shareholder</span>
									</th>
									<th scope="col" class="styTableCell" style="border-color: black; width: 60mm; text-align:left;">
                    (b)<span class="styNormalText"> Description of each class of stock held by shareholder <b>Note:</b>
									...
									<th scope="col" class="styTableCell" style="border-color: black; width: 20mm; text-align: center">
                    (c)<span class="styNormalText"> Number of shares held at beginning of annual accounting period</span>
									</th>
									<th scope="col" class="styTableCell" style="border-color: black; width: 20mm; text-align: center; border-right-width: 1px">
                    (d)<span class="styNormalText"> Number of shares held at end of annual accounting period</span>
									</th>
									<th scope="col" class="styTableCell" style="border-color: black; width: 20mm; text-align: center; border-right-width: 0px">
					...
					<table class="styTable" style="width:187mm;font-size: 7pt" cellspacing="0">
						<thead>
							...
							<tr scope="col">
								<th scope="col" colspan="2" class="styBoldText" style="width: 6mm; border-style: solid; border-color: black;  border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 1px; padding-bottom:10mm;vertical-align:top; font-size: 8pt">Important:</th>
               ...
               rules for DASTM corporations.
						...
						<tbody valign="top">
							...
							<tr>
								...
								<td class="styLNDesc" style="width: 99mm">
                  ...
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" select="$IRS5471CData/USOtherIncome"/>
							...
							<tr>
								...
								<td class="styLNDesc" style="border-color: black; border-style:solid; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; width: 99mm; border-bottom-width: 1px">
									<span style="float:left">
...
Other deductions (attach schedule&#151;exclude provision for income,
 <span style="float:left">war profits, and excess profits taxes)
</span>
									<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
								</td>
...
Total deductions (add lines 10 through 16)
							...
							<tr>
								...
								<td class="styLNDesc" style="width: 99mm">
									<span style="float:left">
profits taxes (subtract line 17 from line 9)
</span>
									<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
								</td>
							...
							<tr>
								...
								<td class="styLNDesc" style="width: 99mm">Extraordinary items and prior period adjustments (see
								<span style="float:left">
								 instructions)
								</span>
									<span class="styDotLn" style="float:right;padding-right:1mm;">..................</span>
								...
								<td class="styLNAmountBox" colspan="2" style="width: 38mm;padding-top:4mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$IRS5471CData/ForeignExtraordinaryItems"/>
										<xsl:with-param name="MaxSize" select="17"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBox" colspan="2" style="width: 34mm;padding-top:4mm;">
									<xsl:call-template name="PopulateAmount">
...
<span style="float:left">instructions)
								...
								<td class="styLNAmountBox" colspan="2" style="padding-top: 4mm;width:38mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$IRS5471CData/ForeignProvisionForIncome"/>
										<xsl:with-param name="MaxSize" select="17"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBox" colspan="2" style="padding-top:4mm;width:34mm">
									<xsl:call-template name="PopulateAmount">
...
through 20)
								...
								<td class="styLNAmountBox" colspan="2" style="padding-top:4mm; width: 38mm;border-bottom-width: 0px">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$IRS5471CData/FrgnCurrentYrNetIncomePerBooks"/>
										<xsl:with-param name="MaxSize" select="17"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBox" colspan="2" style="padding-top:4mm; border-bottom-width: 0px; width: 34mm">
									<xsl:call-template name="PopulateAmount">
    ...
    Page <span class="styBoldText" style="font-size: 8pt">3</span>
              ...
              <span style="font-size: 7pt; width: 43mm; font-weight: normal;">(See instructions.)</span>
					...
					<div class="styBB" style="width: 187mm;" rowspan="2">
						...
						<span class="styLNDesc" style="border-right-width:0px;width:147mm;padding-top:2mm;">
							<span style="float:left">Total
						
</span>
							<span style="float:right;">
								<span class="styDotLn" style="padding-right:2mm;">................................</span>
								<img class="styIRS5471Img" style="padding-right:1mm;border-right-width:0px;
						...
						border-left-width:1px;border-bottom-width:0px; width:30mm;padding-right:1px;">
							<xsl:call-template name="PopulateAmount">
...
Current year net income or (loss) per foreign books of account
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNAmountBox" style="height: 4.5mm; width: 34.25mm; border-bottom-width:0px; border-top-width: 1px"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 4.5mm; width: 34.25mm; border-left-width: 1px; border-bottom-width: 0px; text-align: center; font-weight: bold">Net</span>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 4.5mm; width: 34.25mm; border-left-width: 1px; border-bottom-width: 0px; text-align: center; font-weight: bold">Additions</span>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNAmountBox" style="height: 4.5mm; width: 34.25mm; border-left-width: 1px; text-align: center"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNLeftLtrBoxDD">a</span>
						<span class="styLNDesc" style="width: 69.75mm">
							<span style="float:left">
Capital gains or losses
</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						</span>
						<span class="styLNAmountBox" style="width: 34.25mm; height: 5mm; padding-top: .75mm; font-size: 7pt; border-left-width: 1px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="MaxSize" select="17"/>
								<xsl:with-param name="TargetNode" select="$IRS5471HData/CapitalGainsOrLossNetAddition"/>
							</xsl:call-template>
						</span>
						<span class="styLNAmountBox" style="width: 34mm; height: 5mm; padding-top: .75mm; font-size: 7pt; border-left-width: 1px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="MaxSize" select="17"/>
...
Depreciation and amortization
						...
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 5mm; font-size: 7pt; width: 34.25mm; border-left-width: 1px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="MaxSize" select="17"/>
								<xsl:with-param name="TargetNode" select="$IRS5471HData/DeprecAndAmortizNetAddition"/>
							</xsl:call-template>
						</span>
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 5mm; font-size: 7pt; width: 34mm; border-left-width: 1px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="MaxSize" select="17"/>
...
Other (attach schedule)
						...
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 8.5mm; font-size: 7pt; width: 34.25mm; border-left-width: 1px;">
							<span style="float: left; clear:none">
								<xsl:call-template name="SetFormLinkInline">
						...
						<span class="styLNAmountBox" style="padding-top: .75mm; height: 8.5mm; font-size: 7pt; width: 34mm; border-left-width: 1px;">
							<span style="float: left; clear:none">
								<xsl:call-template name="SetFormLinkInline">
						...
						<span class="styLNRightNumBox" style="height:8.5mm; background-color: lightgrey; border-bottom-width: 0px"/>
						<span class="styLNAmountBox" style="height:8.5mm; width: 33mm; background-color: lightgrey; border-bottom-width: 0px"/>
					</div>
					<!--   END LINE 2H   -->
					<!--   END LINE 2   -->
					<!--   BEGIN LINE 3   -->
...
Total net additions
						...
						<span class="styLNAmountBox" style="height: 5mm; width: 34mm; border-left-width: 1px; background-color: lightgrey"/>
						<span class="styLNRightNumBox" style="height: 5mm; background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNLeftNumBoxSD">4</span>
						<span class="styLNDesc" style="width: 104mm">
							<span style="float:left">
...
Did any such income become unblocked during the tax year (see section 964(b))?
					...
					<div style="width: 187mm; border-color: black;padding-top:.5mm; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
						...
						<span style="float: right">Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 12-2011)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>

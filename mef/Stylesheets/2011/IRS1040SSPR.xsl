...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <body class="styBodyClass">
        <form name="IRS1040SSPR" style="font-family:arial;">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:2px;">
            <div class="styFNBox" style="width:31mm;height:18mm;border-right-width:2px;padding-top:.5mm;">
                ...
                <span style="text-align:center;font-weight:bold;width:100%;">
                  <div style="width:100%;height:5mm;padding-left:5px;">
                    <div style="width:100%;height:5mm;">
                      ...
                      Mariana Islands (CNMI), or Puerto Rico. For the year Jan. 1-Dec. 31, 2011,<br/>
            ...
            <div class="styTYBox" style="width:30mm;border-left-width:2px;height:18mm;">
          ...
          <div class="styBB" style="width:187mm;height:33mm;">
            ...
            <div class="styIRS1040SSPRCleanDiv" style="width:97%;height:100%;border-left-width:1px;">
              <!-- Line 1 -->
              <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:25%;border-bottom-width:1px;">
              ...
              <!-- Line 4 -->
              <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:25%;">
                <div class="styIRS1040SSPRLNDesc" style="width:100%;height:auto;font-size:7pt;">
          ...
          <div class="styBB" style="width:187mm;">
              ...
              <div class="styIRS1040SSPRCleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
                <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:100%;float:right;">
                  <xsl:call-template name="CreateBox_1040SS">
                    ...
                    <xsl:with-param name="TargetNode" select="$Form1040SSPRData/HouseholdEmploymentTax"/>
                  </xsl:call-template>
                </div>
              </div>
            </div>
            ...
            <div class="styIRS1040SSPRLineItem">
              ...
              <div class="styIRS1040SSPRCleanDiv" style="width:106mm;height:auto;padding:0px 0px 0px 0px;">
                <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
                  <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;">
                    Amount of line 11 you want <b>applied to 2012 estimated tax</b>
                  </div>
                  <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 5.3mm 0px 0px;">
                    <!--Dotted Line-->
                    <span class="styBoldText">
            ...
            <div class="styIRS1040SSPRLineItem" style="height:8mm;">
              ...
              <div class="styIRS1040SSPRCleanDiv" style="width:81.8%;height:100%;font-size:7pt;">
                ...
                <div class="styIRS1040SSPRLineItem" style="width:100%;">
                  ...
                  <div class="styIRS1040SSPRLNDesc" style="width:20mm;padding:5px 5px 6px 5px;height:100%;text-align:center;font-size:7pt;">
            ...
            <div class="styIRS1040SSPRLineItem" style="height:6mm;">
              ...
              <div class="styIRS1040SSPRCleanDiv" style="width:18%;height:100%;">
                ...
                <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:10mm;padding-top:14px;">
                  <div class="styIRS1040SSPRCleanDiv" style="width:87%;height:100%;">
                    Joint Return?<br/>
                    See instructions<br/>
                    Keep a copy<br/>
                    for your<br/>
                  ...
                  <div class="styIRS1040SSPRCleanDiv" style="width:auto;height:100%;padding-top:3px;">
                    <img src="{$ImagePath}/1040SS_Bullet_Lg.gif" alt="Large Bullet"/>
                  </div>
                </div>
              </div>
              <!-- Body -->
              <div class="styIRS1040SSPRCleanDiv" style="width:81.8%;height:100%;">
                ...
                <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:22mm;">
                  ...
                  <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:10mm;border-bottom-width:1px;border-color:black;">
                    ...
                    <div class="styIRS1040SSPRLNDesc" style="width:47mm;height:100%;padding-left:0px;font-size:7pt;">
          ...
          <!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
          <div class="styTBB" style="width:187mm;font-size:6.5pt;font-family:arial;" >
  ...
  <xsl:template name="PopulateProfitOrLossFromFarmingSection_1040SS">
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <!-- (5a) ////////////////////////////////////////////////////-->
      <div class="styIRS1040SSPRLineItem" style="width:110mm;float:left;">
      ...
      <div class="styIRS1040SSPRLineItem" style="width:77mm;float:left;height:100%">
        <div class="styIRS1040SSPRCleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
          <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:100%;float:right;">
            <xsl:call-template name="CreateBox_1040SS">
      ...
      <!-- (5b) ////////////////////////////////////////////////////-->
      <div class="styIRS1040SSPRLineItem" style="width:77mm;float:left;">
            ...
            <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;">
              ...
              <xsl:if test="$TargetNode">
                <xsl:if test="$TargetNode/FarmExpenses/NetFarmProfitOrLoss/@passiveActivityLossLiteralCd">
                  <span style="width:4px;"/>
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
                    <xsl:with-param name="Desc">Part III, Line 36 - Passive Activity Loss Literal Code</xsl:with-param>
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <!-- (38a) ////////////////////////////////////////////////////-->
      <div class="styIRS1040SSPRLineItem" style="width:115mm;float:left;">
      ...
      <!-- (38b) ////////////////////////////////////////////////////-->
      <div class="styIRS1040SSPRLineItem" style="width:72mm;float:left;">
  ...
  <xsl:template name="PopulateProfitLossFromBusinessSection_1040SS">
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <div class="styIRS1040SSPRCleanDiv" style="width:50%;height:100%;float:right;padding-left:3mm;">
        ...
        <!-- (25b) ////////////////////////////////////////////////////-->
        <div class="styIRS1040SSPRLineItem">
          <div class="styIRS1040SSPRLNLeftNumBox" style="padding-right:0px;">25b</div>
          <div class="styIRS1040SSPRCleanDiv" style="width:47mm;height:auto;padding:0px 0px 0px 0px;">
            <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
              <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;">
      ...
      <div class="styIRS1040SSPRLineItem" style="width:187mm;">
        ...
        <div class="styIRS1040SSPRCleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
          ...
          <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:auto;float:right;">
            <xsl:call-template name="CreateBox_1040SS">
              <xsl:with-param name="Number">7</xsl:with-param>
              <xsl:with-param name="StaticText">106,800.00</xsl:with-param>
            </xsl:call-template>
          </div>
        </div>
      </div>
        ...
        <div class="styIRS1040SSPRCleanDiv" style="width:106mm;height:auto;padding:0px 0px 0px 0px;">
          <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
            <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;">
              ...
              W-2CM, W-2GU, W-2VI, or 499R-2/W-2PR. If $106,800 or more, skip<br/>
      ...
      <div class="styIRS1040SSPRLineItem" style="width:187mm;">
        ...
        <div class="styIRS1040SSPRCleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
          <div class="styIRS1040SSPRCleanDiv" style="width:100%;height:100%;float:right;">
            <xsl:call-template name="CreateBox_1040SS">
              <xsl:with-param name="Number">1</xsl:with-param>
              <xsl:with-param name="StaticText">4,480.00</xsl:with-param>
            </xsl:call-template>
          </div>
        </div>
      </div>
        ...
        <div class="styIRS1040SSPRCleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
          <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
            <div class="styIRS1040SSPRLNDesc" style="width:auto;height:100%;">
              ...
              share from farm partnerships), but not less than zero; <b>or</b> $4,480. Also include this amount in Part<br/>
              V, line 4b, above
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
								...
								<span style="text-align:center;font-weight:bold;width:100%;">
									<div style="width:100%;height:5mm;padding-left:0px;">
										<div style="width:100%;height:5mm;font-size:7.5pt;font-family:arial narrow;">
											<span class="styNormalText">
												Para el año que comienza el primero de enero de 2011 y termina el 31 de diciembre de 2011, o cualquier otro<br/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS1040PRLineItem">
							...
							<div class="styIRS1040PRCleanDiv" style="width:106mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS1040PRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS1040PRLNDesc" style="width:auto;height:100%;">
										<span style="font-size:7pt;">Pagos de contribución estimada del año 2011 (vea las instrucciones</span>)
									</div>
		...
		<div class="styBB" style="width:187mm;">
			...
			<div class="styIRS1040PRLineItem">
				...
				<div class="styIRS1040PRCleanDiv" style="width:142mm;height:auto;padding:0px 0px 0px 0px;">
					<div class="styIRS1040PRLNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
						<div class="styIRS1040PRLNDesc" style="width:auto;height:100%;">
							Cantidad máxima de salarios e ingreso del trabajo por cuenta propia combinados sujeta a la contribución al seguro social para 2011
							<!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:9px"/>.
								<span style="width:11px"/>.

              ...
              <th rowspan="2" scope="col" valign="top" align="left" style="width:32mm; font-weight:normal; border-right:1 solid black; border-bottom:1 solid black; line-height:100%">
                <label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">IRS5472ConsolidatedFilingOfForm5472</xsl:with-param>
                  </xsl:call-template>             
              Check here if this 
              <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" select="$Form5472Data/ReportingCorporationInfo/ConsolidatedFilingOfForm5472"/>
              ...
              <span class="styNormalText" style="font-size: 8pt;">
                <label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">IRS5472ReasonableEstimatesUsed</xsl:with-param>
                  </xsl:call-template>   
              ...
              <span class="styNormalText">
                <label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">IRS5472AllNonmonetaryAndLessThanFull</xsl:with-param>
                  </xsl:call-template> 
                ...
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form5472Data/ImportGoodsFromFrgnRltdParty"/>
                      <xsl:with-param name="BackupName">IRS5472ImportGoodsFromFrgnRltdParty</xsl:with-param>
                    </xsl:call-template>
                  </input>
                </span>
                <label>
              ...
              <div class="styLNDesc" style="float: right; clear:none; width: 26mm">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form5472Data/GoodsCostGreaterThanCustomsVal"/>
                      <xsl:with-param name="BackupName">IRS5472GoodsCostGreaterThanCustomsVal</xsl:with-param>
                    </xsl:call-template>
                  </input>
                </span>
                <label>
              ...
              <div class="styLNDesc" style="float: right; clear:none; width: 26mm">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form5472Data/SupportingDocInExistenceInUS"/>
                      <xsl:with-param name="BackupName">IRS5472SupportingDocInExistenceInUS</xsl:with-param>
                    </xsl:call-template>
                  </input>
                </span>
                <label>

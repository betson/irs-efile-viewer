		...
		<html>
            ...
            Form<span class="styFormNumber">1120S</span>
						...
						<div class="styTYBox" style="width:30mm;height:20mm;">
							...
							<div class="styTY" style="height:11mm;padding-top:3mm;">20<span class="styTYColor">11</span>
							</div>
						</div>
					</div>
					<div class="styBB" style="width:187mm;">
        For calendar year 2011<span style="width: 1mm"/>or tax year beginning
					...
					<div class="styBB" style="width:187mm;float:left;clear:left;">
						<div style="width:31mm;height:11.75mm;float:left;clear:left;">
							...
							<div class="styComType" style="width:31mm;height:9mm;border-bottom-width:1px;">
								...
								<div style="height:7mm;width:27.5mm;float:left;">Business activity code number <i>(see instructions)
								</i>
								</div>
        ...
        Check if: 
          ...
          information.
					...
					<div class="styBB" style="width:187mm;height:27mm;">
						<div class="styIRS1120SVTImageBox" style="height:45.5mm;padding-top:16mm;">
				  ...
				  <span style="float:left;">Merchant card and third-party payments.  For 2011, enter -0- </span>
							...
							<div style="float:right;clear:none;">
								...
								<div class="styLNAmountBox" >
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120SData/MerchantCardThirdPartyPayments"/>
									</xsl:call-template>
								</div>
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:92mm;">
				  <span style="float:left;">Gross receipts or sales not reported on line 1a (see instructions) 
                    <span style="width:2px;"/>
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styGenericDiv" style="width:181mm;">
							...
							<div style="float:right;clear:none;">
								...
								<div class="styLNAmountBox" >
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalLine1aAnd1b"/>
									</xsl:call-template>
								</div>
								<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width:0px;"/>
								<div class="styLNAmountBox" style="width:31mm;height:4.5mm;border-bottom-width:0px;"/>
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear;none;">
								...
								<div class="styLNDesc" style="width:94mm;">
									<span style="float:left;">Returns and allowances plus any other adjustments (see instructions)</span>
									<!--Dotted Line-->
									<!--<div class="styDotLn" style="float:right;padding-right:1mm;"></div>-->
								</div>
							</div>
...
-->
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">
							Gross profit. Subtract line 2 from line 1e
 </span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
							</div>
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">
							Net gain (loss) from Form 4797, Part II, line 17 <i>(attach Form 4797)</i>
									<span style="width:2px;"/>
									<xsl:call-template name="SetFormLinkInline">
...
Depreciation not claimed on
							 Form 1125-A or elsewhere on return <i>(attach Form 4562)</i>
									<xsl:call-template name="SetFormLinkInline">
...
Employee benefit programs
      <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">
Other deductions <i>(attach statement)</i>
									<span style="width:2px;"/>
									<xsl:call-template name="SetFormLinkInline">
...
Excess net passive income or LIFO recapture tax <i>(see</i>
								<br/>
								<span style="float:left">
									<i>instructions)</i>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                    ...
                    <span style="width:2px;"/>
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:94mm;padding-left:1mm;">
2011 estimated tax payments and 2010 overpayment credited
<br/>
<span style="float:left;">
  to 2011
 </span>
                    ...
                    <span style="width:2px;"/>
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:94mm;padding-left:1mm;">
				  <span style="float:left;">Credit for federal tax paid on fuels <i>(attach Form 4136)</i>
                    <span style="width:2px;"/>
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
...
Add lines 23a through 23c
       ...
       <xsl:call-template name="LinkToLeftoverDataTableInline">
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span>
									<span style="float:left;">Estimated tax penalty <i>(see instructions).</i>
										<label>
											<xsl:call-template name="PopulateLabel">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120S</span> (2011)
    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120S (2011)<span style="width:148mm;"/>
						</div>
      ...
      Accrual
       ...
       Other (specify)
					...
					<div style="width:187mm; height:4.5mm;">
						...
						<span style="float:right;">
							<div class="styShadingCell" style="width:10mm;height:10mm;"/>
							<div class="styShadingCell" style="width:10mm;height:10mm;"/>
						</span>
					</div>
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:10.5mm;">3</div>
						<div class="styLNDesc" style="width:159mm;height:10.5mm;">
...
At the end of the tax year, did the corporation own, directly or indirectly, 50% or more of the voting stock of a 
    ...
    <span class="styBoldText">(c)</span> if 100% owned, was a qualified subchapter S subsidiary 
    <span style="float:left">
    election made?  <span style="width:2px;"/>
								<xsl:call-template name="SetFormLinkInline">
 ...
 <!--Dotted Line-->
    ...
    Issue Discount Instruments.
					...
					<!-- line 6 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:14mm">6</div>
...
years, enter the net unrealized built-in gain reduced by net recognized built-in gain from prior years <i>(see</i>
							<br/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:159mm;height:7mm;">
							
Are the corporation's total receipts
						 <i>(see instructions)</i> for the tax year <span class="styBoldText">and</span> its total assets
						  at the end of the tax year less
						  <span style="float:left">
						   than $250,000? If &#8220;Yes,&#8220;
						   the corporation is not required to complete Schedules L and M-1.
       ...
       <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						Did the corporation make any payments in 2011 that would require it to file
	          ...
	          <span style="width:2px;"/>
               ...
               <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									...
									<td>
										<span class="styLNRightNumBoxNBB" style="width:12mm;height:6.5mm;">10</span>
										<span class="styLNAmountBoxNBB" style="height:6.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1120SScheduleK/OtherIncomeLoss"/>
											</xsl:call-template>
										</span>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120S</span> (2011)
            ...
            <xsl:call-template name="SetFormLinkInline">
               ...
               Type <img src="{$ImagePath}/1120S_Bullet_Md.gif" alt="MidSizeBullet"/>
									...
									<td style="border-bottom:1px solid black;">
										<span class="styLNRightNumBoxNBB" style="width:12mm;height:6.5mm;">13g</span>
										<span class="styLNAmountBoxNBB" style="height:6.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1120SScheduleK/OtherCreditsTotal "/>
											</xsl:call-template>
...
Tax-exempt securities <i>(see </i>
					...
					<div style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:50mm;height:4.5mm;padding-top:0.4mm">
							Other current assets <i>(attach</i>
							<span style="float:left">
								<i>statement)</i>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
...
Mortgage and real estate loans
      ...
      <i>(attach statement)</i>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:7mm;font-size:8pt;font-family:arial;">
							<xsl:call-template name="PopulateAmount">
...
Accounts payable
					...
					<div style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:50mm;height:7.5mm;padding-top:0.7mm">
							Other current liabilities <i>(attach</i>
							<span style="float:left">
								<i>statement)</i>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
						...
						<div class="styLNAmountBox" style="width:4mm;height:7.5mm;padding-top:2mm;">
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/OtherCurrentLiabilitiesBOY"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120SLNAmountBoxNLB" style="width:28mm;height:7.5mm;padding-top:2mm;font-size:8pt;font-family:arial;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/OtherCurrentLiabilitiesBOY"/>
							</xsl:call-template>
						</div>
						...
						<div class="styIRS1120SLNAmountBoxNLB" style="padding-top:2mm;width:28mm;height:7.5mm;font-size:8pt;font-family:arial;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/OtherCurrentLiabilitiesEOY"/>
							</xsl:call-template>
						</div>
...
Loans from shareholders
					...
					<div style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:50mm;height:4.5mm;padding-top:0.4mm">
							<span style="float:left">
						Other liabilities <i>(attach statement)</i>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
						</div>
						<div class="styShadingCell" style="height:5mm;"/>
...
Retained earnings
					...
					<div style="width:187mm;">
						...
						<div class="styIRS1120SLNAmountBoxNLB" style="width:28mm;height:7.5mm;font-size:8pt;font-family:arial;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/AdjToShareholdersEquityBOY"/>
							</xsl:call-template>
						</div>

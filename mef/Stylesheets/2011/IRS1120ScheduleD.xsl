		    ...
		    <img src="{$ImagePath}\8865_Bullet_Sm.gif" alt="Small Right Arrow" border="0"/> See separate instructions.
              ...
              <div class="IRS1120ScheduleD_styTYBox" style="width:125px;height:85px;">
                ...
                <div class="IRS1120ScheduleD_styTY" style="height:45px;line-height:45px;color:Green;padding-top:.5mm;">
                  <span style="color:black;">20</span>11
                </div>
              </div>
            </div>
            <!-- END FORM HEADER -->
                    ...
                    <tr>
                      <td class="IRS1120ScheduleD_styTableCellA" scope="row">
                        ...
                        <xsl:call-template name="LinkToLeftoverDataTableInline">
                          <xsl:with-param name="Desc">Part I, Line 1(a) - SSBIC Rollover Indicator for Short Term Capital Gain And Loss</xsl:with-param>
		  ...
		  <xsl:if test="count($FormData/ShortTermCapitalGainAndLoss) &lt; 7 or ((count($FormData/ShortTermCapitalGainAndLoss) &gt; 7) and ($Print = $Separated))">
		    ...
		    <td class="IRS1120ScheduleD_styTableCellF" style="border-bottom-width: 0px"><span style="width: 1mm" /></td>
              ...
              <div class="IRS1120ScheduleD_styLineItem">
                ...
                <span class="IRS1120ScheduleD_styLNRtMargin"/>
                <span class="IRS1120ScheduleD_styLNDesc">
                  <span style="float:left;">Short-term gain or (loss) from like-kind exchanges from Form 8824</span>
                  <!--Dotted Line-->
			      <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">.........</span>
			    </span>
              ...
              <div class="IRS1120ScheduleD_styLineItem">
                ...
                <span class="IRS1120ScheduleD_styLNRtMargin"/>
                <span class="IRS1120ScheduleD_styLNDesc">
                  <span style="float:left;">Net short-term capital gain or (loss). Combine lines 1 through 4</span>
                  <!--Dotted Line-->
			      <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">..........</span>
			    </span>
                    ...
                    <xsl:for-each select="$FormData/LongTermCapitalGainAndLoss">
                      <tr>
                        ...
                        <!-- If this is the last row, do not display a bottom line -->
                          ...
                          <xsl:call-template name="LinkToLeftoverDataTableInline">
                            <xsl:with-param name="Desc">Part II, Line 6(a) - SSBIC Rollover Indicator for Long Term Capital Gain And Loss</xsl:with-param>
                            <xsl:with-param name="TargetNode" select="PropertyDescription/@ssbicRolloverIndicator"/>
                          </xsl:call-template>
                        </td>
                        <td class="IRS1120ScheduleD_styTableCellB">
		      ...
		      <xsl:if test="count($FormData/LongTermCapitalGainAndLoss) &lt; 7 or (($Print = $Separated) and (count($FormData/LongTermCapitalGainAndLoss) &gt; 7)) ">
               ...
               <div class="IRS1120ScheduleD_styLineItem">
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">
                    <span style="float:left;">Long-term gain or (loss) from like-kind exchanges from Form 8824 </span>
                    <!--Dotted Line-->
			        <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">.........</span>
			      </span>
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">
                    <span style="float:left;">Net long-term capital gain or (loss). Combine lines 6 through 10 </span>
                    <!--Dotted Line-->
			        <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">..........</span>
			      </span>
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">
                    <span style="float:left;">Enter excess of net short-term capital gain (line 5) over net long-term capital loss (line 11) </span>
                    <!--Dotted Line-->
			        <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">.</span>
			      </span>
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">
                    Net capital gain. Enter excess of net long-term capital gain (line 11) over net short-term 
                    <span style="float:left;">capital  loss (line 5) </span>
                     <!--Dotted Line-->
			        <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">..........................</span>
			      </span>          
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">
                    Add lines 12 and 13. Enter here and on Form 1120, page 1, line 8, or the proper line on 
                    <span style="float:left;">other returns. </span> 
                    <!--Dotted Line-->
			        <span style="float:right;font-weight:bold;letter-spacing:3.3mm;padding-right:2mm;">............................</span>
			      </span>
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                 ...
                 <div class="IRS1120ScheduleD_styFormFooter" style="width:707px;border-top-width: 1px;">
                   ...
                   <span style="float:right;width:42mm;text-align:right;font-weight:bold;font-size:7pt;" class="styGenericDiv" >Schedule D (Form 1120) 2011</span>
                 </div>
                 <!-- BEGIN FOOTER -->
               </form>
               <!-- leftover data table -->

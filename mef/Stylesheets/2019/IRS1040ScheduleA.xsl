       ...
       <body class="styBodyClass" style="width:187mm;">
          ...
          <div class="styTBB" style="width:187mm;height:19.5mm;">
            <div class="styFNBox" style="width:28mm;height:19.5mm;">
              <div style="height:8mm;">
                ...
                <br/>
                <span class="styFormNumber" style="font-size:9pt">(Form 1040 or 
					<br/>1040-SR) <span style="width:1mm"/>
            ...
            <div class="styFTBox" style="width:126.5mm;height:19.5mm;">
			  ...
			  <div class="styFBT" style="width:126.5mm;font-size:7pt;margin-top:.5mm;font-weight:normal">         
				  ...
				  <b>Go to <a style="text-decoration:none;color:black;" href="www.irs.gov/ScheduleA " title="Link to IRS.gov"><i>www.irs.gov/ScheduleA </i>
				  </a> for instructions and the latest information.</b><br/>
				  <span style="padding-top:.5mm;">
				 	 <img src="{$ImagePath}/1040SchA_Bullet.gif" alt="SmallBullet Image"/> <b>Attach to Form 1040 or 1040-SR.</b>
				  </span>    
				  <span style="padding-top:.5mm;">				  
        ...
        <xsl:call-template name="PopulateReturnHeaderFiler">
          ...
          <div class="styBB" style="width:187mm;height:23mm;">
            <div class="styIRS1040ScheduleAleftBox" style="width: 20mm; height:23mm;font-size:8.8pt;border-left-width:0px;
            ...
            <div class="styIRS1040ScheduleAleftBox" style="width: 96mm; height:15.7mm;font-size:7.5pt;border-right-width:0px;
              ...
              <div class="styIRS1040ScheduleAleftBox" style="width:61mm;height:6.7mm;border-left-width:0px;border-right-width:0px;
                border-bottom-width:0px;padding-left:2mm;padding-top:1mm;">
                <span>
					<span class="styBoldText">2</span>
					<span style="width:2.3mm"/>
					<span style="font-size:8.2pt;font-family:arial narrow;padding-top:1mm">
						Enter amount from Form 1040 or 1040-SR, line 8b
					</span>
				</span> 
              </div>
              <div class="styIRS1040ScheduleAlnRightNumBox" style="width:5mm;height:1mm;border-left-width:0px;border-bottom-width:0px;"></div>
              <div class="styIRS1040ScheduleAlnAmountBox" style="width:30mm;height:1mm;border-left-width:0px;border-bottom-width:0px"></div>
              <div class="styIRS1040ScheduleAlnRightNumBox" style="width:5mm;height:4.2mm;border-left-width:1px;border-bottom-width:1px;">2</div>
              ...
              <div class="styIRS1040ScheduleAleftBox" style="width:96.5mm; height:4.5mm;font-size:7pt;border-left-width:0px;
                border-right-width:0px;border-bottom-width:0px;padding-left:2mm;padding-top:.5mm;">
            ...
            <!--Line 3 amount boxes-->             
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:6mm;background-color:lightgrey;border-bottom-width:0px;"/>
            <div class="styIRS1040ScheduleAlnAmountBox" style="
height:6mm;border-bottom-width:0px"/>    
           <div class="styIRS1040ScheduleAlnRightNumBox" style="height:6mm;background-color:lightgrey;border-bottom-width:0px;"/>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:6mm;border-bottom-width:0px;"/> 
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:5mm;padding-top:1mm;border-left-width:1px;border-bottom-width:1px">3</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:5mm;padding-top:1mm;padding-right:.5mm;font-size:7pt">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/CalculatedMedicalAllowanceAmt"/>
              </xsl:call-template>
            </div>    
              <div class="styIRS1040ScheduleAlnRightNumBox" style="height:5mm;background-color:lightgrey;border-left-width:1px;
                border-bottom-width:0px;"/>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:5mm;border-bottom-width:0px;"/>    
            <br/>  
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.4mm;padding-top:.5mm;border-bottom-width:0px;">
              4</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:4.4mm;padding-top:.5mm;border-bottom-width:0px;padding-right:.5mm;font-size:7pt">
              <xsl:call-template name="PopulateAmount">
            ...
            <div class="styIRS1040ScheduleAleftBox" style="width: 96mm; height:47mm;font-size:7pt;border-right-width:0px;border-left-width:0px;">
                ...
                border-right-width:0px;border-bottom-width:0px;padding-left:2mm;padding-top:0mm;">
					<div class="styIRS1040ScheduleAleftBox" style="height:13mm;border-left-width:0px;">
						<span style="width:1.5mm;"/>
						<span class="styBoldText">a
							<span style="width:.2mm;"/>
						</span>
						<span style="height:3mm">State and local income taxes or general sales taxes. You may include</span>
						<br/>
						<span style="width:4.2mm;"/>
						<span style="height:3mm">either income taxes or general sales taxes on line 5a, but not both.</span>
						<br/>
						<span style="width:4.2mm;"/>
						<span style="height:3mm">If you elect to include general sales taxes instead of income taxes,</span>
						<br/>
						<span style="width:3mm;"/> check this box
						<span style="width:1.3mm"/>
						<span style="width:65mm;">
							<span style=" letter-spacing:3.2mm; font-weight:bold;float:left; ">.............</span>
							<span style="width:1mm"/>
							<img src="{$ImagePath}/1040SchA_Bullet.gif" alt="SmallBullet Image"/>
							<span style="width:2mm"/>
					...
					<br/>
					<div class="styIRS1040ScheduleAleftBox" style="height:4mm;border-left-width:0px;padding-top:.5mm">
						<span style="width:1.5mm;"/>
          ...
          <div class="styBB" style="width:187mm;">
				<div class="styIRS1040ScheduleAleftBox" style="width: 20mm; height:64mm;font-size:8.8pt;border-left-width:0px;border-right-width:0px;padding-top:0mm;">
					<span class="styBoldText" style="height:7mm;padding-top:0mm;">Interest<br/>You Paid<br/>
					</span>
					<br/>              
				...
				<div class="styIRS1040ScheduleAleftBox" style="width: 96mm; height:56mm;font-size:7pt;border-right-width:0px;
				  border-left-width:0px;">
					...
					<div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:10mm;font-size:7.1pt;border-left-width:0px;
						border-right-width:0px;border-bottom-width:0px;padding-left:1.8mm;padding-top:0mm">
						...
						<span style="width:4mm"/><span style="height:3mm">home mortgage loan(s) to buy, build, or improve your home,</span>
						<br/>
						<span style="width:4mm"/>see instructions and check this box
						<span style="width:40mm;height:5mm;">
							<span style="width:2mm"/>
							<span style=" letter-spacing:3.2mm; font-weight:bold;float:left; ">.......</span>
							<img src="{$ImagePath}/1040SchA_Bullet.gif" alt="SmallBullet Image"/>
							<span style="width:2mm"/>
					...
					<div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:7.7mm;font-size:7pt;border-left-width:0px;
						...
						<span class="styBoldText" style="font-size:7pt">a</span>
							Home mortgage interest and points reported to you on Form 1098. <br/>
						<span style="width:2.5mm"/>See instructions if limited
						<span style="width:2mm"/>
						<span style=" letter-spacing:3.2mm; font-weight:bold;float:right; ">.............</span>
					</div>
					<!--Line 8b Verbiage only-->
					<div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:14mm;font-size:7pt;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;
padding-left:3.3mm;padding-top:1.5mm;">
						<span class="styBoldText" style="font-size:7pt">b</span>
							Home mortgage interest not reported to you on Form 1098. See <br/>
						<span style="width:2.5mm"/>instructions if limited. If paid  to the person from whom you bought the <br/>
						<span style="width:2.5mm"/>home, see instructions and show that person's name, identifying no.,<br/>
						<span style="width:2.5mm"/>and address
					...
					<div class="styIRS1040ScheduleAleftBox" style="width:95mm;height:4.9mm;font-size:7pt;border-left-width:0px;
						...
						<span style="width:1mm"/>
						<span style="width:82mm;border-bottom:dotted 1px;text-align:right;"/>
					</div>
					...
					<div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:4mm;font-size:7pt;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;
padding-left:3.3mm;padding-top:.8mm;">
...
padding-left:3.3mm;padding-top:.8mm;">
				...
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:3.9mm;border-bottom-width:0px;"/>
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:10mm;background-color:lightgrey;border-left-width:1px;
				  border-bottom-width:0px;"/>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:10mm;border-bottom-width:0px"/>
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:10mm;background-color:lightgrey;border-bottom-width:0px;"/>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:10mm;border-bottom-width:0px;"/>
				...
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:3.9mm;border-bottom-width:0px"/>
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:17mm;border-left-width:1px;border-bottom-width:0px;
				  background-color:lightgrey"/>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:17mm;border-bottom-width:0px;"/>
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:17mm;background-color:lightgrey;border-bottom-width:0px;"/>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:17mm;border-bottom-width:0px;"/>
				...
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:5.3mm;border-bottom-width:1px;padding-right:.5mm;font-size:6pt;padding-top:2mm"> 
					<xsl:call-template name="PopulateAmount">
			...
			<div class="styBB" style="width:187mm;height:24mm;">
				<div class="styIRS1040ScheduleAleftBox" style="width:20mm; height:24mm;font-size:8.8pt;border-left-width:0px;
				  border-right-width:0px;padding-top:1mm;">
					...
					<div style="font-size:6.4pt;padding-top:.7mm;"><b>Caution:</b> If you made a gift <br/>and got a<br/>
				  ...
				  border-right-width:0px;">
					...
					<div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:7.8mm;font-size:7pt;border-left-width:0px;
						...
						<span style="width:1.2mm;"/>
							Other than by cash or check. If you made any gift of $250 or more, <br/>
						<span style="width:5.9mm"/><span style="font-size:7.5pt;">see instructions. You </span>
						<span style="width:1mm"/>
				...
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:2mm;background-color:lightgrey;border-left-width:1px;
					border-bottom-width:0px;padding-top:3mm"></div>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:2mm;padding-right:.5mm;font-size:6pt;padding-top:3mm;
					border-bottom-width:0px;"></div>
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:2mm;background-color:lightgrey;border-left-width:1px;
					border-bottom-width:0px;padding-top:3mm"></div>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:2mm;padding-right:.5mm;font-size:6pt;padding-top:3mm;
					border-bottom-width:0px;"></div>	
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:4mm;border-left-width:1px;border-bottom-width:1px;
					padding-top:1mm">11</div>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:4mm;padding-right:.5mm;font-size:6pt;padding-top:1mm;">
					<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:2mm;padding-right:.5mm;font-size:6pt;padding-top:3mm;
					border-bottom-width:0px;"></div>	
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.4mm;border-left-width:1px;border-bottom-width:1px;
					padding-top:1mm">12</div>
				<div class="styIRS1040ScheduleAlnAmountBox" style="height:4.4mm;padding-right:.5mm;font-size:6pt;padding-top:1mm">
					<xsl:call-template name="SetFormLinkInline">
						<xsl:with-param name="TargetNode" select="$FormData/OtherThanByCashOrCheckAmt"/>
					</xsl:call-template>
					<span style="width:4px;"/>
				...
				<div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.4mm;background-color:lightgrey;border-bottom-width:0px;"/>
		...
		<div class="styBB" style="width:187mm;height:16mm;">
            ...
            <div class="styIRS1040ScheduleAleftBox" style="width:131.5mm; height:16mm;font-size:7pt;border-left-width:0px;border-right-width:0px;">
				...
				<div class="styIRS1040ScheduleAleftBox" style="width:131.5mm; height:8mm;font-size:7pt;border-left-width:0px;
					...
					<span style="width:1.5mm"/>
					 ...
					 <span style="width:5.2mm"/> Form 1040 or 1040-SR, line 9  <span style="width:2mm"/>
					<span style="letter-spacing:3.2mm; font-weight:bold;float:right;">....................</span>  
				</div>                
				<!--Line 18 Verbiage-->             		              
               ...
               <span class="styBoldText" style="font-size:7pt;">18</span>
                ...
                <span style="width:5.5mm"/>deduction, check this box
                     <span style="width:1.3mm"/>
                <span style=" letter-spacing:3.2mm; font-weight:bold; ">..................</span>
                <span style="width:2mm"/>
                <img src="{$ImagePath}/1040SchA_Bullet.gif" alt="SmallBullet Image"/>
          ...
          <div style="width:187mm;clear:both;">
            ...
            <div style="float:right;font-size:6pt" class="styGenericDiv">
              <span class="styBoldText">Schedule A (Form 1040 or 1040-SR) 2019</span>
            </div>
          </div>

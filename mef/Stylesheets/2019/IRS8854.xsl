	...
	<xsl:template name="SetPageEndFooter">
		...
		<div class="pageEnd" style="width:187mm;padding-top:1mm;">
			...
			<div style="float:right;">
				...
				Form <span class="styBoldText" style="font-size:8pt;">8854</span> (2019)
			</div>
		</div>
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;float:none;clear:both;">
			<div style="float:left;">
				Form 8854 (2019)<span style="width:148mm;"/>
			</div>
			<div style="float:right;">
			...
			<body class="styBodyClass">
				<form name="IRS8854">
						...
						<div class="styIRS8854LineItem" style="margin-bottom:3mm;">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<label>
									...
									Initial expatriation statement for persons who expatriated in 2019. Complete Part II.
								</label>
								<br/>
								<!-- ++++++++++++++ 2nd Checkbox +++++++++++++ -->
								<span style="width:1mm;"/>
								...
								<label>
									...
									Annual expatriation statement for persons who expatriated before 2019. Complete Part III.
								</label>
								<br/>
							</div>
						</div>
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Initial Expatriation Statement for Persons Who Expatriated in 2019
						</div>
					</div>
					<!-- END: Part II (Header)-->
					<!-- END Page Header -->
						...
						<div class="styIRS8854LineItem" style="height:15mm;">
							<div class="styIRS8854LNDesc" style="width:40%;height:4mm;border-right-width:0px;float:left;padding-top:0px;padding-bottom:0px;">
								...
								<div class="styIRS8854LNDesc" style="height:4mm;width:60mm;padding-left:0px;">
									...
									of any such company 
									<span style="border-bottom:1px solid black;width:45mm;height:3mm;"></span><br />
									<span style="border-bottom:1px solid black;width:45mm;min-height:3mm;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8854LNDesc" style="width:180mm;padding-left:12mm;">
							...
							<span style="width:12px;"/>
								more than $168,000, your net worth (see line 2 in Section A) was under $2 million, and you checked "<span class="styBoldText">Yes</span>" on line 6 in<br/>
							<span style="width:12px;"/>
								Section A;<br/>
							<img src="{$ImagePath}/8854_Bullet_Round.gif" alt="Bullet Round"/>
							<span style="width:1mm;"/>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="height:auto;">
									Enter the total tax you would have reported, absent the deferral election, on Form 1040, line 15, for the part of the year
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2019
						</div>
					</div>
					<!-- END: Part III (Header)-->
					<!-- BEGIN: Part III (Body) -->
					...
					<div class="styBB" style="width:187mm;float:none;display:block;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								column (d) for any property you disposed of in 2019 and see the instructions for Part III.
								<!--+++++++++++++++++++ Table Toggle Button +++++++++++++++++++-->
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						<div class="styPartName" style="width:15mm;">Part III</div>
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2019 (continued from page 4)
						</div>
					</div>
					<!-- END: Part III (Header)-->
						<!-- Begin (Line) 2 -->
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">2</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions of eligible deferred compensation items for 2019?
							</div>
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">3</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions from a nongrantor trust for 2019?
							</div>
							<div class="styIRS8854LNDesc" style="width:35mm">
								<!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
								<span>

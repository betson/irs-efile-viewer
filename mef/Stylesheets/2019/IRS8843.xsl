				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styFTBox" style="width:131mm;height:23mm;">
							...
							<br/>
							<span>
								For the year January 1 &#8212; December 31, 2019, or other tax year<br/>beginning 
						...
						<div class="styTYBox" style="width:28mm;height:23mm;">
							...
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">19</span>
							</div>
							<div style="width:100%;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:138.5mm;float:left;">
								Enter the number of days in 2019 you claim you can exclude for purposes of the substantial presence test <img src="{$ImagePath}/56_Bullet.gif" alt="Right pointing arrowhead image"/> 
							</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								<span style="width:158.5mm;float:left;">
									For teachers, enter the name, address, and telephone number of the academic institution where you taught in 2019 <img src="{$ImagePath}/56_Bullet.gif" alt="Right pointing arrowhead image"/> 
								</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="width:48.5mm;float:left;">
									you participated in during 2019 <img src="{$ImagePath}/56_Bullet.gif" alt="Right pointing arrowhead image"/> 
								</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							calendar years (2013 through 2018)? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........................</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								<span style="width:133mm;float:left;">
									Enter the name, address, and telephone number of the academic institution you attended during 2019 <img src="{$ImagePath}/56_Bullet.gif" alt="Right pointing arrowhead image"/> 
								</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="width:23mm;float:left;">
									 in during 2019 <img src="{$ImagePath}/56_Bullet.gif" alt="Right pointing arrowhead image"/> 
								</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							During 2019, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status <br/>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8843</span> (2019)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Enter the name of the charitable sports event(s) in the United States in which you competed during 2019 and the dates of <br/>

			...
			<body class="styBodyClass" style="width:187mm">
				<form name="Form945">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styLNDesc" style="width:138.8mm;">Total deposits for 2019, including overpayment applied from a prior year and overpayment applied from<br/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText" style="font-size:8pt;">945 </span> (2019)
						</div>
					</div>

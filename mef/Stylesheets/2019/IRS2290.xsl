    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        Form <span class="styFormNumber">2290</span>
              ...
              <br/>
              <span class="styAgency">(Rev. July 2019)
...
Check if applicable:</div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;">Was the vehicle(s) reported on this return used on public highways during <b>July</b> 2019? If YES,</div>
            <div style="float:right">
  ...
  <div class="styDotLn" style="float:right;padding-right:2mm;padding-top:1mm">...</div>
    ...
    <xsl:call-template name="SetFormLinkInline">
        ...
        7,500 miles or less for agricultural vehicles</label>
              ...
              <br/>
during the period July 1, 2019, through June 30, 2020, and are suspended from the tax. Complete and attach Schedule 1.
       </div>
          </div>
          <!-- Line 8a -->
          <div style="height:8mm;width:187mm;padding-top:1mm;">
            ...
            I declare that the vehicles listed as suspended on the Form 2290 filed for the period July 1, 2018, through June 30, 2019, were not
          ...
          <div style="height:16mm;width:187mm;padding-top:1mm;">
           ...
           I declare that vehicle identification numbers 
            <span style="width:110mm;border-bottom:1 black solid">
              ...
              <br/>
were listed as suspended on the Form 2290 filed for the period July 1, 2018, through June 30, 2019. These vehicles were sold or
<br/>transferred to
        ...
        <xsl:call-template name="PopulateReturnHeaderPreparer">
          ...
          <div style="width:187mm;padding-top:.5mm;">
            <span>
              ...
              <span>Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2019)</span>
            </span>
          </div>
          <div class="pageEnd" />
          <!--  PAGE 1  END -->
          ...
          <div class="styBB" style="width:187mm;text-align:right;">
            <span style="float:left">Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2019)</span>Page <span class="styBoldtext" style="font-size:8pt">2</span>
          </div>
          <!--******************************************************************************************************************************************-->
          <!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
...
Tax Computation
          ...
          <div style="width:187mm">
            <span style="float:right"> Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2019)</span>
          </div>
          <div class="pageEnd" />

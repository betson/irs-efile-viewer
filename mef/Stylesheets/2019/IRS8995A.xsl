			...
			<body class="styBodyClass">
				<form id="Form8995A">
						...
						<xsl:if test="position() mod 3 = 1">
							...
							<div class="styStdIBDiv">
								...
								<div class="sty8995ADesc" style="height:13mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $160,700 or less ($160,725 if married filing separately; $321,400 if married 
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">8995-A</span> (2019)</span>
					</div>
					<div class="styStdDiv">
						Form 8995-A (2019)
					...
					<div class="styStdDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;font-family:Arial;">
						Complete Part III only if your taxable income is more than $160,700 but not $210,700 ($160,725 and $210,725 if married filing separately; 
						$321,400 and $421,400 if married filing jointly) and line 10 is less than line 3. Otherwise, skip Part III.
					</div>
					<xsl:for-each select="$FormData/QBIDeductionInformationGrp">
						<xsl:if test="position() mod 3 = 1">
							<xsl:variable name="pos" select="position()"/>
					...
					<xsl:if test="count($FormData/QBIDeductionInformationGrp) &lt; 1">
						...
						<div class="styStdDiv">
							...
							<div class="styLNRightNumBox" style="height:7mm;"><br />24</div>
							<div class="sty8995AAmtBox" style="height:7mm;"><br />%</div>
							<div class="styLNRightNumBox" style="height:7mm;background-color:lightgrey;">&nbsp;</div>
							<div class="sty8995AAmtBox" style="height:7mm;background-color:lightgrey;">&nbsp;</div>
							<div class="sty8995AAmtBox" style="height:7mm;background-color:lightgrey;">&nbsp;</div>
							<div class="sty8995AAmtBox" style="height:7mm;background-color:lightgrey;">&nbsp;</div>

							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									...
									<td style="width: 52.75mm;font-size: 7pt;">		
										<div class="styTY" style="float: right; clear: none; padding-right: 2mm;">20<span class="styTYColor">19</span>
											<span style="font: normal normal 7pt Verdana; padding-left: 1mm;">
												<span style="width: 5mm;"/>
											</span>
										</div>
										<span style="width:52mm;text-align:right;padding-right:1mm;">For calendar year 2019, or tax<br/></span>
								...
								<tr>
									<td colspan="2" style="width:92.5mm;">
										...
										<span style="font-weight: bold; font-size: 7pt; padding-left: 6mm; padding-top: 0.5mm;">
											<img src="{$ImagePath}/8865SchK1_Bullet_Lg.gif" width="4" height="7" alt="Right arrow image" border="0"/> See back of form.</span>
									</td>
								</tr>
							</table>
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">

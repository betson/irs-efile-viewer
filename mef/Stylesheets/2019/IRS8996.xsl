			...
			<body class="styBodyClass">
				<form id="Form8996">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;width:179mm;">
							...
							<div style="width:173mm;float:left;padding-top:0.7mm;">
								...
								organizing documents include a statement of the entity's purpose of investing in qualified opportunity zone property and a description <br /> of the trade or business(es) that the QOF is engaged in either directly or through a qualified opportunity zone business. See instructions. 
							</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <strong>8996</strong> (Rev. 12-2019)</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS" style="border-bottom:2px solid black;">
						Form 8996 (Rev. 12-2019)
					...
					<!-- Part 4, Line 3 -->
					<div class="styStdDivLS">
						<div class="styLNLeftNumBoxSD" style="width:7.5mm;height:7mm;border-bottom:1px solid black;">3</div>
					...
					<div class="styStdDivLS" style="border-bottom:1px solid black;border-top:1px solid black;">
						...
						<div class="styPartDesc" style="width:230mm;margin-top:1.5mm;margin-bottom:1.5mm;">Qualified Opportunity Zone (QOZ) Business Property &mdash; directly owned or leased by taxpayer</div>
					...
					<div class="styStdDivLS" style="border-bottom:1px solid black;border-top:1px solid black;">
						...
						<div class="styPartDesc" style="width:230mm;margin-top:1.5mm;margin-bottom:1.5mm;">Qualified Opportunity Zone (QOZ) Stock or Partnership Interests</div>
						<div style="float:right;width:5mm;height:4mm;">
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:205.9mm;">
							6-month test QOZ property. Add Part V, columns (b) and (c), and Part VI, column (c). Enter the total here and on Part II, line 6
							<span class="sty8996DotLn">..........</span>
						</div>
					...
					<div class="styStdDivLS">
						<div class="styLNLeftNumBoxSD">3</div>
						<div class="styLNDesc" style="width:205.9mm;">
							Year-end test QOZ property. Add Part V, columns (d) and (e), and Part VI, column (f). Enter the total here and on Part II, line 9
							<span class="sty8996DotLn">..........</span>
						</div>
						<div class="styLNAmountBox" style="width:42mm;">
							<xsl:call-template name="PopulateAmount">

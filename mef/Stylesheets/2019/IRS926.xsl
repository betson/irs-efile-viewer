...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:if test="not($Print) or $Print=''">
      ...
      <body class="styBodyClass">
        <form name="Form926Data">
          ...
          Name of transferor<br></br>
             ...
             <!-- Choice between 1120, 1041, 1040 and 1040NR Return Header Filer info -->
                                                         <xsl:call-template name="PopulateText">
                                                            <xsl:with-param name="TargetNode" select="$Form926Data/TransferorBusinessName/BusinessNameLine1Txt"/>
                                                         </xsl:call-template> <br/>
                                                         <xsl:call-template name="PopulateText">
                                                            <xsl:with-param name="TargetNode" select="$Form926Data/TransferorBusinessName/BusinessNameLine2Txt"/>
                                                         </xsl:call-template> 
              </div>
          ...
          <!--L1-10.2D5-->
          <div style="padding-top:1.5mm; width:140mm;height:auto;">
          ...
          <div style="width:47mm;height:auto;padding-top: 1mm; float: right;">
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  <xsl:call-template name="PopulateSpan">
                    <xsl:with-param name="TargetNode" select="$Form926Data/Owned10PercentForeignCorpInd"/>
                  </xsl:call-template>
                  <input type="Checkbox" class="styCkbox" alt="Transferee Specified 10 Percent Owned Foreign Corp Is Not a Controlled Foreign Corp Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/Owned10PercentForeignCorpInd"/>
                      <xsl:with-param name="BackupName">F926Owned10PercentForeignCorpInd</xsl:with-param>
                    </xsl:call-template>
                  </input>
                </span> &nbsp;
            <label>
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transferee Specified 10 Percent Owned Foreign Corp Is Not a Controlled Foreign Corp No">
            ...
            ........................                       
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Controlled By 5 or Fewer Domestic Corporations Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ControlledBy5OrFewerDomCorpInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Controlled By 5 or Fewer Domestic Corporations No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ControlledBy5OrFewerDomCorpInd"/>
                      <xsl:with-param name="BackupName">F926ControlledBy5OrFewerDomCorpInd</xsl:with-param>
                    </xsl:call-template>
            ...
            ..................                                      
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Remained in Existence After Transfer Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ExistedAfterTransferInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="height:auto;width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Remained in Existence After Transfer No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ExistedAfterTransferInd"/>
                      <xsl:with-param name="BackupName">F926ExistedAfterTransferInd</xsl:with-param>
                    </xsl:call-template>
          ...
          <div class="styBB" style="width:187mm;height:auto;display:table">
            <div style="float:left; clear:none; ">
              <div style="width:180mm;padding-left:8mm;padding-bottom:1mm;height:auto;">
            ...
            ..............................                      
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;height:auto;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Was It A Parent Corporation Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ParentCorporationInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;height:auto;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Was It A Parent Corporation No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ParentCorporationInd"/>
                      <xsl:with-param name="BackupName">F926ParentCorporationInd</xsl:with-param>
                    </xsl:call-template>
          ...
          <table class="styIRS926InerTable" cellpadding="0" cellspacing="0" border="0" style="display:table">
            <tr>
              ...
              <th style="width:1mm; border-left:1px solid black; border-bottom:1px solid black;border-top:1px solid black;"></th>
          ...
          <td style="width:1mm;border-bottom:1px solid black;"></td>
            ...
            <div style="float:right; padding-right:0.5mm">
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Basic Adjustments Under Section 367a4 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/BasicAdjusmentsSect367a5Ind"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Basic Adjustments Under Section 367a4 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/BasicAdjusmentsSect367a5Ind"/>
                      <xsl:with-param name="BackupName">F926BasicAdjusmentsSect367a5Ind</xsl:with-param>
                    </xsl:call-template>
 ...
 <xsl:choose>
            ...
            ........                                    
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Partner Picked up its Pro Rata Share of Gain on the Transfer of Partnership Assets Yes"> 
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrPickProRataShrGnTrnsfrInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Partner Picked up its Pro Rata Share of Gain on the Transfer of Partnership Assets No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrPickProRataShrGnTrnsfrInd"/>
                      <xsl:with-param name="BackupName">F926PrtnrPickProRataShrGnTrnsfrInd</xsl:with-param>
                    </xsl:call-template>
            ...
            ...............                                     
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is the partner disposing of its entire interest in the partnership Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrDispsngEntireIntPrtshpInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is the partner disposing of its entire interest in the partnership No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrDispsngEntireIntPrtshpInd"/>
                      <xsl:with-param name="BackupName">F926PrtnrDispsngEntireIntPrtshpInd</xsl:with-param>
                    </xsl:call-template>
            ...
            .............................
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is partner disposing interest in limited partnership regularly traded on established securities market Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrDisposingIntLtdPrtshpInd"/>
            ...
            <label>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is partner disposing interest in limited partnership regularly traded on established securities market No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PrtnrDisposingIntLtdPrtshpInd"/>
                      <xsl:with-param name="BackupName">F926PrtnrDisposingIntLtdPrtshpInd</xsl:with-param>
                    </xsl:call-template>
   ...
   <!-- 5b New for 2013  There must be a problem with the Schema because this field will not populate with the element for this line. I can make the field populate-->
            ...
            <div style="float:right; padding-right:0.5mm">
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is the transferee foreign corporation a controlled foreign corporation Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransfereeForeignCorpInd"/>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Is the transferee foreign corporation a controlled foreign corporation No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransfereeForeignCorpInd"/>
                      <xsl:with-param name="BackupName">F926TransfereeForeignCorpInd</xsl:with-param>
                    </xsl:call-template>
      ...
      Form <b style="font-size:8pt">926</b> (Rev. 11-2018)
      </div>
          </div>
     
          <!-- Begin page 2 Header-->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 926 (Rev. 11-2018)</div>
...
<!--Q10 YesCheckBox-->    
 ...
 <!---->                     
                  <input type="Checkbox" class="styCkbox" alt="Was cash the only property transferred Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/CashOnlyPropertyTransferredInd"/>
...
<!--Q10 NoCheckBox-->          
			<div style="width: 12mm; height: 4.5mm;">
                ...
                <input type="Checkbox" class="styCkbox" alt="Was cash the only property transferred No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/CashOnlyPropertyTransferredInd"/>
                      <xsl:with-param name="BackupName">F926CashOnlyPropertyTransferredInd</xsl:with-param>
                    </xsl:call-template>
...
<!-- BEGIN Part III Section B—Other Property (other than intangible property subject to section 367(d)) -->
          ...
          <div style="width:187mm;float:left;clear:left;" id="IRTP">
            ...
            <xsl:variable name="AGRowCount1" select="count($Form926Data/StocksAndSecuritiesPropertyGrp/TransferDt)"/>
                ...
                <xsl:variable name="AGRowCount3" select="count($Form926Data/InventoryPropSection367dGrp)"/>
                <xsl:if test="$AGRowCount3 = 0 or ((count($Form926Data/InventoryPropSection367dGrp) &gt; 1) and ($Print = $Separated))">
                  <tr>
                    <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;border-bottom-width: 0px;">
                    Inventory</td>
                    <td class="styIRS926TableCellA " style="width:24mm;">
                ...
                <xsl:if test="($Print != $Separated) or (count($Form926Data/InventoryPropSection367dGrp) &lt;= 1) ">
                  <xsl:for-each select="$Form926Data/InventoryPropSection367dGrp">
                    <tr>
                      <xsl:if test="position()=1">
                        <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;">
                ...
                <xsl:variable name="AGRowCount4" select="count($Form926Data/OthPropNotOthCatSection367dGrp)"/>
                <xsl:if test="$AGRowCount4 = 0 or ((count($Form926Data/OthPropNotOthCatSection367dGrp) &gt; 1) and ($Print = $Separated))">
                  <tr>
                    <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;border-bottom-width: 0px;">
                ...
                <!-- Adding check for the SRD -->
                <!-- Part III Table II L3-->
                <xsl:if test="($Print != $Separated) or (count($Form926Data/OthPropNotOthCatSection367dGrp) &lt;= 1) ">
                  <xsl:for-each select="$Form926Data/OthPropNotOthCatSection367dGrp">
                    <tr>
                      <xsl:if test="position()=1">
                        <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;">
                ...
                <xsl:variable name="AGRowCount5" select="count($Form926Data/BuiltInLossPropSection367dGrp)"/>
                <xsl:if test="$AGRowCount5 = 0 or ((count($Form926Data/BuiltInLossPropSection367dGrp) &gt; 1) and ($Print = $Separated))">
                  <tr>
                    <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;border-bottom-width: 1px;">
                ...
                <!-- Adding check for the SRD -->
                <!-- Part III Table II L4-->
                <xsl:if test="($Print != $Separated) or (count($Form926Data/BuiltInLossPropSection367dGrp) &lt;= 1) ">
                  <xsl:for-each select="$Form926Data/BuiltInLossPropSection367dGrp">
                    <tr>
                      <xsl:if test="position()=1">
                        <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;">
                          <xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount4"/></xsl:attribute>
                ...
                <xsl:variable name="AGRowCount15" select="count($Form926Data/TotalOtherPropSection367dGrp)"/>
                <xsl:if test="$AGRowCount15 = 0 or ((count($Form926Data/TotalOtherPropSection367dGrp) &gt; 1) and ($Print = $Separated))">
                  <tr>
                    <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;border-bottom-width: 1px;">
						Totals
					</td>
                ...
                <xsl:if test="($Print != $Separated)">
                  <xsl:for-each select="$Form926Data/TotalOtherPropSection367dGrp">
                    <tr>
                      <xsl:if test="position()=1">
                        <td class="styIRS926TableCellLine " style="width:34mm;vertical-align:middle;">
                          <xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount4"/></xsl:attribute>
...
<!--Q11a text--> 
              ...
              <div style="width:14mm; height: 4.5mm; padding-top:3mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transferor transfer stock or securities subject to section 367(a) with respect to which a gain recognition agreement was filed Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/StockOrSecuritiesTransferInd"/>
              ...
              <div style="width:12mm; height: 4.5mm; padding-top:3mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transferor transfer stock or securities subject to section 367(a) with respect to which a gain recognition agreement was filed No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/StockOrSecuritiesTransferInd"/>
                      <xsl:with-param name="BackupName">F926StockOrSecuritiesTransferInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q12a YesCheckBox-->    
 ...
 <!---->                     
                  <input type="Checkbox" class="styCkbox" alt="Were any assets of a foreign branch transferred to a foreign corporation Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ForeignBranchAssetTransferInd"/>
...
<!--Q12a NoCheckBox-->          
			<div style="width: 12mm; height: 9mm; padding-top:4mm;">
                ...
                <input type="Checkbox" class="styCkbox" alt="Were any assets of a foreign branch transferred to a foreign corporation No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ForeignBranchAssetTransferInd"/>
                      <xsl:with-param name="BackupName">F926ForeignBranchAssetTransferInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q12b Text-->  			
					<div style="width:138.5mm; height: 13.5mm; float:left;padding-top:1mm;">
					 Was the transferor a domestic corporation that transferred substantially all of the assets of a foreign branch (including a branch that is a foreign disregarded entity) to a specified 10&#x25;-owned foreign corporation?  If "Yes", continue to line 12c. If "No", skip lines 12c and 12d, and go to line 13.
				</div>
<!--Q12b DotLine-->  		
...
<!--Q12b YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt=" transferor a domestic corporation that transferred substantially all of the assets of a foreign branch Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/DomCorpAstTransferForeignBrInd"/>
...
<!--Q12b NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 9mm;padding-top:3mm; ">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt=" transferor a domestic corporation that transferred substantially all of the assets of a foreign branch No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/DomCorpAstTransferForeignBrInd"/>
                      <xsl:with-param name="BackupName">F926DomCorpAstTransferForeignBrInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q12c Text-->  			
					...
					Immediately after the transfer, was the domestic corporation a U.S. shareholder with respect to the transferee foreign
					 corporation?  If "Yes", continue to line 12d.  If "No", skip line 12d, and go to line 13. 
...
<!--Q12c YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="was the domestic corporation a U.S. shareholder with respect to the transferee foreigncorporation Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/DomesticCorpUSShareholderInd"/>
...
<!--Q12c NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 9mm;padding-top:3mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="was the domestic corporation a U.S. shareholder with respect to the transferee foreigncorporation No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/DomesticCorpUSShareholderInd"/>
                      <xsl:with-param name="BackupName">F926DomesticCorpUSShareholderInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q12d DotLine-->  		
              ...
              ......
				...
				<!-- A straight Line -->
				<span style="width:34mm;border-bottom:solid 1px;letter-spacing:0.25mm;">
				  <xsl:call-template name="PopulateAmount">
...
<!--Q13 YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did the transferor transfer property described in section 367 d 4 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IntangiblePropertyTrnsfrInd"/>
...
<!--Q13 NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 9mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did the transferor transfer property described in section 367 d 4 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IntangiblePropertyTrnsfrInd"/>
                      <xsl:with-param name="BackupName">F926IntangiblePropertyTrnsfrInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q13 NoLabel-->               
          ...
          <div class="styBB" style="width:187mm; height: auto;">
            <div class="styPartDesc" style=" width: 187mm; height: 1mm; padding-top:.5mm; border-top-style: solid; border-top-width: 1px;">Section C - Intangible Property Subject to Section 367(d)
            </div>       
    ...
    <xsl:call-template name="SetDynamicTableToggleRowCount">
      ...
      <xsl:with-param name="containerID" select=" 'IRTP' "/>
          ...
          <!-- Part III Table IV -->
          <div style="width:187mm;float:left;clear:left;" id="IRTP">
            <table class="styTable" id="IRS926PartIII" summary="Intangible Property Subject to Section 367(d)" cellspacing="0" >
              <thead class="styIRS926TableThead">
				<tr>
                  <th class="styIRS926TableCellLine " scope="col" 
					  style="width:34mm;text-align:center;border-bottom-width: 0px; border-top-width: 0px;vertical-align:top; ">
...
<!--Q14a Text-->  			
					<div style="width:151mm; height: 9mm; float:left; padding-top:1mm;">
						  ...
						  transfer, had a useful life reasonably<br/> anticipated to exceed 20 years?
						 <!--<span>
							<xsl:call-template name="SetFormLinkInline">
...
<!--Q14 YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transfer any intangible property that had useful life reasonably anticipated to exceed 20 years Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/UsefulLifeTransferInd"/>
...
<!--Q14a NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 4.5mm; padding-top:3mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transfer any intangible property that had useful life reasonably anticipated to exceed 20 years No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/UsefulLifeTransferInd"/>
                      <xsl:with-param name="BackupName">F926UsefulLifeTransferInd</xsl:with-param>
                    </xsl:call-template>
            ...
            <div style="float:right;clear:none;">
              <div class="styLNDesc" style="width:16mm; height: 4.5mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="did any of the transferred intangible property have an indefinite useful life Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IndfntUsefulLifeTransferInd"/>
              ...
              <div class="styLNDesc" style="width:12mm; height: 4.5mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="did any of the transferred intangible property have an indefinite useful life No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IndfntUsefulLifeTransferInd"/>
                      <xsl:with-param name="BackupName">F926IndfntUsefulLifeTransferInd</xsl:with-param>
                    </xsl:call-template>
            ...
            <div style="float:right;clear:none;">
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transferor choose to apply the 20-year inclusion period provided under Regulations section Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/Apply20YearInclusionPeriodInd"/>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transferor choose to apply the 20-year inclusion period provided under Regulations section No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/Apply20YearInclusionPeriodInd"/>
                      <xsl:with-param name="BackupName">F926Apply20YearInclusionPeriodInd</xsl:with-param>
                    </xsl:call-template>
          ...
          <div class="styIRS926Part2NBB" style="height:4.5mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:105mm;">
				 thereafter, a platform contribution as defined in Regulation section 1.482-7(c)(1)?
			  </div>
            ...
            <div style="float:right;clear:none;">
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="intangible property transferred considered or anticipated to be a platform contribution as defined in Regulation Yes ">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IntngblPropTrnsfrContriInd"/>
              ...
              <div class="styLNDesc" style="width:15mm;text-align:right;padding-top:0mm;padding-bottom:0mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="intangible property transferred considered or anticipated to be a platform contribution as defined in Regulation No ">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/IntngblPropTrnsfrContriInd"/>
                      <xsl:with-param name="BackupName">F926IntngblPropTrnsfrContriInd</xsl:with-param>
                    </xsl:call-template>
...
<!-- Begin Supplemental Information Area -->
          <div style="width:187mm;border-top:solid 1px;border-bottom:solid 1px;">
            <div class="styLNDesc" style="width: 128mm;">
              <span style="font-weight: bold">Supplemental Part III Information Required To Be Reported (see instructions)</span>
			</div>
          </div>
          <div>
<!-- A straight Line -->
            <span style="width:187mm;border-bottom:solid 1px; padding: 0.5mm 1mm;">
              ...
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[1]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[2]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[3]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[4]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[5]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[6]"/>
              </xsl:call-template> <br/><br/>
             
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[7]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[8]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[9]"/>
              </xsl:call-template> <br/><br/>
              
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form926Data/SupplementalInformationTxt[10]"/>
              </xsl:call-template> 
            </span>
            <br/>
          </div>        
...
<!--Q18a YesCheckBox-->    
 ...
 <!---->                     
                  <input type="Checkbox" class="styCkbox" alt="Transfer Gain Under Section 904 f 3 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferGainUnderSect904f3Ind"/>
...
<!--Q18a NoCheckBox-->          
			<div style="width: 12mm; height: 4.5mm;">
                ...
                <input type="Checkbox" class="styCkbox" alt="Transfer Gain Under Section 904 f 3 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferGainUnderSect904f3Ind"/>
                      <xsl:with-param name="BackupName">F926TransferGainUnderSect904f3Ind</xsl:with-param>
                    </xsl:call-template>
...
<!--Q18b YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Gain Under Section 904 f 5 F Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferGainUnderSect904f5FInd"/>
...
<!--Q18b NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 4.5mm; ">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Gain Under Section 904 f 5 F No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferGainUnderSect904f5FInd"/>
                      <xsl:with-param name="BackupName">F926TransferGainUnderSect904f5FInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q18c YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Recapture Under Section 1503 d Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferRcptrUndSect1503dInd"/>
...
<!--Q18c NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 4.5mm; ">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Recapture Under Section 1503 d No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TransferRcptrUndSect1503dInd"/>
                      <xsl:with-param name="BackupName">F926TransferRcptrUndSect1503dInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q18d YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Exchange Gain Under Section 987 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TrnsfrExchGainUndSect987Ind"/>
...
<!--Q18d NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 6mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Transfer Exchange Gain Under Section 987 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/TrnsfrExchGainUndSect987Ind"/>
                      <xsl:with-param name="BackupName">F926TrnsfrExchGainUndSect987Ind</xsl:with-param>
                    </xsl:call-template>
...
<!--Q19 YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transfer result from a change in entity classification Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ResultedInChangeClsfInd"/>
...
<!--Q19 NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 6mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="transfer result from a change in entity classification No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/ResultedInChangeClsfInd"/>
                      <xsl:with-param name="BackupName">F926ResultedInChangeClsfInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q20a YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did a domestic corporation make a distribution of property covered by section 367 e 2 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/CoverPropertyDistributionInd"/>
...
<!--Q20a NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 8mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did a domestic corporation make a distribution of property covered by section 367 e 2 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/CoverPropertyDistributionInd"/>
                      <xsl:with-param name="BackupName">F926CoverPropertyDistributionInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q20c Text-->  			
					<div style="width:152mm; height: 9mm; float:left;">
						...
						in the conduct of U.S. trade or business under Regulations section 1.367(e)-2(b)(2)?
...
<!--Q20c YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did domestic corporation not recongize gain or loss on distribution of property because property was used in the conduct of U.S. trade or business under Regulations section 1.367 e - 2 b 2 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PropDistriGainLossNotRcgnzInd"/>
...
<!--Q20c NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 9mm; padding-top:3mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did domestic corporation not recongize gain or loss on distribution of property because property was used in the conduct of U.S. trade or business under Regulations section 1.367 e - 2 b 2 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/PropDistriGainLossNotRcgnzInd"/>
                      <xsl:with-param name="BackupName">F926PropDistriGainLossNotRcgnzInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q21 YesCheckBox-->   
                ...
                <span>  
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did a domestic corporation make a section 355 distribution of stock in a foreign controlled corporation covered by section 367 e 1 Yes">
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/Section355StockDistributionInd"/>
...
<!--Q21 NoCheckBox-->       
              <div class="styLNDesc" style="width:12mm; height: 6mm; padding-top: 4mm;">
                <span>
                  ...
                  <input type="Checkbox" class="styCkbox" alt="Did a domestic corporation make a section 355 distribution of stock in a foreign controlled corporation covered by section 367 e 1 No">
                    <xsl:call-template name="PopulateNoCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form926Data/Section355StockDistributionInd"/>
                      <xsl:with-param name="BackupName">F926Section355StockDistributionInd</xsl:with-param>
                    </xsl:call-template>
...
<!--Q21 NoLabel-->               
          ...
          <div style="width:187mm;height: auto; padding-top:1mm; border-top-style: solid; border-top-width: 1px;">
            ...
            Form <span class="styBoldText">926 </span> (Rev. 11-2018)
            <div class="pageEnd"/>
        </div>
          </div>
          <!-- End Footer -->
          ...
          <xsl:if test="($Print = $Separated) and  (count($Form926Data/ControllingShareholder) &gt; 6)">
            <div class="pageEnd"/>
            <span class="styRepeatingDataTitle">Form 926; Part I - U.S. Transferor Information; Line 2b -- If not, list the controlling shareholder(s) and their identifying number(s):</span>
        ...
        <xsl:if test="(count($Form926Data/CashPropertyGrp/TransferDt) &gt;1) and ($Print = $Separated)">
            ...
            <br/>
            <br/>
            <span class="styRepeatingDataTitle">Form 926; Part III - Information Regarding Transfer of Property; Section A -- (Cash)</span>
            <div style="width:187mm;float:left;clear:left;" id="IRTP">
          ...
          <!-- End separated data for Section A Cash Line Table-->
           <!-- Begin separated data for Section B Stock and Securities Line Table-->
          <!-- Stock and Securities table header -->
          <xsl:if test="(count($Form926Data/StocksAndSecuritiesPropertyGrp) &gt;1) and ($Print = $Separated)">
            <div class="pageEnd"/>
            <br/>
            <br/>
            <span class="styRepeatingDataTitle">Form 926; Part III - Information Regarding Transfer of Property, Section B -- Other Property (other than intangible property subject to section 367(d)) </span>
            <div style="width:187mm;float:left;clear:left;" id="IRTP">
              ...
              cellspacing="0" style="font-family:verdana;font-size:7pt;display:table">
                ...
                <tfoot/>
                <tbody>
                  <!--Section B Stock and securities line repeating data -->
          ...
          <!-- Begin separated data for Intangible Property Subject to Section 367(d)(4) Line Table-->
          ...
          <xsl:if test="(count($Form926Data/IntangiblePropertyDetailGrp) &gt;1) and ($Print = $Separated)">
            ...
            <br/>
            <span class="styRepeatingDataTitle">
				Form 926; Part III, Information Regarding Transfer of Property; Section C -- Intangible Property Subject to Section 367(d)</span>
            <div style="width:187mm;float:left;clear:left;" id="IRTP">
              <table class="styDepTable" id="IRS926PartIII" summary="Property not qualifying for Active Trade or Business exception" 
				  cellspacing="0" style="font-family:verdana;font-size:7pt;display:table">
                <thead class="styDepTableThead">

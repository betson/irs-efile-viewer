		...
		<!-- Page Header -->
				 <div style="width:187mm">	
					<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
						Form 8863 (2019)<span style="width:148mm;"/>						
...
2019 at an eligible educational institution in a program leading towards a postsecondary degree, certificate, or other recognized postsecondary educational credential? See instructions.
										</div>
									</td>
									<td class="styTableCell" style="font-size:7pt;width:50%;border-color:black;text-align:left;border-right-width:0px">
										<xsl:call-template name="PopulateSpan">
...
enter
					...
					<div style="width:187mm;padding-top:0mm;border-top-width:1px;">
						<div style="width:100%;text-align:right">
							Form <span class="styBoldText" style="font-size:8pt;">8863</span> (2019) 
						</div>
					</div>
					</div>
	</xsl:template>
				  ...
				  <div style="width:187mm">
					...
					<div class="styBB" style="width:187mm;height:23.5mm;">
						...
						<div class="styTYBox" style="width:31mm; height:100%">
							...
							<div class="styTaxYear" style="font-size:21pt;padding-top:1.5mm;padding-bottom:1.5mm;">20<span class="styTYColor" style="font-size:21pt">19</span>
							</div>
	...
	<!--						<span style="float:right;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="font-size:7pt;width:142mm;height:4mm;padding-top:0mm;">
							...
							<span style="float:left;"> Form 1040 or 1040-SR, line 18c. Then go to line 9 below</span>
                            <!--Dotted Line -->
						    <span class="styDotLn" style="float:right;padding-right:1mm;">.................</span>	
						</div>
						</span>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="font-size:7pt;width:104.98mm;height:4mm;">
			                Enter: $136,000 if married filing jointly; $68,000 if single, head of 
			                <span style="float:left;">household, or qualifying widow(er)</span>
                            <!--Dotted Line-->
                            <span class="styDotLn" style="float:right;padding-right:1mm;">..............</span>
						</div>
					...
					<div style="width:187mm;border-bottom:1px solid black">
						...
						<div class="styLNDesc" style="width:142mm;height:5mm;padding-top:1mm;">
							...
							<span style="float:left;">(see instructions) here and on Schedule 3 (Form 1040 or 1040-SR), line 3</span>
                            <!--Dotted Line-->
                            <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
						</div>
						</span>

				...
				<form id="Form1040X">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:1px solid black;padding-top:2px;">
						...
						<input type="checkbox" class="styCkboxNM" style="margin-left:4mm;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AmendedReturnForCalendarYrCd"/>
								<xsl:with-param name="DisplayedCheckboxValue" select="2017"></xsl:with-param>
								<xsl:with-param name="BackupName">F1040XAmendedReturnForCalendarYrCd[2017]</xsl:with-param>
							</xsl:call-template>
						</input>
						<label style="padding-left:0.7mm;">
							<xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="DisplayedCheckboxValue" select="2017"></xsl:with-param>
								<xsl:with-param name="BackupName">F1040XAmendedReturnForCalendarYrCd[2017]</xsl:with-param>
							</xsl:call-template>2017</label>
						<input type="checkbox" class="styCkboxNM" style="margin-left:4mm;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AmendedReturnForCalendarYrCd"/>
								<xsl:with-param name="DisplayedCheckboxValue" select="2016"></xsl:with-param>
								<xsl:with-param name="BackupName">F1040XAmendedReturnForCalendarYrCd[2016]</xsl:with-param>
							</xsl:call-template>
						</input>
						<label style="padding-left:0.7mm;">
							<xsl:call-template name="PopulateLabel">
					...
					<div class="styStdDiv">
						...
						<div class="styGenericDiv" style="width:80mm;height:12mm;padding-top:6px;padding-left:2px;border-left:1px solid black;border-bottom:1px solid black;">
							...
							If amending a 2019 return, leave blank. See instructions.
						</div>
					</div>
					<div class="styStdDiv" style="padding-top:2px;padding-bottom:4px;">
						...
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="DisplayedCheckboxValue" select="5"/>
								<xsl:with-param name="BackupName">F1040XIndividualReturnFilingStatusCd[4]</xsl:with-param>
							</xsl:call-template>Qualifying widow(er) (QW)
						</label> 	
					</div>
					<div class="styStdDiv" style="padding-bottom:2px;">
						If you checked the MFS box, enter the name of spouse. If you checked the HOH or QW box, enter the child's name if the qualifying <br /> 
					...
					<div class="styStdDiv">
						...
						<div class="sty1040XAmtBox" style="height:7.5mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/OriginalRptOrAsPrevAdjGrp/TotalCreditsAmt" />
							</xsl:call-template>
						</div>
						<div class="sty1040XAmtBox" style="height:7.5mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/NetChangeOrigRptOrPrevAdjGrp/TotalCreditsAmt" />
							</xsl:call-template>
						</div>
						<div class="sty1040XAmtBox" style="height:7.5mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/CorrectNumberOrAmountGrp/TotalCreditsAmt" />
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 8 -->
					...
					<div class="styStdDiv" style="border-top:1px solid black;">
						<div class="sty1040XDesc" style="width:90mm;font-weight:bold;font-size:8pt;height:4mm;">Payments</div>
						<div class="sty1040XRightNumBoxNBB" style="height:4mm"></div>
						<div class="sty1040XAmtBox" style="height:4mm;border-bottom-width:0px;"></div>
						<div class="sty1040XAmtBox" style="height:4mm;border-bottom-width:0px;"></div>
						<div class="sty1040XAmtBox" style="height:4mm;border-bottom-width:0px;"></div>
					</div>
					<!-- Line 12 -->
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">1040-X</span> (Rev. 1-2020)</span>
					</div>
					<div class="styStdDiv">
					...
					<div class="styStdDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;">
						Complete this part <strong>only</strong> if any information relating to exemptions (to dependents if amending your 2018 or later return) has changed 
					...
					<div class="styStdDiv">
						...
						<div class="sty1040XDesc" style="height:16mm;">
							...
							on line 4a on page 1 of this form. <br /> 
							If amending your 2018 or later return, leave line blank 
							<span class="sty1040XDotLn">...</span>
						</div>

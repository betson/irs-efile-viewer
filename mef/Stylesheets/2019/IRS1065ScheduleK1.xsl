							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2019, or tax year</span>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 10mm;border-top-width:0;">
										...
										<xsl:choose>
											<xsl:when test="$FormData/DomesticPartnerInd">
												<div style="float:left;clear:none;">
													<span style="font-weight: bold; width:2mm;height:4mm;">H1</span>
										...
										<div style="float:left;clear:none;">
											<span style="font-weight:bold; width:2mm;">H2</span>
											<input type="checkbox" class="styckbox" name="checkbox">
												<xsl:call-template name="PopulateCheckbox">
							...
							<table width="93mm" border="0" cellpadding="0" cellspacing="0" style="border-top: 2px solid black; border-bottom: 0px; border-left: 1px solid black;          border-right: 2px solid black;">
								...
								<tr>
									<td colspan="2" style="font-family: Verdana; font-size: 7pt;text-align: left;border-top: 1px solid black;padding-top:2mm;">
										<!-- Line 21 -->
										<span style="font-weight: bold; width: 2mm;">21</span>
										<span style="width: 1mm;"/>
										<span style="width: 80mm;">
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
					...
					<tr>
					    ...
					    font-size: 6pt;font-weight: bold; border-top: 1px solid black;">
						   ...
						   Instructions for Form 1065.
							...
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2019</span>
						</td>
					</tr>
				</table>

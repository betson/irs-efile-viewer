			...
			<body class="styBodyClass" style="width:187mm;">
				<form id="IRS1040ScheduleE">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:30mm;height:23mm;">
							<div style="padding-top:1mm;line-height:100%;">
								...
								<span class="styFormNumber" style="font-size:9pt;padding-top:2mm;">(Form 1040 or 1040-SR)</span>
					...
					<div class="pageEnd" style="width:187mm;page-break-after:always;display:block;">
                        ...
                        <span class="styBoldText" style="font-size:7pt;padding-top:.0mm;padding-left:5mm;float:right;">Schedule E (Form 1040 or 1040-SR) 2019</span>
                    </div>
					<p class="pageEnd" style="page-break-after:always;display:block;"/>
					<!-- end page 1 footer -->
					<!-- Page 2 -->
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040 or 1040-SR) 2019</span>
                  ...
                  lncome or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
						...
						<div class="pageEnd" style="height:6mm;width:187mm;">
							...
							<div class="stySmallText" style="width:66mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040 or 1040-SR) 2019</span>
							</div>
						</div>
					</div>
					<!-- end page 2 footer -->

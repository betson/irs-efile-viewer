...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <div class="styIRS8839LineItem" style="height:13mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 7 more than $211,160<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  <span>
                  ...
                  <label>
                    ...
                    <span style="width:5px;"/>Subtract $211,160 from line 7
					<!--Dotted Line-->
 ...
 <!--               <div style="width:187mm;">
            ...
            <div class="styIRS8839LineItem" style="height:7mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Credit carryforward, if any, from prior years. See your Adoption Credit Carryforward Worksheet in the<br/>2018 Form 8839 instructions
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;padding-right:1mm;">..........................</span>	
                </div>
              </div>
            ...
            <div class="styIRS8839LineItem" style="height:10mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  <b>Adoption Credit.</b> Enter the smaller of line 14 or line 15 here and on Schedule 3 (Form 1040 or 1040-SR),<br />line 6, or Form 1040-NR, line 51. Check box <b>c</b> on that line and enter <b>"8839"</b> in the space next to box <b>c</b>. If line 15 is smaller than line 14, you may have a credit carryforward (see instructions)
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>	
                </div>
              </div>
            ...
            <div style="float:left;clear:all;">
              <span class="styBoldText">
                ...
                <span style="font-size:7pt;">			   Cat. No. 22843L					</span>
                 <span style="width:24.1mm;"/>   Form <span class="styBoldText" style="font-size:8pt;">8839</span> (2019)
            </div>
          </div>
		  ...
		  <xsl:otherwise>
               ...
               <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
                 ...
                 child with special needs and the<br/>
                  adoption became final in 2019,<br/>
          ...
          <xsl:with-param name="Number">22</xsl:with-param>
            ...
            <div class="styIRS8839LineItem" style="height:18mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;padding-top:3mm;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 23 more than $211,160<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  ...
                  <label>
                    ...
                    <span class="styBoldText">Yes.</span>
                    <span style="width:4px;"/>Subtract 211,160 from line
                    23             
                  </label>
                </div>
              </div>
...
<!--                <div style="width:187mm;">
                  ...
                  <div style="padding:0px 0px 0px 0px;width:100%;height:100%;">
                    <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
                     ...
                     <input type="checkbox" alt="ExcludedBenefitsMoreThanEmployerProvidedAdoptionBenefits No" class="styCkbox" >
                      ...
                      <label>
                        ...
                        <span style="width:11mm;"/>line 1 of Form 1040 or 1040-SR or line 8 of Form 1040-NR. On the dotted line next to line<br/>
                        <span style="width:11mm;"/>1 of Form 1040 or 1040-SR or line 8 of Form 1040-NR, enter “AB.”<br/>
                      </label>
                      <!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
                      <span style="width:1mm;"/>
                      <span>
                   ...
                   <input type="checkbox" alt="ExcludedBenefitsMoreThanEmployerProvidedAdoptionBenefits Yes" class="styCkbox">
                      ...
                      <label>
                        ...
                        <span style="width:11mm;"/>the total you would enter on line 1 of Form 1040 or 1040-SR or line 8 of Form 1040-NR by<br/>
                        <span style="width:11mm;"/>the amount on Form 8839, line 29. Enter the result on line 1 of Form 1040 or 1040-SR<br/>
                        <span style="width:11mm;"/>or line 8 of Form 1040-NR. Enter "SNE" on the dotted line next to the entry line.
                      </label>
                    </div>
          ...
          <div class="styTBB" style="width:187mm;height:25mm;">
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:88%;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You paid adoption expenses in 2018, those expenses were not fully reimbursed by your employer or otherwise, <br/>
                  <span style="width:10px;"/>and the adoption was not final by the end of 2018.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>The total adoption expenses you paid in 2019 were not fully reimbursed by your employer or otherwise, <br/>
                  <span style="width:10px;"/>and the adoption became final in 2019 or earlier.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 5px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You adopted a child with special needs and the adoption became final in 2019.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;clear:all;">
            <div style="float:right;">
              ...
              Form  <span class="styBoldText" style="font-size:7pt;">  8839 </span> (2019)
            </div>
          </div>
          <!-- END Page Break and Footer-->          
  ...
  <xsl:template name="CreateTableHeaders">
    ...
    <tr>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        ...
        <br/>Check if<br/>adoption<br/>became final in 2019 or earlier</th>
    </tr>
    <tr>
      <xsl:if test="$AddColoredHeaders">
        <xsl:attribute name="class">styDepTblHdr</xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="2">
        ...
        <br/>born <b>before<br/>2002</b> and<br/>disabled</th>
      <th class="styTableCellHeader" scope="col" rowspan="2">
        <xsl:attribute name="style">
          border-color:black;width:8mm;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
      ...
      <div class="styIRS8839LNDesc" style="width:48mm;height:100%;padding:0px 0px 0px 0px;border-color:black;">
        <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
         <span style="float:left;padding-right:6mm;">Maximum adoption credit per</span>
          <span style="float:left;">child.  Enter $14,080 (see instructions)
          <!--Dotted Line-->
    ...
    <div class="styIRS8839LineItem" style="height:18mm;">
      ...
      <div class="styIRS8839LNDesc" style="width:48.5mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          ...
          benefits you received in 2019.<br/>
          This amount should be shown<br/>
          in box 12 of your 2019 Form(s)<br/>
          W-2 with code <b>T</b>
          <!--Dotted Line-->

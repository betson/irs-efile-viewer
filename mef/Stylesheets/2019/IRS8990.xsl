...
<!DOCTYPE xsl:stylesheet [<!ENTITY nbsp "&#160;"> <!ENTITY mdash "&#8212;">]>
  <!-- Last Modified by Iskilu Lawal on 6/21/2020 UWR # 232917 Drop 2 R10.4 -->
			...
			<body class="styBodyClass">
				<form id="Form8990">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc">
							Tentative taxable. See instructions
							<span class="sty8990DotLn">.......................</span>
						</div>
					...
					<div class="sty8990BlockLn">
						Additions <span style="font-weight:normal;">(adjustments to be made if amounts are included on line 6)</span>
					</div>
					<!-- Line 7 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:7mm;width:98mm;">
							Deduction for depreciation, amortization, or depletion <br /> attributable to a trade or business. See instructions
							<span class="sty8990DotLn">........</span>
						</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8990</strong> (Rev. 12-2019)</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="sty8990SectionLn" style="border-top-width:0px;">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:7mm;width:98mm;">
							Multiply adjusted taxable income (line 22) by 30% (0.30). <br /> See instructions
							<span class="sty8990DotLn">...................</span>
						</div>
						<div class="styLNRightNumBox" style="height:7mm;"><br />26</div>
						<div class="styLNAmountBox" style="height:7mm;padding-right:0.5mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AdjTaxableIncomeSpcfdPctAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:7mm;background-color:lightgrey;">&nbsp;</div>
						<div class="styLNAmountBoxNBB" style="height:7mm;">&nbsp;</div>
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" rowspan="2" scope="col" style="width:26mm;font-weight:normal;">
										<span style="font-weight:bold;">(h) </span> Excess business interest expense treated as paid or accrued <br /> (see instructions)
									</th>

	...
	<xsl:template match="/">
      ...
      20<span class="styTYColor">19</span>
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:auto;width:182mm;float:left;clear:none;">For the 2019
...
<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span> (2019)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="width:187mm;padding-top:1mm;">
						<div style="float: left; clear: none">Form 990-EZ (2019)</div>
						<div style="float:right">
...
-->
	...
	<!-- </label> -->
					...
					<!--   BEGIN FORM FOOTER  -->
					<div style="width:187mm;">
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2019)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>

...
<!--Created by Doug Peterson 6-27-2006 submitted for inspection 7-13-2006--><!-- Last Modified by Steven Fook on 6/13/2019 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <body class="styBodyClass">
    <form name="Form1065ScheduleC">
     ...
     <div class="styTBB" style="width:187mm;">
        <div class="styFNBox" style="height:19mm;width:26mm;">
        ...
        <div class="styFTBox" style="width:134mm;">
          <div class="styMainTitle" style="padding-top:1mm;">Additional Information for Schedule M-3 Filers</div>
            ...
            <div class="styFBT">
            <img src="{$ImagePath}/1065SchC_Bullet.gif" alt="Bullet"/> Information about Schedule C (Form 1065) and its instructions is at
				<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form1065" title="Link to IRS.gov">               
					<i>www.irs.gov/Form1065</i>.
				</a>
           </div> 
        </div>
        <div class="styTYBox" style="width:27mm;height:19mm;">

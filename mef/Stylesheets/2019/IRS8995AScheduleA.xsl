			...
			<body class="styBodyClass">
				<form id="Form8995AScheduleA">
					...
					<div class="sty8995ASALineDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;">
						...
						income is more than $160,700 but not $210,700 ($160,725 but not $210,725 if married filing separately; $321,400 and $421,400 
						if married filing jointly). If your taxable income isn’t more than $160,700 ($160,725 if married filing separately; $321,400 if married 
						filing jointly) and you’re not a patron of an agricultural or horticultural cooperative, don’t file this form; instead, file Form 8995, 
						Qualified Business Income Deduction Simplified Computation. Otherwise, complete Schedule D (Form 8995-A) before beginning 
						Schedule A. If your taxable income is more than $210,700 ($210,725 if married filing separately; $421,400 if married filing jointly), 
						your specified service trade or business doesn’t qualify for the deduction. If you have more than three trades or businesses attach 
						as many Schedules A as needed. See instructions.
					</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 8995-A) 2019</span>
					</div>

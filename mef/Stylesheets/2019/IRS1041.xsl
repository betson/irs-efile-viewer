	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
		...
		<html lang="EN-US">
				...
				<form id="Form1041">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2019 or fiscal year beginning 
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Business income or (loss). Attach Schedule C (Form 1040 or 1040-SR)
										<xsl:call-template name="SetFormLinkInline">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Rents, royalties, partnerships, other estates and trusts, etc. Attach Schedule E (Form 1040 or 1040-SR)
										<xsl:call-template name="SetFormLinkInline">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Farm income or (loss). Attach Schedule F (Form 1040 or 1040-SR)
										<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2019 net 965 tax liability paid from Form 965-A, Part II, column (k), line 3</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">
										<b>Payments: a</b> 2019 estimated tax payments and amount applied from 2018 return
										<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25a</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; " >
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25b</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								<div class="styLNLeftNumBox" style="height:4mm;padding-left:4.2mm;">c</div>
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Subtract line 25b from line 25a</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="20"/>
										</xsl:call-template>			  
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25c</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPaymentsAmt" />
									</xsl:call-template>     
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25d</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
		  ...
		  --><!--Line 25e--><!--
			...
			<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25e</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/FederalIncomeTaxWithheldAmt" />
				</xsl:call-template>     
		...
		--><!--Line 25f--><!--
							<div style="width:181.8mm;font-size:7pt;float:left;">
								<div class="styLNLeftNumBox" style="height:4mm;padding-left:4.2mm;">f</div>
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2019 net 965 tax liability from Form 965-A, Part I, column (f), line 2</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25f</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
		  ...
		  --><!--Line 25h--><!--
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				...
				<span style="float:left;padding-left:1mm;padding-right:1mm;font-size:6pt;"><b>g </b>Form 2439
					<xsl:call-template name="SetFormLinkInline">
				...
				<span style="float:left;padding-left:1mm;padding-right:1mm;font-size:6pt;">; <b>h </b>Form 4136
					<xsl:call-template name="SetFormLinkInline">
			...
			<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">25i</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 26-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><!--<b>Total payments.</b>-->Total payments (from Schedule G, Part II, line 17)</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="13"/>
					</xsl:call-template>		  
		  ...
		  <!--Line 30-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Amount on line 29 to be:  a Credited to 2020<span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
				...
				<span style="float:left;padding-left:1mm;padding-right:1mm;font-weight;">: b Refunded</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>				  
				</span>
			   </div>
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2019)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2019)</span>
	...
	<!--Line 4-->
		  ...
		  <!--Line 7-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Household employment taxes. Attach Schedule H (Form 1040 or 1040-SR)
				<xsl:call-template name="SetFormLinkInline">
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
			...
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">10</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">2019 Estimated tax payments and amount applied from 2018 return
				<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 25a - Estimated Tax Credited To Trust Code</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxCreditedToTrustGrp/EstimatedTaxCreditedToTrustCd" />
										</xsl:call-template>
		  ...
		  <!--Line 15-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">15</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;"><!--<b>Income distribution deduction. </b>--> 2019 net 965 tax liability from Form 965-A, Part I, column (f), line 3 </span>
			  ...
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Other Payments:</span>
									<span style="float:left;font-size:6pt;padding-left:1mm;padding-right:1mm;">
										<b>a: </b>Form 2439
										<xsl:call-template name="SetFormLinkInline">
                                    <xsl:with-param name="TargetNode" select="$FormData/TaxPaidByRICOrREITAmt"/></xsl:call-template>
                                     </span>
									<span style="border-bottom:1px dashed;float:left;height:3mm;width:25mm;font-size:6pt;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TaxPaidByRICOrREITAmt" />
									...
									<span style="float:left;font-size:6pt;padding-left:1mm;padding-right:1mm;">
										<b>b: </b>Form 4136
										<xsl:call-template name="SetFormLinkInline">
                                    <xsl:with-param name="TargetNode" select="$FormData/TotalFuelTaxCreditAmt"/></xsl:call-template>
                                     </span>
									<span style="float:left;border-bottom:1px dashed;height:3mm;width:25mm;font-size:6pt;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalFuelTaxCreditAmt" />
		  ...
		  <!--Line 17-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">17</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;"><b>Total payments.</b> Add lines 12 through 15 and 16c. Enter here and on page 1, line 26
				<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPaymentsAmt"/>
										</xsl:call-template>
										</span>
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">17</div>
			  <div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/TotalPaymentsAmt" />
				</xsl:call-template>     
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;height:auto;">At any time during calendar year 2018, did the estate or trust have an interest in or a signature or other authority</span>
		 ...
		 <!--Line 4-->
		  ...
		  <!--Line 12 (2)-->
			...
			<div style="width:187mm;font-size:7pt;float:left;border-bottom:0px solid black;">
				<div class="styLNLeftNumBox" style="height:4mm;">13</div>
				<div class="styLNDesc" style="width:159mm;height:4mm;">
					<span style="float:left;">ESBTs only. Does the ESBT have a non-resident alien grantor? If "Yes",  see instructions.</span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="10"/>
					</xsl:call-template>	
			...
			<div style="width:187mm;font-size:7pt;float:left;border-bottom:1px solid black;">
				<div class="styLNLeftNumBox" style="height:4mm;">14</div>
				<div class="styLNDesc" style="width:159mm;height:4mm;">
					<span style="float:left;">ESBTs only. Did the S portion of the trust claim a qualified business income deduction? If "Yes",  see instructions.</span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="3"/>
					</xsl:call-template>	

  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      Name(s) shown on return<br/>
       ...
       <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Individuals. Enter the sum of the amounts from Form 1040 or Form 1040-SR, line 12a, and Schedule 2 (Form 1040 or 1040-SR), line 2; or the sum of the amounts from Form 1040-NR, lines 42 and 44.<br/>

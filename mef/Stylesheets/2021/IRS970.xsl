        ...
        <form name="Form970">
          ...
          Form <span class="styFormNumber">970</span>
            ...
            <div class="styFTBox" style="width:125mm;height:19mm;">
              ...
              <br/>
              <div class="styFST" style="height:3mm;padding-top:4mm;">
                <img src="{$ImagePath}/970_Bullet.gif" alt="bullet image"/>
                  Attach to your tax return.
               </div>
                <br/>
                 <div class="styFST" style="height:5mm;padding-top:3.5mm;">
                <img src="{$ImagePath}/970_Bullet.gif" alt="bullet image"/>
                  Go to 
                 <a href="http://www.irs.gov/Form970. " title="Link to irs.gov">
                    <i>www.irs.gov/Form970 </i> for the latest information.
            </a>
              </div>
            </div>
         ...
         <div class="styBB" style="width:187mm;height:auto;clear:both;">
                   ...
                   <xsl:choose>
                        <xsl:when test="ApplicantBusinessName !=''">
                          <xsl:call-template name="PopulateText">
                            <xsl:with-param name="TargetNode" select="ApplicantBusinessName/BusinessNameLine1Txt"/>
                            </xsl:call-template>
                        <xsl:if test="ApplicantBusinessName/BusinessNameLine2Txt !=''">
                <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="ApplicantBusinessName/BusinessNameLine2Txt"/>
                </xsl:call-template>
              </xsl:if>,
              	 ...
              	 <xsl:choose>
                        <xsl:when test="ApplicantPersonNm !=''">
                          <xsl:call-template name="PopulateText">
                            <xsl:with-param name="TargetNode" select="ApplicantPersonNm"/>
                            </xsl:call-template>,
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS970LNYesNoBox" style="width:10.4mm;height:3.5mm;text-align:center;font-weight:bold;padding-top:.7mm;border-bottom-width:0px;padding-top:0mm;padding-bottom:0mm;">Yes</div>
            <div class="styIRS970LNYesNoBox" style="width:10.4mm;height:3.5mm;text-align:center;font-weight:bold;padding-top:.7mm;border-bottom-width:0px;padding-top:0mm;padding-bottom:0mm;">No</div>
          </div>
          <!-- END Part I  Title -->
          <!--Begin Part I -->
          ...
          <span style="width:2px"/>
              ...
              <span class="styUnderlineAmount" style="width:18mm; float:none;text-align:left;">
                <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode" select="$Form970/ElectsLIFOMethodForFrstTYEndDt"/>
                </xsl:call-template>
              </span>
              <br/>
            ...
            <div class="styShadingCell" style="height:10mm;width:10.4mm;"/>
            <div class="styShadingCell" style="height:10mm;width:10.4mm;"/>
          </div>
          ...
          <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styShadingCell" style="height:100%;width:10.4mm;"/>
            <div class="styShadingCell" style="height:100%;width:10.4mm;"/>
          </div>
          ...
          the applicant in the prior tax year for the goods covered by this election.
            ...
            <div class="styShadingCell" style="height:100%;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styShadingCell" style="height:100%;width:10.4mm;border-bottom: solid 1px;"/>
          </div>
          ...
          <span style="width:2px;"/>
           ...
           <span style="letter-spacing:4mm;font-weight:bold">...........</span>
            ...
            <div class="styIRS970LNYesNoBox" style="height:4.5mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/LIFOMthdCurrUsedForOthGoodsInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:4.5mm;width:10.4mm;">
          ...
          <!--Dotted Line-->
           <span style="letter-spacing:4mm;font-weight:bold;">.......</span>
            ...
            <div class="styIRS970LNYesNoBox" style="height:6mm;padding-top:2mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/LIFOInventoryMethodUsedBfrInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:6mm;padding-top:2mm;width:10.4mm;">
              <xsl:call-template name="PopulateNoBoxText">
...
<!--  Line 5  -->          
          ...
          <span style="width:2px"/>
           <xsl:call-template name="SetFormLinkInline">
              ...
              <br/>
                ...
                <xsl:for-each select="$Form970/LIFOMethodGoodsTxt">
          ...
          Attach a statement if necessary.
            ...
            <div class="styShadingCell" style="height:21.5mm;width:10.4mm;"/>
            <div class="styShadingCell" style="height:21.5mm;width:10.4mm;"/>
          </div>
          <!--End Part I -->
          <!-- BEGIN Part II Title -->
          ...
          <!--Dotted Line-->
            ...
            <div class="styIRS970LNYesNoBox" style="height:7.6mm;padding-top:3.5mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/ClsInventoriesValuedForPrTYInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:7.6mm;padding-top:3.5mm;width:10.4mm;">
              <xsl:call-template name="PopulateNoBoxText">
          ...
          <!--Dotted Line-->
            ...
            <div class="styShadingCell" style="height:3.4mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styShadingCell" style="height:3.4mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styIRS970LNYesNoBox" style="height:4.1mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          section 472(d) over a 3-year period?
            ...
            <div class="styIRS970LNYesNoBox" style="height:4.9mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/AdjIncludedInIncomeOver3YrsInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:4.9mm;width:10.4mm;">
              <xsl:call-template name="PopulateNoBoxText">
          ...
          total cost of those goods divided by the total number of units on hand?
            ...
            <div class="styShadingCell" style="height:3.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styShadingCell" style="height:3.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styIRS970LNYesNoBox" style="height:4mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <!--Dotted Line-->
            ...
            <div class="styShadingCell" style="height:6.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styShadingCell" style="height:6.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styIRS970LNYesNoBox" style="height:3.9mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styShadingCell" style="height:6mm;;width:10.4mm;"/>
            <div class="styShadingCell" style="height:6mm;width:10.4mm;"/>
          </div>
          <div style="width:187mm;height:3mm;">
            <div class="styLNLeftNumBoxSD" style="padding-top:0mm;padding-left:4mm;"></div>
          ...
          <!--Dotted Line-->
            ...
            <div class="styIRS970LNYesNoBox" style="height:4.5mm;width:10.4mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/InventoryNotTakenAtActlCostInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:4.5mm;width:10.4mm;">
              <xsl:call-template name="PopulateNoBoxText">
          ...
          <!--Dotted Line-->
            ...
            <div class="styShadingCell" style="height:9.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styShadingCell" style="height:9.5mm;width:10.4mm;border-bottom: solid 1px;"/>
            <div class="styIRS970LNYesNoBox" style="height:4mm;border-bottom-width:0px;width:10.4mm;border-bottom: solid 1px;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form970/SectionAdjustmentAgreementInd"/>
              </xsl:call-template>
            </div>
            <div class="styIRS970LNYesNoBox" style="height:4mm;border-bottom-width:0px;width:10.4mm;border-bottom: solid 1px;">
              <xsl:call-template name="PopulateNoBoxText">
          ...
          <div  class="pageEnd"  style="width:187mm;padding-top:1mm;float:none;">
            ...
            <div style="float:right;">
              ...
              Form <span class="styBoldText"> 970 </span> (Rev. 11-2020)
        </div>
          </div>
          <!-- End Footer -->
          <br style="float:none;"/>
          <div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
            <div style="float:left;">Form 970 (Rev. 11-2020)<span style="width:100mm;"/>
            </div>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/ActCostGdsMostRctPrchsPrdcdInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/AvgCostOfGdsPrchsPrdcdDurYrInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/ActlCostGdsPrchsPrdcdAcqOrdInd"/>
          ...
          <div class="styBB" style="width:187mm;height:7mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/OtherMethodUsedInd"/>
          ...
          this election (for example, double-extension method, link-chain method, or index method).
           ...
           <xsl:call-template name="SetFormLinkInline">
                <xsl:with-param name="TargetNode" select="$Form970/LIFOCmptMthdDolVlPoolingDesc"/>
              </xsl:call-template>
              </span>
              <xsl:for-each select="$Form970/LIFOCmptMthdDolVlPoolingDesc">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="."/>
                </xsl:call-template>
                <br/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/DollarVlMthdCostOfGdsPrchsInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/DolVlMthdAvgCostOfGdsPrchInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/DolVlMthdCostOfGdsPrchsOrdInd"/>
          ...
          <div class="styBB" style="width:187mm;height:7mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/DollarValueOtherMethodUsedInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/DoubleExtensionIPICMethodInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/LinkChainIPICMethodInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/ConsumerPriceIndexDtlRptInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/ProducerPriceIndexDtlRptInd"/>
          ...
          <div style="width:187mm;height:4mm;padding-left:8mm;">
            <input type="checkbox" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="$Form970/OtherTablePPIDetailedReportInd"/>
          ...
          <xsl:call-template name="LinkToLeftoverDataTableInline">
                ...
                <xsl:with-param name="TargetNode" select="$Form970/MonthBLSPriceIndexRepDt"/>
              </xsl:call-template>
              <br/>
          See instructions and attach a statement if necessary.
          <xsl:call-template name="SetFormLinkInline">

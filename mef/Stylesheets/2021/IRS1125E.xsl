...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<body class="styBodyClass" style="width:187mm;">
	  ...
	  <!-- BEGIN WARNING LINE -->
		...
		<div style="width:187mm;" class="styTBB">
		  <div style="width:38mm;height:22.5mm;" class="styFNBox">
			<div style="height:11mm;">Form
			  <span class="styFormNumber">1125-E</span>
			  <br/>(Rev. October 2016)
			</div>
			<div style="height:9mm;padding-top:3mm;">
			  <span class="styAgency">Department of the Treasury</span>
			  <br/>
			  <span class="styAgency">Internal Revenue Service</span>
			</div>
		  </div>
		  <div style="width:110mm;height:22.5mm;" class="styFTBox">
		  	<div class="styMainTitle" style="font-size:16pt;padding-top:1mm;">Compensation of Officers</div>
			...
			<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1125e" title="Link to IRS.gov">
		  ...
		  <div style="width:38mm;height:22.5mm;" class="styTYBox">
		...
		<div style="width:187mm;" class="styTBB">
		  ...
		  <div class="styGenericDiv" style="float:right;" >
			<xsl:call-template name="SetDynamicTableToggleButton">
			  ...
			  <xsl:with-param name="containerHeight" select="22"/>
 ...
 <span class="styBoldText">Form 1125-E</span> (Rev. 10-2016)
</div>
					</div>
					<!--div class="pageEnd" /-->

	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
				...
				<form id="Form1041">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2021 or fiscal year beginning 
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2021 net 965 tax liability paid from Form 965-A, Part II, column (k), line 5</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Amount on line 29 to be: <b> a Credited to 2022</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2021)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2021)</span>
	...
	<!--Line 4-->
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
			...
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">10</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">2021 Estimated tax payments and amount applied from 2020 return
				<xsl:call-template name="LinkToLeftoverDataTableInline">
		  ...
		  <!--Line 15-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">15</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;"><!--<b>Income distribution deduction. </b>--> 2021 net 965 tax liability from Form 965-A, Part I, column (f), line 5 </span>
		  ...
		  <!--Line 17-->
			...
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">18</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;">Credit for qualified sick and family leave wages for leave taken after March 31, 2021. </span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="6"/>
						</xsl:call-template>
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;height:auto;">At any time during calendar year 2021, did the estate or trust have an interest in or a signature or other authority</span>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/Owned10PctIntForeignPrtshpStmt"/>
	 <!-- - Common Form Displays as - 10% Interest Owned in Foreign Partnership Statement - -->
    ...
    <table id="OPFPTbl" class="styDepTblLandscape" style="margin-top:4mm;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           <th class="styDepTblCell" style="width:39mm;" scope="col" rowspan="2">Name</th>
           <th class="styDepTblCell" style="width:21mm;" scope="col" rowspan="2" >Entity EIN<br/>(if any)</th>
           <th class="styDepTblCell" scope="col" rowspan="2">Forms Filed (if any) (F1042,<br/>1065or 1065-B, or 8804)</th>
           <th class="styDepTblCell" style="width:39mm;" scope="col" rowspan="2" >Name of Tax Matters Partner<br/>(if any)</th>
      ...
      <xsl:for-each select="$DependencyData/Owned10PctForeignPartnership">
        ...
        <td class="styDepTblCell" style="text-align:center;witth:21mm">  
          ...
          <td class="styDepTblCell" align="left" valign="top" style="width:39mm;">            
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="TaxMatterPartnerName/BusinessNameLine1Txt"/></xsl:call-template> 
            <xsl:if test="normalize-space(TaxMatterPartnerName/BusinessNameLine2Txt) != ''">
              <br/><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="TaxMatterPartnerName/BusinessNameLine2Txt"/></xsl:call-template> 
            </xsl:if>
          </td>
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">    
        ...
        <div class="styDepTitleLineLandscape">
          <div class="styDepTitle" style="width:144mm">

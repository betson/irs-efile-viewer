				...
				<form name="Form8902">
					...
					<div style="width:187mm;">
						<div class="styFNBox" style="width:32mm;height:18.75mm;">
							...
							<div class="styAgency" style="width:22mm;padding-bottom:1mm;">(Rev. April 2018)
    <span style="width:1mm;"/>
						...
						<div class="styFTBox" style="width:125mm;height:19mm;">
							...
							<div class="styFBT" style="font-size: 7pt;padding-top:.5mm;">
								<img src="{$ImagePath}/8902_Bullet_Sm.gif" alt="Right black arrow for attachments" width="7"/>
								Go to <a href="http://www.irs.gov/Form8902"><i>www.irs.gov/Form8902</i></a> for instructions and the latest information.
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:18.95mm;">
							<span style="width:110px;"/>
							<span style="width:110px;padding-top: 4mm">OMB No.1545-0123</span>
						</div>
					</div>
		...
		Does any member of the electing group have income from qualifying secondary activities or
			...
			......................
							...
							<span style="width:13mm;margin-right:1mm;padding-top:0mm;">
								<xsl:call-template name="PopulateSpan">
								...
								<input type="checkbox" class="styCkbox" name="Checkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/SecondaryOrIncdtlActyIncInd"/>
										<xsl:with-param name="BackupName">SecondaryOrIncdtlActyInc</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabelYes">
          ...
          Yes
							...
							<span style="width:7mm;padding-top:0mm;"/>
							<span style="width:12.5mm;margin-right:1mm;padding-top:0mm;">
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$FormData/SecondaryOrIncdtlActyIncInd"/>
								</xsl:call-template>
								<input type="checkbox" class="styCkbox" name="Checkbox">
		...
		on the corporation’s income tax return. Add lines G(1), G(2)(a), and G(3)(a)
  		...
  		<span style="font-weight:bold;">8902</span> (4-2018)
						</div>
					</div>
					<!--Page 2 start-->
					<div class="styGenericDiv" style="width:187mm;padding-bottom:.5mm;float:none;">
						<div style="float:left">Form 8902 (4-2018)</div>
							...
							<xsl:if test="position() mod 4 = 1">
								...
								<div class="sty8902TableContainerNBB">
									<table class="styTable" cellspacing="0" style="font-size:7pt;border-color:black;">
										<tr>
											<th style="width:58mm;border:none;text-align:center;padding-left:6mm;font-weight:medium;" scope="col">
                  Description
                </th>
											<th class="styTableCell" style="text-align:center;font-weight:bold;border-left-width:1px;" scope="col">
												<xsl:number value="position()" format="A"/>
												<span class="styTableCellPad"/>
											</th>
											<th class="styTableCell" style="text-align:center;font-weight:bold;" scope="col">
                  ...
                  Description
									...
									<th class="styTableCell" style="text-align:center;font-weight:bold;border-left-width:1px;" scope="col">A<span class="styTableCellPad"/>
									</th>
									<th class="styTableCell" style="text-align:center;font-weight:bold;" scope="col">B<span class="styTableCellPad"/>
									</th>
									<th class="styTableCell" style="text-align:center;font-weight:bold;" scope="col">C<span class="styTableCellPad"/>
									</th>
									<th class="styTableCell" style="text-align:center;font-weight:bold;" scope="col">D<span class="styTableCellPad"/>
									</th>
								</tr>
								<tr>
									<td style="border:none;" scope="row">
						...
						<xsl:for-each select="$FormData/NotionalShippingIncome ">
							...
							<xsl:if test="position() mod 4 = 1">
								...
								<div class="sty8902TableContainerNBB">
									<table class="styTable" cellspacing="0" style="font-size:7pt;border-color:black;">
										<tr>
											<th style="width:58mm;border:none;text-align:center;padding-left:6mm;font-weight:medium;" scope="col">Description</th>
										...
										<tr>
											<td style="border:none;" scope="row">
												<div>
													...
													<div class="styGenericDiv">
														<b>Annual notional shipping income.</b> <br/>Enter the amount from line 22 or line </div>
	   ...
	   through 27. Otherwise, skip lines 23 through 27 and enter the amount from line 22 on line 28.
			...
			<div class="styLNDesc" style="width:144mm;height:100%;">
           		Alternative tax on qualifying shipping activities. Multiply line 29 by the highest rate of tax specified in section 11<b/> 
           		(see instructions). Enter here and on the "Other taxes" line of Form 1120, Schedule J, or Form 1120-F, Schedule J.<b/>
				Be sure to check the box for Form 8902
				<!--Dotted Line-->
                <span class="styDotLn" style="float:right;padding-right:1mm">.......................</span>
 			</div>
			<div class="styLNAmountBox" style="width:2mm;height:100%;border-bottom-width:0px;padding-top:6mm;">$</div>
			<div class="styLNAmountBoxNBB" style="padding-top:6mm;height:100%;border-left-width:0px;">
				<xsl:call-template name="PopulateAmount">
									...
									<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
										<thead class="styTableThead">
											<tr class="styDepTblHdr">
												<th class="styDepTblCell" style="width:58mm;text-align:center;padding-left:6mm;" scope="col">
                 	        Description
                	      </th>
												<th class="styDepTblCell" style="width:32mm;text-align:center;" scope="col">
													<xsl:number value="position()" format="A"/>
													<span class="styTableCellPad"/>
												</th>
												<th class="styDepTblCell" style="width:32mm;text-align:center;" scope="col">

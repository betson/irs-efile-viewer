	...
	<div class="styFNBox" style="width:33.5mm;height:22mm;border-right-width:1px;">
		<div style="font-size: 8pt;height:16mm">      
		  Form <span class="styFormNumber">8936</span> <br /> <br /> 
			<span style="font-size:7pt;font-weight:normal">(Rev. January 2022)</span> <br /> 
 ...
 <!-- END PREPARER SIGNATURE SECTION -->
    ...
    <div class="styBB" style="width:187mm;padding-top:1mm;border-bottom-width:1px;">  
	 ...
	 <!-- End of page -->
          ...
          Cat. No. 37751E
          <span style="width:81px;"/>  
          Form <span class="styBoldText">8936</span> (Rev. 1-2022)
        </div>
  ...
  <!--   Part III header -->
		  ...
		  <div class="styBB" style="width:187mm;padding-top:.5mm;">
			<div style="float:left;">Form 8936 (Rev. 1-2022)<span style="width:145mm;"/>
		  </div>
 ...
 <!-- End of page -->
	  <!-- Page Break and Footer-->
		  <div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1 solid black;border-top-width:1px;clear:all;">
			...
			<div style="float:right;">
			  <span style="width:81px;"/>  
              Form <span class="styBoldText" style="font-size:8pt;">8936</span> (Rev. 1-2022)
            </div>
		  </div>
		  <br/>

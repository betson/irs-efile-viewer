  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
         <th class="styDepTblCell" scope="col" style="width:60mm;">Property Information</th>         
         <th class="styDepTblCell" scope="col" style="width:87mm;">Type of Expenditure</th>         
         <th class="styDepTblCell" scope="col" style="width:20mm;">Month of the Expenditure Occurred or Incurred</th>  
         <th class="styDepTblCell" scope="col" style="width:20mm;">Amount</th>                                                                                
      </tr>
      </thead>
        <tfoot/>
        
       <tbody>
      <xsl:for-each select="$DependencyData/Sect59e2ExpenditureGrp">
        <tr>
       ...
       <td class="styDepTblCell" style="text-align:left;width: 107mm;">      		
       ...
       <td class="styDepTblCell" style="text-align:left;width: 40mm;">      		
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="ExpenditureTyp"/>
          </xsl:call-template> 
	</td>       
       <td class="styDepTblCell" style="text-align:center; width: 20mm">      		
          <xsl:call-template name="PopulateMonthForMonthType">
            <xsl:with-param name="TargetNode" select="ExpenditureMonthDt"/>
          </xsl:call-template> 
	</td>  
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <head>
         ...
         <meta http-equiv="Content-ExpenditureTyp" content="text/html; charset=ISO-8859-1"/>

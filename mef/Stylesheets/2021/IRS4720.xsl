			...
			<body class="styBodyClass">
				<form id="Form4720">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>4720</strong> (2021)</span>
					</div>
					<!-- Page 2 -->
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:131mm;font-weight:normal;border-right-width:0px;">
					...
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD">1</div>
						<div class="styLNDesc" style="">
							Undistributed income for years before 2020 (from Form 990-PF for 2021, Part XII, line 6d)
							<span class="sty4720DotLn">.....</span>
						</div>
						<div class="styLNRightNumBox">1</div>
						<div class="styLNAmountBox">
					...
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD">2</div>
						<div class="styLNDesc" style="">
							Undistributed income for 2020 (from Form 990-PF for 2021, Part XII, line 6e)
							<span class="sty4720DotLn">.........</span>
						</div>
						<div class="styLNRightNumBox">2</div>
						<div class="styLNAmountBox">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;">
							Total undistributed income at end of current tax year beginning in 2021 and subject to tax under <br /> 
					...
					<xsl:for-each select="$FormData/IRS4720ScheduleC">
						...
						<div class="styStdDivIB">
							...
							<div class="styLNDesc" style="width:179mm;height:7.5mm;">
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:57mm;font-weight:normal;">
										<strong>(d)</strong>
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:58mm;font-weight:normal;border-right-width:0px;">
										...
										<tr style="height:4mm;vertical-align:top;">
											...
											<td class="styTableCellCtrInherit">
												...
												<input type="checkbox" class="styCkboxNM" style="">
													...
													<xsl:call-template name="PopulateYesCheckbox">
														<xsl:with-param name="TargetNode" select="CorrectionMadeInd"/>
														<xsl:with-param name="BackupName">IRS4720ScheduleEActsSelfDealingTaxCmptGrpCorrectionMade</xsl:with-param>
													</xsl:call-template>
												</input> Yes
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="CorrectionMadeInd"/>
										...
										<tr style="height:4mm;vertical-align:top;">
											...
											<td class="styTableCellCtrInherit">
												...
												<input type="checkbox" class="styCkboxNM" style="">
													...
													<xsl:call-template name="PopulateYesCheckbox">
														<xsl:with-param name="TargetNode" select="CorrectionMadeInd"/>
														<xsl:with-param name="BackupName">IRS4720ScheduleFActsSelfDealingTaxCmptGrpCorrectionMade</xsl:with-param>
													</xsl:call-template>
												</input> Yes
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="CorrectionMadeInd"/>
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:129mm;font-weight:normal;border-right-width:0px;">
										...
										<tr style="height:4mm;vertical-align:top;">
											<td class="styTableCellCtrInherit">
												...
												<input type="checkbox" class="styCkboxNM" style="">
													...
													<xsl:call-template name="PopulateYesCheckbox">
														<xsl:with-param name="TargetNode" select="KnownPTSTTransInd"/>
														<xsl:with-param name="BackupName">IRS4720ScheduleFActsSelfDealingTaxCmptGrpKnownPTSTTransInd</xsl:with-param>
													</xsl:call-template>
												</input> Yes
												<input type="checkbox" class="styCkboxNM" style="margin-left:4.5mm;">
													...
													<xsl:call-template name="PopulateNoCheckbox">
														<xsl:with-param name="TargetNode" select="KnownPTSTTransInd"/>
														<xsl:with-param name="BackupName">IRS4720ScheduleIActsSelfDealingTaxCmptGrpKnownPTSTTransInd</xsl:with-param>
													</xsl:call-template>
												</input> No
											</td>
											<td class="styTableCellAmtInherit">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:14mm;">
										<strong>(a)</strong> Act <br /> number
									</th>
									<th class="styDepTblCell" scope="col" style="width:19mm;">
										<strong>(b)</strong> Date <br /> of act
									</th>
									<th class="styDepTblCell" scope="col" style="width:23mm;">
										<strong>(c)</strong>
										Correction made?
									</th>
									<th class="styDepTblCell" scope="col" style="width:131mm;">
										<strong>(d)</strong> Description of act
									</th>
								</tr>
							</thead>
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:17mm;font-weight:normal;">
										<strong>(b)</strong>
										Date of <br /> investment
									</th>
									...
									<th class="styDepTblCell" scope="col" style="width:57mm;font-weight:normal;">
										<strong>(d)</strong>
										Description of investment
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;font-weight:normal;">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:129mm;font-weight:normal;">
										<strong>(d)</strong> Description of transaction
									</th>
								</tr>
							</thead>
		...
		<tr style="height:4mm;vertical-align:top;">
			...
			<td class="styTableCellCtrInherit">
				<input type="checkbox" class="styCkboxNM" style="">
					...
					<xsl:call-template name="PopulateYesCheckbox">
						<xsl:with-param name="TargetNode" select="/.."/>
						<xsl:with-param name="BackupName">IRS4720ScheduleAActsSelfDealingTaxCmptGrpCorrectionMade<xsl:value-of select="$LineNumber"/></xsl:with-param>
					</xsl:call-template>
				</input> Yes
				<input type="checkbox" class="styCkboxNM" style="margin-left:4.5mm;">

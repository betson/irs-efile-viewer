				...
				<form name="Form4684">
						...
						<div class="styLNDesc" style="width:187mm;padding-top: 0px">
							...
							<label>
								...
								<xsl:choose>
									...
									<!--DR- -->
										<div class="styFixedUnderline" style="height:4mm;width:18mm;text-align:center;float:none;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form4684Data/FEMADisasterDeclarationNum"/>
											</xsl:call-template>
										</div><span style="width:1mm;"/>or EM-		
										<div class="styFixedUnderline" style="height:4mm;width:18mm;text-align:left;float:none;"/>
									</xsl:when>
								    <xsl:otherwise>
									<!--EM- --> 
										<div class="styFixedUnderline" style="height:4mm;width:18mm;text-align:left;float:none;"/>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:121.7mm;height:auto;">
					           ...
					           complete the rest of this section.<br/>
								...
								reduction on line 11 on any Form(s) 4684, enter -0- here and go to line 16.  If you have qualified 
								disaster losses subject to the $500 reduction, subtract line 13 from line 14 and enter the smaller 
								of this difference or the amount on line 12 of the Form(s) 4684 reporting those losses.  Enter that  
								result here and on Schedule A (Form 1040), line 16, or Schedule A (Form 1040-NR), line 7.  If you 
								claim the standard deduction, also include on Schedule A (Form 1040), line 16, the amount of  
								your standard deduction (see the instructions for Form 1040.  Do not complete the rest of this 
					...
					<div class="styTBB" style="width:187mm;">
						...
						from line 16. If zero or less, enter -0- Also enter the result on Schedule A
						 (Form 1040), line 15, or Schedule A (Form 1040-NR), line 6. Estates and trusts,
					...
					<div class="styTBB" style="width:187mm;clear:both;padding-bottom:.5mm;">
						<div class="styGenericDiv" style="width:75mm;" >Form 4684 (2021)</div>
								...
								<xsl:if test="($Print != $Separated) or  
									...
									<xsl:for-each select="$Form4684Data/ShortTermTheftProperty">
										<tr style="height:4mm;">
											...
											<td class="styTableCell" style="width:84mm;text-align:left;border-bottom-width:0px;border-top-width:1px; 
											              border-color:black;">
												<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;height:11.5mm">
					            Enter the amount from line 30, column (b)(ii) here. Individuals, enter the amount from  income-producing 
					            property on Schedule A (Form 1040), line 16, or Schedule A (Form 1040-NR), line 7.  (Do not include any
								...
								<!--<span class="styDotLn" style="float:none;clear:none;padding-right:2mm;">................</span>-->
									<span class="styFixedUnderline" style="border-left-width:0px;width:6mm;
							...
							<div class="styLNRightNumBox" style="height:11.5mm;padding-top:7.5mm;  
							      background-color:lightgrey;padding-bottom:0mm;border-bottom-width:0px;">
								<span style="background-color:white;width:100%;height:4mm;">32</span>
							</div>
					...
					<div class="styBB" style="width:187;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;height:13.5mm;">
								...
								property on Schedule A (Form 1040), line 16, or Schedule A (Form 1040-NR), line 7.  (Do not include any loss on 
	...
	I agree to all <br/><span style="width:2mm"/>adjustments or actions that are necessary to comply with those conditions. The tax year(s) for which I filed the return(s) or amended return(s) <br/><span style="width:2mm"/>and the date(s) on which they were filed are as follows:
				...
				<xsl:if test="(count($Form4684Data/FedDclrDsstrLossPrElectRvkGrp) &gt;= 1)">
					...
					<div  class="pageend" style="width:187mm;border-style:solid;border-color:black;border-width:1px 0px 0px 0px;">
						...
						<span class="styBoldText">4684</span> (2021)</div>
					</div>					

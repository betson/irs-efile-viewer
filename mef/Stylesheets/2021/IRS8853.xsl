        ...
        <form name="IRS8853">
          ...
          <div class="styBB" style="width:187mm;height:19mm;border-bottom-width:2px;">
            ...
            <div class="styTYBox" style="width:31mm;height:19mm;border-left-width:1.5px;">
              ...
              <div class="styTaxYear" style="margin-bottom:-1mm;">20<span class="styTYColor">21</span></div>
            ...
            <div class="styIRS8853LineItem" style="height:4mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:4mm;">
                  Total employer contributions to your Archer MSA(s) for 2021
                </div>
            ...
            <div class="styIRS8853LineItem" style="height:7mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  Archer MSA contributions you made for 2021, including those made from January 1, 2022,<br/>
                  through April 18, 2022, that were for 2021. Don't include rollovers. See instructions.
                  <!--Dotted Line-->                  
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  <b>Taxable Archer MSA distributions.</b> Subtract line 7 from line 6c. If zero or less, enter -0-. Also<br/>
					include this amount in the total on Schedule 1 (Form 1040), line 8z. On<br/>
					the dotted line next to Schedule 1 (Form 1040), line 8z, enter "MSA" and the amount
                  <!--Dotted Line-->
     			 <span class="styDotLn" style="float:none;clear:none;padding:0mm 0mm 0mm 1.5mm;">........</span>
                </div>
              </div>
          ...
          <div style="width:187mm;border-top:1px solid black;" class="styBB">
            ...
            <div style="padding-left:3mm;width:170mm;font-size:8.5pt;">
              ...
              distributions in 2021 from a Medicare Advantage MSA, complete a separate Section B for each spouse. See
              instructions. 
            </div>
          </div>
          <!-- Body -->
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  <b>Taxable Medicare Advantage MSA distributions.</b> Subtract line 11 from line 10. If zero or less,
					enter -0-.<br/> Also include this amount in the total on Schedule 1 (Form 1040), line 8z.<br/> On the dotted line next to Schedule 1 (Form 1040), line 8z, enter “Med MSA” and the amount
                  <!--Dotted Line-->
          			 <span class="styDotLn" style="float:none;clear:none;padding:.5mm 0mm 0mm 1mm;">......</span>
              </div>
              </div>
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8.5pt;">8853</span> (2021)
            </div>
          </div>
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styIRS8853LineItem" style="height:10.5mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:140mm;">
                In 2021, did anyone other than you receive payments on a per diem or other periodic basis under a<br/>
            ...
            <div class="styIRS8853LineItem" style="height:11.5mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:40mm;padding:0mm 0mm 1mm 3mm;">
				...
				<div class="styIRS8853LNDesc" style="width:181mm;padding:0mm 0mm 1mm 3mm;float:right;clear:none;">              
					 <b>Note:</b> If &#8220;Yes&#8221; and the <b>only</b> payments you received in 2021 were accelerated death benefits that were paid to you<br/> because the insured was terminally ill, skip lines 17 through 25 and enter -0- on line 26.              
				</div>   
            </div>
            <!-- (Line 17) ////////////////////////////////////////////////////-->
            <div class="styIRS8853LineItem" style="height:10.5mm;">
                ...
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  ...
                  LTC insurance contract that isn't a <b>qualified</b> LTC insurance contract. Instead, if the benefits aren't<br/>
					excludable from your income (for example, if the benefits aren't paid for personal injuries or sickness through<br/>
					 ...
					 line 8z or, for taxpayers filing Form 1040-NR, on  Schedule NEC (Form 1040-NR), line 12.
                </div>
              </div>
              <xsl:call-template name="CreateBox">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  <b>Taxable payments.</b> Subtract line 25 from line 20. If zero or less, enter -0-. Also include this<br/>
						amount in the total on Schedule 1 (Form 1040), line 8z or, for taxpayers filing Form 1040-NR, on Form 1040-NR, Schedule NEC, line 12. On the dotted line next to Schedule 1	(Form 1040), line 8z or, for taxpayers filing Form 1040-NR, on  Schedule NEC (Form 1040-NR), line 12, enter “LTC” and the amount
                  <!--Dotted Line-->
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            <div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8.5pt;"> 8853 </span> (2021)
            </div>
          </div>
          <!-- END Page Break and Footer-->

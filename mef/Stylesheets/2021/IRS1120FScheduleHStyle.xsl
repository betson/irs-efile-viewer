...
<!-- CSS Styles for form IRS 1120-F Schedule H -->
  <xsl:template name="IRS1120FScheduleHStyle">
	...
	.sty1120FSchHFooter {   /* Form Footer */
	  width:187mm;
	  font-size: 6pt;
	  text-align: left;
	  border-style: solid;

			...
			<body class="styBodyClass">
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;">
						...
						<span style="float:right;">Schedule K-3 (Form 1065) 2021</span>
					</div>
					<!-- Page 2 -->
					...
					<xsl:for-each select="$FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityInsideUSGrp">
						<div class="styStdIBDivLS">
							...
							<div class="styLNDesc" style="width:205mm;">
								<span style="width:8mm;font-weight:bold;">(<xsl:number value="position()" format="i"/>)</span>
								SIC code 
							...
							<div class="styLNRightNumBox" style="width:12mm;">2A(<xsl:number value="position()" format="i"/>)</div>
					...
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityInsideUSGrp) &lt; 1">
						<div class="styStdIBDivLS">
							<div class="styLNLeftNumBox" style="width:7mm;">&nbsp;</div>
							<div class="styLNDesc" style="width:205mm;">
								<span style="width:8mm;font-weight:bold;">(i)</span>
								SIC code 
								<span style="width:12mm;border-bottom:1px solid black;text-align:center;">&nbsp;</span>
								<span class="sty1065K2DotLn">........................................&#9658;</span>
							</div>
							<div class="styLNRightNumBox" style="width:12mm;">2A(i)</div>
					...
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityInsideUSGrp) &lt; 2">
						<div class="styStdIBDivLS">
							<div class="styLNLeftNumBox" style="width:7mm;">&nbsp;</div>
							<div class="styLNDesc" style="width:205mm;">
								<span style="width:8mm;font-weight:bold;">(ii)</span>
								SIC code 
								<span style="width:12mm;border-bottom:1px solid black;text-align:center;">&nbsp;</span>
								<span class="sty1065K2DotLn">........................................&#9658;</span>
							</div>
							<div class="styLNRightNumBox" style="width:12mm;">2A(ii)</div>
							<div class="styLNAmountBox">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityInsideUSGrp) &lt; 3">
						<div class="styStdIBDivLS">
							...
							<div class="styLNRightNumBox" style="width:12mm;">2A(iii)</div>
							<div class="styLNAmountBox">&nbsp;</div>
						</div>
					</xsl:if>
					<!-- Line 2B -->
					...
					<xsl:for-each select="$FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityOutsdUSGrp">
						<div class="styStdIBDivLS">
							...
							<div class="styLNRightNumBox" style="width:12mm;">2B(<xsl:number value="position()" format="i"/>)</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="TotalAmt"/>
								</xsl:call-template>
					...
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityOutsdUSGrp) &lt; 1">
						<div class="styStdIBDivLS">
							...
							<div class="styLNRightNumBox" style="width:12mm;">2B(i)</div>
							<div class="styLNAmountBox">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityOutsdUSGrp) &lt; 2">
						<div class="styStdIBDivLS">
							...
							<div class="styLNRightNumBox" style="width:12mm;">2B(ii)</div>
							<div class="styLNAmountBox">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="count($FormData/SchK2K3REExpnssApprtnFctrGrp/REExpnsActivityOutsdUSGrp) &lt; 3">
						<div class="styStdIBDivLS">
							...
							<div class="styLNRightNumBox" style="width:12mm;">2B(iii)</div>
							<div class="styLNAmountBox">&nbsp;</div>
						</div>
					</xsl:if>
					...
					<xsl:variable name="sep3-4-1" select="($Print = $Separated) and (count($FormData/SchK2K3ForeignTaxesGrp/DrtSect901Or903FrgnTxsGrp) &gt; 3)"/>
					<xsl:variable name="sep3-4-3" select="($Print = $Separated) and (count($FormData/SchK2K3ForeignTaxesGrp/SchK2K3UnrcptrSect1250GainGrp) &gt; 3)"/>
					...
					<xsl:for-each select="$FormData/SchK2K3PrtshpFrgnCorpIncmGrp">
						...
						<xsl:call-template name="S960Page1">

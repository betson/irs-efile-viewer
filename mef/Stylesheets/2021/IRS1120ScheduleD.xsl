		...
		<html>
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleD">
					...
					<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:.5mm;">
						...
						<div class="styTY" style="padding-top:1mm;height:14mm;">20<span class="styTYColor">21</span></div>
					</div>
				</div>
				<!-- END FORM HEADER -->
				<!-- BEGIN TAXPAYER INFO -->
          ...
          <!-- Qurstion in qualified opportunity fund -->
					...
					<div class="IRS1120ScheduleD_styFormFooter">
						...
						<span style="width:42mm;text-align:right;float:right;">Schedule D (Form 1120) 2021</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>

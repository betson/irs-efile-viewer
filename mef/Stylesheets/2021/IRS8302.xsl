      ...
      <body class="styBodyClass">
        <form name="Form8302">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:2px;">
            <div class="styFNBox" style="width:32mm;height:20mm;border-right-width:2px;">Form
              ...
              <br/>
              <span style="font-size:7pt;">(Rev. November 2018)</span>
              ...
              <div class="styFST" style="height:5mm;font-size:7pt;margin-left:2mm;text-align:center;">
                <span style="text-align:center;font-weight:bold;">
                  <img src="{$ImagePath}/8302_Bullet_Md.gif" alt="MediumBullet"/> 
					...
					1120S), Form 1045, or Form 1139.<br/>
                  <img src="{$ImagePath}/8302_Bullet_Md.gif" alt="MediumBullet"/> 
					Information about Form 8302 and its instructions is at <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form8302" title="Link to IRS.gov">
					<i>www.irs.gov/Form8302.</i></a> 
				</span>
              </div>
            </div>
            <div class="styTYBox" style="width:32mm;height:20mm;border-left-width:2px;">
              <div class="styOMB" style="height:11mm;border-bottom:0px;padding-top:9mm;padding-left:1mm;">
				OMB No. 1545-1763 
			  </div>
            </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;height:3mm;"/>
			<div style="width:187mm;">
				<div style="width:150mm;float:left;clear:none;padding-left:80mm;">Cat. No. 62280S</div>
				<div style="width:35mm;float:right;clear:none;">
					  Form <span class="styBoldText">8302 </span> (Rev. 11-2018)
				</div>
			</div>

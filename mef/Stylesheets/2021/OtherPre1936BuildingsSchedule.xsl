...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/OtherPre1936BuildingsSchedule"/>
	<!-- Main template -->
	...
	<xsl:template match="/">
		...
		<html>
			...
			<!-- NameDisplay - IRS3468 - Other Pre 1936 Buildings Schedule -->
			<body class="styBodyClass">
				...
				<table id="Tbl" class="styDepTbl" style="width:187mm;">
					...
					<tfoot/>
					<tbody>
						<xsl:for-each select="$FormData/OtherPre1936Buildings">
							<tr>

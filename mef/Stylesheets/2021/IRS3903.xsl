...
<!-- Last Modified by Jermaine Merchant on 08/20/2021 -->
			...
			<body class="styBodyClass">
				<form name="Form3903">
					...
					<!-- Extra data line -->
						...
						<div class="styFTBox" style="width:125mm;height:20mm;">
							...
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:5mm;">
							    <img src="{$ImagePath}/3903_Bullet.gif" width="9" height="9" alt="right arrow"/>
								...
								<img src="{$ImagePath}/3903_Bullet.gif" width="9" height="9" alt="bullet image"/><span style= "width:1mm;"/>Attach to Form 1040, 1040-SR, or 1040-NR.
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:20mm;">
							<div class="styOMB" style="height:4mm;">OMB No. 1545-0074</div>
							<div class="styTY" style="height:7mm;font-size:22pt;">2021</div>
					...
					<div class="styBB" style="width:187mm;height:12mm;font-size:8pt">
                        ...
                        <div style="padding-top:.8mm;"> Check here
                        
						        to certify that you meet these requirements.  See the instructions</div>
							<span class="styDotLn" style="float:right;">........<img src="{$ImagePath}/3903_Bullet.gif" width="9" height="9" alt="right arrow"/>
							<span style="width:1mm"/>
						        <span style="padding-top:0mm;">
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/          EligibilityRequirementMetInd"/>
									</xsl:call-template>
									<input type="checkbox" alt="Checkbox" name="Checkbox" style="margin-right:.3mm;margin-left:.3mm;margin-bottom:.3mm;margin-top:.3mm">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;height:24.5mm;">
							...
							<span style= "width:3mm;"/>You <span style="font-weight:bold;">cannot</span>
							 ...
							 the result on Form 1040 or 1040-SR, line 1; or Form 1040-NR, line <span style= "width:0mm;"/>1a.</p>
					...
					<div style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">3903</b> (2021)
						</div>
					</div>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/OtherAmountsReceivedStatement"/>
...
<xsl:call-template name="OtherAmountsReceivedStatementTemp"/>
</body>
 </html>
	</xsl:template>
	<xsl:template name="OtherAmountsReceivedStatementTemp">
		<table id="VesselOrAircraftCharterOutStmtTbl" class="styDepTblLandscape">
			...
			<tfoot/>
			<tbody>
				<xsl:for-each select="$DependencyData/OtherAmountsReceivedGrp">
					<!-- set row background -->
					<tr>

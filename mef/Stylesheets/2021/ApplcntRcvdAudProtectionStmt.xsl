...
<!-- edited with XML Spy v4.4 U (http://www.xmlspy.com) by Ken Dulabhan (Comteq Federal Inc) --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ApplcntRcvdAudProtectionStmt"/>
  <!-- 3115  - Applicant Received Audit Protection For Requested Change Statemen -  -->
        ...
        <table id="AdjustmentsScheduleLineTbl" class="styDepTbl">
          <thead class="styTableThead">
            <tr class="styDepTblHdr">
              <th class="styDepTblCell" scope="col" style="width:187mm;">Applicant Received Audit Protection For Requested Change Statement </th>
            </tr>
          </thead>

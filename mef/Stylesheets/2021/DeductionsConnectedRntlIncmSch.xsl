...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/DeductionsConnectedRntlIncmSch" />

	<xsl:template name="ShowDependencyData">
		<!-- Add stylesheet dependency code here -->
		<div class="styStdDiv" style="font-weight:bold;padding-top:2mm;font-size:8pt;">
			Deduction Directly Connected with Rental Income
		</div>
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					<th class="styDepTblCell" scope="col" style="width:40mm;">Property line number from Schedule A</th>
					<th class="styDepTblCell" scope="col" style="width:87mm;">Expense Descriptions</th>
			...
			<tbody>
				<xsl:for-each select="$DependencyData/DeductionsConnectedRntlIncmGrp">

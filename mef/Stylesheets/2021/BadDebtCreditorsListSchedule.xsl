...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/BadDebtCreditorsListSchedule"/>
  ...
  <xsl:template name="BadDebtCreditorsListSchedule">

  <table id="GeneralDependencyTbl" class="styDepTbl">
    <tr class="styDepTblHdr">
      <th class="styDepTblCell" style="width:62mm;text-align:center;">Debtor</th>
      <th class="styDepTblCell" style="width:62mm;text-align:center;">Amount</th>
      <th class="styDepTblCell" style="width:62mm;text-align:center;">Description</th>
    </tr>
    <xsl:for-each select="$DependencyData/BadDebtCreditorsGrp">
      <tr>
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="BadDebtCreditorsListSchedule"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
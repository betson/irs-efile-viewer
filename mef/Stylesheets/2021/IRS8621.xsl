  ...
  <body class="styBodyClass">    
    <form style="font-family:arial; font-size:9pt" name="Form8621">      
      ...
      <div class="styTBB" style="width:187mm">
        ...
        <div class="styFTBox" style="width:128mm;border-left:1px solid black;border-right:1px solid black;">
          ...
          <div class="styFBT" style="height:9mm;padding-top:4mm;font-size:7pt;">            
            <img src="{$ImagePath}/8621_Bullet.gif" alt="Arrow Bullet"/> Go to www.irs.gov/Form8621 for instructions and the latest information.
          </div>
        </div>
        ...
        <div class="styIRS8621FNBox" style="height:9mm;">
            ...
            <div style=" font-family:'verdana';font-size:6pt;">
				<xsl:choose>
					...
					<xsl:when test="normalize-space($Form8621Data/ShareholderName) != ''">
						<xsl:call-template name="PopulateText">
      ...
      <div class="styIRS8621BB" style="font-size:6.5pt">
       ...
       <!-- Choose between Shareholder US or Foreign Address -->
              <xsl:if test="$Form8621Data/ShareholderUSAddress">
                <div style="width:186mm;font-family:'verdana';font-size:7pt;padding-top:1mm">
                <xsl:call-template name="PopulateText">
              ...
              <xsl:if test="$Form8621Data/ShareholderForeignAddress">
                <div style="width:186mm; font-family:'verdana';font-size:7pt;">
                <xsl:call-template name="PopulateText">
      ...
      <div class="styIRS8621BB" style="font-size:8pt; height:5.5mm;width:8mm;border-bottom:1px solid black;"><span style="width:2mm;"/>
        <input type="Checkbox" class="styCkbox">
			<xsl:call-template name="PopulateCheckbox">
				<xsl:with-param name="TargetNode" select="$Form8621Data/ForeignFinancialAssetInd"/>
				<xsl:with-param name="BackupName">ForeignFinancialAssetInd</xsl:with-param>
      ...
      <div class="styIRS8621BB" style="font-size:8pt; height:8mm;padding-bottom:0.5mm;border-bottom:1px solid black;">
        <label>
        	<xsl:call-template name="PopulateLabel">
        		<xsl:with-param name="TargetNode" select="$Form8621Data/QualifiedInsuranceCorpElectInd"/>
        		<xsl:with-param name="BackupName">Form8621QualifiedInsuranceCorpElect </xsl:with-param>
        	</xsl:call-template>
			Qualified Insurance Corporation Election - , a shareholder of stock of a foreign corporation, elect to treat such stock as the stock of a Qualifying Insurance Corporation under the alternative facts and circumstances test within the meaning of section 1297(f). See instructions
        </label>  
        ...
        <input type="Checkbox" class="styCkbox" >
			<xsl:call-template name="PopulateCheckbox">
				<xsl:with-param name="TargetNode" select="$Form8621Data/QualifiedInsuranceCorpElectInd"/>
				<xsl:with-param name="BackupName">Form8621QualifiedInsuranceCorpElect
			</xsl:with-param></xsl:call-template>
		</input>
		</span>
      </div>
      ...
      <div style="font-size:6.5pt; border-bottom:1px solid black;">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>  
                <xsl:if test="$Form8621Data/PFICOrQEFForeignAddress">
                    <xsl:call-template name="PopulateText">
		               <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/AddressLine1Txt"/>
		            </xsl:call-template><br/>
					<xsl:if test="$Form8621Data/PFICOrQEFForeignAddress/AddressLine2Txt">
						<xsl:call-template name="PopulateText">
						   <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/AddressLine2Txt"/>
						</xsl:call-template><br/>
					</xsl:if>
                    <xsl:call-template name="PopulateText">
		               <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/CityNm"/>
		            </xsl:call-template>,<span style="width:1mm;"/>
                    <xsl:call-template name="PopulateText">
		               <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/ProvinceOrStateNm"/>
		            </xsl:call-template><span style="width:1mm;"/>
                    <xsl:call-template name="PopulateText">
		               <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/ForeignPostalCd"/>
		            </xsl:call-template><span style="width:1mm;"/>
                    <xsl:call-template name="PopulateText">
		               <xsl:with-param name="TargetNode" select="$Form8621Data/PFICOrQEFForeignAddress/CountryCd"/>
		            </xsl:call-template>
                </xsl:if>     
              </xsl:otherwise>  
            </xsl:choose>      
        ...
        <div style="height:9mm;width:87mm;float:left; padding-top:1.5mm; padding-left:1mm;border-top:1px solid black;">
          Tax year of foreign corporation, PFIC, or QEF: calendar year
          <xsl:choose>
    ...
    <div style="width:187mm;"><span style="width:2mm;"/>Provide the following information with respect to all shares of the PFIC held by the shareholder:</div>
			<div style="width:187mm;display:inline;vertical-align:bottom;padding-left:2mm;">
				1<span style="width:3mm;"/>
			...
			<div style="width:182mm;padding-left:7mm;">
			...
			<div style="width:187mm;padding-top:3mm;padding-left:2mm;">
				2<span style="width:3mm;"/>
			...
			<div style="width:182mm;padding-top:3mm;padding-left:2mm;">
				3<span style="width:3mm;"/>
				Number of shares held at the end of the tax year: 
				<span class="styFixedUnderline" style="float:none;width:69mm;">
					<xsl:choose>
						<xsl:when test="$Form8621Data/EndTaxYearSharesPct">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" select="$Form8621Data/EndTaxYearSharesPct"/>
							</xsl:call-template>
						</xsl:when>
						<xsl:otherwise>
							<xsl:call-template name="PopulateAmount">
			...
			<div style="width:182mm;padding-top:3mm;padding-left:2mm;">
				4<span style="width:3mm;"/>
				Value of shares held at the end of the tax year (check the appropriate box, if applicable):
			</div>
			<div style="width:187mm;padding-left:7mm;">
				<span style="vertical-align:top;padding-top:0.5mm;"><b>(a)</b></span>
				<span style="">
					<input class="styCkbox" type="checkbox" style="width:3mm;">
						<xsl:call-template name="PopulateCheckbox">
			  ...
			  <span style="vertical-align:top;padding-top:1mm;">$0-50,000</span>
				...
				<span style="vertical-align:top;padding-top:0.5mm;"><b>(b)</b></span>
				<span style="">
					<input class="styCkbox" type="checkbox" style="width:3mm;">
						<xsl:call-template name="PopulateCheckbox">
			  ...
			  <span style="vertical-align:top;padding-top:1mm;">$50,001-100,000</span>
				...
				<span style="vertical-align:top;padding-top:0.5mm;"><b>(c)</b></span>
				<span style="">
					<input class="styCkbox" type="checkbox" style="width:3mm;">
						<xsl:call-template name="PopulateCheckbox">
			  ...
			  <span style="vertical-align:top;padding-top:1mm;">$100,001-150,000</span>
				...
				<span style="vertical-align:top;padding-top:0.5mm;"><b>(d)</b></span>
				<span style="">
					<input class="styCkbox" type="checkbox" style="width:3mm;">
						<xsl:call-template name="PopulateCheckbox">
			  ...
			  <span style="vertical-align:top;padding-top:1mm;">$150,001-200,000</span>
				...
				<b>(e)</b> If more than $200,000, list value: 
			...
			<div style="width:182mm;padding-top:3mm;padding-left:2mm;">
				5<span style="width:3mm;"/>
				Type of PFIC and amount of any excess distribution or gain treated as an excess distribution
			</div>
			<div style="width:1827mm;padding-left:7mm;">
				under section 1291, inclusion under section 1293, and inclusion or deduction under section 1296 (check all boxes that apply):
			</div>
			<div style="width:187mm;padding-left:7mm;">
				(a)
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          ...
          <xsl:call-template name="PopulateLabel">
            ...
            <b>Election To Treat the PFIC as a QEF.</b></label> I, a shareholder of a PFIC, elect to treat the PFIC as a QEF. <i>Complete lines 6a through 7c of Part III.</i>
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          ...
          <xsl:call-template name="PopulateLabel">
            ...
            <b>Election To Extend Time For Payment of Tax.</b></label> I, a shareholder of a QEF, elect to extend the time for payment of tax on<br/>the undistributed earnings and profits of the QEF until this election is terminated. <i>Complete lines 8a through 9c of Part III to
            <br/><span style="width:10mm;" />calculate the tax that may be deferred.</i>
            <span style="padding-top:1mm;padding-bottom:0.5mm;">
				<span style="width:10mm;" /><b>Note:</b> <span style="width:1mm;"/> <i>If any portion of line 6a or line 7a of Part III is includible under section 951, you may <b>not</b> make this election. Also, see 
				<br/><span style="width:10mm;" />sections 1294(c) and 1294(f) and the related regulations for events that terminate this election.</i><br/>
            </span>
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          <label>
            ...
            <b>Election To Mark-to-Market PFIC Stock.</b></label> I, a shareholder of a PFIC, elect to mark-to-market the PFIC stock that is<br/>marketable within the meaning of section 1296(e). <i>Complete Part IV.</i>
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          ...
          <xsl:call-template name="PopulateLabel">
            ...
            <b>Deemed Dividend Election.</b></label> I, a shareholder on the first day of a PFIC's first tax year as a QEF that is a controlled foreign<br/>corporation (CFC), elect to treat an amount equal to my share of the post-1986 earnings and profits of the CFC as an excess
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          <label>
            ...
            <b>Election To Recognize Gain on Deemed Sale of PFIC.</b></label> I, a shareholder of a former PFIC or a PFIC to which section 1297(d) applies, elect to treat as an excess distribution the gain recognized on the deemed sale of my interest in the PFIC on the 
	  ...
	  <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          <label>
            ...
            <b>Deemed Dividend Election With Respect to a Section 1297(e) PFIC.</b></label> I, a shareholder of a section 1297(e) PFIC, within the meaning of Regulations section 1.1297-3(a), elect to make a deemed dividend election with respect to the Section 1297(e) 
      ...
      <div class="styIRS8621Item" style="width:187mm;padding-top:1mm">
        ...
        <div style="width:177mm;display:inline;">
          <label>
            ...
            <b>Deemed Dividend Election With Respect to a Former PFIC.</b></label> I, a shareholder of a former PFIC, within the meaning of Regulations section 1.1298-3(a), elect to make a deemed dividend election with respect to the former PFIC. My holding 
    ...
    <div style="width:187mm; border-top:1px solid black;font-size:7pt;">    
      ...
      <div style="float:right">
        Cat. No. 64174H
        <span style="width:1mm"/>
        Form <b style="font-size:10pt">8621</b> (Rev. 12-2018)
      </div>      
    </div>
    <div class="pageEnd" />    
    ...
    <!-- BEGIN Part III Title -->  
      <div class="styIRS8621BB" style="height:9mm; border-top:1px solid black">
    ...
    <!-- BEGIN Part III Line Items -->
      ...
      <div class="styIRS8621Item">
        <div class="styIRS8621Part2" style="height:4.4mm;border-color:black;border-style:solid;border-top-width:0px;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;"/>
        <div style="height:4.4mm;width:118mm;float:left;border-color:black;border-style:solid;border-top-width:0px;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;">
          in Part II of the Schedule D used for your income tax return. See instructions          
        </div>        
        <div style="height:4.4mm;width:21mm;float:left;border-color:black;border-style:solid;border-top-width:0px;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;">    
          <span class="styIRS8621DotLn">      
            .....                        
          </span>   
        </div>                   
          <div class="styIRS8621LNRightNumBox" style="height:4.4mm;">7c</div>  
          <div class="styIRS8621LNAmountBox" style="height:4.4mm;">
      ...
      <div class="styIRS8621Item" style="height:4mm;">
        <div style="height:4mm;float:left;font-weight:bold;font-size:7pt;">
          Complete lines 8 and 9 only if you are making a section 1294 election (Election B) for the current tax year  
        </div>        
        <div style="float:right">                        
          <div class="styIRS8621LNRightNumBoxNBB" style="background-color:lightgrey; height:4mm"/>  
          <div class="styIRS8621LNAmountBoxNBB" style="height:4mm"/>  
        </div>    
      </div>
    ...
    <!-- BEGIN Part IV Title -->  
      <div class="styIRS8621BB" style="height:4.5mm; border-top:1px solid black">
        ...
        <div class="styTitleDesc" style="font-size:10pt">Gain or (Loss) From Mark-to-Market Election <span class="styNormalText">(see instructions)</span></div>        
      </div>
    <!-- END Part IV Title -->
...
<div class="styIRS8621Part3"/>
      ...
      <div class="styIRS8621Item" style="border-bottom:2 solid black">
        <div class="styIRS8621Part3"/>
        <div style="float:left">
          <span style="width:6mm;"/><b>Note:</b>See instructions in case of multiple sales or dispositions.
        </div>      
        <div style="float:right">            
        ...
        <!-- end -->  
          ...
          <xsl:if test="($Print != $Separated) or (count($Form8621Data/DistriAndDisposOfStockTyp) = 1) or (count($Form8621Data/DistriAndDisposOfStockTyp) = 0)">
			<xsl:for-each select="$Form8621Data/DistriAndDisposOfStockTyp">
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="padding-top:0.5mm">15a</div>
					<div style="float:left; width:135mm;padding-top:0.5mm">
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:12mm;padding-top:8mm;">15a</div>  
						<div class="styIRS8621LNAmountBox" style="height:12mm;padding-top:8mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="padding-top:0.5mm">b</div>
					<div style="float:left; width:135mm;padding-top:0.5mm">
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:15mm;padding-top:11mm;">15b</div>  
						<div class="styIRS8621LNAmountBox" style="height:15mm;padding-top:11mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					...
					<div style="float:right">             
						...
						<div class="styIRS8621LNAmountBox" style="height:5mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="height:5mm;padding-top:1mm">d</div>
					<div style="float:left; width:135mm;height:5mm;padding-top:1mm">
						Multiply line 15c by 125% (1.25)
						<span class="styIRS8621DotLn" style="float:right;">.....................</span>       
					</div>  
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:5mm;padding-top:1mm;">15d</div>  
						<div class="styIRS8621LNAmountBox" style="height:5mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="height:19mm;padding-top:1mm">e</div>
					<div style="float:left; width:135mm;height:19mm;padding-top:1mm">
						...
						If there is an excess distribution, complete line 16.  If zero or less and you did not dispose of stock during the tax 
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:19mm;padding-top:15mm;">15e</div>  
						<div class="styIRS8621LNAmountBox" style="height:19mm;padding-top:15mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="height:8mm;padding-top:1mm">f</div>
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:8mm;padding-top:4mm;">15f</div>  
						<div class="styIRS8621LNAmountBox" style="height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="padding-top:0.5mm">16a</div>
					<div style="float:left; width:135mm;padding-top:0.5mm">
					...
					<div style="float:right">             
						...
						<div class="styIRS8621LNAmountBox" style="height:15mm;padding-top:11mm;background-color:lightgrey"><span style="width:1mm;"/></div>  
					</div>      
				</div>
				  
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="height:12mm;padding-top:1mm">b</div>
					<div style="float:left; width:135mm;height:12mm;padding-top:1mm">
						Enter the total of the amounts determined in line 16a that are allocable to the current tax year
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:12mm;padding-top:8mm;">16b</div>  
						<div class="styIRS8621LNAmountBox" style="height:12mm;padding-top:8mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="height:8mm;padding-top:1mm">c</div>
					<div style="float:left; width:135mm;height:8mm;padding-top:1mm">
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:8mm;padding-top:4mm;">16c</div>  
						<div class="styIRS8621LNAmountBox" style="height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item">
					...
					<div style="float:right">             
						<div class="styIRS8621LNRightNumBox" style="height:5mm;padding-top:1mm;">16d</div>  
						<div class="styIRS8621LNAmountBox" style="height:5mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styIRS8621Item" style="">
					<div class="styIRS8621Part3" style="height:8mm;padding-top:1mm;">f</div>
					<div style="float:left; width:135mm;height:8mm;padding-top:1mm;">
          ...
          <xsl:if test="(($Print = $Separated) and (count($Form8621Data/DistriAndDisposOfStockTyp) &gt; 1)) or (count($Form8621Data/DistriAndDisposOfStockTyp) &lt; 1)">
			   <div class="styIRS8621Item">
					<div class="styIRS8621Part3" style="padding-top:0.5mm">15a</div>
					<div style="float:left; width:135mm;padding-top:0.5mm">
						Enter your total distributions from the section 1291 fund during the current tax year with respect to the
    ...
    <div style="width:187mm; font-size:7pt">    
      ...
      <div style="float:right">        
        Page <b style="font-size:9pt">4</b>
      </div>      
    </div>        

    <!-- BEGIN Part VI Title -->  
    <!--  <div class="styIRS8621BB" style="height:4mm; border-top:2 solid black">-->
      <div class="styIRS8621BB" style="height:9mm; border-top:1px solid black; border-bottom:0px; width:187mm">
        <div class="styTitleName" style="width:12mm; font-size:10pt">Part VI</div>
        <div class="styTitleDesc" style="font-size:10pt">Status of Prior Year Section 1294 Elections and Termination of Section 1294 Elections<br/><span class="styNormalText" style="font-style: italic;">Complete a separate column for each outstanding election.</span></div>        
      </div>
    <!-- END Part VI Title -->
            ...
            <tbody>
              ...
              <tr class="styDepTblRow1">
                ...
                <td class="styDepTblCell" style="text-align:left;width:138mm;">
                  ...
                  share of stock or block of shares held. Allocate the excess distribution or gain to each day in your<br/>
                  holding period. Add all amounts that are allocated to days in each tax year.
                </td>                
        ...
        <xsl:for-each select="$Form8621Data/ElectionStatus">
          ...
          <xsl:if test="$pos mod 6 = 1">
            <table class="styDepTbl" style="font-size:7pt">
              ...
              <tbody>
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:49mm;padding-bottom:4mm;text-align:left;border-left:0;border-bottom:0;" colspan="2">
                    <b>Complete lines 17 through 20 to report the status of outstanding prior year section 1294 elections.</b>
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:center;border-bottom:0;">
                      <span style="width:1mm;"/>        
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:center;border-bottom:0;">
                      <span style="width:1mm;"/>        
                ...
                <!-- Line 17 -->
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:2mm;text-align:right;font-weight:bold;border-right:0;border-top:0;">17</td>
                  <td class="styDepTblCell" style="width:47mm;text-align:left;border-left:0;border-top:0;">
                    Tax year of outstanding election
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:center;border-top:0;">
                      <xsl:call-template name="PopulateText">
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:49mm;text-align:left;padding-bottom:4mm;border-left:0;border-bottom:0;" colspan="2">
                    <b>Complete lines 21 through 24 only if a section 1294 election is terminated in the current year.</b>
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:center;border-bottom:0;">
                      <span style="width:1mm;"/>        
                  </td>
                ...
                <!-- Line 21 -->
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:2mm;text-align:right;font-weight:bold;border-right:0;border-top:0;">21</td>
                  <td class="styDepTblCell" style="width:47mm;text-align:left;border-left:0;border-top:0;">
                    Event terminating election
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:left;vertical-align:bottom;font-size:6pt;border-top:0;">
                    <xsl:call-template name="PopulateText">
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:49mm;text-align:left;padding-bottom:4mm;border-left:0;border-bottom:0;" colspan="2">
                    <b>Complete lines 25 and 26 only if there is a partial termination of a section 1294 election in the current tax year.</b>
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:center;border-bottom:0;">
                      <span style="width:1mm;"/>        
                  </td>
                ...
                <!-- Line 25 -->
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" style="width:2mm;text-align:right;font-weight:bold;border-right:0;border-top:0;">25</td>
                  <td class="styDepTblCell" style="width:47mm;text-align:left;border-left:0;border-top:0;">
                    Deferred tax outstanding after partial termination of election
                  </td>
                  <td class="styDepTblCell" style="width:23mm;text-align:right;vertical-align:bottom;font-size:6pt;border-top:0;">
                    <xsl:call-template name="PopulateAmount">
  ...
  <xsl:if test="$index &lt;= $max">    
    <table style="clear:both; width:187mm; font-size:7pt; border-top:1px solid black; border-bottom:2 solid black" cellpadding="0" cellspacing="0">
        <tr style="font-size:8pt">
          <th colspan="2" rowspan="2" style="height:18mm;text-align:left; padding-top:1mm; vertical-align:top;font-size:9pt;">Complete lines 17 through 20 to report the status of outstanding prior year section 1294 elections.</th>
          <th class="styIRS8621P5Th" scope="col" style="height:13mm;background-color:lightgrey;">
              <span style="width:1mm;"/>
          </th>
          <th class="styIRS8621P5Th" scope="col" style="height:13mm;background-color:lightgrey;">
            <span style="width:1mm;"/>
        ...
        <tr style="font-size:8pt">
          <th class="styIRS8621P5Th" scope="col" style="height:4mm;">
            <xsl:choose>
        ...
        <tr>
          ...
          <td class="styIRS8621P5Td" style="height:4mm;padding-left:0.5mm; text-align:left;border-bottom-width:0px;background-color:lightgrey;">
            <span style="width:1mm;" />
          </td>
          <td class="styIRS8621P5Td" style="height:4mm;padding-left:0.5mm; text-align:left;border-bottom-width:0px;background-color:lightgrey;">
            <span style="width:1mm;" />

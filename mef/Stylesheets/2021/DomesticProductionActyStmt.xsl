...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Form1120S Displays as - Domestic Production Activities Statement - -->
    ...
    <table class="styDepTbl" style="margin-top:4mm;">
      <thead class="styTableThead">        
        <tr class="styDepTblHdr">           
           <th class="styDepTblCell" scope="col" style="width:35mm;">Code </th>
           <th class="styDepTblCell" scope="col" style="width:117mm;">Description </th>
          <th class="styDepTblCell" scope="col" style="width:35mm;">Amount </th>                
        </tr>
      </thead>  
      <tfoot/>
      <tbody>    
      <xsl:for-each select="$DependencyData/DomesticProductionActivities">
        <tr>
          ...
          <td class="styDepTblCell" align="center" style="width:35mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="Cd"/>
            </xsl:call-template>
          </td>  
          <td class="styDepTblCell" align="left" style="width:117mm;">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="Desc"/>
              </xsl:call-template>    
          </td>
          <td class="styDepTblCell" align="right" style="width:35mm;">   
              <xsl:call-template name="PopulateAmount">

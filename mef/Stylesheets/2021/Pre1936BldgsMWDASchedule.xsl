...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/Pre1936BldgsMWDASchedule"/>
	<!-- Main template -->
	...
	<xsl:template match="/">
		...
		<html>
			...
			<!-- NameDisplay - IRS3468 - Pre 1936 Buildings Midwestern Disaster Schedule -->
			<body class="styBodyClass">
				...
				<table id="Tbl" class="styDepTbl" style="width:187mm;">
					...
					<tfoot/>
					<tbody>
						<xsl:for-each select="$FormData/Pre1936BldgsMWDA">
							<tr>

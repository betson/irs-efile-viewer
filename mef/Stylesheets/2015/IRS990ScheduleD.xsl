...
<span style="padding-top:1mm;padding-top:7mm">
      ...
      <span style="width:4mm;padding-top:7mm"/>
      <span>
          <xsl:call-template name="PopulateSpan">
            <xsl:with-param name="TargetNode" select="$FormData/DisclosedForCharitablePrpsInd"/>
          </xsl:call-template>
...
<!-- Footer -->
    <div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageEnd">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule D (Form 990) 2015</span>
      </div>
    </div>
   ...
   <br/>
    ...
    <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
      <div style="width:90mm;" class="styGenericDiv">Schedule D (Form 990) 2015</div>
...
<!-- Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageEnd">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule D (Form 990) 2015</span></div>
    </div>
...
<!--<div class="styGenericDiv" style="float:right">-->
  ...
  <!--   <xsl:call-template name="SetDynamicTableToggleButton">
    ...
    <table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
		...
		<span class="styGenericDiv" style="float:left;height:auto;"><b>(1)</b>Financial derivatives</span></td>
  ...
  <tr>
	 <td class="styTableCell" style="width:100mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
		...
		<b>(2)</b>Closely-held equity interests</span></td>
      <td class="styTableCell" style="width:35mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
		<xsl:call-template name="PopulateAmount">
...
<xsl:if test="position()=1">
             <b>(3)</b>Other <span class="styIRS990ScheduleDUnderlineAmount" style="width:84mm;float:none;padding-left:2mm;text-align:center;"/></xsl:if></span><br/>(<xsl:number value="position()" format="A"/>)
 ...
 <xsl:if test="count($FormData/OtherSecuritiesGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/OtherSecuritiesGrp) &gt; 9)) ">
        ...
        <xsl:if test="count($FormData/OtherSecuritiesGrp) &lt; 2 or ((count($FormData/OtherSecuritiesGrp) &gt; 9) and ($Print = $Separated))">
								...
								<xsl:if test="count($FormData/OtherSecuritiesGrp) &lt; 4 or ((count($FormData/OtherSecuritiesGrp) &gt; 9) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchDPartVIITableFillerRow"><xsl:with-param name="index">(C)</xsl:with-param></xsl:call-template>
								</xsl:if>
 ...
 <xsl:if test="count($FormData/InvstProgramRelatedOrgGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/InvstProgramRelatedOrgGrp) &gt;9)) ">
             ...
             <td class="styTableCell" style="width:52mm;vertical-align:bottom;border-left:0px;border-right-width:0px;border-color:black;text-align:center;">
                                ...
                                <xsl:if test="count($FormData/InvstProgramRelatedOrgGrp) &lt; 2 or ((count($FormData/InvstProgramRelatedOrgGrp) &gt; 9) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchDPartVIIITableFillerRow"><xsl:with-param name="index">(1)</xsl:with-param></xsl:call-template>
								</xsl:if>
...
<xsl:if test="count($FormData/OtherAssetsOrgGrp) &lt; 2 or ((count($FormData/OtherAssetsOrgGrp) &gt; 9) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchDPartIXTableFillerRow"><xsl:with-param name="index">(1)</xsl:with-param></xsl:call-template>
								</xsl:if>
   ...
   <!--   <div class="styGenericDiv" style="float:right">-->
    ...
    <div style=" width: 187mm; ">
      <table class="styTable" style="font-size:7pt;float:none;clear:both;display:table;" cellspacing="0">
        <thead class="styTableThead">
          <tr>
            <th class="styTableCellHeader" scope="col" style="height:auto;width:100mm;font-weight:normal;border-color:black"><span class="styLNLeftNumBoxSD" style="text-align:left;padding-left:0mm;font-weight:normal"><b>1.</b></span><span style="font-weight:bold">(a)</span> Description of liability</th>
         <th class="styTableCellHeader" scope="col" style="width:35mm;height:auto;font-weight:normal; text-align:center;border-right-width:1px;border-color:black;vertical-align:top;"><span style="font-weight:bold">(b)</span> Book value</th>
            <td class="styIRS990ScheduleDShadingCell" scope="col" style="height:4.5mm;width:52mm;border-left:1px;border-color:black;border-bottom:0px;"/>
         </tr>
</thead>
        <tfoot/>
        <tbody>
        ...
        <tr>
         <td class="styIRS990ScheduleDTableCellLB" style="width:100mm;height:auto;vertical-align:top;padding-right:0.75mm;border-left:0px;border-color:black">
		
	<span class="styGenericDiv" style="float:left;height:auto;">(1) Federal income taxes</span></td>
      <td class="styIRS990ScheduleDTableCellLB" style="width:35mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
		<xsl:call-template name="PopulateAmount">
      ...
      <table class="styTable" style="font-size:7pt;width:187mm;border-top-width:1px" cellspacing="0">
        ...
        <tbody valign="top">
          <tr>
            ...
            <td class="styLNRightNumBox" style="width:8mm;height:4.5mm; border-right:0">1</td>
            <td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px;"><xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$FormData/TotalRevEtcAuditedFinclStmtAmt"/></xsl:call-template></td>
          </tr>    

	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2015 that would require you to file Form(s) 1099? (see instructions)</span>
...
<div style="width:187mm;float:none;clear:both; ">  
	...
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2015 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p  class="pageEnd" style="page-break-after:always;display:block;"/>
    <!-- Header -->    
    <div class="styBB" style="width:187mm;float:left;clear:all;padding-top:2mm">  
      <div style="float:left;">Schedule C (Form 1040) 2015 <span style="width:130mm;"/></div>
 ...
 <!--Line 41-->   
		...
		<div style="width:182mm;height:11mm;">
			...
			<span style="width:169mm;font-weight:normal;padding-left:5mm;" class="styPartDesc">
				<b> Information on Your Vehicle.</b> Complete this part <b>only</b> if you are claiming car or truck expenses on line 9,<br/>
				 and are not required to file Form 4562	for this business. See the instructions for line 13 to find out if you must file Form 4562.</span> 
		  </div>   
		</td>
		</tr>
		<tr>				
  ...
  <!--Line 48-->
    ...
    <div style="width:187mm;clear:all;">    
      ...
      <div class="stySmallText" style="width:46mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2015</span> </div>
    </div>
    <!--    </div> -->      
    <p class="pageEnd"  style="page-break-after:always;display:block;"/>

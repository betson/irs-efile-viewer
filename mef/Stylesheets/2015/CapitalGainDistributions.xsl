...
<xsl:strip-space elements="*"/>
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/CapitalGainDistributions"/>

  <xsl:param name="depDocTitle">
    <xsl:call-template name="PopulateDisplayName"><xsl:with-param name="TargetNode" select="$DependencyData"/></xsl:call-template>  
  </xsl:param>
  
  <xsl:template name="CapitalGainDistributionsTemp">
    <table id="CapitalGainDistributionsTbl" class="styDepTbl">
...
<!--          <th class="styTblCell" scope="col">Item No.</th>       -->
      ...
      <xsl:for-each select="$DependencyData/CapitalGainDistributionGrp">
        <tr>
  ...
  <xsl:if test="not($Print) or $Print=''">
    <xsl:call-template name="AddOnStyle"/>    
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="CapitalGainDistributionsTemp"/>

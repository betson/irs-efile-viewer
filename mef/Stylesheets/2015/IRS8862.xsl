...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<div class="styIRS8862CleanDiv" style="width:181mm;height:auto;">
					...
					<span style="width:6mm;height:100%;text-align:center;border-bottom:1px solid black;">
						<xsl:if test="$TargetNode">
							<xsl:call-template name="PopulateMonthForMonthDayType">
								<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmChildBirthMonthDayDt"/>
							</xsl:call-template>
						</xsl:if>
					</span>
					<b>/</b>
				...
				<div class="styIRS8862LNDesc" style="width:auto;height:auto;">
					...
					<span style="width:6mm;height:100%;text-align:center;border-bottom:1px solid black;">
						<xsl:if test="$TargetNode">
							<xsl:call-template name="PopulateMonthForMonthDayType">
								<xsl:with-param name="TargetNode" select="$TargetNode/EICEligChildDeathMonthDayDt"/>
							</xsl:call-template>
						</xsl:if>
					</span>
					<b>/</b>
	...
	<xsl:template name="CreateLine6ChildItem">
		...
		<div class="styIRS8862LineItem" style="padding-right:0px;height:auto;">
			...
			<div class="styIRS8862LNDesc" style="width:19mm;height:4mm;">
				<b>Child <xsl:value-of select="$Number"/>
				</b>
				<span style="width:4px;"/>
				<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/>
			...
			<div class="styIRS8862CleanDiv" style="width:162mm;height:auto;">
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:4mm;">
					...
					<div class="styIRS8862LNDesc" style="width:134mm;height:4mm;border-bottom-width:1px;border-color:black;border-style:dashed;">
						<xsl:if test="$TargetNode">
							<xsl:if test="count($TargetNode/following-sibling::*) = 0">
								<xsl:choose>
									<xsl:when test="$TargetNode/EICEligClmLivedWithChldUSAddr">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmLivedWithChldUSAddr/AddressLine1Txt"/>
										</xsl:call-template>
										<xsl:if test="$TargetNode/EICEligClmLivedWithChldUSAddr/AddressLine2Txt">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmLivedWithChldUSAddr/AddressLine2Txt"/>
											</xsl:call-template>
										</xsl:if>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmLiveWithChldFrgnAddr/AddressLine1Txt"/>
										</xsl:call-template>
										<xsl:if test="$TargetNode/EICEligClmLiveWithChldFrgnAddr/AddressLine2Txt">
											<br/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmLiveWithChldFrgnAddr/AddressLine2Txt"/>
											</xsl:call-template>
										</xsl:if>
									</xsl:otherwise>
								</xsl:choose>
					...
					<div class="styIRS8862LNDesc" style="width:117mm;height:4mm;border-bottom-width:1px;border-color:black;border-style:dashed;word-wrap:break-word;">
						<xsl:if test="$TargetNode">
							<xsl:if test="count($TargetNode/following-sibling::*) = 0">
								...
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmLiveWithChldFrgnAddr/CountryCd"/>
								</xsl:call-template>
							</xsl:if>
						</xsl:if>
					</div>
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:4mm;">
					...
					<div class="styIRS8862LNDesc" style="width:118mm;height:4mm;border-bottom-width:1px;border-color:black;border-style:dashed;float:right;">
						<xsl:if test="$TargetNode">
							<xsl:if test="count($TargetNode/following-sibling::*) = 0">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/EICEligClmOtherPersonNm"/>
								</xsl:call-template>
							</xsl:if>
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS8862" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;height:18mm;">
						<div class="styFNBox" style="width:31mm;height:18mm;border-right-width:2px;padding-top:0mm;">
					...
					<div class="styBB" style="width:187mm;height:32mm;">
						...
						<div class="styIRS8862LineItem" style="width:187mm;height:4mm;">
							...
							<div class="styIRS8862LNDesc" style="width:20mm;height:4mm;padding-left:0px;padding-top:1px;border-bottom:1px solid black;">
						...
						<div class="styIRS8862LineItem" style="width:187mm;height:8mm;">
							...
							<div class="styIRS8862LNDesc" style="width:37mm;height:8mm;padding-left:0px;padding-top:4mm;float:right;">
								...
								<span style="float:right;width:auto;height:8mm;">
									<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<span>
										<xsl:call-template name="PopulateSpan">
											<xsl:with-param name="TargetNode" select="$Form8862Data/EICEligClmIncmIncorrectRptInd"/>
						...
						<div class="styIRS8862LineItem" style="width:187mm;height:8mm;">
							...
							<div class="styIRS8862CleanDiv" style="width:144mm;height:8mm;padding:0px 0px 0px 0px;">
								<div class="styIRS8862LNDesc" style="width:auto;height:8mm;padding:0px 0px 0px 0px;">
									<div class="styIRS8862LNDesc" style="width:auto;height8mm;;">
					...
					<div class="styTBB" style="width:187mm;height:auto;">
						<div class="styIRS8862LineItem" style="width:187mm;height:7.5mm;">
							<div class="styIRS8862LNLeftNumBox"/>
						...
						<div class="styIRS8862LineItem" style="width:40mm;float:left;">
							<div class="styIRS8862LNLeftNumBox" style="padding-right:0px;">a</div>
							<div class="styIRS8862LNDesc" style="width:auto;height:6mm;">
								<b>Child 1</b>
								<span style="width:4px;"/>
								<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/>
								<span style="width:4px;"/>
								<span style="width:12mm;height:3.5mm;border-bottom:1px solid black;">
						...
						<div class="styIRS8862LineItem" style="width:187mm;height:auto;">
							<div class="styIRS8862LNLeftNumBox"/>
							<div class="styIRS8862LNDesc" style="width:187mm;height:auto;">
								<b>Caution.</b>
								<span style="width:4px;"/>If you entered less than <b>183</b> (184 if the year on line 1 is a leap year) for any child, you cannot take the EIC based on that child, unless the special rule for a child who was born or died during the year shown on line 1 applies. See the instructions.
							</div>
						</div>
						<!-- (5) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem" style="width:187mm;height:8mm;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8862LineItem">
							...
							<div class="styIRS8862LNDesc" style="width:181mm;height:auto;">
								<b>Caution.</b>
								<span style="width:3px;"/>If you entered less than <b>183 (184 if the year on line 1 is a leap year), stop.</b> You cannot take the EIC. See the instructions.
							</div>
						</div>
						<!-- (9) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem"  style="width:187mm;height:auto;">

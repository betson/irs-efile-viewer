    ...
    <table id="ElectUseLIBORRateReg18825Stmt" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">30 day U.S. LIBOR Rate Used</th>
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">Publisher of the Rate Used</th>         
        </tr>
      </thead>
        ...
        <tr>
          ...
          <xsl:choose>
            ...
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="ThirtyDayUSLIBORRateUsedTxt"/> 
             </xsl:call-template>
             </td>                          
                      <td class="styDepTblCell" style="text-align:center;">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="PublisherOfTheRateUsedTxt"/>
              </xsl:call-template>
            </td>
           </tr>
      </xsl:for-each>

						...
						<div class="styFTBox" style="width:131mm;float:left;height:16mm;">
							...
							<div style="font-size:6pt;float:left;text-align:left;padding-left:1mm;padding-top:1mm;">
								...
								<b>Information about Form 1042-S and its separate instructions is at 
												<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1042">
										<i>www.irs.gov/form1042.</i>
									</a>
								</b>
							</div>
									...
									<table style="float-left;" cellpadding="0" cellspacing="0">
										<tr>
											...
											Gross income
												...
												<span class="styIRS1042STableCell" style="width:30mm;height:12mm;border-bottom:0;">
													<span class="styIRS1042STableCellContent" style="padding-top:0;width:30mm;height:4mm;border-width:1px 0px 0px 1px;">
														<span class="styIRS1042SBoxNumber" style="padding-top:1mm;">3 
														<span style="font-weight:normal;padding-right:12mm;"> Chap. 3:</span>
														</span>
														<input alt="Chapter3Ind" type="checkbox" class="styCkbox" name="Chapter3Ind">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" select="$FormData/Chapter3Ind"/>
																<xsl:with-param name="BackupName">Chapter 3 indicator</xsl:with-param>
															</xsl:call-template>
														</input>
														<label>
															<xsl:call-template name="PopulateLabel">
											...
											Tax rate
												...
												<span class="styIRS1042STableCell" style="width:28mm;height:12mm;border-bottom:0;">
													<span class="styIRS1042STableCellContent" style="padding-top:0;width:28mm;height:4mm;border-width:1px 1px 0px 1px;">
														<span class="styIRS1042SBoxNumber" style="padding-top:1mm;">4 
														<span style="font-weight:normal;padding-right:10mm;"> Chap. 4:</span>
														</span>
														<input alt="Chapter4Ind" type="checkbox" class="styCkbox" name="Chapter4Ind">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" select="$FormData/Chapter4Ind"/>
																<xsl:with-param name="BackupName">Chapter 4 indicator</xsl:with-param>
															</xsl:call-template>
														</input>
														<label>
															<xsl:call-template name="PopulateLabel">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:93mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:49mm;height:4mm;border-width:0px 0px 0px 1px;">
											...
											Ch. 3 status code
												...
												<span class="styIRS1042STableCellContent" style="width:44mm;height:4mm;border-width:0px 1px 0px 1px;">
...
-->																<xsl:call-template name="PopulateCityStateInfo">
									...
									<table style="float-right;" cellpadding="0" cellspacing="0">
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:94mm;height:4mm;border-width:1px 1px 0px 0px;">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCell" style="width:56mm;height:8mm;border-bottom:0;">
													<span class="styIRS1042STableCellContent" style="width:56mm;height:4mm;border-width:0px 0px 0px 0px;">
											...
											Net income
													...
													<span class="styIRS1042STableCellContent" style="width:56mm;height:4mm;border-width:1px 0px 0px 0px;">
											...
											Federal tax withheld
												...
												<span class="styIRS1042STableCellContent" style="width:38mm;height:8mm;border-width:0px 1px 0px 1px;">
													<span style="float-left;font-size:5pt;width:29mm;padding:0mm 0mm 1mm 0.5mm;">
													Check if tax not deposited with IRS<br/>pursuant to escrow procedure
												</span>
													<div style="float-right;width:7mm;height:7mm;">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:33mm;height:6mm;border-width:0px 1px 0px 0px;">
											...
											<span style="font-size:80%;">
												...
												<span class="styIRS1042STableCellContent" style="width:61mm;height:6mm;border-width:0px 1px 0px 0px;">
													<span class="styIRS1042SBoxNumber" style="height:3mm;">13i</span>
											Recipient's foreign tax identification number, if any<br/>
													<span style="font-size:80%;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="$FormData/RecipientGrp/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNum"/>
													</xsl:call-template>
												</span>
												</span>
											</td>
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:61mm;height:6mm;border-width:0px 0px 0px 0px;">
													<span class="styIRS1042SBoxNumber">16</span>
											Recipient's account number<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:33mm;height:6mm;border-width:0px 1px 0px 1px;">
													<span class="styIRS1042SBoxNumber">17</span>
											Recipient's date of birth<br/>
													<span style="padding-left:8mm;">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:47mm;height:13mm;border-width:0px 0px 0px 0px;">
													<span class="styIRS1042SBoxNumber">18</span>
											Payer's name<br/>
													<span style="font-size:80%;">
														<xsl:choose>
															<xsl:when test="$FormData/PayerGrp/PersonNm">
																<span style="padding-top:7mm;">
																	<xsl:call-template name="PopulateText">
															...
															<xsl:otherwise>
																<xsl:choose>
																	<xsl:when test="$FormData/PayerGrp/BusinessName/BusinessNameLine2Txt">
																		<span style="width:43mm;word-wrap: break-word;">
																			<xsl:call-template name="PopulateText">
																	...
																	<xsl:otherwise>
																		<span style="width:43mm;word-wrap: break-word;padding-top:5mm;">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="$FormData/PayerGrp/BusinessName/BusinessNameLine1Txt"/>
																			</xsl:call-template>
																		</span>
												...
												<span class="styIRS1042STableCellContent" style="width:19mm;height:13mm;border-width:0px 0px 0px 1px;">
													<span class="styIRS1042SBoxNumber">19</span>
											Payer's TIN<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:28mm;height:13mm;border-width:0px 1px 0px 1px;">
													<span class="styIRS1042SBoxNumber" style="height:3mm;">20</span>
											Payer's GIIN<br/>
													<span style="font-size:90%;padding-top:6mm;">
														<xsl:call-template name="PopulateText">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:36mm;height:6mm;border-width:0px 0px 0px 0px;">
													<span class="styIRS1042SBoxNumber">21</span>
											State income tax withheld<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:36mm;height:6mm;border-width:0px 0px 0px 1px;">
													<span class="styIRS1042SBoxNumber">22</span>
											Payer’s state tax no.<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:22mm;height:6mm;border-width:0px 1px 0px 1px;">
													<span class="styIRS1042SBoxNumber">23</span>
											Name of state<br/>
													<span style="padding-left:5mm;">
														<xsl:call-template name="PopulateText">
			    ...
			    For Privacy Act and Paperwork Reduction Act Notice, see instructions.
						...
						<span style="width:38mm;font-weight:normal;font-size:6pt;text-align:center;" class="styGenericDiv">Cat. No. 11386R</span>
						<span style="float:right;" class="styGenericDiv">Form <span class="styBoldText">1042-S</span> (2015)</span>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->

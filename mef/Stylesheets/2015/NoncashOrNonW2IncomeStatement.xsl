...
<body class="styBodyClass" style="width:187mm;">
     ...
     <div class="styTopSectionLine">
		<div class="styTopSectionLineLbl" style="float:left">
          ...
          <div class="styExplanationLine" style="float:left;width:187mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$FormData/LodgingMarketValueExplnTxt"/>
            </xsl:call-template>            
          </div>
        </div>    
        <div class="styTopSectionLine">
		<div class="styTopSectionLineLbl" style="float:left">
          ...
          <div class="styExplanationLine" style="float:left;width:187mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$FormData/MealsMarketValueExplnTxt"/>
            </xsl:call-template>            
          </div>
        </div>
        <div class="styTopSectionLine">
		<div class="styTopSectionLineLbl" style="float:left">
          ...
          <div class="styExplanationLine" style="float:left;width:187mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$FormData/CarMarketValueExplnTxt"/>
            </xsl:call-template>            
          </div>
        </div> 

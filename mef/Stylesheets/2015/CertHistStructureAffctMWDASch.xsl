...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- 3468 - Certified Historic Structures Midwestern Affected Schedule -->
				...
				<table id="Tbl" class="styDepTblLandscape" style="font-size:7pt;">
					<thead class="styDepTableThead">
						<tr class="styDepTblHdr">
							<th class="styDepTblCell" scope="col" style="width:29mm;">Credit Amount</th>
							...
							<th class="styDepTblCell" scope="col" style="width:40mm;">Explanation</th>

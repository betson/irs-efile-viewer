...
<!-- 07/22/2015 - Modified per defect 43635 - Jeremy Nichols-->
	...
	<!-- End Name / Employer identification number / Total Refund  -->
		...
		<table cellspacing="0" cellpadding="0" style="height:auto;width:187mm;">
			<tbody>
				<tr style="font-size:8pt;height:8mm">
					...
					<th scope="col" colspan="5" class="styTableCellHeader" style="width:180mm; text-align:left;border-top-width:1px;border-right-width:0px;border-bottom-width:0px;">
						<b>Sales of Undyed Diesel Fuel</b>
					</th>
				</tr>
				<tr style="font-size:7pt">
					<td style="width:7mm;border-color: black;text-align: center;border-style: solid; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px"><span style="width: 1px"/></td>
					...
					<td style="width:25mm;border-color: black;text-align: center;border-style: solid; border-top-width: 1px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px"><b>(a) Rate</b></td>
					<td style="width:25mm;border-color: black;text-align: center;border-style: solid; border-top-width: 1px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px"><b>(b) Gallons</b></td>
					<td style="width:60mm;border-color: black;text-align: center;border-style: solid; border-top-width: 1px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px"><b>(c) Amount of refund</b>
					<br/><span style="font-size: 7p"><i>Multiply col. <b>(a)</b> by col. <b>(b)</b></i></span></td>
					<td style="width:10mm;border-color: black;text-align: center;border-style: solid; border-top-width: 1px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px"><b>(d)<br/>CRN</b></td>
				</tr>
				<tr style="font-size:7pt;height:8mm">
					<td style="width:7mm;border-color: black;text-align: left;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px"><span style="width:1px"/></td>
					...
					<td style="width:25mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: center">$
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="$FormData/SalesUndyedDieselFuel/FuelUsedByStateLocalGovt/Rt"/>
						</xsl:call-template>
					</td>
					<td style="width:25mm;border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;padding-right:4px">
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$FormData/SalesUndyedDieselFuel/FuelUsedByStateLocalGovt/GallonsQty"/>
						</xsl:call-template>
					</td>
					<td style="width:60mm;text-align: right;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;padding-right:4px"><span style="padding-left:4px;float:left">$</span>
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$FormData/SalesUndyedDieselFuel/FuelUsedByStateLocalGovt/Amt"/>
						</xsl:call-template>
					</td>
					<td style="width:10mm;border-color: black;text-align: center;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px">
						<xsl:call-template name="PopulateText">
		...
		<table cellspacing="0">
			<tbody>
				<tr style="font-size:8pt;height:8mm">
					...
					<th scope="col" colspan="5" class="styTableCellHeader" style="width:180mm; text-align:left;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;">
				...
				<tr style="font-size:7pt;height:8mm">
					...
					<td style="width:60mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: right;padding-right:4px"><span style="padding-left:4px;float:left">$</span>
						<xsl:call-template name="PopulateAmount">
		...
		<table cellspacing="0">
			<tbody>
				...
				<tr style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					<td style="width:7mm;border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px; padding-right: 6px;vertical-align:top;padding-top:4px"><b>a</b></td>
					...
					<td style="width:25mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: left;padding-left:8.25mm;">$
						<xsl:call-template name="PopulateText">
				...
				<tr style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					<td style="width:7mm;border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; padding-right: 6px;vertical-align:top;padding-top:4px"><b>b</b></td>
					...
					<td style="width:25mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: left;padding-left:10.75mm;">
						<xsl:call-template name="PopulateText">
					...
					<td style="width:60mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: right;padding-right:4px">
						<xsl:call-template name="PopulateAmount">
		...
		<table cellspacing="0">
			<tbody>
				...
				<tr style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					...
					<td rowspan="2" style="width:10mm;border-color: black;padding-bottom:6mm;text-align: center;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px">
						<xsl:call-template name="PopulateText">
				...
				<tr style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					<td style="width:7mm;border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; padding-right: 6px;vertical-align:bottom;padding-top:4px"><b>b</b></td>
		...
		<table cellspacing="0">
			<tbody>
				...
				<tr style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					<td style="width:7mm;border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; padding-right: 6px;vertical-align:top;padding-top:4mm"><b>b</b></td>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
 ...
 <div class="styFBT" style="width:128mm;height:auto;margin-top:2mm;font-size:6.5pt;">
 <img src="{$ImagePath}/945A_Bullet_Sm.gif"  alt="Bullet Image"/> Information about Form 945-A and its instructions is at <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form945a" title="Link to IRS.gov"><i>www.irs.gov/form945a</i>.</a><br/>
	...
	<div class="pageEnd" style="width:187mm;border: black solid 1px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;">
		...
		<div class="styGenericDiv" style="float:right" >Form <span style="font-weight:bold;font-size:8.5pt;">945-A</span> (Rev. 2-2015)</div>
	</div>
		<p style="page-break-before: always"/>
	<div class="styBB" style="width:187mm;float:left;clear:both;">  
		<div style="float:left;">Form 945-A (Rev. 2-2015)<span style="width:130mm;"/></div>
    ...
    <div class="pageEnd" style="width:187mm;float:left;border:1px solid black;border-right-width:0px;border-bottom-width:0px;border-left-width:0px;">
        <div class="styGenericDiv" style="float:right" >Form <b><span style="font-size:8pt;">945-A</span></b> (Rev. 2-2015)</div>
    </div>

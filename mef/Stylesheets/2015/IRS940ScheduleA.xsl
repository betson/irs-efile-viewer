...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass" style="width:187mm">
				<form id="IRS940ScheduleA">
					...
					<div class="styBB" style="width:131mm;height:28mm;border-top-width:1px;border-left-width:1px;border-right-width:1px;float:left;">
	...
	<div style="width:187mm;">
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;font-weight:bold;font-size:6pt;padding-top:0.4mm;">Schedule A (Form 940) 2015</span>
		</div>
				...
				<div class="styIRS940SATableRow">
					...
					<div class="styIRS940SAAmtBoxRR" style="background-color:lightgrey;font-size:6pt;padding-top:3mm;">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:choose>
									<xsl:when test="$StateAbrv = 'CA' or $StateAbrv = 'OH' or $StateAbrv = 'VI'">
										<span style="text-align:left;">.015</span>
									</xsl:when>
									<xsl:when test="$StateAbrv = 'CT'">
										<span style="text-align:left;">.021</span>
									</xsl:when>
									<xsl:otherwise>

...
<!--Created by Doug peterson 6-19-2006--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/Section59e2ExpendituresStmt"/>
    ...
    <table id="AOVSSTbl" class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tr class="styDepTblHdr">
          ...
          <th class="styDepTblCell" scope="col">MonthNum</th>  
          <th class="styDepTblCell" scope="col">Amt</th>        
             
        </tr>
      </thead>
      <tfoot/>
      <tbody>    
        <xsl:for-each select="$AOVSSData/Section59e2ExpendituresItemGrp">  
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:center;width:33mm;">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="MonthNum"/>
              </xsl:call-template>
            </td>
            <!-- Third Column -->

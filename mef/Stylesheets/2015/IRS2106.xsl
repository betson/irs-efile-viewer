	...
	<xsl:template match="/">
				...
				<form name="Form2106">
		          ...
		          <!--Dotted Line-->
					...
					<div style="width:187mm; padding-top:.5mm; padding-bottom:15mm; clear: all; float: left;">
						...
						Form <span class="styBoldText" style="font-size:8pt;">2106  </span>	(2015)
					</div>
					</div>
					<!-- END Page 1 Footer -->
		          ...
		          <!--Dotted Line-->
						...
						<div style="width: 187mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left; height: 5mm;">
							...
							<div class="styLNDesc" style="width: 107.5mm; height: 5mm; padding-top: 1.5mm;">Total miles the vehicle was driven during 2014
		          ...
		          <!--Dotted Line-->
					...
					<div style="width: 187mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left; height: 5mm;">
			          ...
			          <!--Dotted Line-->
						...
						<div class="styLNDesc" style="width:15mm;height:5mm;padding-top:1.5mm;text-align:right;">
							<span>
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleAvailableOffDutyHrsInd"/>
								</xsl:call-template>
      ...
      Section B-Standard Mileage Rate <span style="font-weight:normal;">(See the instructions for Part II to find out whether to complete this section or Section C.)	</span>
					...
					<div class="styBB" style="width: 187mm; height: 6mm; font-size: 8pt;">
						...
						<div class="styLNDesc" style="width: 139mm; padding-top: 1.5mm;">Multiply line 13 by 57.5¢ (.575). Enter the result here and on line 1 
		          ...
		          <!--Dotted Line-->
								...
								<div class="styIRS2106ColBox" style="height: 4mm; padding-top: 1mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section C 24b -->
							<div style="width: 187mm; height: 4mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4mm; text-align: right; padding-top: 0.5mm; padding-right: 1mm; padding-bottom: 0mm; font-size: 7pt;">b</div>
							...
							<!-- BEGIN Section C 24c -->
							<div style="width: 187mm; height: 4mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4mm; text-align: right; padding-top: 0.5mm; padding-right: 1mm; padding-bottom: 0mm; font-size: 7pt;">c</div>
							...
							<!-- END Section C 24c -->
							<!-- BEGIN Section C 25 -->
							<div style="width: 187mm; height: 16mm; clear: all; float: left;">
							<div class="styLNLeftNumBox" style="height:16mm; padding-top:3mm; font-size:8pt;">25</div>
							<div class="styLNDesc" style="width:44mm; height:16mm; font-size:7.5pt; padding-top:3mm;">Value<span style="width:1mm"/>of<span style="width:1mm"/> employer-provided vehicle (applies only if 100% 	of annual lease value was included <br/>
			on Form W-2-see instructions)</div>
							<div class="styLNRightNumBox" style="height:16mm;width:7mm;padding-top:12.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">25</div>
							<div class="styIRS2106ColBoxGrey" style="height:16mm; padding-top:13.5mm; border-left-width:0px; border-right-width:0px; border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:16mm; padding-top:12.5mm; border-left-width:1px; border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/ValueEmplrProvidedVehicleAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height:16mm; padding-top:13.5mm; border-left-width:1px; border-right-width:0px; border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:16mm; padding-top:12.5mm; border-left-width:1px; border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
				          ...
				          <!--Dotted Line-->
							...
							<!-- END Section C 28 -->
							<!-- BEGIN Section C 29 -->
							<div style="border-width: 0px 0px 1px; border-style: solid; border-color: black; width: 187mm; height: 8mm; clear: all; float: left;">
							<div class="styLNLeftNumBox" style="height:8mm; padding-top:0.5mm; padding-bottom:0mm; font-size:8pt;">29</div>
							<div class="styLNDesc" style="width: 44mm; height: 8mm; padding-top: 0.5mm; padding-bottom: 0mm; font-size: 7.5pt;">Add lines 27 and 28. <span style="width:2mm"/>Enter total here and on line 1
				          <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:8px"/>.
											<span style="width:8px"/>.
							...
							<div class="styLNRightNumBox" style="border-width: 0px 1px; border-style: solid; border-color: black; width: 7mm; height: 8mm; text-align: center; padding-top: 3.8mm; font-size: 8pt;">29</div>
							<div class="styIRS2106ColBoxGrey" style="height: 8mm; padding-top: 4.5mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 0px;"/>
							<div class="styIRS2106ColBox" style="height: 8mm; padding-top: 4.5mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/TotalActualExpenseAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 8mm; padding-top: 4.5mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;"/>
							<div class="styIRS2106ColBox" style="height: 8mm; padding-top: 4.5mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
			...
			on Form W-2-see instructions)</div>
		          ...
		          <!--Dotted Line-->
							...
							<!-- BEGIN Section D 31 -->
							<div style="width: 187mm; height: 8mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 8mm; padding-top: 1mm; font-size: 8pt;">31</div>
								<div class="styLNDesc" style="width: 44mm; height: 8mm; padding-top: 1mm; font-size: 7.5pt;">Enter section 179 deduction <br/>(see instructions)
										<!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:5px"/>.
												<span style="width:8px"/>.
							...
							<div class="styLNLeftNumBox" style="height: 12mm; padding-top: 1mm; font-size: 8pt;">32</div>
							<div class="styLNDesc" style="width: 44mm; height: 12mm; padding-top: 2mm; font-size: 7.5pt;">Multiply line 30 by line 14 (see instructions if you 
		claimed the section 179 deduction)
		          ...
		          <!--Dotted Line-->
							...
							<!-- BEGIN Section D 33 -->
							<div style="width: 187mm; height: 8mm; clear: all; float: left;">
							<div class="styLNLeftNumBox" style="height: 8mm; padding-top: 1.5mm; font-size: 8pt;">33</div>
							<div class="styLNDesc" style="width: 44mm; height: 8mm; padding-top: 1.5mm; font-size: 7.5pt;">Enter depreciation method and percentage
		 (see instructions)
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 8mm; text-align: center; padding-top: 4.5mm; font-size: 8pt;">33</div>
							<div class="styIRS2106ColBox" style="height: 8mm; text-align: left; color: darkblue; padding-top: 2mm; font-size: 6.5pt; border-right-width: 0px; border-left-width: 0px;">
								<xsl:call-template name="PopulateText">
							...
							<div class="styIRS2106ColBoxGrey" style="height: 8mm; padding-top: 6.3mm; border-right-width: 0px; border-left-width: 1px;"/>
							<div class="styIRS2106ColBox" style="height: 8mm; text-align: left; color: darkblue; padding-top: 2mm; font-size: 6.5pt; border-right-width: 0px; border-left-width: 1px;">
								<xsl:call-template name="PopulateText">
		 ...
		 (see instructions)
		          ...
		          <!--Dotted Line-->
							...
							<div class="styIRS2106ColBoxGrey" style="height: 5mm; padding-top: 8mm; border-right-width: 0px; border-left-width: 1px;"/>
							<div class="styIRS2106ColBox" style="height: 5mm; padding-top: 1.5mm; border-right-width: 0px; border-left-width: 1px;">
								<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section D 36 -->
							<div style="width: 187mm; height: 12mm; clear: all; float: left;">
							<div class="styLNLeftNumBox" style="height: 12mm; padding-top: 1mm; font-size: 8pt;">36</div>

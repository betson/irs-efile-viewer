...
<!-- 08/04/2015 - Changes made for defect 43696 - Jeremy Nichols -->
<!-- 09/22/2015 - Changes made for defect 43695 - Jeremy Nichols -->
    ...
    credit card issued to the state or local government by a credit card issuer.
	 ...
	 <span style="width:16px"/>.
        ...
        <span style="width:16px"/>.
          ...
          <div class="pageEnd" style="width:187mm;border-top:0px black solid;">
                  ...
                  <tr>
                    <xsl:choose>
                      <xsl:when test="position() = count($FormData/KeroseneUsedInAviation/OtherNontaxableUsesTaxedAt219)">
                        <td style=" height:3mm;width:6mm;text-align:center;">e</td>
                      </xsl:when>
                      <xsl:otherwise>
                        <td style=" height:3mm;width:6mm;text-align:center;border-bottom:0px black solid;">e</td>
                      </xsl:otherwise>
                    </xsl:choose>
      ...
      educational organization by the credit card issuer.
          ...
          <!--footnote-->
          <div class="pageEnd" style="width:187mm;border-top-width:0px;">

	...
	<xsl:template match="/">
      ...
      20<span class="styTYColor">15</span>
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:auto;width:182mm;float:left;clear:none;">For the 2015
...
-->
							...
							<div class="styNameAddr" style="width:110mm;height:10mm;border-left-width:1px;">
...
<!-- Section H -->
  ...
  Add lines 5b, 6c, and 7b to line 9 to determine gross receipts. If gross receipts are $200,000 or more, or if total assets (Part II, column (B)  
    ...
    Form<span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span>(2015)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="width:187mm;padding-top:1mm;">
						<div style="float: left; clear: none">Form 990-EZ (2015)</div>
						<div style="float:right">
    Page <span class="styBoldText" style="font-size: 8pt">2</span>
            ...
            <!-- Dotted Line -->
                ...
                <input type="checkbox" class="styIRS990EZCkBox">
					...
					<!--</div>-->
					<div class="styTableNBB" style="height:52mm;width:187mm;display:table;" id="SPctn">
                ...
                describe the services provided,   the number of persons benefited, and other relevant information for each program title.   
							...
							<xsl:if test="($Print != $Separated) or (count($IRS990EZData/ProgramSrvcAccomplishmentGrp) &lt;=3)">
										<tr>
											...
											<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 1px; border-right-width: 1px; border-left-width: 0px; border-top-width: 0px; font-weight: bold; width: 6mm; vertical-align:top;">
												<xsl:choose>
							...
							<!--**************Put in smaller font for amounts because it wraps with 7pt******************************-->
											<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 1px; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px;vertical-align:top;font-size:6pt;">
												<xsl:call-template name="PopulateAmount">
    ...
    <xsl:call-template name="SetFormLinkInline">
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNAmountBox" style="border-bottom-width:0;background-color:none;"/>
						<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width:0;"/>
						<!--  Yes box  -->
						<div class="styIRS990EZYesNoBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width:0;"/>
						<!--  No box  -->
                ...
                <span class="styBoldText">   No</span>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;height:100%;display:inline">
						<tr>
							...
							<div style="width:187mm;">
							<div class="styLNDesc" style="height:100%;font-size:6pt;padding-left:0mm;padding-top:2mm;vertical-align:center;">Under penalties of perjury, I declare that I have examined this return, including accompanying schedules and statements, and to the best of my knowledge and belief, it is true, correct, and complete. Declaration of preparer (other than officer) is based on all information of which preparer has any knowledge.
							</div>
							</div>
...
-->
	...
	<!-- </label> -->
					...
					<!--   BEGIN FORM FOOTER  -->
					<div style="width:187mm;">
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2015)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>

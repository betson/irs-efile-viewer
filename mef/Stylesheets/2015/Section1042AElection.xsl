          ...
          <tr>
           ...
           <!--Column 4 - Adjusted Basis Of Securities -->
            ...
            <td class="styDepTblCell" style="width:35mm;text-align:left;vertical-align:top;font-size:6.5pt">
              ...
              <!--Allow row to expand by column -->
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="NameOfESOPOrCooperative/BusinessNameLine1Txt"/>
              </xsl:call-template>
              <br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="NameOfESOPOrCooperative/BusinessNameLine2Txt"/>
              </xsl:call-template>
              <span class="styTablecellpad"/>
            </td>
            <!--Column 5 - Name Of ESOP Or Cooperative -->

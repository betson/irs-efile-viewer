					...
					<div style="width:187mm;height:auto;">
						...
						<div style="width:97.5mm;height:auto;float:left;">
							...
							<div style="width:98mm;height:11mm;float:left;border-top:solid black 1px;">
								<!--Blank Box -->
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:4px;height:10.9mm;                                       width:49mm;">
									<span style="width:2px;"/>
								...
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:4px;height:10.9mm;                                       width:49mm;">
									...
									<span style="width:1mm;"/>
									<span style="font-size: 7pt;">1st year of desig. Roth contrib.
									</span>
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:32mm;float:left;">
								      <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:32mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;               border-left:1px solid black;text-align:center;">
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:32mm;float:left;">
								      <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:3.8mm;width:32mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;text-align:left" valign="bottom">&#160;
                                          </td>
									    </tr>
									    <tr>
								  ...
								  <!--<td colspan="3" class="styIRS1099R_tdRight">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:25mm;               font-size:6pt;border-bottom:1px solid black;border-right:0px solid black;">&#160;
										  </td>
									    </tr>
									    <tr>
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight" style="border-top-width:0px">
								    <table cellpadding="0" cellspacing="0" style="width:32mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:32mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;               border-left:1px solid black">&#160;
                                          </td>
									    </tr>
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:32mm;               font-size:6pt;border-bottom:1px solid black;border-right:1px solid black;               border-left:1px solid black">&#160;
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight" style="border-top-width:0px">
								    <table cellpadding="0" cellspacing="0" style="width:32mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:32mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;               text-align:left">&#160;
                                          </td>
									    </tr>
									    <tr>
								  ...
								  <!--<td colspan="3">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.1mm;width:25mm;               font-size:6pt;border-bottom:1px solid black;border-right:0px solid black;">&#160;
									      </td>
									    </tr>
									    <tr>

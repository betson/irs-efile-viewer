		...
		<html>
            ...
            Form <span class="styFormNumber"> 2106-EZ<br/>
						...
						<div class="styTYBox" style="width:36mm; height:21mm;">
							...
							<div class="styTY" style="height: 9mm; font-size: 22pt;">2015</div>
          ...
          Social security number<br/>
					...
					<div class="styBB" style="padding: 1mm 0mm; width: 187mm; height: 44mm; clear: left; float: left;">
						<span style="width: 187mm; height: 5mm; font-weight: bold;">You Can Use This Form Only if All of the Following Apply.</span>
							...
							<li><img src="{$ImagePath}/8911_Bullet_Round.gif" width="5" height="5" alt="Bullet"/> You <span style="font-weight:bold">do not</span> get reimbursed by your employer for any expenses (amounts your employer 
								  ...
								  <br/>
							<li><img src="{$ImagePath}/8911_Bullet_Round.gif" width="5" height="5" alt="Bullet"/> If you are claiming vehicle expense, you are using the standard mileage rate for 2015.</li>
							<br/>
								<span style="font-weight:bold">Caution:</span> <span style="font-style:italic;">
									You can use the standard mileage rate for 2015 <span style="font-weight:bold">only if: (a)</span> you owned the vehicle and used the standard mileage rate for the first year
					...
					<div style="width:187mm; height:6mm; clear: left; float: left;">
						...
						Complete Part II. Multiply line 8a by 57.5¢ (.575). Enter the result here
...
entertainment<span style="letter-spacing:3mm;">...</span></div>
					...
					<div class="pageEnd" style="width:187mm; border-top:2px solid black; padding-top:0.5mm; clear: left; float: left;">
						...
						Form <b style="font-size:9pt">2106-EZ</b> (2015)
						</div>
					</div> 
					<!--END Page Footer-->
					<!-- Additonal Data Title Bar and Button -->
					<div class="styLeftOverTitleLine" id="LeftoverData" style="width: 187mm; height: auto; clear: all; float: left;">
	...
	<xsl:template name="makeRow">
		...
		<div style="width:187mm; height:4mm; clear: left; float: left;"/>
					...
					<div style="width: 187mm; height: 4.5mm; clear: left; float: left;">
						...
						<div class="styLNDesc" style="height:4.5mm;width:180mm;">Of the total number of miles you drove your vehicle during 2015, enter the number of miles you used your vehicle for:</div>
					</div>
					<div style="width:187mm;height:2mm; clear: left; float: left;"/>

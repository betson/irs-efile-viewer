...
<!-- edited with XML Spy v4.4 U (http://www.xmlspy.com) by Ken Dulabhan (Comteq Federal Inc) --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/NonAutomaticChgReqProcStmt"/>
  <!-- 3115  - Non Automatic Change Request Procedures Statement -  -->
        ...
        <table id="AdjustmentsScheduleLineTbl" class="styDepTbl">
          <thead class="styTableThead">
            <tr class="styDepTblHdr">
              <th class="styDepTblCell" scope="col" style="width:187mm;">Non Automatic Change Request Procedures Statement </th>
            </tr>
          </thead>

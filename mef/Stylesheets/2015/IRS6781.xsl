...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<form name="Form6781">
					...
					<div class="styTableContainer" style="height:auto" id="LFSctn">
						...
						<table class="styTable" cellspacing="0" style="border-color:black;">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:32mm;font-weight:normal;"> (a)<span class="styNormalText;height:10mm;"> Description of property</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:17mm;font-weight:normal;"> (b)<span class="styNormalText;height:10mm"> Date entered<br/>into or acquired</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:17mm;font-weight:normal;"> (c)<span class="styNormalText;height:10mm"> Date closed out or sold</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:24mm;font-weight:normal;"> (d)<span class="styNormalText;height:10mm"> Gross sales price</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:24mm;font-weight:normal;"> (e)<span class="styNormalText;height:10mm"> Cost or other basis plus expense of sale</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:24mm;font-weight:normal;"> (f) Loss. <span class="styNormalText;height:10mm">If column (e) is more than (d), enter difference. Otherwise, enter -0-</span>
									</th>
									<th class="styTableCellHeader" scope="col" style="width:24mm;font-weight:normal;"> (g)<span class="styNormalText;height:10mm;"> Unrecognized gain on offsetting positions</span>
									</th>
									...
									<xsl:for-each select="$Form6781Data/GainsFromStraddlesInfoGrp">
										<tr style="height:5mm;">
											<td class="styTableCellTextSmall" style="width:40mm;border-right-width:0px;">
												...
												<span class="styBoldText" style="padding-right:34mm;">
  ...
  <!-- Line 13a  -->
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc" style="width: 170mm;height:3.8mm;">
							<div class="styGenericDiv" style="width:1mm; float: right; clear: none;">
								<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styTableContainer" style="width:187mm;" id="UGLctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="border-color:black;">
					...
					<div style="width:187mm;">
					   ...
					   <span style="width:40mm"/>  
						  Form <span class="styBoldText" style="font-size:8pt">6781</span> (2015)
					</div>
					<div class="pageEnd"/>

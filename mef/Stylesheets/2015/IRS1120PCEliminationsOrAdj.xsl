			...
			<!--Form box end -->
			  ...
			  <div class="styFST" style="height:5mm;font-size:6pt;margin-left:2mm;text-align:center;font-weight:normal">
				...
				<div class="styFST" style="height:5mm;font-size:5.6pt;padding-top:1mm;">
                  ...
                  <a href="http://www.irs.gov/form1120pc" title="Link to irs.gov">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">15</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
...
<span style="padding-left:0.75mm"/>
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
			...
			<div style="width:2mm;height:35mm;"/>
							<img src="{$ImagePath}/1120PC_TaxComputation.gif" alt="VerticalIncome" style="width:4.8mm;"/>
		  </div>
		  <!--line 1 -->
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div style="width:181mm;">
			  <div style="float:left; clear:none;">
				...
				<div class="styLNDesc" style="width:53mm;height:4.5mm;font-size:6pt;"> 2015 estimated tax payments (see instructions)</div>
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:91.5mm;height:4.5mm;">
				  <span style="float:left"> 2015 special estimated tax payments (Do not include on line 14f)</span>
				</div>
			  </div>
			  <div style="float:right;clear:none;">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:53mm;height:4.5mm;font-size:6pt;">2015 refund applied for on Form 4466
				  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
		  ...
		  <!-- Page 2 Header -->
			...
			<div style="float:left;">Form 1120-PC (2015)<span style="width:146mm;"/>
		  </div>
	  ...
	  <div class="styLblNameAddr" style="width:93mm;height:27mm;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px;border-right-width: 0px;">
		...
		<div class="styGenericDiv" style="width:93.5mm;">
		  ...
		  <div class="styGenericDiv" style="width:93.5mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			  Enter the available NOL carryover<br/> from prior tax years. (Do not reduce it by any<br/> 
			  <span style="float:left">deduction on line 36b, Schedule A.)</span>
			  <!--Dotted Line -->
		...
		<div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:none;clear:both;">
		  <div class="styLblNameAddr" style="width:93.5mm;height:auto;border-top-width: 0px;border-bottom-width: 0px; border-left-width: 0px;border-right-width: 1px;float:left;clear:left;">
			...
			<div class="styGenericDiv" style="width:93.5mm;">
			  ...
			  <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;width:32mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleM1/TotalTaxableIncmNotRecOnBksAmt"/>
				</xsl:call-template>
			  </div>
			...
			<div class="styGenericDiv" style="width:93.5mm;">
			  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 2.25mm"></div>
			  <div class="styLNDesc" style="width:53.5mm;height:4.5mm;">
				<div class="styUnderlineAmount" style="width:53.5mm;text-align:right;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleM1/TotalTaxableIncmNotRecOnBksAmt"/>
				  </xsl:call-template>
				</div>

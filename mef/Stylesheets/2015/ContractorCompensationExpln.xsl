        ...
        <xsl:for-each select="$DependencyData/ContractorCompExplnGrp">
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:left">
              ...
              <xsl:if test="ContractorBusinessName/BusinessNameLine1Txt != ''">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="ContractorBusinessName/BusinessNameLine1Txt"/>
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="ContractorBusinessName/BusinessNameLine2Txt != ''"><br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="ContractorBusinessName/BusinessNameLine2Txt"/>
                </xsl:call-template>
              </xsl:if>
            </td>
            <td class="styDepTblCell" style="text-align:left;">

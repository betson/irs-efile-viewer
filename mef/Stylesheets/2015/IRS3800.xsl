			...
			<body class="styBodyClass">
               ...
               Form<span class="styFormNumber"> 3800</span>
                ...
                OMB No. 1545-0895
							...
							<div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">15</span>
							</div>
         ...
         <xsl:call-template name="PartIIITemplate"/>        
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credits allowed for 2015 (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">........</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Carryforward of general business credit to 2015. Enter the amount from line 2 of Part III with box C</span>
                    ...
                    <!--Dotted Line-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								...
								<span style="float:left;">Carryback of general business credit from 2016. Enter the amount from line 2 of Part III with box D</span>
		      ...
		      <span style="padding-left:4mm;width:114.8mm;">
					...
					<span class="styDotLn" style="float:right;">..........</span>
								...
								<span style="padding-left:4mm;width:114.8mm;">
									<li>Corporations. Enter the amount from Form 4626, line 14
					<span class="styDotLn" style="float:right;">.........</span>
									</li>
								</span>
								<span style="padding-left:4mm;width:114.8mm;">
             ...
             Tentative minimum tax: 
		      <span style="padding-left:4mm;width:85.8mm;">
					...
					<span class="styDotLn" style="float:right;">..</span>
								...
								<span style="padding-left:4mm;width:85.8mm;">
									<li> Corporations. Enter the amount from Form 4626, line 12
					<span class="styDotLn" style="float:right;">.</span>
									</li>
								</span>
								<span style="padding-left:4mm;">
                ...
                <!--Pen and ink image -->
						...
						<div style="width:187mm;clear:both;" class="styGenericDiv">
							...
							<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3800</span> (2015)</div>
						</div>
					</div>
					<p style="page-break-before: always"/>
					<!-- Page 2 Header -->
					<div style="width:187mm;clear:both;padding-bottom:.5mm;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Form 3800 (2015)</div>
              ...
              Passive activity credit from line 3 of all Parts III with box B checked 
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credit allowed for 2015 (see instructions)</span>
								<div class="styDotLn" style="float:right;">.........</div>
							</div>
              ...
              <!--<span style="float:left;">line 6 of all Parts III with box F check</span>-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryforward of business credit to 2015. Enter the amount from line 5 of Part III with box C checked 
              <span style="float:left;">and line 6 of Part III with box G checked. See instructions for statement to attach
                <!-- Push Pin image -->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryback of business credit from 2016. Enter the amount from line 5 of Part III with box D checked 
...
<!--						<label>
					...
					<div style="width:187mm;">
						...
						<div style="width:6mm;padding-top:3mm;">
							<input type="checkbox" class="styCkbox" style="padding-top:1mm;">
								<xsl:call-template name="PopulateCheckbox">
             ...
             <span style="float:left"> instructions for limitation)</span>
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">   Nonconventional source fuel
                 	<!-- Push Pin image -->
<!--								<xsl:call-template name="SetFormLinkInline">
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">   Energy efficient appliance 
                                    			<!-- Push Pin image -->
<!--								<xsl:call-template name="SetFormLinkInline">
				...
				<div style="width:187mm;">
					...
					<div style="float:right;clear:none;">
						...
						<div class="styLNAmountBox" style="border-bottom-width:0px;border-top-width:1px;background-color:lightgrey;height:4.5mm;">
...
1065-B)) 
				...
				<div style="width:187mm;">
					...
					<div style="float:right;clear:none;">
						<div class="styLNRightNumBoxNBB" style="border-top-width:1px;height:4.5mm;">1zz</div>
						<div class="styLNAmountBoxNBB" style="border-top-width:1px;text-align:center;height:4.5mm;">
          ...
          Employer social security and Medicare taxes paid on certain employee tips (Form 8846)    
				...
				<div style="width:187mm;">
					...
					<div style="float:right;clear:none;">
						...
						<div class="styLNAmountBoxNBB" style="height:4.5mm;border-top-width:1px;background-color:lightgrey"/>
						<div class="styLNAmountBoxNBB" style="height:4.5mm;border-top-width:1px;background-color:lightgrey">	</div>
					</div>
				</div>
				<!-- Schedule C Line 4j-->
				<div style="width:187mm;">
				...
				<div style="width:187mm;float:left;">
					...
					<div style="width:187mm;">
						...
						<div style="width:6mm;padding-top:3mm;float:right;">
							<span type="checkbox" class="styCkbox" style="border:1px solid black;padding-top:1mm;">
						</span>
						</div>
					</div>
				</div>
...
Enter the appropriate amount
             ...
             <span style="float:left"> instructions for limitation)</span>
				...
				<div style="width:187mm;">
					...
					<div style="float:right;clear:none;">
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;border-top-width:1px;">1zz</div>
						<div class="styLNAmountBoxNBB" style="height:4.5mm;border-top-width:1px;"/>
						<div class="styLNAmountBoxNBB" style="height:4.5mm;border-top-width:1px;">
						</div>
					</div>

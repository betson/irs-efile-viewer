...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
				...
				<form name="Form1065B">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:35mm;height:20mm;">
							<div class="styOMB" style="width:35mm;">OMB No. 1545-0123</div>
      ...
      Check accounting method: 
         ...
         Other (specify)
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:126mm;font-size:6pt;">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2015)
                    </div>
					</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2015)<span style="width:148mm;"/>
						</div>
...
and 8813. (See instructions.)
						...
						<div style="width:187mm">
							...
							<div class="styLNDesc" style="width:167mm">At any time during calendar year 2015, did the partnership have an interest in or a signature or other authority
    ...
    to this return.
					...
					<div  style="width:187mm;">
                        ...
                        <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2015)
                    </div>
					</div>
					<p style="page-break-before: always"/> 
					<!-- END Page Break and Footer-->
      ...
      Form
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2015)

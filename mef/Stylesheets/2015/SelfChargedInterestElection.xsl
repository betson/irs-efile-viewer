        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$RtnDoc/SelfChargedInterestElection/PartnershipName/BusinessNameLine1Txt"/>
            </xsl:call-template><br/>
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$RtnDoc/SelfChargedInterestElection/PartnershipName/BusinessNameLine2Txt"/>
            </xsl:call-template>
          </div>
        </div>
      ...
      <!--  <xsl:if test="USAddress!= ''">
                ...
                <xsl:call-template name="PopulateText">
                        ...
                        <xsl:if test="ForeignAddress!= ''">
                            ...
                            <xsl:if test="ForeignAddress/ProvinceOrStateNm != ''">,<span style="width: 1mm"/>
                              <xsl:call-template name="PopulateText">

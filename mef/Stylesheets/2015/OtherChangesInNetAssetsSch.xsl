...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherChangesInNetAssetsSch" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="OCNATbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      ...
      <tfoot></tfoot>
      <tbody>        
      <xsl:for-each select="$DependencyData/OtherChangesInNetAsset">
        <tr>
  ...
  <xsl:template match="/">
    <html>
      <head>
         <title>
           <!--Other Changes in Net Assets Schedule-->
      ...
      <body class="styBodyClass">    
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:110mm">
            <!--TY 2003 Other Changes in Net Assets Schedule-->
            <xsl:value-of select="$depDocTitle" />  
          </div>
        </div>        

      ...
      <body class="styBodyClass" style="width:187mm">
        <form name="Form1120PCSchM3ElimOrAdj">
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styTYBox" style="width:30mm;height:21mm;border-left-width:2px;">
              ...
              <div class="styTY" style="height:13.5mm;padding-top:2mm;">20<span class="styTYColor">15</span>
              </div>
            </div>
          </div>
		...
		Mixed 1120/L/PC group
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-PC) 2015</div>
          </div>
          <!-- Page 2 -->
          <p style="page-break-before:always"/>
          <!-- Page 2 Header -->
          <div class="styBB" style="width:187mm;border-bottom:solid 2px;">
            <div style="float:left;">Schedule M-3 (Form 1120-PC) 2015</div>
          ...
          <!-- Part II Table -->
          <table class="styTBB" id="IRS1120PCScheduleM3PartIITable" summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable Income per Return " cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;border-bottom-width:0">
...
<!--                <span class="styDotLn" style="float:right;padding-right:1mm;"/>-->
          ...
          <!-- Page 2 END -->
          <div class="pageEnd" style="width:187mm;">
            <div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-PC) 2015</div>
          </div>
          <!-- Page 3 -->
          <p style="page-break-before:always"/>
          <!-- Page 3 Header -->

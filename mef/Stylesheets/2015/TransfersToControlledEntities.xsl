...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/TransfersToControlledEntities"/>
  ...
  <xsl:template name="TransToCntrlEntScheduleTemp">
    <table id="TransToCntrlEntTbl" class="styDepTbl" style="font-size: 6pt">
 ...
 <!--         <th class="styDepTblCell"  scope="col" style="font-size:10 pt;">Total</th> -->
      ...
      <xsl:for-each select="$DependencyData/TransfersToControlledEntGrp">
        <tr>
  ...
  <xsl:template match="/">
    ...
    <!-- NameDisplay - IRS990PF - Transfers To Controlled Entities Schedule -->
    <body class="styBodyClass">  
     <xsl:call-template name="DocumentHeaderDependency"/>
      ...
      <xsl:call-template name="TransToCntrlEntScheduleTemp"/>
    </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
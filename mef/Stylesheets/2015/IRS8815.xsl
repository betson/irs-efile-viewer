				...
				<form name="Form8815">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:125mm;height:22.2mm;">
							...
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:4.5mm;">
								...
								Information about Form 8815 and its instructions is at <i>www.irs.gov/form8815.</i><br/>
								<img src="{$ImagePath}/8815_Bullet.gif" width="9" height="9" alt="bullet image"/>
					...
					<div class="styTableContainer" id="tblctn">
						...
						<table style="width:187mm;border-collapse:collapse;font-size:7pt;float:right;">
							<thead>
								...
								<th scope="col" style="width:94mm;font-weight:normal;border:1px solid black;border-right:none;border-top:none;font-size:7pt;padding-top:3mm;">
							...
							<tbody>
								...
								<td style="border:1px solid black;border-right:none;height:18.5mm;width:94mm;">
										...
										<div style="height:11.0mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">				
										<xsl:choose>
										<xsl:when test="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress[1]">
										<xsl:call-template name="PopulateText">
						...
						<span style="width:2mm;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp[1]/EligibleInstitutionFrgnAddress/CityNm"/>
                                                 ...
                                                 <xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp[1]/EligibleInstitutionFrgnAddress/ProvinceOrStateNm"/>
										</xsl:call-template>
                                                 <xsl:call-template name="PopulateText">
								...
								<tr>
									...
									<div style="height:11.0mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">				
										<xsl:choose>
										<xsl:when test="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress[2]">
										<xsl:call-template name="PopulateText">
						...
						<span style="width:2mm;"/>
								...
								<td style="border:1px solid black;border-right:none;height:18.5mm;width:94mm;">
										...
										<div style="height:11.0mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">				
										<xsl:choose>
										<xsl:when test="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress[3]">
										<xsl:call-template name="PopulateText">
						...
						<span style="width:2mm;"/>
								...
								<xsl:if test="$Print != $Separated">
									<xsl:for-each select="$FormData/EligibleEducationInstnGrp[position() &gt; 3]">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress/AddressLine1Txt"/>
										</xsl:call-template>
						<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress/AddressLine2Txt"/>
										</xsl:call-template>
								<span style="width:2mm;"/>
											<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress/CityNm"/>
												</xsl:call-template><span style="width:1mm;"/>
													<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress/StateAbbreviationCd"/>
												</xsl:call-template><span style="width:2mm;"/>
                                    <xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionUSAddress/ZIPCd"/>
												</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>		
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/AddressLine1Txt"/>
										</xsl:call-template>
					<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/AddressLine2Txt"/>
										</xsl:call-template>
						<span style="width:2mm;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/CityNm"/>
										</xsl:call-template>
                                                 <xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/ProvinceOrStateNm"/>
										</xsl:call-template>
                                                 <xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/CountryCd"/>
										</xsl:call-template>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EligibleEducationInstnGrp/EligibleInstitutionFrgnAddress/ForeignPostalCd"/>
										</xsl:call-template>		
								</xsl:otherwise>
								</xsl:choose>							
								</xsl:if>
					...
					<div class="styBB" style="width:187mm;">
						<div style="width:187mm;">
							...
							Enter the total qualified higher education expenses you paid in 2015 for the person(s) listed in
column (a) of line 1. See the instructions to find out which expenses qualify<span style="letter-spacing:3mm;">.................</span>
							</div>
							<div class="styLNRightNumBox" style="height:8mm;padding-left:0mm;padding-top:4mm;">
								2
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:141mm;height:8mm;">Enter the total of any nontaxable educational benefits (such as nontaxable scholarship or fellowship grants) received for 2015 for the person(s) listed in column (a) of line 1 (see instructions)<span style="letter-spacing:3mm;">.........</span></div>
...
after 1989</span> that you <span style="font-weight:bold">cashed during 2015</span><span style="letter-spacing:3mm;">..........................</span></div>
...
5. Enter the result as a decimal (rounded to at least three places)<span style="letter-spacing:3mm;">.................</span></div>
							<div class="styLNRightNumBox" style="height:8mm;position:relative">
								<span style="padding-top:4.5mm;">7</span>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNRightNumBox" style="position:relative;height:4.5mm;">
								<span style="padding-top:1mm;">8</span>
							</div>
							<div class="styLNAmountBox" style="height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:101mm;height:12mm;padding-right:4px;overflow:hidden;"><span style="font-weight:bold;">Note: </span> <i> If line 9 is $92,200 or more if single or head of household, or $145,750 or more if married filing jointly or qualifying widow(er) with dependent child, <b>stop</b>. You <b>cannot</b> take the exclusion.</i></div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:101mm;height:8mm;">Enter: $77,200 if single or head of household; $115,750 if married filing
jointly or qualifying widow(er) with dependent child<span style="letter-spacing:3mm;">...........</span>
							</div>
							<div class="styLNRightNumBox" style="padding-left:2px;height:8mm;padding-top:4.5mm;">
								10
							</div>
...
13, and go to line 14<span style="letter-spacing:3mm;">....................</span>
							...
							<div class="styLNRightNumBox" style="height:8mm;padding-left:2px;padding-top:1.5mm;">
								<br/>11
							</div>
							<div class="styLNAmountBox" style="height:8mm;padding-right:2px;"><br/>
								<xsl:call-template name="PopulateAmount">
...
<br/>places)<span style="letter-spacing:3mm;">.................................</span>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNRightNumBox" style="padding-left:2px;height:4.5mm;padding-top:1mm;">
								13
							</div>
							<div class="styLNAmountBox" style="height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm;clear:all;">
						...
						Form <b style="font-size:9pt">8815</b> (2015)
						</div>
					</div>

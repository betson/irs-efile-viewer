...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/RequiredInterestOnReservesSch"/>
<!-- Display Document name Required Interest on Reserves Schedule -->
  <!-- Main template begin -->
  ...
  <xsl:template match="/">
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
	  ...
	  <!--table begin -->      
      	...
      	<xsl:for-each select="$DependencyData/RequiredInterestOnReserves">
        		<tr>

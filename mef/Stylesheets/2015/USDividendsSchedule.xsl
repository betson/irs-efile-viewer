...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/USDividendsSchedule"/>
    ...
    <table class="styDepTblLandscape" style="font-size:7pt">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           ...
           <th class="styDepTblCell" scope="col" style="width:32mm">Class of voting</th>       
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/USDividendPrtshpItemGrp">
          <tr>

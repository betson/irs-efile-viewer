	  ...
	  <body class="styBodyClass" style="width:187mm;">
		<form name="Form851">
				...
				<tbody>
			      ...
			      <xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
				    <tr>
				      ...
				      <!--Column 2 -->
				      <td class="styTableCell" style="width:81mm;height:10mm;text-align:left;vertical-align:top;">Subsidiary corporations:
				        <br/>
			...
			<table class="styTable" cellspacing="0" summary="Table Changes in Stock Holdings During the Tax Year" style="font-size:7pt;">
			  <thead class="styTableThead">
				...
				<tr>
				  ...
				  <th class="styTableCell" scope="col" style="width:21mm;text-align:center;font-weight:normal;">Percent of voting power</th>
				  <th class="styTableCell" scope="col" style="width:21mm;text-align:center;font-weight:normal;border-right:none;">Percent of value</th>
				</tr>
			  </thead>
			  <tfoot/>
			  <tbody>
				...
				<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
				  <tr>
					...
					<!-- Column 7 -->
					<td valign="top" class="styTableCell" style="width:22mm;vertical-align:bottom;">
					  <span style="padding-top:6mm;">%</span>
					</td>
					<!-- Column 8 -->
				    <td valign="top" class="styTableCell" style="width:22mm;vertical-align:bottom;border-right-width:0px;">
					  <span style="padding-top:6mm;">%</span>
					</td>
				  </tr>
				</xsl:if>
				...
				<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
				  ...
				  <xsl:for-each select="StockHoldingChangesForTaxYear">
					<xsl:if test="position() &gt;1">
					  <tr>
						<!-- Define background colors to the rows -->
						<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow2</xsl:when><xsl:otherwise>styDepTblRow1</xsl:otherwise></xsl:choose></xsl:attribute>												<!-- Column 3 Part III line2 for inline format -->
						<td valign="top" class="styTableCell" style="width:15mm;text-align:left;">
						  <xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="ShareholderOfCorporationNum"/>
						  </xsl:call-template>
		  ...
		  <xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated)">
		    <br/>
			<span class="styRepeatingDataTitle">Form 851, Part IV, Line 1 - Additional Stock Information<span class="styNormalText">  (see instructions)</span>:</span>
			<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
			  <tr class="styDepTblHdr">
		  ...
		  <xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated)">
			<br/>
			<span class="styRepeatingDataTitle">Form 851, Part IV, Line 2 - Additional Stock Information<span class="styNormalText">  (see instructions)</span>:</span>
			<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
			  <thead class="styTableThead">
				<tr class="styDepTblHdr">
				  <th class="styDepTblCell" scope="col" rowspan="1" style="width:10mm;text-align:center;font-weight:normal;">Corp. No.</th>
		  ...
		  <xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated)">
			<br/>
			<span class="styRepeatingDataTitle">Form 851, Part IV, Line 3 - Additional Stock Information<span class="styNormalText">  (see instructions)</span>:</span>
			<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
			  <thead class="styTableThead">
				<tr class="styDepTblHdr">
				  <th class="styDepTblCell" scope="col" rowspan="1" style="width:10mm;text-align:center;font-weight:normal;">Corp. No.</th>
		  ...
		  <xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated)">
			<br/>
			<span class="styRepeatingDataTitle">Form 851, Part IV, Line 3d - Additional Stock Information<span class="styNormalText">  (see instructions)</span>:</span>
			  <table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
				<thead class="styTableThead">
				  <tr class="styDepTblHdr">
					<th class="styDepTblCell" scope="col" style="width:10mm;text-align:center;font-weight:normal;">Corp. No.</th>

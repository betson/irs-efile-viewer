		...
		<html lang="EN-US">
			<head>
				...
				<style type="text/css">
					...
					<!--HINTS: Tester claim data in all tables is double line spacing, reject the claim is invalid.  Appear double spacing but when max characters are added the line is single spacing -->
					<!--HINTS: Tester claim data in all tables should be top align.  Reject, the customer concur with the design and not all data is top align -->
				...
				<form name="Form851">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<div class="styFNBox" style="width:30mm;height:21mm;border-right-width:2px;">
							...
							<div class="styAgency" style="width:22mm;height:6mm;">(Rev. December 2010)
						...
						<div class="styFTBox" style="width:127mm;height:21mm;">
							...
							<br/>
							<div class="styFBT" style="font-size: 7pt;padding-top:3mm;">
								<img src="{$ImagePath}/851_Bullet_Sm.gif" alt="Right pointing arrow large image"/>
								<span style="width:1mm;"/>File with each consolidated income tax return.</div>
							<br/>
							<div style="font-size:7pt;font-weight:normal;padding-top:4mm;">
						...
						<div class="styTYBox" style="width:30mm;height:21mm;border-left-width:2px;">
							<span style="width:110px;font-size:7pt;padding-top: 9mm">OMB No. 1545-0025</span>
						</div>
					</div>
					<!-- Name and EIN -->
					...
					<div class="styBB" style="width:187mm;">
						<div style="width:140mm;height:9mm;">Number, street, and room or suite no. If a P.O. box, see instructions.<br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
					...
					<div class="styBB" style="width:187mm;height:9mm;">
						<div style="font-size:7pt;width:140mm;">City or town, state, and ZIP code<br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
					...
					<div class="styTableContainer" id="TPctn" style="width:187mm;">
						...
						<table cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								<tr>
									<td valign="bottom" class="styTableCell" style="width:10mm;font-weight:bold;text-align:right;padding-right:3mm;">
									...
									<td valign="bottom" class="styTableCell" style="width:81mm;text-align:left;">Common parent corporation </td>
									<td class="styTableCell" style="width:32mm;background-color:lightgrey;"/>
									<td valign="bottom" class="styTableCell" style="width:32mm;text-align:right;">
									...
									<td valign="bottom" class="styTableCell" style="width:32mm;text-align:right;border-right:none;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
											<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
									<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
										<tr>
											...
											<td valign="bottom" class="styTableCell" style="width:10mm;padding-right:3mm;font-weight:bold;text-align:right;">
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCell" style="width:32mm;border-style:solid;text-align:center;vertical-align:bottom;">
												<xsl:choose>
											...
											<td class="styTableCell" style="width:32mm;text-align:right;vertical-align:bottom;">
												<xsl:call-template name="PopulateAmount">
											...
											<td class="styTableCell" style="width:32mm;text-align:right;border-right:none;vertical-align:bottom;">
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
									<tr>
										...
										<td class="styTableCell" style="width:10mm;height:10mm;"/>
								...
								<tr>
									...
									<td colspan="2" class="styTableCell" style="vertical-align:bottom;width:113mm;height:10mm;border-bottom:none;">
										...
										<span class="styDotLn" style="float-right;padding-left:4mm;">.<img src="{$ImagePath}/851_Bullet_Sm.gif" alt="Right pointing arrow large image"/>
										</span>
									</td>
...
-->
					...
					<div class="styNBB" style="width:187mm;border-top-width:1px;">
						...
						<!--						<span class="styGenericDiv" style="float:right;height:4mm;clear:none;width:7mm;text-align:right;">
							...
							<table cellspacing="0" summary="Table describing Principal Business Activity, Voting Stock information, etc. (See instructions)" style="font-size:7pt;border-top:1px solid black;">
								<thead class="styTableThead">
									<tr>
									...
									<tr>
										...
										<th class="styTableCell" scope="col" style="width:21mm;text-align:center;font-weight:normal;">Percent of voting power</th>
										<th class="styTableCell" scope="col" style="width:21mm;text-align:center;font-weight:normal;">Percent of value</th>
								...
								<tbody>
									<tr style="height: 10mm">
										...
										<td valign="top" class="styTableCell" style="width:46mm;text-align:left;">Common parent corporation<br/>
											<!-- If the separated data tag is not switched, populate with data -->
											<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
												<xsl:call-template name="PopulateText">
										...
										<td valign="middle" class="styTableCell" style="width:12mm;text-align:center;border-right-width:1px;border-bottom-width:1px;">
											<!-- If the separated data tag is not switched, populate with data -->
											<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
												<xsl:choose>
									...
									<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
										<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
											<tr>
												...
												<td valign="middle" class="styTableCell" style="width:12mm;text-align:center;">
												...
												<td class="styTableCell" style="width:21mm;text-align:left;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="StockHoldingInfo[1]/SharesCnt"/>
													</xsl:call-template>
												</td>
												<td class="styTableCell" style="width:21mm;text-align:right;">
													<xsl:choose>
												...
												<td class="styTableCell" style="width:21mm;text-align:left;border-right:none;">
													<xsl:call-template name="PopulateText">
											...
											<xsl:for-each select="StockHoldingInfo">
												<xsl:if test="position() &gt; 1">
													<tr>
														...
														<td valign="bottom" class="styTableCell" style="width:21mm;text-align:left;">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SharesCnt"/>
															</xsl:call-template>
														</td>
														<!--Column 7 of Part II LIne 2 of Subsidiary for inline print -->
														<td valign="bottom" class="styTableCell" style="width:21mm;text-align:right;">
															<xsl:choose>
														...
														<td valign="middle" class="styTableCell" style="width:21mm;text-align:left;border-right:none;">
															<xsl:call-template name="PopulateText">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<table class="styTable" cellspacing="0" summary="Table Changes in Stock Holdings During the Tax Year" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCell" rowspan="2" scope="col" style="width:10mm;text-align:center;font-weight:normal;">Corp. No.</th>
									<th class="styTableCell" rowspan="2" scope="col" style="width:16mm;text-align:center;font-weight:normal;">Name of corporation  </th>
									<th class="styTableCell" rowspan="2" scope="col" style="width:15mm;text-align:center;font-weight:normal;">Share-holder of Corporation No.</th>
									<th class="styTableCell" rowspan="2" scope="col" style="width:24mm;text-align:center;font-weight:normal;">Date of transaction</th>
									<th class="styTableCell" colspan="2" scope="col" style="width:70mm;text-align:center;font-weight:normal;">
										<b>(a)</b> Changes</th>
									<th class="styTableCell" colspan="2" scope="col" style="width:44mm;text-align:center;font-weight:normal;border-right:none;">
										<b>(b)  </b> Shares held after changes described in column (a)</th>
								</tr>
								<tr>
									<th class="styTableCell" scope="col" style="width:35mm;text-align:center;font-weight:normal;">
									  Number of shares acquired
									</th>
									<th class="styTableCell" scope="col" style="width:35mm;text-align:center;font-weight:normal;">
									  Number of shares disposed of
									</th>
									<th class="styTableCell" scope="col" style="width:22mm;text-align:center;font-weight:normal;">
									  Percent of voting power
									</th>
									<th class="styTableCell" scope="col" style="width:22mm;text-align:center;font-weight:normal;border-right:none;">
									  Percent of value
									</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<!--START Part III, Line 1 inline print-->
								<tr>
									<!--Column 1 of Part III for inline format -->
									<td valign="bottom" class="styTableCell" style="text-align: right;padding-right:2mm;width:10mm;height:10mm;">
										<!-- Choice option of input Corporation Number is blank or separated format is selected then the default number 1 would display -->
										<xsl:choose>
											<!-- When there is no data or the separated data tag is switched, fill the box with just a 1 -->
									...
									<!--Column 3 of Part III row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="width:15mm;text-align:left;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<xsl:call-template name="PopulateText">
									...
									<!--Column 4 of Part III row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="width:40mm;text-align:center;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									...
									<!--Column 5 of Part III row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="width:35mm;text-align:left;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<xsl:call-template name="PopulateText">
									...
									<!--Column 6 of Part III row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="width:35mm;text-align:left;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<xsl:call-template name="PopulateText">
									...
									<!--Column 7 of Part III row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="width:22mm;height:5mm;text-align:right;">
										<xsl:if test="(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									...
									<!--Column 8 %sign of Part III  row 1 for inline format -->
									<td valign="bottom" class="styTableCell" style="text-align:right;width:22mm;border-right:none;">
										<xsl:if test="(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<!--<span style="width:2px;"/>-->%
										</xsl:if>
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									...
									<xsl:for-each select="$Form851Data/CommonParentCorporationInfo/StockHoldingChangesForTaxYear">
										<xsl:if test="not(position() = 1)">
											<tr>
												...
												<td valign="middle" class="styTableCell" style="width:15mm;text-align:left;">
													<!-- If the separated data tag is not switched, populate with data -->
													<xsl:call-template name="PopulateText">
												...
												<td valign="middle" class="styTableCell" style="width:21mm;text-align:center;">
													<xsl:call-template name="PopulateMonthDayYear">
												...
												<td valign="middle" class="styTableCell" style="width:35mm;text-align:left;">
													<xsl:call-template name="PopulateText">
												...
												<td valign="middle" class="styTableCell" style="width:22mm;text-align:right;">
													<xsl:choose>
												...
												<td valign="middle" class="styTableCell" style="width:22mm;text-align:right;border-right:none;">
													<xsl:choose>
								...
								<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 6))">
									<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
										<tr>
											<!-- Column 1 Part III row 2 for inline format -->
											<td valign="bottom" class="styTableCell" style="height: 10mm; text-align: right; width:10mm;padding-right:2mm;">
											...
											<!-- Column 2 Part III row 2 for inline format -->
											...
											<!-- Column 3 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:15mm;text-align:left;">
												<xsl:call-template name="PopulateText">
											...
											<!-- Column 4 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:21mm;text-align:center;">
												<xsl:call-template name="PopulateMonthDayYear">
											...
											<!-- Column 5 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:35mm;text-align:left;">
												<xsl:call-template name="PopulateText">
											...
											<!-- Column 6 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:35mm;text-align:left;">
												<xsl:call-template name="PopulateText">
											...
											<!-- Column 7 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:22mm;text-align:right;">
											<xsl:choose>
											...
											<!-- Column 8 Part III row 2 for inline format -->
											<td valign="middle" class="styTableCell" style="width:22mm;text-align:right;border-right:none;">
													<xsl:choose>
								...
								<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									<tr>
										...
										<td valign="middle" class="styTableCell" style="height: 10mm; text-align: left; width:10mm;">
											<span class="styTableCellPad"/>
										</td>
...
<!--											<xsl:if test="($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7)">
										...
										<!-- Column 5 Part III line2 for inline format -->
										<td valign="bottom" class="styTableCell" style="width:35mm;text-align:right;">
											<span class="styTableCellPad"/>
										</td>
										<!-- Column 6 Part III line2 for inline format -->
										<td valign="bottom" class="styTableCell" style="width:35mm;text-align:right;">
										...
										<!-- Column 7 Part III empty row 2 for inline format -->
										<td valign="bottom" class="styTableCell" style="width:22mm;text-align:right;">
											%
										</td>
										<!-- Column 8 Part III empty row2 for inline format -->
										<td valign="bottom" class="styTableCell" style="width:22mm;text-align:right;border-right:none;">
										   %
										</td>
									</tr>
								</xsl:if>
			  ...
			  Did any share of subsidiary stock become worthless within the meaning of section 165 (taking into account the provisions
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="float:right;width:27mm;padding-top:0;">
							<span>
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/MoreThanOneClassStkOutstdInd"/>
								</xsl:call-template>
								<input class="styCkBox" type="checkbox" TabIndex="-1" name="Checkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/MoreThanOneClassStkOutstdInd"/>
...
-->
					<div class="styTableContainer" id="TPctnA1">
						<xsl:call-template name="SetInitialState"/>
						<table cellspacing="0" style="width:182.5mm;font-size:7pt;">
							<tr>
								<th class="styTableCell" scope="col" rowspan="1" style="width:7mm;text-align:center;font-weight:normal;">
								Corp. No.</th>
								<th class="styTableCell" scope="col" rowspan="1" style="width:85mm;text-align:center;font-weight:normal;">
								Name of corporation</th>
								<th class="styTableCell" scope="col" rowspan="1" style="width:85mm;text-align:center;font-weight:normal;border-right:none;">
        Class of stock
      </th>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="styTableCell" style="width:7mm;height:10mm;text-align:left;">
							...
							<!-- Part IV Line 1 Empty lines Check if Additional Stock Information is less than 1 and greater than 3 or Separated print format is selected then display empty lines -->
...
<div style="page-break-inside:avoid;width:187mm;">
					<div class="styBB" style="width:187mm;bottom-border:1px;">
						...
						<div class="styLNDesc" style="float:right;width:27mm;padding-top:0;">
							<span>
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/MemReaffiliatedWithin60MnthInd"/>
								</xsl:call-template>
								<input class="styCkBox" type="checkbox" TabIndex="-1" name="Checkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/MemReaffiliatedWithin60MnthInd"/>
...
<!--									<xsl:if test="$Form851Data/CommonParentCorporationInfo/MemReaffiliatedWithin60MnthInd=1">
									...
									<td class="styTableCell" style="width:80mm;height:10mm;text-align:left;border-right:none;">
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;3))">
											<xsl:call-template name="PopulateText">
...
<div style="page-break-inside:avoid;width:187mm;">
					<div style="width:187mm;padding-top:1mm;">
						...
						<div class="styLNDesc" style="width:152mm;">
						During the tax year, was there any arrangement in existence by which one or more persons that were not members
						</div>
					</div>
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="padding-left:1mm;"/>
						<div class="styLNDesc" style="width:152mm;">
						of the affiliated group could acquire any stock, or acquire any voting power without acquiring stock, in the corporation,
						</div>
					</div>
					<!-- End of Part III line (d) row 1-->
					<!-- Part III Line (d) row 2 -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="float:right;width:27mm;padding-top:0;">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/ArrngmNonMemAcqStkVtngPwrInd"/>
									</xsl:call-template>
									<input class="styCkBox" type="checkbox" TabIndex="-1" name="Checkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation/ArrngmNonMemAcqStkVtngPwrInd"/>
			    ...
			    If "Yes," enter the name of the corporation and see the instructions for the percentages to enter in columns (a), (b), and (c).
					...
					<div class="styTableContainer" id="TPctnC1" style="height:auto;">
						<xsl:call-template name="SetInitialState"/>
						<table cellspacing="0" style="width:182.5mm;font-size:7pt;">
							<thead class="styTableThead">
								<tr>
							...
							<tbody>
								<tr>
									...
									<td class="styTableCell" style="text-align:right;width:27mm;height:10mm;">
										<xsl:choose>
											<xsl:when test="($Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/VotingPowerPct) and 
											(not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;3)))">
												<xsl:call-template name="PopulatePercent">
									...
									<td class="styTableCell" style="width:27mm;text-align:right;">
										<xsl:choose>
											<xsl:when test="($Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/VotingPowerPct) and 
											(not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;3)))">
												<xsl:call-template name="PopulatePercent">
									...
									<td class="styTableCell" style="width:26mm;height:10mm;border-right:none;">
										<xsl:choose>
											<xsl:when test="($Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/VotingPowerPct) and 
											(not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;3)))">
												<xsl:call-template name="PopulatePercent">
								...
								<xsl:if test="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation!=''">
									<xsl:if test="not((count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated))">
										<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation">
											<tr style="height:10mm;">
												<td valign="middle" class="styTableCell" style="width:7mm;text-align:left;">
													<xsl:if test="(position() = last()) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;2)">
												...
												<td valign="middle" class="styTableCell" style="width:27mm;height:10mm;">
													<xsl:if test="(position() = last()) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;2)">
												...
												<td valign="middle" class="styTableCell" style="width:27mm;height:10mm;border-right:none;">
													<xsl:if test="(position() = last()) and (count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt;2)">
...
<div style="page-break-inside:avoid;width:187mm;">
					<div class="styGenericDiv" style="width:187mm;bottom-border:1px;">
						<!--Table expand/collapse toggle button-->
							...
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCell" scope="col" style="width:175mm;text-align:left;font-weight:normal;border-right:none;">
										<b>(d)</b>  Provide a description of any arrangement.</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
        ...
        Additional Data        
					...
					<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &gt; 9) and ($Print = $Separated)">
						...
						<span class="styNormalText">  (see instructions)</span>:</span>
						<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:40mm;text-align:center;font-weight:normal;">
              Portion of overpayment credits and estimated tax payments
            </th>
									<th class="styDepTblCell" scope="col" style="width:40mm;text-align:center;font-weight:normal;border-right:none;">
              Portion of tax deposited with Form 7004
							...
							<tbody>
								<tr class="styDepTblRow1">
									<td valign="middle" class="styTableCell" style="width:10mm;padding-right:3mm;font-weight:bold;text-align:right;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/CorporationNum"/>
										</xsl:call-template>
									</td>
              ...
              Subsidiary corporations:<br/>
                ...
                <xsl:call-template name="PopulateText">
										...
										<td class="styTableCell" style="width:32mm;border-style:solid;text-align:center;">
											<xsl:choose>
												<xsl:when test="CorporationEIN">
													<xsl:call-template name="PopulateEIN">
														<xsl:with-param name="TargetNode" select="CorporationEIN"/>
								...
								<tr class="styDepTblHdr">
									<td colspan="3" class="styDepTblCell" style="width:100mm;height:10mm;text-align:left; border-bottom-width: 0px">
              ...
              <span style="width:1px;font-weight:bold;">.</span>
									...
									<td class="styDepTblCell" style="width:40mm;height:10mm;text-align:right; border-bottom-width: 0px">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form851Data/TotOvpmtCrAndEstTxPaymentsAmt"/>
									...
									<td class="styDepTblCell" style="width:40mm;height:10mm;border-right:none;text-align:right; border-bottom-width: 0px">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form851Data/TaxPaidForm7004Amt"/>
											<xsl:with-param name="WhiteFont">true</xsl:with-param>
										</xsl:call-template>
					...
					<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &gt; 9) and ($Print = $Separated)">
						...
						<span class="styRepeatingDataTitle">Form 851, Part II - Principal Business Activity, Voting  Stock Information, Etc. 
							<span class="styNormalText">  (see instructions)</span>:</span>
						<!--Part II table for inline print format -->
						<table class="styDepTbl" cellspacing="0" summary="Table describing Principal Business Activity, Voting Stock information, etc. (See instructions)" style="width:187mm;overflow-y:visible;font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" colspan="2" scope="col" style="width:24mm;text-align:center;font-weight:normal;">
					  Did the subsidiary make any nondividend distributions?
					</th>
									<th class="styDepTblCell" scope="col" colspan="4" style="width:96mm;text-align:center;font-weight:normal;">
					  Stock holdings at beginning of year
					</th>
								</tr>
								<!-- Define background colors to the rows -->
								...
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:24mm;text-align:center;font-weight:normal;">Percent of voting power</th>
									<th class="styDepTblCell" scope="col" style="width:24mm;text-align:center;font-weight:normal;">Percent of value</th>
							...
							<tbody>
								<tr class="styDepTblRow1" style="height:10mm;">
									<!--Column 1 of Part II line 1  of Parent Corp for inline format-->
									<td valign="middle" class="styTableCell" style="width:12mm;padding-right:3mm;font-weight:bold;text-align:right;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/CorporationNum"/>
										</xsl:call-template>
									</td>
									<!-- Column 2 of Part II line 1 - Parent Corp for inline format -->
									<td valign="middle" class="styTableCell" style="width:43mm;text-align:left;">Common parent corporation:<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/PrincipalBusinessActivityDesc"/>
										</xsl:call-template>
									</td>
								...
								<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
									<tr>
										...
										<td valign="top" class="styTableCell" style="width:43mm;text-align:left;">
											<!--Row will span for column 2 Part II -->
											<xsl:attribute name="rowspan"><xsl:value-of select="count(StockHoldingInfo)"/></xsl:attribute>
											<xsl:if test="position() = 1">Subsidiary corporations:<br/>
											</xsl:if>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="PrincipalBusinessActivityDesc"/>
											</xsl:call-template>
										...
										<!-- First Instance of Column 6 Through 9 Below. The remaining repeating Column 6 Through 9 will be handled by the for-each loop-->
										<td valign="bottom" class="styTableCell" style="width:24mm;text-align:left;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="StockHoldingInfo[1]/SharesCnt"/>
											</xsl:call-template>
										</td>
										<td valign="middle" class="styTableCell" style="width:24mm;text-align:right;">
											<xsl:choose>
												<xsl:when test="normalize-space(StockHoldingInfo[1]/VotingPowerPct)=''">%</xsl:when>
												<xsl:otherwise>
													<xsl:call-template name="PopulatePercent">
										...
										<td valign="middle" class="styTableCell" style="width:24mm;text-align:left;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="StockHoldingInfo[1]/OwnedByCorporationNum"/>
											</xsl:call-template>
										</td>
						...
						<table class="styDepTbl" cellspacing="0" sumary="Table Changes in Stock Holdings During the Tax Year" style="width:187mm;clear:both;float:none;font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" colspan="2" scope="col" style="width:70mm;text-align:center;font-weight:normal;">
										<b>(a)</b> Changes</th>
								...
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="width:22mm;text-align:center;font-weight:normal;">Percent of voting power </th>
									<th class="styDepTblCell" scope="col" style="width:22mm;text-align:center;font-weight:normal;">Percent of value </th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
						...
						<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
							...
							<tbody>
								<tr class="styDepTblRow1" style="height:10mm;">
									...
									<td class="styTableCell" style="width:88mm;text-align:left;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/ExplanationTxt"/>
										</xsl:call-template>
									</td>
					...
					<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation) &gt; 3) and ($Print = $Separated)">
						...
						<table class="styDepTbl" cellspacing="0" style="width:187mm;font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:10mm;text-align:center;font-weight:normal;">
									Corp. No.</th>
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:87mm;text-align:center;font-weight:normal;">
									Name of corporation</th>
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:30mm;text-align:center;font-weight:normal;">
										<b>(a)</b>
										<br/>Percent of value</th>
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:30mm;text-align:center;font-weight:normal;">
										<b>(b)</b>
										<br/>Percent of outstanding voting stock</th>
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:30mm;text-align:center;font-weight:normal;">
							...
							<tbody>
								...
								<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation">
									<tr style="height:10mm">
										...
										<td valign="middle" class="styTableCell" style="width:30mm;">
											<xsl:choose>
												<xsl:when test="StockValuePct != '' ">
													<xsl:call-template name="PopulatePercent">
														<xsl:with-param name="TargetNode" select="StockValuePct"/>
										...
										<td valign="middle" class="styTableCell" style="width:30mm;text-align:right;">
											<xsl:choose>
												<xsl:when test="OutstandingVotingStockPct != '' ">
													<xsl:call-template name="PopulatePercent">
														<xsl:with-param name="TargetNode" select="OutstandingVotingStockPct"/>
	...
	<xsl:template name="PartIIIEmptyRows">
		...
		<xsl:if test="$numRows &gt; 0">
			<tr style="height: 10mm;">
				<td valign="middle" class="styTableCell" style="width:10mm;"/>
				<td valign="top" class="styTableCell" style="width:19mm;"/>
				<td valign="middle" class="styTableCell" style="width:15mm;"/>
				<td valign="middle" class="styTableCell" style="width:21mm;"/>
				<td valign="bottom" class="styTableCell" style="width:35mm;"/>
				<td valign="bottom" class="styTableCell" style="width:35mm;"/>
				<td valign="bottom" class="styTableCell" style="width:22mm;text-align:right;"> %</td>
				<td valign="bottom" class="styTableCell" style="width:22mm;text-align:right;border-right:none;"> %</td>
			</tr>
			<xsl:call-template name="PartIIIEmptyRows">
				<xsl:with-param name="numRows" select="$numRows - 1"/>
			</xsl:call-template>
			...
			<xsl:choose>
				<xsl:when test="$numRows = 1">
					<tr style="height:10mm;border-bottom:none;">
						...
						<td class="styTableCell" style="text-align:right;border-bottom:0;">%</td>
						<td class="styTableCell" style="text-align:right;border-bottom:0;">%</td>
						<td class="styTableCell" style="border-right:none;border-bottom:0;">%</td>
					</tr>
				</xsl:when>
				<xsl:otherwise>
					<tr style="height:10mm;border-bottom:none;">
						...
						<td class="styTableCell" style="text-align:right;">%</td>
						<td class="styTableCell" style="text-align:right;">%</td>
						<td class="styTableCell" style="border-right:none;">%</td>
					</tr>
				</xsl:otherwise>
			</xsl:choose>
			<xsl:call-template name="PartIVLineCEmptyRows">

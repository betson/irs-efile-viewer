				...
				<form name="Form851">
							...
							<table cellspacing="0" style="font-size:7pt;">
								...
								<tbody>
									...
									<tr>
										<td valign="bottom" class="styTableCell" style="width:10mm;font-weight:bold;text-align:center;">
											...
											<xsl:choose>
												...
												<xsl:when test="(not($Form851Data/CommonParentCorporationInfo)) or ($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9)">1
												</xsl:when>
												<xsl:otherwise>
														<xsl:call-template name="PopulateText">
									...
									<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
										<tr>
											<!--Column 1 -->
											<td valign="top" class="styTableCell" style="width:10mm;height:10mm;">
												<span style="font-weight:bold;padding-top:6mm;padding-right:4mm;">2</span>
											</td>
											<!--Column 2 -->
						...
						<div class="styTableContainer" style="width:187mm;border-bottom-width:0px;" id="PartIITable">
							...
							<table cellspacing="0" summary="Table describing Principal Business Activity, Voting Stock information, etc. (See instructions)" style="font-size:7pt;border-top:1px solid black;">
								...
								<tbody>
									...
									<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">
										<tr style="height: 10mm;">
											<td class="styTableCell" style="width:12mm;font-weight:bold;">
												<span style="padding-top:6mm;padding-right:5mm;">2</span>
											</td>
						...
						<table class="styTable" cellspacing="0" summary="Table Changes in Stock Holdings During the Tax Year" style="font-size:7pt;">
							...
							<tbody>
								...
								<tr>
									...
									<td valign="top" class="styTableCell" style="width:40mm;text-align:center;">
										<!-- If the separated data tag is not switched, populate with data -->
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									...
									<td valign="top" class="styTableCell" style="width:22mm;height:5mm;text-align:right;">
										<xsl:if test="(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
										...
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<xsl:choose>
												<xsl:when test="not($Form851Data/SubsidiaryCorporationInfo/StockHoldingChangesForTaxYear[1]/VotingPowerPct)">
													<span style="padding-top:9mm;">%</span>
												</xsl:when>
												<xsl:otherwise>
													<xsl:call-template name="PopulatePercent">
									...
									<td valign="top" class="styTableCell" style="text-align:right;width:22mm;border-right:none;">
										<xsl:if test="(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
											<span style="padding-top:6mm;">%</span>
										</xsl:if>
										<xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									...
									<xsl:for-each select="$Form851Data/CommonParentCorporationInfo/StockHoldingChangesForTaxYear">
										<xsl:if test="not(position() = 1)">
											<tr>
												...
												<!--Column 7 ***repeating within row*** ***inline and empty row format***-->
												...
												<!--Column 8 ***repeating within row*** ***inline and empty row format***-->
								...
								<!-- Row 1 ***Parent Corp??? *** for ***Empty row format***-->
								<xsl:if test="(count($Form851Data/SubsidiaryCorporationInfo) &lt;1) or (($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7))">
									<tr>
										<!-- Column 1 -->
										<td class="styTableCell" style="width:10mm;height:10mm;text-align:left; "/>
										<!-- Column 2 -->
										<td class="styTableCell" style="width:19mm;text-align:left;">
											<!--<xsl:if test="($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 7)">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" select="$Form851Data/SubsidiaryCorporationInfo"/>
												</xsl:call-template>
										...
										<!-- Column 3 -->
										<td class="styTableCell" style="width:15mm;text-align:left;"/>
										<!-- Column 4 -->
										<td class="styTableCell" style="width:21mm;text-align:center;"/>
										<!-- Column 5 -->
										<td class="styTableCell" style="width:35mm;text-align:right;"/>
										<!-- Column 6 -->
										<td class="styTableCell" style="width:35mm;text-align:right;"/>
										<!-- Column 7 -->
										<td class="styTableCell" style="width:22mm;vertical-align:bottom;">%</td>
										<!-- Column 8 -->
										<td class="styTableCell" style="width:22mm;vertical-align:bottom;border-right-width:0px;">%</td>
									</tr>
								</xsl:if>
								<!-- Row 2 ***Subsidiary Corp *** for ***Empty row format***-->
								...
								<!-- IF (DATA COUNT < 7)  THEN PRINT (6 - DATA COUNT) EMPTY ROWS -->
					...
					<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation">
						<div class="styNBB" style="width:187mm;">
							...
							<!--Part IV Line 1 repeating row 2 -->
							<div style="width:165mm;float:left">
								<div class="styGenericDiv" style="width:150mm;padding-bottom:.5mm;padding-left:8mm;">
									If "Yes," enter the name of the corporation and list and describe each class of stock.
								</div>
					...
					-->
						...
						<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation">
							<div class="styNBB" style="width:187mm;">
								...
								<!--Part IV Line 2 repeating row 2 (subsidiary corp) -->
								<div style="width:165mm;float:left">
									<div class="styGenericDiv" style="width:150mm;padding-bottom:.5mm;padding-left:8mm;">
									If "Yes," enter the name of the corporation(s) and explain the circumstances.
								</div>
					...
					<div style="page-break-inside:avoid;width:187mm;">
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="float:right;width:27mm;padding-top:5mm;">
								<span>
									...
									<input class="styCkBox" alt="IRS851ArrngmExstNonMemAcqStkVotePwr" type="checkbox" TabIndex="-1" name="Checkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/ArrngmNonMemAcqStkVtngPwrInd"/>
						...
						<div class="styNBB" style="width:187mm;bottom-border:1px;">
						...
						<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo/AdditionalStockInformation">
							...
							<span class="styDotLn" style="float:right;">......</span>
								...
								<!--Part IV Line 3 row 4 -->
								<div style="width:187mm;float:left">
									<div class="styGenericDiv" style="width:165mm;padding-bottom:.5mm;padding-left:8mm;">
									If "Yes," enter the name of the corporation and see the instructions for the percentages to enter in columns (a), (b), and (c).
								</div>
								</div>
								<xsl:if test="position()=last()">
						...
						<table class="styDepTbl" cellspacing="0" summary="Table describing Principal Business Activity, Voting Stock information, etc. (See instructions)" style="width:187mm;overflow-y:visible;font-size:7pt;">
							...
							<tbody>
								<tr class="styDepTblRow1" style="height:10mm;">
									...
									<!--Column 4 of Part II line 1 of Parent Corp for inline print-->
									<td class="styTableCell" style="width:12mm;background-color:lightgrey;"/>
									<!--Column 5 of Part II line 1  of Parent Corp for inline print-->
									<td class="styTableCell" style="width:12mm;background-color:lightgrey;"/>
								...
								<!--Part II, Line 1 of Subsidiary corp for separated print -->
								<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
									<tr>
										<!-- Define background colors to the rows -->
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow2</xsl:when><xsl:otherwise>styDepTblRow1</xsl:otherwise></xsl:choose></xsl:attribute>
									...
									<xsl:for-each select="StockHoldingInfo">
										<xsl:if test="position() &gt; 1">
											<tr>
												...
												<td valign="top" class="styTableCell" style="'width:24mm;text-align:right;background-color:yellow;">
													<xsl:choose>
														<xsl:when test="normalize-space(StockValuePct)=''">%</xsl:when>
														<xsl:otherwise>
															<xsl:call-template name="PopulatePercent">
							...
							<tbody>
								...
								<tr class="styDepTblRow1">
									...
									<td class="styTableCell" style="text-align:right;width:22mm;">
										<xsl:choose>
											<xsl:when test="not($Form851Data/CommonParentCorporationInfo/StockHoldingChangesForTaxYear[1]/VotingPowerPct) or $Form851Data/CommonParentCorporationInfo/StockHoldingChangesForTaxYear[1]/VotingPowerPct='' ">
												<span style="text-align:bottom">%</span>
											</xsl:when>
											<xsl:otherwise>
												<xsl:call-template name="PopulatePercent">
													<xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/StockHoldingChangesForTaxYear[1]/VotingPowerPct"/>
								...
								<!--END Part III, Line 1-->
								<!--START Part III line 2 subsidiarity Corporation Info separated format -->
								<xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
									<tr>
										<!-- Define background colors to the rows -->
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow2</xsl:when><xsl:otherwise>styDepTblRow1</xsl:otherwise></xsl:choose></xsl:attribute>

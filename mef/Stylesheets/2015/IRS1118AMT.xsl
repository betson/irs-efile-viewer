        ...
        Check only one box on each form.<br/>
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all amounts in U.S. dollars. See<b> Specific instructions</b>.)</span>
							...
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellLtr" rowspan="3">
										<span style="width:6mm;height:27mm;"/>
									</th>
					...
					<div class="styBB" style="width:256mm;border-bottom-width:0px;">* For section 863(b) income, NOLs, income from RICs, and high-taxed income, use a single line (see instructions). 
						<!-- button display logic -->
						<div class="styGenericDiv" style="width:25mm;text-align:right;border-top-width:0px;border-left:1px solid black;border-right:1px solid black;float:right;">
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp"/>
								<xsl:with-param name="containerHeight" select="6"/>
					...
					<div class="styIRS1118TableContainerLandscape" style="height:auto;width:256mm;" id="DEDctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="height:auto;width:256mm;">
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:29mm" rowspan="2" scope="col">(c) <span class="styNormalText">Expenses Related to Gross Income From Performance of Services</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:29mm" rowspan="2" scope="col">(d) <span class="styNormalText">Other Definitely Allocable Deductions</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:29mm" rowspan="2" scope="col">(e) <span class="styNormalText">Total Definitely Allocable Deductions (add columns 9(a) through 9(d))</span>
									</th>
								</tr>
								<tr>
							...
							<tbody>
								<xsl:if test="(count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &lt; 7) or ((count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &gt; 6) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp">
										<tr style="height:6mm;">
											...
											<td class="styTableCell" style="width:29mm;border-color:black;">
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:choose>
									<xsl:when test="(count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &gt; 6) and ($Print = $Separated)">
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellLtr" style="width:17mm;">
												<span class="styTableCellPad" style="font-size:2pt;font-weight:bold">Totals</span>
											</td>
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<div class="styTableContainerLandscape" style="border-top:1px solid black;display:block;" id="DIPRE1987ctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0">

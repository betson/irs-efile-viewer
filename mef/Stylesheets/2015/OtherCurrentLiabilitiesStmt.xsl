...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherCurrentLiabilitiesStmt" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="OCLSTbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
  ...
  <xsl:template match="/">
    <html>
      <head>
         <title>
           <!--Other Current Liabilities Statement-->
         ...
         <meta name="Description" content="Other Current Liabilities Statement" />
      ...
      <body class="styBodyClass">    
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:105mm">
            <!--TY 2003 Other Current Liabilities Statement-->
            <xsl:value-of select="$depDocTitle" />          
          </div>
        </div>        

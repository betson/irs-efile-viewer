...
<!-- 07/20/2015 - Modified per defect 43279 - Jeremy Nichols-->
<!-- 09/02/2015 - Changes made for defect 43446 - Jeremy Nichols -->
  ...
  <xsl:template match="/">
        ...
        <form name="Form2290Schedule1">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:17mm;">
              ...
              <br/>
              <span class="styAgency">(Rev. July 2015)<span style="width:10mm;"/>Department of the Treasury</span>
              <br/>
            ...
            <div class="styFTBox" style="width:125mm;height:17mm;padding-top:1mm">
              ...
              <div class="styFST" style="height:4mm;font-size:8pt;text-align:center;font-weight:normal">
				 For the period July 1, 2015, through June 30, 2016<br/>
              </div>
         ...
         <b>Complete and file both copies of Schedule 1. One copy will be stamped and returned to you for use as proof of payment when registering vehicle(s) with a state.</b>
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="font-size:6pt;width:187mm">
            <tbody>
              <tr>
                <td rowspan="3" style="border:0 solid black;border-right-width:1px;width:10mm;font-size:7pt;text-align:center">
                  <span class="styBoldText">Type<br/> or<br/> Print</span>
                </td>
                <td style="width:93mm;border:0 solid black;border-right-width:1px;border-bottom-width:1px;padding-left:2mm">Name<br/>
                  <br/>
    ...
    <!--Dotted Line-->
          ...
          <div style="width:187mm;border-top:1px black solid">
            ...
            <span style="float:right">
              <span class="styBoldText" style="font-size:6pt"><span style="font-weight:normal">Cat. No. 11250O</span> <span style="width:5mm;"/>Schedule 1 (Form 2290)</span> (Rev. 7-2014)</span>
          </div>
          ...
          <div style="width:187mm;height:8mm;font-size:11pt;text-align:center;vertical-align:middle">For the period July 1, 2014, through June 30, 2015</div>

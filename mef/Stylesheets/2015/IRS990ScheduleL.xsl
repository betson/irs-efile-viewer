						...
						<td class="styTableCellCtr" style="border-style: solid; border-color: black;width:75mm;padding-right:0.75mm;border-bottom-width:0px;vertical-align:top;text-align:left;border-bottom-width:1px;">(<xsl:number value="position()" format="1"/>)
								...
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/DisqualifiedPersonExBnftTrGrp) &gt;10)) ">
									<tr>
										...
										<td class="styTableCellCtr" style="border-style: solid; border-color: black;width:9mm;vertical-align:bottom;padding-right:0.75mm;border-right-width:0px;border-bottom-width:1px;">
											<span style="width:3px"/>
										</td>
									</tr>
								</xsl:if>
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styTableCell" style="height:auto;border-style: solid; border-color: black;border-right-width:1px;width:35mm;vertical-align:bottom;border-top-width:1px;font-size:7pt;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalBalanceDueAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCell" scope="col" colspan="6" style="height:auto;border-style: solid; border-color: black;width:88mm;vertical-align:bottom;border-top-width:1px;border-right-width:1px;background-color:lightgrey;">
         ...
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
				...
				<div class="styGenericDiv" style="width:110mm;font-weight:bold;font-size:6pt">For Paperwork Reduction Act Notice, see the Instructions for Form 990 or 990-EZ. </div>
						...
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText" style="font-size:6pt">Schedule L (Form 990 or 990-EZ) 2015</span>
						</div>
					</div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Schedule L (Form 990 or 990-EZ) 2015</div>
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							...
							<tbody>
								...
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/BusTrInvolveInterestedPrsnGrp) &gt;10)) ">
									<tr>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:60mm;vertical-align:bottom;padding-right:0.75mm;border-left-width:0px;border-right-width:0px;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/BusTrInvolveInterestedPrsnGrp/NameOfInterested/PersonNm"/>
											</xsl:call-template>
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:32mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;border-right-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:30mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;border-right-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:45mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;border-right-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:8mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;border-right-width:0px;text-align:center;">
											<span style="width:3px"/>

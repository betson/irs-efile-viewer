...
<!-- 02/13/2015 - Modified per UWR #151147 - Jeremy Nichols-->
<!-- 04/14/2015 - Changes made for IE11 compatibility - Jeremy Nichols -->
<!-- 06/02/2015 - Modified per KISAMS 2154186 - Jeremy Nichols-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:choose>
      <xsl:when test="($Version = '2015Q1v1.0') or ($Version = '2015Q1v1.1') or ($Version = '2015Q1v1.2') or ($Version = '2015Q1v1.3') or ($Version = '2015Q1v2.0') or ($Version = '2015Q1v2.1') or ($Version = '2015Q1v3.0') or ($Version = '2015Q1v3.1')">
      <!-- beginning for versions for 2015Q1 -->	
        <xsl:call-template name="DocumentHeader"/>
        <!--Title of Form -->
		<div class="styBB" style="width:187mm;height: 19mm;display:block;">
			<div class="styFNBox" style="height: 19mm; width:31mm;font-size: 7pt">
				<br/>
				...
				<br/>
              <span class="styAgency" style="font-size: 7pt; font-weight:bold">(Rev. January 2015) </span>
				<br/>
				<span class="styAgency" style="font-size: 7pt; font-weight:bold">Department of the Treasury</span>
				<br/>
              <span class="styAgency" style="font-size: 7pt;font-weight:bold">Internal Revenue Service</span>
			</div>
			<div class="styFTBox" style="width:125mm; height: 19mm;">
				<div class="styMainTitle" style="height:10mm; font-weight: bold; padding-top: 2mm">Quarterly Federal Excise Tax Return</div>
				<div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold; padding-top: 1mm;">
		...
		<!--  End title of Form  -->
		<div style="height:30mm;width:187mm; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px; border-bottom-width: 0px">
					...
					<tr>
						...
						<th scope="col"  valign="top" style="height:auto;width:124mm;font-size:7pt; padding-top:3mm">
							<table class="styTable" cellspacing="0" cellpadding="0" border="0" style="height:auto;width:124mm;">
								<thead class="styTableThead" style="font-size:7pt">
									<tr>
										<th scope="col"  valign="top" style="text-align:left;height:12mm;width:78mm;font-weight:normal">Name<br/>
										...
										<th scope="col"  valign="top" style="height:12mm;width:46mm;text-align:left;font-weight:normal">Quarter ending <br/>
									...
									<tr>
										<td valign="top" style="height:8mm;width:78mm;font-weight:normal;">Number, street, and room or suite no. 
										...
										<td valign="top" style="height:8mm;width:46mm;font-weight:bold;">Employer identification number <br/>
											<br/>
											<xsl:call-template name="PopulateReturnHeaderFiler">
			...
			<table cellspacing="0" cellpadding="0" style="width:187mm;font-size:7pt;">
				<thead class="styTableHead">
					...
					<tr>
						...
						<th scope="col" colspan="5" style="border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; height:4mm; width:130mm; font-weight:normal;padding-left:5px;text-align:left;float:left;clear:none;" >
						...
						<th scope="col" style="border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; height:4mm; width:34mm;font-weight:normal;float:left;clear:none;" >
							<b>Tax</b>
						</th>
				...
				<tbody style="font-size:7pt;">
					...
					<tr>
						...
						<td colspan="5" style=" height:3mm; width:130mm;text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;float:left;clear:none;">Domestic petroleum oil spill tax
					    </td>
						<td style=" height:3mm; width:34mm;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;padding-right:1mm;float:left;clear:none;">
					...
					<tr>
						...
						<td colspan="5" style="height:3mm; width:130mm;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;float:left;clear:none;">Imported petroleum products oil spill tax
              </td>
						<td style="height:3mm; width:34mm;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;padding-right:1mm;float:left;clear:none;">
					...
					<tr>
						...
						<td colspan="5" style="height:3mm; width:130mm;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;float:left;clear:none;">Ozone-depleting chemicals (ODCs)
              </td>
						<td style="height:3mm; width:34mm;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm;float:left;clear:none;">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="5" style="height:3mm;width:130mm;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;float:left;clear:none;">ODC tax on imported products
              </td>
						<td style="height:3mm;width:34mm;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm;float:left;clear:none;">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<th scope="col" colspan="5" style="border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; width:130mm; height:4mm; text-align:left; font-weight:normal;padding-left:5px;float:left;clear:none;" >
							<span style="font-size:8pt">
								<b>Communications and Air Transportation Taxes</b> (see instructions)</span>
						</th>
						<th scope="col" align="center" style="border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; width:34mm; height:4mm; text-align:center; font-weight:normal;float:left;clear:none;" >
							<b>Tax</b>
						</th>
					...
					<tr>
						...
						<td colspan="5" style="width:130mm; height:3mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Local telephone service and teletypewriter exchange service
					    </td>
						<td style="width:34mm; height:3mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="5" style="width:130mm; height:3mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Transportation of persons by air
              </td>
						<td style="width:34mm; height:3mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="5" style="width:130mm; height:3mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Transportation of property by air
              </td>
						<td style="width:34mm; height:3mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="5" style="width:130mm; height:3mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Use of international air travel facilities
              </td>
						<td style="width:34mm; height:3mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<th scope="col" style="text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal;height:4mm;width:40mm; font-size:6pt;float:left;clear:none;" >
							<b>Number of gallons</b>
						</th>
						<th scope="col" colspan="2" style="text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal; height:4mm;width:30mm;float:left;clear:none;" >
							<b>Rate</b>
						</th>
						<th scope="col" style="text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal;height:4mm; width:34mm;float:left;clear:none;" >
							<b>Tax</b>
						</th>
      ...
      <td style="text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >  
        ...
        <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum71/IRSNum"/>
					...
					<tr>
						...
						<td style="height:6mm;width:34mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;padding-top:3mm;background:lightgrey;">
							<span style="width:1px;"/>
						</td>
        ...
        <!--Need to add a pushpin here for MultiRateSchedule -->
						...
						<td style="height:3.5mm;width:40mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal;padding-top:0.5mm; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum79/GallonsQty"/>
							</xsl:call-template>
						</td>
						<td style="height:3.5mm;width:26mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal;padding-top:0.5mm; padding-right:1mm" >
							<span style="float:left;"/>
							<xsl:call-template name="PopulateText">
						...
						<td style="height:3.5mm;width:34mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-right:1mm;padding-top:0.5mm;">
							<xsl:call-template name="PopulateAmount">
        ...
        Gasoline, tax on taxable events other than removal at terminal rack
					...
					<tr>
						...
						<td style="height:6mm;width:34mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-right:1mm">
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="2" style="height:6mm;width:60mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Liquefied petroleum gas (LPG)
              </td>
						<td style="height:6mm;width:40mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="2" style="height:6mm;width:60mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Liquid fuel derived from biomass
              </td>
						<td style="height:6mm;width:40mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						...
						<td colspan="3" style="height:4mm;width:100mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 2x; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;"><b>Retail Tax</b> - Truck, trailer, and semitrailer chassis and bodies, and tractor
              </td>
					...
					<tr>
						...
						<td style="height:4mm;width:40mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal" >
							<span style="font-size:6pt; font-weight:bold">Amount of obligations </span>
						</td>
					...
					<tr>
						<td colspan="8" style="width:187mm;float:left;clear:none; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
							...
							<div style="float:right;">
								...
								Form <span class="styBoldText" style="font-size:8pt;">720</span> (Rev. 1-2015)
							  </div>
						</td>
					</tr>
				</tbody>
			...
			<table cellspacing="0" cellpadding="0" style="width:187mm;font-size:7pt;">
				<tbody>
					<tr>
						<td colspan="8" class="styBB" style="width:187mm">
							<div style="float: left; clear: none">Form 720 (Rev. 1-2015)</div>
					...
					<tr>
						<td style="height:4mm;width:11mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<b>IRS No.</b>
						</td>
					...
					<tr>
						...
						<td style="height:3mm;width:36mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-top:1mm; padding-left:5px;">Coal&#8212;Underground mined
              </td>
                ...
                of sales price</span>
					...
					<tr>
						...
						<td style="height:3mm;width:36mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-top:1mm; padding-left:5px;">Coal&#8212;Surface mined
              </td>
						<td style="height:3mm;width:24mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
                ...
                of sales price</span>
					...
					<tr>
						...
						<td colspan="3" style="height:6mm;width:100mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Taxable biasply or super single tires (other than super single tires designed for steering)
              </td>
						<td colspan="2" style="height:6mm;width:30mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;padding-top:3mm;padding-right:1mm">
							<xsl:call-template name="PopulateAmount">
        ...
        <!--Dotted Line-->
                  ...
                  <span style="width:11px"/>. 
					...
					<tr>
						...
						<td colspan="2" style="height:3mm;width:30mm;float:left;clear:none;text-align: center; vertical-align:bottom; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal" >
							<xsl:call-template name="PopulatePercent">
					...
					<tr>
						<td colspan="6" style="text-align: left; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<span style="padding-left:4mm">
								<b>2  Total.</b>  Add all amounts in Part II. </span><span style="width:108mm;"/>
 ...
 <span style="width:11px"/>.
      ...
      <br/> 
		...
		<div class="styBB" style="width:187mm;clear:none; padding-bottom:0.5mm;display:block;">
...
taxed at $.219</td>
    ...
    Form <span style="font-size:8pt;font-weight:bold">720</span> (Rev. 1-2015)
  </div>
		<!-- End Footer -->
		<!-- ========================================================================= -->
		<!-- END PAGE 4  -->
					...
					<tr>
						<xsl:choose>
							<xsl:when test="$FormData/IRS720ScheduleC/NontaxableUseOfAlternativeFuel/NontxLiquefiedPetroleumGas/OtherFuelUseDetail">
								<td class="styIRS720TableCellText" style="width:24mm;">
									<xsl:call-template name="PopulateText">
							...
							<xsl:otherwise>
								<td class="styIRS720TableCellTextType5" style="width:24mm;">
									<xsl:call-template name="PopulateText">
					...
					<tr>
						...
						<xsl:choose>
							<xsl:when test="$FormData/IRS720ScheduleC/NontaxableUseOfAlternativeFuel/NontxPSeriesFuelCredit/OtherFuelUseDetail">
								<td class="styIRS720TableCellText" style="width:24mm;height:4mm;">
									<xsl:call-template name="PopulateText">
							...
							<xsl:otherwise>
								<td class="styIRS720TableCellTextType5" style="width:24mm;height:4mm;">
									<xsl:call-template name="PopulateText">
					...
					<tr>
						...
						<xsl:choose>
							<xsl:when test="$FormData/IRS720ScheduleC/NontaxableUseOfAlternativeFuel/NontxLNG/OtherFuelUseDetail">
								<td class="styIRS720TableCellText" style="width:24mm;height:4mm;border-bottom-width:1px">
									<xsl:call-template name="PopulateText">
							...
							<xsl:otherwise>
								<td class="styIRS720TableCellTextType5" style="width:24mm;height:4mm;border-bottom-width:1px">
									<xsl:call-template name="PopulateText">
					...
					<tr>
						...
						<xsl:choose>
							<xsl:when test="$FormData/IRS720ScheduleC/NontaxableUseOfAlternativeFuel/NontxLiquefiedGasFromBiomass/OtherFuelUseDetail">
								<td class="styIRS720TableCellText" style="width:24mm;height:4mm;border-bottom-width:0px">
									<xsl:call-template name="PopulateText">
							...
							<xsl:otherwise>
								<td class="styIRS720TableCellTextType5" style="width:24mm;height:4mm;border-bottom-width:0px">
									<xsl:call-template name="PopulateText">
    ...
    Form 720 (Rev. 1-2015)
		...
		<div style="width:187mm">
			<div style="float:left;clear:none;width:8mm;height:9mm"/>
		  <br/>
          <b>Reserved</b> 
			...
			<table class="styBB" cellspacing="0" style="font-size:7pt;border-bottom-width:0px">
				<tbody>
					...
					<tr>
						...
						<th scope="col" class="styIRS7204BoldTableHeaderCell" style="width:95mm;border-left-width:0px;font-weight:normal;text-align:left;vertical-align:bottom" rowspan="2"><b>Reserved</b></th>
						<th scope="col" class="styIRS7204BoldTableHeaderCell" style="width:16mm">Rate</th>
					...
					<tr>
						<td class="styIRS720TableCellTextRate" style="background:lightgrey;">
							<span style="width:1mm;"/>
						</td>
					...
					<tr>
						<td class="styIRS720TableCellLineNumber" style="border-right-width:0px;font-size:8pt;padding-right:1mm">b</td>
						<td class="styIRS7204BoldTableHeaderCell" style="border-left-width:0px;border-top-width:0px;font-weight:normal;text-align:left"><b>Reserved</b></td>
						<td class="styIRS720TableCellTextRate" style="background:lightgrey;">
							<span style="width:1mm;"/>
						</td>
						<td class="styIRS720TableCellAmount" style="font-size:7pt;background:lightgrey;">
				...
				<table cellspacing="0" style="font-size:7pt">
					<tbody>
						<tr>
							...
							<th scope="col" colspan="3" style="width:99mm;text-align:left;vertical-align:top;font-size:8pt;padding-top:1mm;"><b>Reserved</b></th>
							<th scope="col" style="width:24mm;text-align:right;font-weight:normal;padding-right:1mm">Period of claim
								<span style="width:0.5mm"/>
								<img src="{$ImagePath}/720_Bullet.gif" alt="Bullet"/>
							</th>
			...
			<table cellspacing="0" style="font-size:7pt">
				<tbody>
					<tr style="padding-top:1mm;padding-bottom:1mm">
						...
						<th scope="col" style="width:106mm;text-align:left;font-size:8pt"><b>Reserved</b></th>
						<th scope="col" style="text-align:right;padding-right:1mm;font-weight:normal">Registration Number
			  <span style="width:0.5mm"/>
							<img src="{$ImagePath}/720_Bullet.gif" alt="Bullet"/>
						</th>
			...
			<table cellspacing="0" style="font-size:7pt">
				<tbody>
				  ...
				  <th scope="col" class="styIRS7204BoldTableHeaderCell" style="width:95mm;border-left-width:0px;border-bottom-width:0px;font-weight:normal;text-align:left;vertical-align:bottom"><span style="width:1mm;"/></th>
					...
					<tr>
						<td class="styIRS720TableCellLineNumber" style="border-bottom-width:0px;border-right-width:0px;font-size:8pt;padding-right:1mm;vertical-align:top">b</td>
						<td class="styIRS720NameTableCell"><b>Reserved</b></td>
						<td class="styIRS720TableCellTextRate" style="background:lightgrey;">
							<span style="width:1mm;"/>
						</td>
						<td class="styIRS720TableCellAmount" style="font-size:7pt;background:lightgrey;">
			...
			<table cellspacing="0" style="font-size:7pt">
				<tbody>
					<tr style="padding-top:1mm;padding-bottom:1mm">
						...
						<th scope="col" colspan="2" style="width:134mm;text-align:left;font-size:7pt;border-top:0px;border-bottom:0px;border-left:0px;border-right:1px;border-color:black;border-style:solid;">Other Claims. <span style="width:130mm;font-weight:normal;display:inline;">See the instructions.  For lines 15b and 15c, see the Caution above line 1 on page 4.</span>
						</th>
...
<span class="styTableCellPad"/>
			  ...
			  <!-- end for versions for 2015Q1 -->
			  </xsl:when>
			  <xsl:otherwise>
				<!-- beginning for versions for 2015Q2, 2015Q3, 2015Q4 -->
<xsl:call-template name="DocumentHeader"/>
        <!--Title of Form -->
		<div class="styBB" style="width:187mm;height: 18mm;display:block;">
			<div class="styFNBox" style="height: 18mm; width:31mm;padding-top:2mm;font-size: 7pt">
				<span style="font-size:8pt">Form</span>
				<span class="styMainTitle" style="font-size:17pt; font-weight:bold; padding-left:7px;padding-right:2mm">720</span>
				...
				<br/>
              <span class="styAgency" style="font-size: 7pt; font-weight:bold">(Rev. April 2015) </span>
				<br/>
				<span class="styAgency" style="font-size: 7pt; font-weight:bold">Department of the Treasury</span>
				<br/>
              <span class="styAgency" style="font-size: 7pt;font-weight:bold">Internal Revenue Service</span>
			...
			<div class="styTYBox" style="width:31mm; height: 18mm">
				<div style="padding-top:6mm; font-size:7pt">OMB No. 1545-0023</div>
			</div>
		</div>
		<!--  End title of Form  -->
		<div style="height:30mm;width:187mm; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px; border-bottom-width: 0px">
			...
			<table cellspacing="0" cellpadding="0" style="width:187mm;font-size:7pt;">
				...
				<tbody style="font-size:7pt;">
					...
					<tr>
						...
						<td colspan="5" style="width:131mm; height:3mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Use of international air travel facilities
              </td>
						<td style="width:33mm; height:3mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;height:3mm; padding-right:1mm">
							<span style="float:left;"/>
							<xsl:call-template name="PopulateAmount">
      ...
      <td style="text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >  
        ...
        Gasoline, tax on taxable events other than removal at terminal rack
					...
					<tr>
						...
						<td colspan="2" style="height:4mm;width:60mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;">Liquefied natural gas (LNG)
              </td>
						<td style="height:4mm;width:35mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum124/GallonsQty"/>
					...
					<tr>
						...
						<td colspan="3" style="height:4mm;width:95mm;float:left;clear:none;text-align: left; border-style: solid; border-color: black; border-top-width: 2x; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-left:5px;"><b>Retail Tax</b> - Truck, trailer, and semitrailer chassis and bodies, and tractor
              </td>
						<td colspan="2" style="height:4mm;width:36mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm; font-size:6pt" >
							<xsl:call-template name="PopulatePercent">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum33/Rt"/>
							</xsl:call-template> of sales price
      </td>
						<td style="height:4mm;width:33mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; padding-right:1mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum33/TaxAmt"/>
							</xsl:call-template>
						</td>
					...
					<tr>
						...
						<th scope="col" style="height:4mm;width:35mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal;font-size:6pt" >
							<b>Number of persons</b>
						</th>
						<th scope="col" colspan="2" style="height:4mm;width:36mm;float:left;clear:none;text-align:center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal; " >
							<b>Rate</b>
						</th>
						<th scope="col" style="height:4mm;width:33mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal;" >
							<b>Tax</b>
						</th>
						<th scope="col"  style="height:4mm;width:12mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
							<span style="width:1px"/>
					...
					<tr>
						...
						<td colspan="2" style="height:3mm;width:36mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal;" >
							$
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum29/Rt"/>
							</xsl:call-template>
					...
					<tr>
						...
						<td style="height:4mm;width:35mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal" >
							<span style="font-size:6pt; font-weight:bold">Amount of obligations </span>
						</td>
						<td colspan="2" style="height:4mm;width:36mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal" >
							<b>Rate</b>
						</td>
						<td style="height:4mm;width:33mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width:2px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
							<b>Tax</b>
						</td>
						<td style="height:4mm;width:12mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
							<span style="width:1px"/>
					...
					<tr>
						...
						<td style="height:3mm;width:32mm;float:left;clear:none;text-align:center; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:3mm" >
							$
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum31/Rt"/>
							</xsl:call-template>
					...
					<tr>
						...
						<th scope="col" style="height:7mm;width:35mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:1px; font-weight:normal" >
							<b>Premiums paid</b>
						</th>
						<th scope="col" colspan="2" style="height:7mm;width:36mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 2px; border-right-width:1px; border-left-width:0px; border-bottom-width:1px; font-weight:normal" >
							<b>Rate</b>
						</th>
						<th scope="col"  style="height:7mm;width:33mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width:2px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<b>Tax</b>
						</th>
						<th scope="col"  style="height:7mm;width:12mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width: 2px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
							<b>IRS No.</b>
					...
					<tr>
						...
						<td style="height:3mm;width:35mm;float:left;clear:none;text-align: right; border-color: black; border-style: solid; border-top-width: 0px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum30/IRSNum30a/PremiumsPaidAmt"/>
							</xsl:call-template>
						</td>
						<td style="height:3mm;width:32mm;float:left;clear:none;text-align: center; border-color: black; border-style: solid; border-top-width: 0px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal;" >
							$							
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/QrtlyFederalExciseTaxPartI/PartIIRSNum30/IRSNum30a/Rt"/>
							</xsl:call-template><span style="width:4mm;"/>
						...
						<td style="height:3mm;width:33mm;float:left;clear:none;text-align: right; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px; background:lightgrey">
							<span style="width:1px"/>
						</td>
						<td style="height:3mm;width:12mm;float:left;clear:none;text-align: center; border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px; background:lightgrey">
							<span style="width:1px"/>
					...
					<tr>
						<td colspan="8" style="width:187mm;float:left;clear:none; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
							...
							<div style="float:right;">
								<span style="width:20px;"/>  
								Form <span class="styBoldText" style="font-size:8pt;">720</span> (Rev. 4-2015)
							  </div>
						</td>
					</tr>
				</tbody>
			...
			<table cellspacing="0" cellpadding="0" style="width:187mm;font-size:7pt;">
				<tbody>
					<tr>
						<td colspan="8" class="styBB" style="width:187mm">
							<div style="float: left; clear: none">Form 720 (Rev. 4-2015)</div>
							<div style="float:right">Page <span class="styBoldText" style="font-size: 8pt">2</span>
							</div>
						</td>
					</tr>
...
taxed at $.219</td>
		...
		<!-- Begin Footer -->
		<div style="width:187mm;text-align:right;right;padding-top:0.5mm">
    Form <span style="font-size:8pt;font-weight:bold">720</span> (Rev. 4-2015)
  </div>
		<!-- End Footer -->
		<!-- ========================================================================= -->
		<!-- END PAGE 4  -->

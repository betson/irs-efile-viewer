        ...
        <form name="Form6627">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:21mm;padding-top:2mm;">
              ...
              <br/>      
              <span class="styAgency" style="font-weight:normal;">(Rev. January 2015)</span><br/> 
          ...
          <div  style="width:187mm;border-bottom:1px black solid;">
            <span style="width:140mm;font-weight:normal;text-align:left;font-size:7pt;display:inline;"> 
              Form 6627 (Rev. 1-2015)<span style="width:140mm;"/>
            </span>
                ...
                <tbody>
                  <xsl:for-each select="$FormData/ODCTaxOnImportedProductsGrp">
                    <tr>
                      ...
                      <td class="styTableCellText" style="width:4mm;border-color:black;border-right:0px solid black;vertical-align:top;padding-top:1mm;">
                        <div style="width:4mm;padding:left:1mm;float:left;clear:none;font-size:7pt;text-align:center;display:inline;">
                          <xsl:value-of select="position()"></xsl:value-of>
                        </div>
                      </td>
                      <td class="styTableCellText" style="width:54mm;border-color:black;border-left:0px solid black;padding-top:1mm;">
                      ...
                      <td class="styTableCell" style="width:23mm;border-color:black;padding-right:1mm;vertical-align:top;padding-top:1mm;">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="TaxableProductCnt"></xsl:with-param>
                        </xsl:call-template>
                      </td>
                      <td class="styTableCell" style="width:26mm;border-color:black;padding-right:1mm;vertical-align:top;padding-top:1mm;">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="IRSOzoneDepletingChmclWghtQty"></xsl:with-param>
                        </xsl:call-template>
                      </td>
                      ...
                      <td class="styTableCell" style="width:28mm;border-color:black;border-right-width:0px;padding-right:1mm;vertical-align:top;padding-top:1mm;">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="TaxAmt"></xsl:with-param>
                        </xsl:call-template>
                      </td>
                  ...
                  <tr style="height:10mm">
                    ...
                    <td class="styTableCellText" colspan="6" style="width:159mm;font-size:7pt;border-color:black;border-bottom-width:0">
                      <div style="width:4mm;font-size:7pt;text-align:center;font-weight:bold;padding:left:1mm;float:left;clear:none;padding-bottom:2mm;display:inline;">
                        <xsl:value-of select="(count($FormData/ODCTaxOnImportedProductsGrp) + 1)"></xsl:value-of>
                      </div>
                      <div style="display:inline;">
                        <b>Total ODC tax on imported products.</b> Add all amounts in column (f), include amounts from any
              ...
              <table class="styDepTbl" style="font-size:7pt;border-collapse:collapse;">
                ...
                <xsl:for-each select="$FormData/TaxOnFloorStocksOfODCGrp">
                  <tr>
                    ...
                    <td style="height:8mm;width:6mm;text-align:center;font-weight=bold;border-bottom:1px black solid;border-top:1px black solid;vertical-align:top;padding-top:1mm;">
                      <xsl:value-of select="position()">
                      </xsl:value-of>
                    </td>

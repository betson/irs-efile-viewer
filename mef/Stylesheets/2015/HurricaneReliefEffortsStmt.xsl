...
<!-- 06/12/2015 - Changes made for IE11 compatibility - Jeremy Nichols -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/HurricaneReliefEffortsStmt"/>
  <!-- Display Name is Hurricane Relief Efforts Statement -->
  <!-- Main template begin -->
  ...
  <xsl:template match="/">
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
	  ...
	  <!--table begin -->      
    	   <table id="HurricaneReliefEffortsStmtTbl" class="styDepTbl">
      	...
      	<xsl:for-each select="$DependencyData/HurricaneReliefEfforts">
        		<tr>

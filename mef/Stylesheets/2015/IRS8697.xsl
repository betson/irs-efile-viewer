      ...
      <div style="float:left;font-size:6pt;width:104mm;font-family:verdana;">
								<xsl:choose>
									...
									<xsl:otherwise>
										...
										<xsl:if test="$Form8697Data/BusinessName/BusinessNameLine2Txt!=''">
											<div style="float:left;font-size:6pt;width:104mm;font-family:verdana;">
												<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;" id="TPctn">
						...
						<table cellspacing="0" summary="Table displaying entity name or names and corresponding employer identification numbers" style="font-size:7pt;" name="TYTable" id="TYTable">
							<tr>
								...
								<th class="styTableCell" rowspan="1" style="width:130mm;text-align:left;border-color:black;border-right-width:1px;border-bottom:none;font-weight:normal;">Name of entity <br/>
								</th>
					...
					<xsl:choose>
						<xsl:when test="($PriorYearCount  &gt; '2') and ($Print = $Separated)">
							<table style="width:187mm; " id="TP1ctn">
								<xsl:call-template name="SetInitialState"/>
								<table cellspacing="0" summary="Table located under line C, having four columns and eight rows" style="width:187mm;border-top-width:0px;font-size:7pt;border-style: solid; border-color: black;         border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;page-break-inside: avoid">
									<tr>
...
has any knowledge. </td>
      ...
      Date<br/>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;border-bottom:1px solid black;page-break-inside: avoid">
						<tr>
							<!--row 1-->
							<td rowspan="3" style="width:22mm;font-size:14pt;font-weight:bold;font-family:'arial narrow';border-right:1px solid black;border-bottom:1px solid black;text-align:left;">Paid Preparer Use Only</td>
        ...
        Additional Data        
                ...
                (<xsl:number value="$pos" format="a"/>)<span style="width:2px"/>
                  ...
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
                  	<xsl:call-template name="PopulateMonth">
						<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYrGrp[$pos]/YearEndedDt"/>
					</xsl:call-template>
				</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
                ...
                (<xsl:number value="$pos+1" format="a"/>)<span style="width:2px"/>
                  ...
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
                  	<xsl:call-template name="PopulateMonth">
						<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYrGrp[$pos + 1]/YearEndedDt"/>
					</xsl:call-template>
                ...
                (<xsl:number value="$pos+2" format="a"/>)<span style="width:2px"/>
                  ...
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
                  	<xsl:call-template name="PopulateMonth">
						<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYrGrp[$pos +2 ]/YearEndedDt"/>
					</xsl:call-template>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
          ...
          Adjusted taxable income for look-back purposes. Combine lines 1 and 2.  If line 3 is a negative amount, see instructions.
					...
					<xsl:choose>
						<xsl:when test="$index=1">
							<td class="styForm8697TableCell" rowspan="1">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYrGrp/AdjTaxableIncomeForLookBackAmt"/>
									</xsl:call-template>
							</td>
						</xsl:when>
						<xsl:otherwise>
	...
	<xsl:template name="part2Table">
		...
		<xsl:if test="$index &lt;= $Part2Max">
			<table style="width:187mm;" id="TP2ctn">
				<xsl:call-template name="SetInitialState"/>
				<table cellspacing="0" summary="Table located under Part 2, having four columns and eight rows" style="width:187mm;border-top-width:0px;font-size:7pt;border-style: solid; border-color: black;border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;page-break-inside: avoid; " name="TYTable" id="TYTable">				
					<tr>
						<th class="styTableCell" rowspan="1" style="width:7mm;text-align:center;border-color:black;border-right:none;border-bottom:none;">
							<span style="width:1px;"/>
						</th>

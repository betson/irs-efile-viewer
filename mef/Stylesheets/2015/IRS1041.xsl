	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
		...
		<html lang="EN-US">
				...
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div style="width:187mm;height:14mm;">
							...
							<span class="styTaxYear">20<span class="styTYColor">15</span></span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2015 or fiscal year beginning 
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">
										<b>Payments: a</b> 2015 estimated tax payments and amount applied from 2014 return
										<xsl:call-template name="LinkToLeftoverDataTableInline">
		  ...
		  <!--Line 29-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Amount of line 28 to be: <b> a Credited to 2016 estimated tax</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2015)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2015)</span>
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;">At any time during calendar year 2015, did the estate or trust have an interest in or a signature or other authority</span>

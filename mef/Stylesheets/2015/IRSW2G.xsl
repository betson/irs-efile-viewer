...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
             ...
             <div style="width:187mm;">        
                ...
                <div class="styIRSW2GRowItem" style="width:74.4mm;height:40mm;float:left;">
                  ...
                  <div class="styIRSW2GRowItem" style="width:37mm;float:left;">
                   ...
                   <div class="styIRSW2GRightTopFrame" style="float:left;width:33.8mm;height:39.6mm;border-bottom-width:1px;">
                ...
                <span style="font-family:Arial;font-size:8pt;">
                 ...
                 <!-- </div>-->
                  ...
                  <div class="styIRSW2GDataLTxtField">
                       <xsl:if test="$FormW2GData/RecipientUSAddress!=''" >
                        <br/>
                       
                                 <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="$FormW2GData/RecipientUSAddress/CityNm"/>
                          <xsl:with-param name="ForeignAddressTargetNode" select="$FormW2GData/RecipientUSAddress"/>
                        </xsl:call-template>,
                                <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="$FormW2GData/RecipientUSAddress/StateAbbreviationCd"/>
                          <xsl:with-param name="ForeignAddressTargetNode" select="$FormW2GData/RecipientUSAddress"/>
                        </xsl:call-template>,
                             <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="$FormW2GData/RecipientUSAddress/ZIPCd"/>
                          <xsl:with-param name="ForeignAddressTargetNode" select="$FormW2GData/RecipientUSAddress"/>
                        </xsl:call-template>
                  </xsl:if>
                    <xsl:if test="$FormW2GData/RecipientForeignAddress!=''" >
                        <br/>
                        <xsl:call-template name="PopulateText">
        ...
        <div class="styIRSW2GRowItem" style="width:37mm;float:left;">
                ...
                <!-- (10) Window >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>-->
                 <div class="styIRSW2GRowItem" style="width:37mm;float:left;">
                  ...
                  <div class="styIRSW2GDataMRTxtFields" style="text-align:center;height:7mm;border-right-width:1px;">
                    <xsl:call-template name="PopulateText">
            ...
            <div style="width:187mm;">
               <div style="width:187mm;height:20mm;border:0px solid black;border-top-width:0px;border-left-width:1px;border-bottom-width:1px;">
                  ...
                  <div style="width:187mm;height:10mm;">
                      <div style="width:17mm;font-weight:bold;font-size:8pt;padding-left:2mm;">Signature</div> 
                      <img src="{$ImagePath}/w2g_Bullet_Md.gif" height="8mm" alt="med_arrow"/>
                      <div style="width:100mm"/>
                      <div style="width:9mm;font-weight:bold;font-size:8pt;padding-left:2mm;">Date</div>
                      <img src="{$ImagePath}/w2g_Bullet_Md.gif" height="8mm" alt="med_arrow"/>
                 </div>
                </div>            
            </div>
 ...
 <br/>
          ...
          <!--<div class="pageEnd"><br/></div><br/><br/><br/>
         <div style="width:10mm;height:110mm;"></div>-->

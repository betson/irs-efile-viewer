...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <br/>							
      ...
      <img src="{$ImagePath}/990SchN_Bullet_Md.gif" alt="bullet"/>
       ...
       <span class="styNormalText">Complete this part if the organization answered "Yes" on Form 990, Part IV, line 31, or Form 990-EZ, line 36.</span><br/><span class="styNormalText">Part I can be duplicated if additional space is needed.</span> 
	...
	<!-- ================ Begin changes for Table I ========================================== -->
						...
						<div class="styTableLandscape " id="p1TbCtnr" style="height:auto;display:table;">
							...
							<table cellspacing="0" style="font-size:7pt;margin-left:0mm;height:auto;display:table;">
								...
								<!--   END HEADER   -->
								<div class="styTableLandscape" style="height:auto;display:table;">
							<!-- print logic -->
          ...
          <!--Dotted Line-->
					...
					<div style="width:140mm;font-weight:bold; float: left; clear: none;">For Paperwork Reduction Act Notice, see the Instructions for Form 990 or Form 990-EZ.</div>
						...
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;">Schedule N (Form 990 or 990-EZ) (2015)</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
					<br/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left">Schedule N (Form 990 or 990-EZ) (2015)</div>
								...
								<thead class="styTableThead">
									<tr>
										<th class="sty990ScheduleNLNCol" scope="col" style="border-style: solid; border-color: black;text-align: center;font-size: 7pt; height:15mm; border-   bottom-width: 0px; border-top-width:0px;padding-top:1mm;font-weight:normal;vertical-align:top">
											...
											<b>(a)</b> Description of asset(s)<br/>distributed or transaction<br/>expenses paid</th>
										<th class="sty990ScheduleNColA" scope="col" style="border-style: solid; border-color: black;text-align: center; height:15mm; width:20mm;border-bottom-width: 0px;border-top-width:0px; font-size: 7pt; padding-top: 1mm;font-weight:normal;vertical-align:top; float:left; clear: none;">
										<b>(b)</b> Date of<br/>distribution</th>
									...
									<!--   END HEADER   -->
									<div class="styTableLandscape" style="display:table;">
							<!-- print logic -->
								<!-- end -->
							<table cellspacing="0" style="font-size:7pt;margin-left:0mm;display:table;">
									<!--   BEGIN LINE 1   -->
...
<span style="font-weight:normal;border-top-width:1px;padding-top:1mm;border-bottom-width:1px;border-right-width:0px;padding-left:0mm;border-top-width:1px">
 ...
 Also complete this part to provide any additional information.</span>
				...
				<!--	<xsl:call-template name="SetInitialDynamicTableHeight">
					...
					<div class="pageEnd" style="width:256mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule N (Form 990 or 990-EZ) (2015)</span>
						</div>
					</div>
					<!--END Page Footer-->
      ...
      Additional Data        
						...
						<div class="styLeftOverButtonLandscape">
					...
					<xsl:if test="($Print = $Separated) and count($FormData/DispositionOfAssetsDetail) &gt;= 9">
						<span class="styRepeatingDataTitle" style="width:256mm">Form 990, Schedule N, Part II - Sale, Exchange, Disposition or Other Transfer of more than 25% of the Organization's Assets. Complete this part if the organization answered "Yes" on Form 990, Part IV, line 32, or Form 990-EZ, line 36. Part II can be duplicated if additional space is needed.</span>
						<table class="styLeftOverTblLandscape" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">

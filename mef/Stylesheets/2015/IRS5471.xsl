				...
				<form name="IRS5471">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:28.25mm; height: 23mm;border-bottom-width:1pt;;border-right-width:1pt">
							<div>
								Form 
								<span class="styFormNumber">5471</span><br/>
					...
					<div class="styBB" style="width:187mm;height:5mm">
						...
						<!--	<span style="width:3mm"/>-->
							<label>
								...
								<span style="width:8px"/>
								<input type="checkbox" alt="foreign financial assets reported on this form" class="styCkbox" name="ForeignFinancialAssetInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/ForeignFinancialAssetInd"/>
										<xsl:with-param name="BackupName">IRS5471ForeignFinancialAssetInd</xsl:with-param>
									</xsl:call-template>
				...
				<!--   BEGIN SCHEDULE G   -->
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							...
							<input type="checkbox" alt="IRS5471Owns10PctOrMoreFrgnPartnershipYes" class="styCkbox" style="width: 3mm; height: 3mm">
                  ...
                  Exchange gain or (loss) on a distribution of previously taxed income  
						...
						<div class="styGenericDiv" style="width: 187mm;padding-top:1mm;">
							...
							<span>
								...
								<input type="checkbox" class="styCkbox" alt="AnyIncomeBlockedYes" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
										<xsl:with-param name="BackupName">IRS5471AnyIncomeBlocked</xsl:with-param>
									</xsl:call-template>
							...
							<span>
								...
								<input type="checkbox" class="styCkbox" alt="AnyIncomeBlockedNo" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
										<xsl:with-param name="BackupName">IRS5471AnyIncomeBlocked</xsl:with-param>
									</xsl:call-template>
							...
							<span class="styLNDesc" style="font-size: 8pt; width: 186mm">
								<label>
									<xsl:call-template name="PopulateLabelYes">
										...
										<xsl:with-param name="BackupName">
										IRS5471AnyIncomeBlocked</xsl:with-param>
									</xsl:call-template>
								</label>
								<span style="width: 2mm"/>
								<label>

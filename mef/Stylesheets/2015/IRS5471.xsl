...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <span style="width:2mm"/>
					...
					<div style="width:187mm;">
						<div class="styAddrFld" style="border-bottom-width: 0px; border-left-width: 0px;
						 border-style:solid; font-size: 6pt; height:9.3mm;width: 109mm;
						 font-weight: normal">
    ...
    <span class="styFixedUnderline" style="width:15mm;float:none;">
                  ...
                  <span style="width: 20mm;">
					...
					<div class="styBB" style="width: 187mm; border-top-width: 0px;height:6mm">
						<span style="text-align:left">
                             <b style="font-size: 7pt;padding-right:1mm;">D</b>
							<!--<span class="styNBSP"/>-->
							<span style="font-size: 7pt">Check if any excepted specified foreign financial assets are
                                 reported on this form (see instructions) 
						...
						<span style="width:1mm"/>
					             <label>
									<xsl:call-template name="PopulateLabel">
										...
										<xsl:with-param name="BackupName">Foreign Financial Asset Ind</xsl:with-param>
									</xsl:call-template>
					             </label>
								<input type="checkbox" class="styCkbox" name="CategoryOfFiler2Ind">
									<xsl:call-template name="PopulateCheckbox">
											...
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:for-each select="$IRS5471Data/ForeignEntityIdentificationGrp">
														<tr>
															<td class="styTableCell" style="vertical-align:bottom;height:9mm;border-color:black;border-right:0;width:72mm;">
				...
				<span class="styTableCell" style="text-align:left;padding-left:2mm;height:9.5mm;border:none;border-left:1px solid black;
					...
					<table class="styTable" cellspacing="0" style="width:187mm;border-top:0px solid black;font-size: 7pt">
						<tr>
							...
							<td class="styTableCell" valign="top" style="width: 36.8mm; height: 10mm; 
							border-color: black; border-bottom-width: 0px;border-top-width:1px">
								<span style="width:36.8mm;text-align:left;padding-left:1mm;">
									<b>f</b>
									<span style="width: 1mm"/>Principal business 
	                         </span>
								<span style="text-align: left; width: 36.8mm;padding-left:3mm">activity code number<br/>
								</span>
								<span style="text-align: left; width: 36.8mm; padding-left:3.5mm;">
									<xsl:choose>
					...
					<table class="styTable" cellspacing="0" style="width:187mm;font-size:7pt;">
						...
						<tr>
							...
							border-right-width: 1px; width: 103mm;
							...
							<div class="styBB" style="width:41mm;height:10mm;border-right-width:0px;padding-top:2mm;">
									<i>(i)</i>
									<span style="width:1mm"/>Taxable income or (loss)
								</div>
<div style="border-top-width:1px;padding-left:16mm;height:14.5mm;padding-top:13mm">
							...
							<td scope="col" class="styTableCellHeader " style="font-weight: normal; border-color: black;border-right-width:0px;">
								<div class="styBB" style="width:41mm;height:8.4mm;border-right-width:0px;">
									<i>(ii)</i>
									<span style="width: 1mm"/>U.S. income tax paid (after all credits)
								</div>
								<div style="border-top-width:1px;padding-left:16mm;height:13mm;padding-top:13mm;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:186mm;float:none;clear:both;border-top:1px solid black;height:auto;">
				...
				agent in <br/>
						...
						<xsl:if test="($Print != $Separated) or (count($IRS5471Data/PersonWithRecordsCustody) = 1)">
							<span id="PWRCctn" style="width:84mm;border-left:1px solid black;height:auto;" class="styIRS5471TableContainer">
								<xsl:call-template name="SetInitialState"/>
				...
				<!--   BEGIN SCHEDULE G   -->
					...
					<!--   BEGIN LINE 3   -->
						...
						During the tax year, did the foreign corporation own any foreign entities that were disregarded as entities separate
						 from their <br/>owners under  Regulations sections 301.7701-2 and 301.7701-3 (see instructions)?
						 <xsl:call-template name="SetFormLinkInline">
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNDesc" style="width: 160mm">
							<span style="float:left">
								During the course of the tax year, did the foreign corporation
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						During the tax year, did the foreign corporation participate
						 in any reportable transaction as defined in Regulations <br/>section 1.6011-4?</span>
					</div>
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="width: 160mm; margin-left:8mm">
							<span style="float:left;padding-left:23mm;">
								<xsl:call-template name="SetFormLinkInline">
					...
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="margin-left: 8mm">
						If "Yes," attach Form(s) 8886 if required by Regulations section 1.6011-4(c)(3)(i)(G).</span>
					</div>
					<!--   END LINE 6  -->
					<!--   BEGIN LINE 7   -->
					<div class="styGenericDiv" style="width: 187mm">
						...
						During the tax year, did the foreign corporation pay or
						 accrue any foreign tax that was disqualified for credit under section <br/>901(m)?
						</span>
					</div>
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="width: 160mm; margin-left:8mm">
	...
	<!--BEGIN FOOTER-->
          ...
          Additional Data        
					...
					<xsl:if test="($Print = $Separated) and  (count($IRS5471Data/PersonInformationIsFiledFor) &gt; 4)">
						<br/>
						<br/>
						<span class="styRepeatingDataTitle">Form 5471, Line E - Person(s) on whose behalf this information return is filed:</span>

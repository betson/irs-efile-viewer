...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- - Form 1120 displays as - Other Refundable Credits Schedule - -->
    ...
    <table id="OtherRefundableCreditsScheduleTbl" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           <th class="styDepTblCell" style="width:50mm;" scope="col">Description</th>
           <th class="styDepTblCell" style="width:91mm;" scope="col">Regulations Reference</th>
           <th class="styDepTblCell" style="width:36mm;" scope="col">Dollar Amount</th>
        </tr>
      </thead>
      <xsl:for-each select="$DependencyData/OtherRefundableCredits">
        ...
        <td class="styDepTblCell" style="width:50mm;text-align:left;font-family:verdana;">
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <span class="styDepTitle"  style="padding-right:2mm;">
          ...
          <xsl:call-template name="OtherRefundableCreditsScheduleTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
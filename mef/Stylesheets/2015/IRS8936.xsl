 ...
 <!--Title of Form -->    
  <div class="styBB" style="width:187mm;height: 22mm">
	...
	<div class="styFTBox" style="width:122.5mm;height:22mm;">
      ...
      <span style="font-size:11pt">(Including Qualified Two-Wheeled Plug-in Electric Vehicles)</span>
      </div>
...
<!--          (Including Qualified Two- or Three-Wheeled Plug-in Electric Vehicles)--><br/>
            ...
            <img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="Bullet"/>
             Information about Form 8936 and its separate instructions is at <i><a style="text-decoration:none;color:black;" href="http://www.irs.gov/form8936">www.irs.gov/form8936</a>.</i>  
             </div>
    </div>
  </div>
    ...
    <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;padding-left:6mm;">
     ...
     <tr>
		...
		<td class="sty8936LNDescTallShortest" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px;border-style:solid">
               If the vehicle is a two-wheeled vehicle, enter the cost of the vehicle. If the vehicle has at least four wheels, enter	
 the tentative credit (see instructions)<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
		 </td>
		 <td class="sty8936HLNRightNumBoxTall">
			4
		</td>
...
<tbody>
     ...
     <tr style="width:187mm">
        ...
        <td class="styTableCell" style="padding-top:5mm;width:45mm;border-color:black;border-left-width:1px; border-right-width:1px; border-top-width:0px; border-bottom-width:1px; text-align:center;">
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="BusinessInvestmentUsePct"/>
          </xsl:call-template>%
        <span class="styTableCellPad"/>
        </td>
        <td class="styTableCell" style="padding-top:5mm;width:44mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateText">
  ...
  <!-- Line 6  -->
      <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-left:1.5mm;padding-bottom:3mm;">
			6</td>
		<td class="sty8936LNDescTallShortest">
      <span style="float:left;">Multiply line 4 by line 5. If the vehicle has at least four wheels,</span> 
...
<!--Line 12 -->  
  ...
  <div style="width: 187mm;">  
    ...
    <div class="sty8936HLNAmountBoxTall" style="height:8mm;padding-top:5mm;width:43.5mm;font-size: 7pt">
      <xsl:call-template name="PopulateAmount">
  ...
  <div  class="styBB" style="width: 187mm;height:11mm;">  
    ...
    <div class="sty8936HLNAmountBoxTall" style="height:11mm;padding-top:8mm;border-bottom-width:0px;width:43.5mm;font-size: 7pt">
      <xsl:call-template name="PopulateAmount">
	...
	<!--  Line 15  -->
	  ...
	  <tr>  
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:9mm;">
			15</td>
		<td class="sty8936LNDescTallShortest">
       <span style="float:left;">If you skipped Part II, enter the amount from line 4. If you completed Part II, subtract line 6 from line 4. If the vehicle  </span>
   ...
   <table class="styTable" cellspacing="0" style="font-size: 7pt">
    ...
    <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:9mm;">
			15</td>
		<td class="sty8936LNDescTallShortest">
       <span style="float:left;">If you skipped Part II, enter the amount from line 4. If you completed Part II, subtract line 6 from line 4. If the vehicle has at least four wheels, leave lines 16 and 17 blank and go </span>
       <span style="float:left;">to line 18</span>
       <span class="styDotLn" style="float:right;padding-right:1mm;">...............</span> 
		 </td>
		 <td class="sty8936HLNRightNumBoxTall" style="padding-top:0px;padding-left:0px;padding-right:0px;padding-bottom:0px">

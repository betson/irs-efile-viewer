      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div class="styExplanationLine">
            <xsl:for-each select="$DependencyData/CopyReceiverGovernmentCd">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="."/>
              </xsl:call-template>
              <!-- If this is not the last Gov't Code, put in a comma -->
              <xsl:if test="position() != count($DependencyData/CopyReceiverGovernmentCd)">, </xsl:if>
            </xsl:for-each>
          </div>
        </div>
        <div class="styTopSectionLine" style="width:187mm;">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div class="styExplanationLine">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/PersonTitleTxt"/>
            </xsl:call-template>
          </div>
        </div>
        <div class="styTopSectionLine" style="width:187mm;">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div class="styExplanationLine">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/Dt"/>
            </xsl:call-template>
          </div>
        </div>
      </body>

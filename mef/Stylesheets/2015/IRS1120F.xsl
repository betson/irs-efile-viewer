...
<!--					<div style="width:187mm;font-size:7pt">-->
						<table class="styTable" cellspacing="0" cellpadding="0" style="font-size:7pt; width:187mm;border: 0 solid black;border-bottom-width:1px">
							<tr>
								...
								<td valign="top" class="styGenericDiv" style="width:100mm;border: 0 solid black;border-right-width:1px">
									...
									<!-- end line D (2) -->
									<!-- begin line D (3) -->
									<div class="styGenericDiv" style="width:100mm;heigth:auto">
					...
					<!--<div style="width:187mm">-->
						...
						<table cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;" border="0">
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:70mm" scope="row">
									<span style="float:left">
										Less 2015 refund applied for on Form 4466
										<span style="padding-left:1mm;">
											<!-- Form to Form Link -->
											<xsl:call-template name="SetFormLinkInline">
							...
							<tr>
								...
								<td colspan="5" class="styIRS1120FItemDesc" style="width:142mm; height:4.5mm;border-bottom-width:1px;" scope="row">									
										Enter portion of line 8a you want <b>Credited to 2016 estimated tax</b>
									<span style="padding-left:1mm">
										<img src="{$ImagePath}/1120F_Bullet_Sm.gif" alt="SmallBullet"/>
									</span>
					...
					<p>
						<div class="pageEnd" style="width:187mm;">
							...
							<span style="float:right;">Form 
								...
								<span style="font-size:7pt">(2015)</span>
							</span>
						</div>
					</p>
						<!--	<div class="pageEnd"/>
						...
						<div class="styBB" style="width:187mm;padding-top:.5mm;">
							<div style="float:left;">Form 1120-F (2015)<span style="width:148mm;"/>
							</div>
             ...
             <xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;padding-top:0.5mm;">
						...
						Form <span class="styBoldText" style="font-size:8pt;">1120-F</span> (2015)
					</div>
					</div>
					<div class="pageEnd"/>
					<p style="page-break-before: always"/>
			...
			If <b>11a </b>or<b> 11b </b>applies and the transferee is a domestic corporation, attach Form 8848. If<b> 11c </b>applies, attach the statement required by Temporary Regulations section 1.884-2T(d)(5).
					...
					<div style="width:187mm;padding-top:1mm; border:1px solid black; border-left-width:0px; border-right-width:0px; border-bottom:0px">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							Form 
							<span class="styBoldText" style="font-size:8pt;">1120-F</span> (2015)
						</div>
					</div>
					<div class="pageEnd"/>
					<p style="page-break-before: always"/>
					...
					<div style="width:187mm;clear:both;padding-top:0.5mm">
						<div style="float:right;" class="styGenericDiv">Form <span style="font-size:8pt;font-weight:bold">1120-F</span> (2015)</div>

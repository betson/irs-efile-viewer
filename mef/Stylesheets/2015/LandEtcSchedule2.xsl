...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/LandEtcSchedule2"/>
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/LandEtcGrp">
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:right" width="110mm">
          ...
          <td class="styDepTblCell" style="text-align:right" width="110mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="AccumulatedDepreciationAmt"/>
            </xsl:call-template>
          </td>
  ...
  <!-- NameDisplay - IRS990PF - Land, etc. schedule -->

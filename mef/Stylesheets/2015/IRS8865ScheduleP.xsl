	...
	<xsl:template match="/">
		...
		<html>
          ...
          20<span class="stytycolor">15</span>
					...
					<div class="styIRS8865SchedulePBB" style="height:4.5mm; border-top:1px solid black">
					...
					<div class="styIRS8865SchedulePTableContainer" id="part1TPctn" style="border-bottom:0px;">

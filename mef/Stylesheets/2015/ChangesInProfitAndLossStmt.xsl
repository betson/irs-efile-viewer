    ...
    <table class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           <th class="styDepTblCell" scope="col" style="width:93mm">Calendar date</th>        
           <th class="styDepTblCell" scope="col" style="width:94mm">Percentage</th>           
        </tr>
      </thead>
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/ChangesProfitLossInfoGrp">
          <tr>
            ...
            <td class="styDepTblCell" style="width:93mm;text-align:center">
              <xsl:call-template name="PopulateMonthDayYear">
                <xsl:with-param name="TargetNode" select="ProfitLossChangeDt"/>
              </xsl:call-template>                  
            </td>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="Form1120LData" select="$RtnDoc/IRS1120L"/>
			...
			<head>
				...
				<title>
					<xsl:call-template name="FormTitle">
						<xsl:with-param name="RootElement" select="local-name($Form1120LData)"/>
					</xsl:call-template>
				</title>
				<!-- No Browser Caching  -->
			...
			<body class="styBodyClass">
				<form name="Form1120L">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:28mm;height:14mm;">
                         Form <span class="styFormNumber" style="font-size:18pt">1120-L</span>
							<span class="styAgency">Department of the Treasury</span>
							<br/>
							<span class="styAgency">Internal Revenue Service</span>
							<!-- puch pen  -->
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="  $Form1120LData"/>
							</xsl:call-template>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="TargetNode" select="  $Form1120LData/@suprtStmtToCnsldtReturnInd"/>
							</xsl:call-template>
						</div>
						<div class="styFTBox" style="width:132.5mm;height:14mm;padding-top:0mm">
							<div class="styMainTitle" style="height:5mm;padding-top:1mm;">U.S. Life Insurance Company Income Tax Return</div>
							<div style="height:4mm;font-size:7pt;margin-left:2mm;text-align:center;padding-top:1mm;">
        For calendar year 2015 or tax year beginning
        <span style="width: 16mm;border-bottom:1px solid black;">
									<!-- No need to send the parameters -->
									<xsl:call-template name="PopulateMonthDayYear">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxYearBeginDt"/>
									</xsl:call-template>
								</span>, and ending 
            <span style="width: 16mm;border-bottom:1px solid black;">
									<xsl:call-template name="PopulateMonthDayYear">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxYearEndDt"/>
									</xsl:call-template>
								</span>
								<div style="height:4mm;font-weight:bold;font-size:7pt;margin-left:0mm;text-align:left;padding-left:0mm;padding-top:0mm;">	
             ...
             Information about Form 1120-L and its separate instructions is at 
						...
						<div class="styTYBox" style="width:26mm;height:14mm;">
					...
					<div style="width:187mm;float:left;clear:left;">
						<div style="width:33.5mm;height:4mm;float:left;clear:left">
							<div class="styComType" style="width:33.5mm;border-bottom-width: 0px;padding-top:1mm;border-right-width: 1px;">
								<div class="styBoldText" style="height:4mm;width:4mm;float:left;clear:none;">A</div>
								<div class="styGenericDiv" style="height:4mm;width:26mm">Check if:</div>
							</div>
							<div class="styComType" style="width:33.5mm;border-bottom:0px;border-right-width: 1px;">
								...
								<div class="styGenericDiv" style="height:7mm;width:24mm;padding-top:2mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="  $Form1120LData/ConsolidatedReturnInd"/>
...
<!-- Form to Form Link -->
							...
							<div class="styComType" style="width:33.5mm;border-bottom:0px;border-right-width: 1px;">
								...
								<div class="styGenericDiv" style="height:7mm;width:24mm;padding-top:2mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="  $Form1120LData/LifeNonlifeConsolidatedRetInd"/>
							...
							<br/>
							<!-- Header Line A 3 -->
							<div class="styComType" style="width:33.5mm;border-bottom:1px solid black;border-right-width: 1px;height:9mm;">
								<div class="styBoldText" style="height:7mm;width:4mm;float:left;clear:none;padding-top:2mm;">3</div>
								<div class="styGenericDiv" style="height:7mm;width:24mm;padding-top:2mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="  $Form1120LData/ScheduleM3Form1120LInd"/>
          ...
          <xsl:call-template name="SetFormLinkInline">
						...
						<div class="styLblNameAddr" style="width:107mm;height:auto;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width:1px;">
							<div class="styUseLbl" style="width:10mm;height:27.7mm;border-right-width:1px;padding-top:12mm;padding-left:1mm">
  Please<br/> print<br/> or<br/> type</div>
							<div class="styNameAddr" style="width:96.7mm;height:9.5mm;padding-left:2mm;">
Name<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/BusinessName/BusinessNameLine1Txt"/>
								</xsl:call-template>
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/BusinessName/BusinessNameLine2Txt"/>
								</xsl:call-template>
								<br/>
							</div>
    ...
    <!-- Address -->
								<!-- USA Address -->
								<br/>
								<xsl:if test="  $Form1120LData/USAddress/AddressLine1Txt!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/USAddress/AddressLine1Txt"/>
									</xsl:call-template>
									<br/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/USAddress/AddressLine2Txt!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/USAddress/AddressLine2Txt"/>
									</xsl:call-template>
									<br/>
								</xsl:if>
								<!-- Foreign Address -->
								<xsl:if test="  $Form1120LData/ForeignAddress/AddressLine1Txt!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/AddressLine1Txt"/>
									</xsl:call-template>
									<br/>
								</xsl:if>
								<xsl:if test="   $Form1120LData/ForeignAddress/AddressLine2Txt!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/AddressLine2Txt"/>
									</xsl:call-template>
									<br/>
								</xsl:if>
							</div>
							<div class="styNameAddr" style="border-bottom-width:0px;width:96.7mm;padding-left:2mm;height:8.9mm">
        City or town, state or province, country, and ZIP or foreign postal code
<!-- USA Address -->
								<xsl:if test="  $Form1120LData/USAddress/CityNm!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/USAddress/CityNm"/>
									</xsl:call-template>,
<span class="styTableCellPad"/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/USAddress/StateAbbreviationCd!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/USAddress/StateAbbreviationCd"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/USAddress/ZIPCd!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/USAddress/ZIPCd"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
								<!-- Foreign Address -->
								<xsl:if test="  $Form1120LData/ForeignAddress/CityNm!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/CityNm"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/ForeignAddress/ProvinceOrStateNm!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/ProvinceOrStateNm"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/ForeignAddress/ForeignPostalCd!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/ForeignPostalCd"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/ForeignAddress/CountryCd!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/ForeignAddress/CountryCd"/>
									</xsl:call-template>
									<span class="styTableCellPad"/>
								</xsl:if>
							</div>
    ...
    To do this, we use the EINChanged parameter PopulateReturnHeaderFiler.-->
						<div class="styEINDateAssets" style="width:46mm;height:9.5mm;">
							...
							<span style="padding-left:15mm">
								<xsl:if test="  $Form1120LData/CorporationEIN !=' '">
									<xsl:call-template name="PopulateEIN">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/CorporationEIN"/>
									</xsl:call-template>
									<span style="width: 2px"/>
									<br/>
								</xsl:if>
								<xsl:if test="  $Form1120LData/MissingEINReasonCd!=' '">
									<span style="font-weight:normal;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="  $Form1120LData/MissingEINReasonCd"/>
										</xsl:call-template>
									</span>
									<br/>
								</xsl:if>
						...
						<div class="styEINDateAssets" style="width:46mm;height:9.5mm;">
							...
							<span class="styEINFld" style="padding-left:15mm;">
								<xsl:call-template name="PopulateMonthDayYear">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/IncorporationDt"/>
								</xsl:call-template>
							</span>
						</div>
						<!-- Header D Date incorparated -->
						<div class="styEINDateAssets" style="width:46mm;height:9mm;border-bottom-width:0px;">
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="TargetNode" select="  $Form1120LData/Section953dElectionInd/@section953dCd"/>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="TargetNode" select="  $Form1120LData/Section953dElectionInd/@section953dAmt"/>
								<xsl:with-param name="Style">padding-left:4mm;</xsl:with-param>
							</xsl:call-template>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;border-right-width:0px">
						<div class="styBB" style="border-right-width:1px;border-bottom-width:0px;">
							<!-- E 1 -->
							<div class="styGenericDiv" style="width:140.3mm;height:5mm;">
      ...
      Check if: <span style="width:3mm;"/>
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/InitialReturn"/>
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/FinalReturn"/>
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/AddressChangeInd"/>
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/AmendedReturn"/>
						...
						<input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="  $Form1120LData/Section953c3CElectionInd"/>
 ...
 953(c)(3)(C)
						...
						<input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="  $Form1120LData/Section953dElectionInd"/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1120VTImageBox" style="height:32mm;width:19px;padding-top:12mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="  $Form1120LData/GrossPremiumsAmt"/>
							</xsl:call-template>
						</div>
						<!-- line 2 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/NetDecreaseInReservesAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line3 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/PercentDecreaseSection807Amt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 4 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/InvestmentIncomeAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 5 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/CapitalGainNetIncomeAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 6 -->
...
<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/SpecialLossDscntAcctIncomeAmt"/>
									</xsl:call-template>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">..........</span>
...
<span style="width:2px;"/>
									<!-- Form to Form Link -->
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherIncomeAmt"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 7 - other Income Item</xsl:with-param>
										<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherIncomeAmt/@otherIncomeDesc"/>
										<xsl:with-param name="Style">padding-left:4mm;</xsl:with-param>
									</xsl:call-template>
								</span>
								<!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:0px;padding-top:1mm">8</div>
							<div class="styLNAmountBox" style="height:4mm;border-bottom-width:0px;width:32.9mm;padding-top:1mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/LifeInsuranceGrossIncomeAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1120VTImageBox" style="height:77mm;width:19px;padding-top:7mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/DeathBenefitsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 10 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/NetIncreaseInReservesAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 11 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/PercentIncreaseSection807Amt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 12 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/DeductiblePolicyholderDivAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 13 -->
	...
	<span style="float: left; clear: none;">Assumption by another person of liabilities under insurance, etc., contracts
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/LiabilitesAssumptionAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 14 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/ReimbursableDividendsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 15a -->
...
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/InterestDeductionAmt"/>
								</xsl:call-template>
							</div>
							<div class="styUnderlineAmount" style="width:25mm;height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/InterestDeductionAmt"/>
								</xsl:call-template>
							</div>
							<!-- line 15b -->
							<div class="styLNLeftNumBox" style="height:4mm;width:6mm;padding-left:2mm;">b</div>
							<div class="styLNDesc" style="width:43mm;height:4mm;">Less tax-exempt interest expense</div>
								<div class="styUnderlineAmount" style="width:25mm;height:4mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxExemptInterestExpenseAmt"/>
									</xsl:call-template>
								</div>
							<!-- line 15c -->
							<div class="styLNLeftNumBox" style="height:4mm;width:6mm;padding-left:2mm;">c</div>
...
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/InterestBalanceAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 16 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/DedPolicyAcquisitionExpnssAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 17 -->
...
<!-- Form to Form Link-->
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/SpecialLossDscntAcctDedAmt"/>
									</xsl:call-template>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">..................</span>
...
<!-- Form to Form Link -->
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherDeductionsAmt"/>
									</xsl:call-template>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">..............</span>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/PartialTotalDeductionsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 20 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/DeductionsSubtotalAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 21a -->
...
<span style="width:2px;"/>
							...
							<div class="styLNAmountBox" style="height:4mm;width:33mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/DividendsReceivedDeductionAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBox" style="height:4mm;background-color:lightgrey;border-bottom-width:0px"/>
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm;border-bottom-width:0px"/>
						</div>
						<!-- line 21b -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:91mm;height:5mm;padding-top:1mm;">
								<b>Plus: b </b>Operations loss deduction (see instructions) (attach statement)
							</div>
							<div class="styLNRightNumBox" style="height:5mm;padding-top:1mm;">21b</div>
							<div class="styLNAmountBox" style="border-bottom-width:1px;height:5mm;width:33mm;">
<!-- Form to Form Link  -->
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/NetOperatingLossDeductionAmt"/>
								</xsl:call-template>
								<span style="width:4px;"/>
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/NetOperatingLossDeductionAmt"/>
							...
							<div class="styLNRightNumBox" style="height:5mm;padding-top:1mm;">21c</div>
							<div class="styLNAmountBox" style="border-bottom-width:1px;height:5mm;width:32.9mm;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalDivReceivedAndOprLossAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 22 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/GainOrLossFromOperationsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 23 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/SmallLifeInsuranceCoDedAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 24 -->
 ...
 Subtract line 23 from line 22</span>
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/LifeInsuranceCoTxblIncmAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 25 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/LmtOnNoninsuranceLossesAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!--line 26 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:0px">26</div>
							<div class="styLNAmountBox" style="height:4mm;border-bottom-width:0px;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/SurplusAccountDeductionAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1120VTImageBox" style="height:68mm;width:19px;padding-top:24mm">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm;height:4mm;">
								<span style="float: left; clear: none;">
									<b>Taxable income. </b>Add lines 24, 25, and 26 (see instructions)</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">.............</span>
							</div>
							<div class="styLNRightNumBox" style="height:4mm;">27</div>
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncomeAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 28 -->
...
(Schedule K, line 10)</span>
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalTaxAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 29a -->
   ...
   2014 overpayment credited to 2015
							...
							<div class="styLNRightNumBox" style="height:4mm;width:7mm;padding-top:1mm">29a</div>
							<div class="styLNAmountBox" style="width:29mm;height:4mm;padding-top:1mm;border-right-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/PriorYearOverpaymentCreditAmt"/>
								</xsl:call-template>
							</div>
							<div class="styShadingCell" style="width:40mm;height:4mm;border-left-width:0px;"/>
							<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4mm;"/>
							<div class="styLNAmountBoxNBB" style="height:4mm;"/>
						</div>
						<!-- line 29b -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:6.5mm;padding-left:4.5mm;">b</div>
							<div class="styLNDesc" style="width:56mm;height:6.5mm;">
 Prior year(s) special estimated tax payments to be applied
<span style="width:2px;"/>
								<span style="letter-spacing:4mm;font-weight:bold">.......</span>
							</div>
							<div class="styLNRightNumBox" style="height:7mm;width:7mm;padding-top:3mm">29b</div>
							<div class="styLNAmountBox" style="height:7mm;border-right-width:1px;width:29mm;padding-top:3mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/PriorYearEstimatedTaxPymtAmt"/>
								</xsl:call-template>
							</div>
						...
						<!-- line 29c -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:4mm;padding-left:4.5mm;">c</div>
							<div class="styLNDesc" style="width:56mm;height:4mm;">
 2015 estimated tax payments
 <span style="width:2px;"/>
								<span style="letter-spacing:4mm;font-weight:bold">...</span>
							</div>
							<div class="styLNRightNumBox" style="height:4mm;width:7mm;">29c</div>
							<div class="styLNAmountBox" style="height:4mm;border-right-width:1px;width:29mm;padding-top:1mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt"/>
								</xsl:call-template>
							</div>
						...
						<!-- line 29d -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:4mm;padding-left:4.5mm;">d</div>
							<div class="styLNDesc" style="width:92mm;height:4mm;">
   2015 special estimated tax payments<i> (Do not include on line 29f)</i>
							</div>
							<div class="styLNRightNumBox" style="height:4mm;">29d</div>
							<div class="styLNAmountBox" style="height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/SpecialEstimatedTaxPaymentsAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4mm;"/>
							<div class="styLNAmountBoxNBB" style="height:4mm;"/>
						...
						<!-- line 29e -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:4mm;padding-left:4.5mm;">e</div>
							<div class="styLNDesc" style="width:56mm;">
								<span style="float: left; clear: none;">Less 2015 refund applied for on 
    Form 4466</span>
							</div>
							<div class="styLNRightNumBox" style="width:7mm;height:4mm;">29e</div>
							<div class="styLNAmountBox" style="border-right-width:0px;width:29mm;height:4mm;">(
<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentOfEstimatedTaxAmt"/>
								</xsl:call-template>)</div>
							<!-- line 29f -->
							<div class="styLNRightNumBox" style="height:4mm;">29f</div>
							<div class="styLNAmountBox" style="width:32.2mm;height:4mm;border-right-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotOvpmtCrAndEstTxPaymentsAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="width:8.1mm;border-bottom-width:0px;border-right-width:1px;border-left-width: 0px;background-color:lightgrey;height:4mm;"/>
						</div>
						<!-- line 29g -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:4mm;padding-left:4.5mm;">g</div>
							<div class="styLNDesc" style="width:92mm;height:4mm;">
								<span style="float: left; clear: none;">Tax deposited with Form 7004 
</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">............</span>
							</div>
							<div class="styLNRightNumBox" style="height:4mm;">29g</div>
							<div class="styLNAmountBox" style="height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxPaidForm7004Amt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4mm;"/>
							<div class="styLNAmountBoxNBB" style="height:4mm;border-left-width:1px"/>
						</div>
						<!-- line 29h 1-->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:4mm;padding-left:4.5mm;">h</div>
							<div class="styLNDesc" style="width:52mm;padding-top:0mm;">
							<div class="styLNDesc" style="width:28mm;height:4mm;">Credits: <span style="font-size:6pt"><b> (1)</b> Form 2439 </span>
							</div>
							<div class="styUnderlineAmount" style="height:4mm;width:22mm;border-left-width:0px;font-size:6pt;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalUndistributedLTCapGainAmt"/>
								</xsl:call-template>
							</div>
							
							</div>
							<div class="styLNDesc" style="width:40mm;padding-top:0mm;">
								<div class="styLNDesc" style="width:17.5mm;height:4mm;font-size:6pt;padding-top:1mm;">
									<b>(2) </b> Form 4136
								</div>
								<div class="styUnderlineAmount" style="height:4mm;width:22mm;border-left-width:0px;font-size:6pt;padding-top:1mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalFuelTaxCreditAmt"/>
									</xsl:call-template>
								</div>
							</div>	
								<div class="styLNRightNumBox" style="height:4mm;">29h</div>
								<div class="styLNAmountBox" style="height:4mm;">
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 29H - Ozone Depleting Chemical Indicator</xsl:with-param>
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalCreditsAmt/@ozoneDepletingChemicalCd"/>
									</xsl:call-template>
									<span style="padding-right:1mm"/>
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalCreditsAmt"/>
									</xsl:call-template>
									<span style="width:1mm;"/>
								</div>
								<div class="styLNRightNumBox" style="height:4mm;background-color:lightgrey;border-bottom-width: 0px"/>
						...
						<!-- line 29i -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:5mm;padding-left:4.5mm;padding-top:1mm;">i</div>
...
<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/IncomeTaxPaidOrWithheldAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBox" style="height:5mm;padding-top:1mm;">29i</div>
							...
							<div class="styLNAmountBox" style="height:5mm;width:32.9mm;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29j"/>
								</xsl:call-template>
								<span style="width:1mm;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 29j - backup Withholding Indicator</xsl:with-param>
									<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29j/@backupWithholdingTypeCd"/>
								</xsl:call-template>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 29j - backup Withholding Amount</xsl:with-param>
									<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29j/@backupWithholdingAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 29J and 29K-->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBoxDD" style="height:7mm;padding-top:3mm;padding-left:4.5mm;">j</div>
...
<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/RefundableCreditsAmt"/>
									</xsl:call-template>
								</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">........</span>
							</div>
							<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm">29j</div>
							<div class="styLNAmountBox" style="height:7mm;padding-top:3.5mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/RefundableCreditsAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="height:7mm;border-bottom-width:1px;padding-top:4mm">29k</div>
							<div class="styLNAmountBox" style="height:7mm;width:32.9mm;">
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 29k - backup Withholding Indicator</xsl:with-param>
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalPaymentsAmt/@backupWithholdingTypeCd"/>
								</xsl:call-template>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 29k - backup Withholding Amount</xsl:with-param>
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalPaymentsAmt/@backupWithholdingAmt"/>
								</xsl:call-template>
								<!--<br/>-->
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalPaymentsAmt"/>
								</xsl:call-template>
								<!--<span style="width:1mm;"/>-->
							</div>
						</div>
						<!-- line 30 -->
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:1mm;">30</div>
							<div class="styLNDesc" style="width:132mm;height:4.5mm;padding-top:0mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="  $Form1120LData/Form2220AttachedInd"/>
...
<span style="width:2px;"/>
							...
							<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/EsPenaltyAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 31 -->
 ...
 If line 29k is smaller than the total of lines 28 and 30, enter amount owed</span>
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/BalanceDueAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 32 -->
 ...
 If line 29k is larger than the total of lines 28 and 30, enter amount overpaid</span>
							...
							<div class="styLNAmountBox" style="height:4mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/OverpaymentAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- line 33 -->
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:82mm;height:4mm">
							...
							<div class="styGenericDiv" style="width:28mm;height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LData/OverpaymentSection /AppliedToEsTaxAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNDesc" style="width:22mm;height:4mm;">
								<span class="styBoldText">Refunded</span>
								<span style="width:2px"/>
								<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/RefundAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="height:4mm;">33</div>
							<div class="styLNAmountBoxNBB" style="height:4mm;;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/RefundAmt"/>
								</xsl:call-template>
							</div>
...
<input class="styCkbox" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
 ...
 Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2015)
</div>
					</div>
					<!--div class="pageEnd" /-->
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-L (2015)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;">
						<table class="styTable" style="font-size:7pt;border-bottom:1px solid black;width:187mm;height:auto;" cellspacing="0">
							<thead>
								<tr scope="col">
									<th scope="col" class="styBB" colspan="2" style="width:85mm;border-bottom-width:0px;float:none;clear:none;">
										<div class="styPartDesc" style="width:85mm;text-align:center;">Dividends subject to proration
	</div>
									</th>
									<th class="styBB" style="width:11mm;height:4mm;border-right-width:0px;float:none;clear:none;">
										<span style="width:1px;font-weight:bold;"/>
									</th>
									<th scope="col" class="styLNAmountBox" style="width:45mm;height:8mm;text-align:center;font-size:7pt; padding-top:1mm;font-weight:normal;border-left-width:1px;float:none;clear:none;">
							...
							<tbody valign="top">
								<!-- SCH A line 1 -->
								<tr>
									<td class="styLNLeftNumBox" style="height:8mm;padding-left:3mm;width:5mm;float:none;clear:none;">1</td>
									<td class="styLNDesc" style="width:85mm;height:8mm;float:none;clear:none">
   Domestic corporations, less-than-20%-owned (other than 
 debt-financed stock)
 <!--Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:2mm;">............</span>
									</td>
									<td class="styLNRightNumBox" style="height:8mm;width:11mm;padding-top:4mm;">1</td>
									<td class="styLNAmountBox" style="height:8mm;width:40mm;vertical-align:bottom;float:none;clear:none">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$IRS1120LScheduleA/DomCorpBelow20OwnDivRcvdAmt"/>
										</xsl:call-template>
									</td>
									<td class="styIRS1120LNPercentBox" style="height:8mm;vertical-align:bottom;padding-left:3mm;width:15mm;;float:none;clear:none">70</td>
									<td class="styLNAmountBox" style="width:40mm;height:8mm;vertical-align:bottom;float:none;clear:none;">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
								...
								<!-- SCH A line 2 -->
								<tr>
									<td class="styLNLeftNumBox" style="height:8mm;padding-left:3mm;float:none;clear:none;">2</td>
									<td class="styLNDesc" style="width:85mm;height:8mm;;float:none;clear:none;">
...
<!--Dotted Line-->
									...
									<td class="styLNRightNumBox" style="height:8mm;width:11mm;padding-top:4mm;">2</td>
									<td class="styLNAmountBox" style="width:40mm;height:8mm;vertical-align:bottom;;float:none;clear:none;">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
									...
									<td class="styLNAmountBox" style="width:40mm;height:8mm;vertical-align:bottom;float:none;clear:none;" colspan="2">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
								...
								<!-- SCH A line 3 -->
								<tr>
									<td class="styLNLeftNumBox" style="height:9mm;padding-left:3mm;float:none;clear:none;padding-top:5mm;">3</td>
									<td class="styLNDesc" style="width:85mm;height:9mm;float:none;clear:none;padding-top:5mm;">
Debt-financed stock of domestic and foreign corporations
</td>
									<td class="styLNRightNumBox" style="height:9mm;width:11mm;padding-top:5mm;">3</td>
									<td class="styLNAmountBox" style="width:40mm;height:9mm;vertical-align:bottom;float:none;clear:none;">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$IRS1120LScheduleA/DebtFincdStockCorpDivRcvdAmt"/>
										</xsl:call-template>
									</td>
									<td class="styIRS1120LNPercentBox" style="height:9mm;vertical-align:bottom; font-size:6pt;padding-left:4mm;float:none;clear:none;">see instructions
<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS1120LScheduleA/DebtFincdStockCorpPct"/>
										</xsl:call-template>
									</td>
									<td class="styLNAmountBox" style="height:9mm;width:40mm;vertical-align:bottom;float:none;clear:none;" colspan="2">
										<span style="width:1px;"/>
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									...
									<td class="styLNDesc" style="width:85mm;height:4mm;;float:none;clear:none;">
										<span style="float: left; clear: none;">Public utility corporations, less-than-20%-owned</span>
										<!-- Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:2mm;">...</span>
									</td>
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">4</td>
								...
								<tr>
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">5</td>
									<td class="styLNAmountBox" style="width:40mm;height:4mm;;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
										<xsl:call-template name="PopulateAmount">
...
FSCs
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">6</td>
...
FSCs
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">7</td>
									<td class="styLNAmountBox" style="width:40mm;height:4mm;vertical-align:bottom;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styLNDesc" style="width:85mm;height:4mm;font-size:7pt;float:none;clear:none;">
 Wholly owned foreign subsidiaries and certain FSCs
<span class="styDotLn" style="float:right;padding-right:2mm;">..</span>
									</td>
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">8</td>
									<td class="styLNAmountBox" style="width:40mm;height:4mm;vertical-align:bottom;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">9</td>
									<td class="styLNAmountBox" style="width:40mm;height:4mm;vertical-align:bottom;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styLNLeftNumBox" style="height:4mm;">10</td>
									<td class="styLNDesc" style="width:85mm;height:4mm;float:none;clear:none;">
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">10</td>
								...
								<tr>
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;">11</td>
									...
									<td class="styLNAmountBox" style="width:40mm;height:4mm;vertical-align:bottom;float:none;clear:none;font-size:6.0pt;" colspan="2">
										<span style="width:1px;"/>
								...
								<tr>
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;padding-top:1mm;">12</td>
								...
								<tr>
									...
									<td class="styLNDesc" style="width:85mm;text-align:center;font-size:9pt;float:none;clear:none;padding-bottom:0mm;">
										<b>Dividends not subject to proration</b>
									</td>
									<td class="styLNRightNumBox" style="height:4.5mm;width:11mm;border-bottom-width:0px;"/>
									<td class="styLNAmountBox" style="width:45mm;vertical-align:bottom;border-bottom-width:0px;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
									</td>
									<td class="styIRS1120LNPercentBox" style="width:15mm;border-bottom-width:0px;float:none;clear:none;">
										<!--<span style="width:1px;"/>-->
									</td>
									<td class="styLNAmountBox" style="width:40mm;vertical-align:bottom;border-bottom-width:0px;float:none;clear:none;" colspan="2">
										<!--<span style="width:1px;"/>-->
									</td>
								</tr>
								<!-- SCH A line 13 -->
								<tr>
									<td class="styLNLeftNumBox" style="height:8mm;padding-top:5mm;float:left;clear:none;">13</td>
									<td>
									 <div class="styLNDesc" style="height:8mm;width:85mm;padding-top:5mm;float:none;clear:none;">
										<span style="float: left; clear: none;">Affiliated company dividends</span>
										<span class="styDotLn" style="float:right;padding-right:2mm;">.........</span>
										</div>
									</td>
									<td class="styLNRightNumBox" style="height:8.5mm;width:11mm;padding-top:5mm;">13</td>
									<td class="styLNAmountBox" style="height:8mm;width:45mm;vertical-align:bottom;float:none;clear:none;">
										<xsl:call-template name="SetFormLinkInline">
									...
									<td class="styIRS1120LNPercentBox" style="height:8mm;padding-bottom: 0mm;padding-left:3mm;font-size:6pt;text-align:center;float:none;clear:none;">
									see instructions
                                    <xsl:call-template name="PopulateText">
								...
								<tr>
									...
									<td class="styLNRightNumBox" style="height:4mm;width:11mm;">14</td>
									<td class="styBB" style="width:45mm;height:4mm;border-left-width:1px;  border-bottom-width: 1px;vertical-align:bottom;text-align:right;float:none;clear:none;">
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styLNDesc" style="width:85mm;height:7mm;float:none;clear:none;">
										<span style="float: left; clear: none;">
 ...
 Add lines 1 through 14, column (a). Enter </span>
									...
									<td class="styLNRightNumBox" style="height:7mm;width:11mm;padding-top:3.5mm;">15</td>
									<td class="styBB" style="width:45mm;height:7mm;border-left-width:1px; vertical-align:bottom;border-bottom-width: 1px;text-align:right;float:none;clear:none;">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
								...
								<!-- SCH A line 16 -->
								<tr>
									<td class="styLNLeftNumBox" style="height:11mm;float:none;clear:none;border-bottom: 1px solid black;">16</td>
									<td class="styLNDesc" style="width:85mm;height:11mm;float:none;clear:none;border-bottom: 1px solid black;">
...
<!-- No Dotted Line-->
									...
									<td class="styLNRightNumBox" style="height:11mm;width:11mm;padding-top:7.5mm;">16</td>
									<td class="styBB" style="width:45mm;height:11mm;border-left-width:1px;border-bottom-width: 1px;background-color:lightgrey;float:none;clear:none;">
										<span style="width:1px;"/>
									</td>
									<td class="styIRS1120LNPercentBox" style="border-bottom-width: 1px;height:11mm;vertical-align:bottom;background-color:lightgrey;float:none;clear:none;">
										<span style="width:1px;"/>
									</td>
									<td class="styLNAmountBox" style="width:40mm;height:11mm;vertical-align:bottom;border-bottom-width:1px;float:none;clear:none;" colspan="2">
										<span style="width:1px;"/>
										<xsl:call-template name="PopulateAmount">
...
<!-- Form to Form Link -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:4mm;">
							<span style="float: left; clear: none;">Total dividends (Schedule A, line 15, column (a))</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:2mm;">..................</span>
						</div>
						<div class="styLNRightNumBox" style="height:4mm;">2</div>
...
<!-- Form to Form Link -->
					...
					<!-- SCH B line 10-1 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:mm;">10</div>
						<div class="styLNDesc" style="height:7mm;">
							
 Increase in policy cash value of section 264(f) policies as defined in section 805(a)(4)(F). Enter here and include on Schedule F, line 13
							<!--Dotted Line-->

							<span class="styDotLn" style="float:right;padding-right:2mm;">........................</span>
						</div>
						<div class="styLNRightNumBox" style="height:7mm;padding-top:4mm;">10</div>
...
Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2015)
    ...
    <span class="styNormalText">(section 812) (see instructions)</span>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;;padding-top:1mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS1120LScheduleF/UnearnedPremUnpaidLossesBOYAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:1px;padding-top:1mm"/>
						<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:1px;padding-top:1mm">
							<xsl:call-template name="PopulateAmount">
...
-->
					...
					<div style="width:187mm;clear:all;">
						...
						<div class="styLNAmountBox" style="height:4.5mm;text-align:right;border-bottom-width:0px">
							<i>100%</i>
						</div>
					</div>
					<!-- SCH F line 32 -->
					...
					<xsl:choose>
						<xsl:when test="string-length($IRS1120LScheduleF/InvestmentIncomeRt) &gt; 15">
							<div style="width:187mm;">
								...
								<div class="styLNAmountBoxNBB" style="width:45mm;height:5mm;border-top-width:1px;padding-top:2mm">
									<xsl:call-template name="PopulatePercent">
					...
					<div class="styBB" style="width:187mm;">
						<xsl:choose>
							<xsl:when test="string-length($IRS1120LScheduleF/InvestmentIncomeRt) &gt; 15">
								...
								<div class="styLNDesc" style="width:126mm;height:4mm;">
									<span style="float: left; clear: none;">
										<b>Policyholders share percentage. </b> Subtract line 32 from line 31</span>
									<span class="styDotLn" style="float:right;padding-right:2mm;">.........</span>
								</div>
								<div class="styLNRightNumBoxNBB" style="height:5mm;border-top-width:1px;">33</div>
								<div class="styLNAmountBoxNBB" style="width:45mm;height:5mm;border-top-width:1px;">
									<xsl:call-template name="PopulatePercent">
...
<span style="letter-spacing:4mm;font-weight:bold">...............</span>
					...
					<!-- SCH G line 18b -->
					<div style="width:187mm;">
						<div class="styLNLeftLtrBox" style="height:8mm;padding-top:4mm">
							<span style="width:4px;"/>b</div>
...
Tentative LICTI</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:6mm;width:117mm;border-left-width:0px;padding-top:2mm">
							<span style="float: left; clear: none;">Add lines 1 through 5 in both columns</span>
							<span class="styDotLn" style="float:right;padding-right:2mm;">................</span>
						</div>
						<div class="styLNAmountBox" style="height:6mm;width:31mm;padding-top:2mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS1120LScheduleH/TotalTentativeIncomeAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="height:6mm;width:30.5mm;padding-top:2mm">
							<xsl:call-template name="PopulateAmount">
...
<span style="letter-spacing:4mm;font-weight:bold">...............</span>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px">
						...
						<div class="styLNDesc" style="width:139mm;height:8mm;">
							<span style="float: left; clear: none;">
								<b>Small life insurance company deduction.</b>
...
<span class="styDotLn" style="float:right;padding-right:2mm;">............................</span>-->
						...
						<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:1px;border-bottom-width:0px;"/>
						<div class="styLNAmountBox" style="height:4mm;border-bottom-width:0px">
</div>
					</div>
					<!-- Schedule I line 5-2 -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:1px;padding-top:1mm">7</div>
						<div class="styLNAmountBox" style="height:4mm;border-bottom-width:1px;padding-top:1mm">
							<xsl:call-template name="PopulateAmount">
					...
					<!-- Schedule I  line 9 -->
					<div class="styBB" style="width:187mm;border-bottom-width:1px;float: none; clear: none;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:3mm">9 </div>
						<div class="styLNDesc" style="width:139mm;height:4mm;">
							<span style="float: left; clear: none;">
								<b>Limitation on noninsurance losses. </b>
...
<span class="styNormalText"> (see instructions)</span>
					...
					<!-- SCH K line 1 -->
					<div style="width:187mm;clear:all;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;padding-left:3mm">1</div>
						<div class="styLNDesc" style="width:139mm;height:4mm;padding-top:0mm;">
							<label>
								<xsl:call-template name="PopulateLabel">
...
<!-- Form to Form Link   -->
					...
					<!-- Schedule K line 9 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;padding-left:3mm">9</div>
						<div class="styLNDesc" style="width:139mm;padding-top:0mm;height:4mm;">Other taxes. Check if from: 
<span style="width:8px"/>
							<input type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
...
amounts includible in “total insurance liabilities on U.S. business" as defined in 
</span>
							<span style="float: left; clear: none;">section 842(b)(2)(B)(i)) </span>
							<span class="styDotLn" style="float:right;padding-right:2mm;">..................</span>
						</div>
						...
						<div style="width:187mm;clear:both;float:none;">
							...
							<div class="styGenericDiv" style="width:94mm;">
								<div class="styGenericDiv" style="width:94mm;">
									...
									<div class="styLNDesc" style="width:74mm;height:4.5mm;">Check method of accounting:</div>
								...
								<div class="styGenericDiv" style="width:94mm;">
									<!-- Line 1 A -->
									<div class="styLNDesc" style="width:82mm;height:4.5mm;">
										<span class="styLNLeftLtrBox" style="width:7mm;height:4.5mm;">a</span>
										<!--<span style="width:3px;"/>-->
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
...
Other (specify)
										...
										<div class="styIRS1120BBText" style="width:25mm;float:none;border-style:dotted;">
											<xsl:call-template name="PopulateText">
								...
								<div class="styGenericDiv" style="width:94mm;">
									...
									<div class="styLNDesc" style="width:74mm;height:4.5mm;">Check if the corporation is a:</div>
...
Legal reserve company if checked:<br/>
											<span style="padding-left:8mm">Kind of company:</span>
										</label>
									</div>
								...
								<div class="styGenericDiv" style="width:94mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;"/>
									<div class="styLNDesc" style="width:74mm;height:4.5mm;">
										<span class="styBoldText">(1)</span>
										<span style="width:3px;"/>
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
...
Health and accident insurance
								...
								<div class="styGenericDiv" style="width:94mm;">
									<div class="styLNDesc" style="width:82mm;height:4.5mm;">
										<span class="styLNLeftLtrBox" style="width:7mm;height:4.5mm;">b</span>
										<span style="width:3px;"/>
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
...
Fraternal or assessment association
								...
								<div class="styGenericDiv" style="width:94mm;">
									<div class="styLNDesc" style="width:82mm;height:4.5mm;">
										<span class="styLNLeftLtrBox" style="width:7mm;height:4.5mm;">c</span>
										<span style="width:3px;"/>
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
...
<!-- Form to Form Link  -->
									...
									<div class="styShadingCell" style="width:6mm;height:21mm;"/>
									<div class="styShadingCell" style="width:6mm;height:21mm;border-right-width:1px"/>
								</div>
								<!-- Line 4 -->
								<div class="styGenericDiv" style="width:94mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">4</div>
									<div class="styLNDesc" style="width:74mm;height:4.5mm;padding-bottom:0px;padding-top:0px;">
...
<span style="letter-spacing:4mm;font-weight:bold">............</span>
								...
								<div class="styGenericDiv" style="width:94mm;">
									...
									<div class="styLNDesc" style="width:74mm;padding-top:0mm;padding-bottom:0mm;">
...
<span style="width:3px;"/>
										<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
										<span style="width:6px;"/>
										<span style="width:70mm;border-bottom:1px dotted black;">
											<xsl:call-template name="PopulateText">
...
<span style="width:3px;"/>
								...
								<div class="styGenericDiv" style="width:94mm;">
									...
									<div class="styLNDesc" style="width:74mm;height:4mm;">
...
<span style="width:3px;"/>
									...
									<div class="styShadingCell" style="width:6mm;height:19.5mm;border-bottom-width:0mm"/>
									<div class="styShadingCell" style="width:6mm;height:19.5mm;border-right-width:1px;border-bottom-width:0mm"/>
								</div>
							</div>
...
<!--Dotted Line-->
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;"/>
									<div class="styLNDesc" style="width:73mm;height:4.5mm;">If "Yes," enter: 
<span class="styBoldText">a </span>
Percentage owned <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
										<span style="width:3px;"/>
										<div class="styIRS1120BBText" style="width:20mm;text-align:right;float:none;clear:none;border-style:dotted;">
											<xsl:call-template name="PopulatePercent">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;"/>
									<div class="styLNDesc" style="width:73mm;height:4.5mm;">and <span class="styBoldText">b</span>
Owner's country <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
										<span style="width:3px;"/>
										<div class="styIRS1120BBText" style="width:37mm;float:none;clear:none;border-style:dotted;">
											<xsl:call-template name="PopulateText">
...
Engaged in a U.S. Trade or Business.  Enter number of Forms 5472 attached 
<!-- Form to Form Link   -->
											<xsl:call-template name="SetFormLinkInline">
											...
											<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
											<span style="width:3px;"/>
											<span style="width:25.5mm;font-size:6pt;border-bottom:1px dotted black;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$IRS1120LScheduleM/TotalForm5472FiledCnt"/>
													<xsl:with-param name="MaxSize" select="4"/>
												</xsl:call-template>
								...
								<div class="styGenericDiv" style="width:93mm;">
									...
									<div class="styLNDesc" style="width:73mm;padding-top:0mm;padding-bottom:0mm;">
...
<!--Dotted Line-->
								...
								<!-- Line 10 -->
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:2mm;padding-bottom:0mm;">10</div>
									<div class="styLNDesc" style="width:73mm;padding-top:2mm;padding-bottom:0mm;">
...
<!--Dotted Line-->
								...
								<div class="styGenericDiv" style="width:93mm;">
									...
									<div class="styLNDesc" style="width:73mm;height:4.5mm;">Enter the total unpaid losses shown on the
corporation’s annual statement:</div>
								...
								<div class="styGenericDiv" style="width:93mm;height:4.5mm;">
									<div class="styLNLeftLtrBox" style="height:4.5mm;padding-left:8mm;width:12mm;padding-top:1.5mm;">(1)</div>
									<div class="styLNDesc" style="width:69mm;height:4.5mm;padding-left:2mm">
For the current year: $ 
<div class="styIRS1120BBText" style="width:34mm;text-align:right;float:none;clear:none;">
											<xsl:call-template name="PopulateAmount">
								...
								<div class="styGenericDiv" style="width:93mm;height:6.5mm;">
									<div class="styLNLeftLtrBox" style="height:4.5mm;padding-left:8mm;width:12mm;padding-top:1.5mm;">(2)</div>
									<div class="styLNDesc" style="width:69mm;height:4.5mm;padding-left:2mm">
For the previous year: $ 
<div class="styIRS1120BBText" style="width:32mm;text-align:right;float:none;clear:none;">
											<xsl:call-template name="PopulateAmount">
								...
								<!-- Line 11b -->
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:6.5mm;padding-left:4.5mm">b</div>
									<div class="styLNDesc" style="width:73mm;height:6.5mm;">Enter the total unpaid loss adjustment expenses
shown<br/>on the corporation’s annual statement:
</div>
									<div class="styShadingCell" style="width:6mm;height:6.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:6.5mm;border-right-width:0px"/>
								</div>
...
<div class="styIRS1120BBText" style="width:32mm;text-align:right;float:none;clear:none;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									...
									<div class="styLNDesc" style="width:73mm;height:7mm;font-size:6pt;">
										<label>
											<xsl:call-template name="PopulateLabel">
...
<!-- Form to Form Link   -->
								...
								<!-- Line 12 - sub -->
								<div class="styGenericDiv" style="width:93mm;height:12mm;">
									<div class="styLNLeftNumBox" style="height:12mm;"/>
									<div class="styLNDesc" style="width:73mm;height:12mm;padding-right:2px;">
If the corporation is filing a consolidated return, the statement required by Regulations section 1.1502-21(b)(3) must be attached or the election will not be valid.</div>
								...
								<!-- Line 13 sub -->
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:12mm;">13</div>
									<div class="styLNDesc" style="width:73mm;height:12mm;">
Enter the available OLD carryover from prior tax years. (Do not reduce it by any deduction on page 1, <br/>line 21b.)
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
$
<div class="styIRS1120BBText" style="width:32mm;text-align:right;float:none;clear:none;">
											<xsl:call-template name="PopulateAmount">
									...
									<!-- Line 14a  -->
									<div class="styGenericDiv" style="width:93mm;">
										<div class="styLNLeftNumBox" style="height:4mm;padding-top:0mm; padding-bottom:0mm;">14a</div>
										<div class="styLNDesc" style="width:73mm;padding-top:0mm;padding-bottom:0mm;">
Enter the corporation’s state of domicile
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
											<span style="width:3px;"/>
											<span style="width:15mm;border-bottom:1px dotted black;text-align:left">
												<xsl:call-template name="PopulateText">
									...
									<!-- Line 14b1 -->
									<div class="styGenericDiv" style="width:93mm;">
										<div class="styLNLeftNumBox" style="height:4mm;padding-top:0mm; padding-bottom:0mm;padding-left:5mm">b</div>
										<div class="styLNDesc" style="width:73mm;padding-top:0mm;padding-bottom:0mm;">
Was the annual statement used to prepare the tax return filed with the state of domicile?
									...
									<!-- Line 14b2 -->
									<div class="styGenericDiv" style="width:93mm;">
										<div class="styLNLeftNumBox" style="height:4mm;padding-top:0mm; padding-bottom:0mm;padding-left:5mm"/>
										<div class="styLNDesc" style="width:73mm;padding-top:0mm;padding-bottom:0mm;">
If "No," complete<b> c</b> below.
									...
									<!-- Line 14c -->
									<div class="styGenericDiv" style="width:93mm;">
										<div class="styLNLeftNumBox" style="height:6mm;padding-top:0mm; padding-bottom:0mm;padding-left:5mm">c</div>
										<div class="styLNDesc" style="width:73mm;padding-top:0mm;padding-bottom:0mm;">
...
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
								...
								<!-- Line 15 -->
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:12mm;padding-top:2mm;padding-bottom:0mm;">15</div>
									<div class="styLNDesc" style="height:12mm;width:73mm;padding-top:2mm;padding-bottom:0mm;">
...
Additional Data        
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							...
							<xsl:with-param name="TargetNode" select="  $Form1120LData/@section1291InterestAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Top Left Margin - Section 1294 Interest Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/@section1294InterestIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Form 1120, Top Left Margin - Section 1294 Interest Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/@section1294InterestAmount"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Top Left Margin - Section 501d Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/@section501dIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Top Left Margin - Subchapter T Cooperative Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/@subchapterTCoopIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							...
							<xsl:with-param name="TargetNode" select="  $Form1120LData/NetGainLoss/@form4684Indicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 30 - CCF Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncomeAmt/@cCFIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							...
							<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncomeAmt/@cCFAmount"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 32b - Beneficiary Of Trust Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt/@beneficiaryOfTrustIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 32b - Beneficiary Of Trust Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt/@beneficiaryOfTrustAmount"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 32b - Form 8816 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt/@f8816Indicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 32b - Form 8816 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt/@f8816Amount"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 32b - Section 847 Deduction Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPaymentsAmt/@section847DeductionIndicator"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 32f(1) - Backup Withholding Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalUndistributedLTCapGainAmt/@backupWithholdingTypeCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Line 32f(1) - Backup Withholding Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalUndistributedLTCapGainAmt/@backupWithholdingAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 32f(2) - Ozone Depleting Chemicals Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalFuelTaxCreditAmt/@ozoneDepletingChemicalsInd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">

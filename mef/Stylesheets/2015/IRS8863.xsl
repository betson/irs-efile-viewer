		...
		<!-- Page Header -->
				 <div style="width:187mm">	
					<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
						Form 8863 (2015)<span style="width:148mm;"/>						
							...
							<tbody>
								...
								<tr style="height:10mm" valign="top">
									<td class="styTableCell" style="font-size:7pt;width:92mm;border-color:black;text-align:left;">
										...
										<div class="styGenericDiv" style="width:63%;padding-left:0.5mm;">
											Did the student receive Form 1098-T from this institution for 2014 with Box
...
2015 at an eligible educational institution in a program leading towards a postsecondary degree, certificate, or other recognized postsecondary educational credential? (see instructions)
										</div>
									</td>
									<td class="styTableCell" style="font-size:7pt;width:50%;border-color:black;text-align:left;border-right-width:0px">
										<xsl:call-template name="PopulateSpan">
...
enter
					...
					<div style="width:187mm;padding-top:0mm;border-top-width:1px;">
						<div style="width:100%;text-align:right">
							Form <span class="styBoldText" style="font-size:8pt;">8863</span> (2015) 
						</div>
					</div>
					</div>
	</xsl:template>
				  ...
				  <div style="width:187mm">
					...
					<div class="styBB" style="width:187mm;height:23.5mm;">
						...
						<div class="styTYBox" style="width:31mm; height:100%">
							...
							<div class="styTaxYear" style="font-size:21pt;padding-top:1.5mm;padding-bottom:1.5mm;">20<span class="styTYColor" style="font-size:21pt">15</span>
							</div>
	...
	<!--						<span style="float:right;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="font-size:7pt;width:142mm;height:4mm;padding-top:0mm;">
							<b>Refundable American opportunity credit.</b> Multiply line 7 by 40% (.40). Enter the amount here and on

							...
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTablesCells" scope="col" style="width:35mm; padding-left:17.5mm; padding-top:0px; padding-bottom:0px; height:4mm;">
										<div class="styLNRightNumBoxNBB" style="width:8.25mm; background-color:lightgrey; border-color:black; border-right-width:1px;"/>
									</th>
								   <!--<xsl:choose>
									 <xsl:when test="count($Form8825Data/IdentifyPartnershipEstateTrGrp) &lt; 1 or ($Print = $Separated) ">
										<th class="styTablesCells" scope="col" style="width:35mm; padding-left:17.5mm; padding-top:0px;p adding-bottom:0px;">
											<div class="styLNRightNumBoxNBB" style="width:8.25mm; background-color:yellow; height:4.5mm; border-color:black; border-right-width:1px;"/>
										</th>
									 </xsl:when>
									 <xsl:otherwise>
							...
							<tbody>
								...
								<xsl:if test="($Print != $Separated) or (count($Form8825Data/IdentifyPartnershipEstateTrGrp) &lt;= 3) ">
									<xsl:for-each select="$Form8825Data/IdentifyPartnershipEstateTrGrp">
										<tr>
											<td class="styTablesCells" scope="row" style="width:69mm; height:12mm; border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
											...
											<td class="styTablesCells" scope="row"  style="width:35mm; padding-left:17.5mm; padding-top:0px; padding-bottom:0px;height:12mm; ">
												<div class="styLNRightNumBoxNBB" style="width:8.25mm; height:12mm; background-color:lightgrey; border-right-width:1px; padding-top:0px; padding-bottom:0px;">
												</div>
											</td>
										</tr>
									</xsl:for-each>

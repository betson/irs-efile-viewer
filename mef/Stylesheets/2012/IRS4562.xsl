...
<!-- end line 5B -->
 <!--   END LINE 5   -->
					...
					<div class="styIRS4562LineItem" style="vertical-align: top; margin: 0px; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-top-width: 0px; float:none; clear:both;">
						...
						<span class="styIRS4562LNDesc" style="width: 111.6mm">Listed property. Enter the amount from line 29.
    <b>
      ...
      <span class="styIRS4562NBSP"/>.
						...
						<span class="styLNRightNumBox" style="width:8mm">7</span>
           ...
           ....
			...
			<!--   END LINE 12   -->
					...
					<div class="styIRS4562LineItem">
						...
						<span class="styIRS4562LNDesc" style="width: 111mm">Carryover of disallowed deduction to 2013 Add lines 9 and 10, less line 12
    <b>
	<span class="styIRS4562NBSP"/>.
   </b>
...
<!--  END LINE 18  -->
  ...
  <xsl:call-template name="SetFormLinkInline">
          ...
          <span class="styIRS4562TableCellPad"/>
								...
								<tr>
									<td style="border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width:0px; font-weight: bold; text-align: center" colspan="7">Section C&#151;Assets Placed in Service During 2012 Tax Year Using the Alternative Depreciation System
          <xsl:call-template name="SetFormLinkInline">
...
here and on the appropriate lines of your return.  Partnerships and S corporations&#151;see instructions.
	...
	<!--   END LINE 22   -->
					...
					<div class="styIRS4562LineItem" style="float:none;clear:all;">
						...
						<span class="styIRS4562LNDesc" style="width: 112.6mm">For assets shown above and placed in service during the current year,
    ...
    <b>
      ...
      <span class="styIRS4562NBSP"/>.
						...
						<div class="styIRS4562LNAmountBox" style="border-top-width: 1px; border-bottom-width: 0px;height: 7.5mm;padding-top:3mm;width:29mm;font-size:6.3pt">
							<xsl:call-template name="PopulateAmount">
         ...
         Form <span class="styBoldText" style="font-size: 8pt">4562</span> (2012)
       </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styBB" style="width:187mm">
						<div style="float: left; clear: none">Form 4562 (2012)</div>
						<div style="float:right">
...
<div class="styLNDesc" style="width: 158mm; height: 4.5mm;">
							...
							<tbody>
								<tr>
									<td class="styIRS4562OtherCell" style="border-color: black; border-left-width: 0px; border-right-width:0px; border-top-width: 0px; border-bottom-width:1px; " colspan="6">
										...
										<span class="styLNDesc">&#160;Amortization of costs that begins during your 2012 tax year (see instructions):</span>
										<span class="styIRS4562TableCellPad"/>
									</td>
								</tr>
  ...
  <span style="float: left; clear: none;padding-left:1mm">Amortization of costs that began before your 2012 tax year</span>
  <span class="styDotLn" style="float:right;padding-right:2mm;">............</span>
</div>				
...
<!--						<span class="styIRS4562LNDesc" style="width: 130.2mm;">
  ...
  <b>
						...
						<div class="styLNDesc" style="width: 131mm; height: 4.5mm;">
  <span style="float: left; clear: none;padding-left:1mm"><b>Total. </b>Add amounts in column (f). See the instructions for where to report</span>
  <span class="styDotLn" style="float:right;padding-right:2mm;">.......</span>
</div>			
					...
					<div style="width:187mm;clear:both;">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">4562</span>(2012)</div>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>
          ...
          Additional Data        
					...
					<xsl:if test="(((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or 
                           ...
                           (count($IRS4562Data/GeneralDepreciationSystem/GDSNonResidentialRealProperty2) &gt; 1)) and $Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part III, Line 19, Section B&#151;Assets Placed in Service During 2012 Tax Year Using the General Depreciation System:</span>
          ...
          <span class="styIRS4562TableCellPad"/>
					...
					<xsl:if test="((count($IRS4562Data/AlternativeDepreciationSystem/ADSClassLifeProperty) &gt; 1) or 
                          ...
                          (count($IRS4562Data/AlternativeDepreciationSystem/ADS40YearProperty) &gt; 1)) and ($Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part III, Line 20a - c, Section C&#151;Assets Placed in Service During 2012 Tax Year Using the Alternative Depreciation System           
        <xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$IRS4562Data/AlternativeDepreciationSystem"/>
         ...
         Total business/investment miles driven<br/>
          ...
          <span style="width: 5mm"/>
            ...
            <span class="styIRS4562TableCellPad"/>
					...
					<xsl:if test="(count($IRS4562Data/AmortizationInfo/AmortizationInfoTable) &gt; 2) and ($Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part VI, Line 42, Amortization of costs that begins during your 2012 tax year (see instructions):</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">

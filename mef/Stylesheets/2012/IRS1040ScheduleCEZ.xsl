			...
			<body class="styBodyClass">
				<form name="Form2210">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styGenericDiv" style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;border-bottom:1px solid black;">
								Did you make any payments in 2012 that would require you to file Form(s) 1099 (see the Schedule C <br/>
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:1 solid black; padding-top:0.5mm">
						...
						<b style="font-size:7pt">Schedule C-EZ (Form 1040) 2012</b>
						</div>
					</div>
					<!--END Page Footer-->

				...
				<form name="IRS8814">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									Add lines 1a, 2a, and 3. If the total is $1,900 or less, skip lines 5 through 12 and go to line 13. If<br/>
									the total is $9,500 or more, <b>do not</b> file this form. Your child <b>must</b> file his or her own return to<br/>
									report the income
									<!--Dotted Line-->
									<span class="styBoldText">
						...
						<div class="styIRS8814LineItem">
							...
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="StaticText">1,900.00</xsl:with-param>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem">
							...
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="StaticText">950.00</xsl:with-param>
								<xsl:with-param name="AmountBoxStyle">text-align:right;</xsl:with-param>
						...
						<div class="styIRS8814LineItem">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									<b>Tax.</b> Is the amount on line 14 less than $950?<br/>
									<div class="styIRS8814LNDesc" style="width:auto;height:auto;padding:0px 0px 0px 0px;">
										...
										<label>
											...
											<span class="styBoldText">No.</span> Enter $95 here and see the <b>Note</b> below.
										</label>
										<br/>
										<span>
											<xsl:call-template name="PopulateSpan">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form<span class="styBoldText" style="font-size:7pt;"> 8814 </span>(2012)
						</div>

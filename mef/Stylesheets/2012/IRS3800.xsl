        ...
        <form name="Form3800" style="font-size:7pt;">
          ...
          <div class="styTBB" style="width:187mm;height:21mm;">
            ...
            <div class="styTYBox" style="width:30mm;height:21mm;">
              ...
              <div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">12</span>
              </div>
	...
	<xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param>
         ...
         <xsl:call-template name="PartIIITemplate"/>        
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNAmountBox" style="width:28mm;">
               ...
               <div class="styLNRightNumBox" style="height:4.5mm;border-right-width:1px;border-bottom-width:0px;width:8.18mm;background-color:lightgrey;"></div> 
            </div>
            <!-- Part I, Line 3-->
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:139mm;">
                <span style="float:left;">Enter the applicable passive activity credits allowed for 2012 (see instructions) </span>
                <!--Dotted Line-->
                <div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
              </div>
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:139mm;">
                <span style="float:left;">Carryforward of general business credit to 2012. Enter the amount from line 2 of Part III with box C</span>
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:139mm;">
                ...
                <span style="float:left;">Carryback of general business credit from 2013. Enter the amount from line 2 of Part III with box D</span>
          ...
          <div style="width:187mm">
            ...
            <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0px;background-color:lightgrey;padding-top:5mm;width:8mm"/>
            ...
            <div class="styLNRightNumBox" style="height:5mm;border-bottom-width:0px;background-color:lightgrey;padding-top:5mm;width:8.03mm"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNAmountBox" >
              <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form3800Data/CertainAllwblCreditsAmt" />      
          </xsl:call-template>
            </div>
...
<!--<div class="styLNRightNumBoxNBB" style="padding-top:3mm;background-color:lightgrey;"/>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="padding-left:4.5mm">b</div>
            <div class="styLNDesc" style="width:139mm;">
              For a corporation electing to accelerate the research credit, enter the bonus depreciation 
                                     <span style="float:left;"> amount attributable to the research credit (see instructions)</span>
              <div class="styDotLn" style="float:right;padding-right:1mm;">..............</div>
            </div>
            <div class="styLNRightNumBox"  style="height:8mm;padding-top:4mm;">16b</div>
       ...
       <!-- Part II, Line 17 -->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146.9mm;height:4.55mm;">
            <div class="styLNLeftNumBox" style="padding-left:4.5mm;">b</div>
             Enter the smaller of line 6 or line 16a. If you made an entry on line 16b, go to line 17c; otherwise, 
                        <span style="float:left;padding-left:1mm;">skip line 17c (see instructions)
                        <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Section 41(G) Indicator Code</xsl:with-param>
            ...
            <div class="styLNRightNumBox" style="height:8mm;width:8.05mm;padding-top:4.5mm;">17b</div>
           ...
           <div class="styBB" style="width:187mm;">
            <div class="styLNLeftNumBox" style="padding-left:4.5mm">c</div>
            <div class="styLNDesc" style="width:139mm;">
              Subtract line 17b from line 17a. This is the refundable amount for a corporation electing to
              accelerate the research credit. Include this amount on Form 1120, Schedule J, Part II, line 19c
              <span style="float:left;">(or the applicable line of your return)
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Section 41(G) Indicator Code</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$Form3800Data/RefundableAmtForACorporation/@sec383Or384Indicator"/>
                </xsl:call-template>
              </span>
              <div class="styDotLn" style="float:right;padding-right:1mm;">......................</div>
            </div>
            ...
            <div class="styLNRightNumBoxNBB"  style="height:3.5mm;padding-top:0mm;">17c</div>
            <div class="styLNAmountBoxNBB" style="height:3.5mm;padding-top:0mm;">
             <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;clear:both;padding-top:1mm;" class="pageend">
            ...
            <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3800</span> (2012)</div>
          </div>
          <!-- Page 3 Header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 3800 (2012)</div>
  ...
  <!-- Part II, Line 23 -->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:139mm;">
              <span style="float:left;">Enter the applicable passive activity credit allowed for 2012 (see instructions)</span>
              <div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
            </div>
        ...
        <!-- Part II, Line 34 -->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:139mm;">
              Carryforward of business credit to 2012. Enter the amount from line 5 of Part III with box C checked 
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:139mm;">
              Carryback of business credit from 2013. Enter the amount from line 5 of Part III with box D checked 
              <span style="float:left;">and line 6 of Part III with box H checked (see instructions)
              <!--  --><!-- Push Pin image --><!--
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$Form3800Data/AllwGenAndEligSmllBusCybkCrAmt"/>
                </xsl:call-template>-->
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styLNRightNumBox" style="border-bottom-width:0px;background-color:lightgrey;width:8.03mm"/>
            <div class="styLNAmountBox" style="border-left-width:0px;border-bottom-width:0px;border-left-width:1px;"/>
            <div class="styLNRightNumBox" style="width:8.03mm" >38</div>
            <div class="styLNAmountBox">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$Form3800Data/CurrentYearCreditAllowed"/>
              </xsl:call-template>
          ...
          <div style="width:187mm;clear:both;padding-bottom:0mm;" class="styBB">
            <div style="width:90mm;padding-top:2mm;" class="styGenericDiv">Form 3800 (2012)</div>
            <div style="width:55mm;text-align:center;" class="styGenericDiv"/>
           ...
           <xsl:choose>
            ...
            <xsl:variable name="ESmllBusCrCarFwdGrp" select="count($Form3800Data/GenBusCrOrEligSmllBusCrGrp/EligSmllBusCrCarryforwardsGrp)*8"/>   
  ...
  <xsl:template name="PartIIITemplate">
	...
	<xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param>
            ...
            <div class="styEINBox" style="width:52mm;padding-left:0mm;font-size:6pt;border-left-width:1px;">Identifying number
                  <br/>
                      ...
                      <div class="styDotLn" style="float:right;padding-right:1mm;">..........</div>
						...
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
                             <span style="float:left">  Disabled access (Form 8826) (do not enter more than $5,000 in column (c) of</span>
                              <span style="float:left">  Parts III with box A, B, E, or F checked, combined)
                              <!-- Push Pin image -->
								 <span style="float:none;">
							     <xsl:call-template name="SetFormLinkInline">
	...
	<!-- Schedule C Line1j-->
		<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
              <span style="float:left">  Small employer pension plan startup costs (Form 8881) (do not enter more than $500 in column (c) of Parts III with box A, B, E, or F checked,
                 combined)
                      <!--Dotted Line -->
			...
			<!-- Schedule C Line 1k-->
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:4mm;width:107mm;"> 
            <span style="float:left">Employer-provided child care facilities and services (Form 8882) 
            (do not enter  </span>
            <span style="float:left">more than $150,000 in column (c) of Parts III with box A, B, E, or F checked, </span>
            <span style="float:left">combined)
                  	<!-- Push Pin image -->
                      ...
                      <div class="styDotLn" style="float:right;padding-right:1mm;">....................</div>
						...
						<div style="float:right;clear:none;">
							<div class="styLNRightNumBox" style="border-top:1px solid black;border-bottom-width:0px;height:12mm;padding-top:7mm;">1k</div>
							<div class="styLNAmountBox" style="border-bottom-width:0px;border-top:1px solid black;text-align:center;height:12mm;padding-top:7mm;">
							...
							<div class="styLNAmountBox" style="border-bottom-width:0px;border-top:1px solid black;height:12mm;padding-top:7mm;">
				...
				<!-- Schedule C Line 1v-->
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
            <span style="float:left">Agricultural chemicals security (Form 8931) (do not enter more than $2 million</span>
         <span style="float:left"> in column (c) of Parts III with box A, B, E, or F checked, combined)
                      <!--Dotted Line -->
                      	<!-- Push Pin image -->
             ...
             <span style="float:left">Qualified plug-in electric drive motor vehicle (Form 8936) 
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:4mm;width:107mm;"> 
              <span style="float:left">Qualified plug-in electric vehicle (Form 8834, Part I only) 
                  <!-- Push Pin image -->
             ...
             <span style="float:left">New hire retention (Form 5884-B) 
                <!-- Push Pin image -->
                                <xsl:call-template name="SetFormLinkInline">
              ...
              <span style="float:left">Add lines 1a through 1zz and enter here </span>   
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="width:107mm;">
         <span style="float:left">Enter the amount from Form 8844
          <!-- Push Pin image -->
				...
				<!-- Schedule C Line4c-->
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">c</div>
							<div class="styLNDesc" style="height:4mm;width:107mm;"> 
             <span style="float:left">Alcohol and cellulosic biofuel fuels (Form 6478) 
                <!-- Push Pin image -->
...
<b>Note:</b> On any line where the credit is from more than one source and one of the sources is a pass-through entity.
                  ...
                  <span style="float:none;">
                      ...
                      <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
						...
						<div style="float:left;clear:none:">
							<div class="styLNLeftNumBox" style="height:8mm;padding-left:4mm;">e</div>
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
                Disabled access (Form 8826) (do not enter more than $5,000 in column (c) of<span style="float:left"> Parts III with box A, B, E, or F checked, combined)</span>
                              <!-- Push Pin image -->
								 <span style="float:none;">
							    </span>
                      <!--Dotted Line -->
	...
	<!-- Schedule C Line1j-->
		<div style="width:187mm;">
						<div style="float:left;clear:none:">
							<div class="styLNLeftNumBox" style="height:8mm;padding-left:4mm;">j</div>
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
                Small employer pension plan startup costs (Form 8881) (do not enter more <span style="float:left;">than $500 in column (c) of Parts III with box A, B, E, or F checked,
                 combined)</span>
                      <!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
										<!-- Push Pin image -->
            ...
            (do not enter  </span>
            <span style="float:left">more than $150,000 in column (c) of Parts III with box A, B, E, or F checked, </span>
            <span style="float:left">combined)</span>
                      ...
                      <span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						...
						<div style="float:right;clear:none;">
							<div class="styLNRightNumBox" style="height:12mm;border-top:1px solid black;border-bottom-width:0px;">1k</div>
							<div class="styLNAmountBox" style="height:12mm;border-bottom-width:0px;border-top:1px solid black;text-align:center;">
							</div>
							<div class="styLNAmountBox" style="height:12mm;border-bottom-width:0px;border-top:1px solid black;">
								</div>
						</div>
					</div>		
															<!-- Schedule C Line 1l-->
				...
				<!-- Schedule C Line 1v-->
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							<div class="styLNLeftNumBox" style="height:8mm;padding-left:4mm;">v</div>
							<div class="styLNDesc" style="height:8mm;width:107mm;padding-top:1mm;"> 
              Agricultural chemicals security (Form 8931) (do not enter more than $2 million <span style="float:left;">in column (c) of Parts III with box A, B, E, or F checked, combined)</span>
                      <!--Dotted Line -->
				...
				<!-- Schedule C Line4c-->
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">c</div>
							<div class="styLNDesc" style="height:4mm;width:107mm;"> 
                <span style="float:left;">Alcohol and cellulosic biofuel fuels (Form 6478) </span>

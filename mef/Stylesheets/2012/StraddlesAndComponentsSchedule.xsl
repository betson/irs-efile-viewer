...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Template to display Itemized Other Income Schedule -->
    ...
    <table id="SACSTbl" class="styDepTbl" style="font-size:8pt;">
      ...
      <tfoot></tfoot>
      <tbody>
      <xsl:for-each select="$DependencyData/StraddleAndComponentInfo">
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:left">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="TypeOfStraddle" />
              </xsl:call-template>
            </td>
            <td class="styDepTblCell" style="text-align:left">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="Component" />
              </xsl:call-template>
            </td>

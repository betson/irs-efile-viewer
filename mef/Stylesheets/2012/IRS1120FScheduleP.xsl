...
<xsl:with-param name="TargetNode" select="$FormData"/>
			...
			See separate instructions.
                ...
                <tr>
                  <td class="sty1120FSchPTY">20<span class="styTYColor">12</span>
                  </td>
                </tr>
              </tbody>
            </table>
   ...
   <br/>
          ...
          <div style="width:187mm;padding-top:1mm">
            <div style="float:left;">
              ...
              <span style="font-weight:bold; font-size:6pt">Schedule P (Form 1120-F) 2012</span>
          ...
          <!-- page break and footer-->
                      <div>
             <span class="styBoldText">Schedule P (Form 1120-F) 2012</span>

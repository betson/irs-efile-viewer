...
<!-- Last Modified by Eugenia McDonald on 11/16/2012 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="RowWriterCore">
		<tr>
			...
			<td height="10px;" style="height:4.5mm;font-size:7pt;text-align:left;width:172mm;" 
			  class="styIRS1065ScheduleK1BBtable">
				<span style="width:1px;"/>
			</td>
		</tr>
	</xsl:template>
	...
	<xsl:template name="DisplayPart3CodeAmountLine">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<span class="IRS1065ScheduleK1_amountCell" style="text-align:left;padding-left:1px;
	...
	<xsl:template name="DisplayPart3CodeAmountAddlDataLine">
		...
		<xsl:choose>
			...
			<xsl:when test="($Print != $Separated) or (count($TargetNode) &lt;= $NumOfTotalRows) ">
				<xsl:for-each select="$TargetNode">
					<tr>
						<td style="font-size:7pt;font-family:Verdana;width:6mm;height:8mm;vertical-align:bottom;
						  padding-bottom:2px;border-right:1px solid black;border-bottom:1px solid lightgrey;
						...
						<td style="vertical-align:bottom;font-size:7pt;font-family:Verdana;float:right;width:41.5mm;
						  border-bottom:1px solid lightgrey;text-align:right;height:8mm;padding-bottom:2px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="Amount"/>
							</xsl:call-template>
						</td>
			...
			<xsl:otherwise>
				<tr>
					<td style="width:4.9mm;height:8mm;font-size:7pt;font-family:Verdana;border-right:1px solid black;
					  border-bottom:1px solid lightgrey;text-align:center;border-left:0px;padding-top:4mm;">
						<span class="styTableCellPad"/>
					</td>
					<td colspan="2" style="float:right;font-size:7pt;width:41.5mm;border-bottom:1px solid lightgrey;
					  padding-top:4mm;text-align:left;padding-left:1px;">
						<xsl:call-template name="PopulateAdditionalDataTableMessage">
							<xsl:with-param name="TargetNode" select="$TargetNode"/>
						</xsl:call-template>
					</td>
		...
		<html>
			...
			<body class="styBodyClass">
				...
				<!--
                    ...
                    +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                -->
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; 
				  font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right;
							  width: 186mm;">651112</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="width: 186mm;">
								<span style="float: right; margin-bottom: 0.5mm;">
									<input type="checkbox" class="styCkbox" name="checkbox" id="dummyID1" 
									...
									<input type="checkbox" class="styCkbox" name="checkbox" id="dummyID2" 
									  onclick="return false;">
										<xsl:call-template name="PopulateCheckbox">
					...
					<tr>
						<td style="width: 93mm;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="width: 93mm;">
										<div style="width: 93mm;">
											...
											<span class="styFormNumber" style="font-size: 10pt;padding-top:2mm; float: left;
											  clear: none;">Schedule K-1<br/>(Form 1065)
											    <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2012, or tax
											<br/>year beginning
								...
								<tr>
									<td>
										...
										<span style="float: right; clear: none; font-weight: bold; font-size: 7pt; padding-right: 1mm;
										  padding-top: 0.5mm;">
											<img src="{$ImagePath}/1065SchK1_Bullet.gif" width="4" height="7"
											 alt="Right arrow image" border="0"/> See back of form and separate instructions.
											 </span>
									</td>
								</tr>
								<tr>
									<td style="border-left: 2px solid black; border-top: 2px solid black; height: 5mm;
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 8mm;">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											  select="$FormData/IRSServiceCenterWhereFiled"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 7.5mm;">
										...
										<span style="width: 80mm;">
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" 
													  select="$FormData/PubliclyTradedPartnership"/>
												</xsl:call-template>
											</input>
											<label>
												<xsl:call-template name="PopulateLabel">
								...
								<tr>
									<td style="border-left: 2px solid black; border-top: 1px solid black; 
									  height: 5mm; background-color: lightgrey;">
										<!-- Part II header -->
										...
										<div style="float:left;clear:none;">
											...
											<span style="width: 40mm;height:8mm;">
												<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode"
														  select="$FormData/GenPartnerOrLLCMemManager"/>
													</xsl:call-template>
												</input>
												<label>
													<xsl:call-template name="PopulateLabel">
										...
										<div style="float:right;clear:all;">
											<span style="width: 50mm;height:8mm;">
												<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode"
														  select="$FormData/LimitedPartnerOrOtherLLCMember"/>
													</xsl:call-template>
												</input>
												<label>
													<xsl:call-template name="PopulateLabel">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 4mm;border-top-width:0;">
										<!-- PART II Line H-->
										<xsl:choose>
											<xsl:when test="$FormData/DomesticPartner">
												<div style="float:left;clear:none;">
													...
													<span style="width: 40mm;height:4mm;">
														<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode"
																  select="$FormData/DomesticPartner"/>
															</xsl:call-template>
														</input>
														<label>
															<xsl:call-template name="PopulateLabel">
													...
													<span style="width: 50mm;height:4mm;">
														<input type="checkbox" alt="alt" class="styckbox" name="checkbox"
														 id="dummyidforeign">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" 
																  select="$FormData/ForeignPartner"/>
															</xsl:call-template>
														</input>
											...
											<xsl:when test="$FormData/ForeignPartner">
												<div style="float:left;clear:none;">
													<span style="font-weight: bold; width: 2mm;height:4mm;">H</span>
													<span style="width: 3mm;"/>
													<span style="width: 40mm;height:4mm;">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<span style="width: 2mm;"/>What type of entity is this partner (see instructions)?
										<span style="width: 13mm; border-bottom: 1px solid black; text-align: left; ">
											<xsl:call-template name="PopulateText">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												<xsl:with-param name="TargetNode" 
												  select="$FormData/IsPartnerARetirementPlan"/>
												<xsl:with-param name="BackupName">
												  IRS1065ScheduleK1IsPartnerARetirementPlan</xsl:with-param>
											</xsl:call-template>
											If this partner is a retirement plan (IRA/SEP/Keogh/etc.),
                                            <br/><span style="width: 5mm;"/>check here (see instructions)
                                        </label>
										<span style="width: 2mm;"/>
										<span style=" letter-spacing:3.2mm; font-weight:bold; ">.........
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" 
													  select="$FormData/IsPartnerARetirementPlan"/>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 23mm;border-top-width:0;">
										...
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode"
											  select="$FormData/PartnersShareProfitLossCapital"/>
										</xsl:call-template>
										<br/>
										<br/>
										<table style="font-size:7pt;margin-left:5.3mm;" cellpadding="0" cellspacing="0">
											<tbody>
												...
												<tr>
													<td width="3" style="width:2mm;border:1px black solid;border-top:0px;
													  border-left:0;border-right:0;">Profit</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;font-size:6pt"
													  align="right">
												...
												select="$FormData/PartnersShareProfitLossCapital/PartnersShareOfProfitBOY"/>
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 17.5mm;border-top-width:0;">
										...
										<span style="width: 4mm;"/>Partner’s share of liabilities at year end:
										    <xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode"
												  select="$FormData/PartnersShareOfLiabilityEOY"/>
										</xsl:call-template>
										<br/>
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; text-align: right;
														  font-size:7pt;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" 
												select="$FormData/PartnersShareOfLiabilityEOY/PrtnrShareOfLiabNonRcrsEOY"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; text-align: right;
														  font-size:7pt;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode"
											select="$FormData/PartnersShareOfLiabilityEOY/PrtnrShareOfLiabQlfyNonRcrsEOY"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black;
														  text-align:right;font-size:7pt; ">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode"
												select="$FormData/PartnersShareOfLiabilityEOY/PartnersShareOfLiabRcrsEOY"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 50.4mm;
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; text-align: right;
														  font-size:7pt; ">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode"
																 select="$FormData/PartnersCapitalAcct/PrtnrBeginningCapitalAcct"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; 
														  text-align: right; font-size:7pt;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" 
																select="$FormData/PartnersCapitalAcct/PrtnrCapContributedDuringYr"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; text-align: right;
														  font-size:7pt; ">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" 
																select="$FormData/PartnersCapitalAcct/PrtnrCurrentYrIncrDecr"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
                              ...
                              <xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" 
															select="$FormData/PartnersCapitalAcct/PrtnrWithdrawAndDistribution"/>
															</xsl:call-template>
                              )
                            </span>
													</td>
                          ...
                          <span style="width:8px;"/>.
													...
													<td>
														...
														<span style="width: 33mm; border-bottom: 1px solid black; text-align: right;
														  font-size:7pt;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" 
																select="$FormData/PartnersCapitalAcct/PrtnrEndingCapitalAccount"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
										...
										<input type="checkbox" alt="alt" class="styCkbox" name="checkbox" id="dummyID1"
										  onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode"
												  select="$FormData/PartnersCapitalAcct/TaxBasis"/>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox" alt="alt" class="styCkbox" name="checkbox" id="dummyID1"
										  onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" 
												  select="$FormData/PartnersCapitalAcct/GAAP"/>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox" alt="alt" class="styCkbox" name="checkbox" id="dummyID1"
										  onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" 
												  select="$FormData/PartnersCapitalAcct/Section704bBook"/>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox" alt="alt" class="styCkbox" name="checkbox" id="dummyID1"
										  onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode"
												  select="$FormData/PartnersCapitalAcct/OtherExplain"/>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox" class="styCkbox">
										   <xsl:call-template name="PopulateYesCheckbox">
										      <xsl:with-param name="TargetNode"
										        select="$FormData/PropContriWithBuiltInGainLoss"/>
									             <xsl:with-param name="BackupName">
										...
										<br/>
										<span style="width:10mm"/>If "Yes", attach statement (see instructions)
								             <span style="width:1mm;"/>
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode"
											  select="$FormData/PropContriWithBuiltInGainLoss"/>
						...
						<td width="93mm" style="width: 93mm;" valign="top">
							<table width="93mm" border="0" cellpadding="0" cellspacing="0" 
							  style="border-top: 2px solid black; border-bottom: 0px; border-left: 1px solid black;
							  border-right: 2px solid black;">
								...
								<tr>
									<td valign="top" style="border-right:1px solid black;">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:if test="count($FormData/OrdinaryIncomeLoss) = 0 ">
													  <tr>
													...
													<xsl:for-each select="$FormData/OrdinaryIncomeLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/OrdinaryIncomeLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/OrdinaryIncomeLoss"/>
																</xsl:call-template>
															  </span>
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/NetIncomeLossRealEstateAmount) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/NetIncomeLossRealEstateAmount">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/NetIncomeLossRealEstateAmount) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/NetIncomeLossRealEstateAmount"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/OtherNetRentalIncomeLoss) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/OtherNetRentalIncomeLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/OtherNetRentalIncomeLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/OtherNetRentalIncomeLoss"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/GuaranteedPayments) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.63mm;
														  float:left;border-top:0px solid;width:41.40mm;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
													  </tr>
													</xsl:if>
													<xsl:for-each select="$FormData/GuaranteedPayments">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/GuaranteedPayments) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.63mm;
															  ...
															  <span style="float:right;">
																 <xsl:call-template name="PopulateAmount">
																   <xsl:with-param name="TargetNode" 
																	 select="$FormData/GuaranteedPayments"/>
																 </xsl:call-template>
															  </span>
															</td>
														  </tr>
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/InterestIncome) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/InterestIncome">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/InterestIncome) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																    select="$FormData/InterestIncome"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
															  	<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/OrdinaryDividends) = 0 ">
													  <tr>
													...
													<xsl:for-each select="$FormData/OrdinaryDividends">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/OrdinaryDividends) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.6mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																    <xsl:with-param name="TargetNode" 
																	  select="$FormData/OrdinaryDividends"/>
																  </xsl:call-template>
															    </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/QualifiedDividends) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/QualifiedDividends">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/QualifiedDividends) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.6mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																    <xsl:with-param name="TargetNode" 
																	  select="$FormData/QualifiedDividends"/>
																  </xsl:call-template>
															    </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/Royalties) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/Royalties">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/Royalties) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/NetSTCapitalGainLoss) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/NetSTCapitalGainLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/NetSTCapitalGainLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.6mm;
															  ...
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/NetSTCapitalGainLoss"/>
																</xsl:call-template>
															  </span>
															</td>
														  </tr>
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/NetLTCapitalGainLoss) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:6.38mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:6.38mm;
														  float:left;border-top:0px solid;width:41.40mm;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
													  </tr>
													</xsl:if>
													<xsl:for-each select="$FormData/NetLTCapitalGainLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/NetLTCapitalGainLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:6.38mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:6.38mm;
															  ...
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/NetLTCapitalGainLoss"/>
																</xsl:call-template>
															  </span>
															</td>
														  </tr>
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/CollectiblesGainLoss) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/CollectiblesGainLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/CollectiblesGainLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/CollectiblesGainLoss"/>
																</xsl:call-template>
															  </span>
															</td>
														  </tr>
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/UnrecapturedSection1250Gain) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/UnrecapturedSection1250Gain">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/UnrecapturedSection1250Gain) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/UnrecapturedSection1250Gain"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/NetSect1231GainLoss) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/NetSect1231GainLoss">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/NetSect1231GainLoss) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/NetSect1231GainLoss"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/OtherIncomeLoss/Item">
													  <xsl:if test="($Print != $Separated) or 
													                      (count($FormData/OtherIncomeLoss/Item) &lt;=3)">
													    <xsl:choose>
															...
															<tr>
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
																...
																<span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																	<xsl:with-param name="TargetNode" 
																    	select="$FormData/OtherIncomeLoss"/>
																  </xsl:call-template>
																</span>
																<span style="float:right;">
																  <xsl:call-template name="PopulateAmount">
													...
													<xsl:if test="((count($FormData/OtherIncomeLoss/Item) &gt;3)  and  
													  ($Print = $Separated))">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/OtherIncomeLoss/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:8mm;
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/Section179ExpenseDeduction">
														<xsl:if test="($Print != $Separated) or 
														  (count($FormData/Section179ExpenseDeduction) =1)">
														  <tr>
															<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  float:left;border-top:0px solid;font-size:7pt;" valign="bottom">
															  <xsl:call-template name="PopulateText">
															...
															<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															  ...
															  <span style="float:left;padding-left:2px;">
																<xsl:call-template name="SetFormLinkInline">
																  <xsl:with-param name="TargetNode" 
																	select="$FormData/Section179ExpenseDeduction"/>
																</xsl:call-template>
															  </span>
															  <span style="float:right;">
																<xsl:call-template name="PopulateAmount">
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/OtherDeductions/Item">
													  <xsl:if test="($Print != $Separated) or 
													                      (count($FormData/OtherDeductions/Item) &lt;=3)">
														<xsl:choose>
														  <xsl:when test="position() = 1">
															<tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
																...
																<span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																	<xsl:with-param name="TargetNode" 
																    	select="$FormData/OtherDeductions"/>
																  </xsl:call-template>
																</span>
																<span style="float:right;">
																  <xsl:call-template name="PopulateAmount">
														  ...
														  <xsl:otherwise>
															<tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:7.795mm;
															    float:left;border-top:1px solid black;font-size:7pt;"
															    valign="bottom">
																<xsl:call-template name="PopulateText">
																  <xsl:with-param name="TargetNode" select="Code"/>
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:7.795mm;
															    float:left;border-top:1px solid black;width:41.40mm;
													...
													<!-- See Additional Table message for > 3 rows -->
													<xsl:if test="((count($FormData/OtherDeductions/Item) &gt;3)  and  
													                    ($Print = $Separated))">
													  <tr>
													    <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid black;font-size:7pt;">
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/OtherDeductions/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:7.8mm;
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/SelfEmploymentEarningsLoss/Item">
													  <xsl:if test="($Print != $Separated) or 
													                      (count($FormData/SelfEmploymentEarningsLoss/Item) &lt;=2)">
													    <xsl:choose>
														  <xsl:when test="position() = 1">
															<tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:4.35mm;
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:4.35mm;
															    float:left;border-top:0px solid;width:41.40mm;
															    font-size:7pt;" valign="bottom">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" select="Amount"/>
																</xsl:call-template>
														  ...
														  <xsl:otherwise>
														    <tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:7.7mm;
															    float:left;border-top:1px solid black;font-size:7pt;" 
															    valign="bottom">
																<xsl:call-template name="PopulateText">
																  <xsl:with-param name="TargetNode" select="Code"/>
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:7.7mm;
															    float:left;border-top:1px solid black;width:41.40mm;
															    font-size:7pt;" valign="bottom">
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" select="Amount"/>
													...
													<xsl:if test="(($Print = $Separated)  and
													  ...
													  <tr>
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/SelfEmploymentEarningsLoss/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:7.5mm;
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:if test="count($FormData/CreditsAndCreditRecapture/Item) = 0 ">
													  ...
													  <!-- Add 1 blank row -->
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:7.81m;float:left;
													...
													<xsl:for-each select="$FormData/CreditsAndCreditRecapture/Item">
													  <xsl:if test="($Print != $Separated) or 
												                (count($FormData/CreditsAndCreditRecapture/Item) &lt;=2)">
													    <xsl:choose>
														  <xsl:when test="position() = 1">
														    <tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:4.6mm;
															    ...
															    <span style="float:left;padding-left:2px;">
															      <xsl:call-template name="SetFormLinkInline">
																    <xsl:with-param name="TargetNode" 
																      select="$FormData/CreditsAndCreditRecapture"/>
																  </xsl:call-template>
															    </span>
															    <span style="float:right;">
																  <xsl:call-template name="PopulateAmount">
													...
													<xsl:if test="count($FormData/CreditsAndCreditRecapture/Item) = 1">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:7.81mm;float:left;
														  border-top:1px solid black;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:7.81mm;
													...
													<xsl:if test="(($Print = $Separated)  and  
													  ...
													  <tr>
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.48mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/CreditsAndCreditRecapture/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:7.81mm;
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/ForeignTransactions">
													  <xsl:if test="($Print != $Separated) or 
												                (count($FormData/ForeignTransactions) &lt;=6)">
														    ...
														    <xsl:when test="position() = 1">
															  <tr>
																<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
																  ...
																  <xsl:call-template name="PopulateText">
																    <xsl:with-param name="TargetNode" 
																      select="CountryOrPossessionCode"/>
																  </xsl:call-template>
																</td>
																<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
																  float:left;border-top:0px solid;width:41.40mm;font-size:7pt;"
																  ...
																  <span style="float:left;padding-left:2px;">
																    ...
																    <xsl:call-template name="SetFormLinkInline">
																	  <xsl:with-param name="TargetNode" 
																	    select="$FormData/ForeignTransactions"/>
																    </xsl:call-template>
																  </span>
																  <span style="padding-right:15mm;">
																	<xsl:call-template name="PopulateText">
																	  <xsl:with-param name="TargetNode" 
																	    select="CountryOrPossessionName"/>
																	</xsl:call-template>
																  </span>
																</td>
															  </tr>
													...
													<xsl:if test="count($FormData/ForeignTransactions) = 1">
													  ...
													  <!--<tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:8mm;float:left;
														  border-top:1px solid black;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:8mm;
													...
													<xsl:if test="((count($FormData/ForeignTransactions) &gt;7)  and  
													  ($Print = $Separated))">
													   <tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														    float:left;border-top:0px solid;font-size:7pt;"
												 ...
												 <table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/AMTItems/Item">
													  <xsl:if test="($Print != $Separated) or 
													                      (count($FormData/AMTItems/Item) &lt;=3)">
													    <xsl:choose>
														  <xsl:when test="position() = 1">
															<tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:4.2mm;
													...
													<!-- See Additional Table message for > 3 rows -->
													<xsl:if test="((count($FormData/AMTItems/Item) &gt;3)  and  
													                    ($Print = $Separated))">
													  <tr>
													    <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid black;font-size:7pt;">
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:for-each select="$FormData/TaxExemptIncomeNonDedExpenses/Item">
													  <xsl:if test="($Print != $Separated) or 
													         (count($FormData/TaxExemptIncomeNonDedExpenses/Item) &lt;=3)">
													    <xsl:choose>
														  <xsl:when test="position() = 1">
															<tr>
															  <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
															    ...
															    <span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																	<xsl:with-param name="TargetNode" 
																	select="$FormData/TaxExemptIncomeNonDedExpenses"/>
																  </xsl:call-template>
																</span>
																<xsl:call-template name="PopulateAmount">
																  <xsl:with-param name="TargetNode" select="Amount"/>
													...
													<xsl:if test="(($Print = $Separated) and 
													  ...
													  <tr>
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/TaxExemptIncomeNonDedExpenses/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:8mm;
											  ...
											  <td colspan="3" class="IRS1065ScheduleK1_tdRight" 
												...
												<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<!-- Display a blank line if there are no data elements -->
													<xsl:if test="count($FormData/Distributions/Item) = 0 ">
													  <tr>
													    <td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  float:left;border-top:0px solid;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
													...
													<xsl:for-each select="$FormData/Distributions/Item">
													  <xsl:if test="($Print != $Separated) or 
													    (count($FormData/Distributions/Item) &lt;=2)">
															  ...
															  <tr>
																...
																<td class="IRS1065ScheduleK1_amountBox" 
																  ...
																  <span style="float:left;padding-left:2px;">
  																	<xsl:call-template name="SetFormLinkInline">
																	  <xsl:with-param name="TargetNode" 
																	    select="$FormData/Distributions/Item"/>
																    </xsl:call-template>
																    <span style="width:1mm"/>
																    <xsl:call-template name="SetFormLinkInline">
																	  <xsl:with-param name="TargetNode" 
																	    select="$FormData/Distributions"/>
																    </xsl:call-template>
																  </span>
																  <span style="float:right;">
																	<xsl:call-template name="PopulateAmount">
											    ...
											    <table cellpadding="0" cellspacing="0" style="width:46.5mm;">
												  <tbody>
													...
													<xsl:if test="count($FormData/OtherInformation/Item) = 0 ">
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:8.6mm;float:left;
													  ...
													  <tr>
														<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;float:left;
														  border-top:1px solid black;font-size:7pt;">
														  <span style="vertical-align:baseline;height:100%;"/>
														</td>
														<td class="IRS1065ScheduleK1_amountBox" style="height:7.6mm;
													...
													<xsl:for-each select="$FormData/OtherInformation/Item">
													  <xsl:if test="($Print != $Separated) or 
													      (count($FormData/OtherInformation/Item) &lt;=4)">
													    <xsl:choose>
														  <xsl:when test="position() = 1">
														    <tr>
															  ...
															  <td class="IRS1065ScheduleK1_amountBox" style="height:8.6mm;
																...
																<span style="float:left;padding-left:2px;">
																  <xsl:call-template name="SetFormLinkInline">
																	<xsl:with-param name="TargetNode" 
																      select="$FormData/OtherInformation"/>
																  </xsl:call-template>
																  <span style="width:1mm;"/>
																</span>
																<span style="float:right;">
													...
													<xsl:if test="(($Print = $Separated) and 
													  ...
													  <tr>
														...
														<td class="IRS1065ScheduleK1_amountBox" style="height:9.5mm;
														  ...
														  <xsl:call-template name="PopulateAdditionalDataTableMessage">
													        <xsl:with-param name="TargetNode"
													          select="$FormData/OtherInformation/Item"/>
												          </xsl:call-template>
														</td>
														<tr>
														  <td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;
								      ...
								      <tr>
									    <td colspan="2" style="font-family: Verdana; font-size: 7pt;text-align: left; 
									      border-top: 2px solid black; border-bottom:2px solid black;">
                                          * See attached statement for additional information.
                                        </td>
								      </tr>
								    <tr>
									  <td colspan="2" style="height:100%;height:62.95mm;border-bottom:1px solid black;">
										<!-- IRS Use Only box -->
										<span style="vertical-align:baseline;height:85%;"/>
										<img src="{$ImagePath}/1065SchK1_For_IRS_Use_Only.gif" width="24" height="112" 
									      alt="For IRS Use Only"/>
									  </td>
								    </tr>
							</table>
					...
					<tr>
					  <td width="187mm" colspan="2" style="width: 187mm; font-family: Verdana; font-size: 6pt; 
						...
						<span style="width: 116mm;">For Paperwork Reduction Act Notice, see Instructions for Form 1065.
						</span>
						<span style="font-weight: normal; width: 31mm;">Cat. No. 11394R</span>
						<span style="width: 40mm;">Schedule K-1 (Form 1065) 2012</span>
					  </td>
					</tr>
				</table>
             ...
             Additional Data        
				...
				<div style="width:187mm">
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/OtherIncomeLoss/Item) &gt;3)">
						  ...
						  <xsl:for-each select="$FormData/OtherIncomeLoss/Item">
						    <xsl:choose>
							  ...
							  <xsl:otherwise>
								<tr style="border-color:black;">
                                  <!-- Define background colors to the rows -->
							      <xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute><!-- First Column -->
								  <td class="styDepTblCell" align="left"> 
								    <div style="width:5mm;">
									  <xsl:call-template name="PopulateText">
									    <xsl:with-param name="TargetNode" select="Code"/>
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/OtherDeductions/Item) &gt;3)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/SelfEmploymentEarningsLoss/Item) &gt;2)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
				...
				<div style="width:187mm">
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/CreditsAndCreditRecapture/Item) &gt;2)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/ForeignTransactions) &gt;7)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
								    ...
								    <td class="styDepTblCell" align="left"> 
								      <div style="width:40mm;">
									    <span style="float:left;padding-left:2px;">
									      <xsl:call-template name="SetFormLinkInline">
										    <xsl:with-param name="TargetNode" 
										      select="$FormData/ForeignTransactions/CountryOrPossessionCode"/>
									      </xsl:call-template>
									    </span>
									    <span style="float:right;">
									      <xsl:call-template name="PopulateText">
								    ...
								    <td class="styDepTblCell" align="left"> 
								      <div style="width:40mm;">
									    <span style="float:left;padding-left:2px;">
									      <xsl:call-template name="SetFormLinkInline">
										    <xsl:with-param name="TargetNode" 
										      select="$FormData/ForeignTransactions/Code"/>
									      </xsl:call-template>
									    </span>
									    <span style="float:right;">
									      <xsl:call-template name="PopulateAmount">
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/AMTItems/Item) &gt;3)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
				...
				<div>
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/TaxExemptIncomeNonDedExpenses/Item) &gt;3)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
				  ...
				  <xsl:if test="($Print = $Separated) and  (count($FormData/Distributions/Item) &gt;2)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
                ...
                <!-- Separated Data for Part III Line 20 -->
				  <xsl:if test="($Print = $Separated) and  (count($FormData/OtherInformation/Item) &gt;4)">
				    <div style="float:left">
				      <br/>
					  <span class="styRepeatingDataTitle" style="width:60mm">Form 1065 Schedule K1,</span>
					  <br/>
								  ...
								  <td class="styDepTblCell" align="left"> 
								    <div style="width:40mm;">
									  <span style="float:left;padding-left:2px;">
									    ...
									    <span style="width:1mm;"/>
									    <xsl:call-template name="LinkToLeftoverDataTableInline">
									      <xsl:with-param name="Desc">Schedule K-1, Part III, 

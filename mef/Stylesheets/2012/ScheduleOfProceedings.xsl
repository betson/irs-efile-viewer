      ...
      <xsl:for-each select="$DependencyData/ScheduleOfProceedingsGrp">
        <tr>
          ...
          <td class="styDepTblCell" valign="top" align="center" nowrap="nowrap">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="ProceedingsTime" /></xsl:call-template>     
          </td>    
          <td class="styDepTblCell" valign="top" align="left" nowrap="nowrap">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="ProceedingsLocationDescTxt" /></xsl:call-template>     
          </td>       
        </tr>
      </xsl:for-each>
      </tbody>    

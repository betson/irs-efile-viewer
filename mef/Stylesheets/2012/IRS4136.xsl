...
* These rates apply after September 30, 2012</div>-->
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4mm;">.244</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
...
* These rates apply after September 30, 2012</div>-->
    ...
    <span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2012)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styBB" style="width:187mm">
						<div style="float: left; clear: none">Form 4136 (2012)</div>
								...
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/LUSTTaxAvnFuel) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/LUSTTaxAvnFuel">
										<tr>
											...
											<td class="styIRS4136TableCellB" style="padding-left:3mm;">.001</td>
											<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="MaxSize" select="9"/>
...
of the buyer to make the claim. Claimant certifies that the kerosene did not contain visible evidence of dye.
					...
					<div style="width:187mm;float:left;clear:left;" id="UVctn">
						<table class="styIRS4136Table" style="width:187mm;" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									<th class="styIRS4136TableCellLine" style="width:3mm;height:4mm;border-bottom-width:0px;border-right-width:0;border-top-width:1px;" scope="col">
										<span class="styIRS4136TableCellPad"/>
									</th>
...
<span style="width:72mm"/>
    ...
    Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2012)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
    ...
    <span class="styIRS4136NBSP"/>Alcohol Fuel Mixture Credit
            <span style="width:87mm;"/>Registration No.
    <img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/>
						<span style="width:8px;"/>
						<span style="font-weight:normal">
							<xsl:call-template name="PopulateText">
...
for use as a fuel or was used as a fuel by the claimant.
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4.5mm;">
										<!-- <span class="styIRS4136TableCellPad"/>-->$ .45*
									</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
                  ...
                  <xsl:call-template name="PopulateAmount">
									...
									<td class="styIRS4136TableCellE">
										<span class="styIRS4136TableCellPad"/>393
								</td>
								</tr>
								<!--  Row 09B  -->
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4.5mm;">
										<span class="styIRS4136TableCellPad" style="width:2.5mm;"/>.60*
									</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
						...
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4.5mm;">$1.00
                    <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
										<xsl:call-template name="PopulateText">
...
-->
    ...
    Alternative Fuel Credit
            <span style="padding-left:2mm;">Registration No.</span>
                  ...
                  <xsl:call-template name="PopulateAmount">
									...
									<td class="styIRS4136TableCellE">426
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12B  -->
                      ...
                      .50	
									...
									<td class="styIRS4136TableCellE">427
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12C  -->
                     ...
                     .50	
									...
									<td class="styIRS4136TableCellE">428
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12D  -->
								...
								<tr>
									...
									<td class="styIRS4136TableCellE">430
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12f  -->
								<tr>
									...
									<td class="styIRS4136TableCellE">431
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12g  -->
								<tr>
									...
									<td class="styIRS4136TableCellE">432
										<span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 12h  -->
    ...
    <span class="styIRS4136NBSP">
        ...
        <span style="font-weight:normal">
                  ...
                  width:3mm;height:4mm;" scope="col">
										<span class="styIRS4136TableCellPad"/>
									</th>
      ...
      <span class="styIRS4136TableCellPad"/>
                            ...
                            <xsl:call-template name="PopulateAmount">
								...
								<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.198
        <span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136TableCellC" style="padding-left:2mm;text-align:center;">
									<xsl:call-template name="PopulateText">
        ...
        <span style="padding-left:2mm">
          ...
          <xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2012)
  </div>
					</div>
					<!--   END FORM FOOTER   -->
					<!-- <br/>

      ...
      <table id="DataTbl" class="styDepTbl" style="font-size: 8pt">
        <thead class="styTableThead">
          <tr class="styDepTblHdr">
           ...
           <th class="styDepTblCell" scope="col" style="width: 40mm;padding-left:7mm">Number Of Shares</th>                                 
          </tr>      
        </thead>
        <xsl:for-each select="$FormData/Category3FilerInfo">
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:center;width:40mm" valign="top" >
              <xsl:call-template name="PopulateText">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ExplanationOfForm1099BAdjSch" />
  <!-- Template to display Itemized Other Income Schedule -->
  <xsl:template name="DependencyTemplate">
    <!-- Itemized Other Income Schedule Data -->
    <table id="E1099Tbl" class="styDepTbl">
      ...
      <tfoot></tfoot>
      <tbody>
        <xsl:for-each select="$DependencyData/Form1099BAdjustmentsInfo">
          <tr>

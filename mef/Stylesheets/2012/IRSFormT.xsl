  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        <form name="IRSFormT">
          ...
          <div class="styGenericDiv" style="width:187mm;">
            <div class="styNameBox" style="width:140mm;height:8mm;font-size:7pt;">
              ...
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$FormTData/NameAsShownOnReturn/BusinessNameLine2" />
              </xsl:call-template>  
              </xsl:otherwise>
			 </xsl:choose>
            </div>
              ...
              <table class="styDepTbl" style="font-size:7pt">
                ...
                <tr class="styDepTblRow1">
                  ...
                  <td style="width: 31.5mm; text-align: right" class="styFormTTablesCells "><nobr>
                    <xsl:choose>
                      <xsl:when test="ForestedLand/CostOrOtherBasisPerUnit">
                        <xsl:call-template name="PopulateAmount">
                      ...
                      <xsl:otherwise>
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="ForestedLand/CostOrOtherBasisPerUnitDecimal" />
                        </xsl:call-template>
                      </xsl:otherwise>
                    </xsl:choose>  
        ...
        <xsl:choose>
        	<xsl:when test="OtherUnimprovedLand/CostOrOtherBasisPerUnit">
                    <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="OtherUnimprovedLand/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                    <span style="width:1px;"></span></nobr>
        ...
        <xsl:choose>
        	<xsl:when test="ImprovedLand/CostOrOtherBasisPerUnit">
                    <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="ImprovedLand/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                    <span style="width:1px;"></span></nobr>
        ...
        <xsl:choose>
        	<xsl:when test="MerchantableTimber[1]/CostOrOtherBasisPerUnit">
                    <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="MerchantableTimber[1]/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                    <span style="width:1px;"></span></nobr>
        ...
        <xsl:choose>
        	<xsl:when test="CostOrOtherBasisPerUnit">
                        <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>                          
                        </nobr>
        ...
        <xsl:choose>
        	<xsl:when test="PremerchantableTimber[1]/CostOrOtherBasisPerUnit">
                    <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="PremerchantableTimber[1]/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                    <span style="width:1px;"></span></nobr>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <xsl:for-each select="Improvement">
                  <tr>
                    ...
                    <td style="width:80mm;text-align: left;vertical-align:bottom;border-bottom-width:0px;" scope="row" class="styFormTTablesCells ">         
        ...
        <xsl:choose>
        	<xsl:when test="MineralRights/CostOrOtherBasisPerUnit">
                    <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="MineralRights/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                    <span style="width:1px;"></span></nobr>
        ...
        <xsl:choose>
        	<xsl:when test="NonforestedLand/CostOrOtherBasisPerUnit">
                  <xsl:call-template name="PopulateAmount">
       	 ...
       	 <xsl:otherwise>
       	 <xsl:call-template name="PopulateAmount">
         			 <xsl:with-param name="TargetNode" select="NonforestedLand/CostOrOtherBasisPerUnitDecimal" />
      		      </xsl:call-template>
       	 </xsl:otherwise>
        </xsl:choose>  
                  <span style="width:1px;"></span></nobr>
    ...
    <table summary="Allocation of total cost or other basis on books" cellpadding="0" cellspacing="0" class="styFormTTable">
      ...
      <tbody>
        <tr>
          ...
          <td style="width:  31.5mm; text-align: righ;vertical-align:bottom;" class="styFormTTablesCells ">
  ...
  <!-- Start the table -->
    ...
    <div class="styBB" style="width:187mm;">
      <div style="width:181.25mm;">
        ...
        <div style="float:right">
          ...
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width: 32.80mm;padding-right:0.5mm;border-right-width:1px;" >
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="MaxSize" select="12" />
              <xsl:with-param name="TargetNode" select="TotalNumberOfAcresTreated"/>
            </xsl:call-template>
          </div>
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width: 31.25mm;padding-right:0.5mm;border-left-width:0px;" >
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="TotalOfTotalExpenditures"/>
            </xsl:call-template>
          </div>
    ...
    <div class="styBB" style="width:187mm;">
      <div style="width:181.25mm;">
        ...
        <div style="float:right">
          ...
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width:32.8mm;padding-right:0.5mm;border-right-width:1px;" >
           <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="MaxSize" select="12" />           
              <xsl:with-param name="TargetNode" select="ReforestationExpnssNumAcreTrtd"/>
            </xsl:call-template>
    ...
    <div class="styNBB" style="width:187mm;">
      <div style="width:181.25mm;">
        ...
        <div style="float:right">
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width:32.8mm;padding-right:0.5mm;border-right-width:1px;background-color:lightgrey;" ></div>
          <div class="styLNAmountBoxNBB" style="height:4.5mm;width:31.25mm;padding-right:0.5mm;border-left-width:0px;" >
          </div>
        </div>
      </div>

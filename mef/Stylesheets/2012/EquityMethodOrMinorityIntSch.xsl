...
<xsl:template name="EquityMethodOrMinorityIntSchTemp">
    <table id="EquityMethodOrMinorityIntSchTbl" class="styDepTblLandscape" style="font-size: 6pt;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           ...
           <th class="styDepTblCell"  scope="col" style="width:25mm">Income (Loss) per Income Statement Amount</th>

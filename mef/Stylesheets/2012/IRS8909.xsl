...
<!-- Last Modified by James Ganzy on 02/12/2013 -->
    ...
    <div class="styFTBox" style="width:125mm;padding-top:4mm;">
        ...
        <div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold;">
			<img src="{$ImagePath}/8923_Bullet.gif" alt="MediumBullet"/>
				Information about Form 8909 and its instructions is at <a href="http://www.irs.gov/form8909" title="Link to IRS.gov"><i>www.irs.gov/form8909</i></a>
		</div> 
    </div>
    <div class="styTYBox" style="width:30mm;border-left-width: 1px;">
      <div class="styOMB" style="height:2mm;">OMB No. 1545-2055</div>
      <div class="styTaxYear" style="">20<span class="styTYColor">12</span></div>
     ...
     <!-- end line 1 Number Eligible Dishwashers-->
				<div style="width:93mm;">
				    ...
				    <div class="styLNDesc" style="height:12mm;width:86mm;padding-left:2mm;float:left;font-size:7pt;padding-top:6mm;">
						  Enter the number of eligible dishwashers produced in calendar year 2012
					<!--Dotted Line-->
...
<span style="float:left;clear:none;">
			...
			<!-- End  Line 21b -->  
			  ...
			  <!-- End Line 21g -->
				...
				<div style="width: 187mm">  
					...
					<div class="styShadingCell" style="height:4.3mm;width:32mm;border-bottom:solid black 1px;padding-bottom:0mm;background-color:gray;"></div> 
				</div>
			  <!-- End Line 21h -->
			...
			<!-- End  Line 22b -->  
			  ...
			  <div style="width: 187mm;">  
				<div class="styLNLeftNumBox" style="width:6mm;float:left;padding-left:1.5mm;">23</div>
				 <div class="styLNDesc" style="width:148.8mm;float:left;padding-left:2mm;">
					<span style="float:left;clear:none;"> 
						 Maximum credit amount. Add lines 21i through 21c
					</span>
						  <!--Dotted Line-->
					<span class="styDotLn" style="float:right;padding-right:2mm;clear:none;">....................</span>    
			   ...
			   <!--  Line 25 Energy Efficient Appliance Credits Amount-->    
				...
				<div style="width: 187mm;">  
							...
							<div class="styLNDesc" style="height:7mm;width:148.8mm;float:left;padding-left:2mm;">
								...
								<div class="styLNRightNumBox" style="height:7mm;width:6mm;padding-top:4mm;padding-bottom:0mm;">26</div>
  ...
  <!--  FOOTER-->
        <div style="width:187mm;border-top:1px solid black;">
          ...
          Form <span class="styBoldText">8909</span> (2012)
        </div> 
        <div class="pageEnd"/>

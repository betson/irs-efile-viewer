				...
				<form style="font-family:arial; font-size:8pt" name="Form5472">
                    ...
                    margin-left:1mm; 
										...
										<xsl:otherwise>
											...
											<xsl:if
												test="(normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/City) != '') and (normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/PostalCode) != '')">
												,
											</xsl:if>
											<xsl:call-template name="PopulateText">
											...
											<xsl:if
												test="normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/City) != '' or normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/ReportingCorporationInfo/CorporationForeignAddress/PostalCode) != ''">
												<br/>
											</xsl:if>
											<xsl:call-template name="PopulateText">
								...
								<div style="margin-left:1mm">
									...
									<xsl:choose>
										<xsl:when test="$Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress">
											...
											<xsl:if
												test="(normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/City) != '') and (normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/PostalCode) != '')">
												,
											</xsl:if>
											<xsl:call-template name="PopulateText">
											...
											<xsl:if
												test="normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/City) != '' or normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/RelatedPartyInfo/RelatedPartyForeignAddress/PostalCode) != ''">
												<br/>
											</xsl:if>
											<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm">
						...
						<div style="float:right">
							...
							<div class="styLNAmountBox">
								<!-- *************************************************************************************** -->
								<xsl:choose>
									<xsl:when test="normalize-space($Form5472Data/PlatformContributionReceived) != ''">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/PlatformContributionReceived"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/PlatformContriRcvd50000Less"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
								<!-- *************************************************************************************** -->
					...
					<div style="width:187mm">
						...
						<div style="float:right">
							...
							<div class="styLNAmountBox">
								<!-- *************************************************************************************** -->
								<xsl:choose>
									<xsl:when test="normalize-space($Form5472Data/CostSharingReceived) != ''">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/CostSharingReceived"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/CostSharingReceived50000Less"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
								<!-- *************************************************************************************** -->
						...
						<div style="float:right">
							...
							<div class="styLNAmountBox">
								...
								<xsl:choose>
									<xsl:when test="normalize-space($Form5472Data/PlatformContributionReceived) != ''">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/PlatformContributionPaid"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/PlatformContriPaid50000Less"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
								<!-- *************************************************************************************** -->
						...
						<div style="float:right">
							...
							<div class="styLNAmountBox">
								...
								<xsl:choose>
									<xsl:when test="normalize-space($Form5472Data/CostSharingReceived) != ''">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/CostSharingPaid"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form5472Data/CostSharingPaid50000Less"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
								<!-- *************************************************************************************** -->
					...
					<div style="width:187mm;padding-bottom:1mm; border-bottom:2 solid black">
						...
						<div style="float:right; margin-right:1mm">
							...
							<div class="styLNDesc" style="clear:none; width: 26mm">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form5472Data/FrgnPrntCorpPartcpCostShr"/>
									</xsl:call-template>
									<input type="Checkbox" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form5472Data/FrgnPrntCorpPartcpCostShr"/>
						...
						<xsl:if test="($Print != $Separated) or (count($Form5472Data/Direct25PctFrgnShareholderInfo) &lt; 3)">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									...
									<xsl:if
										test="(normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/City) != '') and (normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/PostalCode) != '')">
										,
									</xsl:if>
									<xsl:call-template name="PopulateText">
									...
									<xsl:if
										test="normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/City) != '' or normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/Direct25PctFrgnShareholderInfo[$index]/ForeignAddress/PostalCode) != ''">
										<br/>
									</xsl:if>
									<xsl:call-template name="PopulateText">
						...
						<xsl:if test="($Print != $Separated) or (count($Form5472Data/UltimateIndr25PctFrgnShrInfo) &lt; 3)">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									...
									<xsl:if
										test="(normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/City) != '') and (normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/PostalCode) != '')">
										,
									</xsl:if>
									<xsl:call-template name="PopulateText">
									...
									<xsl:if
										test="normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/City) != '' or normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/ProvinceOrState) != '' or normalize-space($Form5472Data/UltimateIndr25PctFrgnShrInfo[$index]/ForeignAddress/PostalCode) != ''">
										<br/>
									</xsl:if>
									<xsl:call-template name="PopulateText">

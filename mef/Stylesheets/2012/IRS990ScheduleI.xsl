...
<div class="IRS990ScheduleI_TaxYear" style="padding-top:0mm;padding-bottom:0;">
       <span>20<span class="styTYColor">12</span></span>
...
<!-- Employer Identification Number -->
        ...
        <xsl:if  test="count($FormData/RecipientTable) &lt; 1 or
...
<div class="sty990ScheduleIFormFooter" style="padding-top:1mm;">
  ...
  <span class="styBoldText"> Schedule I (Form 990) 2012</span> 
</div>
</div>
<!--     END FORM FOOTER   -->
...
<br/>      
  ...
  <div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">  
    <div style="float:left">Schedule I (Form 990) 2012</div>
...
<xsl:if  test="count($FormData/Form990ScheduleIPartIII) &lt; 1or
...
Complete this part to provide the information required in Part I, line 2, Part III, column (b), and any other additional information.</div>

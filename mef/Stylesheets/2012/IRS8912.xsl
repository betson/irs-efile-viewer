...
Attach to your tax return.    
							...
							<div class="styFST" style="height:5mm;font-size:7pt;">
								<img src="{$ImagePath}/8912_Bullet.gif" alt="Bullet Image"/>
Information on Form 8912 and its instructions is available at <i>www.irs.gov/form8912.</i>
							</div>
						</div>
...
1</div>
						<div class="styLNAmountBox" style="height:5mm;width:32mm;font-size:7pt;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8912Data/TotalF8912BondCreditGrp/TotalAllForm1097BTCAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!--Line 2a-->
...
2a</div>
						<div class="styLNAmountBox" style="height:5mm;width:32mm;font-size:7pt;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8912Data/TotalF8912BondCreditGrp/NewCleanEnergyBondAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!--Line 2b-->
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;height:4.5mm;">
Bond credit(s) from partnerships, S corporations, regulated investment companies, real estate investment trusts, estates, and trusts not reported to you on Form(s) 1097-BTC. Enter the amount from line 22. (see instructions.)
<!--Dotted Line-->
							<span style="letter-spacing:3.8mm;font-weight:bold;">.......................</span>
						</div>
...
2b</div>
						<div class="styLNAmountBox" style="height:10.5mm;width:32mm;font-size:7pt;padding-top:6.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8912Data/TotalF8912BondCreditGrp/TotalEntityNotRtpF1097BTCAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!--Line 3-->
...
3</div>
						<div class="styLNDesc" style="width:138mm;height:4.5mm;">
Carryforward of credits for qualified tax credit bonds and build America bonds to 2012. (see instructions.)    
<!--Dotted Line-->
							<span style="letter-spacing:3.8mm;font-weight:bold;">..........................</span>
						</div>
...
Form <span class="styBoldText">8912</span>(2012)
</div>
					<br class="pageend"/>
					<!--Begin Page 2 -->
					<!-- Page Header -->
					<div style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 8912 (2012)<span style="width:148mm;"/>
						</div>
						...
						<table class="styTable" style="font-size:7pt;border-color:black;height:76.4mm;" cellspacing="0" summary="Table displaying Bond information" name="CREYCtable1" id="CREYCtable1">
							<thead class="styTableThead">
								<tr>
									...
									<th scope="col" class="styTableCell" style="height:7mm;width:43mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top">
										<b>(b2)</b> Unique<br/> identifier <br/>(see instructions)</th>
											...
											<xsl:for-each select="$Form8912Data/BondInformation">
												<tr>
													...
													<td class="styTableCell" style="width:36mm;text-align:left;padding-top:3mm">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="UniqueIdentifier"/>
														</xsl:call-template>
													</td>
													<td class="styTableCell" style="width:40mm;text-align:right;border-right-width:0px;padding-top:3mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="Form1097BTCCrAmt"/>
														</xsl:call-template>
													</td>
												</tr>
											</xsl:for-each>
...
<span style="width:1px;"/>
			...
			<th scope="col" class="styTableCell" style="font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;width:39mm;height:7mm;" colspan="1">
							...
							<tfoot/>
												<tr>
<td class="styTableCell" style="width:5mm;text-align:center;border-right-width:0px;font-weight:bold;vertical-align:top;border-bottom-width:1px;height:5mm;">18
...
19</div>
<div class="styLNDesc" style="width:141.5mm;height:5mm;">
...
Identifying number<br/>
					...
					<!-- BEGIN Part V Title -->
					<div class="styBB" style="width:187mm;border-top:1px;">
						<div class="styPartName">Part V</div>
						<div class="styPartDesc">Bond credit(s) from partnerships, S corporations, regulated investment companies, real estate investment trusts, estates, and trusts not reported to you on Form(s) 1097-BTC (see instructions) </div>	
</div>
					<!-- END Part V Title -->
					<!-- Start table -->
<!--Line 21-->
					<div class="styTableContainer" id="CREYCtable3" style="border-bottom-width:0px;height:0mm;width:187mm;">
						<xsl:call-template name="SetInitialState"/>
						<table class="styTable" style="font-size:7pt;border-color:black;height:76.4mm;" cellspacing="0" summary="Table displaying Bond credit for partnerships" name="CREYCtable3" id="CREYCtable3">
							<thead class="styTableThead">
								<tr>
<th scope="col" class="styTableCell" style="width:95mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;" colspan="2">
	<div class="styBB" style="height:7mm;width:85mm;border-bottom-width: 0px;text-align:center;padding-top:0mm;">
											<b>(a)</b> Name of the entity distributing the bond<br/> credit
</div>
									</th>
<th scope="col" class="styTableCell" style="height:7mm;width:66mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top">
										<b>(b)</b> Employer identification number of the entity in column (a)</th>
<th scope="col" class="styTableCell" style="height:7mm;width:35mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right-width:0px;">
										<b>(c)</b> Amount of the credit</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<xsl:choose>
									<xsl:when test="($Print = $Separated) and (count($Form8912Data/OtherBondNotOnForm1097BTCGrp) &gt;= 1)">
										<tr>
<td class="styTableCell" style="height:7mm;width:5mm;text-align:center;border-right:none;font-weight:bold;padding-top:3.5mm;">
												<xsl:choose>
													<xsl:when test="position() = 1">
...
<td class="styTableCell" style="height:7mm;width:80mm;text-align:left;padding-top:3mm;">"See Additional Data Table"
<span style="width:1px;"/>
											</td>
<td class="styTableCell" style="height:7mm;width:66mm;text-align:center;border-right-width:1px;">
												<span style="width:1px;"/>
											</td>
<td class="styTableCell" style="height:7mm;width:35mm;text-align:right;border-right:none;">
												<span style="width:1px;"/>
											</td>
										</tr>
									</xsl:when>
									<xsl:otherwise>
										<xsl:if test="($Print != $Separated) and (count($Form8912Data/OtherBondNotOnForm1097BTCGrp) &gt;= 1)">
											<xsl:for-each select="$Form8912Data/OtherBondNotOnForm1097BTCGrp">
												<tr>
													<td class="styTableCell" style="width:5mm;text-align:center;border-right-width:0px;font-weight:bold;vertical-align:top;padding-top:3.5mm;">
														<xsl:choose>
															<xsl:when test="position() = 1">
													...
													<td class="styTableCell" style="width:80mm;text-align:left;">
														<xsl:call-template name="PopulateText">
													...
													<td class="styTableCell" style="width:66mm;text-align:center;padding-top:3mm">
														<xsl:call-template name="PopulateEIN">
															<xsl:with-param name="TargetNode" select="EIN"/>
														</xsl:call-template>
													</td>
													<td class="styTableCell" style="width:35mm;text-align:right;border-right-width:0px;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="BondCreditAmt"/>
														</xsl:call-template>
													</td>
												</tr>
											</xsl:for-each>
								...
								<xsl:if test="count($Form8912Data/BondInformation)&lt; 1">
									<tr>
										...
										<td class="styTableCell" style="height:7mm;width:80mm;text-align:left;">
											<span style="width:1px;"/>
										</td>
										<td class="styTableCell" style="height:7mm;width:66mm;text-align:center;">
											<span style="width:1px;"/>
										</td>
										<td class="styTableCell" style="height:7mm;width:35mm;text-align:right;border-right-width:0px;">
											<span style="width:1px;"/>
										</td>
									</tr>
								</xsl:if>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:7mm;width:6mm;padding-top:3.5mm;">
22</div>
						<div class="styLNDesc" style="width:138.7mm;height:7mm;padding-top:3.5mm;">
							<b>Total.</b> Combine the amounts in column (c). Enter here and on line 2b
<!--Dotted Line-->
							<span style="letter-spacing:3.8mm;font-weight:bold;"> ...........</span>
						</div>
						<div class="styLNRightNumBox" style="width:8mm;height:7mm;padding-top:3.5mm;border-bottom-width:0px;">
22	</div>
						<div class="styLNAmountBox" style="height:7mm;width:31mm;padding-top:3.5mm;border-bottom-width:0px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8912Data/TotalEntityNotRtpF1097BTCAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
						...
						<table class="styDepTbl" style="font-size:7pt;width:187mm;" cellspacing="0" summary="Table showing Bond Payment information" name="CREYCtable" id="CREYCtable">
							<thead class="styTableThead">
								<tr class="styDepTblHdr" style="width:187mm;">
									...
									<th scope="col" class="styDepTblCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:bold;vertical-align:top">(b) Unique identifier<br/>(see instructions)</th>
...
<!--Dotted Line-->
	...
	<th class="styDepTblCell" style="width:39mm;font-size:7pt;text-align:center;font-weight:bold;" colspan="2">(a) CUSIP number. If CUSIP number not issued, enter principal payment dates. (Clean renewable energy bonds: Include CUSIP number and principal payment dates. Build America bonds: Include CUSIP number and interest payment dates.) </th>
							...
							<tfoot/>
									<tr>
									<xsl:choose>
                    <xsl:when   test="$Form8912Data/BondNotOnForm1097BTCGrp">
...
<span style="width:1px;"/>
					...
					<xsl:if test="($Print = $Separated) and (count($Form8912Data/OtherBondNotOnForm1097BTCGrp) &gt;= 1)">
						<!-- Start of Separate Table -->
						<span class="styRepeatingDataTitle">Form 8912 - Part V Bond Credit from partnerships, S corporations, regulated investment companies, real estate investment trusts, estates, and trusts not reported to you on Form(s) 1097-BTC</span>
						<table class="styDepTbl" style="font-size:7pt;width:187mm;" cellspacing="0" summary="Table showing Bond Payment information" name="CREYCtable" id="CREYCtable">
							<thead class="styTableThead">
								<tr class="styDepTblHdr" style="width:187mm;">
									<th scope="col" class="styDepTblCell" style="width:109mm;font-size:7pt;text-align:center;font-weight:bold;padding-top:4mm;" colspan="2">(a) Name of the entity distributing the bond<br/> credit </th>
									<th scope="col" class="styDepTblCell" style="width:41mm;font-size:7pt;text-align:center;font-weight:bold;vertical-align:top">(b) Employer identification number of the<br/> entity in column (a)</th>
									<th scope="col" class="styDepTblCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:bold;vertical-align:top">(c) Amount of the credit</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<xsl:for-each select="$Form8912Data/OtherBondNotOnForm1097BTCGrp">
									<tr style="width:187mm;">
										...
										<td class="styDepTblCell" style="width:36mm;text-align:right;padding-top:4mm;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="BondCreditAmt"/>
											</xsl:call-template>
										</td>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="CPSData" select="$RtnDoc/WorthlessStockDeductionSch" />
    ...
    <html>
      ...
      <body class="styBodyClass" >
        ...
        <div class="styTopSectionLine">
          <div style="float:left;clear:none;width:65mm;"><span class="styTopSectionLineLbl">Schedule:</span></div>
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$CPSData/Schedule"/>
            </xsl:call-template>            
          </div>
        </div>
        <br />      

...
-->
          ...
          <div  class="pageEnd" style="width:187mm;">
            ...
            <div class="stySmallText" style="width:36mm;text-align:right;float:right;clear:none;">
              Form <span class="styBoldText" style="font-size:8pt;">8858</span> (Rev.12&#8211;2012)
            </div>
          </div>
          <!--<br class="pageEnd"/>-->
          <div style="width:187mm;">
            <div class="stySmallText" style="width:90mm;text-align:left;float;left; font-weight: bold;">
              Form 8858 (Rev.12&#8211;2012)
            </div>
            <div class="stySmallText" style="width:36mm;text-align:right;float:right;clear:none;">
...
1.1503(d)&#8211;1(b)(4) or part of a combined separate unit under Reg. 1.1503(d)&#8211;1(b)(4)(ii) does the separate unit or combined separate unit </span>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="height: 4mm;padding-left:3mm;"></div>
              <div class="styLNDesc" style="width: 146.5mm; height: 4mm;">
                  ...
                  <span style="width:25mm;font-size:6pt;border-bottom:1px solid black;">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/DualConsolidatedLoss"/>
            ...
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="width: 16mm;background-color: lightgrey;text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 4mm;padding-left:0mm;float:left;clear:none; ">
                      <span style="width:5px;" />
                </div>
                <div style="width: 16mm;background-color: lightgrey;text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height:4mm;float:right;">
                      <span style="width:5px;" />
                </div>
              </div>
            </div>
            ...
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="height: 8mm;padding-top:3.5mm;width: 16mm;text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; padding-left:0mm;float:left;clear:none; ">
                                    <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/DualCnsldtLossTaxableIncome"/>
                  </xsl:call-template>
                </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="height: 4.5mm;padding-left:3mm;">b</div>
              <div class="styLNDesc" style="width: 146.5mm; height: 4.5mm;">
                <span style="float: left; clear: none;">Was this a permitted domestic use of the dual consolidated
loss under Reg. 1.1503(d)&#8211;6? If “No,” go to 5c.</span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
              </div>
            </div>
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="width: 16mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 4.5mm;padding-left:0mm;float:left;clear:none; ">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/PrmtDomDualCnsldtLoss"/>
                  </xsl:call-template>
                </div>
                <div style="width: 16mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 4.5mm;float:right;">
                  <xsl:call-template name="PopulateNoBoxText">
...
consolidated loss used to compute consolidated taxable</span>
            ...
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="width: 16mm;padding-top:3.5mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;padding-left:0mm;float:left;clear:none; ">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/ComputedCnsldtTaxableIncm"/>
                  </xsl:call-template>
                </div>
                <div style="width: 16mm;padding-top:3.5mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;float:right;">
                  <xsl:call-template name="PopulateNoBoxText">
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="height: 8mm;padding-left:3mm;"></div>
              <div class="styLNDesc" style="width: 146.5mm; height: 8mm;">
                                 <span style="float:left;">If “Yes,” enter the separate unit's contribution to the cumulative consolidated taxable income ("cumulative </span>
                                 <span style="float:left;">register") as of the beginning of the tax year <span style="width:4px;"/><img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="Bullet"/><span style="width:4px;"/> $ <span style="width:25mm;font-size:6pt;border-bottom:1px solid black;">  
          ...
          <div style="width:187mm;">
            ...
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="width: 16mm;padding-top:3.5mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;padding-left:0mm;float:left;clear:none; ">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/ForeignTaxDisqualifiedSec901m"/>
                  </xsl:call-template>
                </div>
                <div style="width: 16mm;padding-top:3.5mm; text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;float:right;">
                  <xsl:call-template name="PopulateNoBoxText">
...
section 909 applies, or treat foreign taxes that were previously suspended under section 909 as no longer suspended?                                 
            ...
            <div style="float:right;clear:none;">
              <div style="width:32mm;">
                <div style="width: 16mm;padding-top:3.5mm;text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;padding-left:0mm;float:left;clear:none; ">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleG/ForeignTaxesUnderSec909"/>
                  </xsl:call-template>
                </div>
                <div style="width: 16mm;padding-top:3.5mm;text-align: center; font-weight: bold; border-left: 1px solid black; border-bottom: 1px solid black; height: 8mm;float:right;">
                  <xsl:call-template name="PopulateNoBoxText">
...
<!--            <xsl:call-template name="PopulateLeftoverRowAmount">
          ...
          <xsl:if test="(($Print = $Separated) or (count($Form8858Data/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber) &gt;1))">
          ...
          <xsl:if test="(($Print = $Separated) or (count($Form8858Data/TaxOwnerEntityIdGrp/ForeignEntityReferenceIdNumber) &gt; 1))">
            <span class="styRepeatingDataTitle">

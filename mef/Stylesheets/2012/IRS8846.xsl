              ...
              <div class="styLNDesc" style="font-size:7pt; width:138.9mm;height:8mm;padding-right:1mm;">
                <label>
                  <xsl:call-template name="PopulateLabel">
                    <xsl:with-param name="TargetNode" select="$Form8846Data/EmpWagesExceededMaxAmtInd"/>
                    <xsl:with-param name="BackupName">IRS8846EmpWagesExceededMaxAmtInd</xsl:with-param>
                  </xsl:call-template>
                    Multiply line 3 by 7.65% (.0765). If you had any tipped employees whose wages (including tips) 
                  <span style="float:left;">exceeded $110,100, see instructions and check here.  
          ...
          <div style="width:187mm;">
            ...
            <span style="width:128px;"/>  
              ...
              <span style="width:115px;"/>  
                Form <span class="styBoldText">8846</span> (2012)
            </div>
          <!--Page End break -->
          <br class="pageEnd"/>

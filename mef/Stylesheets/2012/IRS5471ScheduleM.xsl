...
<div class="styBB" style="font-size:6pt;width:187mm;border-top-width:1px;">
  <div class="styNameBox" style="width:76mm;height:9mm;font-size:6pt;">Name of foreign corporation
  <br />
    <span style="font-size:7pt;">
      ...
      <xsl:call-template name="PopulateText">
        ...
        select="$IRS5471ScheduleMData/NameOfForeignCorporation/BusinessNameLine2" />
                                                                ...
                                                                <!--  Foreign EIN-->
  <div class="styNameBox" style="width:34mm;height:15mm;padding-left:2mm;font-size:6pt;">EIN (if any)   <br/>       <br/>
      <span style="font-weight:normal;font-size:7pt;">  
        <xsl:choose>
          ...
          <xsl:when test="$IRS5471ScheduleMData/MissingForeignCorpEINReason">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/MissingForeignCorpEINReason" />
            </xsl:call-template>
          </xsl:when>
                                                  ...
                                                  <!--Reference Number ID-->
  <div class="styEINBox" style="width:77mm;height:9mm;padding-left:2mm;font-size:6pt;border-left-width:1px;">Reference ID number (see instructions)          <br/><br/>
  <xsl:choose>
		 <xsl:when test="(count($IRS5471ScheduleMData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber) &gt; 1)">
		      <span style="width:30mm;font-size:6.5pt;padding-left:5mm;">-See Add'l Data-</span>
     <!--<xsl:call-template name="PopulateAdditionalDataTableMessage">
    
     <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber"/>
     </xsl:call-template> --> 
  </xsl:when>
  <xsl:otherwise>
  ...
  <!--(count($FormData/IRS8910PartI) &gt; 2)
  $IRS5471ScheduleMData/ForeignEntityIdentificationGrp/-->
...
<div style="width: 187mm">
  ...
  <span class="sty5471ScheduleMColEF" style="width:33mm;text-align: center; height: 16mm; padding-top: 3px;padding-right: 0px;"><b>(f)</b> 10% or more U.S. shareholder of any<br/>corporation<br/>controlling the<br/>foreign corporation</span>
</div>
<!--   END HEADER   -->
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 7.5mm;padding-top: 4mm">
  ...
  <span class="sty5471ScheduleMColEF" style="height:  7.5mm; padding-top: 4mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/StockSalesInTradeShrOfFrgnCorp" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height:  7.5mm; padding-top: 4mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 9mm;padding-top: 6mm;vertical-align:bottom" >
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/SaleTangiblePropUSReturnFiler" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 9mm; padding-top:6mm">
    <xsl:call-template name="PopulateAmount">
  ...
  <span class="sty5471ScheduleMColEF" style="height: 9mm; padding-top:6mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/SaleTangiblePropShrOfFrgnCorp" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 9mm; padding-top:6.5mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<!--   BEGIN LINE 4   -->
<div class="sty5471ScheduleMDescLine">
  <span class="sty5471ScheduleMColA" style="height: 6mm">
  ...
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmTransPymtRcvdUSFilerAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtRcvdDomCorpPrtshpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtRcvdOtherFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMColEF" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtRcvdShrOfFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtRcvdShrOfCorpCtrlAmt" />
    </xsl:call-template>
  </span>
</div>
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtRcvdUSFilerAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtRcvdDomCorpPrtshpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtRcvdOtherFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMColEF" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtRcvdShrOfFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtRcvdShrOfCorpCtrlAmt" />
    </xsl:call-template>
  </span>
</div>
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 12mm;padding-top:9mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 4mm;padding-top:1mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 14mm;padding-top:11mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="width:30mm;height:4mm;padding-top:.5mm">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmTransPymtPdUSFilerAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtPdDomCorpPrtshpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtPdOtherFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMColEF" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtPdShrOfFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PltfrmPymtPdShrOfCorpCtrlAmt" />
    </xsl:call-template>
  </span>
</div>
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtPdUSFilerAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtPdDomCorpPrtshpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtPdOtherFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMColEF" style="height: 6mm;padding-top:3mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtPdShrOfFrgnCorpAmt" />
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height: 6mm;padding-top:3mm;width:30mm;">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/TransPymtPdShrOfCorpCtrlAmt" />
    </xsl:call-template>
  </span>
</div>
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="width:30mm;height:4mm;padding-top:1mm">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMDescLine" >
  ...
  <span class="sty5471ScheduleMCol" style="height:4mm;width:30mm;padding-top:1mm">
    <xsl:call-template name="PopulateAmount">
...
<div class="sty5471ScheduleMFormFooter">
  ...
  <div style="width:55mm;text-align:right;font-weight:bold; text-align: right; float: left; clear: none">Schedule M(Form 5471) <span style="font-weight:normal">(Rev. 12-2012)</span></div>
</div>
<!--     END FORM FOOTER   -->
      <br/>
      ...
      <table class="styLeftOverTbl">
        <xsl:call-template name="PopulateCommonLeftover">
          ...
          <xsl:with-param name="DescWidth" select="100"/>
				...
				<xsl:if test="(count($IRS5471ScheduleMData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber) &gt; 1)">

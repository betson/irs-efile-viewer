				...
				<form name="IRS9465" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<div class="styFNBox" style="width:31mm;height:19mm;border-right-width:2px;">
							Form<span class="styFormNumber">  9465</span><br/>
								...
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;padding-left:5px;">
										<div style="width:120mm;height:5mm;">
											...
											Information about Form 9465 and its separate instructions is at <span style="font-weight:normal;"><i>www.irs.gov/form9465</i></span>.<br/>
											<img src="{$ImagePath}/9465_Bullet_Sm.gif" alt="SmallBullet"/> 
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						<div class="styIRS9465LineItem">
							<div class="styIRS9465LNDesc" style="width:100%;height:auto;padding-left:0px;font-size:8pt;">
								<b>Tip: </b>If you owe less than $50,000, you may be able to establish an installment agreement on-line, even if you have not yet received a bill for 
								your taxes. Go to IRS.gov to apply to pay on-line.<br/>
								<b>Caution: </b>
								<span class="styItalicText">
									...
									call 1-800-829-1040. If you are in bankruptcy or we have accepted your offer-in-compromise, see <b>Bankruptcy or offer-in-compromise,</b> in the
									instructions.
								</span>
							</div>
						</div>
					...
					<!-- Form # and Tax Year -->
						<div class="styIRS9465LineItem">
							<div class="styIRS9465LNDesc" style="width:100%;height:auto;padding-left:0px;font-family:Arial Narrow;">
								...
								and for tax year(s) (for example, 2011 and 2012)
								<span style="width:4px;"/>
								<img src="{$ImagePath}/9465_Bullet_Sm.gif" alt="SmallBullet"/>
								<span style="width:4px;"/>
					...
					<!-- (5)(6) ////////////////////////////////////////////////////-->
					<div class="styBB" style="width:187mm;">
						<div class="styIRS9465CleanDiv" style="width:94mm;height:37mm;border-right:1px solid black">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS9465LineItem">
							...
							<div class="styIRS9465CleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS9465LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS9465LNDesc" style="width:auto;height:100%;">
										Enter the total amount you owe as shown on your tax return(s) (or notice(s))<br/>
										<b>Note: </b>If the amount on line 7 is greater than $25,000 but not more than $50,000, you <b>must</b> complete
										line 11. If you owe more than $50,000, complete Form 433-F and attach it to your request. See instructions
										<!--Dotted Line-->
										<span class="styBoldText">
											<span style="width:11px"/>.
										</span>
							...
							<div class="styIRS9465CleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
								<div class="styIRS9465CleanDiv" style="width:100%;height:8mm;float:right;">
						...
						<div class="styIRS9465LineItem">
							...
							<div class="styIRS9465CleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS9465LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS9465LNDesc" style="width:auto;height:100%;">
										...
										interest and penalty charges.</b> The charges will continue until you pay in full. If no payment 
										amount is listed on line 9, or the proposed payment does not meet our streamlined processing 
										criteria, a payment will be determined for you by dividing the balance due by 72 months
										<!--Dotted Line-->
										<span class="styBoldText">
											<span style="width:5px"/>.
											<span style="width:11px"/>.
							...
							<div class="styIRS9465CleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
								<div class="styIRS9465CleanDiv" style="width:100%;height:12mm;float:right;">
									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">100%</xsl:with-param>
										<xsl:with-param name="AmountBoxStyle">border-bottom-width:0px;padding:0px 0px 0px 0px;</xsl:with-param>
										<xsl:with-param name="NumberBoxStyle">border-bottom-width:0px;padding:0px 0px 0px 0px;</xsl:with-param>
					  ...
					  <div class="pageEnd" style="width:187mm;">
						...
						<div style="float:right;">
						  <span style="width:75px;"/>  
							Form <span class="styBoldText" style="font-size:8pt;">9465</span> (Rev. 12-2012)
						</div>
					  </div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->

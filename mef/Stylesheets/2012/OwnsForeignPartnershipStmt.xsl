            ...
            <xsl:value-of select="position()" />
						...
						<td class="styDepTblCell" valign="top" align="left">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="NameOfForeignPartnership/BusinessNameLine1"/>
							</xsl:call-template>
							<xsl:if test="normalize-space(NameOfForeignPartnership/BusinessNameLine2) != ''">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="NameOfForeignPartnership/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
						</td>
						...
						<td class="styDepTblCell" valign="top" align="center">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="OtherFormsFiled"/>
							</xsl:call-template>
						</td>
						<td class="styDepTblCell" valign="top" align="left">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="NameOfTaxMattersPartner/BusinessNameLine1"/>
							</xsl:call-template>
							<xsl:if test="normalize-space(NameOfTaxMattersPartner/BusinessNameLine2) != ''">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="NameOfTaxMattersPartner/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
						</td>
						<td class="styDepTblCell" valign="top" align="center">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="ForeignPrtshpTYBeginningDate"/>
							</xsl:call-template>
						</td>
						<td class="styDepTblCell" valign="top" align="center">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="ForeignPrtshpTaxYearEndingDate"/>
							</xsl:call-template>
						</td>
					</tr>
				</xsl:for-each>

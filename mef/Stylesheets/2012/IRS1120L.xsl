...
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxYearBeginning"/>
</xsl:call-template>
</span>, ending 
            <span style="width: 18mm;border-bottom:1 solid black;">
<xsl:call-template name="PopulateMonthDayYear">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxYearEnding"/>
</xsl:call-template>
</span>
<br/><br/>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/IsConsolidatedReturn"/>
...
<label>
<xsl:call-template name="PopulateLabel">
<xsl:with-param name="TargetNode" select="  $Form1120LData/LifeNonlifeConsolidatedReturn"/>
...
<label>
<xsl:call-template name="PopulateLabel">
<xsl:with-param name="TargetNode" select="  $Form1120LData/ScheduleM3_1120L"/>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/Name/BusinessNameLine1"/>
</xsl:call-template>
<br/>
<xsl:call-template name="PopulateText">
<xsl:with-param name="TargetNode" select="  $Form1120LData/Name/BusinessNameLine2"/>
</xsl:call-template>
</div>
...
<xsl:if test="  $Form1120LData/MissingEINReason !=' '">
<span style="font-weight:normal;">
<xsl:call-template name="PopulateText">
<xsl:with-param name="TargetNode" select="  $Form1120LData/MissingEINReason"/>
</xsl:call-template>
</span>
</xsl:if>
</span>
...
<xsl:call-template name="PopulateMonthDayYear">
<xsl:with-param name="TargetNode" select="  $Form1120LData/DateIncorporated"/>
</xsl:call-template>
</span>
</div>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/ElectionMadeUnderSection953D/@Section953DIndicator"/>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/ElectionMadeUnderSection953D/@Section953DAmount"/>
<xsl:with-param name="Style">padding-left:4mm;</xsl:with-param>
</xsl:call-template>
</div>
</div>
...
<input type="checkbox" class="styCkbox">
<xsl:call-template name="PopulateCheckbox">
<xsl:with-param name="TargetNode" select="  $Form1120LData/AddressChange"/>
...
<input type="checkbox" class="styCkbox">
<xsl:call-template name="PopulateCheckbox">
<xsl:with-param name="TargetNode" select="  $Form1120LData/ElectionMadeUnderSection953C3C"/>
...
<input type="checkbox" class="styCkbox">
<xsl:call-template name="PopulateCheckbox">
<xsl:with-param name="TargetNode" select="  $Form1120LData/ElectionMadeUnderSection953D"/>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/GrossPremiumsBalance"/>
</xsl:call-template>
</div>
<!-- line 2 -->
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/NetDecreaseInReserves"/>
</xsl:call-template>
</div>
</div>
<!-- line3 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/PercentDecreaseSection807"/>
</xsl:call-template>
</div>
</div>
<!-- line 4 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/InvestmentIncome"/>
</xsl:call-template>
</div>
</div>
<!-- line 5 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/CapitalGainNetIncome"/>
</xsl:call-template>
</div>
</div>
<!-- line 6 -->
...
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/IncmFromSpecialLossDscntAcct"/>
...
<!-- Form to Form Link -->
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherIncome"/>
</xsl:call-template>
<xsl:call-template name="LinkToLeftoverDataTableInline">
<xsl:with-param name="Desc">Line 7 - other Income Item</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherIncome/@otherIncomeItem"/>
<xsl:with-param name="Style">padding-left:4mm;</xsl:with-param>
</xsl:call-template></span>
<!--Dotted Line-->
<span class="styDotLn" style="float:right;padding-right:2mm;">....................</span>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/LifeInsuranceGrossIncome"/>
</xsl:call-template>
</div>
</div>
</div>
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/DeathBenefits"/>
</xsl:call-template>
</div>
</div>
<!-- line 10 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/NetIncreaseInReserves"/>
</xsl:call-template>
</div>
</div>
<!-- line 11 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/PercentIncreaseUnderSection807"/>
</xsl:call-template>
</div>
</div>
<!-- line 12 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/DeductiblePolicyholderDiv"/>
</xsl:call-template>
</div>
</div>
<!-- line 13 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/AssumptionOfLiabilities"/>
</xsl:call-template>
</div>
</div>
<!-- line 14 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/ReimbursableDividends"/>
</xsl:call-template>
</div>
</div>
<!-- line 15a -->
...
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/InterestDeductions"/>
</xsl:call-template>
</div>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxExemptInterestExpense"/>
</xsl:call-template>
</div>
<!-- line 15c -->
...
<div class="styLNRightNumBox" style="height:5mm;border-bottom-width:0px;width:8mm"></div>
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/InterestBalance"/>
</xsl:call-template>
</div>
</div>
<!-- ************************************************************************************************** -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/DeductibleAcquisitionExpenses"/>
</xsl:call-template>
</div>
</div>
<!-- line 17 -->
...
<!-- Form to Form Link-->
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/AdditionalDeduction"/>
</xsl:call-template></span>
<!--Dotted Line-->
<span class="styDotLn" style="float:right;padding-right:2mm;">..................</span>
</div>
...
<!-- Form to Form Link -->
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/OtherDeductions"/>
</xsl:call-template></span>
<!--Dotted Line-->
<span class="styDotLn" style="float:right;padding-right:2mm;">..............</span>
</div>
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/PartialTotalDeductions"/>
</xsl:call-template>
</div>
</div>
<!-- line 20 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/SubtotalOfDeductions"/>
</xsl:call-template>
</div>
</div>
<!-- line 21a -->
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/DividendsReceivedDeduction"/>
</xsl:call-template>
</div>
...
<!-- Form to Form Link  -->
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/NetOperatingLossDeduction"/>
</xsl:call-template>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalDividendsRcvdAndOprLoss"/>
</xsl:call-template>
</div>
</div>
<!-- line 22 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/GainOrLossFromOperations"/>
</xsl:call-template>
</div>
</div>
<!-- line 23 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/SmallLifeInsCompanyDeduction"/>
</xsl:call-template>
</div>
</div>
<!-- line 24 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/LICTI"/>
</xsl:call-template>
</div>
</div>
<!-- line 25 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/LimitationOnNoninsuranceLosses"/>
</xsl:call-template>
</div>
</div>
<!--line 26 -->
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/SurplusAccountDeduction"/>
</xsl:call-template>
</div>
</div>
</div>
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncome"/>
</xsl:call-template>
</div>
</div>
<!-- line 28 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TotalTax"/>
</xsl:call-template>
</div>
</div>
<!-- line 29a -->
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/PriorYearOverpaymentCredit"/>
</xsl:call-template>
</div>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/PriorYearEstimatedTaxPayments"/>
</xsl:call-template>
</div>
...
<div class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;width:28mm;
      font-size:6pt;padding-top:1mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments"/>
</xsl:call-template>
</div>
...
<div class="styLNDesc" style="width:92mm;height:4.5mm;">
   2012 special estimated tax payments<i> (Do not include on line 29f)</i>
</div>
<div class="styLNRightNumBox" style="height:4.5mm;">29d</div>
<div class="styLNAmountBox" style="height:4.5mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/SpecialEstimatedTaxPayments"/>
</xsl:call-template>
</div>
<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4.5mm;"/>
<div class="styLNAmountBoxNBB" style="height:4.5mm;"/>
...
<div class="styLNDesc" style="width:56mm;font-size:7.5pt;">
    <span style="float: left; clear: none;">Less 2012 refund applied for on 
    Form 4466</span>
<!--<span class="styDotLn" style="float:right;padding-right:2mm;">........</span>-->
</div>
...
font-size:6pt;height:7.5mm;padding-top:3.5mm">(
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/RefundAppliedFor29e"/>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/SumOfLines29aThrough29cLess29e"/>
</xsl:call-template>
</div>
...
<div class="styLNAmountBox" style="height:4.5mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxDepositedWithForm7004"/>
</xsl:call-template>
</div>
<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4.5mm;"/>
<div class="styLNAmountBoxNBB" style="height:4.5mm;"/>
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/UndistributedCapitalGainsCr"/>
</xsl:call-template>
</div>
<div class="styGenericDiv" style="width:22mm;">
<xsl:call-template name="LinkToLeftoverDataTableInline">
<xsl:with-param name="Desc">Line 32f(1) - Backup Withholding Amount</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/UndistributedCapitalGainsCr/@backupWithholdingAmount"/>
...
<div class="styUnderlineAmount">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/CreditForFederalTaxOnFuels"/>
</xsl:call-template>
</div>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/Form2439And4136Credits/@ODCIndicator"/>
</xsl:call-template>
</span><br/>
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/Form2439And4136Credits"/>
</xsl:call-template>
<span style="width:1mm;"/>
</div>
...
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29i"/>
</xsl:call-template>
</div>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29j/@backupWithholdingIndicator"/>
</xsl:call-template>
<xsl:call-template name="LinkToLeftoverDataTableInline">
<xsl:with-param name="Desc">Line 29j - backup Withholding Amount</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29j/@backupWithholdingAmount"/>
</xsl:call-template>
</div>
</div>
<!-- line 29J and 29K-->
...
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/RefundableCredits"/>
</xsl:call-template></span>
<span class="styDotLn" style="float:right;padding-right:2mm;">........</span>
</div>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29k/@backupWithholdingIndicator"/>
</xsl:call-template>
<xsl:call-template name="LinkToLeftoverDataTableInline">
<xsl:with-param name="Desc">Line 29k - backup Withholding Amount</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29k/@backupWithholdingAmount"/>
</xsl:call-template>
</span><br/>
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/USIncomeTaxPaidOrWithheld29k"/>
</xsl:call-template>
<span style="width:1mm;"/>
</div>
</div>
...
<label>
<xsl:call-template name="PopulateLabel">
<xsl:with-param name="TargetNode" select="  $Form1120LData/Form2220Attached"/>
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPenalty"/>
</xsl:call-template>
</div>
</div>
<!-- line 31 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/BalanceDue"/>
</xsl:call-template>
</div>
</div>
<!-- line 32 -->
...
<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/OverpaymentAmount"/>
</xsl:call-template>
</div>
</div>
<!-- line 33 -->
...
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/CreditElect"/>
</xsl:call-template>
</div>
...
<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
<xsl:call-template name="SetFormLinkInline">
<xsl:with-param name="TargetNode" select="  $Form1120LData/OverpaymentSection/Refund"/>
</xsl:call-template>
</div>
...
<span style="width:40px;"/>  
 Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2012)
</div>
</div>
...
<div style="float:left;">Form 1120-L (2012)<span style="width:148mm;"/>
</div>
...
padding-top:1mm;font-weight:normal;border-left-width:0px;" >
...
<td class="styLNDesc" style="width:86mm;height:7mm;">
 <span style="float: left; clear: none;">Domestic corporations,less-than-20%-owned (other than </span>
 <span style="float: left; clear: none;">debt-financed stock)</span>
<!--Dotted Line-->
<span class="styDotLn" style="float:right;padding-right:2mm;">............</span>
</td>
...
<td class="styLNDesc" style="width:84mm;height:7mm;">
 <span style="float: left; clear: none;">Domestic corporations, 20%-or-more-owned (other than </span>
 <span style="float: left; clear: none;">debt-financed stock)</span>
<!--Dotted Line-->
<span class="styDotLn" style="float:right;padding-right:2mm;">............</span>
</td>
...
<td class="styBB" style="width:10mm;height:4mm;vertical-align:bottom;border-left-width:1px;
...
<td class="styBB" style="width:40mm;height:4mm;border-left-width:1px;
...
<div class="styLNDesc" style="width:139mm;height:4mm;">
<span style="float: left; clear: none;">Investment income ratio. Divide line 11 by line 16</span>
<span class="styDotLn" style="float:right;padding-right:2mm;">..........................</span>
</div>
...
<!-- This line was comment out 10-31-2012 to elemenate next empty page -->
<!-- SCH F line 19 blank -->
<!--<div style="width:187mm;">
<div class="styLNLeftLtrBox" style="height:4mm;">
<span style="width:4px;"/>
...
<div style="width:187mm;">
<div class="styLNLeftNumBox" style="height:4.5mm;"/>
<div class="styLNAmountBox" style="height:4.5mm;width:117mm;border-left-width:0px;
...
<div class="styLNAmountBox" style="height:8mm;width:117mm;border-left-width:0px;
...
<div class="styLNAmountBoxNBB" style="height:8mm;border-top-width:1px;padding-top:4.5mm;border-bottom-width:1px;font-size:6.3pt">
<xsl:call-template name="PopulateText">
...
<div class="styLNRightNumBox" style="height:4mm;border-bottom-width:1px;border-bottom-width:0px;height:5mm;"></div>
<div class="styLNAmountBox" style="height:5mm;border-bottom-width:0px">
<!--<xsl:call-template name="PopulateAmount">
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/@section1291InterestAmount"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncome/@cCFIndicator"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/TaxableIncome/@cCFAmount"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
<xsl:with-param name="Desc">Line 32b - Beneficiary Of Trust Indicator</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments/@beneficiaryOfTrustIndicator"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRowAmount">
<xsl:with-param name="Desc">Line 32b - Beneficiary Of Trust Amount</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments/@beneficiaryOfTrustAmount"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
<xsl:with-param name="Desc">Line 32b - Form 8816 Indicator</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments/@f8816Indicator"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRowAmount">
<xsl:with-param name="Desc">Line 32b - Form 8816 Amount</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments/@f8816Amount"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
<xsl:with-param name="Desc">Line 32b - Section 847 Deduction Indicator</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/EstimatedTaxPayments/@section847DeductionIndicator"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">
<xsl:with-param name="Desc">Line 32f(1) - Backup Withholding Indicator</xsl:with-param>
<xsl:with-param name="TargetNode" select="  $Form1120LData/UndistributedCapitalGainsCr/@backupWithholdingIndicator"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRowAmount">
<xsl:with-param name="Desc">Line 32f(1) - Backup Withholding Amount</xsl:with-param>
...
<xsl:with-param name="TargetNode" select="  $Form1120LData/CreditForFederalTaxOnFuels/@ozoneDepletingChemicalsInd"/>
<xsl:with-param name="DescWidth" select="100"/>
</xsl:call-template>
<xsl:call-template name="PopulateLeftoverRow">

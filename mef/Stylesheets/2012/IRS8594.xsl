      ...
      <head>
        <title>
          <xsl:call-template name="FormTitle">
            <xsl:with-param name="RootElement" select="local-name($Form8594Data)"></xsl:with-param>
          </xsl:call-template>
        </title>
        <!-- No Browser Caching -->
...
is at <a href="http://www.irs.gov/form8594" title="Link to IRS.gov">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styNameBox" style="width:120mm;height:8mm;font-size:7pt; padding-left:5mm;">
              ...
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8594Data/Name/BusinessNameLine1">
                </xsl:with-param>
              </xsl:call-template>
              <xsl:if test="$Form8594Data/Name/BusinessNameLine2">
                <br />
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form8594Data/Name/BusinessNameLine2">
                  </xsl:with-param>
                </xsl:call-template>
              </xsl:if>
            </div>
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styNumberBox" style="height:8mm;font-size:7pt;padding-left:8mm;">
              ...
              <xsl:if test="$Form8594Data/USAddressOfOtherParty">
                ...
                <xsl:if test="$Form8594Data/USAddressOfOtherParty/AddressLine2!=''">
                  <br />
                  <xsl:call-template name="PopulateText">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class1FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class1SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class2FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class2SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class3FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class3SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class4FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class4SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class5FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class5SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class6And7FairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class6And7SalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:80mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/TotalFairMarketValue" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:75mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/TotalSalesPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:178mm;height:8mm;">
              ...
              <br />
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8594Data/TaxYearOfOrigFormFiled" />
              </xsl:call-template>
              <span style="width:16px;"></span>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8594Data/TaxReturnFormNumber" />
              </xsl:call-template>
            </div>
          </div>
          <div class="styIRS8594TableContainer">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class1PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class1IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class1RedeterminedAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class2PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class2IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class2RedeterminedAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class3PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class3IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class3RedeterminedAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class4PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class4IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class4RedeterminedAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class5PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class5IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class5RedeterminedAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class6And7PrevPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:37mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class6And7IncreaseDecrease" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/Class6And7RedeterminedAllocn" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="styTableCellText" style="width:60mm;padding-top:5mm;text-align:right;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/TotalOfPreviousPriceAllocation" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                  ...
                  <td class="styTableCellText" style="width:58mm;padding-top:5mm;text-align:right;border-right-width: 0px;">
                    ...
                    <span style="width:2px;"></span>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form8594Data/RedeterminedAllocationTotal" />
                    </xsl:call-template>
                    <span style="width:4px;"></span>
                  </td>
                </tr>

		...
		<html>
			...
			<body class="styBodyClass">
        		...
        		Form <span class="styFormNumber">4684</span>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">Form 4684, Top Left Margin - Revenue Procedure 2009-20 Code</xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form4684Data/@revenueProcedure201036Ind"/>
								<xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">Form 4684, Top Left Margin - Revenue Procedure 200920 IND</xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form4684Data/@revenueProcedure200920Ind"/>
								<xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
							</xsl:call-template>
							<br/>
...
Cost or other basis of each property</span>
 ...
 Enter the <span class="styBoldText"> smaller </span> of line 2 or line 7
	        	...
	        	or Form 1040NR, Schedule A, line 6. Estates and trusts, enter the result on the "Other deductions" line of your tax return.
					...
					<div style="width:187mm;clear:both;padding-bottom:.5mm;" class="styBB">
						<div style="width:75mm;" class="styGenericDiv">Form 4684 (2012)</div>
 ...
 not you filed a claim). See the instructions for	<span>
											...
											<td class="styIRS4684TableCellSmallRB " style="width:5mm;vertical-align:bottom;
													     ...
													     border-top-width:0px;border-bottom-width:1px;border-color:black;">21</td>
													...
													<span class="styGenericDiv" style="width:70mm;font-size:7pt;">
														<span>
															...
															<span style="float:left;padding-left:2mm;">Gain from casualty or theft. If line 21 is <b>more</b>
																...
																claim, or you received payment for your loss<br/><span><span style="float:left;">in a later tax year</span>
																	<span class="styBoldText" style="float:right;padding-right:2mm;">
																		<span class="styDotLn">..........</span>
																	</span>
																</span>
						...
						<xsl:otherwise>
							<table class="styTable" cellspacing="0" style="width:187mm;">
								...
								<tr>
									...
									<td class="styIRS4684TableCellSmallRB " style="width:5mm;vertical-align:bottom;
													     font-weight:bold;border-left-width:1px;border-right-width:0px;padding-left:3.5mm;
													     border-top-width:0px;border-bottom-width:1px;border-color:black;">21
												</td>
									<td class="styTableCellSmall" style="vertical-align:bottom;border-left-width:1px;
												   border-right-width:0px;border-top-width:0px;border-bottom-width:1px;
												   border-color:black">
						...
						<table class="styTable" cellspacing="0">
                          ...
                          ( ($Print = $Separated) and (count($Form4684Data/ShortTermTheftProperty) &lt; 3) )">
							 ...
							 &gt; 2)">
									...
									font-weight:bold;	font-size:7pt;padding-left:1mm">29</td>
										<td class="styTableCell" style="width:81mm;border-top-width: 1px;
					...
					<div class="styBB" style="width:187mm;">
						<div style="width:187mm;">
							...
							<div class="styLNAmountBox" style="height:9mm;padding-top:4mm;width:32mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form4684Data/ShortTermPropNetGainOrLossGrp/ShortTermPropNetGainOrLoss"/>
								</xsl:call-template>
							</div>
						</div>
						<!--  ******************************************************************************  -->
						...
						<div style="width:187mm;">
							...
							<div class="styLNAmountBox" style="height:14mm;padding-top:12mm;width:32mm;
							                    border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form4684Data/ShortTermPropertyIncTotalGrp/ShortTermPropertyIncomeTotal"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
	                     		 ...
	                     		 &lt; 3) )">
									...
									<xsl:if test="count($Form4684Data/LongTermTheftProperty) &lt; 1">
										<tr style="height:4mm;">
											...
											font-size:7pt;padding-left:1mm;">34<span class="styTableCellPad"/>
											</td>
					...
					<div class="styBB" style="width:187;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNRightNumBox" style="height:11.3mm;padding-top:6mm;
							...
							<div class="styLNAmountBox" style="height:12.5mm;padding-top:8mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form4684Data/LongTermPropNetGainOrLossGrp/LongTermPropertyNetGainOrLoss"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:187mm;">
...
Schedule A, line 9. Estates and trusts, enter on the "Other deductions" line of your tax return.<br/>
 Partnerships (except electing large partnerships) and S corporations, see the note below. Electing<br/> 
							...
							<div class="styLNAmountBox" style="height:20.5mm;padding-top:17mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form4684Data/LongTermPropertyIncomeTotalGrp/LongTermPropertyIncomeTotal"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- Line 39 -->
						<div style="width:187mm;">
							...
							<div class="styLNAmountBox" style="height:12mm;padding-top:8mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form4684Data/LongTermPropIncomePlusGainGrp/LongTermPropIncomePlusGain"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:187mm;">
					...
					<div class="styGenericDiv " style="width:187mm;float:none;clear:both;padding-top:1mm;">
						...
						<div style="float:right;clear:none;">Form <span class="styBoldText">4684 </span>(2012)    
						</div>
					</div>
							...
							<xsl:if test="position() mod 4 = 1">
								...
								<table class="styDepTbl" cellspacing="0" style="font-size:7pt">
									...
									<tr class="styDepTblRow2">
										...
										vertical-align:bottom;font-weight:bold;border-color:black;
										border-left-width:1px;border-right-width:0px;border-top-width:0px;
										border-bottom-width:1px;"><span class="styTableCellPad"/>
										</td>
										<td class="styTableCellSmall" style="vertical-align:bottom;
										border-color:black;border-left-width:1px;border-right-width:0px;
...
">6
								...
								<div>
									...
									<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
										...
										<tr class="styDepTblRow1">
											...
											border-left-width:1px;border-right-width:0px;border-top-width:1px;
											border-bottom-width:1px;padding-left:3mm;">20<span class="styTableCellPad"/>
											</td>
											<td class="styTableCellSmall" style="border-color:black;
												border-left-width:1px;border-right-width:0px;
												border-top-width:0px;border-bottom-width:1px;
 ...
 not you filed a claim). See the instructions for	<span>
											...
											border-top-width:1px;font-weight:bold;border-color:black;vertical-align:bottom;
											border-left-width:1px;border-right-width:0px;border-top-width:1px;
											border-bottom-width:1px;padding-left:3mm;">21<span class="styTableCellPad"/>
											</td>
											<td class="styTableCellSmall" style="border-color:black;
												border-left-width:1px;border-right-width:0px;
												border-top-width:0px;border-bottom-width:1px;
										...
										<tr class="styDepTblRow1">
											...
											<td class="styIRS4684TableCellSmallRB " style="width:5mm;vertical-align:bottom;
											  ...
											  border-bottom-width:1px;border-color:black;padding-left:1mm;">22</td>
										...
										<tr class="styDepTblRow2">
											...
											border-top-width:1px;font-weight:bold;border-color:black;
											border-left-width:1px;border-right-width:0px;border-top-width:1px;
											border-bottom-width:1px;padding-left:2mm;">23<span class="styTableCellPad"/>
											</td>
											<td class="styTableCellSmall" style="vertical-align:bottom;
										...
										<tr class="styDepTblRow1">
											...
											border-top-width:1px;font-weight:bold;border-color:black;
											border-left-width:1px;border-right-width:0px;border-top-width:1px;
											border-bottom-width:1px;padding-left:2mm;">24<span class="styTableCellPad"/>
											</td>
											<td class="styTableCellSmall" style="border-color:black;
											border-left-width:1px;border-right-width:0px;border-top-width:0px;
										...
										<tr class="styDepTblRow2">
											...
											border-left-width:1px;border-right-width:0px;
											border-top-	width:0px;border-bottom-width:1px;padding-left:2mm">25<span class="styTableCellPad"/>
											</td>
										...
										<tr class="styDepTblRow1">
											...
											vertical-align:bottom;font-weight:bold;border-color:black;
											border-left-width:1px;border-right-width:0px;border-top-width:0px;
											border-bottom-width:1px;padding-left:2mm">26<span class="styTableCellPad"/>
											</td>
											<td class="styTableCellSmall" style="vertical-align:bottom;
											border-color:black;border-left-width:1px;border-right-width:0px;
											border-top-width:0px;border-bottom-width:1px;font-size:6pt;text-align:right">
...
<span style="float:left;"> enter -0- </span>
											...
											border-top-width:0px;border-bottom-width:1px;padding-left:2mm">27<span class="styTableCellPad"/>
											</td>

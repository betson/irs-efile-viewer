				...
				<form name="IRS8582CR" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						...
						<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:2px;">
							...
							<div style="margin-left:3mm;text-align:left;font-size:7pt;height:11mm;padding-top:2mm;">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;font-size:8.5pt;">
							...
							<span class="styNormalText">
								<span class="styItalicText">
									If you have credits from a publicly traded partnership, see <b>Publicly Traded Partnerships (PTPs)</b> in<br/>
									the instructions.
								</span>
							</span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem" style="">
							<div class="styIRS8582CRLNDesc" style="height:1mm;width:81mm;float:right;padding:0px 0px 0px 0px;">
								<div class="styIRS8582CRLNDesc" style="height:1mm;width:40mm;float:right;padding:0px 0px 0px 0px;">
									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">100%</xsl:with-param>
										<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;</xsl:with-param>
										<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;background-color:lightgrey;</xsl:with-param>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8582CRLineItem">
							...
							<div class="styIRS8582CRLNDesc" style="width:auto;height:10mm;padding:0px 0px 0px 0px;">
								...
								<div class="styIRS8582CRLNDesc" style="width:81mm;height:50%;border-style:dashed;border-color:black;border-bottom-width:1px;"/>

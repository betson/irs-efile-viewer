...
<html lang="EN-US">
  <head>
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form5884AData)"></xsl:with-param></xsl:call-template></title>
    <!-- No Browser Caching -->
    ...
    <style type="text/css">
      <xsl:if test="not($Print) or $Print=''">
        ...
        <xsl:call-template name="IRS5884AStyle"></xsl:call-template>
...
Area Employers</div>      
  ...
  <!-- End Form Number and Name section -->
    ...
    <div class="styBB" style="width:187mm;padding-top:1.5mm; padding-bottom:1.5mm;">
      ...
      SECTION A.<span style="width:10px;"></span>Employee Retention Credit <span class="styNormalText"> (see instructions)</span>
      </div>
    </div>
   ...
   <div class="styBB" style="width:187mm;">    
      ...
      <span style="vertical-align:baseline;height:100%;"></span><span> 1 </span>
        </div>
        <div class="styLNAmountBox" style="height:8mm;">
          <br/>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/QualifiedWgsPdIncurdAftrDsstr"/>
          </xsl:call-template>
        </div>
      ...
      <div style="width:187mm;font-size:8pt;">
        ...
        <div class="styLNDesc" style="width:138mm;height:8mm;padding-top:1.3mm;"><br/>
          ...
          <!--Dotted Line-->
               ...
               <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" select="$Form5884AData/MultiplyLine1By40Pct"/>
               </xsl:call-template>           
        ...
        <span style="height:8mm;background-color:lightgrey;width:7.80mm;"></span>
        2
        </div>
        <div class="styLNAmountBox" style="height:12.2mm;">
        <span style="vertical-align:baseline;height:100%;"></span><span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/MultiplyLine1By40Pct"/>
          </xsl:call-template>
        </span>
    ...
    <!--Line 3 Begin-->
 	<!-- Employee Retention Credit --> 
        ...
        <span style="vertical-align:baseline;height:100%;"></span><span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/EmployeeRetentionCredit"/>
          </xsl:call-template>
        </span>
        </div>
      </div>
  ...
  <!--Line 3 End-->
	...
	<!-- Current Year Credit -->
        ...
        <div class="styLNDesc" style="width:138mm;height:8mm;"><br/>
          ...
          <!--Dotted Line-->
                           	<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="TargetNode" select="$Form5884AData/SectionACurrentYearCredit/@F1041Portion"/>
							</xsl:call-template>
        ...
        <span style="height:14mm;background-color:lightgrey;width:7.80mm;"></span>
        4
        </div>
        <div class="styLNAmountBox" style="height:18.3mm;border-bottom:none;">
        <span style="vertical-align:baseline;height:100%;"></span><span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/SectionACurrentYearCredit"/>
          </xsl:call-template>
        </span>
        </div>
      </div>
     ...
     <div class="styBB" style="width:187mm;padding-top:1.5mm; padding-bottom:1.5mm;">
      <div class="styPartDesc" style="padding-left:0mm;font-size:9pt;float:left;clear:none;">
      SECTION B.<span style="width:10px;"></span>Employee Housing Credit <span class="styNormalText"> (see instructions)</span>
      </div>
    </div>
    ...
    <div class="styBB" style="width:187mm;">    
      ...
      <div class="styLNRightNumBox" style="height:12mm;padding-top:0mm;">
      <span style="vertical-align:baseline;height:100%;"></span><span> 5 </span>
        </div>
        <div class="styLNAmountBox" style="height:12mm;padding-top:4mm;">
          <br/>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/QualifiedLodging"/>
          </xsl:call-template>
        </div>
      </div>
      ...
      <div style="width:187mm;font-size:8pt;">
        ...
        <div class="styLNDesc" style="height:7mm;"><br/>
          ...
          <!--Dotted Line-->
               ...
               <xsl:call-template name="SetFormLinkInline">
                   <xsl:with-param name="TargetNode" select="$Form5884AData/MultiplyLine5By30Pct"/>
               </xsl:call-template>           
       ...
       <div class="styLNRightNumBox" style="height:11.2mm;padding-top:0mm;">
          <div style="height:7.5mm;width:7.80mm;border-left-width:0px;background-color:lightgrey;"></div>
          6          
        </div>        
	...
	<!-- Employer Housing Credit from partnerships, S corporations, cooperatives, estates, and trusts -->  
       ...
       7
        ...
        <span style="vertical-align:baseline;height:100%;"></span><span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/EmployerHousingCredit"/>
          </xsl:call-template>
        </span>
        </div>
      </div>
	...
	<!-- Current Year Credit (add lines 6 and 7) -->
        ...
        <div class="styLNDesc" style="width:138mm;height:8mm;"><br/>
          ...
          <!--Dotted Line-->
                           	...
                           	<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">    </xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form5884AData/SectionBCurrentYearCredit/@F1041Portion"/>
							</xsl:call-template>
       ...
       8
        ...
        <span style="vertical-align:baseline;height:100%;"></span><span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$Form5884AData/SectionBCurrentYearCredit"/>
          </xsl:call-template>
        </span>
        </div>
      </div>
        ...
        <table class="styLeftOverTbl">
          <xsl:call-template name="PopulateCommonLeftover">
            ...
            <xsl:with-param name="DescWidth" select="100"/>
 						...
 						<xsl:if test="$Form5884AData/SectionACurrentYearCredit/@F1041Portion">
							<tr>
              ...
              Current Year Credit (Add Lines 2 and 3):
  						...
  						<xsl:if test="$Form5884AData/SectionBCurrentYearCredit/@F1041Portion">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">

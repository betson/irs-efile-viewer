...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ThreeMonthExtensionToFileStmt" />
  ...
  <xsl:template name="ThreeMonthExtensionToFileStmtTemp">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="ThreeMonthExtensionToFileStmtTemp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

...
<!-- Address --> 
 ...
 <!-- EIN -->
        ...
        <td class="styDepTblCell" style="text-align:center;" >
           <xsl:choose>
                <xsl:when test="ConsolidatedGroupEIN">
                        <xsl:call-template name="PopulateEIN">
                        <xsl:with-param name="TargetNode" select="ConsolidatedGroupEIN" />
                        </xsl:call-template>  
               </xsl:when>
               <xsl:otherwise>
                        <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="ConsolidatedGroupNoEINReason" />
                        </xsl:call-template>  
               </xsl:otherwise>
          </xsl:choose>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/DAFCashGrantsPaidSchedule" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="CGPSTbl" class="styDepTbl" style="width:187mm;">
      ...
      <xsl:for-each select="$DependencyData/DAFCashGrantPaid">
        <tr>
          ...
          <td class="styDepTblCell" nowrap="nowrap" style="text-align:left;width:40mm;">
                ...
                <xsl:call-template name="PopulateUSAddressTemplate"><xsl:with-param name="TargetNode" select="AddressUS" /></xsl:call-template> 
                <xsl:call-template name="PopulateForeignAddressTemplate"><xsl:with-param name="TargetNode" select="AddressForeign" /></xsl:call-template> 
                        </td>            

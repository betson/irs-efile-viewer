...
<body class="styBodyClass" >
  <form name="Form2439">
 	...
 	<xsl:choose>
      ...
      <div class="styIRS2439leftBox" style="width:25mm;height:30mm;text-align:center;">
        ...
        <span style="padding-top:4mm;height:11mm;">
          <div class="styTY" style="padding-top:1mm;font-size:26;">20<span class="styTYColor">12</span></div><br/>
        </span>
      ...
      <div class="styIRS2439rightBox" style="width:75mm;height:30mm;text-align:center;">
        ...
        For calendar year 2012, or other tax year of the <br/>regulated investment company (RIC) or the<br/> 
    ...
    <div style="width:187mm;height:40mm;">
	 ...
	 <xsl:when test="$Form2439Data/MissingEINReason" >
      ...
      <xsl:choose>
       ...
       <xsl:choose>
           ...
           <xsl:if test="$Form2439Data/ShareholderPersonName != ''">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderPersonName" />
                </xsl:call-template>            
           </xsl:if>
           </xsl:otherwise>           
       </xsl:choose>
        ...
        <!-- US Address -->
          <xsl:when test="$Form2439Data/ShareholderUSAddress">
            <xsl:if test="$Form2439Data/ShareholderUSAddress/AddressLine1!='' ">
              <br/><span style="vertical-align:bottom;" valign="bottom"></span>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" 
    ...
    <div style="width:187mm;">
      ...
      <span style="width:7mm;font-size: 7pt;"></span>      

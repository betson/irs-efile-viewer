...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="AFLTbl" class="styDepTbl">
      ...
      <xsl:for-each select="$DependencyData/Affiliate">
        <tr>
          ...
          <td class="styDepTblCell" nowrap="nowrap" style="text-align:left">
            <xsl:choose>
              <xsl:when test="AddressUS">
                ...
                &nbsp;<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="AddressUS/ZIPCode" /></xsl:call-template> 
              </xsl:when>
              <xsl:otherwise>
          ...
          <td class="styDepTblCell" style="text-align:left">            
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="NameControl" /></xsl:call-template>             
          </td>                    
        </tr>
      </xsl:for-each>
    </table>

				...
				<form name="Form8919">
					<xsl:call-template name="DocumentHeader"/>
						...
						<div class="styBB" style="width:187mm;border-bottom:none;">
							...
							<div class="styCodes" style="width:187mm; height:8mm;font-size:7.5pt;padding-left:20mm;">
								...
								<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC from this firm for 2012. The amount on Form 1099-MISC should have been included as wages on Form W-2. <b>(Do not file Form SS-8 if you select reason code H.)</b>
								</span>
								<br/>
							</div>
						</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:4mm;float:left;padding-top:1mm;">
								<span style="float:left;">
									Multiply line 10 by .042 (social secuity tax rate for 2012)
								</span>
									<!--Dotted Line-->
								<span style="float:right;padding-right:3mm;letter-spacing:3.5mm;font-weight:bold;">..............</span>
							</div>									
					...
					<div style="float:left;">
								...
								<div style="float:right;">
								  ...
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2012)
								</div>						
					</div>

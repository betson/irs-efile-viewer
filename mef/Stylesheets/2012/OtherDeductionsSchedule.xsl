...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherDeductionsSchedule" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="ODSTbl" class="styDepTbl">
      ...
      <tfoot></tfoot>
      <tbody>
        <xsl:for-each select="$DependencyData/OtherDeductions">
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:left">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="TypeOfDeduction" />
              </xsl:call-template>
            </td>

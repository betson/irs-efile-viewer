      ...
      <span class="styAgency">Department of the Treasury</span>
        ...
        <span class="styItalicText"> Complete a separate Form 8611 for each building to<br/>which recapture applies.</span>
            ...
            <div class="styTYBox" style="width:30mm;height:19mm; border-left-width: 1px">
              ...
              <div class="stySequence" style="height: 9mm;padding-top:3mm">Attachment<br/>Sequence No. <b>90</b>
              </div>
            </div>
          </div>
          <!--  End title of Form  -->
...
-->                <!--</xsl:otherwise>
       ...
       If building is financed in whole or part with tax-exempt bonds, see instructions and furnish:<br/>
              ...
              <xsl:if test="$FormData/NameOfIssuer/BusinessNameLine2">
                <br/>
                <xsl:call-template name="PopulateText">
    ...
    Form <span class="styBoldText">8611</span> (Rev. 1-2011)
  </div>

              ...
              <tbody>
                <tr>
                  ...
                  <th rowspan="2" class="sty1120FSchIFTBox" style="width:119mm" scope="col">
                    ...
                    <br/>
                      <img src="{$ImagePath}/1120_Bullet_Md.gif" alt="Bullet Image"/>
                    Information about Schedule I (Form 1120-F) and its
separate instructions is available at www.irs.gov/form1120f.
                  </div>
                  </th>
                  <!--OMB/Tax Year-->
   ...
   <!--Line 7a-->
          ...
          <div style="width:187mm;clear:both;padding-top:0.5mm">
            ...
            <div style="float:right;" class="styGenericDiv">
              <b>Schedule I (Form 1120-F) 2012</b>
            </div>
          </div>
          <br/>
          <div class="pageEnd"/>
          ...
          <div class="styTBB" style="width:187mm">
            ...
            <div>Schedule I (Form 1120-F) 2012</div>
          </div>
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchISummaryDescShort"  scope="row">Amount of line 23 that is disallowed as a deduction under section 265, 163(f)(2). etc. or under an income tax treaty (attach statement&#8212;see instructions)
                                 <xsl:call-template name="SetFormLinkInline">
                ...
                <tr>
                  ...
                  <td class="sty1120FSchISummaryDescShort" style="padding-top:1.5mm" scope="row">
                    ...
                    <span style="float:left;">etc. (attach statement &#8212; see instructions) </span> 
                    <div class="sty1120FSchIRightFloat">
                      <span class="sty1120FSchIDotLn">..........</span>
                    </div>
                  <xsl:call-template name="SetFormLinkInline">

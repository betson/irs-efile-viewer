...
<!-- Last Modified by Eugenia McDonald on 09/13/2012 -->
		...
		<html>
          ...
          Internal Revenue Service</span>
						...
						<div class="styTYBox" style="width:30mm;height:12mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="height:7mm;padding-top:1mm;">20<span class="styTYColor">12</span>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">Enter the income statement period:
							...
							<span style="width:25mm;border-bottom:solid 1px;text-align:center">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065ScheduleM3/IncomeStatementBegngDate"/>
								</xsl:call-template>
							</span>
							...
							<span style="width:25mm;border-bottom:solid 1px;text-align:center">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065ScheduleM3/IncomeStatementEndDate"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
         ...
         statement been restated for any of the five income statement periods preceding
          ...
          (If “Yes,” attach an explanation and the amount of each item restated.)
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  Net income from nonincludible foreign entities (attach schedule)
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065ScheduleM3/NetIncomeNonincludibleFrgnEnt"/>
								</xsl:call-template>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;height:4mm">
							  Net loss from nonincludible foreign entities (attach schedule and enter as a positive amount)
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetLossNonincludibleFrgnEnt"/>
								</xsl:call-template>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  Net income from nonincludible U.S. entities (attach schedule)
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetIncomeNonincludibleUSEnt"/>
								</xsl:call-template>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  ...
							  <!-- Form Link -->
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetLossNonincludibleUSEnt"/>
								</xsl:call-template>
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  Net income (loss) of other foreign disregarded entities (attach schedule)
								...
								<xsl:call-template name="SetFormLinkInline">
									...
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetIncomeLossForeignDisrgdEnt"/>
								</xsl:call-template>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  Net income (loss) of other U.S. disregarded entities (attach schedule)
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetIncomeLossOtherDisrgdEnt"/>
								</xsl:call-template>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:138mm;height:4mm">
							  ...
							  <br/> (attach schedule)           
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/AdjToEliminateTransactions"/>
								</xsl:call-template>
								<span class="styDotLn" style="float:none;padding-left:1mm">...........................</span>
							</div>
						</div>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">
							  Adjustment to reconcile income statement period to tax year (attach schedule)
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/AdjRecnclIncmStmtYearToTaxYear"/>
								</xsl:call-template>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:3mm">
								...
								Combine lines 4a through 10<span class="styDotLn" 
								  style="float:none;padding-left:3.5mm">....</span>
							</div>
						</div>
						<div style="float:right;">
							...
							<div class="styLNAmountBox" style="height:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode"
									  select="$Form1065ScheduleM3/NetIncomeLossPerIncomeStmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div style="float:right;width:140mm">
							...
							<div class="styLNAmountBox" style="width:42mm;border-top:solid black 0px;border-right:solid black 1px">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/TotalAmountIncludedTotLiabLn4"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;font-size:6pt;height:3mm">Schedule M-3 (Form 1065) 2012</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1065) 2012</div>
            ...
            <!-- Form Link -->
						...
						<tr>
						  ...
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
							    select="$Form1065ScheduleM3/IncomeLossItems/USDiv/IncomeLossPerIncomeStatement"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
							    select="$Form1065ScheduleM3/IncomeLossItems/USDiv/TemporaryDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
							    select="$Form1065ScheduleM3/IncomeLossItems/USDiv/PermanentDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
							    select="$Form1065ScheduleM3/IncomeLossItems/USDiv/IncomeLossPerTaxReturn"/>
							</xsl:call-template>
						  </td>
						</tr>
						<!-- Part II - Line 7 -->
						<tr>
						  ...
						  <td>Income (loss) from U.S. partnerships
							...
							<xsl:call-template name="SetFormLinkInline">
							  <xsl:with-param name="TargetNode" 
							    select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossUSPartnerships"/>
							</xsl:call-template>
							<span class="styDotLn" style="float:none;padding-left:1mm;">......</span>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
         select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossUSPartnerships/IncomeLossPerIncomeStatement"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
						    select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossUSPartnerships/TemporaryDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
							select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossUSPartnerships/PermanentDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
					 select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossUSPartnerships/IncomeLossPerTaxReturn"/>
							</xsl:call-template>
						  </td>
						</tr>
						<!-- Part II - Line 8 -->
						<tr>
						  ...
						  <td>Income (loss) from foreign partnerships
							...
							<xsl:call-template name="SetFormLinkInline">
							  <xsl:with-param name="TargetNode" 
							    select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships"/>
							</xsl:call-template>
						  ...
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
	  select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships/IncomeLossPerIncomeStatement"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
					     select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships/TemporaryDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
						 select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships/PermanentDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
				 select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships/IncomeLossPerTaxReturn"/>
								</xsl:call-template>
							</td>
						</tr>
						<!-- Part II - Line 9 -->
						<tr>
						  ...
						  <td>Income (loss) from other pass-through entities<xsl:call-template name="SetFormLinkInline">
							  <xsl:with-param name="TargetNode"
			                 	select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities"/>
							</xsl:call-template>
						  ...
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
	 select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities/IncomeLossPerIncomeStatement"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
		               select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities/TemporaryDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode" 
				       select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities/PermanentDifference"/>
							</xsl:call-template>
						  </td>
						  <td class="styIRS1065ScheduleM3Cell">
							<xsl:call-template name="PopulateAmount">
							  <xsl:with-param name="TargetNode"
			    select="$Form1065ScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities/IncomeLossPerTaxReturn"/>
							</xsl:call-template>
				          </td>
						</tr>
						<!-- Part II - Line 10 -->
            ...
            <!-- Form Link -->
              ...
              IncomeLossItems/UnearnedDeferredRevenue/IncomeLossPerTaxReturn"/>
						...
						<tr>
							...
							<td>Income recognition from long-term contracts<span class="styDotLn" 
							style="float:none;padding-left:2.3mm;">....</span>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ...
              IncomeLossItems/IncomeRecognitionLTContracts/IncomeLossPerTaxReturn"/>
						...
						<tr>
							...
							<td>Original issue discount and other imputed interest<span class="styDotLn" 
							style="float:none;padding-left:3.5mm;">..</span>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
...
<!-- Form Link -->
         ...
         Line 26, column (a), must equal the amount on Part I, line 11, and column (d) must equal Form 1065,
Analysis of Net <br/>Income (Loss), line 1.</div>
					<div class="styBB" style="width:187mm;"/>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1065) 2012</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styBB" style="width:187mm;">
...
Return—Expense/Deduction Items
            ...
            ExpenseDeductionItems/JudgmentsDamagesAwardsSmlrCost/ExpensePerIncomeStatement"/>
              ...
              ExpenseDeductionItems/CharitableContriIntangibleProp/DeductionPerTaxReturn"/>
						...
						<tr>
							<td class="styIRS1065ScheduleM3NumberCell">15</td>
							<td style="padding-top:.5mm;">Organizational expenses as per Regulations Section 1.709-2(a)
                               <span class="styDotLn" style="float:none;padding-left:3mm;">...............</span>
                            </td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
              ...
              ExpenseDeductionItems/OtherAmortzImpairmentWriteOffs/DeductionPerTaxReturn"/>
						...
						<tr>
							<td class="styIRS1065ScheduleM3NumberCell">22</td>
							<td>Section 198 environmental remediation costs
							   <span class="styDotLn" style="float:none;padding-left:1mm;">....</span>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
              ...
              ExpenseDeductionItems/PurchaseVersusLease/DeductionPerTaxReturn"/>
						...
						<tr>
							...
							<td style="padding-top:.5mm;">Research and development costs (attach schedule)
            <!-- Form Link -->
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ExpenseDeductionItems/ResearchAndDevelopment"/>
								</xsl:call-template>
								<span class="styDotLn" style="float:none;padding-left:2mm;">.</span>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ExpenseDeductionItems/ResearchAndDevelopment/ExpensePerIncomeStatement"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ExpenseDeductionItems/ResearchAndDevelopment/TemporaryDifference"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ExpenseDeductionItems/ResearchAndDevelopment/PermanentDifference"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1065ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleM3/
              ExpenseDeductionItems/ResearchAndDevelopment/DeductionPerTaxReturn"/>
								</xsl:call-template>
							</td>
						</tr>
						<!-- Part III - Line 30 -->

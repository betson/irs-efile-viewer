...
<!-- 05/12/2011 - Copied from 2010 version and made changes needed for 2011 per UWR #40040 - Jeremy Nichols -->
<!-- 09/12/2011 - Made changes as per defect #29861 - Jeremy Nichols -->
<!-- 09/13/2011 - Made changes as per defect #29863 - Jeremy Nichols -->
<!-- 11/08/2011 - Made changes as per defect #29860 - Jeremy Nichols -->
<!-- 11/09/2011 - Made additional changes per UWR #40040 - Jeremy Nichols -->
<!-- 11/18/2011 - Made changes as per defect #29667 - Jeremy Nichols -->
<!-- 12/14/2011 - Made changes as per defect #31493 - Jeremy Nichols -->
<!-- 07/05/2012 - Made additional changes per UWR #64909 - Jeremy Nichols -->
<!-- 09/14/2012 - Made changes as per defect #33504 - Jeremy Nichols -->
<!-- 09/19/2012 - Made changes as per defect #33325 - Jeremy Nichols -->
        ...
        Check only one box on each form.<br/>
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="padding-left:0;">Part III—Summary of Separate Credits
          ...
          Page <span class="styBoldText" style="font-size: 8pt">3</span>
								...
								<xsl:if test="(count($Form1118ScheduleC/DivAndDeemedInclsnPost1986) &lt; 8) or ((count($Form1118ScheduleC/DivAndDeemedInclsnPost1986) &gt; 7) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleC/DivAndDeemedInclsnPost1986">
										<tr style="height:6mm;">
											...
											<!-- column 4 -->
											<td class="styTableCellSmallArial" style="width:30mm;padding-top:4px;">
									...
									<xsl:otherwise>
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellNW" style="text-align:left;" colspan="11">
												<span class="styBoldText">Total</span> (Add amounts in column 10. Enter the result here and include on "Totals" line of Schedule B, Part I, column 3.)
                        <!--Dotted Line-->
                        <span >
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;padding-left:0;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;padding-left:0;">Part II—Dividends Paid Out of Pre-1987 Accumulated Profits</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellNW" style="text-align:left;" colspan="9">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellNW" style="text-align:left;" colspan="8">
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:13mm" rowspan="2" scope="col">2. <span class="styNormalText">Tax Year End (Yr-Mo) (see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:13mm" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:36mm" rowspan="2" scope="col">4. <span class="styNormalText">Post-1986 Undistributed Earnings (in functional currency—attach schedule)</span>
									</th>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:20mm;" rowspan="2" scope="col">10. <span class="styNormalText">Tax Deemed Paid (multiply column 7 by column 9)</span>
									</th>
								</tr>
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:22mm" scope="col">(a) <span class="styNormalText">Taxes Paid</span>
								...
								<xsl:if test="(count($Form1118ScheduleD/UndistrEarnDividends2ndTier) &lt; 6) or ((count($Form1118ScheduleD/UndistrEarnDividends2ndTier) &gt; 5) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleD/UndistrEarnDividends2ndTier">
										<tr style="height:6mm;">
											...
											<td class="styTableCellSmallArial" style="width:13mm;text-align:center;padding-right:2px;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="TaxYearEnd"/>
												</xsl:call-template>
											</td>
											...
											<td class="styTableCellSmallArial" style="width:36mm;padding-right:2px;">
								...
								<xsl:if test="(count($Form1118ScheduleD/AccumProfitsDividends3rdTier) &lt; 6) or ((count($Form1118ScheduleD/AccumProfitsDividends3rdTier) &gt; 5) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleD/AccumProfitsDividends3rdTier">
										<tr style="height:6mm;">
											...
											<td class="styTableCellSmall" style="width:27mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="DividendsPaidOfSecondTierCorp"/>
												</xsl:call-template>
												<span class="styTableCellPad"/>
          ...
          Page <span class="styBoldText" style="font-size: 8pt">5</span>
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;text-align:left;padding-left:0;">Part I—Tax Deemed Paid by Third-Tier Foreign Corporations
						  <span style="font-weight:normal">(Include the column 10 results in Schedule D, Part II Section A, column 6(b).)</span>
						</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								...
								<xsl:if test="(count($Form1118ScheduleE/UndistrEarnDividends4thTier) &lt; 7) or ((count($Form1118ScheduleE/UndistrEarnDividends4thTier) &gt; 6) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleE/UndistrEarnDividends4thTier">
										<tr style="height:6mm;">
											...
											<td class="styTableCellSmallArial" style="width:28mm;padding-right:2px;">
												<div style="padding-top:.5mm;float: left; clear:none">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="Post1986UndistributedEarnings"/>
													</xsl:call-template>
          ...
          Page <span class="styBoldText" style="font-size: 8pt">7</span>
              ...
              <span class="styItalicText">
					...
					<div class="styBB" style="width:256mm;text-align:left;left-padding:0;">
                      ...
                      corresponding Schedule A.
									...
									<tbody>
										<tr>
											...
											<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm;text-align:left;">See Add'l Data<span style="width:1px;"/>
											</td>
											<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm;">
												<span style="width:1px;"/>
											</td>
											...
											<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm;border-bottom-width:0px;">
												<span style="width:1px;"/>
											</td>
										</tr>
										<tr>
							...
							<tbody>
								<xsl:for-each select="$Form1118ScheduleC/DivAndDeemedInclsnPost1986">
									<tr style="height:6mm;">
										...
										<!-- tester 1 -->
										<td class="styTableCellSmallArial" style="width:44mm;">
											<div class="styGenericDiv" style="float: left; clear:none;">
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleC/DivAndDeemedInclsnPost1986/Post1986UndistributedEarnings"/>
												</xsl:call-template>
...
and 1d from line 1a)</td>
								...
								<tr class="styDepTblRow2">
									<td class="styLNLeftLtrBoxBB" style="height:4.5mm;">a</td>
									<td class="styIRS1118LNDescDed" style="height:4.5mm;">General limitation income</td>
									<td class="styLNAmountBoxSmall" style="height:4.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AvgAstValNonfinclGenCatIncome"/>
										</xsl:call-template>
	...
	<xsl:template name="AddRowsForSchH">
		...
		<xsl:param name="TargetNode"/>
		<td class="styIRS1118LNAmountBoxSmall" valign="top">

...
<!--          <th class="styTblCell" scope="col">Item No.</th>       -->
           ...
           <th class="styDepTblCell"  scope="col">Expense per Income Statement Amount</th>
           ...
           <th class="styDepTblCell" scope="col">Deductions per Tax Return Amount</th>
        </tr>
      </thead>
      <xsl:for-each select="$DependencyData/ResearchAndDevelopmentCost">
        <tr>

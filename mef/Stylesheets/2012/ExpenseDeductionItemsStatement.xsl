		  ...
		  <head>
			...
			<body class="styBodyClass">
				...
				<table id="ILSTbl" class="styDepTblLandscape" style="font-size: 8pt">
				  ...
				  <tfoot/>
					<tbody>
						<xsl:for-each select="$DependencyData/ExpenseDeductionItems">
						  <!-- set row background -->
						  <tr>
							...
							<td class="stydepTblCell" style="width:36mm; text-align:right;padding-top:3mm;">
							  <xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="ExpensePerIncomeStatement"/>
							  </xsl:call-template>
							</td>
							...
							<td class="stydepTblCell" style="width:36mm; text-align:right;padding-top:3mm">
							  <xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="DeductionPerTaxReturn"/>
							  </xsl:call-template>
							</td>
						  </tr>
						</xsl:for-each>

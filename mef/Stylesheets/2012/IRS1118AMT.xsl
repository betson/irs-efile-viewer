...
<!-- 05/14/2011 - Copied from 2010 version and made changes needed for 2011 per UWR #40040 - Jeremy Nichols -->
<!-- 08/22/2011 - Fixed errors listed in defect #29697 - Jeremy Nichols -->
<!-- 11/09/2011 - Made additional changes per UWR #40040 - Jeremy Nichols -->
<!-- 11/17/2011 - Made changes as per defect #29662 - Jeremy Nichols -->
<!-- 12/14/2011 - Made changes as per defect #31507 - Jeremy Nichols -->
<!-- 07/05/2012 - Made additional changes per UWR #64909 - Jeremy Nichols -->
<!-- 09/21/2012 - Made changes as per defect #33335 - Jeremy Nichols -->
	...
	<xsl:template match="/">
        ...
        Check only one box on each form.<br/>
						...
						<div style="height:16mm;width:47mm;float:left;">
							...
							<input type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1118Data/GeneralCategoryIncome"/>
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all amounts in U.S. dollars. See <b>Specific Instructions</b>.)</span>
						...
						<div class="styGenericDiv" style="width:3.2mm;text-align:right;">
							...
							<xsl:call-template name="SetTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData"/>
					...
					<div class="styTableContainerLandscape" id="IBActn" style="height:71mm;">
						...
						<table class="styTable" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 7) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData">
										<tr style="height:6mm;">
											...
											<td class="styTableCellSmall" style="width:29mm;">
												...
												<div style="float:left; clear:none; width: 4mm">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleA/ScheduleAAndScheduleBPartIData/OtherIncomeOrLoss"/>
													</xsl:call-template>
												</div>
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 1) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:choose>
										<xsl:when test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated)">
								...
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 2) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">B</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 3) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">C</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 4) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">D</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 5) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
										<xsl:with-param name="TargetNode">E</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 6) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartI">
					...
					<div class="styIRS1118TableContainerLandscape" style="height:65mm;" id="DEDctn">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 7) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData">
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellLtr">
												<span class="styTableCellPad" style="font-weight:bold">
								...
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 1) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:choose>
										<xsl:when test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated)">
								...
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 2) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartII">
										<xsl:with-param name="TargetNode">B</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 3) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartII">
										<xsl:with-param name="TargetNode">C</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 4) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartII">
										<xsl:with-param name="TargetNode">D</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 5) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartII">
										<xsl:with-param name="TargetNode">E</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &lt; 6) or ((count($Form1118Data/IRS1118AMTScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchAPartII">
										<xsl:with-param name="TargetNode">F</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
          ...
          Form <b style="font-size:8pt;">1118</b> (Rev. 12-2012)
        </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					<!--BEGIN HEADER-->
					<div class="styBB" style="width:256mm">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2012)</div>
						<div style="float:right">
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all foreign tax amounts in U.S. dollars.)</span>
           ...
           <span class="styItalicText" style="font-weight:normal">(see instructions)</span>
							<!--COUNT: <xsl:value-of select="count(Form1118ScheduleA/ScheduleAAndScheduleBPartIData)"/-->
						</div>
						<div class="styGenericDiv" style="width:3mm">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleA/ScheduleAAndScheduleBPartIData"/>
								<xsl:with-param name="containerHeight" select="6"/>
                ...
                1. <span class="styNormalText">Credit is Claimed for Taxes (check one):</span>
							...
							<tfoot/>
							<tbody>
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 7) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print != $Separated))">
									<xsl:for-each select="$Form1118ScheduleA/ScheduleAAndScheduleBPartIData">
										<tr style="height:6mm;">
								...
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 1) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:choose>
										<xsl:when test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated)">
								...
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 2) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchBPartI">
										<xsl:with-param name="TargetNode">B</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 3) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchBPartI">
										<xsl:with-param name="TargetNode">C</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 4) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchBPartI">
										<xsl:with-param name="TargetNode">D</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 5) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchBPartI">
										<xsl:with-param name="TargetNode">E</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="(count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &lt; 6) or ((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="AddRowsForSchBPartI">
										<xsl:with-param name="TargetNode">F</xsl:with-param>
									</xsl:call-template>
								</xsl:if>
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part II—Separate Foreign Tax Credit
          <span class="styItalicText" style="font-weight:normal">(Complete a </span>
					...
					<div style="width:256mm;">
						...
						<div class="styLNAmountBox">
							...
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleB/ForeignTxPdOrAccrByCorpSuspend"/>
							</xsl:call-template>
						</div>
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part III—Summary of Separate Credits
          ...
          Page <span class="styBoldText" style="font-size: 8pt">3</span>
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;text-align:left;padding-left:0;">Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;text-align:left;padding-left:0;">Part II—Dividends Paid Out of Pre-1987 Accumulated Profits</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;text-align:left;padding-left:0;">Part III—Deemed Inclusions From Pre-1987 Earnings and Profits</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
          ...
          specified.</i>
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part I—Tax Deemed Paid by First-Tier Foreign Corporations</div>
					</div>
					<!-- BEGIN SCHEDULE D PART I SECTION A -->
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="stySectionDesc" style="width:251.8mm;text-align:left;padding-left:0;"><span style="width:15mm;"/>Section A—Dividends Paid Out of Post-1986 Undistributed Earnings
          ...
          <span style="font-weight:normal">(Include the column 8(b) results in Schedule C, Part I,
            column 6(b).)
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part II—Tax Deemed Paid by Second-Tier Foreign Corporations</div>
					</div>
         ...
         <span style="font-weight:normal">(Include the column 10 results in column 6(b) of Part II above.)</span>
          ...
          Page <span class="styBoldText" style="font-size: 8pt">6</span>
					...
					<div class="styBB" style="width:256mm;clear:both;border-bottom-width:0px;">
						<div class="styIRS1118ScheduleCell" style="border-bottom:0px;">
							...
							<div class="styIRS1118TableContainerSchF" id="FGIctn">
								...
								<table class="styTable" cellspacing="0" style="height: 82mm;">
									<thead class="styTableThead">
										<tr>
											<th class="styIRS1118TableCellHeaderSmall" colspan="2" style="width:47mm;">
												<b>1. </b>
												<span class="styNormalText"> Foreign Country or U .S. Possession (Enter
											...
											<th class="styIRS1118TableCellHeaderSmall" style="width:39mm;">3. <span class="styNormalText">Definitely Allocable Deductions</span>
											</th>
										</tr>
									</thead>
									<tfoot/>
						...
						<div class="styIRS1118ScheduleCell" style="border-right-width:0px;border-bottom:0px;">
							<div class="styBB">
							...
							<div style="width:127mm;height:5mm;">
								<div class="styIRS1118LNDescRed" style="width:92mm;border-left-width:0px;border-bottom-width:0px;padding-top:1mm;padding-left:1mm;font-size:6pt;">
									<span class="styBoldText"> Total</span> (add lines A through E). Enter here and on Schedule B, Part II, line 3
								</div>
							...
							<div style="width:127mm;float:left;clear:none;border-bottom:0pt;border-top:1pt solid black;padding-top:1mm;padding-bottom:1mm;padding-left:1mm;">
								<span style="width:4mm;vertical-align:top;">1.</span>  
								<span style="width:122mm;">During the tax year, did the corporation pay or accrue any foreign tax that was disqualified for credit under section 901(m)?
								<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">... </span>
								  <span>
									<xsl:call-template name="PopulateSpan">
									  <xsl:with-param name="TargetNode" select="$Form1118ScheduleG/OthInfoPayAccrForeignTxDisqual"/>
									</xsl:call-template>
									<input type="checkbox">
							...
							<div style="width:127mm;float:left;clear:none;border-bottom:0pt;border-top:0pt solid black;padding-top:2mm;padding-bottom:1mm;padding-left:1mm;">
								<span style="width:4mm;vertical-align:top;">2.</span>
								<span style="width:122mm;">During the tax year, did the corporation pay or accrue foreign taxes that were suspended due to the rules of section 909?
								  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">... </span>
								  <span>
									<xsl:call-template name="PopulateSpan">
									  <xsl:with-param name="TargetNode" select="$Form1118ScheduleG/OthInfoPayAccrForeignTxSupend"/>
									</xsl:call-template>
									<input type="checkbox">
									  <xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1118ScheduleG/OthInfoPayAccrForeignTxSupend"/>
							...
							<div style="width:127mm;float:left;clear:none;border-bottom:0pt;border-top:0pt solid black;padding-bottom:1mm;padding-left:1mm;">
								<span style="width:4mm;vertical-align:top;"/>
								<span style="width:122mm;">If the answer to line 2 is &quot;Yes,&quot;, include the reduction amounts on Part I, line E above.</span>
							</div>
						</div>
					</div>
						...
						<div style="float:right;clear:none;">
							<div style="width:100mm;">
								<span style="width:62mm;"/>
								 Form <b style="font-size:8pt;">1118</b> (Rev. 12-2012)</div>
						</div>
          ...
          <span class="styItalicText">
					...
					<div class="styBB" style="width:256mm;">
						<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part I—Research and Development Deductions         </div>
					</div>
					<xsl:choose>
						<xsl:when test="( ( (count($Form1118ScheduleH/SalesMethod) &gt; 2) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesCrtnDivEach1050PFIC) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesSection901jIncome) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesTreatyRscIncome) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/RDDedSection901jIncome) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/RDDedTreatyRscIncome) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/GrossIncomeSection901jIncome) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/GrossIncomeTreatyRscIncome) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/RDDedSect901jIncm) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/RDDedTreatyRscIncm) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/RDDedSection901jIncome) &gt; 1) or
                              (count($Form1118ScheduleH/GrossIncMethod/RDDedTreatyResourcedIncome) &gt; 1) )
                            and ($Print = $Separated))">
							<div style="width:256mm;clear:both;">
								<table class="styTable" cellspacing="0">
									<thead class="styTableThead">
										<tr class="styBB">
											<td class="styIRS1118TableCell" colspan="2" rowspan="3" style="border-left-width:0px;">
												<span style="width:1px;"/>
											</td>
											<td class="styIRS1118TableCell" colspan="4" >
                              ...
                              <td class="styIRS1118TableCell" rowspan="3" style="border-bottom-width:0px;">
                        ...
                        Allocable (enter the sum of all amounts entered in all applicable &quot;R&amp;D Deductions&quot; columns)
										...
										<tr class="styBB">
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #1 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/SICCode"/>
												</xsl:call-template>)*
                      </td>
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #2 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/SICCode"/>
												</xsl:call-template>)*
                      </td>
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #1 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeSICCode"/>
												</xsl:call-template>)*
                      </td>
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #2 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeSICCode"/>
												</xsl:call-template>)*
                      </td>
										</tr>
										<tr class="styBB">
											<td class="styIRS1118TableCell" >
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod" />
                        ...
                        Allocable (enter the sum of all amounts entered in all applicable &quot;R&amp;D Deductions&quot; columns)
										...
										<tr class="styBB">
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #1 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/SalesSICCode"/>
												</xsl:call-template>)*
                      </td>
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #2 (SIC Code: <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/SalesSICCode"/>
												</xsl:call-template>)*
                      </td>
											<td class="styIRS1118TableCell" colspan="2" >
                        Product line #1 (SIC Code: <xsl:call-template name="PopulateText">
                        ...
                        Product line #2 (SIC Code: <xsl:call-template name="PopulateText">
									...
									<tr>
										<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-left:1mm;">1</td>
										<td class="styIRS1118LNDescRD" style="height:8mm;font-size:5pt;">Totals (see instructions)</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDeductionsTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDeductionsTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedTotals"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDedTotalToBeApportioned"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDedTotalToBeApportioned"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedTotToBeApprtn"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedTotToBeApprtn"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDeductionsGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDeductionsGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedGenCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeGeneralCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedGenCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesPassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDeductionsPassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesPassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDeductionsPassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomePassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomePassiveCatIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedPassiveIncome"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
									...
									<tr>
										...
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[1]/GrossSalesSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[1]/RDDedSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDedSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[2]/GrossSalesSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[2]/RDDedSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDedSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[1]/RDDedSect901jIncm)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedSect901jIncm"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeSection901jIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeSection901jIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[2]/RDDedSect901jIncm)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedSect901jIncm"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
									...
									<tr>
										...
										<td class="styIRS1118LNDescRD" style="height:8mm;">Income re-sourced by treaty*</td>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[1]/GrossSalesTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[1]/RDDedTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDedTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[2]/GrossSalesTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[2]/RDDedTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDedTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[1]/RDDedTreatyRscIncm)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedTreatyRscIncm"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeTreatyRscIncome)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeTreatyRscIncome"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
											<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[2]/RDDedTreatyRscIncm)"/>
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedTreatyRscIncm"/>
										</xsl:call-template>
										<xsl:call-template name="AddRowsForSchH">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/GrossSalesTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[1]/RDDeductionsTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/GrossSalesTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[2]/RDDeductionsTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/GrossIncomeTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[1]/RDDedTotalFrgn"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/GrossIncomeTotalForeign"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[2]/RDDedTotalFrgn"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
							...
							<!-- Repeat Column Code -->
							<xsl:for-each select="$Form1118ScheduleH/SalesMethod">
										...
										<table class="styTable" cellspacing="0">
												...
												<tr>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 0]/SalesSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 1"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/SalesSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 2"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/SalesSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 3"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/SalesSICCode"/>
														</xsl:call-template>)*</td>
												</tr>
												<tr>
											...
											<tbody>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDeductionsTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDeductionsTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDeductionsTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDedTotalToBeApportioned"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDedTotalToBeApportioned"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDedTotalToBeApportioned"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												...
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDeductionsGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDeductionsGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDeductionsGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDeductionsPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDeductionsPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDeductionsPassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDedSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDedSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDedSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDedSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDedSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDedSection901jIncome"/>
													</xsl:call-template>
												</tr>
												<tr>
													<td class="styLNLeftLtrBoxBB" style="height:8mm;">d</td>
													...
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDedTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDedTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDedTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDedTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDedSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDedTreatyRscIncome"/>
													</xsl:call-template>
												</tr>
												<tr>
													<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-left:1mm;">4</td>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/GrossSalesTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 1]/RDDeductionsTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/GrossSalesTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 2]/RDDeductionsTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/GrossSalesTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/SalesMethod[$curPos + 3]/RDDeductionsTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
							...
							<!-- Repeat Column Code -->
							<xsl:for-each select="$Form1118ScheduleH/GrossIncMethod">
								<xsl:if test="(position() mod 4) = 3">
									<xsl:variable name="curPos">
										<xsl:value-of select="position()"/>
									</xsl:variable>
										...
										<table class="styTable" cellspacing="0">
											<thead class="styTableThead">
												<tr>
													...
													<td class="styIRS1118TableCell" colspan="8" style="height:4mm;">Gross Income Method</td>
												</tr>
												<tr>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 0]/GrossIncomeSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 1"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 2"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeSICCode"/>
														</xsl:call-template>)*</td>
													<td class="styIRS1118TableCell" colspan="2" style="height:7mm;padding-top:.5mm;">Product line #<xsl:value-of select="$curPos + 3"/>
														<br/>(SIC Code: <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeSICCode"/>
														</xsl:call-template>)*</td>
												</tr>
												<tr>
													<td class="styIRS1118TableCell" style="height:4mm;">Gross Sales</td>
											...
											<tbody>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossIncomeTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDedTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedTotals"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDedTotToBeApprtn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedTotToBeApprtn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedTotToBeApprtn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styShadingCellSmall" style="height:4.5mm;border-bottom-width:1px;">
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedTotToBeApprtn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												...
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossIncomeGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDedGenCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedGenCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedGenCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeGeneralCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedGenCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossIncomePassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDedPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomePassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomePassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomePassiveCatIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:4.5mm">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedPassiveIncome"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
												<tr>
													...
													<td class="styIRS1118LNDescRD">Section 901(j) income*</td>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count(GrossIncomeSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="GrossIncomeSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count(RDDedSect901jIncm)"/>
														<xsl:with-param name="TargetNode" select="RDDedSect901jIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedSect901jIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedSect901jIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedSect901jIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedSect901jIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeSection901jIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeSection901jIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedSect901jIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedSect901jIncm"/>
													</xsl:call-template>
												</tr>
												<tr>
													<td class="styLNLeftLtrBoxBB" style="height:8mm;">d</td>
													<td class="styIRS1118LNDescRD" style="height:8mm;">Income re-sourced by treaty*</td>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count(GrossIncomeTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="GrossIncomeTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count(RDDedTreatyRscIncm)"/>
														<xsl:with-param name="TargetNode" select="RDDedTreatyRscIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedTreatyRscIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedTreatyRscIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedTreatyRscIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedTreatyRscIncm"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeTreatyRscIncome)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeTreatyRscIncome"/>
													</xsl:call-template>
													<xsl:call-template name="AddRowsForSchH">
														<xsl:with-param name="RowCount" select="count($Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedTreatyRscIncm)"/>
														<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedTreatyRscIncm"/>
													</xsl:call-template>
												</tr>
												<tr>
													<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-left:1mm;">4</td>
													...
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="GrossIncomeTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="RDDedTotalFrgn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/GrossIncomeTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 1]/RDDedTotalFrgn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/GrossIncomeTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 2]/RDDedTotalFrgn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/GrossIncomeTotalForeign"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
													<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;padding-top:4mm;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncMethod[$curPos + 3]/RDDedTotalFrgn"/>
														</xsl:call-template>
														<span style="width:1px;"/>
													</td>
												</tr>
					...
					<div style="width:256mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2012)</div>
						</div>
					</div>
					<!--END FOOTER-->
					<div class="pageEnd"/>
									...
									<thead class="styTableThead">
										<tr>
											...
											<td class="styIRS1118TableCell" colspan="2" style="height:22mm;text-align:left;float:none;">
												<span style="width:16px"/>
												<span class="styBoldText">(a)</span>
                Average Value of Assets–Check<br/>
												<span style="width:48px"/>
                 method used:<br/>
												<div>
												<span style="width:2mm"/>
...
and 1d from line 1a)</td>
            ...
            Additional Data        
					...
					<xsl:if test="((count($Form1118ScheduleA/ScheduleAAndScheduleBPartIData) &gt; 6) and ($Print = $Separated))">
                ...
                1. <span class="styNormalText">Credit is Claimed for Taxes:</span>
							...
							<tbody>
								<xsl:for-each select="$Form1118ScheduleA/ScheduleAAndScheduleBPartIData">
									<tr style="height:6mm;">
										...
										<td class="styTableCellSmall" style="width:20mm;text-align:center;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="DatePaid"/>
											</xsl:call-template>
										</td>
					...
					<xsl:if test="( ( (count($Form1118ScheduleH/SalesMethod) &gt; 2) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesCrtnDivEach1050PFIC) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesSection901jIncome) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/GrossSalesTreatyRscIncome) &gt; 1) or
                              (count($Form1118ScheduleH/SalesMethod/RDDedSection901jIncome) &gt; 1) or

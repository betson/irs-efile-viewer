...
<!-- Last Modified by James Ganzy on 11/16/2012 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form1065B">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:34.5mm;height:20mm;">Form 
						...
						<div class="styFTBox" style="width:110mm;height:20mm;">
                            ...
                            <span style="width:17mm;border-bottom:1 solid black;">
                               ...
                               <a href="http://www.irs.gov/form1065b" title="Link to IRS.gov"><i>www.irs.gov/form1065b</i></a>
							</div>
						</div>
						<div class="styTYBox" style="width:42.5mm;height:20mm;">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2012)
                    </div>
					</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2012)<span style="width:148mm;"/>
						</div>
					...
					<!--Dotted Line-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:138mm;height:4mm;">
								<span  style="float:left;clear:none;">Excess of net short-term capital gain over net long-term capital loss (Schedule D, line 22)</span>
      				<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">....</span>
							</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc" style="width:164mm;">Other Information <span style="font-weight:normal;">(see instructions)</span></div>
					</div>
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;">1</div>
      ...
      What type of entity is filing this return? Check the applicable box:
        ...
        Other 
						...
						<div class="styIRS1065BLNYesNoBox" style="height:4mm;background:lightgrey;border-left-width:1;border-right:1;"/>
						<div class="styIRS1065BLNYesNoBox" style="height:4mm;background:lightgrey;"/>
						<div style="width:187mm">
...
and 8813. (See instructions.)
						...
						<div style="width:187mm">
							<div class="styLNLeftNumBox" style="height:4mm">7</div>
							<div class="styLNDesc" style="width:167mm">At any time during calendar year 2012, did the partnership have an interest in or a signature or other authority
    ...
    to this return.
      ...
      <xsl:with-param name="TargetNode" select="($Form1065BData)/IRS1065BScheduleB/ReceivedDistriFromForeignTrust"></xsl:with-param>
					...
					<div class="pageEnd" style="width:187mm;">
                        ...
                        <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2012)
                    </div>
					</div>
					<!-- END Page Break and Footer-->
					<!-- Page Header -->
					...
					<div class="styBB" style="width:187mm;height:3.75mm;">
						...
						(Use Form 8949 to list your transactions for lines 1, 2, 3, 8, 9, and 10.)</span>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;overflow-y:visible">
						<!-- BEGIN PART I TABLE -->
								<div class="" style="width:187mm">
									<div class="styLNDesc"  style="height:14mm;width:57.3mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											Complete Form 8949 before completing line 1, 2, or 3.<br/> This form may be easier to  complete if you round off cents to whole dollars.</div>
										<div class="styLNDesc" style="height:14mm;width:31mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(d)</b> Sales price from<br/>Form(s) 8949, line 2,<br/>column (d)</div>
										<div class="styLNDesc" style="height:14mm;width:37mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(e)</b> Cost or other basis<br/>from Form(s) 8949,<br/>line 2, column (e)
										</div>
										<div class="styLNDesc" style="height:14mm;width:31mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(g)</b> Adjustments to<br/>gain or loss from<br/> Form(s) 8949, line 2,<br/>column (g)
										</div>
										<div class="styLNDesc" style="height:14mm;width:30mm;padding-left:1mm;font-weight:normal;text-align:left;">
											<b>(h) Gain or (loss)</b><br/>Combine columns<br/>(d), (e), and (g)</div>
						...
						<div class="" style="width:187mm">
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:1.5mm;">1</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Short-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;"> with <b>box A</b> checked in <b>Part I</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxA/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxA/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxA/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxA/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxA/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:1.5mm;">2</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Short-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;"> with <b>box B</b> checked in <b>Part I</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxB/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxB/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxB/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxB/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxB/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:1.5mm;">3</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Short-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;"> with <b>box C</b> checked in <b>Part I</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxC/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxC/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxC/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxC/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/ShortTermFromF8949BoxC/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
						<div class="styBB" style="width:187mm">
							<div style="width:187mm">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:1mm;">4</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
                        ...
                        <!--Dotted Line-->
							...
							<div style="width:187mm">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:1mm;">5</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
						    ...
						    <!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="height:4.5mm;width:30.8mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/STCGOrLossLikeKindExchs"/>
									</xsl:call-template>
								</div>
							</div>
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:1mm;">6</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
							...
							<!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height:4.5mm;">6</div>
								<div class="styShadingCell" style="height:4.5mm;width:30.8mm;border-bottom-width: 1px;">
									<!--<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/"/>
									</xsl:call-template>-->
								</div>
							</div>
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:1mm;">7</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<span  style="float:left;clear:none;"><b>Net short-term capital gain or (loss).</b> Combine lines 1 through 5 in column (h)</span>
						    <!--Dotted Line-->
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.........</span>	
								</div>
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">7</div>
						...
						<!-- BEGIN PART II TABLE -->
								<div class="styBB" style="width:187mm">
									<div class="styLNDesc"  style="height:14mm;width:57.3mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											Complete Form 8949 before completing line 8, 9, or 10.<br/> This form may be easier to  complete if you round off cents to whole dollars.</div>
										<div class="styLNDesc" style="height:14mm;width:31mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(d)</b> Sales price from<br/>Form(s) 8949, line 4,<br/>column (d)</div>
										<div class="styLNDesc" style="height:14mm;width:37mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(e)</b> Cost or other basis<br/>from Form(s) 8949,<br/>line 4, column (e)
										</div>
										<div class="styLNDesc" style="height:14mm;width:31mm;padding-left:1mm;font-weight:normal;text-align:left;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
											<b>(g)</b> Adjustments to<br/>gain or loss from<br/> Form(s) 8949, line 4,<br/>column (g)
										</div>
										<div class="styLNDesc" style="height:14mm;width:30mm;padding-left:1mm;font-weight:normal;text-align:left;">
											<b>(h) Gain or (loss)</b><br/>Combine columns<br/> (d), (e), and (g)</div>
						...
						<div class="styBB" style="width:187mm">
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:1mm;">8</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Long-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;">with <b>box A</b> checked in <b>Part II</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxA/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxA/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxA/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxA/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxA/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:1mm;">9</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Long-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;">with <b>box B</b> checked in <b>Part II</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxB/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxB/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxB/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxB/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxB/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
							<div class="styBB" style="width:187mm">
								<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:0mm;">10</div>
								<div class="styLNDesc" style="height:7.5mm;width:52mm;padding-left:.5mm;">Long-term totals from all Forms 8949<br/>
									<span  style="float:left;clear:none;">with <b>box C</b> checked in <b>Part II</b></span>
                        <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">...</span>			 
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxC/SalePrice"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:3.6mm;width:37mm;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxC/CostOrOtherBasis"/>
									</xsl:call-template>
									(<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxC/CostOrOtherBasis"/>
									</xsl:call-template>)
								...
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxC/AdjustmentsToGainOrLoss"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBoxNBB" style="height:7.5mm;padding-top:4mm;width:31mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermFromF8949BoxC/GainOrLoss"/>
									</xsl:call-template>
								</div>
							</div>
						<!-- END PART II TABLE -->
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="height:4mm;width:143.1mm;">
					    ...
					    <!--Dotted Line-->
							...
							<div style="width:187mm;float:right;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">12</div>
								<div class="styLNDesc" style="height:4mm;width:143.1mm;">
						...
						<!--Dotted Line-->
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">13</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
						...
						<!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="height:4.5mm;width:30.8mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/LongTermGainOrLossFromLikeKind"/>
									</xsl:call-template>
								</div>
							</div>
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">14</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<span  style="float:left;clear:none;"><b>Net long-term capital gain or (loss).</b> Combine lines 8 through 13 in column (h)</span>       
						<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.........</span>
								</div>
						...
						<div class="styBB" style="width:187mm">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">15</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<span  style="float:left;clear:none;">Combine lines 7 and 14 and enter the net gain (loss)</span>
						<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">..................</span>
								</div>
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">16</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<span  style="float:left;clear:none;">Enter excess of net short-term capital gain (line 7) over net long-term capital loss (line 14)</span>
						<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.....</span>
								</div>
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">17</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<span  style="float:left;clear:none;"><b>Net capital gain or (loss).</b> Subtract line 16 from line 15</span>
					    <!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.................</span>
								</div>
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0">17</div>
								<div class="styLNAmountBox" style="height:4.5mm;width:30.8mm;border-bottom-width:0">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styBB" style="width:187mm">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">18</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									Redetermine the amount on line 16 by taking into account only gains and losses from passive	loss<br/>
						...
						<!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="height:7.5mm;padding-top:3.5mm;width:30.8mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">19</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<b>Excess of net short-term capital gain over net long-term capital loss. </b> Enter the <b>smaller</b> of the<br/>
									amount on line 16 or line 18. Enter here and on page 1, Part I, line 8
						<!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="height:7.5mm;width:30.8mm;padding-top:3.5mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">20</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">Redetermine the amount on line 17 by taking into account only gains and losses from passive loss<br/>
								limitation activities
						<!--Dotted Line-->
								<span class="styDotLn" style="float:none;clear:none;padding-left:2mm;">...........................</span>
								</div>								<div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">20</div>
								<div class="styLNAmountBox" style="height:7.5mm;width:30.8mm;padding-top:3.5mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">21</div>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<b>Net capital gain or (loss) from passive loss limitation activities. </b> If lines 17 and 20 are both<br/>
									  positive or both negative, enter the <b>smaller</b> of line 17 or line 20. Otherwise, enter -0-. Enter here<br/>
									  and on Schedule K, line 4a
						<!--Dotted Line-->
								<span class="styDotLn" style="float:none;clear:none;padding-left:.5mm;">..........................</span>
								</div>
								<div class="styLNRightNumBox" style="height:10.5mm;padding-top:6.5mm;">21</div>
								<div class="styLNAmountBox" style="height:10.5mm;width:30.8mm;padding-top:6.5mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;"/>
								<div class="styLNDesc" style="width:143.1mm;height:4mm;">
									<b>Note. </b>
									<!--<span class="styBoldText">Note.</span>-->
									<span class="styItalicText">When figuring whether line 17 or line 20 is <b>smaller</b>, treat both numbers as positive.</span>
									<!--Dotted Line-->
								</div>
								<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0;background:lightgrey"/>
								<div class="styLNAmountBox" style="height:4.5mm;width:30.8mm;border-left-width:0;border-bottom-width:0;background:lightgrey"/>
							</div>
						</div>
						<div class="styBB" style="width:187mm;">
							<div class="styPartDesc" style="width:182mm;text-align:center;">
					...
					<div class="styBB" style="width:187mm;">	
						<div style="width:187mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="height:4mm;width:5mm;padding-left:0mm;">22</div>
							<div class="styLNDesc" style="width:143.1mm;height:4mm;">
								<b>Excess of net short-term capital gain over net long-term capital loss. </b>  Subtract line 19 from<br/>
								line 16. Enter here and on page 2, Part II, line 4
						<!--Dotted Line-->
								<span class="styDotLn" style="float:none;clear:none;padding-left:2mm;">...................</span>
							</div>
						...
						<div style="width:187mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="height:7.5mm;width:5mm;padding-left:0mm;">23</div>
							<div class="styLNDesc" style="width:143.1mm;height:7.5mm;">
								<b>Net capital gain or (loss) from other activities. </b> Subtract line 21 from line 17. Enter here and on<br/>
								Schedule K, line 4b       
					    <!--Dotted Line-->
								<span class="styDotLn" style="float:none;clear:none;padding-left:.5mm;">............................</span>
							</div>
							<div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;border-bottom-width:0">23</div>
							<div class="styLNAmountBox" style="height:7.5mm;width:30.8mm;padding-top:3.5mm;border-bottom-width:0">
								<xsl:call-template name="PopulateAmount">
      ...
      Form
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2012)
					...
					<div class="styBB" style="width:187mm;height:3.75mm;">
						<div class="styPartDesc" style="width:148.5mm;border-right:1px solid black;text-align:center;"> (a) Distributive share items. </div>
						<div class="styPartDesc" style="width:38mm;text-align:center;"> (b) Total amount</div>
					</div>
					<!--Line 1a-->
					...
					<div style="width:187mm;float:left;">
						...
						<div class="styLNDesc" style="width:100.1mm;height:4mm;">
					...
					<div style="width:187mm;float:left;">
					  ...
					  Taxable income (loss) from passive loss limitation activities allocated to limited partners. Subtract
						...
						<div class="styLNRightNumBox" style="height:4.3mm;width:8.3mm;border-bottom-width:0;background:lightgrey;border-right-width:1px;"/>
					</div>
					<div style="width:187mm;float:left;">
						<div class="styLNLeftNumBox" style="height:4mm;width:6mm;text-align:right;"/>
					...
					<div style="width:187mm;float:left;">
						...
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
							<span  style="float:left;clear:none;">Net capital gain (loss) from passive loss limitation activities (Schedule D, line 21)</span>
  					<!--Dotted Line-->
							<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">........</span>
						</div>
					...
					<div style="width:187mm;float:left;">
						<div class="styLNLeftNumBox" style="height:4.5mm;width:6mm;padding-left:3mm;">b</div>
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
							<span  style="float:left;clear:none;">Net capital gain (loss) from other activities (Schedule D, line 23)</span>
					<!--Dotted Line-->
							<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">..............</span>
						</div>
        ...
        Name of foreign country or U.S. possession
						...
						<div class="styLNRightNumBox" style="height:4.5mm;width:8.3mm;background:lightgrey;border-bottom-width:0px;border-right-width:1px;"/>
					</div>
					<div style="width:187mm;float:left;">
						<div class="styLNLeftLtrBox" style="height:4.5mm;width:6mm;">b</div>
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
					...
					<div style="width:187mm;float:left;">
						...
						<div class="styLNRightNumBox" style="height:4.5mm;width:8.3mm;border-bottom-width:0px;border-right-width:1px;background:lightgrey"/>
					</div>
					<div style="width:187mm;float:left;">
						<div class="styLNLeftNumBox" style="height:4mm;width:6mm;text-align:right;"/>
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
					...
					<div style="width:187mm;float:left;">
						...
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
							<span  style="float:left;clear:none;"><b>(2) </b> General category</span>
					<!--Dotted Line-->
							<span class="styDotLn" style="letter-spacing:3.2mm;float:right;clear:none;padding-right:2mm;">............................</span>
						</div>
        ...
        Paid
         ...
         Accrued   
					...
					<div class="styBB" style="width:187mm;float:left;">
						...
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">Net income (loss). In column (b), add lines 1c through 4b, 7, and 8. From the result, subtract line 14g
                        <span style="width:2px;"/>
						</div>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2012)
					...
					<!--Dotted Line-->
						...
						<div class="styLNAmountBox" style="height:6.8mm;padding-top:3mm;font-family:arial;font-size:8pt;padding-bottom:0mm;">
							<xsl:call-template name="SetFormLinkInline">
					...
					<!--Line 7a - b-->	
						<div class="styShadingCell" style="height:6.8mm;"/>
						<div class="styLNAmountBox" style="height:6.8mm;font-size:8pt;font-family:arial;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/Loan2PrnOrPersRelated2PrnBOY"/>
							</xsl:call-template>
						</div>
					<!--Line 7a - d-->	
						<div class="styShadingCell" style="height:6.8mm;"/>
						<div class="styLNAmountBox" style="height:6.8mm;font-size:8pt;font-family:arial;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/Loan2PrnOrPersRelated2PrnEOY"/>
							</xsl:call-template>
						</div>
					</div>
					<!--Line 7b-->
				    ...
				    <!--Dotted Line-->
						...
						<div class="styShadingCell" style="height:6.8mm;"/>
						<div class="styLNAmountBox" style="height:6.8mm;font-family:arial;font-size:8pt;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/LoanFromPrnRPersRelated2PrnBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="height:6.8mm;"/>
						<div class="styLNAmountBox" style="height:6.8mm;font-family:arial;font-size:8pt;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/LoanFromPrnRPersRelated2PrnEOY"/>
							</xsl:call-template>
						</div>
					</div>

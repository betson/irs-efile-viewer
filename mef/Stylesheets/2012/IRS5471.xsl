...
Other deductions (attach schedule&#151;exclude provision for
              ...
              <span style="font-size: 7pt; width: 43mm; font-weight: normal;">(See instructions.)</span>
					...
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="width:108mm;font-size:8pt;height:11mm;text-align:center;
						 border-color:black;border-style:solid;border-bottom-width:1px;border-top-width:0;border-left-width:0;border-right-width:0;">
							<b><br/>Assets</b>
						</span>
...
During the tax year, did the foreign corporation own an interest in any trust?
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						section 1.6011-4?
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/PrtcptInReportableTrans"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.................................</span>
						</span>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/ForeignCorpPd901Tax"/>
							</xsl:call-template>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/ForeignCorpPd909Tax"/>
							</xsl:call-template>
...
<br/>
					...
					Name of U.S. shareholder <span style="width:2mm;"/>
								...
								<span style="width:65mm;border-bottom: 1 solid black">
									<xsl:choose>
										<xsl:when test="ShareholderInformation/ShareholderPersonName != ''">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="ShareholderInformation/ShareholderPersonName"/>
											</xsl:call-template>
										</xsl:when>
										<xsl:otherwise>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="ShareholderInformation/ShareholderBusinessName/BusinessNameLine1"/>
											</xsl:call-template>
											<br/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="ShareholderInformation/ShareholderBusinessName/BusinessNameLine2"/>
											</xsl:call-template>
										</xsl:otherwise>
									</xsl:choose>
								</span>					
						Identifying number <span style="width:2mm;"/>
								...
								<span style="width:50mm;border-bottom: 1 solid black; text-align:center;">
									<xsl:choose>
										...
										<xsl:when test="ShareholderInformation/ShareholderMissingEINReason != ''">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="ShareholderInformation/ShareholderMissingEINReason"/>
											</xsl:call-template>
										</xsl:when>
									</xsl:choose>
								</span>

...
<!-- Last Modified by Eugenia McDonald on 11/29/2012 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form1065">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:34.5mm;height:19mm;">
      Form 
            <span class="styFormNumber">1065</span>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="TargetNode" 
								  select="$Form1065Data/QualifyingTherapeuticDiscvCr"/>
							</xsl:call-template>
							<br/>
						...
						<div class="styFTBox" style="width:117.5mm;height:19mm;">
							  ...
							  ending 
								...
								<div style="text-align:left;font-style:7pt">
									...
									<img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MediumBullet"/> 
									  Information about Form 1065 and its separate  <br/>
									<span style="width:30mm"/>instructions is at <i>www.irs.gov/form1065</i>
								</div>
                			</div>
						</div>
					...
					<div style="width:187mm;float:left;clear:left;">
						<div style="width:34mm;height:25.5mm;float:left;clear:left;">
							<div class="styEINDateAssets" style="width:34mm;height:11mm;">
                ...
                <br/>
								<span class="styEINFld">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" 
										  select="$Form1065Data/PrincipalProductOrService"/>
									</xsl:call-template>
								</span>
							</div>
							<div class="styEINDateAssets" style="width:34mm;height:8.5mm;border-bottom-width:1px;
						...
						<div class="styLblNameAddr" style="width:118.5mm;height:29mm;">
							...
							<div class="styNameAddr" style="width:101.5mm;height:10mm;font-size:8px;border-left-width:1px;
							  padding-left:1px;">Name of partnership<br/>
							...
							<div class="styNameAddr" style="width:101.5mm;height:10mm;border-left-width:1px;">
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:89mm;height:9mm;
							  border-left-width:1px;">City or town, state, and ZIP code<br/>
					...
					<div class="styNBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:178mm;">Check applicable boxes:
      ...
      Check accounting method: 
         ...
         Cash
							...
							<input type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065Data/MethodOfAccountingAccrual"/>
      ...
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1065VTImageBox" style="height:45.25mm;padding-top:17mm;">
						...
						<div style="width:181mm;float:right;clear:none">
							...
							<div class="styLNAmountBox" style="height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065Data/GrossReceiptsOrSales"/>
								</xsl:call-template>
							</div>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065Data/Balance"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:181mm;float:right;clear:none;">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm;height:4mm;">
								...
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									...
									<xsl:with-param name="TargetNode"
							          select="$Form1065Data/OrdinaryBusinessIncomeLoss/@ThreeAndOneHalfPercent"/>
								</xsl:call-template>
								<span style="width:1mm"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">
									...
									<xsl:with-param name="TargetNode"
							          select="$Form1065Data/OrdinaryBusinessIncomeLoss/@QlfyTherapeuticDiscoveryCredit"/>
								</xsl:call-template>
								<!--Dotted Line-->
								<span style="width:1.8mm"/>
								<span style=" letter-spacing:3.2mm; font-weight:bold; ">..........</span>
							...
							<div class="styLNAmountBox" style="height:4mm;border-bottom-width:1;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065Data/OrdinaryBusinessIncomeLoss"/>
								</xsl:call-template>
							</div>
						</div>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;">
						<tr>
							<td rowspan="3" style="width:13mm;font-size: 8pt;font-weight:bold;
      ...
      of which preparer has any knowledge.
						...
						<tr>
							...
							<td rowspan="2" style="width:45mm;border-bottom:1 solid black;padding-bottom:1mm;">
								...
								<div style="border-right:3 solid black;border-left:3 solid black;border-bottom:3 solid black;
								  ...
								  May the IRS discuss this return with <br/>the preparer shown below (see
								  <span style="width:10px"/><br/> instructions)?<span style="width:5px"/>
								  <input class="styCkbox" alt="alt" type="checkbox" name="Checkbox" id="dummyidyes" 
										...
										<label for="dummyidyes">
											<xsl:call-template name="PopulateReturnHeaderPartner">
												...
												<xsl:with-param name="BackupName">
												  ReturnHeaderMayIRSDiscussReturnWithPrep</xsl:with-param>
											</xsl:call-template>
										  Yes
										</label>
									</span>
									<input class="styCkbox" alt="alt" type="checkbox" name="Checkbox" id="dummyidno" 
									  style="width:2.8mm;">
										<xsl:call-template name="PopulateReturnHeaderPartner">
											<xsl:with-param name="TargetNode">AuthorizeThirdPartyNoCheckbox
											</xsl:with-param>
											<xsl:with-param name="BackupName">ReturnHeaderMayIRSDiscussReturnWithPrep
											</xsl:with-param>
										</xsl:call-template>
									</input>
									<span class="styBoldText" style="padding-left:0mm">
										<label for="dummyidno">
											<xsl:call-template name="PopulateReturnHeaderPartner">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							  Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2012)
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065 (2012)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm">
						...
						<div class="styIRS1065LNYesNoBox" style="height:4m;border-bottom-width:0; border-left-width:1"/>
                        <div class="styIRS1065LNYesNoBox" style="height:4m;border-bottom-width:0;"/>
						<div class="styIRS1065LNYesNoBox" style="height:6.3mm; border-left-width:1; 
						  border-bottom-width:1;font-weight:normal;padding-top:2mm">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleB/IndivOrEstateOwnIntOfThePrtshp"/>
							</xsl:call-template>
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">At any time during calendar year 2012, 
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">
						  Enter the number of partners that are foreign governments under section 892.
							...
							<span style="height:4mm;width:30mm;border-bottom:dotted 1px;text-align:right;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									  select="$Form1065ScheduleB/NumberOfPartnersUnderSec892"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:5.2mm;right-border-width:0;background:gray;
						  border-bottom-width:0;"/>
						<div class="styIRS1065LNYesNoBox" style="height:5.2mm;background:gray;
						  border-bottom-width:0;"/>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:95mm;padding-top:1mm;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleB/TMPNameOrMemberManager"/>
							</xsl:call-template>
						</div>
						<div class="styGenericDiv" style="width:23mm;">
						...
						<div class="styGenericDiv" style="width:35mm;padding-top:1mm;">
							<xsl:choose>
								<xsl:when test="not($Form1065ScheduleB/TMPNumberEIN) or
								 $Form1065ScheduleB/TMPNumberEIN=''">
									<xsl:call-template name="PopulateSSN">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:call-template name="PopulateForeignAddressTemplate">
										<xsl:with-param name="TargetNode" 
										  select="$Form1065ScheduleB/TMPForeignAddress"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<span class="styBoldText" style="width:40mm;height:4mm;border-left:1 solid black;
						  padding-left:13mm;">Total Amount</span>
					</div>
							...
							<tbody>
								...
								<tr>
									<td>
										...
										<span class="styIRS1065LNDesc" style="height:4mm;">Net rental real estate income
								...
								<tr>
									...
									<td>
										...
										<span class="styLNAmountBox" style="height:4mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												  select="$Form1065ScheduleK/InterestIncome"/>
											</xsl:call-template>
										</span>
									</td>
								</tr>
								...
								<tr>
									<td>
										<span>
											<span class="styIRS1065LNLeftLtrBoxTD" style="height:4mm;">c</span>
											<span class="styIRS1065LNDesc" style="height:4mm;">Unrecaptured section 1250
								...
								<tr>
								  <td>
									<div class="styGenericDiv" style="width:132mm;height:4mm;padding-top:.5mm;
									    padding-bottom:.5mm;float:left;clear:none;">
										<span class="styIRS1065LNLeftLtrBoxTD">c</span>
										<span class="styIRS1065LNDesc" style="width:65mm;height:4mm;">
										  Section 59(e)(2) expenditures:<span style="width:8mm"/>
										  <span class="styBoldText">(1)</span>
										Type <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
										</span>
									    <div class="styIRS1065LNDesc" style="width:36mm;padding-left:.3mm;height:4mm;
									      padding-top:.5mm;padding-bottom:.5mm;border-bottom:1 solid black;">
										  <xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleK/Section59e2ExpendituresType"/>
										  </xsl:call-template>
									  	</div>
										<div style="width:22mm;text-align:left;height:4mm;padding-top:.5mm;
										  padding-bottom:.5mm;float:right;clear:none">
										  <span class="styBoldText">(2)</span>
								...
								<tr>
								  <td style="border-bottom:1px solid black;">
									...
									<span class="styIRS1065LNDesc" style="width:54mm;padding-bottom:0mm;
								      padding-top:0mm;">
									...
									<span style="float:left;padding-left:0mm">
									  ...
									  <span style="width:35mm;padding-left:.3mm;">
										<xsl:call-template name="PopulateText">
										  <xsl:with-param name="TargetNode" 
								...
								<tr>
									<td style="border-bottom:1px solid black;">
										...
										<span class="styIRS1065LNDesc">Other AMT items (attach statement)
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" 
												  select="$Form1065ScheduleK/OtherAMTItems"/>
											</xsl:call-template>
										</span>
										<span style="float:right;">
											<span class="styIRS1065DotLn">..................</span>
            ...
            (vi)<span class="styNormalText" style="font-size:6pt;"> Nominee/Other</span>
							...
							<tbody>
								...
								<xsl:choose>
									<xsl:when test="
									count($Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeGenPartners) &gt; 0">
										<xsl:for-each
										  select="$Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeGenPartners">
								...
								<xsl:choose>
									<xsl:when test="
									count($Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeLtdPartners) &gt; 0">
										<xsl:for-each 
										  select="$Form1065Data/AnalysisOfNetIncomeLoss/AnalysisPartnerTypeLtdPartners">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNAmountBox" style="text-align:center;border-bottom-width:0px;width:56mm;
						  height:4mm;">Beginning of tax year</div>
						<div class="styLNAmountBox" style="text-align:center;border-bottom-width:0px;width:56mm;
						  height:4mm;">End of tax year</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/TradeNotesAcctReceivableBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/TradeNotesAcctReceivableEOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/USGovernmentObligationsBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/USGovernmentObligationsEOY"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/TaxExemptSecuritiesBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/TaxExemptSecuritiesEOY"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/MortgageRealEstateLoansBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-size:7pt;font-family:arial;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/MortgageRealEstateLoansEOY"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/BldgOtherDepreciableAssetsBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/BldgOtherDepreciableAssetsEOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
					</div>
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedDepreciationBOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/AccumulatedDepreciationBOY2"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedDepreciationEOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedDepreciationEOY2"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/AccumulatedDepletionBOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/AccumulatedDepletionBOY2"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/AccumulatedDepletionEOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedDepletionEOY2"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedAmortizationBOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/AccumulatedAmortizationBOY2"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedAmortizationEOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/AccumulatedAmortizationEOY2"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNFormLinkBox" style="height:5.5mm;">
							...
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/OtherCurrentLiabilitiesBOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBoxFormLink" style="width:23mm;height:5.5mm;font-family:arial;
						  font-size:7pt;padding-right:.5mm;">
						...
						<div class="styLNFormLinkBox" style="height:5.5mm;">
							...
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/OtherCurrentLiabilitiesEOY"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBoxFormLink" style="width:23mm;height:5.5mm;font-family:arial;
						  font-size:7pt;padding-right:.5mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/PartnersCapitalAccountsBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:5mm;"/>
						<div class="styLNAmountBox" style="width:28mm;height:5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$Form1065ScheduleL/PartnersCapitalAccountsEOY"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNAmountBoxNBB" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/TotalLiabilitiesCapitalBOY"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="width:28mm;height:4.5mm;"/>
						<div class="styLNAmountBoxNBB" style="width:28mm;height:4.5mm;font-family:arial;font-size:7pt;
						  padding-right:.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								  select="$Form1065ScheduleL/TotalLiabilitiesCapitalEOY"/>
							</xsl:call-template>
						</div>
					</div>
							...
							<tbody>
								<tr>
									...
									<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;width:31mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											  select="$Form1065ScheduleM1/NetIncomeLoss"/>
										</xsl:call-template>
										<span style="width:1px;"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
										...
										<div class="styIRS1065BBText" style="width:23mm;float:left;text-align:right;
										  font-size:6pt;">
											<span style="width:1px;"/>
										</div>
									</td>
									<td class="styLNAmountBox" style="border-bottom-width:0px;border-right-width:1px;
									  width:31mm;">
								...
								<tr>
									...
									<td class="styLNAmountBox" style="border-right-width:1px;width:31mm;padding-top:3mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM1/GuaranteedPayments"/>
										</xsl:call-template>
										<span style="width:1px;"/>
									</td>
								</tr>
								<tr>
									...
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
									  ...
									  included on Schedule K, lines 1 through 13d, and 16l (itemize):
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM1/ExpensesRecOnBksNotIncluded"/>
										</xsl:call-template>
									</td>
									<td class="styLNAmountBoxNBB" style="border-right-width:1px;width:31mm;">
										<span style="width:1px;"/>
									...
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
										...
										<div class="styIRS1065BBText" style="width:23mm;float:left;text-align:right;
										  font-size:6pt;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode"
												  select="$Form1065ScheduleM1/Depreciation"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</div>
									</td>
									...
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
										...
										<div class="styIRS1065BBText" style="width:23mm;float:left;text-align:right;font-size:6pt;
										  padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode"
												  select="$Form1065ScheduleM1/TravelEntertainment"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</div>
									</td>
								...
								<tr class="styGenericDiv" style="height:4.5mm;">
									<td class="styLNLeftNumBox" style="height:4.5mm;"/>
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;padding-right:.5mm;"
									 colspan="2"/>
									<td class="styLNAmountBoxNBB" style="border-right-width:1px;width:31mm;">
										<span style="width:1px;"/>
									</td>
								...
								<tr class="styGenericDiv" style="height:4.5mm;">
									<td class="styLNLeftNumBox" style="height:4.5mm;"/>
									<td class="styGenericDiv" style="width:50mm;height:4.5mm;padding-right:.5mm;"
									 colspan="2">
										<div class="styIRS1065BBText" style="width:50mm;height:4.5mm;text-align:right;
										  font-size:6pt;"/>
									</td>
									<td class="styLNAmountBox" style="border-bottom-width:0px;border-right-width:1px;
									  width:31mm;">
										<xsl:attribute name="style">padding-left:1mm;border-right-width:1px;width:31mm;
										</xsl:attribute>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											  select="$Form1065ScheduleM1/ExpensesRecOnBksNotIncluded"/>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:52mm;height:4.5mm;" 
									  colspan="2">Add lines 1 through 4
									    <!--Dotted Line-->
										<span class="styBoldText">
											<span style="width:16px"/>.
											<span style="width:16px"/>.
									...
									<td class="styLNAmountBoxNBB" style="height:4.5mm;border-right-width:1px;
									  width:31.5mm;padding-top:1.5mm;padding-bottom:1mm;">
										<xsl:call-template name="PopulateAmount">
						...
						<table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								<tr class="styGenericDiv">
									...
									<td class="styGenericDiv" style="width:51.5mm;height:4.5mm;" colspan="2">
									  ...
									  on Schedule K, lines 1 through 11 (itemize):
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" 
											  select="$Form1065ScheduleM1/TotalIncomeRecordedNotIncluded"/>
										</xsl:call-template>
									</td>
								...
								<tr class="styGenericDiv" style="width:51.5mm;">
									...
									<td class="styIRS1065BBText" style="width:23mm;font-size:6pt;text-align:right;
									  font-family:verdana;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											  select="$Form1065ScheduleM1/TaxExemptInterest"/>
										</xsl:call-template>
										<span style="width:1px;"/>
									</td>
								...
								<tr class="styGenericDiv">
									...
									<td class="styGenericDiv" style="width:51.5mm;height:4.5mm;" colspan="2">
									  ...
									  book income this year (itemize):
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM1/TotalDeductionsNotCharged"/>
										</xsl:call-template>
									</td>
									<td class="styLNAmountBoxNBB" style="width:31mm;">
										<span style="width:1px;"/>
								...
								<tr class="styGenericDiv" style="width:51.5mm;">
									...
									<td class="styIRS1065BBText" style="width:23mm;font-size:6pt;text-align:right;
									  font-family:verdana;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM1/DepreciationDeduction"/>
										</xsl:call-template>
									</td>
									<td class="styLNAmountBoxNBB" style="width:31mm;height:9mm;">
										<span style="width:1px;"/>
								...
								<tr class="styGenericDiv">
									...
									<td class="styGenericDiv" style="width:52mm;height:5.5mm;" 
									  colspan="2">Add lines 6 and 7
										<!--Dotted Line-->
										<span class="styBoldText">
											<span style="width:15px"/>.
											<span style="width:15px"/>.
									...
									<td class="styLNAmountBox" style="height:5.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM1/TotalIncomeDeductions"/>
										</xsl:call-template>
										<span style="width:1px;"/>
									</td>
								</tr>
								<tr class="styGenericDiv">
									...
									<td class="styLNAmountBox" style="height:5mm;border-bottom-width: 0px;
									  padding-top:1mm">
										<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;clear:both;" class="styBB">
						...
						<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							<tr class="styGenericDiv">
								<td class="styLNLeftNumBox" style="height:4.5mm;">1</td>
								<td class="styGenericDiv" style="width:52mm;height:4.5mm;" 
								  colspan="2">Balance at beginning of year
								<!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
										<span style="width:16px"/>.
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										  select="$Form1065ScheduleM2/CashCapitalContributed"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
							</tr>
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										  select="$Form1065ScheduleM2/PropertyCapitalContributed"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
							</tr>
							<tr class="styGenericDiv">
								...
								<td class="styGenericDiv" style="width:52mm;height:4.5mm;" 
								  colspan="2">Net income (loss) per books
									<!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
									    <span style="width:16px"/>.
								...
								<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										  select="$Form1065ScheduleM2/NetIncomeLossPerBooks"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
							</tr>
							<tr class="styGenericDiv">
								...
								<td class="styLNDesc" style="width:52mm;height:4.5mm;vertical-align:bottom;
								  padding-top:1.5mm;" colspan="2">
									<div class="styGenericDiv" style="width:40mm;">Other increases (itemize):
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode"
											  select="$Form1065ScheduleM2/TotalOtherIncreases"/>
										</xsl:call-template>
									</div>
							...
							<tr class="styGenericDiv" style="height:4.5mm;">
								<td class="styLNLeftNumBox" style="height:4.5mm;"/>
								<td class="styGenericDiv" style="width:52mm;height:4.5mm;padding-right:2mm;" 
								  colspan="2">
									<div class="styIRS1065BBText" style="width:49mm;text-align:right;height:4.5mm;
									  padding-right:3mm;"/>
								</td>
								<td class="styLNAmountBox" style="border-bottom-width:0px;border-right-width:1px;
								  width:31mm;">
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBoxNBB" style="height:4.5mm;border-right-width:1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										  select="$Form1065ScheduleM2/BalanceIncomeOtherIncreases"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
							</tr>
						...
						<table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										  select="$Form1065ScheduleM2/PropertyDistribution"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
							</tr>
								...
								<td class="styLNDesc" style="width:52mm;height:4.5mm;vertical-align:bottom;
								  padding-top:1.5mm;" colspan="2">
									<div class="styGenericDiv" style="width:40mm;">Other decreases (itemize):
									   <xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" 
											  select="$Form1065ScheduleM2/TotalOtherDecreases"/>
										</xsl:call-template>
									</div>
									<div class="styIRS1065BBText" style="width:9mm;float:left;"/>
								</td>
					...
					<table class="styLeftOverTbl">
						...
						<xsl:if test="$Form1065Data/QualifyingTherapeuticDiscvCr">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:130mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
	...
	<xsl:template name="FrnTran">
		...
		<tr>
			<td>
				...
				<span class="styIRS1065LNDesc" style="height:4mm;">Passive category
                          <img src="{$ImagePath}/1065_Bullet_Md.gif" alt="MidSizeBullet"/>
					<span style="width:22mm;font-family:arial; font-size:7pt; text-align:right; border-bottom:1 solid black;
					  height:4mm;">
						<xsl:call-template name="PopulateAmount">
		...
		<tr>
			<td>
				...
				<span style="font-size:7pt; font-weight:bold; padding-left:3mm; height:4mm; padding-top:1.2mm;">k
				</span>
				<span style="width:1mm;"/>
				<span style="font-size:7pt; height:4mm; vertical-align:bottom;padding-top:1.2mm;">Other
                    <xsl:call-template name="SetFormLinkInline">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="FundraiserActivityInformationSize" select="count($Form990ScheduleGData/FundraiserActivityInformation)" />
        ...
        <form name="Form990ScheduleG">
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styFNBox" style="width:33mm;padding-top:1mm;">
              ...
              <div style="padding-top:2mm;padding-bottom:0.8mm;">
            ...
            <div class="styFTBox" style="width:122mm;">
              ...
              <div class="styFBT" style="margin-top:0mm;font-weight:bold;" >
                <span style="width:122mm;font-size:5.5pt;font-weight:bold;">
					Complete if the organization answered "Yes" to Form 990, Part IV, lines 17, 18, or 19, or if the organization 
					entered more than $15,000 on Form 990-EZ, line 6a.  Form 990-EZ filers are not required to complete this part.
				</span>
                <span style="width:122mm;font-size:5.5pt;font-weight:bold;"><img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>Attach to Form 990 or Form 990-EZ.  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>See separate instructions. </span>
              </div>
            </div>
        ...
        <div class="styNBB" style="width:187mm">
          ...
          <div class="IRS990ScheduleG_TableContainer" style="border-top-width: 0px" id="P1ctn"> 
            <xsl:call-template name="SetInitialState"/> 
              <table class="styTable" cellspacing="0" cellpadding="0" style="font-size:7pt;overflow-y:auto;">
                ...
                <tbody>
                  ...
                  <xsl:if test="($Print != $Separated) or count($Form990ScheduleGData/FundraiserActivityInformation) &lt;= 10">
            ...
            <div class="styBB" style="width:187mm; padding-bottom:.5mm;">  
              <div style="float:left;">Schedule G (Form 990 or 990-EZ) 2012</div>
            ...
            <table class="styTable" style="font-size: 7pt;width:187mm;" cellspacing="0">
              ...
              <tbody valign="top">
                ...
                <tr>
                  ...
                  <td class="styLNAmountBox" style="width:32mm; border-right-width:0px;text-align:right;padding-top:2mm;">
					<xsl:choose>
						<xsl:when test="$Form990ScheduleGData/EventsInformation/DirectExpenseSummaryEvents &lt; 0">
                ...
                <tr>
                  ...
                  <td style="height:4mm;padding-top:.5mm;" colspan="4">
                    <span class="styNormalText" style="font-size:7pt;">Net income summary. Combine line 3, column (d), and line 10. </span>
          ...
          <tr>
            ...
            <tr>
              ...
              <td class="styLNAmountBox" style="width:32mm; border-top-width:1px;border-right-width:0px;text-align:right;">
				<xsl:choose>
					<xsl:when test="$Form990ScheduleGData/GamingInformation/DirectExpenseSummaryGaming &lt; 0">
						<xsl:call-template name="PopulateNegativeNumber">
 ...
 <xsl:if test="string-length($Form990ScheduleGData/ExplanationIfYes) &lt;1">
   <div class="IRS990ScheduleG_LineContainer">
    ...
    <div class="pageEnd" style="width:187mm;">
      ...
      <span style="font-weight:bold;font-size:6pt;">Schedule G (Form 990 or 990-EZ) 2012</span>
    </div>
 
     <!-- PAGE 3 HEADER  -->
 <div class="styBB" style="width:187mm; padding-bottom:.5mm;border-bottom-width:1.75px;">  
    <div style="float:left;font-size;6pt;">Schedule G (Form 990 or 990-EZ) 2012</div>
 ...
 <div class="styBB" style="width:187mm;">  
  ...
  <div class="styBB" style="width:187mm;">
    ...
    <div class="styPartDesc" style="width:170mm;padding-bottom:.5mm;">
      <span class="styNormalText">  
        <b>Supplemental Information.</b> Complete this part to provide the explanations required by Part I, line 2b,
            ...
            <table cellspacing="0" class="styDepTbl" cellpadding="0" style="font-size:7pt;">
              <thead class="styTableThead">
                <tr class="styDepTblHdr">
                  ...
                  <th class="styDepTblCell" scope="col" style="width:50mm;height:5mm;text-align:center;font-size:7pt;font-weight:normal;border-color:black;">Return Reference </th>

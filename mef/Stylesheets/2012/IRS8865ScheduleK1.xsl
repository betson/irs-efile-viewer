...
-->
          ...
          OMB No. 1545-1668</span>
					...
					<tr>
						<td style="width: 92.75mm;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2012, or tax year beginning
                ...
                <span style="width: 20mm; border-bottom: 1px solid black; text-align: center;">
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 8mm;">
										...
										<span style="width: 5mm;"/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignEntityIdentificationGrp/ForeignEntityReferenceNumber"/>
											</xsl:call-template>
									</td>
								</tr>							
								<tr>
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 24mm;">
										...
										<span style="width: 75mm;">
											...
											<xsl:otherwise>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/PartnerPersonName"/>
												</xsl:call-template>
												<br/>
											</xsl:otherwise>
											</xsl:choose>	
        ...
        * See attached statement for additional information.
					...
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 1px solid black;">
							...
							<span style="width: 1mm;"/>
							<span style="width: 43mm;">Schedule K-1 (Form 8865) 2012</span>
						</td>
					</tr>
				</table>

			...
			<span>
				<xsl:choose>
					<xsl:when
						...
						<button tabIndex="1" class="sty1040PREnglishBtn" name="1040PR English Button" id="1040PREnglishBtn" 
					...
					<xsl:when
						...
						<span style="width:70px;" />
						<button tabIndex="1" class="sty1040PRSpanishBtn" name="1040PR Spanish Button" id="1040PRSpanishBtn" 

  ...
  <span style="width:1mm;"/>
    ...
    . See page 4 of the instructions.
      ...
      <div style="float:left;font-size:6pt;width:104mm;font-family:verdana;">
								<xsl:choose>
									<xsl:when test="$Form8697Data/PersonName">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8697Data/PersonName" />
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
      ...
      <span style="width:20mm;float:right;"/>
						...
						<table cellspacing="0" summary="Table displaying entity name or names and corresponding employer identification numbers" style="font-size:7pt;" name="TYTable" id="TYTable">
							...
							<tr>
								...
								<td class="styTableCell" style="margin-left:2mm;width:139mm;border-color:black;border-left:none;border-right-width:1px;text-align:left;border-bottom:none;font-size:6pt;font-family:verdana;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8697Data/NameOfPassThroughEntity/BusinessNameLine1"/>
									</xsl:call-template>
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8697Data/NameOfPassThroughEntity/BusinessNameLine2"/>
									</xsl:call-template>
								</td>
								<td class="styTableCell" style="width:44mm;border-color:black;text-align:left;padding-left:1mm;border-left:none;border-right:none;border-bottom:none;">
									<xsl:call-template name="PopulateEIN">
										<xsl:with-param name="TargetNode" select="$Form8697Data/EINOfPassThroughEntity"/>
									</xsl:call-template>
          ...
          border-right-width:0px;border-left-width:0px;padding-top:2mm;float:none;clear:both;">
					...
					<xsl:variable name="PriorYearCount" select="count($Form8697Data/RegularMethodRedetermYr/AdjustedTaxableIncomeForLkBck)"/>
					<xsl:variable name="FilingYearCount">
						<xsl:value-of select="count($Form8697Data/RegularMethodFilingYear/TaxableIncomeOrLoss)"/>
					</xsl:variable>
					...
					<xsl:choose>
						<xsl:when test="($PriorYearCount  &gt; '2') and ($Print = $Separated)">
							<table style="width:187mm;" id="TP1ctn">
								<xsl:call-template name="SetInitialState"/>
								<table cellspacing="0" summary="Table located under line C, having four columns and eight rows" style="width:187mm;border-top-width:0px;font-size:7pt;border-style: solid; border-color: black;
        border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;">
          ...
          <span style="width:2mm;"/>
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/TaxableIncomeOrLoss">
														<xsl:choose>
															<xsl:when test="substring(../YearEndedDate,6,7)=''">
																<xsl:value-of select="substring(../YearEndedDate,6,7)"/>
																<span style="width:2mm;"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:value-of select="substring(../YearEndedDate,6,7)"/>
            ...
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/TaxableIncomeOrLoss">
														<xsl:value-of select="substring(../YearEndedDate,1,4)"/>
													</xsl:for-each>
												</span>
											</span>
										</td>
									...
									<tr>
												...
												<xsl:when test="$FilingYearExists = 'true'">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/TaxableIncomeOrLoss">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="../TaxableIncomeOrLoss"/>
														</xsl:call-template>
													</xsl:for-each>
												</xsl:when>
												<xsl:otherwise>
										...
										<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr/TaxableIncomeOrLoss"/>
          ...
          <!-- Form Link to Additional Data -->
										...
										<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
											<xsl:choose>
												<xsl:when test="$FilingYearExists = 'true'">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/AdjustmentToIncome">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="../AdjustmentToIncome"/>
														</xsl:call-template>
													</xsl:for-each>
												</xsl:when>
												<xsl:otherwise>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/AdjustmentToIncome">
          ...
          Adjusted taxable income for look-back purposes. Combine lines 1 and 2.  If line 3 is a negative amount, see instructions.
										...
										<td class="styForm8697TableCell" rowspan="1">
											<xsl:choose>
												<xsl:when test="$FilingYearExists = 'true'">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/AdjustedTaxableIncomeForLkbck">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="../AdjustedTaxableIncomeForLkbck"/>
														</xsl:call-template>
													</xsl:for-each>
												</xsl:when>
												<xsl:otherwise>
          ...
          <span style="width:2mm;"/>
										...
										<td class="styForm8697TableCell" rowspan="1">
											<xsl:choose>
												<xsl:when test="$FilingYearExists = 'true'">
													<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/TaxLiabilityAmt">
														<xsl:call-template name="PopulateAmount">
        ...
        border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;">
          ...
          <span style="width:2mm;"/>
            ...
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/TaxableIncomeOrLoss">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styTableCell" rowspan="1" style="width:29mm;text-align:center;font-weight:bold;border-color:black;">
							<!--				(a)   -->
            ...
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
															<xsl:choose>
																<xsl:when test="substring(../YearEndedDate,1,4)=''"/>
																<xsl:otherwise>
																	<xsl:value-of select="substring(../YearEndedDate,1,4)"/>
																</xsl:otherwise>
															</xsl:choose>
...
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
										...
										<td class="styForm8697TableCell" rowspan="1" style="border-right:0px;border-top:1px;border-color:black;border-style:solid;">
											<xsl:choose>
												<xsl:when test="$PriorYearCount  &lt;= '2'">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackRegularMethod/TotalAdjustmentToIncomeAmt"/>
													</xsl:call-template>
												</xsl:when>
												<xsl:otherwise>
													<span style="width:1mm;"/>
          ...
          Adjusted taxable income for look-back purposes. Combine lines 1 and 2.  If line 3 is a negative amount, see instructions.
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/AdjustedTaxableIncomeForLkbck">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../AdjustedTaxableIncomeForLkbck"/>
...
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
          ...
          <span style="width:2mm;"/>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/TaxLiabilityAmt">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../TaxLiabilityAmt"/>
...
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
          ...
          years <span style="width:2mm;"/>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/IncomeTaxLiabilityOnReturn">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../IncomeTaxLiabilityOnReturn"/>
													</xsl:call-template>
												</td>
											</xsl:if>
										</xsl:for-each>
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
          ...
          line 4.<span style="width:4mm;"/>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/IncreaseOrDecreaseInTaxForPY">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../IncreaseOrDecreaseInTaxForPY"/>
													</xsl:call-template>
												</td>
											</xsl:if>
										</xsl:for-each>
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
          ...
          page 4 of the instructions)<span style="width:4mm;"/>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/InterestDueOnIncrease">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../InterestDueOnIncrease"/>
													</xsl:call-template>
												</td>
											</xsl:if>
										</xsl:for-each>
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
										...
										<td class="styForm8697TableCell" rowspan="1" style="border-right:none;">
											<xsl:choose>
												<xsl:when test="$PriorYearCount  &lt;= '2'">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackRegularMethod/TotalInterestDueOnIncrease"/>
													</xsl:call-template>
												</xsl:when>
												<xsl:otherwise>
													<span style="width:1mm;"/>
          ...
          <span style="width:2mm;"/>
										...
										<xsl:for-each select="$Form8697Data/RegularMethodRedetermYr/InterestToBeRefundedOnDecrease">
											<xsl:if test="position() &lt;= 2 ">
												<td class="styForm8697TableCell" rowspan="1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="../InterestToBeRefundedOnDecrease"/>
													</xsl:call-template>
												</td>
											</xsl:if>
										</xsl:for-each>
<!--										<xsl:if test="$PriorYearCount &lt; '1'">
										...
										<td class="styForm8697TableCell" rowspan="1" style="border-right:none;">
											<xsl:choose>
												<xsl:when test="$PriorYearCount  &lt;= '2'">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackRegularMethod/TotalInterestToBeRefunded"/>
													</xsl:call-template>
												</xsl:when>
												<xsl:otherwise>
													<span style="width:1mm;"/>
      ...
      <span style="width:2mm;"/>
						...
						<div class="styLNAmountBox" style="float:right;clear:all;border-top-width:0px;border-bottom:none;width:30mm;height:7.5mm;">
							...
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackRegularMethod/NetAmountOfInterestYouOwe"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Footer line -->
...
<!--							<xsl:call-template name="PopulateAmount">
      ...
      Form 8697 to your tax return. See page 6 of the instructions for where to include this amount on your return<span style="width:2mm;"/>
						...
						<div class="styLNAmountBox" style="float:right;clear:all;border-top-width:0px;border-bottom:none;width:30mm;height:7.5mm;">
							<span style="width:30mm;"/>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackSmplfdMthdGrp/NetAmountOfInterestYouOwe"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="page-break-after:always"/>
...
has any knowledge. </td>
      ...
      Date<br/>
        ...
        Additional Data        
					...
					<xsl:if test="($Print = $Separated) and (count($Form8697Data/RegularMethodFilingYear) &gt; 3)">
						<span class="styRepeatingDataTitle">
							<br/>Form 8697, Part I - Regular Method:
    </span>
						<xsl:for-each select="$Form8697Data/RegularMethodFilingYear">
							<xsl:variable name="pos" select="position()"/>
                ...
                (<xsl:number value="$pos" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
											<td class="styDepTblCell" style="width:29mm;text-align:center;font-weight:bold;">
                (<xsl:number value="$pos+1" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos + 1]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos + 1]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
											<td class="styDepTblCell" style="width:29mm;text-align:center;font-weight:bold;">
                (<xsl:number value="$pos+2" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos +2 ]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$pos + 2]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
										...
										<tr class="styDepTblRow1">
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos]/TaxableIncomeOrLoss"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 1]/TaxableIncomeOrLoss"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 2]/TaxableIncomeOrLoss"/>
												</xsl:call-template>
											</td>
                ...
                Schedule K-1 or a similar statement.
											...
											<td class="styDepTblCell" style="vertical-align:bottom;text-align:right;width:29mm">
												<div style="text-align:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos]/AdjustmentToIncome"/>
													</xsl:call-template>
												</div>
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos]/AdjustmentToIncome"/>
											...
											<td class="styDepTblCell" style="vertical-align:bottom;text-align:right;width:29mm">
												<div style="text-align:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos+1]/AdjustmentToIncome"/>
													</xsl:call-template>
												</div>
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 1]/AdjustmentToIncome"/>
											...
											<td class="styDepTblCell" style="vertical-align:bottom;text-align:right;width:29mm">
												<div style="text-align:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos+2]/AdjustmentToIncome"/>
													</xsl:call-template>
												</div>
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 2]/AdjustmentToIncome"/>
                ...
                <span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos]/AdjTaxableIncomeForLookBack"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 1]/AdjTaxableIncomeForLookBack"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 2]/AdjTaxableIncomeForLookBack"/>
												</xsl:call-template>
											</td>
                ...
                Income tax liability on line 3 amount using tax rates in effect for the prior years (see page 4 of the instructions)
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos]/TaxLiabilityAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 1]/TaxLiabilityAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$pos + 2]/TaxLiabilityAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="background-color:lightgrey;width:29mm;border-top:none;border-bottom:none"/>
										</tr>
                ...
                years <span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos]/IncomeTaxLiabilityOnReturn"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 1]/IncomeTaxLiabilityOnReturn"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 2]/IncomeTaxLiabilityOnReturn"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="background-color:lightgrey;width:29mm;border-top:none;border-bottom:none"/>
										</tr>
                ...
                line 4<span style="width:4mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 1]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 2]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
                ...
                page 4 of the instructions)<span style="width:4mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 1]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 2]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
                ...
                <span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 1]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$pos + 2]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<!-- If this is the first Part I Table, then display the total amounts in the (d) column -->
                ...
                (<xsl:number value="$pos" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
											<td class="styDepTblCell" style="width:29mm;text-align:center;font-weight:bold;">
                (<xsl:number value="$pos+1" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos + 1]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos + 1]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
											<td class="styDepTblCell" style="width:29mm;text-align:center;font-weight:bold;">
                (<xsl:number value="$pos+2" format="a"/>)<span style="width:2px"/>
												...
												<span style="float:left;clear:all;width:29mm;font-weight:normal">mo
                  <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos + 2]/YearEndedDate,6,7)"/>
													</span>
													<span style="width:1mm;"/>yr.
                  <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
														<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$pos + 2]/YearEndedDate,1,4)"/>
													</span>
												</span>
											</td>
											<td class="styDepTblCell" style="width:29mm;text-align:center;">
										...
										<tr class="styDepTblRow1">
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<div style="text-align:left;">
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/AdjustmentToRegularTxblIncome"/>
													</xsl:call-template>
												</div>
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/AdjustmentToRegularTxblIncome"/>
                ...
                page 6 of the instructions)
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/PriorYearRegTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 1]/PriorYearRegTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 2]/PriorYearRegTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="background-color:lightgrey;width:29mm;border-top:none;border-bottom:none"/>
										</tr>
                ...
                <span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/PriorYearAltMinTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 1]/PriorYearAltMinTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 2]/PriorYearAltMinTaxIncrOrDecr"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="background-color:lightgrey;width:29mm;border-top:none;border-bottom:none"/>
										</tr>
                ...
                <span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 1]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 2]/IncreaseOrDecreaseInTaxForPY"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="background-color:lightgrey;width:29mm;border-top:none"/>
										</tr>
                ...
                6 of the instructions)<span style="width:2mm;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 1]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 2]/InterestDueOnIncrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<span style="width:1mm;"/>
												...
												<xsl:if test="$pos = 1">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackSmplfdMthGrp/TotalInterestDueOnIncrease"/>
													</xsl:call-template>
												</xsl:if>
											</td>
										</tr>
                ...
                line 7 (see page 6 of the instructions)<span style="width:px;"/>
											...
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 1]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$pos + 2]/InterestToBeRefundedOnDecrease"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="text-align:right;vertical-align:bottom;width:29mm">
												<span style="width:1mm;"/>
	...
	<xsl:template name="part1Table">
        ...
        border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;">
          ...
          <span style="width:2mm;"/>
           ...
           <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodFilingYear[$index*3-2]/YearEndedDate,6,7)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$index*3-2]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodFilingYear[$index*3-2]/YearEndedDate,1,4)=''">
											<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$index*3-2]/YearEndedDate,1,4)"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodFilingYear[$index*3-2]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodRedetermYr[$index*3-1]/YearEndedDate,6,7)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodRedetermYr[$index*3-1]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodRedetermYr[$index*3-1]/YearEndedDate,1,4)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodRedetermYr[$index*3-1]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
							</span>
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodRedetermYr[$index*3]/YearEndedDate,6,7)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodRedetermYr[$index*3]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/RegularMethodRedetermYr[$index*3]/YearEndedDate,1,4)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/RegularMethodRedetermYr[$index*3]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
							</span>
					...
					<tr>
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<xsl:if test="$index=0 and $Part1Max=0">
								<xsl:call-template name="PopulateAdditionalDataTableMessage">
									<xsl:with-param name="TargetNode" select="$Form8697Data/TaxableIncomeOrLoss"/>
									<xsl:with-param name="ShortMessage" select="'true'"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$index*3-2]/TaxableIncomeOrLoss"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/TaxableIncomeOrLoss"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/TaxableIncomeOrLoss"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCellEmptyGray" rowspan="1">
							<span style="width:1mm;"/>
          ...
          <!-- Form Link to Additional Data -->
						...
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<div style="text-align:left;">
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$index*3-2]/AdjustmentToIncome"/>
								</xsl:call-template>
							</div>
							<br/>
							<xsl:call-template name="PopulateAmount">
						...
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<div style="text-align:left;">
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/AdjustmentToIncome"/>
								</xsl:call-template>
							</div>
							<br/>
							<xsl:call-template name="PopulateAmount">
						...
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
							<div style="text-align:left;">
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/AdjustmentToIncome"/>
								</xsl:call-template>
							</div>
							<br/>
							<xsl:call-template name="PopulateAmount">
          ...
          Adjusted taxable income for look-back purposes. Combine lines 1 and 2.  If line 3 is a negative amount, see instructions.
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$index*3-2]/AdjTaxableIncomeForLookBack"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/AdjTaxableIncomeForLookBack"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/AdjTaxableIncomeForLookBack"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCellEmptyGray" rowspan="1">
							<span style="width:1px;"/>
          ...
          <span style="width:2mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodFilingYear[$index*3-2]/TaxLiabilityAmt"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/TaxLiabilityAmt"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/TaxLiabilityAmt"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCellEmptyGray" rowspan="1">
							<span style="width:1px;"/>
          ...
          years <span style="width:2mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/PriorYearIncomeTaxLiability"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/PriorYearIncomeTaxLiability"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCellEmptyGray" rowspan="1">
							<span style="width:1px;"/>
          ...
          line 4.<span style="width:4mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/PriorYearTaxIncreaseOrDecrease"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/PriorYearTaxIncreaseOrDecrease"/>
							</xsl:call-template>
						</td>
						<td class="styTableCell" rowspan="1" style="width:29mm;background-color:lightgrey;border-right:none;">
							<span style="width:1px;"/>
          ...
          page 4 of the instructions)<span style="width:4mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/InterestDueOnIncrease1"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/InterestDueOnIncrease1"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1" style="border-right:none;">
							<xsl:choose>
								<xsl:when test="$index = $Part1Max">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8697Data/TotalInterestDueOnIncrease"/>
									</xsl:call-template>
								</xsl:when>
								<xsl:otherwise>
									<span style="width:1mm;"/>
          ...
          <span style="width:2mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3-1]/InterestToBeRefundedOnDecr1"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodRedetermYr[$index*3]/InterestToBeRefundedOnDecr1"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1" style="border-right:none;">
							<xsl:choose>
								<xsl:when test="$index = $Part1Max">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8697Data/TotalInterestToBeRefunded"/>
									</xsl:call-template>
								</xsl:when>
								<xsl:otherwise>
									<span style="width:1mm;"/>
	...
	<xsl:template name="part2Table">
		...
		<xsl:if test="$index &lt;= $Part2Max">
          ...
          <!-- Form Link to Additional Data -->
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3-2]/YearEndedDate,6,7)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3-2]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3-2]/YearEndedDate,1,4)=''">
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3-2]/YearEndedDate,1,4)"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3-2]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3-1]/YearEndedDate,6,7)=''">
                </xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3-1]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3-1]/YearEndedDate,1,4)=''"/>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3-1]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
							</span>
            ...
            <span class="styFixedUnderline" style="width:5mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3]/YearEndedDate,6,7)=''">
											<xsl:value-of select="''"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3]/YearEndedDate,6,7)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
								<span style="width:1mm;"/>yr.
            <span class="styFixedUnderline" style="width:8mm;float:none;padding-bottom:0;">
									<xsl:choose>
										<xsl:when test="substring($Form8697Data/SimplifiedMethodComputation[$index*3]/YearEndedDate,1,4)=''">
											<xsl:value-of select="''"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="substring($Form8697Data/SimplifiedMethodComputation[$index*3]/YearEndedDate,1,4)"/>
										</xsl:otherwise>
									</xsl:choose>
								</span>
							</span>
						...
						<td class="styForm8697TableCell" rowspan="1" nowrap="nowrap">
							<xsl:choose>
								...
								<xsl:otherwise>
									<div style="text-align:left;">
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3-2]/AdjustmentToRegularTxblIncome"/>
										</xsl:call-template>
									</div>
									<br/>
									<xsl:call-template name="PopulateAmount">
          ...
          6 of the instructions)<span style="width:2mm;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3-2]/InterestDueOnIncrease"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3-1]/InterestDueOnIncrease"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3]/InterestDueOnIncrease"/>
							</xsl:call-template>
						</td>
						<td class="styTableCell" rowspan="1" style="width:29mm;text-align:right;border-color:black;border-right:none;vertical-align:bottom;padding-bottom:1mm;">
							<xsl:choose>
								<xsl:when test="($index = $Part2Max) and (($Print != $Separated) or (count($Form8697Data/SimplifiedMethodComputation) &lt;= 3))">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8697Data/TotLookBackSmplfdMthdGrp/TotalInterestDueOnIncrease"/>
									</xsl:call-template>
								</xsl:when>
								<xsl:otherwise>
									<span style="width:1mm;"/>
          ...
          line 7 (see page 6 of the instructions)<span style="width:px;"/>
						...
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3-2]/InterestToBeRefundedOnDecrease"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3-1]/InterestToBeRefundedOnDecrease"/>
							</xsl:call-template>
						</td>
						<td class="styForm8697TableCell" rowspan="1">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8697Data/SimplifiedMethodComputation[$index*3]/InterestToBeRefundedOnDecrease"/>
							</xsl:call-template>
						</td>
						<td class="styTableCell" rowspan="1" style="width:29mm;text-align:right;border-color:black;border-right:none;vertical-align:bottom;padding-bottom:1mm;">
							<xsl:choose>
...
is not a number</xsl:if>
	...
	<xsl:template name="Page1">
		...
		<xsl:variable name="PriorYearCount">
			<xsl:value-of select="count($Form8697Data/RegularMethodFilingYear/AdjTaxableIncomeForLookBack)"/>
		</xsl:variable>
...
-->
        ...
        border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;">
          ...
          Adjusted taxable income for look-back purposes. Combine lines 1 and 2.  If line 3 is a negative amount, see instructions.
					...
					<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/AdjTaxableIncomeForLookBack">
						<xsl:if test="(position() &gt;= ($StartingPage*2-1)) and (position() &lt;= $StartingPage*2)">
							<td class="styForm8697TableCell" rowspan="1">
								<xsl:call-template name="PopulateAmount">
          ...
          years <span style="width:2mm;"/>
					...
					<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/PriorYearIncomeTaxLiability">
						<xsl:if test="(position() &gt;= ($StartingPage*2-1)) and (position() &lt;= $StartingPage*2)">
							<td class="styForm8697TableCell" rowspan="1">
								<xsl:call-template name="PopulateAmount">
          ...
          line 4.<span style="width:4mm;"/>
					...
					<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/PriorYearTaxIncreaseOrDecrease">
						<xsl:if test="(position() &gt;= ($StartingPage*2-1)) and (position() &lt;= $StartingPage*2)">
							<td class="styForm8697TableCell" rowspan="1">
								<xsl:call-template name="PopulateAmount">
          ...
          page 4 of the instructions)<span style="width:4mm;"/>
					...
					<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/InterestDueOnIncrease1">
						<xsl:if test="(position() &gt;= ($StartingPage*2-1)) and (position() &lt;= $StartingPage*2)">
							<td class="styForm8697TableCell" rowspan="1">
								<xsl:call-template name="PopulateAmount">
          ...
          <span style="width:2mm;"/>
					...
					<xsl:for-each select="$Form8697Data/RegularMethodFilingYear/InterestToBeRefundedOnDecr1">
						<xsl:if test="(position() &gt;= ($StartingPage*2-1)) and (position() &lt;= $StartingPage*2)">
							<td class="styForm8697TableCell" rowspan="1">
								<xsl:call-template name="PopulateAmount">

		...
		<html>
				...
				<form name="Form4797">
					...
					<div class="styTBB" style="width:187mm;height:23mm;">
						...
						<div class="styTYBox" style="width:30mm;height:23mm;">
							...
							<div class="styTY" style="height:16.9mm;">20<span class="styTYColor">12</span>
							</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:133mm;">Enter the gross proceeds from sales or
						  exchanges reported to you for 2012 on Form(s) 1099-B or 
						...
						<div class="styLNDesc" style="width:146mm;">
							...
							<div style="float:right;">
								...
								<span style="width: 10mm;border-bottom:1 solid black;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form4797Data/PALCd"/>
									</xsl:call-template>
								</span>
							</div>
						</div>
          ...
          of your return and skip lines a and b below. For individual returns, complete lines a and b below:
            ...
            on line 18a. Enter here and on Form 1040,
			  ...
			  Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2012)
			</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 4797 (2012)<span style="width:148mm;"/>
						</div>

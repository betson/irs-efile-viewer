...
bar to display in line data. -->
                ...
                <div style="width:3.2mm;float:right;clear:all;text-align:right;">
					...
					<div class="styTableContainer" style="width:187mm;" id="line6Tctn">
                        ...
                        <br/>
								...
								<!-- Line 6 has 1 record -->
								<xsl:if test="($Print != $Separated) or (count($Form8886Data/PersonsYouPaidAFeeInfo)=1)">										<tr style="width:187mm;">
								...
								<xsl:if test="count($Form8886Data/IdentifyAllInvolvedInTr) &lt; 1 or ((count($Form8886Data/IdentifyAllInvolvedInTr) &gt;2) and ($Print = $Separated))">
									...
									<tr style="width:187mm;">
										...
										<td style="width:127mm;border-color:black;border-left-width:0px;border-style:solid;border-right-width:0px;border-top-width:0px;border-bottom-width:1px;" valign="bottom">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form8886Data/IdentifyAllInvolvedInTr/BusinessNameInvolvedInTr/BusinessNameLine1"/>
											</xsl:call-template>
											<span class="styTableCellPad"/>
										</td>
							...
							<tbody>
								<xsl:for-each select="$Form8886Data/PersonsYouPaidAFeeInfo">
									<tr class="styDepTblHdr" style="width:187mm;">
										<!-- Define background colors to the rows -->
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<td class="styDepTblCell" style="width:6mm;float:left;font-weight:bold;padding-left:2mm;" rowspan="2" valign="top">
											<xsl:number value="position()" format="a"/>
										</td>
										<td class="styDepTblCell" style="width:80mm;padding-left:3px;text-align:left;">Name
                        <br/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="NameOfPersonYouPaidFee"/>
											</xsl:call-template>
										...
										<td class="styDepTblCell" style="width:40mm;padding-left:3px;text-align:left;font-weight:normal;">Identifying number (if known)
                            <br/>
											<span valign="center">
												<xsl:choose>
													<xsl:when test="SSNNumberPersonPaidFee">
										...
										<td class="styDepTblCell" style="width:40mm;padding-left:3px;text-align:left;border-bottom-width:1px;" colspan="2">Fees paid
                            <br/>
                              $ <span style="width:4mm;"/>
											<span style="text-align:right;width:20mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="FeesPaid"/>
												</xsl:call-template>
											</span>
									...
									<tr class="styDepTblHdr" style="width:187mm;">
										<!-- Define background colors to the rows -->
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<td class="styDepTblCell" style="width:86mm;padding-left:3px;text-align:left;" colspan="1">Number, street, and room or suite no.
                        <br/>
											<!-- A Choice of US or Foreign Street Address-->
											<xsl:choose>
												<!-- US Street Address -->
										...
										<td class="styDepTblCell" style="width:40mm;padding-left:3px;text-align:left;font-weight:normal;">City or  town
                            <br/>
											<!-- A choice of US or Foreign -->
											<xsl:choose>
												<!-- US -->
										...
										<td class="styDepTblCell" style="width:15mm;padding-left:3px;text-align:left;font-weight:normal;">State
                            <br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="USAddressPersonPaidFee//State"/>
														</xsl:call-template>&#160;</td>
													<td class="styDepTblCell" style="width:20mm;padding-left:3px;text-align:left;font-weight:normal;">Zip code
                            <br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="USAddressPersonPaidFee//ZIPCode"/>
														</xsl:call-template>
   ...
   <span style="padding-left:0px;font-weight:normal;text-align:left;vertical-align:bottom" valign="bottom">
                                 ...
                                 <span style="width:2px;"/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="$Form8886Data/IdentifyAllInvolvedInTr/BusinessNameInvolvedInTr/BusinessNameLine2"/>
													</xsl:call-template>

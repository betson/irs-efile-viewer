...
<!-- Last Modified by James Ganzy on 01/19/2011 -->
				...
				<form id="Form1040">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:65mm;padding-right:1mm;padding-top:6px;height:42px;">
							<span class="styAgency">Department of the Treasury&#8212;Internal Revenue Service</span><span style="width:4mm;"/>(99)<br/>
						...
						<div class="styTYBox" style="width:18mm;border-right-width:1px;height:42px;padding-top:7px;">
							<span class="styTaxYear">20<span class="styTYColor">12</span></span>
						</div>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS1040HeaderCell" style="width:141.8mm;height:4mm;">
							For the year Jan. 1&#8211;Dec. 31, 2012, or other tax year beginning <span style="width:2mm;"/>
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<div class="styIRS1040HeaderCell" style="width:45mm;height:10mm;padding-top:6px;border-right-width:0px;">
								<div class="styGenericDiv" style="width:5mm;padding-top:0.5mm;"><img alt="Up-pointing triangle" src="{$ImagePath}/1040_Bullet_Up2.gif" height="22" width="22"/></div>
...
-->
                           ...
                           <xsl:call-template name="LinkToLeftoverDataTableInline">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:116.2mm;padding-left:1.5mm;float:left;clear:none;">
									...
									<span style="width:3mm;"/><span style="padding-top:1mm;">
						...
						<div style="width:162.5mm;float:left;clear:none;">
                           ...
                           Health savings account deduction. 
                              <span class="styAgency" style="font-size:8pt;">Attach Form 8889 </span> 
									  <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData/HealthSavingsAccountDedAmt"/></xsl:call-template>
									</span>
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.</span>
								</div>
								<span style="float:right;">
                           ...
                           <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData/MovingExpensesAmt"/></xsl:call-template>
                           </span>
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.....</span>
								</div>
								<span style="float:right;">
                           ...
                           Student loan interest deduction 
							...
							<div style="width:162.5mm;">
							   ...
							   <xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData/TuitionAndFeesDedAmt"/></xsl:call-template>
                           </span>
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.....</span>
								</div>
								<span style="float:right;">
							...
							<div style="width:162.5mm;">
                              ...
                              Attach Form 8903 </span>
										<xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData/DomesticProductionActDedAmt"/></xsl:call-template>
										<span style="width:2px;"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
               ...
               Form <span class="styBoldText" style="font-size:10pt;">1040</span> (2012)
               </span>
					</div>
					<!-- end page 1 footer -->
					<!-- page 2 -->
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<span class="" style="float:left;clear:none;">Form 1040 (2012)</span>
					...
					<div class="styBB" style="width:187mm;padding-top:0mm;padding-bottom:0mm;">
						...
						<div style="height:8mm;width:162.5mm;float:left;clear:none;">
							...
							<div style="width:162.5mm;">
									...
									<div style="padding-top:1mm;padding-left:0mm;float:left;clear:none;">
										<div style="width:59mm;float:left;clear:none;">
											...
											<label>
												...
												<b>You </b> were born before January 2, 1948,
								  </label>
										</div>
										<div style="width:59mm;float:left;clear:none;padding-top:1mm;">
											...
											<label>
												...
												<span style="width:3px;"/>
												<b>Spouse </b> was born before January 2, 1948,
								  </label>
										</div>
									</div>
								...
								<div class="styLNAmountBox" style="height:11.6mm;border-left-width:1px;border-bottom-width:0px;"></div>
								</span>
							</div>
							<!--End Line 39a -->
							<!-- Line 39b -->
							<div style="width:162.5mm;">
								...
								<div class="styLNAmountBox" style="height:20px;border-left-width:1px;border-bottom-width:0px;"></div>
								</span>
							</div>
							<!--End Line 39b -->
							<!-- Line 40 -->
                           ...
                           Subtract line 40 from line 38
							...
							<div style="width:162.5mm;">
								...
								<div style="width:117.7mm;float:left;clear:none;padding-top:.5mm;padding-left:3mm;">
									<div style="padding-left:0mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
											<b>Exemptions.</b> Multiply $3,800 by the number on line 6d
                           </span>
										<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">..........</span>
									</div>
								</div>
								<span style="float:right;">
								<div class="styLNRightNumBox" style="height: 4.3mm;">42</div>
								<div class="styLNAmountBox" style="height: 4.3mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 44 -->
							<div style="width:162.5mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:.8mm;width:4mm;border-color:black;border-style:solid;border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;">44</div>
								<div style="width:117.7mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<b>Tax</b>
									<span style="width:3px;"/>
								<span style="font-family:Arial ;">
									...
									<input type="Checkbox" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/Section962ElectionInd"/>
											<xsl:with-param name="BackupName">IRS1040Section962ElectionInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2px;"/>
									<label>
										...
										<span class="styAgency" style="font-size:7pt;clear:none;float:none;">962 election</span>
									</label>
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$FormData/Section962ElectionInd"/>
									</xsl:call-template>
                           ...
                           Foreign tax credit. Attach Form 1116 if required
										<xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData/ForeignTaxCreditAmt"/></xsl:call-template>
								   </span>
									<span class="styDotLn" style="float:right;padding-right:2mm;">.</span>
								</div>
								<span style="float:right;">
                           ...
                           Retirement savings contributions credit.                     
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77mm;padding-top:1mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;font-size:6pt;padding-top:0.4mm;">
                     ...
                     Taxes
						...
						<div style="float:left;clear:none;height:8mm;width:162.5mm;">
                           ...
                           Additional tax on IRAs, other qualified retirement plans, etc. Attach Form 5329 if required
							...
							<!-- Line 59a -->
							<div style="width:162.5mm;">
								<div class="styLNLeftNumBox" style="width:4mm;">59a</div>
							...
							<div style="width:162.5mm;">
								...
								<div style="width:117.8mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									...
									<div style="float:left;clear:none;padding-left:1mm;padding-right:1mm;">
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/TotalOtherTaxAmt"/>
										</xsl:call-template>
									</div>
									<div class="styUnderlineAmount" style="width:50mm;float:left;clear:none;padding-top:0mm;padding-left:3mm;border-style:dotted;text-align:left;">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 60 - Form 8693 Approved Indicator</xsl:with-param>
								...
								<span style="float:right;">
								<div class="styLNRightNumBox" style="padding-top:1mm;">60</div>
								<div class="styLNAmountBox" style="padding-top:1mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/TotalOtherTaxAmt"/>
						...
						<div style="float:left;clear:none;height:8mm;width:162.5mm;">
                           ...
                           Federal income tax withheld from Forms W-2 and 1099
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span style="font-family:Arial Narrow;font-size:7.5pt;">2012 estimated tax payments and amount applied from 2011 return</span>
										<xsl:call-template name="SetFormLinkInline">
							...
							<!-- Line 64a -->
							<div style="width:162.5mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;border-color:black;border-style:solid;border-width:1px 0px;">64a</div>
								<div style="width:76mm;padding-top:.5mm;padding-left:1mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
							...
							<div style="width:162.5mm;">
                               ...
                               <xsl:call-template name="SetFormLinkInline">
								   <xsl:with-param name="TargetNode" select="$FormData/FirstTimeHomebuyerCreditAmt"/>
                               </xsl:call-template>
                        </div>
								<span style="float:right;">
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77mm;padding-top:.8mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										...
										<input type="Checkbox" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/Form8801Ind2"/>
												<xsl:with-param name="BackupName">IRS1040Payments8801Ind2</xsl:with-param>
											</xsl:call-template>
										</input>
										<span style="width:1px;"/>
										<label>
                           ...
                           Account number
							...
							<div style="width:165.5mm;">
								...
								<div style="height:4mm;width:77.3mm;padding-left:2.5mm;border-bottom-width:0mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span class="styAgency" style="font-size:7.8pt;">Amount of line 73 you want<b> applied to your 2013 estimated tax</b>
										</span>
                  ...
                  <span style="width:1mm;height:.25mm;background-color:blue;"></span> 
                        ...
                        Spouse's occupation
								...
								<div class="styGenericDiv" style="height:11mm;width:37mm;border-left-width:0px;">
									<span style="width:100%;padding-left:4px;font-family:Arial Narrow;font-size:larger;">If the IRS sent you an Identity Protection PIN, enter it here (see </span><br/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="DependencyTemplate">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/PassiveForeignSourceQlfyDiv">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="ForeignSourceIncomeExplanation"/>
						</xsl:call-template>
					</td>
					<td class="styDepTblCell" style="text-align:right;width:67mm;">
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="ForeignSourceIncomeAmount"/>
						</xsl:call-template>
					</td>
				</tr>
			</xsl:for-each>
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/PassiveForeignSourceCGLs">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/GeneralForeignSourceQlfyDiv">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/GeneralForeignSourceCGLs">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/Sect901jForeignSourceQlfyDiv">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/Sect901jForeignSourceCGLs">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/TreatyForeignSourceQlfyDiv">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/TreatyForeignSourceCGLs">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/LumpSumForeignSourceQlfyDiv">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">
		...
		<table id="DDSTbl" class="styDepTbl">
			...
			<xsl:for-each select="$DependencyData/LumpSumForeignSourceCGLs">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:119mm;">
						<xsl:call-template name="PopulateText">

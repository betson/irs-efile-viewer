...
<div class="styLNLeftNumBox" style="padding-left: 1mm;padding-top:2mm">7</div>
 <div class="styLNDesc" style="width:179mm;border-right-width:0;padding-top:1mm">
  Amount of expenses incurred in monitoring, inspecting, and enforcing conservation easements during the year  <br></br>
  <img src="{$ImagePath}/990SchD_Bullet_Md.gif" alt="SchDMd Bullet"/> $
...
<!-- Footer -->
    <div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageend">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule D (Form 990) 2012</span>
      </div>
    </div>
   ...
   <br />
    ...
    <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
      <div style="width:90mm;" class="styGenericDiv">Schedule D (Form 990) 2012</div>
...
<input type="checkbox" class="styIRS990ScheduleDCkBox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/ExplanationInPartXIII"/>
...
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus2Years/BeginningOfYearBalance" />
   ...
   <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/BeginningOfYearBalance" />
</xsl:call-template>
</td>
...
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/BeginningOfYearBalance" />
</xsl:call-template>
</td>
    </tr>
    <tr>
...
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus2Years/Contributions" />
   ...
   <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/Contributions" />
</xsl:call-template>
</td>
 <!-- <td class="styTableCell" style="width:25mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-style: solid; border-color:black; border-left-width:1px;border-right-width:0px "> 
<span class="styTableCellPad" /> 
...
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/Contributions" />
</xsl:call-template>
</td>
    </tr>
...
-->
  <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm;padding-top:3mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/InvestmentEarningsOrLosses" />
</xsl:call-template>
</td>
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm; padding-top:3mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/InvestmentEarningsOrLosses" />
</xsl:call-template>
</td>
...
-->
    <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/GrantsOrScholarships" />
</xsl:call-template>
</td>
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/GrantsOrScholarships" />
</xsl:call-template>
</td>
  <!--<td class="styTableCell" style="width:25mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-style: solid; border-color:black; border-left-width:1px;border-right-width:0px "> 
<span class="styTableCellPad" /> 
...
-->
    <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm;padding-top:3mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/OtherExpenditures" />
</xsl:call-template>
</td>
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm; padding-top:3mm;">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/OtherExpenditures" />
</xsl:call-template>
</td>
...
-->
   <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/AdministrativeExpenses" />
</xsl:call-template>
</td>
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/AdministrativeExpenses" />
</xsl:call-template>
</td>
...
-->
   <td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus3Years/EndOfYearBalance" />
</xsl:call-template>
</td>
<td class="styLNAmountBoxSmall" style="height:4.5mm;width:24mm">
<xsl:call-template name="PopulateAmount">
<xsl:with-param name="TargetNode" select="$FormData/CurrentYearMinus4Years/EndOfYearBalance" />
</xsl:call-template>
</td>
...
<div style=" width: 187mm; ">
<div class="styLNLeftNumBox" style="padding-left: 3mm;padding-top:1mm"></div>
 <div class="styLNDesc" style="width:179mm;border-right-width:0;padding-top:0mm">
...
<!-- Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule D (Form 990) 2012</span></div>
    </div>
...
<div class="styGenericDiv" style="float:right">
    ...
    <div class="styTableContainer" id="IOSctn" style="height:25mm;">
      ...
      <table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
          ...
          <tr>
            <th class="styTableCellHeader" scope="col" colspan="2" style="width:82mm;font-weight:normal;border-color:black;vertical-align:top;"><span style="font-weight:bold">(a)</span> Description of security or category<br />(including name of security)</th>
          ...
          <th class="styTableCellHeader" scope="col" colspan="2" style="width:70mm;font-weight:normal;text-align:center;border-right-width:0px;border-color:black;vertical-align:top;"><span style="font-weight:bold">(c)</span> Method of valuation:<br />Cost or end-of-year market value</th>
         </tr>
	...
	<span class="styGenericDiv" style="float:left" colspan="2">(1)Financial derivatives</span></td>
      <td class="styTableCell" style="width:35mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
		<xsl:call-template name="PopulateAmount">
         ...
         <td class="styTableCell" colspan="2" style="width:70mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-right-width:0px;border-color:black;text-align:center;">
		<xsl:call-template name="PopulateText">
    ...
    <div class="styTableContainerNBB" id="IPRctn" style="height:25mm;">
      ...
      <table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
        <thead class="styTableThead">
          <tr>
            <th class="styTableCellHeader" scope="col" colspan="2" style="width:82mm;font-weight:normal;border-color:black;vertical-align:top;text-align:center;"><span style="font-weight:bold">(a)</span> Description of investment type</th>
            <th class="styTableCellHeader" scope="col" style="font-weight:normal; text-    				align:center;border-right-width:1px;border-color:black;vertical-align:top;"><span style="font-weight:bold">(b)</span> Book value</th>
          <th class="styTableCellHeader" scope="col" colspan="2" style="width:70mm;font-weight:normal;border-right-width:0px;border-color:black;vertical-align:top;text-align:center;"><span style="font-weight:bold">(c)</span> Method of valuation:<br />Cost or end-of-year market value</th>
         </tr>
 </thead>
        <tfoot></tfoot>
        <tbody>
   ...
   <xsl:if test="($Print != $Separated) or count($FormData/InvestmentsProgramRelated) &lt;= 9">
      ...
      <td class="styIRS990ScheduleDTableCellLB" style="width:35mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
		<xsl:call-template name="PopulateAmount">
         ...
         <td class="styIRS990ScheduleDTableCellLB" colspan="2" style="width:70mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-right-width:0px;border-color:black;text-align:center;">
		<xsl:call-template name="PopulateText">
			<xsl:with-param name="TargetNode" 			select="MethodOfValuation" />
	</xsl:call-template></td>
		 </tr>
...
<b>2.</b> Fin 48 (ASC 740) Footnote. In Part XIII, provide the text of the footnote to the organization's financial statements that reports the organization's liability for uncertain tax positions under FIN 48 (ASC 740). Check here if the text of the footnote has been provided in Part XIII
<!-- For 508 Jaws I had to move the span to after the closing label which shortened the spot where the box ends-->
<span class="styIRS990ScheduleD_DotSpacing">.....................................................

<input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/FootnoteInPartXIII"/>
...
Complete this part to provide the descriptions required for Part II, lines 3, 5, and 9; Part III, lines 1a and 4; Part lV, lines 1b and 2b;<br /> Part V, line 4; Part X, line 2; Part XI, lines 2d and 4b; and Part XII, lines 2d and 4b. Also complete this part to provide any additional information.<br />
</div>
<span style="float:right"> 
  
 
          <xsl:call-template name="SetDynamicTableToggleButton" >
              <xsl:with-param name="TargetNode" select="$FormData/Form990ScheduleDPartXIII" />              
...
<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
  ...
  <tfoot></tfoot>
  <tbody valign="top">
   <xsl:if test="($Print!=$Separated) or (($Print=$Separated) and (count($FormData/Form990ScheduleDPartXIII) &lt;20))">
      <xsl:for-each select="$FormData/Form990ScheduleDPartXIII">
          <tr>

    ...
    <span class="IRS990ScheduleF_Dotspacing">...................................</span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:175mm;padding-top:2mm;font-size:7.5pt;">
              <b>For grantmakers.</b> Describe in Part V the organization’s procedures for monitoring the use of grant funds outside <br/>the United States.</div>
          </div>
          <!-- End Line 2 -->
          <!-- Start Line 3-->
      ...
      <span style="width:7mm;"/>
            <span style="font-weight:bold;font-size:6.25pt;">Schedule F (Form 990) 2012</span>
          </div>
          <!-- PAGE 2 HEADER  -->
          <div class="styBB" style="width:256mm; padding-bottom:.5mm;">
            <div style="float:left;">Schedule F (Form 990) 2012</div>
          ...
          <!--Dotted Line-->
            ...
            <div class="pageEnd" style="width:256mm;">
              ...
              <span style="font-weight:bold;font-size:7pt;">Schedule F (Form 990) 2012</span>
            </div>
            <!-- PAGE 3 HEADER  -->
            <div class="styBB" style="width:256mm; padding-bottom:.5mm;">
              <span style="width:212mm;float:left;">Schedule F (Form 990) 2012</span>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-size:7pt;padding-top:3mm;text-align:left;vertical-align:top;width:150mm;">
                    ...
                    <i>If “Yes,” the organizationmay be required to file Form 3520, Annual Return to 
              ...
              <table cellspacing="0" class="styTable" cellpadding="0">
                <thead class="styTableThead">
                  <tr class="styDepTblHdr">
                    ...
                    <th class="styDepTblCell" scope="col" style="width:50mm;text-align:center;font-size:7pt;font-weight:normal;border-color:black;">ReturnReference</th>
                    <th class="styDepTblCell" scope="col" style="width:87mm;text-align:center;font-size:7pt;font-weight:normal;border-color:black;border-right:none;">Explanation  </th>
                  </tr>
                </thead>
                <tbody>

...
<html>
  <head>
    ...
    <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form5713BData)"></xsl:with-param></xsl:call-template></title>
    ...
    <style type="text/css">
      <xsl:if test="not($Print) or $Print=''">
        <xsl:call-template name="IRS5713ScheduleBStyle"></xsl:call-template>    
  ...
  <xsl:call-template name="DocumentHeader"></xsl:call-template>
        ...
        <div class="styFNBox" style="width:32mm;height:24.25mm;">
          <div class="styFormNumber" style="font-size: 11pt;">SCHEDULE B</div>
            <div class="styFormNumber" style="font-size: 9pt;">(Form 5713)</div><br/>
        <div style="width:31mm;font-weight:normal;font-size:7pt;">(Rev. December 2010)</div>
        <br/>
        ...
        <div class="styFTBox" style="width:125mm;height:22mm;">
          ...
          <div style="height:4mm;font-size: 7pt;"><img src="{$ImagePath}/5713SchB_Bullet.gif" alt="bullet image pointing to right" width="6"/><span style="width: 1mm;"></span>Complete only if you are <b>not</b> computing a loss of tax benefits<br/> 
          using the international boycott factor on Schedule A (Form 5713).</div>
            <div class="styFBT"><img src="{$ImagePath}/5713SchB_Bullet.gif" alt="bullet image pointing to right" width="6"/><span style="width: 1mm;"></span>Attach to Form 5713. <span style="width:5mm;"></span><img src="{$ImagePath}/5713SchB_Bullet.gif" alt="bullet image pointing to right" width="6"/><span style="width: 1mm;"></span>See instructions on page 2.</div>
        </div>
...
<!--Name and Identifying number Begin-->
        <div class="styBB" style="width:187mm;border-top-width:1px">
          ...
          <xsl:if test="$Form5713BData/BusinessName/BusinessNameLine1 != ''">
         
            <xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$Form5713BData/BusinessName/BusinessNameLine1" />
				  </xsl:call-template>  
          </xsl:if>
          <xsl:if test="$Form5713BData/BusinessName/BusinessNameLine2 != ''">
          <br/>
            <xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$Form5713BData/BusinessName/BusinessNameLine2" />
				  </xsl:call-template>  
          </xsl:if>
           <xsl:if test="$Form5713BData/Name != ''">
           <br/>
            <xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$Form5713BData/Name" />
				  </xsl:call-template>  
          </xsl:if>
        ...
        <div class="styEINBox" style="font-family:Verdana;font-size:7pt;width:50mm;height:9mm;padding-left:2mm;">Identifying number<br/><br />
		  ...
		  <xsl:choose >
		   <xsl:when test="$Form5713BData/SSN">
            ...
            <xsl:when test="$Form5713BData/MissingEINReason">
              <xsl:call-template name="PopulateText">
...
<!-- Item portion above "(a-o) table" start  -->
  ...
  <xsl:call-template name="PopulateText">
    <xsl:with-param name="TargetNode" select="$Form5713BData/OtherCountryBoycotted/@nameOfOtherCountry" />
  </xsl:call-template>
  </span>
    </div>
  </div>
  <div class="styBB" style="width:187mm;border-top-width:0px"></div>
  <div class="styBB" style="width:187mm;"><b>Important:</b><i> If you are involved in more than one international boycott, use a separate Schedule B (Form 5713) to compute the specifically attributable taxes and income for each boycott.</i>
  </div>
  ...
  <table cellspacing="0" summary="Specifically Attributable Taxes and  Income by Operation">
    ...
    <xsl:if test="($Print != $Separated) or (count($Form5713BData/OperationTaxesAndIncome) &lt;= 14) ">
      ...
      <tr>      
        <xsl:if  test="position()&lt;15">
          <td class="styTableCell" style="width:20mm;text-align:center;font-size:7pt;border-color:black;padding-left:2mm;">
        ...
        <td class="styTableCell" style="width:30mm;text-align:right;font-size:7pt;
        border-color:black;border-right:none;" nowrap="nowrap">
        <xsl:call-template name="PopulateAmount">
    ...
    <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 1 or
      ...
      <tr>
        ...
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:33mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:33mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:33mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:33mm;border-color:black;border-right:none;"><span class="styTableCellPad"></span></td>
      </tr>
      </xsl:if>
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 2 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">b<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;border-right:none;"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 3 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">c<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 4 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">d<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 5 or 
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">e<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 6 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">f<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 7 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">g<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 8 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">h<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 9 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">i<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 10 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">j<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 11 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">k<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 12 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">l<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt; 13 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">m<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <xsl:if test="count($Form5713BData/OperationTaxesAndIncome) &lt;14 or
         (($Print = $Separated) and (count($Form5713BData/OperationTaxesAndIncome)&gt;14)) ">
      <tr>
        <td class="styTableCell" style="width:60mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">n<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:14mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:16mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:34mm;border-color:black;"><span class="styTableCellPad"></span></td>
      ...
      <tr>
        <td class="styTableCell" colspan="3" style="width:48mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;">o<span style="width:3mm;"></span> Total
        <!--dotted line-->
   ...
   <xsl:call-template name="SetInitialDynamicTableHeight">
    ...
    <!--Begin Footer-->
      <div class="pageEnd" style="width:187mm;">
        <div class="stySmallText" style="width:110mm;"><span class="styBoldText">For Paperwork Reduction Act Notice, see the instructions for Form 5713.</span></div>
        <div class="stySmallText" style="width:20mm;">Cat. No. 12060S</div>
        <div class="stySmallText" style="width:56mm;text-align:right"><span class="styBoldText">Schedule B (Form 5713) (Rev. 12-2010)</span></div>
      </div>
      <!--End Footer-->
       <br/>
      ...
      <table class="styDepTbl" style="font-size:7pt">
        <thead class="styTableHead">
          <tr class="styDepTblHdr">
            <th class="styDepTblCell" scope="col" style="width:20mm;text-align:center;border-bottom:none;"></th>
        ...
        <tbody>
          ...
          <tr class="styDepTblHdr">
            <td class="styDepTblCell" colspan="3" style="width:60mm;text-align:left;font-weight:bold;">
              <span style="width:3mm;"></span> Total

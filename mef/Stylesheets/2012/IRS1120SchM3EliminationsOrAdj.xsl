		...
		<html>
          ...
          Internal Revenue Service</span>
						...
						<div class="styTYBox" style="width:30mm;height:23mm;border-left-width:2px;">
							...
							<div class="styTY" style="height:11mm;padding-top:4mm;">20<span class="styTYColor">12</span>
							</div>
						</div>
					</div>
...
(attach statement)           
      ...
      Cat. No. 37961C 
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule M-3 (Form 1120) 2012</span>
						</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1120) 2012</div>
...
Combine lines 29a through 29c</span>
         ...
         Line 30, column (a), must equal the amount on Part I, line 11, and column (d) must equal Form 1120, page 1, line 28.</div>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120) 2012</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styBB" style="width:187mm;">

	...
	<xsl:template match="/">
		<html>
          ...
          Name of foreign corporation<br/>
						...
						<!--  End choise of name from header or data elements for shared file 1040/1120  -->
						<!-- EIN LIne choice from input and Return header 1120 or 1040   -->
						<div class="styNameBox" style="float:left;clear:none;padding-left:1mm;width:27mm;height:11mm;
            ...
            EIN (if any)<br/>
							...
							<span style="font-weight: normal;">
								...
								<xsl:if test="$Form5471ScheduleO/MissingForeignCorpEINReason">
									<br/>
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form5471ScheduleO/MissingForeignCorpEINReason"/>
									</xsl:call-template>
								</xsl:if>
							</span>
						</div>
						<div class="styNameBox" style="float:left;clear:none;padding-left:1mm;width:45mm;height:10mm;border-right-width:0px;
            border-color:black">
							<span>

	...
	<xsl:template match="/">
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="Form8917">
					...
					<div class="styBB" style="width:{$pageWidth}mm;border-bottom:{$borderWidth35}mm solid">
						<div class="styFNBox" style="width:31mm;height:18mm;padding-bottom:0mm;border-right:{$borderWidth35}mm solid">
              Form<span style="width:1mm;"/>
                ...
                Department of the Treasury<br/>
						...
						<div class="styFTBox" style="width:125mm;height:18mm;">
							...
							<span style="font-weight:normal;">Instructions and more are at <i>www.IRS.gov/form8917</i></span></div>
						</div>
          ...
          border-right-width:0;border-left-width:0;float:left;line-height:normal;">-->
					<!-- Line 1 -->
					<div class="styGenericDiv" style="width:187.5mm;">
						<div class="styLNLeftNumBoxSD" style="float:left !important;clear:none !important;">1</div>
					<div class="styTableContainer" id="Studentctn" style="width:179mm;float:left !important;clear:none !important;">
					  <!-- print logic -->
									...
									<tr>
										...
										<td class="styTableCell" style="width:auto;border-right:none;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="TotalQualifiedExpensesAmt"/>
											</xsl:call-template>
										</td>
									</tr>
								</xsl:for-each>
				...
				Form <span class="styBoldText" style="font-size:8pt;">8917</span> (2012)
			</div>
					</div>

				...
				<form name="IRS5471ScheduleJ">
					...
					<div class="styBB" style="width:256mm;height: 25mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:40mm;font-size:8pt;height:25mm;border-right-width:1px;">
							...
							<div class="sty5471ScheduleJRev">(Rev. December 2011)</div>
					...
					<div class="styBB" style="width:256mm;">
						...
						<div class="sty5471ScheduleJBusinessName" style="width:64mm;height:12mm;width-right:0;">
							<span style="font-weight:bold;float:left; clear: none; margin-left: 1mm">EIN (if any)</span>
							<br/>
							<span class="sty5471ScheduleJINBox" style="font-weight:normal; margin-left: 1mm; padding-top: 4mm;">
								<xsl:choose>
									...
									<xsl:when test="$IRS5471ScheduleJData/MissingForeignCorpEINReason != '' ">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471ScheduleJData/MissingForeignCorpEINReason"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
									</xsl:otherwise>
						...
						<div class="sty5471ScheduleJIN" style="width:72mm;height:12mm;boarder-left:0;">
							<span style="font-weight:bold;float:left; clear: none; margin-left: 1mm">Reference ID number (see instructions)</span>
							<br/>
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<span style="font-size:8px;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$IRS5471ScheduleJData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber"/>
											</xsl:call-template>
										</span>
									</xsl:otherwise>
								</xsl:choose>
					...
					<div style="width: 256mm;">
						...
						<span class="sty5471ScheduleJCellGeneric" style="width:32mm;text-align: center; border-right: 0;height: 22.5mm; ">
					...
					<div class="sty5471ScheduleJDescLine">
						...
						<span class="sty5471ScheduleJCellGeneric" style="height: 13mm;padding-top: 10mm; width:32mm; border-right:0;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="MaxSize" select="17"/>
					...
					<div class="sty5471ScheduleJFormFooter">
						...
						<span style="font-weight: normal"> (Rev. 12-2011)</span>
						</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>

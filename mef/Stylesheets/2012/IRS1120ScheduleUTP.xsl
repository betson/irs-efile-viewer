				...
				<form name="Form1120ScheduleUTP">
				  ...
				  <i>www.irs.gov/scheduleutp</i>
						...
						<div class="styTYBox" style="width:30mm;height:19mm;border-left-width: 2px">
							...
							<div class="styTY" style="height:10mm;padding-top:1mm;">20<span class="styTYColor">12</span>
							</div>
						</div>
					</div>
					<!--  End title of Form  -->
				...
				<img src="{$ImagePath}/1120SchUTP_Bullet.gif" alt="Pointer"/>
					...
					<div class="styIRS1120ScheduleUTP_styTableContainer" id="ScheduleUTPPartITable">
						...
						<table class="styIRS1120ScheduleUTP_styTable" cellspacing="0">
							...
							<tr>
								<th class="styIRS1120ScheduleUTP_styMiddleCell" colspan="3" style="width:75mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">Primary IRC Sub Sections</span>
									<br/>(e.g. (a)(12)(A)(viii))
        </th>
							</tr>
									...
									<tr>
										...
										<td class="styIRS1120ScheduleUTP_styLeftCell" scope="row" style="text-align:left;font-size:6pt;width:14mm;" rowspan="2">
											...
											<b>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="UTPNumberCY"/>
												</xsl:call-template>
											</b>
										</td>
										...
										<xsl:if test="count(IRCSections) = 1">
											<xsl:for-each select="IRCSections">
												<td class="styIRS1120ScheduleUTP_styMiddleCell" style="text-align:center;font-size:6pt;width:25mm;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="PrimaryIRCSections"/>
													</xsl:call-template>
												</td>
											</xsl:for-each>
											<td class="styIRS1120ScheduleUTP_styMiddleCell" style="text-align:center;font-size:6pt;width:25mm;">
...
(<span style="width: 8px">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="PrimaryIRCSubSection"/>
													</xsl:call-template>
												</span>)
(<span style="width: 8px">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="PrimaryIRCParagraph"/>
													</xsl:call-template>
												</span>)
(<span style="width: 8px">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="PrimaryIRCSubParagraph"/>
													</xsl:call-template>
												</span>)
(<span style="width: 8px">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="PrimaryIRCClause"/>
													</xsl:call-template>
												</span>)
												</td>
											<td class="styIRS1120ScheduleUTP_styMiddleCell" style="text-align:center;font-size:6pt;width:25mm;">
...
(<span style="width: 8px">
			    ...
			    For Paperwork Reduction Act Notice, see the Instructions for Form 1120.
						...
						<span style="width:50mm;text-align:right;font-weight:bold;font-size:6pt;" class="styGenericDiv">Schedule UTP (Form 1120) 2012</span>
					</div>
					<!-- END PAGE I FOOTER -->
					<!--  ********************************************************************************************************* -->
					<br class="pageend"/>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Schedule UTP (Form 1120) 2012 </div>
								...
								<xsl:for-each select="$FormData/ScheduleUTPInformationPriorTY">
									<tr>
										...
										<td class="styIRS1120ScheduleUTP_styLeftCell" style="text-align:left;width:20mm;font-size:6pt;" rowspan="2">
											...
											<b>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="UTPNumberPY"/>
												</xsl:call-template>
											</b>
										</td>
...
(<span style="width: 8px">
		 ...
		 count($FormData/ScheduleUTPInformationPriorTY))"/>
					...
					<div class="styIRS1120ScheduleUTP_styFormFooter" style="width:707px;border-top-width: 1px;">
						<span style="width:98mm;font-weight:bold;font-size:7pt;" class="styGenericDiv"/>
						<span style="width:38mm;font-weight:normal;font-size:6pt;text-align:center;" class="styGenericDiv"/>
						<span style="width:50mm;text-align:right;font-weight:bold;font-size:6pt;" class="styGenericDiv">Schedule D (Form 1120) 2012</span>
					</div>
					<!-- END PART III FOOTER -->
				</form>
				<!--  ********************************************************************************************************* -->
				...
				<xsl:if test="($Print = $Separated) and (count($FormData/ScheduleUTPInformationCurrTY) &gt; 21)">
					...
					<table class="styDepTbl" style="font-size:6pt">
					  ...
					  <span style="font-weight:normal;">(e.g. (a)(12)(A)(viii))</span>
								</th>
							</tr>
						</thead>
						<tbody>

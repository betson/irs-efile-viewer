...
<!-- start page header-->
  <xsl:call-template name="DocumentHeader"></xsl:call-template>
      ...
      <div style="width:187mm;">
        ...
        <div style="width:31mm;font-weight:normal;font-size:7pt;">(Rev. December 2004)</div><br/>
          <div>
    ...
    <xsl:call-template name="PopulateText">
      <xsl:with-param name="TargetNode" select="$Form5713BData/Name/BusinessNameLine2" />
        ...
        <div class="styEINBox" style="font-family:Verdana;font-size:7pt;width:50mm;height:9mm;padding-left:2mm;">Identifying number<br/><br />
          <xsl:choose>
            <xsl:when test="$Form5713BData/IdentifyingNumber = '' or not($Form5713BData/IdentifyingNumber)">
   ...
   <xsl:call-template name="SetInitialDynamicTableHeight">
    ...
    <!--Begin Footer-->
      <div class="pageEnd" style="width:187mm;">
        ...
        <div class="stySmallText" style="width:56mm;text-align:right"><span class="styBoldText">Schedule B (Form 5713) (Rev. 12-2004)</span></div>
      </div>
      <!--End Footer-->

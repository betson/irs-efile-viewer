...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherAssetsStatement" />
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="OASSTbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      ...
      <body class="styBodyClass">
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:80mm">
            <!--TY 2003 Other Assets Statement-->
            <xsl:value-of select="$depDocTitle" />
          </div>
        </div>        

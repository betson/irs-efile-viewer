...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
     ...
     <!--<xsl:call-template name="SetFormLinkInline">
       ...
       Form 990. All other organizations with gross receipts less than <br/>$500,000 and total assets less than $1,250,000 at the end of the year may use this form.
    </div>
      ...
      20<span class="styTYColor">09</span>
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:3mm;width:182mm;float:left;clear:none;">For the 2009
          ...
          <xsl:call-template name="SetFormLinkInline">
            ...
            <span class="styIRS990EZNBSP" style="width: 4px"/>
					...
					<div class="styBB" style="float: none; clear:both; width: 187mm; border-top-width: 1px">
						...
						<span class="styPartDesc">Balance Sheets&#151;<span class="styNormalText" style="font-size: 7pt; font-weight: normal">If Total assets on line 25, column (B) are $1,250,000 or more, file Form 990 instead of Form 990-EZ.</span>
						</span>
					</div><br />
					<!--   END PART II HEADER   -->
					<div style="width: 187mm;" >
    ...
    <span class="styIRS990EZNBSP"/>.
					...
					<div class="styGenericDiv" id="OActn" style="overflow-y: auto; height: 100%;">
						<div class="styIRS990EZLineItem" style="height:4.5mm;">
							...
							<span class="styLNDesc" style="padding-left: 2mm; width: 109.5mm">Other assets (describe 
      <img src="{$ImagePath}/990EZ_Bullet_Lg.gif" alt="Bullet"/>
  ...
  <b>
    ...
    Form<span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span>(2009)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="width:187mm;padding-top:1mm;">
						<div style="float: left; clear: none">Form 990-EZ (2009)</div>
						<div style="float:right">
    ...
    Page <span class="styBoldText" style="font-size: 8pt">3</span>
     ...
     <xsl:call-template name="SetFormLinkInline">
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNDesc" style="width:150mm;">Were any changes made to the organizing or governing documents?  If "Yes," attach a conformed copy of the changes.
    <xsl:call-template name="SetFormLinkInline">
						...
						<!--  Yes box  -->
						<div class="styIRS990EZYesNoBox" style="height:8mm;">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" select="$IRS990EZData/MadeChangesToOrgnzngEtcDoc"/>
							</xsl:call-template>
						</div>
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNDesc" style="width:150mm;height:12mm;">If the organization had income from business activities, such as those reported on lines 2, 6a, and 7a (among others), but 
							<b>not</b> reported on Form 990-T, attach a statement explaining why the organization did not report the income on Form 990-T. 
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNDesc" style="width:150mm;height:8mm;">Did the organization have unrelated business gross income of $1,000 or more or was it subject to section 6033(e) notice, reporting, and proxy tax requirements?
    <xsl:call-template name="SetFormLinkInline">
    ...
    <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm; margin-right:1mm">...............</span>
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNDesc" style="width:150mm;">any such loans made in a prior year and still outstanding at the end of the period covered by this return?
  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:0mm; margin-right:0mm">...</span>
    ...
    ; section 4955 <img src="{$ImagePath}/990EZ_Bullet_Lg.gif" alt="bullet"/>
  		 ...
  		 year or is it aware that it engaged in an excess benefit transaction with a disqualified person in a prior year, and that the transaction has not been reported on any of the organization's prior Forms 990 or 990-EZ? If “Yes,” complete Schedule L, Part I.
							<xsl:call-template name="SetFormLinkInline">
  ...
  <b>
    ...
    <span class="styIRS990EZNBSP"/>.
					...
					<!-- BEGIN LINE 44  -->
					<div style="width:187mm;float:none;">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:6mm;">44</div>
     ...
     <span class="styIRS990EZNBSP"/>.
						...
						<div class="styLNRightNumBox" style="height:4.5mm;border-top-width:0px;">44</div>
 ...
 <span class="styIRS990EZNBSP"/>.
    ...
    Page <span class="styBoldText" style="font-size: 8pt">4</span>
					...
					<div class="styBB" style="float: none; clear:both; width: 187mm; border-top-width: 1px; border-bottom-width: 1px; font-size:8pt">
						...
						<span class="styNormalText" style="height: 4.5mm;padding-top: .5mm;">All section 501(c)(3) organizations and section 4947(a)(1) nonexempt charitable trusts must answer questions 46-49b and 
						complete the tables for lines 50 and 51. </span>
					</div></div>
					<!--   END PART VI HEADER   -->
					<div style="width:187mm;float:none;">
     ...
     <span class="styIRS990EZNBSP"/>.
							...
							<div class="styLNRightNumBox" style="height:6mm;border-top-width:0px;padding-top:1mm;">46</div>
...
and belief, it is true, correct, and complete. Declaration of preparer (other than officer) is based on all information of which preparer has any knowledge. </td>
						...
						<tr>
							...
							<td style="width:103mm;border-bottom:1 solid black;vertical-align:bottom;border-right:1 solid black;height:6mm">
...
<span style="width:2px;"/>
	...
	<!-- </label> -->
					...
					<!--   BEGIN FORM FOOTER  -->
					<div style="width:187mm;">
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2009)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>

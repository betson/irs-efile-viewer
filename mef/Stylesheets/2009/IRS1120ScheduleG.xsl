				...
				<form name="Form1120ScheduleG">
					...
					<div class="IRS1120ScheduleG_styBB" style="width:187mm;">
						<div class="styFNBox" style="width:33.3mm;height:19mm;">
							<div class="styFormNumber" style="font-size: 10pt;">SCHEDULE G<br/>
						...
						<div class="styFTBox" style="width:120mm;height:17mm;">
							...
							<table class="IRS1120ScheduleG_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
								...
								<xsl:if test="($Print != $Separated) or (count($FormData/EntityInformation) &lt;= 6) ">
									<xsl:for-each select="$FormData/EntityInformation">
										<tr>
											<td class="IRS1120ScheduleG_styTableCellA" scope="row">
											...
											<td class="IRS1120ScheduleG_styTableCellD" style="padding-left:2mm;text-align:left ">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="CountryOfOrganization"/>
												</xsl:call-template>
											</td>
											<td class="IRS1120ScheduleG_styTableCellE" style="text-align:center;border-right-width:0px">
					...
					<div class="IRS1120ScheduleG_styTableContainer" id="IndividualInformationTableContainer">
						...
						<table class="IRS1120ScheduleG_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							<tr>
								...
								<th class="IRS1120ScheduleG_styTableCellB" style="width20mm;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(ii) Identifying Number <br/>(if any) </span>
								</th>
								<th class="IRS1120ScheduleG_styTableCellD" style="text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(iii) Country of Citzenship<br/>(see instructions)</span>
								</th>
								<th class="IRS1120ScheduleG_styTableCellE" style="text-align:center;font-weight:normal;border-right-width:0px" scope="col">
									<span style="font-weight:bold;">(iv) Percentage Owned
<br/>in Voting Stock</span>
								</th>
							</tr>
							<!-- END PART I TABLE HEADER -->
							<!-- BEGIN PART I TABLE -->
					...
					<!--  &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&  -->
					<!-- BEGIN FOOTER -->
					<div class="IRS1120ScheduleG_styFormFooter" style="width:707px;border-top-width: 0px;">
						<span style="width:105mm;font-weight:bold;font-size:7pt;" class="styGenericDiv">For Privacy Act and Paperwork Reduction Act Notice, see the Instructions.</span>
						<span style="width:20mm;font-weight:normal;font-size:6pt;text-align:center;" class="styGenericDiv">Cat. No. 52684S</span>
						<span style="width:53mm;text-align:right;font-weight:bold;font-size:6pt;" class="styGenericDiv">Schedule G (Form 1120) 2009</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
				<!-- leftover data table -->
						...
						<tbody>
							<xsl:for-each select="$FormData/IndividualInformation">
								<tr>
									...
									<td class="IRS1120ScheduleG_styTableCellD" style="text-align:right;border-right-width:0px">
										<!-- If this is the last row, do not display a bottom line
                      <xsl:if test="(position() = last()) and (count($FormData/ShortTermCapitalGainAndLoss) &gt;6)">
                        <xsl:attribute name="style">border-bottom-width:0px;</xsl:attribute>
                      </xsl:if> -->

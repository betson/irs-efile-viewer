		    ...
		    <img src="{$ImagePath}\8865_Bullet_Sm.gif" alt="Small Right Arrow" border="0"/> See separate instructions.
              ...
              <div class="IRS1120ScheduleD_styTYBox" style="width:125px;height:85px;">
                ...
                <div class="IRS1120ScheduleD_styTY" style="height:45px;line-height:45px;color:Green;padding-top:.5mm;">
                  <span style="color:black;">20</span>09
                </div>
              </div>
            </div>
            <!-- END FORM HEADER -->
		  ...
		  <xsl:if test="count($FormData/ShortTermCapitalGainAndLoss) &lt; 7 or ((count($FormData/ShortTermCapitalGainAndLoss) &gt; 7) and ($Print = $Separated))">
		    ...
		    <td class="IRS1120ScheduleD_styTableCellF" style="border-bottom-width: 0px"><span style="width: 1mm" /></td>
              ...
              <div class="IRS1120ScheduleD_styLineItem">
                ...
                <div class="IRS1120ScheduleD_styLNValBox">
                  <span type="text" class="IRS1120ScheduleD_styLNVal" name="UnusedCapitalLossCarryover" id="UnusedCapitalLossCarryover">
		      ...
		      <xsl:if test="count($FormData/LongTermCapitalGainAndLoss) &lt; 7 or (($Print = $Separated) and (count($FormData/LongTermCapitalGainAndLoss) &gt; 7)) ">
               ...
               <div class="IRS1120ScheduleD_styLineItem">
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Net capital gain. Enter excess of net long-term capital gain (line 11) over net short-term capital  loss (line 5) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</span>          
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Add lines 12 and 13. Enter here and on Form 1120, page 1, line 8, or the proper line on other returns. 
                If the corporation has qualified timber gain, also complete Part IV  . . . . . . . . .</span>
                 ...
                 <!-- END NOTE -->
                  ...
                  <div class="IRS1120ScheduleD_styPartHdr" style="width:187mm;">
                      <div style="width:180mm;">
                            ...
                            <span style="width:160mm;"> <b>Alternative Tax for Corporations with Qualified Timber Gain.</b><span style="font-weight:normal"> 
                            Complete Part  IV <b>only</b> if the corporation has qualified timber gain under section 1201(b). Skip this part if you are filing Form 
                            1120-RIC. See instructions.</span>  </span>                    
                      </div>                 
                </div> 
                <!-- END PART IV HEADER -->
                <!-- BEGIN LINE 15 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">15</div>
						<div class="IRS1120ScheduleD_styLNDesc" style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
						...
						<div style="float:left;width:40.1mm;">
							<div class="styLNRightNumBox" style="height:3mm;padding-top:2mm;">15</div>
							<div class="styLNAmountBox" style="width:32.4mm;height:3mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedTimberGain"/>
								</xsl:call-template>   
							</div>
						</div>
						<div class="styLNAmountBoxNBB" style="float:left;height:6mm;width:37.5mm;
                ...
                <!-- BEGIN LINE 16 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">16</div>
						<div style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
                                  Enter taxable income from Form 1120, page 1, line 30, or the applicable line of your tax return
                                    		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
						...
						<div style="float:left;width:40.1mm;">
							<div class="styLNRightNumBox" style="height:7mm;padding-top:4mm;">16</div>
							<div class="styLNAmountBox" style="width:32.4mm;height:7mm;padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TaxableIncomeFromF1120Line30"/>
								</xsl:call-template>    
							</div>
						</div>
						<div class="styLNAmountBoxNBB" style="float:left;height:8mm;width:37.5mm;
                                        background-color:lightgrey;"/>
					</div>
                ...
                <!-- BEGIN LINE 17 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">17</div>
						<div style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
                            Enter the smallest of: (a) the amount on line 15; (b) the amount on line 16; or (c) the amount on Part III, line 13
                                  		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
						...
						<div style="float:left;width:40.1mm;">
							...
							<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode"
									 select="$FormData/SmallestLine15Or16OrPartIII13"/>
								</xsl:call-template>   
							</div>
						</div>
						<div class="styLNAmountBoxNBB" style="float:left;height:8mm;width:37.5mm;
                ...
                <!-- BEGIN LINE 18 -->
                <div class="IRS1120ScheduleD_styLineItem">
                  <span class="IRS1120ScheduleD_styLN" style="height:4mm:padding-top:2mm;" >18</span>
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc" style="height:4mm;padding-top:1mm;" >Multiply line 17 by 15% 
                                                    		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
                  ...
                  <span class="IRS1120ScheduleD_styLNBox" style="height:4mm; padding-top:2.5mm">18</span>
                  <div class="IRS1120ScheduleD_styLNValBox" style="height:4mm; padding-top:2.5mm">
                    			<xsl:call-template name="PopulateAmount">
							 	<xsl:with-param name="TargetNode" 
								 select="$FormData/MultiplyLine17By15Percent"/>
								</xsl:call-template>
                ...
                <!-- END LINE 18 -->
                         <!-- BEGIN LINE 19 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">19</div>
						<div style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
						...
						<div style="float:left;width:40.1mm;">
							<div class="styLNRightNumBox" style="height:2mm;padding-top:1mm;">19</div>
							<div class="styLNAmountBox" style="width:32.4mm;height:2mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SubtractLine13FromLine16"/>
								</xsl:call-template>    
							</div>
						</div>
						<div class="styLNAmountBoxNBB" style="float:left;height:5mm;width:37.5mm;
                                        background-color:lightgrey;"/>
					</div>
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Enter the tax on line 19, figured using the Tax Rate Schedule (or applicable tax rate) appropriate for the
                  ...
                  <span class="IRS1120ScheduleD_styLNBox" style="height:6mm; padding-top:4mm">20</span>
                  <div class="IRS1120ScheduleD_styLNValBox" style="height:6mm; padding-top:4mm">
                    <span type="text" class="IRS1120ScheduleD_styLNVal" name="NetCapitalGain" id="NetCapitalGain">
                  <xsl:call-template name="PopulateAmount">
                ...
                <!-- END LINE 20 -->
                                         <!-- BEGIN LINE 21 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">21</div>
						<div style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
                                  Add lines 17 and 19
                                                        		<span class="styBoldText">
								            <span style="width:4px;"/>
						...
						<div style="float:left;width:40.1mm;">
							<div class="styLNRightNumBox" style="height:2mm;padding-top:1mm;">21</div>
							<div class="styLNAmountBox" style="width:32.4mm;height:2mm;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
                ...
                <!-- END LINE 21 -->
                                         <!-- BEGIN LINE 22 -->
                <div style="width:187mm;">
						<div class="styLNLeftNumBox" style="font-size:8pt;float:left;padding-left:0mm;">22</div>
						<div style="width:101.4mm;float:left;height:0mm;padding-top:1.5mm;">
                                  Subtract line 21 from line 16. If zero or less, enter -0-
                                             		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
						...
						<div style="float:left;width:40.1mm;">
							<div class="styLNRightNumBox" style="height:2mm;padding-top:1mm;">22</div>
							<div class="styLNAmountBox" style="width:32.4mm;height:2mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc" style="height:2mm;" >Multiply line 22 by 35% 
                                                                          		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
                  ...
                  <span class="IRS1120ScheduleD_styLNBox" style="height:4mm; padding-top:2mm">23</span>
                  <div class="IRS1120ScheduleD_styLNValBox" style="height:4mm; padding-top:2mm">
               					<xsl:call-template name="PopulateAmount">
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Add lines 18, 20, and 23
                                  		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
                  ...
                  <span class="IRS1120ScheduleD_styLNBox" style="height:4mm; padding-top:2mm">24</span>
                  <div class="IRS1120ScheduleD_styLNValBox" style="height:4mm; padding-top:2mm">
                  					<xsl:call-template name="PopulateAmount">
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Enter the tax on line 16, figured using the Tax Rate Schedule (or applicable tax rate) appropriate for the
                   return with which Schedule D (Form 1120) is being filed
                                                		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                ...
                <div class="IRS1120ScheduleD_styLineItem">
                  ...
                  <span class="IRS1120ScheduleD_styLNRtMargin"/>
                  <span class="IRS1120ScheduleD_styLNDesc">Enter the smaller of line 24 or line 25. Also enter this amount on Form 1120, Schedule J, line 2, or the applicable line of your tax return
                                                    		<span class="styBoldText">
								            <span style="width:4px;"/>
								             <span style="width:4px;"/>.
                                             <span style="width:4px;"/>.
                  ...
                  <span class="IRS1120ScheduleD_styLNBox" style="height:8mm; padding-top:4mm">26</span>
                  <div class="IRS1120ScheduleD_styLNValBox" style="height:8mm; padding-top:4mm">
    					<xsl:call-template name="PopulateAmount">
                ...
                <!-- END LINE 14 -->
                 ...
                 <div class="IRS1120ScheduleD_styFormFooter" style="width:707px;border-top-width: 1px;">
                   <span style="width:98mm;font-weight:bold;font-size:7pt;" class="styGenericDiv">For Paperwork Reduction Act Notice, see the Instructions for Form 1120.</span>
                   <span style="width:38mm;font-weight:normal;font-size:6pt;text-align:center;" class="styGenericDiv">Cat. No. 11460M</span>
                   <span style="width:50mm;text-align:right;font-weight:bold;font-size:6pt;" class="styGenericDiv" >Schedule D (Form 1120) 2009</span>
                 </div>
                 <!-- BEGIN FOOTER -->
               </form>
               <!-- leftover data table -->

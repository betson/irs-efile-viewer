...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/RecaptureUnderSection1503dOnTransferStatement" />
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
         <th class="styDepTblCell" scope="col">Description of Property Transfered</th>        
         <th class="styDepTblCell" scope="col">Amount of Recapture</th>    
      </tr>
      </thead>
        <tfoot></tfoot>
        
       <tbody>
      <xsl:for-each select="$DependencyData/RecaptureSect1503dTrnsfrStmt">
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:right" width="35mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="AmountOfRecapture"/>
            </xsl:call-template>
          </td>     

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/GainRecognizedUnderSection904f5FOnTransferStatement" />
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/GainRcgnzSect904f5FTrnsfrStmt">
        <tr>

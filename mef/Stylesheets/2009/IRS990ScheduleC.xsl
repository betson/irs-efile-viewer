...
Complete if the organization is described below.</span>
							<br/>
							<img src="{$ImagePath}/990SchC_Bullet_Md.gif" alt="SchCMd Bullet"/>
							<span style="font-weight:bold;font-size:7pt;text-align:center;"> Attach to Form 990 or Form 990-EZ. 
							<img src="{$ImagePath}/990SchC_Bullet_Md.gif" alt="SchCMd Bullet"/>
		...
		Section 501(c)(3) organizations: Complete Parts I-A and B. Do not complete Part I-C.<br/>
		 ...
		 Section 501(c)(3) organizations that have NOT filed Form 5768 (election under section 501(h)): Complete Part II-B. Do not complete Part II-A.<br/>
						<span style="font-weight:bold;">If the organization answered “Yes,” to Form 990, Part IV, Line 5 (Proxy Tax) or Form 990-EZ, line 35a (regarding proxy tax), then</span>
						<br/>
						<img src="{$ImagePath}/990SchC_Bullet_Round.gif" alt="Round Bullet"/>
...
State the names, addresses and employer identification number (EIN) of all section 527 political organizations to which  payments<br/> were made. For each
...
political action committee (PAC). If additional space is needed, provide information in Part IV.   </div>
            ...
            Cat. No. 50084S
						...
						<div style="width:50mm;text-align:right;float:left;">
							<span style="font-weight:bold;font-size:6pt">Schedule C (Form 990 or 990-EZ) 2009</span>
						</div>
					</div>
					<br/>
					<!--END Page Footer-->
					...
					<div class="styBB" style="width:187mm; float: none; clear:none">
						<div style="float:left">Schedule C (Form 990 or 990-EZ) 2009</div>
      ...
      <span class="IRS990ScheduleC_Dotspacing"> ...............</span>
							...
							<tr>
								...
								<td class="IRS990ScheduleC_LineDesc" style="width:123mm; height:4.5mm" colspan="3">
									<span style="width:66mm;font-weight:bold;border-left:1px solid;border-top:1px solid;height:4.5mm">If the amount on line 1e, column (a) or (b) is:</span>
									<span style="width:57mm;font-weight:bold;border-right:1px solid;border-left:1px solid;border-top:1px solid;height:4.5mm">The lobbying nontaxable amount is:</span>
								</td>
...
<span class="IRS990ScheduleC_Dotspacing"> ......................................</span>
        ...
        Calendar year (or fiscal year<br/> beginning in)
								...
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(a) </span>2006</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(b) </span>2007</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(c) </span>2008</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(d) </span>2009</th>
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule C (Form 990 or 990-EZ) 2009</span>
						</div>
					</div>
					<br/>
					<br/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<div class="styPartDesc" style="width:169mm;font-weight:bold"> Complete if the
organization is exempt under section 501(c)(3) and has NOT filed Form 5768
...
if BOTH Part III-A, lines 1 and 2 are answered “No” OR if Part III-A, line 3 is
answered “Yes”.
							<!-- <br />
...
Complete this part to provide the descriptions required for Part l-A, line 1; Part l-B, line 4; Part l-C, line 5; and Part ll-B, line 1i.<br/>Also, complete this part for any additional information.
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							<span style="width:80px;"/>
							<span class="styBoldText"> Schedule C (Form 990 or 990EZ) 2009</span>
						</div>
					</div>
					<!--END Page Footer-->
					<br/>

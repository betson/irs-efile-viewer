  ...
  <div style="width:187mm;" class="styBB">
   ...
   <!-- Page Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
      ...
      <div class="styGenericDiv" style="float:right;font-size:6pt;"><span class="styBoldText">Schedule M (Form 990) 2009</span> 
    </div> </div>
<!--END Page Footer-->

  <!-- Page 2 header -->
    <div style="width:187mm;clear:both;padding-bottom:0mm;float:none;clear:both;" class="styBB">
      <div style="width:90mm;font-size:6.25pt;font-weight:bold;padding-top:1mm;" class="styGenericDiv">Schedule M (Form 990) 2009</div>
...
<xsl:call-template name="SetInitialDynamicTableHeight">
   ...
   <!-- Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule M (Form 990) 2009</span></div>
    </div>

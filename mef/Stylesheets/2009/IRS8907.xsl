	...
	<xsl:template match="/">
				...
				<form name="Form8907">
					...
					<div class="styBB" style="width:187mm;height: 20mm;">
						...
						<div class="styFTBox" style="height: 22mm;width:125mm;padding-top:4mm;">
							<div class="styMainTitle" style="height: 8mm">See Instructions.</div>
		...
		<span style="font-weight:normal; border-style: solid; border-color: black;width:27mm;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
						...
						<div class="styLNRightNumBox" style="width:47mm;border-right-width:0px;height:10mm;">
							...
							<div class="styLNDesc" style="font-weight:normal;width:47mm;">Qualified coke and coke gas sold after 12/31/2008 and before 1/1/2010</div>
						</div>
						<div class="styLNRightNumBox" style="width:47mm;border-right-width:0px;height:16.1mm;">
							...
							<div class="styLNDesc" style="font-weight:normal;width:47mm;">Qualified coke and 
				                 coke gas sold after 12/31/2009</div>
						</div>
					</div>
					<!-- Line 2 -->
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="width:47.3mm;border-right-width:0px;height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/CYQlfyCokeAndCokeGasSoldType1"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="width:47mm;border-right-width:0px;height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
          ...
          Form <span class="styBoldText">8907</span> (2009)
        </div>
					<br class="pageEnd"/>

          ...
          Add lines 10 and 11
            ...
            ...........................
              ...
              <div class="styIRS8609ScheduleALNAmountBox">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form8609SAData/
            AdjustedCreditForLowIncomeBldg"/>
                </xsl:call-template>
              </div>
            </div>
          </div>

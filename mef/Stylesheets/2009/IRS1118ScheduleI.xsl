...
<body class="styBodyClass">
  ...
  <div class="LineContainerLong">
    <!-- Form Name -->
          <div class="IRS1118ScheduleI_FormNumBlock" style="height:21.5mm;">
       <span style="font-size:9pt;" class="styFormNumber">SCHEDULE I<br/>(Form 1118)</span>
       <xsl:call-template name="SetFormLinkInline">
           <xsl:with-param name="TargetNode" select="$FormData"/>
       </xsl:call-template>
            <br/>
      <span style="font-size:6pt;">(Rev. December 2009)</span> 
       <br/>
            <br/>
    ...
    <!-- Form Title Box -->
          <div class="IRS1118ScheduleI_FormTitleBlock" style="padding-top:3mm;height:21.5mm;">
      <!-- Form Title -->
      ...
      <!-- IRS1118ScheduleI_NameBox No. -->
          <div class="IRS1118ScheduleI_FormYearBlock" style="height:21.5mm;">OMB No. 1545-0122</div>
  </div>
  <!-- Name and Address -->
      ...
      <tr>
        ...
        <th class="IRS1118ScheduleI_GenericCell" style="width:109mm;height:3mm;font-weight:bold;text-align:center;" colspan="3" scope="colgroup">
          Deductions
                ...
                <th class="IRS1118ScheduleI_GenericCell" style="text-align:center;" rowspan="2">
   ...
   <!--BEGIN FOOTER-->
      <div style="width:256mm">
        ...
        <div style="float:right">
          ...
          <span class="styBoldText" style="padding-right:2mm">Schedule I (Form 1118) (Rev. 12-2009)</span>
        </div>      
      </div>     
        <div class="pageEnd"/>
      <!--END FOOTER-->  
      <!--BEGIN HEADER-->
      <div class="styBB" style="width:256mm">
        <div style="float: left; clear: none">Schedule I (Form 1118) (Rev. 12-2009)</div>        
  ...
  <div class="LineContainer">
   ...
   <div class="LineContainer">
      ...
      <div class="IRS1118ScheduleI_LineDesc">Combined foreign oil and gas income. (See the instructions for <span style="font-weight: bold">Line 1</span> below.)
...
<table class="styDepTbl"  style="width: 256mm;font-size: 7pt">
	<thead class="styTableThead">
	 ...
	 <xsl:call-template name="SetFormLinkInline">
      ...
      <tr class="styDepTblHdr">
                <td class="styDepTblCell" style="width:51mm;height:4mm;font-weight:bold;text-align:center;font-size:7pt;" scope="row">
          Totals 
        </td>
         <td class="styDepTblCell" style="height:4mm;text-align: right">
        <xsl:call-template name="PopulateAmount">

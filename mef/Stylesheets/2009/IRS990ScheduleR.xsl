...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
              ...
              (f)<br/>
					...
					<div style="width:256mm;float:none;clear:both;padding-top:.2mm;border-top:1px;" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;padding-right:4mm">
							<span class="styBoldText">Schedule R (Form 990) 2009</span>
						</div>
					</div>
					<!-- *********BEGIN NEW PAGE 2********** -->
					<!-- header -->
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule R (Form 990) 2009</div>
       ...
       Identification of Related Organizations Taxable as a Corporation or Trust
        ...
        <span style="font-weight:normal">  (Complete if the organization answered "Yes" on Form 990, Part IV, line 34, 35, or 36.)</span>
       </div>
          ...
          <!--Dotted Line-->
					...
					<div class="styTableContainerLandscape" id="IRT5ctn" style="width:256mm;">
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:196mm;padding-right:10mm;border-top-width:1px">(a)      
              <br/>
              ...
              (b)<br/>
									...
									<th class="styTableCellHeader" scope="col" style="width:30mm;padding-right:2mm;border-right-width:0px;border-top-width:1px">
              (c)<br/>
							...
							<tbody>
								...
								<xsl:if test="count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &lt; 2 or ((count($Form990ScheduleRData/TransactionsRelatedOrgsTable) &gt; 6) and ($Print = $Separated)) ">
									<tr>
										<td class="styTableCellText" style="width:196mm;border-right-width:1px;">
											<span style="font-weight:bold;"> (<xsl:number value="position()" format="1"/>)    </span>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$Form990ScheduleRData/TransactionsRelatedOrgsTable"/>
											</xsl:call-template>

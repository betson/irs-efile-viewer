...
<!-- change -->    
  <xsl:param name="Form990DepsData" select="$RtnDoc/InvestmentsOtherSchedule" />
<!-- end change -->
...
<!-- change -->    
        ...
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Cost/FMV</th>
      </tr>          
      <xsl:for-each select="$Form990DepsData/InvestmentOther">
<!-- end change -->
        <tr>
...
<!-- change -->    
          ...
          <td class="styDepTblCell" style="text-align:left">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="CostOrFmv" /></xsl:call-template>             
          </td>                                    
<!-- end change -->    
        </tr>
      </xsl:for-each>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherExpensesSchedule" />
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl" style="font-size: 7pt">
      ...
      <tr class="styDepTblHdr">         
		...
		<th class="styDepTblCell" scope="col">Revenue and Expenses per Books</th>      
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/OtherExpenses">
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:right; width: 30mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="RevenueAndExpensesPerBooks"/>
            </xsl:call-template>
          </td>         
          ...
          <td class="styDepTblCell" style="text-align:right; width: 30mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="DisbursementsCharitablePrps"/>
            </xsl:call-template>
          </td>         

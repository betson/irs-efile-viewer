...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <form name="Form851">
          ...
          <div style="width:187mm;">
            <div class="styFNBox" style="width:32mm;height:18.75mm;">
              ...
              <div class="styAgency" style="width:22mm;">(Rev. December 2005)
               ...
               %
                    ...
                    <xsl:otherwise>
                      <td class="styTableCell" style="width:27mm;height:10mm;font-size:7pt;border-color:black;">
                        <xsl:call-template name="PopulatePercent">
                          <xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/ValuePercentageOfAcquirable"/>
                        </xsl:call-template>
                        <span class="styTableCellPad"/>
                      </td>
                    </xsl:otherwise>
            ...
            %
                    ...
                    <xsl:otherwise>
                      <td class="styTableCell" style="width:27mm;height:5mm;text-align:right;font-size:7pt;border-color:black;">
                        <xsl:call-template name="PopulatePercent">
                          <xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/VotingPercentageAcquirable"/>
                        </xsl:call-template>
                        <span class="styTableCellPad"/>
                      </td>
                    </xsl:otherwise>
            ...
            %
                    ...
                    <xsl:otherwise>
                      <td class="styTableCell" style="width:26mm;height:10mm;font-size:7pt;border-color:black;border-right:none;">
                        <xsl:call-template name="PopulatePercent">
                          <xsl:with-param name="TargetNode" select="$Form851Data/CommonParentCorporationInfo/AdditionalStockInformation/VotingPowerPctAcquirable"/>
                        </xsl:call-template>
                      </td>
                    </xsl:otherwise>
                  </xsl:choose>
                        ...
                        <xsl:choose>
                          <xsl:when test="ValuePercentageOfAcquirable!=''">
                            <td valign="middle" class="styTableCell" style="">
                              ...
                              <xsl:call-template name="PopulatePercent">
                                <xsl:with-param name="TargetNode" select="ValuePercentageOfAcquirable"/>
                              </xsl:call-template>
                              <span class="styTableCellPad"/>
                            </td>
                          </xsl:when>
                        ...
                        <xsl:choose>
                          <xsl:when test="VotingPercentageAcquirable!=''">
                            <td valign="middle" class="styTableCell">
                              ...
                              <xsl:call-template name="PopulatePercent">
                                <xsl:with-param name="TargetNode" select="VotingPercentageAcquirable"/>
                              </xsl:call-template>
                              <span class="styTableCellPad"/>
                            </td>
                          </xsl:when>
                        ...
                        <xsl:choose>
                          <xsl:when test="VotingPowerPctAcquirable!=''">
                            <td valign="middle" class="styTableCell">
                              ...
                              <xsl:call-template name="PopulatePercent">
                                <xsl:with-param name="TargetNode" select="VotingPowerPctAcquirable"/>
                              </xsl:call-template>
                            </td>
                          </xsl:when>
                          <xsl:otherwise>
  ...
  <xsl:template name="PartIITable_EmptyRow">
    <tr style="height: 10mm;">
      ...
      <td class="styTableCell" style="width:43mm;font-size:7pt;border-color:black;vertical-align:top;text-align:left;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:12mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
  ...
  <xsl:template name="PartIIITable_EmptyRow">
    <tr>
      <td class="styTableCell" style="width:10mm;height:10mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:54mm;height:5mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:14mm;height:5mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:20mm;height:5mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:23mm;height:5mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>
      </td>
      <td class="styTableCell" style="width:23mm;height:5mm;font-size:7pt;border-color:black;">
        <span class="styTableCellPad"/>

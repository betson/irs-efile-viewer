...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <body class="styBodyClass">
        <form name="IRS990ScheduleH">
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <span style="font-weight:bold;font-size:6.25pt;">Schedule H (Form 990) 2009</span>
          </div>
          
          <!-- PAGE2HEADER  -->
          <div class="styBB" style="width:187mm; padding-bottom:.5mm;">
            <div style="float:left;">Schedule H (Form 990) 2009</div>
          ...
          <div style="width: 187mm">
            ...
            <div class="styLNDesc" style="width: 155mm;padding-top:.5mm;">
              <span style="float:left; clear: none">Provide in Part VI the text of the footnote to the organization's financial statements that describes bad debt expense. In addition, describe the costing methodology used in determining the amounts reported on lines 2 and 3, and rationale for including other bad debt amounts in community benefit.</span>
            </div>
          ...
          <div class="styBB" style="width:183mm;height:4mm;border-top-width:1px;">
            ...
            <table class="styTable" cellspacing="0" name="TYTable" id="TYTable">
              <thead class="styTableThead">
                <tr style="height:6mm;">
                  ...
                  <th class="styTableCellHeader" style="width:26mm;border-right-width:0px;border-right-width:1px;border-color:black;font-weight:normal;" scope="col">
                    <b>(c)</b> Organization's
                    <br/>profit % or stock
                    <br/>ownership %
                </th>
                  <th class="styTableCellHeader" style="width:29.5mm;padding-left:1mm;padding-top:1mm; border-color:black;font-weight:normal;" scope="col">
              ...
              <tbody>
                <xsl:choose>
                  <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartIV ">
                    <xsl:if test="($Print != $Separated) or (count($Form990ScheduleHData/Form990ScheduleHPartIV) &lt;=14) ">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:0mm;">
            ...
            <div style="float:right;">
              ...
              <span class="styBoldText" style="font-weight:bold;font-size:6.25pt;">Schedule H (Form 990) 2009</span>
            </div>
          </div>
          ...
          <div class="styTableContainer" id="PartVctn" >
            ...
            <table border="0" cellspacing="0" cellpadding="0" style="width:100%;font-size:7pt;clear:both;">
              <thead class="styTableThead" style="font-size:7pt;border-left-width:0;border-top-width:0;">
                <tr>
                  <th class="styTableCellHeader" scope="col" style="vertical-align:top;padding-top:5mm;width:90mm;border-bottom-width:1px; border-style:solid;border-color:black;border-right-width:0px;font-size:8pt;">
                  ...
                  <th class="styTableCellHeader" scope="col" style="vertical-align:top;padding-top:5mm;width:34mm;border-bottom-width:1px; border-style:solid;border-color:black; border-right-width:0px;padding-left:1mm;font-size:8pt;">
          ...
          <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
            ...
            <div style="width:58mm;font-size:6pt;text-align:right;padding-top:1mm;float:right;font-weight:bold;">Schedule H (Form 990) 2009</div>
          </div>
          ...
          <div style="width:187mm;">
            ...
            <div style="width:187mm;"/>
            <xsl:choose>
              <xsl:when test="not($Form990ScheduleHData/Form990ScheduleHPartVI/AnnualCommunityBenefitExpln)">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              </xsl:when>
              <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartVI/AnnualCommunityBenefitExpln = ''">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              ...
              <xsl:otherwise>
                <div class="styBB" style="width:187mm;margin-left:0.75mm;text-align:justify;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleHData/Form990ScheduleHPartVI/AnnualCommunityBenefitExpln "/>
                  </xsl:call-template>
                </div>
              </xsl:otherwise>
            </xsl:choose>
            <div style="width:187mm;"/>
            <xsl:choose>
              <xsl:when test="not($Form990ScheduleHData/Form990ScheduleHPartVI/SubsidizedHealthServicesExpln)">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              </xsl:when>
              <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartVI/SubsidizedHealthServicesExpln= ''">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              ...
              <xsl:otherwise>
                <div class="styBB" style="width:187mm;margin-left:0.75mm;text-align:justify;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleHData/Form990ScheduleHPartVI/SubsidizedHealthServicesExpln"/>
                  </xsl:call-template>
                </div>
              </xsl:otherwise>
            </xsl:choose>
            <div style="width:187mm;"/>
            <xsl:choose>
              <xsl:when test="not($Form990ScheduleHData/Form990ScheduleHPartVI/PercentOfTotalExpenseExpln)">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              </xsl:when>
              <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartVI/PercentOfTotalExpenseExpln= ''">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              ...
              <xsl:otherwise>
                <div class="styBB" style="width:187mm;margin-left:0.75mm;text-align:justify;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleHData/Form990ScheduleHPartVI/PercentOfTotalExpenseExpln"/>
                  </xsl:call-template>
                </div>
              </xsl:otherwise>
            </xsl:choose>
            ...
            <div style="width:187mm;"/>
            <xsl:choose>
              <xsl:when test="not($Form990ScheduleHData/Form990ScheduleHPartVI/NumberOfFacilityTypeExpln)">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              </xsl:when>
              <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartVI/NumberOfFacilityTypeExpln= ''">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              ...
              <xsl:otherwise>
                <div class="styBB" style="width:187mm;margin-left:0.75mm;text-align:left;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleHData/Form990ScheduleHPartVI/NumberOfFacilityTypeExpln"/>
                  </xsl:call-template>
                </div>
              </xsl:otherwise>
            </xsl:choose>
            <div style="width:187mm;"/>
            <xsl:choose>
              <xsl:when test="not($Form990ScheduleHData/Form990ScheduleHPartVI/GeneralExplanation)">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              </xsl:when>
              <xsl:when test="$Form990ScheduleHData/Form990ScheduleHPartVI/GeneralExplanation= ''">
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
                <div class="styBB" style="width:187mm;"/>
              ...
              <xsl:otherwise>
                <div class="styBB" style="width:187mm;margin-left:0.75mm;text-align:left;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleHData/Form990ScheduleHPartVI/GeneralExplanation"/>
                  </xsl:call-template>
                </div>
              </xsl:otherwise>
            </xsl:choose>
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left; padding-top:1mm">
              <b>Community building activities. </b>
              Describe how the organization's community building activities, as reported in Part II, promote the health of the communities the organization serves. 
            </div>
            <xsl:choose>
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left; padding-top:1mm">
              If the organization is part of an affiliated health care system, describe the respective roles of the organization and its affiliates in promoting the health of the communites served. 
            </div>
            <xsl:choose>
          ...
          <xsl:if test="($Print = $Separated) and (count($Form990ScheduleHData/Form990ScheduleHPartV) &gt; 16)">
            ...
            <table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
              <thead class="styTableThead" style="font-size:7pt;">
                <tr class="styDepTblHdr">
                  <th class="styDepTblCell" scope="col" style="width:90mm;">
                    Name and address
                  </th>
                  <th class="styIRS990SchHVTImageBox" style="width:7mm;border-style:solid;border-color:black;border-left-width:1px; vertical-align:top;border-right-width:1px;border-top-width:0px;border-bottom-width:1px; " scope="col" rowspan="10" valign="middle">
                    <img src="{$ImagePath}/990SchH_LicHosp.gif" alt="Licensed Hospital"/>
                  </th>
                  ...
                  <th class="styIRS990SchHVTImageBox" style="width:7mm;border-style:solid;border-color:black;border-left-width:0px;vertical-align:top;border-right-width:1px;border-top-width:0px;border-bottom-width:1px; " scope="col" rowspan="10" valign="middle">
                    <img src="{$ImagePath}/990SchH_TeachHosp.gif" alt="Teaching Hospital"/>
                  </th>
                  <th class="styIRS990SchHVTImageBox" style="width:7mm;border-style:solid;border-color:black;border-left-width:0px;border-right-width:1px;border-top-width:0px;border-bottom-width:1px; " scope="col" rowspan="10" valign="middle">
                    <img src="{$ImagePath}/990SchH_CriticalHosp.gif" alt="Critical Hospital"/>
              ...
              <tbody>
                <xsl:for-each select="$Form990ScheduleHData/Form990ScheduleHPartV">
                  ...
                  <tr>
                    ...
                    <td class="styDepTblCell" style="width:45mm;border-right-width:0px;text-align:left;padding-right:1px;">
                      <xsl:call-template name="PopulateAmount">
                        <xsl:with-param name="TargetNode" select="Other"/>
                      </xsl:call-template>
                      <span style="width:1px;"/>
  ...
  <xsl:template name="IRS990SchHPartVTableFillerRow">
    <tr>
      <td class="styTableCellText" style="width:85mm;height:4mm;">
        <span style="width:1px"/>
      </td>
      ...
      <td class="styTableCell" style="width:50mm;border-right-width:0px;height:4mm;">
        <span style="width:1px"/>
      </td>
    </tr>
  </xsl:template>

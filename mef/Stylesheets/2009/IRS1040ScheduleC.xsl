...
<!-- put comment here -->
 ...
 <img src="{$ImagePath}/1040SchC_Bullet_Sm.gif"  alt="Bullet Image"/> Partnerships, joint ventures, etc., generally must file Form 1065 or 1065-B.<br/>
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <div class="styNameBox" style="width:134mm;height:8mm;padding-top:1mm;font-size:7pt;border-right-width: 0px;">
        ...
        Principal business or profession, including product or service (see page C-3 of the instructions)<br/>          
 ...
 <!-- Item C-->
    ...
    <div style="width:187mm;font-size:7pt">
      <div class="styLNLeftNumBoxSD" style="height:17mm;">1</div>
      <div class="styLNDesc" style="width:112mm;height:17mm;">
        Gross receipts or sales. <b>Caution.</b> See page C-4 and check the box if:
         <div class="styLNDesc" style="width:112mm;padding-top:2mm;">
         ...
         to self-employment tax. Also see page C-4 for limit on losses.</li> 
        </label>  
         </div>        
           </div>        
         <div class="styLNDesc" style="width:2mm; height:10mm;padding-top:5mm;">
        <img src="{$ImagePath}/1040SchC_Bracket.gif"  align="bottom" height="50mm" alt="Curly Bracket Image"/>              
      </div>
      <div class="styLNDesc" style="width:25.3mm;height:20mm;padding-top:10mm;padding-left:2mm;">
           <xsl:call-template name="SetFormLinkInline">
      ...
      <div class="styLNRightNumBox" style="height:14mm;padding-top:9mm;width:8mm;">1</div>
      <div class="styLNAmountBox" style="height:14mm;padding-top:9mm;width:31.5mm;">
        <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/GrossReceiptsOrSalesAmt" />
        </xsl:call-template>      
      </div>        
         <div class="styLNRightNumBox" style="height:6mm;width:8mm;border-bottom-width:0px; "></div>
      <div class="styLNAmountBox" style="border-bottom-width:0px;height:6mm;width:31.5mm; ">
      </div>          
    </div>
    <!--Line 2-->
    <div style="width:187mm;">
      <div class="styLNLeftNumBoxSD" style="height:4mm;">2</div>
      <div class="styLNDesc" style="width:139.5mm;height:4;font-size:7pt">Returns and allowances
        <!--Dotted Line-->
        <span class="styBoldText">
          <span style="width:16px;"></span>.
          <span style="width:16px;"></span>. 
    ...
    <div style="width:187mm;font-size:7pt">
      ...
      <div class="styLNDesc" style="width:139.5mm;height:4mm;">Other incomes, including federal and state gasoline or fuel tax credit or refund (see page C-4)
      <span class="styBoldText">
          <span style="width:16px;"></span>.
          <span style="width:16px;"></span>.  
        </span>    
...
<!--Line 9-->
          <tr>
            ...
            <td class="styGenericDiv" style="width:41mm;font-size:7pt;" colspan="1">Car and truck expenses (see <br/>page C-5)
              <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:16px"></span>.
                <span style="width:16px"></span>.
...
<!--Line 10-->
        ...
        <!--Line 11-->  
          <tr>
            ...
            <td class="styGenericDiv" style="width:41mm;height:4.5mm;" >Contact labor (see pages C-5)            
            </td>
          ...
          <tr>
            ...
            <td class="styGenericDiv" style="width:45mm;height:4.5mm;">Mortage (paid to banks, etc.)
              <!--Dotted Line-->
              <span class="styBoldText">   
              </span>
            </td>
      ...
      <table class="styTable" style="width:93mm;float:left;font-size:7pt;" cellspacing="0">
       ...
       <!--Line 20-->      
          ...
          <tr>
            ...
            <span style="width:3mm;"></span>  b</td>
            <td class="styGenericDiv" style="width:45mm;height:4.5mm;" >Deductible meals and <br/>entertainment (see page C-7)   
                  <!--Dotted Line-->
              <span class="styBoldText">  
              </span>  
            </td>
...
<div style="width:187mm;">
     ...
     <xsl:call-template name="LinkToLeftoverDataTableInline">
      ...
      <xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/NetProfitOrLossAmt/@passiveActivityLossLiteralCd"/>
       ...
       <br/>   </li>   
            <li>If a loss, you <span class="styBoldText">must</span> go on to line 32.</li>             
        </div>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:none;">
      ...
      <div class="styLNDesc" style="width:2mm; height:10mm;padding-top:3mm;">
     ...
     <!--Line 32a-->  
      <div class="styLNDesc" style="width:40mm;height:4mm;padding-top:2mm;">
       ...
       <!--Line 32b-->  
      <div class="styLNDesc" style="width:41mm;height:4mm;padding-top:2mm;">
        <span style="width:.5mm;"></span>
    ...
    <div class="pageEnd" style="width:187mm;">  
        <span class="styBoldText">For Paperwork Reduction Act Notice, see page C-9 of the instructions. </span>   
        <span style="width:15mm;"></span>                        
        Cat. No. 11334P 
        <span style="width:7mm;"></span>  
        <span class="styBoldText" >Schedule C (Form 1040) 2009 </span>
    </div>   
    <!--Begin Page 2 -->   
    <!-- Header -->    
      <div class="styBB" style="width:187mm;border-bottom-width: 0px;">  
    ...
    <div class="styBB" style="width:187mm;float:left;clear:none;">  
      <div style="float:left;">Schedule C (Form 1040) 2009 <span style="width:130mm;"></span></div>
 ...
 <!--Line 33--> 
   ...
   If "Yes," attach explanation
    ...
    <!--Line 35-->
    <div style="width:187mm;font-size:7pt;">      
      <div class="styLNLeftNumBox" style="height:5mm;padding-top:2mm;">35</div>      
...
<!-- End Part V Table-->
  <!--Line 48-->
    ...
    <div style="width:187mm;">    
      ...
      <div class="stySmallText" style="width:46mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2009</span> </div>
    </div>       
      <br /><br class="pageEnd"/>

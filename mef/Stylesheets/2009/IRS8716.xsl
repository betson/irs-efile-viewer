      ...
      <body class="styBodyClass">
        <form style="font-family:Arial; font-size:8.5pt" name="Form8716">
          ...
          <span class="styFormNumber" style="margin-left:3mm">8716</span>
              ...
              <div style="font-size:6pt; margin-top:.5mm;">        
          ...
          <div style="float:left; width:71mm; padding-top:0.5mm">
                ...
                <div style="padding-top:0.5mm">
                  ...
                  S corporation (or C corporation electing to be<br/>an S corporation)
          ...
          <div class="styBB" style="width:187mm">
            ...
            <div style="float:right; border-left:1 solid black; text-align:center; height:8.5mm">
              <div style="float:left; text-align:center">
                <div style="float:left; border-bottom:1 solid black; height:4.2mm; width:23.7mm">

              Month

            </div>
                <div style="border-left:1 solid black; float:left; border-bottom:1 solid black; height:4.2mm; width:23.7mm">
          ...
          Under penalties of perjury, I declare that the entity named above has authorized me to make this election under section 444(a), and that the statements made are, to<br/>the best of my knowledge and belief, true, correct, and complete.

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html lang="EN-US">
         ...
         Internal Revenue Service (99)
						...
						<div class="styFTBox" style="width:127mm;height:18mm; ">
							<div class="styMainTitle" style="height:4mm;margin-top:2mm;">Interest and Ordinary Dividends  
						...
						<div class="styTYBox" style="width:30mm;height:19.5mm;">
							<div class="styOMB" style="height:1mm;">
								<span style="font-size:6pt;padding-left:5mm;">
									<!--Version A, Cycle 3-->
									<span style="font-size:6pt;">OMB No. 1545-0074 </span>
								</span>
							</div>
							<div class="styTaxYear" style="font-size:16pt;padding-top:0mm;">
                  ...
                  form.
                        ...
                        List name of payer. If any interest is from a seller-financed mortgage and the
                          ...
                          interest first. Also, show that buyer&apos;s social security number and address
										...
										<th class="styTableCell" scope="col" rowspan="2" style="height:4mm;width:31.3mm;border-bottom-width:1px;border-right-width:0px;text-align:center;">
	...
	<div style="width:187mm;float:left;clear:none;padding-bottom:0mm;border-bottom-width:1px;">
				...
				<div class="styGenericDiv" style="width:2mm;float:right;padding-top:.6mm;">
									<!-- button display logic -->
									<xsl:call-template name="SetDynamicTableToggleButton">
...
<th class="styTableCellHeader" scope="col" rowspan="1" style="width:114mm;border-right-width:1px;text-align:left;">
						...
						<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartII) &lt;= 19) ">
							...
							<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 1 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:114mm;height:4mm;border-right-width:1px;text-align:left;">
														<xsl:call-template name="PopulateAdditionalDataTableMessage">
															<xsl:with-param name="TargetNode" select="$FormData/Form1040SchBPartII"/>
														</xsl:call-template>
													</td>
                ...
                You must complete this part if you<span class="styBoldText"> (a) </span>had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
                    ...
                    At any time during 2009, did you have an interest in or a signature or other authority over a financial
               ...
               <xsl:call-template name="LinkToLeftoverDataTableInline">
                    ...
                    If "Yes," enter the name of the foreign country
                      <span style="float:none;clear:none;padding-left:1mm;">
										...
										<span class="styNameAddr" style="float:none;clear:none;border-style:dashed;width:66mm;font-size:7pt">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignCountryName"/>
												<xsl:with-param name="BackupName">IRS1040ScheduleEForeignCountryName</xsl:with-param>
											</xsl:call-template>
										</span>
									</span>
								</div>
					...
					<div style="width:187mm; border-top:1 solid black;border-top-width:1px;">
						<div style="width:100mm;font-weight:bold;" class="styGenericDiv">For Paperwork Reduction Act Notice, see 1040A or 1040 instructions.</div>
						<div style="width:25mm;text-align:center;" class="styGenericDiv">Cat. No. 17146N</div>
						<div style="float:right;" class="styGenericDiv">Schedule B (Form 1040A or 1040) <b>2009</b>
						</div>
					</div>
					<!-- end page 2 footer -->
					<br/>

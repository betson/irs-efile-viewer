		...
		<table cellspacing="0">
			<tbody>
				...
				<tr  style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					...
					<td style="border-color: black;text-align: right;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;padding-right:6px">
						<xsl:call-template name="PopulateAmount">
				...
				<tr  style="font-size:7pt;height:8mm;vertical-align:bottom;padding-bottom:4px">
					...
					<td style="width:23mm;border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: center;padding-left:3mm;">
						<xsl:call-template name="PopulateText">
					...
					<td style="border-color: black;border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;text-align: right;padding-right:8px">
						<xsl:call-template name="PopulateAmount">

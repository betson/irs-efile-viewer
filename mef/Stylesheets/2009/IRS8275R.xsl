  ...
  <xsl:template match="/">
          ...
          <div style="width:187mm;height:18mm;" class="styTBB">
            <div style="width:32mm;height:20.5mm;" class="styFNBox">
              <div style="height:13.5mm;">Form<span class="styFormNumber" style="font-size: 18pt;">  8275-R</span>
                <br/> <div style="font-size:normal">(Rev. August 2008) </div><br/>
              </div>
    ...
    Identifying number shown on return<br/>
       ...
       General Information <span class="styNormalText">(see instructions.)</span>
          ...
          (b)<br/><div> Item or Group</div> of Items
        </th>
    ...
    Information About Pass-Through Entity. <span class="styNormalText">To be completed by partners, shareholders, beneficiaries, 
   <div style="width:60mm;"> or residual interest holders.</div></span>
            </div>
          </div>
          <div style="width:187mm;" class="styBB">
    ...
    <br/>
            ...
            <div style="width:120mm;">   trust (REIT), or real estate mortgage investment conduit (REMIC).</div></span>
            </div>
          </div>
      ...
      Tax year of pass-through entity<br/>
        ...
        its return<br/>
          ...
          <div style="width:187mm;clear:both;padding-top:1mm;">
            ...
            <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8275-R</span> (Rev. 8-2008)</div>
          </div>

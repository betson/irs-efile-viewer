...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
        ...
        <form name="Form1120FScheduleP">
          ...
          <div class="styTBB" style="width:187mm;border-bottom-width: 1px">
			...
			See separate instructions.
                ...
                <tr>
                  <td class="sty1120FSchPTY">20<span class="styTYColor">09</span>
                  </td>
                </tr>
              </tbody>
            </table>
	...
	<br/>
              ...
              <tbody>
                <xsl:if test="($Print != $Separated) or (count($FormData/ForeignPartnerInfo) &lt;= 4) ">
                  <xsl:for-each select="$FormData/ForeignPartnerInfo">
                    <tr>
                      ...
                      <!--  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  -->
                      <!--Foreign Corp -->
                      <td class="sty1120FSchPTableCellDataRG" style="border-left-width:1px;">
                        ...
                        <input type="checkbox" class="styCkbox" name="InitialReturn" id="DistributiveShareTreatedAsECI">
                        ...
                        <label>
                          <xsl:call-template name="PopulateLabelYes">
                            <xsl:with-param name="TargetNode" select="DistributiveShareTreatedAsECI"/>
                            <xsl:with-param name="BackupName" select="DistributiveShareTreatedAsECI"/>
                          </xsl:call-template>
                ...
                <xsl:if test="count($FormData/ForeignPartnerInfo)&lt; 2  or ((count($FormData/ForeignPartnerInfo) &gt; 4) and ($Print = $Separated))">
                  <tr>
                    ...
                    <td class="styTableCell" style="border-right-width:0px;border-left-width:1px;border-color:black">
                      <span style="width:6mm"/>
                ...
                <xsl:if test="count($FormData/ForeignPartnerInfo)&lt; 4  
                  ...
                  <tr>
                    ...
                    <td class="styTableCell" style="border-right-width:0px;border-left-width:1px;border-color:black;border-bottom-width:0px;">
                      <span style="width:6mm"/>
                      <input type="checkbox" class="styCkbox" name="InitialReturn" id="FrgnCorpDoesNotHaveOfficeInUS">
                        <xsl:call-template name="PopulateCheckbox">
                          <xsl:with-param name="TargetNode" select="$FormData/FrgnCorpDoesNotHaveOfficeInUS"/>
		...
		Note: <span style="font-weight:normal; padding-left:2mm">
          ...
          <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
            <tbody>
                ...
                <xsl:for-each select="$FormData/ForeignPartnerInfo">
                  <xsl:if test="position() mod 4 = 1">
                    ...
                    <tr>
                      ...
                      <td colspan="5" class="sty1120FSchPTableK1CellMainHeader">
                        <b>Schedules K-1</b>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="sty1120FSchPTableK1Desc" scope="row">
											Interest expense directly allocable under Temporary Regulations section1.882-5T(a)(1)(ii)(B).<span style="width:2mm"/>(<b>Note: </b> Include the line 14b total on Schedule I, line 22.) <span class="sty1120FSchPDotLn">.........</span>
                      </td>
              ...
              <xsl:if test="($Print = $Separated and count($FormData/ForeignPartnerInfo) &gt; 4) or count($FormData/ForeignPartnerInfo) = 0">
                ...
                <tr>
                  ...
                  <td class="sty1120FSchPTableK1Desc" scope="row">
				                	...
				                	1.882-5T(a)(1)(ii)(B). <br/>	(<b>Note:</b> Include the
              ...
              <!-- end Part I filter table  -->
            </tbody>
          </table>
          <!-- page break and footer-->
          <div style="width:187mm;padding-top:1mm">
            <div style="float:left;">
              <span class="styBoldText">For Privacy Act and Paperwork Reduction Act Notice, see the Instructions for Form 1120-F.</span>
              <span style="width:3mm"/>
              <span style="font-size:6pt">Cat. No. 49677Z</span>
            </div>
            <div style="float:right">
              <span style="width:1mm"/>
              <span style="font-weight:bold; font-size:6pt">Schedule P (Form 1120-F) 2009</span>
            </div>
          </div>
          <div class="pageEnd"/>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Schedule P (Form 1120-F) 2009<span style="width:100mm;"/>
            </div>
                ...
                <xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/ForeignPartnerInfo) &lt; 5)">
                  ...
                  <xsl:for-each select="$FormData/ForeignPartnerInfo">
                    <xsl:if test="position() mod 4 = 1">
                        ...
                        <td class="sty1120FSchPTableK1Desc" scope="row">
					                         		Partner’s liabilities included in outside basis under section
					                         		 752 that give rise to directly allocable interest expense
					                         		  under Temporary Regulations section 1.882-5T(a)(1)(ii)(B)
                      ...
                      <!--Line 18-->
                      <tr>
                        <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:1.7mm">18</td>
                        <td class="sty1120FSchPTableK1Desc" scope="row">
          ...
          <div style="width:187mm;padding-top:0.5mm;">
            ...
            <div style="float:right;">
              ...
              <span class="styBoldText">Schedule P (Form 1120-F) 2009</span>
            </div>
          </div>
          <div class="pageEnd"/>
          <!-- end page break and footer  -->
                  ...
                  <tr>
                    ...
                    <td class="styTableCellText" style="text-align:center">
                      <xsl:choose>
                        ...
                        <xsl:when test="MissingSSNEINReason">
                          <xsl:call-template name="PopulateEIN">
                            <xsl:with-param name="TargetNode" select="MissingSSNEINReason"/>
                          </xsl:call-template>
                        </xsl:when>

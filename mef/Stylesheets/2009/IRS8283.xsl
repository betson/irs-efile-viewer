...
<html xmlns="http://www.irs.gov/efile" xmlns:efile="http://www.irs.gov/efile">
  <head>
  <title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($Form8283Data)"></xsl:with-param></xsl:call-template></title>
  ...
  <style type="text/css">
   ...
   <xsl:if test="not($Print) or $Print=''">
      <xsl:call-template name="IRS8283Style"></xsl:call-template>    
...
<div style="width:187mm;">
  <div class="styFNBox" style="width:32mm;height:21mm;">
      <div> <span style="padding-top:1mm;">Form<span style="width:6px;"></span></span>
    <span class="styFormNumber" >8283</span>
      ...
      <div><span class="styAgency">Department of the Treasury</span><br/>
  ...
  <div class="styFTBox" style="width:125mm;height:21mm;">
    ...
    <div class="styFBT" style="font-size: 7pt;padding-bottom:1mm;">
      <img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:3px;"></span>Attach to your tax return if you claimed a total deduction<br/>
      of over $500 for all contributed property.
    </div>
    <div class="styFBT"><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:1mm;"></span>See separate instructions.
    </div>
  </div>
  <div class="styTYBox" style="width:30mm;height:10.5mm;border-bottom-width:1px;"><br/>
    <div style="font-size:7pt;"><span style="width:6px;"></span>OMB No.1545-0908
    </div>
  </div>
  <div class="styTYBox" style="width:30mm;height:6mm;"><br/>
    <div style="font-size:7pt;text-align:left;"><span style="width:6px;"></span>Attachment<br/><span style="width:6px;"></span>Sequence No.
  ...
  <div class="styBB" style="width:187mm;border-top-width:1px">
    <div class="styNameBox" style="font-size:7pt;width:139mm;height:8mm;font-weight:normal;">Name(s) shown on your income tax return<br/>
...
<div style="width:187mm;">
  <div class="styBB" style="width:187mm;border-top-width:0px">
    <span style="font-size:8pt;"><b>Note.</b></span><span style="width:6px;"></span>Figure the amount of your contribution deduction before completing this form. See your tax return instructions.
  </div>
  <!--Section A -->
  <div style="width:187mm;">
    <div class="styBB" style="width:187mm;border-top-width:0px;border-bottom-width:0px;">
        <span style="font-size:8pt;"><b>Section A.  Donated Property of $5,000 or Less and Certain Publicly Traded Securities&#151;</b></span>
  ...
  <div style="width:187mm;"  id="TPctn" class="styTableContainerNBB">
    ...
    <thead class="styTableThead">
      <tr>
        <th class="styTableCell" style="width:6mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;">1</th>
        <th class="styTableCell" style="width:81mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;" colspan="3"><span class="styBoldText">(a)</span><span style="width:1mm;"></span><span style="font-size:7pt;">Name and address of the <br />donee organization</span></th>
        <th class="styTableCell" style="width:100mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;" colspan="3"><span class="styBoldText">(b)</span><span style="width:1mm;"></span><span style="font-size:7pt;">Description of donated property <br /> (For a donated vehicle, enter the year, make, model, condition, and mileage, and attach Form 1098-C if required.)</span>
     </th>
      </tr>          
    </thead>
    <tfoot></tfoot>
    <tbody>
          ...
          <tr>
            <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size:7pt;font-weight:bold;border-color:black;">
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <span style="width:4px;float:center;"></span>
                </xsl:otherwise>
              </xsl:choose>
            </td>
            <td class="styTableCell" style="width:81mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;" colspan="3">
              ...
              <!--<xsl:if test="AddressOfDoneeOrganization/AddressLine1">
                <br/>
                <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="AddressOfDoneeOrganization/AddressLine1"/>
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="AddressOfDoneeOrganization/AddressLine2">
                <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="AddressOfDoneeOrganization/AddressLine2"/>
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="AddressOfDoneeOrganization/City">
                <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="AddressOfDoneeOrganization/City"/>
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="AddressOfDoneeOrganization/State">
                ,
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="AddressOfDoneeOrganization/State"/>
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="AddressOfDoneeOrganization/ZIPCode">
                <span style="width:1mm;"/>
              <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="AddressOfDoneeOrganization/ZIPCode"/>
                </xsl:call-template>
              </xsl:if>-->
            </td>
      ...
      <tr>
        <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">A<span class="styTableCellPad"></span></td>
        <xsl:if test="($Print != $Separated) or (count($Form8283Data/InformationOnDonatedProperty) &lt; 1)">
          <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3"><span class="styTableCellPad"></span></td>
        </xsl:if>
        ...
        <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>
      <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 2 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">B<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>  
      <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 3 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">C<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>  
      <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 4 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">D<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>
      <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 5 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:6mm;text-align:left;padding-left:3mm;font-size: 7pt;font-weight:bold;border-color:black;">E<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:81mm;text-align:center;font-weight:bold;border-color:black;" colspan="3"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:100mm;text-align:center;font-weight:bold;border-color:black;border-right:none;" colspan="3"><span class="styTableCellPad"></span></td>                        
      </tr>
      </xsl:if>
...
<!--Table expand/collapse toggle button end -->
  ...
  <div style="width:187mm;"  id="TP1ctn" class="styTableContainerNBB">
    <xsl:call-template name="SetInitialState"/>
      ...
      <thead class="styTableThead">      
      <tr>
        <th colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;font-weight:normal;border-top-width:0px;border-color:black;">
      ...
      <tr>
        <th class="styTableCell" style="width:7mm;background-color:lightgrey;border-right:1 solid black;border-bottom:1 solid black;"><span style="width:1mm;"></span></th>
          <th class="styTableCell" style="width:28mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
            <span class="styBoldText">(c)</span><span style="width:1mm;"></span>Date of the contribution
          </th>
          <th class="styTableCell" style="width:27mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
            <span class="styBoldText">(d)</span><span style="width:1mm;"></span>Date acquired by donor (mo., yr.)
          </th>
          <th class="styTableCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
            <span class="styBoldText">(e)</span><span style="width:1mm;"></span>How acquired by donor
          </th>
          <th class="styTableCell" style="width:36mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
            <span class="styBoldText">(f)</span><span style="width:1mm;"></span>Donor's cost or adjusted basis
          </th>
          <th class="styTableCell" style="width:36mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
            <span class="styBoldText">(g)</span><span style="width:1mm;"></span>Fair market value (see instructions)
          </th>
          <th class="styTableCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;border-right:none;">
            <span class="styBoldText">(h)</span><span style="width:1mm;"></span>Method used to determine the fair market value
          </th>
        </tr>
        </thead>
        <tfoot></tfoot>
  ...
  <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 1 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
    <tr>
       <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">A<span class="styTableCellPad"></span></td>
       <xsl:choose>
        <xsl:when test="($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
          ...
          <xsl:otherwise>
            <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>                   
          </xsl:otherwise>
     </xsl:choose>
        <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:44mm;text-align:center;font-weight:bold;border-color:black;border-right:none;"><span class="styTableCellPad"></span></td>
      </tr>
    </xsl:if>  
    <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 2 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">B<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
    ...
    <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 3 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">C<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
    ...
    <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 4 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">D<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
    ...
    <xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 5 or
        ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      <tr>
        <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size: 7pt;font-weight:bold;border-color:black;">E<span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:right;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="float:left;width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:26mm;text-align:center;font-weight:bold;border-color:black;"><span class="styTableCellPad"></span></td>
...
<xsl:call-template name="SetInitialDynamicTableHeight">
  ...
  <div style="width:187mm;height:34mm;"  id="TPXctn" >
   ...
   <!--Display empty Section A Part II --> 
    ...
    <tr>
      <th colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
      ...
      <tr>
        <td colspan="7" class="styTableCell" style="width:187mm;text-align:left;
          ...
          <b>(1)</b><span style="width:12px;"></span>For this tax year
             </div>
                <div class="" style="float:right;">
                  <img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" />
                  <span style="width:6px;"></span>
            ...
            <div class="styGenericDiv" style="padding-left:0mm;width:48mm;">
      <b>(2)</b><span style="width:12px;"></span>For any prior tax years
         </div>
            <div class="" style="float:right;">
              <img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" />
              <span style="width:6px;"></span>
          ...
          <div class="styLNLeftLtrBox" style="height:4.5mm;">c</div>
            <div class="styLNDesc" style="width:172mm;height:4.5mm;border-bottom-width:1px;font-weight:normal;">Name and address of each organization to which any such contribution was made in a prior year (complete only if different from the donee organization above):</div><br/>
              <div class="styBB" style="width:180mm;margin-left:4mm;float:left;"></div>
                <div style="width:187mm;">
                  <div class="styLNLeftLtrBox" style="height:4.5mm;"><span style="width:1mm;"></span></div>
                  <div style="font-size:6pt;font-weight:normal;">Name of charitable organization (donee)</div>
                </div>
          <div class="styBB" style="width:180mm;margin-left:4mm;float:left;"><span style="width:1px;"></span></div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept<span style="width:7mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width: 2mm;"></span><span style="border-bottom: 1px solid black; width: 20mm;"></span></div>
          </div>
          <div style="width:187mm;">
            <div class="styLNLeftLtrBox" style="height:4.5mm;">e</div>
            <div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">Name of any person, other than the donee organization, having actual possession of the property<span style="width:5mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width: 2mm;"></span><span style="border-bottom: 1px solid black; width: 20mm;"></span></div>
          </div>
          <div class="styBB" style="width:180mm;margin-left:4mm;float:left;"></div>
      ...
      <div class="styIRS8283LNYesNoBox" style="width:6mm;height:4mm;font-weight:bold;border-top-width:1px;">No</div>
       ...
       <div class="styLNLeftLtrBox" style="height:4mm;"></div>
            ...
            <span class="styBoldText" style="width:20px;">.</span>
                  ...
                  <div class="styIRS8283LNYesNoBox" style="width:6mm;height:4.5mm;font-weight:bold;border-top-width:0px;padding-bottom:0mm;padding-top:0mm"></div>
      <div class="styIRS8283LNYesNoBox" style="width:6mm;height:4.5mm;font-weight:bold;border-top-width:0px;padding-bottom:0mm;padding-top:0mm"></div>
                </div>
                </xsl:when>
                <xsl:otherwise>
      ...
      <div style="width:186mm;float:left;">
        <div class="styLNLeftLtrBox" style="height:4mm;padding-bottom:0mm;padding-top:0mm"></div>
        <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;padding-bottom:0mm;padding-top:0mm">
            property?
        <span class="styBoldText" style="width:20px;">.</span>
                      <span class="styBoldText" style="width:20px;">.</span>
            ...
            <span class="styBoldText" style="width:20px;">.</span>
                  ...
                  <div class="styLNAmountBox" style="width:6mm;height:4.5mm;padding-top:0mm;padding-bottom:0mm;"><span style="1px;"></span></div>
                  <div class="styLNAmountBox" style="width:6mm;height:4.5mm;padding-bottom:0mm;padding-top:0mm;float:right; text-align: center;"></div>
                 </div>
                </xsl:otherwise>
              </xsl:choose>
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4mm;padding-bottom:0mm;padding-top:0mm">b</div>
                <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;padding-bottom:0mm;padding-top:0mm">
                  ...
                  <div class="styShadingCell" style="width:6mm;height:4.5mm;padding-bottom:0mm;padding-top:0mm"></div>
              <div class="styShadingCell" style="width:6mm;height:4.5mm;padding-bottom:0mm;padding-top:0mm"></div>
            </div>
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4mm;padding-bottom:0mm;padding-top:0mm"></div>
            ...
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
                ...
                <div class="styShadingCell" style="width:6mm;height:4.5mm;padding-bottom:0mm;padding-top:0mm; border-bottom-width:1px;"></div>
              <div class="styShadingCell" style="width:6mm;height:4.5mm;padding-bottom:0mm;padding-top:0mm; border-bottom-width:1px;"></div>
            </div>  
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4mm;padding-bottom:0mm;padding-top:0mm"></div>
                ...
                <span class="styBoldText" style="width:19px;">.</span>
                  ...
                  <div class="styLNAmountBox" style="width:6mm;height: 4mm; padding-bottom:0mm;padding-top:0mm"><span style="width:1px;"></span></div>
              <div class="styLNAmountBox" style="width:6mm;height: 4mm; padding-bottom:0mm;padding-top:0mm"><span style="width:1px;"></span></div>
            </div>  
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4mm;padding-bottom:0mm;padding-top:0mm">c</div>
                ...
                <div class="styLNAmountBox" style="height: 4.5mm; width:6mm;border-bottom:none;padding-bottom:0mm;padding-top:0mm"><span style="width:1px;"></span></div>
                <div class="styLNAmountBox" style="height: 4.5mm; width:6mm;border-bottom:none;padding-bottom:0mm;padding-top:0mm"><span style="width:1px;"></span></div>
            </div>
        </td>
      </tr>
      ...
      <th colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
        <div style="width:187mm;border-top-width:0px">
          <span class="styPartName" style="width:16mm;">Part II</span>
            <span style="font-family:verdana;font-size:8pt;">
              <span style="width:6px;"></span>
                <b>Partial Interests and Restricted Use Property&#151;</b></span>
              <span style="font-family:verdana;font-size:8pt;font-weight:normal;">
...
<!-- Organization City, State & Zip Code-->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:108mm;height:4mm;font-weight:normal;">
              <span style="width:100mm;">For tangible property, enter the place where the property is located or kept</span>
              <span style="width:5mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" />
            </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:134mm;height:4mm;font-weight:normal;float:left;clear:none;">
              <span style="width:129mm">Name of any person, other than the donee organization, having actual possession of the property</span>
              <span style="width:2mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" />
            </div>
            <div style="width:47mm;float:right;clear:all;">
              <span class="styUnderlineText" style="width:45mm;float:right;">
<!--    *****************************************************************************  -->
<choice >
    <when  test="BusNameOfPersonPossessingProp" >
              <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode"
                     select="BusNameOfPersonPossessingProp/BusinessNameLine1"/>
                </xsl:call-template><br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode"  
                  select="BusNameOfPersonPossessingProp/BusinessNameLine2"/>
                </xsl:call-template>
           </when>  
  <Otherwise >
  <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode"
                     select=" NameOfPersonPossessingProperty/BusinessNameLine1"/>
                </xsl:call-template><br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode"  
                  select=" NameOfPersonPossessingProperty/BusinessNameLine2"/>
                </xsl:call-template>
      </Otherwise>              
  </choice>
    <!--**********************************************************************************  -->  
          ...
          <div style="width:187mm;">
            ...
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;">b</div>
                ...
                <div class="styShadingCell" style="width:6mm;height:5mm;"></div>
              <div class="styShadingCell" style="width:6mm;height:5mm;"></div>
            </div>
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
            ...
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
                ...
                <div class="styShadingCell" style="width:6mm;height:5mm;border-bottom-width:1px;"></div>
              <div class="styShadingCell" style="width:6mm;height:5mm;border-bottom-width:1px;"></div>
            </div>  
            <div style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
  ...
  <div class="styBB" style="width:187mm;padding-top:.5mm;">  
    <div style="float:left;">Form 8283 (Rev. 12-2006)<span style="width:130mm;"></span></div>
  ...
  <!-- END Page Header -->
    ...
    <div style="width:187mm;">
      <div class="styBB" style="width:187mm;border-style:solid;border-top-width:1px;border-bottom-width:0px;">
        <span style="font-size:8pt;"><b>Section B.  Donated Property Over $5,000 (Except Certain Publicly Traded Securities)&#151;</b></span>List in this section only 
      ...
      <div class="styBB" style="width:187mm;border-top-width:1px;">
          <span class="styPartName" style="width:16mm;">Part I</span>
            <span style="font-family:verdana;font-size:8pt;font-weight:bold;"><span style="width:2mm;"></span>Information on Donated Property&#151;</span>
          <span style="font-family:verdana;font-size:8pt;">To be completed by the taxpayer and/or the appraiser.</span>
        </div>
      <div style="width=187mm;"><!--span style="width:10mm;float:left;text-align:center;"><b>4</b></span-->
...
-->
  ...
  <div  class="styIRS8283TableContainer" style="width:187mm;"  id="TP2ctn" >
    ...
    <thead class="styTableThead">
      <tr>
        <th colspan="2" class="styTableCell" style="width:77mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;">
<div class="styGenericDiv" style="text-align:center;width:6mm;font-weight:bold;">5</div>
<div class="styGenericDiv" style="width:68mm;text-align:center;"><b>(a)</b><span style="width:4px;"/>Description of donated property (if you need more space, attach a separate statement)</div>
</th>
        <th class="styTableCell" style="width:70mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;"><b>(b)</b><span style="width:1px;"></span>If tangible property was donated, give a brief summary of the overall physical condition of the property at the time of the gift</th>
        <th class="styTableCell" style="width:40mm;text-align:center;font-size:7pt;border-color:black;border-right:none;border-top-width:1px;font-weight:normal;"><b>(c)</b><span style="width:1px;"></span>Appraised fair market value</th>
      </tr>
    </thead>      
    <tfoot></tfoot>
    <tbody>
      ...
      <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 1 or
        ...
        <tr>
          <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">A<span class="styTableCellPad"></span></td>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
            </xsl:otherwise>
          </xsl:choose>
          <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:40mm;text-align:center;border-color:black;font-size:7pt;border-right:none;"><span class="styTableCellPad"></span></td>                        
        </tr>
      </xsl:if>
      <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 2 or
        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
        <tr>
          <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">B<span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:40mm;text-align:center;border-color:black;font-size:7pt;border-right:none;"><span class="styTableCellPad"></span></td>                        
        </tr>
      ...
      <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 3 or
        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
        <tr>
          <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">C<span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:40mm;text-align:center;border-color:black;font-size:7pt;border-right:none;"><span class="styTableCellPad"></span></td>                        
        </tr>
      ...
      <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 4 or
        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
        <tr>
          <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">D<span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:68mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:70mm;text-align:center;border-color:black;font-size:7pt;"><span class="styTableCellPad"></span></td>
          <td class="styTableCell" style="width:40mm;text-align:center;border-color:black;font-size:7pt;border-right:none;"><span class="styTableCellPad"></span></td>                        
        </tr>
...
<thead class="styTableThead">
  <tr>
    <th rowspan="2" colspan="2" class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;left-margin:3mm;font-weight:normal;" ><b>(d)</b><span style="width:1mm;"></span>Date acquired by donor (mo., yr)</th>
      <th rowspan="2" class="styTableCell" style="width:20mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(e)</b><span style="width:1mm;"/>How acquired by donor</th>
        <th rowspan="2"  class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(f)</b><span style="width:1mm;"></span>Donor's cost or adjusted basis</th>
      <th rowspan="2"  class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(g)</b><span style="width:1mm;"></span>For bargain sales, enter amount received</th>
    <th colspan="2" class="styTableCell" style="left-margin:0mm;width:70mm;text-align:center;font-size:7pt;border-color:black;border-right-width:0px;font-weight:bold;">See instructions</th>
  </tr>
  <tr>
    <th class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(h)</b><span style="width:1mm;"/>Amount claimed as a deduction</th>
    <th class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;"><b>(i)</b><span style="width:1mm;"></span>Average trading price of securities</th>
  </tr>
</thead>
<tfoot></tfoot>  
<tbody>
      ...
      <tr>
        <td class="styTableCell" style="width:7mm;text-align:left;padding-left:2mm;font-size:7pt;border-color:black;font-weight:bold;">A<span class="styTableCellPad"></span></td>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <td class="styTableCell" style="width:23mm;text-align:center;font-size:7pt;border-color:black;"><span class="styTableCellPad"></span></td>
            </xsl:otherwise>
          </xsl:choose>
        <td class="styTableCell" style="width:20mm;text-align:center;font-size:7pt;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;"><span class="styTableCellPad"></span></td>
        <td class="styTableCell" style="width:35mm;text-align:center;font-size:7pt;border-color:black;border-right:none;"><span class="styTableCellPad"></span></td>
      </tr>
    </xsl:if>
    <xsl:if test="count($Form8283Data/PropertyInformation) &lt; 2 or
        (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
...
<!-- Section B part II  Taxpayer (Donor) Statement-->
    <div class="styBB" style="width:187mm;border-top-width:0px">
      <span class="styPartName" style="width:16mm;">Part II</span>
        <span style="font-family:verdana;font-size:8pt;font-weight:bold;">
          <span style="width:2mm;"></span>Taxpayer (Donor) Statement&#151;</span>
          <span style="font-family:verdana;font-size:8pt;">List each item included in Part I above that the appraisal identifies as
        <span style="width:71.5mm;"></span>having a value of $500 or less. See instructions.</span>
    </div>        
    ...
    <div style="width:187mm;">
      ...
      <div style="width:138mm;float:left;" class="styGenericDiv">$500 (per item). Enter identifying letter from Part I and describe the specific item. See instructions.<span style="width:2mm;"></span>
        <img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right"/>
      </div>
    ...
    <div style="width:187mm;"></div>
      <div class="styBB" style="width:187mm;">Signature of taxpayer (donor)<span style="width:2mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /><span style="width:105mm;"></span>Date<span style="width:2mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /></div>
    <div class="styBB" style="width:187mm;border-top-width:0px">
      <span class="styPartName" style="width:16mm;">Part III</span>
      <span style="font-family:verdana;font-size:8pt;font-weight:bold;"><span style="width:2mm;"></span>Declaration of Appraiser</span>
    </div>
      ...
      <div class= "styBB" style="width:187mm;">
        <span class="styIRS8283SignatureBox" style="width:10mm;font-size:9pt;font-weight:bold;border-bottom-width:0px;">Sign Here</span>
          <span style="width:6mm;"></span>
            ...
            padding-left: 2mm;border-bottom-width:0px;">Signature<span style="width:1mm;"></span>
            <img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /></span>
            
            <span class="styIRS8283SignatureBox" style="width:43mm;border-right-width:0px;border-bottom-width:0px;">
            Title<span style="width:1mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif"
             alt="bullet image pointing to right" /></span>
        <span class="styIRS8283SignatureBox" style="width:77mm;border-right-width:0px;border-bottom-width:0px;">
        Date <span style="width:1mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" 
         alt="bullet image pointing to right" /></span>
      </div>
      <div style="width:187mm;border-top-width:1px">
        <div class="styNameBox" style="font-family:Arial;font-size:7pt;width:135mm;height:8mm;">Business address (including room or suite no.)<span style="width:2mm;"></span></div>
          <div class="styEINBox" style="font-family:Arial;font-size:7pt;width:47mm;height:4mm;padding-left: 2mm"><b>Identifying number</b><span style="width:2mm;"></span></div>
      </div>
      <div class="styBB" style="width:187mm;border-top-width:1px">
        <div class="styNameBox" style="font-family:Arial;font-size:7pt;width:187mm;height:8mm;border-right-width:0px;">City or town, state, and ZIP code</div>
      </div>
      <div class="styBB" style="width:187mm;border-top-width:0px">
        <span class="styPartName" style="width:16mm;">Part IV</span>
          <span style="font-family:verdana;font-size:8pt;font-weight:bold;"><span style="width:2mm;"></span>Donee Acknowledgment&#151;</span>
        <span style="font-family:verdana;font-size:8pt;">To be completed by the charitable organization.</span>
      </div>
      <div style="width:187mm;">This charitable organization acknowledges that it is a qualified organization under section  170(c) and that it received the donated property as described in Section B, Part I, above on the following date<span style="width:2mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" /> 
<!-- A straight Line -->
<span style="width:75mm;border-bottom:solid 1px;">
      ...
      <!--  <div style="width:187mm;">-->
        <div class="styLNDesc" style="width:179mm;height:4.0mm;">Does the organization intend to use the property for an unrelated use?
          ...
          <span class="styBoldText" style="width:17px;">.</span>
            <img src="{$ImagePath}/8283_Bullet_Lg.gif" alt="bullet image pointing to right"/><span style="width:1px;"></span>
            <span>          
          ...
          <label>
            <xsl:call-template name="PopulateLabelNo">
              <xsl:with-param name="TargetNode" select="$Form8283Data/UsePropertyForUnrelatedUse" />
              <xsl:with-param name="BackupName">Form8283DataUsePropertyForUnrelatedUseNo</xsl:with-param>            </xsl:call-template>No
          </label>
        </div>
      </div>

      <div class="styBB" style="width:187mm;border-top-width:1px;">
          <div class="styNameBox" style="font-face:Arial;font-size:7pt;width:94mm;height:8mm;">Name of charitable organization (donee)<br/>  <xsl:call-template name="PopulateText">
        ...
        <div class="styEINBox" style="font-family:face;font-size:7pt;width:93mm;height:4mm;"><b>Employer identification number</b><br/><br/><span style="font-weight:normal;"> <xsl:call-template name="PopulateEIN">
                      <xsl:with-param name="TargetNode" select="$Form8283Data/DoneeEIN"/>
                    </xsl:call-template></span>
</div>
      </div>
      <div style="width:187mm;border-top-width:1px">
        <div class="styNameBox" style="font-family:Arial;font-size:7pt;width:94mm;height:8mm;">Address (number, street, and room or suite no.) <br/><xsl:if test="$Form8283Data/USAddressOfDonee">
      ...
      <xsl:if test="$Form8283Data/ForeignAddressOfDonee/AddressLine2!=''">
        ...
        <div class="styEINBox" style="font-family:Arial;font-size:7pt;width:93mm;height:4mm;font-weight:normal;">City or town, state, and ZIP code <br/><br/>
  ...
  <xsl:if test="($Print =$Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
      ...
      <table class="styDepTbl" style="width:187mm;" id="donatedPrptyInfo">
        <thead class="styTableThead">
          <tr class="styDepTblHdr">
            <th class="styDepTblCell" style="width:7mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;">1</th>
            <th class="styDepTblCell" style="width:90mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;" colspan="3"><span class="styBoldText">(a)</span><span style="width:1mm;"></span><span style="font-size:7pt;">Name and address of the <br /> donee organization</span></th>
            <th class="styDepTblCell" style="width:90mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;" colspan="3"><span class="styBoldText">(b)</span><span style="width:1mm;"></span>Description of donated property </th>
          </tr>          
        </thead>
        <tfoot></tfoot>
        <tbody>
    ...
    <div>
      <table class="styDepTbl" style="width:187mm;" id="contDonPrptInfo">
        <thead class="styTableThead">      
          <tr class="styDepTblHdr">
            <th colspan="7" class="styDepTblCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;font-weight:normal;border-top-width:0px;border-color:black;">
              <span class="styBoldText">Note:</span>
              <span style="width:1mm;"></span>
          ...
          <tr class="styDepTblHdr">
            <th class="styDepTblCell" style="width:7mm;background-color:lightgrey;border-right:1 solid black;border-bottom:1 solid black;"><span style="width:1mm;"></span></th>
            <th class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;padding-top:3mm;">
              <span class="styBoldText">(c)</span><span style="width:1mm;"></span>Date of the contribution
            </th>
            <th class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;">
              <span class="styBoldText">(d)</span><span style="width:1mm;"></span>Date acquired by donor (mo., yr.)
            </th>
            <th class="styDepTblCell" style="width:26mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;padding-top:3mm;">
              <span class="styBoldText">(e)</span><span style="width:1mm;"></span>How acquired by donor
            </th>
            <th class="styDepTblCell" style="width:36mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;padding-top:3mm;">
              <span class="styBoldText">(f)</span><span style="width:1mm;"></span>Donor's cost or adjusted basis
            </th>
            <th class="styDepTblCell" style="width:36mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;padding-top:3mm;">
              <span class="styBoldText">(g)</span><span style="width:1mm;"></span>Fair market value
            </th>
            <th class="styDepTblCell" style="width:30mm;text-align:center;font-size: 7pt;font-weight:normal;border-color:black;border-right:none;">
              <span class="styBoldText">(h)</span><span style="width:1mm;"></span>Method used to determine the fair market value
            </th>
          </tr>
        </thead>
 ...
 <xsl:if test="($Print =$Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
   ...
   <span class="styRepeatingDataTitle">Form 8283, Section A, Part II - Partial Interests and Restricted Use Property:</span>
     <xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
       ...
       <tr>
         <td colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
           <div class="styDepTblHdr" style="width:187mm;"></div>
...
<!-- Organization City, State & Zip Code-->
          ...
          <div class="styDepTblRow2" style="width:187mm;background-color:yellow">
            <div class="styLNLeftLtrBox" style="height:4.5mm;">d</div>
            <div class="styLNDesc" style="width:108mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept<span style="width:5mm;"></span><img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right" />
            </div>
         ...
         <!--Line 2e -->          
          <div class="styDepTblRow1" style="width:187mm;">
            ...
            <div style="width:47mm;float:right;clear:all;">
              <span class="styUnderlineAmount" style="width:45mm;float:right;background-color:yellow;">
<!--    *****************************************************************************  -->
<choice >
    <when  test="BusNameOfPersonPossessingProp" >
              <xsl:call-template name="PopulateText">
          ...
          <div class="styDepTblRow2" style="width:187mm;float:left;">  
            ...
            <div class="styDepTblRow1" style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;">b</div>
                ...
                <div class="styShadingCell" style="width:6mm;height:4.5mm;"></div>
              <div class="styShadingCell" style="width:6mm;height:4.5mm;"></div>
            </div>
            <div class="styDepTblRow1" style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
            ...
            <div class="styDepTblRow1" style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
                <div class="styLNDesc" style="width:166mm;height:4mm;font-weight:normal;">of the property, including the right to vote donated securities, to acquire the property by purchase or otherwise,</div>
                <div class="styShadingCell" style="width:6mm;height:4.5mm;border-bottom-width:1px;"></div>
              <div class="styShadingCell" style="width:6mm;height:4.5mm;border-bottom-width:1px;"></div>
            </div>  
            <div class="styDepTblRow1" style="width:187mm;">
              <div class="styLNLeftLtrBox" style="height:4.5mm;"></div>
  ...
  <xsl:if test="($Print =$Separated) and (count($Form8283Data/PropertyInformation) &gt; 4)">
    ...
    <div>
      ...
      <table class="styDepTbl" style="width:187mm;">
        <thead class="styTableThead">
          <tr class="styDepTblHdr">
            <th colspan="2" class="styDepTblCell" style="width:77mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;">
<div class="styGenericDiv" style="width:6mm;text-align:center;font-weight:bold;">5</div>
<div class="styGenericDiv" style="width:68mm;text-align:center;"><b>(a)</b><span style="width:4px;"/>Description of donated property (if you need more space, attach a separate statement)</div>
</th>
            <th class="styDepTblCell" style="width:70mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;"><b>(b)</b><span style="width:1px;"></span>If tangible property was donated, give a brief summary of the overall physical condition at the time of the gift</th>
            <th class="styDepTblCell" style="width:40mm;text-align:center;font-size:7pt;border-color:black;border-right:none;border-top-width:1px;font-weight:normal;"><b>(c)</b><span style="width:1px;"></span>Appraised fair market value</th>
          </tr>
        </thead>      
        <tfoot></tfoot>
        <tbody>
    ...
    <div>
      <table class="styDepTbl" style="width:187mm;">
        <thead class="styTableThead">
          <tr class="styDepTblHdr">
            <th rowspan="2" colspan="2" class="styDepTblCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;left-margin:3mm;font-weight:normal;" ><b>(d)</b><span style="width:1mm;"></span>Date acquired by donor (mo., yr)</th>
            <th rowspan="2" class="styDepTblCell" style="width:20mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(e)</b><span style="width:1mm;"/>How acquired by donor</th>
            <th rowspan="2"  class="styDepTblCell" style="width:36mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(f)</b><span style="width:1mm;"></span>Donor's cost or adjusted basis</th>
            <th rowspan="2"  class="styDepTblCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(g)</b><span style="width:1mm;"></span>For bargain sales, enter amount received</th>
            <th colspan="2" class="styDepTblCell" style="left-margin:0mm;width:64mm;text-align:center;font-size:7pt;border-color:black;border-right-width:0px;font-weight:bold;">See instructions</th>
          </tr>
          <tr class="styDepTblHdr">
            <th class="styDepTblCell" style="width:32mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;"><b>(h)</b><span style="width:1mm;"/>Amount claimed as a deduction</th>
            <th class="styDepTblCell" style="width:32mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;"><b>(i)</b><span style="width:1mm;"></span>Average trading price of securities</th>
          </tr>
        </thead>
        <tfoot></tfoot>  
        <tbody>
  ...
  <xsl:if test="($Print = $Separated) and (count($Form8283Data/PropertyIdLetterAndDescription) &gt; 1)">
    ...
    <table class="styDepTbl" style="width:187mm;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" style="width:70mm;font-size:7pt;border-color:black;border-right-width:1px;">Property Identifying Letter</th>
          <th class="styDepTblCell" style="width:118mm;font-size:7pt;border-color:black;border-right-width:0px;">Description</th>
        </tr>
      </thead>
      <tfoot></tfoot>
      <tbody>

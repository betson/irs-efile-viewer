    ...
    <html>
      ...
      <body class="styBodyClass" >      
        ...
        <div class="styDepTitleLine">
          <span class="styDepTitle" style="width:82mm">
        ...
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;"> <br />         
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/SolarGthrmlEnergyPropBasis2005" />
            </xsl:call-template>                  
          </div>                  
        </div>      
        ...
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;">   <br />       
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/SolarGthrmlEnergyPropBasis2006" />
            </xsl:call-template>                  
          </div>                  
        </div>
        ...
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;"><br />          
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/QualifiedFuelCellPropBasis2006" />
            </xsl:call-template>                  
          </div>                  
        </div>      
        ...
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;"> <br />         
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/CapacityQualifiedFuelCellProp" />
            </xsl:call-template>                  
          </div>                  
        </div>
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;"> <br />         
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/QlfyMicroturbinePropBasis2006" />
            </xsl:call-template>                  
          </div>                  
        </div>      
        ...
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left;text-align:right;width:42mm;"> <br />         
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/CapacityQlfyMicroturbineProp" />
            </xsl:call-template>                  
          </div>                  
        </div>

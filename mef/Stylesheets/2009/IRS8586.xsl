        ...
        <form id="Form8586">
          ...
          <div style="width:187mm">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:139mm;padding-top:4mm;">
                <span style="float:left;">Low-income housing credit allowed for 2009 from a passive activity (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:7px;"/>.
                <span style="width:16px;"/>.
          ...
          <div style="width:187mm">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:139mm;padding-top:4mm;">
                <span style="float:left;">Carryforward of low-income housing credit to 2009 (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:7px;"/>.
                <span style="width:16px;"/>.
          ...
          <div style="width:187mm">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:139mm;padding-top:4mm;">
                <span style="float:left;">Carryback of low-income housing credit from 2010 (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:7px;"/>.
                <span style="width:16px;"/>.
          ...
          <div style="border-top:1 solid Black; font-size:7pt; width:187mm">
            ...
            <div style="float:right">
              ...
              <span style="width:45mm"/>
                Form <b style="font-size:9pt">8586</b> (2009)
            </div>
          </div>

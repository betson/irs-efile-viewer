...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="AdjToIntercompanyTransSchTemp">

  <table id="GeneralDependencyTbl" class="styDepTbl">
    <tr class="styDepTblHdr">
      <th class="styDepTblCell" style="width:93mm;text-align:center;" scope="col">Description</th>
      <th class="styDepTblCell" style="width:93mm;text-align:center;" scope="col">Amount</th>
    </tr>
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="AdjToIntercompanyTransSchTemp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

    ...
    <html>
      ...
      <body class="styBodyClass">
        <form name="Form4797">
          ...
          exchanges reported to you for 2009 on Form(s) 1099-B or 1099-S (or substitute
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Gain, if any, from Form 4684, line 43
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:146mm;">Net gain or (loss) from Form 4684, lines 35 and 42a
          <!--Dotted Line-->
              <span class="styBoldText">
                <span style="width:11px"/>.
            <span style="width:11px"/>.
        ...
        If the loss on line 11 includes a loss from Form 4684,
         line 39, column (b)(ii), enter that part of the loss here. Enter the part of the loss from income-producing property
...
line 14          <!--Dotted Line-->
      ...
      Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2009)
    </div>
          </div>
          ...
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 4797 (2009)<span style="width:148mm;"/>
            </div>
          ...
          <xsl:if test="not($Form4797Data/PropertyDispositionGain)  or ((count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated))">
            <xsl:if test="(position() mod 4) = 1">
              ...
              development of mines and other natural deposits, mining exploration costs, and depletion (see instructions)
              <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                <span style="width:11px"/>.
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styLNDesc"> 
          Subtract line 31 from line 30. Enter the portion from casualty or theft on Form 4684, line 37. Enter the portion

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
        ...
        Check only one box on each form.<br/>
          ...
          Form <b style="font-size:8pt;">1118</b> (Rev. 12-2009)
        </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"/>.
                    ...
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
                      <!--<xsl:with-param name="Desc">Form 1118 HTKO</xsl:with-param>-->
               ...
               requires the corporation to complete Schedule F under the authority of section 905(b).
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2009)</div>
						</div>
              ...
              Net Operating Loss Deduction</span>
                ...
                Product line #2 <br/>(SIC Code: <xsl:call-template name="PopulateText">
							...
							<tr class="styDepTblRow2">
								...
								<td class="styLNAmountBoxSmall" style="height:4.5mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/GrossIncmTotRDDedPassiveCategoryIncome"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
								<td class="styLNAmountBoxSmall" style="height:4.5mm">

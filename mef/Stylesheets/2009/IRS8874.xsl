									...
									<xsl:for-each select="$Form8874Data/CurrentYearCreditInfo">
										<tr>
											...
											<td class="styTableCell" rowspan="1" style="width:63mm;text-align:left;font-size:7pt;font-weight:normal;">
												...
												<xsl:choose>
													<xsl:when test="USAddressOfCDE">
														<br/>
														<xsl:call-template name="PopulateUSAddressTemplate">
															<xsl:with-param name="TargetNode" select="USAddressOfCDE"/>
														</xsl:call-template>
													</xsl:when>
													<xsl:otherwise>
														<xsl:call-template name="PopulateForeignAddressTemplate">
															<xsl:with-param name="TargetNode" select="ForeignAddressOfCDE"/>
														</xsl:call-template>
													</xsl:otherwise>
												</xsl:choose>
											</td>
...
all others, report this amount on the applicable line of Form 3800, (e.g., line 1l of the 2009 Form
3800)
          <!--Dotted Line-->
							<span style="letter-spacing:3.5mm;font-weight:bold">....</span>
						</div>
      ...
      Form <span class="styBoldText">8874</span> (Rev. 12-2009)    </div>
					<br class="pageEnd"/>

  ...
  <xsl:template match="/">
    <html lang="EN-US">
      <head>
        ...
        <style type="text/css">
          <!-- Exception: DO NOT contained shortPeriodReason112011120FInd where 1120 does -->
        ...
        <!--Dotted Line-->
          ...
          <span style="width:16px"/>.
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:7.5mm;">2008 overpayment credited to 2009
          <span class="styBoldText">
                  <span style="width:16px"/>.
         <span style="width:16px"/>.
         <span style="width:16px"/>.
         ...
         <span style="width:16px"/>.
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:8.5mm;font-size:7pt;">2009 estimated tax payments
        <span style="width:2px;"/>
                <!-- Form to Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:7.5mm;font-size:7pt;">2009 refund applied for on Form 4466
                    <span class="styBoldText">
                  <span style="width:16px"/>.
          <span style="width:16px"/>.
          <span style="width:16px"/>.
          ...
          <span style="width:16px"/>.
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div style="width:181mm;float:right;clear:none;height:4.5mm;">
                ...
                <div class="styLNRightNumBoxNBB" style="width:8.2mm;border-right-width:1px;height:4.5mm;background-color:lightgrey;"/>
              </div>
            </div>
            <!-- Line 32g -->
            <div style="width:181mm;float:right;clear:none;">
    ...
    May the IRS discuss this return<br/> with the preparer shown below <br/>(see instructions)?
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2009)
    </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 1120 (2009)<span style="width:148mm;"/>
            </div>
         ...
         <span style="width:11px"/>.
           <span style="width:3.5mm"/>
              ...
              <span style="width:4mm;padding-top:1mm;">
                <!--HINT: this checked-box named different from 1120 QualifiedPersonalServiceCorp on 1120E&A is PersonalServiceCorporation-->
                <input type="checkbox" class="styCkbox">
                  <xsl:call-template name="PopulateCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/PersonalServiceCorporation"/>
                    <xsl:with-param name="BackupName">IRS1120ScheduleJPersonalServiceCorporation</xsl:with-param>
                  </xsl:call-template>
                </input>
              </span>
            </div>
         ...
         <span style="width:5mm;"/>
          ...
          <div class="styGenericDiv" style="width:187mm;height:4.5mm;">
            ...
            <div class="styGenericDiv">
              ...
              <div class="styIRS1120LNYesNoBox" style="height:4.5mm;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/PartshpCorpTrustOwnPctVtngStk"/>
                  </xsl:call-template>
              ...
              <div class="styIRS1120LNYesNoBoxRB" style="height:4.5mm;border-right-width:0px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateNoBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/PartshpCorpTrustOwnPctVtngStk"/>
                  </xsl:call-template>
          ...
          <div class="styGenericDiv" style="width:187mm;height:4.5mm;">
            ...
            <div class="styGenericDiv">
              <div class="styShadingCell" style="width:6mm;height:6.5mm;"/>
              <div class="styShadingCellRB" style="width:6mm;height:6.5mm;border-right-width:0px;"/>
              <div class="styIRS1120LNYesNoBox" style="height:4.5mm;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/IndivEstateTrustOwnPctVtngStk"/>
                  </xsl:call-template>
              ...
              <div class="styIRS1120LNYesNoBoxRB" style="height:4.5mm;border-right-width:0px;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateNoBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/IndivEstateTrustOwnPctVtngStk"/>
                  </xsl:call-template>
          ...
          <div class="styGenericDiv" style="width:187mm;">
           ...
           Own directly 20% or more, or own, directly or indirectly, 50% or more of the total voting power of all classes of stock entitled to vote of any
               foreign or domestic corporation not included on <b>Form 851,</b> Affiliations Schedule? For rules constructive ownership, see instructions 
                <span class="styBoldText">
                  <span style="width:16px"/>.
                  <span style="width:16px"/>.
                  <span style="width:16px"/>.
              ...
              <div class="styGenericDiv">
                <div class="styIRS1120LNYesNoBox" style="height:10.5mm;padding-top:2.5mm;border-bottom-width:1px;">
                  <span style="font-weight:normal;">
                    <xsl:call-template name="PopulateYesBoxText">
                ...
                <div class="styIRS1120LNYesNoBoxRB" style="height:10.5mm;padding-top:2.5mm;border-right-width:0px;border-bottom-width:1px;">
                  <span style="font-weight:normal;">
                    <xsl:call-template name="PopulateNoBoxText">
                      <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/CorpOwnPercentVotingStock"/>
                    </xsl:call-template>
            ...
            <table class="styTable" cellspacing="0" style="font-size:7pt;">
              <thead class="styTableThead">
                <tr>
                  ...
                  <th class="styTableCellHeader" scope="col" rowspan="2" style="width:36mm;font-weight:normal;border-right:0;">
                    <span style="font-weight:normal">(iv)</span> Maximun Percentage Owned in Profit, Loss or Capital</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>

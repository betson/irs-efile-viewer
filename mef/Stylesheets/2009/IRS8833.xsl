...
<head>  
  ...
  <style type="text/css">    
    <xsl:if test="not($Print) or $Print=''">  
      <xsl:call-template name="IRS8833Style"></xsl:call-template>
...
<body class="styBodyClass">
  ...
  <div style="width: 187mm">
    Check one or both of the following boxes as applicable:<br/><br/>
  </div>
  
  <!--  First Bullet  -->  
  <div style="width: 187mm">
    <div class="styLNLeftNumBox"><img src="{$ImagePath}/8833_Bullet_Round.gif" alt="RoundBullet"/> </div>
  ...
  <div style="width: 187mm">
    <div class="styLNLeftNumBox"><img src="{$ImagePath}/8833_Bullet_Round.gif" alt="RoundBullet"/> </div>
    <div style="float: left">
      <label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$FormData/TreatybasedPositionSec7701" />
  ...
  <div class="styBB" style="width: 187mm; padding-top: 2mm; padding-bottom:2mm">
    <div style="float: left">
      <label><xsl:call-template name="PopulateLabel"><xsl:with-param name="TargetNode" select="$FormData/IsUSCitizenOrOther" />
  ...
  <div class="styForm8833BB" style="width:187mm;height:31mm;">
    <div style="width:93.75mm;float:left;height:31mm;">
      <div class="styForm8833BB" style="height:12mm;">
        <span style="width:2mm;"></span><span style="font-weight:bold;">1</span><span style="width:4mm;"></span> Enter the specific treaty position relied on:<br/>
        <span style="height:4mm;padding-top:1mm;"><span style="width:4mm;"></span><span style="font-weight:bold;">a</span><span style="width:3mm;"></span>Treaty country
        ...
        <span style="width:4mm;"></span><span style="font-weight:bold;">b</span><span style="width:3mm;"></span>Article(s)<span style="width:3mm;"></span>     <br/>     
      ...
      <div>
        <span style="width:2mm;"></span><span style="font-weight:bold;">2</span><span style="width:4.75mm;"></span>List the Internal Revenue Code provision(s) overruled or<br/>
        <span style="width:8.5mm"></span>modified by the treaty-based return position<br/>
          <span style="padding-left:8.75mm;width:85mm;">
            <xsl:call-template name="PopulateText">
    ...
    <div style="font-family:verdana;font-size:6pt;">
      ...
      <xsl:if test="$FormData/NameOfPayor/BusinessNameLine2 != ''"><br/>
        <xsl:call-template name="PopulateText">
      ...
      <xsl:if test="$FormData/PayorIdentificationNumber != ''"><br/>  
  ...
  <div class="styBB" style="width: 187mm">  
    ...
    <span style="width: 175mm">
      ...
      <img src="{$ImagePath}/8833_Bullet.gif" alt="lBullet"/><span style="width: 1mm"></span>
      <xsl:call-template name="PopulateText">
  ...
  <div class="styBB" style="width: 187mm">  
    ...
    <div>
      ...
      <span style="width: 9mm"></span>or other item (as applicable) for which the treaty benefit is claimed

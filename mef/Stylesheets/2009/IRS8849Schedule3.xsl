 ...
 <xsl:template match="/">
  <html>
      ...
      <!--END WARNING LINE -->
        ...
        <div class="styTBB" style="width:187mm;">
 	    ...
 	    <div class="styFNBox" style="width:31mm;height:20mm;border-right-width:2px;border-bottom:1px;">
 	       ...
 	       <span class="styAgency">(Rev. October 2009)</span>
   ...
   <div style="width:187mm;">
	...
	<b>Biodiesel mixtures.</b> Claimant produced a mixture by mixing biodiesel with diesel fuel. The biodiesel used to produce the mixture met ASTM D6751 and met EPA's registration requirements for fuels and fuel additives. The mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has attached the Certificate for Biodiesel and, if applicable, the Statement of Biodiesel Reseller. <b>Renewable diesel mixtures.</b> Claimant produced a mixture by mixing renewable diesel with liquid fuel (other than renewable diesel). The renewable diesel used to produce the renewable diesel mixture was derived from biomass, and met EPA's registration requirements for fuels and fuel additives, and met ASTM D975, D396, or other equivalent standard approved by the IRS.  The mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has attached the Certificate for Biodiesel and, if applicable, Statement of Biodiesel Reseller, both of which have been edited as discussed in the instructions for line 2. See the instructions for line 2 for information about renewable diesel used in aviation.
	...
	<tr>
	  ...
	  <td style="border-left:1px black solid;border-bottom:1px black solid;"><span style="width:.5mm;">$</span>
  ...
  <div style="width:187mm">
    ...
    <span style="width:6mm;"/>
    <span style="text-align:right;width:35mm;font-weight:bold;font-size:6pt;">Schedule 3 (Form 8849)</span><span style="font-weight:normal;font-size:6pt;" > (Rev. 10-2009)</span>
 </div>
   <br class="pageEnd"/>

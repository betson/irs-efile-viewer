        ...
        <tr class="styDepTblHdr">
            ...
            <td class="styDepTblCell" style="text-align:right;font-weight:normal">
              ...
              <xsl:call-template name="PopulateAmount">
                ...
                <xsl:with-param name="TargetNode" select="$TCCGSData/GroupTotals/ApportionmentAmountLine2a1" />
              </xsl:call-template>          
            </td>
            ...
            <td class="styDepTblCell"  style="text-align:right;font-weight:normal">
              ...
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="WhiteFont">true</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$TCCGSData/GroupTotals/ApportionmentAmountLine2a2" />
              </xsl:call-template>          
            </td>
            ...
            <td class="styDepTblCell"  style="text-align:right;font-weight:normal">
              ...
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="WhiteFont">true</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$TCCGSData/GroupTotals/ApportionmentAmountLine2a3" />
              </xsl:call-template>          
            </td>

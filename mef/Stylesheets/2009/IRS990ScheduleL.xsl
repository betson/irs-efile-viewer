...
Complete if the organization answered "Yes" on Form 990, Part IV, line 25a or 25b, or Form 990-EZ, Part V, line 40b.
        ...
        Complete if the organization answered "Yes" on Form 990, Part IV, line 26, or Form 990-EZ, Part V, line 38a.
            ...
            (($Print = $Separated) and (count($FormData/LoanTable) &gt;6)) ">
								...
								<xsl:if test="count($FormData/LoanTable) &lt; 2 or ((count($FormData/LoanTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 3 or ((count($FormData/LoanTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 4 or ((count($FormData/LoanTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 5 or ((count($FormData/LoanTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 6 or ((count($FormData/LoanTable) &gt; 6) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<tr>
         ...
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
            ...
            (($Print = $Separated) and (count($FormData/Form990ScheduleLPartIII) &gt;6)) ">
									<tr>
        ...
        Business Transactions Involving Interested Persons.<br/>
            ...
            (($Print = $Separated) and (count($FormData/Form990ScheduleLPartIV) &gt;6)) ">
					...
					<div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageend">
						<div class="styGenericDiv" style="width:110mm;font-weight:bold;font-size:6pt">For Privacy Act and Paperwork Reduction Act Notice, see the Intructions for Form 990 </div>
						<div class="styGenericDiv" style="width:22mm;font-size:6pt">Cat. No. 50056A</div>
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText" style="font-size:6pt">Schedule L (Form 990 or 990-EZ) 2009</span>
						</div>
					</div>
					<br/>

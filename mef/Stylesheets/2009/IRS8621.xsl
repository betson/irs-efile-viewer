    ...
    <form style="font-family:arial; font-size:9pt" name="Form8621">      
      ...
      <div class="styTBB" style="width:187mm">
        <div class="styIRS8621FNBox" style="height:18mm; width:32mm; font-size:7pt">
          <div>
            Form &nbsp; <span class="styFormNumber">8621</span><br/>(Rev. December 2004)
        ...
        <div class="styFTBox" style="width:122mm">
          <div class="styMainTitle" style="height:8mm;">
            Return by a Shareholder of a Passive Foreign<br/>Investment Company or Qualified Electing Fund<br />            
          </div>
      ...
      <div class="styIRS8621BB" style="font-size:7pt">
        <div class="styIRS8621FNBox">
          ...
          <div style=" font-family:'verdana';font-size:6pt;">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8621Data/NameOfShareholder/BusinessNameLine1"/></xsl:call-template>
            <xsl:if test="normalize-space($Form8621Data/NameOfShareholder/BusinessNameLine2)!=''">              
              <br /><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form8621Data/NameOfShareholder/BusinessNameLine2"/></xsl:call-template>
            </xsl:if>
          </div>
        </div>
        <div style="float:left; padding-left:1mm">
          <b>Identifying number</b> (see page 2 of instructions)        
      ...
      <div class="styIRS8621BB" style="font-size:7pt">
        <div class="styIRS8621FNBox">
          Number, street, and room or suite no. (If a P.O. box, see page 2 of instructions.)<br/>
 ...
 <!-- Choose between Shareholder US or Foreign Address -->
      ...
      <div class="styIRS8621Item" style="padding-bottom:1mm">
        ...
        <div class="styIRS8621LNDesc">
          ...
          <xsl:call-template name="PopulateLabel">
            ...
            <b>Election To Extend Time For Payment of Tax.</b> I, a shareholder of a QEF, elect to extend the time for payment of tax on<br/>the undistributed earnings and profits of the QEF until this election is terminated. <i>Complete lines 3a through 4c of Part II to<br/>calculate the tax that may be deferred.</i><br/><b>Note:</b> &nbsp; <i>If any portion of line 1a or line 2a of Part II is includible under section 551 or 951, you may <b>not</b> make this election.<br/>Also, see sections 1294(c) and 1294(f) and the related regulations for events that terminate this election.</i>
          </label>
        </div>
      </div>
    ...
    <!-- BEGIN Part II Title -->  
      <div class="styIRS8621BB" style="height:8mm; border-top:2 solid black">
        ...
        <div class="styTitleDesc" style="font-size:10pt; width:170mm">Income From a Qualified Electing Fund (QEF). <span class="styNormalText" style="font-size:8pt">All QEF shareholders complete lines 1a through 2c. If you are making<br/>Election D, also complete lines 3a through 4c. (See page 5 of instructions.)</span></div>        
      </div>
    <!-- END Part II Title -->
    ...
    <!-- BEGIN Part II Line Items -->
      ...
      <div class="styIRS8621Item">
        ...
        <div style="float:left">
          Enter the portion of line 1a that is included in income under<br/>section 551 or 951 or that may be excluded under section 1293(g)          
        </div>      
        <div style="float:right">    
      ...
      <div class="styIRS8621Item">
        ...
        <div style="float:right">      
          ...
          <div class="styIRS8621LNAmountBox">
            <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="$Form8621Data/DividendIncome"/></xsl:call-template>
          </div>  
        </div>      
      </div>
      ...
      <div class="styIRS8621Item">
        <div class="styIRS8621Part2">b</div>
        <div style="float:left">
          Enter the portion of line 2a that is included in income under<br/>section 551 or 951 or that may be excluded under section 1293(g)      
        </div>        
        <div style="float:right">    
      ...
      <div class="styIRS8621Item">
        <div class="styIRS8621Part2"></div>
        <div style="float:left">
          <b>Important:</b> &nbsp; <i>If line 3e is greater than zero, and no portion of line 1a or 2a is includible in income<br/>under section 551 or 951, you may make Election D with respect to the amount on line 3e.</i>
        </div>      
        <div style="float:right">            
          <div class="styIRS8621LNRightNumBoxNBB" style="background-color:lightgrey; height:8mm"></div>  
          <div class="styIRS8621LNAmountBoxNBB" style="height:8mm"></div>  
    ...
    <div style="width:187mm; font-size:7pt; page-break-after:always">    
      <div style="float:left; font-size:8pt">
        <b>For Paperwork Reduction Act Notice, see page 7 of separate instructions.</b>
      </div>    
      <div style="float:right">
        Cat. No. 64174H
        <span style="width:15mm"></span>
        Form <b style="font-size:10pt">8621</b> (Rev. 12-2004)
      </div>      
    </div>    
    ...
    <!-- BEGIN Part III Line Items -->  
      <div class="styIRS8621Item">
        <div class="styIRS8621Part3" style="padding-top:0.5mm">5</div>
        <div style="float:left; padding-top:0.5mm">
        ...
        <div style="float:right">
          ...
          <div class="styIRS8621LNRightNumBox" style="height:4.5mm">5</div>  
      ...
      <div class="styIRS8621Item">
        ...
        <div style="float:left">
          <b>Excess.</b> Subtract line 6 from line 5. If a gain, <b>stop here.</b> Include this amount as ordinary income
        </div>  
        <div style="float:right">            
          <div class="styIRS8621LNRightNumBox" style="border-bottom:0"></div>  
          <div class="styIRS8621LNAmountBox" style="border-bottom:0"></div>  
      ...
      <div class="styIRS8621Item">
        ...
        <div style="float:right">  
          ...
          <div class="styIRS8621LNRightNumBox">8</div>  
          <div class="styIRS8621LNAmountBox">
    ...
    <!-- BEGIN Part IV Title -->  
      ...
      <div class="styIRS8621BB" style="height:8mm; border-top:1 solid black">
        ...
        <div class="styTitleDesc" style="font-size:10pt">
          Distributions From and Dispositions of Stock of a Section 1291 Fund <span class="styNormalText">(See page 6 of instructions.)<br/><i>Complete a  <b>separate</b> </i>&nbsp; <i>Part IV for each excess distribution (see instructions).</i></span>          
        </div>          
    ...
    <!-- BEGIN Part V Title -->  
      <div style="height:8mm; border-top:1 solid black; width:187mm">

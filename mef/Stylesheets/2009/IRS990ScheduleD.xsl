    ...
    <form name="Form990ScheduleD">
     ...
     <br />
        ...
        <div class="styTYBox" style="width:30mm;">
          ...
          <div class="styTY" >20<span class="styTYColor">09</span></div>
...
<!-- Footer -->
    <div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageend">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule D (Form 990) 2009</span></div>
    </div>
   ...
   <br />
    ...
    <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
      <div style="width:90mm;" class="styGenericDiv">Schedule D (Form 990) 2009</div>
...
<div class="styGenericDiv" style="float:right">
	...
	<span class="styGenericDiv" style="float:left" colspan="2">Financial derivatives</span></td>
...
<b>2.</b> Fin 48 Footnote. In Part XIV, provide the text of the footnote to the organization's financial statements that reports the organization's liability for uncertain tax positions under FIN 48.
</td>

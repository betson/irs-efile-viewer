...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ExchangeRateSchedule" />
  
  <xsl:template name="DependencyTemplate">
    <table id="ERSTbl" class="styDepTbl" >
      <thead class="styDepTableThead">
        <tr class="styDepTblHdr">
           <!--th class="styDepTblCell" scope="col">Item No.</th-->
           <th class="styDepTblCell" scope="col"> Exchange Rate</th>
           <th class="styDepTblCell" scope="col">Reference to Form</th>
        </tr>
      </thead>
      <tfoot></tfoot>
      <tbody>
        <xsl:for-each select="$DependencyData/ExchangeRateInfo">
          <tr>

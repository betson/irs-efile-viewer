      ...
      <body class="styBodyClass">
        ...
        2
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:138mm;">
                <span style="float:left;">Work opportunity credit allowed for 2009 from a passive activity (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:16px;"/>.  
                  <span style="width:16px;"/>.
            ...
            <div style="width:187mm;">
             ...
             <span style="float:left;">carryforward from 2008 of the New York Liberty Zone business employee credit </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:16px;"/>.  
                <span style="width:16px;"/>.  
       ...
       8
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:138mm;">
                <span style="float:left;">Carryback of the work opportunity credit from 2010 (see instructions) </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:16px;"/>.  
                  <span style="width:16px;"/>.
       ...
       Form <span class="styBoldText">5884</span> (2009)
        </div>
          <!--<br class="pageEnd"/>-->

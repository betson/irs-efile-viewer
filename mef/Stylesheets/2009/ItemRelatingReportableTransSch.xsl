        ...
        <tr>
          ...
          <xsl:choose>
            ...
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="SequenceNumber" />
            </xsl:call-template>
          </td>
          ...
          <td class="styDepTblCell" style="text-align:center;width:25mm" >
           ...
           <td class="styDepTblCell" style="text-align:left;width:69mm" >
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="TypeOfReportableTransaction" />
            </xsl:call-template>
          </td>
...
<xsl:template name="ItemRelatingReportableTransSchTemp2">
    <table id="ItemRelatingReportableTransSchTbl2" class="styDepTblLandscape" style="font-family:'verdana' ">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           <th class="styDepTblCell"  scope="col" style="width:94mm;">Name of the Entity</th>
           <th class="styDepTblCell"  scope="col" style="width:26mm">EIN of the entity</th>    
      ...
      <xsl:for-each select="$DependencyData/ItemRelatingReportableTrans">
        <tr>
          ...
          <xsl:choose>
           ...
           <td class="styDepTblCell" style="text-align:left;width:94mm" >
            <xsl:call-template name="PopulateText">
          ...
          <td class="styDepTblCell" style="text-align:center;width:26mm" >

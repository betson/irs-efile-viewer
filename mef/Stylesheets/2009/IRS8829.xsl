...
home you used for business during the year.
  ...
  <div class="styTYBox" style="width:32mm;height:21mm;">
    ...
    <div class="styOMB" style="padding-top:2.5mm;height:6mm;text-align:left;padding-left:5mm;border-bottom-width:0px;line-height:110%;">
      Attachment <br />Sequence No. <span class="styBoldText">66</span>
    </div>
  </div>
</div>
...
<div style="width:187mm;" class="styBB">
  ...
  <div style="width:187mm">        
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm; width:137mm;">
      ...
      or product samples (see instructions)  <span style=" letter-spacing:3.2mm; font-weight:bold; ">      
      ....................
      </span>    
    </div>
  ...
  <div style="width:187mm">        
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm;">
      Total area of home     <span style=" letter-spacing:3.2mm; font-weight:bold; ">...........................</span>    
...
<!--Line 5-->
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm;">
      Total hours available for use during the year (365 days x 24 hours)<br/> (see instructions)    
      <span style=" letter-spacing:3.2mm; font-weight:bold; ">..................</span>      
        </div>
    <div style="float:right;">
      <div class="styLNRightNumBox" style="height:8.5mm; padding-top:4.5mm;" >5</div>  
    ...
    <xsl:call-template name="PopulateText">
      ...
      <div class="styLNRightNumBox" style="padding-top:.6.5m;background-color:lightgrey;border-bottom-width:0px;height:8.5mm;"></div>
      <div class="styLNAmountBoxNBB"  style="padding-top:4.5mm;width:34mm;height:8.5mm;">
      </div>
    </div>        
  </div>
  <!--Line 6-->
...
<div style="width:187mm;" class="styBB">
  <div style="width:187mm">        
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm;">
   Enter the amount from Schedule C, line 29, <b>plus</b> any net gain or (loss) derived from the business use of
    </div>
    <div style="float:right;">
    <div class="styLNRightNumBoxNBB" style="background-color:lightgrey;"></div>
      <div class="styLNAmountBoxNBB" style="width:34mm;"></div>
  ...
  <div class="styLNLeftNumBox"></div>
   <div style="float:left;">
     your home and shown on Schedule D or Form 4797. If more than one place of business, 
    </div>
     <div style="float:right;">
         <div class="styLNRightNumBoxNBB"></div>
         <div class="styLNAmountBoxNBB" style="width:34mm;"></div>
  ...
  <div style="width:187mm">  
    ...
    <div class="styGenericDiv" style="width: 187mm">
          <div  class="styLNDesc" style="padding-left:8mm;width:64mm; ">
           ...
           <div class="styLNLeftNumBox" style="padding-left:0mm; "></div>
            <div class="styGenericDiv" style="width: 20mm;padding-top:3.5mm;">
            <div class="styLNRightNumBox" style="font-weight:normal;width:72.9mm;border-left-width1px; border-top-width:1px;border-right-width:0px;border-bottom-width:0px; height:4.5mm;">
                    <b>(a) Direct expenses </b><span style="width:8mm;"></span>  <b>(b) Indirect expenses</b>
            </div>
            </div>
 ...
 <xsl:call-template name="PopulateAmount">
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:56mm;height:8mm;">
      ...
      <div class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:8mm;padding-top:4mm;">10</div>
 <div class="styLNAmountBox" style="width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px; height:8mm;padding-top:4mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/DeductibleMortgageIntDirectAmt"/>
        </xsl:call-template>
            </div>
 <div class="styLNAmountBox" style="width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px; height:8mm;padding-top:4mm;">
 <xsl:call-template name="PopulateAmount">
...
<!-- End Line 10 -->
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:56mm; ;">
      ...
      <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:4.5mm;">11</div>
 <div class="styLNAmountBox" style="font-weight:normal;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.5mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/RealEstateTaxesDirectAmt"/>
        </xsl:call-template>
            </div>
 <div class="styLNAmountBox" style="font-weight:normal;width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.5mm;">
 <xsl:call-template name="PopulateAmount">
...
<!-- End Line 12 -->
 ...
 <div class="styLNRightNumBox" style="font-weight:normal;width:29mm;border-left-width1px; border-top-width:0px;border-right-width:1px;background-color:lightgrey;height:4.9mm;"></div>
            <span class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-right-width:0px;border-left-width:0px;height:4.9mm;">13</span>
...
<!-- End Line 14 -->
 ...
 <div class="styLNRightNumBox" style="font-weight:normal;width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px;background-color:lightgrey;height:7.5mm;"></div>
       <div class="styLNRightNumBox" style="height:7.5mm;padding-top:2.5mm;">15</div>
      <div class="styLNAmountBox" style="width:34mm;height:7.5mm;padding-top:2mm;">
<xsl:call-template name="PopulateAmount">
...
<!-- End Line 15 -->
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:56mm;height:8mm;">
      ...
      <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:8mm;padding-top:4mm;">16</div>
...
<!-- End Line 23 -->
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:93.2mm;">
               Carryover of operating expenses from 2008 Form 8829, line 42
             <span style=" letter-spacing:3.2mm; font-weight:bold; padding-left:3mm;">..</span>
         </div>
...
<!--  Line 28 -->
 ...
 <!--  Line 30 -->
  <div style="width:187mm">        
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm;width:90mm;height:8mm;">
      Carryover of excess casualty losses and depreciation from 2008 Form 8829, line 43 
      <span style=" letter-spacing:3.2mm; font-weight:bold; padding-left:3mm; ">................</span>
        </div>
    <div style="float:right;">
      ...
      <div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;height:8mm;"></div>
...
<!-- End Line 34 -->
 ...
 <!-- Line 35 -->
    ...
    <div style="float:left;padding-top:0.5mm;padding-bottom:.5mm; width:133mm;">
...
<span style=" letter-spacing:2.2mm; font-weight:bold; padding-left:2mm;padding-right:1mm;">...</span> 
 <img src="{$ImagePath}/8829_Bullet.gif" alt="Bullet Image" />
   ...
   <div style="float:right;">
    <div class="styLNRightNumBoxNBB" style="background-color:lightgrey;"></div>
      <div class="styLNAmountBoxNBB" style="width:34mm;"></div>
      <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0px;">35</div>
      <div class="styLNAmountBox" style="height:4.5mm;width:34mm; border-bottom-width:0px;">
      <xsl:call-template name="PopulateAmount">
...
<div class="styBB" style="width:187mm;border-top-width: 1px;" >
  ...
  <div class="styPartDesc" style="padding-left:3mm;">
   Carryover of Unallowed Expenses to 2010 	 
  </div>
</div>
<div style="width:187mm;" class="styBB">
   <!-- Line 42 -->
...
<div style="width:187mm;clear:both;">
  <div style="width:110mm;font-weight:bold;" class="styGenericDiv">For Paperwork Reduction Act Notice, see page 4 of separate instructions.</div>
  <div style="width:35mm;text-align:center;" class="styGenericDiv">Cat. No. 13232M</div>
  <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">8829</span> (2009)</div>
</div>
  <p class="pageend"></p>

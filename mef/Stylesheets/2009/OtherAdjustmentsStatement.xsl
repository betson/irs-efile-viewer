    ...
    <table id="ILSTbl" class="styDepTbl" style="text-align:center;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr"> 
 			<xsl:choose>
                <xsl:when test="$RtnDoc/OtherAdjustmentsStatement/OtherAdjustmentsStmt/OtherAdjustmentsLitCd ">
					   <th class="styDepTblCell" scope="col" style="width:100mm;">Other Adjustments Literal</th>
				</xsl:when>
				<xsl:otherwise>
					   <th class="styDepTblCell" scope="col" style="width:100mm;">Other Adjustments Code Text</th>
				</xsl:otherwise>
			</xsl:choose>

        ...
        <form name="Form8911">
          ...
          <div style="width:187mm;">
            <div style="float:left;clea:none;">
              ...
              <div class="styLNDesc" style="width:97mm;height:4mm;"/>
            </div>
            <div style="float:right;clear:none">
              <div class="styLNRightNumBox" style="height:6.5mm;border-bottom-width:1px;border-left-width:0px;"/>
              <div class="styLNAmountBox" style="height:6.5mm;border-bottom-width:1px;text-align:center;padding-left:0px;font-size:6pt;valign:center;font-weight:bold">
                (a) Hydrogen refueling property
              </div>
              <div class="styLNAmountBox" style="height:6.5mm;border-bottom-width:1px;text-align:center;padding-left:0px;font-size:6pt;font-weight:bold">
                (b) Other refueling property
              </div>
            </div>
          </div>
          <!-- L1-->
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:105mm;height:8mm;font-size:7pt;">
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none">
              ...
              <div class="styLNDesc" style="width:137mm;">
		        ...
		        Add lines 9 and 10. Partnerships and S corporations, report 
		      <span style="float:left;">this amount on Schedule K; all others, report this amount on Form 3800, line 1s </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:16px"/>.
                  <span style="width:16px"/>.
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:105mm;height:4mm;">
                Subtract line 2 from line 1. If zero, stop here; <span class="styBoldText">do not</span> file this form unless you 
                  <span style="float:left;">are claiming a credit on line 9 </span>
                <!--Dotted Line-->
                <span class="styBoldText" style="float:right;padding-right:1mm;">
                  <span style="width:16px"/>.
                  <span style="width:16px"/>.
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBox" style="padding-left: 2mm;height:4mm;"/>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="padding:0mm">
                  <tr>
                    ...
                    <td style="width:27mm">
                      ...
                      <div class="styLNDesc" style="width:24.5mm;padding-top:1.5mm;">
                        <span class="styBoldText" style="font-size: 7pt;float:right;padding-right:1mm;">
                          <span style="width:16px;"/>.
                          <span style="width:16px;"/>. 
                          <span style="width:16px;"/>.
                          <span style="width:16px;"/>.
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:97mm;height:4mm;">
		      Non-business qualified electric vehicle credit from Form 8834, Line 7
              </div>
            </div>
            <div style="float:right;clear:none;">
          ...
          <div style="width:187mm;">
            ...
            <div style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="height:4mm;">19d</div>
              <div class="styLNAmountBox" style="height:4mm;">
                <xsl:call-template name="PopulateAmount">
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="padding:0mm">
                  <tr>
                    ...
                    <td style="width:27mm">
                      ...
                      <div class="styLNDesc" style="width:24.5mm;padding-top:4mm;;">
                        <span class="styBoldText" style="font-size: 7pt;float:right;padding-right:1mm;">
                          <span style="width:16px;"/>.
	                     <span style="width:16px;"/>.
	                     <span style="width:16px;"/>.
          ...
          <div class="styBB" style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;height:4mm;">
			   ...
			   of line 17 or line 22 here and on Form 1040, line 53; Form 1040NR, line 49; or the appropriate line of your return. If line 22 is smaller than line 17, see 
          ...
          <div style="width:187mm">
            ...
            <div style="float:right;clear:none;">
              <span style="width:27mm;text-align:right;">Form <span class="styBoldText">8911 </span>(2009)</span>
            </div>
          </div>
          <br class="pageend"/>

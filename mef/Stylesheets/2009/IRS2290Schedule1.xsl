  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        <form name="Form2290Schedule1">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:18mm;">
              ...
              <br/>
              <span class="styAgency">(Rev. July 2009)<br/> Department of the Treasury</span>
              <br/>
         ...
         For the period July 1, 2009, through June 30, 2010<br/>
              </div>
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="font-size:6pt;width:187mm">
            <tbody>
              <tr>
                ...
                <td style="width:31.2mm;border:2 solid black;border-right-width:0;border-bottom-width:1px;text-align:center">
                  <b>FOR IRS<br/>USE ONLY</b>
                </td>
              </tr>
              <tr>
        ...
        <br/>
                ...
                <td rowspan="2" style="border:2 solid black;border-right-width:0;border-top-width:0px">T<br/>FF<br/>FP<br/>I<br/>T<br/>
                </td>
              </tr>
              <tr>
    ...
    <br/>
          ...
          <div class="styBB" style="width:187mm;border-top:1 solid black;border-right-width:0px">
            ...
            <span class="styItalicText">You must list <span class="styBoldText">all</span> vehicles. Attach a separate list if needed. See page 7 of the instructions.</span>
          </div>
    ...
    <!--Dotted Line-->
          ...
          <div style="width:187mm;border-top:2 black solid">
            <span style="float:left">
              <span class="styBoldText" style="font-size:7pt">For Privacy Act and Paperwork Reduction Act Notice, see page 9 of the instructions.</span>
            </span>
            <span style="float:right">
              <span class="styBoldText" style="font-size:8pt">Schedule 1 (Form 2290)</span> (Rev. 7-2009)</span>
          </div>
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="width:55mm;padding-left:2mm;padding-top:1mm;"/>
            <div class="styLNDesc" style="width:130mm;font-size:6.5pt;padding-top:1mm;">
              <b>Do not</b> cut or separate the forms on this page.</div>
    ...
    <br/>
          ...
          <!-- End Set Initial Height of Above Table -->
          <!--End Part 1 Table-->
          <xsl:variable name="xx" select="count($Form2290Schedule1/VehicleReportTaxItem)"/>
          <xsl:variable name="yy" select="count($Form2290Schedule1/VehicleSuspendedTaxItem)"/>
          <!--BEGIN PART II BEGIN PART II BEGIN PART II BEGIN PART II BEGIN PART II-->
          <div style="width:187mm;height:3.75mm;border-top-width:1">
            <div class="styPartName" style="height:3.75mm">Part II</div>
            <div class="styPartDesc" style="width:167mm"> Vehicles for Which Tax is Suspended&#8212;5,000 Miles or Less (7,500 Miles or Less for</div>
    ...
    <!--Dotted Line-->
          ...
          <div style="width:187mm;border-top:2 black solid">
            <span style="float:left">
              <span class="styBoldText" style="font-size:6pt">For Privacy Act and Paperwork Reduction Act Notice, see page 9 of the instructions. </span>
              <span class="styNormalText" style="font-size:6pt;padding-left:6mm;">         Cat. No. 11250O      </span>
            </span>
            <span style="float:right">
              <span class="styBoldText" style="font-size:6pt">Schedule 1 (Form 2290)</span> (Rev. 7-2009)</span>
          </div>
          ...
          <div class="styTBB" style="width:187mm">
            <div style="float:left;width:177mm;padding-bottom:0.5mm">Schedule 1 (Form 2290) (Rev. 7-2009)</div>
            <div style="float:left;width:10mm;text-align:right;padding-bottom:0.5mm">Page <span class="styBoldText" style="font-size:8pt">2</span>
            </div>
          </div>
          ...
          <div style="width:187mm;height:8mm;font-size:11pt;text-align:center;vertical-align:middle">For the period July 1, 2009, through June 30, 2010</div>
...
authority to execute this consent to disclosure of tax information.
          ...
          <div style="width:187mm;text-align:right;padding-top:1mm">
            <b>Schedule 1 (Form 2290)</b> (Rev. 7-2009)</div>
          <div class="pageEnd"/>
          <br/>
          <!--</xsl:if>-->

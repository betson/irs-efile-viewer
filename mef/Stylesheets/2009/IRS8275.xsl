        ...
        <xsl:choose>
          ...
          <!-- #######separated mode#######################-->
                  <xsl:if test="count($Form8275Data/GeneralInformation/DetailedExplanation) &lt; 1 or ((count($Form8275Data/GeneralInformation/DetailedExplanation) &gt; 3) and ($Print = $Separated))">
                    <tr style="height:5mm;">
                      <td class="styTableCell" style="background-color:yellow;width:3mm;font-weight:bold;text-align:left;border-right-width:0px;border-left-width:0px;border- color:black;vertical-align:top;border-color:black;">
                        1
                      </td>

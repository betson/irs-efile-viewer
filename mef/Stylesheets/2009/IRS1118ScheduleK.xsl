	...
	<xsl:template match="/">
		<html>
            ...
            <span style="width: 20mm;">
							...
							<div class="styFBT">
								<img src="{$ImagePath}/1118ScheduleK_Bullet_Title.gif" alt="bulletpoint"/>See separate instructions.</div>
							<div class="styFBT" style="height:4mm; margin-top:0px">
								<img src="{$ImagePath}/1118ScheduleK_Bullet_Title.gif" alt="bulletpoint"/> Attach to Form 1118</div>
						</div>
        ...
        schedule.
						...
						<div style="height:16mm;width:108mm;float:left;">
							...
							<span style="border-color:black; border-style:solid; border-right-width: 0px; border-left-width: 0px; border-top-width:0px; border-bottom-width: 1px; width: 25mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1118ScheduleKData/Section901jIncome/@sanctionedCountryName"/>
								</xsl:call-template>
							</span>
							<br/>
							<br/>
							...
							<span style="border-color:black; border-style:solid; border-right-width: 0px; border-left-width: 0px; border-top-width:0px; border-bottom-width: 1px; width: 30mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1118ScheduleKData/TreatyResourcedIncome/@countryName"/>
								</xsl:call-template>
							</span>
							<br/>
						</div>
...
<!--((count($Form1118ScheduleA/IncomeOrLossBeforeAdjustments) &gt; 6) and ($Print != $Separated))">   -->
          ...
          Page <span class="styBoldText" style="font-size: 8pt">2</span>
					...
					<!-- END SCHEDULE A TITLE -->
					<!-- BEGIN INCOMEORLOSS TABLE -->
					<div class="styTableContainerLandscape" id="IBActn" style="height:145mm;">
						<!-- print logic -->
						<!--	<xsl:call-template name="SetInitialState"/>    -->
						<!-- end -->
						<table class="styTable" cellspacing="0">

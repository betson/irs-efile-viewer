  ...
  <xsl:template name="MultiRateScheduleTemp">
    ...
    <table id="GeneralDependencyTbl" class="styDepTbl">
      <tr class="styDepTblHdr">
         ...
         <th class="styDepTblCell" style="width:79mm;">Fuel Type</th>
         	<th class="styDepTblCell" style="width:20mm;">Number of Gallons</th>
         <th class="styDepTblCell" style="width:34mm;">Rate</th>
...
<tr class="styDepTblHdr">
        <td class="styDepTblCell" style="width:20mm;text-align:left;font-weight:bold;border-top-width:2px;border-right-width:0px"></td>

  ...
  <xsl:template match="/">
        ...
        <form name="Form2290Schedule1">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:18mm;">
              ...
              <br/>
              <span class="styAgency">(Rev. July 2010)<br/> Department of the Treasury</span>
              <br/>
    ...
    <!--Dotted Line-->
          ...
          <div style="width:187mm;border-top:2 black solid">
            ...
            <span style="float:right">
              <span class="styBoldText" style="font-size:8pt">Schedule 1 (Form 2290)</span> (Rev. 7-2010)</span>
          </div>
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:130mm;font-size:6.5pt;padding-top:1mm;">
              <b>Do not</b> cut or separate the forms on this page.
            </div>
          </div>
          <table style="width:187mm">
            <tbody>
              <tr>
                <td style="width:187mm;height:7mm;">
                  ------------------------------------------------------------------------------------------------
                </td>
              </tr>
            </tbody>
    ...
    <!--Dotted Line-->
          ...
          <div style="width:187mm;border-top:2 black solid">
            ...
            <span style="float:right">
              <span class="styBoldText" style="font-size:6pt">Schedule 1 (Form 2290)</span> (Rev. 7-2010)</span>
          </div>
          ...
          <div class="styTBB" style="width:187mm">
            <div style="float:left;width:177mm;padding-bottom:0.5mm">Schedule 1 (Form 2290) (Rev. 7-2010)</div>
          ...
          <div style="width:187mm;height:8mm;font-size:11pt;text-align:center;vertical-align:middle">For the period July 1, 2010, through June 30, 2011</div>
...
authority to execute this consent to disclosure of tax information.
          ...
          <div style="width:187mm;text-align:right;padding-top:1mm">
            <b>Schedule 1 (Form 2290)</b> (Rev. 7-2010)</div>
          <div class="pageEnd"/>
          <br/>
          <!--</xsl:if>-->

	...
	<xsl:template match="/">
      ...
      <br/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4.5mm;text-align:center;font-weight:bold;border-bottom-width:0px;">(b)</div>
					</div>
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;"/>
						<div class="styLNDesc" style="width:107mm;"/>
						...
						<div class="styLNAmountBox" style="height:4.5mm;text-align:center;">All activities</div>
					</div>
					<!--  Line 1 -->
					<div style="width:187mm;">
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="padding-top:4mm;height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/DomesticProdGrossReceipts"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox" style="padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/DomesticProdGrossReceipts"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
            ...
            <span class="styBoldText">
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="padding-top:4mm;height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/AllocatedCOGS"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox" style="padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/AllocatedCOGS"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
     	...
     	Enter deductions and losses allocable to DPGR (see instructions)
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/DirectDeductionsExpensesLosses"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/DirectDeductionsExpensesLosses"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
	    ...
	    <span class="styBoldText">
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="padding-top:6.5mm;height:6mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/IndDeductionsExpensesLosses"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox" style="padding-top:6.5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/IndDeductionsExpensesLosses"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
              ...
              <span class="styBoldText">
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/TotalAllocatedCOGSDedExpLosses"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/TotalAllocatedCOGSDedExpLosses"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
              ...
              <span class="styBoldText">
                  ...
                  <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="height:5mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/NetDomesticProdGrossReceipts"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">
							<div class="styLNAmountBox" style="height:5mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/NetDomesticProdGrossReceipts"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
                 ...
                 <span style="width:8px"/>.
                  ...
                  <span style="width:8px"/>.        
						...
						<div class="styLNAmountBox" style="height:8mm;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/QlfyProductionActivities"/>
							</xsl:call-template>
						</div>
						...
						<div style="float:right">
							<div class="styLNAmountBox" style="height:4.5mm;padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/QlfyProductionActivities"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
                 ...
                 <span style="width:8px"/>.      
                  ...
                  <span style="width:8px"/>.                              
						...
						<div class="styLNAmountBox" style="height:7mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/ProductionActivitiesIncome"/>
							</xsl:call-template>
						</div>
						<div style="float:right">
							<div class="styLNAmountBox" style="height:4mm;padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/ProductionActivitiesIncome"/>
								</xsl:call-template>
							</div>
              ...
              <span class="styBoldText">
                 ...
                 <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="height:4mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllProduction/AmtAllocToBeneficiariesOrTrust"/>
							</xsl:call-template>
						</div>
						<div style="float:right">
							<div class="styLNAmountBox" style="height:4mm;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/AmtAllocToBeneficiariesOrTrust"/>
								</xsl:call-template>
							</div>
     	 ...
     	 <div class="styLNAmountBoxNBB" style="height: 3.5mm;"></div>          -->
          	...
          	10a         
							...
							<div class="styLNAmountBox" style="height:8mm;padding-top:8mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllProduction/OilRelQlfyProdActivitiesIncome"/>
								</xsl:call-template>
							</div>
							<div class="styLNAmountBoxNBB" style="height: 12mm;background-color: lightgrey;border-bottom-width:1px;"/>
						</div>
					</div>
					<!-- End Line 10a -->
					<!-- Line 10b -->
          	...
          	10b         
							...
							<div class="styLNAmountBox" style="height:10.5mm;padding-top:10.5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/AllActivities/QlfyProdActivitiesIncome"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
       ...
       Enter the smaller of line 10a or line 12   
           <span class="styBoldText">
                ...
                <span style="width:8px"/>.
						...
						<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QlfyIncOrOilRelOrIncomeLimits"/>
							</xsl:call-template>
						</div>
						<div style="float:right;">

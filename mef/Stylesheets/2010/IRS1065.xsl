...
<!-- Last Modified by Eugenia McDonald on 10/06/2010 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
					...
					<div class="styBB" style="width:187mm;height:6mm">
						...
						<div class="styGenericDiv" style="width:175mm;">
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form1065Data/ScheduleCAndScheduleM3Attached"/>
									<xsl:with-param name="BackupName">IRS1065SScheduleCAndScheduleM3Attached</xsl:with-param>
								</xsl:call-template>
						...
						<div class="styGenericDiv" style="width:5mm;float:right;text-align:right;">
							<input type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1065Data/ScheduleCAndScheduleM3Attached"/>
									<xsl:with-param name="BackupName">IRS1065ScheduleCAndScheduleM3Attached</xsl:with-param>
								</xsl:call-template>
							</input>
						</div>
					</div>
    ...
    May the IRS discuss this return
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2010)
    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065 (2010)<span style="width:148mm;"/>
						</div>
       ...
       <span class="styBoldText">
           ...
           <span style="width:16px"/>.
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">At any time during calendar year 2010, 
						   did the partnership have an interest in or a signature or other authority over a <br/>financial account
						   in a foreign country (such as a bank account, securities account, or other financial account)? See the
						   <br/>instructions for exceptions and filing requirements for Form TD F 90-22.1, Report of Foreign Bank
						   and Financial Accounts. If "Yes," enter the name of the foreign country.
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2010)
        ...
        Additional Data        
              ...
              Form 1065, Top Left Margin - IRC 6114:
						...
						<xsl:call-template name="PopulateLeftoverRow">
						   <xsl:with-param name="Desc">Form 1065, Schedule B, Line 11 - Form 3250 Indicator
						   </xsl:with-param>
						   <xsl:with-param name="TargetNode" 

		...
		<html>
          ...
          Internal Revenue Service</span>
						...
						<div class="styTYBox" style="width:30mm;height:12mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="height:7mm;padding-top:1mm;">20<span class="styTYColor">10</span>
							</div>
						</div>
					</div>
          ...
          (If “Yes,” attach an explanation and the amount of each item restated.)
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm">Net income from nonincludible foreign entities (attach schedule)
                                  <!-- Form Link -->
								<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;height:4mm">Net loss from nonincludible foreign entities
           ...
           <!-- Form Link -->
            ...
            <!-- Form Link -->
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;height:3mm">
								...
								Combine lines 4 through 10<span class="styDotLn" style="float:none;padding-left:3.5mm">....</span>
							</div>
						</div>
						<div style="float:right;">
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;font-size:6pt;height:3mm">Schedule M-3 (Form 1065) 2010</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1065) 2010</div>
...
Analysis of Net Income (Loss), line 1.</div>
					<div class="styBB" style="width:187mm;"/>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1065) 2010</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styBB" style="width:187mm;">

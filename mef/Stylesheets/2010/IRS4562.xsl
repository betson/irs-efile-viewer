    ...
    <b>
      ...
      <span class="styIRS4562NBSP"/>.
					...
					<div class="styIRS4562LineItem">
						...
						<span class="styIRS4562LNDesc">Carryover of disallowed deduction from line 13 of your 2009 Form 4562.
    <b>
								<span class="styIRS4562NBSP"/>.
      <span class="styIRS4562NBSP"/>.
      <span class="styIRS4562NBSP"/>.
      ...
      <span class="styIRS4562NBSP"/>.
        ...
        <span class="styIRS4562NBSP"/>.
					...
					<div class="styIRS4562LineItem">
						...
						<span class="styIRS4562LNDesc" style="width: 113.5mm">Carryover of disallowed deduction to 2011 Add lines 9 and 10, less line 12
    <b>
								<span class="styIRS4562NBSP"/>.
   </b>
...
during the tax year (see instructions)</span>
  ...
  <b>
    ...
    <span class="styIRS4562NBSP"/>.
					...
					<div class="styIRS4562LineItem">
						...
						<span class="styIRS4562LNDesc">MACRS deductions for assets placed in service in tax years beginning before 2010
  <b>
								<span class="styIRS4562NBSP"/>.
    <span class="styIRS4562NBSP"/>.
    <span class="styIRS4562NBSP"/>.
  ...
  <xsl:call-template name="SetFormLinkInline">
          ...
          <span class="styIRS4562TableCellPad"/>
								...
								<tr>
									<td style="border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width:0px; font-weight: bold; text-align: center" colspan="7">Section C&#151;Assets Placed in Service During 2010 Tax Year Using the Alternative Depreciation System
          <xsl:call-template name="SetFormLinkInline">
  ...
  <b>
    ...
    <b>
      ...
      <span class="styIRS4562NBSP"/>.
         ...
         Form <span class="styBoldText" style="font-size: 8pt">4562</span> (2010)
       </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styBB" style="width:187mm">
						<div style="float: left; clear: none">Form 4562 (2010)</div>
 ...
 mm; border-bottom-width: 0px" id="GDctn">
    ...
    <xsl:call-template name="SetFormLinkInline">
							...
							<tbody>
								<tr>
									<td class="styIRS4562OtherCell" style="border-color: black; border-left-width: 0px; border-right-width:0px; border-top-width: 0px; border-bottom-width:1px; " colspan="6">
										...
										<span class="styLNDesc">&#160;Amortization of costs that begins during your 2010 tax year (see instructions):</span>
										<span class="styIRS4562TableCellPad"/>
									</td>
								</tr>
					...
					<div class="styIRS4562LineItem" style="float: none; clear: both">
						...
						<span class="styIRS4562LNDesc" style="width: 130.5mm">Amortization of costs that began before your 2010 tax year 
  <b>
								<span class="styIRS4562NBSP"/>.
     <span class="styIRS4562NBSP"/>.
    <span class="styIRS4562NBSP"/>.
  ...
  <b>
    ...
    <span class="styIRS4562NBSP"/>.
					...
					<div style="width:187mm;clear:both;">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">4562</span>(2010)</div>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>
          ...
          Additional Data        
					...
					<xsl:if test="(((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or 
                           ...
                           (count($IRS4562Data/GeneralDepreciationSystem/GDSNonResidentialRealProperty2) &gt; 1)) and $Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part III, Line 19, Section B&#151;Assets Placed in Service During 2010 Tax Year Using the General Depreciation System:</span>
          ...
          <span class="styIRS4562TableCellPad"/>
					...
					<xsl:if test="((count($IRS4562Data/AlternativeDepreciationSystem/ADSClassLifeProperty) &gt; 1) or 
                          ...
                          (count($IRS4562Data/AlternativeDepreciationSystem/ADS40YearProperty) &gt; 1)) and ($Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part III, Line 20a - c, Section C&#151;Assets Placed in Service During 2010 Tax Year Using the Alternative Depreciation System           
        <xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$IRS4562Data/AlternativeDepreciationSystem"/>
         ...
         Total business/investment miles driven<br/>
          ...
          <span style="width: 5mm"/>
            ...
            <span class="styIRS4562TableCellPad"/>
					...
					<xsl:if test="(count($IRS4562Data/AmortizationInfo/AmortizationInfoTable) &gt; 2) and ($Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part VI, Line 42, Amortization of costs that begins during your 2010 tax year (see instructions):</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">

...
<body class="styBodyClass"><form name="Form8697">
  ...
  <div class="styTBB" style="width:187mm;height:20mm;border-bottom-width: 1px; ">
    ...
    <div class="styFNBox" style="float:left;width:32mm;height:22mm;">
      ...
      <div style="padding-top:1.5mm; font-size:6pt;">(Rev. November 2002)</div>
      <div style="padding-top:1mm;">
    ...
    <div class="styFTBox" style="width:125mm;">
      ...
      <div class="styFBT" style="padding-top:3mm;">
        ...
        <img src="{$ImagePath}/8697_Bullet_Md.gif" alt="bullet image pointing to right" width="8"/>
        <span style="width:34mm;font-size:7pt;">Please print or type.</span>
      </div>
    </div>
  ...
  <div class="styBB" style="width:187mm;">
    <div class="styNameBox" style="font-size:7pt;width:131mm;height:9.5mm;">Name
      <div style="float:left;font-size:6pt;width:131mm;font-family:verdana;">
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$Form8697Data/Name/BusinessNameLine1" />
        </xsl:call-template>
        <xsl:if test="$Form8697Data/Name/BusinessNameLine2!=''">
          <div style="float:left;font-size:6pt;width:131mm;font-family:verdana;">      
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form8697Data/Name/BusinessNameLine2" />
            </xsl:call-template>
          </div>
        </xsl:if>      
      </div>
  ...
  <div class="styBB" style="width:187mm;">
    <div class="styNameBox" style="width:27mm;text-align:center;font-size:7pt;height:20mm;font-weight:bold;">
...
<xsl:variable name="part4Count" select="1"/>
  ...
  <div style="width:187mm;height:8mm;border-style:solid;
    ...
    <span class="styPartName" style="height:1mm;width:16mm;">Part I</span>
    <span style="width:60mm;" class="styPartDesc">
      <span style="width:3mm;"></span>Regular Method<br/>
    </span>
  </div>
  ...
  <div style="width:187mm;">
    ...
    <div class="styLNDesc" style="width:152.25mm;height:4mm;padding-left:1mm;">Net amount of <span style="font-weight:bold;">interest to be refunded to you.</span> If line 8, column (d), exceeds line 7, column (d), enter the excess. File
  ...
  <div class="styBB" style="width:187mm;">
    ...
    <div class="styLNDesc" style="width:152.25mm;height:4mm;padding-left:1mm;">
      Net amount of <span style="font-weight:bold;">interest you owe.</span> If line 7, column (d), exceeds line 8, column (d), enter the excess. Attach
  ...
  <div style="  clear:both;width:187mm;">
    ...
    <span style="width:5mm;"></span>
    Form 
    <span style="font-size:9pt;font-weight:bold;">8697</span> (Rev. 11-2002)
  </div>    
  ...
  <!-- Header -->
  <div class="styBB" style="width:187mm;">  
    <div style="float:left;">Form 8697 (Rev. 11-2002)<span style="width:130mm;"></span></div>
  ...
  <div style="width:187mm;height:8mm;border-style:solid;
          border-bottom-width:1px;border-top-width:0px;
          border-right-width:0px;border-left-width:0px;padding-top:2mm;float:left;">
    <span class="styPartName" style="height:1mm;width:16mm;">Part II</span>
    <span style="width:70mm;" class="styPartDesc">
      <span style="width:3mm;"></span>Simplified Marginal Impact Method
    </span>
  </div>
   ...
   <!-- End Signature Section -->
	...
	<tr>
		...
		<td style="width:32mm;border-bottom:1 solid black;">
			...
			<span class="styGenericDiv" style="border:0 solid red;"><img src="{$ImagePath}/8697_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/></span>
		</td>
        ...
        <span style="width:2px;"></span>
        <img src="{$ImagePath}/8697_Bullet_Sm.gif" width="4" height="7" alt="right pointing bullet image" border="0"/><span style="width:5px;"></span>         
	...
	<tr>
		<td rowspan="2" colspan="1" style="border-bottom:1 solid black;padding-left:.5mm;">
    		...
    		<span class="styGenericDiv" style="">
    		  <img src="{$ImagePath}/8697_Bullet_Lg.gif" align="middle" alt="Big Right Arrow" border="0"/>
        </span>		
		</td>
		<td colspan="3" style="border-right:1 solid black;border-bottom:1 solid black;padding-left:.5mm;font-family:verdana;font-size:6pt;">                  
  ...
  <table style="width:187mm;"  id="TP1ctn" >
    ...
    <table cellspacing="0" summary="Table located under line C, having four columns and eight rows" 
      ...
      <tr>
        ...
        <th class="styTableCell" colspan="3" 
            style="width:96mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
          <span style="width:12mm;"></span>
          Date of each prior year to which interest <br/>
      ...
      <tr>
        ...
        <td class="styTableCell" rowspan="1" style="width:29mm;text-align:center;border-color:black;border-right:none">
          <span style="font-weight:bold;">        <xsl:if test="$index &lt;= 1">(d)</xsl:if>
</span><br/>
          <span style="text-align:center;width:20mm;">Totals</span>
        ...
        <td class="styForm8697TableCell" rowspan="1" nowrap="nowrap;">
          <xsl:if test="$index=0 and $Part1Max=0">
            <xsl:call-template name="PopulateAdditionalDataTableMessage">
              <xsl:with-param name="TargetNode" select="$Form8697Data/RegularMethodComputation" />
      ...
      <tr>
        ...
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
              select="$Form8697Data/RegularMethodComputation[$index*3-2]/PriorYearIncomeTaxLiability"/>
          </xsl:call-template>
        </td>
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
      ...
      <tr>
        ...
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
              select="$Form8697Data/RegularMethodComputation[$index*3-2]/PriorYearTaxIncreaseOrDecrease"/>
          </xsl:call-template>
        </td>
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
      ...
      <tr>
        ...
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
              select="$Form8697Data/RegularMethodComputation[$index*3-2]/InterestDueOnIncrease1"/>
          </xsl:call-template>
        </td>
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
      ...
      <tr>
        ...
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
              select="$Form8697Data/RegularMethodComputation[$index*3-2]/InterestToBeRefundedOnDecr1"/>
          </xsl:call-template>
        </td>
        <td class="styForm8697TableCell" rowspan="1">
          <xsl:call-template name="PopulateAmount">

				...
				<form name="IRS4136">
					...
					<div class="styIRS4136BB" style="width:187mm;">
						<div class="styIRS4136FN" style="width:31mm; height: 21mm">
							...
							<div class="styIRS4136Agency" style="padding-top:8mm;">Department of the Treasury Internal Revenue Service (99)
    </div>
						</div>
						...
						<div class="styIRS4136TYBox" style="height: 25mm;">
							...
							<div class="styIRS4136TY">20<span class="styTYColor">10</span>
							</div>
...
<!-- Name and Identifying number END-->
        ...
        Claimant has the name and address of the person who sold the fuel to the claimant and the dates of purchase. <br/>
         ...
         not been provided to the credit card issuer. </span>
		<div style="width:187mm;"/>
		</div>
		<!--   END NOTE HEADER   -->
		<!--   BEGIN BLOCK 1   -->
		...
		<!-- Count the number of rows in the table -->
					...
					<div class="styIRS4136NumLine" style="padding-left:2mm;border-top-width: 0px;"><br/>
						<span style="float:left;clear:none;"> 1<span class="styIRS4136NBSP" style="padding-right:3mm;"/> Nontaxable Use of Gasoline</span><span style="width:6mm"/><b>Note.</b><span style="font-weight:normal"> CRN is credit reference number</span><br/>
   ...
   <xsl:call-template name="PopulateAmount">
                  ...
                  <xsl:with-param name="Desc">Form 4136 line 1(d),  NontaxableUseOfGasolineCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseOfGasolineCredit/@creditReferenceNumber"/>
              </xsl:call-template>
             	<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
                ...
                Exported
									...
									<td class="styIRS4136Braces">
										<span class="styIRS4136TableCellPad" style="padding-right:1mm">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" 
												select="$IRS4136Data/ExportedNontaxableUseOfGasGals"/>
											</xsl:call-template>
										</span>
									</td>
									<td class="styIRS4136TableCellD">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/ExportedNontaxableUseOfGasCr"/>
										</xsl:call-template>									
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 1d(d),  ExportedNontaxableUseOfGasCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedNontaxableUseOfGasCr/@creditReferenceNumber"/>
              </xsl:call-template>									
										<span class="styIRS4136TableCellPad"/>
									</td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD" style="padding-left:3mm;text-align:left;">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 2a(d),  AviationGasolineCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationGasolineCredit/@creditReferenceNumber"/>
              </xsl:call-template>			
				<span class="styIRS4136TableCellPad"/>
				</td>
										...
										<tr>
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 2b(d),  NontaxableAviationGasolineCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableAviationGasolineCr/@creditReferenceNumber"/>
              </xsl:call-template>
              <span class="styIRS4136TableCellPad"/>
												</td>
												<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD" style="padding-left:3mm;text-align:left;">
										...
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/ExpNontaxableAviationGasCredit"/>
										</xsl:call-template>									
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 2c(d),  ExpNontaxableAviationGasCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExpNontaxableAviationGasCredit/@creditReferenceNumber"/>
              </xsl:call-template>										
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD" style="padding-left:3mm;text-align:left;">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 2d(d),  LUSTTaxAviationFuelCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LUSTTaxAviationFuelCredit/@creditReferenceNumber"/>
              </xsl:call-template>										
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<!-- END LINE 2   -->
					<div class="styBB" style="width:187mm;height:2mm;padding-left:8mm">*See instructions for possible rate changes.</div>
					<!--   BEGIN BLOCK 3  -->
					<!--   BEGIN LINE 3   -->
              ...
              <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 3a(d),  NontxUseFarmUndyedDslFuelCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxUseFarmUndyedDslFuelCr/@creditReferenceNumber"/>
              </xsl:call-template>             
              <span class="styIRS4136TableCellPad"/>
				</td>
				<td class="styIRS4136TableCellE">
				<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>360
              <span class="styIRS4136TableCellPad"/>
				</td>
				</xsl:if>
				</tr>
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 3c(d),  TrainUseOfUndyedDieselCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/TrainUseOfUndyedDieselCredit/@creditReferenceNumber"/>
              </xsl:call-template>										
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD" style="padding-top:2mm;">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 3d(d),  UseOfUndyedDieselInBusesCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UseOfUndyedDieselInBusesCredit/@creditReferenceNumber"/>
              </xsl:call-template>									
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                                   <xsl:with-param name="Desc">Form 4136 line 3e(d),  ExportedUndyedDieselFuelCr/@creditReferenceNumber</xsl:with-param>
                                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedUndyedDieselFuelCr/@creditReferenceNumber"/>
                                  </xsl:call-template>
                                  <span class="styIRS4136TableCellPad"/>
									</td>
								...
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/NontaxableUseOfUndyedKerosene) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/NontaxableUseOfUndyedKerosene">
										<tr>
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/>
													</xsl:attribute>$													
													 <xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedKeroseneForFarmingCredit"/>
                                                  ...
                                                  <span class="styIRS4136TableCellPad"/>                                                  
                                                 <xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 4a(d),  UndyedKeroseneForFarmingCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedKeroseneForFarmingCredit/@creditReferenceNumber"/>
              </xsl:call-template> 
												</td>
												<td class="styIRS4136TableCellE">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD" style="padding-top:2mm;">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 4c(d),  UseOfUndyedKeroseneCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UseOfUndyedKeroseneCredit/@creditReferenceNumber"/>
              </xsl:call-template> 
              <span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 4d(d),  ExportedUndyedKeroseneCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedUndyedKeroseneCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 4e(d),  NontaxableUseTaxedAt044Credit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxPSeriesFuelsCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 4f(d),  NontaxableUseTaxedAt219Credit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt219Credit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
    ...
    <span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2010)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styBB" style="width:187mm">
						<div style="float: left; clear: none">Form 4136 (2010)</div>
    ...
    <span class="styIRS4136NBSP" style="padding-right:3mm;"/>
						...
						<table class="styIRS4136Table" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									...
									<th class="styIRS4136TableCellA" style="text-align: center"><b>(a) Type of use</b>
									</th>
									<th class="styIRS4136TableCellB" style="text-align: center"><b>(b) Rate</b>
									</th>
									<th class="styIRS4136TableCellC" style="text-align: center"><b>(c) Gallons</b>
									</th>
									<th class="styIRS4136TableCellD" style="text-align: center"><b>(d) Amount of credit</b>
									</th>
									<th class="styIRS4136TableCellE" style="text-align: center"><b>(e) CRN</b>
									</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								...
								<tr>
									...
									<xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 5a(d),  KeroseneTaxedAt244Credit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneTaxedAt244Credit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
        ...
        border-bottom-width:10mm;border-color:white">
									...
									<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.175*</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 5b(d),  KeroseneTaxedAt219Credit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneTaxedAt219Credit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseTaxedAt244">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>Nontaxable use (other than use by state or local government) taxed at $.244
        </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 5c(d),  NontaxableUseTaxedAt244Cr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt244Cr/@creditReferenceNumber"/>
              </xsl:call-template>
													<span class="styIRS4136TableCellPad"/>
												</td>
												<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$AGRowCount2 = 0 or ((count($IRS4136Data/NontaxableUseTaxedAt219) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Nontaxable use (other than use by state or local government) taxed at $.219*
      </td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
        ...
        <span class="styIRS4136TableCellPad"/>
									...
									<xsl:for-each select="$IRS4136Data/NontaxableUseTaxedAt219">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount2"/></xsl:attribute>Nontaxable use (other than use by state or local government) taxed at $.219*
                       </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$AGRowCount5e = 0 or ((count($IRS4136Data/LUSTTaxAvnFuel) &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;
										padding-left:4mm;padding-right:1.5mm;"><b>e</b>
										</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/LUSTTaxAvnFuel) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/LUSTTaxAvnFuel">
										<tr>
											<xsl:if test="position()=1">
												<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount5e"/></xsl:attribute><b>e</b>
												</td>
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount5e"/></xsl:attribute>LUST tax on aviation fuels used in foreign trade
        </td>
											</xsl:if>
											<td class="styIRS4136TableCellA" style="background-color: lightgrey;">
												<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
					...
					<!--   BEGIN BLOCK 6   -->
					<!--   BEGIN LINE 6   -->
					<div class="styIRS4136NumLine" style="width:186mm;float: none; clear: both;padding-left:2mm;"><br/>6
					<span class="styIRS4136NBSP" style="padding-right:3mm;"/>  Sales by Registered Ultimate Vendors of Undyed Diesel Fuel <span style="width:4mm;"/>
						<br/>
...
consent of the buyer to make the claim. Claimant certifies that the diesel fuel did not contain visible evidence of dye.
      ...
      visible evidence of dye, attach an explanation and check here<span class="styDotLn" style="float:none;clear:none;">......</span> 
								...
								<tr>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 6a(d),  StateLocalGovtDieselCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/StateLocalGovtDieselCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<tr>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 6b(d),  UndyedDieselFuelBusesCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedDieselFuelBusesCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
						...
						<table class="styIRS4136Table" style="width:187mm;border-bottom:0px solid black;">
							<tbody>
								<tr class="styIRS4136NumLine">
									...
									<span class="styIRS4136NBSP"/>Sales by Registered Ultimate Vendors of Undyed Kerosene (Other Than Kerosene For Use in Aviation)
        </td>
									<br/>
								</tr>
							</tbody>
					...
					<div style="width:187mm;border-bottom:1px solid black;padding-left:5.5mm"><b>Registration No.</b>
...
of the buyer to make the claim. Claimant certifies that the kerosene did not contain visible evidence of dye.
	...
	<xsl:call-template name="PopulateLabel">
						...
						<table class="styIRS4136Table" style="width:187mm;" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									...
									<th class="styIRS4136TableCellB" style="text-align: center;border-top-width:1px;"><b>(b) Rate</b>
									</th>
									<th class="styIRS4136TableCellC" style="text-align: center;border-top-width:1px;"><b>(c) Gallons</b>
									</th>
									<th class="styIRS4136Braces" style="border-top-width:1px;">
										<span class="styIRS4136TableCellPad"/>
									</th>
									<th class="styIRS4136TableCellD" style="text-align: center;border-top-width:1px;"><b>(d) Amount of credit</b>
									</th>
									<th class="styIRS4136TableCellE" style="text-align: center;border-top-width:1px;"><b>(e) CRN</b>
									</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								...
								<tr>
									<td class="styIRS4136LetterCell"><b>a</b>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									<td class="styIRS4136LetterCell"><b>b</b>
									</td>
        ...
        <span class="styIRS4136TableCellPad"/>
					...
					<div class="styIRS4136NumLine" style="float: none; clear: both; padding-bottom:1mm;">
						<br/>
						<br/>
						<br/>8<span class="styIRS4136NBSP"/> Sales by Registered Ultimate Vendors of Kerosene For Use in Aviation<br/>
					...
					<div class="styIRS4136DescLine" style="font-size: 7pt; margin-left: 5mm; margin-right: 5mm; padding-right:10mm">Claimant sold the kerosene for use in aviation at a tax-excluded price and has not collected the amount of tax from the buyer, repaid 
    ...
    information to be submitted.
						...
						<table class="styIRS4136Table" style="width:187mm;" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									...
									<th class="styIRS4136TableCellA" style="text-align: center;border-top-width:1px;"><b>(a) Type of use</b>
									</th>
									<th class="styIRS4136TableCellB" style="text-align: center;border-top-width:1px;"><b>(b) Rate</b>
									</th>
									<th class="styIRS4136TableCellC" style="text-align: center;border-top-width:1px;"><b>(c) Gallons</b>
							...
							<tbody>
								...
								<tr>
									<td class="styIRS4136LetterCell " style=";border-bottom-width:9mm;border-color:white;padding-bottom:8mm"><b>a</b>
									</td>
									<td class="styIRS4136TableCellLine" style="padding-bottom:13mm;">Use in commercial aviation (other than foreign trade) taxed at $.219*<br/>
									</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellB" style="padding-top:2mm; text-align:center;">$ .175*
        <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
           ...
           <xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8a(d),  UseCmrclAviation219KeroseneCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UseCmrclAviation219KeroseneCr/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellE">355
        <span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!--  Row 8B OTHER NONTAXABLE USE  -->
								<td class="styIRS4136LetterCell " style="padding-bottom:4mm;"><b>b</b>
								</td>
								<td class="styIRS4136TableCellLine">Use in commercial aviation (other than foreign trade) taxed at $.244
								</td>
								<td class="styIRS4136TableCellA" style="background-color: lightgrey">
									<span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;padding-top:3mm;">.200
        <span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136TableCellC">
									<xsl:call-template name="PopulateText">
								...
								<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8b(d),  UseCmrclAviation244KeroseneCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/UseCmrclAviation244KeroseneCr/@creditReferenceNumber"/>
              </xsl:call-template>
									<span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136TableCellE">417
        <span class="styIRS4136TableCellPad"/>
								</td>
								<!--  Row 8C  -->
								<tr>
									<td class="styIRS4136LetterCell "><b>c</b>
									</td>
									<td class="styIRS4136TableCellLine">Nonexempt use in noncommercial aviation</td>
									<td class="styIRS4136TableCellA" style="background-color: lightgrey">
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellB" style="padding-top:3mm;padding-left:4mm;text-align:center;">.025*
        <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8c(d),  NonexemptUseNonCmrclAviationCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NonexemptUseNonCmrclAviationCr/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellE">418
        <span class="styIRS4136TableCellPad"/>
									</td>
								</tr>
								<!-- ########################################################## -->
								...
								<xsl:if test="$AGRowCount = 0 or ((count($IRS4136Data/OtherNontaxableUseTaxedAt244) &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="padding-left:3mm;padding-right:2mm;"><b>d</b>
										</td>
									...
									<xsl:for-each select="$IRS4136Data/OtherNontaxableUseTaxedAt244">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount"/></xsl:attribute>Other nontaxable uses taxed at $.244
        </td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
											...
											<xsl:if test="position()=1">
												...
												<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8d(d),  OtherNontaxableUseTaxedAt244Cr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/OtherNontaxableUseTaxedAt244Cr/@creditReferenceNumber"/>
              </xsl:call-template>
              <span class="styIRS4136TableCellPad"/>
												</td>
												<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$AGRowCount2 = 0 or ((count($IRS4136Data/OtherNontaxableUseTaxedAt219) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellLine">Other nontaxable uses taxed at $.219*</td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
										<td class="styIRS4136TableCellB" style="padding-left:5mm;">.218*</td>
										<td class="styIRS4136TableCellC">
											<xsl:attribute name="style">text-align:left;</xsl:attribute>
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
        ...
        <span class="styIRS4136TableCellPad"/>
									...
									<xsl:for-each select="$IRS4136Data/OtherNontaxableUseTaxedAt219">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount2"/></xsl:attribute>Other nontaxable uses taxed at $.219*
</td>
											</xsl:if>
											<td class="styIRS4136TableCellA">
												<xsl:call-template name="PopulateText">
											...
											<xsl:if test="position()=1">
												<td class="styIRS4136TableCellD">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8e(d),  OtherNontaxableUseTaxedAt219Cr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/OtherNontaxableUseTaxedAt219Cr/@creditReferenceNumber"/>
              </xsl:call-template>
				<span class="styIRS4136TableCellPad"/>
												</td>
												<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:5mm;">.001
        <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC">
									<xsl:call-template name="PopulateText">
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 8f(d),  LUSTTxAviationFuelCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LUSTTxAviationFuelCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellE">433
        <span class="styIRS4136TableCellPad"/>
			...
			<!-- ############################################################# -->
					...
					<!--   END LINE 8   -->
					<div class="styBB" style="width:187mm;height:2mm;padding-left:6mm">*See instructions for possible rate changes.</div>
					<!--BEGIN FOOTER-->
					<div style="width:187mm; padding-top:1mm;padding-bottom:2mm;">
						<div style="float: left; clear: none;">
    ...
    Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2010)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div class="styIRS4136NumLine" style="float: none; clear: both">
						<br/>
						<br/>9
    <span class="styIRS4136NBSP"/>Alcohol Fuel Mixture Credit<br/>
						<span style="width:5mm;"/>Registration No.
    <img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/>
						<span style="width:8px;"/>
						<span style="font-weight:normal">
							<xsl:call-template name="PopulateText">
					...
					<div class="styIRS4136DescLine" style="font-size: 7pt; margin-left: 5mm; margin-right: 5mm; padding-right:10mm;width:182mm;border:solid black 1; border-top-width:0px;border-right-width:0px;border-left-width:0px;">Claimant produced an alcohol fuel mixture by mixing taxable fuel with alcohol. The alcohol 
						...
						<table class="styIRS4136Table" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									...
									<th class="styIRS4136TableCellC" style="text-align: center"><b>(c) Gallons of alcohol</b>
									</th>
									<th class="styIRS4136TableCellD" style="text-align: center"><b>(d) Amount of credit</b>
									</th>
									<th class="styIRS4136TableCellE" style="text-align: center"><b>(e) CRN</b>
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:4mm">$.45
                    <span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
									...
									<xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 9a(d),  AlcoholFuelMixtureEthanolCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/AlcoholFuelMixtureEthanolCr/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<!--  Row 09B  -->
								<tr>
									<td class="styIRS4136LetterCell" style="border-bottom-width:1px;"><b>b</b>
									</td>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 9b(d),  AlcoholFuelMixtureAlcoholCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/AlcoholFuelMixtureAlcoholCr/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
    ...
    <img src="{$ImagePath}/4136_Bullet.gif" alt="Bullet"/>
					...
					<div class="styIRS4136DescLine" style="font-size: 7pt; margin-left:5mm; margin-right: 5mm;width:182mm;border:solid black 1; border-top-width:0px;border-right-width:0px;border-left-width:0px;"><b>Biodiesel mixtures. </b>Claimant produced a mixture by mixing biodiesel with diesel fuel. The biodiesel used to
       produce the mixture met ASTM D6751 and met EPA&#8217;s registration requirements for fuels and fuel additives. The mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by 
       the claimant. Claimant has attached the Certificate for Biodiesel and, if applicable, the Statement of Biodiesel Reseller. <b>Renewable diesel mixtures.</b> Claimant produced a mixture by mixing renewable 
      diesel with liquid fuel (other than renewable diesel). The renewable diesel used to produce the renewable diesel mixture was derived from biomass process, met EPA&#8217;s registration requirements for fuels and fuel additives, and met 
      ...
      as a fuel by the aimant. Claimant has attached the Certificate for Biodiesel and, if applicable, the Statement of Biodiesel Reseller, both of which have been edited as discussed in the Instructions for Form 
						...
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="text-align: center">$1.00</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
									...
									<xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 10a(d),  BiodieselMixtureCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/BiodieselMixtureCredit/@creditReferenceNumber"/>
              </xsl:call-template>
									</td>
								...
								<tr>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 10b(d),  AgriBiodieselMixtureCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/AgriBiodieselMixtureCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 10c(d),  RenewableDieselMixtureCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/RenewableDieselMixtureCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
					...
					<div class="styIRS4136NumLine" style="float: none; clear: both;"><br/><br/><br/>11
    <span class="styIRS4136NBSP"/>  
    Nontaxable Use of Alternative Fuel 
    <span style="width:182mm;"/><br/>
					</div>
					...
					<div style="width:187mm;float:left;clear:left;" id="14ctn">
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<xsl:if test="($AGRowCount + count($IRS4136Data/BusNontxLiquifiedPetroleumGas)  = 0) or
								 ((count($IRS4136Data/NontxLiquifiedPetroleumGas) + count($IRS4136Data/BusNontxLiquifiedPetroleumGas) &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>a</b>
										</td>
        ...
        <span class="styIRS4136TableCellPad"/>
               ...
               <xsl:call-template name="PopulateAmount">
															...
															<span class="styIRS4136TableCellPad"/>
																			<xsl:call-template name="LinkToLeftoverDataTableInline">
                <xsl:with-param name="Desc">Form 4136 line 11a(d),  NontxLiquifiedPetroleumGasCr/@creditReferenceNumber</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedPetroleumGasCr/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
											...
											<xsl:when test="$AGRowCount = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" 
															select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">$ .183</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
             ...
             <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode"
															 select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/TypeOfUseLiteral"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode"
													...
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode"
															 select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
								...
								<xsl:if test="($AGRowCountb  + count($IRS4136Data/BusNontxPSeriesFuels)  = 0) or 
								((count($IRS4136Data/NontxPSeriesFuels) + count($IRS4136Data/BusNontxPSeriesFuels)  &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>b</b>
										</td>
        ...
        <span class="styIRS4136TableCellPad"/>
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxPSeriesFuels) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																		<xsl:call-template name="LinkToLeftoverDataTableInline">
                <xsl:with-param name="Desc">Form 4136 line 11b(d),  NontxPSeriesFuelsCredit/@creditReferenceNumber</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxPSeriesFuelsCredit/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
              ...
              <span class="styIRS4136TableCellPad"/>
													...
													<xsl:otherwise>
														...
														<td class="styIRS4136TableCellE">
															...
															<xsl:value-of select="$AGRowCountb"/></xsl:attribute>420
              <span class="styIRS4136TableCellPad"/>
														</td>
													</xsl:otherwise>
												</xsl:choose>
										...
										<xsl:choose>
											<xsl:when test="$AGRowCountb = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" 
															select="$IRS4136Data/BusNontxPSeriesFuels/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
														...
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode"
															select="$IRS4136Data/NontxPSeriesFuelsCredit"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellE">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode"
															 select="$IRS4136Data/BusNontxPSeriesFuels/TypeOfUseLiteral"/>
															</xsl:call-template>
														 <span style="width:1mm"/>
														 <xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/TypeOfUse"/>
													...
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
								...
								<xsl:if test="($AGRowCountc  + count($IRS4136Data/BusNontxCompressedNaturalGas)  = 0) or 
								((count($IRS4136Data/NontxCompressedNaturalGas) + count($IRS4136Data/BusNontxCompressedNaturalGas)  &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>c</b>
										</td>
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxCompressedNaturalGas) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																					<xsl:call-template name="LinkToLeftoverDataTableInline">
                <xsl:with-param name="Desc">Form 4136 line 11c(a),  NontxCompressedNaturalGasCr/@creditReferenceNumber</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxCompressedNaturalGasCr/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
										...
										<xsl:choose>
											<xsl:when test="$AGRowCountc = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxCompressedNaturalGas/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxCompressedNaturalGas/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" 
															select="$IRS4136Data/BusNontxCompressedNaturalGas/TypeOfUseLiteral"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxCompressedNaturalGas/TypeOfUse"/>
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLiquifiedHydrogen) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11d(d),  NontxLiquifiedHydrogenCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedHydrogenCredit/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
										...
										<xsl:choose>
											<xsl:when test="$AGRowCountd = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedHydrogen/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedHydrogen/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedHydrogen/TypeOfUseLiteral"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode"
															 select="$IRS4136Data/BusNontxLiquifiedHydrogen/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
								...
								<xsl:if test="($AGRowCounte  + count($IRS4136Data/BusNontxLqfdFuelDerFromCoal)  = 0) or 
								((count($IRS4136Data/NontxLqfdFuelDerivedFromCoal) + count($IRS4136Data/BusNontxLqfdFuelDerFromCoal)  &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>e</b>
										</td>
										<td class="styIRS4136TableCellLine" style="vertical-align:middle;">Any liquid fuel derived from coal (including peat) through the Fischer-Tropsch process
      </td>
										<td class="styIRS4136TableCellA">
											<span class="styIRS4136TableCellPad"/>
										</td>
										...
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
											<xsl:if test=" ((count($IRS4136Data/NontxLqfdFuelDerivedFromCoal) + count($IRS4136Data/BusNontxLqfdFuelDerFromCoal)  &gt; 1) and ($Print = $Separated))">
												<xsl:attribute name="style">text-align:left;</xsl:attribute>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<!-- Adding check for the SRD -->
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/NontxLqfdFuelDerivedFromCoal) + count($IRS4136Data/BusNontxLqfdFuelDerFromCoal)  &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/NontxLqfdFuelDerivedFromCoal">
										<tr>
											<xsl:if test="position()=1">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLqfdFuelDerFromCoal) = 1)">
														<td class="styIRS4136TableCellLine" style="vertical-align:middle;border-bottom:0;">
															<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCounte"/></xsl:attribute>Any liquid fuel derived from coal (including peat) through the Fischer-Tropsch process
        </td>
													</xsl:when>
													<xsl:otherwise>
														<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLqfdFuelDerFromCoal) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																	<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11e(d), NontxLqfdFuelDerivedFromCoalCr /@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLqfdFuelDerivedFromCoalCr/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
              ...
              <span class="styIRS4136TableCellPad"/>
									...
									<!-- ====================================================================== -->
									<xsl:if test="count($IRS4136Data/BusNontxLqfdFuelDerFromCoal) = 1">
										<br/>
										<xsl:choose>
											<xsl:when test="$AGRowCounte = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.243</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
													<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/TypeOfUseLiteral"/>
														</xsl:call-template>
													<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode"
															 select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.243</td>
								...
								<xsl:if test="($AGRowCountf  + count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass)  = 0) or ((count($IRS4136Data/NontxLiqHydrcrbnsDerBiomass) + count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass)  &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>f</b>
										</td>
										...
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
											<xsl:if test=" ((count($IRS4136Data/NontxLiqHydrcrbnsDerBiomass) + count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass)  &gt; 1) and ($Print = $Separated))">
												<xsl:attribute name="style">text-align:left;</xsl:attribute>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<!-- Adding check for the SRD -->
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/NontxLiqHydrcrbnsDerBiomass) + count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass)  &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/NontxLiqHydrcrbnsDerBiomass">
										<tr>
											<xsl:if test="position()=1">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass) = 1)">
														<td class="styIRS4136TableCellLine" style="vertical-align:middle;border-bottom:0;">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																		<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11f(d),  NontxLiqHydrcrbnsDerBiomassCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiqHydrcrbnsDerBiomassCr/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
              ...
              <span class="styIRS4136TableCellPad"/>
									...
									<!-- ====================================================================== -->
									<xsl:if test="count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass) = 1">
										<br/>
										<xsl:choose>
											<xsl:when test="$AGRowCountf = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.243</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUseLiteral"/>
														</xsl:call-template>
													<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUse"/>
								...
								<xsl:if test="($AGRowCountg  + count($IRS4136Data/BusNontxLiquifiedNaturalGas)  = 0) or ((count($IRS4136Data/NontxLiquifiedNaturalGas) &gt; 1) + count($IRS4136Data/BusNontxLiquifiedNaturalGas)  and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>g</b>
										</td>
										...
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
											<xsl:if test=" ((count($IRS4136Data/NontxLiquifiedNaturalGas) + count($IRS4136Data/BusNontxLiquifiedNaturalGas) &gt; 1) and ($Print = $Separated))">
												<xsl:attribute name="style">text-align:left;</xsl:attribute>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<!-- Adding check for the SRD -->
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/NontxLiquifiedNaturalGas) + count($IRS4136Data/BusNontxLiquifiedNaturalGas)  &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/NontxLiquifiedNaturalGas">
										<tr>
											<xsl:if test="position()=1">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLiquifiedNaturalGas) = 1)">
														<td class="styIRS4136TableCellLine" style="vertical-align:middle;border-bottom:0;">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusNontxLiquifiedNaturalGas) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																	<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11g(d),  NontxLiquifiedNaturalGasCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedNaturalGasCredit/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
              ...
              <span class="styIRS4136TableCellPad"/>
									...
									<!-- ====================================================================== -->
									<xsl:if test="count($IRS4136Data/BusNontxLiquifiedNaturalGas) = 1">
										<br/>
										<xsl:choose>
											<xsl:when test="$AGRowCountg = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.243</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
              ...
              <span class="styIRS4136TableCellPad"/>
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUseLiteral"/>
														</xsl:call-template>
														<span style="width:1mm"/>
															<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUse"/>
								...
								<xsl:if test="($AGRowCounth + count($IRS4136Data/BusLiquefiedGasBiomass)  = 0) or ((count($IRS4136Data/LiquefiedGasBiomass) + count($IRS4136Data/BusLiquefiedGasBiomass)  &gt; 1)  and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:4mm;padding-right:1.5mm;">
											<b>h</b>
										</td>
										...
										<td class="styIRS4136TableCellC" style="text-align:left;">
											<span class="styIRS4136TableCellPad"/>
											<xsl:if test=" ((count($IRS4136Data/LiquefiedGasBiomass) + count($IRS4136Data/BusLiquefiedGasBiomass)  &gt; 1) and ($Print = $Separated))">
												<xsl:attribute name="style">text-align:left;</xsl:attribute>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
        ...
        <span class="styIRS4136TableCellPad"/>
								...
								<!-- Adding check for the SRD -->
								<xsl:if test="($Print != $Separated) or (count($IRS4136Data/LiquefiedGasBiomass) + count($IRS4136Data/BusLiquefiedGasBiomass) &lt;= 1) ">
									<xsl:for-each select="$IRS4136Data/LiquefiedGasBiomass">
										<tr>
											<xsl:if test="position()=1">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusLiquefiedGasBiomass) = 1)">
														<td class="styIRS4136TableCellLine" style="vertical-align:middle;border-bottom:0;">
												...
												<xsl:choose>
													<xsl:when test="(count($IRS4136Data/BusLiquefiedGasBiomass) = 1)">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<span class="styIRS4136TableCellPad"/>
																			<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11h(d),  LiquefiedGasBiomassCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquefiedGasBiomassCredit/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
              ...
              <span class="styIRS4136TableCellPad"/>
									...
									<!-- ====================================================================== -->
									<xsl:if test="count($IRS4136Data/BusLiquefiedGasBiomass) = 1">
										<br/>
										<xsl:choose>
											<xsl:when test="$AGRowCounth = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusLiquefiedGasBiomass/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="MaxSize" select="9"/>
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusLiquefiedGasBiomass/Gallons"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellD">
											...
											<xsl:otherwise>
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" 
															select="$IRS4136Data/BusLiquefiedGasBiomass/TypeOfUseLiteral"/>
														</xsl:call-template>
														<span style="width:1mm"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" 
															select="$IRS4136Data/BusLiquefiedGasBiomass/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;">.183</td>
    ...
    Alternative Fuel Credit and Alternative Fuel Mixture Credit <br/>
						...
						<table class="styIRS4136Table" cellspacing="0">
							<thead class="styIRS4136TableThead">
								<tr>
									...
									<th class="styIRS4136TableCellC" style="text-align: center"><b>(c) Gallons or gasoline gallon equivalents (GGE)</b>
									</th>
									<th class="styIRS4136TableCellD" style="text-align: center"><b>(d) Amount of credit</b>
									</th>
									<th class="styIRS4136TableCellE" style="text-align: center"><b>(e) CRN</b>
							...
							<tbody>
								...
								<tr>
									...
									<xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12a(d),  LiquifiedPetroleumGasCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedPetroleumGasCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:5mm;"> .50</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="9"/>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12b(d),  PSeriesFuelsCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/PSeriesFuelsCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12c(d),  CompressedNaturalGasCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/CompressedNaturalGasCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
                  ...
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedHydrogenCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<!--  Row 12e  -->
								<tr>
									<td class="styIRS4136LetterCell" style="padding-bottom:4mm;"><b>e</b>
									</td>
									...
									<td class="styIRS4136TableCellD">
										...
										<span class="styIRS4136TableCellPad"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12e(d),  LiquifiedFuelDerivedFromCoalCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedFuelDerivedFromCoalCr/@creditReferenceNumber"/>
              </xsl:call-template>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<span class="styIRS4136TableCellPad"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12f(d),  LiqHydrcrbnsDerFromBiomassCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiqHydrcrbnsDerFromBiomassCr/@creditReferenceNumber"/>
              </xsl:call-template>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellD">
										...
										<span class="styIRS4136TableCellPad"/>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12g(d),  LiquifiedNaturalGasCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedNaturalGasCredit/@creditReferenceNumber"/>
              </xsl:call-template>
									</td>
								...
								<xsl:if test="$AGRowCount12h = 0 or ((count($IRS4136Data/LiqfdGasBiomass) &gt; 1) and ($Print = $Separated))">
									<tr>
										...
										<td class="styIRS4136TableCellD">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12h(d),  LiqfdGasBiomassCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiqfdGasBiomassCredit/@creditReferenceNumber"/>
              </xsl:call-template>
											<span class="styIRS4136TableCellPad"/>
										</td>
										<td class="styIRS4136TableCellE">436
        <span class="styIRS4136TableCellPad"/>
										</td>
									</tr>
								</xsl:if>
									...
									<xsl:for-each select="$IRS4136Data/LiqfdGasBiomass">
										<tr>
											<xsl:if test="position()=1">
												...
												<td class="styIRS4136TableCellLine" style="vertical-align:middle;">
													<xsl:attribute name="rowspan"><xsl:value-of select="$AGRowCount12h"/></xsl:attribute>Liquified gas derived from biomass
                         </td>
											</xsl:if>
											<td class="styIRS4136TableCellB" style="padding-left:5mm;"> .50</td>
											<td class="styIRS4136TableCellC">
                  ...
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/LiqfdGasBiomassCredit/@creditReferenceNumber"/>
                         ...
                         <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="$AGRowCount12i = 0 or ((count($IRS4136Data/CompressedGasBiomass) &gt; 1) and ($Print = $Separated))">
									<tr>
										<td class="styIRS4136LetterCell" style="vertical-align:middle;padding-left:3mm;">
											<b>i</b>
										</td>
										...
										<td class="styIRS4136TableCellD">
											<span class="styIRS4136TableCellPad"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 12i(d),  CompressedGasBiomassCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/CompressedGasBiomassCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										</td>
										<td class="styIRS4136TableCellE">437
        <span class="styIRS4136TableCellPad"/>
										</td>
									</tr>
								</xsl:if>
                  ...
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/CompressedGasBiomassCredit/@creditReferenceNumber"/>
						...
						<span style="width:8mm"/>*See instructions for possible rate changes. 
          </div>
					<!--   END LINE 12   -->
					<!--   BEGIN BLOCK 13   -->
					<!--BEGIN FOOTER-->
					...
					<div class="styIRS4136NumLine" style="float: none; clear: both">
						<br/>13
    <span class="styIRS4136NBSP"/>Registered Credit Card Issuers<br/>
						<span style="padding-left:6.5mm;">Registration No.</span>
                  ...
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneSoldCredit/@creditReferenceNumber"/>
								...
								<tr>
									...
									<td class="styIRS4136TableCellB" style="padding-left:6mm;padding-top:3mm;">.218*</td>
									<td class="styIRS4136TableCellC" style="padding-top:3mm;">
										...
										<span class="styIRS4136TableCellPad"/>
										   <xsl:call-template name="LinkToLeftoverDataTableInline">
                <xsl:with-param name="Desc">Form 4136 line 13c(c),  AviationKeroseneGallons/@taxedAt244Indicator</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationKeroseneGallons/@taxedAt244Indicator"/>
              </xsl:call-template>
									</td>
									<td class="styIRS4136TableCellD" style="padding-top:4mm;">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 13c(d),  AviationKeroseneCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationKeroseneCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
          ...
          *See instructions for possible rate changes.</div>
					<!--   END LINE 13   -->
					<!--   BEGIN BLOCK 14   -->
					<!--   BEGIN LINE 14   -->
					<xsl:variable name="Line14aCount" select="count($IRS4136Data/NontxUseDieselWaterEmulsion)"/>
					<div style="width:187mm;"/>
					<div class="styIRS4136NumLine" style="float:none;clear:both;border-bottom-width: 0px">14
    <span class="styIRS4136NBSP">
							<br/>
        ...
        <span style="font-weight:normal">
					...
					<div style="width:187mm;border-top:solid black 1;font-size:6pt;padding-top:1mm;border-top-width:1px;">
						<div class="styGenericDiv" style="padding-left:8mm"><b>Caution.</b>There is a reduced credit rate for use in certain intercity and local buses (type of use 5) (see instructions).
            </div>
                  ...
                  width:3mm;height:4mm;">
									...
									<th class="styIRS4136TableCellC" style="text-align: center;border-top-width:1px;width:32mm"><b>(c) Gallons</b>
									</th>
									<th class="styIRS4136Braces" style="border-top-width:1px;">
										<span class="styIRS4136TableCellPad"/>
									</th>
      ...
      <span class="styIRS4136TableCellPad"/>
								...
								<xsl:if test="($Line14aCount  + count($IRS4136Data/BusNontxUseDieselWtrEmulsion)) =1 or (($Line14aCount  + count($IRS4136Data/BusNontxUseDieselWtrEmulsion) &gt;1)  and ($Print != $Separated))">
									<xsl:for-each select="$IRS4136Data/NontxUseDieselWaterEmulsion">
										<tr>
											<xsl:if test="position()=1">
												<td class="styIRS4136LetterCell" style="padding-bottom:10mm;">
												...
												<xsl:choose>
													<xsl:when test="count($IRS4136Data/BusNontxUseDieselWtrEmulsion) =1">
														<td class="styIRS4136TableCellLine" style="padding-bottom:10mm;border-bottom:0;">
												...
												<xsl:choose>
													<xsl:when test="count($IRS4136Data/BusNontxUseDieselWtrEmulsion) =1">
														<td class="styIRS4136TableCellD" style="border-bottom:0;">
															...
															<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 14a(d),  NontxUseDieselWaterEmulsionCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxUseDieselWaterEmulsionCr/@creditReferenceNumber"/>
              </xsl:call-template>
														</td>
														<td class="styIRS4136TableCellE" style="border-bottom:0;">
										...
										<xsl:choose>
											<xsl:when test="$Line14aCount = 0">
												<tr>
													...
													<td class="styIRS4136TableCellA">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedPetroleumGas/TypeOfUse"/>
														</xsl:call-template>
														<span class="styIRS4136TableCellPad"/>
													</td>
													<td class="styIRS4136TableCellB" style="padding-top:1mm;">
													...
													<td class="styIRS4136TableCellC">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/Gallons"/>
														</xsl:call-template>
													</td>
													<td class="styIRS4136Braces">
														<span class="styIRS4136TableCellPad"/>
...
================================================================ -->
								...
								<td class="styIRS4136TableCellB" style="padding-left:2mm;text-align:center;padding-top:3mm;">.198
        <span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136TableCellC" style="text-align:right;padding-top:2mm;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="MaxSize" select="19"/>
										<xsl:with-param name="TargetNode" 
										select="$IRS4136Data/ExpNontxUseDieselWaterEmlsn"/>
									</xsl:call-template>
									<span class="styIRS4136TableCellPad"/>
								</td>
								<td class="styIRS4136Braces">
								...
								<td class="styIRS4136TableCellD" style="text-align:right;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="MaxSize" select="19"/>
										<xsl:with-param name="TargetNode"
										 select="$IRS4136Data/ExpNontxUseDieselWaterEmlsnCr"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 14b(d),  ExpNontxUseDieselWaterEmlsnCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExpNontxUseDieselWaterEmlsnCr/@creditReferenceNumber"/>
              </xsl:call-template>
									<span class="styIRS4136TableCellPad"/>
								</td>
								...
								<tr>
									...
									<xsl:call-template name="PopulateAmount">
										...
										<span class="styIRS4136TableCellPad">
											...
											<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 15(d),  BlenderCrUseDieselWaterEmlsnCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/BlenderCrUseDieselWaterEmlsnCr/@creditReferenceNumber"/>
              </xsl:call-template>
										</span>
									</td>
  ...
  <div style="width187mm'">
          ...
          $<xsl:call-template name="PopulateAmount">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 16a(a),  ExportedDyedDieselFuelCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedDyedDieselFuelCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellC" style="width=32mm">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="MaxSize" select="19"/>
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/ExportedDyedKeroseneGallons"/>
										</xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td class="styIRS4136TableCellD" style="width=32mm">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11b(a),  ExportedDyedKeroseneCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedDyedKeroseneCredit/@creditReferenceNumber"/>
              </xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
					...
					<div class="styBB" style="width:187mm;font-size:7pt;float:none;clear:both;">
						...
						<div class="styGenericDiv" style="width:129.7mm;height:11mm;padding-left:5px;padding-top:3px;">
							<b>Total income tax credit claimed. </b>Add lines 1 through 16, column (d). Enter here and on Form 1040, line 70; Form 1120, line 32f(2); Form 1120S, line
        ...
        <span style="padding-left:2mm">
          ...
          <xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2010)
  </div>
					</div>
					<!--   END FORM FOOTER   -->
					<!-- <br/>
      <div class="pageEnd"></div> -->
              ...
              <xsl:with-param name="Desc"> Line 1a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseOfGasolineCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 1d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedNontaxableUseOfGasCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
               	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 2a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationGasolineCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 2b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableAviationGasolineCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 2c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExpNontaxableAviationGasCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                 	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 2d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LUSTTaxAviationFuelCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 3a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxUseFarmUndyedDslFuelCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                    	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 3c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/TrainUseOfUndyedDieselCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                        	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 3d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UseOfUndyedDieselInBusesCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
           	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 3e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedUndyedDieselFuelCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
     <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 4a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedKeroseneForFarmingCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                                	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 4c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UseOfUndyedKeroseneCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
		                  	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 4d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedUndyedKeroseneCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                          	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 4e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt044Credit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                           	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 4f(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt219Credit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                            	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 5a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneTaxedAt244Credit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                          	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 5b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneTaxedAt219Credit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                        	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 5c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt244Cr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                        	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 5d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt219Cr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                      	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 5e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LUSTTaxAvnFuelCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                    	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 6a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/StateLocalGovtDieselCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                    	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 6b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedDieselFuelBusesCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                  	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 7a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneSoldBlockedPumpCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 7b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UseInCertainBusesCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UseCmrclAviation219KeroseneCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/UseCmrclAviation244KeroseneCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                  	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NonexemptUseNonCmrclAviationCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                     	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/OtherNontaxableUseTaxedAt244Cr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                    	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/OtherNontaxableUseTaxedAt219Cr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                       	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 8f(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LUSTTxAviationFuelCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                        	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 9a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AlcoholFuelMixtureEthanolCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                         	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 9b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AlcoholFuelMixtureAlcoholCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                       	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 10a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/BiodieselMixtureCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 10b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AgriBiodieselMixtureCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                   	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 10c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/RenewableDieselMixtureCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
					 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedPetroleumGasCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxPSeriesFuelsCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxCompressedNaturalGasCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                  <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedHydrogenCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
              <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLqfdFuelDerivedFromCoalCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11f(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiqHydrcrbnsDerBiomassCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11g(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxLiquifiedNaturalGasCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 11h(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquefiedGasBiomassCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
          <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedPetroleumGasCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/PSeriesFuelsCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
               <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/CompressedNaturalGasCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12d(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedHydrogenCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
              <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12e(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedFuelDerivedFromCoalCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
           <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12f(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiqHydrcrbnsDerFromBiomassCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
               <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12g(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiquifiedNaturalGasCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12h(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/LiqfdGasBiomassCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 12i(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/CompressedGasBiomassCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 13a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/DieselFuelSoldCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
                <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 13b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/KeroseneSoldCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
					 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 13c(C) taxedAt244Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationKeroseneGallons/@taxedAt244Indicator"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            		 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 13c(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/AviationKeroseneCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 14a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxUseDieselWaterEmulsionCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>       
              </xsl:call-template>
              <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 14b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExpNontxUseDieselWaterEmlsnCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>       
              </xsl:call-template>
               <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 15(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/BlenderCrUseDieselWaterEmlsnCr/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>       
              </xsl:call-template>	
            	 <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 16a(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedDyedDieselFuelCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>       
              </xsl:call-template>	
               <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc"> Line 16b(d) creditReferenceNumber</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$IRS4136Data/ExportedDyedKeroseneCredit/@creditReferenceNumber"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
					</table>
					...
					<xsl:if test="($Print = $Separated) and  ($AFRowCount &gt; 1) ">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="text-align: center;width:16mm;border-left-width:0px;"><b>(a) Type of use</b>
									</th>
									<th class="styDepTblCell" style="text-align: center;width:13mm;"><b>(b) Rate</b>
									</th>
									<th class="styDepTblCell" style="text-align: center;width:32mm;border-right-width:0px;"><b>(c) Gallons</b>
									</th>
									<th class="styDepTblCell" style="text-align: center;width:32mm;"><b>(d) Amount of credit</b>
									</th>
									<th class="styDepTblCell" style="text-align: center;width:9mm;"><b>(e) CRN</b>
									</th>
								</tr>
							</thead>
							<tfoot/>
									...
									<tr>
										...
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="width:77mm;vertical-align:top;border-left-width:0px;text-align:left;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$AFRowCount"/></xsl:attribute>Other nontaxable use of gasoline (see <b>Caution</b> above line 1)
            </td>
										</xsl:if>
                      ...
                      <xsl:call-template name="PopulateAmount">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 1c(d),  NontaxableUseOfGasolineCredit/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseOfGasolineCredit/@creditReferenceNumber"/>
              </xsl:call-template>
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:16mm;"><b>(a) Type of use</b>
									</th>
									<th class="styDepTblCell" style="width:13mm;"><b>(b) Rate</b>
									</th>
									<th class="styDepTblCell" style="width:32mm;border-right-width:0px;"><b>(c) Gallons</b>
									</th>
									<th class="styDepTblCell" style="width:32mm;"><b>(d) Amount of credit</b>
									</th>
									<th class="styDepTblCell" style="width:9mm;"><b>(e) CRN</b>
									</th>
								</tr>
							</thead>
							<tfoot/>
  ...
  <span style="font-weight:normal">(see </span>
            ...
            <span class="styIRS4136TableCellPad"/>
										...
										<xsl:if test="position()=1">
											<td class="styDepTblCell" style="text-align:right;border-right:1 solid black;vertical-align:top;">
												...
												<xsl:call-template name="PopulateAmount">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 1c(d),  NontaxableUseTaxedAt244Cr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontaxableUseTaxedAt244Cr/@creditReferenceNumber"/>
              </xsl:call-template>
												<span class="styIRS4136TableCellPad"/>
											</td>
              ...
              <span class="styIRS4136TableCellPad"/>
					...
					<xsl:if test="(count($IRS4136Data/NontaxableUseTaxedAt219) &gt;1) and ($Print = $Separated)">
						<span class="styRepeatingDataTitle">Form 4136, Line 5 - Kerosene Used in Aviation
  <span style="font-weight:normal">(see </span><b>Caution </b>
							<span style="font-weight:normal">above line 1)</span>
						</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
            ...
            <span class="styIRS4136TableCellPad"/>
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxPSeriesFuels/TypeOfUse"/>
					...
					<xsl:if test="(count($IRS4136Data/NontxCompressedNaturalGas) &gt;1) and ($Print = $Separated)">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								count($IRS4136Data/BusNontxCompressedNaturalGas)"/>
								<xsl:for-each select="$IRS4136Data/NontxCompressedNaturalGas">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
										...
										<xsl:if test="position()=1">
											<td class="styDepTblCell" style="text-align:right;border-right:1 solid black;vertical-align:top;">
												...
												<xsl:call-template name="PopulateAmount">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
                  <xsl:with-param name="Desc">Form 4136 line 11c(d),  NontxCompressedNaturalGasCr/@creditReferenceNumber</xsl:with-param>
                  <xsl:with-param name="TargetNode" select="$IRS4136Data/NontxCompressedNaturalGasCr/@creditReferenceNumber"/>
              </xsl:call-template>
												<span class="styIRS4136TableCellPad"/>
											</td>
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxCompressedNaturalGas/TypeOfUse"/>
										</xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td style="border-bottom:1 solid black;padding-top:2mm;">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								<xsl:variable name="UKRowCount8" select="count($IRS4136Data/NontxLiquifiedHydrogen) +
								 count($IRS4136Data/BusNontxLiquifiedHydrogen)"/>
								<xsl:for-each select="$IRS4136Data/NontxLiquifiedHydrogen">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxLiquifiedHydrogen/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxLiquifiedHydrogen/TypeOfUse"/>
					...
					<xsl:if test="(count($IRS4136Data/NontxLqfdFuelDerivedFromCoal) &gt;1) and ($Print = $Separated)">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								count($IRS4136Data/BusNontxLqfdFuelDerFromCoal)"/>
								<xsl:for-each select="$IRS4136Data/NontxLqfdFuelDerivedFromCoal">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
											...
											<td class="styDepTblCell" style="vertical-align:top;border-left-width:0px;text-align:left;width:77mm;border-right-width:1px;">
												<xsl:attribute name="rowspan"><xsl:value-of select="$UKRowCount8"/></xsl:attribute>Any liquid fuel derived from coal (including peat) through the Fischer-Tropsch process
            </td>
										</xsl:if>
										<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
											<xsl:call-template name="PopulateText">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											 select="$IRS4136Data/BusNontxLqfdFuelDerFromCoal/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
											<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
					...
					<xsl:if test="(count($IRS4136Data/NontxLiqHydrcrbnsDerBiomass) &gt;1) and ($Print = $Separated)">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								count($IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass)"/>
								<xsl:for-each select="$IRS4136Data/NontxLiqHydrcrbnsDerBiomass">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxLiqHydrcrbnsDerBiomass/TypeOfUse"/>
										</xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td style="border-bottom:1 solid black;padding-top:2mm;">
					...
					<xsl:if test="(count($IRS4136Data/NontxLiqHydrcrbnsDerBiomass) &gt;1) and ($Print = $Separated)">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								count($IRS4136Data/BusNontxLiquifiedNaturalGas)"/>
								<xsl:for-each select="$IRS4136Data/NontxLiquifiedNaturalGas">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode
											" select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxLiquifiedNaturalGas/TypeOfUse"/>
										</xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
										<span class="styIRS4136TableCellPad"/>
									</td>
            ...
            Form 4136, Line 11 - Liquified gas derived from biomass</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							...
							<tbody>
								...
								count($IRS4136Data/BusLiquefiedGasBiomass)"/>
								<xsl:for-each select="$IRS4136Data/LiquefiedGasBiomass">
									<tr>
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<xsl:if test="position()=1">
            ...
            <span class="styIRS4136TableCellPad"/>
              ...
              <span class="styIRS4136TableCellPad"/>
								...
								<tr>
									...
									<td class="styDepTblCell" style="border:1 solid black;border-left-width:1px;width:16mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/TypeOfUseLiteral"/>
										</xsl:call-template>
										<span style="width:1mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$IRS4136Data/BusNontxUseDieselWtrEmulsion/TypeOfUse"/>
										</xsl:call-template>
										<span class="styIRS4136TableCellPad"/>
									</td>
									<td style="border-bottom:1 solid black;padding-top:2mm;">

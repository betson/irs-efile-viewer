            ...
            <table cellspacing="0" summary="Boycott Information for each country">
              ...
              <tr>
                <td class="styTableCell" colspan="2"
                 style="width:50mm;text-align:left;font-weight:bold;font-size:7pt;border-color:black;
                 border-bottom-width:0px;border-right-width:1px;">Total    
                      <!--dotted line-->
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none">
              ...
              <div class="styLNDesc" style="width:93.6mm;padding-top:2mm;">
                <br/>Total sales to or from countries other than United States   
                  <!--Dotted Line-->
         <span style="letter-spacing:4mm;font-weight:bold">.</span>
              </div>
            </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none">
              <div class="styLNLeftLtrBox" style="height:4.5mm;font-size:7pt;">
                <br/>c</div>
              <div class="styLNDesc" style="width:93.6mm;padding-top:2mm;">
                <br/>Total payroll paid or accrued for services performed in countries other than United States 
                  <!--Dotted Line-->
         <span style="letter-spacing:4mm;font-weight:bold">...............</span>
              </div>
            </div>
            <div style="float:right;clear:none">
              <div class="styLNAmountBox" style="border-top-width:0px;font-size:7pt;width:42.3mm;height:13mm;padding-top:3mm">
                <br/>
                <span style="height: 6mm;">&#160;</span>
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form5713AData/TotalPayrollPaidInOtherThanUS"/>
                </xsl:call-template>
              </div>
              <div class="styShadingCell" style="height:13mm;width:42.3mm;"/>
            </div>
          </div>
          <!-- Item 2c end-->
              <div style="width:187mm;">

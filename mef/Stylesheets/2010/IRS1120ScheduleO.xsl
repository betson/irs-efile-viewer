  ...
  <xsl:template match="/">
    ...
    <html>
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styTYBox" style="width:30mm;border-left-width:2px;">
              ...
              <div class="styOMBNBB" >
               ...
               <div class="styTY" style="height:14mm;">2010
      ...
      Name <br/>
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" alt="alt" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleO/TermCurrApportionPlanElected"/>
					<xsl:with-param name="BackupName" select="Form1120ScheduleO/TermCurrApportionPlanElected"/>
                  </xsl:call-template>
                </input>
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <xsl:call-template name="PopulateSpan">
                  ...
                  select="$Form1120ScheduleO/TermCurrApportionPlanRequired"/>
        ...
        Check the applicable box(es) (see instructions).
         ...
         The corporation has a short tax year that does not include December 31.
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div style="width:35mm;float:left;">Cat. No. 48100N</div>

            <div class="styBoldText" style="float:right;">Schedule O (Form 1120)(2010)</div>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="float:left;">Schedule O (Form 1120) (2010)</div>
	...
	or the comparable line</i>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="float:left;">Schedule O (Form 1120) (12-2010)</div>

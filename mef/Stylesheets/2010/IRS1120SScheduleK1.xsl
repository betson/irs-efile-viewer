	...
	<xsl:template name="DisplayPart3CodeAmountLine">
		...
		<xsl:choose>
			...
			<xsl:when test="($Print != $Separated) or (count($TargetNode) &lt;= $NumOfTotalRows) ">
			  	 <xsl:for-each select="$TargetNode">
					<span class="IRS1120SScheduleK1_codeCell">
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="Code"/>
						</xsl:call-template>
					</span>
					<span class="IRS1120SScheduleK1_amountCell">
					  <xsl:call-template name="PopulateAmount">
						  <xsl:with-param name="TargetNode" select="Amount"/>
					  </xsl:call-template>
					</span>
			...
			<xsl:otherwise>
				<span class="IRS1120SScheduleK1_codeCell" style="border-bottom:1px solid lightgrey;"/>
				<span class="IRS1120SScheduleK1_amountCell" style="text-align:left;padding-left:1px;border-bottom:1px solid lightgrey;">
...
<!-- This template is the same as DisplayPart3CodeAmountLine with additional display of the pushpin in the amount field. -->
				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right; width: 186mm;">671110</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
                      ...
                      <xsl:with-param name="TargetNode" select="$FormData/FinalK1"/>
									...
									<input type="checkbox" class="styCkbox" alt="alt" name="checkbox" id="dummyID2" onclick="return false;">
										<!-- No schema data to match this checkbox -->
										<!--
                                              <xsl:call-template name="PopulateCheckbox">
                                                <xsl:with-param name="TargetNode" select="$FormData/NOTHING"/>
                                              </xsl:call-template>
                                        -->
									</input>
									<span style="vertical-align: bottom;">Amended K-1</span>
                  <span style="width: 11mm;"/>
									  OMB No. 1545-0130</span>
							        </span>
						</td>
					</tr>
					<tr>
     ...
     <xsl:call-template name="SetFormLinkInline">
       <xsl:with-param name="TargetNode" select="$FormData"/>
             ...
             Shareholder's percentage of stock<br/>
										...
										<span style="float: left; clear: none;">ownership for tax year
               <!--Dotted Line-->
                 ...
                 <span style="width:16px;"/>.
					...
					<!-- Line 7 -->
                        ...
                        <td colspan="3" class="IRS1120SScheduleK1_tdRight">
													<!-- Line 8c -->
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;width:5.3mm;">8c</span>
														<span style="width:1mm"/>
														<span style="font-size: 6pt;">Unrecaptured section 1250 gain</span>
														<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="width:5.3mm;"/>
														<span class="IRS1120SScheduleK1_amountBox" style="text-align:right;w">
                        ...
                        <td colspan="3" class="IRS1120SScheduleK1_tdRight">
							<!-- Line 9 -->
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align: center;width:5.4mm;">9</span>
														<span style="width:1mm"/>Net section 1231 gain (loss)
														<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="width:5.4mm;"/>
															<span class="IRS1120SScheduleK1_amountBox" style="text-align:right;">
															<span style="float:left;padding-left:2px;">
														    <xsl:call-template name="SetFormLinkInline">
				...
				<!-- Line 10 -->
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;width:5.4mm;">10</span>
														<span style="width:1mm"/>Other income (loss)<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="border-bottom-width:0px;width:5.4mm;"/>
                            <span class="IRS1120SScheduleK1_amountBox" style="border-bottom-width:0px;width:5.4mm;"/>
					...
					<!-- Line 11 -->
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight" style="height:4mm;">
													<div style="width:46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;width:5.4mm;">11</span>
														...
														<xsl:if test="count($FormData/Section179ExpenseDeduction) = 0 ">
															<span class="IRS1120SScheduleK1_codeBox" style="border-bottom:0px;margin-top:0mm;"/>
	...
	<!-- Line 12 -->
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;width:5.4mm;">12</span>
														<span style="width:1mm"/>Other deductions<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="border-bottom:0px;margin-top:0mm;width:5.4mm;"/>
														<span class="IRS1120SScheduleK1_amountBox" style="border-bottom:0px;margin-top:0mm;"/>
														<br/>
														<xsl:call-template name="DisplayPart3CodeAmountAddlDataLine">
...
<!-- Part III columns 13-17 -->								
                      ...
                      <tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;">13</span>
                            <span style="width:1mm;"/>
														Credits<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="height:4mm;border-top:0px;"/>
							...
							<!-- Line 14 -->					
											<tr>
												<td colspan="4" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;">14</span>Foreign transactions<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="height: 1mm;text-align:center; "/>
  ...
  <span style="width:4.4mm;float:left;">
					...
					<span  style="width:32mm;float:right;text-align:right;"><xsl:call-template name="PopulateAmount">
                                      <xsl:with-param name="TargetNode" select="Amount"/>
                                    </xsl:call-template></span>
				     </td>
				    <!-- <td style="width:32mm;float:right;font-size:7pt;border-bottom:1px solid lightgrey;padding-top:4mm;text-align:right;background-color:lightgreen;">
			...
			<xsl:call-template name="AddBlankFillerRows">
				...
				<xsl:with-param name="CurrentRowCount" select="1"/>
                      ...
                      <tr>
                        <td colspan="3" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;">15</span>
				...
				<!-- Line 16 -->
                        ...
                        <td colspan="3" class="IRS1120SScheduleK1_tdRight">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;">16</span>
                      ...
                      <tr>
                        <td colspan="3" class="IRS1120SScheduleK1_tdRight" style="border-bottom:1px solid lightgrey;">
													<div style="width: 46.5mm;">
														<span class="IRS1120SScheduleK1_itemLabel" style="text-align:center;">17</span>Other  information<br/>
														<span class="IRS1120SScheduleK1_codeBox" style="height: 1mm;text-align:center; "/>
														<span class="IRS1120SScheduleK1_amountBox" style="height: 1mm;"/>
													<br/>
								                              </div>
            ...
            * See attached statement for additional information.
					...
					<tr>
						<td width="189mm" colspan="2" style="width: 189mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 2px solid black;">
							...
							<span style="width: 43mm;">Schedule K-1 (Form 1120S) 2010</span>
						</td>
					</tr>
				</table>

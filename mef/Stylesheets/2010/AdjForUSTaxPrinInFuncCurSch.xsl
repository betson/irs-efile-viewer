...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <table id="GeneralDependencyTbl" class="styDepTbl">
    ...
    <tr>
      <xsl:attribute name="class">
        <xsl:choose>
          <xsl:when test="count($DependencyData/AdjForUSTaxPrinInFuncCur) mod 2 = 1">styDepTblRow2</xsl:when>
      ...
      <td class="styDepTblCell" style="text-align:right;font-size:7pt;width:93.5mm">
        <xsl:call-template name="PopulateAmount">

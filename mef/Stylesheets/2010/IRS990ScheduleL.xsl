...
Complete if the organization answered <br/>"Yes" on Form 990, Part IV,
		 lines 25a, 25b, 26, 27, 28a, 28b, or 28c, <br/>or Form 990-EZ, Part V lines 38a or 40b.<br/>
          <img src="{$ImagePath}/990SchL_Bullet_Md.gif" alt="MediumBullet"/>
...
Complete if the organization answered "Yes" on Form 990, Part IV, line 25a or 25b, or Form 990-EZ, Part V, line 40b.
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/DQPTable) &lt;= 6">
									<xsl:for-each select="$FormData/DQPTable">
										<tr>
											<td class="styTableCellCtr" style="width:85mm;padding-right:0.75mm;border-left:0px;vertical-align:top;text-align:left">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
											...
											<td class="styTableCellCtr" style="width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:0px;">
            ...
            (($Print = $Separated) and (count($FormData/DQPTable) &gt;6)) ">
									<tr>
										<td class="styTableCellCtr" style="width:85mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-left:1px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/DQPTable/NamePerson"/>
											</xsl:call-template>
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="width:85mm;vertical-align:bottom;padding-right:0.75mm;border-left:1px">
											<span style="width:3px"/>
										</td>
        ...
        Complete if the organization answered "Yes" on Form 990, Part IV, line 26, or Form 990-EZ, Part V, line 38a.
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/LoanTable) &lt;11">
									<xsl:for-each select="$FormData/LoanTable">
										<tr>
											<td class="styTableCellCtr" style="width:61mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
													<xsl:when test="NamePerson">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="NamePerson"/>
            ...
            (($Print = $Separated) and (count($FormData/LoanTable) &gt;11)) ">
									<tr>
								...
								<xsl:if test="count($FormData/LoanTable) &lt; 2 or ((count($FormData/LoanTable) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 3 or ((count($FormData/LoanTable) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 4 or ((count($FormData/LoanTable) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 5 or ((count($FormData/LoanTable) &gt;11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoanTable) &lt; 6 or ((count($FormData/LoanTable) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<tr>
         ...
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
					...
					<div class="styTableContainerNBB" id="OActn" style="height:25mm;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/Form990ScheduleLPartIII) &lt;= 11">
									<xsl:for-each select="$FormData/Form990ScheduleLPartIII">
										<tr>
											<td class="styTableCellCtr" style="width:62mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
            ...
            (($Print = $Separated) and (count($FormData/Form990ScheduleLPartIII) &gt;11)) ">
									<tr>
										...
										<td class="styTableCellCtr" style="width:62mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-right:0px">
											<span style="width:3px"/>
										</td>
									</tr>
								</xsl:if>
					...
					<div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageend">
						<div class="styGenericDiv" style="width:110mm;font-weight:bold;font-size:6pt">For Privacy Act and Paperwork Reduction Act Notice, see the <br/>Instructions for Form 990 or 990-EZ. </div>
						<div class="styGenericDiv" style="width:22mm;font-size:6pt">Cat. No. 50056A</div>
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText" style="font-size:6pt">Schedule L (Form 990 or 990-EZ) 2010</span>
						</div>
					</div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Schedule L (Form 990 or 990-EZ) 2010</div>
        ...
        Business Transactions Involving Interested Persons.<br/>
            ...
            (($Print = $Separated) and (count($FormData/Form990ScheduleLPartIV) &gt;6)) ">
					...
					<div class="styGenericDiv" style="width: 187mm;">
						<div class="styPartName" style="width:18mm;">Part V</div>
						<div class="styPartDesc" style="width:169mm;font-weight:bold;">
Supplemental Information
</div>
						<div class="IRS990ScheduleC_LineDesc" style="width:187mm;height:4mm;border-top-width:1px;padding-top:1mm;border-bottom-width:1px;border-right-width:0px;padding-left:21mm ">
          ...
          Additional Data        
					...
					<xsl:if test="($Print = $Separated) and count($FormData/DQPTable) &gt;= 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:83mm;font-weight:bold;border-right:0px;border-left:0px">
										<span class="styLNLeftNumBox">1</span>
										<span style="font-weight:normal">
											<b>(a)</b> Name of disqualified person</span>
									</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="width:83mm;font-weight:normal; text-    			align:center;border-right-width:0px;">
										<span style="font-weight:bold">(b)</span> Description of transaction</th>
									<th class="styDepTblCell" colspan="2" scope="col" style="width:20mm;font-weight:normal;border-right-width:0px;">
										<span style="font-weight:bold">(c)</span> Corrected?</th>
								</tr>
								<tr class="styDepTblHdr">
							...
							<xsl:for-each select="$FormData/DQPTable">
								<tr>
									...
									<td class="styDepTblCell" style="width:85mm;padding-right:0.75mm;border-right:1px;border-left:0px;vertical-align:top;text-align:left;border-bottom-width:1px">
										<xsl:choose>
											<xsl:when test="NamePerson">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="NamePerson"/>
									...
									<td class="styDepTblCell" style="width:8mm;padding-right:0.75mm;border-right:1px;vertical-align:top;border-bottom-width:1px">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="TransactionCorrected"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="width:8mm;vertical-align:top;padding-right:0.75mm;border-left-width:1px;border-right-width:0px;border-bottom-width:1px">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="TransactionCorrected"/>
										</xsl:call-template>
									</td>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/LoanTable) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:63mm;font-weight:normal;border-right:0px;border-left:0px">
										<span style="font-weight:bold">(a)</span> Name of interested person and purpose</th>
									<th class="styDepTblCell" colspan="2" scope="col" style="width:20mm;font-weight:normal;border-right:0px;">
										<span style="font-weight:bold">(b)</span> Loan to or from the organization?</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="width:30mm;font-weight:normal; text-align:center;border-right-width:1px;border-right:0px;">
			 ...
			 $</th>
								...
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:8mm;font-weight:bold;border-right:0px;">To</th>
									<th class="styDepTblCell" scope="col" style="width:8mm;border-right:0px;">From</th>
									<th class="styDepTblCell" scope="col" style="width:8mm;font-weight:bold;border-right:0px;">Yes</th>
									<th class="styDepTblCell" scope="col" style="width:8mm;font-weight:bold;border-right:0px;">No</th>
									<th class="styDepTblCell" style="width:8mm;font-weight:bold;border-right:0px;">Yes</th>
									<th class="styDepTblCell" scope="col" style="width:8mm;font-weight:bold;border-right:0px;">No</th>
									<th class="styDepTblCell" style="width:8mm;font-weight:bold;border-right:0px;">Yes</th>
									<th class="styDepTblCell" scope="col" style="width:8 mm;font-weight:bold;border-right:0px;">No</th>
								</tr>
							</thead>
							<tfoot/>
							<xsl:for-each select="$FormData/LoanTable">
								<tr>
									...
									<td class="styDepTblCell" style="width:53mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left">
										<xsl:choose>
											<xsl:when test="NamePerson">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="NamePerson"/>
									...
									<td class="styDepTblCell" style="width:4mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-right-width:1px;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="LoanToOrganization"/>
										</xsl:call-template>
									...
									<td class="styDepTblCell" style="width:32mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:right">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="OriginalPrincipalAmount"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="width:32mm;vertical-align:bottom;padding-right:0.75mm;text-align:right">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="BalanceDue"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="padding-left:.50mm;width:4mm;vertical-align:bottom;border-left:0px;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="Default"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="padding-left:.50mm;width:4mm;vertical-align:bottom;border-left:0px;border-right-width:1px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="Default"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="padding-left:0.50mm;width:4mm;vertical-align:bottom;border-left:0px;border-right-width:1px;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="ApprovedByBoard"/>
										</xsl:call-template>
									</td>
									...
									<td class="styDepTblCell" style="padding-left:0.50mm;width:4mm;vertical-align:bottom;border-left:0px;border-right-width:0px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="WrittenAgreement"/>
										</xsl:call-template>
									</td>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/Form990ScheduleLPartIII) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:62mm;font-weight:normal;border-top-width:1px;border-right:0px;border-left:0px">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styDepTblCell" scope="col" style="width:62mm;font-weight:normal; text-align:center;border-top-width:1px;border-right-width:0px">
										<span style="font-weight:bold">(b)</span>Relationship between interested person and the organization</th>
									<th class="styDepTblCell" scope="col" style="width:62mm;font-weight:normal; text-align:center;border-top-width:1px;border-right-width:0px">
										<span style="font-weight:bold">(c)</span>Amount of grant or type of assistance</th>
								</tr>
							...
							<xsl:for-each select="$FormData/Form990ScheduleLPartIII">
								<tr>
									<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1Cell </xsl:when><xsl:otherwise>styDepTblRow2Cell </xsl:otherwise></xsl:choose></xsl:attribute>
									<td class="styDepTblCell" style="width:62mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;">
										<xsl:choose>
											<xsl:when test="NameOfInterestedPerson">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="NameOfInterestedPerson"/>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/Form990ScheduleLPartIV) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:60mm;font-weight:normal;border-right:0px;border-left:0px">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="width:32mm;font-weight:normal; text-align:center;border-right-width:0px;">
										<span style="font-weight:bold">(b)</span> Relationship between interested person and the organization</th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:30mm;font-weight:normal;border-right:0px">
										<span style="font-weight:bold">(c)</span> Amount of transaction $</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="width:45mm;font-weight:normal; text-align:center;border-right-width:0px;">
										<span style="font-weight:bold">(d)</span> Description of transaction</th>
									<th class="styDepTblCell" colspan="2" scope="col" style="width:20mm;font-weight:normal;border-right-width:0px;">
										<span style="font-weight:bold">(e)</span> Sharing of organization's revenues?</th>
								</tr>
							...
							<xsl:for-each select="$FormData/Form990ScheduleLPartIV">
								<tr>
									<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1Cell </xsl:when><xsl:otherwise>styDepTblRow2Cell </xsl:otherwise></xsl:choose></xsl:attribute>
									<td class="styDepTblCell" style="width:60mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
										<xsl:choose>
											<xsl:when test="NameOfInterestedPerson/NamePerson">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="NameOfInterestedPerson/NamePerson"/>
									...
									<td class="styDepTblCell" style="width:4mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:1px;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="SharingOfRevenues"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="width:4mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:0px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="SharingOfRevenues"/>
										</xsl:call-template>
									</td>

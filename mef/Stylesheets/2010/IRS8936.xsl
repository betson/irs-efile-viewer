...
<body class="styBodyClass">
  ...
  <div class="styTYBox" style="width:30mm;height:21mm; border-left-width: 1px">
      ...
      <div class="styTY" style="height:10mm">20<span class="styTYColor">10</span></div>
  ...
  <div class="styBB" style="width: 187mm;">
         ...
         <li>Use this form to claim the credit for certain plug-in electric vehicles (other than two-or three-wheeled or low-speed four-wheeled vehicles).</li>
 ...
 <div  style="width: 187mm"> 
  <xsl:if test="($Print != $Separated) or (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &lt;= 3)">
 ...
 <div class="styIRS8936TableContainer" id="Spcctn">
  ...
  <!--end-->
   <table class="styTable" cellspacing="0" cellpadding="0" border="0" style="font-size: 7pt; font-family:verdana;">
    <tr style="height: 8mm">
      <th class="PopulateTxt"  style="border-color:black;border-bottom-width:1px;padding-left:0px;padding-right:0px;"></th>
        <th class="PopulateTxt" colspan="2" style="width:83.5mm; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width:1mm; border-bottom-width:0px; text-align: left;padding-left:0px;padding-right:0px;">        
    <span class="styNormalText" style="font-size:6pt;"> Use a separate column for each vehicle. If you need more columns, use additional Forms 8936 and include the total on lines 6 and 10.
            </span>
         
        </th>
        <th class="styTableCell" style="width:32mm;font-weight:normal;border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 0px;border-bottom-width:0px; text-align: center"><b>(<xsl:number value="($pos)" format="a"/>)</b> 
          <span style="width:12mm;">Vehicle</span>     
            <xsl:number value="($pos)" format="1"/> 
        </th>
        <!--background-color:red;-->
        <th class="styTableCell" style="width:32mm;font-weight:normal;border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px;border-bottom-width:0px; text-align: center;"><b>(<xsl:number value="($pos + 1)" format="a"/>)</b> 
                  <span style="width:12mm;"> Vehicle</span>
                  <xsl:number value="($pos + 1)" format="1"/>   
        </th>
        <th class="styTableCell" style="width: 32mm;font-weight:normal;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px;border-bottom-width:0px; text-align: center"><b>(<xsl:number value="($pos + 2)" format="a"/>)</b>  
                        <span style="width:12mm;">Vehicle</span>
...
<td class="styLNRightNumBoxNBB" style="border-left-width:1px;padding-top:0px;padding-bottom:0px;border-bottom-width:0px;border-top-width:1px;border-right-width:0px;background-color:lightgrey;padding-left:0px;padding:right:0px" >        
        ...
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width:1px; text-align: center">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateYear">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp [$pos + 2]/VehicleDescription/VehicleYear" /> 
           </xsl:call-template>
           <br />
            <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp [$pos + 2]/VehicleDescription/VehicleMake" /> 
           </xsl:call-template>
          <br />
           <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp [$pos + 2]/VehicleDescription/VehicleModel" /> 
           </xsl:call-template>
        </td>
        </tr> 
   ...
   Enter date vehicle was placed in service (MM/DD/YY)
        ...
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateMonthDayYear">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 2]/VehiclePlacedInServiceDate" />  <!-- [$pos + 2]/VehiclePlacedInServiceDate-->
          </xsl:call-template>
        </td>
        </tr>
     ...
     <tr>
        ...
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 2]/VehicleTentativeCreditAmt" /> 
          </xsl:call-template>
        </td>
        </tr>
     </tbody>
 ...
 <xsl:if test="(count($FormData/QlfyPlugInElecDriveMtrVehCrGrp)=0) or (($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 3))">
 <div class="styIRS8936TableContainer" id="Spcctn" >
  ...
  <!-- blank lines -->
   <table class="styTable" cellspacing="0" style="font-size: 7pt">
    ...
    <!-- Header Line -->
       <tr>
			<td class="styBB" colspan="3" style="width:96.8mm;">Use a separate column for each vehicle. If you need more columns, use additional Forms 8936 and include the totals on lines 6 and 10.m </td>
			<td  class="styTableCellSmall" style="border-left:1 solid black;width:30mm;text-align:center;font-weight:bold;" >
			        <span>(</span>
			       <xsl:number value="position()" format="a"/>
			         <span>)</span>
			         <span style="width:12mm;font-weight:normal;">Vehicle 1</span>
			       </td> 
			       <td  class="styTableCellSmall" style="border-left:1 solid black;width:30mm;text-align:center;font-weight:bold;" >
			        <span>(</span>
			       <xsl:number value="position() + 1" format="a"/>
			         <span>)</span>
			         <span style="width:12mm;font-weight:normal;">Vehicle 2</span>
			       </td> 
			         <td  class="styTableCellSmall" style="border-left:1 solid black;width:30mm;text-align:center;font-weight:bold;border-right-width:0px;" >
			        <span>(</span>
			       <xsl:number value="position() + 2" format="a"/>
			         <span>)</span>
			         <span style="width:12mm;font-weight:normal;">Vehicle 3</span>
			        <!--start here-->
			       </td> 
   ...
   <!--    start here 1111-->
      <span style="letter-spacing:4mm;padding-top:.5mm; font-weight:bold;">...... </span>   
        ...
        <xsl:choose>
          ...
          <xsl:when test="(($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 3))">
  ...
  <!-- Line 2  -->
   ...
   Enter date vehicle was placed in service (MM/DD/YY)
         ...
         <td class="styLNRightNumBox" style="border-top-width:1px;">2</td>
 ...
 <!--  Part II -->
  <div style="width: 187mm;padding-top:4px;padding-bottom:4px;border-top-width:1px;padding-left:4mm;">
...
<tbody>
       <!-- line 4  -->
     <tr>
             <td class="styTableCell" style="width:5.25mm;text-align:left;font-weight:bold;border-right-width:0px;border-bottom-width:0px;padding-left:2mm;">4</td>
        <td class="styTableCell" style="width:69mm; text-align:left;border-color:black;border-left-width:0px;border-right-width: 0px;border-top-width:0px;border-bottom-width:0px;font-size:6pt;padding-top:.5mm;">
Business/investment use percentage (see instructions) 
        ...
        <span class="styLNRightNumBox" style="width:8.75mm;padding-bottom:0mm;float:right;border-top-width:0px;border-left-width:0px;background-color:white;padding-left:0px;padding-right:0px;">4</span>
                </td>
        <td class="styTableCell" style="padding-top:5mm;width:33mm;border-color:black;border-left-width:1px; border-right-width:1px; border-top-width:0px; border-bottom-width:1px; text-align:center;">
                    <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="BusinessInvestmentUsePct" />
          </xsl:call-template>%
        <span class="styTableCellPad"></span>
        </td>
        <td class="styTableCell" style="padding-top:5mm;width:33mm;border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; text-align:center;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 1]/BusinessInvestmentUsePct" /> 
          </xsl:call-template>%
             </td>
        <td class="styTableCell" style="padding-top:5mm;width:33mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 2]/BusinessInvestmentUsePct" />  
          </xsl:call-template>%
              </td>
        </tr>
  <!-- Line 5  -->
      ...
      <td  class="styTableCell" style="padding-left:2mm;width:5.5mm;text-align:left;font-weight:bold;border-right-width: 0px;border-bottom-width:0px;" valign="center">5</td>
        ...
        <td class="styTableCell" style="width:70mm; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:0px;text-align:left;">
              Multiply line 3 by line 4 <b>
  <span style="letter-spacing:4mm;padding-top:.5mm; font-weight:bold;">........ </span>   
             
             </b>
        </td>
         <td class="styLNRightNumBox" style="border-bottom-width:1px;padding-left:.5mm">5</td>
        ...
        <td class="styTableCell" style="border-color:black;border-left-width:0px;border-right-width:0px; border-top-width:0px; border-bottom-width:1px" valign="bottom">
          <span class="styTableCellPad"></span>
	         <xsl:call-template name="PopulateAmount">
		            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 2]/BusinessInvestmentUseAmt" />  		         
		  </xsl:call-template>      
        </td>
        </tr> 
   </tbody>
 ...
 <div class="styIRS8936TableContainer" id="Spcctn" >
  ...
  <!-- blank lines -->
   <table class="styTable" cellspacing="0" style="font-size: 7pt">
    ...
    <!-- Header Line -->
      ...
      <tr>
      <!--start here-->
      <td class="styTableCell" style="     width:5mm;padding-left:2mm;text-align:left;font-weight:bold;padding-top:4mm;border-color:black;border-top-width:1px;border-right-width:0px;border-bottom-width:0px;"><b>4</b>
     <!-- <div class="styLNLeftNumBoxSD" >7</div>-->
      ...
      Business/investment use percentage (see instructions)
        ...
        </xsl:choose>         <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 1px; border-bottom-width:1px; text-align:right;"><span class="styTableCellPad">%</span></td>
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width:1px; text-align: rightr"><span class="styTableCellPad">%</span></td>
        </tr>
  <!-- Line 5  -->
      <tr style="font-size: 7pt">
      <td class="styTableCell" style="width:5.25mm;text-align:left;padding-left:2mm;left;font-weight:bold;border-right-width: 0px;border-bottom-width:0px;">5</td> 
  ...
  <div style="width: 187mm">  
    ...
    <div class="styLNDesc" style="width:139mm;">
      <span style="float:left;">Add columns (a) through (c) on line 5 </span> 
  ...
  <div style="width: 187mm">  
    ...
    <div class="styLNDesc" style="width:139mm;">
      <b>Business/investment use part of credit. </b>Add lines 6 and 7. Partnerships and S corporations, 
...
<tr>
	<!--start here 2222-->
      ...
      <td class="styTableCell"  style="width:5.25mm;text-align:right;font-weight:bold;padding-top:3mm;border-color:black;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;"><b>9</b>
      </td>
     <td class="styTableCell" style="width:70mm;padding-left:2mm; text-align:left; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width:0px; border-bottom-width:0px;padding-top:6mm;">
...
<td class="styLNRightNumBoxNBB" style="border-left-width:1px;padding-top:0px;padding-bottom:0px;border-bottom-width:0px;border-top-width:0px;border-right-width:0px;background-color:lightgrey;padding-left:0px;padding:right:0px" >       
        ...
        <span class="styLNRightNumBox" style="width:8.75mm;padding-bottom:0mm;float:right;border-top-width:0px;border-left-width:0px;background-color:white;padding-left:0px;padding-right:0px">9</span>
                </td>
        <td class="styTableCell" style="width:33mm;border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; text-align:right;padding-left:0mm;padding-right:0mm;padding-top:8mm;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="TentativeCreditForPersonalUse"/>
          </xsl:call-template>
                 </td>
      <td class="styTableCell" style="width:33mm;border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px; text-align:right;padding-top:8mm;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp [$pos + 1]/TentativeCreditForPersonalUse" />  
          </xsl:call-template>
                 </td>
        <td class="styTableCell" style="width:33mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:right;padding-top:8mm;">
          <span class="styTableCellPad"></span>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp [$pos + 2]/TentativeCreditForPersonalUse" /> 
           </xsl:call-template>
            </td>
        </tr> 
  ...
  <!-- blank lines -->
   <table class="styTable" cellspacing="0" style="font-size: 7pt">
    ...
    <tbody>
      ...
      <td class="styTableCell" style="     width:6mm;text-align:left;padding-left:2mm;font-weight:bold;padding-top:6mm;border-color:black;border-top-width:1px;border-right-width:0px;border-bottom-width:0px;
      padding-bottom:2mm;"><b>9</b>
      </td>
        <td class="styTableCell" style="width: 75mm;padding-left:1mm; text-align: left; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width:1px; border-bottom-width:0px;padding-top:6mm;">
       If you skipped Part II, enter the amount from line 3. If you completed Part II, subtract line 5 from line 3
    
   
        </td>
        <td class="styLNRightNumBox" style="border-top-width:1px">9</td>
        <xsl:choose>
          <!-- Display "Additional Data" message if Print is set to separated and there are more than 3 elements -->
          <xsl:when test="(($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 3))">
            <td class="styTableCell" style="border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-width:1px; text-align:center;padding-top:5mm;">
...
<div style="width: 187mm">  
    ...
    <div class="styLNDesc" style="width:139mm;">
	  <span style="float:left;">Add columns (a) through (c) on line 9 </span> 
	  <span class="styDotLn" style="float:right;padding-right:1mm;">............</span> 
    </div>    
...
<div style="width: 187mm">  
    ...
    <div class="styLNDesc" style="width:139mm;">
	  <span style="float:left;">Enter the amount from Form 1040, line 46, or Form 1040NR, line 43 </span> 
	  <span class="styDotLn" style="float:right;padding-right:1mm;">............</span> 
    </div>    
...
<div style="width: 187mm">  
	...
	<div class="styBB" style="width: 187mm">  
      ...
      <div class="styLNDesc" style="width:139mm;">
	    <b> Personal use part of credit. </b> Enter the <b>smaller </b>of line 10 or line 13 here 
	    and on Form 1040,  line 53, or Form 1040NR, line 49. 
        Check box <b>c</b> on that line and enter “8936” in the space next to that box. If line 13 
        <span style="float:left;">is smaller than line 10, see instructions </span> 
	    <span class="styDotLn" style="float:right;padding-right:1mm;">......................</span> 
      </div>    
      <div class="styLNRightNumBoxNBB" style="height:10mm;padding-top:8mm;">14</div>
 ...
 <!-- End of page -->
          ...
          Form <span class="styBoldText">8936</span> (2010)
        </div>
        <br/>
        <br class="pageEnd"/>
 ...
 <!-- Additonal Data Title Bar and Button -->
  ...
  <xsl:if test="($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 3)">            
    <br />
    <br />
            ...
            <tr style="height: 8mm" class="styDepTblHdr">
              <td class="styDepTblCell" colspan="2" style="width: 91mm; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align: left">        
                <span class="styNormalText" style="padding-left: 5mm">
                  Use a separate column for each vehicle. If you need more columns, use additional Forms 8936 and include the totals on lines 6 and 10.
                </span>
              </td>
              ...
              <td class="styDepTblCell" style="width: 30mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align: center">(<xsl:number value="($pos + 2)" format="a"/>)
                                                              <span style="width:12mm">Vehicle</span>      
                                                              <xsl:number value="($pos + 2)" format="1"/>         
...
(MM/DD/YYYY)</span>
              ...
              <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;padding-top:6mm;">
                <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode" select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp[$pos + 2]/VehiclePlacedInServiceDate" />
                </xsl:call-template>
                <span class="styTableCellPad"></span>
              </td>
            </tr>
 ...
 <!-- line 5 -->            
              ...
              <td class="styTableCell" style="width: 83mm; text-align: left; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:0px;padding-top:4mm;">
              <span class="styBoldText" style="font-size:7pt; padding-left: 2mm;">5</span><span style="width: 1mm"></span>Multiple line 3 by line 4
               </td>
               <td class="styLNRightNumBox" >5</td>
  ...
  <xsl:if test="($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 3)">            
    <br />
    <br />
    <span class="styRepeatingDataTitle">Form IRS8936, Part III -Credit for Personal Use of Vehicle:</span>
    <xsl:for-each select="$FormData/QlfyPlugInElecDriveMtrVehCrGrp">
      <xsl:variable name="pos" select="position()"/>
      <xsl:if test="(position() mod 3)=1">
        <table class="styDepTbl" cellspacing="0" style="font-size: 7pt">
 ...
 <!-- line 11 -->         
           <tr class="styDepTblRow1" style="height:8mm">
              ...
              <span class="styBoldText" style="font-size:7pt; padding-left: 2mm;text-align:bottom;">9</span><span style="width: 1mm;">
              </span>Add columns (a) through (c) on line 9                                                                                                                                             
               </td>

...
<!-- Changed revision date and added text to lines 2a and 3a as per UWR WSP101238OTH - 04/19/2010 - JSN -->
<!-- Jeremy Nichols - Modified per ITAMS #7823812 - 12-13-2010 -->
<!-- 02/02/2011 - Modified per UWR 36699 - Jeremy Nichols -->
        ...
        <form name="Form8849Schedule3">
          ...
          <div style="border-bottom:1px black solid;width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:5mm;padding-top:1.5mm;padding-bottom:1.5mm;">
              ...
              <span class="styNormalText">
                ...
                (or will claim) on Schedule C (Form 720) or Form 4136, Credit for Federal Tax Paid on Fuels.
                <b>NOTE: This rule does not apply to claims for calendar year 2010 except the alcohol fuel mixture credit 
                (line 1) and the credit for liquefied hydrogen (line 3(d)). Claims for calendar year 2010 for the other credits can 
                only be made on this form.  See the instructions.</b>
              </span>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:4.5mm;">
              <span class="styText">
                Enter your registration number, including the prefix, on the entry line above. Line 3 
          ...
          <div style="border-bottom:1px black solid;width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:5mm;">
              <span class="styText">
                ...
                or was used as a fuel by the claimant. </span>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                ...
                <tr>
                  ...
                  <th scope="col" style="width=87mm;"><span style="width=1px;"/></th>
                  <th scope="col" style="width=19mm;border-left:1px black solid;border-bottom:1px black solid;">(a)<br/> Rate</th>
                  <th scope="col" style="width=30mm;border-left:1px black solid;border-bottom:1px black solid;">(b)<br/> Gallons of alcohol</th>
                  ...
                  <th scope="col" style="width=8mm;border-left:1px black solid;border-bottom:1px black solid;">(d)<br/> CRN</th>
                </tr>
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                ...
                <tr>
                  <th scope="col" style="width=96mm;font-weight:normal;" colspan="2" align="left"></th>
            ...
            <table style="font-size:7pt;border-collapse:collapse;">
              <tbody>
                ...
                <tr>
                  <th scope="col" style="width=96mm;font-weight:normal;" colspan="2" align="left"><span style="width=1px;"/></th>
                  <th scope="col" style="width=10mm;border-left:1px black solid;border-bottom:1px black solid;">(a)<br/> Rate<br/><br/></th>

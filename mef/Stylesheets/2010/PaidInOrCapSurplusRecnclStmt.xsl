...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="PCSRTbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      ...
      <xsl:for-each select="$DependencyData/Item">
        <tr>
          ...
          <td class="styDepTblCell" valign="top" align="right" nowrap="nowrap">
            <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="BeginningAmount" /></xsl:call-template>   
          </td>          
          <td class="styDepTblCell" valign="top" align="right" nowrap="nowrap">
            <xsl:call-template name="PopulateAmount"><xsl:with-param name="TargetNode" select="EndingAmount" /></xsl:call-template>   
          </td>          
      ...
      <body class="styBodyClass">      
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:135mm">
            <!--TY 2003 Paid-in or Capital Surplus Reconciliation Statement-->
            <xsl:value-of select="$depDocTitle" />
          </div>
        </div>        

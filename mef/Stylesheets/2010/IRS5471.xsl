                ...
                <br/>
          		...
          		<span style="width: 20mm">
						...
						<div class="styTYBox" style="height: 23.25mm">
							...
							<div style="font-size:6pt; height:6mm; text-align: left; padding-left: 1mm"><div style="width:10mm;">Attachment</div> 
							<div style="width:20mm;">Sequence No.<b>121</b> </div>       </div>
						</div>
					</div>
					<!--   END FORM HEADER   -->
					<!--   BEGIN TAXPAYER INFO   -->
                  ...
                  <xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/USAddress/ZIPCode"/>
									...
									<xsl:otherwise>
										<!-- xsl:attribute name="style">line-height:100%; font-size:5pt </xsl:attribute-->
												<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/City"/>
										</xsl:call-template>
										...
										<xsl:call-template name="PopulateText">
											...
											<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/ProvinceOrState"/>
										</xsl:call-template>															
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/PostalCodes"/>
										</xsl:call-template>
						                <xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$IRS5471Data/PersonFilingThisReturn/Country"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
							</span>
    ...
    <span class="styFixedUnderline" style="width:12mm;float:none;">
        ...
        <span style="width: 20mm; ">
                    ...
                    (3)<span class="styNormalText"> Identifying number</span>
									...
									<th scope="col" class="styTableCellHeader" style="border-color: black; font-size: 7pt;border-right-width: 0px" colspan="3">
                  ...
                  b<span style="width: 1mm"/>
						...
						<tr>
							<td class="styLNAmountBoxNBB" style="text-align: left; border-left-width: 0px;border-right-width: 1px; width: 102mm;" valign="top" rowspan="2">
								...
								<xsl:if test="$IRS5471Data/SSNOfAgentInTheUS != ''">
									<xsl:call-template name="PopulateSSN">
								...
								<span>
								<br/>
								<xsl:if test="$IRS5471Data/EINOfBranchOfficeInTheUS != ''">
									<xsl:call-template name="PopulateEIN">
										<xsl:with-param name="TargetNode" 
										select="$IRS5471Data/EINOfBranchOfficeInTheUS"/>
									</xsl:call-template>
								</xsl:if>
								
								</span>
								<xsl:if test="$IRS5471Data/MissingSSNEINReason != ''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$IRS5471Data/MissingSSNEINReason"/>
									</xsl:call-template>
								</xsl:if>								
								<span class="styTableCellPad"/>
							</td>
						...
						<tr>
							...
							<td class="styTableCell" valign="top" style="width: 97mm; border-color:black; border-left-width: 1px; border-top-width: 1px; height: 25mm;text-align:left; border-right-width: 0px; border-bottom-width: 0px">
								<span style="text-align:left;padding-left:1.5mm;">
									...
									<span style="width: 100mm;padding-left:4mm;">applicable) of person (or persons) with custody of the books </span>
									<span style="width: 4mm"/>and records of the foreign corporation, and the location of 
									<span style="width:100mm;padding-left:4mm;">such books and records, if different </span>
	              </span>
								<br/>
    ...
    <span class="styNBSP"/>.
                ...
                <xsl:with-param name="TargetNode" select="$IRS5471EData/TotalIncomeAndWarProfitsTaxes"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span class="styLNRightNumBox" style="height: 16.6mm;"/>
          ...
          Additional Data        
					...
					<xsl:if test="((count($IRS5471BData/USShareholdersOfForeignCorp) &gt; 5) or (count($IRS5471BData/USShareholdersOfForeignCorp[count(ForeignCorporationStocks) &gt; 4]) &gt; 0)) and ($Print = $Separated)">
						...
						<table class="styDepTbl" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="width: 60mm; text-align: center;">
										<br/>
										<br/>
									...
									<th scope="col" class="styDepTblCell" style="width: 20mm; text-align: center; border-right-width: 1px">

                  ...
                  Corporation's Voting Stock </span>
                    ...
                    Attach to Form 1120.</b>
						...
						<div class="styTYBox" style="width:30mm;height:19mm;">
							...
							<div class="styTY" style="height:10mm;padding-top:2mm">20<span class="styTYColor">10</span>
							</div>
						</div>
					</div>
					<!-- BEGIN FORM HEADER -->
...
<br/>in Voting Stock
					...
					<div class="IRS1120ScheduleG_styFormFooter" style="width:707px;border-top-width: 0px;">
						...
						<span style="width:53mm;text-align:right;font-weight:bold;font-size:6pt;" class="styGenericDiv">Schedule G (Form 1120) 2010</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
				<!-- leftover data table -->

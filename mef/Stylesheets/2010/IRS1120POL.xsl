...
<span style="width:14px"/>.
        ...
        <!-- additional info line 1 -->
              ...
              At any time during the 2010 calendar year, did the organization have an interest in or a signature or other 
              </div>
 </div>
...
<!-- END PREPARER SIGNATURE SECTION -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2010)</div>
        </div>
        <!-- leftover data table -->
				<br/>
				<br/>

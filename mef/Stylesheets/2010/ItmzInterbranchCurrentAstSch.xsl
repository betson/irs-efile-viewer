...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <table id="GeneralDependencyTbl" class="styDepTblLandscape">
    <tr class="styDepTblHdr">
      ...
      <xsl:choose>
        <xsl:when test="$DependencyData/ItmzInterbranchCurrentAst/CorporationEIN">
    ...
    <tfoot/>
    <tbody>
    <xsl:for-each select="$DependencyData/ItmzInterbranchCurrentAst">
      <tr>
         ...
         <!--Column 1 - Corporation Name -->
          <td class="styDepTblCell" style="width:85mm;text-align:left;vertical-align:middle;font-size:7pt">
            ...
            <xsl:attribute name="rowspan">
              <xsl:value-of select="count(ItmzInterbranchCurrAstLineItem)"></xsl:value-of>
            </xsl:attribute>
            <!--Allow row to expand by column -->
          ...
          <xsl:if test="count(ItmzInterbranchCurrAstLineItem)=0 or count (ItmzInterbranchCurrAstLineItem)=1">
            <!--Column 3 - Itemized Inter Branch Current Assets Line Item Description -->
            <td class="styDepTblCell" style="width:86mm;text-align:left;font-size:7pt">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ItmzInterbranchCurrAstLineItem/Description" />
              </xsl:call-template>
              <span class="styTablecellpad"/>
            </td>
            <!--Column 3 - Itemized Inter Branch Current Assets Line Item Description -->
            <!--Column 4 - Itemized Inter Branch Current Assets Line Item Beginning Amount -->
            <td class="styDepTblCell" style="width:30mm;text-align:right;font-size:7pt">
              <xsl:call-template name="PopulateAmount">
                 <xsl:with-param name="TargetNode" select="ItmzInterbranchCurrAstLineItem/BeginingAmount" />
              </xsl:call-template>
              <span class="styTablecellpad"/>
            </td>
            <!--Column 4 - Itemized Inter Branch Current Assets Line Item Beginning Amount -->
            <!--Column 5 - Itemized Inter Branch Current Assets Line Item Ending Amount -->
            <td class="styDepTblCell" style="width:30mm;text-align:right;font-size:7pt">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="ItmzInterbranchCurrAstLineItem/EndingAmount" />
              </xsl:call-template>
              <span class="styTablecellpad"/>
            </td>
            <!--Column 5 - Itemized Inter Branch Current Assets Line Item Ending Amount -->
          ...
          <xsl:if test="count(ItmzInterbranchCurrAstLineItem)&gt;1">
            <!--Column 3 - Itemized Inter Branch Current Assets Line Item Description -->
            <td class="styDepTblCell" style="width:86mm;text-align:left;font-size:7pt">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ItmzInterbranchCurrAstLineItem/Description" />

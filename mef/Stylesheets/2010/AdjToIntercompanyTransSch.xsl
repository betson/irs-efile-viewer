						...
						<td class="styDepTblCell" align="left">
							<span style="width:50mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="NamesOfEntities/BusinessNameLine1"/>
								</xsl:call-template>
								<xsl:if test="normalize-space(NamesOfEntities/BusinessNameLine2)!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="NamesOfEntities/BusinessNameLine2"/>
									</xsl:call-template>
								</xsl:if>
							</span>
						</td>

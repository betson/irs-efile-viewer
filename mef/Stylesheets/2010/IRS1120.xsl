...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
              ...
              <xsl:call-template name="SetFormLinkInline">
                ...
                <xsl:with-param name="Style">padding-left:12mm;</xsl:with-param>
				  ...
				  <span style="width:2px;"/>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm; font-size:6.pt;">
                ...
                <span style="float:left;">4466 </span>
						...
						<!-- line 32f 1-->
						<!--NOTE: This line is differenet from 1120 Elimination and Adjustment-->
						<div style="width:181mm;float:right;clear:none;">
                ...
                <span style="float:left;">8c
                  <xsl:call-template name="SetFormLinkInline">
							...
							<div class="styLNAmountBox" style="height:8mm;float:left;">
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 32h - Backup Withholding Indicator</xsl:with-param>
								...
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Line 32h - Backup Withholding Amount</xsl:with-param>
    ...
    May the IRS discuss this return<br/> with the preparer shown below <br/>(see instructions)?
								...
								<xsl:if test="($Print != $Separated) or (count($Form1120ScheduleE/Officer) &lt;= 5) ">
									<xsl:for-each select="$Form1120ScheduleE/Officer">
										<tr>
											...
											<td class="styTableCellCtr" style="width:31mm;padding-left:">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2010)
              ...
              classes of the corporation’s stock entitled to vote? If “Yes,” complete Part II of Schedule G (Form 1120) (attach Schedule 
            </div>
						<div class="styGenericDiv">
                ...
                <!-- Form to Form Link -->
						...
						<div class="styGenericDiv">
							<div class="styIRS1120LNYesNoBox" style="width:6mm;height:4.5mm;border-bottom-width:1px;padding-top:0px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateYesBoxText">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleK/IndivEstateTrustOwnPctVtngStk"/>
									</xsl:call-template>
							...
							<div class="styIRS1120LNYesNoBoxRB" style="width:6mm;height:4.5mm;border-right-width:0px;border-bottom-width:1px;padding-top:0px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateNoBoxText">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleK/IndivEstateTrustOwnPctVtngStk"/>
									</xsl:call-template>
									...
									<xsl:for-each select="$Form1120ScheduleK/CorpOwnPercentVotingStockInfo">
										<tr>
											...
											<td class="styTableCellCtr" style="width:35mm;">
												<!--  <xsl:choose>
                    <xsl:when test="$Form1120ScheduleK/EmployerIdentificationNumber">
                      <xsl:call-template name="PopulateEIN">
                        <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/EmployerIdentificationNumber"/>
                      </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/MissingEmployerIdNumberReason"/>
                      </xsl:call-template>
                    </xsl:otherwise>
                  </xsl:choose> -->
						...
						<table class="styTable" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" rowspan="2" style="width:36mm;font-weight:normal;border-right:0;">
										<span style="font-weight:normal">(iv)</span> Maximum Percentage Owned in Profit, Loss or Capital</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
				  ...
				  Distributions:
                    ...
                    Cash 
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBoxNBB" style="height:6mm;">
									<xsl:call-template name="PopulateAmount">

  ...
  <body class="styBodyClass">
    ...
    <div style="width:187mm;font-size:6pt;">
      ...
      <div style="float:right;">
        ...
        <span class="styBoldText">Schedule PH (Form 1120) (2010)</span>
      </div>      
    </div>     
          <div class="pageEnd"/>
    <!--END FOOTER-->  
    ...
    <div class="styBB" style="width:187mm;border-bottom:0px solid black;">
      <div style="float: left; clear: none">Schedule PH (Form 1120) (2010)</div>        
      <div style="float:right">
...
">
  ...
  <div class="styIRS1120SchedulePHLineItem" style="float:none">
   ...
   <div style="width: 187mm">
     ...
     <span class="styBoldText" style="float: right">Schedule PH (Form 1120) (2010)</span>
   </div>
   <!--   END FORM FOOTER   -->
   <br/>
          <div class="pageEnd"/>

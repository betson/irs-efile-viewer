      ...
      <body class="styBodyClass">
        ...
        Skip line 1b and complete lines 2 through 11 with respect to that income statement.
         ...
         statement been restated for any of the five income statement periods preceding
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120S) 2010</div>
          </div>
          <!-- Page 2 -->
          <!-- Page 2 Header -->
          <div class="styBB" style="width:187mm;border-bottom-width:2px">
            <div style="float:left;">Schedule M-3 (Form 1120S) 2010</div>
          ...
          <table class="styTable" id="IRS1120SScheduleM3PartIITable" summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable Income per Return " cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;">
            ...
            <tr>
              ...
              <td>Income (loss) from equity method U.S. corporations (attach schedule)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
       ...
       <!-- Form Link -->
         ...
         Line 26, column (a), must equal the amount on Part I, line 11, and column (d) must equal Form 1120S, Schedule K, line 18.</div>
          <div class="pageEnd" style="width:187mm;">
            <div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120S) 2010</div>
          </div>
          <!-- Page 3 -->
          <!-- Page 3 Header -->
          <div class="styBB" style="width:187mm;border-bottom-width:2px;">
         ...
         Depreciation<span class="styDotLn" style="float:none;padding-left:3mm;">..............</span>
           ...
           <!-- form link -->
            ...
            <!-- Part III - Line 30 -->
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" >30</td>
              <td>Section 118 exclusion (attach schedule)
                 <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$Form1120SScheduleM3/ExpenseDeductionItems/Section118Exclusion"/>
                </xsl:call-template>
                <span class="styDotLn" style="float:none;padding-left:3mm;">...</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell">
            ...
            <!-- Part III - Line 31 -->
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell">31</td>
            ...
            <!-- Part III - Line 32 -->
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" style="border-bottom-width:1px;border-color:black;border-style:solid;border-left-width:0px;border-top-width:0px;border-right-width:0px">32</td>

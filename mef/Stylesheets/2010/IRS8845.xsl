    ...
    <html lang="EN-US">
      ...
      <body class="styBodyClass">
          ...
          <div class="styBB" style="width:187mm">
            ...
            <div style="width:187mm;">
              <div style="float:left;clear:none;">
                ...
                <div class="styLNDesc" style="width:139mm;height:8mm;">
                  Multiply line 3 by 20% (.20) (see instructions for the adjustment you must make for salaries and wages)
		...
		5
		    ...
		    <span style="float:left;">report this amount on Schedule K; all others, report this amount on Form 3800, line 1g </span> 
		    <!--Dotted Line-->
                  <span style="letter-spacing:4mm;font-weight:bold;float:right;padding-right:1mm;skiplink:display:none;">.....</span>
                </div>
              </div>
              <div style="float:right;clear:none">
                ...
                <div class="styLNAmountBox" style="height:8mm;padding-top:4.25mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <div style="float:left;clear:none;">
                ...
                <div class="styLNDesc" style="width:139mm;height:8mm;">
                  <span class="styBoldText">Cooperatives, estates and trusts.</span>
                    Subtract line 7 from line 6. Report this amount on Form 3800, line 1g 
                    <span style="float:left;"></span>
		      <!--Dotted Line-->
                  <span style="letter-spacing:4mm;font-weight:bold;float:right;padding-right:1mm;skiplink:display:none;">................</span>
                </div>
          ...
          <div style="width:187mm;">
            ...
            Form <span class="styBoldText">8845</span> (2010)
          </div>
          <br/>
          <br class="pageEnd"/>

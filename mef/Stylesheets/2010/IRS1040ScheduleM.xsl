...
<div class="styLNLeftNumBox" style="font-size:7pt;height:3mm;padding-bottom:0mm;padding-left: 2.25mm"/>
    ...
    <!--Line 10--> 
      ...
      <div class="styForm1040SchedulelineItem" style="width:139.4mm; height:14mm;padding-top:0mm;">          
        Did you (or your spouse, if filing jointly) receive an economic recovery payment in 2010? You
may have received this payment in 2010 if you receive an economic recovery payment in 2009 but if you received social security benefits, supplemental security
			 ...
			 <input type="checkbox"  class="styCkbox"  name="Checkbox">
                  ...
                  <xsl:with-param name="BackupName">IRS1040ScheduleMEconomicRecoveryPymtInd</xsl:with-param>
                   ...
                   <xsl:with-param name="BackupName">IRS1040ScheduleMEconomicRecoveryPymtInd</xsl:with-param>
							...
							<span style="width:11mm;"></span>jointly) received in 2010. Do not enter more than $250 ($500 if married filing jointly)
				</div>
					</div>
...
<div class="styBB" style="width:187mm;border-bottom-width: 0px;">
      ...
      <b>Making work pay.</b> Subtract line 10 from line 9. If zero or less, enter -0-  Enter the result here <br/>

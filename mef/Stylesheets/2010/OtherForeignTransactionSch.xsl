...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherForeignTransactionSch" />
  <!-- Display Name is Other Foreign Transaction Schedule -->
 ...
 <!-- Table begin -->     
    <table class="styDepTbl" style="margin-top:4mm;">
      ...
      <tfoot></tfoot>
      <tbody>    
      <xsl:for-each select="$DependencyData/OtherForeignTransaction">
        <tr>

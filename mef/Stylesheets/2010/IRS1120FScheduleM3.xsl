	...
	<xsl:template match="/">
		<html>
           ...
           <span style="float:left;">business profits to a  U.S. permanent establishment under rules other than section 864(c)?</span>
              ...
              period <span style="float:left;">(see instructions)?</span>
								<!-- Dotted Line -->
								<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...............................</span>
							</div>
							<div class="sty1120FSchM3Pad4mm"/>
              ...
              Has the corporation’s income statement been restated for any of the 5 income statement periods preceding<br/>the period on line 2a?
                ...
                Net income from includible disregarded foreign entities not included on line 4 (attach schedule)
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net loss from includible disregarded foreign entities not included on line 4 (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.</span>
						</div>
                ...
                (<xsl:call-template name="PopulateAmount">
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net income from includible disregarded U.S. entities not included on line 4 (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.</span>
						</div>
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net loss from includible disregarded U.S. entities not included on line 4 (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">..</span>
						</div>
                ...
                (<xsl:call-template name="PopulateAmount">
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net income (loss) from foreign locations not included on line 4 (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.....</span>
						</div>
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net income of non-includible entities (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.............</span>
						</div>
                ...
                (<xsl:call-template name="PopulateAmount">
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Net loss of non-includible entities (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">..............</span>
						</div>
						...
						<div class="sty1120FSchM3LN411Desc">
							...
							<span style="float:left;">Adjustments to intercompany transactions (attach schedule)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...........</span>
						</div>
                ...
                Other adjustments to reconcile to amount on line 11 (attach schedule)
						...
						<div class="sty1120FSchM3LN411Desc" style="height:8mm">
							<div style="text-align-last:justify">
								<b>Adjusted financial net income (loss) of non-consolidated foreign corporation.</b> Combine lines 4</div>
							<div class="sty1120FSchM3RightFloat">
								<!--<span class="sty1120FSchM3DotLn">.............................</span>-->
							</div>
					...
					<div style="width:187mm;clear:both;padding-top:0.5mm">
						...
						<div style="float:right;" class="styGenericDiv">
							<b>Schedule M-3 (Form 1120-F) 2010</b>
						</div>
					</div>
					<br/>
					<div class="pageEnd"/>
            ...
            Page <span style="font-size:8pt;font-weight:bold">2</span>
						...
						<div>Schedule M-3 (Form 1120-F) 2010</div>
					</div>
					<!--Begin Name/EIN-->
					<div style="width:187mm">
						<div class="styTableCell" style="width:135mm;float:left;height:10mm;text-align:left">
                  ...
                  Cost of goods sold (attach schedule)
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										<div style="text-align-last:justify">
                 Interest income excluding interest <span style="float:left;">equivalents</span>
										</div>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">..........</span>
									</td>
                ...
                <span style="float:left;">corporations</span>
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="font-size:6pt" scope="row">
										...
										<span style="float:left;">Net income (loss) from U.S. partnerships</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount">
                    ...
                    Net income (loss) from certain foreign</div>
                  ...
                  Net income (loss) from other pass-
										...
										<span style="float:left;">through entities (attach schedule)
                  <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										...
										<span style="float:left;">transactions (attach details)</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...</span>
                 ...
                 <!-- start here 1 -->
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:12mm" scope="row">
										...
										<span style="float:left;">through entities</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">........</span>
									</td>
          ...
          Corporations With Taxable Income per Return <span style="font-weight:normal">(see instructions) <i>(continued from page 2)</i>
                   ...
                   <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										...
										<span style="float:left;">assets other than inventory</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">....</span>
									</td>
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										...
										<span style="float:left;">carryforward used</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">........</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="padding-top:1mm;background-color:lightgrey;border-bottom-width:0">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:12mm" scope="row">
										...
										<span style="float:left;">liabilities</span>
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...........</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:12mm;padding-top:5mm;background-color:lightgrey">
										<br/>
                  ...
                  <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										<div style="text-align-last:justify">
											<b>Total income (loss) items.</b> Combine</div>
										<span style="float:left;">lines 1 through 24</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">........</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:8mm;padding-top:1mm">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										...
										<span style="float:left;">(from Part III, line 33)</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">......</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:8mm;padding-top:1mm">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:8mm" scope="row">
										<div style="text-align-last:justify">
											<b>Reconciliation totals.</b> Combine lines</div>
										<span style="float:left;">25 through 27</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.........</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:8mm;padding-top:1mm">
							...
							<tbody>
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:12mm" scope="row">
										...
										<span style="float:left;">fees, legal and accounting fees</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">...</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:12mm;padding-top:5mm">
								...
								<tr>
									...
									<td class="sty1120FSchM3TableCellText" style="height:16mm;font-size:6pt" scope="row">
										<div style="text-align-last:justify">
              Expenses allocable to effectively connected income under Regulations section 1.861-8 from home office or other books that do not give  rise to U.S. booked liabilities (from Schedule H (Form</div>
										<span style="float:left;">1120-F), line 20)</span>
										<!-- Dotted Line -->
										<span class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;">.........</span>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:16mm;padding-top:8mm;background-color:lightgrey">
										<br/>
										<span style="width:1px"/>
									</td>
									<td class="sty1120FSchM3TableCellAmount" style="height:16mm;padding-top:8mm;background-color:lightgrey">
									...
									<td class="sty1120FSchM3TableCellAmount" style="height:16mm;padding-top:8mm">
										<br/>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/ExpnssAllcblToECIUndSect18618/OtherPermanentDifferences"/>
										</xsl:call-template>
									</td>
									<td class="sty1120FSchM3TableCellAmountLastCol" style="height:16mm;padding-top:8mm">
										<br/>
										<xsl:call-template name="PopulateAmount">

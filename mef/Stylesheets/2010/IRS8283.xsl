	...
	<xsl:template match="/">
      ...
      <span style="font-family:Arial;font-size:9pt;font-weight:bold;">155</span>
						...
						<div class="styBB" style="width:187mm;border-top-width:1px">
							<div class="styNameBox" style="font-size:7pt;width:139mm;height:8mm;font-weight:normal;">Name(s) shown on your income tax return
							  <br/>
      ...
      <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param></xsl:call-template>-->
							...
							<div class="styEINBox" style="font-size:7pt;width:47mm;height:4mm;padding-left:2mm;">Identifying number<br/>
								<br/>
										...
										<tr>
											...
											<td class="styTableCell" style="width:100mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;border-right:none;" colspan="3">
												<xsl:call-template name="PopulateText">
                                       			...
                                       			<div style="text-align:bottom;padding-top:10mm;">
                                       			    <span class="styLNLeftNumBox" style="float:left;width:95mm;"/>
                                       				<xsl:call-template name="SetFormLinkInline">
                                                      <xsl:with-param name="TargetNode" select="$Form8283Data/InformationOnDonatedProperty"/>
                                                 </xsl:call-template>
              ...
              If Part II applies to more than one property, attach a separate statement.</div>
                  ...
                  Total amount claimed as a deduction for the property listed in Part I:
										...
										<div style="width:187mm;">
											...
											<div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept<span style="width:7mm;"/>
												<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right"/>
										...
										<div style="width:187mm;">
											...
											<div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">Name of any person, other than the donee organization, having actual possession of the property<span style="width:5mm;"/>
												<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right"/>
												<span style="width: 2mm;"/>
												<span style="border-bottom: 1px solid black; width: 20mm;"/>
											</div>
      ...
      Form <span class="styBoldText" style="font-size:8pt;">8283</span>  (Rev. 12-2006)
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 8283 (Rev. 12-2006)<span style="width:130mm;"/>
						</div>
...
-->
        ...
        <span style="width:71.5mm;"/>having a value of $500 or less. See instructions.</span>
					</div>
					<div style="width:187mm;"/>
					<div style="width:187mm;">
      ...
      Also, I declare that I hold myself out to the public as an appraiser or perform appraisals on a regular basis; and that because of my qualifications as described in the appraisal, I am qualified to make appraisals of the type of property being valued. I certify that the appraisal fees were not based on a percentage of the appraised property value. Furthermore, I understand that a false or fraudulent overstatement of the property value as described in the qualified appraisal or this Form 8283 may subject me to the penalty under section 6701(a) (aiding and abetting the understatement of tax liability).  In addition, I understand that a substantial or gross valuation misstatement resulting from the appraisal of the value of the property that I know, or reasonably should know, would be used in connection with a return or claim for refund, may subject me to the penalty under section 6695A.  I affirm that I have not been barred from presenting evidence or testimony by the Office of Professional Responsibility.
        ...
        <div>
          ...
          <span class="styBoldText" style="width:19px;">.</span>
					...
					<div style="width:187mm;border-top-width:1px">
						<div class="styNameBox" style="font-family:Arial;font-size:7pt;width:94mm;height:8mm;">Address (number, street, and room or suite no.) <br/>
						...
						<div class="styEINBox" style="font-family:Arial;font-size:7pt;width:93mm;height:4mm;font-weight:normal;">City or town, state, and ZIP code <br/>
							<br/>
							<xsl:if test="$Form8283Data/USAddressOfDonee">
           ...
           <xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
                ...
                Total amount claimed as a deduction for the property listed in Part I:
										...
										<div class="styDepTblRow2" style="width:187mm;background-color:yellow">
											<div class="styLNLeftLtrBox" style="height:4.5mm;">d</div>
											<div class="styLNDesc" style="width:108mm;height:4mm;font-weight:normal;">For tangible property, enter the place where the property is located or kept<span style="width:5mm;"/>
												<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right"/>
											</div>

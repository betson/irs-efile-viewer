...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="RootElt" select="$RtnDoc/OtherIncomeTypeStatement" />
  
  <!-- Template to display Other Income Type Statement -->
  
  <xsl:template name="ShowData">
    <table id="ILSTbl" class="styDepTbl" style="text-align:center;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">          
           <th class="styDepTblCell" scope="col" style="width:150mm;">Other Income Literal or Code</th>        
           <th class="styDepTblCell" scope="col" style="width:38mm;">Other Income Amt</th>        
        </tr>
      </thead>
       <tbody>    
        <xsl:for-each select="$RootElt/OtherIncomeTypeStmt">  
          <tr>
    ...
    <html>
      ...
      <body class="styBodyClass" >
        ...
        <div class="styDepTitleLine ">
          <span class="styDepTitle" style="width:100mm;text-align:center;">

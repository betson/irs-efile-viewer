...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
        ...
        Did you "materially participate" in the operation of this business during 2010? If &#8220;No," see page F-2 for limit on passive losses.          
      </div>
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:67.5mm;height:4mm;font-size:6pt;">
        ...
        <!--Dotted Line-->
         ...
         Taxable amount
					...
					<div style="width:187mm;">
						<div class="styLNLeftLtrBox" style="height:4mm;padding-left:4mm;">a</div>
						<div class="styLNDesc" style="width:67.5mm;height:4mm;">Amount received in 2010
        <!--Dotted Line-->
							<span style="letter-spacing:4mm;font-weight:bold">.......</span>
						</div>
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139mm;height:4mm;">Other income, including federal and state gasoline or fuel tax credit or refund (see page F-3)
        <!--Dotted Line-->
							<span style="letter-spacing:4mm;font-weight:bold">...</span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width: 139mm; height:4mm;">
							...
							<span style="font-size:7pt;"> Add amounts in the right column for lines 3 through 10. If you use the accrual method, </span>to figure your income, enter the amount from Part III, line 51
      ...
      11
            ...
            <span style="width:1px;"/>
              ...
              23b
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:52mm;height:8.75mm" colspan="2">Labor hired (less employment credits)
              <!--Dotted Line-->
										<span style="letter-spacing:4mm;font-weight:bold">......</span>
									</td>
            ...
            <!--Dotted Line-->
									...
									<xsl:for-each select="$Form1040ScheduleFData/FarmExpenses/OtherExpenses/OtherExpense">
										<tr>
											<td class="styLNLeftLtrBox" style="height:4.5mm;vertical-align:top;">
												...
												<xsl:if test="position() = 6 and not($Form1040ScheduleFData/FarmExpenses/
                        OtherExpenses/TotalPreproductivePeriodExpnss)">
                  f
                  </xsl:if>
											</td>
											<td class="styGenericDiv" style="width:50mm;height:4.5mm;" colspan="2">
              ...
              f
										...
										<td class="styLNRightNumBoxNBB" style="height:4.5mm;width:7.25mm;border-top-width: 1px">
              34f
            </td>
        ...
        Cat. No. 11346H 
						...
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule F (Form 1040) 2010 </span>
						</div>
					</div>
					<!--Begin Page 2 -->
					<!-- Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule F (Form 1040) 2010 <span style="width:130mm;"/>
						</div>
...
-->
					...
					<div style="width:187mm;">
						...
						<div class="stySmallText" style="width:46mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;">Schedule F (Form 1040) 2010</span>
						</div>
					</div>
					<br/>
					<br class="pageEnd"/>

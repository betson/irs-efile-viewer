	...
	<br/>
                ...
                <xsl:if test="count($FormData/ForeignPartnerInfo)&lt; 2  or ((count($FormData/ForeignPartnerInfo) &gt; 4) and ($Print = $Separated))">
                  <tr>
                    ...
                    <td class="styTableCell" style="border-right-width:0px;border-left-width:1px;border-color:black">
                      <span style="width:6mm"/>
                      <input type="checkbox" alt="alt" class="styCkbox" name="InitialReturn" id="FrgnCorpDoesNotHaveOfficeInUS">
		...
		Note: <span style="font-weight:normal; padding-left:2mm">
          ...
          <div class="styBB" style="width:187mm;border-top-width:1px;">
            <div class="styPartName" style="width:23mm;height:7mm">Part II</div>
                ...
                <xsl:for-each select="$FormData/ForeignPartnerInfo">
                  <xsl:if test="position() mod 4 = 1">
                    ...
                    <tr>
                      ...
                      <td class="sty1120FSchPTableK1Desc" scope="row">
											Interest expense directly allocable under Temporary Regulations section1.882-5(a)(1)(ii)(B).<span style="width:2mm"/>(<b>Note: </b> Include the line 14b total on Schedule I, line 22.) <span class="sty1120FSchPDotLn">.........</span>
                      </td>

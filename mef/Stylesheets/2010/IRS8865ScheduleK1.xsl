							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									<td style="width: 93mm;">
										<div style="width: 93mm;">
											<!-- Width necessary to prevent table from shrinking --> <!-- Set year -->
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2010, or tax year beginning
        ...
        * See attached statement for additional information.
					...
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 1px solid black;">
							...
							<span style="width: 1mm;"/>
							<span style="width: 43mm;">Schedule K-1 (Form 8865) 2010</span>
						</td>
					</tr>
				</table>

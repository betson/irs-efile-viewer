...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      Form <span class="styFormNumber" style="font-size:18pt">1120-PC</span>
        ...
        <span style="width: 18mm;border-bottom:1 solid black;">
									...
									<!-- <xsl:call-template name="TaxYearBeginning"></xsl:call-template>-->
								</span>, and
        ending 
        <span style="width: 18mm;border-bottom:1 solid black;">
									<!-- No need to send the parameters -->
						...
						<div class="styBB" style="border-right-width:1px;border-bottom-width:0px;">
      					...
      					Check if: <span style="width:3mm;"/>
      						...
      						Final return
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120PCData/namechange"/>
										<xsl:with-param name="BackupName">IRS1120FinalReturn</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
		...
		<!-- Form to Form Link (Push Pin) -->
		          ...
		          <span style="width:16px"/>.
						...
						<div style="width:181mm;">
							<div style="float:left; clear:none;">
								...
								<div class="styLNDesc" style="width:53mm;height:4mm;font-size:6pt;"> 2010 estimated tax payments (see instructions)</div>
						...
						<div style="width:181mm;">
							<div style="float:left;clear:none;">
								<div class="styLNLeftLtrBox" style="height:4mm;padding-left: 4.25mm;">d</div>
								<div class="styLNDesc" style="width:93mm;height:4mm;"> 2010 special estimated tax payments (Do not include on line 14f)</div>
							</div>
							<div style="float:right;clear:none;">
						...
						<div style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:53mm;height:4mm;font-size:6pt;">2010 refund applied for on Form 4466
								   	  <!-- Form to Form Link (Push Pin) -->
									<xsl:call-template name="SetFormLinkInline">
				...
				<span style="width:16px"/>.
          		...
          		<!--span style="width:17px;vertical-align:top;"-->
					...
					<!-- Implementing the Preparer section in table -->
						...
						<tr>
							<td rowspan="3" style="width:18mm;font-size:10pt;font-weight:bold;font-family:'arial narrow';border-right:1 solid black;vertical-align:top;padding-top:5mm;border-bottom:1 solid black;">Paid Preparer <br/> Use Only</td>
							<td style="width:32mm;border-bottom:1 solid black;solid black;border-right:1">
							
								<span style="width:33mm;padding-left:1mm;height:8mm;border-right:1 solid black;" class="styGenericDiv">Print/Type preparer’s name</span>
								
							</td>
							<td style="width:32mm;border-bottom:1 solid black;">
								<span style="width:33mm;padding-left:1mm;height:8mm;">Preparer's signature</span>
								
							</td>
							<td style="width:13mm;border-right:1 solid black;border-bottom:1 solid black;">
								<span style="width:2px;"/>
							</td>
            ...
            Date <br/>
							...
							<td style="width:22mm;border-right:1 solid black;border-bottom:1 solid black;padding-left:1mm;vertical-align:bottom;padding-bottom:.5mm;">
								<nobr>
									<label for="dummyid1">
										<xsl:call-template name="PopulateReturnHeaderPreparer">
            ...
            <br/>
						...
						<tr>
						<td colspan="5" style="border-right:1 solid black;border-bottom:1 solid black;padding-left:.5mm;">
							     <div style="width:25mm;">Firm’s name
                                     	<img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet"/> 		     
							...
							<td style="border-bottom:1 solid black;padding-left:1mm;">
							      <div style="width:25mm;">Firm’s EIN  
                                   	<img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet"/> 		     
							      </div>
              <xsl:call-template name="PopulateReturnHeaderPreparerFirm">
						...
						<tr>
							<td colspan="5" style="border-bottom:2px solid black;border-right:1 solid black;padding-left:.5mm;">
							     <div style="width:25mm;">Firm’s address
                                     	<img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet"/> 		     
       ...
       Cat. No. 64270Q 
        ...
        Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2010)
    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120-PC (2010)<span style="width:146mm;"/>
						</div>
    ...
    <span class="styNormalText">(see instructions)</span>
      	  ...
      	  832(b)(7)(A)) and unearned premiums of section 833 organizations (see instructions)
      	   <!--Dotted Line -->
								<span class="styBoldText">
                                       <span style="width:16px"></span>.
                                       <span style="width:16px"></span>.
          ...
          <!--Dotted Line -->
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none:">
							...
							<div class="styLNDesc" style="height:8mm;">
								<b>Special deduction.</b> If you checked "No" on line 14 of Schedule I, enter -0- here, you cannot take the special deduction.  All others subtract line 5 from line 4. If zero or less, enter -0-. Enter amount here and on Schedule A, line 34a. (See instructions for limitation.)
          <!--Dotted Line -->
								<span class="styBoldText">
									<span style="width:16px"/>.
                                     <span style="width:16px"/>.
						...
						<table class="styDepTbl" style="font-size:6pt;" cellspacing="0">
							<thead class="styTableThead" style="border-color: black; font-size: 7pt;">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:42mm;" rowspan="2" colspan="2">
               		(a) <span class="styNormalText">Description of capital <br/>asset</span>
									</th>
									<th class="styDepTblCell" style="width:15mm;" rowspan="2">
                    	(b) <span class="styNormalText">Date<br/>acquired</span>
									</th>
									...
									<th class="styDepTblCell" style="width: 26mm;border-right-width: 0px;">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/RentalActivityTaxesExpenseStmt" />
  
  <!-- Template to display Itemized Other Deductions Schedule  -->
  
  <xsl:template name="ShowDependencyData">
    <!--Itemized Other Deductions Schedule Data -->
    <table class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">      
           <th class="styDepTblCell" scope="col" style="width:152mm">Activity type</th>
           <th class="styDepTblCell" scope="col" style="width:35mm">Amount</th>             
        </tr>
      </thead>
        <tfoot></tfoot>
       <tbody>
        <xsl:for-each select="$DependencyData/RntlActyTaxesExpense">
          <tr>
            ...
            <td class="styDepTblCell" style="width:152mm;text-align:left">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ActivityType"/>
              </xsl:call-template>
            </td> 

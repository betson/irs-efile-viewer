  ...
  <xsl:template match="/">
    <html lang="EN-US">
      ...
      Form <span class="styFormNumber">1120</span>
              ...
              <!--REMOVE in 6.2_Drop 1 <xsl:call-template name="LinkToLeftoverDataTableInline">
        ...
        City or town, state, and ZIP code<br/>
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:.5mm">
            <div class="styComType" style="width:33mm;border-bottom:0px;border-right-width:1px">
              ...
              <div class="styGenericDiv" style="height:5mm;width:26mm;">
                <label>
				  ...
				  <!--NOTE: THIS PUSH PIN REFERENCE 1120ScheduleM3E&A ON 1120E&A NOT 1120 -->
				  <!-- Form to Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" select="$Form1120Data/ScheduleM3Attached"/>
                  </xsl:call-template>
            ...
            <input type="checkbox" alt="alt" class="styCkbox">
              <!--NOTE: NOT VALID FOR 1120E&A <xsl:call-template name="PopulateCheckbox">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:.5mm">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <span style="float:left;">Cost of goods sold (Schedule A, line 8) </span>
                <!--Dotted Line-->
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:132mm;">
              <span style="float:left;">Compensation of officers (Schedule E, line 4) </span> 
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">..................</div>
			  </div>
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:8mm;height:4.5mm;"/>
              <div class="styLNDesc" style="width:84.25mm;">
                <span style="float:left;">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:7.5mm;">2009 overpayment credited to 
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:8.5mm;font-size:7pt;">2010 estimated tax payments
				<span style="width:2px;"/>
                <!-- Form to Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:46mm;height:7.5mm;font-size:7pt;">2010 refund applied for on Form 
                <span style="float:left;">4466 </span> 
                <!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">..........</div>
              </div>
            ...
            <!-- line 32f1--><!--NOTE: This line is differenet from 1120 -->
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div style="width:181mm;float:right;clear:none;height:4.5mm;">
                ...
                <div class="styLNRightNumBoxNBB" style="width:8.2mm;height:4.5mm;border-right-width:1px;background-color:lightgrey;"/>
              </div>
            </div>
            <!-- Line 32g -->
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:92mm;height:4.5mm;">Refundable credits from Form 3800, line
                19c, and Form 8827, line 
                <span style="float:left;">8c
                  <xsl:call-template name="SetFormLinkInline">
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:132mm;">
                ...
                <span class="styBoldText">Amount owed.</span> If line 32h is smaller than the total of lines
				  31 and 33, enter amount owed. </span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
			  </div>
            ...
            <div style="width:181mm;float:right;clear:none;">
              ...
              <div class="styLNDesc" style="width:132mm;">
                ...
                <span class="styBoldText">Overpayment.</span> If line 32h is larger than the total of lines
			      31 and 33, enter amount overpaid </span>
                <!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
              </div>
    ...
    May the IRS discuss this return<br/> with the preparer shown below <br/>(see instructions)?
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2010)
    </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 1120 (2010)<span style="width:148mm;"/>
            </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:178mm;height:4.5mm;padding-top:1.5mm;">Check all methods used for valuing closing inventory: </div>
          </div>
        ...
        Other (Specify method used and attach explanation.)
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="height:7mm;">
			  ...
			  <span style="float:left;">inventory computed under LIFO </span> 
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;">........................</div>
			</div>
            <div class="styGenericDiv" style="width:36mm;height:3mm;"/>
            <div style="float:right;">
          ...
          <!--Schedule A, line 9e -->
          <div style="width:187mm;">
            <div class="styLNLeftLtrBox" style="height:4.5mm;padding-top:1.5mm;padding-left:4mm;">e</div>
            <div class="styLNDesc" style="width:153mm;height:4.5mm;padding-top:1.5mm;">
			  <span style="float:left;">If property is produced or acquired for resale, do the rules of section 263A apply to the corporation? </span> 
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
            </div>
            <div style="float:right;">
        ...
        No
          ...
          <table class="styTable" style="font-size:7pt;border-bottom:1 solid black;width:187mm;padding-top:0mm;" cellspacing="0">
            ...
            <!--Schedule C, line 1 -->
              <tr>
                <td class="styLNLeftNumBoxSD" style="height:7mm;">1</td>
                <td class="styLNDesc" style="width:84mm;height:7mm;">
                  Dividends from less-than-20%-owned domestic corporations <span style="float:left;">(other than debt-financed stock) </span> 
				  <!--Dotted Line-->
              ...
              <!--Schedule C, line 2 -->
              <tr>
                <td class="styLNLeftNumBoxSD" style="height:7mm;padding-left:2.5mm;">2</td>
                <td class="styLNDesc" style="width:84mm;height:7mm;">Dividends from 20%-or-more-owned domestic corporations 
              ...
              <!--Schedule C, line 3 -->
              <tr>
                <td class="styLNLeftNumBoxSD" style="height:5mm;padding-top: 1.5mm;">3</td>
                <td class="styLNDesc" style="width:84mm;height:5mm;padding-top: 2mm">
                  <span style="float:left;"><span class="stySmallText">Dividends on debt-financed stock of domestic
					  and foreign corporations</span></span>
                  <!--Dotted Line-->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
                </td>
              ...
              <!--Schedule C, line 5 -->
              <tr>
                <td class="styLNLeftNumBoxSD" >5</td>
                <td class="styLNDesc" style="width:84mm;">Dividends on certain preferred stock of
				  20%-or-more-owned 
                ...
                <td class="styIRS1120LNPercentBox" style="vertical-align:bottom;">48</td>
              ...
              <!--Schedule C, line 6 -->
              <tr>
                <td class="styLNLeftNumBoxSD" style="height:7mm;">6</td>
                <td class="styLNDesc" style="width:84mm;height:7mm;">Dividends from less-than-20%-owned foreign corporations and 
              ...
              <!--Schedule C, line 7 -->
              <tr>
                <td class="styLNLeftNumBoxSD" style="height:7mm;">7</td>
                <td class="styLNDesc" style="width:84mm;height:7mm;">Dividends from 20%-or-more-owned foreign corporations and 
                  <span style="float:left;">certain FSCs </span> 
				  <!--Dotted Line-->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
                </td>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:84mm;font-size:7pt;">
                ...
                <td class="styIRS1120LNPercentBox" style="vertical-align:bottom;">100</td>
                <td class="styLNAmountBox" style="width:40mm;vertical-align:bottom;" colspan="2">
                  <span style="width:1px;"/>
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:84mm;height:7mm;">
                  <span class="stySmallText">Dividends from domestic corporations received by a small business investment 
				    ...
				    <span style="float:left;">1958 </span> 
				    <!--Dotted Line-->
				    <span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
                  </span>
                </td>
          ...
          <div class="styBB" style="width:187mm;float:none;clear:none;border-top-width:1px;">
            ...
            <div class="styPartDesc" style="width:160mm;height:8mm;">Compensation of Officers
              ...
              <span class="styItalicText" style="font-size:7pt;font-weight:normal;">
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD" >3</div>
            <div class="styLNDesc" style="width:146mm;">
              <span style="float:left;">Compensation of officers claimed on Schedule A and elsewhere on return </span> 
			  <!--Dotted Line-->
			  <span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
            </div>
            <div class="styLNAmountBox" >
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:.5mm">
            <div class="styLNLeftNumBoxSD" >4</div>
            <div class="styLNDesc" style="width:146mm;">
              <span style="float:left;">Subtract line 3 from line 2. Enter the result here and on page 1, line 12 </span>      
			  <!--Dotted Line-->
			  <span class="styDotLn" style="float:right;padding-right:1mm;">.............</span>
            </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:139mm;height:4.5mm;padding-top:.5mm;">
                ...
                <span style="width:4mm;padding-top:1mm;">
                  <input type="checkbox" alt="alt" class="styCkbox">
                    <!--NOTE: ELEMENT NAME FOR THIS CHECK BOX IS DIFFERENT FROM 1120 -->
                    <xsl:call-template name="PopulateCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/PersonalServiceCorporation"/>
                      <xsl:with-param name="BackupName">IRS1120ScheduleJPersonalServiceCorp</xsl:with-param>
                    </xsl:call-template>
                    <!--NOTE: ELEMENT NAME FOR THIS AMOUNT IS DIFFERENT FROM 1120 -->
                  </input>
                </span>
              </div>
            </div>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD" >4</div>
            <div class="styLNDesc" style="width:167mm;">At the end of the tax year:
          </div>
            <div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
            <div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
          </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              ...
              <span style="float:left;">the corporation’s stock entitled to vote? If "Yes," complete Part I of Schedule G (Form 1120) (attach Schedule G)
                <!-- Form to Form Link -->
                <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              ...
              all classes of the corporation’s stock entitled to vote? If "Yes", complete Part II of Schedule G (Form 1120) (attach Schedule 
          ...
          <div style="width:187mm;height:4.5mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;">a</div>
            <div class="styLNDesc" style="width:167mm;height:4.5mm; ">
              Own directly 20% or more, or own, directly or indirectly, 50% or more of the total voting power of all classes of stock entitled to vote of any
              foreign or domestic corporation not included on <b>Form 851,</b> Affiliations Schedule? For rules of constructive 
            </div>
            <div class="styGenericDiv">
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;padding-top:0px;"></div>
          ...
          <div  style="width:187mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;">b</div>
            <div class="styLNDesc" style="width:167mm;height:4.5mm;">
              Own directly an interest of 20% or more, or own, directly or indirectly, an interest of 50% or more in any foreign or domestic 
            ...
            <div class="styGenericDiv">
              <div class="styIRS1120LNYesNoBox" style="height:11mm;padding-top:7.5mm;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateYesBoxText">
              ...
              <div class="styIRS1120LNYesNoBoxRB" style="height:11mm;padding-top:7.5mm;border-right-width:0px;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateNoBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/CorpOwnPercentPartnership"/>
                  </xsl:call-template>
          ...
          <div style="width:187mm;">
            ...
            <div class="styGenericDiv">
              <div class="styIRS1120LNYesNoBox" style="width:6mm;height:8mm;padding-top:4mm;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateYesBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/ExcessDividendsPaid"/>
                  </xsl:call-template>
              ...
              <div class="styIRS1120LNYesNoBoxRB" style="width:6mm;height:8mm;padding-top:4mm;border-right-width:0px;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateNoBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/ExcessDividendsPaid"/>
                  </xsl:call-template>
          ...
          <!-- BEGIN Schedule K, Line 6 row 3 and 4-->
          <div style="width:187mm;">
          ...
          <!-- BEGIN Schedule K, Line 7 row 1 and 2-->
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;height:4.5mm; ">
			  ...
			  <span style="float:left;">all classes of the corporation’s stock entitled to vote or <b>(b)</b> the total value of all classes of the corporation’s stock? </span> 
		      <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
            </div>
            <div class="styGenericDiv">
              <div class="styIRS1120LNYesNoBox" style="height:7mm;padding-top:3.5mm;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateYesBoxText">
              ...
              <div class="styIRS1120LNYesNoBoxRB" style="height:7mm;padding-top:3.5mm;border-right-width:0px;border-bottom-width:1px;">
                <span style="font-weight:normal;">
                  <xsl:call-template name="PopulateNoBoxText">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/ForeignOwn25PercentStock"/>
                  </xsl:call-template>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" >12</div>
            <div class="styLNDesc" style="width:167mm;font-size:6pt; ">
              Enter the available NOL carryover from prior tax years (do not reduce it by any deduction on line 29a.)
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3px;">$</span>
              <span style="border-bottom:1 solid black;width:32mm;text-align:right;font-size:7pt;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" >13</div>
            <div class="styLNDesc" style="width:167mm;">
			  Are the corporation’s total receipts (line 1a plus lines 4 through 10 on page 1) for the tax year <b>and</b> its total assets at the end 
			  <span style="float:left;">of the tax year less than $250,000? </span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">..............................</div>
              <div style="width:167mm;font-size:6pt;padding-top:1mm;">
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;">
              ...
              <div style="width:167mm;">
                 ...
                 <!--Per R6.2 D4 and DD4 there is no push pin for this line<xsl:call-template name="SetFormLinkInline">
          ...
          <div class="styBB" style="width:187mm;clear:both;">
            ...
            <table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              ...
              <tbody>
                ...
                <tr> <!-- Schedule M-1, Line 5c-->
                  <td class="styLNLeftNumBoxSD" style="vertical-align:top;">
            ...
            <table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              ...
              <tfoot/>
              <tbody>
                <tr class="styGenericDiv"> <!-- Schedule M-1, Line 7-->
                ...
                <tr class="styGenericDiv"> <!-- Schedule M-1, Line 8-->
                ...
                <tr class="styGenericDiv"> <!-- Schedule M-1, Line 10-->
      ...
      (Line 25, Schedule L)
          ...
          <div style="width:187mm;clear:both;" class="styBB">
            ...
            <table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              <tr class="styGenericDiv"> <!-- Schedule M2, line 1 -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;">1</td>
                <td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 2 -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;">2</td>
                <td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
                  <span style="float:left;">Net income (loss) per books </span> 
				  <!--Dotted Line-->
              ...
              <!-- line 3 Sch M-2 -->
              <tr class="styGenericDiv"> <!-- Schedule M2, line 3 -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;">3</td>
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 4 -->
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 4 row 2-->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;border-bottom-width:2px;"></td>
                <td class="styGenericDiv" style="width:52mm;height:4.5mm;" colspan="2">
                </td>
            ...
            <table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              <tr class="styGenericDiv"><!-- Schedule M2, line 5a -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;">5</td>
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 5b -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;"/>
                <td class="styGenericDiv" style="width:20mm;height:4.5mm;"/>
                <td class="styGenericDiv" style="width:32mm;height:4.5mm;">
                  <span style="float:left;">
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 5c -->
                <td class="styLNLeftNumBoxSD" style="height:4.5mm;"/>
                <td class="styGenericDiv" style="width:20mm;height:4.5mm;"/>
                <td class="styGenericDiv" style="width:32mm;height:4.5mm;">
                  <span style="float:left;">
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 6 -->
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 7 -->
              ...
              <tr class="styGenericDiv"> <!-- Schedule M2, line 8 -->
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2010)
        ...
        Additional Data        
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 9 - Form 8693 Approved Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TotalOtherTaxes/@f8693ApprovedIndicator"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 9 - Form 8693 Approval Date</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TotalOtherTaxes/@f8693ApprovalDate"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 9 - Form Section1260B Indicator </xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TaxFromForm4255/@section1260BIndicator"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 9 - Form Section1260B Amount </xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TaxFromForm4255/@section1260BAmount"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">

		...
		<html>
           ...
           the appropriate 720 stylesheet template to call -->
					<xsl:choose>
						...
						<xsl:when test="($Version = '2010Q1v1.0') or ($Version = '2010Q1v1.1')"><!--or ($Version = '2009Q1v1.1') or ($Version = '2009Q1v1.2') or ($Version = '2009Q1v1.3')-->
      ...
      <td style="text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" scope="col">  
        ...
        Form <span class="styBoldText" style="font-size:8pt;">720</span> (Rev. 01-2010)
					...
					<tr>
						...
						<th style="text-align: center; border-color: black; border-style: solid; border-top-width: 0px; border-right-width:1px; border-left-width:0px; border-bottom-width:0px;font-weight:normal;width:50mm font-size:6pt" scope="col">
    ...
    Form 720 (Rev. 01-2010)
		...
		<div class="styBB" style="width:187mm;">
			<table cellspacing="0" style="font-size:7pt;">
				<tbody>
					<tr style="padding-top:2mm;padding-bottom:2mm">
						<th style="width:8mm;text-align:center;vertical-align:center;padding-top:2mm;padding-bottom:2mm;font-size:8pt">13</th>
...
mixture was sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant.		</div>
		...
		<div style="width:187mm; " >
			<table cellspacing="0" style="font-size:7pt;">
				<tbody>
					<tr>
						<th class="styIRS720TableCellLineNumber" style="width:8mm;border-top-width:0px;border-right-width:0px;font-size:8pt;padding-right:1mm;vertical-align:bottom" rowspan="2"></th>
						<th class="styIRS7204BoldTableHeaderCell" style="width:95mm;border-left-width:0px;font-weight:normal;text-align:left;vertical-align:bottom;border-bottom-width:1px" rowspan="2">
							<br/>Liquefied hydrogen)</th>
						<th class="styIRS7204BoldTableHeaderCell" style="width:16mm;border-bottom-width:1px">Rate</th>
						<th class="styIRS7204BoldTableHeaderCell" style="width:23mm;font-size:7pt;border-bottom-width:1px">Gallons or<br/>gasoline gallon<br/>equivalents (GGE)<br/>
		...
		<div class="styBB" style="width:187mm">
			<table cellspacing="0" style="font-size:7pt">
				<tbody>
					<tr style="padding-top:2mm;padding-bottom:2mm;">
			     <th style="width:8mm;text-align:center;vertical-align:center;padding-top:2mm;padding-bottom:2mm;font-size:8pt;k">14</th>
						<th style="width:179mm;text-align:left;font-size:8pt">Other Claims. <span style="font-weight:normal">See the instructions. For lines 14b and 14c, see the <b>Caution</b> above line 1 on page 5.</span>
						</th>
					</tr>
				</tbody>
			</table>
		...
		<div style="width:187mm">
			<table cellspacing="0" style="font-size:7pt">
				<tbody>
					...
					<tr>
						<td class="styIRS720TableCellAmount" style="font-size:7pt;padding-right:3px">
							<div style="float:left;clear:none">$</div>
							<xsl:call-template name="PopulateAmount">
 ...
 <xsl:call-template name="SetFormLinkInline">
            ...
            <xsl:call-template name="SetFormLinkInline">
					...
					<tr>
						<td class="styIRS720TableCellLineNumber" style="border-bottom-width:0px;border-right-width:0px;font-size:8pt;padding-right:1mm;vertical-align:top">h</td>
						<td class="styIRS720NameTableCell" scope="col">Taxable tires, super single tires designed for steering              <xsl:call-template name="SetFormLinkInline">
		...
		<div style="width:187mm">
			<table cellspacing="0" class="styBB" style="font-size:7pt">
				<tbody>
					<tr>
						<th class="styIRS720LineNumber" style="width:8mm">15</th>
						<th class="styIRS720RightBorder" style="width:128mm;font-size:6pt;font-weight:normal;text-align:left;padding-left:1mm">
							<b>Total claims. </b>Add all amounts on lines 1-14. Enter the result here and on page 2, Part III, line 4 of Form 720.</th>
						<th class="styIRS720RightBorder" style="width:6mm;font-weight:bold;text-align:center;font-size:8pt;padding-top:0.5mm">15</th>

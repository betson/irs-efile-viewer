        ...
        <form name="Form6627">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:21mm;padding-top:2mm;">
              ...
              <br/>      
              <span class="styAgency" style="font-weight:normal;padding-top:1.5mm;">(Rev. January 2010)<br/> Department of the Treasury</span><br /><span class="styAgency" style="font-weight:normal;padding-top:1.5mm;">Internal Revenue Service</span>
            </div>
              ...
              <tbody>
                <tr>
                  <th class="styTableCell" style="width:94mm;border-right-width:0px" scope="col">
                    ...
                    <div class="styPartDesc" style="width:80mm;">Tax on Petroleum</div>
                  </th>
                ...
                <tr>
                  ...
                  <td class="styTableCell" style="width:17mm;text-align:center;padding-top:10mm">
                    <span style="padding-left:.5mm;float:left;clear:none">$</span>
                    <xsl:call-template name="PopulateText">

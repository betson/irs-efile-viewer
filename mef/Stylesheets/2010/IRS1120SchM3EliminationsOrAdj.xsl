...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      Cat. No. 37961C 
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule M-3 (Form 1120) 2010</span>
						</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1120) 2010</div>
              ...
              TotalIncomeLossItems/IncomeLossPerTaxReturn"/>
						...
						<tr>
							...
							<td>
								...
								<span style="font-weight:normal"> (from Part III, line 38)</span>
							</td>
							<td class="styIRS1120ScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/
...
lines 26 through 28
         ...
         Line 30, column (a), must equal the amount on Part I, line 11, and column (d) must equal Form 1120, page 1, line 28.</div>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120) 2010</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styBB" style="width:187mm;">
          ...
          Name of corporation (common parent, if consolidated return)<br/>
					...
					<xsl:variable name="consolidatedGroup2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/ConsolidatedGroup2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- Defined to resolve ID conflict for ParentCorporation2-->
					<xsl:variable name="parentCorporation2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/ParentCorporation2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- Defined to resolve ID conflict for ConsolidatedEliminations2-->
					<xsl:variable name="consolidatedEliminations2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/ConsolidatedEliminations2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- Defined to resolve ID conflict for SubsidiaryCorporation2-->
					<xsl:variable name="subsidiaryCorporation2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/SubsidiaryCorporation2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- Defined to resolve ID conflict for Mixed1120LPCGroup2-->
					<xsl:variable name="mixed1120LPCGroup2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/Mixed1120LPCGroup2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- Defined to resolve ID conflict for Is1120Group2-->
					<xsl:variable name="is1120Group2BaseID">
						<xsl:call-template name="PopulateID">
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/IncomeLossItems/Is1120Group2"/>
						</xsl:call-template>
					</xsl:variable>
					<!-- start check box line1  -->
					<div style="width:187mm;font-size:6pt;">
           	...
           	Check applicable box(es): <span style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(1)</span>
							...
							/ConsolidatedGroup2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($consolidatedGroup2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
           	...
           	<span style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(2)</span>
							...
							ParentCorporation2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($parentCorporation2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
           	 ...
           	 Parent corp  <span style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(3)</span>
							...
							ConsolidatedEliminations2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($consolidatedEliminations2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
           	...
           	<span style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(4)</span>
							...
							SubsidiaryCorporation2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($subsidiaryCorporation2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
						...
						<div class="styGenericDiv" style="padding-left:1px;;">
							...
							Mixed1120LPCGroup2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($mixed1120LPCGroup2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
           	...
           	Check if a sub-consolidated: <span style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(6)</span>
							...
							Is1120Group2"/>
								...
								<xsl:attribute name="id">
									<xsl:value-of select="concat($is1120Group2BaseID, '[2]')"/>
								</xsl:attribute>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
						...
						<tr>
							...
							<td>Research and development costs (attach schedule)
							  <!-- Form Link -->
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/
              ResearchAndDevelopmentCosts/OtherExpnsDedItemsDifferences"/>
								</xsl:call-template>
          <span class="styDotLn" style="float:none;padding-left:3mm;">..</span>
							</td>
							<td class="styIRS1120ScheduleM3Cell">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/NoninsuranceDeductionsSchedule" />
<!-- Display Document name Noninsurance Deductions Schedule -->
  <!-- Main template begin -->
  ...
  <xsl:template match="/" >
    ...
    <html>
	  ...
	  <!--table begin -->      
      	...
      	<xsl:for-each select="$DependencyData/NoninsuranceDeductions">
        		<tr>

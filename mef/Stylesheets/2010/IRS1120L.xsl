...
<div class="styLNDesc" style="width:92mm;height:4.5mm;">
   2010 special estimated tax payments<i> (Do not include on line 29f)</i>
</div>
...
<div class="styLNDesc" style="width:56mm;font-size:7pt;">
    Less 2010 refund applied for on Form 4466
<span style="width:2px;"/>
</div>
...
<span style="width:40px;"/>  
 Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2010)
</div>
</div>
...
<div style="float:left;">Form 1120-L (2010)<span style="width:148mm;"/>
</div>
...
<xsl:with-param name="BackupName">IRS1120ScheduleKMethodOfAccountingMutualCompany</xsl:with-param>
</xsl:call-template>
</input>
<label>
<xsl:call-template name="PopulateLabel">

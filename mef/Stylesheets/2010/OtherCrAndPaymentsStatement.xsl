...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherCrAndPaymentsStatement" />
<!-- Display Document name Other Credits and Payments Statement -->
  <!-- Main template begin -->
  ...
  <xsl:template match="/" >
    ...
    <html>
	  ...
	  <!--table begin -->      
      	...
      	<xsl:for-each select="$DependencyData/OtherCreditsAndPayments">
        		<tr>

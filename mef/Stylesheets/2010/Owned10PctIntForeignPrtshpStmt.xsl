...
<!--          <td class="styDepTblCell" align="left" valign="top"> -->
        <td class="styDepTblCell" style="text-align:center;witth:21mm">  
          ...
          <td class="styDepTblCell" align="left" valign="top">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="FormsFiled" /></xsl:call-template> 
          </td>
          <td class="styDepTblCell" align="left" valign="top" style="width:39mm;">            
          ...
          <td class="styDepTblCell" align="center" valign="top">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="BeginningDateOfTaxYear" /></xsl:call-template> 
          </td>
          <td class="styDepTblCell" align="center" valign="top">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="EndingDateOfTaxYear" /></xsl:call-template> 
          </td>
        </tr>
      </xsl:for-each>
      </tbody>    

...
<!--General Dependency Push Pin -->
          ...
          See separate instructions.
						...
						<div class="styTYBox" style="width:30mm;height:19mm; border-left-width: 1px">
							...
							<div class="stySequence" style="padding-top:1mm;">Attachment<br/>Sequence No. <b>126</b>
							</div>
						</div>
					</div>
...
-->
        ...
        Check the box if you are electing under section 942(a)(3) to exclude a portion of your gross receipts from foreign trading <br/>
								<span>
...
Check the box if you are electing to apply the extraterritorial income 
 exclusion provisions to certain transactions involving<br/>
								<span>
									<span style="float:left;">
										<label>
											<xsl:call-template name="PopulateLabel">
      ...
      border-bottom-width: 1px; border-right-width: 0px; border-left-width: 0px">
					...
					<div style="width: 187mm">
						<div class="styIRS8873LongLNDesc" style="margin-left: 4mm">
...
<span>
 ...
 United States</span>
      ...
      attributable to foreign economic processes. <span class="styBoldText"> Do not </span>include any amounts already<br/>
							<span>
								<span style="float:left;">
...
Other expenses and deductions (see instructions) (attach schedule)
					...
					<div style="width: 187mm">
						...
						<div class="styIRS8873ShortLNDesc">
							<span class="styBoldText">Foreign trade income. </span> In column (a), subtract line 19 from line 18. If -0- or less,<br/>
							<span>
								<span style="float:left;">
...
Multiply line 38 by 2.0
      ...
      Multiply line 43 by 30% (.30)
					...
					<div style="width: 187mm">
						...
						<div class="styIRS8873MedLNDesc">
      Enter the <span class="styBoldText">greatest</span> of lines 33, 36, 38, 42, or 44. If you are using the alternative computation, see<br/>
							<span>
								<span style="float:left;">
      ...
      Reduction for international boycott operations, illegal bribes, kickbacks, etc. (see instructions)
					...
					<div style="width: 187mm">
						...
						<div class="styIRS8873MedLNDesc">
							<span class="styBoldText">Qualifying foreign trade income. </span>Subtract line 50 from line 49. If -0- or less, stop here. You do not<br/>
							<span>
								<span style="float:left;">

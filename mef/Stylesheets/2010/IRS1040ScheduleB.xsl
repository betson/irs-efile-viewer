		...
		<html lang="EN-US">
         ...
         Internal Revenue Service (99)
						...
						<div class="styFTBox" style="width:127mm;height:18mm; ">
							<div class="styMainTitle" style="height:4mm;margin-top:3mm;">Interest and Ordinary Dividends  
        <div class="styFBT" style="height:1mm;font-size:7pt;margin-top:.5mm;">    
          </div>
							</div>
							<div class="styFBT" style="height:3mm;margin-top:3mm;font:size:6pt;width:127mm;">
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Bullet Image"/> Attach to Form 1040A or 1040.
       <span style="width:15mm;">
       </span>
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Bullet Image"/>  See instructions on back.       
        </div>
						</div>
          ...
          Attachment<br/>Sequence No. <span class="styBoldText">08</span>
            ...
            Name(s) shown on return <br/>
						...
						<!--SSN-->
						<div class="styEINBox" style="width:44mm;padding-left:2mm;font-size:7pt;">
            Your social security number<br/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							<div style="width:27.5mm;float:left;clear:none;border-bottom-width: 0px;">
								<div class="styFMT" style="padding-top:2mm;font-size:12pt;height:7mm;font-family:Arial">Part l<br/><br/>
                Interest
                </div>
                ...
                on back and the<br/>
                  ...
                  line 8a.)   
								...
								<br/>
								<div style="padding-top:2mm;width:27.5mm;">
									<b>Note.</b> If you<br/>
                  received a Form<br/>
                  1099-INT, Form<br/>
                  1099-OID, or<br/>
                  ...
                  form.
							...
							<div style="width:159mm;float:left;clear:none;border-bottom-width: 1px;" id="part1ContainerId">
								<!-- print logic -->
								<!-- end -->
								...
								<table class="styTable" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends " name="INORDtable" id="INORDtable">
									<thead class="styTableThead">
										<!--Line 1-->
										<th class="styTableCell" scope="col" rowspan="2" style="border-right-width:0px;border-bottom-width:0px;width:6mm;padding-bottom:0mm;vertical-align:top">
											<span class="styBoldText" style="font-size:7pt;padding-right:1mm;">1</span>
										</th>
										<th class="styTableCell" scope="col" rowspan="2" style="width:114mm;border-bottom-width:0px;text-align:left;">
                       ...
                       Amount
											...
											<xsl:for-each select="($FormData/Form1040SchBPartIGroup1) ">
												<tr>
													...
													<td class="styTableCell" style="width:114mm;height:4mm;text-align:left;border-top-width:1px;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="SellerFinancedName"/>
															<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedName</xsl:with-param>
														</xsl:call-template>
														<br/>
														...
														<xsl:if test="SellerFinancedAddressUS != ''">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressUS/AddressLine1"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressUSAddressLine1</xsl:with-param>
															</xsl:call-template>
															<br/>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressUS/AddressLine2"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressUSAddressLine2</xsl:with-param>
															</xsl:call-template>
															<br/>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressUS/City"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressUSCity</xsl:with-param>
															</xsl:call-template>    
                                 ,<span style="width:1mm;">
                              </span>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressUS/State"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressUSState</xsl:with-param>
															</xsl:call-template>
															<span style="width:1mm;"> 
                                    </span>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressUS/ZIPCode"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressUSZIPCode</xsl:with-param>
															</xsl:call-template>
														</xsl:if>
														<xsl:if test="SellerFinancedAddressForeign != ''">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/AddressLine1"/>
															...
															<br/>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/AddressLine2"/>
															...
															<br/>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/City"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressForeignCity</xsl:with-param>
															</xsl:call-template>
                               ,<span style="width:1mm;">
                              </span>
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/ProvinceOrState"/>
															...
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/PostalCode"/>
																<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressForeignPostalCode</xsl:with-param>
															</xsl:call-template>
														</xsl:if>
														<span style="width:2mm;">
                             </span>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="SellerFinancedAddressForeign/Country"/>
															<xsl:with-param name="BackupName">IRS1040ScheduleBForm1040SchBPartIGroup1SellerFinancedAddressForeignCountry</xsl:with-param>
														</xsl:call-template>
													</td>
													<!-- Column 3 -->
							...
							<div style="width:187mm;border-bottom-width: 0px;">
								...
								<!--End of toggle-->
								<div style="float:left;clear:none;border-bottom-width: 1px;border-top-width: 1px;" id="part2ContainerId">
									<!-- print logic -->
									<xsl:call-template name="SetInitialState"/>
									<table class="styTable" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends " id="PAYORTable" name="PAYORtable">
										<thead class="styTableThead">
											<th class="styTableCell" style="border-right-width:0px;border-bottom-width:0px;width:6mm;padding-bottom:2mm;vertical-align:top">
												<span class="styBoldText" style="font-size:7pt;">
                        </span>
											</th>
											<th class="styTableCellHeader" scope="col" rowspan="1" style="width:119mm;border-top-width:1px;text-align:left">
                  Payer
                  </th>
											<th class="styTableCellHeader" scope="col" rowspan="1" style="width:7mm;border-right-width:1px;border-top-width:1px;border-bottom-width:0px;">
												<span class="styTableCellPad">
                   </span>
											</th>
											<th class="styTableCellHeader" scope="col" rowspan="1" style="text-align:center;width:31.9mm;border-top-width:1px;border-left-width:0px;border-right-width:0px;">
										...
										<tbody>
											<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartIGroup2) &lt;= 14) ">
												<xsl:for-each select="$FormData/Form1040SchBPartIGroup2">
													<tr>
														...
														<td class="styTableCell" style="width:119mm;text-align:left">
															<xsl:call-template name="PopulateText">
														...
														<td class="styTableCell" style="width:31.9mm;border-right-width:0px;">
															<xsl:call-template name="PopulateAmount">
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup2) &lt; 1 or ((count($FormData/Form1040SchBPartIGroup2) &gt; 14) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:119mm;height:4mm;border-right-width:1px;text-align:left;">
														<xsl:call-template name="PopulateAdditionalDataTableMessage">
															<xsl:with-param name="TargetNode" select="$FormData/Form1040SchBPartIGroup2"/>
														</xsl:call-template>
														<span class="styTableCellPad">
													...
													<td class="styTableCell" style="width:31.9mm;height:4mm;border-right-width:0px;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
												</tr>
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup2) &lt; 2 or ((count($FormData/Form1040SchBPartIGroup2) &gt; 14) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:119mm;height:4mm;border-right-width:1px;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:7mm;height:4mm;border-right-width:1px;border-bottom-width:0px;">
			...
			<div class="styBB" style="width:187mm;border-bottom-width: 0px;">
				<div class="styLNLeftNumBox" style="width:27.5mm;border-bottom-width:0px;">
               </div>
				<div class="styLNLeftNumBox" style="padding-left:3mm;width:6mm;">2</div>
					<div class="styLNDesc" style="width:113.8mm;padding-left:1mm;">
									<span style="float:left;clear:none;">Add the amounts on line 1</span>
									<span class="styDotLn" style="padding-left:4mm;">..................</span>
					</div>
				<div class="styLNRightNumBox" style="border-top-width:0px;width:7.2mm;border-bottom-width: 1px;">
                  2
                  </div>
					<div class="styLNAmountBox" style="width:31mm;padding-right:0mm;border-top-width:1px;border-bottom-width: 1px;border-top-width:0px;">
							...
							<div class="styBB" style="width:187mm;border-bottom-width: 0px;padding-bottom:0mm;">
								<div class="styLNLeftNumBox" style="width:27.5mm;height:8mm;border-bottom-width:0px;padding-top:0mm;">
               </div>
								<div class="styLNLeftNumBox" style="padding-left:3mm;width:6mm;">3</div>
								<div class="styLNDesc" style="width:113.8mm;padding-left:1mm;float:left;clear:none">
                  ...
                  Attach Form 8815
                    <span class="styBoldText">
								...
								<div class="styLNRightNumBox" style="height:9mm;width:7.2mm;padding-top:3mm;">
                  3
                  </div>
								<div class="styLNAmountBox" style="height:9mm;width:31mm;padding-top:3mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- end line 3 -->
							<!-- Line 4 -->
							<div style="width:187mm;padding-top:0mm;border-bottom-width:0px;float:left;clear:none;">
								<div class="styLNLeftNumBox" style="width:27.5mm;height:8mm;border-bottom-width:0px;padding-top:0mm;">
               </div>
					<div class="styLNLeftNumBoxBB" style="padding-left:3mm;width:6mm;height:8mm;border-bottom-width:1px;text-align:left;">4</div>
								<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:113.8mm;padding-left:1mm;border-bottom-width:1px;height:8mm;">
                   ...
                   <span class="styBoldText">
								...
								<div class="styLNRightNumBox" style="border-bottom-width:1px;width:7.2mm;height:8mm;padding-top:2mm;">
                  4
                  </div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;width:31mm;height:8mm;padding-top:2mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- end line 4 -->
							<!-- Line 4 note -->
	<div style="width:187mm;float:left;clear:none;padding-bottom:0mm;border-bottom-width:1px;">
				<div class="styLNLeftNumBoxBB" style="padding-left:3mm;width:31.3mm;border-bottom-width:1px;height:5mm;"> </div>
                ...
                width:116.2mm;">
					...
					<div class="styLNRightNumBox" style="border-bottom-width:1px;width:7.2mm;height:5mm;">          
                  </div>
				...
				<div class="styGenericDiv" style="width:2mm;padding-top:.6mm;">
									<!-- button display logic --><span style="float:left;padding-left:2mm;">Amount</span>
									<xsl:call-template name="SetDynamicTableToggleButton">
		...
		<div class="styBB" style="width:187mm;">
				<div style="width:187mm;">
								<!-- Part II Left margin -->
		<div style="width:27.5mm;float:left;clear:none;border-bottom-width:0px;">
			<div class="styFMT" style="padding-top:2mm;font-size:12pt;font-family:Arial">Part ll<br/><br/>
                Ordinary
                Dividends
                </div>
			<div style="padding-top:1mm;width:27.5mm;">(See instructions<br/>
...
<!-- Line 5 Table -->
<!-- Generated Table (Start) -->
<div style="width:159mm;padding-top:0mm;float:left;clear:none;border-bottom-width:1px;" id="1040SchBPartII">
<!-- print logic -->
<xsl:call-template name="SetInitialState"/>
<!-- end -->
<table class="styTable" cellspacing="0" style="font-size:7pt;padding-top:0mm;" summary="Table displaying Ordinary Dividends" name="ODtable" id="ODtable">
				<thead class="styTableThead">
						<tr >
<th class="styTableCellHeader" scope="col"  rowspan="1" style="text-align:left;width:6mm;border-right-width:0px;border-bottom-width:0px;padding-top:0mm;">
													<span class="styBoldText" style="font-size:7pt;padding-left:3mm;">5</span>
</th>
<th class="styTableCellHeader" scope="col" rowspan="1" style="width:114mm;border-right-width:1px;text-align:left;">
						...
						<th class="styTableCellHeader" scope="col" rowspan="1" style="width:6.8mm;border-right-width:1px;border-bottom-width:0px;">
													<!-- uncomment and change table header literals here or use 'cellpad' -->
													<span class="styTableCellPad">
                        </span>
												</th>
						<th class="styTableCellHeader" scope="col" rowspan="1" style="width:31.3mm;border-bottom-width:1px;border-right-width:0px;border-top-width:1px;">
													<div class="styBoldText" style="font-size:7pt;width:30mm;border-top-width:1px;">
														<div style="width:26mm;padding-left:4mm;"></div>
													</div>
												</th>
											</tr>
										</thead>
						...
						<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartII) &lt;= 19) ">
												<xsl:for-each select="$FormData/Form1040SchBPartII">
													<tr>
														<!-- Column 1 -->
							<td class="styTableCell" style="width:6mm;height:4mm;border-right-width:0px;border-bottom-width:0px;text-align:left;">
															<span class="styBoldText" style="font-size:7pt;">
                               </span>
														</td>
							<!-- Column 2 -->
							<td class="styTableCellText" style="width:114mm;height:4mm;font-size:7pt;border-right-width:1px;text-align:left;">
															...
															<br/>
															<xsl:if test="$FormData/Form1040SchBPartII/DividendPayerNameBusiness/BusinessNameLine2">
																<xsl:call-template name="PopulateText">
																	<xsl:with-param name="TargetNode" select="DividendPayerNameBusiness/BusinessNameLine2"/>
							...
							<td class="styTableCell" style="width:6.8mm;height:4mm;border-right-width:1px;border-bottom-width:0px;">
															<xsl:choose>
																<xsl:when test="position() = 11">
																	<span style="padding-right:2mm;font-size:8pt;font-style:bold;">5</span>
																</xsl:when>
																<xsl:otherwise>
																	<span class="styTableCellPad"/>
																</xsl:otherwise>
							...
							<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 1 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
								...
								<div style="border-bottom-width: 0px;width:187mm;">
									<div style="width:27.5mm;float:left;clear:none;border-bottom-width:0px;"/>
									<div class="styLNLeftNumBoxBB" style="padding-left:2mm;width:4mm;height:5mm;border-bottom-width:1px;padding-bottom:3.3mm;border-top-width:0px;">6</div>
									<div class="styLNLeftNumBoxBB" style="width:115.4mm;padding-left:3mm;height:5mm;font-weight:normal;border-bottom-width:1px;border-top-width:0px;padding-top:0mm;">
                  Add the amounts on line 5. Enter the total here and on Form 1040A, or Form<br/>1040, line 9a .
                    <span class="styBoldText">
									...
									<div class="styLNRightNumBox" style="padding-top:3.2mm;border-bottom-width:1px;width:7.75mm;height:5mm;border-top-width:0px;">
                  6
                  </div>
									<div class="styLNAmountBox" style="border-bottom-width:1px;width:31mm;height:5mm;padding-top:3.2mm;">
										<xsl:call-template name="PopulateAmount">
									...
									<!-- end line 6 -->
									<!-- Line 6 note -->
									<div class="styBB" style="width:187mm;float:left;clear:none;padding-bottom:0mm;border-bottom-width:1px;">
                ...
                border-left-width: 0px; border-right-width: 0px;
                width:113mm;">
											<span style="float:left;clear:none;border-top-width:1px;">
												<span class="styBoldText">Note.</span> If line 6 is over $1,500, you must complete Part III.
                  </span>
										</div>
										<div class="styLNRightNumBox" style="border-left-width:0px;border-bottom-width:0px;width:7.75mm;">
                </div>
										<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;border-left-width:0px;">
						...
						<div style="width:187mm;">
							...
							<div style="width:28mm;float:left;clear:none;">
                ...
                and Trusts
								...
								<div style="padding-top:1mm;width:28mm;">(See<br/> instructions on <br/>back)
                </div>
							</div>
							<!-- end left margin -->
							<!--Yes and No heading-->
							<div class="styBB" style="padding-top:.5mm;height:8mm;width:141mm;float:left;clear:none;">
                You must complete this part if you<span class="styBoldText"> (a) </span>had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
							...
							<!-- end Yes No Boxes -->
							<!-- Line 7a text -->
							<div class="styBB" style="padding-top:0mm;width:158mm;border-bottom-width:0px;float:left;clear:none;">
								<div class="styLNLeftNumBox" style="padding-left:2mm;width:6mm;height:9mm;">7a</div>
								<div class="styLNDesc" style="width:135mm;height:9mm;">
									<span style="float:left;clear:none;">
                    At any time during 2010, did you have an interest in or a signature or other authority over a financial
               ...
               <xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Part III, Line 7 - Form 8814 Literal Code</xsl:with-param>
								...
								<div class="styBB" style="height:4mm;width:17mm;float:left;clear:none;border-bottom-width:0px;">
									<div class="styBB" style="height:6.8mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px;border-bottom-width:0px; ">
       </div>
									<div class="styBB" style="height:6.8mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px; border-bottom-width:0px;">
       </div>
								</div>
							...
							<!--end of 7a-->
							<!-- Line 7b text -->
							<div class="styBB" style="width:158mm;float:left;clear:none;border-bottom-width:0px;">
								<div class="styLNLeftNumBox" style="padding-left:4mm;width:7mm;">b</div>
								<div class="styLNDesc" style="width:134.2mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
                    If "Yes," enter the name of the foreign country
                      <span style="float:none;clear:none;padding-left:1mm;">
											<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
										</span>
										<xsl:if test="$FormData/ForeignCountryName">     
				<xsl:call-template name="CreateTable">
					<xsl:with-param name="Start" select="position()" />
					<xsl:with-param name="Stop" select="position()+25" />
					<xsl:with-param name="TargetNode" select="$FormData/ForeignCountryName" />		
								...
								<!-- end Line 7b text-->
								<xsl:if test="count($FormData/ForeignCountryName) &lt; 18 ">
								<!-- grey areas -->
								<div class="styBB" style="height:5mm;width:17mm;float:left;clear:none;border-bottom-width:0px;">
									<div class="styBB" style="height:5mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px;border-bottom-width:0px; ">
                  </div>
									<div class="styBB" style="height:5mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px;border-bottom-width:0px; ">
                  </div>
								</div></xsl:if>
								...
								<!-- end Line 7b text-->
								<!-- grey areas -->
								<div class="styBB" style="height:8mm;width:17mm;float:left;clear:none;border-bottom-width:0px;">
									<div class="styBB" style="height:8mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px;border-bottom-width:0px; ">
                  </div>
									<div class="styBB" style="height:8mm;width:8.5mm;background-color:lightgrey;float: left; clear: none;border-left-width: 1px;border-bottom-width:0px; ">
                  </div>
								</div></xsl:if>
							...
							<div class="styBB" style="padding-top:0mm;width:158mm;float:left;clear:none;border-bottom-width: 0px;padding-bottom:0mm;">
								<div class="styLNLeftNumBox" style="padding-left:2mm;width:7mm;">8</div>
								<div class="styLNDesc" style="width:134.2mm;">
									<span style="float:left;clear:none;">
                    During 2010, did you receive a distribution from, or were you the grantor of, or transferor to, a
                    foreign trust? If "Yes," you may have to file Form 3520. See instructions on back.
                         <span class="styBoldText">
								...
								<!-- end grey areas -->
								<!-- Line 8 YES/NO -->
								<div class="styBB" style="width:17mm;float:left;clear:none;">
					...
					<div style="width:187mm; border-top:1 solid black;border-top-width:1px;">
						...
						<div style="float:right;" class="styGenericDiv">Schedule B (Form 1040A or 1040) <b>2010</b>
						</div>
					</div>
					<!-- end page 2 footer -->
					<br/>
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends information">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:7mm;height:8mm;">
                  1
                  </th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:109mm;height:8mm;text-align:left;">
                  List name of payer. If any interest is from a seller-financed mortgage and the<br/>
                    buyer used the property as a personal residence, see page B-1 and list this<br/>
                    interest first. Also, show that buyer&apos;s social security number and address
                  </th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:6.8mm;height:8mm;">
										<span class="styTableCellPad">
                    </span>
									</th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:30.3mm;height:8mm;font-size:8pt;">
                    Amount
                  </th>
								</tr>
							</thead>
							...
							<tbody>
								<xsl:for-each select="$FormData/Form1040SchBPartIGroup1">
									...
									<tr>
										...
										<td class="styDepTblCell" style="width:109mm;text-align:left;">
											<span style="width:2mm;">
                     </span>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="SellerFinancedName"/>

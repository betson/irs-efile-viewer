...
<span style="width:32mm;text-align:right;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width:1px; border-left-width: 0px; border-right-width: 0px;float:">
        ...
        2
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNAmountBox" style="height:3.25mm;padding-top:.5mm;">
                <br/>
                <xsl:call-template name="PopulateAmount">
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:138mm;">
                <span style="float:left;">Work opportunity credit allowed for 2010 from a passive activity (see instructions) </span>
                <!-- Dotted Line -->
               <span  class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;margin-right:2mm;">......</span>
              </div>
            ...
            <!-- Line 8-->
            <div style="width:187mm;">
              <div class="styLNLeftNumBoxSD" style="height:3.9mm;">8</div>
              <div class="styLNDesc" style="width:138mm;height:4mm;">
             Carryforward of any work opportunity credit that originated in a tax year that began after 2006 and
             <span style="float:left;">carryforward from 2009 of the New York Liberty Zone business employee credit 
             <span style="width: 3mm;padding-left:1.5mm;">
			 <xsl:call-template name="LinkToLeftoverDataTableInline">
			 <xsl:with-param name="Desc">Form 8884 Indicator</xsl:with-param>
       ...
       8
            ...
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:138mm;">
                <span style="float:left;">Carryback of the work opportunity credit from 2011 (see instructions) </span>
               <!-- Dotted Line -->
               <span  class="styDotLn" style="float:right;font-weight:bold;padding-right:1mm;margin-right:2mm;">..........</span>
              </div>
       ...
       Form <span class="styBoldText">5884</span> (2010)
        </div>

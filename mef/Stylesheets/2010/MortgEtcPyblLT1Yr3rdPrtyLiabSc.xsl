...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!--HINTS - Display name is Mortgages etc. Payable Less Than 1 Year Third-Party Liabilities Schedule- 1120F -->
  <xsl:param name="depDocTitle">
    <xsl:call-template name="PopulateDisplayName">
      <xsl:with-param name="TargetNode" select="$DependencyData" />
    </xsl:call-template>
  </xsl:param>
  <xsl:template name="MortgEtcPyblLT1Yr3rdPrtyLiabScTemp">
  <table id="GeneralDependencyTbl" class="styDepTblLandscape">
    <tr class="styDepTblHdr">
      ...
      <xsl:choose>
        <xsl:when test="$DependencyData/MortgEtcPyblLT1Yr3rdPrtyInfo/CorporationEIN">
        ...
        <xsl:otherwise>
          ...
          <th class="styDepTblCell" style="width:86mm;text-align:center;" scope="col">Mortgages etc. Payable Less Than 1 Year Third-Party Liabilities Description</th>
         ...
         <!--Column 1 - Corporation Name -->
          <td class="styDepTblCell" style="width:85mm;text-align:left;vertical-align:middle;font-size:7pt">
            ...
            <xsl:attribute name="rowspan">
              <xsl:value-of select="count(MortgEtcPyblLT1Yr3rdPrtyLnItem)"></xsl:value-of>
            </xsl:attribute>
            <!--Allow row to expand by column -->
          ...
          <xsl:if test="count(MortgEtcPyblLT1Yr3rdPrtyLnItem)=0 or count (MortgEtcPyblLT1Yr3rdPrtyLnItem)=1">
          ...
          <xsl:if test="count(MortgEtcPyblLT1Yr3rdPrtyLnItem)&gt;1">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="MortgEtcPyblLT1Yr3rdPrtyLiabScTemp" />
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>

...
<td class="styLNDesc" style="width:112mm;height:4.5mm;" >Number of voting members of the governing body (Part VI, line 1a)
...
<xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:112mm;height:4.5mm;" colspan="2">Net assets or fund balances. Subtract line 21 from line 20
                <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;">
                  <xsl:call-template name="PopulateAmount">
...
<div class="styBB" style="width:187mm;"/>
        ...
        Date <br/>
              ...
              <td style="width:20mm;border-right:1 solid black;border-bottom:1 solid black;padding-left:1mm;">
                <nobr>
                  <label for="dummyid1">
                    ...
                    </xsl:call-template>Check if <br/> self-<br/>employed
          </label>
                </nobr>
                <span style="width:2px;"/>
              ...
              <td style="width:50mm;border-bottom:1 solid black;padding-left:1mm;vertical-align:top;padding-top:1mm;">Preparer’s taxpayer identification number<br/>
(see instructions)
<br/>
                <xsl:call-template name="PopulateReturnHeaderPreparer">
...
<span style="width:2px;"/>
          ...
          <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageend">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">990</span> (2010)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2010)</div>
        ...
        <span class="styNormalText" style="padding-top:0.0mm;width:178mm;height:4.5mm;padding-left:17mm;">
...
<xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:4mm;">e</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
              <!--<img src="{$ImagePath}/990_Bullet_Round.gif" alt="RoundBullet"/>-->
...
<xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">11e</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;">
            <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/ReportOtherLiabilities"/>
              </xsl:call-template>
...
<xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:10.5mm;padding-top:4.5mm;">11f</div>
...
<span class="styItalicText">If “Yes,” complete Schedule D, Parts XI, XII, and XIII
          <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:4.5mm;">12a</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:4.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/IndependentAuditFinancialStmt"/>
              </xsl:call-template>
            </div>
      ...
      <div style="width:187mm;float:none;">
        ...
        <span class="styItalicText"> If “Yes,” and if the organization answered ‘No’ to line 12a, then completing Schedule D, Parts XI, XII, and XIII is optional
          <xsl:call-template name="SetFormLinkInline">
              ...
              <div class="styLNRightNumBox" style="height:10.5mm;padding-top:4.5mm;">12b</div>
            <div class="styIRS990LNYesNoBox" style="height:10.5mm;padding-top:4.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/ConsolidatedAuditFinancialStmt"/>
              </xsl:call-template>
    ...
    <span class="styItalicText"> If “Yes,” complete Schedule H</span>
       ...
       <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization attach its audited financial statement to this return? 
    Note: All Form 990 filers that operate one or more hospitals must attach audited financial statements.
    <!--<span class="styItalicText"> If “Yes,” complete Schedule H</span>-->
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.....
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:1.5mm;">20b</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/FinancialStmtAttached"/>
              </xsl:call-template>
...
sections 301.7701-2 and 301.7701-3?    <span class="styItalicText">  If “Yes,” complete Schedule R, Part I</span>
    ...
    Is any related organization a controlled entity within the meaning of section 512(b)(13)?
            ...
            <div class="styLNRightNumBox" style="height:4.5mm;padding-top:2.5mm;">35</div>
            <div class="styIRS990LNYesNoBox" style="height:4.5mm;padding-top:2.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
...
<!-- NEW 35a for 2010 per BSP-102104OTH -->
        <!-- Changed line 35a to put yes/no boxes inside the normal set up of yes/no boxes -->  
                  
<div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:4mm;">a</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    Did the organization receive any payment from or engage in any transaction with a controlled entity within the meaning of section 512(b)(13)? <span class="styItalicText"> If “Yes,” complete Schedule R, Part V, line 2</span>
              </span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...
       <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styLNRightNumBox" style="height:8mm;border-bottom-width:0px;"></div>
            <div class="styIRS990LNYesNoBox" style="height:8mm;border-bottom-width:0px;">
               </div>
            <div class="styIRS990LNYesNoBox" style="height:8mm;border-bottom-width:0px;">
...
<input type="checkbox" class="styCkbox">
        ...
        Enter the number reported in Box 3 of Form 1096. <!--<span class="styItalicText">Annual Summary and Transmittal of U.S. Information Returns.-->Enter -0- <!--</span>--> if not applicable.   
            ...
            <div class="styLNRightNumBox" style="height:4.5mm;padding-top:8mm;">1a</div>
...
Statements</span> filed for the calendar year ending with or within the year covered by this return   
    ...
    If at least one is reported on line 2a, did the organization file all required federal employment tax returns?</span>
              <br/>
              <span class="styNormalText" style="padding-top:0.0mm;"><br></br>
                <span class="styBoldText">Note.</span>
                <span class="styNormalText"> If the sum of lines 1a and 2a is greater than 250, you may be required to e-file. (see
instructions)</span>
              </span>
            </div>
    ...
    If “Yes,” has it filed a Form 990-T for this year?<span class="styItalicText"> If “No,” provide an explanation in Schedule O</span>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:10.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
    At any time during the calendar year, did the organization have an interest in, or a signature or other authority over, a financial account in a foreign country (such as a bank account or securities account)?</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.......................</span>
            </div>
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
                ...
                <span class="styBoldText" style="padding-top:0.0mm;"> <br></br>Note.</span>
                All 501(c)(29) organizations must list in Schedule O each state in which they are licensed to issue qualified health plans, the amount of reserves required by each state, and the amount of reserves the organization allocated to each state.
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;"/>
            </div>
            <div class="styLNRightNumBox" style="height:13.5mm;padding-top:9mm;">13a</div>
            <div class="styIRS990LNYesNoBox" style="height:13.5mm;padding-top:9mm;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/FiledLieu1041"/>
              </xsl:call-template>
            </div>
...
Enter the aggregate amount of reserves on hand.
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3mm;">13c</div>
            <div class="styLNAmountBox" style="height:7.5mm;padding-right:0.5mm;padding-top:3.5mm;">
              <xsl:call-template name="PopulateAmount">
 ...
 <span class="styItalicText"> If “No,” provide an explanation in Schedule O</span>
          ...
          <div class="styBB" style="width:187mm;float:none;">
            ...
            <div class="styPartDesc" style="float:left;width:170mm;">Governance, Management, and Disclosure <span class="styNormalText"> For each “Yes” response to lines 2 through 7b below, and for a “No” response to lines 8a, 8b, or 10b below, describe the circumstances, processes, or changes in Schedule O. See instructions. </span>
...
Section A. Governing Body and Management 
       ...
       Enter the number of voting members of the governing body at the end of the tax year   
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;">1a</div>
            <div class="styLNAmountBox" style="height:7.5mm;padding-right:0.5mm;padding-top:3.5mm;">
              <xsl:call-template name="PopulateAmount">
...
<input type="checkbox" class="styCkbox">
 ...
 List all of the organization’s <span class="styBoldText">former directors or trustees</span> that received, in the capacity as a former director or trustee of the <br/>organization, more than $10,000 of reportable compensation from the organization and any related organizations.</div>
      ...
      (B) 
      <br/>
                    <span class="styNormalText">Average hours per week (describe hours for related organizations in Schedule O)</span>
                  </th>
      ...
      <br/>
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;border-color:black" cellspacing="0">
            <tbody valign="top">
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:.3mm;padding-left:3mm;border-style: solid;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">c</td>
                <td class="styGenericDiv" colspan="4" style="width:102mm;height:4.5mm;border-style: solid;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
...
and labeled miscellaneous may not exceed 5% of total expenses shown on line 25 below.)       
 <xsl:call-template name="SetFormLinkInline">
  ...
  if  following <br/>SOP 98-2 (ASC 958-720). Complete this line only if the organization reported in column (B) joint costs from a combined educational campaign and fundraising solicitation
     </td>
                <td class="styLNAmountBoxSmall" style="width:26mm;height:9mm;vertical-align:bottom;padding-right:0.75mm;">
                  <xsl:call-template name="PopulateAmount">
...
<input type="checkbox" class="styCkbox">
         ...
         <!-- Dotted Line-->
           ...
           <!--  L6 -->
            <div style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:139mm;height:4.5mm;"> Net assets or fund balances at end of year. Combine lines 3, 4, and 5 (must equal Part X, line 33, column (B))  
                <!-- Dotted Line-->
                <span class="styBoldText">
                  <span style="width:16px"/>.
              <span style="width:16px"/>.
      ...
      <span class="styNormalText" style="padding-top:0.0mm;width:178mm;height:4.5mm;padding-left:18mm;">
...
audit, review, or compilation of its financial statements and selection of an independent accountant?<br/> If the organization changed either its oversight process or selection process during the tax year, explain in Schedule O.</span>
            ...
            <div class="styLNRightNumBox" style="height:10.5mm;padding-top:10.5mm;">2c</div>
            <div class="styIRS990LNYesNoBox" style="height:10.5mm;padding-top:10.5mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <!-- 2d -->
          <div style="width:187mm;float:none;">
      <div class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;">d</div>
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
   If “Yes” to line 2a or 2b, check a box below to indicate whether the financial statements for the year were issued on a separate basis, consolidated basis, or both:</span>
          </div>
    <div class="styShadingCell" style="width:8mm;height:7.5mm;"/>
    <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
    <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>

...
<!--Line 5-->
    ...
    <div style="float:right;">
      ...
      <div class="styLNAmountBox" style="height:7.5mm;padding-top:3.5mm;">
       <xsl:if test="(count($FormData/BusinessSquareFeetPct) &lt;1) ">8,760
               </xsl:if>
    <xsl:call-template name="PopulateAmount">
...
">(a) Direct expenses
 ...
 <xsl:call-template name="PopulateAmount">
    ...
    <!-- Line 10 -->
  <div style="width:187mm;">
         <div class="styLNLeftNumBox" style="height:7.2mm;">10</div>
     <div  class="styLNDesc" style="width:56mm;height:7.2mm;">
               Deductible mortgage interest (see instructions)
             <span style=" letter-spacing:3.2mm; font-weight:bold; padding-left:3mm;">.........</span>
         </div>
      <div class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:7.2mm;padding-top:3mm;">10</div>
 <div class="styLNAmountBox" style="width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px; height:7.2mm;padding-top:3mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/DeductibleMortgageIntDirectAmt"/>
        </xsl:call-template>
            </div>
 <div class="styLNAmountBox" style="width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px; height:7.2mm;padding-top:3mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/DeductibleMortgageIntIndrAmt"/>
        </xsl:call-template>
            </div>
             <div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:7.3mm;"></div>
             <div class="styLNAmountBoxNBB" style="width:34mm; height:7.2mm;"></div>
  </div>         
<!-- End Line 10 -->
     <!-- Line 11 -->
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:56mm;height:4mm; ">
      ...
      <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:4mm;">11</div>
 <div class="styLNAmountBox" style="font-weight:normal;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/RealEstateTaxesDirectAmt"/>
        </xsl:call-template>
            </div>
 <div class="styLNAmountBox" style="font-weight:normal;width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4mm;">
 <xsl:call-template name="PopulateAmount">
...
<!-- End Line 15 -->
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:56mm;height:8mm;">
      ...
      <div class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:8mm;padding-top:3mm;">16</div>
 <div class="styLNAmountBox" style="padding-top:3mm;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:8mm;">
 <xsl:call-template name="PopulateAmount">
          <xsl:with-param name="TargetNode" select="$FormData/ExcessMortgageIntDirectAmt"/>
        </xsl:call-template>
            </div>
 <div class="styLNAmountBox" style="width:36mm;border-left-width;1px; border-top-width:0px;border-right-width:0px;height:8mm;padding-top:3mm;">
 <xsl:call-template name="PopulateAmount">
...
<!-- End Line 23 -->
  ...
  <div class="styGenericDiv" style="width: 187mm;">
     ...
     <div  class="styLNDesc" style="width:93.2mm;">
               Carryover of operating expenses from 2009 Form 8829, line 42
             <span style=" letter-spacing:3.2mm; font-weight:bold; padding-left:3mm;">..</span>
         </div>
...
<!--  Line 28 -->
 ...
 <!--  Line 30 -->
  <div style="width:187mm">        
    ...
    <div style="float:right;">
         <div class="styLNRightNumBox" style="height:6mm;padding-top:1mm;" >30</div>  
...
<div class="styBB" style="width:187mm;border-top-width: 1px;" >
  ...
  <div class="styPartDesc" style="padding-left:3mm;">
   Carryover of Unallowed Expenses to 2011 	 
  </div>
</div>
<div style="width:187mm;" class="styBB">
   <!-- Line 42 -->
...
<div style="width:187mm;clear:both;">
  ...
  <div style = "float:right;" class="styGenericDiv">Form <span class="styBoldText">8829</span> (2010)</div>
</div>
  <p class="pageend"></p>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/PartAdvncPymtGoodsLTContrctSch" />
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/PartAdvncPymtGoodsLTContrct/TotalAdvncPymtsRcvd"/>
            </xsl:call-template>
          </div>
        </div>
        <br />      
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/PartAdvncPymtGoodsLTContrct/TotalAmtAdvncPymtsRcvdNotGross"/>
            </xsl:call-template>
          </div>
        </div>
        <br />   
          ...
          <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/PartAdvncPymtGoodsLTContrct/TotalAmtAdvncPymtsRcvdGross"/>
            </xsl:call-template>
          </div>
        </div>
        <br />   

  ...
  <body class="styBodyClass">      
    <form style="font-family:arial; font-size:9pt" name="Form3115">      
      ...
      <div class="styBB" style="width:187mm; font-size:8.5pt; padding-top:0.5mm; padding-bottom:0.5mm">
        <b>Caution:</b> To be eligible for approval of the requested change in method of accounting, the taxpayer <b>must</b> provide all information that 
        is relevant to the taxpayer or to the taxpayer's requested change in method of accounting.  This includes all information requested on this Form 3115
         (including its instructions), as well as any other information that is not specifically requested.
        <div style="font-weight:bold;"> The taxpayer must attach all applicable supplemental statements requested throughout this form. </div>
      </div>
    ...
    <!-- BEGIN Part I Line Items -->  
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
          <div style="width:167.1mm"> 
          Enter the applicable designated automatic accounting method change number for the requested automatic change. Enter only one designated automatic
          accounting method change number, except as provided for in guidance published by the IRS. If the requested change has no designated automatic
          accounting method change number, check “Other,” and provide both a description of the change and citation of the IRS guidance providing the
          automatic change. See instructions. </div>
          <div style="padding-top:1mm">
            <img src="{$ImagePath}/3115_Bullet.gif" alt="Right Arrow Bullet"/>
            ...
            <span style="border-bottom:1 solid black; width:100mm; font-size:7pt">
              <xsl:call-template name="PopulateText">
        ...
        <div style="float:left">
          <div class="styIRS3115DimYesBox" style="height:25.1mm"></div>  
          <div class="styIRS3115DimNoBox" style="height:25.1mm;"></div>  
        </div>
      </div>  
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
            <div style="width:167.1mm;">
          Do any of the scope limitations described in section 4.02 of Rev. Proc. 2008-52 cause automatic consent to be unavailable for the applicant’s requested
          change? If "yes", attach an explanation. <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> .........</span>
      ...
      <div style="width:187mm;">    
        <div style="float:left">
          <span><b>Note.</b> Complete Part II below and then Part IV, and also Schedules A through E of this form (if applicable).</span>
        </div>
        <div style="float:right">  
    ...
    <!-- BEGIN Part II Line Items -->  
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
            <div style="width:167.1mm;">
          Did or will the applicant cease to engage in the trade or business to which the requested change relates, or terminate its existence, in the tax year 
          of change? (see instructions.) <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> ...............</span>
          </div>  
    ...
    <xsl:if test="count($Form3115Data/GovtCouncilContactInfo) &lt;1 or ((count($Form3115Data/GovtCouncilContactInfo) &gt; 1) and ($Print = $Separated))">
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm;">
          If the applicant answered "Yes" to line 4a and/or 5a with respect to any present or former consolidated group,<br/>attach a statement that provides each parent corporation's <b>(a)</b> name, <b>(b)</b> identification number, <b>(c)</b> address, and <b>(d)</b> tax year(s) during which<br/>the applicant was a member that is under examination, before an Appeals office, and/or before a Federal court.</div>
        </div>
        <div style="float:right">
          <div class="styIRS3115DimYesBox" style="height:16.8mm"></div>  
          <div class="styIRS3115DimNoBox" style="height:16.8mm"></div>        
        </div>    
      </div>    
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm">
          If, for federal income tax purposes, the applicant is an entity (including a limited liability company) treated as a partnership, S corporation, or a foreign 
          corporation, is it requesting a change from a method of accounting that is an issue under consideration in an examination, before Appeals, or before a
           Federal court, with respect to a Federal income tax return of a partner, member, or shareholder of that entity? 
            <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> .............</span>
      ...
      <div style="width:187mm">
        <div class="styIRS3115LNLeftLtrBox">8a</div>
        <div style="float:left">
        <div style="width:167.1mm;">
          Does the applicable revenue procedure (advance consent or automatic consent) state that the applicant will not receive  audit protection for the 
          requested change (see instructions)?   <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> ..............</span>       
          <xsl:call-template name="SetFormLinkInline">
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm">
          Has the applicant, its predecessor, or a related party requested or made (under either an automatic change<br/>procedure or a procedure requiring advance
           consent) a change in method of accounting within the past 5 years         
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm">
          If “Yes,” for each trade or business, attach a description of each requested change in method of accounting (including the tax year of change)
          and state whether the applicant received consent</div>          
        </div>
        <div style="float:right">
          <div class="styIRS3115DimYesBox" style="height:8mm"></div>  
          <div class="styIRS3115DimNoBox" style="height:8mm"></div>  
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm;">
          If any application was withdrawn, not perfected, or denied, or if a Consent Agreement granting a change was not signed and returned to the IRS, or 
          if the change was not made or not made in the requested year of change, attach an explanation.  </div>      
        </div>
        <div style="float:right">
      ...
      <div style="width:187mm">
        ...
        <div style="float:left">
        <div style="width:167.1mm;">
          If the applicant is  either (i) <b>not</b> changing its overall method of accounting, or (ii) is changing its overall method of accounting and also changing to a special method of accounting for one or more items,attach a detailed and complete description for each of the following:</div>
        </div>
        <div style="float:right">  
          <div class="styIRS3115DimYesBox" style="height:12mm"></div>  
          <div class="styIRS3115DimNoBox" style="height:12mm"></div>  
      ...
      <div style="width:187mm">    
        ...
        <div style="float:left">
          Does the applicant request a conference with the IRS National Office if the IRS proposes an adverse            
        </div>  
        <div style="float:right">  
          <div class="styIRS3115DimYesBox"></div>  
          <div class="styIRS3115DimNoBox"></div>  
      ...
      <div style="width:187mm">    
        ...
        <div style="float:left">
        <div style="width:167.1mm;">
          If the applicant is changing to either the overall cash method or an overall accrual method, or is changing its method of accounting for any property subject to
           section 263A, any long-term contract subject to section 460, or inventories subject to section 474, enter the applicant's gross receipts for the 3 tax years
            preceding the tax year of change. </div>           
        </div>        
        <div style="float:right">  
          <div class="styIRS3115DimYesBox" style="height:12mm"></div>  
      ...
      <div style="width:187mm; ">  
        ...
        <div style="float:left">
         <div style="width:167.1mm;">
          If the applicant qualifies for a reduced user fee, attach the required information or certification (see instructions).</div>
          <xsl:call-template name="SetFormLinkInline">
      ...
      <div style="width:187mm">  
        ...
        <div style="width:167.1mm;">
          Does the applicable revenue procedure require the applicant to implement the requested change in method of accounting on a cut-off basis rather than a
           section 481(a) adjustment? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> ...............</span></div>
        </div>
        <div style="float:right">
          <div class="styIRS3115YesBox" style="height:8.5mm;padding-top:4mm;">
            <xsl:call-template name="PopulateYesBox">
              <xsl:with-param name="TargetNode" select="$Form3115Data/DoesChangeRequireUseCutOffMthd"/>
            </xsl:call-template>
          </div>  
          <div class="styIRS3115NoBox" style="height:8.5mm;padding-top:4mm;">
            <xsl:call-template name="PopulateNoBox">
              <xsl:with-param name="TargetNode" select="$Form3115Data/DoesChangeRequireUseCutOffMthd"/>
            </xsl:call-template>
          </div>  
      ...
      <div style="width:187mm">  
        ...
        <div style="float:left">
          ...
          Income received or reported before it was earned (such as advance payments). Attach a description of the income and the legal basis for the proposed method
          <xsl:call-template name="SetFormLinkInline">
      ...
      <div style="width:187mm">    
        ...
        <div style="float:left">
        <div style="width:148mm;">
          Other amounts Attach  a description of the item and the legal basis for its inclusion in the calculation of the section 481(a) adjustment.  
       <!--   <img src="{$ImagePath}/3115_Bullet.gif" alt="Right Arrow Bullet"/> &nbsp; -->
          <span style="border-bottom:1 solid black; width:100mm"> 
            <xsl:call-template name="SetFormLinkInline">
      ...
      <div style="width:187mm">    
        ...
        <div style="float:left">
        <div style="width:148mm;">
          <b>Net section 481(a) adjustment</b> (Combine lines 1a-1g.) Indicate whether the adjustment is an increase (+) or decrease (-) in income.  
          Also enter the net amount of this section 481(a) adjustment amount in Part IV on line 25.
                   <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> .............................</span>
          </div>
        </div>            
        <div style="float:right">    
      ...
      <div style="width:187mm; padding-bottom:3mm; padding-top:1mm">                
        <div class="styIRS3115LNLeftNumBox" style="text-align:center">1</div>
        <div style="float:left">
          If the applicant is requesting to change to the deferral method for advance payments described in section 5.02 of Rev. Proc. 2004-34, 2004-1 C.B. 991,
        ...
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">c</div>
        <div style="float:left; padding-top:1mm">
A statement explaining that the advance payments will be included in income no later than when included in gross receipts for purposes of the applicant's financial reports. See Regulations section 1.451-5(b)(1)(ii).
        </div>    
                <br/>
...
A statement explaining whether the inventoriable goods exception of Regulations section 1.451-5(c) applies and if so, when substantial advance payments will be received under the contracts, and how the exception will limit the deferral of income
      ...
      <div style="width:187mm; padding-top:1mm; border-bottom:1 solid black">                
        ...
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">b</div>
        <div style="float:left; padding-top:1mm">
          Pooling (e.g., by line or type or class of goods, natural business unit, multiple pools, raw material content, simplified<br/>dollar-value method, inventory price index computation (IPIC) pools, vehicle-pool method,etc.).
        </div>    
        <br/>
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">c</div>
        <div style="float:left; padding-top:1mm">
        ...
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">d</div>
        <div style="float:left; padding-top:1mm">
          Determining the current year cost of goods in the ending inventory (e.g., most recent acquisitions, earliest acquisitions<br/>during the current year, average 
          cost of current-year acquisitions, or other permitted method).
        </div>        
        <br/>
      ...
      <div style="width:187mm; padding-bottom:1mm; padding-top:1mm">                
        ...
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">c</div>
        <div style="float:left; padding-top:1mm">
          If all of the products to be included in the proposed NBU pool(s) are not produced at one facility, state the reasons for the separate facilities, indicate the location of each facility, and provide a description of the products each<br/>facility produces.
        </div>  
        <br/>
        <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">d</div>
        <div style="float:left; padding-top:1mm">
      ...
      <div style="width:187mm; padding-top:1mm">                
        ...
        <div style="float:left">
          To the extent not already provided, attach a description of the applicant's present and proposed methods for reporting income<br/>and expenses from 
          long-term contracts.  Also, attach  a representative contract for the requested change. If the applicant is a construction contractor, attach a detailed 
          description of its construction activities.
        </div>                          
      </div>    
      ...
      <div style="width:187mm">      
        ...
        <div style="width:155mm;">
          If line 2d is "Yes," attach an explanation of what cost comparison the applicant will use to determine a contract's completion factor
          <xsl:call-template name="SetFormLinkInline">
            <xsl:with-param name="TargetNode" select="$Form3115Data/IRS3115ScheduleD/IsApplcntReqExemptComplnMthd"/>              
          </xsl:call-template>  </div>
          If line 2d is "No," attach an explanation what method the applicant is using and the authority for its use.          
        </div>
      </div>        
      ...
      <div style="width:187mm; margin-top:0.5mm">      
        <div class="styIRS3115LNLeftLtrBox">b</div>        
        <div style="float:left">
          If "Yes," attach an explanation of the applicant's present and proposed method(s) of accounting for long-term manufacturing<br/>contracts.                  
        </div>
      </div>  
      ...
      <div style="width:187mm">                
        ...
        <div style="float:left">
           Is the applicant subject to section 263A? If  "No," go to line 4a. <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm	"> ................</span>
        </div>  
        <div class="styIRS3115YNChxBoxDiv">
                  <span>
                <xsl:call-template name="PopulateSpan">
      ...
      <span>
        ...
        <div style="float:left">
         <div style="width:155mm;">
           Is the applicant's present inventory valuation method in compliance with section
      263A (see instructions)?  If  "No," attach a detailed explanation. <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:5mm;"> .........................</span> </div>
        </div>  
        <div class="styIRS3115YNChxBoxDiv"  style="padding-top:3.7mm;">
                  <span >
                <xsl:call-template name="PopulateSpan">
                  <xsl:with-param name="TargetNode" select="$Form3115Data/IRS3115ScheduleD/PresentInvntryVltnMthdPer263A" />
                </xsl:call-template> 
      ...
      <div style="width:187mm">      
        <div class="styIRS3115LNLeftLtrBox">c</div>        
        <div style="float:left">
          <b>Only for applicants requesting an automatic change.</b> The statement required by section 22.01(5) of the Appendix<br/>of Rev. Proc. 2008-52 (or its successor).
        </div>
      </div>
      ...
      <div class="styBB" style="width:187mm; border-top:2 solid black">
        ...
        <div class="styPartDesc" style="width:170mm; font-size:9.5pt; padding-bottom:0.5mm">
          Method of Cost Allocation <span style="font-weight:normal">(Complete this part if the requested change involves either property subject to section 263A or long-term contracts as described in section 460 (see instructions).</span>
        </div>        
      </div>    
      ...
      <div style="width:187mm">                
        <div class="styIRS3115LNLeftNumBox" style="padding-left:1.5mm">2</div>
        <div style="float:left">
          Research and experimental expenses not included in Section B on line 26 above
        </div>  
        <div style="float:right">
          <span class="styDotLn" style="padding-right:0">
            ....
      ...
      <div style="width:187mm">                
        <div class="styIRS3115LNLeftNumBox" style="padding-left:1.5mm">3</div>
        <div style="float:left">
          Bidding expenses not included in Section B on line 22 above
        </div>  
        <div style="float:right">
          <span class="styDotLn" style="padding-right:0">
            ............
      ...
      <div style="width:187mm">                
        ...
        <div class="styIRS3115LNLeftNumBox">10</div>
        <div style="float:left">
          Depreciation, amortization, and cost recovery allowance not included in Section B on 
        </div>  
        <div style="float:right">          
          <div class="styIRS3115SchDP3" style="border-bottom:0"></div>
          <div class="styIRS3115SchDP3" style="border-bottom:0"></div>
      ...
      <div style="width:187mm; padding-top:1mm">
        Applicants requesting approval to change their method of accounting for depreciation or amortization complete this section.<br/>Applicants <b>must </b>provide this information for each item or class of property for which a change is requested.<br/><span><b>Note.</b>  See the <b>List of Automatic Accounting Method Changes</b> in the instructions for information regarding automatic changes<br/>under sections 56, 167, 168, 197, 1400I, 1400L, or former section 168. 
      <b>Do not </b>  file Form 3115 with respect to certain late elections</span>        
      </div>  
    ...
    <div style="float:left; padding-top:1mm">
      To the extent not already provided in the applicant's description of its present method, attach a statement explaining <br/>
     how the property is treated under the applicant's present method (e.g., depreciable property, inventory property, <br/>
     1.162-3, nondepreciable section 263(a) property, property supplies under Regulations section deductible<br/> as a current expense, etc.).
    </div> 
    <br/>   
    <div class="styIRS3115LNLeftNumBox" style="text-align:center; padding-top:1mm">6</div>  
    <div style="float:left; padding-top:1mm">
      If the property is not currently treated as depreciable or amortizable property, attach a statement of the facts supporting <br/> the proposed change to depreciate or amortize the property.
    </div>        
    <br/>   
    <div class="styIRS3115LNLeftNumBox" style="text-align:center; padding-top:1mm">7</div>  
    <div style="float:left; padding-top:1mm">
       If the property is currently treated and/or will be treated as depreciable or amortizable property, attach the following<br/>information for both the present (if applicable) and proposed methods:
    </div>  
    <br/>   
    <div class="styIRS3115LNLeftLtrBox" style="padding-top:1mm">a</div>
    <div style="float:left; padding-top:1mm">
  ...
  <xsl:for-each select="$Form3115Data/IRS3115ScheduleE/ChangeInDeprecOrAmortization">  
    ...
    <div class="styGenericDiv">
      <div style="padding-left:.5mm;padding-right:1mm;font-weight:bold;width:6mm;text-align:left;" class="styGenericDiv">3</div>
       <div style="float:left">
          Has a depreciation, amortization, or expense  election been made for the property (e.g., the election under section 168(f)(1)) 179, or 179C?
        </div>  
        <div class="styIRS3115YNChxBoxDiv">  
          <span class="styDotLn" style="padding-right:0">     
          . 
...
<xsl:template name="SchETemplate">  
  ...
  <xsl:if test="$index &lt;= $max">    
    ...
    <tr>  
      ...
      <td></td>
      <td>
        Has a depreciation , amortization, or expense  election been made for the property (e.g., the election under section
      </td>
    </tr>
    <tr>
      <td></td>

			...
			Schedule M-3 attached		     
				...
				<!--Dotted Line-->
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:81mm" scope="row">2009 overpayment credited to 2010
				<!--Dotted Line-->
									<span class="styDotLn" style="float:none">......</span>
								</td>
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:81mm" scope="row">2010 estimated tax payments
<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Form 1120F - Trust Indicator </xsl:with-param>
										<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPayments/@trustIndicator"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Form 1120F - Ttust Payment Amount </xsl:with-param>
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:81mm" scope="row">Less 2010 refund applied for on Form 4466
			<span style="padding-left:1mm;">
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
...
amounts from Forms 8288-A and 8805 (attach Forms 8288-A and 8805))
		...
		<label>
			...
			Check if Form 2220 is attached
				...
				<!--Dotted Line-->
							...
							<tr>
								...
								<td colspan="5" class="styIRS1120FItemDesc" style="width:153mm" scope="row">
									<b>Amount of overpayment on line 8a resulting from tax deducted and withheld under Chapter 3  </b>(attach schedule&#8212;see instructions)
									<xsl:call-template name="SetFormLinkInline">
			...
			Enter portion of line 8a you want <b>Credited to 2011 estimated tax</b>
									<span style="padding-left:1mm">
										<img src="{$ImagePath}/1120F_Bullet_Sm.gif" alt="SmallBullet"/>
									</span>
			...
			Form <span class="styBoldText" style="font-size:8pt;">1120-F </span>
							<span style="font-size:7pt">(2010)</span>
						</div>
					</div>
					<div class="pageEnd"/>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120-F (2010)<span style="width:148mm;"/>
						</div>
					...
					<span class="styDotLn" style="float:none"/>
			         ...
			         <span class="styDotLn" style="float:none"/>
									...
									<div class="styIRS1120FRGnewYesNoBox" style="height:11mm;float:left;clear:none;border-bottom-width:0px;padding-top:0.5mm;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="$FormData/MarkToMarketOtherThanDealer"/>
										</xsl:call-template>
									</div>
									<div class="styIRS1120FRGnewYesNoBox" style="height:11mm;float:left;clear:none;border-bottom-width:0px;padding-top:0.5mm;border-right-width:1px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="$FormData/MarkToMarketOtherThanDealer"/>
										</xsl:call-template>
									</div>
						...
						reallocation of income based on section 482 and its regulations?</span>
						 ...
						 <span style="padding-left:5mm; float:left; clear:none">amounts? If &#8220;Yes,&#8221; attach statement (see instructions)
								...
								<div class="styGenericDiv" style="width:94mm; height:9mm;">
									<div class="styLNLeftNumBox" style="padding-left:3mm">AA</div>
...
<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="$FormData/UncertainTaxPositionsToReport"/>
												</xsl:call-template>
											</div>
										</div>
										<div style="width:12.1mm;height:10mm;float:left; clear:none;">
			...
			<span style="padding-left:15mm;">
				 ...
				 <!-- Form to Form Link -->
					...
					<div style="width:187mm;padding-top:0.5mm;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
			Form <span class="styBoldText" style="font-size:8pt;">1120-F</span> (2010)
		</div>
					</div>
					<div class="pageEnd"/>
					<!-- end page break and footer  -->
			...
			<b>Assembling the Return</b> in the instructions.</i>
				...
				<!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">Interest expense from Schedule I, line 25 (see instructions)
				<span style="width:2px;"/>
								<!-- Form to Form Link -->
								<xsl:call-template name="SetFormLinkInline">
		  ...
		  <xsl:call-template name="SetFormLinkInline">
                ...
                Worldwide basis.
                  ...
                  <span class="styDotLn" style="float:none;padding-left:.6mm">.</span>
					...
					<div style="width:187mm;clear:both;padding-top:0.5mm">
						<div style="float:right;" class="styGenericDiv">Form <span style="font-size:8pt;font-weight:bold">1120-F</span> (2010)</div>
			...
			Additional Data        
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">EstimatedTaxPayments - Trust Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPayments/@trustIndicator "/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">EstimatedTaxPayments -Trust Payment Amount </xsl:with-param>
							<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPayments/@trustPaymentAmount"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">

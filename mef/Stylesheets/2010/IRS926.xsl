          ...
          <div style="width:187mm;float:left;clear:left;" id="IRTP">
            <table class="styTable" id="IRS926PartIII" summary="Information Regarding Transfer of Property" cellspacing="0">
              ...
              <!--Begin Part III Table - Cash line -->
                <!-- Part III table L1 -->
            <xsl:variable name="AGRowCount1" select="count($Form926Data/Cash/DateOfTransfer)"/>
                <xsl:if test="$AGRowCount1 = 0 or ((count($Form926Data/Cash/DateOfTransfer) &gt; 1) and ($Print = $Separated))">
                  <tr>
                ...
                <!-- Part III table L1-->
                <xsl:if test="($Print != $Separated) or (count($Form926Data/Cash/DateOfTransfer) &lt;= 1) ">
      ...
      Form <b style="font-size:8pt">926</b> (Rev. 12-2008)
        ...
        Page <b style="font-size:8pt">3</b>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">Indicate whether the transferor was required to recognize income under Temporary Regulations sections 
            <br/>1.367(a)-4T through 1.367(a)-6T for any of the following:  
          <xsl:call-template name="SetFormLinkInline">
          ...
          <!-- Cash table header -->
        <xsl:if test="(count($Form926Data/Cash/DateOfTransfer) &gt;1) and ($Print = $Separated)">
            <div class="pageEnd"/>
            <br/>
            <br/>
            ...
            <div style="width:187mm;float:left;clear:left;" id="IRTP">
              <table class="styDepTable" id="IRS926PartIII" summary="Information Regarding Transfer of Property" cellspacing="0" style="font-family:verdana;font-size:7pt;">
                ...
                <tbody>
                  ...
                  <xsl:variable name="UKRowCount" select="count($Form926Data/Cash/DateOfTransfer)"/>
                  <xsl:for-each select="$Form926Data/Cash">
                    <tr>
                      <xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
                      <xsl:if test="position()=1">

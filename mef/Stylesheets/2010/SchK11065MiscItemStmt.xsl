...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/SchK11065MiscItemStmt" />
  
  <!-- Template to display Miscellaneous Item Statement -->
          ...
          <tr>
            ...
            <td class="styDepTblCell" style="width:10mm;text-align:center">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="BoxNumber"/>
              </xsl:call-template>                  
            </td>
            <td class="styDepTblCell" style="width:10mm;text-align:center">
              <xsl:call-template name="PopulateText">
            ...
            <td class="styDepTblCell"  style="width:36mm;text-align:left">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="CodeName"/>
              </xsl:call-template>
            </td>    

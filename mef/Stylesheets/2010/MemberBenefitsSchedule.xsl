...
<!-- change -->    
  <xsl:param name="Form990DepsData" select="$RtnDoc/MemberBenefitsSchedule" />
<!-- end change -->
...
<!-- change -->    
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Type of Benefit</th>
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Amount</th>        
      </tr>          
      <xsl:for-each select="$Form990DepsData/MemberBenefit">
<!-- end change -->
        <tr>
...
<!-- change -->    
          <td class="styDepTblCell" style="text-align:left">          
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="TypeOfBenefit" /></xsl:call-template>             
          </td>              

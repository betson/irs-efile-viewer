            ...
            Form <span class="styFormNumber">3468</span>
						...
						<div class="styTYBox" style="width:30mm;height:22.5mm;line-height:110%;padding-top:0mm;">
							...
							<div style="text-align:left;padding-left:3mm;">
								<div class="styTY" style="height:9.5mm;">20<span class="styTYColor">10</span>
								</div>
          ...
          Identifying number<br/>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						...
						<div class="styPartDesc" style="font-weight:bold;font-size:7.5pt;">
					      Qualifying Advanced Coal Project Credit, Qualifying Gasification Project Credit, Qualifying Advanced Energy Project Credit, 
					      and Qualifying Therapeutic Discovery Project Credit
					      </div>
					</div>
					<!-- Start of Line 5 -->
  ...
  <!--                               <span style="width:2mm"/>  -->
    ...
    <!--                         <span style="float:left;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;height:4.5mm;">
				                          Add lines 5d, 6c, 7, 8, and 9.  Report this amount on Form 3800, line 1a
				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>. 
...
treated as incurred, during the period on line 11b above
        ...
        Pre-1936 buildings located in the Gulf Opportunity Zone
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3468</span> (2010)</div>
					</div>
               ...
               Form 3468 (2010)
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div style="width:146mm;">
								...
								<div class="styLNDesc" style="width:138mm;font-size:7pt;">
                                          Enter the date that the NPS approved the Reques t for Certification
							...
							<div style="width:146mm;">
								...
								<div class="styLNDesc" style="width:138mm;font-size:7pt;">
									...
									<span class="styUnderlineAmount" style="float:none;width:32mm;height:3.5mm;padding-top:0px;padding-bottom:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form3468Data/GeothAndSolarEnergyPropBssAmt"/>
										</xsl:call-template>
									</span>
						...
						<div style="float:left;clear:none;">
							<div style="float:left;">
								...
								<div class="styLNAmountBox" style="height:10mm;padding-top:6.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form3468Data/CalcGeothAndSolarEnergyPropAmt"/>
									</xsl:call-template>
								</div>
							</div>
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:138mm;float:left;">
                                  Basis of property installed placed in servic during the tax year that was acquired after December 31, 2005,
							...
							<span class="styUnderlineAmount" style="float:none;width:29mm;padding-top:0px;
                                           padding-bottom:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form3468Data/QualifiedFuelCellPropertyBasis"/>
								</xsl:call-template>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CalcQlfyFuelCellPropKwCapAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12d -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;height:4.5mm;padding-top:1mm;">
                                                   Enter the lesser of line 12c or 12d
                                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
					...
					<div style="width:187mm;">
						...
						<div style="width:138mm;float:left;">
							...
							<span class="styUnderlineAmount" style="float:none;width:29mm;padding-top:1px;
                                           padding-bottom:0px;font-size:">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form3468Data/BasisQlfyFuelCellPropAcq"/>
								</xsl:call-template>
							</span>
							<span style="width:19mm;padding-top:0mm;padding-left:1mm;">x 30% (.30)</span>
						</div>
						...
						<div class="styLNAmountBox" style="height:10mm;padding-top:8mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CalcBasisQlfyFuelCellPropAcq"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12f -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
							...
							<span class="styUnderlineAmount" style="float:none;width:30mm;padding-top:0px;
                                           padding-bottom:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form3468Data/QlfyAppFuelCellPropKwCapacity"/>
								</xsl:call-template>
							</span>
						...
						<div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CalcAppFuelCellPropKwCapAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12g -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;height:4.5mm;padding-top:1mm;">
            Enter the lesser of line 12f or 12g
     						       <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
						...
						<div class="styLNAmountBox" style="height:4mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/AdjBasisQlfyAppFuelCellCrAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12h -->
					...
					<div style="width:187mm;">
						...
						<div style="width:138mm;float:left;">
                                  Basis of property placed in service during the year that was acquired  after December 31, 2005,
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;padding-top:1mm;">
            Enter the lesser of line 12i or 12j
            <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
						...
						<div class="styLNAmountBoxNBB" style=" height: 4mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/AdjQlfyMircroturbineKwBasis"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12k -->
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText" style="font-size:8pt;">3468</span> (2010)</div>
					</div>
					<div style="width:187mm;padding-top:1mm;">
               Form 3468 (2010)
                          <span style="width:150mm;"/>
					...
					<div style="width:187mm;">
						...
						<div style="width:138mm;float:left;">
					 Basis of property placed in service during the year that was acquired  after October 3, 2008,
                                  and the basis attributable to construction, reconstruction, and erection by the taxpayer after October 3, 2008
	                                      <span style="float:left;">
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:16px;"/>.
            ...
            Enter the smaller of line 12o or $4,000
					...
					<div style="width:187mm;">
					 ...
					 Basis of property placed in service during the year that was acquired  after December 31, 2008,
                                  and the <br/>basis attributable to construction, reconstruction, and erection by the taxpayer after<br/>
									...
									<span class="styUnderlineAmount" style="float:none;width:29mm;padding-top:0px;padding-bottom:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form3468Data/BssOfWindEnergyConstrErecAmt"/>
										</xsl:call-template>
									</span>
						...
						<div class="styLNAmountBox" style="height:10mm;padding-top:8mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CalcBssOfWindEnergyConstrErec"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12q -->
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:138mm;font-size:7pt;">
                                         ...
                                         basis attributable to construction, reconstruction, or erection by the taxpayer after October3, 2008
 										<!--Dotted Line-->
								<span class="styBoldText" style="float:left">
									<span style="width:16px;"/>.
                                                                  <span style="width:16px;"/>.
								...
								<span style="float:left;">
									...
									<span class="styUnderlineAmount" style="width:29mm;padding-top:0px;padding-bottom:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form3468Data/BasisOfGeothPropHeatPumpSysAmt"/>
										</xsl:call-template>
									</span>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNAmountBox" style="height:12mm;padding-top:8mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form3468Data/CalcBssOfGeoPropHeatPumpSysAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Add lines 11e through 11j, 11m, 12a, 12b, 12e, 12h, 12k, 12n, 12p, 12q, 12r, 12s, and 13
				                                        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
						...
						<div class="styLNAmountBox" style="height:4.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/SumOfRehabAndEnergyCrAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of Line 14 -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Rehabilitation and energy credits included on line 14 from passive activities				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
 								<span style="width:16px;"/>.
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Rehabilitation and energy credits allowed for 2010 from a passive activity				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
 								<span style="width:16px;"/>.
						...
						<div class="styLNAmountBox" style="height:4.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CurrTYRehabEnergyPassActCrAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of Line 17 -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Carryforward of the rehabilitation credit that originated after 2007 and the energy credit that originated in a tax year that began after October 3, 2008 (see instructions)				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
 								<span style="width:16px;"/>.
						...
						<div class="styLNRightNumBox" style="height:8.5mm;width:8mm;padding-top:4.5mm">18</div>
						<div class="styLNAmountBox" style="height:8.5mm;padding-top:4.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CarryforwardOfRehabEnergyCr"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of Line 18 -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Carryback of rehabilitation and energy credits from 2011				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
 								<span style="width:16px;"/>.
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138mm;">
				                Add lines 16 through 19. Report this amount on Form 3800, line 29a				                           <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:4px;"/>
								<span style="width:16px;"/>.
 								<span style="width:16px;"/>.
						...
						<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;border-bottom-width:0px;">20</div>
						<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0px;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/InvestmentCredit"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of Line 20 -->
					...
					<div style="width:187mm;">
						<div style="float:right;" class="styGenericDiv">Form
					       <span class="styBoldText" style="font-size:8pt;">3468</span> (2010)</div>
					</div>

			...
			<body class="styBodyClass">
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						<div class="styFNBox" style="width:28mm;height:20mm;border-right-width:2px;">
						...
						<div class="styFTBox" style="width:131mm;height:20mm;">
							...
							<span>
								For the year January 1 &#8212; December 31, 2017, or other tax year<br />beginning 
						...
						<div class="styTYBox" style="width:28mm;height:20mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">17</span></div>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							During 2017, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status in <br />
					...
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:56mm;">Where was your tax home during 2017?</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Enter the name of the foreign country to which you had a closer connection than to the United States during 2017 <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Where was your tax home on January 1, 2017?
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							After changing your tax home from its location on January 1, 2017, where was your tax home for the remainder of 2017?<br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							...
							10 during all of the 2017 or <strong>(b)</strong> both of the countries listed on lines 9 and 10 for the period during which you <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Have you filed or will you file tax returns for 2017 in the countries listed on lines 9 and 10? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........</span>
							<span style="float:right;">
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8840</span> (2017)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;">
						...
						<div class="styPartDesc">Significant Contacts With Foreign Country or Countries in 2017</div>
					</div>
					<!-- Line 14 -->
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:120.5mm;float:left;">
								Where was your regular or principal permanent home located during 2017? See instructions.
							</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							If you had more than one permanent home available to you at all times during 2017, list the location of each and <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:104mm;float:left;">
								From what country or countries did you derive the majority of your 2017 income?
							</span>

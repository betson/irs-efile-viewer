        ...
        <form name="Form1120ScheduleN">
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styTYBox" style="width:30mm;height:17mm;">
              ...
              <div class="styTY" style="height:8mm;padding-top:2mm">20<span class="styTYColor">17</span>
              </div>
            </div>
          </div>
          <!--Name Line -->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:158mm;height:4.5mm;">
				At any time during the 2017 calendar year, did the corporation have an interest in or a signature or other authority
			</div>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
            <div class="styShadingCell" style="height:4.5mm;width:10mm;"/>
          </div>
          ...
          <div style="width:187mm;height:8mm;">
            ...
            <div class="styLNDesc" style="width:158mm;height:8mm;">
          ...
          <div style="width:187mm;height:4.5mm;">
            ...
            <table class="styTable" style="float:left;font-size:7pt;width:178mm;" cellspacing="0">
              <tr>
                ...
                <td class="styShadingCell" scope="col" style="width:9.9mm;height:6mm;">
          ...
          <!-- line 8 -->
          <div class="styTBB" style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:8mm;">8</div>
            <div class="styLNDesc" style="width:158mm;height:8mm;">
				Was the corporation a specified domestic entity required to file Form 8938 for the tax year (see the Instructions for Form 8938)?
				<span style="width:2px;"/>
                <xsl:call-template name="SetFormLinkInline">
            ...
            <div class="styIRS1120ScheduleNLNYesNoBox" style="height:8mm;padding-top:4mm;border-bottom:0px;">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form1120ScheduleN/RequiredToFileForm8938Ind"/>
              </xsl:call-template>
            </div>
          ...
          <!--Page footer -->
           <div style="width:187mm;">
            ...
            <div class="stySmallText" style="width:41mm;text-align:right;">
              <span class="styBoldText">Schedule N (Form 1120) (2017)</span>
            </div>
          </div>
          <br/>
          <br/>

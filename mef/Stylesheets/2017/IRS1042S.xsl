				...
				<form name="IRS1042S">
					...
					<div class="styNBB" style="width:187mm;height:16mm;">
						...
						<div class="styFTBox" style="width:131mm;float:left;height:16mm;">
							...
							<div class="styMainTitle" style="padding-top:1mm;width:130mm;padding-left:2mm;font-size:9pt;text-align:left;">
								<span class="styIRS1042STableCellContent" style="float:none;width:16mm;height:4mm;border-width:1px 1px 1px 1px;">
								...
								<input alt="AmendedInd" type="checkbox" class="styCkbox" name="AmendedInd" style="height:3.5mm;width:3.5mm;">
								...
								AMENDED 
								<span style="width:5mm;"/>
								<span class="styIRS1042STableCellContent" style="float:none;width:4.5mm;height:4mm;border-width:1px 1px 1px 1px;">
									<span style="float:right;padding-right:2px;">
										<xsl:call-template name="PopulateText">
									...
									<table style="float-left;" cellpadding="0" cellspacing="0">
										...
										<tr>
											...
											Federal tax withheld
												...
												<span class="styIRS1042STableCellContent" style="width:39mm;height:8mm;border-width:0px 1px 0px 1px;padding-top:0;">
													<span style="float-left;font-size:6pt;width:32mm;padding:0mm 0mm 0mm 0.5mm;">
									...
									<table style="float-right;" cellpadding="0" cellspacing="0">
										...
										<tr>
											...
											Recipient's foreign tax identification number, if any<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:17mm;height:9mm;border-width:0px 1px 0px 0px;">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:42mm;height:6.3mm;border-width:0px 1px 0px 0px;">
										...
										Primary Withholding Agent's EIN<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:52mm;height:6.3mm;border-width:0px 1px 0px 0px;">
													<span style="padding-top:1mm;">
					...
					<div class="styFormFooter" style="width:187mm;border-top-width: 1px;">
						...
						<span style="float:right;" class="styGenericDiv">Form <span class="styBoldText">1042-S</span> (2017)</span>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<div style="width:187mm;">
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;font-weight:bold;font-size:6pt;padding-top:0.4mm;">Schedule A (Form 940) 2017</span>
		</div>
				...
				<div class="styIRS940SATableRow">
					...
					<div class="styIRS940SAAmtBoxRR" style="background-color:lightgrey;font-size:6pt;padding-top:3mm;">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:choose>
									<xsl:when test="$StateAbrv = 'CA' or $StateAbrv = 'VI'">
										<span style="text-align:left;">0.021</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="text-align:left;">0.000</span>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:otherwise>
						</xsl:choose>

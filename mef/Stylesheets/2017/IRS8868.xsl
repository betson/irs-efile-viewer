			...
			<body class="styBodyClass">
				<form name="IRS8868">
					...
					<div style="width:187mm; line-height:1.2; padding-top:1mm; padding-bottom:1mm">
						...
						of the
						 ...
						 which must be sent to the IRS in paper form (see instructions).  For more details on the electronic filing of this form, visit 
						  <i>www.irs.gov/efile</i>, click on Charities and Nonprofits, and click on <i>e-file</i> for <i>Charities &#38; Nonprofits.</i>
					</div>
					<!--   BEGIN PART I   -->
					<!--   BEGIN PART I HEADER   -->
					...
					<div style="width:187mm;float:left;clear:none;border-bottom:1px solid black">
						...
						<div class="styFNBox" 
						style="padding-left:2mm;font-size:7pt;width:68mm;height:13mm;border-right-width:0px;border-bottom-width:1px;"> 
						...
						<div class="styNameAddr" style="width:103mm;height:8.5mm; font-size:7pt; border-top-width: 1px;
				...
				<xsl:choose>
					...
					<div class="styIRS8868LineItem" style="width:187mm; padding-top:1mm;height:auto; float:left">
						<span class="styLNLeftNumBoxSD" style="height:6mm;padding-top:3mm">2</span>
						...
						<span style="width: 1mm"/>
							<input type="checkbox" alt="InitialReturn" class="styIRS8868Ckbox" name="InitialReturn" TabIndex="-1" id="InitialReturn">
								<xsl:call-template name="PopulateCheckbox">
							...
							id="AccountingPeriodChangeInd">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS8868Data/Automatic6MonthExtensionOfTime/AccountingPeriodChangeInd"/>
					...
					<div class="pageEnd" style="clear:both;width:187mm;page-break-after:always; ">						
						...
						<span style="; font-size:7pt; float:right;">Form  <span class="styBoldText" style="font-size: 8pt;"> 8868  </span>  (Rev. 1-2017)</span>
						</span>
					</div>
					<!--END FOOTER-->					
					  <!-- end Page footer -->	

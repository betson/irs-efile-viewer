					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styEINBox" rowspan="2" 
							...
							<div style="width:55mm;font-weight:normal;text-align:left;padding-top:0.5mm;">
								...
								<input type="checkbox" class="styCkbox" style="width:4mm;margin-left:none;">
									<xsl:call-template name="PopulateCheckbox">
		...
		<xsl:if test="$index &lt;= $Pt1AddlTblMax">
			...
			<table class="styDepTbl" style="width:187mm;" id="TP1ctn">
				...
				<table class="styDepTbl" cellspacing="0" summary="Table located under line C, having four columns and eight rows"
					...
					<tr>
						<th class="styDepTblCell" rowspan="1" style="width:7mm;text-align:center;border-color:black;border-right:none;border-bottom-width:1px;border-top:none">
							<span style="width:1px;"/>
						</th>
						<th class="styDepTblCell" rowspan="1" style="width:80mm;text-align:left;border-color:black;border-bottom-width:1px;border-top:none;border-right:none
								;border-left:none;">
							<span style="width:1px;"/>
						</th>
						<th class="styDepTblCell" rowspan="1" style="width:29mm;height:7mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;
								border-right:none">
						  Filing Year
						</th>
						<th class="styDepTblCell" colspan="2" style="width:67mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;
								border-right:none">
						  Redetermination Years
						</th>
						<th class="styDepTblCell" rowspan="1" 

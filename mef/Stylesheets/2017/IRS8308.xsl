  ...
  <xsl:template match="/">
        ...
        <form name="Form8308">
          ...
          <div class="styTBB" style="width:187mm;height:19mm;">
            <div class="styFNBox" style="width:30mm;height:19mm;">
				 ...
				 <div style="height:7mm;font-size:7pt;font-family:arial;">(Rev. September 2017)
    ...
    <!-- End Part III, Date of Sale or Exchange of Partnership Interest -->
        ...
        <div style="width:187mm;">
			...
			<span style="font-size:7pt;padding-right:1mm;">Form</span> <span class="styBoldText" style="font-size:8pt;">8308</span> <span style="font-size:7pt;padding-left:1mm;">(Rev. 9-2017)</span>
		</div>
		<br/><br/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
       ...
       <br/>
								<img src="{$ImagePath}/1040SchB_Bullet.gif" alt="Bullet Image"/>  Go to <span style="font-style:italic">www.irs.gov/ScheduleB</span> for instructions and the latest information.       
        </div>
						</div>
...
<!--								<xsl:call-template name="SetInitialDynamicTableHeight">
	...
	<!--							<xsl:call-template name="SetInitialDynamicTableHeight">
					...
					<!-- Line 4 -->
						...
						<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:114mm;padding-left:1mm;border-bottom-width:0px;height:8mm;border-right:0px solid black;">
						...
						<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;height:8mm;padding-top:4mm;border-left:0px solid black;">
							<xsl:call-template name="PopulateAmount">
...
<!--								--><!-- Set Initial Height of Above Table --><!--
								...
								<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:114mm;padding-left:1mm;border-bottom-width:0px;height:8mm;border-right:0px solid black;">
									...
									<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;height:8mm;padding-top:4.2mm;border-left:0px solid black;
">
										<xsl:call-template name="PopulateAmount">
                ...
                You must complete this part if you <span class="styBoldText"> (a) </span> had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
							...
							<div class="styGenericDiv" style="padding-top:0mm;width:158mm;border-bottom-width:0px;">
								...
								<div class="styLNDesc" style="width:135mm;height:10mm;">
									<span style="float:left;clear:none;">
										At any time during 2017, did you have a financial interest in or signature authority over a financial account (such as a bank account, securities account, or brokerage account) located in a foreign country?  See instructions
									   <xsl:call-template name="LinkToLeftoverDataTableInline">
							...
							<div class="styBB" style="padding-top:0mm;width:187mm;float:left;clear:none;border-bottom-width: 0px;padding-bottom:0mm;">
								...
								<div class="styLNDesc" style="width:135mm;height:8mm;float:left;clear:none;">
										During 2017, did you receive a distribution from, or were you the grantor of, or transferor to, a
					...
					<div style="width:187mm; border-top:1 solid black;border-top-width:1px;">
						...
						<div style="float:right;" class="styGenericDiv">
							<b>Schedule B (Form 1040A or 1040) 2017</b>
						</div>
					</div>
					<!-- end page 2 footer -->
					<br/>

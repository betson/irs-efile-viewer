											...
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:for-each select="$IRS5471Data/ForeignEntityIdentificationGrp">
														<tr>
															<td class="styTableCell"
															 style="vertical-align:bottom;height:9mm;border-color:black;border-right:0;border-left:0;">
...
<br/>
    ...
    Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 09-2015)
                    ...
                    <b>(c)</b> Number of shares held at beginning of annual accounting period
								...
								<th scope="col" class="styTableCell" style="border-color: black; width: 29mm; text-align: center;
				...
				<!--   BEGIN SCHEDULE G   -->
						...
						<span>
							...
							<input type="checkbox" alt="ForeignCorporationWasParticipantYes" class="styCkbox" style="width: 3mm; height: 3mm">
								<xsl:call-template name="PopulateYesCheckbox">
									...
									FrgnCorpPartcpCostShrInd"/>
									<xsl:with-param name="BackupName">
									IRS5471ForeignCorporationWasParticipant</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span class="styNBSP" style="width: 10px"/>
					...
					<div class="styGenericDiv" style="width: 187mm">
						...
						<span>
							...
							<input type="checkbox" alt="ForeignCorporationorationBecameParticipantYes" class="styCkbox" style="width: 3mm; height: 3mm">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/
									FrgnCorpBecamePartcpCostShrInd"/>
									<xsl:with-param name="BackupName">
						...
						<span>
							...
							<input type="checkbox" alt="ForeignCorporationorationBecameParticipantNo" class="styCkbox" style="width: 3mm; height: 3mm">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/
									FrgnCorpBecamePartcpCostShrInd"/>
									<xsl:with-param name="BackupName">
                  ...
                  Exchange gain or (loss) on a distribution of previously taxed income  
						...
						<div class="styGenericDiv" style="width: 187mm;padding-top:1mm;">
							...
							<span>
								...
								<input type="checkbox" alt="AnyIncomeBlocked" class="styCkbox" style="width: 3mm; height: 3mm">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
										<xsl:with-param name="BackupName">IRS5471AnyIncomeBlocked</xsl:with-param>
									</xsl:call-template>
                             ...
                             Previously excluded export trade income withdrawn from investment in export trade assets (line 7b,  
								...
								<div class="styGenericDiv" style="width: 187mm;padding-top:1mm;">
									...
									<span>
										...
										<input type="checkbox" alt="Any Income Blocked Yes" class="styCkbox" style="width: 3mm; height: 3mm">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
												<xsl:with-param name="BackupName">IRS547AnyIncomeBlocked</xsl:with-param>
											</xsl:call-template>
									...
									<span>
										...
										<input type="checkbox"  alt="Any Income Blocked No" class="styCkbox" style="width: 3mm; height: 3mm">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="IncomeBlockedInd"/>
												<xsl:with-param name="BackupName">IRS547AnyIncomeBlocked</xsl:with-param>
											</xsl:call-template>
								...
								<div class="styGenericDiv" style="width: 187mm">
									...
									<span>
										...
										<input type="checkbox" alt="Income Become Unblocked This Yes" class="styCkbox" style="width: 3mm; height: 3mm">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
												<xsl:with-param name="BackupName">IRS547IncomeBecomeUnblockedThisTY
												</xsl:with-param>
									...
									<span>
										...
										<input type="checkbox" alt="Income Become Unblocked This No" class="styCkbox" style="width: 3mm; height: 3mm">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="IncomeUnblockedInd"/>
												<xsl:with-param name="BackupName">IRS547IncomeBecomeUnblockedThisTY
												</xsl:with-param>

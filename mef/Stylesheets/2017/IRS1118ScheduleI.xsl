    ...
    <!-- Form Name -->
       ...
       <xsl:call-template name="SetFormLinkInline">
           <xsl:with-param name="TargetNode" select="$FormData"/>
            ...
            <br/>
      <span style="font-size:6pt;">(Rev. October 2017)</span> 
            <br/>
...
<input type="checkbox" alt="PassiveCatagoryIncome" class="styCkbox">
...
<br/>
<input type="checkbox" alt="GeneralCatagoryIncome" class="styCkbox">
	<xsl:call-template name="PopulateCheckbox">
...
<div style="height:12mm;width:108mm;float:left;">
	<input type="checkbox" alt="Section901(j)IncomeNameofSanctionedCountry" class="styCkbox">
		<xsl:call-template name="PopulateCheckbox">
	...
	<span style="border-color:black; border-style:solid; border-right-width: 0px; border-left-width: 0px; 
	border-top-width:0px; border-bottom-width: 1px; width: 25mm">
		<xsl:call-template name="PopulateText">
			<xsl:with-param name="TargetNode" select="$FormData/ForeignIncSection901jInd/@sanctionedCountryCd"/>
		</xsl:call-template>
	</span>
	<br/>
	<input type="checkbox" alt="IncomeRe-sourcedbyTreatyNameofCountry" class="styCkbox">
		<xsl:call-template name="PopulateCheckbox">
	...
	<label>
		...
		<span style="border-color:black; border-style:solid; border-right-width: 0px; border-left-width: 0px; 
			border-top-width:0px; border-bottom-width: 1px; width: 31mm">
			<xsl:call-template name="PopulateText">
				<xsl:with-param name="TargetNode" select="$FormData/ForeignIncResourcedTreatyInd/@countryCd"/>
			</xsl:call-template>
		</span>
	</div>
  </div>
  ...
  <!-- end -->
     <table cellspacing="0" style="font-size:7pt;">
      ...
      <tr>
        ...
        padding-right:3mm" rowspan="2" scope="col">
          <b>1. </b>Name of foreign country (Use a separate line for each country.)*
        </th>
        <th class="IRS1118ScheduleI_GenericCell" style="height:4mm;width:200mm;font-size:7pt;font-weight:bold;border-right-width:0px;text-align:center;" 
        colspan="6" scope="col">
	...
	<xsl:choose>
      ...
      <tr>
        ...
        <td class="IRS1118ScheduleI_GenericCell" style="height:4mm;background-colo">
        <xsl:call-template name="PopulateAmount">
      ...
      <tr>
        ...
        colspan="3" scope="col">
          Deductions
                ...
                <th class="IRS1118ScheduleI_GenericCell" style="text-align:center;height:14mm;" rowspan="2" scope="col">
        ...
        style="width:104mm;height:4mm;font-weight:bold;border-right-width:0px;text-align:center;" colspan="3" scope="col">
          ...
          <tr>
                <th class="IRS1118ScheduleI_GenericCell" style="height:10mm;width:41mm;text-align:center;" scope="col">
                  <span class="styBoldText">8. </span>Definitely allocable deductions</th>
   ...
   <!--BEGIN FOOTER-->
      <div style="width:256mm">
        ...
        <div style="float:right">
          ...
          <span class="styBoldText" style="padding-right:2mm">Schedule I (Form 1118) (Rev. 10-2017)</span>
        </div>      
      </div>
      ...
      <!--BEGIN HEADER-->
      <div class="styBB" style="width:256mm">
        <div style="float: left; clear: none">Schedule I (Form 1118) (Rev. 10-2017)</div>        

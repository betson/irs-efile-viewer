					...
					<div class="styTBB" style="width:256mm;height:25mm;">
						<div class="styFNBox" style="width:31mm;height:25mm;">
							<div style="height:auto;">
								...
								<span style="font-weight:bold;height:5mm;">(Form 1118)</span><br/>
								(Rev. October 2017)
				  ...
				  for instructions and the latest information.
					...
					<div>
						<div style="float:left;padding-left:1.2mm;">
							Use a separate Schedule K (Form 1118) for each category of income listed below.
							 Check only one box on each schedule.
						</div>
					</div>					
						...
						<input type="checkbox" alt="Section 901(j) Income: Name of Sanctioned Country "  class="styCkbox">
							...
							<span style="border-color:black; border-style:solid; border-right-width: 0px;
							 border-left-width: 0px; border-top-width:0px; border-bottom-width: 1px; width: 25mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									select="$Form1118ScheduleKData/
									ForeignIncSection901jInd/@sanctionedCountryCd"/>
								</xsl:call-template>
							</span>							
							<br/>
							<br/>
													...
													select="$Form1118ScheduleKData/OtherAdjustmentsDescription">
														<xsl:choose>
															<xsl:when test="position()=1">
																<span style="width:4mm;font-weight:bold;padding-bottom:0mm;
																 padding-left:2mm;vertical-align:top;">c</span>																	<span style="width:35mm;padding-left:1mm;">
																	<xsl:call-template name="PopulateText">
																		<xsl:with-param name="TargetNode"
					...
					<div style="width:256mm">
						...
						<div style="float:right">
							...
							<b>  Schedule K (Form 1118)  </b>(Rev. 10-2017)
						</div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->

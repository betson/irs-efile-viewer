			...
			<!-- Begin Form title an dForm number section -->
				...
				<div class="styFNBox" style="width:31mm;height:20mm;">
                  Form <span class="styFormNumber">8916</span>
					...
					<span class="styAgency" style="height:11mm;padding-top:3mm;">
					  <span style="width:31mm;"> (Rev. October 2017) </span>
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:10mm;padding-top:6mm;">1</div>
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2b</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2d(1)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2d(2)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2e(1)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2e(2)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2f(1)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">2f(2)</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
			  ...
			  <div style="width:187mm">
			    ...
			    <div style="float:right;clear:none;">
			      <div class="styLNRightNumBox" style="height:9mm;padding-top:5mm;">7</div>
			      <div class="styLNAmountBox" style="height:9mm;padding-top:5mm;">
				    <xsl:call-template name="PopulateAmount">
				      <xsl:with-param name="TargetNode" select="$FormData/OtherAdjustmentsToReconcileAmt"/>
				    </xsl:call-template>

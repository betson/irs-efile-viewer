			...
			<body class="styBodyClass" style="width:187mm;">
				<form id="IRS1040ScheduleE">
                        ...
                        (From rental real estate, royalties, partnerships,
                           S corporations, estates, trusts, REMICs, etc.)
							...
							<div style="padding-top:0.5mm;">
								<img src="{$ImagePath}/1040SchE_Bullet.gif" alt="Bullet Image"/>
								<span class="styBoldText" style="font-size:6pt;padding-left:.5mm;">Go to <i>www.irs.gov/ScheduleE</i> for instructions and the latest information. </span>
							</div>
						</div>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<!-- End Prologue -->
                         <xsl:choose>
							<xsl:when test="($Print != $Separated) and (count($FormData/PropertyRealEstAndRoyaltyGroup) &gt;= 3)">
						...
						<div class="styTableContainer" style="width:188mm;border-bottom-width:1px;height:auto;" id="PICctn">
							...
							<table class="styTable" style="border-bottom-width:1px;height:auto;" cellspacing="0" id="PICTable">
								<tr style="height:2mm;">
									<td class="styTableCell" scope="col" style="height:2mm;width:5.9mm;border-right-width:1px;text-align:center;font-weight:bold;font-size:8pt;">
                                    1a
                                    </td>
									<td class="styTableCell" scope="col" colspan="8" style="width:182mm;height:4mm;border-right-width:0px; text-align:left;padding-left:2mm;">
								...
								<tr>
									...
									<td class="styTableCell" scope="col" style="width:5.9mm;border-right-width:1px;text-align:center;font-weight:bold;font-size:8pt;">
                                        1b
                                   </td>
									...
									<xsl:for-each select="$FormData/PropertyRealEstAndRoyaltyGroup">
										<tr>
											...
											<td class="styTableCell" style="width:16mm;border-right-width:0px;padding-right:6.5mm; vertical-align:center;">
												<input type="checkbox" class="styCkbox" alt="Qualified Joint Venture">
								...
								<xsl:if test="count($FormData/PropertyRealEstAndRoyaltyGroup) &lt; 2 or ((count($FormData/PropertyRealEstAndRoyaltyGroup) &gt; 3) and ($Print = $Separated))">
									<tr>
										...
										<!-- Column I -->
										<td class="styTableCell" style="width:16mm;border-right-width:0px;text-align:center; vertical-align:center;">
											<input type="checkbox" class="styCkbox" alt="Property Real Estate And Royalty Group">
													<xsl:call-template name="PopulateCheckbox">
													...
													<xsl:choose>
														<xsl:when test="position() mod 3=1">
															...
															<td class="styTableCell" style="text-align:left;border-width:0px 1px 0px 0px;border-style:solid; width:63.6mm;padding-left:1.5mm;">
																...
																<span style="width:10mm;border-bottom-width:1px">
																	<xsl:call-template name="PopulateText">
													...
													<xsl:choose>
														<xsl:when test="position() = 1">
															...
															<td style="font-size:7pt;border-right-width:0px;border-top-width:0px;border-left-width:0px;border-bottom-width:1px">
																<div class="styGenericDiv" style="width:7.4mm;font-weight:bold;text-align:left;padding-left:0mm;margin-bottom:0mm;height:3.5mm">19</div>
															</td>
															<!-- Col 2 -->
															<td style="text-align:left;border-width:0px 1px 0px 0px;border-style:solid;padding-left:1.5mm;">
																<div class="styGenericDiv" style="width:50mm;font-size:7pt;">
																	...
																	<div class="styBB" style="width:32mm;float:right;border-style:dotted;">
																		<xsl:call-template name="PopulateText">
																			<xsl:with-param name="TargetNode" select="Desc"/>
																		</xsl:call-template>
																	</div>
									...
									<xsl:if test="($Print != $Separated) or (count($FormData/PropertyRealEstAndRoyaltyGroup) &lt; 1) ">
										...
										<xsl:if test="position() mod 3 = 1">
											...
											<tr>
												...
												<!-- Column 2 -->
												<td class="styTableCell" style="width:63.6mm;text-align:left;border-bottom-width:0px;">
													<span style="font-size:7pt;float:left;padding-left:1.5mm;">Other (list)
 													<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="SmallBullet"/> 
 													<span style="padding-right:1mm;float:right;clear:none;">__________________________</span>
											...
											<tr style="height:auto;">
												...
												<td class="styTableCell" style="width:34.5mm;vertical-align:text-bottom;">
												      <span class="styTableCellPad" style="height:7mm;width:5mm;border-left-width:0px;padding-top:6mm;;text-align:right;">(  )
													<!--<span style="width:10mm; height:7mm;padding-top:7mm;text-align:right;"> (  ) </span>-->
													</span>
												</td>
												                                                            <!-- Column 4 --> 
												<td class="styTableCell" style="width:34.5mm;vertical-align:text-bottom;">
					...
					<div class="pageEnd" style="width:187mm;page-break-after:always;display:block;">
						...
						<span style="float:right;clear:none;">
							<span class="styBoldText" style="font-size:7pt;padding-top:.5mm;padding-left:10mm;float:right;">Schedule E (Form 1040) 2017</span>
						</span>
					</div>
					...
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2017</span>
					...
					<!-- End Part II Title -->
					<!-- Line 27-->
					<div style="width:187mm;height:10.5mm;" class="styBB">
					    <div class="styLNLeftNumBox" style="float:left;clear:none;padding-right:4mm;width:5mm;padding-top:.5mm;padding-left:1mm;">27</div>
					    <div style="width:180mm;padding-left:10mm;">
					   Are you reporting any loss not allowed in a prior year due to the at-risk, excess farm loss, or basis limitations, a prior year unallowed loss from a passive
					   activity (if that loss was not reported on Form 8582), or unreimbursed partnership expenses?
					   If you answered “Yes,” see instructions before completing this section.  
					   <span style="width:60mm;float:right;">
                             <span style="width:16mm;float:left;clear:none;padding-left:2mm;padding-top:5.5mm;">
                                  <xsl:call-template name="PopulateSpan">
							...
							<input type="Checkbox" class="styCkbox" alt="Yes" style="width:2.5mm">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PriorYearsLossesInd"/>
							...
							<span style="width:6mm"/>
								<!-- No Checkbox -->
							<input type="Checkbox" class="styCkbox" alt="No" style="width:2.5mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PriorYearsLossesInd"/>
									<xsl:with-param name="BackupName">IRS1040ScheduleEPriorYearsLossesInd</xsl:with-param>
								</xsl:call-template>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px" id="sCorpContainerId">
						<table style="float:none;clear:both;" class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr style="height:7mm;">
									<th class="styTableCellHeader" scope="col" style="width:5mm;border-right-width:0px;height:7mm;float:left;">
									...
									<th class="styTableCellHeader" scope="col" style="width:32mm;border-right-width:0px;height:7mm;">
										<span style="padding-left:2mm;">
								...
								<xsl:if test="($Print != $Separated) or (count($FormData/PartnershipOrSCorpGroup) &lt;= 4) ">
									<xsl:for-each select="$FormData/PartnershipOrSCorpGroup">
										<tr style="height:11mm;">
											...
											<!-- Column c -->
											<td class="styTableCell" style="width:31.9mm;height:11mm;text-align:center;float:center;clear:none;font-size:7pt;vertical-align:top;background">
												<!-- Checkbox -->
												<input type="checkbox" alt="Foreign Partnership" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
											...
											<td class="styTableCell" style="width:32mm;height:11mm;text-align:center;float:center;clear:none;border-right-width:0px;font-size:7pt;vertical-align:top;">
												<!-- Checkbox -->
												<input type="Checkbox" alt="Any Amount Is Not At Risk" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
								...
								<xsl:if test="count($FormData/PartnershipOrSCorpGroup) &lt; 1 or ((count($FormData/PartnershipOrSCorpGroup) &gt; 4) and ($Print = $Separated))">
									<tr>
										...
										<td class="styTableCell" style="width:31.9mm;height:5.5mm;text-align:center">
											<input type="Checkbox" alt="Partnership Or S Corporation Group Any Amount Is Not At Risk" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
									...
									<tr style="height:auto;">
										...
										<th class="styTableCellHeader" scope="col" style="width:46mm;clear:none;height:8.5mm;">
											...
											<span style="padding-left:2mm;padding-right:1mm;">
												<span style="font-weight:bold;">(f) <span class="styNormalText"> Passive loss allowed </span>
												</span>
										...
										<th class="styTableCellHeader" scope="col" style="width:36.5mm;border-right-width:1px;clear:none;height:8.5mm;">
											<span style="padding-left:2mm;padding-right:1mm;">
												<span style="font-weight:bold;">(g) <span class="styNormalText">Passive income</span>
												</span>
												<span style="float:center;">
										...
										<th class="styTableCellHeader" scope="col" style="width:36.5mm;clear:none;height:8.5mm;">
										        	...
										        	<span style="font-weight:bold;">(h) <span class="styNormalText">Nonpassive loss</span>
												</span>
												<span style="float:center;">
													<span style="font-weight:normal;padding-right:1mm;">from</span>
													<b>Schedule K-1</b>
										...
										<th class="styTableCellHeader" scope="col" style="width:30.9mm;clear:none;height:8.5mm;">
											<span style="padding-left:2mm;padding-right:1mm;">
												<span style="font-weight:bold;">(i) <span class="styNormalText">Section 179 expense</span>
												</span>
												<span style="float:center;">
										...
										<th class="styTableCellHeader" scope="col" style="width:36mm;border-right-width:0px;clear:none;">
											<span style="padding-left:2mm;padding-right:1mm;">
												<span style="font-weight:bold;">(j) <span class="styNormalText">Nonpassive income</span>
												</span>
												<span style="float:center;">
													<span style="font-weight:normal;padding-right:1mm;"> from</span>
													<b>Schedule K-1 </b>
						...
						<div style="width:187mm">
							<div style="width:187mm;border-right-width:0px;height:auto;">
								<div style="float:left;clear:none;height:auto;">
									...
									<div style="float:left;clear:none;height:auto;">
										<div class="styShadingCell" style="width:34mm;border-bottom-width:1px;height:5mm;font-size:7pt;border-right-width:0px;"/>
										<div class="styShadingCell" style="width:34.8mm;border-bottom-width:1px;height:5mm;font-size:7pt;border-left-width:0px;"/>
										<div class="styLNAmountBox" style="width:35.2mm;height:5mm;padding-right:1mm;">
											<xsl:call-template name="PopulateAmount">
									...
									<div class="styShadingCell" style="height:4.5mm;width:35.5mm;border-bottom-width:1px;"/>
								</div>
							</div>
						</div>
						<!-- End line 29 -->
                     ...
                     32
								...
								<thead class="styTableThead">
									<tr>
										...
										<th class="styTableCellHeader" scope="col" style="width:36.5mm;border-right-width:0px;clear:none;">
											<span style="font-weight:bold;">(b) <span class="styNormalText"> Employer </span> <span style="width:2mm"/>
												<span style="font-weight:normal">identification number</span>
											</span>
											<!--<span>
						...
						<div class="styBB" style="width:187mm;border-top-width:1px;">
							<div class="styPartName" style="width:15mm;height:3.85mm;">Part lV</div>
                  ...
                  lncome or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
						...
						<div class="pageEnd" style="height:6mm;width:187mm;">
							...
							<div class="stySmallText" style="width:46mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2017</span>
							</div>
						</div>
					</div>
					<!-- end page 2 footer -->
								...
								<xsl:for-each select="$FormData/PropertyRealEstAndRoyaltyGroup">
									<tr style="height:6mm;">
										...
										<td class="styTableCellText" style="width:9mm;text-align:center;">
											<input class="styCkbox" alt="Qualified Joint Venture" type="checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="QualifiedJointVentureInd"/>
								...
								<xsl:for-each select="$FormData/PartnershipOrSCorpGroup">
									<tr style="height:6mm;">
										...
										<td class="styDepTblCell" style="text-align:center;width:23.2mm;">
											<!-- Checkbox -->
											<input type="Checkbox" alt="Any Amount Is No At Risk" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="AnyAmountIsNotAtRiskInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleEPartnershipOrSCorpGroupAnyAmountIsNotAtRiskInd</xsl:with-param>
												</xsl:call-template>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<form name="Form1040ScheduleF">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:152mm;height:4.5mm;padding-top:1.5mm;">
							<span style="float:left;">
								Did you "materially participate" in the operation of this business during 2017? If "No," see instructions for limit on passive losses
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:67.5mm;height:4mm;">
							<span style="float:left">Amount received in 2017</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:80mm;height:4mm;">
							If election to defer to 2018 is attached, check here
							<label>
								<xsl:call-template name="PopulateLabel">
	...
	<xsl:if test="($Print = $Separated) or (count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt;= 5) ">
					...
					<div class="styLNDesc" style="height:4.5mm;width:140mm;">
						Did you receive an applicable subsidy in 2017? See instructions
					...
					<div style="width:187mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule F (Form 1040) 2017 </span>
						</div>
					</div>
					...
					<!-- Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule F (Form 1040) 2017 <span style="width:130mm;"/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="stySmallText" style="width:46mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;">Schedule F (Form 1040) 2017</span>
						</div>
					</div>
					<br/>
					<br class="pageEnd"/>

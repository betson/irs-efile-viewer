       ...
       <!--    <span style="width:2px;"></span>
        ...
        <div class="styFTBox" style="width:128mm;height:auto;">
         ...
         <span style="padding-left:1mm;padding-top:1mm;text-align:left;"><img src="{$ImagePath}/990SchM_Bullet_Line.gif" alt="Right pointing arrow large image" width="6"/> Attach to Form 990.</span>
                         <br/>
            <span style="padding-left:1mm;padding-top:1mm;text-align:left;"> 
  ...
  <div style="width:187mm;" class="styBB">
   ...
   <!-- Page Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageEnd">
      ...
      <div class="styGenericDiv" style="float:right;font-size:6pt;"><span class="styBoldText">Schedule M (Form 990) (2017)</span> 
    </div> </div>
<!--END Page Footer-->

  <!-- Page 2 header -->
    <div style="width:187mm;clear:both;padding-bottom:0mm;float:none;clear:both;" class="styBB">
      <div style="width:90mm;font-size:6.25pt;font-weight:bold;padding-top:1mm;" class="styGenericDiv">Schedule M (Form 990) (2017)</div>
...
<xsl:call-template name="SetInitialDynamicTableHeight">
   ...
   <!-- Footer -->
    <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" class="pageEnd">
      ...
      <div class="styGenericDiv" style="float:right;"> <span class="styBoldText">Schedule M (Form 990) (2017)</span></div>
    </div>

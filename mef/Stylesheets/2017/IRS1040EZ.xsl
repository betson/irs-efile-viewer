...
<!-- Last Modified by Eugenia McDonald on 03/01/2018 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="IRS1040EZ">
					...
					<!-- Income -->
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styTBB" style="width: 187mm; height: 59mm; clear: left; float: left;">
						<div class="styIRS1040EZLineItem" style="width: 187mm; height: 53mm;">
							<!-- Header -->
							<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 58mm;">
							...
							<!-- Body -->
							<div class="styIRS1040EZCleanDiv" style="width: 153mm; height: 58mm;">
								<!-- (1) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 6mm;padding-top:0mm">
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 4mm; padding-top: 0mm;">1</div>
									...
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 4mm; float: right;padding-top:2mm">
										<xsl:call-template name="CreateBox">
											<xsl:with-param name="Number">1</xsl:with-param>
											<xsl:with-param name="AmountBoxStyle">padding:1px 0px 0px 0px;</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$Form1040EZData/WagesSalariesAndTipsAmt"/>
										</xsl:call-template>
									</div>
								</div>
								<!-- (2) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 7mm; padding-top: 3mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 4mm; padding-top: 1mm;">2</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 7mm; padding-top: .8mm">
									...
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 5mm; float: right;padding-bottom: .2mm">
										<xsl:call-template name="CreateBox">
								...
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 7mm; padding-top: 2.5mm;">
									...
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4mm; padding-top: .8mm;">
								...
								<!-- (5) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 18mm; padding-top: .5mm;">
									...
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 16mm; padding-top: 0mm;">
										...
										<br/>
										If no one can claim you (or your spouse if a joint return), enter $10,400 if <b>single;</b>
										<br/>
										$20,800 if <b>married filing jointly.</b> See back for explanation.
									</div>
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 16mm; float: right; ">
										<xsl:call-template name="CreateBox">
											<xsl:with-param name="Height">16mm</xsl:with-param>
											<xsl:with-param name="Number">5</xsl:with-param>
											<xsl:with-param name="AmountBoxStyle">padding:28px 0px 0px 0px;</xsl:with-param>
											<xsl:with-param name="NumberBoxStyle">padding:53px 0px 0px 0px;</xsl:with-param>
										</xsl:call-template>
										<xsl:call-template name="CreateBox">
								...
								<div class="styIRS1040EZLineItem" style="width: 153mm; height: 4mm; padding-top: 1mm;">
									...
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4mm; padding-top: 0mm;">
									...
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 4mm; float: right; padding-top: 2.2mm;">
										<xsl:call-template name="CreateBox">
					...
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styTBB" style="width: 187mm; height: 35mm; clear: left; float: left;">
						<div class="styIRS1040EZLineItem" style="width: 187mm; height: 37mm;">
							<!-- Header -->
							<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 24mm;padding-top:.5mm">
								<span class="styBoldText" style="font-size:10pt;">Payments,<br/>Credits,<br/>and Tax</span>
							</div>
							<!-- Body -->
							<div class="styIRS1040EZCleanDiv" style="width: 153mm; height: 25mm;">
								<!-- (7) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 4mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 4mm; padding-top: .5mm;">7</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4mm; padding-top: .7mm;">
								...
								<!-- (8) ////////////////////////////////////////////////////-->
								<!-- (8a) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 4.5mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="padding: 1mm 0mm 0mm 2mm; width: 6mm; height: 4mm;">8a</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4mm; padding-top: 1mm;">
										...
										<xsl:if test="$Form1040EZData/PriorYearEarnedIncomeCd">
											<span style="width:4px;"/>
											<xsl:call-template name="LinkToLeftoverDataTableInline">
												<xsl:with-param name="Desc">Prior Year Earned Income Code</xsl:with-param>
												<xsl:with-param name="TargetNode" select="$Form1040EZData/PriorYearEarnedIncomeCd"/>
											</xsl:call-template>
										</xsl:if>
										<xsl:if test="$Form1040EZData/PriorYearEarnedIncomeAmt">
											<span style="width:4px;"/>
											<xsl:call-template name="LinkToLeftoverDataTableInline">
												<xsl:with-param name="Desc">Prior Year Earned Income Amount</xsl:with-param>
												<xsl:with-param name="TargetNode" select="$Form1040EZData/PriorYearEarnedIncomeAmt"/>
											</xsl:call-template>																						
										</xsl:if>
									</div>
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 4mm; float: right; padding-top: 0mm;">
										<xsl:call-template name="CreateBox">
								...
								<!-- (8b) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 4mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="padding: .5mm 0mm 0mm 2mm; width: 6mm; height: 4mm;">b</div>
									<div class="styIRS1040EZLNDesc" style="width: 74mm; height: 4mm; padding-top: .5mm;">
										Nontaxable combat pay election.
									</div>
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; float: left; padding-top: 0mm;">
										<xsl:call-template name="CreateBox">
											<xsl:with-param name="Number">8b</xsl:with-param>
											<xsl:with-param name="AmountBoxStyle">padding:4px 0px 0px 0px;</xsl:with-param>
								...
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 5mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 4mm; padding-top: 1mm;">9</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4mm; padding-top: 1mm;">
									...
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 4mm; float: right; padding-top: .5mm;">
										<xsl:call-template name="CreateBox">
								...
								<!-- (10) ////////////////////////////////////////////////////-->
								<div class="styIRS1040EZLineItem" style="width: 153mm; height: 12.5mm;"> 
								  <div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 6.5mm;"> 
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 2mm; padding-top: .5mm;">10</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 4.5mm; padding-top: .5mm;">
									...
									<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 4.5mm; float: right;padding-top:2mm">
										<xsl:call-template name="CreateBox">
								...
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 6mm;">
						        	...
						        	<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 6mm;padding-top:.3mm">	
							   	...
							   	<!-- (12) //////////////////////////////////////////////////// 	-->							 				    	
				            	<div class="styIRS1040EZLineItem" style="width: 153mm; height: 4mm; padding-top:.3mm">			           		            	 	
									<div class="styIRS1040EZLNLeftNumBox" style="width: 6mm; height: 0.25mm; padding-top:1.2mm;">12</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 0.25mm; padding-top:1.5mm;">									
										 Add lines 10 and 11. This is your <b> total tax. </b>
									</div>
									<div class="styIRS1040EZCleanDiv" style="border-width: 0px; width: 34mm; height: 4mm; text-align: right; padding-right: 0mm; 
									  float: right;">
										<xsl:call-template name="CreateBox">
											<xsl:with-param name="NumberBoxStyle">padding-top:1mm</xsl:with-param>
					...
					<div class="styTBB" style="width: 187mm; height: 27mm; clear: left; border-bottom-width: 2px; float: left;">
						<div class="styIRS1040EZLineItem" style="height:27mm;">
							...
							<div class="styIRS1040EZCleanDiv" style="width: 34mm; height: 25mm;">
								...
								<br/>
								<span style="font-size:3pt;"><br/></span>Have it directly<br/>
								deposited! See<br/>
								instructions and <br/>
								fill in 13b, 13c,<br/>
								and 13d, or<br/>
							...
							<div class="styIRS1040EZCleanDiv" style="width: 153mm; height: 9mm;">
								...
								<div class="styIRS1040EZLineItemBB" style="width: 153mm; height: 9.25mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="padding-right:0px;padding-top:.5mm">13a</div>
									<div class="styIRS1040EZLNDesc" style="width: 112mm; height: 9mm;padding-top:.5mm">
					...
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styTBB" style="width:187mm; clear: left; float: left;">
						<div class="styIRS1040EZLineItem" style="width:187mm; height:7.5mm;">
							<!-- Header -->
							<div class="styIRS1040EZCleanDiv" style="width:34mm; height:7.5mm;">
							...
							<div class="styIRS1040EZCleanDiv" style="width:153mm;height:8mm;">
								...
								<div class="styIRS1040EZLineItem" style="width:153mm;height:8mm;">
									<div class="styIRS1040EZLNLeftNumBox" style="padding-top:1.5mm;">14</div>
									<div class="styIRS1040EZLNDesc" style="width:112mm; height:8mm; padding-top:1.5mm;">
									...
									<div class="styIRS1040EZCleanDiv" style="width:34mm; height:8mm; float:right; padding-top: 3mm;">
										<xsl:call-template name="CreateBox">
											<xsl:with-param name="NumberBoxStyle">padding-top:1mm</xsl:with-param>
					...
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styBB" style="width:187mm; height:15.4mm; border-bottom-width: 2px;">
						<div class="styIRS1040EZLineItem" style="height:15.4mm;">
							<!-- Header -->
							<div class="styIRS1040EZCleanDiv" style="width: 34mm; height:15.4mm;">
								<span class="styBoldText" style="font-size:10pt;">Third Party<br/>Designee</span>
							</div>
							<!-- Body -->
							<div class="styIRS1040EZCleanDiv" style="width:153mm; height:15.4mm;">
								<div class="styIRS1040EZLineItem" style="width:153mm; height:8mm;">
								...
								<div class="styIRS1040EZLineItem" style="width: 153mm; height: 8mm;">
									...
									<div class="styIRS1040EZLNDesc" style="width:25mm;padding:0px 0px 0px 0px;height:100%;">Personal identification<br/>
									  number (PIN)</div>
									<div class="styIRS1040EZLNDesc" style="width:3mm;padding:12px 0px 0px 0px;height:100%;"><img src="{$ImagePath}/1040EZ_Bullet_Sm.gif" alt="Small Bullet"/></div>
										<div class="styIRS1040EZCleanDiv" style="border-width: 1px; border-color: black; width: 15mm; height: 4.5mm; 
										  text-align: center; margin-top: 2mm;">
										<div class="styIRS1040EZCleanDiv" style="border-width: 0px; border-color: black; width: 15mm; height: 4mm;
					...
					<!-- Sign Here -->
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styGenericDiv" style="height:9mm; width:187mm; clear: left; float: left; border-bottom-width: 2px;">
						<div class="styIRS1040EZLineItem" style="height:9mm;">
							<!-- Header -->
							<div class="styGenericDiv" style="width:34mm; height:9mm;">
							...
							<div class="styGenericDiv" style="width:153mm; height:8mm;">
								<div class="styIRS1040EZLNDesc" style="padding: 1mm 0mm 0mm; width: 153mm; height: 8mm;">
									Under penalties of perjury, I declare that I have examined this return and, to the best of my knowledge and belief, it is true,
									correct, and accurately lists all amounts and sources of income I received during the tax year. Declaration of preparer 
							...
							<!-- Body -->
						<div class="styGenericDiv" style="width: 187mm; height: 23.5mm; clear: left; border-bottom-color: black; border-bottom-width: 2px; 
							 ...
							 <div class="styGenericDiv" style="width:10mm;height:13mm;padding-top:0mm">
								...
								<!-- Container -->
									...
									<div class="styGenericDiv" style="width:153mm;height:11mm;border-bottom:1px solid black;">
										<!-- Your Signature -->
										<div class="styIRS1040EZLNDesc" style="width:50mm; height:10.5mm; border-right-width:1px; border-color:black;
										  padding-left:0px;">
											Your signature<br/>
									...
									<!-- Line 2 -->
									<div class="styGenericDiv" style="width:153mm;height:12mm;">
										<!-- Your Signature -->
										<div class="styIRS1040EZLNDesc" style="width:50mm;height:12mm;border-right-width:1px;border-color:black;padding-left:0px;">
										...
										<!-- Date -->
										<div class="styIRS1040EZLNDesc" style="width:16mm;height:12mm;border-right-width:1px;border-color:black;padding-left:0px;">
											<span style="width:100%;padding-left:4px;">Date</span>
											<span style="width:100%;padding-top:6px;text-align:center;">
												<xsl:call-template name="PopulateMonthDayYear">
										...
										<!-- Spouse’s occupation -->
										<div class="styIRS1040EZLNDesc" style="width:45mm;height:12mm;border-right-width:1px;border-color:black;padding-left:0px;">
										...
										<div class="styIRS1040EZLNDesc" style="width:42mm;height:12mm;padding-left:2px;">
											<span style="width:42mm;padding-left:4px;font-family:Arial Narrow;">If the IRS sent you an Identity Protection</span>
											<span style="width:42mm;padding-left:4px; padding-bottom: 1mm; font-family:Arial Narrow;">PIN, enter it here
											 (see inst.)</span>
											<span style="width:25mm;height:4mm;padding-top:2px;text-align:center;font-family:Verdana;font-size:7pt;
					...
					<div class="pageEnd" style="width:187mm; height: 8mm; padding-top:1mm; clear: left; float: left;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">1040EZ</span> (2017)
						</div>
					...
					<table class="styLeftOverTbl" style="clear: left; float: left;">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 8a - Prior Year Earned Income Code</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1040EZData/PriorYearEarnedIncomeCd"/>
							<xsl:with-param name="DescWidth" select="$TableWidth"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Line 8a - Prior Year Earned Income Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1040EZData/PriorYearEarnedIncomeAmt"/>
							<xsl:with-param name="DescWidth" select="$TableWidth"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							...
							<xsl:with-param name="TargetNode" select="$Form1040EZData/RefundProductCd"/>
							<xsl:with-param name="DescWidth" select="$TableWidth"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Top Left Margin - Refund Product Code Text</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1040EZData/RefundProductCodeTxt"/>
							<xsl:with-param name="DescWidth" select="$TableWidth"/>
						</xsl:call-template>
				<!-- Begin Separated Repeating data table for Special Condition Description-->
				<xsl:if test="$Form1040EZData/SpecialConditionDesc">
					...
					<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
						...
						<tbody>
							<xsl:for-each select="$Form1040EZData/SpecialConditionDesc">
									...
									<td class="styTableCellText" style="width:91.5mm;">
										...
										<div style="width:80mm;float:none;clear:none;">
											...
											<xsl:call-template name="PopulateText">
												...
												<xsl:with-param name="BackupName">IRS1040EZSpecialConditionDescription</xsl:with-param>
											</xsl:call-template>
										</div>
									</td>
								</tr>
	...
	<xsl:template name="PopulateFormLinks">
		<xsl:call-template name="LinkToLeftoverDataTableInline">
			...
			<xsl:with-param name="TargetNode" select="$Form1040EZData/SpecialConditionDesc"/>
		</xsl:call-template>
		<xsl:call-template name="LinkToLeftoverDataTableInline">
			<xsl:with-param name="Desc">Top Left Margin - Primary Date of Death</xsl:with-param>
			<xsl:with-param name="TargetNode" select="$Form1040EZData/PrimaryDeathDt"/>
	...
	<xsl:template name="CreateBox">
		...
		<div class="styLNAmountBox">
			<xsl:attribute name="style">
				...
				height:<xsl:value-of select="$Height"/>;
				border-width: 0px; width: 26mm; height: 5mm; text-align: right; padding-top: 1.5mm; padding-right: 2px; font-size: 6pt;

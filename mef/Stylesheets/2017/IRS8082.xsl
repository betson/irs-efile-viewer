...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    foreign trust owners and beneficiaries, REMIC residual interest holders, and TMPs.) </div>
							<div style="height:3.5mm;font-size:7pt;padding-top:1.5mm;" class="styFST">
								...
								Go to  			
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form8082" title="Link to IRS.gov">
									<i>www.irs.gov/Form8082</i></a> for instructions and the latest information.
  </div>
						</div>
...
-->										</xsl:if>
    ...
    Explanations—Enter the Part II item number before each explanation. If more space is needed, continue your explanations on the back.
					...
					<div style="width:187mm;clear:both;border-top:1px solid black;">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8082</span> (Rev. 9-2017)</div>
					</div>
					<div class="pageEnd"/>

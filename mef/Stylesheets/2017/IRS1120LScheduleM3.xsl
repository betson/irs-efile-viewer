				...
				<form name="Form1120LScheduleM3">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:30mm;height:19.5mm;border-left-width:2px;">
							...
							<div class="styTY" style="height:11mm;padding-top:1.5mm;">20<span class="styTYColor">17</span>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" alt="IRS1120LScheduleM3NonConsolidatedReturn" class="styCkbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (2)
							<input type="checkbox" alt="IRS1120LScheduleM3ConsolidatedReturn (Form 1120-L only)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3Mixed1120/L/PCGroup">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3DormantSubsidiariesscheduleAttached">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="CorporationFiledSECForm10KIndYes" class="styCkbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="CorporationFiledSECForm10KIndNo" class="styCkbox">
					...
					<div style="width:187mm;">
						...
						<div style="width:25mm;height:4.5mm;border: solid 1px;float:left;margin-left:3mm;text-align:center;">
							<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:135mm;padding-top:.5mm;">(1)
							    <input type="checkbox" alt="IRS1120LScheduleM3GAAP" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
								...
								<input type="checkbox" alt="IRS1120LScheduleM3IFRS" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
							    ...
							    <input type="checkbox" alt="IRS1120LScheduleM3Statutory" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
							    ...
							    <input type="checkbox" alt="IRS1120LScheduleM3Other (specify)" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-L) 2017</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
						<div style="float:left;">Schedule M-3 (Form 1120-L) 2017</div>
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<input type="checkbox" alt="IRS1120LScheduleM3/ConsolidatedGroup" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(2)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3/ParentCorp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(3)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3ConsolidatedEliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(4)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3SubsidiaryCorp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(5)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3Mixed1120/L/PCGroup" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<b>(6)</b>
							<input type="checkbox" alt="IRS1120LScheduleM31120-LGroup" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:5mm;">
							<b>(7)</b>
							<input type="checkbox" alt="IRS1120LScheduleM31120-LEliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
...
<!-- Form Link -->
					...
					<!-- Page 2 END -->
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-L) 2017</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							Check applicable box(es): <b>(1)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3ConsolidatedGroup" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:1px;">
							<b>(2)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3ParentCorp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">

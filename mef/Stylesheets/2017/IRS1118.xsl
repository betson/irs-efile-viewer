	...
	<xsl:template match="/">
        ...
        Check only one box on each form.<br/>
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all amounts in U.S. dollars. See<b> Specific instructions</b>.)</span>
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:21mm;height:22mm;" rowspan="3" scope="col">1. <span class="styNormalText" style="display:inline;">Foreign Country or U.S. Possession (Enter two-letter code; see instructions. Use a separate line for each.)*</span>
									</th>
					...
					<div class="styTableContainerLandscape" style="height:71mm;width:256mm;border-bottom-width:0px;display:block;" id="DEDctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0">
			...
			width: 256mm; height:auto;float:none;clear:both;overflow-y: auto;" id="FTPctn">
						...
						<table class="styTable" cellspacing="0" style="height: 66mm">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellLtr" style="width:8mm;height:21mm;" rowspan="3">
										<span class="styTableCellPad" style="font-weight:bold"/>
									</th>
									...
									<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:192mm;height:7mm;" colspan="8">2. <span class="styNormalText" style="display:inline;">Foreign Taxes Paid or Accrued (attach schedule showing amounts in foreign currency and conversion rate(s) used)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" scope="col" style="height:21mm;" rowspan="3">3. <span class="styNormalText" style="display:inline;">Tax Deemed Paid (from Schedule C- Part I, column 12, Part II, column 8(b), and Part III, column 8)</span>
										<span style="width:4px"/>
									</th>
								</tr>
								<tr>
          ...
          Section 902(b)
					...
					<div style="width:256mm;height:8mm;float:none;clear:none;display:block;;border-bottom-width:0px;">
						<div class="stySectionDesc" style="width:251.8mm;text-align:left;padding-left:0;border-bottom-width:0px;">Section B—Dividends Paid Out of Pre-1987 Accumulated Profits
						  <span style="font-weight:normal;display:inline;border-bottom-width:0px;">(In general, include the column 8(b) results in Section A, column 6(b), of Part I. However, see instructions for
							Schedule C, Part I, column 6(b) for an exception.)
						  </span>
						</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right;border-bottom-width:0px;">
...
<div class="styBB" style="width:256mm;float:none;clear:none;">
					...
					<!-- BEGIN FIFTHTIER_TAX -->
					<div class="styBB" style="height:8mm;width:256mm;float:none;clear:none;display:block;border-bottom-width:0px;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;text-align:left;padding-left:0;border-bottom-width:0px;">Part III—Tax Deemed Paid by Fifth-Tier Foreign Corporations
					...
					<div class="styTableContainerLandscape" style="display:block;" id="5TUEctn">
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:74mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">1a. <span class="styNormalText" style="display:inline;">Name of Sixth-Tier Foreign Corporation and Its Related Fifth-Tier Foreign Corporation</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:17mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">1b. <span class="styNormalText" style="display:inline;">EIN (if any) of the sixth-tier foreign corporation</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:65mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">1c. <span class="styNormalText" style="display:inline;">Reference ID number</span><br/><span class="styNormalText">(see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:15mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">2. <span class="styNormalText" style="display:inline;">Tax Year End (Yr-Mo) (see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:15mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">3. <span class="styNormalText" style="display:inline;">Country of Incorporation (enter country code - see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">4. <span class="styNormalText" style="display:inline;">Post-1986 Undistributed Earnings (in functional currency—attach schedule)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">5. <span class="styNormalText" style="display:inline;">Opening Balance in Post-1986 Foreign Income Taxes</span>
									</th>
								</tr>
							</thead>
							<tfoot/>

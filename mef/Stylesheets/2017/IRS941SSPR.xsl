        ...
        <form name="IRS941SSPR" style="font-family:arial;">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styFNBox" style="width:51mm;height:12mm;border:0px;">
                ...
                <br/>
				<span class="styAgency">(Rev. January 2017)</span>
				<br/>
			...
			<div style="float:right;padding-right:2mm;">
				<div class="styBB" style="width:58mm;height:48mm;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;">
					...
					<div style="width:53mm;padding-bottom:0mm;padding-top:4mm;float:none;clear:both;font-size:7pt;">
						Instructions and prior year forms are available at <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form941" title="Link to IRS.gov"><i>www.irs.gov/form941ss</i>.</a>
					</div>
				</div>
			</div>
				...
				<!-- DOUBLE CHECK PUSHPIN -->
					...
					<div style="width:187mm;height:7mm;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:134mm;padding-left:1mm;padding-top:2.6mm;">
								<span style="float:left;"><b>Total taxes after adjustments and credits.</b> Subtract line 11 from line 10 </span>
								<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
							</div>
						</span>
		...
		<div style="width:187mm;font-size:8pt;">
			...
			<div style="width:187mm;padding-bottom:1mm;padding-top:1mm;">
				...
				<label style="padding-left:3mm;padding-bottom:2mm;width:155mm;vertical-align:top;">
					...
					<b>Line 12 on this return is less than $2,500 or line 12 (line 10 if the prior quarter was the fourth quarter of 2016) on the 
					return for the prior quarter was less than $2,500, and you didn't incur a $100,000 next-day deposit obligation during the 
					current quarter.</b> If line 12 (line 10 if the prior quarter was the fourth quarter of 2016) for the prior quarter was less than 
					$2,500 but line 12 on this return is $100,000 or more, you must provide a record of your federal tax liability. If you are a 
					monthly schedule depositor, complete the deposit schedule below; if you are a semiweekly schedule depositor, attach 
					Schedule B (Form 941). Go to Part 3.</span>
				</label><br/><br/>
		...
		<html lang="ES">
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS941PR" style="font-family:arial;">
				 ...
				 para 2017: <span class="styMainTitle" style="font-size:10pt;">Planilla para la Declaración 
								Federal TRIMESTRAL del Patrono</span>
							</span>
							<div style="width:187mm;padding-bottom:0mm;float:none;clear:both;">
								<span class="styAgency" style="float:left;padding-bottom:0mm;">(Rev. enero de 2017)<span style="width:13mm;"/>
					...
					<div style="width:187mm;float:none;clear:both;">	
						<div class="styBB" style="width:122mm;height:auto;float:left;border:black solid 1px;padding-top:1mm;padding-left:2mm;padding-right:2mm;">
							<div style="width:118mm;padding-top:0mm;">
								<span style="float:left;padding-right:5mm;font-size:6pt;padding-top:2mm;"><b>Número de identificación patronal </b>
						...
						<div style="float:right;padding-right:2mm;">
							<div class="styBB" style="width:60mm;height:46mm;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;">
								<div class="styPartName" style="width:55mm;height:8mm;text-align:left;padding-left:1mm;padding-top:1mm;padding-bottom:1mm;">Informe para este trimestre de 2017.<br/><span style="font-size:7pt;">(Marque uno).</span></div>
								<xsl:variable name="Date">
								...
								<div style="width:53mm;padding-bottom:0mm;float:none;clear:both;font-size:7pt;">
									<br/>Puede encontrar instrucciones y formularios de años anteriores en <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form941" title="Link to IRS.gov"><i>www.irs.gov/form941pr</i>.</a>
								</div>
							</div>
						</div>
					</div>
				...
				<!--Line 1-->
					...
					<div style="width:187mm;float:none;clear:both;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:123mm;padding-left:1mm;">
								<b>Crédito contributivo sobre la nómina de pequeños negocios calificados por el aumento</b> 
								<span style="float:left;"><b>de actividades investigativas.</b> Adjunte el Formulario 8974 
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$FormData/PayrollTaxCreditAmt"/>
									</xsl:call-template>
								</span>
					...
					<div style="width:187mm;clear:both;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:123mm;padding-left:1mm;padding-top:2mm;">
								<span style="float:left;"><b>Total de contribuciones después de considerar los ajustes y créditos.</b> Reste la línea <b>11</b> de la línea <b>10</b></span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
							</div>
						</span>
					...
					<div style="width:187mm;clear:both;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:123mm;padding-left:1mm;padding-top:2mm">
								<span style="float:left;"><b>Saldo adeudado.</b> Si la línea <b>12</b> es mayor que la línea <b>13</b>, anote la diferencia y vea las instrucciones </span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
							</div>
						</span>
			...
			<div style="width:187mm;padding-bottom:1mm;padding-top:1.4mm;mm;font-size:8pt;float:none;clear:both;">
				...
				<label style="padding-left:3mm;width:154.5mm;vertical-align:top;">
					...
					<span style="width:150mm;padding-top:1mm;font-size:7pt;">
						<b>La línea 12 de esta planilla es menos de $2,500 o la línea 12 (la línea 10 si el trimestre anterior fue el 4to trimestre de 2016) 
						de la planilla del trimestre anterior es menos de $2,500 y usted no tuvo una obligación de depositar $100,000 el próximo día durante
						 el trimestre en curso.</b> Si la línea <b>12</b> (la línea <b>10</b> si el trimestre anterior fue el 4to trimestre de 2016) del trimestre

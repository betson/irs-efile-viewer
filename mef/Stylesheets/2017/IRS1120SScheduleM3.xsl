        ...
        <form name="Form1120SScheduleM3">
          ...
          <div class="styTBB" style="width:187mm;border-bottom-width: 0px;">
            ...
            <!-- Form Link -->
              ...
              <span class="styAgency" style="height:5mm;padding-top:3.1mm;">
				  <span style="width:25mm;padding-top:3mm"> Department of the Treasury </span>
				  Internal Revenue Service
			  </span>
            </div>
            <div class="styFTBox" style="width:125mm;height:21mm;">
              <div class="styMainTitle">Net Income (Loss) Reconciliation for S Corporations
              ...
              <div class="styFST" style="height:5mm;">
                 ...
                 Attach to Form 1120S.<br/>
					 ...
					 <span style="text-align:center;margin-left:0mm;font-weight:bold;;padding-top:3.5mm">
									...
									href="http://www.irs.gov/form1120s" title="Link to IRS.gov">
            ...
            <div class="styTYBox" style="width:30mm;height:21mm;border-left-width:1px;">
              ...
              <div class="styTY" style="height:11mm;padding-top:4mm;">20<span class="styTYColor">17</span>
              </div>
            </div>
          </div>
          ...
          <div class="styBB" style="width:187mm;border-top-width: 2px;">
            ...
            Name of corporation<br/>
              <xsl:call-template name="PopulateText">
                ...
                select="$Form1120SScheduleM3/BusinessName/BusinessNameLine1Txt"/>
              </xsl:call-template>
              <br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" 
                select="$Form1120SScheduleM3/BusinessName/BusinessNameLine2Txt"/>
              </xsl:call-template>
            </div>
          ...
          <div style="width:187mm;height:8mm;border-style:solid; border-bottom-width:1px;
            ...
            <span style="width:175mm;" class="styPartDesc">
              ...
              <span style="font-weight:normal;">(see instructions)
              </span>
              <br/>
            </span>
          </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:6mm;">
                   Did the corporation prepare a certified audited non-tax-basis income statement for 
                     the period ending with or within this tax year?
                    See instructions if multiple non-tax-basis income statements are prepared.</div>
			</div>
          <!-- Line 1a - Yes -->
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                <xsl:call-template name="PopulateSpan">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
                </xsl:call-template>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                <xsl:call-template name="PopulateSpan">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/CorporationPreparedIncmStmtInd"/>
                </xsl:call-template>
                <input type="checkbox" alt="CorpPrepIncomeStatementYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/CorporationPreparedIncmStmtInd"/>
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                <xsl:call-template name="PopulateSpan">
				  ...
				  <input type="checkbox" alt="CorpPrepIncomeStatementNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/CorporationPreparedIncmStmtInd"/>
			 ...
			 Skip lines 2 through 3b and enter the corporation’s net income (loss)
			  per its books and records on line 4a.
			</div>
          </div>
          <!-- Line 2 -->
            ...
            <div class="styLNDesc" style="width:179mm;">Enter the income statement period:
              ...
              <span style="width:25mm;border-bottom:solid 1px;">
                <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeStatementBeginningDt"/>
                </xsl:call-template>
              </span>
              ...
              <span style="width:25mm;border-bottom:solid 1px;">
                <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeStatementEndingDt"/>
                </xsl:call-template>
              </span>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
			  Has the corporation’s income statement been restated for the income statement 
			  period on line 2?
            <!-- Form Link -->
              <xsl:call-template name="SetFormLinkInline">
                <xsl:with-param name="TargetNode" 
                select="$Form1120SScheduleM3/CorporationIncmStmtRestatedInd"/>
              </xsl:call-template>
            </div>
          </div>
          <!-- Line 3a  YES-->
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" alt="CorpIncomeStatementRestatedYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/CorporationIncmStmtRestatedInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" alt="CorpIncomeStatementRestatedNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/CorporationIncmStmtRestatedInd"/>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD">
              <span style="width:1.5mm"/>b</div>
            <div class="styLNDesc" style="width:179mm;height:6mm;">Has the corporation's income
			 statement been restated for any of the five income statement periods immediately preceding
			  the period<br/> on line 2?
            <!-- Form Link -->
              <xsl:call-template name="SetFormLinkInline">
                <xsl:with-param name="TargetNode"
                 select="$Form1120SScheduleM3/CorpIncmStmtRestated5PrecInd"/>
              </xsl:call-template>              
            </div>
          </div>
          <!-- Line 3b - Yes -->
                ...
                <input type="checkbox" alt="CorpIncmStmtRestated5PrecedingNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    ...
                    select="$Form1120SScheduleM3/CorpIncmStmtRestated5PrecInd"/>
                      ...
                      CorpIncmStmtRestated5PrecedingNo</xsl:with-param>    
                  </xsl:call-template>
                </input>
              </span>
              <label>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD">4a</div>
				  ...
				  Worldwide consolidated net income (loss) from income statement 
            ...
            <div style="float:right;">
              ...
              <div class="styLNAmountBox">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/WorldwideCnsldtNetIncmLossAmt"/>
                </xsl:call-template>
              </div>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:131mm;padding-top:.5mm;">
              Indicate accounting standard used for line 4a (see instructions):</div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				...
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/NetLossNonincludibleFrgnEntAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				...
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/NetIncomeNonincludibleUSEntAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">.............</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				...
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/NetLossNonincludibleUSEntAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				...
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/NetIncmOthIncludibleFrgnEntAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
              </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="height:8mm;">
                <span style="width:1.5mm"/>b</div>
              <div class="styLNDesc" style="width:137mm;">
                Net income (loss) of other U.S. disregarded entities 
                (except qualified subchapter S subsidiaries) 
                <span style="float:left;">(attach statement)
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/NetIncomeOthIncludibleUSEntAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..........................</span>
              </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
                <span style="float:left;">Net income (loss) of other qualified subchapter
                 S subsidiaries (QSubs) (attach statement)
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/NetIncmOthQlfySbchptrSbsdrsAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <span style="float:left;">(attach statement)           
               <!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/AdjustmentToEliminateTransAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..........................</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
                ...
                <!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/AdjRecnclIncmStmtYrToTYAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
              </div>
            ...
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				...
				<!-- Form Link -->
                  <xsl:call-template name="SetFormLinkInline">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/OtherAdjustmentsToReconcileAmt"/>
                  </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
              </div>
          ...
          <div class="styBB" style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:138mm;height:8mm;">
                <span style="float:left;">
				  ...
				  <span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
				  <br/>
				  <b>Note: </b>Part I, line 11, must equal Part II, line 26, column (a) or Schedule M-1,
            ...
            <div style="float:right;">
              ...
              <div class="styLNAmountBox">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/NetIncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </div>
            </div>
            <!-- close float right -->
          ...
          <div style="width:187mm;">
            ...
            <div style="float:right;clear:none;">
              <div style="width:137mm;">
                <div class="styLNAmountBox" 
                style="width:50mm;text-align:center;border-width:1px;border-right-width:0px;">
                Total Assets
                </div>
            ...
            <div style="float:right;clear:none;">
              <div style="width:137mm;">
                ...
                <div class="styLNAmountBox" style="width:50mm;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntIncldWorldwideCnsldtAstAmt"/>
                  </xsl:call-template>
                </div>
                <!--Liabilities column -->
                <div class="styLNAmountBox" style="width:50mm;border-right-width:1px;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntIncldWorldwideCnsldtLiabAmt"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- close width -->
            ...
            <div style="float:right;clear:none;">
              <div style="width:137mm;">
                ...
                <div class="styLNAmountBox" style="width:50mm;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntRmvdNonincludibleFrgnAstAmt"/>
                  </xsl:call-template>
                </div>
                <!--Liabilities column -->
                <div class="styLNAmountBox" style="width:50mm;border-right-width:1px;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode"
                     select="$Form1120SScheduleM3/EntRmvdNonincludblFrgnLiabAmt"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- close width -->
            ...
            <div style="float:right;clear:none;">
              <div style="width:137mm;">
                ...
                <div class="styLNAmountBox" style="width:50mm;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntRmvdNonincludibleUSLiabAmt"/>
                  </xsl:call-template>
                </div>
                <!--Liabilities column -->
                <div class="styLNAmountBox" style="width:50mm;border-right-width:1px;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntRmvdNonincludibleUSAstAmt"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- close width -->
            ...
            <div style="float:right;clear:none;">
              <div style="width:137mm;">
                ...
                <div class="styLNAmountBox" style="width:50mm;border-bottom-width:1px;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntIncldOtherIncludibleAstAmt"/>
                  </xsl:call-template>
                </div>
                <!--Liabilities column -->
                <div class="styLNAmountBox" style="width:50mm;border-right-width:1px;border-bottom-width:1px;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                    select="$Form1120SScheduleM3/EntIncldOtherIncludibleLiabAmt"/>
                  </xsl:call-template>
                </div>
              </div>
              <!-- close width -->
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            style="width:95mm;float:left;font-size:6pt;">
            For Paperwork Reduction Act Notice, see the Instructions for Form 1120S.	</div>
            <div style="width:25mm;float:left;">Cat. No. 39666W</div>
            <div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120S) 2017</div>
          </div>
          <p style="page-break-before: always"/>
          <!-- Page 2 -->
          <!-- Page 2 Header -->
          <div class="styBB" style="width:187mm;border-bottom-width:1px">
            <div style="float:left;">Schedule M-3 (Form 1120S) 2017</div>
          ...
          <!-- Part 2 - Header -->
          <div style="width:187mm;height:8mm;border-style:solid;border-bottom-width:1px;
          border-top-width:0px; border-right-width:0px;border-left-width:0px;padding-top:0;float:left;">
            <span class="styPartName" style="height:4mm;width:14mm;padding: .25mm 1mm .25mm 1mm;">
            Part II</span>
            <span class="styPartDesc" style="width:170mm;">
              <span style="width:2mm;"/>Reconciliation of Net Income (Loss) per Income Statement of the 
              Corporation With Total Income <br/>
          ...
          <!--<table class="styIRS1120ScheduleM3_styTable" id="IRS1120SScheduleM3PartIITable"
            ...
            <tr>
			  ...
			  scope="col" style="width:81mm; height:auto;text-align:center;font-size:8pt;border:none;" >
				<span style="font-weight:normal">
            ...
            <tr>
              ...
              Income (loss) from equity method foreign corporations  </span>             
				<!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/IncomeLossEquityMethodFrgnCorp"/>
                </xsl:call-template>               
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/
                   IncomeLossEquityMethodFrgnCorp/IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">Gross foreign dividends not previously taxed
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/GrossFrgnDividendsNotPrevTaxed"/>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/
                   GrossFrgnDividendsNotPrevTaxed/IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">Subpart F, QEF, and similar income inclusions       
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/SubpartFQEFSimilarIncmInclsn"/>
                </xsl:call-template></span>    
                <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/GrossForeignDistriPrevTaxed"/>
                </xsl:call-template></span> 
                <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td>
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/IncomeLossEquityMethodUSCorp"/>
                </xsl:call-template></span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">U.S. dividends not eliminated in tax consolidation         
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/USDivNotEliminatedTaxConsol"/>
                </xsl:call-template></span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">Income (loss) from foreign partnerships             
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/IncomeLossForeignPartnerships"/>
                </xsl:call-template></span>               
                <span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">Income (loss) from other pass-through entities             
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/IncomeLossPassThroughEntities"/>
                </xsl:call-template></span>                
                <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              Items relating to reportable transactions             
               <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/ItemsRelatedReportableTransGrp"/>
                </xsl:call-template></span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <!-- form link -->
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/InterestIncomeForm8916AGrp"/>
                </xsl:call-template>
                </span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
              </td>
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/TotalAccrualCashAdjustmentGrp/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/HedgingTransactions/
                  IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/HedgingTransactions/TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/HedgingTransactions/PermanentDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateNegativeNumber">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/CostOfGoodsSoldNNGrp/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/SalesVersusLease/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/SalesVersusLease/TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/SalesVersusLease/PermanentDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/Section481aAdjustments/
                   TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/UnearnedDeferredRevenueGrp/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/OrigIssueDiscountOthImputedInt/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/IncmStmtGainLossAstNotInvntry/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;padding-left:2mm;">
                    <span style="float:left;">Gross capital gains from Schedule D, 
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/GrossCapitalGainsFromSchD/
                   TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;padding-left:2mm;">
				  <span style="float:left;">Gross capital losses from Schedule D, excluding 
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/GrossCapitalLossesFromSchD/
                   TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;padding-left:2mm;">
                    <span style="float:left;">Net gain/loss reported on Form 4797, line 17, excluding 
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/GainLossReportedOnForm4797/
                   TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
             ...
             <td style="padding-top:.5mm;padding-left:2mm;">
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/AbandonmentLosses/TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/AbandonmentLosses/
                   PermanentDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/WorthlessStockLosses/
                   TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/OthGainLossAssetsNotInventory/
                  TemporaryDifferenceAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/OthIncmLossItemsDifferences"/>
                </xsl:call-template></span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..............</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td>
                <span style="padding-top:.5mm;padding-left:2mm;"><b>Total income (loss) items. </b>Combine lines
                 1 through 22</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/TotalIncomeLossItems/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td>
                <span style="padding-top:.5mm;padding-left:2mm;"><b>Total expense/deduction items </b>
                (from Part III, line 32)</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/TotalExpenseDeductionItems/
                  IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td>
                <span style="font-weight:normal;float:left;padding-left:2mm;">
                Other items with no differences</span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IncomeLossItems/OtherItemsNoDifferences/
                  IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3ShadedCell" scope="col" style="border-bottom-width:1px;">
            ...
            <tr>
              ...
              <td>
                <span style="padding-top:.5mm;padding-left:2mm;"><b>Reconciliation totals. </b>
                Combine lines 23 through 25</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IncomeLossItems/ReconciliationTotals/
                   IncomeLossPerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
         ...
         Line 26, column (a), must equal Part I, line 11, and column (d) must equal Form 1120S, 
         Schedule K, line 18.</div>
          <div class="pageEnd" style="width:187mm;">
            <div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120S) 2017</div>
          </div>
          <p style="page-break-before: always"/>
          <!-- Page 3 -->
          <!-- Page 3 Header -->
          ...
          <div class="styBB" style="width:187mm">
            <div class="styNameBox" style="width:141mm;font-size:7pt;">
              Name of corporation<br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form1120SScheduleM3/BusinessName/
          ...
          <!--<table class="styTable" id="IRS1120SScheduleM3PartIII" summary="Reconciliation of 
            ...
            <tr>
              ...
              <th scope="col" class="styIRS1120ScheduleM3TheadCell"
               style="width:81mm;text-align:center;font-size:8pt;border:none;font-weight:normal;">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   StateLocalCurrIncomeTaxExpense/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   ForeignCurrentIncomeTaxExpense/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/FinesAndPenalties/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   JudgmentsDamagesAwardsSmlrCost/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/PensionAndProfitSharing/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" scope="col">14</td>
              <td>
                 <span style="float:left;left;padding-left:2mm;">
                 Charitable contribution of cash and tangible property</span>
                 <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                  CharitableContriIntangibleProp/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/CYAcquisReorgLegalAcctFees/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/CYAcquisReorgOtherCosts/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   AmortizationImpairmentGoodwill/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   OtherAmortzImpairmentWriteOffs/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/DepletionOilGas/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/DepletionOtherThanOilGas/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/DepreciationGrp/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode"
                   select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/
                   CorpOwnedLifeInsurancePremiums/
                   ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
            ...
            <tr>
              ...
              <td>
                ...
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/PurchaseVersusLease"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <!-- Part III - Line 32 -->
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell">32</td>
              <td style="padding-top:.5mm;padding-left:2mm;border-style:solid;border-bottom-width:2px; 
              border-top-width:0px; border-right-width:0px;border-left-width:0px;padding-top:0;">
				  <b>Total expense/deduction items.  </b> 
				   Combine lines 1 through 31. Enter here and on Part II, line 24, reporting positive amounts 
              ...
              <td class="styIRS1120SScheduleM3Cell" scope="col" style="border-bottom-width: 2px;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" 
                  select="$Form1120SScheduleM3/IRS1120SSchM3ExpenseDedItems/TotalExpenseDeductionItems/
                  ExpensePerIncomeStmtAmt"/>
                </xsl:call-template>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col" style="border-bottom-width: 2px;">

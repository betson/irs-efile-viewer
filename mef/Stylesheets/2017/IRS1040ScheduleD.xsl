      ...
      <body class="styBodyClass">
        <form name="Form1040ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
            ...
            <div class="styTYBox" style="width:31mm;height:20mm;">
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;">20<span style="color:green;">17</span>
              </div>
          ...
          <div class="stySmallText" style="width:110mm;">
           <span class="styBoldText">For Paperwork Reduction Act Notice, see your tax return instructions.</span>
            ...
            <div class="stySmallText" style="width:48mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1040) 2017</span>
                   </div>
          </div>
          <p style="page-break-before:always"/>
        <!--Begin Page 2 -->
        <div class="styBB" style="width:187mm;border-bottom-width:1px;">
          <span style="width:65mm;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1040) 2017</span>
       ...
       <div class="styBB" style="width:187mm;border-bottom-width:0px;">
        ...
        <div class="styBB" style="width:187mm;border-top-width: 1px;border-bottom-width:0px;">
          <span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1040) 2017</span>
        </div>
        <!--  PART III HEADER -->
       <p style="page-break-before:always"/>

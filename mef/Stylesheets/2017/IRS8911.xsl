			...
			<body class="styBodyClass">
                ...
                Alternative Fuel Vehicle Refueling Property Credit
                  ...
                  Attach to your tax return.<br/>
								<img src="{$ImagePath}/8911_Bullet.gif" alt="Bullet Image"/>
                  Go to <i>www.irs.gov/Form8911 </i> for instructions and the latest information. 
			   ...
			   than line 13, see instructions
                <!--Dotted Line-->
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<span style="width:27mm;text-align:right;">Form <span class="styBoldText">8911 </span>(2017)</span>
						</div>
					</div>

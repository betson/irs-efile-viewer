	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			<head>
				...
				<style type="text/css">
				<!-- Hint:  05/21/2014 Per Schema: Special Condition Desc does not require a pen/ink image on the top left of the style sheet.  The data is	displayed in the additional data area at the end of form -->
				    <!--  Updated 05/02/2014 WT: Per UWR 101606 for R9.5_D2   -->
				    <!--  Updated 06/11/2014 WT: Per UWR 112237/112664 FATCA for R9.5_D3   -->
					<!--  Separated text     -->
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120F">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div valign="top" class="styNameBox" style="width:62mm;border-bottom-width:0px;border-right-width:0px;">
							...
							<span style="height:5mm;padding-left:11.6mm;">
								...
								<input type="checkbox" alt="IRS1120FInitialReturn" class="styCkbox" style="width:9px;height:9px;">
							...
							<span style="height:5mm;width:62mm;">
								<input type="checkbox" alt="IRS1120FNameOrAddressChange" class="styCkbox" style="width:9px;height:9px;">
								 <xsl:call-template name="PopulateCheckbox">
								...
								<span style="height:5mm;padding-left:1.5mm;">
									<input type="checkbox" alt="IRS1120FFinalReturn" class="styCkbox" style="width:9px;height:9px;">
										<xsl:call-template name="PopulateCheckbox">
							...
							<span style="height:5mm;width:62mm;">
								<input type="checkbox" alt="IRS1120FFirstPostMergerReturn" class="styCkbox" style="width:9px;height:9px;">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="height:5mm;padding-left:2mm;">
									<input type="checkbox" alt="IRS1120FAmendedReturn" class="styCkbox" style="width:9px;height:9px;">
										<xsl:call-template name="PopulateCheckbox">
							...
							<span style="height:4mm;width:62mm;">
								<input type="checkbox" alt="IRS1120FScheduleM3Attached" class="styCkbox" style="width:9px;height:9px;">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="height:4mm;padding-left:3.5mm;">
									<input type="checkbox" alt="IRS1120FProtectiveReturn" class="styCkbox" style="width:9px;height:9px;">
										<xsl:call-template name="PopulateCheckbox">
					...
					<!-- begin main content area -->
						<table class="styTable" cellspacing="0" cellpadding="0" style="font-size:7pt; width:187mm;">
							<tr>
								...
								<td valign="top" class="styGenericDiv" style="width:93mm;">
											...
											<xsl:choose>
												<xsl:when test="string-length($FormData/LocationOfPrimaryBooks/CityNm) +              string-length($FormData/LocationOfPrimaryBooks/ProvinceOrStateNm) + string-length($FormData/LocationOfPrimaryBooks/CountryCd) &gt; 28">
													...
													<span class="sty1120FItemUnderlineSM" style="width:84mm; float:left;clear:none;">
														...
														<xsl:if test="not($FormData/LocationOfPrimaryBooks/ProvinceOrStateNm = '') and                $FormData/LocationOfPrimaryBooks/ProvinceOrStateNm and not($FormData/LocationOfPrimaryBooks/CountryCd = '') and $FormData/LocationOfPrimaryBooks/CountryCd">
															<span>, </span>
														</xsl:if>
														<xsl:call-template name="PopulateText">
												...
												<xsl:otherwise>
													<span class="sty1120FItemUnderlineSM" style="width:44mm">
														...
														<xsl:if test="(not($FormData/LocationOfPrimaryBooks/CityNm = '') and $FormData/LocationOfPrimaryBooks/CityNm) and                 ((not($FormData/LocationOfPrimaryBooks/CountryCd = '') and $FormData/LocationOfPrimaryBooks/CountryCd) or                 (not($FormData/LocationOfPrimaryBooks/ProvinceOrStateNm = '') and $FormData/LocationOfPrimaryBooks/ProvinceOrStateNm))">
															<span>, </span>
														</xsl:if>
														<xsl:if test="not($FormData/LocationOfPrimaryBooks/ProvinceOrStateNm = '') and                $FormData/LocationOfPrimaryBooks/ProvinceOrStateNm">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="$FormData/LocationOfPrimaryBooks/ProvinceOrStateNm"/>
															</xsl:call-template>
														</xsl:if>
									...
									<div class="styGenericDiv" style="width:93mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;"/>
											...
											<xsl:variable name="LocForeignAddressBlank">
												<xsl:value-of select="$FormData/LocationOfBooksForeignAddress/AddressLine1Txt = '' and $FormData/LocationOfBooksForeignAddress/AddressLine2Txt = '' and $FormData/LocationOfBooksForeignAddress/CityNm = '' and $FormData/LocationOfBooksForeignAddress/ProvinceOrStateNm = '' and $FormData/LocationOfBooksForeignAddress/ForeignPostalCd = '' and $FormData/LocationOfBooksForeignAddress/CountryCd = ''"/>
											</xsl:variable>
											<xsl:if test="$FormData/LocationOfBooksUSAddress and $LocUSAddressBlank = 'false'">
													<div class="styIRS1120FLNLeftNumBox" style="width:6mm;"/>
												<span class="sty1120FItemUnderlineSM" style="width:86mm;height:auto;float:left;padding-left:6mm;clear:none;">
									...
									<div class="styGenericDiv" style="width:93mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;"/>
											...
											<input type="checkbox" alt="IRS1120FMaintainOfficeInUS" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
								...
								<td class="styGenericDiv" style="width:94mm;vertical-align:top;border-left:1px solid black;">
									<!-- begin line E  -->
									<div class="styGenericDiv" style="width:94mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;">E</div>
									...
									<div class="styGenericDiv" style="width:94mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;"/>
											...
											<xsl:variable name="USAddressBlank">
												<xsl:value-of select="$FormData/USAgentAddress/AddressLine1Txt = '' and $FormData/USAgentAddress/AddressLine2Txt = '' and $FormData/USAgentAddress/CityNm = '' and $FormData/USAgentAddress/State = '' and $FormData/USAgentAddress/ZIPCd = ''"/>
											</xsl:variable>
											<xsl:variable name="ForeignAddressBlank">
												<xsl:value-of select="$FormData/AgentForeignAddress/AddressLine1Txt = '' and $FormData/AgentForeignAddress/AddressLine2Txt = '' and $FormData/AgentForeignAddress/CityNm = '' and $FormData/AgentForeignAddress/ProvinceOrStateNm = '' and $FormData/AgentForeignAddress/ForeignPostalCd = '' and $FormData/AgentForeignAddress/CountryCd = ''"/>
											</xsl:variable>
											<xsl:variable name="AddressNotPresent">
												<xsl:value-of select="(not($FormData/USAgentAddress) and not($FormData/AgentForeignAddress)) or                                  (not($FormData/USAgentAddress) and $ForeignAddressBlank = 'true') or (not($FormData/AgentForeignAddress) and $USAddressBlank = 'true')"/>
											</xsl:variable>
											<xsl:choose>
									...
									<!-- begin line F  -->
									<div class="styGenericDiv" style="width:94mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;">F</div>
									...
									<!-- begin line G(1,2) -->
									<div class="styGenericDiv" style="width:94mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;">G</div>
											Check method of accounting:
											<span style="padding-left:3mm;">
												<b>(1)</b>
											</span>
											<span style="padding-left:2mm;">
												<input type="checkbox" alt="IRS1120FMethodOfAcctCash" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
											...
											<span style="padding-left:2mm;">
												<input type="checkbox" alt="IRS1120FMethodOfAcctAccrual" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
									...
									<div class="styGenericDiv" style="width:94mm;padding-top:1mm;">
										<div class="styIRS1120FLNLeftNumBox" style="width:6mm;"/>
											<b>(3)</b>
											<span style="padding-left:2mm;">
												<input type="checkbox" alt="IRS1120FMethodOfAcctOther" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
						...
						<table cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;" border="0">
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:70mm" scope="row">
									<span style="float:left">
										...
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Form 1120F Line 5(b), Estimated Tax Payments - Trust Payment Amount 
											</xsl:with-param>
							...
							<tr>
								...
								<td class="styIRS1120FItemDesc" style="width:70mm" scope="row">
									<span style="float:left">
										Less 2017 refund applied for on Form 4466
										<span style="padding-left:1mm;">
											<!-- Form to Form Link -->
											<xsl:call-template name="SetFormLinkInline">
								...
								<td colspan="3" class="styIRS1120FItemDesc" style="width:106mm;" scope="row">
									<span style="float:left">
										...
										<span style="padding-left:1mm;">
											...
											<span style="width:1mm;"/>
											<xsl:call-template name="LinkToLeftoverDataTableInline">
												<xsl:with-param name="Desc">Form 1120F Line 5(g), Credit From Form 4136 - Ozone Depleting Chemicals Indicator
												</xsl:with-param>
								...
								<td colspan="5" class="styIRS1120FItemDesc" style="width:142mm;height:4.5mm;" scope="row">
									...
									<span style="float:right;padding-left:1mm">
										...
										<span style="float:right;">
											<img src="{$ImagePath}/1120F_Bullet_Sm.gif" alt="SmallBullet"/>
											<span style="width:8px"/>
											<input type="checkbox" alt="IRS1120FForm2220Attached" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/Form2220AttachedInd"/>
													<xsl:with-param name="BackupName">IRS1120FForm2220Attached</xsl:with-param>
												</xsl:call-template>
							...
							<tr>
								...
								<td colspan="5" class="styIRS1120FItemDesc" style="width:142mm; height:4.5mm;border-bottom-width:1px;" scope="row">									
										Enter portion of line 8a you want <b>Credited to 2018 estimated tax</b>
									<span style="padding-left:1mm">
										<img src="{$ImagePath}/1120F_Bullet_Sm.gif" alt="SmallBullet"/>
									</span>
					...
					<!--<div style="width:187mm">-->
						...
						<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;border-bottom:1pt solid black;">
							<tr>
								<!--row 1-->
								<td rowspan="3" style="width:18mm;font-size:10pt;font-weight:bold;font-family:'arial narrow';border-right:1pt solid black;vertical-align:top;padding-top:5mm;border-bottom:0pt solid black;">Paid Preparer Use Only</td>
								<td style="width:43mm;border-right:1pt solid black;border-bottom:1pt solid black;padding-left:1mm;">Print/Type preparer's name
									<br/>
									<xsl:call-template name="PopulateReturnHeaderPreparer">
										<xsl:with-param name="TargetNode">Name</xsl:with-param>
									</xsl:call-template>
								</td>
								<td style="width:55mm;border-right:1pt solid black;border-bottom:1pt solid black;padding-left:1mm;">Preparer's signature
									<br/>
								...
								<td style="width:35mm;border-bottom:1pt solid black;padding-left:1mm;">PTIN
									<br/>
							...
							<tr>
								<!--row 2-->
								<td rowspan="1" colspan="4" style="border-bottom:1pt solid black;border-right:1pt solid black;padding-left:.5mm;">Firms name
								...
								<td style="border-bottom:1pt solid black;padding-left:1mm;">Firms EIN
									<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="padding-left:1mm;">
									<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
										<xsl:with-param name="TargetNode">EIN</xsl:with-param>
							...
							<tr>
								<!--row 3-->
								<td rowspan="1" colspan="4" style="border-bottom:0pt solid black;border-right:1pt solid black;padding-left:.5mm;">Firms address
									<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="padding-left:1mm;">
										<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
											<xsl:with-param name="TargetNode">AddressLine1Txt</xsl:with-param>
						...
						<div class="pageEnd" style="width:187mm;">
							...
							<span style="float:right;">Form 
								...
								<span style="font-size:7pt"> (2017)</span>
							</span>
						</div>
						<!--<div class="pageEnd"/>-->
						<!-- ***********************************************************************-->
						...
						<div class="styBB" style="width:187mm;padding-top:.5mm;border-bottom-width:2px;">
							<div style="float:left;">Form 1120-F (2017)<span style="width:148mm;"/>
							</div>
					...
					<table border="0" cellpadding="0" cellspacing="0" class="styTable" style="width:187mm;clear:both;float:none;font-size:7pt;">
						<tr>
							...
							<td class="styGenericDiv" style="width:93mm;height:auto;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;"/>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">If Yes, attach a statement with an explanation.
													<xsl:call-template name="SetFormLinkInline">
														<xsl:with-param name="TargetNode" select="$FormData/ChangeInMethodOfAccountingInd"/>
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">I</div>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">Did the corporations method of determining income</div>
									<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:4.5mm;"/>
								</div>
								<div class="styGenericDiv" style="width:93mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">J</div>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">K</div>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">L</div>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;">M</div>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm; padding-left:3mm"/>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
									  tax year ending with or within your tax year.</div>
									<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:4.5mm;"/>
								</div>
									...
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
										...
										<span style="float:right;">
											...
											<span style="float:right;padding-right:2mm;">
												...
												<span style="width:8px"/>
												<input type="checkbox" alt="IRS1120FNOLForegoCarryback" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="$FormData/NOLForegoCarrybackInd"/>
														<xsl:with-param name="BackupName">IRS1120FNOLForegoCarryback</xsl:with-param>
													</xsl:call-template>
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm;"/>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">page 4.)
										<span style="padding-left:1mm;">
											<!-- Form to Form Link -->
											<xsl:call-template name="SetFormLinkInline">
								...
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4mm;">T</div>
									<div class="styLNDesc" style="width:72mm;height:4mm;">Is the corporation a subsidiary in a parent-subsidiary</div>
									<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:4.5mm;"/>
								</div>
								<div class="styGenericDiv" style="width:93mm;height:4.5mm;">
								...
								<div class="styGenericDiv" style="width:93mm;">
									...
									<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width: 1px;"/>
								</div>
								<div class="styGenericDiv" style="width:93mm;">
									<div class="styLNLeftNumBox" style="height:4.5mm; padding-left:3mm"/>
									<div class="styLNDesc" style="width:72mm;height:4.5mm;">
									...
									<div class="styShadingCell" style="width:6mm;height:5.5mm;"/>
									<div class="styShadingCellRB" style="width:6mm;height:5.5mm;border-right-width: 1px;"/>
								</div>
								<div class="styGenericDiv" style="width:93mm;height:auto;border-bottom-width: 1px solid black;">
									<div class="styLNLeftNumBox" style="height:auto; padding-left:3mm"/>
									<div class="styLNDesc" style="width:72mm;height:auto;">
										<b>(2) Name</b><span style="width:1mm;"/>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
										...
										<span class="sty1120FItemUnderlineSM" style="padding-left:2mm; width:52mm;height:auto;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/ParentCorporationName/BusinessNameLine1Txt"/>
											</xsl:call-template>
										</span>
										<br/>
										<span class="sty1120FItemUnderlineSM" style="padding-left:2mm; width:69.5mm;height:auto;">
											<xsl:call-template name="PopulateText">
									...
									<div class="styShadingCellRB" style="width:6mm;height:12.8mm;border-right-width: 1px;"/>
								</div>
							...
							<td class="styGenericDiv" style="width:94mm;height:auto;vertical-align:top;">
								<!-- begin Additional Information - blank line before U  -->
								<div class="styGenericDiv" style="width:94mm;">
									<div class="styLNLeftNumBox" style="height:4mm;"></div>
									<div class="styLNDesc" style="width:73.6mm;height:4mm;"></div>
									<div style="width:12.1mm;height:4mm;float:left; clear:none;">
										...
										<div class="styIRS1120FYesNoBoxRB" style="width:6mm;height:4mm;float:left;clear:none;font-weight:bold;padding-top:1mm;border-right-width:0px;">No
										</div>
									</div>
								</div>								
								<!-- end Additional Information - blank line before U -->
								...
								<div class="styGenericDiv" style="width:94mm">
									...
									<div class="styIRS1120FRGnewYesNoBox" style="height:4.2mm;float:left;clear:none;border-right-width:0px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="$FormData/DealerSection475Ind"/>
										</xsl:call-template>
									</div>
									...
									<div class="styIRS1120FRGnewYesNoBoxShaded" style="height:4.2mm;float:left;clear:none;border-right-width:0px;">
										<span style="width:1px"/>
									</div>
									<div class="styLNLeftNumBox" style="clear:left;padding-left:3mm">
										<span style="width:1px"/>
									</div>
									<div class="styLNDesc" style="width:73.6mm;height:5mm;">
										<span style="padding-left:5mm; float:left; clear:none">or commodities other than in a dealer capacity?
										<span class="styDotLn" style="float:none"/>
										</span>
									</div>
									<div class="styIRS1120FRGnewYesNoBox" style="height:5mm;float:left;clear:none;border-bottom-width:1px;padding-top:0.5mm;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="$FormData/MarkToMarketOtherThanDealerInd"/>
										</xsl:call-template>
									</div>
									<div class="styIRS1120FRGnewYesNoBox" style="height:5mm;float:left;clear:none;border-bottom-width:1px;padding-top:0.5mm;border-right-width:0px;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="$FormData/MarkToMarketOtherThanDealerInd"/>
										</xsl:call-template>
									</div>
								...
								<div class="styGenericDiv" style="width:94mm;height:28mm;">
									...
									<div style="width:85.8mm; float:left; clear: none; ">
										...
										<div style="width:12.1mm;height:9mm;float:left; clear:none;">
											<div style="width:12.1mm;height:5mm;float:left; clear:none;">
												<div class="styShadingCell" style="width:6mm;height:5mm; float:left; clear:none;"/>
												<div class="styShadingCellRB" style="width:6mm;height:5mm; border-right-width:0px;float:left; clear:none;"/>
											</div>
											<div class="styIRS1120FYesNoBox" style="height:5mm;padding-top:1mm;">
													<xsl:call-template name="PopulateYesBoxText">
														<xsl:with-param name="TargetNode" select="$FormData/Own50PercentOrMoreVotingStkInd"/>
													</xsl:call-template>
											</div>
											...
											<div style="width:12.1mm;height:5mm;float:left; clear:none;">
												<div class="styShadingCell" style="width:6mm;height:18mm; float:left; clear:none;"/>
												<div class="styShadingCellRB" style="width:6mm;height:18mm; border-right-width:0px;float:left; clear:none;"/>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="styGenericDiv" style="width:94mm;">
									...
									<div style="width:85.8mm; float:left; clear: none;">
										<div class="styLNDesc" style="width:73.6mm;height:30mm;">
										...
										<div style="width:12.1mm;height:9mm;float:left; clear:none;">
											...
											<div class="styShadingCellRB" style="width:6mm;height:18mm; border-right-width:0px;"/>
									</div>
								</div>
								...
								<div class="styGenericDiv" style="width:94mm;height:14mm;">
									...
									<div style="width:85.8mm; float:left; clear: none;">
										<div class="styLNDesc" style="width:73.6mm;">
											<b>(2) </b>Is the corporation claiming treaty benefits pursuant to <br/>
											<span style="padding-left:5mm; float:left; clear:none">
										...
										<div style="width:12.1mm;float:left;height:16mm; clear:none;">
								...
								<div class="styGenericDiv" style="width:94mm; height:26mm;">
									...
									<div style="width:85.8mm; float:left; clear: none">
										<div class="styLNDesc" style="width:73.6mm">
											...
											<div style="float:left;clear:left;padding-top:1.5mm">
										...
										<div style="width:12.1mm;height:24mm;float:left; clear:none;">
								...
								<div class="styGenericDiv" style="width:94mm; height:30mm;">
									...
									<div style="width:85.8mm; float:left; clear: none; height:12.5mm;">
										...
										<div style="width:12.1mm;height:4mm;float:left; clear:none;">
											<div class="styShadingCell" style="width:6mm;height:10mm;"/>
											<div class="styShadingCellRB" style="width:6mm;height:10mm;border-right-width:0px;float:left; clear:none;"/>
											<div class="styIRS1120FYesNoBox" style="width:6mm;height:4mm;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="$FormData/ECIOrTrtdECIDistriShrPrtshpInd"/>
												</xsl:call-template>
											...
											<div class="styIRS1120FYesNoBoxRB" style="width:6mm;height:4mm; border-right-width:0px;padding-top:.5mm">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="$FormData/Owned10PercentIntFrgnPrtshpInd"/>
												</xsl:call-template>
											</div>
								...
								<div class="styGenericDiv" style="width:94mm; height:22mm;padding-top:2mm;">
									...
									<div style="width:85.8mm; float:left; clear: none; height:12.5mm;">
										...
										<div style="width:12.1mm;height:10mm;float:left; clear:none;">
											...
											<div class="styShadingCell" style="width:6mm;height:4mm;float:left; clear:none;"/>
											<div class="styShadingCellRB" style="width:6mm;height:4mm; border-right-width:0px;float:left; clear:none;"/>
											<div class="styIRS1120FYesNoBox" style="width:6mm;height:5mm;padding-top:1mm;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="$FormData/InterbranchTransactionInd"/>
												</xsl:call-template>
											</div>
											<div class="styIRS1120FYesNoBoxRB" style="width:6mm;height:5mm; border-right-width:0px;padding-top:1mm;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="$FormData/InterbranchTransactionInd"/>
												</xsl:call-template>
											</div>
								...
								<div class="styGenericDiv" style="width:94mm; height:16mm;">
									...
									<div style="width:85.8mm; float:left; clear: none; height:9mm;">
										...
										<div style="width:12.1mm;height:10mm;float:left; clear:none;">
											...
											<div class="styLNRightNumBox" style="width:6mm;height:9.5mm;float:left; clear:none;background-color:lightgrey;border-bottom-width:0px;"/>
											<div class="styShadingCellRB" style="width:6mm;height:9.5mm; border-right-width:0px;float:left; clear:none;"/>
										</div>
									</div>
								</div>
								<!-- end Additional Information - lline AA -->
								<!-- begin Additional Information - line BB  -->
								<div class="styGenericDiv" style="width:94mm; height:auto;">
									<div class="styLNLeftNumBox" style="">BB</div>
									<div style="width:85.8mm; float:left; clear: none; height:16mm;">
										<div class="styLNDesc" style="width:73.6mm;">
											During the corporation’s tax year, did the corporation make any payments that would require it to file Forms 1042 and 1042-S under chapter 3 
										...
										<div style="width:12.1mm;height:10mm;float:left; clear:none;">
											...
											<div class="styShadingCellRB" style="width:6mm;height:12mm; border-right-width:0px;float:left; clear:none;"/>
											<div class="styIRS1120FYesNoBox" style="width:6mm;height:4mm;border-bottom:0;">
												<xsl:call-template name="PopulateYesBoxText">
								...
								<!-- begin Additional Information - line CC  -->
								<div class="styGenericDiv" style="width:94mm; height:auto;">
									...
									<div style="width:85.8mm; float:left; clear: none; height:8mm;">
										<div class="styLNDesc" style="width:73.6mm;">
											...
											<span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
											<div class="styLNDesc" style="width:73.6mm;height:4mm;">
												If "Yes," attach the required statement (see instructions).
												<!-- Form to Form Link -->
												<xsl:call-template name="SetFormLinkInline">
										...
										<div style="width:12.1mm;height:7mm;float:left; clear:none;">
											<div class="styShadingCell" style="width:6mm;height:3mm;"/>
											<div class="styShadingCellRB" style="width:6mm;height:3mm; border-right-width:0px;float:left; clear:none;"/>
											<div class="styIRS1120FYesNoBox" style="width:6mm;height:4mm;border-bottom:0;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="$FormData/QualifiedDerivativeDealerInd"/>
												</xsl:call-template>
								...
								<!-- end Additional Information - lline CC -->
								<!-- begin Additional Information - blank line  -->
								<div class="styGenericDiv" style="width:94mm; height:auto;">
									...
									<div style="width:85.8mm; float:left; clear: none; height:16mm;">
										...
										<div style="width:12.1mm;height:10mm;float:left; clear:none;">
											<div class="styShadingCell" style="width:6mm;height:32.5mm;"/>
											<div class="styShadingCellRB" style="width:6mm;height:32.5mm; border-right-width:0px;float:left; clear:none;"/>
											<!--<div class="styIRS1120FYesNoBox" style="width:6mm;height:4mm;border-bottom:0;">
											</div>
											<div class="styIRS1120FYesNoBoxRB" style="width:6mm;height:4mm; border-right-width:0px; border-bottom:0;">
											</div>-->
				...
				<!-- page break and footer-->
					<div class="styBB" style="width:187mm;padding-top:0.5mm;border-top-width: 1px;border-bottom-width: 0px;">
						...
						Form <span class="styBoldText" style="font-size:8pt;">1120-F</span> (2017)
					</div>
					</div>
					<div class="pageEnd"/>
					<p style="page-break-before: always"/>
					...
					<table cellpadding="0" cellspacing="0" class="styIRS1120FSectionTitle">
						<tr>
							<td class="styBB" style="float:left; font-size:6pt; font-weight:normal;clear:none; padding-bottom:1mm; padding-top:1mm">
								Report all gross transportation income subject to 4% tax on line 9. Report other column (a) income items only if not properly withheld and reported on Form 1042-S.  The rate of tax on these <b>gross</b> income items is 30% or such lower rate specified by tax treaty.  No deductions are allowed against these types of income. Enter treaty rates where applicable. <b>If the corporation is claiming a lower treaty rate, also complete item W above.</b> If multiple treaty rates apply to a type of income (e.g., subsidiary and portfolio dividends or dividends received by disregarded entities), attach a statement showing the amounts, tax rates, and withholding for each.	
             <xsl:call-template name="SetFormLinkInline">
					...
					<!-- Section I, Line 2a -->
					<div style="width:187mm;clear:none; padding-bottom:0mm;">
						<div class="styIRS1120FDivTreatyDataTitle" style="width:65mm;height:6mm;border-bottom-width:0px">
							...
							<span style="padding-left:4.5mm;">
								their equity derivatives dealer capacity) 
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:31mm;height:6mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/DividendExcldQDDGrp/GrossAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:25mm;height:6mm;text-align:center;padding-top:2mm;">
							<xsl:call-template name="PopulatePercent">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/DividendExcldQDDGrp/TaxRt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:32mm;height:6mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/DividendExcldQDDGrp/TaxLiabilityAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataRG" style="width:33mm;height:6mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;clear:none; padding-bottom:0mm;">
						<div class="styIRS1120FDivTreatyDataTitle" style="width:65mm;height:6mm;border-bottom-width:0px">
							<span style="padding-left:2.5mm;padding-right:2mm;font-weight:bold">b
								<span style="font-weight:normal;">Dividend equivalents (excluding payments received </span>
							</span>
							<span style="padding-left:4.5mm;">
								by QDDs in their equity derivatives dealer capacity) 
							</span>
							<!--<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>-->
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:31mm;height:6mm;padding-top:2mm;">
					...
					<div style="width:187mm;clear:none; padding-bottom:0mm;">
						<div class="styIRS1120FDivTreatyDataTitle" style="width:65mm; height:10mm; border-bottom-width:0px">
					...
					<div style="width:187mm;clear:none; padding-bottom:0mm;">
						...
						<div class="styIRS1120FDivTreatyDataLF" style="width:31mm;  height:7mm;padding-top:3mm; ">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/FiduciaryDistriIncmClassGrp/GrossAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:25mm; text-align:center;  height:7mm;padding-top:3mm;">
							<xsl:call-template name="PopulatePercent">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/FiduciaryDistriIncmClassGrp/TaxRt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataLF" style="width:32mm; height:7mm;padding-top:3mm; ">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/FiduciaryDistriIncmClassGrp/TaxLiabilityAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120FDivTreatyDataRG" style="width:33mm;  height:7mm;padding-top:3mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;clear:none; padding-bottom:0mm;">
						<div class="styIRS1120FDivTreatyDataTitle" style="width:65mm; height:7.5mm; border-bottom-width:0px;">
							<span style="padding-left:0mm; padding-right:1mm; padding-top:3mm;font-weight:bold">10</span>Other items of income
							 <!-- Form to Form Link -->
								<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styIRS1120FDivTreatyDataRG" style="width:187mm; height:9mm; text-align:left;">
							...
							Is the corporation fiscally transparent under the laws of the foreign jurisdiction with respect to any item of income listed above?		
								<span style="padding-left:11mm;">
									...
									<input type="checkbox" alt="1120FCorpFiscallyTransparentIndicatorYes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/CorpFiscallyTransparentInd"/>
											<xsl:with-param name="BackupName">1120FCorpFiscallyTransparentIndicatorYes</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
											<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/CorpFiscallyTransparentInd"/>
											<xsl:with-param name="BackupName">1120FCorpFiscallyTransparentIndicatorYesLabel</xsl:with-param>
										</xsl:call-template>
										<span style="padding-left:2mm;">
											<b>Yes</b>
										</span>
								...
								<span style="padding-left:8mm;">
									...
									<input type="checkbox" alt="1120FCorpFiscallyTransparentIndicatorNo" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/CorpFiscallyTransparentInd"/>
											<xsl:with-param name="BackupName">1120FCorpFiscallyTransparentIndicatorNo</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelNo">
											<xsl:with-param name="TargetNode" select="$FormData/IRS1120FSectionI/CorpFiscallyTransparentInd"/>
											<xsl:with-param name="BackupName">1120FCorpFiscallyTransparentIndicatorNoLabel</xsl:with-param>
										</xsl:call-template>
										<span style="padding-left:2mm">
											<b>No</b>
										</span>
					...
					<table style="font-size:7pt;width:187mm" cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<th class="styIRS1120FLNPercentBox" style="vertical-align:middle;height:9mm;" scope="col">
									<b>(b) </b>%
								</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="sty1120FSchCLNAmountBox">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/IRS1120FScheduleC/ForeignDivGrossUpTotRcvdAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS1120FLNPercentBoxShaded">
									<span style="width:1px"/>
							...
							<tr>
								...
								<td class="sty1120FSchCLNDesc" scope="row">
									<b>Total dividends. </b> Add lines 1 through 12. Enter here and on line 4, page 4
									<div class="sty1120FRightFloat">
										<span class="sty1120FDotLn ">.</span>
									</div>
								</td>
							...
							<tr>
								...
								<td colspan="3" class="sty1120FSchCLNDesc" style="width:151mm;padding-right:3mm;" scope="row">
									<b>Total special deductions. </b> Add lines 8 and 13. Enter here and on line 30b, page 4
									<div class="sty1120FRightFloat">
										<span class="sty1120FDotLn ">........</span>
										<span style="width:3mm"/>
										<img src="{$ImagePath}/1120F_Bullet_Sm.gif" alt="SmallBullet"/>
						...
						<!-- Form to Form Link -->
							...
							<div class="sty1120FRightFloat">
								...
								<input type="checkbox" alt="IRS1120ScheduleJQualifiedPersonalServiceCorp" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/IRS1120FScheduleJ/QualifiedPersonalSrvcCorpInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:4.5mm;padding-right:1.8mm">
							...
							<!-- Form to Form Link -->
							<xsl:call-template name="SetFormLinkInline">
							<xsl:with-param name="TargetNode" select="$FormData/IRS1120FScheduleJ/AlternativeMinimumTaxAmt"/>
							</xsl:call-template>
							<!--Dotted Line--><div class="sty1120FRightFloat">
								<span class="sty1120FDotLn">..................</span>
							</div>
						</div>
						<div class="styLNRightNumBox" style="height:4.5mm;">3</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;padding-right:1mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/IRS1120FScheduleJ/IncomeTxPlusAltMinimumTaxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:7mm;padding-left:2.5mm;">8</div>
						<div class="styLNDesc" style="width:37mm">Other taxes. Check if from:</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:101mm;height:8mm;">
			...
			If <b>11a </b>or<b> 11b </b>applies and the transferee is a domestic corporation, attach Form 8848. If<b> 11c </b>applies, attach the statement required by Temporary Regulations section 1.884-2T(d)(5).
					...
					<div style="width:187mm;padding-top:1mm; border:1px solid black; border-left-width:0px; border-right-width:0px; border-bottom:0px">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							Form 
							<span class="styBoldText" style="font-size:8pt;">1120-F</span> (2017)
						</div>
					</div>
					<div class="pageEnd"/>
					<p style="page-break-before: always"/>
					...
					<div style="width:187mm;clear:both;padding-top:0.5mm">
						<div style="float:right;" class="styGenericDiv">Form <span style="font-size:8pt;font-weight:bold">1120-F</span> (2017)</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBoxNBB" style="height:7mm;border-left-width:0px;"></div>
					...
					<!-- Begin Line 3b -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="padding-left:2.5mm;"></div>

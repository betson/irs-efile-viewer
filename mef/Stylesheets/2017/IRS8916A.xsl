...
<!DOCTYPE xsl:stylesheet [
	<!ENTITY nbsp "&#160;">
]><!-- Last Modified by Iskilu Lawal on 10/18/2017 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      Form <span class="styFormNumber">8916-A</span>
       ...
       Go to 
        <a href="http://www.irs.gov/Form 1120" title="Link to IRS.gov"><i>www.irs.gov/Form 1120  </i></a> for the latest information.
						...
						<div class="styTYBox" style="width:30mm;height:17mm; border-left-width: 1px;">
							<div class="styOMB" style="height:4mm;">OMB No. 1545-0123</div>
							<br/>
							<div class="styTY" style="height:10mm;">20<span class="styTYColor">17</span>
							</div>
						</div>
					</div>
					<!--  End title of Form  -->
    ...
    <xsl:with-param name="TargetNode" select="$FormData/AmtAttrblCostFlowAssumptionGrp/ExpensePerIncomeStmtAmt"/>
					...
					<div style="width:187mm;border-top:1px solid black;">
                        ...
                        <span style="font-size:6.5pt;padding-right:10mm;width:30mm">Cat. No. 48657X</span>
                        <span style="width:106px;"/>  
                        <span style="font-size:6.5pt;"> Form </span><span style="font-size:8pt">
                        <span class="styBoldText;">8916-A</span></span> (2017)
                    </div>
					<p style="page-break-before: always"/> 
					<!--Begin Page 2 -->
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 8916-A (2017)<span style="width:148mm;"/>
						</div>
            ...
            <!-- pushpin data -->
					...
					<div style="width:187mm;border-top:1px solid black;">
						<span style="width:156mm;"/>  
                          Form <span style="font-size:8pt;width:13mm"><span class="styBoldText">8916-A</span></span> (2017)
                    </div>
					<p style="page-break-before: always"/> 

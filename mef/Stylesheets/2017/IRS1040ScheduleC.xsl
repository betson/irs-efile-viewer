  ...
  <form name="Form1040ScheduleC">
	...
	<div class="styFTBox" style="width:127mm;height:20mm;">
		...
		<div class="styFBT" style="height:3mm;margin-top:1mm;font:size:6pt;width:127mm;">
			 <img src="{$ImagePath}/1040SchC_Bullet_Sm.gif" alt="Bullet Image"/>Information about Schedule C and its separate instructions is at <i><a href="http://www.irs.gov/schedulec">IRS.gov/ScheduleC</a>.</i><br/>
	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2017 that would require you to file Form(s) 1099? (see instructions)</span>
	...
	<table class="styTable" style="width:93mm;float:left;font-size:7pt;heght:auto;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styLNAmountBox" style="height:6.5mm;width:31.5mm;border-bottom-width:0px;background-color:lightgrey;"> &#160;    
<!--					<xsl:call-template name="PopulateAmount">
...
<div style="width:187mm;float:none;clear:both; ">  
	...
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2017 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p style="page-break-before: always"/>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:all;">  
      <div style="float:left;">Schedule C (Form 1040) 2017 <span style="width:130mm;"/></div>
 ...
 <!--Line 41-->   
  ...
  <!--Line 48-->
    ...
    <div style="width:187mm;clear:all;">    
      ...
      <div class="stySmallText" style="width:46mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2017</span> </div>
    </div>
    <!--    </div> -->      

				...
				<form name="Form4797">
					...
					<div class="styTBB" style="width:187mm;height:25mm;">
							...
							<div class="styFBT" style="height:5mm;">
								...
								<img src="{$ImagePath}/4797_Bullet.gif" alt="Bullet"/>
	                 			  ...
	                 			  <a style="text-decoration:none;color:black;" 
	                         			  href="http://www.irs.gov/form4797"><i>www.irs.gov/Form4797</i></a>
						...
						<div class="styTYBox" style="width:29mm;height:25mm;border-left-width:2px;">
							...
							<div class="styTYBox" 
							style="border:none;padding-top:3mm;padding-left: 2mm; 
							text-align: left;">Attachment <br/>
				...
				<div class="styEINBox" style="width:45mm;padding-left:2mm;font-size:7pt;">
					...
					<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
						<div class="styBB" style="border-bottom-width:1px;width:187mm;">
							...
							Enter the gross proceeds from sales or exchanges reported to you for 2017 on
							 Form(s) 1099-B or 1099-S (or substitute statement) 
							 that you are including on line 2, 10, 
							 or 20. See instructions
							<!--Dotted Line-->
						...
						<div class="styBB" style="width:187mm;height:8mm;">
							...
							<div class="styPartDesc" style="float:left;width:167mm;">
							 Sales or Exchanges of Property Used in a Trade or Business and
						          ...
						          Most Property Held More Than 1 Year
						...
						<div id="PSOctn">
							...
							<table class="styTable" cellspacing="0">
									...
									<tr>
									 ...
									 <span class="styTableCellPad"/>
										...
										<th class="styTableCellHeader" style="width:29mm;font-weight:normal;" scope="col">
											<b>(a)</b> Description <br/>of property</th>
										...
										<th class="styTableCellHeader" style="width:30mm;font-weight:normal;" scope="col">
											<b>(f)</b> Cost or other<br/>basis, plus<br/>
											improvements and<br/>expense of sale</th>
										<th class="styTableCellHeader" 
								...
								<tbody style="border:1px solid black;height:auto;clear:all;">
										 ...
										 or (count($Form4797Data/PropertySaleOrExchange) &lt;= 4) ">
											<tr>
												<td class="styTableCell"
												 style="width:4mm;text-align:right;border-right:0;font-weight:bold;" scope="col">
									...
									<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 1
									 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4)
									  and ($Print = $Separated))">
										<tr>
											<td class="styTableCell" 
									...
									<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 2 
									or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4)
									 and ($Print = $Separated))">
										<tr>
											<td class="styTableCell"
									...
									<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 3
									 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4) 
									 and ($Print = $Separated))">
										<tr>
											<td class="styTableCell" 
											style="width:4mm;text-align:right;border-right-width:0px;" scope="col">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="text-align:left;width:30mm;">
												<span class="styTableCellPad"/>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;">
								<span style="float:left;">
								Combine lines 2 through 6.  Enter the gain or (loss)
								 here and on the appropriate line as        
								    follows: </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">.....</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;height:11mm;">
								<span class="styBoldText">Partnerships (except electing large partnerships)
								 and S corporations.</span>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;height:14mm;">
								...
								Individuals, partners, S corporation shareholders, and all others.</span> 
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;">
								<span style="float:left;">
								Nonrecaptured net section 1231 losses from prior years. See instructions</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">.............</div>
							</div>
							<div class="styLNRightNumBox" style="height:4.75mm;border-bottom-width:1px;">8</div>
							<div class="styIRS4797LNAmountBoxSmall" style="height:4.75mm;border-bottom-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="styBB" style="width:187mm;bottom-border:0;">
							...
							<div class="styLNDesc" style="width:145mm;">
						            ...
						            from line 7 on line 12 below. If line 9 is more than zero, enter the amount from 
						            line 8 on line 12 below 
						            and enter the gain from line 9 <span style="float:left;">as a long-term capital gain
						             on the Schedule D  filed with your 
						...
						<div id="OGLctn">
							<xsl:attribute name="class">
							    <xsl:choose>
							          <xsl:when test="($Print = $Separated)">styGenericDiv
							          </xsl:when>
						  ...
						  <xsl:attribute name="style">
						  <xsl:choose>
						         <xsl:when test="($Print = $Separated)">height:auto;clear:all;
						         </xsl:when>
						   <xsl:otherwise>
						           height:auto;border-bottom:0;
						   </xsl:otherwise>
							...
							<table class="styTable" cellspacing="0">
								...
								<tbody style="border:1px solid black;">
									<xsl:for-each select="$Form4797Data/OrdinaryGainLoss">
										<xsl:if test="($Print != $Separated)
										 or ((count($Form4797Data/OrdinaryGainLoss) &lt;= 4) and ($Print = 
										                   $Separated))">
											<tr>
												...
												<td class="styTableCell" style="width:30mm;text-align:right;border-right:0;">
													...
													and (count($Form4797Data/OrdinaryGainLoss) != 4)">
														<xsl:attribute name="style">
													           border-bottom:1px solid black;width:30mm;
													           text-align:right;border-right:0;
											     	     </xsl:attribute>
													</xsl:if>
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="GainOrLossAmt"/>
									...
									<xsl:if test="count($Form4797Data/OrdinaryGainLoss) &lt; 1
									...
									<xsl:if test="count($Form4797Data/OrdinaryGainLoss) &lt; 2 
									or ((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
									                   and ($Print = $Separated))">
										<tr>
											<td class="styTableCell" style="width:34mm;text-align:left;" colspan="2">
									...
									<xsl:if test="count($Form4797Data/OrdinaryGainLoss) &lt; 3 
									or ((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
									                   and ($Print = $Separated))">
										<tr>
											<td class="styTableCell" style="width:34mm;text-align:left;" colspan="2">
									...
									or ((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
										...
										<tr>
											...
											<td class="styTableCell" style=";width:16mm;">
												<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4)
												 and ($Print = $Separated))">
													<xsl:attribute name="style">width:16mm;
											    	</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:30mm;text-align:right;">
												<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
												and ($Print = $Separated))">
													<xsl:attribute name="style">width:30mm;text-align:right;
											    	</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:30mm;text-align:right;">
												<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
												and ($Print = $Separated))">
													<xsl:attribute name="style">width:30mm;width:30mm;text-align:right;
												    </xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											</td>
											...
											<td class="styTableCell" style="width:30mm;text-align:right;border-right:0;">
												<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) 
												and ($Print = $Separated))">
													<xsl:attribute name="style">width:30mm;text-align:right;border-right:0;
											    	</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											</td>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:146mm;">
								<span style="float:left;">Gain, if any, from line 7 or amount from line 8, 
								if applicable </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">.................</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:146mm;">
								<span style="float:left;">
								Ordinary gain from installment sales from Form 6252, line 25 or 36 </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">...............</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:146mm;">
								<span style="float:left;">
								Ordinary gain or (loss) from like-kind exchanges from Form 8824 </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">................</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:145mm;height:7.3mm;">
						                ...
						                of your return and skip lines a and b below. 
						                For individual returns, complete lines a and b below:
					    	</div>
							<div style="float:right;">
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm">a</div>
							    <div class="styLNDesc" style="width:145mm;height:12mm;">
						                  ...
						                  line 35, column (b)(ii), enter that part of the loss here. Enter the
						                   part of the loss from income-producing property
						                  on Schedule A (Form 1040), line 28, and the part  of the loss 
						                   from property used as an employee on Schedule 
						                  A (Form 1040), line 23. Identify as from "Form  4797, line 18a."  See instructions  
							<!--Dotted Line-->
								      <div class="styDotLn" style="float:right;">..............................</div>
							    </div>
							<div style="float:right;">
						...
						<div class="styBB" style="border-bottom-width:2px;width:187mm;">
							...
							Redetermine the gain or (loss) on line 17 excluding the loss, 
						            	if any, on line 18a. Enter here and on Form 1040,
					...
					<p>
						<div class="pageEnd" style="width:187mm;padding-top:0mm;border-top-width:1px;">
							...
							<div style="float:right;">
                                ...
                                Form <span class="styBoldText" style="font-size:8pt;">4797</span> (2017)
                           </div>
						</div>
					</p>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 4797 (2017)<span style="width:148mm;border-bottom-width:5mm"/>
						</div>
						<div style="float:right;">Page <span 
						style="font-weight:bold;font-size:8pt;border-bottom-width:1px">2</span>
						</div>
					</div>
					<!-- END Page Header -->
		     		<!-- BEGIN PART III TITLE -->
						<div class="styBB" style="width:187mm;border-bottom:0;">
							...
							<div class="styPartDesc" style="float:left;width:167mm;">
							Gain From Disposition of Property Under Sections 1245, 1250,1252, 1254, and 1255<br/>
							</div>
							<div class="styBB" style="width:187mm;height:4mm;">
								<div class="styPartDesc" 
								style="float:left;width:182mm;font-weight:normal;padding-left:17mm;">(see instructions)
						...
						<table class="styTable" cellspacing="0">
								<thead class="styTableThead" style="border:1px solid black;width:187mm;">
									<tr>
										...
										<th class="styTableCellHeader" style="width:148mm;text-align:left;" scope="col">(a)
										    <span class="styNormalText" style="padding-left:1mm;"> 
								...
								<tbody style="border:1px solid black;height:auto">
									<xsl:for-each select="$Form4797Data/PropertyDispositionGain">
										<xsl:if test="($Print != $Separated)
										 or ((count($Form4797Data/PropertyDispositionGain) &lt;= 4) and
										 ($Print = $Separated))">
											<tr>
												<td class="styTableCell" 
												style="width:6mm;text-align:center;border-right:0;font-weight:bold;
												      height:auto;" scope="col">
													<xsl:if test="(position() = last())
													 and (count($Form4797Data/PropertyDispositionGain) &lt; 4)">
												     	<xsl:attribute name="style"> width:6mm;text-align:center;
												...
												<td class="styTableCellText" style="width:17mm;border-right:0;">
													<xsl:if test="(position() = last()) 
													and (count($Form4797Data/PropertyDispositionGain) &lt; 4)">
														<xsl:attribute name="style">width:16mm;border-right:0;border-bottom:0;
											         	</xsl:attribute>
													</xsl:if>
													<span style="width:1px;"/>
													<xsl:if test="SoldDt">
									...
									<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 1 or     
									                 ((count($Form4797Data/PropertyDispositionGain) &gt; 4) 
									                 and ($Print = $Separated))">
										<tr style="height:auto;">
											...
											<td class="styTableCell" 
											style="width:248mm;text-align:left;border-bottom:0;">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" 
													select="$Form4797Data/PropertyDispositionGain"/>
												</xsl:call-template>
									...
									<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 2 or 
									                  ((count($Form4797Data/PropertyDispositionGain) &gt; 4) 
									                  and ($Print = $Separated))">
										<tr style="height:4mm">
											<td class="styTableCell" style="border-top:1px solid black;border-bottom:0;
									             	width:6mm;text-align:center;border-right:0;font-weight:bold;" scope="col">B
									         </td>
											<td class="styTableCell" 
											...
											<td class="styTableCell"
											 style="width:16mm;border-top:1px solid black;border-bottom:0;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" 
									...
									<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 3 or 
									                  ((count($Form4797Data/PropertyDispositionGain) &gt; 4)
									                   and ($Print = $Separated))">
										<tr style="height:4mm">
											<td class="styTableCell" 
									...
									<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 4 or 
									                  ((count($Form4797Data/PropertyDispositionGain) &gt; 4)
									                   and ($Print = $Separated))">
										<tr style="height:4mm">
											<td class="styTableCell" style="border-top:0px solid black;border-bottom:1;
												...
												<xsl:if test="($Print = $Separated)">
													<xsl:attribute name="style">
												    	border-top:1px solid black;border-bottom:1;width:6mm;
												    	text-align:center;border-right:0;font-weight:bold;
												    </xsl:attribute>
												</xsl:if>D
											</td>
											<td class="styTableCell" 
											style="border-top:0px solid black;width:16mm;border-bottom-width:1px;">
												<xsl:if test="($Print = $Separated)">
													<xsl:attribute name="style">border-top:1px solid black;width:16mm;
											     	</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											</td>
						...
						<xsl:if test="count($Form4797Data/PropertyDispositionGain) &gt; 4">
							<div class="styBB" style="width:187mm;height:8mm;padding-top:1mm">
						            NOTE: Lines 20 through 29 for properties A through D will be
						             displayed in the table immediately below, lines 20 
						            through 29 for further properties will be displayed in repeating tables 
						            below this table, in groups of 4.
						     </div>
						</xsl:if>
						...
						<xsl:if test="not($Form4797Data/PropertyDispositionGain) 
						 or ((count($Form4797Data/PropertyDispositionGain) &gt; 4)
								...
								<div class="styBB" style="width:187mm;">
									<div class="styLNDesc" 
									style="width:83mm;height:7mm;padding-top:4.5mm;text-align:center;font-weight:bold;">
										<span class="styArialText" style="padding-left:9mm;">
										These columns relate to the properties on lines 19A 
										          through 19D.
									    </span>
										<img src="{$ImagePath}/4797_Bullet.gif" alt="Bullet"/>
									</div>
									<div class="styLNAmountBoxNBB" style="
									        width:26mm;height:7mm;padding-top:2mm;
									        text-align:center;font-weight:bold;">Property A</div>
									<div class="styLNAmountBoxNBB" style="
									        width:26mm;height:7mm;padding-top:2mm;
									        text-align:center;font-weight:bold;">Property B</div>
									<div class="styLNAmountBoxNBB" style="
									        width:26mm;height:7mm;padding-top:2mm;
									        text-align:center;font-weight:bold;">Property C</div>
									<div class="styLNAmountBoxNBB" style="
									width:26mm;height:7mm;padding-top:2mm;text-align:center;font-weight:bold;">
									Property D</div>
								</div>
								<!-- Start Line 20 -->
								...
								<div style="width:187mm;height:4.5mm;">
									...
									<div class="styLNDesc" style="margin-left:1mm;width:66mm;height:4.5mm;">
								  Depreciation (or depletion) allowed or allowable<div class="styDotLn" 
								...
								<div style="width:187mm;height:4.5mm;">
									...
									<div class="styLNDesc" style="margin-left:1mm;width:66mm;height:4.5mm;border-bottom-width:1px">
								             Total gain. Subtract 23 from 20<div class="styDotLn" style="float:right;">......</div>
									</div>
									
									<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:1px">24</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;;border-bottom-width:1px">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom-width:1px">
										<span style="width:4px;"/>
								...
								<div class="styBB" style="width:187mm;border-bottom:0;">
									...
									<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:1px">25b</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom-width:1px">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom-width:1px;">
								...
								<div style="width:187mm;height:4.5mm;">
									<div class="styLNLeftLtrBox" style="margin-left: 1mm;">a</div>
									<div class="styLNDesc" style="width:66mm;height:4.5mm;">
										<span class="stySmallText">Additional depreciation after 1975. 
								...
								<div style="width:187mm;height:4.5mm;">
									...
									<div class="styLNDesc" style="width:66mm;height:4.5mm;">
										<span style="float:left;">
										Enter the <span class="styBoldText">smaller</span> of line 26c or 26d </span>
										<!--Dotted Line-->
										<div class="styDotLn" style="float:right;">.....</div>
									</div>
								...
								<div class="styBB" style="width:187mm;">
									...
									<div class="styLNRightNumBox" style="height:4.5mm;border-bottom:1;">26g</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
										<span style="width:4px;"/>
								...
								<div class="styBB" style="width:187mm;">
									...
									<div class="styLNRightNumBox" style="height:4.5mm;border-bottom:1;">27c</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
								...
								<div class="styBB" style="width:187mm;">
									...
									<div class="styLNRightNumBox" style="height:4.5mm;border-bottom:1;">28b</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom:1;">
								...
								<div class="styBB" style="border-bottom-width:1px;width:187mm;height:4.5mm;">
									...
									<div class="styLNDesc" style="width:66mm;height:4.5mm;">
										...
										<span class="styBoldText">smaller</span> of line 24 or 29a. See 
										               instructions
									    </span>
										<div class="styDotLn" style="float:right;">..</div>
									</div>
									<div class="styLNRightNumBoxNBB" style="height:4.5mm;border-bottom-width:2px">29b</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom-width:2px">
										<span style="width:4px;"/>
									</div>
									<div class="styLNAmountBoxSmall" style="height:4.5mm;border-bottom-width:2px">
										<span style="width:4px;"/>
							...
							<xsl:for-each select="$Form4797Data/PropertyDispositionGain">
								<xsl:if test="(position() mod 4) = 1">
									...
									<div class="styBB" style="width:187mm;">
										<div class="styLNDesc"
										 ...
										 padding-left:9mm;text-align:center;font-weight:bold;">
											<span class="styArialText">These columns relate to the properties
											 on lines 19A through 19D.</span>
											<img src="{$ImagePath}/4797_Bullet.gif" alt="Bullet"/>
										</div>
										<div class="styLNAmountBoxNBB" style="
									      width:26mm;height:7mm;padding-top:2mm;text-align:center;
									...
									<div style="width:187mm;height:4.5mm;">
										...
										<div class="styLNRightNumBox" style="height:4.5mm;padding-right:1.5mm">20</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="GrossSalesPriceAmt"/>
											</xsl:call-template>
									...
									<div style="width:187mm;height:4.5mm;">
										...
										<div class="styLNRightNumBox" style="height:4.5mm;padding-right:1.5mm">21</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
										...
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/
												PropertyDispositionGain[$curPos + 3]/CostOrOtherBasisExpenseSaleAmt"/>
											</xsl:call-template>
										</div>
									</div>
									<!-- Start Line 22-->
									<div style="width:187mm;height:4.5mm;">
										...
										<div class="styLNRightNumBox" style="height:4.5mm;padding-right:1.5mm">22</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
										...
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/
												PropertyDispositionGain[$curPos + 1]/DepreciationDepletionAllwAmt"/>
											</xsl:call-template>
										</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
									...
									<div style="width:187mm;height:4.5mm;">
										...
										<div class="styLNRightNumBox" style="height:4.5mm;padding-right:1.5mm">23</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
				     			...
				     			<div class="styLNLeftNumBox" 
				     			 style="border-bottom-width:0px;height:8mm;padding-top:4mm">24</div>
										<div class="styLNDesc" 
										style="width:66mm;margin-left:1mm;border-bottom:1;height:8mm;padding-top:4mm">
											<span style="float:left;border-bottom:0;">Total gain. Subtract line 23
											 from line 20 &#160;
											 <!--Dotted Line-->
											 </span>
												<div class="styDotLn" style="float:right;">...</div> 
										...
										<div class="styLNRightNumBox"
										 style="border-bottom:0;padding-right:1.5mm;height:8mm;padding-top:4mm">24</div>
										<div class="styLNAmountBoxSmall" style="border-bottom:0;height:8mm;padding-top:4mm" >
											<xsl:call-template name="PopulateAmount">
										...
										<div class="styLNAmountBoxSmall" style="border-bottom:0;height:8mm;padding-top:4mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/PropertyDispositionGain[$curPos + 1]/TotalGainAmt"/>
											</xsl:call-template>
										</div>
										<div class="styLNAmountBoxSmall" style="border-bottom:0;height:8mm;padding-top:4mm" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/PropertyDispositionGain[$curPos + 2]/TotalGainAmt"/>
											</xsl:call-template>
										</div>
										<div class="styLNAmountBoxSmall" style="border-bottom:0;height:8mm;padding-top:4mm" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/PropertyDispositionGain[$curPos + 3]/TotalGainAmt"/>
											</xsl:call-template>
										</div>
									</div>
									<!-- Start Line 25-->
									...
									<div style="width:187mm;height:4.5mm;">
										<div class="styLNLeftLtrBox" style="margin-left: 1mm;">d</div>
										<div class="styLNDesc" style="width:66mm;height:4.5mm;">
											<span class="stySmallText">Additional depreciation after 1969 and before 1976
											</span>
											<div class="styDotLn" style="float:right;">..</div>
										</div>
										<div class="styLNRightNumBox" style="height:4.5mm;">26d</div>
									...
									<div style="width:187mm;height:4.5mm;">
										<div class="styLNLeftLtrBox" style="margin-left: 1mm;">e</div>
										<div class="styLNDesc" style="width:66mm;height:4.5mm;">
											<span style="float:left;">Enter the <span class="styBoldText">smaller
											</span> of line 26c or 26d </span>
											<!--Dotted Line-->
											<div class="styDotLn" style="float:right;">....</div>
										</div>
										<div class="styLNRightNumBox" style="height:4.5mm;">26e</div>
									...
									<div style="width:187mm;height:4.5mm;">
										...
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/PropertyDispositionGain[$curPos + 1]/Section291Amt"/>
											</xsl:call-template>
										</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode"
												 select="$Form4797Data/PropertyDispositionGain[$curPos + 2]/Section291Amt"/>
											</xsl:call-template>
										</div>
										<div class="styLNAmountBoxSmall" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form4797Data/PropertyDispositionGain[$curPos + 3]/Section291Amt"/>
											</xsl:call-template>
										</div>
									</div>
									<!-- Start Line 26g-->
									...
									<div class="styBB" style="width:187mm;">
										<div class="styLNLeftLtrBox" style="margin-left: 1mm;">c</div>
										<div class="styLNDesc" style="width:66mm;">
											<span style="float:left;">Enter the <span class="styBoldText">
											smaller</span> of line 24 or 27b </span>
											<!--Dotted Line-->
											<div class="styDotLn" style="float:right;">.....</div>
										</div>
									...
									<div class="styBB" style="border-bottom-width:2px;width:187mm;height:4.5mm;">
										<div class="styLNLeftLtrBox" style="margin-left:1mm;">b</div>
										<div class="styLNDesc" style="width:66mm;height:4.5mm;">
											<span class="stySmallText">Enter the <span class="styBoldText">smaller
											</span> of line 24 or 29a. See instructions</span>
											<!--Dotted Line-->
											<div class="styDotLn" style="float:right;">..</div>
										</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="margin-left:1mm;width:137mm;height:8mm;padding-top:4mm">
								<span style="float:left;">
							...
							<div class="styLNAmountBox" style="height:8mm;width:33mm;padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<!-- Start Line 31 -->
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:1mm;">31</div>
							<div class="styLNDesc" 
							style="margin-left:1mm;width:137mm;height:4.5mm;padding-top:1mm;">
							...
							<div class="styLNRightNumBox" style="height:4.5mm;padding-top:1mm;">31</div>
							<div class="styLNAmountBox" style="height:4.5mm;padding-top:1mm;width:33mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$Form4797Data/TotalSectionPropertyAmt "/>
								</xsl:call-template>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="margin-left:1mm;width:137mm;height:8mm;"> 
						         Subtract line 31 from line 30. Enter the portion from casualty or 
						         theft on Form 4684, line 33. Enter the 
						...
						<xsl:choose>
							...
							(count($Form4797Data/Sect280DedDepreciationPYAmt) &lt;= 1)) or 
                             ((($Print = $Separated) and 
                              ((count($Form4797Data/Sect179DedDepreciationPYAmt) &gt; 1) or   
                              (count($Form4797Data/Sect280DedDepreciationPYAmt) &gt; 1))))">
								<div style="width:187mm;">
												...
												<tbody style="border:1px solid black;">
												  <xsl:for-each select="$Form4797Data/Sect179DedDepreciationPYAmt">
													...
													<tr>
														...
														style="text-align:left;border:none;font-weight:bold;" scope="col">33</td>
											...
											<table class="styTable" cellspacing="0" style="font-size:7pt;">
												...
												<tbody style="border:1px solid black;">
													...
													or (count($Form4797Data/Sect280DedDepreciationPYAmt) &lt;= 1)">
														<tr>
															<td class="styLNLeftNumBox"
															 style="text-align:left;border:none;font-weight:bold;" scope="col">33
															</td>
															<td class="styLNDesc" style="width:102.5mm;">
											                       Section 179 expense deduction or depreciation allowable
											                        in prior years
											                        <div class="styDotLn" style="float:right;">...</div>
															</td>
								...
								<div style="width:187mm;">
									...
									<xsl:choose>
										...
										and  (count($Form4797Data/Sect280RcmptDepreciationAmt) &gt; 1))">
											<div class="styLNRightNumBox" style="border-top-width:0px;border-bottom:0;">
											34</div>
									...
									<xsl:when test=" count($Form4797Data/Sect179RcmptDepreciationAmt) &gt; 
											...
											<table class="styTable" cellspacing="0" style="font-size:7pt;">
												...
												<tbody style="border:1px solid black;">
													...
													<tr>
													   <td class="styLNLeftNumBox" 
													   style="text-align:left;border:none;font-weight:bold;" scope="col">34</td>
														<td class="styLNDesc" style="width:102.5mm;">
                                                              Recomputed depreciation (see instructions)
                                                               <div class="styDotLn" style="float:right;">...........</div>
														</td>
													...
													<tr>
														...
														<td class="styLNDesc" style="width:102.5mm;">
																...
																<xsl:choose>
																	...
																	<xsl:otherwise>
																		<td class="styLNRightNumBox"
																		 style="border-bottom-width:0px;border-top-width:1px;width:8mm;"
																		 >34</td>
																		<td class="styLNAmountBoxNBB"
																		 style="border-top-width:1px;width:32mm;">
																			<xsl:call-template name="PopulateAmount">
						...
						<!-- &&&&&&&&&&&&&&&&&&&&&&&&& START line 35 &&&&&&&&&&&&&&&&&&&&&&&&&&&& -->
						<xsl:choose>
							<xsl:when test=" ((count($Form4797Data/Section179RecaptureAmt) &lt;= 1) and 
							             (count($Form4797Data/Sect280RecaptureAmt) &lt;= 1)) or 
                                         ((($Print = $Separated) and  ((count($Form4797Data/Section179RecaptureAmt)
                                         &gt; 1) or  (count($Form4797Data/Sect280RecaptureAmt) &gt; 1))))">
									...
									<div class="styLNLeftNumBox">35</div>
									      <div class="styLNDesc" style="margin-left:1mm;width:101.5mm;height:8mm;">
                                               Recapture amount. Subtract line 34 from line 33. See the instructions for 
                                               where to report
                                               <div class="styDotLn" style="float:right;">......................</div>
									</div>
									<div class="styLNRightNumBox" 
									style="border-bottom:0;border-top-width:1px;height:9mm;padding-top:4mm;">35 
									</div>
									<xsl:choose>
										<xsl:when test="(($Print = $Separated)
										 and  (count($Form4797Data/Section179RecaptureAmt) &gt; 1))">
											<div class="styLNAmountBox"
											 style="border-bottom:0;border-top-width:1px;height:9mm;padding-top:4mm;">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="ShortMessage" select="'true'"/>
													<xsl:with-param name="TargetNode" 
															...
															<tr>
																...
																<xsl:choose>
																	...
																	<xsl:otherwise>
																		...
																		<td class="styLNAmountBoxNBB"
												         						 style="width:32mm;border-top-width:1px;height:8mm;
														...
														<xsl:if test="($Print != $Separated)
														 or (count($Form4797Data/Sect280RecaptureAmt) &lt;= 1)">
															<tr>
																<td class="styLNLeftNumBox"
																 style="height:8mm;text-align:left;border:none;font-weight:bold;
																 float:none;padding-bottom:3.5mm" scope="col">35</td>
																<td class="styLNDesc" style="width:102.5mm;height:8mm;float:none">
                                                                    Recapture amount. Subtract line 34 from line 33. 
                                                                    See the instructions for where to report
                                                                     <div class="styDotLn" style="float:right;">......................</div>
																...
																<xsl:choose>
																	<xsl:when test="position()  = 1">
																		<td class="styLNRightNumBox"
																		 style="height:8mm;border-bottom-width:0px;border-top-width:0px;
																		           width:8mm;padding-top:4mm;float:none">35</td>
																		<td class="styLNAmountBoxNBB"
																	...
																	<xsl:otherwise>
																		...
																		<td class="styLNAmountBoxNBB" 
																		style="border-top-width:1px;width:32mm;height:8mm;
																		padding-top:4mm;float:none">
																			<xsl:call-template name="PopulateAmount">
																				<xsl:with-param name="TargetNode"
																				 select="$Form4797Data/
					...
					<div class="styLeftOverTitleLine" id="LeftoverData">
						...
						<xsl:if test="(count($Form4797Data/PropertySaleOrExchange) &gt; 4)
						 and ($Print = $Separated)">
							<span class="styRepeatingDataTitle">Form 4797, Part I, Line 2 - Sales or Exchanges of 
						...
						<xsl:if test="(count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated)">
							<span class="styRepeatingDataTitle">Form 4797, Part II, Line 10 - Ordinary 
							            gains and losses not included on lines 11 through 16 (include property 
							            held 1 year or less):
							 </span>
							...
							<table class="styDepTbl" style="font-size:7pt;">
								<thead class="styTableThead">
									...
									<tr class="styDepTblHdr">
										...
										19 <span style="width:3mm;"/> (a) Description of section 1245, 1250, 1252, 1254, 
										or 1255 property:</th>
						...
						<xsl:if test="(count($Form4797Data/PropertyDispositionGain) &gt; 4) 
						and ($Print = $Separated)">
							<span class="styRepeatingDataTitle">Form 4797, Part III, Lines 20 through 29b - Gain 
							               From Disposition of Property Under Sections 1245, 1250, 1252, 1254, and 1255:
					    	</span>
							<xsl:for-each select="$Form4797Data/PropertyDispositionGain">
								<xsl:if test="(position() mod 4) = 1">
									<xsl:variable name="curPos">
									...
									<table class="styDepTbl" style="font-size:7pt;">
										<thead class="styTableThead">
											...
											<tr class="styDepTblHdr">
												<th class="styDepTblCell" scope="col" 
												style="width:154mm;border-right-width:0px;font-size:7pt">
												...
												<th class="styDepTblCell" scope="col" 
						         						style="width:22mm;">Property <xsl:number value="position()" format="A"/>
												</th>
												<th class="styDepTblCell" scope="col" 
					        							style="width:22mm;">
					        							Property <xsl:number value="position() + 1" format="A"/>
												...
												<th class="styDepTblCell" scope="col"
												    style="width:22mm;">Property <xsl:number value="position() + 2" format="A"/>
												</th>
												<th class="styDepTblCell" scope="col"
												 style="width:22mm;">Property <xsl:number value="position() + 3" format="A"/>
												</th>
											</tr>
										</thead>
										<tfoot/>
										<tbody>
											...
											<tr class="styDepTblRow2">
												...
												<td class="styDepTblRow1Cell" style="border-top-width:0px;font-weight:bold;">
												25a</td>
											...
											<tr class="styDepTblRow2">
												...
												<td class="styDepTblRow2Cell" style="border-top-width:0px;font-weight:bold;">
												25b</td>
											...
											<tr class="styDepTblRow1" style="height:12mm;">
												<td class="styDepTblCell" style="text-align:left;border-bottom-width:0px">
													...
													If straight line depreciation was used, enter -0- on line 26g, except for 
													a corporation subject to section 291.
												</td>
												<td class="styDepTblRow1Cell" style="border-bottom-width:0px"/>
												<td class="styDepTblRow1Cell" style="border-bottom-width:0px"/>
												<td class="styDepTblRow1Cell" style="border-bottom-width:0px"/>
											...
											<tr class="styDepTblRow1">
												<td class="styDepTblCell"
												 style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													<span style="font-weight:bold;padding-right:1mm;padding-left:3mm;">
													a</span>
													<span style="float-left;">Additional depreciation after 1975. See instructions.
													</span>
												</td>
												<td class="styDepTblRow1Cell" style="border-top-width:0px;font-weight:bold;">
												26a</td>
											...
											<tr class="styDepTblRow1">
												<td class="styDepTblCell" 
												style="height:8mm;text-align:left;border-top-width:0px;border-bottom-width:0px;">
													<div style="height:8mm;float-left;font-weight:bold;width:3mm;
													float:left;padding-right:3mm;padding-left:3mm;">b</div>
											...
											<tr class="styDepTblRow1">
												<td class="styDepTblCell"
												 style="height:8mm;text-align:left;border-top-width:0px;border-bottom-width:0px;">
													<div style="height:8mm;font-weight:bold;padding-right:3mm;padding-left:3mm;
													width:3mm;float:left;">c</div>
												...
												<td class="styDepTblRow1Cell"
												 style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">26c
												</td>
												<td class="styDepTblRow1Cell" 
												style="border-top-width:0px;font-size:6pt;text-align:
											...
											<tr class="styDepTblRow1">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													...
													<div style="float:left;">Additional depreciation after 1969 and before 
													1976</div>
												</td>
												<td class="styDepTblRow2Cell"
												 style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">26d
												</td>
												<td class="styDepTblRow2Cell" 
								     				style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
											...
											<tr class="styDepTblRow1">
												...
												<td class="styDepTblRow1Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">26e
												</td>
												<td class="styDepTblRow1Cell" 
						      						 style="border-top-width:0px;font-size:6pt;text-align:right;
						      						 vertical-align:bottom;">
											...
											<tr class="styDepTblRow1">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													<div style="font-weight:bold;width:3mm;float:left;padding-right:3mm;
													padding-left:3mm;">f</div>
													<div style="float:left;">Sections 291 amount (corporations only)</div>
												</td>
												<td class="styDepTblRow2Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">26f
												</td>
												<td class="styDepTblRow2Cell"
					      							style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
											...
											<tr class="styDepTblRow2" style="height:12mm;">
												<td class="styDepTblCell" style="text-align:left;border-bottom-width:0px">
													<span style="float:left;font-weight:bold;padding-right:2mm;height:12mm;">
													27</span>
													<b> If section 1252 property: </b> Skip this section if you didn't 
													dispose of farmland or if this form
														 is being completed for a partnership (other than an electing
														  large partnership). 
												</td>
												<td class="styDepTblRow1Cell" style="border-bottom-width:0px"/>
												<td class="styDepTblRow1Cell" style="border-bottom-width:0px"/>
											...
											<tr class="styDepTblRow2">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													<div style="font-weight:bold;width:3mm;float:left;padding-right:3mm;
													padding-left:3mm;">b</div>
													<div style="float:left;">
													Line 27a multiplied by applicable percentage. See instructions.</div>
												</td>
												<td class="styDepTblRow2Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">27b
												</td>
												<td class="styDepTblRow2Cell"
							      					 style="border-top-width:0px;font-size:6pt;text-align:right;
							      					 vertical-align:bottom;">
											...
											<tr class="styDepTblRow2">
												...
												<td class="styDepTblRow1Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">27c
												</td>
												<td class="styDepTblRow1Cell" 
												style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
											...
											<tr class="styDepTblRow1">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													...
													padding-left:3mm;width:3mm;float:left;">a   
													</div>
												      	Intangible drilling and development costs, expenditures for development of
												      	 mines and other natural deposits, and mining exploration costs. 
												      	 See instructions.
												</td>
												<td class="styDepTblRow1Cell"
												 style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">28a
												</td>
												<td class="styDepTblRow1Cell"
												         style="border-top-width:0px;font-size:6pt;text-align:right;
												         vertical-align:bottom;">
											...
											<tr class="styDepTblRow1">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													...
													padding-left:3mm;">b</div>
													<div style="float:left;">
													Enter the <span style="font-weight:bold;">smaller</span> of line 24 or 28a 
													</div>
												</td>
												<td class="styDepTblRow2Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">28b
												</td>
												<td class="styDepTblRow2Cell"
												 style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
											...
											<tr class="styDepTblRow2">
												<td class="styDepTblCell"
												 style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													...
													float:left;">a</div>
													Applicable percentage of payments excluded from income under section 
													126. See instructions.
												</td>
												<td class="styDepTblRow1Cell" 
												style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">29a
												</td>
												<td class="styDepTblRow1Cell"
												 style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
												...
												style="text-align:left;border-top-width:0px;border-bottom-width:0px;">
													...
													padding-left:3mm;">b</div>
												    	<div style="float:left;">Enter the
													        ...
													        smaller</span> of line 24 or 29a. See instructions.
													    </div>
												</td>
												<td class="styDepTblRow2Cell"
												 style="border-top-width:0px;font-weight:bold;vertical-align:bottom;">29b
												</td>
												<td class="styDepTblRow2Cell" 
												style="border-top-width:0px;font-size:6pt;text-align:right;vertical-align:bottom;">
													<xsl:call-template name="PopulateAmount">
						...
						<xsl:if test="(($colACount &gt; 1) or ($colBCount &gt; 1)) and ($Print = $Separated)">
							<span class="styRepeatingDataTitle">Form 4797, Part IV, Line 33, Section 179 expense 
						        	deduction or depreciation allowable in prior years:
							</span>
							<table class="styDepTbl" style="font-size:7pt;">
								<thead class="styTableThead">
									<!-- Label the Column Headers -->
						...
						<xsl:if test="(($col34ACount &gt; 1) or ($col34BCount &gt; 1)) and ($Print = $Separated)">
							<span class="styRepeatingDataTitle">
							Form 4797, Part IV, Line 34, Recomputed depreciation (see instructions):
							</span>
							<table class="styDepTbl" style="font-size:7pt;">
								<thead class="styTableThead">
									<!-- Label the Column Headers -->
	...
	<xsl:template name="PopulateDualTable">
		...
		<xsl:if test="$counter &lt;= $maximumCount">
			<tr>
				...
				<xsl:attribute name="class">
			    	<xsl:choose>
			        	<xsl:when test="$counter mod 2 = 1">styDepTblRow1
			        	</xsl:when>
			        	<xsl:otherwise>
			             	styDepTblRow2
			        	</xsl:otherwise>

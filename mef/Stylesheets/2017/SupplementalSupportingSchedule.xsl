...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- Display Name is Supplemental Supporting Schedule -->
	<!-- Main template begin -->
			...
			<body class="styBodyClass" style="width:187mm;">
				...
				<div class="styTopSectionLine" style="width:187mm;">
					<div style="float:left;clear:none;">
						<span class="styTopSectionLineLbl">Name:</span>
					</div>
					<div style="width:115mm;float:left;clear:none;">
				...
				<div class="styTopSectionLine" style="width:187mm;">
					<div style="float:left;clear:none;">
						<span class="styTopSectionLineLbl">Line Number:</span>
					</div>
					<div style="float:left;clear:none;width:115mm;">
						<xsl:call-template name="PopulateText">

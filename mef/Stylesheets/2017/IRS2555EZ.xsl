...
<!DOCTYPE stylesheet [
  <!ENTITY nbsp "&#160;">
]><!-- Last Modified by Eugenia McDonald on 07/13/2017 -->
        ...
        <form name="Form2555EZ">
            ...
            <div class="styFTBox" style="width:125mm;height:20mm;">
              ...
              <div class="styFBT" style="height:3mm;width:124mm;margin-top:1mm;font-size:6.5pt;">
                ...
                <div class="styFBT" style="height:3mm;width:124mm;margin-top:.5mm;font-size:6.4pt;">
					<span style="text-align:left"><img src="{$ImagePath}/2555EZ_Bullet.gif" width="9" height="9" alt="Bullet"/> Information about Form 
					2555-EZ and its separate instructions is at <i>www.irs.gov/form2555ez.</i></span>
                </div>
            </div>
            <div class="styTYBox" style="width:29mm;height:20mm;">
              <div class="styOMB" style="height:auto;">OMB No. 1545-0074</div>
              <div class="styTY" style="height:7mm;font-size:22pt;">2017</div>
			   ...
			   <div style="float:left;clear:none;width:60mm;height:20mm;">
				   <div style="width:60mm;">
					...
					<div style="width:60mm;padding-top:1px">
						<div style="float:left;clear:none;width:3mm;"></div><div style="width:60mm;float:left;clear:none;">
						<img src="{$ImagePath}/1040_Bullet_Round.gif" alt="Small Bullet"/>
						  Had total foreign earned income of $102,100 <br/> <span style="width:2mm;"/> less.  See line 17.</div>
					</div>
					<div style="width:60mm;padding-top:1px;">
						<div style="float:left;clear:none;width:3mm;"></div><div style="width:60mm;float:left;clear:none;">
						<img src="{$ImagePath}/1040_Bullet_Round.gif" alt="Small Bullet"/>
          ...
          <div style="width:187mm;margin-top:1mm;">
            ...
            <div style="float:left;width:176mm;">
			    <span style="float:left;">
                 List your tax home(s) during 2017 and date(s) established.<img src="{$ImagePath}/2555EZ_Bullet.gif" width="9" height="9"
                 alt="Right Arrow" style="margin:0mm 1mm;"/>
                </span>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <span style="width:90px;"/>  
                Form <span class="styBoldText" style="font-size:8pt;">2555-EZ</span> (2017)
          </div>
          <!-- Page 2 Header -->
        <div class="pageEnd">
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
              <div style="float:left;">Form 2555-EZ (2017)</div>
          ...
          <div style="width:187mm;padding:1mm 0mm;">
            <div class="styPartName" style="font-family:sans-serif;">Part III</div>
              <div class="styPartDesc" style="font-size:10pt; font-weight:normal">
                  <b>Days Present in the United States - </b> Complete this part if you were in the United States or its possessions during 2017.
            </div>
          </div>
          <!-- END PART III TITLE -->
          <!-- Line 12 -->
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:5mm;width:42mm;border-bottom:1px solid black;
                padding-left:10mm;">$102,100.00</div>
            </div>
          </div>
          <!-- Line 14 -->
          <div style="width:187mm;">
            ...
            <div style="float:left;height:9mm;width:100mm;">
              ...
              <div class="styLNDesc" style="width:auto;padding-top:5mm;padding-left:2mm">
                Enter the number of days in your qualifying period that fall within 2017
                <span style="letter-spacing:3mm;font-weight:bold;">.</span>
              </div>
            </div>
            <div style="float:left;">
          ...
          <div style="width:187mm;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;text-align:right;padding-top:.5mm">17</div>
              ...
              Enter, in U.S. dollars, the total foreign earned income you earned and received in 2017 (see instructions). 
              ...
              <!--<img src="{$ImagePath}/2555EZ_Caution.gif" width="18" height="18" alt="Bullet" style="margin:0mm 3mm;"/>-->
				<b>Caution: </b> If the amount on line 17 is more than $102,100, <b>don't</b> file this form.  You must<br/>

...
<!-- Last Modified by Steven Fook on 9/14/2017 -->
				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana;        font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right;          width: 186mm;">651117</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2017, or tax year</span>
                          ...
                          <span style="width:8px;"/>.
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												...
												<xsl:with-param name="BackupName">
												IRS1065ScheduleK1TaxBasis</xsl:with-param>
											</xsl:call-template>
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												<xsl:with-param name="TargetNode" select="$FormData/AccountGrp/GAAPInd"/>
												<xsl:with-param name="BackupName">
												  IRS1065ScheduleK1AccountGrp/GAAP</xsl:with-param>
											</xsl:call-template>
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												...
												<xsl:with-param name="BackupName">
												  IRS1065ScheduleK1Section704bBook</xsl:with-param>
											</xsl:call-template>
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												...
												<xsl:with-param name="BackupName">
												  IRS1065ScheduleK1Other</xsl:with-param>
											</xsl:call-template>
					...
					<tr>
					    ...
					    font-size: 6pt;font-weight: bold; border-top: 1px solid black;">
						   ...
						   Instructions for Form 1065.
							...
							<span style="width: 33mm;">www.irs.gov/Form1065</span>
							<span style="font-weight: normal; width: 25mm;">Cat. No. 11394R</span>
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2017</span>
						</td>
					</tr>
				</table>

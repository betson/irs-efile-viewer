			...
			<body class="styBodyClass">
				<form id="IRS8867">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:27mm;height:24mm;">
						...
						<div class="styFTBox" style="width:127mm;height:24mm;">
							...
							<span class="styFMT" style="font-size:7.5pt;font-weight:normal;"><i>Earned Income Credit (EIC), American Opportunity Tax Credit (AOTC), Child Tax Credit (CTC), and Additional Child Tax Credit (ACTC)</i></span>
                     ...
                     <b> Go to <a href="http://www.irs.gov/Form8867"  title="Link to IRS.gov"> <i>www.irs.gov/Form8867</i></a> for instructions and the latest information.</b>
						</div>
						<div class="styTYBox" style="width:32.7mm;height:24mm;">
							<div class="styOMB">OMB No. 1545-1629</div>
							<span class="styTaxYear">20<span class="styTYColor">17</span></span><br/><br/>
				...
				<div class="styBB" style="width:187mm;">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styBB" style="width:100mm;border-bottom-width: 0px;padding-top:2px;padding-bottom:8px;padding-left:1mm;">
						Please check the appropriate box for  the credit(s) claimed on this return and complete the related Parts I-IV for the credit(s) claimed (check all that apply)
					</div>
					<div class="styLNDesc" style="width:13mm;"></div>
					<div class="styIRS8867ChildBox" style="width:24mm;height:9mm;font-weight:normal;;padding-left:10mm;padding-right:2mm;padding-top:1mm;border-bottom-width: 0px;"> EIC
					<span style="width:3mm"/>
					<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/EICClaimedInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Earned Income Credit Claimed">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											...
											<xsl:with-param name="BackupName">IRS8867EICClaimedInd</xsl:with-param>
												...
												<div class="styIRS8867ChildBox" style="width:24mm;height:9mm;text-align:center;font-weight:normal;padding-right:2mm;padding-top:1mm;border-bottom-width: 0px;"> CTC/ACTC
												<span style="width:1.3mm"/>
																		    <span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/CTCACTCClaimedInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Child Tax Credit and/or Additional Child Tax Credit Claimed">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CTCACTCClaimedInd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867CTCACTCClaimedInd</xsl:with-param>
										</xsl:call-template>
									</input>
									</span>
	</div>
					<div class="styIRS8867ChildBox" style="width:24mm;height:9mm;font-weight:normal;padding-left:10mm;padding-right:2mm;padding-top:1mm;border-bottom-width: 0px;"> AOTC
					<span style="width:3.95mm"/>
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/AOTCClaimedInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="American Opportunity Tax Credit Claimed">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/AOTCClaimedInd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
						...
						<div class="styGenericDiv" style="width:187mm;height:6mm;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:.5mm;">
								<span style="float:left;clear:none;">Did you complete the return based on information for tax year 2017 provided by the taxpayer or reasonably obtained by you? <span class="styDotLn" style="float:none;clear:none;padding-left:3mm;">...........</span></span>
						...
						<div class="styGenericDiv" style="width:187mm;height:17mm;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:3.1mm;height:14mm;" >
							   Did you complete the applicable EIC and/or CTC/ACTC worksheets found in the Form 1040, 1040A, 1040EZ, 1040SS, 1040PR or 1040NR instructions, and/or the AOTC worksheet found in the Form 8863 instructions, or your own worksheet(s) that provides the same information, and all related forms and schedules for each credit claimed?<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">....................</span>
							   <div class="styBB" style="width:105mm;padding-top:.65mm;float:clear"></div>
							</div>
							<div class="styIRS8867ChildBox" style="height:19mm;width:73mm;padding-left:10mm;padding-top:14mm;">
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/CompleteApplicableWorksheetInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CompleteApplicableWorksheetInd"/>
											<xsl:with-param name="BackupName">IRS8867CompleteApplicableWorksheetInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
...
<div class="styIRS8867ChildBox" style="height:23.7mm;width:73mm;padding-left:10mm;padding-top:14mm;">
							<span>
									<xsl:call-template name="PopulateSpan">
						...
						<!-- Begin Line 3a -->
							...
							<div class="styLNLeftNumBox" style="height:8mm;padding-left:5mm;"><img src="{$ImagePath}/8911_Bullet_Round.gif" width="5" height="5" alt="Bullet"/></div>
							<div class="styIRS8867LNDesc" style="width:105mm;height:6mm;padding-left:2mm;padding-top:1mm;">Interview the taxpayer, ask questions, and document the taxpayer’s responses to determine that the taxpayer is eligible to claim the credit(s)<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">......</span></div>
							</div>
						<!-- End Line 3a -->
						<!-- Begin Line 3b -->
						    ...
						    <div class="styIRS8867LNDesc" style="width:103mm;height:6mm;padding-left:0mm;padding-top:1mm;">Review information to determine that the taxpayer is eligible to claim the credit(s) and for what amount<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">..................</span>
						...
						<div class="styGenericDiv" style="width:187mm;height:auto;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:1mm;height:auto;" >
							   Did you satisfy the record retention requirement?  To meet the record retention requirement, you must keep a copy of your documentation referenced in 4b, a copy of this Form 8867, a copy of applicable worksheets, a record of how, when, and from whom the information used to prepare Form 8867 and worksheet(s) was obtained, and a copy of any document(s) provided by the taxpayer that you relied on to determine eligibility or to compute the amount for the credit(s)
						...
						<div class="styGenericDiv" style="width:187mm;height:10.5mm;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:1mm;">
								<span style="float:left;clear:none;">Did you ask the taxpayer whether he/she could provide documentation to
								 substantiate eligibility for and the amount of the credit(s) claimed on the return if his/her return is selected for audit?<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">..............</span> </span>
						...
						<div class="styGenericDiv" style="width:187mm;height:11mm;padding-top:0mm;">
							...
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/PrevDisallowedOrReducedCrInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/PrevDisallowedOrReducedCrInd"/>
											<xsl:with-param name="BackupName">IRS8867PrevDisallowedOrReducedCrInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
						...
						<!-- Begin Line 7a -->
							...
							<span>
									...
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CompleteRequiredRecertFormCd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867CompleteRequiredRecertFormCd</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
							...
							<span style="width:10mm"/>
							<span>
									<input type="checkbox" class="styCkbox" alt="N/A">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/CompleteRequiredRecertFormCd"/>
							...
							<span>
									...
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/QstnToCompleteCorrectSchCCd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867QstnToCompleteCorrectSchCCd</xsl:with-param>
										</xsl:call-template>
									</input><label>
										<xsl:call-template name="PopulateLabelYes">
											<xsl:with-param name="TargetNode" select="$FormData/QstnToCompleteCorrectSchCCd"/>
          ...
          <div style="float:right;">
              <span style="width:50px;"/>  
                Form <span class="styBoldText" style="font-size:8pt;">8867</span> (2017)
            </div>
					<div class="pageEnd" style="width:187mm;clear:all;">
					</div><br/><br/>
						<span style="float:left;clear:none;">Form 8867 (2017)</span>
					...
					<div class="styIRS8867ChildBox" style="width:24mm;height:7mm;text-align:center;font-weight:normal;padding-right:2mm;padding-top:2mm;border-bottom-width: 0px;"> EIC</div>					<div class="styIRS8867ChildBox" style="width:24mm;height:7mm;text-align:center;font-weight:normal;padding-right:2mm;padding-top:2mm;border-bottom-width: 0px;"> CTC/ACTC</div>
					<div class="styIRS8867ChildBox" style="width:24mm;height:7mm;text-align:center;font-weight:normal;padding-right:2mm;padding-top:2mm;border-bottom-width: 0px;"> AOTC</div>
					...
					<!-- Begin Line 9b -->
						<div class="styGenericDiv" style="width:187mm;height:11mm;">
							...
							<div class="styIRS8867ChildBox" style="height:11mm;padding-top:4.75mm;background-color:lightgrey;"></div>
        					<div class="styIRS8867ChildBox" style="height:11mm;width:26mm;padding-top:4.75mm;background-color:lightgrey;border-right-width: 1px;" ></div>
							</div>
					<!-- End Line 9b -->
					<!-- Begin Line 9c -->
						<div class="styGenericDiv" style="width:187mm;height:11mm;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:1mm;height:12mm;" >
							   Did you explain to the taxpayer the rules about claiming the EIC when a child is the qualifying child of more than one person (tie-breaker rules)?<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">.......</span>
							</div>
							...
							<span>
									...
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ExplainTiebreakerRulesCd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867ExplainTiebreakerRulesCd</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
					...
					<!-- Begin Line 10 -->
						...
						<div class="styPartName" style="color:black;background-color:white;width:173mm;height:3mm;padding-left:1.3mm;text-align:left;font-size:7pt;font-weight:normal"><b>Due Diligence Questions for Returns Claiming CTC and/or ACTC</b> (If the return does not claim CTC or ACTC, go to Part IV.)
					</div>
					...
					<!-- Begin Line 10a -->
						<div class="styGenericDiv" style="width:187mm;height:7.85mm;">
							...
							<div class="styIRS8867ChildBox" style="height:7.95mm;background-color:lightgrey;border-bottom-width:0px;"></div>
							<div class="styIRS8867ChildBox" style="height:8.1mm;padding-top:3mm;">
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/ChildLiveWithTaxpayerInd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ChildLiveWithTaxpayerInd"/>
											<xsl:with-param name="BackupName">IRS8867ChildLiveWithTaxpayerInd</xsl:with-param>
										</xsl:call-template>
									</input>	<label>
										<xsl:call-template name="PopulateLabelYes">
											<xsl:with-param name="TargetNode" select="$FormData/ChildLiveWithTaxpayerInd"/>
							...
							<div class="styIRS8867ChildBox" style="height:7.95mm;width:26mm;padding-top:1mm;background-color:lightgrey;border-right-width: 1px;border-bottom-width:0px;"></div>
							</div>
					<!-- End Line 10a -->
					<!-- Begin Line 10b -->
						<div class="styGenericDiv" style="width:187mm;height:12mm;">
							...
							<div class="styIRS8867ChildBox" style="height:12mm;background-color:lightgrey;border-top-width:1px;"></div>
							<div class="styIRS8867ChildBox" style="height:12mm;padding-top:2mm;;" >
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/ActiveForm8332SmlrStatementCd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ActiveForm8332SmlrStatementCd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867ActiveForm8332SmlrStatementCd</xsl:with-param>                                                                                       
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
							...
							<span>
									...
									<label>
										<xsl:call-template name="PopulateLabelNo">
											<xsl:with-param name="TargetNode" select="$FormData/ActiveForm8332SmlrStatementCd"/>
											<xsl:with-param name="BackupName">IIRS8867ActiveForm8332SmlrStatementCd</xsl:with-param>
										</xsl:call-template>
										No
									</label>
							</span>
							...
							<div class="styIRS8867ChildBox" style="height:12mm;width:26mm;background-color:lightgrey;border-right-width: 1px;border-top-width:1px" ></div>
							</div>
					<!-- End Line 10b -->
					<!-- Begin Line 10c -->
						<div class="styGenericDiv" style="width:187mm;height:9mm;">
							...
							<div class="styIRS8867ChildBox" style="height:9mm;;background-color:lightgrey;border-bottom-width: 0px;"></div>
							<div class="styIRS8867ChildBox" style="height:9mm;padding-top:0mm;border-bottom-width: 0px;">
							<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/DetermChildExemptClmReleaseCd"/>
									</xsl:call-template>
									<input type="checkbox" class="styCkbox" alt="Yes">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/DetermChildExemptClmReleaseCd"/>
											<xsl:with-param name="DisplayedCheckboxValue" select="'YES'"/>
											<xsl:with-param name="BackupName">IRS8867DetermChildExemptClmReleaseCd</xsl:with-param>                                                                                       
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
							...
							<span>
									...
									<label>
										<xsl:call-template name="PopulateLabelNo">
											<xsl:with-param name="TargetNode" select="$FormData/DetermChildExemptClmReleaseCd"/>
											<xsl:with-param name="BackupName">IIRS8867DetermChildExemptClmReleaseCd</xsl:with-param>
										</xsl:call-template>
										No
									</label>
							</span>
							...
							<div class="styIRS8867ChildBox" style="height:9mm;width:26mm;background-color:lightgrey;border-bottom-width: 0px;border-right-width: 1px;" ></div>
							</div>
					<!-- End Line 10c -->
					<!-- End Line 10 -->
					<!-- Begin Line 11 -->
					...
					<!-- Begin Line 11 -->
						<div class="styGenericDiv" style="width:187mm;height:7.75mm;">
							...
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:1mm;" >
							   Did the taxpayer provide substantiation such as a Form 1098-T and/or receipts for the qualified tuition and related expenses for the claimed AOTC?<span class="styDotLn" style="float:none;clear:none;padding-left:1.5mm;">.....</span>
					...
					<div class="styPartName" style="width:14mm;height:4.5mm;font-size:9pt;background-color:black">Part V</div>
						<div class="styPartName" style="color:black;background-color:white;width:173mm;height:4.5mm;padding-left:1.3mm;padding-bottom:3mm;text-align:left;font-size:7pt;font-weight:normal"><b>Credit Eligibility Certification</b> 
					</div>
					<div class="styBB" style="width:187mm;border-bottom-width:1px;"></div>
					<!-- BEGIN Words Between 11 and 12 -->
							...
							<div class="styIRS8867LNDesc" style="width:187mm;padding-top:1mm;height:3mm;padding-left:11.5mm;float:none;">
...
B. Submit Form 8867 in the manner required;  </div>
							<div class="styIRS8867LNDesc" style="width:187mm;padding-top:1mm;height:6.5mm;padding-left:11.5mm;">
...
<br/><i>Document Retention.</i></div>
							<div class="styIRS8867LNDesc" style="width:187mm;padding-top:1mm;height:3.5mm;padding-left:14.6mm;">
1. A copy of Form 8867,</div>
<div class="styIRS8867LNDesc" style="width:187mm;height:3mm;padding-left:14.6mm;">
...
credit(s),</div>
<div class="styIRS8867LNDesc" style="width:187mm;padding-top:1mm;height:3mm;padding-left:14.6mm;">
4. A record of how, when, and from whom the information used to prepare this form and worksheet(s) was obtained,
and</div>
<div class="styIRS8867LNDesc" style="width:187mm;padding-top:1mm;height:6.5mm;padding-left:14.6mm;">
				...
				<div class="styIRS8867LNDesc" style="width:5mm;height:6mm;padding-left:8.5mm;padding-top:3mm;">
					...
					<div class="styBB" style="width:187mm;float:clear;padding-bottom:.5mm;"></div>
						<div class="styGenericDiv" style="width:187mm;height:8.5mm;">
							<div class="styLNLeftNumBoxBB" style="padding-top:.5mm;height:7.95mm;border-bottom-width: 2px;">12</div>
							<div class="styIRS8867ChildDesc" style="width:105mm;padding-top:.5mm;" >

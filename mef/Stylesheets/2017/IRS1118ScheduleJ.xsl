...
<!-- BEGIN FORM HEADER -->
	...
	<div class="styFNBox" style="width:26mm;height:32mm;border-right-width:.5mm;">
      <span class="styFormNumber" style="font-size:10pt;">Schedule J 
            ...
            <br/>
            <div style="font-size:6pt;padding-top:2mm;padding-bottom:7mm;height:4mm;">(Rev. September 2016)</div>
	     ...
	     <tbody>
				...
				<div style="width:187mm">
				    <div style="float: left; clear: none;">
					  ...
					  <span class="styBoldText">Schedule J (Form 1118) (Rev. 09-2016)</span>
				</div>
					<div class="pageEnd"/>
          </div>
        </xsl:if>
    ...
    <xsl:for-each select="$FormData/AdjSepLmtOtherIncome">
      <xsl:variable name="pos" select="position()"/>
        ...
        <!-- //////////////////////////////////////////////////////////////////////////////////////////
          ...
          ///////////////////////////////////////////////////////////////////////////////////////// -->
              <br/>
              <span class="styRepeatingDataTitle" style="width:187mm;">Form 1118 Schedule J, Parts I - II Column (iii) Other Income (Continue)</span>
              ...
              id="adSeLmIn">
                <table cellspacing="0" style="font-size:7pt;">
                  ...
                  <tbody>
                    ...
                    <!-- end repeating rows -->
              <br/>
              <span class="styRepeatingDataTitle" style="width:187mm;">Form 1118 Schedule J, Parts III - IV Column (iii) Other Income (Continue)</span>
              <div class="IRS1118ScheduleJ_TableContainer" style="width:187mm;border-top-width:0px;border-bottom-width:0px;page-break-after:always;display:block" 
              id="adSeLmIn">
                <table cellspacing="0" style="font-size:7pt;">

...
<!-- Last Modified by James Ganzy on 9/08/2017 -->
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form1065B">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:32.5mm;height:18mm;">Form 
                        <span class="styFormNumber">1065-B</span>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Form 1065-B, Top Left Margin - Form 8697 Amount</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1065BData/TaxesAmt/@form8697Amt"/>
								</xsl:call-template>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Form 1065-B, Top Left Margin - Form 8866 Amount</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1065BData/TaxesAmt/@form8866Amt"/>
								</xsl:call-template>
							<br/>
						...
						<div class="styFTBox" style="width:119.3mm;height:18mm;">
							<div class="styMainTitle" style="width:94mm;height:10mm;">U .S. Return of Income for <br/>Electing Large Partnerships</div>
							<div class="styFST" style="width:119.3mm;height:5mm;font-size:7pt;text-align:center;">For calendar year 
                            ...
                            <span style="width:18mm;border-bottom:1 solid black;">
								...
								<br/>
								<span style="text-align:center;font-size:6pt;">
									<img src="{$ImagePath}/1065B_Bullet_Md.gif" alt="MediumBullet"/>Go to 
										<a href="http://www.irs.gov/form1065b" title="Link to IRS.gov"><i>www.irs.gov/Form1065B </i></a>for instructions and the latest information.
								</span>
							</div>
						</div>
						<div class="styTYBox" style="width:34mm;height:18mm;">
							<div class="styOMB" style="width:34mm;">OMB No. 1545-0123</div>
							<div class="styTY" style="height:11mm;padding-top:3mm;">20<span class="styTYColor">17</span>
							</div>
						</div>
					</div>
					<div style="width:187mm;float:left;clear:left;">
						<div style="width:32mm;height:44mm;float:left;clear:left;">
							<div class="styEINDateAssets" style="width:32mm;height:16mm;padding-left:0mm;">
							...
							<div class="styEINDateAssets" style="width:32mm;height:12mm;padding-left:0mm;border-bottom-width:1px;">
						...
						<div class="styLblNameAddr" style="width:120.3mm;height:auto;">
							<div class="styUseLbl" style="width:11mm;height:40mm;padding-top:12mm;border-right-width:0px;">TYPE<br/>or<br/>PRINT</div>
							<div class="styNameAddr" style="width:107mm;height:15mm;border-left-width:1px;padding-left:1px;">Name of partnership<br/>
							...
							<div class="styNameAddr" style="width:107mm;height:16mm;border-left-width:1px;">
        Number, street, and room or suite no. If a P.O. box, see instructions.<br/>
								<span class="stySmallText" style="padding-left:2mm;padding-top:1mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="styNameAddr" style="height:11.5mm;border-bottom-width:0px;width:107mm;border-left-width:1px;">
        City or town, state or province, country, and ZIP or foreign postal code<br/>
								<span class="stySmallText" style="width:107mm;padding-left:2mm;padding-top:1mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
						...
						<div class="styEINDateAssets" style="width:34.7mm;height:16mm;padding-left:.5mm;font-size:6pt.">
						...
						<div class="styEINDateAssets" style="width:34.7mm;height:16mm;padding-left:.5mm;">
						...
						<div class="styEINDateAssets" style="width:34.7mm;height:12mm;padding-left:.5mm;border-bottom-width:1px;">
							<div class="styLNDesc" style="width:34.7mm;"><b>F </b>Total assets (see instructions)</div>
							<div class="styLNDesc" style="width:34.7mm;padding-bottom:0mm;padding-top:4mm;">
								<div class="styLNDesc" style="width:2mm;padding-bottom:0mm;">$</div>
								<div class="styLNAmountBox" style="width:32mm;padding-bottom:0mm;border-left-width:0mm;border-bottom-width:0mm;">
				...
				<div style="width:187mm;">	
					...
					<div style="width:187mm;">
						<div class="styBoldText" style="width:6mm;float:left;clear:none;padding-top:1.7mm;padding-left:3mm;">G</div>
						<div class="styLNDesc" style="width:178mm;">
      Check applicable boxes: <span style="width:6mm;"/>
        ...
        Address Change
					...
					<div style="width:187mm;">
						<div class="styBoldText" style="width:6mm;float:left;clear:none;padding-top:1.7mm;padding-left:3mm;">H</div>
      ...
      Check accounting method: 
         ...
         Other (specify)
						...
						<div class="styFixedUnderline" style="height:5mm;width:45mm;padding-top:1mm;border-style: dotted;">
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">H(3) - Other (specify)</xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form1065BData/MethodOfAccountingOtherInd/@methodOfAccountingOtherDesc"/>
								<xsl:with-param name="Style">padding-left:6mm;</xsl:with-param>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
						<div class="styBoldText" style="width:6mm;float:left;clear:none;padding-top:1mm;padding-left:3mm;">I</div>
						<div class="styLNDesc" style="width:136mm;padding-top:1mm;">
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
						...
						<div class="styUnderlineAmount" style="width:45mm;border-style: dotted;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						<div class="styBoldText" style="width:6mm;float:left;clear:none;padding-left:3mm;padding-top:1.5mm;">J</div>
						<div class="styLNDesc" style="width:145mm;padding-top:0mm;">
      Check if Schedule M-3 (Form 1065) is attached
					...
					<!--Part I-->
					<div class="styBB" style="height:auto;width:187mm;border-top:1px black solid;">
						<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS1065BVTImageBox" style="height:46mm;padding-top:20mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<!--line 1-->
							<div class="styLNDesc" style="height:6mm;width:25mm;">
							...
							<!--Box 1a-->
							<div class="styLNAmountBox" style="height:6mm;border-right-width: 1px;padding-top:3mm;padding-bottom:0mm;">
							...
							<!-- 1b-->
							<div class="styLNDesc" style="height:6mm;width:30mm;padding-left:2mm;">
							...
							<div class="styLNDesc" style="height:6mm;width:13.1mm;padding-left:3mm;padding-top:3mm;padding-bottom:0mm;">
								<span class="styBoldText">c</span> Bal <img src="{$ImagePath}/1065B_Bullet_Sm.gif" alt="MidSizeBullet"/>
							</div>
							<!-- Box 1c-->
							<div class="styLNRightNumBox" style="height:6mm;padding-top:3mm;padding-bottom:0mm;">1c</div>
							<div class="styLNAmountBox" style="height:6mm;padding-top:3mm;padding-bottom:0mm;">
								<xsl:call-template name="PopulateAmount">
        ...
        <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/NetIncomeLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">4</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/NetRentalIncomeOrLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">5</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/OrdinaryIncomeLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">6</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/NetFarmProfitLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">7</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/TotalOrdinaryGainLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">9</div>
								</xsl:when>
								<xsl:otherwise>
							...
							<div class="styLNDesc" style="width:132mm;">
								<span style="float:left;clear:none;">Net gain (loss) from Form 4797, Part II, line 17 (attach Form 4797)
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Part I  Line 9 - Form 4684 Code</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1065BData/TotalOrdinaryGainLossAmt/@form4684Cd"/>
									</xsl:call-template>
								</span>	
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.........</span>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/OtherIncomeOrLossAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">10</div>
								</xsl:when>
								<xsl:otherwise>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/SalariesAndWagesAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">12</div>
								</xsl:when>
								<xsl:otherwise>
					  ...
					  <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/TotalRentOrLeaseExpenseAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">16</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/InterestDeductionAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">18</div>
								</xsl:when>
								<xsl:otherwise>
					   ...
					   <!--Dotted Line-->
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/DepreciationAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">19a</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="styLNLeftNumBox" style="">19a</div>
								</xsl:otherwise>
							</xsl:choose>
							<div class="styLNDesc" style="width:92mm;">Depreciation and section 179 expense deduction (see instructions)
                            <xsl:call-template name="SetFormLinkInline">
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/DepreciationAmt">
									<div class="styLNLeftLtrBox" style="padding-top:1mm"><span style="width:4px;"/>b</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="styLNLeftLtrBox" style=""><span style="width:4px;"/>b</div>
								</xsl:otherwise>
							</xsl:choose>
							<div class="styLNDesc" style="width:92mm;">Less: depreciation reported on Form 1125-A and elsewhere 
                        on return
									<xsl:call-template name="SetFormLinkInline">
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/DepletionAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">20</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/OtherDeductionsAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">23</div>
								</xsl:when>
								<xsl:otherwise>
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="">24</div>
							<div class="styLNDesc" style="width:132mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="padding-bottom:0mm;">25</div>
							<div class="styLNDesc" style="width:132mm;padding-bottom:0mm;">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1065BVTImageBox" style="height:16mm;padding-top:2mm;">
							<img src="{$ImagePath}/1065B_TaxAndPayment.gif" alt="VertTaxAndPayment"/>
						</div>
						<div style="width:181mm;float:right;clear:none;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/TaxesAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">26</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="styLNLeftNumBox" style="">26</div>
								</xsl:otherwise>
							</xsl:choose>
							<div class="styLNDesc" style="width:132mm;">
        ...
        Form 8611
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="">27</div>
							<div class="styLNDesc" style="width:132mm;">
       ...
       Form 2439
        ...
        Form 4136
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="">28</div>
							<div class="styLNDesc" style="width:132mm;">
						...
						<!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="border-bottom-width:0px;padding-bottom:0mm;">29</div>
							<div class="styLNAmountBox" style="border-bottom-width:0px;padding-bottom:0mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065BData/OverpaymentAmt"/>
								</xsl:call-template>
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
							<div class="styMainTitle"  style="height:18.5mm;width:12mm;font-size:11pt;font-weight:bold;padding-top:6.5mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;float:left;clear:none;">Sign Here</div>
					<div class="styLNDesc" style="height;auto;width:175mm;">
						<div class="styLNDesc" style="height:6mm;width:175mm;padding-left:1mm;padding-top:0mm;">
                        ...
                        <div class="styLNDesc" style="height:8mm;width:175mm;padding-left:1mm;">
				...
				<div class="styBB" style="height:auto;width:187mm;font-size:6pt;">
				   ...
				   <div style="height:auto;width:168mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 0px 1px;">
 						<div style="width:168mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
							<div class="styLNDesc" style="height:7mm;width:50mm;padding-top:0mm;padding-bottom:0mm;padding-left:.5mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
								Print/Type preparer's name<br/>
									<xsl:call-template name="PopulateReturnHeaderPreparer">
										<xsl:with-param name="TargetNode">Name</xsl:with-param>
									</xsl:call-template>
							</div>
							<div class="styLNDesc" style="height:7mm;width:62.3mm;padding-top:0mm;padding-bottom:0mm;padding-left:.5mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
								Preparer's signature
							</div>
							<div class="styLNDesc" style="height:7mm;width:15mm;padding-top:0mm;padding-bottom:0mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;padding-left:.5mm;">Date <br/>
								<xsl:call-template name="PopulateReturnHeaderPreparer">
									<xsl:with-param name="TargetNode">DatePrepared</xsl:with-param>
								</xsl:call-template>
							</div>
							<div class="styLNDesc" style="height:7mm;width:18mm;padding-top:0mm;padding-bottom:0mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;padding-left:.5mm;">
									<label >Check 
										<xsl:call-template name="PopulateReturnHeaderPreparer">
							...
							<div class="styLNDesc" style="height:6mm;width:19mm;padding-top:0mm;padding-bottom:0mm;padding-left:.5mm;">PTIN
                             <br/>
								<xsl:call-template name="PopulateReturnHeaderPreparer">
 						...
 						<div style="width:168mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">	
							<div class="styLNDesc" style="height:6mm;width:127.3mm;padding-bottom:0mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
							...
							<div class="styLNDesc" style="height:6mm;width:33mm;padding-bottom:0mm;padding-left:.5mm;">Firm's EIN
								<img src="{$ImagePath}/1065B_Bullet_Md.gif" alt="MediumBullet"/>
								<span style="width:4px;"/>
								<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
									<xsl:with-param name="TargetNode">EIN</xsl:with-param>
						...
						<div style="width:168mm;float:left;clear:none;">	
							<div class="styLNDesc" style="height:auto;width:127.3mm;padding-top:0mm;padding-bottom:0mm;border-style:solid;border-color:black;border-width:0px 1px 0px 0px;">
								<div class="styGenericDiv" style="padding-left:.5mm;">Firm's address 
									<img src="{$ImagePath}/1065B_Bullet_Md.gif" alt="MediumBullet"/>
								</div>
								<div class="styGenericDiv" style="padding-left:.5mm;padding-bottom:0mm;">
								<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
									<xsl:with-param name="TargetNode">AddressLine1Txt</xsl:with-param>
								</xsl:call-template>
								<br/>
							...
							<div class="styLNDesc" style="width:33mm;padding-top:0mm;padding-bottom:0mm;padding-left:.5mm;"> Phone no. 
                            <xsl:call-template name="PopulateReturnHeaderPreparer">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2017)
                    </div>
					</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2017)<span style="width:148mm;"/>
						</div>
					...
					<!--Dotted Line-->
      				...
      				<!--Dotted Line-->
						...
						<div style="width:187mm;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/OtherIncomeLossAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">5</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;">5</div>
						...
						<div style="width:187mm;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/CharitableContributionAmt">
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;padding-top:1mm;">9</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="styLNLeftNumBox" style="padding-left: 2.25mm;">9</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:138mm;height:4.5mm;">
								<span style="float:left;clear:none;">Deductible amount. Multiply line 10a by 30% (0.30)</span>
						<!--Dotted Line-->
								<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.................</span> 
							</div>
						...
						<div style="width:187mm;">
							<xsl:choose>
								<xsl:when test="$Form1065BData/PartIIOtherDeductionsAmt">
									<div class="styLNLeftNumBox" style="padding-top:1mm;">11</div>
								</xsl:when>
								<xsl:otherwise>
		  ...
		  What type of entity is filing this return? Check the applicable box:
						...
						<div style="width:187mm">
						<div class="styLNLeftLtrBox" style="padding-left:4.5mm;padding-top:2mm;">a</div>
        ...
        Domestic limited partnership
					...
					<div style="width:187mm">
						<div class="styLNLeftLtrBox" style="padding-left:4.5mm;padding-top:2mm;">c</div>
						<div class="styLNDesc" style="width:65mm">
							<input class="styCkBox" type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
        ...
        Domestic limited liability partnership
					...
					<div style="width:187mm,padding-bottom:2mm;">
						<div class="styLNLeftLtrBox" style="padding-left:4.5mm;padding-top:2mm;">e</div>
						<div class="styLNDesc" style="width:65mm">
							<input class="styCkBox" type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
								...
								During the partnership's tax year, did the partnership own any interest in another partnership or in any foreign entity that was<br/>
								 disregarded as an entity separate from its owner under Regulations sections 301.7701-2 and 301.7701-3?  If "Yes", see<br/>
								  instructions for required attachment
 									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="($Form1065BData)/IRS1065BScheduleB/IntPrtshpUndReg301_7701_2_3Ind"/>
									</xsl:call-template>
...
and 8813. (See instructions.)
						...
						<div style="width:187mm">
							...
							<div class="styLNDesc" style="width:167mm">At any time during calendar year 2017, did the partnership have an interest in or a signature 
										...
										account)? See instructions for<br/> exceptions and filing requirements for FinCEN form 114, Report of Foreign Bank and
										Financial 	Accounts (FBAR).<br/> If "Yes," enter the name of the foreign country.   
                            <span style="width:1mm;"/>
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleB/ForeignFinancialAccountInd"/>
								</xsl:call-template>
								<span style="width:1mm;"/>
								<img src="{$ImagePath}/1065B_Bullet_Sm.gif" alt="SmallBullet"/>
									...
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleB/ForeignFinancialAccountInd/@foreignCountryNm"/>
									</xsl:call-template>
								</span>
							</div>
						...
						<div style="width:187mm;">
							<xsl:choose>
								<xsl:when test="$Form1065BScheduleB/Form8865Cnt">
    ...
    to this return.
							...
							<div class="styIRS1065BLNYesNoBox" style="height:8mm;background:lightgrey;">
							</div>
							<div class="styIRS1065BLNYesNoBox" style="height:8mm;border-left-width:0mm;background:lightgrey;">
							</div>
						</div>
						<div class="styBB" style="width:187mm">
						...
						<!--Dotted Line-->
							...
							<div class="styIRS1065BLNYesNoBox" style="height:7.5mm;border-bottom-width:0mm;padding-top:3.5mm;">
								<xsl:call-template name="PopulateYesBoxText">
									<xsl:with-param name="TargetNode" select="$Form1065BScheduleB/RequiredToFileForms1042Ind"/>
								</xsl:call-template>
							</div>
							<div class="styIRS1065BLNYesNoBox" style="height:7.5mm;border-bottom-width:0mm;padding-top:3.5mm;">
								<xsl:call-template name="PopulateNoBoxText">
					...
					<div  style="width:187mm;">
                        ...
                        <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2017)
                    </div>
					</div>
					<p style="page-break-before: always"/> 
					<!-- END Page Break and Footer-->
					...
					<div class="styBB" style="width:187mm;overflow-y:visible">
						<!-- BEGIN PART I TABLE -->
								<div class="" style="width:187mm">
									<div class="styLNDesc" style="height:17mm;width:57mm;font-weight:normal;text-align:left;">
											See instructions for how to figure the amounts to enter on the lines below.<br/> <br/>This form may be easier to  complete if you round off cents to whole dollars.</div>
                        ...
                        <!--Dotted Line-->
						    ...
						    <!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="padding-bottom:0mm;width:30.8mm;border-bottom-width:0;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/NetSTCapitalGainOrLossAmt"/>
									</xsl:call-template>
								</div>
							</div>
						</div>
						...
						<!--Dotted Line-->
								...
								<div class="styLNAmountBox" style="width:30.8mm;padding-bottom:0mm;border-bottom-width:0">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleD/NetLTCapitalGainOrLossAmt"/>
									</xsl:call-template>
								</div>
							</div>
						</div>
      ...
      Form
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2017)
					...
					<div style="width:187mm;float:left;">
						<xsl:choose>
                            <xsl:when test="$Form1065BData/IRS1065BScheduleK/GeneralBusinessCreditAmt">
                                <div class="styLNLeftNumBox" style="height:4mm;width:6mm;padding-top:1mm;padding-left:0mm;">10</div>
                            </xsl:when>
                            <xsl:otherwise>
					...
					<div style="width:187mm;float:left;">
						<xsl:choose>
                            <xsl:when test="$Form1065BData/IRS1065BScheduleK/LowIncomeHousingCreditAmt">
                                <div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;width:6mm;padding-left:0mm;">11</div>
                            </xsl:when>
                            <xsl:otherwise>
					...
					<div style="width:187mm;float:left;">
						<xsl:choose>
                            <xsl:when test="$Form1065BData/IRS1065BScheduleK/RehabilitationCreditAmt">
                                <div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;width:6mm;padding-left:0mm;">12</div>
                            </xsl:when>
                            <xsl:otherwise>
                    ...
                    <!--(attach Form 3468)-->
							<span class="styItalicText"> (attach Form 3468, if applicable)</span>
								<xsl:call-template name="SetFormLinkInline">
					...
					<!--Line 14-->
					<div style="width:187mm;float:left;">
						<div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;width:6mm;padding-left:0mm;">14a</div>
						<div class="styLNDesc" style="width:142.1mm;height:4mm;">
        Name of foreign country or U.S. possession
                        <xsl:call-template name="SetFormLinkInline">
								...
								<span style="width:1mm;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">SchK Line 14(a) - Foreign Regulated Investment Comp Code</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleK/ForeignTransactionsSchKDetail/ForeignRegulatedInvestmtCompCd"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styLNRightNumBox" style="height:4.5mm;width:8.3mm;background-color:lightgrey;border-bottom-width:0px;border-right-width:1px;"/>
					...
					<div style="width:187mm;float:left;">
						<div class="styLNLeftLtrBox" style="height:4.5mm;width:6mm;padding-top:1.3mm;">g</div>
						<div class="styLNDesc" style="width:142.1mm;height:4.5mm;">Total foreign taxes (check one):
                        <xsl:call-template name="SetFormLinkInline">
        ...
        Paid
         ...
         Accrued   
					...
					<div style="width:187mm;float:left;">
						<xsl:choose>
                            <xsl:when test="$Form1065BData/IRS1065BScheduleK/ForeignTransactionsSchKDetail/ReductionInTaxesAvlblForCrAmt">
                                <div class="styLNLeftLtrBox" style="height:4.5mm;width:6mm;padding-top:1mm;">h</div>
                            </xsl:when>
                            <xsl:otherwise>
								<div class="styLNLeftLtrBox" style="height:4.5mm;width:6mm;">h</div>
                            </xsl:otherwise>
                        </xsl:choose>
						<div class="styLNDesc" style="width:142.1mm;height:4.5mm;">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2017)
					...
					<!--Dotted Line-->
						...
						<div class="styLNAmountBox" style="padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/NetTradeNotesAcctRcvblBOYAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
						...
						<div class="styLNAmountBox" style="padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/NetTradeNotesAcctRcvblEOYAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
					...
					<!--Dotted Line-->
						...
						<div class="styLNAmountBox" style="height:6.5mm;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/ShortTermPayableBOYAmt"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="height:6.5mm;"/>
						<div class="styLNAmountBox" style="height:6.5mm;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/ShortTermPayableEOYAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!--Line 17-->
				    ...
				    <!--Dotted Line-->
						...
						<div class="styLNAmountBox" style="height:6.5mm;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/LongTermPayableBOYAmt"/>
							</xsl:call-template>
						</div>
						<div class="styShadingCell" style="height:6.5mm;"/>
						<div class="styLNAmountBox" style="height:6.5mm;padding-top:3mm;padding-bottom:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1065BScheduleL/LongTermPayableEOYAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
						...
						<table class="styTable" style="height:59mm;font-size:7pt;width:93.5mm;float:left;" cellspacing="0">
							...
							<tbody>
							   ...
							   <!--Dotted Line-->
								...
								<tr>
									<td class="styLNLeftLtrBox" style="width:4mm;padding-left:3.5mm;padding-bottom:0mm;padding-top:1mm;">a</td>
									<td class="styLNDesc" style="width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
								...
								<tr>
									<td class="styLNLeftLtrBox" style="width:4mm;padding-left:3.5mm;padding-bottom:0mm;padding-top:1mm;">b</td>
									<td class="styLNDesc" style="width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
						...
						<table class="styTable" style="height:50mm;width:93.5mm;font-size:7pt;float:left;" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styLNDesc" style="height:11mm;width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px">
						...
						<table class="styTable" style="width:93.5mm;font-size:7pt;float:left;" cellspacing="0">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									<td class="styLNLeftNumBoxSD" style="width:4mm;padding-bottom:0mm;padding-top:1mm;">2</td>
									<td class="styLNDesc" style="width:57mm;" colspan="2">
										<div class="styLNDesc" style="width:30mm;font-size:7pt;padding-left:4mm;">
											Capital Contributed:
										</div>
								...
								<tr class="styGenericDiv">
									<xsl:choose>
										<xsl:when test="$Form1065BScheduleM2/TotalOtherIncreasesAmt">
											<td class="styLNLeftNumBoxSD" style="width:4mm;padding-top:1.5mm;padding-bottom:0mm;">4</td>
										</xsl:when>
										<xsl:otherwise>
											<td class="styLNLeftNumBoxSD" style="width:4mm;padding-top:1mm;padding-bottom:0mm;">4</td>
										</xsl:otherwise>
									</xsl:choose>
						...
						<table class="styTable" style="width:93.5mm;float:left;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								<tr class="styGenericDiv">
									<td class="styLNLeftNumBoxSD" style="width:4mm;padding-bottom:0mm;padding-top:1mm;">6</td>
									<td class="styLNDesc" style="width:57mm;padding-bottom:0mm;" colspan="2">
								...
								<tr class="styGenericDiv">
									<xsl:choose>
										<xsl:when test="$Form1065BScheduleM2/TotalOtherDecreasesAmt">
											<td class="styLNLeftNumBoxSD" style="height:8mm;width:4mm;padding-top:6mm;padding-bottom:0mm;">7</td>
										</xsl:when>
										<xsl:otherwise>
											<td class="styLNLeftNumBoxSD" style="height:8mm;width:4mm;padding-top:5.5mm;padding-bottom:0mm;">7</td>
										</xsl:otherwise>
									</xsl:choose>
								...
								<tr class="styGenericDiv">
									<td class="styLNLeftNumBoxSD" style="height:6.5mm;width:4mm;vertical-align:top;padding-bottom:0mm;">9</td>
              ...
              Form 1065-B, Top Left Margin - IRC 6114:
						...
						<xsl:if test="$Form1065BData/TaxesAmt/@form8697Amt">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$Form1065BData/TaxesAmt/@form8697Amt"/>
											<xsl:with-param name="BackupName">Form 8697 Amount</xsl:with-param>
										</xsl:call-template>
											Form 1065-B, Top Left Margin - Form 8697 Amount:
                                </label>
								</td>
								<td class="styLeftOverTableRowAmount" style="width:87mm;">
									<xsl:call-template name="PopulateAmount">
						...
						<xsl:if test="$Form1065BData/TaxesAmt/@form8866Amt">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$Form1065BData/TaxesAmt/@form8866Amt"/>
											<xsl:with-param name="BackupName">Form 8866 Amount</xsl:with-param>
										</xsl:call-template>
											Form 1065-B, Top Left Margin - Form 8866 Amount:
                                </label>
								</td>
								<td class="styLeftOverTableRowAmount" style="width:87mm;">
									<xsl:call-template name="PopulateAmount">
						...
						<xsl:if test="$Form1065BData/MethodOfAccountingOtherInd/@methodOfAccountingOtherDesc">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$Form1065BData/MethodOfAccountingOtherInd/@methodOfAccountingOtherDesc"/>
											<xsl:with-param name="BackupName">Method Of Accounting Other Ind</xsl:with-param>
										</xsl:call-template>
											H(3) - Other (specify) :
                                </label>
								</td>
						...
						<xsl:if test="$Form1065BData/TotalOrdinaryGainLossAmt/@form4684Cd">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:100mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$Form1065BData/TotalOrdinaryGainLossAmt/@form4684Cd"/>
											<xsl:with-param name="BackupName">Form 4684 Code</xsl:with-param>
										</xsl:call-template>
											Part I  Line 9 - Form 4684 Code:
                                </label>
								</td>
								<td class="styLeftOverTableRowAmount" style="width:87mm;">
									<xsl:call-template name="PopulateText">
						...
						<xsl:if test="$Form1065BData/IRS1065BScheduleK/ForeignTransactionsSchKDetail/ForeignRegulatedInvestmtCompCd">
							<tr>
								<td class="styLeftOverTableRowDesc" style="width:110mm;" scope="row">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$Form1065BData/IRS1065BScheduleK/ForeignTransactionsSchKDetail/ForeignRegulatedInvestmtCompCd"/>
											<xsl:with-param name="BackupName">Foreign Regulated Investment Comp Code</xsl:with-param>
										</xsl:call-template>
										SchK Line 14(a) - Foreign Regulated Investment Comp Code:
                                </label>
								</td>
								<td class="styLeftOverTableRowAmount" style="width:87mm;">
									<xsl:call-template name="PopulateText">

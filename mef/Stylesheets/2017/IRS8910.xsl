				...
				<form name="Form8910">
					...
					<div class="styBB" style="width:187mm;height: 20.5mm">
						...
						<div class="styTYBox" style="width:30mm;height:20mm; border-left-width:1px;">
							...
							<div class="styTY" style="height:9mm">20<span class="styTYColor">17</span>
							</div>
				...
				<xsl:when test="$RtnHdrData/Filer/NationalMortgageAssocCd">
				  ...
				  <br/>
					...
					<div style="width: 187mm">
						...
						<span style="width: 1mm"/>Use this form to claim the credit for certain alternative motor vehicles acquired in 2016 but not 
						placed in service until 2017 (see instructions).
					</div>
							...
							<!--print logic for the table that remains empty if separated (repeating) data appears at the bottom of form-->
								...
								<!--  Line 1   -->
									<tr>
										...
										<td class="styTableCell" style="width:84mm;padding-left:2mm;text-align:left; border:none;border-top:1px solid black;padding-top:6mm;">
										...
										<tr>
											...
											<td class="styTableCell" style="border:1px solid black;border-right:0;width:49mm;border-top:0;">
												...
												<tr>
													...
													<td class="styLNRightNumBox" style="width:8mm;">6</td>
													<td class="styTableCell" style="border:1px solid black;width:46.3mm; border-right:0;border-top:0;">
														<span class="styTableCellPad"/>
													</td>
													<td class="styTableCell" style="border:1px solid black;width:50mm;border-right:0;border-top:0;">
														<span class="styTableCellPad"/>
						...
						<table class="styTable" cellspacing="0" style="font-size: 7pt;">
							...
							<tbody>
								...
								<tr style="width:187mm;">
									...
									<td class="styTableCell" style="width: 126.5mm;padding-left:2mm;text-align:left;border:none;">
								...
								<tr style="width:187mm;">
									...
									<td class="styTableCell" style="width: 124.5mm;padding-left:2mm;text-align:left;border:none;">
						...
						<table class="styTable" cellspacing="0" style="font-size: 7pt;">
							...
							<tbody>
								...
								<tr style="width:187mm;">
									...
									<td class="styTableCell" style="width: 124.5mm;padding-left:2mm;text-align:left;border:none;border-bottom:1px solid black;">
					...
					<div style="width:187mm;">
						...
						<span style="width:80px;"/>Form <span class="styBoldText">8910</span> (2017)
					</div>
					<br/>
					<div class="pageEnd"/>

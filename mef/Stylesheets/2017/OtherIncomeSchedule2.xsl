...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherIncomeSchedule2"/>
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl" style="font-size: 7pt">
      ...
      <tr class="styDepTblHdr">         
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/OtherIncomeDetail">
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:right; width: 30mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="RevenueAndExpensesPerBooksAmt"/>
            </xsl:call-template>
          </td>        
           <td class="styDepTblCell" style="text-align:right; width: 30mm">
            <xsl:call-template name="PopulateAmount">
  ...
  <!-- NameDisplay - IRS990PF - Other Income Schedule -->

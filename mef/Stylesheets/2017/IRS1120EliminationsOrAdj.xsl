	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass" style="width:187mm;">
              ...
              Form <span class="styFormNumber">1120</span>
                ...
                Form 1120, Top Left Margin - Section 1291 Interest Indicator</xsl:with-param>
                ...
                Form 1120, Top Left Margin - Section 1294 Interest Amount</xsl:with-param>
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">
                Form 1120, Top Left Margin - Subchapter T Cooperative Indicator</xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form1120Data/@subchapterTCoopIndicator"/>
								<xsl:with-param name="Style">padding-left:12mm;</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">
                Form 1120, Top left margin - Support Statement to Consolidated Return Indicator</xsl:with-param>
                ...
                Form 1120, Top left margin - FILED PURSUANT TO SECTION 301.9100-2</xsl:with-param>
							...
							<!-- can not find the open tag but if delete then code not working.../-->
						</div>
					...
					<div class="styBB" style="width:187mm;float:left;clear:left;border-bottom-width:1px;">
						<div style="width:33mm;height:40mm;float:left;clear:left;
						padding-bottom:1mm;border-right:1px solid black;">
							...
							<!-- 11/25/2014 CJ: In the paper 1120 form, if the check box for Consolidated Return is 
                                     ...
                                     a checkbox for the Consolidated Return checkbox whereas schema contained a choice
                                     for Consolidated, Parent and Subsidiary.  Per version Tree TY2008 directory, IBM 
                                     modified the Style Sheet code from just a Consolidated return checkbox to one 
                                     eckbox(Consolidated) and two pen and ink for (Parent and Subsidiary) and in the 
                                     additional data section to show an “X” for checkbox type for pen and ink data per the 
                                     business request.  This to allow RRD/HD to have a choice to display Consolidated,
                                     Parent and Subsidiary information separately on screen and to allow form 1120L and 
                                     1120PC filing to be a part of 1120 form family instead of a standalone forms. -->
						...
						<div style="width:154mm;height:29mm;float:left;">
							...
							<div class="styLblNameAddr" style="width:106mm;height:auto;">
								<div class="styUseLbl" style="width:12mm;border-right-width:0px;
								padding-top:40px;font-size: 7pt;">TYPE OR PRINT </div>
							...
							<div style="width:146mm; height:auto;vertical-align:top;">
								...
								style="width:4px;padding-left:2mm;vertical-align:top;padding-top:1px;">E </span>
								...
								<span class="styBoldText" 
								style="padding-left:2mm;vertical-align:top;padding-right:1mm;padding-top:1px;">(1)</span>
								...
								<span class="styBoldText" 
								style="padding-left:2mm;vertical-align:top;padding-right:1mm;padding-top:1px;">(2)</span>
								...
								<span class="styBoldText" 
								style="padding-left:2mm;vertical-align:top;padding-right:1mm;padding-top:1px;">(3)</span>
								...
								<!--NOTE: THIS NAME CHANGE CHECK BOX EXISTED ON 1120 NOT 1120E&A-->
								<span class="styBoldText" 
								style="padding-left:2mm;vertical-align:top;padding-right:1mm;padding-top:1px;">(4)</span>
								...
								<span class="styBoldText" style="padding-left:20mm;vertical-align:top;padding-right:1mm;">
								(5)</span>
					...
					<div class="styBB" style="width:187mm;float:none;clear:none;">
						...
						style="width:6mm;height:59mm;padding-top:23mm;text-align:center;">
							<img src="{$ImagePath}/1120_Income.gif" 
							alt="Vertical Image - Income" valign="center" height="40mm;"/>
						</div>
						<!-- line 1a -->
					...
					<!-- Form to Form Link -->
							...
							<div style="float:right;clear:none">
								...
								style="height:5mm;background-color:lightgrey;border-right-width:1px;border-bottom-width:0px;"/>
								<div class="styLNAmountBox" style="height:5mm;;border-left-width:0px;border-bottom-width:0px;"/>
							</div>
						</div>
						<!-- line 1b -->
						<div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="width:2px;"/>
			      ...
			      Depreciation from Form 4562 not claimed on Form 1125&#8208;A 
			      or elsewhere on return (attach Form 4562)
                  <xsl:call-template name="SetFormLinkInline">
				    ...
				    Add lines 12 through 26 
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" 
								style="width:132mm;padding-top:1mm;padding-bottom:0mm;font-size:6.5pt;">
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:21mm;height:4mm;font-size:6pt;">
									<span class="styBoldText" style="height:4mm;padding-left:2mm;
				  border-style: solid; border-color: black;border-top-width: 0px; 
				  border-bottom-width: 0px; border-left-width: 1px; border-right-width: 0px;">
				  Refunded</span>
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode"
					...
					style="width:187mm;height:25mm;font-size:6pt;border-bottom:1px solid black;">
						<tr>
							<td rowspan="3" style="width:10mm;font-size: 11pt;font-weight:bold;border-right:1px solid black;">
							Sign Here</td>
							<td colspan="6" style="padding-left:1mm;padding-bottom:1mm;">Under penalties of perjury, I 
							declare that I have examined this return, including accompanying schedules and statements,
							 and to the best of my knowledge and belief, it is true, correct, and complete. Declaration of
							  preparer (other than taxpayer) is based on all information of which preparer has any 
							  knowledge. 
							  </td>
						</tr>
						<tr>
							...
							<td rowspan="2" style="width:40mm;border-bottom:0px solid black;padding-bottom:1mm;">
									...
									<span class="styBoldText">
										<label for="dummyidyes">
											<xsl:call-template name="PopulateReturnHeaderOfficer">
												...
												<xsl:with-param 
												name="BackupName">
												May the IRS discuss this return with the preparer shown below? Yes
												</xsl:with-param>
											</xsl:call-template>
											Yes
											</label>
					...
					<div class="styBB" style="width:187mm;font-size:6pt;border-bottom-width:2px">
						...
						<div style="width:164mm;float:left;clear:none;">
							<div style="width:164mm;float:left;clear:none;">
								<div class="styLNDesc" style="height:8mm;width:46.5mm;
								padding-top:0mm;border-right:1px solid black;border-left:1px solid black;padding-left:1mm;">
								...
								<div class="styLNDesc" style="height:8mm;width:15mm;
								border-right:1px solid black;padding-top:0mm;padding-left:1mm;">Date <br/>
									<br/>
								...
								<div class="styLNDesc" style="height:8mm;width:18mm;border-right:1px solid 
								...
								<div class="styLNDesc" style="height:6mm;width:26mm;padding-top:0mm;
								padding-left:1mm;">PTIN
                                 <br/>
									<br/>
							...
							<div style="width:164mm;float:left;clear:none;border-bottom:1px solid black;
							border-left:1px solid black;border-top:1px solid black;">
								<div class="styLNDesc" style="height:7mm;width:125.7mm;
								border-right:1px solid black;padding-left:1mm;">
								...
								<div class="styLNDesc" style="height:7mm;width:32mm;padding-left:1mm;">Firm's EIN
									...
									<xsl:if test="$RtnHdrData/PreparerFirmGrp/MissingEINReasonCd">
										<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
											...
											<xsl:with-param name="BackupName">
											$RtnHdrDataPreparerPersonGrpFirmGrpMissingEINReasonCd</xsl:with-param>
										</xsl:call-template>
									</xsl:if>
								</div>
							</div>
							<div style="width:164mm;float:left;clear:none;">
								<div class="styLNDesc" style="width:126mm;border-right:1px solid black;
								...
								<div class="styLNDesc" style="width:32mm;padding-left:1mm;"> Phone no. 
 								<xsl:call-template name="PopulateReturnHeaderPreparer">
									...
									<xsl:call-template name="PopulateReturnHeaderPreparer">
										...
										<xsl:with-param name="BackupName">
										$RtnHdrDataPreparerPersonGrpForeignPhoneNum</xsl:with-param>
									</xsl:call-template>
								</div>
							</div>
						</div>
					...
					<table class="styTable" style="font-size:7pt;border-bottom:1px solid
					 black;width:187mm;padding-top:0mm;" cellspacing="0">
						<thead>
							<tr scope="col">
						...
						<tbody valign="top">
							...
							<tr>
								...
								style="height:8mm;padding-top:1.5mm;font-size:6pt;">see instructions</td>
								<td class="styLNAmountBox" style="width:40mm;height:8mm;padding-top:4.5mm;">
							...
							<tr>
								...
								<td class="styLNDesc" style="width:85mm;height:8mm;">
								Dividends from less&#8208;than&#8208;20%&#8208;
								owned foreign corporations and <span style="float:left;">certain FSCs </span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
								</td>
								<td class="styLNAmountBox" style="width:40mm;height:8mm;padding-top:4.5mm;">
							...
							<tr>
								...
								style="width:40mm;height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
								...
								<td class="styIRS1120LNPercentBox" 
								style="height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">100</td>
								<td class="styLNAmountBox"
								 style="width:40mm;height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
          ...
          Part I  Tax Computation
                  ...
                  <!-- Form to Form Link -->
								...
								<div style="float:right;clear:none;text-align:right;">
									...
									<span style="float:right;">
										...
										<span style="width:4mm;">
											<input type="checkbox" 
											alt="IRS1120ScheduleJQualifiedPersonalServiceCorp" class="styCkbox">
												...
												<!--NOTE: ELEMENT NAME FOR THIS CHECK BOX IS DIFFERENT 
                                                  FROM 1120E&A -->
											</input>
											<label>
												<xsl:call-template name="PopulateLabel">
                ...
                <xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc">
								<span style="float:left;">
									<span class="styBoldText">Total credits.</span> Add lines 5a through 5e </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">.....................</div>
							</div>
						</div>
				  ...
				  <span style="float:left;">
					...
					<div class="styBB" style="width:187mm;clear:both;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc">
								<span style="float:left;">
									<span class="styBoldText">Total tax.
					</span> Add lines 7, 8, and 10. Enter here and on page 1, line 31
				  </span>
								<span style="width:1mm;"/>
								<!-- Form to Form Link -->
								<xsl:call-template name="SetFormLinkInline">
              ...
              Part II  Payments and Refundable Credits 
					...
					<div style="width:187mm;clear:both;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc">
								<span style="float:left;">
				    2016 overpayment credited to 2017					
			        <span style="width:2px;"/>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
			        ...
			        <span style="width:2px;"/>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">
					  Line 13 - Beneficiary Of Trust Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode"
										 select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@beneficiaryTrustCd"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">
		                           			  Line 13 - Beneficiary Of Trust Amount</xsl:with-param>
										<xsl:with-param name="TargetNode" 
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">
		                    			  Line 13 - Form 8816 Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" 
              ...
              <span class="styNormalText"> (see instructions)</span>
                  ...
                  Other (specify)
                  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="width:56mm;border-bottom:1px solid black;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="   
											$Form1120ScheduleK/MethodOfAccountingOtherInd/@methodOfAccountingOtherDesc"/>
										</xsl:call-template>
									</span>
								</span>
							</label>
                ...
                <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" 
						style="width:167mm;height:4.5mm;padding-top:1.5mm;">At the end of the tax year: </div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
					</div>
					<!-- Schedule K, Line 4a -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;height:9mm;">
						    Did any foreign or domestic corporation, partnership (including any entity treated as
						     a partnership), trust, or tax&#8208;exempt organization own directly 20% or more, 
						     or own, directly or indirectly, 50% or more of the total voting power of all classes of 
						     the corporation’s stock entitled to vote? If "Yes," complete Part I of Schedule G
						      (Form 1120) (attach Schedule G)
                  <!-- Form to Form Link -->
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode"
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;height:3.5mm; ">
                                      Did any individual or estate own directly 20% or more, or own, directly or 
                                      indirectly, 50% or more of the total voting power of all classes of the
                                       corporation’s stock entitled to vote? If "Yes," complete Part II of Schedule G 
                                       (Form 1120) (attach Schedule G) 
                     <xsl:call-template name="SetFormLinkInline">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styGenericDiv">
							...
							<div class="styIRS1120LNYesNoBoxRB" style="width:6mm;height:4mm;border-right-width:0px;
							border-bottom-width:0px;padding-top:0px;">
								<span style="font-weight:normal;padding-top:1mm;">
									<xsl:call-template name="PopulateNoBoxText">
										<xsl:with-param name="TargetNode"
										 select="$Form1120ScheduleK/IndivEstTrOwnPctVtngStkInd"/>
                  ...
                  Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2017)
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" 
						style="width:167mm;height:4.5mm;">At the end of the tax year, did the corporation: </div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;border-bottom-width:1px;"/>
						<div class="styShadingCellRB" 
						style="width:6mm;height:4.5mm;border-right-width:0px;border-bottom-width:1px;"/>
					</div>
					...
					<!--Update per WR51699 for R7_DD4 
              PDF draft dated 8/9/2011-->
					<!-- BEGIN Schedule K Line 5b -->
					<div style="width:187mm;height:6.5mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;">b</div>
						<div class="styLNDesc" style="width:167mm;height:8.5mm; ">
						Own directly an interest of 20% or more, or own, directly or indirectly, an interest of 50% 
						or more in any foreign or domestic partnership
						(including an entity treated as a partnership) or in the beneficial interest 
						of a trust? For rules of constructive ownership, 
                  </div>
						<div class="styGenericDiv">
                    ...
                    Maximum Percentage Owned in Profit, Loss or Capital</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
                ...
                and ($Print = $Separated))">
                  ...
                  and ($Print = $Separated))">
                      ...
                      <xsl:call-template name="SetFormLinkInline">
						...
						<div class="styGenericDiv">
							...
							<!--<div class="styIRS1120LNYesNoBox" style="width:6mm;height:4mm;">Yes</div>
			         		<div class="styIRS1120LNYesNoBox" style="width:6mm;
                              height:4mm;border-right-width:0px;">No</div>-->
							...
							<div class="styIRS1120LNYesNoBoxRB"
							 style="height:8mm;padding-top:4mm;border-right-width:0px;border-bottom-width:1px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateNoBoxText">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleK/ExcessDividendsPaidInd"/>
									</xsl:call-template>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;"/>
						<div class="styLNDesc" style="width:167mm;height:4.5mm; ">
                    If "Yes," file <b>Form 5452,</b> Corporate Report of Nondividend Distributions. See the instructions for Form 5452.
                  </div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
						<div class="styLNDesc" style="width:175mm;height:4.5mm;padding-left:8mm;">
                    If this is a consolidated return, answer here for the parent corporation and 
                    on Form 851 for each subsidiary.
                  </div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
					</div>
			  ...
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
			    ...
			    , Information Return of a 25% Foreign&#8208;Owned U.S. Corporation or a
			     Foreign Corporation Engaged in a U.S. Trade or Business. Enter the number of
			      Forms 5472 attached
                <xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" 
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD">8</div>
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">Check this box if the corporation issued publicly 
			                     offered debt instruments with original issue discount </span>
							<!--Dotted Line-->
							...
							<input type="checkbox" alt="IRS1120ScheduleKOfferedDebtInstruments" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									...
									<xsl:with-param name="BackupName">IRS1120ScheduleKOfferedDebtInstruments
									</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
              ...
              Enter the available NOL carryover from prior tax years (do not reduce it by any deduction reported on
                  page 1, line 29a.)
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;height:4.5mm; ">
			        Are the corporation’s total receipts (page 1, line 1 a, plus lines 4 through 10)
			        ...
			        <span style="float:left;">tax year less than $250,000? </span>
						...
						<div class="styGenericDiv">
							...
							<div class="styIRS1120LNYesNoBoxRB" 
							style="padding-top:3mm;height:7mm;border-right-width:0px;border-bottom-width:1px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateNoBoxText">
										<xsl:with-param name="TargetNode"
										 select="$Form1120ScheduleK/TotalRcptsAssetsLessThanLmtInd"/>
					...
					<div style="width:187mm;">
                      ...
                      M&#8208;1, and M&#8208;2. Instead, enter the total amount of cash
							</div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
						<div class="styLNDesc" style="width:175mm;height:4.5mm;padding-left:8mm;"> 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">
					Is the corporation required to file Schedule UTP (Form 1120), Uncertain 
					Tax Position Statement? See instructions. </span>
							<!--Dotted Line-->
							<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
						</div>
						<div class="styGenericDiv">
             ...
             <!-- <xsl:call-template name="SetFormLinkInline">
	         		<xsl:with-param name="TargetNode"
                       select="$Form1120ScheduleK/UncertainTaxPositionStatement"/>
					    </xsl:call-template>-->
							</span>
						</div>
						<div class="styGenericDiv">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">Did the corporation make any payments in 2017 that 
			  would require it to file Form(s) 1099? </span>
							<!--Dotted Line-->
							<div class="styDotLn" style="float:right;padding-right:1mm;">............</div>
						</div>
						<div class="styGenericDiv">
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox">16</div>
						<div class="styLNDesc" style="width:167mm;">
						During this tax year, did the corporation have an 80% or more change 
						in ownership, including a change due to redemption of 
				  </div>
						<div class="styGenericDiv">
							<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
							<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
					...
					<div style="width:187mm;">
						...
						<!--EXCEPTION: Browser limitation when 5a and 5b contain 5+ repeating data line 16 is
                       displaying properly but print out/print preview line 16 will split and Yes and No
                        box will display 1mm of line gap -->
						<div class="styGenericDiv">
							<div class="styIRS1120LNYesNoBox" style="border-bottom-width:1px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateYesBoxText">
					...
					<div style="width:187mm;">
						...
						Did the corporation receive assets in a section 351 transfer
						 in which any of the transferred assets had a fair market basis or
				  </div>
						<div class="styGenericDiv">
							<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
							<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox">19</div>
						<div class="styLNDesc" style="width:167mm;">
						During the corporation's tax year, did the corporation make any payments 
						that would require it to file Forms 1042 and 1042-S 
				  </div>
						<div class="styGenericDiv">
							<div style="width:6mm;height:4.5mm;border-style: solid; border-color: black;
							border-top-width: 0px; border-bottom-width: 0px; border-left-width: 1px; 
							border-right-width: 0px;float: left; clear: none;"/>
							<div style="width:6mm;height:4.5mm;border-style: solid; 
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						...
						<div class="styLNAmountBox" 
						style="text-align:center;border-bottom-width:0px;width:64mm;height:8mm;">
            ...
            End of tax year</div>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;"/>
						<div class="styGenericDiv" style="width:51mm;height:4.5mm;text-align:center;font-weight:bold;"> 
						 Assets    
						</div>
              ...
              Other liabilities (attach statement)
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" 
						style="height:5.5mm;font-family:arial;font-size:8pt;border-bottom-width:1px;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:51mm;height:7mm;">
							<span>Retained earnings—Appropriated (attach statement)
							<div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
							</span>
						</div>
			  ...
			  Retained earnings—Unappropriated
					...
					<div class="styBB" 
					style="width:187mm;height:8mm;border-top-width:1px;border-top:solid black;border-top-width:1px;">
						...
						<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									style="width:51mm;height:4.5mm;" colspan="2">Expenses recorded on books this year
									 </td>
									<td class="styShadingCell" style="height:4.5mm;border-right-width:1px;">
										<span style="width:1px;"/>
									</td>
								...
								<tr>
									<td class="styLNLeftNumBoxSD" style="height:4.5mm;"/>
									<td class="styGenericDiv" 
									style="width:51mm;height:4.5mm;" colspan="2">not deducted on this return (itemize):</td>
									<td class="styShadingCell" style="height:4.5mm;border-right-width:1px;">
										<span style="width:1px;"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:51mm;height:6mm;" colspan="2">
										<div class="styGenericDiv" 
										style="width:24mm;">Charitable contributions<span style="width:1.5mm;"/>$ </div>
										<div class="styIRS1120BBText" 
										style="width:26mm;float:left;text-align:right;font-size:6pt;padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
						...
						<table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								<tr class="styGenericDiv">
									...
									<td class="styGenericDiv" style="width:54.5mm;height:4mm;padding-top:0.5mm;" colspan="2">
								...
								<tr class="styGenericDiv">
									...
									not included on this return (itemize):</td>
									<td class="styShadingCell" style="height:4mm;">
										<span style="width:1px;"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:54mm;height:4.5mm;" colspan="2">
										<div class="styGenericDiv" style="width:21mm;padding-top:0.7mm;">
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:54mm;height:4.5mm;" colspan="2">
										...
										<div class="styIRS1120BBText" 
										style="width:29.5mm;height:6.5mm;float:left;text-align:right;padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
					...
					<div style="width:187mm;clear:both;" class="styBB">
						...
						<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tr class="styGenericDiv" style="height:4mm;">
								...
								<td class="styGenericDiv" style="width:51mm;height:4.5mm;padding-right:2mm;" colspan="2">
									<div class="styIRS1120BBText" 
									style="width:50.5mm;text-align:right;height:4mm;padding-right:3mm;">
									</div>
								</td>
						...
						<table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNAmountBox" style="height:4.5mm;vertical-align:bottom;border-bottom-width: 1px">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$Form1120ScheduleM2/TotalOtherDecreasesAmt"/>
									</xsl:call-template>
        ...
        Additional Data        
              ...
              Form 1120, Top Left Margin - FILED PURSUANT TO SECTION 301.9100-2</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Top Left Margin - Short Period Reason 1120 1120F Ind</xsl:with-param>
              ...
              Form 1120, Top Left Margin - Support Statement to Consolidated Return Indicator</xsl:with-param>
						...
						<!-- not display -->
						<!--11/25/2015 CJ: The customer (Wallace Kendell E) approved for the exception. 
                              The new template (LinkToLeftoverCheckboxDataTableInline) is created for a Pen 
                               and ink to display yes and no instead of “x”. -->
						<xsl:choose>
						...
						<!-- not display -->
						<!--11/25/2015 CJ: The customer (Wallace Kendell E) approved for the exception. 
                              The new template (LinkToLeftoverCheckboxDataTableInline) is created for 
                               a Pen and ink to display yes and no instead of “x”. -->
						<xsl:choose>
							<xsl:when test="$Form1120Data/SubsidiaryReturnInd = 'X'">
								<tr>
									<td class="styLeftOverTableRowDesc" 
									style="width:100mm;" scope="row">Form 1120, Section A, Line 1a - Is Subsidiary Return:
									</td>
									<td class="styLeftOverTableRowAmount" style="width:100mm;">Yes</td>
								</tr>
							</xsl:when>
              ...
              Form 1120, Page 1, Line 10 - Other Income Item</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 30 - CCF Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/TaxableIncomeAmt/@capitalConstructionFundCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 30 - CCF Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/TaxableIncomeAmt/@capitalConstructionFundAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32b - Beneficiary Of Trust Indicator
              </xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/EstimatedTaxPaymentsAmt/@beneficiaryTrustCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32b - Beneficiary Of Trust Amount
              </xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/EstimatedTaxPaymentsAmt/@beneficiaryTrustAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32b - Form 8816 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/EstimatedTaxPaymentsAmt/@form8816Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32b - Form 8816 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/EstimatedTaxPaymentsAmt/@form8816Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32b - Section 847 Deduction Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/EstimatedTaxPaymentsAmt/@section847DeductionCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32f - Other Refundable Credits Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
              ...
              Form 1120, Page 1, Line 32f - Other Refundable Credits Amount</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32f(2) - Ozone Depleting Chemicals Indicator
              </xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120Data/TotalFuelTaxCreditAmt/@ozoneDepletingChemicalCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32h - Backup Withholding Indicator
              </xsl:with-param>
							<xsl:with-param name="TargetNode" 
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Page 1, Line 32h - Backup Withholding Amount
              </xsl:with-param>
							<xsl:with-param name="TargetNode" 
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J, Line 2 - Section 1291 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J Line 2 - Section 1291 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J Line 2 - Section 197 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J Line 2 - Section 197 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J, Line 5b - Form 5735 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/QlfyElecMotorVehCrAmt/@form5735Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
              Form 1120, Schedule J, Line 5b - Form 5735 Amount </xsl:with-param>
							<xsl:with-param name="TargetNode"
							 select="$Form1120ScheduleJ/QlfyElecMotorVehCrAmt/@form5735Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part I, Line 9a - Section 1260B Indicator
			  </xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/TotalIncreaseInTaxAmt/@section1260BCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part I, Line 9a - Section 1260B Amount
			  </xsl:with-param>
							<xsl:with-param name="TargetNode"
							 select="$Form1120ScheduleJ/TotalIncreaseInTaxAmt/@section1260BAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part I, Line 9b - Form 8693 Approved
			   Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/RecaptureTaxAmt/@form8693ApprovedCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part I, Line 9b - Form 8693
			   Approval Date</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/RecaptureTaxAmt/@form8693ApprovedDt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part II, Line 13 - Beneficiary Of Trust Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@beneficiaryTrustCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part II, Line 13 - Beneficiary Of Trust Amount</xsl:with-param>
							<xsl:with-param name="TargetNode"
							 select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@beneficiaryTrustAmt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
			  ...
			  Form 1120, Page 2, Schedule J, Part II, Line 13 - Form 8816 Indicator</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part II, Line 13 - Form 8816 Amount
			  </xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@form8816Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
			  Form 1120, Page 2, Schedule J, Part II, Line 13 - Section 847 Deduction Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" 
							select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@section847DeductionCd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
			  ...
			  Form 1120, Page 2, Schedule J, Part II, Line 19b - Ozone Depleting Chemicals IndIndicator
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
              Form 1120, Schedule K Line 3 - Parent Corporation Name Control
              </xsl:with-param>
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									style="width:40mm;">Percent of corporation stock owned</th>
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:20mm;">
										<span 
										style="font-weight:bold;">(iv)</span> Maximum Percentage Owned in Profit, Loss, or Capital 
                    </th>
								</tr>
							</thead>
							<tfoot/>

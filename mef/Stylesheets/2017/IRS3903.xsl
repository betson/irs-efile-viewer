...
<!-- Last Modified by Eugenia McDonald on 08/08/2017 -->
		...
		<html>
			...
			<body class="styBodyClass">
				<form name="Form3903">
					...
					<div class="styBB" style="width:187mm;height:11mm;font-size:8pt">
						<div style="height:11mm;width:30mm;float:left;font-weight:bold;padding top:1mm"><i>Before you begin:</i></div>
						<div style="height:6mm;width:156mm;padding-top:.0mm;padding-bottom:0mm;padding-left:2mm">
							<img src="{$ImagePath}/3903_checkmark.gif" width="11" height="10" alt="checkmark image"/> See the <b>
							 Distance Test</b> and <b>Time Test</b> in the instructions to find out if you can deduct your moving <br/>
							 <span style="width:3.5mm"/>expenses.</div>
						<div style="height:5mm;width:156mm;padding-left:2mm;padding-top:1mm"><img src="{$ImagePath}/3903_checkmark.gif"
						  width="11" height="10" alt="checkmark image"/> See <b>Members of the Armed Forces</b> in the instructions, if applicable.</div>
					</div>
					...
					<div style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">3903</b> (2017)
						</div>
					</div>

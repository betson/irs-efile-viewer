				...
				<!-- ******************************************************************************************************* -->	
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:30mm;height:21mm;">
							...
							<div class="styTY" style="height:15mm;padding-top:4mm;">20<span class="styTYColor">17</span>
							</div>
						</div>
					</div>
					<!-- Header Line A 1 -->
...
<!-- Form to Form Link -->
  ...
  Please<br/> print<br/> or<br/> type</div>
							<div class="styNameAddr" style="width:92.5mm;height:13mm;border-left-width:1px;padding-left:2mm;">
Name<br/>
...
<span style="width:2px;"/>
 ...
 <span style="width:2px;"/>
   ...
   2017 special estimated tax payments<i> (Do not include on line 29f)</i>
							</div>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:56mm;">
								<span style="float: left; clear: none;">Less 2017 refund applied for on 
    Form 4466</span>
							</div>
...
<xsl:call-template name="PopulateAmount">
							...
							<div class="styLNAmountBox" style="width:32.3mm;height:8mm;border-right-width:1px;padding-top:3.5mm">
								<xsl:call-template name="PopulateAmount">
...
<xsl:call-template name="SetFormLinkInline">
							...
							<div class="styLNRightNumBox" style="height:5mm;padding-top:1mm">29j</div>
							<div class="styLNAmountBox" style="height:5mm;padding-top:1mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="  $Form1120LData/RefundableCreditsAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNRightNumBoxNBB" style="height:5mm;border-bottom-width:1px;padding-top:1mm">29k</div>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm;height:4.5mm;">
								<span style="float: left; clear: none;">
									<b>Amount owed.</b>If line 29k is smaller than the total of lines 28 and 30, enter amount owed
								 </span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">...</span>
							</div>
 ...
 If line 29k is larger than the total of lines 28 and 30, enter amount overpaid</span>
							...
							<div class="styLNRightNumBox" style="height:4.5mm;padding-right:1mm">32</div>
							<div class="styLNAmountBox" style="height:4.5mm;width:32.9mm">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNRightNumBoxNBB" style="height:4.5mm;padding-right:1mm">33</div>
...
<input class="styCkbox" alt="May IRS Discuss Return With Prep Yes" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
 ...
 Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2017)
</div>
					</div>
					<!--div class="pageEnd" /-->
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-L (2017)<span style="width:148mm;"/>
						</div>
...
<xsl:with-param name="TargetNode" select="$IRS1120LScheduleB/IncrPolicyCashValueSect264f"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="height:4mm;"> and include on Schedule F, line 13
							<span class="styDotLn" style="float:right;padding-right:2mm;">......................</span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						<xsl:choose>
							<xsl:when test="string-length($IRS1120LScheduleF/InvestmentIncomeRt) &gt; 15">
								...
								<div class="styLNAmountBoxNBB" style="width:45mm;height:5mm;border-top-width:1px;font-size:7pt">
									<xsl:call-template name="PopulatePercent">
...
complete lines 8 through 12, line 16, and enter -0- on line 17 (see instructions).
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBoxNBB" style="height:7mm;border-top-width:1px;padding-top:3mm;border-bottom-width:1px;">10a</div>
						<div class="styLNAmountBoxNBB" style="height:7mm;border-top-width:1px;padding-top:4mm;border-bottom-width:1px;">
							<xsl:call-template name="PopulateAmount">
...
<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;background-color:lightgrey;width:40mm;border-bottom-width:0px"/>
					</div>
					<!-- Part II line 11 -->
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:99mm;">
							<span style="float: left; clear: none;">Combined tentative LICTI. Add line 10c and line 11. If $15 million or more, skip lines 13 through 15 and enter -0- on line 17 below and on page 1, line 23</span>
						</div>
						<div class="styLNRightNumBox" style="height:7mm;">12 </div>
						<div class="styLNAmountBox" style="width:32mm;border-bottom-width:1px;height:7mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS1120LScheduleH/CombinedTentativeLICTIAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="height:7mm;background-color:lightgrey;width:40mm;border-bottom-width:0px"/>
					</div>
					<!-- Part II line 13 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:5mm;">13 </div>
					...
					<xsl:choose>
						<xsl:when test="string-length($IRS1120LScheduleF/InvestmentIncomeRt) &gt; 15">
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:139mm;height:4mm;">
									 Taxpayer’s share. Divide line 10c by the total of line 6, column (a) and line 10c. If line 10c is zero or less, enter -0- on this line 
									<span style="letter-spacing:4mm;font-weight:bold;">......................</span>
								</div>
								<div class="styLNRightNumBoxNBB" style="height:7mm;border-top-width:1px;padding-top:3mm;border-bottom-width:1px;">16</div>
								<div class="styLNAmountBoxNBB" style="height:7mm;border-top-width:1px;padding-top:4mm;border-bottom-width:1px;font-size:6pt">
									<xsl:call-template name="PopulateText">
						...
						<xsl:otherwise>
							<div style="width:187mm;">
								...
								<div class="styLNRightNumBox" style="height:7mm;border-top-width:1px;padding-top:3mm">16</div>
								<div class="styLNAmountBox" style="height:7mm;border-top-width:1px;padding-top:4mm">
									<xsl:if test="$IRS1120LScheduleH/TaxpayerShrTentativeLICTIPct">							
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$IRS1120LScheduleH/TaxpayerShrTentativeLICTIPct"/>
										</xsl:call-template>
									</xsl:if>	
...
<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139mm;height:4mm;">
							Noninsurance loss. Subtract line 1 from line 4. If line 1 is greater than line 4, skip lines 5 through 8 and 
							enter -0- on line 9
							<span style="letter-spacing:4mm;font-weight:bold">.........................</span>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:7mm;padding-top:3mm;border-bottom-width:1px;">5</div>
						<div class="styLNAmountBoxNBB" style="height:7mm;;padding-top:4mm;border-bottom-width:1px;">
							<xsl:call-template name="PopulateAmount">
					...
					<!-- Schedule I  line 9 -->
					<div class="styBB" style="width:187mm;border-bottom-width:1px;float:none;">
						<div class="styLNLeftNumBox" style="height:4mm;;padding-left:3mm">9 </div>
						<div class="styLNDesc" style="width:139mm;height:4mm;">
							<span style="float: left; clear: none;">
...
The information provided in Part II should conform with the “Assets” and “Liabilities, Surplus,
 and Other Funds” sections of the NAIC Annual Statement.</span>
						</div>
					</div>
					<!-- Schedule L head line -->
					<div style="width:187mm;clear:all;">
...
<!-- Form to Form Link   -->
												...
												<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
												<span style="width:3px;"/>
												<span style="width:27mm;font-size:6pt;border-bottom:1px solid black;">
													<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode" select="$IRS1120LScheduleM/TotalForm5472FiledCnt"/>
														<xsl:with-param name="MaxSize" select="4"/>
													</xsl:call-template>
...
for the tax year and is electing under section 810(b)(3) to forego the carryback period, check here 
											...
											<span style="width:2px;"/>
											<input type="checkbox" alt="OLD Forego Carryback" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$IRS1120LScheduleM/OLDForegoCarrybackInd"/>
													<xsl:with-param name="BackupName">IRS1120L ScheduleM OLD Forego Carryback</xsl:with-param>
												</xsl:call-template>
											</input>
										</div>

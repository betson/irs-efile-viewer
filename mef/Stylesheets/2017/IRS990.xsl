      ...
      <body class="styBodyClass">
        <form name="Form990">
          ...
          <div style="width:187mm;font-weight:bold;">
            <span class="styBoldText" style="width:4mm;">A</span> For the 2018 calendar year, or tax year beginning
...
<div class="styBB" style="width:187mm;"/>
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990 </span> (2017)
  </div>
					</div>
					<div class="pageEnd"/>
				<!--	<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px"/>
          ...
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2017)</div>
...
-->
          ...
          <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px" class="pageEnd">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">990</span> (2017)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2017)</div>
...
<td class="styLNAmountBox" style="height:7.5mm;width:22mm;font-size:6pt;padding-top:4mm;">
      ...
      <!--*****************New for 2012 make g even with a-f **************************************************************-->
             ...
             <tr>
                ...
                <td class="styGenericDiv" colspan="3" style="padding-top:0mm;width:76mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
          ...
          <xsl:value-of select="count($Form990Data/ProgramServiceRevenueGrp) + 3"/>
             ...
             <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:1mm;padding-left:1mm;">2a</td>
                  ...
                  <xsl:if test="position()!=1">
                   ...
                   <td class="styTableCell" style="width:22mm;height:4.5mm;font-size:6pt;border-left-width:1px;padding-top:1mm;">
                    <span class="styTableCellPad"/>
                      <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="BusinessCd"/>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;padding-top:1mm;border-style: solid; border-color: black;border-top-width: 0px;">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">

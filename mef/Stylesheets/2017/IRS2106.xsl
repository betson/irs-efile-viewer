	...
	<xsl:template match="/">
		...
		<html>
				...
				<form name="Form2106">
					...
					<div class="styBB" style="width: 187mm; height: 22mm; padding-bottom: 0mm; clear: all; float: left;border-bottom-width:2px;">
						...
						<div class="styFTBox" style="width: 125mm; height: 22mm;">
							...
							<div class="styFBT" style="width: 125mm; height: 3mm; font-size: 6.5pt; margin-top: 7mm;">
							 ...
							 <div class="styFBT" style="width: 125mm; height: 8mm; padding-top: 0mm; font-size: 6.5pt; margin-top: 0mm;">
								<img src="{$ImagePath}/2106_Bullet.gif" alt="Bullet"/> Information about Form 2106 and its separate instructions is at <i> www.irs.gov/Form2106.</i>
						    </div>
						</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:0.3mm solid black;">
						...
						<div style="width:45mm;text-align:right;font-size:8px;float:right;clear:none;">
						     Form <span class="styBoldText" style="font-size:8pt;">2106  </span>	(2017)
					    </div>
					</div>
					<!-- END Page 1 Footer -->
		           <!--<div class="pageEnd" style="width:187mm; clear: all; float: left;page-break-before: always;"/>-->
					...
					<div class="styBB" style="width: 187mm; height: 4.5mm; font-size: 8pt;border-bottom-width:2px;">
						...
						<div class="styLNDesc" style="width: 139mm;">
						    Multiply line 13 by 53.5¢ (0.535). Enter the result here and on line 1 
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>
						</div>
		 ...
		 (see instructions)
					...
					<!-- End signature part -->
					<div  class="styStdDiv pageEnd" style="border-top:2px solid black;text-align:right;">Form <span class="styBoldText" style="font-size:8pt;">2106  </span> (2017)
					</div>
					<br></br>
					<!-- END of Page 2 -->

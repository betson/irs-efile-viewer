		...
		<div class="styBB" style="width:187mm;">
		  <!--Form box begin -->
			  ...
			  <div class="styFST" style="height:5mm;font-size:6pt;margin-left:2mm;text-align:center;font-weight:normal">
				For calendar year 2017, or tax year beginning   
					...
					<div class="styFST" style="height:5mm;font-size:7pt;padding-top:1mm;">
					  <img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet" style="padding-right:1mm"/>Go to 
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">17</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
		  ...
		  <!-- Header Line A 1 -->
				...
				<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
				  <input type="checkbox" alt="IRS1120PCConsolidated return (attach Form 851)" class="styCkbox" >
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/ConsolidatedReturnInd"/>
					  <xsl:with-param name="BackupName">IRS1120PCConsolidatedReturn</xsl:with-param>
					</xsl:call-template>
				  </input>
				</div>
			  </div>
			...
			<div class="styBoldText" style="height:7mm;width:3mm;float:left;clear:none;padding-top:2mm;">2</div>
				...
				<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
				  <input type="checkbox" alt="IRS1120PCLife-nonlife consolidated return" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/LifeNonlifeConsolidatedRetInd"/>
					  <xsl:with-param name="BackupName">IRS1120PCLifenonlifeConsolidatedReturn</xsl:with-param>
					</xsl:call-template>
				  </input>
				</div>
			  </div>
			...
			<div class="styGenericDiv" style="height:9mm;padding-top:2mm;">
				  <input type="checkbox" alt="IRS1120PCScheduleM3Required" class="styCkbox" >
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/ScheduleM3Form1120PCInd"/>
					  <xsl:with-param name="BackupName">IRS1120PCScheduleM3Required</xsl:with-param>
					</xsl:call-template>
				  </input>
				</div>
			  </div>
...
<div class="styNameAddr" style="width:94.5mm;height:9.5mm;border-left-width:1px;padding-left:2mm;">
			...
			<br/>			
			<input type="checkbox" alt="IRS1120PC831b" class="styCkbox">
				<xsl:call-template name="PopulateCheckbox">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/Section831bElectionInd"/>
				  <xsl:with-param name="BackupName">IRS1120ElectionMadeUnderSection831b</xsl:with-param>
				</xsl:call-template>
			</input>
			<label>
				<xsl:call-template name="PopulateLabel">
			...
			<input type="checkbox" alt="IRS1120PC953(c)(3)(C)" class="styCkbox">
				<xsl:call-template name="PopulateCheckbox">
		...
		<!-- Header E -->
		  ...
		  <!-- E 1 Final return-->
			...
			<span style="width:3px;"/>
			<input type="checkbox" alt="IRS1120PCFinalReturn" class="styCkbox">
			  <xsl:call-template name="PopulateCheckbox">
			...
			<span style="width:3px;"/>
			<input type="checkbox" alt="IRS1120PCNameChange" class="styCkbox">
			  <xsl:call-template name="PopulateCheckbox">
			...
			<span style="width:3px;"/>
			<input type="checkbox" alt="IRS1120PCAddressChange" class="styCkbox">
			  <xsl:call-template name="PopulateCheckbox">
			...
			<span style="width:3px;"/>
			<input type="checkbox" alt="IRS1120PCAmendedReturn" class="styCkbox">
			  <xsl:call-template name="PopulateCheckbox">
		...
		<!--D Check boxes -->
			<span style="padding-left:1.7mm;"/>			
			<input type="checkbox" alt="IRS1120PC953(d)" class="styCkbox">
			  <xsl:call-template name="PopulateCheckbox">
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
			...
			<div style="width:2mm;height:35mm;"/>
				<img src="{$ImagePath}/1120PC_TaxComputation.gif" alt="Tax Computation and Payments" style="width:4.8mm;border-right:.5px solid black;"/>
		  </div>
		  <!--line 1 -->
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				...
				<input type="checkbox" alt="MemberOfControlledGroup" class="styCkbox">
				  <xsl:call-template name="PopulateCheckbox">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/MemberOfControlledGroupInd"/>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styLNDesc" style="width:133mm;height:4.5mm;">
			  <span style="float:left;padding-right:1mm;">Income tax</span>			  
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:132mm;height:4.5mm;">Other taxes. Check if from:
                  <span style="width:2mm;"/>
				  <input type="checkbox" alt="IRS1120PCForm4255" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
				  ...
				  <span style="width:2mm;"/>
				  <input type="checkbox" alt="IRS1120PCForm8611" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
				  ...
				  <span style="width:2mm;"/>
				  <input type="checkbox" alt="IRS1120PCOther (attach statement)" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.5mm;">2016 overpayment credited to 2017
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;padding-right:1mm;">.</div> 
      	        </div>
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:53.5mm;height:8.5mm;font-size:7pt;">Prior year(s) special estimated tax payments to be applied
        	      <!-- Form to Form Link (Push Pin)-->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<div style="width:181mm;">
			  <div style="float:left; clear:none;">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.5mm;font-size:6pt;"> 2017 estimated tax payments (see instructions)</div>
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:92mm;height:4.5mm;">
				  <span style="float:left"> 2017 special estimated tax payments (Don't include on line 14f)</span>
				</div>
			  </div>
			  <div style="float:right;clear:none;">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.5mm;font-size:6pt;">2017 refund applied for on Form 4466
				  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:92mm;height:4.5mm;font-size:6pt;">Credit by reciprocal for tax paid by attorney-in-fact under section 835(d)
      	        </div>
			  </div>
			  <div style="float:right;clear:none;">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:93mm;height:4.5mm;">
				  <span style="float:left"> Refundable credit from Form 8827, line 8c
         	        <!-- Form to Form Link (Push Pin) -->
					<xsl:call-template name="SetFormLinkInline">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:132mm;height:4.5mm;">
				  ...
				  <img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet"/>
				  <span style="width:2mm;"/>
				  <input type="checkbox" alt="IRS1120PCForm2220Attached" class="styCkbox">
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/Form2220AttachedInd"/>
			...
			<div class="styGenericDiv" style="width:181mm;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				<span style="float:left"> <b>Amount owed.</b> If line 14k is smaller than the total of lines 13 and 15, enter amount owed
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
			...
			<div class="styGenericDiv" style="width:181mm;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
			    <span style="float:left"> <b>Overpayment.</b> If line 14k is larger than the total of lines 13 and 15, enter amount overpaid
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
			  </div>
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="width:141mm;float:left;clear:none">
				...
				<div class="styLNDesc" style="width:86mm;height:4.5mm;">Enter amount from line 17: 
				  <span class="styBoldText">Credited to 2018 estimated tax</span>
				  <span style="width:2px"/>				  
				  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
				</div>
				<div class="styGenericDiv" style="width:28mm;height:4.5mm; padding-top:1mm;">
				  <xsl:call-template name="PopulateAmount">
		  ...
		  <div class="styBB" style="width:187mm;font-size:6pt;">
			...
			<div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2017)
            </div>
		  </div>
		  ...
		  <div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
			<div style="float:left;">Form 1120-PC (2017)<span style="width:146mm;"/>
		  </div>
		...
		<div class="styBB" style="width:187mm;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="float:left;clear:none;">
			  ...
			  <div class="styLNAmountBox" style="width:24mm;height:4.5mm;border-top-width:0px; border-bottom-width:1px;border-left-width:0px; border-right-width: 0px;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleA/InterestDeductionAmt"/>
				</xsl:call-template>
			  </div>
	  ...
	  <div style="float:left;clear:none;border-top:1px solid black;border:0px solid red;width:123mm;border-bottom:1px solid black;">
		<div class="styPartName" style="width:23mm;">Schedule C</div>
		  <div class="styPartDesc" style="width:70mm; height:8mm;">Dividends and Special Deductions <br />
		   <span style="font-weight:normal;">(see instructions) </span>
		  </div>	
		</div>
		<div style="float:right;clear:none;width:64mm;border:0px solid green;" >
		  <div class="styLNAmountBox" style="heigh:4mm;width:64mm;text-align:center;border-top:0px solid black;">Dividends-Received</div>
	...
	<div style="width:187mm;">
	  <div style="float:left;clear:none:">
		<div class="styLNLeftNumBox" style="height:8.5mm;padding-top:4mm;">10</div>
		<div class="styLNDesc" style="height:8.5mm;width:107mm;padding-top:4mm;">
	  ...
	  <div style="float:right;clear:none;">
		...
		<div class="styLNAmountBox" style="border-bottom-width:1px;height:8.5mm;padding-top:4mm;background-color:lightgrey;"/>
		<div class="styLNAmountBox" style="border-bottom-width:1px;height:8.5mm;padding-top:4mm;">
		  <xsl:call-template name="PopulateAmount">
	...
	<div style="width:187mm;">
	  <div style="float:left;clear:none:">
		<div class="styLNLeftNumBox" style="height:8.5mm;padding-top:4mm;">11</div>
		<div class="styLNDesc" style="height:8.5mm;width:107mm;padding-top:4mm;">
	...
	<div style="width:187mm;">
	  ...
	  <div style="width:187mm;">
		<div style="float:left;clear:none:">
		  <div class="styLNLeftNumBox" style="height:4.5mm;">13</div>
		  <div class="styLNDesc" style="height:4.5mm;">
			<span style="float:left">Reduction of deduction under section 832(b)(5)(B). Multiply line 12 by 0.15</span>
			<!--Dotted Line -->
			<div class="styDotLn" style="float:right;padding-right:1mm;">..........</div>
		  </div>
		</div>
	...
	<div class="styGenericDiv" style="width:187mm;">
	  <div class="styGenericDiv" style="float:left;border-right:1px solid black;clear:none;">
		<div class="styLNLeftNumBox" style="width:6mm;height:17mm;padding-top:4mm;">12</div>
		<div class="styLNDesc" style="width:51mm;padding-top:4mm;">
	  ...
	  <div style="float:left;width:25.9mm;height:17mm;border-right:1px solid black;clear:none;text-align:right;padding-top:14mm;">
		<xsl:call-template name="PopulateAmount">
		  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleG/TotalGrossSalesPriceAmt"/>
		</xsl:call-template>
	  </div>
	  <div style="float:left;width:78mm;height:17mm;border-right:1px solid black;background-color:lightgrey;clear:none;"></div>
	  <div style="float:left;width:24mm;height:17mm;border-right:0px solid black;clear:none;text-align:right;padding-top:14mm;">
		<xsl:call-template name="PopulateAmount">
	...
	<div style="width:187mm;">
	  <div style="float:left;clear:none:">
		...
		<div class="styLNDesc" style="height:8.5mm;">
          Health care claims incurred during the tax year and liabilities incurred during the tax year under cost-plus contracts
		  <!--Dotted Line -->
		  <div class="styDotLn" style="float:right;padding-right:1mm;">...............................</div>
		</div>
	  </div>
  ...
  <div class="styBB" style="width:187mm;hight:auto;border-bottom-width:1px;float:left;clear:left;">
	...
	<div class="styLblNameAddr" style="width:93.5mm;height:auto;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px;border-right-width: 0px;">
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;">
		...
		<div class="styShadingCellRB" style="width:6mm;height:5.5mm;padding-bottom:1mm;"/>
	  </div>
	  <!-- Schedule I, Line 2-->
	  <div class="styGenericDiv" style="width:93.5mm;">
		<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 2.25mm">2</div>
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;">
		...
		<div class="styLNDesc" style="width:73mm;height:4.5mm;">
		  ...
		  of a domestic corporation? (For rules of attribution,<br/> <span style="float:left">see section 267(c).) </span>
		  <!--Dotted Line -->
		  <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
		</div>
		<!-- Shading Cell-->
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;">
		...
		<div class="styLNDesc" style="width:73mm;height:17mm;">
		  <span style="float:left">
			If "Yes," attach a statement showing: line 3
			<!--Form to Form Link -->
			<xsl:call-template name="SetFormLinkInline">
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;">
		...
		<div class="styIRS1120PCLNYesNoBox" style="height:4.5mm;">
		  <span style="font-weight:normal;">
			<xsl:call-template name="PopulateYesBoxText">
			  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleI/ControlledGroupMemberInd"/>
			</xsl:call-template>
		  </span>
		</div>
		<div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;">
		...
		<div class="styLNDesc" style="width:73mm;height:4.5mm;">
		  <span style="float:left">
			...
			<span style="width:50mm;border-bottom:1px solid black;">
			  ...
			  Corporation or a Foreign Corporation Engaged in a U.S. Trade or Business. Enter number of Forms 5472 attached
			  <span style="width:3px;"/>
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
			  <span style="width:6px;"/>
		...
		<!-- Schedule I, Line 7-->
		<div class="styGenericDiv" style="width:93.5mm;;">
 		  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm">7</div>
		  <div class="styLNDesc" style="width:73mm;height:10mm;">		    
			...
			<span style="float:left">adjustment expenses?<br/></span>
			<!--Dotted Line -->
		    <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
		  </div>
		  <!-- Shading Cell-->
		  ...
		  <div class="styIRS1120PCLNYesNoBox" style="height:4.5mm;">
			<span style="font-weight:normal;">
			  <xsl:call-template name="PopulateYesBoxText">
			  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleI/ElectedOwnPayoutPatternInd"/>
			  </xsl:call-template>
			</span>
		  </div>
		  <div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
		  ...
		  <!-- Schedule I, two (2) blank lines -->
		  <div class="styGenericDiv" style="width:93.5mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm"></div>
		    <div class="styLNDesc" style="width:73mm;height:4.5mm;"></div>
		    <div class="styShadingCell" style="width:6mm;height:6.25mm;"/>
		    <div class="styShadingCellRB" style="width:6mm;height:6.25mm;"/>
		  </div>
		  <div class="styGenericDiv" style="width:93.5mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm"></div>
		    <div class="styLNDesc" style="width:73mm;height:4.5mm;"></div>
	  ...
	  <div class="styLblNameAddr" style="width:93mm;height:27mm;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px;border-right-width: 0px;">
		...
		<!-- Schedule I, Line 8a-->
		<div class="styGenericDiv" style="width:93mm;">
		  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm">8a</div>
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styIRS1120PCBBText" style="width:30.5mm;height:4.5mm;text-align:right;">
		    <xsl:call-template name="PopulateAmount">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styIRS1120PCBBText" style="width:30.5mm;text-align:right;">
			<xsl:call-template name="PopulateAmount">
		...
		<!-- Schedule I, Line 8b-->
		<div class="styGenericDiv" style="width:93mm;">
		  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 6.25mm">
			b
		  </div>
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
			  Does the corporation discount any of the loss reserves shown on its annual statement?<br/>			  
			</span>			
		  </div>
		  <!-- Shading Cell-->
		...
		<div class="styGenericDiv" style="width:93.5mm;">
		  ...
		  <div class="styGenericDiv" style="width:93.5mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			  ...
			  <br/>
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/> $
			  <span style="padding-left:3mm;width:50mm;border-bottom:1px solid black;text-align:right;">
				<xsl:call-template name="PopulateAmount">
		...
		<!-- Schedule I, blank line -->
		<div class="styGenericDiv" style="width:93mm;">
          <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm"></div>
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;"></div>
		  <div class="styShadingCell" style="width:6mm;height:5mm;"/>
		  <div class="styShadingCellRB" style="width:6mm;height:5mm;"/>
		</div>
		<!-- Schedule I, Line 14 Enter line-->
		<div class="styGenericDiv" style="width:93mm;">
		  <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 2.25mm"></div>
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:8.5mm;">
			...
			<span style="width:5mm;"/>MLR numerator: <span style="width:10mm"/>
			</div>
		    ...
		    <div class="styShadingCellRB" style="width:6mm;height:8.5mm;"/>
		</div>
		<!-- Schedule I, Line 14b -->
		<div class="styGenericDiv" style="width:93mm;">
		  <div class="styLNLeftNumBoxSD" style="height:8.5mm;font-size:6pt;padding-left: 4.25mm"></div>
		  <div class="styLNDesc" style="width:72.5mm;height:8.5mm;">
			...
			<span style="width:5mm;"/>MLR denominator: <span style="width:10mm"/>
			</div>
			<div style="width:32.5mm;float:right;clear:none;">
			  <span style="padding-top:2mm;">
				$ <span style="width:1mm;"/>
			...
			<div style="width:32.5mm;float:right;clear:none;">
			  <!--<span style="padding-top:2mm;">-->
				...
				<span style="width:27.5mm;padding-bottom:.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px">
				  <xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleI/MedicalLossRtRqrSect833c5Ind"/>
				  </xsl:call-template>
				<!--</span>-->
			  </span>			
			 </div>
		...
		<!-- Schedule I, Line 15-->
		  <div class="styGenericDiv" style="width:93.5mm;">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm">15</div>
			<div class="styLNDesc" style="width:72.5mm;height:26mm;">
				...
				<span style="float:left;">(a) Does the corporation satisfy the diversification 
					<span style="float:left;padding-left:4.5mm;">requirements of section 831(b)(2)(B)(i)(I) because no more than 20 percent of the net written premiums (or if greater direct written premiums) of the corporation for the taxable year is attributable to any one policyholder?
					  <!--Dotted Line -->
					  <span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
					</span>
				</span>				   
			...
			<div class="styShadingCellRB" style="width:6mm;height:23mm;"/>
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.5mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
		  ...
		  <div class="styGenericDiv" style="width:93.5mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:12mm;padding-top:2mm;">
				(b) If the answer to (a) is no, does the corporation satisfy
				<span style="float:left;padding-left:4.5mm;"> the diversification requirements of section 831(b)(2)(B)(i)(II)?
				   <!--Dotted Line -->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">.............</span>
				</span> 
		  </div>
		  <!-- Shading Cell-->
			...
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;border-bottom-width:0px;height:5.25mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
			...
			<div class="styIRS1120PCLNYesNoBoxRB" style="height:5.25mm;border-bottom-width:0px;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateNoBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleI/DvrsfctnRqrSect831b2BiIIInd"/>
				</xsl:call-template>
  ...
  <div style="width:187mm;">
	...
	<div style="width:187mm;">
	  ...
	  <div style="width:187mm;">
		...
		<!-- Schedule L Line 29-->
		<div class="styBB" style="width:187mm;">
		  <div class="styLNLeftNumBox" style="height:4.5mm;padding-top:1mm;">29</div>
		...
		<div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:none;clear:both;">
		  <div class="styLblNameAddr" style="width:93.5mm;height:auto;border-top-width: 0px;border-bottom-width: 0px; border-left-width: 0px;border-right-width: 1px;float:left;clear:left;">
			...
			<div class="styGenericDiv" style="width:93.5mm;">
			  ...
			  <div class="styLNAmountBox" style="height:5mm;width:32mm;border-bottom-width: 2px;padding-right:.5mm;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleM1/TotalExpensesNotDeductedAmt"/>
				</xsl:call-template>
			  </div>
		 ...
		 <!-- Sch M-1 : Line 7a row 1 
			Exception: customer approved amount to display on the second line becz limited space on the first line after $ sign from first year development of the form-->
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBoxSD" style="height:4mm;padding-left: 6.25mm">a</div>
		  ...
		  <!-- Exception: customer approved amount to display on the second line becz limited space on the first line after $ sign from first year development of the form-->
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 6.25mm">a</div>
			<div class="styLNDesc" style="width:53mm;height:4.5mm;">
				<span style="float:left;">Depreciation $: </span>
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBoxSD" style="height:4mm;padding-left: 6.25mm">b</div>
			<div class="styLNDesc" style="width:53mm;height:4mm;">
			  <span style="float:left">Charitable contributions $: </span>
			  <span class="styUnderlineAmount" style="float:right;width:20mm; " ></span>
			</div>
			<div class="styLNAmountBoxNBB" style="height:4mm;width:32mm;"/>
		  </div>
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNAmountBox" style="height:5mm;width:32mm;border-bottom-width:2px;;">
			  <xsl:call-template name="PopulateAmount">
				<xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleM1/TotalDeductionsNotChargedAmt"/>
			  </xsl:call-template>
			</div>
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNAmountBox" style="height:4.5mm;width:32mm;border-bottom-width:2px;">
			  <xsl:call-template name="PopulateAmount">

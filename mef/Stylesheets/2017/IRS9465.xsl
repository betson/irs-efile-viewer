		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="IRS9465" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<div class="styIRS9465LineItem" style="height:18mm;">
							<div class="styIRS9465LNDesc" style="width:100%;height:18mm;padding-left:0px;font-size:8.5pt;padding-bottom:2mm;">
								<b>Tip: </b>If you owe $50,000 or less, you may be able to establish an installment agreement online, even if you have not yet received a bill for your taxes. Go to <i>www.irs.gov/opa</i> to apply for an Online Payment Agreement.
								<b> Caution: </b>
					...
					<!-- Form # and Tax Year -->
					<div class="styIRS9465LineItem" style="height:10mm;">
						<div class="styIRS9465LNDesc" style="width:93mm;height:10mm;padding-left:0px;font-family:Arial Narrow;">
							<div class="styIRS9465LNDesc" style="width:77mm;height:10mm;padding-left:0px;font-family:Arial Narrow;">									This request is for Form(s) (for example, Form 1040 or Form 941)
									<span style="width:4px;"/>
								<img src="{$ImagePath}/9465_Bullet_Sm.gif" alt="SmallBullet"/>
							</div>
							<div class="styIRS9465LNDesc" style="width:16mm;height:10mm;padding-left:0px;font-family:Arial Narrow;   
							     padding-top:1mm;">
								<xsl:choose>
									<xsl:when test="(count($Form9465Data/F9465TaxReturnTypeCd) &gt; 1)">
										<div style="width:16mm;height:10mm;font-family:Verdana;font-size:6pt;">See Additional Data Table</div>
									</xsl:when>
									<xsl:otherwise>
										<div style="width:16mm;height:10mm;font-family:Verdana;font-size:6pt">
											<xsl:call-template name="PopulateText">
						...
						<div class="styIRS9465LNDesc" style="width:90mm;height:10mm;padding-right:0mm;font-family:Arial Narrow;">					     		Enter tax year(s) or periods(s) involved (for example 2017 or January 1, 2017 to June 30, 2017
								<span style="width:1px;"/>
							<img src="{$ImagePath}/9465_Bullet_Sm.gif" alt="SmallBullet"/>
							<span style="width:60mm;height:100%;font-family:Verdana;font-size:6pt;padding-left:2mm">
								<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIR9465LineItem" style="height:8mm;">
							...
							<div class="styIRS9465CleanDiv" style="width:47mm;height:6mm;padding:0px 0px 0px 0px;float:right;">
								<xsl:call-template name="CreateBox">
						...
						<!-- (7) ////////////////////////////////////////////////////-->
						<div class="styIRS9465LineItem" style="height:5mm;padding-top:.0mm;">
							<div class="styIRS9465LNLeftNumBox">7</div>
							<div class="styIRS9465CleanDiv" style="width:144mm;height:5mm;">
							...
							<div class="styIRS9465CleanDiv" style="width:37mm;height:1mm;padding:0px 0px 0px 0px;float:right;">
								<div class="styIRS9465CleanDiv" style="width:100%;height:1mm;float:right;">
									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">5mm;text-align:center;padding-top:1.5mm;</xsl:with-param>
						...
						<!-- (9) ////////////////////////////////////////////////////-->
						<div class="styIRS9465LineItem" style="height:5.4mm;">
							<div class="styIRS9465LNLeftNumBox">9</div>
							<div class="styIRS9465CleanDiv" style="width:144mm;height:5.4mm;padding:0px 0px 0px 0px;">
								<div class="styIRS9465LNDesc" style="width:144mm;height:5.4mm;padding:0px 0px 0px 0px;">
									<div class="styIRS9465LNDesc" style="width:144mm;height:5.4mm;padding-top:1mm;">
							...
							<div class="styIRS9465CleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
								<div class="styIRS9465CleanDiv" style="width:100%;height:100%;float:right;">
									<xsl:call-template name="CreateBox">
										<xsl:with-param name="Height">5.3mm;text-align:center;padding-top:1mm</xsl:with-param>
							...
							<!-- (10) ////////////////////////////////////////////////////-->
						<div class="styIRS9465LineItem" style="height:5.3mm;">
							<div class="styIRS9465LNLeftNumBox">10</div>
							<div class="styIRS9465CleanDiv" style="width:144mm;height:5.3mm;padding:0px 0px 0px 0px;">
								<div class="styIRS9465LNDesc" style="width:144mm;height:5.3mm;padding:0px 0px 0px 0px;">
									<div class="styIRS9465LNDesc" style="width:144mm;height:5.3mm;padding-top:1mm;">
							...
							<div class="styIRS9465CleanDiv" style="width:37mm;height:14mm;padding:0px 0px 0px 0px;float:right;">
								...
								<div class="styIRS9465CleanDiv" style="width:100%;float:right;height:auto;">
									<xsl:call-template name="CreateBox">									
										...
										<xsl:with-param name="NumberBoxStyle">border-bottom-width:2px;border-top-width:0px;border-left-width:2px;
										           border-right-width:1px;</xsl:with-param>
						...
						<!-- (11b) ////////////////////////////////////////////////////-->
							...
							<div class="styIRS9465LNLeftNumBox">11b</div>
							<div class="styIRS9465CleanDiv" style="width:144mm;height:14mm;padding-bottom:1.3mm">
								<div class="styIRS9465LNDesc" style="width:auto;height:14mm;padding:0px 0px 0px 0px;">
									<div class="styIRS9465LNDesc" style="width:auto;height:14mm;">
										If the amount on line 11a is less than the amount on line 10 and you are able to increase your payment to an amount that is equal to
						...
						<div class="styIRS9465LNDesc" style="width:auto;height:22mm;padding-left:9mm;">
						<label>
								<xsl:call-template name="PopulateLabel">
								...
								</xsl:call-template>If you can't increase your payment on line 11b to more than or equal to the amount shown on line 10, check the box. <br/>Also, complete and attach Form 433-F, <i>Collection Information Statement</i>
						</label>
							...
							If the amount on line 11a (or 11b, if applicable) is equal to or greater than the amount on line 10 and the amount you owe
							 is over  <br/><span style="width:1.5mm;"/> $25,000 but not more than $50,000, then you do not have to complete Form 433-F. However, if you don't complete Form 433-F, then  <br/><span style="width:1.8mm;"/> you must complete either line 13 or 14.<br/>
							<img alt="Bullet" src="{$ImagePath}/1040SchA_Bullet_Round.gif" height="6" width="6"/>	
						...
						<div class="styIRS9465LineItem">
							...
							<span style="width:45mm;border-bottom:1px solid black;text-align:right;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;padding-bottom:1mm;padding-top:19mm">
					...
					<div style="float:right;">
							<span style="width:75px;"/>  
							Form <span class="styBoldText" style="font-size:8pt;">9465</span> (Rev. 1-2018)
					</div>
				    <p style="page-break-before: always"/>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- page 2 -->					
					...
					<!-- BEGIN Part II Title -->
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<span class="" style="float:left;clear:none;">Form 9465 (1-2018)</span>
						<span style="float:right;clear:none;">Page <span class="styBoldText" style="font-size:8pt;">2</span>
						</span>
					</div>
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
					...
					<div class="styIRS9465LineItem" style="height:auto;">
						<div class="styIRS9465LNDesc" style="width:106mm;height:18mm;">
							<div class="styPartDesc" style="font-weight: normal;text-align:left;"> 
							<b>Additional Information.</b> Complete this part if:  <br/>(1) you defaulted on an installment agreement in the past 12 months, <br/>(2) you owe greater than $25,000 but not more than $50,000, and <br/>(3) the amount online 11a (or 11b, if applicable) is less than line 10.<br/> <b>Note:</b> If you owe more than $50,000, complete and attach Form 433-F, Collection Information Statement.       
                      </div>            
					  </div>
					</div> 
			 ...
			 <!--Dotted Line-->
					...
					<!-- end Line 20 -->
					<!-- Line 21 -->
					<div class="styIRS9465LNDesc" style="width:145mm;padding-left:9mm;height:1.5mm;padding-top:1.5mm;"><b>Note: </b>Complete lines 21 and 22 only if you have a spouse.  If you don't have a spouse, go to line 23.</div>
					<div style="width:187mm;height:25mm;padding-top:2.5mm;">

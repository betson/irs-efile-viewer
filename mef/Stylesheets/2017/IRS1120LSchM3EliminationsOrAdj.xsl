				...
				<form name="Form1120LSchM3EliminationsOrAdj">
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" alt="IRS1120LScheduleM3Non-ConsolidatedReturn" class="styCkbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (2)
							<input type="checkbox" alt="IRS1120LScheduleM3Consolidated return (Form 1120-L only)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3Mixed1120/L/PC group">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3Dormant subsidiaries schedule attached">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styNBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:113mm;">
					...
					<div style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(5)</b>
							<input type="checkbox" alt="IRS1120LScheduleM3Mixed 1120/L/PC group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<b>(6)</b>
							<input type="checkbox" alt="IRS1120LScheduleM31120-L group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:5mm;">
							<b>(7)</b>
							<input type="checkbox" alt="IRS1120LScheduleM31120-L eliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">

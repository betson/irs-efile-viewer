...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="CPSData" select="$RtnDoc/RestatedIncomeStatement"/>
    ...
    <html>
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine">
          <div style="float:left;clear:none;width:65mm;"><span class="styTopSectionLineLbl">Statement:</span></div>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="CreateLine12TableRowsColored">
        ...
        width:100%;height:5mm;border-right-width:0px;<xsl:value-of select="$IsLast"/></xsl:attribute>
			...
			<td class="styIRSW2GUTableCell" style="width:50%;text-align:right;height:10mm;padding-right:1mm">
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$TargetNode/EmployersUseCd"/>
				</xsl:call-template>
			</td>
			<td class="styIRSW2GUTableCell" style="width:50%;text-align:right;border-left-width:1px;height:5mm;padding-right:1mm">
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$TargetNode/EmployersUseAmt"/>
				</xsl:call-template>
			</td>
	...
	<xsl:template name="CreateLine14TableRowsColored">
        ...
        width:100%;height:5mm;border-right-width:0px;<xsl:value-of select="$IsLast"/></xsl:attribute>
			...
			<td class="styIRSW2GUTableCell" style="width:25%;text-align:right;border-left-width:1px;height:5mm;padding-right:1mm">
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$TargetNode/Amount"/>
				</xsl:call-template>
			</td>
			...
			<body class="styBodyClass">
				<form name="IRSW2GU">
                    ...
                    Void
						...
						<div class="styIRSW2GULineItemBB">
							...
							<div class="styIRSW2GUCleanDiv" style="width:25%;height:100%;">
								<div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
									...
									<div class="styIRSW2GULNDesc" style="width:auto;">Guma income tax withheld</div>
								</div>
								<div class="styIRSW2GULNDesc" style="width:100%;text-align:right;padding:1mm">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRSW2GULineItemBB" style="height:31mm;">
							...
							<div class="styIRSW2GUCleanDiv" style="width:49.9%;height:100%;border-left-width:0px;">
								...
								<div class="styIRSW2GULineItemBB" style="border-bottom-width:0px;height:10.60mm;">
									...
									<!-- (8) -->
									<div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;background-color:lightgrey;">
										<div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
						...
						<!-- ////////////////////////////////////////////////////-->
							<div class="styIRSW2GULineItemBB" style="height:100%;">
							<div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;border-left-width:0px;">
                    ...
                    Suff.
							...
							<div class="styIRSW2GUCleanDiv" style="width:25.15%;">
						...
						<table class="styDepTbl" cellspacing="0">
							<thead>
								<tr class="styDepTblHdr">
									...
									<th class="styIRSW2GUTableCell" scope="col" style="width:75%;height:5mm;color:white;border-left-width:1px;">Amount</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>

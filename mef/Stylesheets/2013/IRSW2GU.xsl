...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <div class="styIRSW2GUCleanDiv" style="width:60%;height:13mm;border-left-width:0px;">
        ...
        <div class="styIRSW2GUCleanDiv" style="width:27%;height:100%;border-left-width:0px;">
          <div class="styTY" style="float:left;clear:none;height:100%;font-size:25pt;padding-top:1mm;padding-left:7mm;">
            20<span class="stytycolor">13</span></div>
        </div>
      </div>
      <!-- Right -->
    ...
    <tr>
      ...
      <td class="styIRSW2GUTableCell">
        ...
        <xsl:if test="(position() != 1) or ($Letter != 'a')">
          ...
          <xsl:attribute name="style">width:100%;height:auto;border-width:0px 0px 0px 0px;<xsl:value-of select="$IsB"/>
          </xsl:attribute>
  ...
  <xsl:template name="CreateLine12TableRowsColored">
    ...
    <tr>
      ...
      <td class="styIRSW2GUTableCell" style="width:50%;text-align:right;height:5mm;">
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$TargetNode/EmployersUseCd"/>
        </xsl:call-template>
      </td>
        ...
        <form name="IRSW2GU">
          ...
          <div class="styGenericDiv" style="border:1px black solid;width:187mm;height:auto;">
            ...
            <div class="styIRSW2GULineItemBB">
              <!-- 22222 -->
              <div class="styIRSW2GUCleanDiv" style="width:12%;height:100%;border-left-width:0px">
            ...
            <div class="styIRSW2GULineItemBB">
              ...
              <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:100%;">
                ...
                <div class="styIRSW2GUCleanDiv" style="width:49.9%;height:13mm;border-bottom-width:1px;border-left-width:0px;">
                  ...
                  <div class="styIRSW2GULNDesc" style="width:100%;text-align:right;padding-right:1mm;padding-top:2mm;">
                    <xsl:call-template name="PopulateAmount">
                ...
                <div class="styIRSW2GUCleanDiv" style="width:50%;height:100%;float:right;">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">
                    ...
                    <div class="styIRSW2GUCleanDiv" style="width:auto;text-align:right;border-left-width:0px;">
                ...
                <!-- (14) Other-->
                <div style="width:100%;border-left-width:0px;border-right:">
                  <div class="styIRSW2GUCleanDiv" style="width:100%;height:auto;border-width:0px 0px 0px 0px;">

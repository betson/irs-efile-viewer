...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ItemizedOtherIncomeSchedule2"/>
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="IOIS2Tbl" class="styDepTbl">
  ...
  <xsl:template match="/">
    <html>
      <head>
         ...
         <meta http-equiv="Content-IncomeTypeDesc" content="text/html; charset=ISO-8859-1"/>       

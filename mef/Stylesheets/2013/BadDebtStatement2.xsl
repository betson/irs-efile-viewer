      ...
      <tbody>
       <xsl:for-each select="$DependencyData/BadDebtStatement2Grp">
        ...
        <tr>
          ...
          <td class="styDepTblCell" style="width:50mm;text-align:left;"> 
            <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="DebtorBusinessName/BusinessNameLine1" />
              </xsl:call-template>     
          <br/>
                 <xsl:if test="DebtorBusinessName/BusinessNameLine2">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="DebtorBusinessName/BusinessNameLine2" />
              </xsl:call-template>     
                       </xsl:if>    
                </td>

...
To File U.S. Income Tax Return</div>
							...
							Form 2350 and its instructions is a available at 
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;margin-top:3mm;">
							...
							<div style="float:right;width:177mm;">
								...
								to file my income tax return for the calendar year 2013, or other tax year ending <span style="width:25mm;text-align:center;border-bottom:1px dashed black;"><xsl:if test="$FormData/RequestedOtherTaxYrExtensionDt">
								<xsl:call-template name="PopulateMonth">
						...
						<div style="width:187mm;margin-top:1mm;">
							...
							<div style="width:137mm;">							
					            ...
					            <span style="width:1mm"/>
										<xsl:if test="$FormData/ForeignAddress/AddressLine2">
								<xsl:call-template name="PopulateText">
								...
								<span style="width:1mm"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/ForeignAddress/City"/>
								</xsl:call-template>
									<span style="width:7px;"/>
                                   <xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/ForeignAddress/ProvinceOrState"/>
								</xsl:call-template>								
								...
								<span style="width:7px;"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/ForeignAddress/PostalCode"/>
								</xsl:call-template>
								</span>
							</div>
						</div>
	...
	agent acting for you, enter the other address and add the agent's name.					
				...
				<div class="pageEnd" style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm">
					...
					Form <b style="font-size:9pt">2350</b> (2013)
					</div>
				</div>
				<!--</div>-->

...
To File U.S. Income Tax Return</div>
							...
							Form 2350 and its instructions is available at www.irs.gov/form2350.
							</div>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;margin-top:1mm;">
							...
							<div style="float:right;width:177mm;">							
								...
								<span style="width:25mm;text-align;center;border-bottom:1px dashed black;width:137mm;">						
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/ForeignAddress/AddressLine1"/>
									
								</xsl:call-template>								
								<xsl:if test="$FormData/ForeignAddress/AddressLine2"><span style="width:1mm"/>
								<xsl:call-template name="PopulateText">

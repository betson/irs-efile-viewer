    ...
    <table id="CCSTbl" class="styDepTblLandscape">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">          
           <th class="styDepTblCell" style="width=56mm;" scope="col">Corporation Name </th>        
           <th class="styDepTblCell" style="width=34mm;" scope="col">Corporation EIN </th>  
           <th class="styDepTblCell" style="width=56mm;" scope="col">Type of Contribution </th>        
           <th class="styDepTblCell" style="width=55mm;" scope="col">Method Used </th>        
           <th class="styDepTblCell" style="width=55mm;" scope="col">Fair Market Value </th>  
        </tr>
      </thead>
        <tfoot/>
        
       <tbody>    
        <xsl:for-each select="$CCSData/CharitableContributionGrp">  
          <tr>
            ...
            <td class="styDepTblCell" style="text-align:left;width=56mm;">
            ...
            <td class="styDepTblCell" style="text-align:left;width=56mm;">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ContributionDesc"/>
              </xsl:call-template>
            </td>
           
            <td class="styDepTblCell" style="text-align:left;width=55mm;">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ContributionMethodUsedDesc"/>
              </xsl:call-template>
            </td>
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <head>
        ...
        <title><xsl:value-of select="$depDocTitle"/></title>
         ...
         <meta http-equiv="Content-ContributionDesc" content="text/html; charset=ISO-8859-1"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ItemizedDedNotChargedBooksSch"/>
  ...
  <xsl:template name="ItemizedDedNotChargedBooksSchTemp">
    <table id="ItemizedDedNotChargedBooksSchTbl" class="styDepTbl">
      ...
      <xsl:for-each select="$DependencyData/ItemizedDedNotChargedBooksGrp">
        <tr>
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        <xsl:call-template name="DocumentHeaderDependency"/>          
          ...
          <xsl:call-template name="ItemizedDedNotChargedBooksSchTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
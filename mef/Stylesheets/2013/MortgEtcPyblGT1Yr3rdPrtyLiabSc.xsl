  ...
  <xsl:template name="MortgEtcPyblGT1Yr3rdPrtyLiabSc">
    <table id="GeneralDependencyTbl" class="styDepTblLandscape">
      <tr class="styDepTblHdr">
        ...
        <th class="styDepTblCell" style="width:89mm;text-align:center;" scope="col">Explanation</th>
      ...
      <xsl:for-each select="$DependencyData/MortgEtcPyblGT1Yr3rdPrtyInfo">
        ...
        <tr>
          ...
          <td class="stydepTblCell" style="width:89mm;text-align:left;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="Desc"/>
            </xsl:call-template>
          </td>
          <!-- Beginning Amount -->
          <td class="styDepTblCell" style="width:36mm;text-align:left; text-align:right;">

        ...
        <form name="Form4972">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:150.5mm;">
					<span style="float:left;">Did you use Form 4972 after 1986 for a previous distribution from your own plan? If "Yes," <b>do not</b> use this<br/>form for a 2013 distribution from your own plan
						<!--Dotted Line-->
					<span class="styBoldText" style="padding-left:1mm">
										<span style="width:2.6mm"/>.
										<span style="width:2.6mm"/>.
          ...
          <div class="pageEnd" style="width:{$pageWidth}mm;padding-top:0mm;">
            ...
            <div style="float:right;width:80mm;text-align:right">
							...
							Form 
							<span class="styBoldText" style="font-size:8pt;">4972</span> (2013)
                           </div>
          </div>

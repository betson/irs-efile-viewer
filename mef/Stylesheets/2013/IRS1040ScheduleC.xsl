...
<div style="width:187mm;font-size:7pt;float:none;clear:both;">
	...
	<div class="styLNDesc" style="width:139.5mm;height:4mm;">Cost of goods sold (from line 42)
		<!--Dotted Line-->
		<span class="styBoldText">
			<span style="width:16px;"></span>.
			<span style="width:16px;"></span>.
...
<div class="styBB" style="width:187mm;float:none;clear:both;">
	...
	<div class="styPartDesc" style="font-weight: normal;"> <b>Expenses.  Enter expenses for business use of your home only on line 30.</b>        
	</div>
</div>
<!-- END Part II Title -->    
	...
	<table class="styTable" style="width:94mm;float:left;font-size:7pt;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:41mm;font-size:7pt;padding-top:0mm;padding-bottom:0mm;" colspan="1">Car and truck expenses (see <br/>instructions)
					<xsl:call-template name="SetFormLinkInline">
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:43mm;height:5mm;" >Contact labor (see instructions)
				</td>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:41mm;height:5mm;" >Depletion
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>. 
						<span style="width:16px"></span>.  
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:41mm;padding-top:0mm;padding-bottom:0mm;" >Depreciation and section 179<br/> expense deduction (not <br/> included in Part III) (see instructions)
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.    
						<span style="width:16px"></span>.
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:41mm;padding-bottom:0mm;padding-top:0mm;" >Employee benefit programs<br/> (other than on line 19)
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.
						<span style="width:12px"></span>.        
			...
			<tr>
				<td class="styLNLeftNumBoxSD" style="height:100%;width:6mm;">
					<span style="width:3mm;"></span>  b
				</td>
				<td class="styGenericDiv" style="width:45mm;height:5mm;" >Other
					<xsl:call-template name="SetFormLinkInline">
			...
			<!--Line 17-->
			<tr>
				<td class="styLNLeftNumBox" style="width:5mm;padding-bottom:0mm;"><div style="height:5.8mm;padding-top:1mm;">17</div></td>
	...
	<table class="styTable" style="width:93mm;float:left;font-size:7pt;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:45mm;font-size:6pt;padding-top:0mm;padding-bottom:0mm;">Vehicles, machinery, and equipment
					<!--Dotted Line-->
					<span class="styBoldText">  
						<span style="width:16px"></span>.
					</span>  
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:45mm;padding-top:0mm;padding-bottom:0mm;" >Other business property 
					<!--Dotted Line-->
					<span class="styBoldText">  
						<span style="width:16px"></span>.
						<span style="width:16px"></span>.
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:48mm;padding-top:0mm;padding-bottom:0mm;" >Repairs and maintenance
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.    
						<span style="width:16px"></span>.              
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:48mm;padding-top:0mm;padding-bottom:0mm;" >Taxes and licenses
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.    
						<span style="width:16px"></span>. 
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:45mm;padding-top:0mm;padding-bottom:0mm;">Travel
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.    
						<span style="width:16px"></span>. 
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:48mm;padding-top:0mm;padding-bottom:0mm;" >Utilities
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.  
						<span style="width:16px"></span>.    
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:48mm;padding-top:0mm;padding-bottom:0mm;" >Other expenses (from line 48)
					<!--Dotted Line-->
					<span class="styBoldText">
						<span style="width:16px"></span>.     
					</span>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:45mm;padding-top:0mm;padding-bottom:0mm;" > <b>Reserved for future use</b>
					<!--Dotted Line-->
					<span class="styBoldText">  
						<span style="width:16px"></span>.
						<span style="width:16px"></span>.
...
<div class="pageEnd" style="width:187mm;float:none;clear:both;">  
    ...
    <div class="styBB" style="width:187mm;">
      ...
      <div class="styPartDesc" style="font-weight: normal;"><b>Cost of Goods Sold </b>(see instructions)<span class="styNormalText"></span>             
      </div>
    </div>
    <!-- END Part III Title -->
 <!--Line 33--> 
 ...
 <!--Line 41-->   
    <div style="width:187mm;font-size:7pt;">      
      ...
      <div class="styLNDesc" style="width: 139mm; height:4mm;">        
        <b>Cost of goods sold.</b> Subtract line 41 from line 40. Enter the result here and on line 4
        <!--Dotted Line-->
        <span class="styBoldText">
          <span style="width:16px"></span>.
          <span style="width:16px"></span>.    

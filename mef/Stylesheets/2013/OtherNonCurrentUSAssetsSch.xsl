...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!--1120F displays as - Other Non-Current US Assets Schedule -->
	...
	<xsl:template name="OtherNonCurrentUSAssetsSchTemp">
		<table id="GeneralDependencyTbl" class="styDepTbl">
			<tr class="styDepTblHdr">
				...
				<xsl:choose>
					<xsl:when test="$DependencyData/OtherNonCurrentUSAssetsGrp/CorporationEIN">
				...
				<th class="styDepTblCell" scope="col" style="width:45mm;text-align:center;" >Description</th>
				<th class="styDepTblCell" scope="col" style="width:36mm;text-align:center;" >Beginning Amount</th>
				<th class="styDepTblCell" scope="col" style="width:36mm;text-align:center;" >Ending Amount</th>
			</tr>
			<xsl:for-each select="$DependencyData/OtherNonCurrentUSAssetsGrp">
      <tr>
        ...
        <td class="styDepTblCell" style="width:45mm;text-align:left;">
		  <xsl:attribute name="rowspan">
			<xsl:value-of select="count(OtherNonCurrUSAssetsLnItemGrp)"/>
          </xsl:attribute>
        ...
        <xsl:for-each select="OtherNonCurrUSAssetsLnItemGrp">

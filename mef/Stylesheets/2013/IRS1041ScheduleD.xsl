    ...
    <html>
      ...
      <body class="styBodyClass">
        <form name="Form1041ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
              ...
              <div style="padding-top:2mm;">
                <span style="font-weight:bold; height:4mm;">
                  ...
                  <img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/> Use Form 8949 to list your transactions for lines 1b, 2, 3, 8b, 9, and 10. <br />
                   <img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/> Information about Schedule D and its separate instructions is at <i>www.irs.gov/form1041.</i>
                </span>              
              </div>
           ...
           <!--<div style="padding-left:7mm;font-size:6pt;width:30mm;font-weight:bold;" >Version A, Cycle 1</div>-->
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;padding-top:3.5mm;">20<span style="color:green;">13</span>
              </div>
          ...
          <!-- END TAXPAYER INFO -->
          <!-- BEGIN NOTE -->
           <div class="styBB" style="width:187mm;padding-left:2px;">
            <span style="font-size:9pt;font-weight:bold;">Note:</span><span style="font-size:9pt;font-style:italic;"> Form 5227 filers need to complete <span style="font-weight:bold;">only</span> Parts I and II.</span>
          </div>
          <!-- END NOTE -->
          <!-- BEGIN PART I HEADER -->
		  <div class="styBB" style="width:187mm;">
          ...
          <div>
            <table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                ...
                <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(d)</span><br/>Proceeds<br/>(sales price)</th>
                <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(e)</span><br/>Cost<br/>(or other basis)</th>
                <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;font-size:6pt;" scope="col">
                  <span style="font-weight:bold;">(g)</span> Adjustments to gain or loss from Form(s) 8949, Part I, line 2, column (g)</th>
                  <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;font-size:6pt; border-right-width:0px;" scope="col">
                  <span style="font-weight:bold;">(h)</span> Gain or (loss)<br/>Subtract column (e) from column (d) and combine the result with column (g)</th>
              </tr>
          ...
          <div class="styGenericDiv" style="width:187mm;height:8mm;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				Short-term capital loss carryover. Enter the amount, if any, from line 9 of the 2012 Capital Loss <br/>
          ...
          <div class="styGenericDiv" style="width:187mm;height:8mm;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				...
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					...
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
					<span style="width:11px;"/><img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/>
				</span>
            </div>
            <div class="styLNRightNumBox" style="height:8mm;border-bottom:0px;"><br/>7</div>
            <div class="styLNAmountBox" style="height:8mm;border-bottom:0px;">
				<br/>
				<xsl:call-template name="PopulateAmount">
            ...
            <table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                ...
                <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(e)</span><br/>Cost<br/>(or other basis)</th>
                <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;font-size:6pt;" scope="col">
                  <span style="font-weight:bold;">(g)</span> Adjustments to gain or loss from Form(s) 8949, Part II, line 2, column (g)</th>
                  <th class="IRS1041ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;font-size:6pt; border-right-width:0px;" scope="col">
                  <span style="font-weight:bold;">(h)</span> Gain or (loss)<br/>Subtract column (e) from column (d) and combine the result with column (g)</th>
              </tr>
          ...
          <div class="styGenericDiv" style="width:187mm;height:8mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				Long-term capital loss carryover. Enter the amount, if any, from line 14 of the 2012 Capital Loss <br/>
				<span style="float:left;">Carryover Worksheet</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;height:8mm;float:none;clear:both;">
            ...
            <div class="styLNRightNumBox" style="height:8mm;border-bottom:0px;"><br/>16</div>
            <div class="styLNAmountBox" style="height:8mm;border-bottom:0px;">
				<br/>
				<xsl:call-template name="PopulateAmount">
        ...
        <div class="styBB" style="width:187mm;">
          ...
          Summary of Parts I and II<br /><span style="font-size:8pt;font-weight:normal;"><span style="width:3mm;"/><b>Caution: </b> <i>Read the instructions <b>before</b><br />
          <span style="width:3mm;"/>completing this part.</i></span>
			</div>
			<div class="IRS1041ScheduleD_styPartIIIHeader"><b>(1)</b> Beneficiaries’<br />(see instr.)</div>
			<div class="IRS1041ScheduleD_styPartIIIHeader"><b>(2)</b> Estate’s<br />or trust’s</div>
			<div class="IRS1041ScheduleD_styPartIIIHeader" style="padding-top:4.5mm;"><b>(3)</b> Total</div>
        	</div> 
        <!-- END PART III HEADER -->
        <!-- BEGIN LINE 17 -->               
          <div class="styGenericDiv" style="width:187mm;">
          ...
          <div class="styGenericDiv" style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:74.8mm;">
				<span style="float:left;"><b>Total net gain or (loss).</b> Combine lines 17 and 18a</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. <img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/></span>							
            </div>
...
gains, go to Part V, and <b>do not</b> complete Part IV. If line 19, column (3), is a net loss, complete Part IV and the <b>Capital Loss Carryover Worksheet,</b> as
necessary.</i></div>
          <!-- END Note -->         
        <!--  PART IV HEADER -->
        <div class="styBB" style="width:187mm;">
        ...
        <!-- BEGIN LINE 20 -->               
         ...
         <!-- BEGIN Note -->
           <div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;border-bottom:1px solid black;">
           <b>Note: </b> <i> If the loss on line 19, column (3), is more than $3,000, <b>or</b> if Form 1041, page 1, line 22 (or Form 990-T, line 34), is a loss, complete the <b>Capital
Loss Carryover Worksheet</b> in the instructions to figure your capital loss carryover.</i></div>
          <!-- END Note -->  
         <!--  PART V HEADER -->
        <div class="styBB" style="width:187mm;float:none;clear:both;">
            <span class="styPartName" style="width:17mm;font-size:9pt;">Part V</span>
			<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:9pt;">
			<span style="width:3mm;"/>Tax Computation Using Maximum Capital Gains Rates<br /></div>
			<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;font-weight:normal;">
			<b>Form 1041 filers.</b> Complete this part <b>only</b> if both lines 18a and 19 in column (2) are gains, or an amount is entered in Part I or Part II and there is an
			entry on Form 1041, line 2b(2), <b>and</b> Form 1041, line 22, is more than zero.<br /></div>
			<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;font-weight:normal;">
			...
			• <i>Both Form 1041, line 2b(1), and Form 4952, line 4g are more than zero.</i><br /></div>
			<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;font-size:8pt;font-weight:normal;">
			<b>Form 990-T trusts.</b> Complete this part <b>only</b> if both lines 18a and 19 are gains, or qualified dividends are included in income in Part I of Form 990-T,
			<b>and</b> Form 990-T, line 34, is more than zero. Skip this part and complete the <b>Schedule D Tax Worksheet</b> in the instructions if either line 18b, col. (2) or
		...
		<!--
          <div class="styGenericDiv" style="width:187mm;">
            ...
            <div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:4mm;" />
          </div>            --> 
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            <div class="styLNLeftNumBox" style="height:4.4mm;">28</div>
            <div class="styLNDesc" style="width:98.8mm;height:4.4mm;">
				<span style="float:left;">Enter the <b>smaller</b> of the amount on line 21 or $2,450</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:98.8mm;">
				<span style="float:left;">Enter the smaller of line 21 or line 26</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:98.8mm; height:4.4mm;">
				<span style="float:left;">Enter the <b>smaller</b> of line 21 or $11,950</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:138.75mm;">
				<span style="float:left;">Multiply line 36 by 15%</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:138.75mm;">
				<span style="float:left;">Multiply line 40 by 20%</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            ...
            <div class="styLNDesc" style="width:98.8mm;">
				Figure the tax on the amount on line 27. Use the 2013 Tax Rate Schedule<br />
          ...
          <!-- BEGIN LINE 44 -->                       
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            <div class="styLNLeftNumBox" style="height:11.6mm;">44</div>
            <div class="styLNDesc" style="width:98.8mm;height:11.6mm;">
				Figure the tax on the amount on line 21. Use the 2013 Tax Rate Schedule<br/>
				for Estates and Trusts (see the Schedule G instructions in the instructions<br/>
				<span style="float:left;">for Form 1041)</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					. 
            ...
            <div class="styLNRightNumBox" style="height:11.6mm;border-bottom-width:1px;"><br /><br />44</div>
            <div class="styLNAmountBox" style="height:11.6mm;border-bottom-width:1px;"><br /><br />
				<xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$FormData/TaxOnTaxableIncomeAmt"/>
				</xsl:call-template>
            </div>   
            <div class="styLNRightNumBox" style="width:8mm;height:11.6mm;background-color:lightgrey;border-bottom-width:0px;" />
            <div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:11.6mm;" />
          </div>
          <!-- END LINE 44 -->          
          <!-- BEGIN LINE 45 -->                       
          <div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
            <div class="styLNLeftNumBox" style="height:8mm;">45</div>
            <div class="styLNDesc" style="width:138.75mm; height:8mm;">
            ...
            <div class="styLNRightNumBox" style="height:8mm;border-bottom-width:0px;"><br />45</div>
            <div class="styLNAmountBox" style="height:8mm;border-bottom-width:0px;"><br />
				<xsl:call-template name="PopulateAmount">

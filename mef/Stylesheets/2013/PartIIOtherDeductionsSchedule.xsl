...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/PartIIOtherDeductionsSchedule"/>
    ...
    <table class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">      
           <th class="styDepTblCell" scope="col" style="width:152mm">Type of deduction</th>
           <th class="styDepTblCell" scope="col" style="width:35mm">Deduction amount</th>             
        </tr>
      </thead>
        <tfoot/>
       <tbody>

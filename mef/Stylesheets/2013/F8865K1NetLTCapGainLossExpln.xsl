...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/F8865K1NetLTCapGainLossExpln"/>
		...
		<table id="AccountingFeesScheduleTbl" class="styDepTbl">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">
					<th class="styDepTblCell" scope="col">Form 8865 K1 Net Long Term Capital Gain Loss Explanation</th>
				</tr>
			</thead>
			<xsl:for-each select="$DependencyData/F8865K1NetLTCapGainLossGrp">
				<tr>

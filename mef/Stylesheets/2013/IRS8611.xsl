				...
				<form name="Form8611">
						...
						<div class="styFTBox" style="width:125mm;">
							...
							<div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold">
								...
								<div style="height:3.5mm;font-size:7pt;padding-top:.5mm;border:0px;" class="styFST">
									...
									Information about Form 8611 and its instructions is at 
								...
								Note: 
								<span class="styItalicText"> Complete a separate Form 8611 for each building to</span><br/>
								<span class="styItalicText"> which recapture applies.</span>
								</div>
							</div>
						</div>
					...
					<div class="styBB" style="width: 187mm">
						<div class="styGenericDiv" style="font-size: 8pt">
								...
								<span class="styItalicText" style="padding-left:9.5mm;"> estate, or trust).</span>						
						</div>
					</div>
					<!--  End Note  -->
					<!--  Line 1 -->

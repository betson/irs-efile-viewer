						...
						<div class="styFTBox" style="width:125mm">
							...
							<div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold">
								...
								<div style="height:3.5mm;font-size:7pt;padding-top:.5mm;border:0px;" class="styFST">
									<img src="{$ImagePath}/8611_Bullet.gif" alt="Bullet Image"/>Information about Form 8611 and its instructions is at 
								<a href="http://www.irs.gov/form8611" title="Link to IRS.gov">
										<i>www.irs.gov/form8611.</i>
									</a>
								</div>
								<div style="padding-top:1mm;">Note: 
        <span class="styItalicText"> Complete a separate Form 8611 for each building to<br/>which recapture applies.</span>
								</div>
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:20mm; border-left-width: 1px">
							<div class="styOMB" style="height:10mm;padding-top:3mm">OMB No. 1545-1035</div>
							<div class="stySequence" style="height: 10mm;padding-top:3mm">Attachment<br/>Sequence No. <b>90</b>
							</div>
						</div>
					</div>
					<!--  End title of Form  -->
					...
					<div class="styBB" style="width:187mm; height: 8mm">
						...
						<div class="styEINBox" style=" padding-left:2mm;font-size:7pt;">
							<span class="BoldText">B Identifying number</span>
					...
					<div class="styBB" style="width: 187mm; height: 13mm">
						<div class="styNameAddr" style="height: 19mm; padding-left:0px; width: 100mm; border-right-width: 1px;font-size:7pt;border-bottom:0px;">
						...
						<div class="styNameAddr" style="height: 13mm; width: 46mm;font-size:7pt;border-bottom:0px;">
					...
					<div style="width: 187mm; height: 13mm">
						<div class="styNameAddr" style="height: 13mm; padding-left:0px; width: 141mm; border-right-width: 1px;font-size:7pt">
							...
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/IssuerName/BusinessNameLine1"/>
							</xsl:call-template>
							<xsl:if test="$FormData/IssuerName/BusinessNameLine2">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/IssuerName/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
						</div>
					...
					<div style="width: 187mm; height: 7mm">
						<div class="styNameAddr" style="height: 7mm; padding-left:0px; width: 141mm; border-right-width: 1px;font-size:7pt">
							<span class="styBoldText">(3) </span> Name of issue<br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/IssueNm"/>
							</xsl:call-template>
						</div>
						<div class="styNameAddr" style="height: 7mm; width: 46mm;font-size:7pt">
					...
					<div class="styBB" style="width: 187mm">
						<div class="styGenericDiv" style="font-size: 8pt">
							...
							<span class="styItalicText">Skip lines 1–7 and go to line 8 if recapture is passed through from a flow-through entity (partnership, S corporation,       
									<br/>
								<span style="width: 9mm"/>estate, or trust).</span>
						</div>
					</div>
					<!--  End Note  -->
					<!--  Line 1 -->
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox"/>
						<div style="float:left">
							  here. (<span class="styBoldText">Note: </span>
							<span class="styItalicText">An estate or trust enters on line 8 only its share of recapture amount attributable to the</span>
						</div>
						<div style="float:right">
							<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;"/>
							<div class="styLNAmountBoxNBB" />
					...
					<div class="styBB" style="width: 187mm; border-top-width: 0px">
						<div class="styPartDesc" style="padding-left:0px;padding-top:2mm;padding-bottom:2mm;">Only Section 42(j)(5) partnerships need to complete lines 16 and 17.
						</div>
					</div>
					<!--  End Only Section -->
					<!--  Line 16 -->
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<span style="width:90px;"/>                      
								Cat. No. 63983Q 
						<span style="width:97px;"/>  
								Form <span class="styBoldText">8611</span> (Rev. 12-2013)
					</div>

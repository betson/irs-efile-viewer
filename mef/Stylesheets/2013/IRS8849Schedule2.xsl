...
<!-- 05/18/12 - Made changes per defect #32729 - Jeremy Nichols -->
  ...
  <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
        ...
        claimant must complete line 6 or 7 on page 3.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:4.5mm;padding-top:1mm">
              <span style="width:39mm;clear:none"/>
              <span class="styBoldText">
                <img src="{$ImagePath}/8849Schedule2_Bullet_Md.gif" alt="MediumBullet"/>
              </span>
              <span style="width:12px;clear:none"/>
              ...
              <span style="width:48mm;border-bottom:1px black solid;text-align:left;clear:none">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData/RegNbrUB"/>
                </xsl:call-template>
              </span>
              <span style="width:5mm"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:4.5mm;padding-top:2mm">
              ...
              <span style="width:48mm;border-bottom:1px black solid;text-align:left;clear:none">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData/RegNbrUP"/>
                </xsl:call-template>
              </span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;height:4.5mm;padding-top:3mm">
              ...
              <span style="width:48mm;border-bottom:1px black solid;text-align:left;clear:none">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$FormData/RegNbrUA"/>
                </xsl:call-template>
              </span>
              <span style="width:5mm;clear:none;"/>
              ...
              <span style="width:5px;clear:none;"/>
              ...
              <div class="styLNDesc" style="width:179mm;height:1px;">
                <span style="width:12px;clear:none"/>
                <span style="width:20px;clear:none;font-weight:bold;text-align:right;"/>
                <span style="width:94.5mm;text-align:left;clear:none"/>
          ...
          <div class="styBB" style="width:187mm;border-top:1px black solid;">
            <div class="styLNLeftNumBox" style="height:8mm;text-align:left;padding-bottom:2mm;">
              <br/>1</div>
            <div class="styLNDesc" style="width:100mm;height:8mm;padding-bottom:2mm;">
              <span class="styBoldText">
          ...
          <div style="width:187mm;font-size:7pt;">
            ...
            <div class="styLNDesc" style="width:170mm;height:16mm;text-align:justify;">
              <span class="styText">
				Claimant sold the diesel fuel at a tax-excluded price, repaid the amount of tax to the buyer, or obtained written consent of the buyer to make the claim. <b>For line 1a, </b>
				claimant has obtained the required certificate from the buyer and has no reason to believe any information in the certificate is false. <b>For line 1b, </b>
				the registered ultimate vendor is eligible to make this claim only if the buyer waives their right to make the claim by providing the registered ultimate vendor with an unexpired waiver and has no reason to believe any of the information in the waiver is false. See the instructions for additional information to be submitted. 
			  </span>
            </div>
            <div style="width:187mm;">
      ...
      contain visible evidence of dye, attach an explanation and</span>
         ...
         <span style="width:16px"/>.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:170mm;height:7mm;text-align:justify;">
            <span class="styText"><b>Caution. </b>
				<i>Claims cannot be made on line 1a for diesel fuel purchased by a state or local government for its exclusive use with a 
					credit card issued to the state or local government by a credit card issuer.</i>
			</span>
            </div>
          </div>
          <div style="width:187mm;">
            <table style="font-size:7pt;border-collapse:collapse;width:187mm">
              <tbody>
                <tr>
        ...
        <span style="width:3.3mm;clear:none"/>
          ...
          <div class="styBB" style="width:187mm;border-top:1px black;">
            <div class="styLNLeftNumBox" style="height:8mm;text-align:left;padding-bottom:2mm;">
              <br/>2</div>
            <div class="styLNDesc" style="width:150mm;height:8mm;padding-bottom:2mm;">
              <span class="styBoldText">
          ...
          <div style="width:187mm;font-size:7pt;">
            <div class="styLNLeftNumBox" style="height:22mm;width:8mm;"/>
            <div class="styLNDesc" style="width:170mm;height:22mm;text-align:justify;">
              <span class="styText">Claimant sold the kerosene at a tax-excluded price, repaid the amount of tax to the buyer, or obtained written consent of
                  the buyer to make the claim. <b>For line 2a,</b>                  
				  claimant has obtained the required certificate from the buyer and has no reason to believe any information in the certificate is false. <b>For line 2b, </b>
                  ...
                  of kerosene sold to the buyer. <b>For line 2c, </b>
				  the registered ultimate vendor is eligible to make this claim only if the buyer waives their right to make the claim by providing
    ...
    Cat. No. 27450U
        ...
        Name as shown on Form 8849<br/>
          ...
          <!-- Line 3 Sales-->
          <div class="styBB" style="width:187mm;border-top:1px black;height:6mm;">
          ...
          <div style="width:187mm;font-size:7pt;">
            ...
            <div class="styLNDesc" style="width:170mm;height:20mm;text-align:justify;">
              <span class="styText">
                  ...
                  repaid the amount of tax to the buyer, or has obtained written consent of the buyer to make the claim.
                  <b>For lines 3a, 3b, 3d, 3e, and 3f,</b> the registered ultimate vendor is eligible to make this claim only if the buyer waives their right to make the claim by providing
                  the registered ultimate vendor with an unexpired waiver and has no reason to believe any of the information in the waiver
                  is false. <b>For line 3c,</b>
				  claimant has obtained the required certificate from the buyer and has no reason to believe any of the information in the certificate
                  is false. See the instructions for additional information to be submitted.
				  </span>
            </div>
          </div>
            ...
            <table style="font-size:7pt;border-collapse:collapse;width:187mm;">
              <tbody>
                <tr>
                  ...
                  <th scope="col" style="width:13mm;height:6.5mm;border-left:1px black solid;border-bottom:1px black solid;text-align:right;border-top:1px black solid;" valign="top">
					  Type of <br/>use
				  </th>
          ...
          Use in commercial aviation (other than foreign trade)<br/> taxed at $.244
                ...
                <tr>
                  ...
                  <td style="height:3mm;border-left:1px black solid;border-bottom:1px black solid;text-align:right;">
                    <span style="height:3mm;width:0.5m;text-align:bottom;text-align:left;padding-top:0mm;"/>
      ...
      additional information to be submitted.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:170mm;height:12mm;text-align:justify;">
              <span class="styText"> <b>Caution. </b>
              <i>Claims cannot be made on line 4a or 4b for gasoline purchased by a state or local government or a nonprofit 
				educational organization for its exclusive use with a credit card issued to the state or local government or nonprofit 
				educational organization by the credit card issuer.</i>
			</span>       
            </div>
          </div>
          <!--new 4 sales table-->
          ...
          <span style="width:2mm;clear:none;"/>
                  ...
                  <td style="height:8mm;border-left:1px black solid;border-bottom:1px black solid;text-align:right;" valign="bottom">
                    <span style="width:.5mm;text-align:bottom;text-align:left;">$</span>
                ...
                <tr>
                  ...
                  <td style="height:6.5mm;border-left:1px black solid;border-bottom:1px black solid;text-align:right;" valign="bottom">
                    <span style="width:.5mm;text-align:bottom;text-align:left;"/>
                    <span style="width:46.5mm;">
                      <xsl:call-template name="PopulateAmount">
      ...
      additional information to be submitted.
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:170mm;height:12mm;text-align:justify;">
              <span class="styText"><b>Caution. </b> 
              <i>Claims cannot be made on line 5a or 5b for aviation gasoline purchased by a state or local government or a nonprofit 
				educational organization for its exclusive use with a credit card issued to the state or local government or nonprofit 
				educational organization by the credit card issuer.</i>
			  </span>
    ...
    each governmental unit to whom the fuel was sold. If more space is needed, attach additional sheets.
          ...
          <div class="styBB" style="width:187mm;border-top:1px black;border-bottom:0px;">
            <div class="styTableContainer" style="height:auto;" id="PSOctn">
              ...
              <table style="font-size:7pt;border-collapse:collapse;width:187mm;" cellspacing="0">
                <thead>
                  <tr>
                    <th scope="col" style="width:44mm;height:7.7mm;border:0 black solid;border-right-width:1px;border-bottom-width:1px;text-align:center;">Taxpayer Identification No.
				    </th>
                    <th scope="col" style="width:99mm;height:7.7mm;border-left:1px black solid;border:0 black solid;;border-bottom-width:1px;text-align-center">Name
				    </th>
                    <th scope="col" style="width:42mm;height:7.7mm;border-left:1px black solid;border:0 black solid;border-bottom-width:1px;text-align:center;">Gallons
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <xsl:if test="count($FormData/GovernmentUnitInformation) &lt; 1 or (count($FormData/GovernmentUnitInformation) &gt; 11 and ($Print = $Separated))">
                    <tr>
                      <td style="width:44mm;height:7.7mm;border:0 black solid;border-right-width:1px;
              ...
              border:0 black solid;border-right-width:1px;border-bottom-width:1px;">
                        <span style="width:1px;"/>
                      </td>
                      <td style="width:35mm;height:7.7mm;border-left:1px black solid;
              border:0 black solid;border-bottom-width:1px;text-align:right;">
                        <span style="width:1px;"/>
                      </td>
                    </tr>
                  </xsl:if>
              ...
              border-bottom-width:1px;text-align:right;">
                        <span style="width:1px;"/>
                      </td>
                    </tr>
                  </xsl:if>
              ...
              border-bottom-width:1px;text-align:right;">
                  ...
                  <xsl:if test="count($FormData/GovernmentUnitInformation) &lt; 11 or (count($FormData/GovernmentUnitInformation) &gt; 11 and ($Print = $Separated))">
                    <tr>
                      <td style="width:44mm;height:7.7mm;border-right-width:1px;text-align:center;">
                        <span style="width:1px;"/>
                      </td>
                      <td style="width:99mm;height:7.7mm;border-left:1px black solid;border-right-width:1px;">
                        <span style="width:1px;"/>
                      </td>

  ...
  <xsl:template match="/">
   ...
   Name(s) shown on Form 1040<br/>
        ...
        border-bottom-width:0px;height:4mm;"/>
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.5mm;background-color:lightgrey;
        ...
        border-bottom-width:1px;">10</div>
          ...
          <div class="styBB" style="width:187mm;height:10mm">
            <div class="styIRS1040ScheduleAleftBox" style="width: 20mm; height:10mm;font-size:7.1pt;
              border-left-width:0px;border-right-width:0px;padding-top:1mm;">
          ...
          <div class="styBB" style="width:187mm;height:32mm">
				...
				<label>
                   ...
                   <xsl:with-param name="BackupName">IRS1040SchAItemizedLimitationsByFSInd</xsl:with-param>
							...
							Your deduction is not limited. Add the amounts in the far right column for lines 4		                     
							  <span style="width:18.5mm;"></span>through 28. Also, enter this amount on Form 1040, line 40.
				<br/>					          								
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.2mm;border-bottom-width:1px;font-size:6.7pt;">
              29</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:4.2mm;padding-right:.5mm;
              border-bottom-width:1px;font-size:6pt">
              <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;clear:both;">
            ...
            <div style="float:right;" class="styGenericDiv">
              <span class="styBoldText">Schedule A (Form 1040) 2013</span>
            </div>
          </div>

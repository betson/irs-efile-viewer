       ...
       <div class="styBB" style="width:187mm">
        <div style="float:left; width:108mm; border-right:1px solid black; padding-bottom:0.5mm">
            ...
            <div style="margin-top:0.5mm">  
              <div style="float:left">  
                ...
                <span style="border-bottom:1px solid black; width:18mm;font-size:8pt;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form3115Data/WhoIsFilingForm/OtherApplicantTypeInd/@description"/>
                  </xsl:call-template>  
                </span>
              </div>      
            </div>                    
          ...
          <div class="stySmallText" style="float:left; margin-top:1mm">            
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form3115Data/WhoIsFilingForm/ExemptOrganizationInd/@codeSection"/>
            </xsl:call-template>  
          </div>                  
        </div>
          ...
          <div style="margin-top:3.5mm">
            ...
            <div style="margin-top:0.5mm">
              ...
              <div style="border-bottom:1px solid black; width:47mm; float:right">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form3115Data/TypeOfAccountingMethod/OtherApplicantTypeInd/@description"/>
                </xsl:call-template>    
              </div>
            </div>                                    
          </div>  
         ...
         change. See instructions. <br/>             
          <div style="padding-top:1mm">
            ...
            <span style="border-bottom:1px solid black; width:102mm; font-size:7pt">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form3115Data/MethodOfAccountingOtherInd/@description"/>
              </xsl:call-template>   
            </span>
          </div>
        </div>
       ...
       <div style="width:187.5mm; text-align:center; font-size:7pt">
        ...
        <div style="width:187mm">
          <div style="float:left; width:90mm; text-align:center">
            ...
            <div style="border-bottom:1px solid black; width:100%; height:8mm">
         <xsl:call-template name="PopulateReturnHeaderOfficer"> 
            ...
            <div style="border-bottom:1px solid black; width:100%; height:8mm; line-height:105%; text-align:left;">                
          <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine1</xsl:with-param></xsl:call-template><br/>
          <xsl:call-template name="PopulateReturnHeaderFiler"><xsl:with-param name="TargetNode">BusinessNameLine2</xsl:with-param></xsl:call-template>
            </div>
		...
		<xsl:call-template name="PopulateReturnHeaderPreparer"> 
		   <xsl:with-param name="TargetNode">PTIN</xsl:with-param> 
            ...
            <div style="border-bottom:1px solid black; width:100%; text-align:left; height:auto">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form3115Data/PreparerFirmName/BusinessNameLine1"/>
              </xsl:call-template>
              <br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form3115Data/PreparerFirmName/BusinessNameLine2"/>
              </xsl:call-template>                
              <xsl:call-template name="PopulateText">
          ...
          <table class="styTable" style="font-size:7pt;font-weight:normal; width:100%; border-bottom:0" cellspacing="0" cellpadding="0" border="0">  
            <thead class="styTableThead">
              <tr align="left" style="height:8mm">
                ...
                <th class="styIRS3115TblRB" style="width:6.6mm; border-bottom:0; background-color:lightgrey" scope="col"> </th>                
                <th style="border-bottom:0; background-color:lightgrey;width:7mm; " scope="col"> </th>
              </tr>  
            </thead>  
            <tfoot/>
            <tbody>    
      ...
      <div style="width:187mm">  
        ...
        <div style="float:left">
          ...
          <span style="width:40mm; border-bottom:1px solid black; text-align:center">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form3115Data/NetSectionAdjustmentAmt/@increaseOrDecreaseIndicator"/>
            </xsl:call-template>  
...
If line 2c is No, is the applicant requesting to use the exempt-contract percentage-of-completion
      ...
      <table style="width:187mm; font-size:9pt" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <th  scope="col"  style="font-weight:normal;width:100mm;text-align:left;height:4.5mm;padding-left:3mm;" nowrap="nowrap" valign="center">
            ...
            Check the appropriate boxes below.
                   ...
                   <!--th scope="col"  align="left" nowrap="nowrap" style=" font-weight:normal" valign="bottom">
        ...
        <tr  align="center">
          ...
          <td class="styIRS3115TblRB2" style="font-weight:normal; width:25mm">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form3115Data/IRS3115ScheduleD/InventoryNotBeingChanged/PresentMethodTxt/Methods/SpecificIdentificationInd"/>            </xsl:call-template>
          </td>          
        </tr>
        <tr align="center">
...
Proc. 2008-52 (or its successor).
      ...
      <div class="styBB" style="width:187mm; border-top:2px solid black;height:auto;">
    ...
    <tr>    
      ...
      <td>
        ...
        <div class="styGenericDiv">
          ...
          <div class="styIRS3115YNChxBoxDiv">  
            <span class="styDotLn" style="padding-left:1mm; padding-right:0">      
              .........
            </span>    
            <span>
              <xsl:call-template name="PopulateSpan">
        ...
        <div class="styGenericDiv">
          ...
          <div class="styIRS3115YNChxBoxDiv">  
            <span class="styDotLn" style="padding-left:3.5mm;padding-right:0;background-color:yellow;">
            ..      
            </span>  
            <span>
              <xsl:call-template name="PopulateSpan">
    ...
    <div class="styGenericDiv">
      <div style="padding-left:.5mm;padding-right:1mm;font-weight:bold;width:6mm;text-align:left;" class="styGenericDiv">3</div>
       <div style="text-align: left;float:left">
        ...
        <div class="styIRS3115YNChxBoxDiv">  
          <span class="styDotLn" style="padding-left:0.5mm;padding-right:0">     
          .. 
          </span>    
          <span>
            <xsl:call-template name="PopulateSpan">

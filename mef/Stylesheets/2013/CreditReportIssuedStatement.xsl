        ...
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:left;width:45mm">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="RecipientName/BusinessNameLine1"/>
                </xsl:call-template>
                <xsl:if test="RecipientName/BusinessNameLine2">             
                  <br/>
                   <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="RecipientName/BusinessNameLine2"/>
                  </xsl:call-template>
              </xsl:if>
          </td>          

  ...
  <xsl:template match="/">
	...
	<html>
      ...
      <body class="styBodyClass">    
        ...
        <xsl:call-template name="PopulateDepCommonLeftover"><xsl:with-param name="TargetNode" select="$Form3115Deps8Data"/>
        </xsl:call-template>      
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left">          
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form3115Deps8Data/MethodUsedToPrepareBalSheet"/>
            </xsl:call-template>                  
          </div>                  
        </div>        
        <div class="styTopSectionLine">          
          ...
          <div class="styExplanationLine" style="float:left">          
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form3115Deps8Data/ExplanationOfDifferencesTxt"/>
            </xsl:call-template>                  
          </div>                  
        </div>      
      </body>

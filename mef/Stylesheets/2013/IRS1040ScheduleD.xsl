      ...
      <body class="styBodyClass">
        <form name="Form1040ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
            ...
            <div class="styFTBox" style="width:130mm;height:20mm;">
              ...
              <div>
                <span style="font-weight: bold;height: 4mm;">   
                  <img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/> Information about Schedule D and its separate instructions is at <i>www.irs.gov/form1040.</i>
                </span>
              </div>
              <div>
                <span style="font-weight: bold;height: 4mm;">
           ...
           <!--<div style="padding-left:7mm;font-size:6pt;width:30mm;font-weight:bold;" >Version A, Cycle 1</div>-->
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;">20<span style="color:green;">13</span>
              </div>
          ...
          <div class="styGenericDiv" id="STCapGainTableContainer">
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(g)</span> Adjustments to <br/>gain or loss from <br/>Form(s) 8949, Part l, <br/>line 2, column (g)</th>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalShortTermReportOnF1099B/TotalProceedSalesPriceAmt"/>
						</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalShortTermReportOnF1099B/TotalCostOrOtherBasisAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="background-color:lightgrey">
				<br/>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="border-right-width:0px;">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalShortTermReportOnF1099B/TotalGainOrLossAmt"/>
					</xsl:call-template>
				</td>
              </tr>
              <!-- Line 1b -->
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BShowsBasisGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BNotShowBasisGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BNotReceivedGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:138.8mm;"><b>Net short-term capital gain or (loss). </b>Combine lines 1a through 6 in column (h).  If you have any long-term capital gains or losses, go to Part ll below.  Otherwise, go to Part lll on the back
            ...
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="LTCapGainTable" id="LTCapGainTable">
              ...
              <tr>
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                  <span style="font-weight:bold;">(e)</span> <br/>Cost <br/> (or other basis)<br/></th>
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;" scope="col">
                <span style="font-weight:bold;">(g)</span> Adjustments to <br/>gain or loss from <br/>Form(s) 8949, Part ll, <br/>line 2, column (g)</th>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLongTermReportOnF1099B/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLongTermReportOnF1099B/TotalCostOrOtherBasisAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="background-color:lightgrey">
					<br/>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt" style="border-right-width:0px;">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLongTermReportOnF1099B/TotalGainOrLossAmt"/>
					</xsl:call-template>
				</td>
              </tr>
              <!-- Line 8b -->
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BShowsBasisGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BNotShowBasisGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
              ...
              <tr>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt">
					...
					<br/>
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BNotReceivedGrp/TotalProceedSalesPriceAmt"/>
					</xsl:call-template>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt">
					<br/>
          ...
          <div class="stySmallText" style="width:110mm;">
           <span class="styBoldText">For Paperwork Reduction Act Notice, see your tax return instructions.</span>
            ...
            <div class="stySmallText" style="width:48mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1040) 2013</span>       </div>
          </div>
       ...
       <div class="styBB" style="width:187mm;border-bottom-width:0px;">
        ...
        <div class="styBB" style="width:187mm;border-top-width: 1px;border-bottom-width:0px;">
          <span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1040) 2013</span>
        </div>
        <!--  PART III HEADER -->
        <div class="pageEnd">
        </div>

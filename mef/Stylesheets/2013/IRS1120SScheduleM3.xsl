         ...
         <span style="width:25mm;"> Department of the Treasury </span>
          Internal Revenue Service</span>
            ...
            <div class="styTYBox" style="width:30mm;height:22mm;border-left-width:1px;">
              <div class="styOMB" style="width:30mm;height:4mm;">OMB No. 1545-0130</div>
...
<xsl:with-param name="BackupName">TaxBasis</xsl:with-param>
          ...
          <!-- Part II Table -->
           <div style="width:187mm;">
          <table class="styIRS1120ScheduleM3_styTable" id="IRS1120SScheduleM3PartIITable" summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable Income per Return " cellspacing="0" cellpadding="0" style="width:187mm;">
            <tr>
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">(attach statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
              <span style="float:left;padding-left:2mm;">Subpart F, QEF, and similar income inclusions (attach </span>
              <span style="float:left;padding-left:2mm;">statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
                <span style="float:left;padding-left:2mm;">Gross foreign distributions previously taxed (attach </span>
                <span style="float:left;padding-left:2mm;">statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
                <span style="float:left;padding-left:2mm;">Income (loss) from equity method U.S. corporations</span>
                <span style="float:left;padding-left:2mm;">(attach statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td><span style="float:left;padding-left:2mm;">U.S. dividends not eliminated in tax consolidation
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td style="white-space:nowrap;">
                 <span style="float:left;padding-left:2mm;">Income (loss) from U.S. partnerships (attach statement) 
       <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
              <span style="float:left;padding-left:2mm;">Income (loss) from foreign partnerships (attach </span> 
              <span style="float:left;padding-left:2mm;">statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <span style="float:left;padding-left:2mm;">Income (loss) from other pass-through entities (attach</span>
              <span style="float:left;padding-left:2mm;">statement)
            <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
              <span style="float:left;padding-left:2mm;padding-right:10px;">Items relating to reportable transactions (attach </span>
              <span style="float:left;padding-left:2mm;">statement)
               <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
              <span style="float:left;padding-left:2mm;">Interest income (attach Form 8916-A)
              <!-- form link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
                 <span style="float:left;padding-left:2mm;">Cost of goods sold (attach Form 8916-A)
           <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td>
				  <span style="float:left;padding-left:2mm;">Original issue discount and other imputed interest</span>
				  <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <td>
                <span style="float:left;padding-left:2mm;">Worthless stock losses (attach details)
                <!-- Form Link -->
                <xsl:call-template name="SetFormLinkInline">
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;padding-left:2mm;">
                 <span style="float:left;">Other gain/loss on disposition of assets other than inventory</span>
              </td>
              <td class="styIRS1120SScheduleM3ShadedCell" scope="col" style="border-bottom-width:1px;">
                <span style="width:1mm"/>
              </td>
          ...
          <table class="styTable" id="IRS1120SScheduleM3PartIII" summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporation With Taxable Income per Return—Expense/Deduction Items (see instructions)" cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;">
            ...
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" scope="col">
                <span style="width:1.5mm;"/>5</td>
              <td style="padding-top:.5mm;">
                 <span style="float:left;padding-left:2mm;">Foreign current income tax expense (other than foreign </span>
                 <span style="float:left;padding-left:2mm;"> withholding taxes)</span>
                 <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" scope="col">
                <span style="width:1.5mm;"/>7</td>
              <td>
              <span style="float:left;padding-left:2mm;">Equity-based compensation</span>
              <span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" scope="col">10</td>
              <td>
                <span style="float:left;padding-left:2mm;">Judgments, damages, awards, and similar costs</span>
                <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              ...
              <td>
              <span style="float:left;padding-left:2mm;">Depletion—Oil and Gas</span>
              <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
            ...
            <tr>
              <td class="styIRS1120SScheduleM3NumberCell" scope="col" style="padding-left:5mm">b</td>
              <td>
                 <span style="float:left;padding-left:2mm;">Depletion—Other than Oil and Gas</span>
                 <span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
              </td>
              <td class="styIRS1120SScheduleM3Cell" scope="col">
                <xsl:call-template name="PopulateAmount">
           ...
           <!-- form link -->
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;font-weight:bold;padding-left:2mm;border-bottom-width:1px;border-color:black;border-style:solid;border-left-width:0px;border-top-width:0px;border-right-width:0px">Total expense/deduction items.

    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <div style="width:187mm;float:left;clear:left;">
          <div style="width:35mm;height:auto;float:left;clear:left;">
          ...
          <div class="styLblNameAddr" style="width:106mm;height:27mm;">
            <div class="styUseLbl" style="width:12mm;height:24mm;border-right-width:0px;">TYPE OR PRINT </div>
            <div class="styNameAddr" style="width:92mm;height:10mm;border-left-width:1px;padding-left:1px;">
              Name
              <br/>
          ...
          <!-- Box B -->
          <div class="styEINDateAssets" style="width:46mm;height:9mm;border-top-width:1px">
            <span class="styBoldText">B Employer identification number</span>
            <br/>
            <br/>
            <span class="styEINFld" style="padding-left:2mm;">
              <xsl:call-template name="PopulateReturnHeaderFiler">
          ...
          <!-- Box C -->
          <div class="styEINDateAssets" style="width:46mm;height:8mm;">
            <span class="styBoldText">C </span>Date incorporated
            <br/>
            <br/>
          ...
          <!-- Box D -->
          <div class="styEINDateAssets" style="width:46mm;height:10mm;border-bottom-width:1px;">
            <span class="styBoldText">D </span>Total assets (see instructions)
            <br/>
            <br/>
        ...
        <div class="styBB" style="width:187mm;float:none;clear:none;">
          <div class="styIRS1120VTImageBox" style="width:6mm;height:59mm;padding-top:23mm;text-align:center;">
            <img src="{$ImagePath}/1120_Income.gif" alt="VerticalIncome" valign="center" height="40mm;"/>
          </div>          
			    ...
			    <div class="styLNDesc" style="width:132mm;">
				  <span style="float:left;">Net gain or (loss) from Form 4797, Part II, line 17 (attach Form 4797)
				    ...
				    <xsl:call-template name="LinkToLeftoverDataTableInline">
					  ...
					  <xsl:with-param name="TargetNode" select="$Form1120Data/TotalOrdinaryGainLossAmt/@form4684Indicator"/>
				    </xsl:call-template>
				  </span>
				  <!--Dotted Line-->
				  <div class="styDotLn" style="float:right;padding-right:1mm;">.......</div>
      ...
      <!--line 36 -->
          ...
          <!-- paid preparer -->
					<div class="styBB" style="width:187mm;font-size:6pt;">
						...
						<div style="width:164mm;float:left;clear:none;">
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;border-leftright:1px;">
								...
								<div class="styLNDesc" style="height:8mm;width:18.3mm;border-right:1px solid black;padding-top:.5mm;padding-bottom:0mm;padding-left:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
                  ...
                  <span style="width:6mm;"/>
							...
							<div style="width:164mm;float:left;clear:none;">
								<div class="styLNDesc" style="width:126.5mm;border-right:1px solid black;border-left:1px solid black;padding-left:1mm;">
        ...
        <table class="styTable" style="font-size:7pt;border-bottom:1px solid black;width:187mm;padding-top:0mm;" cellspacing="0">
          <thead>
            <tr scope="col">
              <th class="styBB" colspan="2" style="width:92mm;padding-bottom:3mm;">
          ...
          <!--Schedule C, line 1 -->
			...
			<tr>
			  ...
			  <td class="styShadingCell" style="height:7mm;width:40mm;padding-top:5mm;border-bottom-width:1px;" colspan="2">
				<span style="width:1px;"/>
			  </td>
            ...
            <div class="styLNDesc" style="width:139mm;height:4.5mm;padding-top:.5mm;">
              ...
              <span style="width:4mm;padding-top:1mm;">
                ...
                <!--NOTE: ELEMENT NAME FOR THIS CHECK BOX IS DIFFERENT FROM 1120 -->
                  <xsl:call-template name="PopulateCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/PersonalServiceCorporationInd"/>
        ...
        <!--  Schedule J, Line 9a  -->
            ...
            <div class="styBB" style="width:187mm;height:auto;font-weight: bold;font-size: 8pt;">
				...
				<div class="styLNDesc" style="width:99mm;">
				  <span style="float:left;">
				    ...
				    <xsl:call-template name="LinkToLeftoverDataTableInline">
					  ...
					  <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TotalFuelTaxCreditAmt/@ozoneDepletingChemicalsInd"/>
				    </xsl:call-template>
				  </span>
				  <!--Dotted Line-->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;height:10.5mm;">
              ...
              <span style="float:left;display:inline;">the corporation’s stock entitled to vote? If "Yes," complete Part I of Schedule G (Form 1120) (attach Schedule G)
                <!-- Form to Form Link -->
                <xsl:call-template name="SetFormLinkInline">
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;">b</div>
            <div class="styLNDesc" style="width:167mm;height:11mm;padding-top:0px; ">
              ...
              all classes of the corporation’s stock entitled to vote? If "Yes", complete Part II of Schedule G (Form 1120) (attach Schedule <br/>
              <span style="float:left;display:inline;">G) 
				<!-- Form to Form Link -->
			    <xsl:call-template name="SetFormLinkInline">
            ...
            <table class="styTable" cellspacing="0" style="font-size:7pt;">
              ...
              <tbody>
                ...
                <xsl:if test="count($Form1120ScheduleK/CorpOwnPercentVotingStockInfo)&lt; 5  or ((count($Form1120ScheduleK/CorpOwnPercentVotingStockInfo) &gt; 5) and ($Print = $Separated))">
                  <tr>
                    <td class="styTableCell" style="width:95mm;text-align:left;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                    <td class="styTableCellCtr" style="width:35mm;border-bottom-width:0px;">
                      <span style="width:1px;"/>
                    </td>
                    <td class="styTableCell" style="width:20mm;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                    <td class="styTableCell" style="width:36mm;border-right-width:0px;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                  </tr>
                </xsl:if>
            ...
            <table class="styTable" cellspacing="0" style="font-size:7pt;">
              <thead class="styTableThead">
                <tr>
                  ...
                  <th class="styTableCellHeader" scope="col" rowspan="2" style="width:36mm;font-weight:normal;border-right:0;">
                    <span style="font-weight:bold;">(iv)</span>Percentage Owned in Profit, Loss or Capital</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>
                ...
                <xsl:if test="count($Form1120ScheduleK/CorpOwnPercentPartnershipInfo)&lt; 5  or ((count($Form1120ScheduleK/CorpOwnPercentPartnershipInfo) &gt; 5) and ($Print = $Separated))">
                  <tr>
                    <td class="styTableCell" style="width:95mm;border-bottom-width:0px;">
                      <span class="styTableCellPad"/>
                    </td>
                    <td class="styTableCellCtr" style="width:35mm;border-bottom-width:0px;">
                      <span style="width:1px;"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              ...
              <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3px;"/>
              <span style="border-bottom:1px solid black;width:34mm;text-align:right;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/TotalForm5472FiledCnt"/>
                </xsl:call-template>
              </span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;font-size:6pt; ">
			  ...
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3px;">$</span>
              <span style="border-bottom:1px solid black;width:32mm;text-align:right;font-size:7pt;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox">13</div>
            <div class="styLNDesc" style="width:167mm;">
			  Are the corporation’s total receipts (page 1, line 1 a, plus lines 4 through 10 on page 1) for the tax year <b>and</b> its total assets at the end 
			...
			<div style="width:187mm;">
				<div class="styLNLeftNumBox"/>
				<div class="styLNDesc" style="width:167mm;font-size:6pt;padding-top:1mm;">
                If "Yes," the corporation is not required to complete Schedules L, M-1, and M-2 on page 5. Instead, enter the 
                total amount of cash distributions and the book value of property distributions (other than cash) made during the 
                tax year.
                <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:50mm;height:5mm;">
            ...
            <table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              ...
              <tbody>
                ...
                <tr> <!-- Schedule M-1, Line 5b-->
                  <td class="styLNLeftNumBoxSD" style="height:4.5mm;vertical-align:top;float:none;">
                ...
                <tr> <!-- Schedule M-1, Line 5c-->
                  <td class="styLNLeftNumBoxSD" style="vertical-align:top;float:none;">
                ...
                <tr> <!-- Schedule M-1, Line 6-->
                  ...
                  <td class="styLNAmountBoxNBB" style="width:32mm;height:5.5mm;border-top-width:1px;border-right-width:1px;padding-top:1.5mm;">
                    <xsl:call-template name="PopulateAmount">
              ...
              <tbody>
                ...
                <tr> <!-- Schedule M-1, Line 8b-->
                  ...
                  <td class="styGenericDiv" style="width:51.5mm;height:4.5mm;" colspan="2">
                    ...
                    <div class="styIRS1120BBText" style="width:23mm;height:6.5mm;float:left;text-align:right;font-size:6pt;padding-top:3mm;">
                      <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styGenericDiv" style="height:4mm;">
                  ...
                  <td class="styGenericDiv" style="width:51.5mm;height:4mm;padding-right:.5mm;" colspan="2">
                    <div class="styIRS1120BBText" style="width:51.5mm;text-align:right;padding-right:3mm;height:4mm;"/>
                  </td>
                  <td class="styShadingCell" style="height:4mm;width:30.5mm;float:none">
                    <span style="width:1px;"/>
                  </td>
                </tr>
                <tr class="styGenericDiv" style="height:4.5mm;">
                  <td class="styLNLeftNumBoxSD" style="height:4.5mm;width:7.3mm;"/>
                ...
                <!-- Schedule M-1, Line 9-->
                <tr class="styGenericDiv">
                  <td class="styLNLeftNumBoxSD" style="height:5.5mm;width:7.3mm;">9</td>
                ...
                <tr class="styGenericDiv"> <!-- Schedule M-1, Line 10-->
                  <td class="styLNLeftNumBox" style="height:4.5mm;width:7.3mm;">10</td>
          ...
          <div style="width:187mm;clear:both;" class="styBB">
            ...
            <table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
              <tr class="styGenericDiv"> <!-- Schedule M2, line 1 -->
                ...
                <td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;border-bottom:1px solid black;border-bottom-width:2px;">
                  <xsl:call-template name="PopulateAmount">
        ...
        Additional Data        
          ...
          <table class="styLeftOverTbl">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              ...
              <xsl:with-param name="TargetNode" select="$Form1120Data/TotalFuelTaxCreditAmt/@ozoneDepletingChemicalsInd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="WRPPData" select="$RtnDoc/WholesaleRetailPrpsdPoolsStmt"/>
  <!-- - 3115 Form displays as - Wholesaling or Retailing Goods Proposed Number of Pools Statement  -->

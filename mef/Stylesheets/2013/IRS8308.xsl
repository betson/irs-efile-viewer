...
<!-- Last Modified by James Ganzy on 03/05/2015 -->
        ...
        <form name="Form8308">
         ...
         <div class="styFTBox" style="width:126mm;height:19mm;padding-top:2mm;">
             <div class="styMainTitle">Report of a Sale or Exchange of<br/>Certain Partnership Interests</div><br/>
             	<div class="styFBT">
							 <img src="{$ImagePath}/8308_Bullet_Sm.gif" alt="Bullet"/>
            		Please print or type.           
	            </div>
              </div>
           <div class="styTYBox" style="width:30mm;height:19mm;padding-top:9mm;text-align:center;">OMB No. 1545-0941</div>
         </div>
         <!-- End Form Header -->
         ...
         <div class="styBB" style="width:187mm;">
           ...
           <div class="styNameBox" style="height:10mm;width:35mm;font-size:7pt;border-right:0px solid black;">
	              <span style="padding-left:1mm;">Telephone number</span><br/>
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styNumberBox" style="height:16mm;font-size:7pt;">City or town, state, and ZIP code<br/>

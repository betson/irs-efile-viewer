                 ...
                 <a href="http://www.irs.gov/form1120-PC" title="Link to irs.gov">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:140mm;font-size:7pt;height:10mm">
							...
							<xsl:choose>
								<xsl:when test="$Form1040ScheduleFData/FarmProprietorName/BusinessNameLine1!='' ">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmProprietorName/BusinessNameLine1"/>
									</xsl:call-template>
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmProprietorName/BusinessNameLine2"/>
									</xsl:call-template>
								</xsl:when> 
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styNameBox" style="width:40mm;height:10mm;padding-top:0mm;font-size:7pt;border-right-width: 0px;">
							<span style="width:4px;;padding-top:3mm"/>
						...
						<!-- Box B-->
						<div class="styForm1040ScheduleFEINFullBox" style="width:47mm;height:16mm;float:left;">
						...
						<!-- Box C-->
						<div class="styLNLeftNumBox" style="width:4mm;padding-left:2mm;padding-top:1mm;height:16mm;">C</div>
						<div class="styNameBox" style="width:46mm;height:16mm;padding-left:2mm;padding-top:1mm;font-size:7pt;">
						...
						<!-- Box D-->
						<div class="styEINBox" style="width:46mm;height:16mm;font-size:7pt;">
	...
	<span style="float:left;;font-size:7pt;">
				...
				<div  style="height:4mm;float:left;width:8mm;padding-top:.5mm;
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmIncomeCashMethodGrp/CCCLoansForfeitedTaxableAmount"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 6a and b-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:80mm;height:4mm;">
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmIncomeCashMethodGrp/ElectionDeferCropInsProcAmt"/>
					...
					<!-- END Part II Title -->
						...
						<table class="styTable" style="width:92.25mm;float:right;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
									...
									<xsl:for-each select="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense">
										<tr>
											<td class="styLNLeftNumBox" style="height:4.5mm;vertical-align:top;width:4mm;padding-left:4mm;">
												...
												<xsl:if test="position() = 6 and not($Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp)">
													f
												</xsl:if>
											</td>
										...
										<xsl:if test="position() = 5 and $Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp">
                    </xsl:if>
									</xsl:for-each>
								</xsl:if>
								...
								<xsl:if test="((count($Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &gt; 5) and ($Print = $Separated))">
									<tr><!-- Line 32f-->
								...
								<xsl:if test="($Print != $Separated)">
									<tr>
				                       ...
				                       <span style="width:1mm"/>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp/@section263AIndicatorText"/>
												</xsl:call-template>
											</span>
										</td>
										...
										<td class="styLNAmountBoxNBB" style="vertical-align:bottom;height:5mm;width:31mm;">
											<xsl:if test="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp"/>
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp"/>
											</xsl:call-template>
											<xsl:if test="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp"/>
											<span style="width:1px;"/>
										</td>
							...
							<span class="styBoldText">Net farm profit or(loss). </span>
                             Subtract line 33 from line 9 
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									...
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmExpensesGrp/PassiveActivityLossLiteralGrp"/>
								</xsl:call-template>
							<span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
						</div>
					...
					<div class="styLNDesc" style="height:4.5mm;width:140mm;">
							Did you receive a subsidy in 2013? (see instructions) 
		<span class="styDotLn" style="float:right;padding-right:2mm;">.............</span>
					...
					<div style="width:187mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule F (Form 1040) 2013  </span>
						</div>
					</div>
					...
					<!-- Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule F (Form 1040) 2013  <span style="width:130mm;"/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1040ScheduleFData/FarmIncomeAccrualMethodGrp/CCCLoansForfeitedTaxableAmount"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 41-->
					...
					<div style="width:187mm;">
						...
						<div class="stySmallText" style="width:46mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;">Schedule F (Form 1040) 2014 </span>
						</div>
					</div>
					<br/>
					<br class="pageEnd"/>
								...
								<xsl:for-each select="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense">
									<tr>
										<xsl:if test="position() &gt; 5">
											<xsl:choose>
												<xsl:when test="$Form1040ScheduleFData/FarmExpensesGrp/OtherFarmExpensesGrp/TotalPreproductivePrdExpnssGrp">

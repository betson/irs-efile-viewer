...
<!-- end 3b -->
      ...
      Form <span class="styBoldText" style="font-size:8pt;">8283</span>  (Rev. 12-2013)
        ...
        <br/>
							<span style="width:20mm;"/>contributions of publicly traded securities reported in Section A). An appraisal is generally required for property listed 
        <br/>
									...
									<xsl:for-each select="$Form8283Data/PropertyInformation">
										<tr>
											...
											<td class="styTableCell" style="width:32mm;text-align:right;font-size:7pt;border-color:black;border-right:none;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="AvgTradingPriceSecuritiesAmt"/>
												</xsl:call-template>
											</td>
										</tr>
									</xsl:for-each>

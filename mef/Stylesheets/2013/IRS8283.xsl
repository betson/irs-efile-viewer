...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<form name="Form8283">
					...
					<div style="width:187mm;">
						<div class="styFNBox" style="width:32mm;height:28mm;">
							...
							<div class="styAgency" style="width:30mm;padding-bottom:2mm;">(Rev. December 2013)
	...
	<a href="http://www.irs.gov/form8283">
             <i>www.irs.gov/form8283.</i></a>							
    </div>
						</div>
	...
	<th scope="col" class="styTableCell" style="width:61mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;">
									...
									<th scope="col" class="styTableCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;">
										...
										(For a vehicle, enter the year, make, model, and mileage. For securities, enter the company name and the number of shares.)</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
									...
									<xsl:for-each select="$Form8283Data/InformationOnDonatedProperty">
										<tr>
											...
											<td class="styTableCell" style="width:60mm;text-align:left;font-size:7pt;font-weight:normal;border-color:black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="DoneeOrganizationName/BusinessNameLine1"/>
												</xsl:call-template>
												<xsl:if test="DoneeOrganizationName/BusinessNameLine2">
													<br/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="DoneeOrganizationName/BusinessNameLine2"/>
													</xsl:call-template>
												</xsl:if>
...
<!--    <xsl:call-template name="PopulateText">
	<xsl:with-param name="TargetNode" select="VehicleYear"/>
								...
								<xsl:if test="(count($Form8283Data/InformationOnDonatedProperty) &lt; 1) or         (($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5))">
									<tr>
                ...
                <xsl:call-template name="PopulateLabel">
                  ...
                  <xsl:with-param name="BackupName">IRS1120FSchIForeignBankYes</xsl:with-param>
					...
					<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;border-right:none;">
								...
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 2 or         ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
									<tr>
    ...
    <xsl:call-template name="PopulateLabel">
                  ...
                  <xsl:with-param name="BackupName">IRS1120FSchIForeignBankYes</xsl:with-param>
					...
					<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;border-right:none;">
								...
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 3 or         ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
									<tr>
...
-->					<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;border-right:none;">
								...
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 4 or         ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
									<tr>
	...
	<!--				<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;
               ...
               <xsl:call-template name="PopulateLabel">
                  ...
                  <xsl:with-param name="BackupName">IRS1120FSchIForeignBankYes</xsl:with-param>
					...
					<td class="styTableCell" style="width:60mm;text-align:center;font-weight:bold;border-color:black;border-right:none;">
								...
								<xsl:if test="count($Form8283Data/InformationOnDonatedProperty) &lt; 5 or         ($Print = $Separated) and (count($Form8283Data/InformationOnDonatedProperty) &gt; 5)">
									<tr>
		...
		<td class="styTableCell" style="width:81mm;padding-right:38mm;font-weight:bold;border-color:black;">
			...
			<img src="{$ImagePath}/8283_Bullet_Sm.gif" alt="bullet image pointing to right"/>
										...
										<div class="styBB" style="width:180mm;margin-left:4mm;float:left;"/>
										<xsl:choose>
											<xsl:when test="$Form8283Data/InformationOnDonatedProperty/DonatedPropertyRestrictionInd=1">
              ...
              If Part II applies to more than one property, attach a separate statement.</div>
                ...
                Total amount claimed as a deduction for the property listed in Part I:
											...
											<div style="width:187mm;">
												...
												<br />
												<xsl:if test="OrganizationNm/BusinessNameLine1 !=''">
									
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizationNm/BusinessNameLine1"/>
													</xsl:call-template>
												</xsl:if>
												<xsl:if test="OrganizationNm/BusinessNameLine2 !=''">
													<br/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizationNm/BusinessNameLine2"/>
													</xsl:call-template>
												</xsl:if>
												</div>
											</div>
											...
											<div style="width:187mm;height:auto;">
												...
												<div style="font-size:6pt;font-weight:normal;height:auto;border-bottom:1px solid black;width:177mm;">Address (number, street, and room or suite no.)
													<br />
												<xsl:if test="OrganizatonUSAddress!=''">
												
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/AddressLine1"/>
													</xsl:call-template>
													<br/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/AddressLine2"/>
													</xsl:call-template>
												</xsl:if>
												<xsl:if test="OrganizatonForeignAddress!=''">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/AddressLine1"/>
													</xsl:call-template>
													<br/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/AddressLine2"/>
													</xsl:call-template>
												</xsl:if>
											...
											<br />
												...
												<xsl:if test="OrganizatonForeignAddress">
													...
													<span style="width: 2mm"/>
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/Country"/>
													</xsl:call-template>
												</xsl:if>
													...
													<span class="styUnderlineText" style="width:40mm;float:right;">
														...
														<xsl:choose>
															<xsl:when test="PersonPossessingPropBusName">
																<xsl:call-template name="PopulateText">
																	<xsl:with-param name="TargetNode" select="PersonPossessingPropBusName/BusinessNameLine1"/>
																</xsl:call-template>
																<br/>
																<xsl:call-template name="PopulateText">
																	<xsl:with-param name="TargetNode" select="PersonPossessingPropBusName/BusinessNameLine2"/>
																</xsl:call-template>
															</xsl:when>
															<xsl:otherwise>
																<xsl:call-template name="PopulateText">
...
<!-- end 3b -->
      ...
      Form <span class="styBoldText" style="font-size:8pt;">8283</span>  (Rev. 12-2013)
    </div>
					</div>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 8283 (Rev. 12-2013)<span style="width:130mm;"/>
						</div>
...
<!--													<xsl:call-template name="PopulateText">
								...
								<xsl:if test="count($Form8283Data/PropertyInformation) &lt; 1 or         (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
									<tr>
								...
								<xsl:if test="count($Form8283Data/PropertyInformation) &lt; 2 or         (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
									<tr>
								...
								<xsl:if test="count($Form8283Data/PropertyInformation) &lt; 3 or         (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
									<tr>
								...
								<xsl:if test="count($Form8283Data/PropertyInformation) &lt; 4 or         (($Print = $Separated) and (count($Form8283Data/PropertyInformation) &gt; 4))">
									<tr>
									...
									<xsl:if test="($Print != $Separated) or (count($Form8283Data/PropertyInformation) &lt;= 4)">
										<xsl:for-each select="$Form8283Data/PropertyInformation">
											<tr>
												...
												<td class="styTableCell" style="text-align:center;width:27mm;font-size:7pt;border-color:black;">
        ...
        having a value of $500 or less. See instructions.						
					...
					<div style="width:187mm;">
						...
						<div style="width:49mm;border-bottom:1px solid black;padding-left:1mm;float:right;clear:none;height:auto;" class="styGenericDiv">
							...
							<xsl:if test="($Print = $Separated) and (count($Form8283Data/PropertyIdLetterAndDescGrp) &gt; 1)">
...
substantial or gross valuation misstatement results from my appraisal.  I affirm that I have not been barred from presenting evidence or testimony by the Office of Professional Responsibility.
        ...
        Date <span style="width:1mm;"/>
					...
					<div style="width:187mm;border-top-width:1px">
						<div class="styNameBox" style="font-family:Arial;font-size:7pt;width:135mm;height:6mm;height:auto;">
						<span style="width:100%">
						Business address (including room or suite no.)</span>
								<xsl:choose>
									<xsl:when test="$Form8283Data/AppraiserUSAddress">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/AddressLine1"/>
										</xsl:call-template><br/>
										<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/AddressLine2"/>
											</xsl:call-template>
<!--										<div>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/AddressLine2"/>
...
-->
									...
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/AddressLine1"/>
										</xsl:call-template>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/AddressLine2"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
						
						</div>
						<div class="styEINBox" style="font-family:Arial;font-size:7pt;width:47mm;padding-left: 2mm;height:9mm;">
							...
							<!--div style="padding-top:2.8mm">	<br/>
								<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;border-top-width:1px">
						<div class="styNameBox" style="font-family:Arial;font-size:7pt;width:187mm;height:8mm;border-right-width:0px;">City or town, state, and ZIP code<br/>
        <div> 
								<xsl:choose>
									<xsl:when test="$Form8283Data/AppraiserUSAddress">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/City"/>
										</xsl:call-template><span style="width:1mm;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/State"/>
										</xsl:call-template>
											<span style="width:1mm;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserUSAddress/ZIPCode"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/City"/>
										</xsl:call-template><span style="width:1mm;"/> 
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/ProvinceOrState"/>
										</xsl:call-template><span style="width:1mm;"/>
		 										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/Country"/>
										</xsl:call-template> <span style="width:1mm;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserForeignAddress/PostalCode"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
							</div>
					...
					<div style="width:187mm;border-top-width:1px">
						<div class="styNameBox" style="font-family:Arial;font-size:7pt;width:94mm;height:auto;">Address (number, street, and room or suite no.) <br/>
							<xsl:if test="$Form8283Data/DoneeUSAddress">
								<xsl:if test="$Form8283Data/DoneeUSAddress/AddressLine1!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeUSAddress/AddressLine1"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form8283Data/DoneeUSAddress/AddressLine2!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeUSAddress/AddressLine2"/>
									</xsl:call-template>
								</xsl:if>
							</xsl:if>
							<xsl:if test="$Form8283Data/DoneeForeignAddress">
								<xsl:if test="$Form8283Data/DoneeForeignAddress/AddressLine1!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/AddressLine1"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form8283Data/DoneeForeignAddress/AddressLine2!=''">
									<br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/AddressLine2"/>
									</xsl:call-template>
								</xsl:if>
							</xsl:if>
						</div>
						<div class="styEINBox" style="font-family:Arial;font-size:7pt;width:93mm;font-weight:normal;">City or town, state, and ZIP code <br/>
							<br/>
							<xsl:if test="$Form8283Data/DoneeUSAddress">
								<xsl:if test="$Form8283Data/DoneeUSAddress/City!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeUSAddress/City"/>
									</xsl:call-template>,
            </xsl:if>
								<xsl:if test="$Form8283Data/DoneeUSAddress/State!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeUSAddress/State"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form8283Data/DoneeUSAddress/ZIPCode!=''">
									<span style="width:1mm;"/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeUSAddress/ZIPCode"/>
									</xsl:call-template>
								</xsl:if>
							</xsl:if>
							<xsl:if test="$Form8283Data/DoneeForeignAddress">
								<xsl:if test="$Form8283Data/DoneeForeignAddress/City!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/City"/>
									</xsl:call-template>,
            </xsl:if>
								<xsl:if test="$Form8283Data/DoneeForeignAddress/ProvinceOrState!=''">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/ProvinceOrState"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form8283Data/DoneeForeignAddress/PostalCode!=''">
									<span style="width:1mm;"/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/PostalCode"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form8283Data/DoneeForeignAddress/Country!=''">
									<span style="width:1mm;"/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8283Data/DoneeForeignAddress/Country"/>
									</xsl:call-template>
								</xsl:if>
							</xsl:if>
						</div>
						...
						<div>
							<table class="styDepTbl" style="width:187mm;" id="donatedPrptyInfo">
								<thead class="styTableThead">
									...
									<th scope="col" class="styDepTblCell" style="width:7mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;;border-right-width:0px">1</th>
										<th scope="col" class="styDepTblCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;border-left-width:0px">
											<span class="styBoldText">(a)</span>
											<span style="width:1mm;"/>
											<span style="font-size:7pt;">Name and address of the donee organization</span>
										</th>
           ...
           <xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
                ...
                Total amount claimed as a deduction for the property listed in Part I:
										...
										<div class="styDepTblRow1" style="width:187mm;">
											...
											<div class="styBB" style="width:180mm;margin-left:8mm;float:left;">
												<xsl:if test="OrganizatonUSAddress">
													<xsl:if test="OrganizatonUSAddress/AddressLine1!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/AddressLine1"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizatonUSAddress/AddressLine2!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/AddressLine2"/>
														</xsl:call-template>
												...
												<xsl:if test="OrganizatonForeignAddress">
													<xsl:if test="OrganizatonForeignAddress/AddressLine1!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/AddressLine1"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizatonForeignAddress/AddressLine2!=''">
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/AddressLine2"/>
														</xsl:call-template>
										...
										<div class="styDepTblRow1" style="width:187mm;">
											...
											<div class="styBB" style="width:180mm;margin-left:8mm;float:left;">
												<xsl:if test="OrganizatonUSAddress">
													<xsl:if test="OrganizatonUSAddress/City!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/City"/>
														</xsl:call-template>,
            </xsl:if>
													<xsl:if test="OrganizatonUSAddress/State!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/State"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizatonUSAddress/ZIPCode!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonUSAddress/ZIPCode"/>
														</xsl:call-template>
													</xsl:if>
												</xsl:if>
												<xsl:if test="OrganizatonForeignAddress">
													<xsl:if test="OrganizatonForeignAddress/City!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/City"/>
														</xsl:call-template>,
            </xsl:if>
													<xsl:if test="OrganizatonForeignAddress/ProvinceOrState!=''">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/ProvinceOrState"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizatonForeignAddress/PostalCode!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/PostalCode"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="OrganizatonForeignAddress/Country!=''">
														<span style="width:1mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="OrganizatonForeignAddress/Country"/>
														</xsl:call-template>

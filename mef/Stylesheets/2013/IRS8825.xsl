              ...
              Employer identification number<br/>
				  ...
				  See instructions. See page 2 to list additional properties.</th>
													...
													<tr>
														...
														<th class="styTableCellHeader" style="width:36mm;font-size:7pt;border-bottom:1 solid black;border-right:1 solid black;">
										...
										<table cellspacing="0" class="styTable" style="border-color:black;border-top: solid black 2px;" summary="Table for displaying the rental real estate properties there income and expenses">
											<thead class="styTableThead">
												<tr>
													...
													<th class="styTableCellHeader" style="width:100mm;font-size:8pt;border-left-width: 1px;              border-right-width: 0px;" colspan="4" scope="col">
                      Properties
                    </th>
												</tr>
											</thead>
                  ...
                  14
                              ...
                              <img src="{$ImagePath}/8825_Bullet_Line.gif" width="4" height="7" alt="Bullet Image"/>
																...
																<td class="styForm8825TableCellSmallRB" style="width:5mm;font-size:7pt;                 font-weight:bold;vertical-align:top;border-right-width: 0px;">
																	<xsl:attribute name="rowspan"><xsl:value-of select="$RowCount">
																	</xsl:value-of></xsl:attribute>
																	<span style="padding-left:1.5mm">15</span>
																	<span class="styTableCellPad"/>
																</td>
															</xsl:when>
															<xsl:otherwise>
            ...
            Net income (loss) from rental real estate activities from partnerships, estates, and trusts in which this<br/>
                ...
                <span style="width:290px;"/>
					...
					<div class="styForm8825TableContainer" style="padding-left:9mm;" id="PSTPctn">
						...
						<table class="styTable" style="float:none; font-size: 7pt;" cellspacing="0" summary="Table for partnerships,                  estates or trusts from which net income or loss is shown on line 20a">
							<thead class="styTableThead">
								<tr>
...
<!--												<td style="border:none;font-size:7pt;" scope="row">
                          ...
                          Total expenses for each property. 
													...
													<div>
														...
														<div class="styGenericDiv" style="width:65mm;">
															<span style="float:left;white-space:nowrap;">Total expenses for each property.</span>
															<span style="float:left;white-space:nowrap;">Add lines 3 through 15</span>
															<!--Dotted Line-->
															<div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
														</div>
													</div>
                          ...
                          Income or (Loss) from each property. <br/>
													...
													<div>
														...
														<div class="styGenericDiv" style="width:65mm;">
															...
															<span style="float:left;white-space:nowrap;">Subtract line 16 from line 2</span>
															<!--Dotted Line-->
															<div class="styDotLn" style="float:right;padding-right:1mm;">......</div>
														</div>
													</div>

                  ...
                  <xsl:for-each select="$Form851Data/SubsidiaryCorporationInfo">
                    <tr style="height: 10mm">
                      ...
                      <td valign="middle" class="styTableCell" style="width:21mm;">
                        ...
                        <xsl:choose>
                          <xsl:when test="normalize-space(StockHoldingInfo[1]/VotingPowerPct)=''">
                      ...
                      <td valign="middle" class="styTableCell" style="width:21mm;">
                        <xsl:attribute name="style"><xsl:value-of select="'width:21mm;text-align:right;font-size:7pt;border-color:black;'"/></xsl:attribute>
                        <xsl:choose>
                          <xsl:when test="normalize-space(StockHoldingInfo[1]/StockValuePct)=''">
                            <span style="width:2px;">%</span>
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:call-template name="PopulatePercent">
                      ...
                      <xsl:if test="position() &gt; 1">
                        <tr>
                          ...
                          <td valign="middle" class="styTableCell" style="width:21mm;">
                            <xsl:attribute name="style"><xsl:value-of select="'width:21mm;text-align:right;font-size:7pt;border-color:black;'"/></xsl:attribute>
                            <xsl:choose>
                              <xsl:when test="normalize-space(VotingPowerPct)=''">
                                <span style="width:2px;">%</span>
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:call-template name="PopulatePercent">
                          ...
                          <td valign="middle" class="styTableCell" style="width:21mm;">
                            <xsl:attribute name="style"><xsl:value-of select="'width:21mm;text-align:right;font-size:7pt;border-color:black;'"/></xsl:attribute>
                            <xsl:choose>
                              <xsl:when test="normalize-space(StockValuePct)=''">
                                <span style="width:2px;">%</span>
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:call-template name="PopulatePercent">
          ...
          Percent of value
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td valign="middle" class="styTableCell" style="width:40mm;height:5mm;font-size:7pt;border-color:black;text-align:center;">
					<!-- If the separated data tag is not switched, populate with data -->
                      <xsl:if test="not(($Print = $Separated) and (count($Form851Data/SubsidiaryCorporationInfo) &gt; 9))">

			...
			<body class="styBodyClass">
				<form id="IRS8959">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc">Tier I Employee Additional Medicare Tax on Railroad Retirement Compensation</div>
					</div>
					<!-- Line 14 -->
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:135.86mm;">
							<span style="float:left;">Subtract line 15 from line 14. If the result is zero or less, enter -0-</span>
							<span class="styIRS8959Dots">.........</span>
						</div>
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div class="styLNDesc" style="width:135.86mm;">
							Tier I employee Additional Medicare Tax on railroad retirement compensation. Multiply line<br />
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div class="styLNDesc" style="width:135.86mm;">
							Add lines 7, 13, and 17. Also include this amount on Form 1040, line 60, (see instructions,<br />
							<span style="float:left;">including relevant line numbers for Forms 1040NR, 1040-PR, and 1040-SS) and go to <b>Part V</b></span>
							<span class="styIRS8959Dots"></span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:7.8mm;width:35mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AddlMedicareTaxWitholdingAmt"/>
							</xsl:call-template>
						</div>
					</div>					
					<!-- Line 23 -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:135.86mm;">
							<span style="float:left;">Additional Medicare Tax from Form W-2, box 14</span>
							<span class="styIRS8959Dots">..............</span>
						</div>
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div class="styLNDesc" style="width:135.86mm;">
							<b>Total Additional Medicare Tax withholding.</b> Add lines 22 and 23. Also include this<br />
							amount, combined with federal income tax withholding, on Form 1040, line 62 (Form<br />
							<span style="float:left;">1040NR, 1040-PR, and 1040-SS filers, see instructions)</span>
							<span class="styIRS8959Dots">............</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm;float:none;clear:both;">
						...
						<span style="float:right;clear:none;">Form <span style="font-weight:bold;font-size:9pt;">8959</span> (2013)</span>
					</div>

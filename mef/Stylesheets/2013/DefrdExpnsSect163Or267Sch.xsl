...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DepData" select="$RtnDoc/DefrdExpnsSect163Or267Sch"/>
	<!--  1120F Schedule I  Form displays as - Deferred Interest Expense Under Section 163 Or 267 Schedule-->
  ...
  <xsl:template match="/">
	...
	<html>
      ...
      <body class="styBodyClass" style="width:187mm;">
        ...
        <xsl:call-template name="PopulateDepCommonLeftover"><xsl:with-param name="TargetNode" select="$DepData"/>
        </xsl:call-template>

      ...
      <body class="styBodyClass">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styNameBox" style="width:102mm;height:23.5mm;font-size:7pt;">
              ...
              <div style="font-family:verdana;">
                ...
                <xsl:if test="$Form8858Data/ForeignDisregardedEntityName/BusinessNameLine2 !=''">
                  <br/>
                  <xsl:call-template name="PopulateText">
        ...
        <!--      </span>-->
         ...
         <!--<br/> -->
                ...
                <div style="font-family:verdana;">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8858Data/USAgentName/BusinessNameLine1"/>
                  </xsl:call-template>
                  <xsl:if test="$Form8858Data/USAgentName/BusinessNameLine2 !=''">
                    <br/>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8858Data/USAgentName/BusinessNameLine2"/>
                    </xsl:call-template>
                  </xsl:if>
                </div>
                <!-- 2a - Address -->
                      ...
                      <tr>
                        ...
                        <td class="styTableCell" style="width:86mm;text-align:left;border-color:black;vertical-align:top;border:none;font-size:7pt;">
                          <span style="font-family:verdana;">
                            <xsl:call-template name="PopulateText">
                              <xsl:with-param name="TargetNode" select="PersonsWithBooksName/BusinessNameLine1"/>
                            </xsl:call-template>
                            <br/>
                            <xsl:call-template name="PopulateText">
                              <xsl:with-param name="TargetNode" select="PersonsWithBooksName/BusinessNameLine2"/>
                            </xsl:call-template>
                          </span>
                          <br/>
                        CustodianAddress:<br/>

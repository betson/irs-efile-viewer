...
<!--Created by Doug Peterson 6-27-2006 submitted for inspection 7-13-2006--><!-- Last Modified by Eugenia McDonald on 11/07/2013 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
         ...
         Employer identification number<br/>
						...
						<tbody style="font-size:7pt">
							<tr style="height:8mm">
							  <td class="styTableCell" style="width:4mm;text-align:right;border-right-width:0px;
								...
								<td class="styTableCell" style="width:33mm;background-color:grey">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;font-size:7pt">
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule D (Form 1065) 2013</span>
						</div>
					</div>

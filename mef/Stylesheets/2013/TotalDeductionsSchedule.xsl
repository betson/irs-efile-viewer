...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/TotalDeductionsSchedule"/>
  <!-- Display Name is Total Deductions Schedule -->
  <!-- Main template begin -->
    	   ...
    	   <table id="GeneralDeductionsTbl" class="styDepTbl">
        	<thead class="styTableThead">
        		<tr class="styDepTblHdr">
           		<th class="styDepTblCell" scope="col" style="width: 153 mm;">Description</th>
           		<th class="styDepTblCell" scope="col" style="width: 34 mm;">Amount</th>
        		</tr>
      	</thead>
      	<xsl:for-each select="$DependencyData/TotalDeductionsGrp">
        		<tr>

...
<!-- 09/11/2015 - Changes made for defect 44543 - Jeremy Nichols -->
...
<xsl:strip-space elements="*"/>
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/StmtInSupportOfSuspension"/>
  ...
  <xsl:template name="StmtInSupportOfSuspensionTemp">
    ...
    <table id="GeneralDependencyTbl" class="styDepTbl">
      ...
      <xsl:for-each select="$DependencyData/StmtInSupportOfSuspensionInfo/Item">
        <tr>
    ...
    <xsl:call-template name="AddOnStyle"/>    
     ...
     <body class="styBodyClass">
        ...
        <xsl:call-template name="PopulateDepCommonLeftover">
          ...
          <xsl:call-template name="StmtInSupportOfSuspensionTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
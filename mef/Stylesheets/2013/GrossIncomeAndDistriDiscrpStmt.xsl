...
<!DOCTYPE xsl:stylesheet [<!ENTITY nbsp "&#160;">]><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="FormData" select="$RtnDoc/GrossIncomeAndDistriDiscrpStmt"/>
  <!--  - Form 1120/972 displays as - Gross Income and Consent Distribution Discrepancy Statement - -->
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass" style="width:187mm;">    
		...
		<div class="styTopSectionLine"> 
          <div class="styTopSectionLineLbl"><b>Statement: </b></div>
	   </div>

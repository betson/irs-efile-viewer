				...
				<form name="IRS5074">
							...
							<div class="styFST" style="height:5mm;font-size:7pt;margin-left:2mm;text-align:center;">
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;">
										<div style="width:95%;height:5mm;">
											<br/>
											<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="SmallBullet"/> 
											Information about Form 5074 and its instructions is at <i>www.irs.gov/form5074</i>.
											<br/>
											<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="SmallBullet"/> 
											Attach to Form 1040.
										</div>
					...
					<div class="styBB" style="width:187mm;padding-bottom:1mm">
						...
						<div class="styIRS5074LineItem" style="height:4mm;">
							...
							<div class="styLNRightNumBox" style="float:right;border-width:0px 0px 1px 0px;height:100%;padding:0px 3px 0px 0px;"/>
						</div>
						<!-- (1) ////////////////////////////////////////////////// -->
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:80px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">5074</span> (2013)
						</div>

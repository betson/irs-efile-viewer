			...
			<body class="styBodyClass">
                ...
                Household Employment Taxes<br/>
                  ...
                  (For Social Security, Medicare, Withheld Income, and Federal Unemployment (FUTA) Taxes)<br/>
							...
							<div class="styFST" style="height:5mm;font-size:7pt;text-align:center;">
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;">
										<div style="width:100mm;height:5mm;"><br/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:138mm;height:16mm;font-weight:normal;font-size:7pt;">
							...
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/HouseholdEmployerName"/>
							</xsl:call-template>
							<span style="width:3px;"/>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="Desc">Employer Name Control</xsl:with-param>
								<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/EmployerNameControl"/>
							</xsl:call-template>
						</div>
					...
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					<div class="styTBB" style="width:187mm;height:79mm;padding-top:4mm;">
						<div style="width:187mm;">Calendar year taxpayers having no household employees in 2013 do not have to complete this form for 2013.</div>
						<!-- Spacer -->
						<span style="width:2px;height:4mm;"/>
						<!-- A ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem" style="height:22mm;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">A</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;">
								<!-- Description -->
                Did you pay <span class="styBoldText">any one</span> household employee cash wages of $1,800 or more in 2013? (If any household employee was your<br/>
                ...
                <br/>
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;">
										<span>
										 ...
										 <span style="margin-bottom:3mm;height:auto;">
										   <label>
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;">
										...
										<span  style="height:auto;padding-bottom:1.2mm;">
										   <label>
						...
						<!-- B ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem" style="height:20mm;padding-top:4mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;">
										...
										<label style="height:auto;padding-bottom:1mm;">
											<xsl:call-template name="PopulateLabelYes">
												<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/HsldEmplFedIncmTaxWithheldInd"/>
												<xsl:with-param name="BackupName">IRS1040ScheduleHDataHsldEmplFedIncmTaxWithheldInd</xsl:with-param>
											</xsl:call-template>
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;">
										...
										<label style="height:auto;padding-bottom:0.8mm;">
											<xsl:call-template name="PopulateLabelNo">
												<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/HsldEmplFedIncmTaxWithheldInd"/>
												<xsl:with-param name="BackupName">IRS1040ScheduleHDataHsldEmplFedIncmTaxWithheldInd</xsl:with-param>
											</xsl:call-template>
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:20mm;padding-top:4mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;">
								<!-- Description -->
                                Did you pay <span class="styBoldText">total</span> cash wages of $1,000 or more in <span class="styBoldText">any</span> calendar <span class="styBoldText">quarter</span> of 2012 or 2013 to <span class="styBoldText">all</span> household employees?<br/>
                               (<span class="styBoldText">Do not</span> count cash wages paid in 2012 or 2013 to your spouse, your child under age 21, or your parent.)
                                <br/>
								<br/>
								<!-- Checkboxes -->
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
					...
					<div style="width:187mm;" class="styTBB">
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:auto;padding-right:3px;width:33mm;">
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4mm;padding-right:3px;width:33mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem"  style="height:auto;">
							...
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/AddnlMedicareTaxWitholdingAmt"/>
								</xsl:call-template>
							</div>							
						</div>	
						...
						<div class="styIRS1040ScheduleHLineItem">
							<div class="styIRS1040ScheduleHLNLeftNumBox" style="padding-top:1mm;">8</div>
                ...
                <xsl:if test="$Form1040ScheduleHData/HsldEmplStateDisabilityPymtGrp/HsldEmplStateDisabilityPymtAmt">
							...
							<!--Dotted Line-->
                            <span class="styDotLn" style="padding-right:1mm;width:17mm;">...</span>
				        ...
				        <!-- (9) ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem"/>
						<div class="styIRS1040ScheduleHLineItem"  style="height:28mm;padding-top:2mm;">
                ...
                (<span class="styBoldText">Do not</span> count cash wages paid in 2012 or 2013 to your spouse, your child under age 21, or your parent.)
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									<!-- No -->
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;height:auto;">
										<div style="height:auto;padding-bottom:2mm;">
											<xsl:call-template name="PopulateSpan">
										...
										<div style="height:auto;">	
											<label style="height:auto;padding-bottom:2mm;width:160mm;">
												<xsl:call-template name="PopulateLabelNo">
													<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/HsldEmplPdTotCashWageAnyQtrInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleHDataHsldEmplPdTotCashWageAnyQtrInd</xsl:with-param>
												</xsl:call-template>							
												...
												<span style="width:2mm;"/>
												<span class="styBoldText">No. Stop.</span> Include the amount from line 8 above on Form 1040, line 59a. If you are not required<br/>
												<span style="width:8mm"/> to file Form 1040, see the line 9 instructions.
											</label>
                                        </div>
									</div>
									<!-- Yes -->
					...
					<div style="width:187mm;padding-top:1mm;clear:both;font-size:6.5pt;page-break-after:always;display:block;">
						<div style="float:left;">
							<span class="styBoldText">For Privacy Act and Paperwork Reduction Act Notice, see the instructions.
                            </span>
							<span style="text-align:center;width:30mm;">
                               Cat. No. 12187K
                             </span>
						</div>
						<div style="float:right;">
							<span class="styBoldText">Schedule H (Form 1040) 2013</span>
						</div>
					</div>				
					...
					<div style="width:187mm;" class="styBB">
						<div style="width:187mm;" class="styNBB">
							...
							<div class="styIRS1040ScheduleHLineItem"  style="height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:149mm;height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:30mm;padding:0px 0px 0px 6mm;">
								    <!-- Number Box -->
								    <div class="styLNRightNumBox" style="height:5mm;padding-top:1.2mm;">10</div>
									<!-- Yes Checkbox -->
							...
							<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:153.5mm;height:5mm;">
                                     Did you pay all state unemployment contributions for 2013 by April 15, 2014? Fiscal year filers see instructions
                                </div>
								<div class="styIRS1040ScheduleHLNDesc" style="width:25.5mm;float:right;padding:0px 0px 0px 1.5mm;">
								    <!-- Number Box -->
									<div class="styLNRightNumBox" style="height:5mm;padding-top:1.2mm;">11</div>
									<!-- Yes Checkbox -->
									<div class="styLNRightNumBox" style="height:5mm;">
										<span>
											<xsl:call-template name="PopulateSpan">
							...
							<div class="styIRS1040ScheduleHLineItem">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:28mm;float:right;padding:0px 0px 0px 4mm;">
									<!-- Number Box -->
									<div class="styLNRightNumBox" style="height:5mm;padding-top:1.2mm;">12</div>
									<!-- Yes Checkbox -->
									<div class="styLNRightNumBox" style="height:5mm;">
										<span>
											<xsl:call-template name="PopulateSpan">
                ...
                <span style="width:3px;"/>
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<!-- Amount Box -->
<!--							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:83mm;padding:0px 0px 0px 0px;background-color:red;">-->
								<div class="styLNRightNumBox" style="height:4.5mm;padding:0px 0px 0px 0px;">14</div>
								<div class="styLNAmountBox" style="height:4.5mm;width:33mm;padding:0px 2px 0px 0px;">
									<xsl:choose>
...
<!--							</div>-->
							<span>	
								<div class="styLNRightNumBoxNBB" style="height:4.5mm;background-color:lightgrey;padding:0px 0px 0px 0px;"/>						
								<div class="styLNAmountBoxNBB" style="height:4.5mm;width:33mm;padding:0px 0px 0px 0px;"/>
							</span>
						</div>
						<!-- (15) ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<!-- Amount Box -->
						<!--	<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:45mm;padding:0px 0px 0px 0px;">-->
							    <div class="styLNRightNumBox" style="height:4.5mm;padding:0px 0px 0px 0px;">15</div>
								<div class="styLNAmountBox" style="height:4.5mm;width:33mm;padding:0px 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:138mm;">
								<span style="float:left;">
								     <span class="styBoldText">FUTA tax.</span> Multiply line 15 by .6% (.006). Enter the result here, skip Section B, and go to line 25
								</span>
                               <!--Dotted Line-->
                             <span class="styDotLn" style="float:right;padding-right:1mm;">.</span>
							</div>
							...
							<!-- Amount Box -->
<!--							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:45mm;float:right;padding:0px 0px 0px 0px;">-->
								<div class="styLNAmountBoxNBB" style="height:4.5mm;width:33mm;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;height:auto;" class="styBB">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:160mm;height:auto;">
						...
						<table class="styTable" cellspacing="0" style="width:100%;height:100%;">
							...
							<thead class="styTableThead">
								<tr style="vertical-align:top;">
									...
									<!-- (c) //////////////////////////////////// -->
									<th class="styIRS1040ScheduleHTableCellHeader" style="text-align:center;font-size: 6pt; width:20%;height:16mm;padding:0px 0px 0px 0px;" scope="col">
										...
										<br/>
										<span class="styNormalText;" style="margin-bottom:0px;height:auto;">
											<div class="styIRS1040ScheduleHLineItem"  style="padding:0px 0px 0px 0px;width:100%;height:auto;margin-bottom:-0.6mm;">
												<div class="styIRS1040ScheduleHLineItem" style="padding:0px 0px 0px 0px;float:left;width:49.8%;border-width:1px 0px 0px 0px;border-color:black;border-style:solid;height:4.0mm;">
													<span class="styNormalText"  style="padding-right:25mm;padding-left:5mm;">From</span>
												</div>
												<div class="styIRS1040ScheduleHLineItem" style="padding:0px 0px 0px 0px;float:right;width:50%;border-width:1px 0px 0px 1px;border-color:black;border-style:solid;height:4.0mm;">
									...
									<!-- (h) //////////////////////////////////// -->
									<th class="styIRS1040ScheduleHTableCellHeader" style="text-align:center;font-size: 6pt; width:13%;" scope="col">
										<span class="styBoldText">(h)</span><br/>
										<span class="styNormalText">
							...
							<tbody>
								...
								<xsl:if test="count($Form1040ScheduleHData/UnemplFundMultiStateGroup/UnemploymentStateTaxGroup) &lt; 1 or ((count($Form1040ScheduleHData/UnemplFundMultiStateGroup/UnemploymentStateTaxGroup) &gt;2) and ($Print = $Separated))">
									<tr>
										...
										<!-- (c) //////////////////////////////////// -->
										<td class="styIRS1040ScheduleHTableCell" style="width:20%;font-size: 6pt; text-align:center;padding:0px 0px 0px 0px;height:100%;margin-bottom:1mm;">
					...
					<div style="width:187mm;" class="styBB">
						...
						<!-- (18) ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;margin-top:0.8mm;">
							<div class="styIRS1040ScheduleHLNLeftNumBox" style="text-align:left;">18</div>
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:122.1mm;">
                                <span style="float:left;">Totals</span>
                                <!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">.........................</span>
							</div>
							<!-- Amount Box -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:56.9mm;float:right;padding:0px 0px 0px 0px;">
								<div class="styLNRightNumBox" style="padding:0.6mm 0px 0px 0px;width:7.9mm;">18</div>
								<div class="styLNAmountBox" style="width:24.5mm;padding:0.6mm 2px 0px 0px;font-size:6pt;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/UnemplFundMultiStateGroup/TotalUnemplAdditionalTaxCrAmt"/>
									</xsl:call-template>
								</div>
								<div class="styLNAmountBox" style="width:24mm;padding:0.6mm 2px 0px 0px;font-size:6pt;">
									<xsl:call-template name="PopulateAmount">
		...
		<!--				<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:83mm;float:right;padding:0px 0px 0px 0px;">-->
								<div class="styLNRightNumBox" style="height:100%;padding:0.6mm 0px 0px 0px;">19</div>
				...
				<!--			</div>-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:41mm;float:right;padding:0px 0px 0px 0px;">
							    <div class="styLNRightNumBox" style="height:100%;padding:0.6mm 0mm 0mm 0mm;">20</div>
								<div class="styLNAmountBox" style="height:100%;width:33mm;padding:0mm 0mm 0mm 0mm;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:41mm;float:right;padding:0px 0px 0px 0px;">
								...
								<div class="styLNAmountBox" style="height:100%;width:33mm;padding:0.6mm 0mm 0mm 0mm;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:82mm;float:right;padding:0px 0px 0px 0px;">
								<div class="styLNRightNumBox" style="height:100%;padding:0.6mm 0mm 0mm 0mm;">22</div>
								<div class="styLNAmountBox" style="height:100%;width:33mm;padding:0.6mm 2px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:137mm;height:9mm;">
							...
							<!-- Amount Box -->
							<div class="styIRS1040ScheduleHLNDesc" style="height:9mm;width:41mm;float:right;padding:0px 0px 0px 0px;">
								<div class="styLNAmountBoxNBB" style="height:4.5mm;width:33mm;float:right;padding:0px 0px 0px 0px;"/>
								<div class="styLNRightNumBoxNBB" style="height:4.5mm;background-color:lightgrey;float:right;padding:0.6mm 0px 0px 0px;"/>
								<div class="styLNRightNumBox" style="height:4.5mm;padding:0.6mm 0px 0px 0px;">23</div>
								<div class="styLNAmountBox" style="height:4.5mm;width:33mm;padding:0.6mm 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:137mm;height:4.5mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="height:4.5mm;width:41mm;float:right;padding:0px 0px 0px 0px;">
							    <div class="styLNRightNumBoxNBB" style="height:100%;padding:1mm 0px 0px 0px;">24</div>
								<div class="styLNAmountBoxNBB" style="height:100%;width:33mm;padding:1mm 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
              ...
              Total Household Employment Taxes
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<!-- Amount Box -->
							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:41mm;float:right;padding:0px 0px 0px 0px;">
							    <div class="styLNRightNumBox" style="height:100%;padding:1mm 0px 0px 0px;">25</div>
								<div class="styLNAmountBox" style="height:100%;width:33mm;padding:1mm 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:4.5mm;">
							...
							<!-- Amount Box -->
							<div class="styIRS1040ScheduleHLNDesc" style="height:100%;width:41mm;padding:0px 0px 0px 0px;float:right;">
							    <div class="styLNRightNumBox" style="height:100%;padding:1mm 0px 0px 0px;">26</div>
								<div class="styLNAmountBox" style="height:100%;width:33mm;padding:1mm 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<!-- (27) ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem" style="height:14mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;">
										<span>
											<xsl:call-template name="PopulateSpan">
												<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/RequiredToFileF1040Cd"/>
											</xsl:call-template>
											<input type="checkbox" class="styCkbox">
												<xsl:call-template name="PopulateYesCheckbox">
													<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/RequiredToFileF1040Cd"/>
										...
										<label style="height:auto;padding-bottom:0.8mm;">
											...
											<span style="width:2mm;"/>
											<span class="styBoldText">Yes. Stop.</span> Include the amount from line 26 above on Form 1040, line 59a. <span class="styBoldText">Do not</span> complete Part IV below.
                    </label>
									</div>
									<!-- No -->
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;">
					...
					<div style="width:187mm;height:auto;" class="styBB">
						...
						<div class="styIRS1040ScheduleHLineItem" style="border-bottom-width:1px;border-color:black;padding:0px 0px 0px 0px;height:auto;">
							<div class="styIRS1040ScheduleHLNDesc" style="width:75%;padding-left:3px;">
								...
								<!-- Data -->
								<div class="styIRS1040ScheduleHLNDesc" style="height:6mm;width:100%;padding-left:0px;float:none;height:auto;">
                                </div>
							</div>
              ...
              Declaration of preparer (other than taxpayer) is based on all information of which preparer has any knowledge.<br/>
							...
							<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:100%;height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:58%">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:100%;height:4mm;font-size:6pt;height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:34%;height:auto;">
									<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:100%;height:4mm;border-bottom-width:1px;border-color:black;"/>
									<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:100%;height:4mm;font-size:6pt;height:auto;">
                                    Date
                                    </div>
                  ...
                  Use Only
						...
						<div style="width:164mm;float:left;clear:none;border-width:0px 0px 0px 1px; border-color:black;border-style:solid;">
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:8.2mm;width:46.8mm;padding-top:0mm;border-right:1px solid black;padding-left:3px;">
                Print/Type preparer's name<br/>
								...
								<div class="styLNDesc" style="height:8.2mm;width:46.5mm;padding-top:0mm;border-right:1px solid black;padding-left:1mm;">
                Preparer's signature
              </div>
								<div class="styLNDesc" style="height:8.2mm;width:15.2mm;border-right:1px solid black;padding-top:0mm;padding-left:1mm;">Date <br/>
									<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
										<xsl:with-param name="TargetNode">DateSigned</xsl:with-param>
										<xsl:with-param name="BackupName">$RtnHdrDataPaidPreparerInformationDateSigned</xsl:with-param>
									</xsl:call-template>
								</div>
								<div class="styLNDesc" style="height:auto;width:17.8mm;border-right:1px solid black;padding-bottom:0mm;padding-left:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
                ...
                <xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						<div style="float:right;">
							...
							<span class="styBoldText" style="font-size:7pt;">Schedule H (Form 1040) 2013</span>
						</div>
					</div>
					</div>
						...
						<table class="styDepTbl" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<!-- (a) //////////////////////////////////// -->
									<th class="styIRS1040ScheduleHTableCellHeader" style="text-align:center;font-size: 6pt; width:7%;padding-bottom:4.5mm;" scope="col">
										<span class="styBoldText">(a)</span>
										<span class="styNormalText">
											Name of state
                                        </span>
									...
									<!-- (b) //////////////////////////////////// -->
									<th class="styIRS1040ScheduleHTableCellHeader" style="text-align:center;font-size: 6pt; width:14%;padding-bottom:4.5mm;" scope="col">
										<span class="styBoldText">(b)</span>
										<span class="styNormalText">
											Taxable wages (as defined in state act)
                                        </span>

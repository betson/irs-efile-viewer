			...
			<body class="styBodyClass">
              ...
              Name of employer<br/>
					...
					<div class="styTBB" style="width:187mm;">
						<div style="font-weight:bold;width:187mm;">Calendar year taxpayers having no household employees in 2013 do not have to complete this form for 2013.</div>
						<!-- Spacer -->
              ...
              Social Security, Medicare, and Federal Income Taxes
                ...
                Social security tax. Multiply line 1 by 12.4% (.124)
                <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:11px"/>.
                  <span style="width:11px"/>.
                ...
                <!--Dotted Line-->
                  ...
                  <span style="width:11px"/>.
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:138mm;">
                Medicare tax. Multiply line 3 by 2.9% (.029)
                <!--Dotted Line-->
								<span class="styBoldText">
                ...
                <!--Dotted Line-->
                  ...
                  <span style="width:11px"/>.
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:138mm;">
                Additional Medicare Tax withholding (multiply line 5 by 0.9% (.009))
                <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:8px"/>.
                  <span style="width:11px"/>.
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;">
										...
										<label>
											...
											<span style="width:2mm;"/>
											<span class="styBoldText">No. Stop.</span> Include the amount from line 8 above on Form 1040, line 59a. If you are not<br/>
              ...
              Federal Unemployment (FUTA) Tax
                ...
                <!--Dotted Line-->
                  ...
                  <span style="width:11px"/>.
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:134mm;">
                Enter the <b>smaller</b> of line 19 or line 22
                <!--Dotted Line-->
								<span class="styBoldText">
                ...
                <span class="styBoldText">
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:134mm;">
								<span class="styBoldText">FUTA tax.</span> Subtract line 23 from line 21. Enter the result here and go to line 25
                <!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:8px"/>.
                  <span style="width:11px"/>.

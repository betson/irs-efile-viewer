...
<!-- 06/26/2015 - Changes made for defect 42825 - Jeremy Nichols -->
<!-- 06/26/2015 - Changes made for defect 42826 - Jeremy Nichols -->
      ...
      <body class="styBodyClass">
        <form name="Form8849Schedule3">
          ...
          <div class="styTBB" style="width:187mm;border-bottom-width:1px;">
            ...
            <!--Form Number -->
            <div class="styFNBox" style="width:31mm;height:21mm;border-right-width:1px;border-bottom:0px;">
            ...
            <!--Form Name -->
            <div class="styFTBox" style="width:125mm;height:21mm;padding-top:2mm;border-left-width:0px;">
              ...
              <div class="styFST" style="height:4mm;font-size:6pt;margin-left:2mm;text-align:center;padding-top:4mm;">
                <div style="text-align:center;font-weight:normal;">
                  <img src="{$ImagePath}/8849Schedule3_Bullet_Md.gif" alt="MediumBullet"/> 
                  Attach to Form 8849. <span class="styBoldText">Do not </span><span style="width:4px;"/>file with any other schedule.
                </div>
            ...
            <!--OMB/Tax Year -->				
            <div class="styTYBox" style="width:31mm;height:21mm;padding-top:8mm;text-align:center;border-left-width:1px;">
              OMB No. 1545-1420
            </div>
          </div>	
          ...
          <!--Begin Header 1 -->
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:27mm;width:8mm;"></div>
            <div class="styLNDesc" style="width:179mm;height:27mm;padding-top:1.5mm;padding-bottom:1.5mm;">
              ...
              <span style="padding-top:2mm;">The alternative fuel mixture credit cannot be claimed on this form or on Form 4136. It  must be taken as a credit against your taxable fuel liability (gasoline, diesel fuel, and kerosene) reported on Form 720.</span>
            </div>
          </div>
         
          <!--Begin Header 2-->	
          <div style="border-bottom:1px black solid;height:8mm;width:187mm;padding-top:4mm;">
            <div class="styLNLeftNumBox" style="height:8mm;width:8mm;"></div>
            <div class="styLNDesc" style="width:179mm;height:8mm;font-size:7.5pt;">
          ...
          <div style="width:187mm;">
            ...
            <div style="border-bottom:1px black solid;width:187mm;">
              <div class="styLNLeftNumBox" style="height:30mm;width:8mm;"></div>
            ...
            <!--Line 2 Table-->
            <table style="font-size:7pt;border-collapse:collapse;width:187mm;height:auto;">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border-left:1px black solid;border-bottom:1px black solid;text-align:left;">
                ...
                <tr>
                  ...
                  <td style="border-left:1px black solid;border-bottom:1px black solid;">
                    <span style="width=3.5mm;clear:none"/>
                    <xsl:call-template name="PopulateText">

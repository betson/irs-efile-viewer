...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
    ...
    <body class="styBodyClass">
      ...
      <!--   BEGIN WARNING LINE  -->
        ...
        <div style="width:187mm;">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="border-bottom-width: 0px;border-right-width: 0px; height:4mm"/>
            </span>
          </div>
          <div class="styGenericDiv" style="width:181mm;">
            <span style="float:left;clear:none;">
            ...
            <span style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="height: 4mm; border-right-width: 0px;">    
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="height: 4.5mm;border-bottom-width: 1px;">3</div>
              <div class="styLNAmountBox" style="height: 4.5mm;border-right-width:0px;border-bottom-width:1px;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$IRS1120SchedulePHData/ExcessExpensesDeprec545b6Amt"/>
                </xsl:call-template>
              </div>
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="height:6mm;border-bottom-width:0px;padding-top:1mm;">4</div>
              <div class="styLNAmountBox" style="height:6mm;border-bottom-width:0px;padding-top:1mm;">
                <xsl:call-template name="PopulateAmount">
        ...
        <div style="width:187mm;float:none;clear:none; border-style: solid; border-top-width: 1px; border-bottom-width: 0px; border-right-width: 0px; border-left-width: 0px;">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="border-right-width: 0px; height: 4.5mm">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$IRS1120SchedulePHData/OtherTaxesNotDeductedAmt"/>
                </xsl:call-template>
              </div>
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">     
              ...
              <div class="styLNRightNumBox" style="border-bottom-width:0px;background-color: lightgrey; height: 4.5mm"/>
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="border-bottom-width: 0px;border-left-width: 1px; height: 4.5mm"/>
              <div class="styLNRightNumBox" style="border-bottom-width:1px;border-right-width: 0px; background-color: lightgrey; height: 4.5mm"/>
              <div class="styLNAmountBox" style="border-bottom-width: 0px;border-left-width: 1px; height: 4.5mm"/>
            </span>
          </div>
          <div class="styGenericDiv" style="width:181mm;">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="height: 8mm;border-bottom-width:1px;padding-top:4mm;">9</div>
              <div class="styLNAmountBox" style="height: 8mm;border-right-width: 0px;border-bottom-width:1px;padding-top:4mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="border-bottom-width:1px; height: 4.5mm;">10</div>
          ...
          <div class="styGenericDiv" style="width:181mm;">
            ...
            <span style="float:right;clear:none;">
              <div class="styLNRightNumBox" style="height: 5.5mm;border-bottom-width:0px;padding-top:1mm;">13</div>
              <div class="styLNAmountBox" style="height: 5.5mm;border-bottom-width:0px;padding-top:1mm; ">
                <xsl:call-template name="PopulateAmount">
        ...
        <div style="width:187mm;">
          <div style="float:left;clear:none">
            ...
            <div class="styLNDesc" style="width:99mm;">
              <span style="float:left;"><b>Less: </b>Adjustments to rents (attach schedule)
                <xsl:call-template name="SetFormLinkInline">
                  <xsl:with-param name="TargetNode" select="$IRS1120SchedulePHData/RentsAdjustmentAmount"/>
                </xsl:call-template> 
              </span>
              <!--Dotted Line-->
			  <span style="float:right;font-weight:bold;letter-spacing:3.1mm;padding-right:2mm;">.........</span>
          ...
          <div style="float:right;clear:none;">
            <div class="styLNRightNumBox" style="height: 4mm">18b</div>
            <div class="styLNAmountBox" style="height: 4mm">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$IRS1120SchedulePHData/RentsAdjustmentAmount"/>
              </xsl:call-template>
    ...
    <!--   END PART IV TABLE   -->
    <!--   BEGIN LINE 2   -->
  <div class="styIRS1120SchedulePHLineItem" style="float: none; clear: both;width:187mm;margin-top:-2px;">
    <span class="styIRS1120SchedulePHLN" style="padding-top:4.5mm;padding-left: 1.75mm;float:left;">2</span>
    <span class="styIRS1120SchedulePHLNLtMargin"/>
    <span class="styIRS1120SchedulePHLNDesc" style="width: 139.25mm;padding-top:4.5mm;">
      <span style="float:left;padding-left: 2.5mm;">Add the amounts in columns (c) and (d) and enter the totals here </span>
      <!--Dotted Line-->
      <span style="font-weight:bold;letter-spacing:3.1mm;padding-right:2mm;">...........</span> 
      <img src="{$ImagePath}/1120SchPH_Bullet.gif" alt="Bullet"/>
    </span>
    <span class="styIRS1120SchedulePHPreferred" style="border-right-width: 0px;width:19.3mm;">
      <xsl:call-template name="PopulatePercent">
...
<!--   END PART V TABLE   -->
<!--   BEGIN LINE 2   -->
<div class="styIRS1120SchedulePHLineItem" style="float:none;margin-top:-2px;">
  <span class="styIRS1120SchedulePHLN" style="float:left;">2</span>
  <span class="styIRS1120SchedulePHLNLtMargin"/>
  <span class="styIRS1120SchedulePHLNDesc" style="width: 156.50mm;padding-left:1.5mm;">
    <b>Total excess of expenses and depreciation over rent or other compensation. </b>Add the amounts in column (h).
  </span>
  <span class="styIRS1120SchedulePHCommon" style="height: 4mm; width: 25mm;padding-top: 0px; border-style: solid; border-left-width: 1px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px"/>
</div>
<div class="styIRS1120SchedulePHLineItem">
  ...
  <span class="styIRS1120SchedulePHCommon" style="font-size: 6pt;height: 4mm; width: 25mm;padding-top: 0px; border-style: solid; border-left-width: 1px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 1px;">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS1120SchedulePHData/TotalExcessExpensesDeprecAmt"/>
    </xsl:call-template>
  </span>
...
<div class="styIRS1120SchedulePHNoteHdr" style="border-top-width: 0px; border-bottom-width: 0px">
  ...
  <span class="styIRS1120SchedulePHCommon" style="height:8mm; width: 25mm; padding-top: 0mm; border-style: solid; border-left-width: 1px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px; background-color: lightgrey"/>
</div>
<!--   END LINE 2   -->
<!--   END PART V   -->
<!--   BEGIN PART VI   -->
...
<div class="styIRS1120SchedulePHLineItem" style="width:187mm;">
  ...
  <div style="float:right;clear:none;">
    <div class="styLNRightNumBox" style="height: 8mm">1</div>
...
<xsl:if test="(($Print = $Separated) and (count($IRS1120SchedulePHData/StockOwnrRqrUndSect542a2Grp) &gt; 5))">
  <span class="styRepeatingDataTitle">
    <br/><br/>Form 1120 Schedule PH, Part IV, Line 1 - Stock Ownership Requirement Under Section 542(a)(2)<br/>
  </span>

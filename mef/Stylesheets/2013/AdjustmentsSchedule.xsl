...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/AdjustmentsSchedule"/>
  <!-- 1120L - Adjustments Schedule -->
  <!-- Main template begin -->
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="PopulateDepCommonLeftover"><xsl:with-param name="TargetNode" select="$DependencyData"/></xsl:call-template>
         <div class="styTopSectionLine" style="width:187mm;">
      	...
      	<xsl:for-each select="$DependencyData/AdjustmentsScheduleLineGrp">
        		<tr>
          		<xsl:attribute name="class">
         			...
         			<td class="styDepTblCell" style="text-align:left;width=153mm;">

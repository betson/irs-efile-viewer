...
<!-- Created by Doug Peterson 6-16-2006--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/OtherCreditsAndCrRcptrStmt"/>
    ...
    <table id="AOVSSTbl" class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" scope="col">Credit/Credit Recapture Type</th>        
          <th class="styDepTblCell" scope="col">Credit/Credit Recapture Amount</th>   
        </tr>
      </thead>
      <tfoot/>
      <tbody>    

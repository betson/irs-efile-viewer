...
<!DOCTYPE xsl:stylesheet [<!ENTITY nbsp "&#160;">]><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="FormData" select="$RtnDoc/MthdAllocnNotSect263Aor460Stmt"/>
  <!-- - 3115 Form displays as - Method of Cost Allocation for Costs Not Fully Included Under Section 263A or 460 Statement -->

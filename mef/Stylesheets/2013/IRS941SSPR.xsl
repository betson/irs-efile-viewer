			...
			<body class="styBodyClass" style="width:187mm">
					...
					<div style="width:187mm;float:none;clear:both;">
						<div class="styBB" style="width:124mm;float:left;border:black solid 1px; padding-top:2mm; padding-left:2mm; padding-right:2mm;">
							...
							Number<span style="width:10mm"/>Street<span style="width:60mm;"/>Suite or room number
								...
								<span class="styLNCtrNumBox" style="width:67mm;border-top-width:1px;padding-top:.5mm;height:auto;text-align:left;padding-left:1mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">City</xsl:with-param>
									</xsl:call-template>
								</span>
								<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
								<span class="styLNCtrNumBox" style="width:13mm;border-top-width:1px;padding-top:1.5mm;height:6mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">State</xsl:with-param>
									</xsl:call-template>
								</span>
								<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
								<span class="styLNCtrNumBox" style="width:23mm;border-top-width:1px;padding-top:1.5mm;height:6mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							City<span style="width:68.5mm"/>State<span style="width:7mm;"/>ZIP code
								...
								<span style="width:118mm;padding-left:12mm">
									<span class="styLNCtrNumBox" style="width:25mm;height:6mm;border-top-width:1px;padding-top:1.5mm;text-align:left;padding-left:1mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">Country</xsl:with-param>
										</xsl:call-template>
									</span>
									<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
									<span class="styLNCtrNumBox" style="width:40mm;height:6mm;border-top-width:1px;padding-top:1.5mm;text-align:left;padding-left:1mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">ProvinceOrState</xsl:with-param>
										</xsl:call-template>
									</span>
									<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
									<span class="styLNCtrNumBox" style="width:33.8mm;height:6mm;border-top-width:1px;padding-top:1.5mm;text-align:left;padding-left:1mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">PostalCode</xsl:with-param>
										</xsl:call-template>
									</span>
									<span style="width:106mm;font-size:6pt;padding-bottom:0.2mm;">
										<span style="width:26mm;padding-left:1mm;">Foreign country name</span>
										<span style="width:42mm;padding-left:1mm;">Foreign province/county</span>
				...
				Read the separate instructions before you complete Form 941-SS. Type or print within the boxes.
						...
						<div style="width:187mm;padding-left:0mm;padding-top:2mm;padding-bottom:0px;font-size:8pt;float:none;clear:both;">
							...
							(Quarter 4)
								...
								<span style="float:right;padding-top:1.4mm;">
									...
									<div class="styLNCtrNumBox" style="width:39mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:center;padding-right:1mm;">
										<xsl:call-template name="PopulateText">
						...
						Additional Medicare Tax withholding</span>
							...
							<span style="float:left;">overpayment applied from Form 941-X or 944-X filed in the current quarter </span>
										<!--Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
									</div>
								</span>
			...
			we speak with your third-party designee?</div>
						...
						<div style="width:187mm;font-size:8pt;">
							...
							<div style="width:187mm;float:none;clear:both;padding-bottom:2mm;">
								<div style="width:25mm;float:left;padding-top:.5mm;padding-left:12mm;">
									<span>
										<xsl:call-template name="PopulateSpan">
						...
						No.
								...
								<div style="width:161mm;float:right;padding-top:1.5mm;padding-left:4mm;padding-right:3mm;">
									<div style="width:161mm;height:6mm;">
										<div class="styLNDesc" style="width:48mm;float:left;padding-top:2.5mm;">Designee’s name and phone number </div>
										<div style="float:left;">
											<div class="styLNCtrNumBox" style="width:64mm;height:6mm;border-top-width:1px;float:left;padding-top:1mm;padding-left:.5mm;text-align:left;word-wrap:break-word;">
												<xsl:call-template name="PopulateText">
											...
											<div class="styLNCtrNumBox" style="width:37mm;border-top-width:.1px;height:auto;padding-top:.1mm;padding-left:.5mm;text-align:left;word-wrap:break-word;">
							...
							Select a 5-digit Personal Identification Number (PIN) to use when talking to IRS.
										...
										<div style="float:right;">
											<div class="styLNCtrNumBox" style="width:52mm;border-top-width:1px;height:6.5mm;padding-top:2mm;">
				...
				(other than taxpayer) is based on all information of which preparer has any knowledge.
					...
					Best daytime phone
								...
								<div style="float:right;padding-right:3mm;">
									<div class="styLNCtrNumBox" style="width:37mm;border-top-width:1px;height:auto;padding-top:.1mm;padding-bottom:.1mm;word-wrap:break-word;">
					...
					<span class="styDotLn" style="float:left;padding-right:1mm;">....</span>
						...
						<div style="width:187mm;padding-bottom:2mm;">
							<div class="styLNDesc" style="width:24mm;padding-left:0mm;padding-right:1mm;padding-top:2mm;">
					Preparer's name
				</div>
					...
					Date
						...
						<div style="width:187mm;height:auto;padding-bottom;2mm;">
							<div class="styLNDesc" style="width:24mm;padding-left:0mm;padding-right:1mm;padding-top:1mm;">
					Firm's name (or yours if self-employed)
							...
							<div class="styLNDesc" style="width:18mm;padding-left:3mm;padding-top:1.5mm;">
					EIN
				</div>
							<div class="styLNCtrNumBox" style="width:42mm;border-top-width:1px;height:6mm;padding-top:1mm;">
						...
						<div style="width:187mm;padding-bottom:2mm;padding-top:2mm;">
							<div class="styLNDesc" style="width:24mm;padding-left:0mm;padding-right:1mm;">
					Address
				</div>
							<div class="styLNCtrNumBox" style="width:102mm;border-top-width:1px;height:auto;text-align:left;padding-left:1mm;">
					...
					Phone
						...
						<div class="styBB" style="width:187mm;padding-bottom:1mm;border-bottom-width:2px;">
					...
					City
							...
							<xsl:choose>
								<xsl:when test="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress">
									<div class="styLNCtrNumBox" style="width:46mm;border-top-width:1px;height:7mm;padding-top:.5mm;text-align:left;padding-left:1mm;word-wrap:break-word;">
										<xsl:call-template name="PopulateText">
							...
							Prov./St.
									...
									<div class="styLNCtrNumBox" style="width:24mm;border-top-width:1px;height:7mm;padding-top:.5mm;word-wrap:break-word;">
										<xsl:call-template name="PopulateText">
							...
							Country
									...
									<div class="styLNCtrNumBox" style="width:10mm;border-top-width:1px;height:7mm;padding-top:2mm;word-wrap:break-word;">
										<xsl:call-template name="PopulateText">
							...
							Postal code
									...
									<div class="styLNCtrNumBox" style="width:42mm;border-top-width:1px;height:7mm;padding-top:2mm;word-wrap:break-word;">
										<xsl:call-template name="PopulateText">
			...
			<body class="styBodyClass" style="width:187mm;">
				 ...
				 para 2013: <span class="styMainTitle" style="font-size:10pt;">Planilla para la Declaración 
					...
					<div style="width:187mm;float:none;clear:both;">
						<div class="styBB" style="width:122mm;height:auto;float:left;border:black solid 1px;padding-top:1mm;padding-left:2mm;padding-right:2mm;">
							<div style="width:118mm;padding-top:0mm;">
								<span style="float:left;padding-right:5mm;font-size:6pt;font-family:Arial Narrow;padding-top:2mm;">
							...
							<div style="width:118mm;padding-bottom:0mm;">
								...
								<span style="width:104mm;float:right;">
									...
									<span class="styLNCtrNumBox" style="width:33.8mm;border-top-width:1px;padding-top:1.5mm;height:6mm;text-align:left;padding-left:1mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">Country</xsl:with-param>
										</xsl:call-template>
									</span>
									<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
									<span class="styLNCtrNumBox" style="width:34mm;border-top-width:1px;padding-top:1.5mm;height:6mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">ProvinceOrState</xsl:with-param>
										</xsl:call-template>
									</span>
									<span class="styLNCtrNumBox" style="width:1.5mm;float:left;border:none"/>
									<span class="styLNCtrNumBox" style="width:33mm;border-top-width:1px;padding-top:1.5mm;height:6mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">PostalCode</xsl:with-param>
										</xsl:call-template>
									</span>
						...
						<div style="float:right;padding-right:2mm;">
							<div class="styBB" style="width:60mm;height:46mm;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;">
								<div class="styPartName" style="width:55mm;height:8mm;text-align:left;padding-left:1mm;padding-top:1mm;padding-bottom:1mm;">Informe para este trimestre de 2013.<br/>
						...
						<div style="width:187mm;padding-left:0mm;padding-bottom:0mm;font-size:8pt;float:none;clear:both;">
							...
							<div style="width:187mm;padding-bottom:0mm;float:none;clear:both;">
								...
								<span style="float:right;padding-top:4.4mm;">
									...
									<div class="styLNCtrNumBox" style="width:46mm;border-top-width:1px;height:6mm;padding-top:2mm;text-align:center;padding-right:1mm;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EmployeeCnt"/>
										</xsl:call-template>
									</div>
							...
							<div style="width:187mm;height:14mm;float:none;clear:both;">
								...
								<span style="float:left;">Formulario 941-X (PR) o 944-X (SP) radicado en el trimestre en curso </span>
										<!--Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
									</div>
								</span>
				...
				IRS?</i>
						...
						No.
							...
							Escoja un número de identificación personal <i>(PIN)</i> de 5 dígitos que se debe usar al hablar con el IRS.
										...
										<div style="float:right;">
											<div class="styLNCtrNumBox" style="width:30mm;float:left;border-top-width:1px;height:6mm;padding-top:1.5mm;">
												<xsl:call-template name="PopulatePin">
													<xsl:with-param name="TargetNode" select="$RtnHdrData/DiscussWithThirdPartyYesGrp/ThirdPartyDesigneePIN"/>
												</xsl:call-template>
											</div>
						...
						<div class="styBB" style="width:187mm;border-top-width:1px;float:none;clear:both;">
							...
							<div class="styPartDesc" style="width:173.9mm;text-align:left;height:4mm;padding-left:2mm;font-size:9pt;padding-top:1mm;">Firme aquí. TIENE que completar ambas páginas del Formulario 941-PR y luego FIRMARLO.</div>
						</div>
						<div style="width:187mm;font-size:8pt;">
							<div class="styLNDesc" style="width:187mm;padding-bottom:8mm;padding-left:2mm;font-size:7pt;">
				...
				contribuyente) está basada en toda información de la cual el preparador tenga conocimiento.
					...
					Firme su nombre aquí
							...
							<div class="styBB" style="width:187mm;padding-bottom:1mm;padding-top:2mm;float:none;clear:both;">
					...
					Mejor núm. de teléfono donde llamarlo durante el día
								...
								<div style="padding-top:2mm;float:right;">
									<div class="styLNCtrNumBox" style="width:42.5mm;font-size:7pt;border-top-width:1px;height:6mm;padding-top:1mm;">
										<xsl:if test="$RtnHdrData/SignatureDocumentGrp/DaytimePhoneNum">
											<xsl:call-template name="PopulatePhoneNumber">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/SignatureDocumentGrp/DaytimePhoneNum"/>
											</xsl:call-template>
					...
					Fecha
						...
						<div style="width:187mm;padding-bottom:2mm;float:none;clear:both;">
							<div class="styLNDesc" style="width:22mm;padding-left:2mm;padding-right:2.5mm;padding-top:3mm;font-size:7pt;">
					...
					Núm. de teléfono
							...
							<div style="padding-top:15px;float:right;">
								<div class="styLNCtrNumBox" style="width:44.8mm;border-top-width:1px;height:7mm;padding-top:2mm;word-wrap:break-word;">
									<xsl:if test="$RtnHdrData/PaidPreparerInformationGrp/PhoneNum">
										<xsl:call-template name="PopulatePhoneNumber">
											<xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformationGrp/PhoneNum"/>
										</xsl:call-template>
					...
					Ciudad
							...
							<xsl:choose>
								<xsl:when test="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress">
									<div style="padding-top:5px;float:left;">
										<div class="styLNCtrNumBox" style="width:49.8mm;border-top-width:1px;height:7mm;padding-top:.5mm;text-align:left;padding-left:1mm;word-wrap:break-word;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress/City"/>
											</xsl:call-template>
										</div>
							...
							Estado
									...
									<div style="padding-top:5px;float:left;">
										<div class="styLNCtrNumBox" style="width:25mm;border-top-width:1px;height:7mm;padding-top:.5mm;word-wrap:break-word;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress/ProvinceOrState"/>
											</xsl:call-template>
										</div>
							...
							País
									...
									<div style="padding-top:5px;float:left;">
										<div class="styLNCtrNumBox" style="width:8mm;border-top-width:1px;height:7mm;padding-top:2mm;word-wrap:break-word;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress/Country"/>
											</xsl:call-template>
										</div>
									</div>
									<div class="styLNDesc" style="width:17mm;padding-top:3mm;padding-left:3mm;padding-right:0mm;">

    ...
    <table id="ForeignCorpWithNoGrossIncmStmt" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">Type of income excluded from gross income</th>
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">Amount of income excluded from gross income</th>         
        </tr>
      </thead>

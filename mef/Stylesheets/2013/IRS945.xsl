			...
			<body class="styBodyClass" style="width:187mm">
				<form name="Form945">
					...
					<div class="styBB" style="width:187mm;height:20mm;border-bottom-width:2px">
						<div class="styFNBox" style="width:29mm;height:20mm;border-right-width:2px">Form <span class="styFormNumber">945</span>
							<br/>
						...
						<div class="styFTBox" style="width:128mm;height:20mm; ">
							...
							<div class="styFBT" style="width:128mm;height:auto;padding-top:3mm;font:size:6pt;">
								...
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/> For more information on income tax withholding, see Pub. 15 
									(Circ. E) and Pub. 15-A.<br/>
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/> Information about Form 945 and its separate instructions is at
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form945" title="Link to IRS.gov">
									<i>www.irs.gov/form945</i>.</a>
								<br/>
							</div>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:141.3mm;border-right:1px solid black;border-left:1px solid black;">
							<div class="styGenericDiv" style="width:141.3mm;height:auto;border-bottom:1px solid black;">
								<div class="styGenericDiv" style="width:91mm;height:auto;padding-left:2mm;border-right:1px solid black;">Name (as distinguished from trade name)<br/>
								...
								<div class="styGenericDiv" style="width:50mm;height:auto;padding-left:2mm;">Employer identification number (EIN)<br/>
									<br/>
							...
							<div class="styGenericDiv" style="width:141.3mm;height:auto;padding-left:2mm;border-bottom:1px solid black;">Address (number and street)<br/>
							...
							<!-- 6/23/2015 AM: TY2013 Filer CityStateInfo was revised to populate information, different from TY2014. -->
							<div class="styGenericDiv" style="width:141.3mm;height:12mm;padding-left:2mm;">City or town, state or province, country, and ZIP or foreign postal code<br/>
								<xsl:if test="$RtnHdrData/Filer/USAddress">
									<xsl:call-template name="PopulateReturnHeaderFiler">
					...
					<div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom:2mm;">
						...
						<div class="styLNDesc" style="width:142.8mm;">
							<span style="padding-right:.5mm">If you <b>do not have to file</b> returns in the future, check here </span>
							<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
							<span style="width:3mm;"/>
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="float:left;clear:none;width:172mm;padding-top:.5mm;">
							...
							<div style="float:left;clear:none;padding-left:16mm;font-size:6pt;">
								<!-- Checkbox -->
						...
						<div style="height:9mm;float:left;clear:none;width:172mm;padding-top:2mm;">
							...
							<div style="width:46mm;float:left;clear:none;padding-top:.5mm;">
								<xsl:call-template name="PopulateText">
							...
							<div style="float:left;clear:none;width:10mm;padding-left:.5mm;font-weight:bold;font-size:6pt;">Phone no.
								<span style="width:2px;"/>
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
							</div>
							<div style="float:left;clear:none;width:29mm;padding-top:.5mm;word-wrap:break-word;">
							...
							<div style="height:5mm;width:40mm;float:left;clear:none;">
								<div style="float:right;clear:none;width:35mm;padding-left:.5mm;font-weight:bold;font-size:6pt;">Personal identification number (PIN)
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="width:172mm;height:15mm;float:left;clear:none;padding-top:2mm;">
							<div style="width:18mm;height:13mm;float:left;clear:none;padding-left:2mm;font-weight:bold;font-size:6pt;padding-top:9mm;">Signature
								<span style="width:2px;"/>
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
							</div>
							<div style="width:40mm;float:left;clear:none;padding-top:9mm;">
								<xsl:call-template name="PopulatePin">
							...
							<div style="float:left;clear:none;width:52mm;">
							...
							<div style="width:25mm;height:5mm;float:right;clear:none;padding-top:9mm;">
							...
							<div style="width:164mm;float:left;clear:none;">
								<div class="styLNDesc" style="width:126.2mm;height:auto;border-right:1px solid black;border-left:1px solid black;padding-left:1mm;">
									...
									<div class="styGenericDiv" style="padding-right:.5mm;">
										...
										<!-- 6/23/2015 AM: TY2013 PaidPreparer CityStateInfo was revised to populate information, different from TY2014. -->
										<xsl:if test="$RtnHdrData/PaidPreparerInformationGrp/PreparerUSAddress">
											<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
												<xsl:with-param name="TargetNode">City</xsl:with-param>
											</xsl:call-template>,
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText" style="font-size:8pt;">945 </span> (2013)
						</div>

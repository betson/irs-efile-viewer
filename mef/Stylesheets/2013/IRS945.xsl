...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      <div class="styFNBox" style="width:29mm;height:22mm;">
        Form <span class="styFormNumber">945</span>
      ...
      <div class="styFTBox" style="width:128mm;height:20mm; ">
        <div class="styMainTitle" style="height:4mm;padding-top:2mm;">Annual Return of Withheld Federal Income Tax</div>    
		 ...
		 <img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/> For withholding reported on Forms 1099 and W-2G.<br/>
          <img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/> For more information on income tax withholding, see Pub. 15 <br />(Circ. E) and Pub. 15-A.<br/>
          <img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/> Information about Form 945 and its separate instructions is at www.irs.gov/form945.<br/>        
        </div>
      </div>
    ...
    <div class="styGenericDiv" style="width:28.8mm;height:40mm;text-align:center;padding-top:9mm;"><b>Type<br/>or<br/>Print.</b></div>
    <div class="styGenericDiv" style="width:128.5mm;border-right:1px solid black;border-left:1px solid black;">
    <div class="styGenericDiv" style="width:127.9mm;height:10mm;border-bottom:1px solid black;">
    
		<div class="styGenericDiv" style="width:77.9mm;height:10mm;padding-left:2mm;">Name (as distinguished from trade name)<br/>
		...
		<div class="styGenericDiv" style="width:50mm;height:10mm;">Employer identification number (EIN)<br/>
			<xsl:call-template name="PopulateReturnHeaderFiler">
		...
		<div class="styGenericDiv" style="width:127.9mm;height:10mm;border-bottom:1px solid black;padding-left:2mm;">Trade name, if any<br/>
		...
		<div class="styGenericDiv" style="width:127.9mm;height:10mm;padding-left:2mm;border-bottom:1px solid black;">Address (number and street)<br/>
		...
		<div class="styGenericDiv" style="width:127.9mm;height:10mm;padding-left:2mm;">City or town, state or province, country, and ZIP or foreign postal code<br/>
			<xsl:if test="$RtnHdrData/Filer/USAddress">
				<xsl:call-template name="PopulateReturnHeaderFiler">
    ...
    <div class="styGenericDiv" style="width:29.5mm;height:30mm;padding-left:3mm;padding-top:3mm;"><span class="styBoldText">If address is<br/>
different<br/>
from prior<br/>
return, check<br/>
here. </span><img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/><span style="width:3mm;"/>
    ...
    <!-- BEGIN LINE A -->               
          <div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom:2mm;">
            ...
            <div class="styLNDesc" style="width:142.8mm;">
				<span style="">If you <b>do not have to file</b> returns in the future, check here </span>
				<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/><span style="width:3mm;"/>
						...
						</label><span style="width:3mm;"/>
				<span style="">and enter date final payments made. </span><img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
            </div>            
            <div class="styGenericDiv" style="width:35mm;border-bottom:1px dashed black;float:right;"><span style="width:2mm;"/>
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				<span style="float:left;"><b>Total taxes.</b> If $2,500 or more, this must equal line 7M below or Form 945-A, line M</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				Total deposits for 2013, including overpayment applied from a prior year and overpayment applied from<br /><span style="float:left;">Form 945-X</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
            ...
            <div class="styLNRightNumBox" style="height:8mm;padding-top:3px;"><br/>4</div>
            <div class="styLNAmountBox" style="font-size:6pt;height:8mm;padding-top:6px;"><br/>
				<xsl:call-template name="PopulateAmount">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styLNDesc" style="width:138.8mm;">
				<span style="float:left;"><b>Balance due.</b> If line 3 is more than line 4, enter the difference and see the separate instructions</span>
				<span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.					
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styLNDesc" style="width:98.8mm;">
				<span style="float:left;"><b>Overpayment.</b> If line 4 is more than line 3, enter the difference <img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/></span>
          ...
          <div class="styGenericDiv" style="width:187mm;padding-bottom:3mm;">
			  <div class="styGenericDiv" style="width:187mm;">
				  <b>• All filers:</b> If line 3 is less than $2,500, <b>do not</b> complete line 7 <b>or</b> Form 945-A.			  
			  </div>
			  <div class="styGenericDiv" style="width:182mm;float:left">
				  <span style="float:left;"><b>• Semiweekly schedule depositors:</b> Complete <b>Form 945-A</b> and check here</span>
				  <span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
			  ...
			  <div class="styGenericDiv" style="float:right;text-align:right;">
				  <input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
			  ...
			  <div class="styGenericDiv" style="width:182mm;float:left">
				  <span style="float:left;"><b>• Monthly schedule depositors:</b> Complete <b>line 7, entries A through M,</b> and check here</span>
				  <span style="float:right;font-weight:bold;padding-right:3mm;">
					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.
			  ...
			  <div class="styGenericDiv" style="float:right;text-align:right;">
				  <input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/MonthlyScheduleDepositorInd"/>									<xsl:with-param name="BackupName">IRS945MonthlyScheduleDepositorInd</xsl:with-param>
							</xsl:call-template>
						</input>
						<label>
							<xsl:call-template name="PopulateLabel">
          ...
          <div class="styGenericDiv" style="width:187mm;border:2px solid black;"> 
			<div class="styBB" style="width:187mm;">
				...
				<div class="styLNDesc" style="width:170mm;">
					<b>Monthly Summary of Federal Tax Liability.</b> (<b>Do not</b> complete if you were a semiweekly schedule depositor.)
				</div>
			</div>
			<div class="styGenericDiv" style="width:187mm;height:27mm;">
			<div class="styIRS945MonthlyGrp">
				<div class="styIRS945MonthNm"></div>
				<div class="styIRS945MonthAmt" style="font-size:8px;text-align:center;padding-top:.75mm;"><b>Tax liability for month</b></div>
				<div class="styIRS945MonthNm">
					<div class="styIRS945MonthLetter">A</div>
					<div class="styIRS945Month"><span style="float:left;">January </span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
				...
				<div class="styIRS945MonthNm">
					...
					<div class="styIRS945Month"><span style="float:left;">February</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>				
				</div>
				<div class="styIRS945MonthAmt">
				...
				<div class="styIRS945MonthNm">
					...
					<div class="styIRS945Month"><span style="float:left;">March</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthAmt">
				...
				<div class="styIRS945MonthNm">
					...
					<div class="styIRS945Month"><span style="float:left;">April</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthAmt">
				...
				<div class="styIRS945MonthNm">
					...
					<div class="styIRS945Month"><span style="float:left;">May</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
			...
			<div class="styIRS945MonthlyBGrp">
				<div class="styIRS945MonthBNm"></div>
				<div class="styIRS945MonthBAmt" style="font-size:8px;text-align:center;padding-top:.75mm;"><b>Tax liability for month</b></div>
				<div class="styIRS945MonthBNm">
					<div class="styIRS945MonthBLetter">F</div>
					<div class="styIRS945Month"><span style="float:left;">June</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				...
				<div class="styIRS945MonthBNm">
					...
					<div class="styIRS945Month"><span style="float:left;">July</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthBAmt">
				...
				<div class="styIRS945MonthBNm">
					...
					<div class="styIRS945Month"><span style="float:left;">August</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthBAmt">
				...
				<div class="styIRS945MonthBNm">
					...
					<div class="styIRS945Month"><span style="float:left;">September</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthBAmt">
				...
				<div class="styIRS945MonthBNm">
					...
					<div class="styIRS945Month"><span style="float:left;">October</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
			...
			<div class="styIRS945MonthlyBGrp" style="width:62.8mm;float:right;">
				<div class="styIRS945MonthBNm" style="width:32.8mm;"></div>
				<div class="styIRS945MonthCAmt" style="font-size:8px;text-align:center;padding-top:.75mm;"><b>Tax liability for month</b></div>
				<div class="styIRS945MonthBNm" style="width:32.8mm;">
					<div class="styIRS945MonthLetter">K</div>
					<div class="styIRS945Month"><span style="float:left;">November</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthCAmt">
				...
				<div class="styIRS945MonthBNm" style="width:32.8mm;">
					...
					<div class="styIRS945Month"><span style="float:left;">December</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					<span style="width:11px;"/>.</span></div>
				</div>
				<div class="styIRS945MonthCAmt">
				...
				<div class="styIRS945MonthBNm" style="height:13.5mm;padding-top:3mm; width:32.8mm;">
					...
					<div class="styIRS945Month">				
						Total liability for<br/>
						year (add lines <b>A</b><br />
						<span style="float:left;">through <b>L</b> )</span><span style="float:right;font-weight:bold;padding-right:3mm;">					.
					<span style="width:11px;"/>.
					</span>
					</div>
				</div>
				<div class="styIRS945MonthCAmt" style="border-bottom:0px;height:13.5mm;padding-top:9mm;">
					<xsl:call-template name="PopulateAmount">
  ...
  <!-- 3rd party -->
		<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
			...
			<div style="float:left;clear:none;width:172mm;padding-top:.5mm;">
				<div style="font-size:6pt;float:left;clear:none;padding-left:2mm;">Do you want to allow another person to discuss this return with the IRS (see the instructions) ?
				</div>
				<div style="float:left;clear:none;padding-left:20mm;font-size:6pt;">
					<!-- Checkbox -->
					<input type="Checkbox" class="styCkbox">
			...
			<div style="height:9mm;float:left;clear:none;width:172mm;padding-top:2mm;">
				<div style="height:7mm;float:left;clear:none;width:18mm;padding-left:2mm;font-weight:bold;font-size:6pt;">
					Designee's
					name
				...
				<div style="float:left;clear:none;width:13mm;padding-left:.5mm;font-weight:bold;font-size:6pt;">
					Phone<br/>
                    no.
                    <span style="width:2px;"/>
					<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
				...
				<div style="float:left;clear:none;width:29mm;padding-top:3mm;">
					...
					<xsl:if test="$RtnHdrData/DiscussWithThirdPartyYesGrp/ThirdPartyDesigneeFrgnPhoneNum">
						<span style="font-size:5pt;"><xsl:call-template name="PopulateText">
				...
				<div style="float:right;clear:none;width:35mm;padding-left:.5mm;font-weight:bold;font-size:6pt;">
		...
		<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
			...
			<div style="float:left;clear:none;width:172mm;padding-top:.5mm;">
				<div style="font-size:6pt;float:left;clear:none;padding-left:2mm;">Under penalties of perjury, I declare that I have examined this return, including accompanying schedules and statements, and
					to the best of my knowledge and belief, it is true, correct, and complete. Declaration of preparer (other than taxpayer) is based on all information of which preparer has any knowledge. 
				</div>				
			</div>
			<div style="height:15mm;float:left;clear:none;width:172mm;padding-top:2mm;">
				<div style="height:13mm;float:left;clear:none;width:18mm;padding-left:2mm;font-weight:bold;font-size:6pt;padding-top:9mm;">
					Signature
					<span style="width:2px;"/>
					<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
				</div>
				...
				<div style="float:left;clear:none;width:25mm;padding-left:.5mm;font-weight:bold;font-size:6pt;padding-top:6mm;">
					Print Your<br/>
                    Name and Title
                    <span style="width:2px;"/>
					<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
				...
				<div style="height:5mm;width:auto;float:right;clear:none;padding-top:9mm;">
			...
			<xsl:if test="$RtnHdrData/PractitionerPINGrp/TaxpayerSignatureDt">
				...
				<div style="float:right;clear:none;width:auto;padding-left:.5mm;font-weight:bold;font-size:6pt;padding-top:9mm;">
					Date
					...
					<div class="styBB" style="width:187mm;font-size:6pt;float:none;clear:both;">
						<div style="width:22.75mm;height:22mm;padding-top:4mm;float:left;clear:none;border-right:1px solid black;">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8pt;">945             
              </span> (2013)
            </div>

...
<title><xsl:call-template name="FormTitle"><xsl:with-param name="RootElement" select="local-name($IRS5471ScheduleMData)"/></xsl:call-template></title>
...
<div class="styBB" style="width:187mm;height:19mm;">
  ...
  <div class="styFTBox" style="width:129mm;height:19mm;">
    ...
    <div class="styFST" style="height:5mm;font-size:6pt;padding-top:1mm;">
      ...
      <img src="{$ImagePath}/5471SchM_Bullet.gif" alt="bullet"/><span style="width: 4px"/> Attach to Form 5471.  See Instructions for Form 5471.</span>
       </div>
...
<div style="width:187mm;float:left;clear:left;">
  ...
  <br/>
    <span style="font-family: verdana, arial, sans-serif;font-size: 7pt;">
      <xsl:if test="$IRS5471ScheduleMData/PersonNm != ''">
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/PersonNm"/>
        </xsl:call-template>
      </xsl:if>
      <xsl:if test="$IRS5471ScheduleMData/BusinessName/BusinessNameLine1 != ''">
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/BusinessName/BusinessNameLine1"/>
        </xsl:call-template>
      </xsl:if>
      <xsl:if test="$IRS5471ScheduleMData/BusinessName/BusinessNameLine2 != ''">
        <xsl:if test="$IRS5471ScheduleMData/BusinessName/BusinessNameLine1 != ''"><br/></xsl:if>
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/BusinessName/BusinessNameLine2"/>
        </xsl:call-template>
      </xsl:if>
    </span>
  </div>
...
<div class="styBB" style="font-size:6pt;width:187mm;border-top-width:1px;">
  <div class="styNameBox" style="width:76mm;height:15mm;font-size:6pt;">Name of foreign corporation
  <br/>
    <span style="font-size:7pt;">
      <xsl:call-template name="PopulateText">
        <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/ForeignCorporationName/BusinessNameLine1"/>
      </xsl:call-template>
      <br/>
      <xsl:call-template name="PopulateText">
        <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/ForeignCorporationName/BusinessNameLine2"/>
      </xsl:call-template>
     </span>
  </div>
                                                                <!--  Foreign EIN-->
...
<div class="sty5471ScheduleMDescLine">
  ...
  <span class="sty5471ScheduleMCol" style="height:4mm;padding-top:1mm">
    <xsl:call-template name="PopulateAmount">
      <xsl:with-param name="TargetNode" select="$IRS5471ScheduleMData/CommissionsPaidUSPrsnAmount"/>
    </xsl:call-template>
  </span>
  <span class="sty5471ScheduleMCol" style="height:4mm;padding-top:1mm">
    <xsl:call-template name="PopulateAmount">

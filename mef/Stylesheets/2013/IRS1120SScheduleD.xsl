...
This form may be easier to complete if you round off cents to whole dollars.</th>
    ...
    <!-- part I body -->
    			    <tr>
					<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;width:80mm;">					       
					  <div>
					         <span class="IRS1120SScheduleD_IndexCol" style="margin-right:2mm;">1a</span>Totals for all short-term       </div>
					   <div>
					  ...
					  <div>
	                         <span class="IRS1120SScheduleD_IndexCol" style="margin-right:3mm;"/>all these transactions 	
	                  	</div>	 
	                   <div>    
					         <span class="IRS1120SScheduleD_IndexCol" style="margin-right:3mm;"/>Form 8949, leave this line
					  </div>
					  <div>
					         <span class="IRS1120SScheduleD_IndexCol" style="margin-right:3mm;"/> blank and on go to line 1b	
					  </div>		
					</td>
					...
					<td class="IRS1120SScheduleD_MoneyCol" scope="row"  align="right"  style="padding-top:28mm;">						    
						<xsl:call-template name="PopulateAmount">
					...
					<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">	
							     <div class="styLNLeftNumBoxSD"  style="width:7mm;">1b</div>		     
									<div>Totals for all transactions reported on Form(s) 8949 
										<span style="padding-left:8mm;">with Box A checked</span>				
									</div>				     
					</td>
				...
				<tr>
					<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">
					   ...
					   <div>
						  ...
						  <span style="padding-left:8mm;">with Box B checked </span>
						</div>
			...
			<tr>
				<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">
                    ...
                    <div>Totals for all transactions reported on Form(s) 8949 
                         <span style="padding-left:8mm">with Box C checked</span>
                    </div>
	            </td>
				<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:4mm;">  			
			  	            <xsl:call-template name="PopulateAmount">
           ...
           <!-- part II  body -->  
           	<tr>
				<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;width:80mm;">
                    ...
                    <div>
                         <span class="IRS1120SScheduleD_IndexCol" style="margin-right:3mm;"/>blank and go to line 8b 
                    </div>
				</td>
				...
				<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-left:10px;padding-top:28mm;width:33mm;">				    
								(<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BBssRptNoAdjGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>)
				</td>
				<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:28mm;background-color:lightgrey;width:33mm;">						           <span style="width:1.5mm;"/>
				</td>
				<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:28mm;width:33mm;">						    
								<xsl:call-template name="PopulateAmount">
			...
			<tr>
				<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">
                     <div class="styLNLeftNumBoxSD" style="width:7mm;">8b</div>
						 <div>Totals for all transactions reported on Form(s) 8949
						 <span style="padding-left:8mm;">with Box D checked</span>
                     </div>
				</td>
				<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:20px;">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BShowsBasisGrp/TotalProceedsSalesPriceAmt"/>
							...
							<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-left:8px;padding-top:20px;">						    
								(<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">
								...
								<div>Totals for all transactions reported on Form(s) 8949 
								     <span style="padding-left:8mm;">with Box E checked</span>
								</div>
							</td>
							<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:20px;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<td class="IRS1120SScheduleD_DescCol" scope="row" style="vertical-align:top;">
								<div class="styLNLeftNumBox" style="width:7mm;padding-left:0.9mm;">10</div>
									<div>Totals for all transactions reported on Form(s) 8949 
									<span style="padding-left:8mm;">with Box F checked</span></div>
						    </td>
							<td class="IRS1120SScheduleD_MoneyCol" scope="row" style="padding-top:20px;">  			
								<xsl:call-template name="PopulateAmount">

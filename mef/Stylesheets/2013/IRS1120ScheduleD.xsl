			...
			<body class="styBodyClass">
				<form name="Form1120ScheduleD">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:33.5mm;height:19mm;border-right-width:.5mm;">
							...
							<br/>
							<div class="IRS1120ScheduleD_styAgency" style="height:25px;line-height:11px;">Department of the Treasury<br/>Internal Revenue Service</div>
						</div>
					</div>
					<div class="styFTBox" style="width:122.5mm;height:19mm;">
						<div class="styMainTitle" style="height:6mm;">Capital Gains and Losses</div>
						<div class="styFST" style="font-size:7pt;text-align:center;">
							...
							<span style="font-weight:bold; ">
								...
								Information about Schedule D (Form 1120) and its separate instructions is at <a href="http://www.irs.gov/form1120" title="Link to IRS.gov">
                ...
                <br/>
					...
					<table class="IRS1120ScheduleD_styTable" style="width:187mm;" cellspacing="0" summary="Short-Term Capital Gains and Losses--Assets Held One Year or Less">
						<tr valign="top">
							<th class="IRS1120ScheduleD_DescCol" style="font-weight:normal;width:48mm;text-align:left;" colspan="2" scope="col">
						See instructions for how to figure the
						 amounts to enter on the lines below.		<br/><br/>					
							<span style="float:left;padding-left:8mm;">
               This form may be easier to complete if you round off cents to whole dollars. </span>
                </th>
						...
						<!-- part I body -->				
						<tr>
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:3mm;vertical-align:top;">1a</td>
						<br/>
						...
						<tr>
							<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:3mm;vertical-align:top;">1b</td>
						...
						<tr>				
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:3mm;vertical-align:top;">2</td>	
						<td class="IRS1120ScheduleD_DescCol" scope="row" style="vertical-align:top;">Totals for all transactions 
						...
						<!--line 3-->
						<tr>
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:3mm;vertical-align:top;">3</td>
						<td class="IRS1120ScheduleD_DescCol" scope="row" style="vertical-align:top;">Totals for all transactions 
							...
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="padding-left:16px;vertical-align:bottom;35mm;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
                  ...
                  and Style sheet guideline indicate only pos amount allow in a hard coded bracket line.-->
					...
					<!-- END PART II HEADER -->
					<table class="IRS1120ScheduleD_styTable" style="width:187mm;" cellspacing="0">
						<tr valign="top">
						
							<th class="IRS1120ScheduleD_DescCol" style="font-weight:normal;width:48mm;text-align:left;padding-top:1mm;" colspan="2" scope="col">
               ...
               This form may be easier to complete if you round off cents to whole dollars.
							...
							<th class="IRS1120ScheduleD_DescCol" style="font-weight:normal;width:33mm;text-align:center;" scope="col">
								<b>(e)<br/>
								</b> Cost <br>(or other basis)</br>
							</th>
							<th class="IRS1120ScheduleD_DescCol" style="font-weight:normal;width:33mm;text-align:left;" scope="col">
								<b>(g)</b> Adjustments to gain or loss from Form(s) 8949, Part II, line 2, column (g)</th>
							<th class="IRS1120ScheduleD_DescCol" style="font-weight:normal;width:33mm;text-align:left;border-right-width:0px;" scope="col">
								<b>(h) Gain or (loss)</b> Subtract column (e) from column (d) and combine the result with column (g)
								</th>
						</tr>
						<!-- part II  body -->
						<!--Line 8a-->
						...
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:2mm;vertical-align:top;">8a</td>	
						<br>
						</br>	
						...
						<tr>					
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:2mm;vertical-align:top;">8b</td>					
						<td class="IRS1120ScheduleD_DescCol" scope="row" style="vertical-align:top;">Totals for all transactions 
						...
						<tr>				
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:2mm;vertical-align:top;">9</td>					
						<td class="IRS1120ScheduleD_DescCol" scope="row" style="vertical-align:top;">Totals for all transactions 
						...
						<tr>					
						<td class="styLNLeftNumBoxSD" style="width:5mm;padding-left:1mm;vertical-align:top;">10</td>					
						<td class="IRS1120ScheduleD_DescCol" scope="row" style="vertical-align:top;">Totals for all transactions 
                ...
                <span style="float:left;"/>
					...
					<div class="IRS1120ScheduleD_styFormFooter" style="width:707px;border-top-width: 1px;">
						...
						<span style="float:right;width:42mm;text-align:right;font-weight:bold;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1120) 2013</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
				<!-- leftover data table -->

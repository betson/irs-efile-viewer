     ...
     <!--<xsl:call-template name="SetFormLinkInline">
       <xsl:with-param name="TargetNode" select="$IRS990EZData"/>
						...
						<div class="styFTBox" style="width:125mm;height:31mm;padding-top;3.5mm;">
							...
							<div class="styFBT" style="font-size: 6.5pt; margin-top: 0px">Under section 501(c), 527, or 4947(a)(1) of the Internal Revenue Code <br/>(except private foundation)</div>
      ...
      20<span class="styTYColor">13</span>
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:3mm;width:182mm;float:left;clear:none;">For the 2013

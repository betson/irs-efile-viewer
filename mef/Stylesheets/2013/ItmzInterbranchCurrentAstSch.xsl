...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ItmzInterbranchCurrentAstSch"/>
	 <!--  - Form 1120F displays as -  Itemized Interbranch Current Assets Schedule - -->
    ...
    <tr class="styDepTblHdr">
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <th class="styDepTblCell" style="width:80mm;text-align:center;" scope="col">Itemized Interbranch Current Asset Description</th>
    ...
    <xsl:for-each select="$DependencyData/ItmzInterbranchCurrentAssetGrp">  
        ...
        <!-- Set row background color -->
          <xsl:attribute name="class">
            ...
            <td class="styDepTblCell" scope="col" style="width:79mm;text-align:left;">
              ...
              <td class="styDepTblCell" scope="col" style="width:25mm;text-align:center;">
                <xsl:attribute name="rowspan">
                  <xsl:value-of select="count(ItmzInterbranchCurrAstLineItem)"/>
                </xsl:attribute>
            ...
            <xsl:for-each select="ItmzInterbranchCurrAstLineItem">
              ...
              <td class="styDepTblCell" scope="col" style="width:80mm;text-align:left;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="Desc"/>
                </xsl:call-template>
              </td>
              <td class="styDepTblCell" scope="col" style="width:36mm;text-align:right;">

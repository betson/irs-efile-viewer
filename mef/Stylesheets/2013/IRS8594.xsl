        ...
        <form name="Form8594">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styNameBox" style="width:120mm;height:9mm;font-size:7pt; padding-left:9mm;">
              ...
              <xsl:if test="$Form8594Data/BusinessName/BusinessNameLine2">
                <br/>
                <xsl:call-template name="PopulateText">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styNameBox" style="width:112mm;height:9.5mm;font-size:7pt;">
              ...
              <br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyName/BusinessNameLine1"/>
              </xsl:call-template>
              <xsl:if test="$Form8594Data/OtherPartyName/BusinessNameLine2 !=''">
                <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyName/BusinessNameLine2"/>
                </xsl:call-template>
              </xsl:if>
            </div>
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styNumberBox" style="height:9mm;font-size:7pt;padding-left:8mm;">
              ...
              <xsl:if test="$Form8594Data/OtherPartyUSAddress">
                <xsl:if test="$Form8594Data/OtherPartyUSAddress/AddressLine1!=''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyUSAddress/AddressLine1"/>
                  </xsl:call-template>
                </xsl:if>
                <xsl:if test="$Form8594Data/OtherPartyUSAddress/AddressLine2!=''">
                  <br/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyUSAddress/AddressLine2"/>
                  </xsl:call-template>
                </xsl:if>
              </xsl:if>
              <xsl:if test="$Form8594Data/OtherPartyForeignAddress">
                <xsl:if test="$Form8594Data/OtherPartyForeignAddress/AddressLine1!=''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyForeignAddress/AddressLine1"/>
                  </xsl:call-template>
                </xsl:if>
                <xsl:if test="$Form8594Data/OtherPartyForeignAddress/AddressLine2!=''">
                  <br/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyForeignAddress/AddressLine2"/>
                  </xsl:call-template>
                </xsl:if>
              </xsl:if>
            </div>
            ...
            <div class="styNumberBox" style="height:9mm;font-size:7pt;padding-left:8mm;">
              ...
              <xsl:if test="$Form8594Data/OtherPartyUSAddress">
                <xsl:if test="$Form8594Data/OtherPartyUSAddress/City!=''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyUSAddress/City"/>
                  </xsl:call-template>
                  ,
                </xsl:if>
                <xsl:if test="$Form8594Data/OtherPartyUSAddress/State!=''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyUSAddress/State"/>
                  </xsl:call-template>
                </xsl:if>
                <xsl:if test="$Form8594Data/OtherPartyUSAddress/ZIPCode!=''">
                  <span style="width:1mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyUSAddress/ZIPCode"/>
                  </xsl:call-template>
                </xsl:if>
              </xsl:if>
              <xsl:if test="$Form8594Data/OtherPartyForeignAddress">
                <xsl:if test="$Form8594Data/OtherPartyForeignAddress/City!=''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form8594Data/OtherPartyForeignAddress/City"/>
                  </xsl:call-template>
                  ,
                </xsl:if>
                <xsl:if test="$Form8594Data/OtherPartyForeignAddress/ProvinceOrState!=''">
                  <xsl:call-template name="PopulateText">

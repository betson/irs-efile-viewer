					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS5405LineItem" style="height:8mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								...
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									The taxpayer who claimed the credit died in 2013. No repayment of the credit is required of the deceased taxpayer. If you<br/>
									are filing a joint return for 2013 with the deceased taxpayer, see instructions. Otherwise, stop here.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS5405LineItem" style="height:8mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
										If you purchased the home in 2008, enter the amount of the credit you repaid with your 2010, 2011, and 2012 returns.
										Otherwise, enter -0-
										<span class="styBoldText" >
											<span style="width:11px"/>.
											<span style="width:11px"/>.
						...
						<div class="styIRS5405LineItem" style="height:5mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:180mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
										<b>Next: </b>Enter the amount from line 8 on your 2013 Form 1040, line 59b, or Form 1040NR, line 58b.
									</div>
								</div>
							</div>
						</div>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS5405LineItem" style="height:7mm;">
							...
							Enter the first-time homebuyer credit claimed on Form 5405 <b>minus</b> the amount of the credit you
								repaid<br/><span class="styGenericDiv">with your 2010, 2011, and 2012 tax returns</span>
								<span class="styBoldText" style="float:right;padding-right:10px;">.
									<span style="width:11px"/>.
									<span style="width:11px"/>.
									<span style="width:11px"/>.
						...
						<div class="styIRS5405LineItem" style="height:29mm;">
							...
							<div class="styIRS5405LNDesc" style="width:144mm;">
								...
								home in 2008 or you purchased the home after 2008 and the event occurred in 2011.<br/><br/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">5405</span> (Rev. 12-2013)
						</div>

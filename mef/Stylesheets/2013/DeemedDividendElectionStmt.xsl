...
<!-- 09/08/2015 - Changes made for defect 44336 - Jeremy Nichols -->
<!-- 01/15/2016 - Changes made for defect 45034 - Jeremy Nichols -->
        ...
        <div class="styTopSectionLine" style="width:187mm;">        
          ...
          <div style="width:118mm;float:left;clear:none;">            
            ...
            <xsl:if test="$DependencyData/BusinessName/BusinessNameLine2 !=''">
              <br/><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$DependencyData/BusinessName/BusinessNameLine2"/></xsl:call-template>
            </xsl:if>
          </div>
        </div>  
 ...
 <!-- added Line label for ssn case -->  
  ...
  <!-- added Line label for ein case here-->    
        ...
        <div class="styTopSectionLine" style="width:187mm;">        
          ...
          <div class="styExplanationLine" style="width:187mm;float:left;clear:right;">            

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Template to display Gross Income Sourced At Shareholder Level Schedule -->
  
  <xsl:template name="ShowGISS">
    <!-- Gross Income Sourced At Shareholder Level Schedule Data -->
    <table id="GISSTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">                 
         ...
         <th class="styDepTblCell" scope="col">Gains</th>    
         <th class="styDepTblCell" scope="col">Losses</th>        
      </tr>
      </thead>
        <tfoot/>
       <tbody>

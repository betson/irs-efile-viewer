...
Department of the Treasury</div>
						...
						<!-- Begin Form Tax Year -->
						<div class="styFNBox" style="width:34mm;font-size:7pt;height:20mm;border-left-width: 1px; border-right-width: 0px;">
...
The amount on Form 1040, line 38; Form 1040A, line 22; or Form 1040NR, line 37 is more than $29,500/$44,250 (if head of <br/>
household; $59,000 if married filing jointly).<br/>
								<br/>
								<img src="{$ImagePath}/8880_Bullet_Round.gif" alt="Arrow Bullet"/> 
The person(s) who made the qualified contribution or elective deferral 
<b>(a)</b> 
was born after January 1, 1996,  
<b>(b)</b> is claimed as a<br/> 
dependent on someone else's 2013 tax return, or
...
Traditional and Roth IRA contributions for 2013.  <b> Do not </b>  include rollover contributions
<!--Dotted Line-->
					...
					<div style="width:187mm;clear:all">
						...
						<div class="styLNDesc" style="width:95.2mm;font-size:8pt;font-family:Arial;">
Elective deferrals to a 401(k) or other qualified employer plan, voluntary employee contributions, and 501(c)(18)(D) plan contributions for 2013 (see instructions)
<!--Dotted Line-->
							<span class="styDotLn" style="float:right;">...................</span>
						</div>
						<div class="styLNRightNumBox" style="height:10.7mm;font-size:8pt;border-right-width:1px;border-top-width:0px;padding-top:0mm;border-bottom-width:2px;">
							<br/>
							<br/>2
</div>
						<div class="styLNAmountBox" style="height:10.7mm;border-left-width:0px;border-top-width:0px;padding-top:4mm;border-bottom-width:2px;">
							<br/>
							<xsl:call-template name="PopulateAmount">
						...
						<div class="styLNAmountBox" style="height:10.6mm;border-left-width:1px;border-top-width:0px;padding-top:4mm;border-bottom-width:2px;">
							<br/>
							<xsl:call-template name="PopulateAmount">
...
<!--Dotted Line-->
					...
					<div style="width:187mm;clear:all">
						...
						<div class="styLNDesc" style=" width:95.2mm;font-size:8pt;font-family:Arial;">
Certain distributions received <span class="styBoldText">after</span> 2010 and 
<span class="styBoldText">before</span> the due date<br/>
(including extensions) of your 2013 tax return (see instructions). If<br/>
...
<!--Dotted Line-->
						...
						<div class="styLNRightNumBox" style="height:14mm;font-size:8pt;border-right-width:1px;border-top-width:0px;padding-top:3mm;border-bottom-width:2px;">
							<br/>
							<br/>4
</div>
						<div class="styLNAmountBox" style="height:14mm;border-left-width:0px;border-top-width:0px;padding-top:7.5mm;border-bottom-width:2px;">
							<br/>
							<xsl:call-template name="PopulateAmount">
						...
						<div class="styLNAmountBox" style="height:14mm;border-left-width:1px;border-top-width:0px;padding-top:7.5mm;border-bottom-width:2px;">
							<br/>
							<xsl:call-template name="PopulateAmount">
...
<!--Dotted Line-->
						...
						<div class="styLNRightNumBox" style="font-size:8pt;border-right-width:1px;border-top-width:0px;padding-top:0mm;border-bottom-width:2px;">6
</div>
						<div class="styLNAmountBox" style="border-left-width:0px;border-top-width:0px;border-bottom-width:2px;padding-top:0mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8880Data/PrimSmallerOfCalculationAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="border-left-width:1px;border-right-width:0px;border-top-width:0px;background:#B8B8B8;border-bottom-width:0px;"/>
						<div class="styLNAmountBox" style="border-left-width:1px;border-top-width:0px;border-bottom-width:2px;padding-top:0mm;">
							<xsl:call-template name="PopulateAmount">
...
<!--Dotted Line-->
						...
						<div class="styLNRightNumBox" style="font-size:8pt;border-right-width:1px;border-top-width:0px;padding-top:.5mm;width:8.2mm;">7
</div>
						<div class="styLNAmountBox" style="border-left-width:0px;border-top-width:0px;padding-top:.5mm;">
							<xsl:call-template name="PopulateAmount">
...
<div class="styLNAmountBoxNB" style="height:4mm;padding-top:1mm;padding-bottom:0mm;border:1px solid red;"/> -->
						<div class="styLNRightNumBox" style="height:5mm;border-right-width:0px;border-left-width:1px;background:#B8B8B8;border-bottom-width:0px;padding-top:2px;width:8mm;"/>
						<div class="styLNAmountBox" style="height:5mm;width:32mm;border-left-width:1px;border-bottom-width:0px;padding-top:0px;padding-bottom:0px;"/>
					</div>
...
<br/> separately, or   <br/> Qualifying widow(er)                          
								...
								<tr class="styDataCell">
									...
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center;"> $17,750</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;border-right:1px solid black">.5</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$17,750 </td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center"> $19,250</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;border-right:1px solid black">.2</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$19,250</td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$26,625</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;border-right:1px solid black">.1</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center"> $26,625	</td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$28,875</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.2</td>
									<td style="text-align:center;border-right:1px solid black">.1</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">  $28,875 </td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$29,500</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.1</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$29,500 </td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$35,500</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$35,500 </td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$38,500</td>
									<td style="text-align:center;">.2</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$38,500 </td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$44,250</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$44,250	</td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$59,000</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;">.0</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell:">
									<td style="border-right:0px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center">$59,000	</td>
									<td style="border-right:1px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center"> ---</td>
									<td style="text-align:center;border-bottom:1px solid black">.0</td>
									<td style="text-align:center;border-bottom:1px solid black">.0</td>
									<td style="text-align:center;border-right:1px solid black;border-bottom:1px solid black;">.0</td>
								</tr>
							</table>
...
<span class="styBoldText">smaller </span> of line 10 or line 11<br/> here and on Form 1040, line 50; Form 1040A, line 32; or Form 1040NR, line 47.
<!--Dotted Line-->
							<span class="styDotLn" style="float:right;">........</span>
						</div>
...
Form </span>
							...
							<span style="font-size:6pt;">(2013)</span>
						</div>
					</div>
					<!--<br class="pageEnd"/>-->
					<!--END Page Footer-->

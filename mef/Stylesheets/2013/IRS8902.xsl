    ...
    <span style="width:1mm;"/>
						...
						<div class="styNameBox" style="width:133mm;height:100%">Name of subsidiary (if consolidated return)<br/>
							<span style="font-size:7pt;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SubsidiaryBusinessName/BusinessNameLine1"/>
								</xsl:call-template>
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SubsidiaryBusinessName/BusinessNameLine2"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styEINBox" style="font-weight:bold;width:50mm;padding-left:2mm;">
  		        Employer identification number<br/>
					...
					<div style="width:187mm;">
						<div class="styGenericDiv" style="width:7mm;padding-top:3mm;">
							<input alt="IRS8902PriorTaxYearElection" type="checkbox" class="sty6Ckbox" style="width:4mm;height:4mm">
 		...
 		<span style="width:4px;"/>
					...
					<div style="width:187mm;">
						<div class="styGenericDiv" style="width:7mm;">
							<input alt="IRS8902CurrentSubsequentTYElection" type="checkbox" class="sty6Ckbox" style="width:4mm;height:4mm">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						<div class="styGenericDiv" style="width:7mm;">
							<input alt="IRS8902RevokingElection" type="checkbox" class="sty6Ckbox" style="width:4mm;height:4mm">
								<xsl:call-template name="PopulateCheckbox">
		...
		, and ending
          <span style="width:4px;"/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styGenericDiv" style="width:7mm;">
							<input alt="IRS8902ElectAutomaticallyTerminated" type="checkbox" class="sty6Ckbox" style="width:4mm;height:4mm">
								<xsl:call-template name="PopulateCheckbox">
  		...
  		<span style="width:1px;"/>
			...
			...................
							...
							<span style="width:13mm;padding-top:1mm;">
								<input type="checkbox" class="sty6Ckbox" name="Checkbox" style="width:4mm;height:4mm">
			...
			How many corporations are in the electing group?
					...
					<div class="IRS8902Container" style="padding-top:1.5mm;">
						<div class="IRS8902Index" style="width:18mm">(2)</div>
						<!-- 2-->
			...
			Enter the number of vessels included under the election for the electing group 
					...
					<div style="width:187mm;padding-top:1.5mm;">
						<div class="IRS8902Index" style="width:18mm">(3)</div>
		...
		Does any member of the electing group have income from qualifying secondary activities or
			...
			.......................
							...
							<span class="styGenericDiv" style="width:18mm;margin-right:1mm;padding-top:0mm;margin-left:2mm;">
								<input type="checkbox" class="sty6Ckbox" name="Checkbox" style="width:4mm;height:4mm">
									<xsl:call-template name="PopulateYesCheckbox">
          ...
          Yes
							...
							<span class="styGenericDiv" style="width:12.5mm;margin-left:1mm;padding-top:0mm;">
								<input type="checkbox" class="sty6Ckbox" name="Checkbox" style="width:4mm;height:4mm">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/SecondaryOrIncdtlActyIncInd"/>
										<xsl:with-param name="BackupName">IRS8902IncomeFromSecIncidentalActy</xsl:with-param>
                 	        ...
                 	        Description
										...
										<tbody>
											<tr class="styDepTblRow1">
												...
												<!--<td class="styDepTblCell" style="width:58mm;">-->
													<div>
														<div class="styGenericDiv" style="width:5mm;font-weight:bold;padding-left:.5mm;">1</div>
														<div class="styGenericDiv">
                       	Vessel name
								...
								<div class="sty8902TableContainerNBB">
									<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
										...
										<tbody>
											...
											<tr class="styDepTblRow2">
												<td class="styDepTblCell" style="width:58mm;text-align:left;" scope="row">
													<div>
														<div class="styGenericDiv" style="width:5mm;font-weight:bold;padding-left:.5mm;">24</div>

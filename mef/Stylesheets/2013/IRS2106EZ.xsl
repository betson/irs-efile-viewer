...
<li>If you are claiming vehicle expense, you are using the standard mileage rate for 2013.</li><br/>
<span style="font-weight:bold">Caution:</span> <span style="font-style:italic;">You can use the standard mileage rate for 2013 <span style="font-weight:bold">only if: (a)</span> you owned the vehicle and used the standard mileage rate for the first year
...
instructions for special rules on where to enter this amount.)<span style="letter-spacing:3mm;">....................</span></div>
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">2106-EZ</b> (2013)
						</div>
					</div>
					<!--END Page Footer-->

...
<xsl:template name="EstateTaxDedWithIRDCmptStmtTmp">
   ...
   <table id="EstateTaxTbl" class="styDepTbl">
			<thead class="styTableThead">
				...
				<tr>
					...
					<td class="styDepTblCell" style="width: 36mm; text-align:left;">Amount
					</td>
				</tr>
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Total IRD						
					</td>
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Total Expenses for IRD						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Net Value of Items Included as IRD						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Estate Tax After Credits						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Estate Tax Without Net Value After Credits						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Qualifying Estate Tax Deduction						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
   ...
   <table id="RecipientsDeductibleTbl" class="styDepTbl">
			<thead class="styTableThead">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">IRD included in Recipient’s Income						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Estate Tax Qualifying For Deduction						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$DependencyData/QualifyingEstateTaxDedAmt"/>
				...
				<tr>
					<td class="styDepTblCell" style="width:150mm;text-align:right;">Estate Tax Deduction						
					</td>
					<td class="styDepTblCell" style="width: 36mm; text-align:right;">
						<xsl:call-template name="PopulateAmount">

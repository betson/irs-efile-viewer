		...
		<html>
         ...
         Form<span class="styFormNumber">8925</span>
              ...
              Department of the Treasury<br/>Internal Revenue Service  (99)
                        ...
                        <div class="styTYBox" style="width:26.1mm;border-left-width:1px;">
                                        ...
                                        <xsl:call-template name="PopulateYesCheckbox">
                                            <xsl:with-param name="TargetNode"
                                             select= "$Form8925Data/ValidConsentForEachEmployeeInd" />
                                              <xsl:with-param name="BackupName">IRS8925/ValidConsentForEachEmployee</xsl:with-param>
                                       </xsl:call-template>                                      
                                    </input> 
...
<xsl:call-template name="PopulateSpan">
            <xsl:with-param name="TargetNode" select="$Form8925Data/ValidConsentForEachEmployeeInd" />
                           ...
                           <div class="styLNRightNumBox" style="height:auto;mm;padding-top:9.3mm;border-right-width:ValidConsentForEachEmployeeInd0px;border-bottom-width:0px;background-color:lightgrey;width:7.7mm;">
                            </div>
                            <div class="styLNAmountBox" 
...
<!-- Start Line 4b -->
                        ...
                        <div style="width:187mm;float:right;clear:none;">
                            <div class="styLNLeftLtrBox" style="height:8mm;"><span style="width:1px;"></span>b</div>
                            <div class="styBB" style="width:136mm;height:8mm;float:left;clear:none;border-bottom-width:0px;border-right-width: 0px;">If "No," enter the number of employees included on line 2 for whom the policyholder does <br/> not have a valid consent     
                       <!--Dotted Line-->
							<span class="styDotLn" style="float:none;clear:none;padding-left:2mm;">.......................</span>	 
                            </div>
                            <div class="styLNRightNumBox" style="width:7.7mm;border-bottom-width:0px;padding-bottom:0mm;height:4mm;padding-top:0mm;background-color:lightgrey;">
                            </div>
                             <div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;padding-bottom:0mm;width:35.3mm;padding-top:0mm;background-color:lightgrey;">
                                     </div>
                            <div class="styLNRightNumBox" style="width:7.7mm;border-bottom-width:0px;padding-bottom:0mm;height:4mm;padding-top:0mm">
                            4b</div>
                            <div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;padding-bottom:0mm;width:35.3mm;padding-top:0mm;">
           <xsl:call-template name="PopulateAmount">
...
<!-- End Line 4b -->
   ...
   <!--  FOOTER-->
        <div style="width:187mm;border-top:1px solid black;">
          ...
          Form <span class="styBoldText" style="width:10mm;font-size:9pt">8925</span> (12-2010)
        </div> 

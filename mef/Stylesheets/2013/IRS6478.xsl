...
<!-- 10/18/2013 - Modified per defect #56259 - Jeremy Nichols -->
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass" style="width:187mm">
		...
		<xsl:choose>
          ...
          $ 1.01    
            ...
            <div class="styLNAmountBox">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$Form6478Data/QlfyCellBiofuelProdNoAlcCrAmt"/>
              </xsl:call-template>
            </div>
          </div>
          ...
          <!-- end line 2 extension 1 -->
          <!-- start line 2 extention 2 -->
          <!--div style="width:187mm">
          ...
          <div class="styFooter" style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:1mm;">
            ...
            <div style="float:right;font-size:6pt">
              Cat. No. 13605J
                ...
                Form <b style="font-size:9pt">6478<span style="font-size:6pt"> (2013)</span>
              </b>
            </div>
          </div>

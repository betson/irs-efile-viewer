              ...
              Form 3800, line 1h 
               <span style="width:2mm;"/>
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
                    ...
                    <xsl:with-param name="TargetNode" select="$FormData/SumCurrYrCrandOrphnDrugCrAmt/@indicatorPortion1041"/>
                  </xsl:call-template>
                  <xsl:call-template name="LinkToLeftoverDataTableInline">
                    <xsl:with-param name="Desc">Line 4 - 1041 Portion Amount</xsl:with-param>
                    <xsl:with-param name="TargetNode" select="$FormData/SumCurrYrCrandOrphnDrugCrAmt/@portionAmount1041"/>

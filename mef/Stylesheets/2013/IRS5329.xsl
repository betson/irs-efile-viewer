  ...
  <xsl:template name="CreateBox">
    ...
    <div class="styLNAmountBox">
      <xsl:attribute name="style">
        ...
        <xsl:choose><xsl:when test="$TargetNode"></xsl:when><xsl:otherwise>padding-top:6px;</xsl:otherwise></xsl:choose><xsl:if test="$AmountBoxStyle"><xsl:value-of select="$AmountBoxStyle"/></xsl:if></xsl:attribute>
      ...
      <body class="styBodyClass">
        <form name="IRS5329">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:2px;float:none;clear:both;">
            <div class="styFNBox" style="width:29mm;height:22mm;border-right-width:2px;padding-top:.5mm;">
            ...
            <div class="styGenericDiv" style="">
              ...
              <div class="styIRS5329LineItem" style="width:72%;float:left;height:18mm;">
                ...
                <div class="styIRS5329LineItem" style="width:100%;height:14mm;border-bottom:1px solid black">
                  ...
                  <div class="styIRS5329LineItem" style="width:50mm;height:100%;float:right;border-left-width:1px;border-color:black;padding-left:5px;padding-top:25px;">
                ...
                <div class="styGenericDiv" style="width:29.7%;border-right:1px solid black;height:14mm">
                ...
                <div class="styGenericDiv" style="width:33.4%;border-right:1px solid black;height:14mm">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:143mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter your excess contributions from line 16 of your 2012 Form 5329 (see instructions). If zero, go<br/>
                  to line 15
                  <!--Dotted Line-->
                  <span class="styBoldText">
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  If your traditional IRA contributions for 2013 are less than your<br/>
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:143mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  <b>Additional tax.</b> Enter 6% (.06) of the <b>smaller</b> of line 16 <b>or</b> the value of your traditional IRAs on December 31, 2013
                  (including 2013 contributions made in 2014). Include this amount on Form 1040, line 58, or Form 1040NR, line 56.
                </div>
              </div>
              <div class="styIRS5329LNDesc" style="height:100%;width:37mm;float:right;padding:0px 0px 0px 0px;">
          ...
          <div style="width:187mm;" class="styBB">
            ...
            <div class="styPartDesc" style="padding-left:3mm;">
              ...
              <span class="styNormalText" style="font-size:6.5pt;">
                Complete this part if you contributed more to your Roth IRAs for 2013 than is allowable or you had an amount on line 25<br/>
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:143mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter your excess contributions from line 24 of your 2012 Form 5329 (see instructions). If zero, go to <br/>line 23
                  <!--Dotted Line-->
                  <span class="styBoldText">
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;float:none;clear:both;">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:143mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter the excess contributions from line 32 of your 2012 Form 5329 (see instructions). If zero, go to<br/>
                  line 31
                  <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:10px"/>.
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS5329LineItem">
              ...
              <div class="styIRS5329LNDesc" style="width:143mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter the excess contributions from line 40 of your 2012 Form 5329 (see instructions). If zero, go to <br/>
                  line 39
                </div>
              </div>
              <div class="styIRS5329LNDesc" style="height:100%;width:37mm;float:right;padding:0px 0px 0px 0px;">

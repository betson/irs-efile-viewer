            ...
            <div class="styNameBox" style="width:140mm;height:8mm;font-size:7pt;">
              ...
              <xsl:choose>
						...
						<br/>
						            ...
						            <xsl:otherwise>		    
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$FormTData/ShownOnReturnName/BusinessNameLine1" /></xsl:call-template><br/>
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$FormTData/ShownOnReturnName/BusinessNameLine2" />
              </xsl:call-template>  
              </xsl:otherwise>
			 </xsl:choose>
            </div>
              ...
              <table class="styDepTbl" style="font-size:7pt">
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" colspan="5" style="text-align:left">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">1
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="5" style="text-align:left">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">2
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" colspan="4" style="text-align:left">
                    <div class="styLNLeftNumBoxSD" style="height:5mm;">3a
                    Name and address of seller or person from whom property was acquired</div><br/>  
                    <xsl:call-template name="PopulateText">
       	 ...
       	 <xsl:otherwise>
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">4
                ...
                <tr class="styDepTblRow1">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">5a  
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px;border-top-width:0px">
                    <div class="styLNLeftLtrBox" style="height:4mm;padding-left:2.3mm;">b 
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" colspan="4" style="text-align:left;vertical-align:top;">
                    <div class="styLNLeftNumBoxSD" style="height:4mm;">7
                ...
                <tr class="styDepTblRow2">
                  <td class="styDepTblCell" style="width: 80mm;font-size:7pt;text-align:left;font-weight:normal;" scope="col">
                    <div style="height:4mm;text-align:left;vertical-align:center;" class="styLNLeftNumBoxSD">9
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 80mm;text-align: left;vertical-align:center;" scope="row" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;text-align:left;vertical-align:center;">
                      <div style="height:4mm;" class="styLNLeftLtrBox">a
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;">
                      <div style="height:4mm;" class="styLNLeftLtrBox">b
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;">
                      <div style="height:4mm;" class="styLNLeftLtrBox">c
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 80mm;text-align: left;vertical-align:top;" scope="row" class="styFormTTablesCells ">
                    ...
                    <div style="float:left;font-size:7pt;width:76mm;">
                      <div style="height:20mm;" class="styLNLeftLtrBox">d
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 80mm;text-align: left;vertical-align:top" scope="row" class="styFormTTablesCells ">
                    ...
                    <div style="float:left;font-size:7pt;width:76mm;">
                      <div style="height:12mm;" class="styLNLeftLtrBox">e
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 80mm;text-align: left;border-bottom-width:0px;vertical-align:center;" scope="row" class="styFormTTablesCells " >
                    <div style="float:left;font-size:7pt;width:77mm;">
                      <div style="height:4mm;" class="styLNLeftLtrBox">f
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 80mm;text-align: left;" scope="row" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;">
                      <div style="height:4mm;" class="styLNLeftLtrBox">g
                      Mineral rights
        ...
        <xsl:choose>
       	 ...
       	 <xsl:call-template name="PopulateAmount">
                ...
                <tr class="styDepTblRow2">
                  <td style="width: 155mm;text-align: left;vertical-align:center;" scope="row" class="styFormTTablesCells " colspan="4">
                    <div style="float:left;font-size:7pt;">
                      <div style="height:4mm;vertical-align:center;" class="styLNLeftLtrBox">h
          ...
          <xsl:if test="($Print = $Separated) and (count($FormTADataIII)&gt;1 or count($FormTADataIII/MerchantableTimber)&gt;6 or count($FormTADataIII/PremerchantableTimber)&gt;4 or count($FormTADataIII/Improvement)&gt;6) ">
            ...
            <table class="styDepTbl" style="font-size:7pt">
              ...
              <tr class="styDepTblRow1">
                <td class="styDepTblCell" colspan="5" style="text-align:left">
                  <div class="styLNLeftNumBox" style="height:4mm;text-align:left;">1
                  Name of block and title of account<span style="width:5px"></span></div>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="NameOfBlockAndTitleOfAcctTxt" />
                  </xsl:call-template>   
                </td>
              ...
              <tr class="styDepTblRow2">
                <td class="styDepTblCell" colspan="5" style="text-align:left">
                  <div class="styLNLeftNumBox" style="height:4mm;text-align:left;">2
                  Location of property (by legal subdivisions or map surveys)</div><br/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="PropertyLocationTxt" />
                  </xsl:call-template>
                </td>
              ...
              <tr class="styDepTblRow1">
                <td class="styDepTblCell" colspan="4" style="text-align:left">
                  <div class="styLNLeftNumBox" style="height:5mm;text-align:left;">3a
                  Purchaser’s name and address</div><br/>  
                  <xsl:call-template name="PopulateText">
       	 ...
       	 <xsl:otherwise>
              ...
              <tr class="styDepTblRow2">
                <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px">
                  <div class="styLNLeftNumBox" style="height:4mm;text-align:left;vertical-align:bottom;">4
              ...
              <tr class="styDepTblRow1">
                <td class="styDepTblCell" colspan="4" style="text-align:left;border-bottom-width:0px">
                  <div class="styLNLeftNumBox" style="height:4mm;text-align:left;">5a
                  Amount of other consideration
                  <span style="letter-spacing:4mm;font-weight:bold">.....................</span></div>
                </td>       
                <td class="styDepTblCell" style="text-align:right;font-size:6pt;" >    
              ...
              <tr class="styDepTblRow2">
                <td class="styDepTblCell" colspan="4" style="text-align:left;border-top-width:0px;border-bottom-width:0px">
                  <div class="styLNLeftLtrBox" style="height:4mm;padding-left:2.2mm;">b
                  Explain the nature of other consideration and how you determined the amount shown on line 5a:</div>
                </td>
              ...
              <tr class="styDepTblRow2">
                <td style="width: 80mm;font-size:7pt;text-align:left;font-weight:normal;" scope="col" class="styFormTTablesHeaders ">
                  <div style="height:4mm;text-align:left;" class="styLNLeftNumBox">7
       	 ...
       	 <xsl:call-template name="PopulateAmount">
              ...
              <tr class="styDepTblRow2">
                <td style="width: 80mm;text-align: left;vertical-align:top;" scope="row" class="styFormTTablesCells ">
                  ...
                  <div style="float:left;font-size:7pt;width:76mm;">
                    <div style="height:5mm;" class="styLNLeftLtrBox">d
       	 ...
       	 <xsl:call-template name="PopulateAmount">
             ...
             <tr class="styDepTblRow2">
               <td style="width: 155mm;text-align: left;" scope="row" class="styFormTTablesCells " colspan="4">
                 <div style="float:left;font-size:7pt;">
                   <div style="height:4mm;" class="styLNLeftLtrBox">h
             ...
             <tr class="styDepTblRow1">
               <td style="width: 155mm;text-align: left;" scope="row" class="styFormTTablesCells " colspan="4">
                 <div style="float:left;font-size:7pt;">
                   <div style="height:4mm;" class="styLNLeftLtrBox">i
             ...
             <tr class="styDepTblRow2" style="height:8mm;">
               <td style="width:155mm;text-align: left;vertical-align:bottom;" scope="row" class="styFormTTablesCells " colspan="4">
                 <div style="float:left;font-size:7pt;">
                   <div style="height:4mm;" class="styLNLeftNumBox">8
            ...
            <table cellpadding="0" cellspacing="0" class="styDepTbl" style="font-size:7pt">
              <thead class="styTableThead">
                ...
                <tr class="styDepTblHdr">
                  <th style="width: 90mm;text-align:left;font-weight:normal;" scope="col" class="styFormTTablesHeaders">
                    <div style="height:4mm;text-align:left;" class="styLNLeftNumBox">1
                    Name of block and title of account <img alt="Bullet Image" src="{$ImagePath}/T_Bullet.gif"  />
                      <span style="width:4px;"></span></div>
              ...
              <tbody>
                ...
                <tr class="styDepTblRow1">
                  <td style="width: 90mm;text-align:left;font-weight:normal;" scope="col" class="styFormTTablesCells ">
                    <div style="float:left;font-size:7pt;">
                      <div style="height:4mm;" class="styLNLeftNumBox">6

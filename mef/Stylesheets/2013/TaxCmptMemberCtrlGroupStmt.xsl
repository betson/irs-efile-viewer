...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- - 1120 Schedule O Form displays as - Tax Computation for each Member of a Controlled Group Statement  -->
  ...
  <xsl:template match="/">
	...
	<html>
      ...
      <body class="styBodyClass" style="width:187mm;">
        ...
        <xsl:call-template name="PopulateDepCommonLeftover"><xsl:with-param name="TargetNode" select="$TCCGSData"/>
        </xsl:call-template>

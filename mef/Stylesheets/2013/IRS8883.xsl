...
<!--Changed per IBM Defect 43215 additional data to its own page. changes by Robert Jones-->
      ...
      <body class="styBodyClass">
        <form name="Form8883">
          ...
          <div class="styBB" style="width:187mm;height:auto;padding-top:1.5mm;">
            ...
            <div class="styPartDesc" style="height:auto;">Filer's Identifying Information</div>
          </div>
          <!-- END Part I  Title  -->
          <div class="styBB" style="width:187mm;">
            ...
            <!-- L1b -->
            <div style="width:65mm;height:auto;float:left;">
              <div class="styLNLeftNumBox" style="height:auto;padding-top:0mm;">1b</div>          
            ...
            <!--L1c-->
            <div class="styBB" style="width:187mm;">
              <div class="styLNLeftNumBox" style="height:auto;padding-top:0mm;">1c</div>        
              <div class="styNameBox" style="width:60mm;font-size:7pt;height:auto;">          
                 Check applicable box (see instructions):            
                 <br/>  
                 <span style="height:auto;padding-top:2mm;">
               ...
               <div style="width:115mm;float:right;">
                 <div class="styLNLeftNumBox" style="height:auto;padding-top:0mm;">1d</div>                    
                 ...
                 <!-- Yes Check Box -->
                   <div class="styLNDesc" style="width:15mm;height:auto;text-align:right;">
                      <span>
            ...
            <div class="styBB" style="width:187mm;">
              ...
              <div class="styNameBox" style="width:112mm;height:9.5mm;font-size:7pt;">
                 ...
                 <div style="font-family:verdana;font-size:6pt;">                   
                   <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyName/BusinessNameLine1"/>
                   </xsl:call-template>
                   <xsl:if test="$Form8883Data/OtherPartyName/BusinessNameLine2 !=''">
                      <br/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyName/BusinessNameLine2"/>
                      </xsl:call-template>
                    </xsl:if>
                 </div>         
            ...
            <div class="styBB" style="width:187mm;">        
              <div class="styNumberBox" style="height:auto;font-size:7pt;padding-left:8mm;">
                 Address (number, street, and room or suite no.)
                 <br/>
                 <!--US Address -->
                 <xsl:if test="$Form8883Data/OtherPartyUSAddress">
                   <xsl:if test="$Form8883Data/OtherPartyUSAddress/AddressLine1!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyUSAddress/AddressLine1"/>
                      </xsl:call-template>
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyUSAddress/AddressLine2!=''">
                      <br/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyUSAddress/AddressLine2"/>
                      </xsl:call-template>
                   </xsl:if>
                 </xsl:if>
                 <!-- Begin Foreign Address --> 
                 <xsl:if test="$Form8883Data/OtherPartyForeignAddress">
                   <xsl:if test="$Form8883Data/OtherPartyForeignAddress/AddressLine1!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/AddressLine1"/>
                      </xsl:call-template>
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyForeignAddress/AddressLine2!=''">
                      <br/>
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/AddressLine2"/>
                        </xsl:call-template>
                   </xsl:if>
                 </xsl:if>
                 <!-- End Foreign Address-->
            ...
            <div class="styBB" style="width:187mm;">        
              <div class="styNumberBox" style="height:auto;font-size:7pt;padding-left:8mm;">
                City or town, state, and ZIP code
                 ...
                 <xsl:if test="$Form8883Data/OtherPartyUSAddress">
                   <xsl:if test="$Form8883Data/OtherPartyUSAddress/City!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyUSAddress/City"/>
                      </xsl:call-template>,
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyUSAddress/State!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyUSAddress/State"/>
                      </xsl:call-template>
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyUSAddress/ZIPCode!=''">
                      <span style="width:1mm;"/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyUSAddress/ZIPCode"/>
                      </xsl:call-template>
                   </xsl:if>
                 </xsl:if>
                 <!--Foreign City, State and Zipcode Line -->
                 <xsl:if test="$Form8883Data/OtherPartyForeignAddress">
                   <xsl:if test="$Form8883Data/OtherPartyForeignAddress/City!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/City"/>
                      </xsl:call-template>,
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyForeignAddress/ProvinceOrState!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/ProvinceOrState"/>
                      </xsl:call-template>,
                   </xsl:if>
                   <xsl:if test="$Form8883Data/OtherPartyForeignAddress/PostalCode!=''">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/PostalCode"/>
                      </xsl:call-template>,
                   </xsl:if>          
                 </xsl:if> 
                 <xsl:if test="$Form8883Data/OtherPartyForeignAddress/Country!=''">
                   <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8883Data/OtherPartyForeignAddress/Country"/>
                   </xsl:call-template>
                 </xsl:if>
              </div>
            </div>
            ...
            <div class="styBB" style="width:187mm;">
              ...
              <div class="styNameBox" style="width:90mm;font-size:7pt;border-right-width: 1px;height:15mm;;">
                 Name and address of target corporation
                 <br/>
                 <!--Name Line -->
                 <div style="font-family:verdana;">
                   <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationName/BusinessNameLine1"/>
                   </xsl:call-template>
                   <xsl:if test="$Form8883Data/OtherPartyName/BusinessNameLine2 !=''">
                      <br/>
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationName/BusinessNameLine2"/>
                      </xsl:call-template>
                   </xsl:if>
                   <br/>
                   <!--US street address Line -->
                   <xsl:if test="$Form8883Data/TargetCorporationUSAddress">
                      <xsl:if test="$Form8883Data/TargetCorporationUSAddress/AddressLine1!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationUSAddress/AddressLine1"/>
                        </xsl:call-template>
                        <br/>
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationUSAddress/AddressLine2!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationUSAddress/AddressLine2"/>
                        </xsl:call-template>
                      </xsl:if>
                   </xsl:if>
                   <!--Foreign street Address Line -->
                   <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress">
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/AddressLine1!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/AddressLine1"/>
                         </xsl:call-template>
                         <br/>
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/AddressLine2!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/AddressLine2"/>
                        </xsl:call-template>
                      </xsl:if>
                   </xsl:if>
                 </div>
                 ...
                 <div style="padding-top:0mm;"/>
                   <xsl:if test="$Form8883Data/TargetCorporationUSAddress">
                      <xsl:if test="$Form8883Data/TargetCorporationUSAddress/City!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationUSAddress/City"/>
                        </xsl:call-template>,
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationUSAddress/State!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationUSAddress/State"/>
                        </xsl:call-template>
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationUSAddress/ZIPCode!=''">
                        <span style="width:1mm;"/>
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationUSAddress/ZIPCode"/>
                        </xsl:call-template>
                      </xsl:if>
                    </xsl:if>
                    <!--Foreign City, State and Zipcode Line -->
                    <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress">
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/City!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/City"/>
                        </xsl:call-template>,
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/ProvinceOrState!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/ProvinceOrState"/>
                        </xsl:call-template>
                      </xsl:if>
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/PostalCode!=''">
                        <span style="width:1mm;"/>
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/PostalCode"/>
                        </xsl:call-template>,
                      </xsl:if>  
                      <xsl:if test="$Form8883Data/TargetCorporationFrgnAddress/Country!=''">
                        <xsl:call-template name="PopulateText">
                           <xsl:with-param name="TargetNode" select="$Form8883Data/TargetCorporationFrgnAddress/Country"/>
                        </xsl:call-template>
                      </xsl:if>
                    </xsl:if>  
                 </div>
                 ...
                 <div style="width:88mm;">
                   ...
                   <!--L3c-->
                   <div class="styLNLeftNumBox" style="border-left:solid 1px black;height:12mm;border-top:solid black 1;">3c</div>
              ...
              <div class="styBB" style="width:187mm;">
                 ...
                 <!--L5b -->
                 <div class="styNameBox" style=" width:56.25mm;font-size:7pt;height:auto;">
                 ...
                 <!--L5c-->
                 <div class="styNameBox" style=" width:45.5mm;font-size:7pt;height:auto;">
              ...
              <div style="width:187mm;">
               ...
               <div class="styBB" style="width:187mm;">
                 ...
                 <div class="styLNDesc" style="width:178mm;height:auto;">
                    ...
                    <xsl:for-each select="$Form8883Data/TYWhichOrigForm8023Or8883Filed">           
                      <xsl:call-template name="PopulateText">
		            <xsl:with-param name="TargetNode" select="$Form8883Data/TYWhichOrigForm8023Or8883Filed/TaxYr"/>
                      </xsl:call-template>
                      <span style="width:16px;"/>
                      <xsl:call-template name="PopulateText">
          	            <xsl:with-param name="TargetNode" select="$Form8883Data/TYWhichOrigForm8023Or8883Filed/TaxReturnFormNumberDsc"/>
                      </xsl:call-template>
               ...
               <div class="styBB" style="width:187mm;">        
                 <table class="styTable" cellspacing="0" style="font-size:7pt;height:auto;">
                   <thead class="styTableThead">
                      <tr>
                        <th class="styTableCellHeader" style="height:auto;width:31mm;text-align:left;" scope="col">                                        
                            <span class="styBoldText" style="width:24px;">11</span><span style="font-size:6pt;font-weight:normal;">  Assets </span>
                        </th>
                        <th class="styTableCellHeader" style="height:auto;width:60mm;font-size:6pt;font-weight:normal;" scope="col">Allocation of sales price as previously reported</th>
                        <th class="styTableCellHeader" style="height:auto;width:37mm;font-size:6pt;font-weight:normal;" scope="col">Increase or (decrease)</th>  
                        <th class="styTableCellHeader" style="height:auto;width:58mm;border-right-width: 0px;font-size:6pt;font-weight:normal;" scope="col">Redetermined allocation of AGUB or ADSP</th>      
                      </tr>
                  </thead>
                  <tfoot/>
                  <tbody>

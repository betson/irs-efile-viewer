...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/CodeDQlfyRehbltExpendStmt"/>
  
  <!-- Template to display Code D Qualified Rehabilitation Expenditures Statement  -->
  
  <xsl:template name="ShowDependencyData">
    <!--Code D Qualified Rehabilitation Expenditures Statement Data -->
    <table class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/CodeDQlfyRehbltExpendituresGrp">
          <tr>

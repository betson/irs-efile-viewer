  ...
  <body class="styBodyClass">    
    <form style="font-family:arial; font-size:8.5pt" name="Form990ScheduleB">
      ...
      <div class="styTBB" style="width:187mm">
        ...
        <div class="styFTBox" style="width:125mm">
          ...
          <div style="padding-left:12mm; text-align:center;"><img src="{$ImagePath}/990SchB_Bullet.gif" alt="Arrow Bullet"/> Information about Schedule B (Form 990, 990-EZ, or 990-PF) and its instructions is at <!--www.irs.gov/form990.--><a href="http://www.irs.gov/form990" title="Link to IRS.gov">
      ...
      <div style="padding-left:5mm; margin-top:5mm; width:187mm">
        ...
        <div style="float:right; width:177mm">
          ...
          <xsl:with-param name="BackupName">IRS990SchBSpclRuleRcvdTotContriUpTo1000</xsl:with-param>
            ...
            For a section 501(c)(7), (8), or (10) organization filing Form 990 or 990-EZ that received from any one contributor,<br />during the year, contributions for use <i>exclusively</i> for religious, charitable, etc., purposes, but these contributions did<br />not total more than $1,000. If this box is checked, enter here the total contributions that were received during<br />the year for an <i>exclusively</i> religious, charitable, etc., purpose. Do not complete any of the parts unless the <b>General Rule</b><br />applies to this organization because it received <i>nonexclusively</i> religious, charitable, etc., contributions of $5,000 or more<br />during the year
          </label>        
   ...
   <xsl:choose>
    ...
    <!-- END Part III -->              
     ...
     <xsl:if test="($Print = $Separated) and (count($Form990ScheduleBData/CharitableContributionsDetail) &gt; 4)"> <br/>
    ...
    <tr>          
      ...
      <td class="styIRS990ScheduleBTblRB">        
        <div class="styIRS990ScheduleBDotBB"> 
          <div style="font-family:verdana;font-size:6pt;">               
           <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorBusinessName/BusinessNameLine1"/></xsl:call-template><br/>
           <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorBusinessName/BusinessNameLine2"/></xsl:call-template>
       </div>
      <br/>
        ...
        <div class="styIRS990ScheduleBDotBB">  
          <xsl:choose>
            <xsl:when test="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress">
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress/AddressLine1"/></xsl:call-template><br/>
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress/AddressLine2"/></xsl:call-template> <span style="width:1px;" />                                                                 
            </xsl:when>
            <xsl:otherwise>
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/AddressLine1"/></xsl:call-template><br/>
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/AddressLine2"/></xsl:call-template> <span style="width:1px;" />                                                                       
            </xsl:otherwise>
          </xsl:choose>  
        </div>     
        <div class="styIRS990ScheduleBDotBB">  
          <xsl:choose>
            <xsl:when test="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress">
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress/City"/></xsl:call-template>, 
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress/State"/></xsl:call-template> <span style="width:1px;" />
              <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorUSAddress/ZIPCode"/></xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
              <xsl:if test="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress">
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/City"/></xsl:call-template>,
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/ProvinceOrState"/></xsl:call-template> <span style="width:1px;" />
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/PostalCode"/></xsl:call-template> <span style="width:1px;" />
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress/Country"/></xsl:call-template>
              </xsl:if>    
            </xsl:otherwise>
          </xsl:choose>                  
        </div>
      ...
      <div style="font-size:7pt; clear:both; padding-top:2mm; padding-left:4mm">(Complete Part II for noncash contributions.)</div>
      </td>
  ...
  <xsl:if test="$index &lt;= 6">
    ...
    <tr>          
      ...
      <td class="styIRS990ScheduleBTblCell">                        
        ...
        <div style="font-size:7pt; clear:both; padding-top:2mm; padding-left:4mm">(Complete Part II for<br /> noncash contribution.)</div>
      </td>                  
    </tr>  
    <xsl:if test="$index mod 6 = 0">
      <tr style="page-break-after:always">
...
<xsl:template name="p3Template">  
  ...
  <xsl:if test="$index &lt;= $max">    
    ...
    <tr align="center">      
      ...
      <th class="styIRS990ScheduleBTblRB" scope="col" width="31%">(c) Use of gift</th>  
          ...
          <tr style="height:16mm">
            <td class="styIRS990ScheduleBTblRB" style="font-size:7pt;font-family:verdana;">                            
              <div class="styIRS990ScheduleBDotBB1" style="height:3mm">    
                ...
                <div style="font-family:verdana;font-size:6pt;">                 
                 <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/CharitableContributionsDetail[$index]/TransfereeNameBusiness/BusinessNameLine1"/></xsl:call-template>
                <xsl:if test="normalize-space($Form990ScheduleBData/CharitableContributionsDetail[$index]/TransfereeNameBusiness/BusinessNameLine2)!=''">
                  <br/><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/CharitableContributionsDetail[$index]/TransfereeNameBusiness/BusinessNameLine2"/></xsl:call-template>                          
                 </xsl:if> 
                </div>         
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>                  
                  ...
                  <div class="styIRS990ScheduleBDotBB1" style="height:4mm;border-bottom:0;">                          
                    ...
                    <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/CharitableContributionsDetail[$index]/TransfereeForeignAddress/PostalCode"/></xsl:call-template>                                                              
                  </div>
                  <div>
                    <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/CharitableContributionsDetail[$index]/TransfereeForeignAddress/Country"/></xsl:call-template>
                  </div>
                </xsl:otherwise>
              </xsl:choose>                            
            </td>
...
<xsl:template name="IRS990BFooter">  
  ...
  <!--div style="width:187mm; font-size:7pt; border-top:1 solid black; page-break-after:always"-->   
    ...
    <div style="float:right; padding-top:0.5mm; padding-right:0.5mm">      
      ...
      <b>Schedule B (Form 990, 990-EZ, or 990-PF) (2013)</b>
    </div>
  <!--/div-->    
</xsl:template>
...
<xsl:template name="p3SRDTemplate">  
  ...
  <xsl:if test="$index &lt;= count($Form990ScheduleBData/CharitableContributionsDetail)">    
      <thead class="styTableThead">
      <tr class="styDepTblHdr" align="center">      
        <th class="styDepTblCell" scope="col" width="7%" style="line-height:100%;">(a) No.<br/>from<br/>Part I</th>

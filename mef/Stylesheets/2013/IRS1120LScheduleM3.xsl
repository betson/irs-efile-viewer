							...
							<div class="styLNDesc" style="width:135mm;padding-top:.5mm;">(1)
								...
								<label>
									...
									<span style="width:35mm;border-bottom:solid 1px;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/OtherInd/@description"/>
										</xsl:call-template>
									</span>
								</label>
							</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:48.9mm;float:right;clear:none;border-top:solid 1px;padding-left:2mm">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItemsGrp/MissingEINReasonCd"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:138mm;height:auto;border-right:solid 1px;float:left;clear:none;border-top:solid 1px;">
						  Name of subsidiary (if consolidated return)<br/>
							...
							<xsl:if test="$Form1120LScheduleM3/ExpenseDeductionItems/SubsidiaryBusinessName/BusinessNameLine2">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/ExpenseDeductionItems/SubsidiaryBusinessName/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
						</div>
						<!-- Employer Identification Number -->

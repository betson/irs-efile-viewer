      ...
      <body class="styBodyClass">
        <form name="Form990">
          ...
          <div style="width:187mm;font-weight:bold;">
            <span class="styBoldText" style="width:3mm;">A</span> For the 2013 calendar year, or tax year beginning
...
<!--<xsl:call-template name="PopulateAdditionalDataTableMessage">
         ...
         possesses the books and records of the organization: <br/><img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
            <xsl:choose>
                ...
                <tr>
                  <td class="styTableCellText" scope="col" style="width:124mm;">
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <xsl:call-template name="PopulateText">
                          <xsl:with-param name="TargetNode" select="ContractorName/BusinessName/BusinessNameLine1"/>
                        </xsl:call-template>
                        <xsl:if test="ContractorName/BusinessName/BusinessNameLine2">
                       <xsl:call-template name="PopulateText">
                            <xsl:with-param name="TargetNode" select="ContractorName/BusinessName/BusinessNameLine2"/>
                          </xsl:call-template>
                        </xsl:if>
                      </xsl:otherwise>
                    </xsl:choose>

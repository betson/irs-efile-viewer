...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="OIPASData" select="$RtnDoc/OrdnryIncmLossPssvBusActyStmt"/>
  <!-- Common Form displays as - Ordinary income loss passive business activities statement - -->
  <xsl:template name="ShowOIPAS">
    ...
    <table id="OIPASTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
        ...
        <tfoot/>
       <tbody>
      <xsl:for-each select="$OIPASData/OrdinaryIncomeLossPssvBusActy">
        <tr>

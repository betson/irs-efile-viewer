...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="FormTitleText">
		<xsl:choose>
			  <xsl:when test="$SubType='940' and $Language='ENGLISH'">940 for 2013:</xsl:when>
			  <xsl:when test="$SubType='940PR' and $Language='ENGLISH'">&lt;span style="font-size:9pt;"&gt;940-PR (Eng) for 2013:&lt;/span&gt;</xsl:when>
			  <xsl:when test="$SubType='940' and $Language='SPANISH'">940 para 2013:</xsl:when>
			  <xsl:when test="$SubType='940PR' and $Language='SPANISH'">940-PR para 2013:</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="NameBoxWidth">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">85</xsl:when>
	...
	<xsl:variable name="StateWidth">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">65</xsl:when>
			  <xsl:otherwise>63</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="ForeignPostalCodeText">
		<xsl:choose>
	...
	<xsl:variable name="ReturnTypeCText">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">No payments to employees in 2013</xsl:when>
			  <xsl:otherwise>Ning&amp;#250;n pago hecho a los empleados en 2013</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="ReturnTypeInstructionsText">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Instructions and prior-year forms are available at &lt;i&gt;www.irs.gov/form940.&lt;/i&gt;</xsl:when>
			  <xsl:otherwise>Instrucciones y formularios para a&amp;#241;os anteriores est&amp;#225;n disponibles en &lt;i&gt;www.irs.gov/form940pr.&lt;/i&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Part1Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Tell us about your return. If any line does NOT apply, leave it blank.</xsl:when>
			  <xsl:otherwise>Inf&amp;#243;rmenos sobre su planilla. Si NO le corresponde una línea, d&amp;#233;jela en blanco.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Part2Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Determine your FUTA tax before adjustments for 2013. If any line does NOT apply, leave it blank.</xsl:when>
			  <xsl:otherwise>&lt;span style="font-size:7pt;"&gt;Determine su contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; sin considerar ajustes para 2013. Si NO le corresponde una línea, d&amp;#233;jela en blanco.&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line8Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;"&gt;&lt;b&gt;FUTA tax before adjustments&lt;/b&gt; (line 7 x .006 = line 8)&lt;/span&gt;
			  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
							  <xsl:call-template name="DotLoop">					
								<xsl:with-param name="DotQty" select="13"/>
							</xsl:call-template>
							&lt;/span&gt;</xsl:when>
			  <xsl:otherwise>&lt;span style="float:left;"&gt;&lt;b&gt;Total de la contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; antes de considerar los ajustes&lt;/b&gt; (l&amp;#237;nea &lt;b&gt;7&lt;/b&gt; x .006 = l&amp;#237;nea &lt;b&gt;8&lt;/b&gt;)&lt;/span&gt;
			  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
							  <xsl:call-template name="DotLoop">					
	...
	<xsl:variable name="Line9Text">
		<xsl:choose>
			  ...
			  &lt;span style="float:left;"&gt;multiply line 7 by .054&lt;/b&gt; (line 7 × .054 = line 9). Go to line 12&lt;/span&gt;
			  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
							  <xsl:call-template name="DotLoop">					
								<xsl:with-param name="DotQty" select="11"/>
							</xsl:call-template>
							&lt;/span&gt;</xsl:when>
			  <xsl:otherwise>&lt;span style="font-size:6.2pt;"&gt;&lt;b&gt;Si el TOTAL de los salarios sujetos a la contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; que pag&amp;#243; fue excluido de la contribuci&amp;#243;n estatal para el desempleo, multiplique la cantidad de la l&amp;#237;nea 7 por .054&lt;/b&gt; (l&amp;#237;nea &lt;b&gt;7&lt;/b&gt; x .054 = l&amp;#237;nea &lt;b&gt;9&lt;/b&gt;). Pase a la l&amp;#237;nea &lt;b&gt;12&lt;/b&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
...
en las instrucciones del Formulario 940, en ingl&amp;#233;s. Anote la cantidad de la l&amp;#237;nea &lt;b&gt;7&lt;/b&gt; de la hoja de trabajo.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line11Text">
		<xsl:choose>
			  ...
			  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
							...
							&lt;/span&gt;</xsl:when>
			  <xsl:otherwise>&lt;b&gt;Si corresponde la reducci&amp;#243;n en el cr&amp;#233;dito,&lt;/b&gt; anote el total del Anexo A (Formulario 940-PR)</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Part4Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Determine your FUTA tax and balance due or overpayment for 2013. If any line does NOT apply, leave it blank.</xsl:when>
			  <xsl:otherwise>Determine su contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; y saldo adeudado o cantidad pagada en exceso para 2013. Si NO le corresponde una línea, d&amp;#233;jela en blanco.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Part45Height">
		<xsl:choose>
	...
	<xsl:variable name="Line12Text">
		<xsl:choose>
			  ...
			  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
							...
							&lt;/span&gt;</xsl:when>
			  <xsl:otherwise>&lt;b&gt;Total de su contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; despu&amp;#233;s de considerar los ajustes&lt;/b&gt; (l&amp;#237;neas &lt;b&gt;8&lt;/b&gt; + &lt;b&gt;9&lt;/b&gt; + &lt;b&gt;10&lt;/b&gt; + &lt;b&gt;11&lt;/b&gt; = l&amp;#237;nea &lt;b&gt;12&lt;/b&gt;)</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line17TotalText">
		<xsl:choose>
			  ...
			  <xsl:otherwise>Este total tiene que ser igual al de la l&amp;#237;nea 12.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="PrintBoxWidth">
		<xsl:choose>
			  ...
			  <xsl:otherwise>36.5</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="BestNumberBoxWidth">
		<xsl:choose>
			  ...
			  <xsl:otherwise>26.5</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:template match="/">
		<html lang="{$HtmlLang}">
			...
			<body class="styBodyClass" >
				<form name="Form940">
					...
					<div class="styFNBox" style="width:{$FormTitleWidth}mm;height:10mm;border:0px;">
					...
					<div class="styFTBox" style="width:{$FormNameWidth}mm;text-align:left;height:10mm;">
				   ...
				   <div class="styTYBox" style="width:30mm;height:10mm;border:0px;">
					  <div style="font-size:12pt;font-family:Courier New;font-weight:bold;text-align:right;"><xsl:value-of disable-output-escaping="yes" select="$FormUpperRightNumber" /></div>
					  <div class="styOMB" style="font-size:7pt;text-align:right;border:0px;padding-top:1mm;"><xsl:value-of disable-output-escaping="yes" select="$FormOMBNoText" /></div>
				   </div>
						
						<div class="styBB" style="float:left;border:black solid 1px; padding-top:2mm; padding-left:2mm; padding-right:2mm;font-size:6pt;">
							<div style="width:118mm;padding-top:0mm;">
								<span style="float:left;"><b><xsl:value-of disable-output-escaping="yes" select="$EINText" /></b></span>
								<div style="float:left;">
									<span class="styLNCtrNumBox" style="width:73mm;border-top-width:1px;padding-top:1mm;float:right;height:6mm;">
							...
							<div style="width:118mm;padding-bottom:2mm;padding-top:2mm;">
								<span style="float:left;padding-top:3mm;"><xsl:value-of disable-output-escaping="yes" select="$NameText" /></span>
								<span class="styLNCtrNumBox" style="width:{$NameBoxWidth}mm;border-top-width:1px;padding-top:1mm;float:right;height:6mm;text-align:left;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div style="width:118mm;padding-bottom:2mm;">
								<span style="float:left;padding-top:3mm;"><xsl:value-of disable-output-escaping="yes" select="$TradeNameText" /></span>
								<span class="styLNCtrNumBox" style="width:{$TradeNameBoxWidth}mm;border-top-width:1px;padding-top:1mm;float:right;height:6mm;text-align:left;">
							...
							<div style="width:118mm;padding-bottom:0mm;">
								<span style="float:left;padding-top:3mm;font-weight:bold;height:15mm;"><xsl:value-of disable-output-escaping="yes" select="$AddressText" /></span>
								<span style="float:right;">
								<span class="styLNCtrNumBox" style="width:103mm;border-top-width:1px;padding-top:1mm;height:6mm;text-align:left;">
								...
								<span style="width:103mm;font-size:5pt;vertical-align:middle;padding-left:1mm;">
									<xsl:value-of disable-output-escaping="yes" select="$NumberText" /><span style="width:25mm"/><xsl:value-of disable-output-escaping="yes" select="$StreetText" /><span style="width:{$SuiteWidth}mm;"/><xsl:value-of disable-output-escaping="yes" select="$SuiteText" />
								</span>
								<span class="styLNCtrNumBox" style="width:64mm;border-top-width:1px;padding-top:1mm;height:6mm;text-align:left;">
									<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateText">
								...
								<span style="width:2mm;float:left;"/>
								<span class="styLNCtrNumBox" style="width:22mm;border-top-width:1px;padding-top:1mm;height:6mm;">
									<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateText">
								...
								<span style="width:103mm;font-size:5pt;vertical-align:middle;padding-left:1mm;">
									<xsl:value-of disable-output-escaping="yes" select="$CityText" /><span style="width:{$StateWidth}mm"/><xsl:value-of disable-output-escaping="yes" select="$StateText" /><span style="width:{$ZipWidth}mm;"/><xsl:value-of disable-output-escaping="yes" select="$ZipText" />
								</span>															
								<span class="styLNCtrNumBox" style="width:38mm;border-top-width:1px;padding-top:1mm;height:6mm;text-align:left;">									
									<xsl:if test="$RtnHdrData/Filer/ForeignAddress">
										<xsl:call-template name="PopulateText">
								...
								<span style="width:2mm;float:left;"/>
								<span class="styLNCtrNumBox" style="width:28mm;border-top-width:1px;padding-top:1mm;height:6mm;">									
									<xsl:if test="$RtnHdrData/Filer/ForeignAddress">
										<xsl:call-template name="PopulateText">
								...
								<span style="width:103mm;font-size:5pt;vertical-align:middle;padding-left:1mm;">
									<span style="width:{$ForeignProvinceWidth}mm;text-align:left;"><xsl:value-of disable-output-escaping="yes" select="$ForeignCountryText" /></span><span style="width:2mm;"/><span style="width:33mm;text-align:center;"><xsl:value-of disable-output-escaping="yes" select="$ForeignProvinceText" /></span><span style="width:2mm;"/><span style="width:27.6mm;text-align:center;"><xsl:value-of disable-output-escaping="yes" select="$ForeignPostalCodeText" /></span>
								</span>
						...
						<div style="float:right;">
							<div class="styBB" style="width:auto;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;padding-right:3mm;">
								<div class="styPartName" style="width:53mm;text-align:left;padding-left:1mm;padding-top:0.5mm;padding-bottom:0.8mm;padding-right:0.6mm;"><xsl:value-of disable-output-escaping="yes" select="$ReturnTypeText" /><br/><span style="font-size:7pt;"><xsl:value-of disable-output-escaping="yes" select="$CheckAllApplyText" /></span></div>
								
								<div style="width:51mm;float:none;clear:both;">
									<div style="width:51mm;float:none;clear:both;">	
											<div style="width:51mm;padding-top:1mm;float:none;clear:both;">
								...
								<div style="width:52mm;padding-bottom:0.8mm;float:none;clear:both;">
				...
				<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:4mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 1:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;"><xsl:value-of disable-output-escaping="yes" select="$Part1Text" /></div>
				</div>
				
				<div style="width:187mm;padding-left:0mm;padding-top:2mm;padding-bottom:0px;">
					<!--Line 1a-->
					<div style="width:187mm;height:10mm;font-size:7pt;">
						<span style="float:left;">
							<div class="styLNLeftNumBoxSD" style="width:8mm;"><xsl:value-of disable-output-escaping="yes" select="$EnglishBreak" />1a</div>
							<div class="styLNDesc" style="width:136mm;padding-left:1mm;font-weight:bold;"><xsl:value-of disable-output-escaping="yes" select="$EnglishBreak" />
						...
						<span style="float:right;padding-top:2mm;padding-right:25mm;">
							...
							<div class="styIRS940LNAmountBox" style="width:12mm;border-top-width:1px;height:5mm;background-color:white;">
								<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm;height:8mm;">
						...
						<span style="float:right">
							<div class="styIRS940RightNumBox" style="float:left;padding-top:4mm;">1b</div>
							<div style="float:left;width:3mm;padding-top:4mm;">
									<input type="checkbox" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/MultiStateInd"/>
							...
							<div style="width:34mm;float:left;font-size:7pt;padding-top:2mm;">												
					...
					<div style="width:187mm;height:8mm;">
						...
						<span style="float:right">
							<div class="styIRS940RightNumBox" style="float:left;">2</div>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:4mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 2:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;background-color:white;"><xsl:value-of disable-output-escaping="yes" select="$Part2Text" /></div>
				</div>
					<!--Line 3-->
					...
					<div style="width:187mm;font-size:7pt;">
						<span style="float:left;">
							<div class="styLNLeftNumBoxSD" style="width:8mm;"></div>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:4mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 3:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;background-color:white;"><xsl:value-of disable-output-escaping="yes" select="$Part3Text" /></div>
				</div>
				<!--Line 9-->
					<div style="width:187mm;font-size:7pt;">
						<span style="float:left;">
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:{$Part45Height}mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 4:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:{$Part45Height}mm;padding-top:0mm;padding-left:2mm;background-color:white;font-size:7.5pt;"><xsl:value-of disable-output-escaping="yes" select="$Part4Text" /></div>
				</div>
				<!--Line 12-->
					...
					<div style="width:187mm;font-size:7pt;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:136mm;padding-left:1mm;">
								<xsl:value-of disable-output-escaping="yes" select="$Line14Text" /><br />
								• <xsl:value-of disable-output-escaping="yes" select="$Line14MoreText" /><br />
								<span style="float:left;padding-right:3px;">•</span><xsl:value-of disable-output-escaping="yes" select="$Line14LessText" />
							</div>
						</span>
					...
					<div style="width:187mm;">
						<span style="float:left;">
							...
							<div class="styLNDesc" style="width:auto;padding-left:1mm;">
								...
								<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak" />
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/> <xsl:value-of disable-output-escaping="yes" select="$MustCompleteText" />
							</div>
						</span>
						<span style="float:right;">
							<div style="float:right;">							
						...
						<span style="float:right;"><xsl:value-of disable-output-escaping="yes" select="$CheckOneText" /></span>
						</div>
							<div style="width:30mm;text-align:right;padding-bottom:0mm;float:right;">
								<img src="{$ImagePath}/{$NextImageNm}.png" alt="Next Page Arrow Image"/>
							</div>
						</span>
					</div>					
				</div>
		...
		<div class="pageEnd" style="width:187mm;border-top-width:1px;border-bottom:0px solid black;">
			<span style="float:left;clear:none;font-weight:bold;font-size:6pt;"><xsl:value-of disable-output-escaping="yes" select="$ForPrivacyText" /></span>
			<span style="float:left;clear:none;margin-left:5mm;font-size:6pt;padding-top:2px;"><xsl:value-of disable-output-escaping="yes" select="$CatNoText" /></span>
			<span style="float:right;clear:none;font-size:6pt;"><xsl:value-of disable-output-escaping="yes" select="$FormText" /><span class="styBoldText" style="font-size:6pt;"><xsl:value-of disable-output-escaping="yes" select="$FormNoText" /></span> (2013)</span>
		</div>
		
		<!--Begin Page 2-->
		<div style="width:187mm;">
			<div style="width:187mm;font-size:12pt;font-family:Courier New;font-weight:bold;text-align:right;"><xsl:value-of disable-output-escaping="yes" select="$FormUpperRightNumber2" /></div>
			<!--Name Shown on return-->
			<div class="styBB" style="width:187mm;font-size:6pt;border-top-width:2px;">
				<div class="styFNBox" style="width:126mm; height:8mm;">
					<xsl:value-of disable-output-escaping="yes" select="$NameText" /><br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
								<xsl:with-param name="TargetNode">BusinessNameLine1</xsl:with-param>
							</xsl:call-template><br />
							<xsl:call-template name="PopulateReturnHeaderFiler">
                ...
                <div style="width:60mm;"><b><xsl:value-of disable-output-escaping="yes" select="$EIN2Text" /></b><br/><span style="width:60mm;text-align:center;"><br />
							<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">EIN</xsl:with-param>
		...
		<!--Part 5-->
		<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:{$Part45Height}mm;padding-top:{$Part5Padding}mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 5:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:{$Part45Height}mm;padding-top:0mm;padding-left:2mm;background-color:white;"><xsl:value-of disable-output-escaping="yes" select="$Part5Text" /></div>
				</div>
				<!--Line 16-->
					<div style="width:187mm;font-size:7pt;">
						<span style="float:left;">
							<div class="styLNLeftNumBox" style="width:8mm;">16</div>
							<div class="styLNDesc" style="width:175mm;padding-left:1mm;font-weight:bold;">
					...
					<div style="width:187mm;font-size:7pt;">
						...
						<div class="styGenericDiv" style="padding-left:1mm;font-weight:bold;font-size:6.5pt;padding-top:{$Line17EqualLine12Padding}mm;"><xsl:value-of disable-output-escaping="yes" select="$Line17TotalText" /></div>
					</div>
					
		
		<!--Part 6-->
		<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:4mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 6:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;background-color:white;"><xsl:value-of disable-output-escaping="yes" select="$Part6Text" /></div>
				</div>
		<div class="styLNDesc" style="width:187mm;padding-left:9mm;padding-bottom:2mm;">
		...
		<div style="width:187mm;float:none;clear:both;padding-bottom:2mm;">
			<div style="width:19mm;float:left;padding-top:1mm;">
				...
				<span>
					...
					<label>
						...
						<b><xsl:value-of disable-output-escaping="yes" select="$YesText" /></b>
					</label>
				</span>
			...
			<div style="width:168mm;float:right;">
				<div style="width:168mm;height:7mm;">
					<div class="styLNDesc" style="width:50mm;float:left;padding-top:1mm;">
						<xsl:value-of disable-output-escaping="yes" select="$DesigneeNameText" />
					</div>
					<div class="styLNCtrNumBox" style="width:64mm;border-top-width:1px;height:5mm;background-color:white;float:left;">
						<xsl:call-template name="PopulateText">
					...
					<div class="styLNCtrNumBox" style="width:42mm;border-top-width:1px;height:5mm;background-color:white;">
				...
				<div style="width:168mm;height:6mm;">
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">
					<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:4mm;padding-top:0mm;"><xsl:value-of disable-output-escaping="yes" select="$PartText" /> 7:</div>
					<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;background-color:white;"><xsl:value-of disable-output-escaping="yes" select="$Part7Text" /></div>
				</div>
		<div class="styLNDesc" style="width:187mm;height:8mm;padding-left:2mm;font-size:7pt;">
		...
		<div style="width:187mm;float:none;clear:both;">
			...
			<div style="width:71mm;float:left;">
				<div style="width:{$PrintTextWidth}mm;height:8mm;float:left;"><xsl:value-of disable-output-escaping="yes" select="$PrintNameText" /></div>
					<div style="height:8mm;padding-top:1mm;float:right;">
						<div class="styLNCtrNumBox" style="width:{$PrintBoxWidth}mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:left;padding-left:1mm;">
				...
				<div style="width:71mm;float:left;">	
					<div style="width:{$PrintTextWidth}mm;height:7mm;float:left;"><xsl:value-of disable-output-escaping="yes" select="$PrintTitleText" /></div>
					<div style="height:7mm;padding-top:1mm;float:right;float:right;">
						<div class="styLNCtrNumBox" style="width:{$PrintBoxWidth}mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:left;padding-left:1mm;float:right;">
		...
		<div class="styBB" style="width:187mm;padding-bottom:3mm;padding-top:0.5mm;padding-right:.2mm;">
			...
			<div class="styLNCtrNumBox" style="width:{$BestNumberBoxWidth}mm;border-top-width:1px;height:6mm;padding-top:1mm;float:right;">
		...
		<div style="width:187mm;padding-bottom:2mm;">
			<div class="styLNDesc" style="width:100mm;font-size:9pt;font-weight:bold;float:left;padding-left:5mm;">
				<xsl:value-of disable-output-escaping="yes" select="$PaidPreparerText" />
			</div>
			<div class="styLNDesc" style="width:70mm;float:right;">
		...
		<div style="width:187mm;padding-bottom:3mm;">
			...
			<div style="float:right;">
			<div class="styLNCtrNumBox" style="width:44.8mm;border-top-width:1px;height:5mm;background-color:white;font-size:5.5pt;">
		...
		<div class="styBB" style="width:187mm;padding-bottom:6mm;border-bottom-width:2px;">
			...
			<div class="styLNCtrNumBox" style="width:10mm;border-top-width:1px;height:5mm;background-color:white;">
				<xsl:if test="$RtnHdrData/PaidPreparerInformationGrp/PreparerUSAddress">
					<xsl:call-template name="PopulateText">
		...
		<div class="pageEnd" style="width:187mm;border-top-width:1px;border-bottom-width:0px;">
			<span style="float:left;clear:none;"><xsl:value-of disable-output-escaping="yes" select="$PageText" /> <span class="styBoldText" style="font-size:8pt;"> 2</span></span>
			<span style="float:right;clear:none;"><xsl:value-of disable-output-escaping="yes" select="$FormText" /> <span class="styBoldText" style="font-size:8pt;"><xsl:value-of disable-output-escaping="yes" select="$FormNoText" /></span> (2013)</span>
		</div>
		<!--END Page Footer-->

...
<xsl:strip-space elements="*"/>
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/RegisteredUltimateVendorsStmt"/>
  ...
  <xsl:template name="RegisteredUltimateVendorsStmtTemp">
  
    <table id="GeneralDependencyTbl" class="styDepTbl">
      <tr class="styDepTblHdr">
         <th class="styDepTblCell" style="width:140mm">Name</th>
         <th class="styDepTblCell" style="width:25mm;">EIN</th>
         <th class="styDepTblCell" style="width:22mm;">Number of Gallons</th>
      </tr>
      <xsl:for-each select="$DependencyData/RegdUltimateVendorsStmtGrp">
        <tr>
    ...
    <xsl:call-template name="AddOnStyle"/>    
     ...
     <body class="styBodyClass">
        ...
        <xsl:call-template name="PopulateDepCommonLeftover">
          ...
          <xsl:call-template name="RegisteredUltimateVendorsStmtTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
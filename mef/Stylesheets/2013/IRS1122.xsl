    ...
    <form name="Form1122">
      ...
      <div class="styBB" style="width:187mm;">
        <div style="height:8mm;padding-top:6mm;">
            For the calendar year<span style="width:8px;"/> 
      ...
      <div class="styBB" style="width:187mm;">
        <div class="styNameBox" style="width:135mm;height:8mm;font-size:7pt;">
          ...
          <span>
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryBusinessName/BusinessNameLine1"/>
            </xsl:call-template>
            <xsl:if test="$Form1122Data/SubsidiaryBusinessName/BusinessNameLine2 !=''">
              <br/><xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryBusinessName/BusinessNameLine2"/>
              </xsl:call-template>
            </xsl:if>
          </span>
        </div>
      ...
      <div class="styBB" style="width:187mm;">
        <div class="styumberBox" style="height:8mm;font-size:7pt;">
          ...
          <xsl:if test="$Form1122Data/SubsidiaryCorpUSAddress">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryCorpUSAddress/AddressLine1"/>
                  </xsl:call-template>
                  <xsl:if test="normalize-space($Form1122Data/SubsidiaryCorpUSAddress/AddressLine2)!=''">    
                    <br/>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryCorpUSAddress/AddressLine2"/>
                    </xsl:call-template>          
                  </xsl:if>
                </xsl:if>
      ...
      <div class="styBB" style="width:187mm;">
        <div class="styNumberBox" style="height:8mm;font-size:7pt;">
          ...
          ZIP code<br/><br/>
            <xsl:if test="$Form1122Data/SubsidiaryCorpUSAddress">
            <xsl:if test="$Form1122Data/SubsidiaryCorpUSAddress/City!=''">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryCorpUSAddress/City"/>
              </xsl:call-template>,
            </xsl:if>
            <xsl:if test="$Form1122Data/SubsidiaryCorpUSAddress/State!=''">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryCorpUSAddress/State"/>
              </xsl:call-template>
            </xsl:if>
            <xsl:if test="$Form1122Data/SubsidiaryCorpUSAddress/ZIPCode!=''">
              <span style="width:1mm;"/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form1122Data/SubsidiaryCorpUSAddress/ZIPCode"/>
              </xsl:call-template>
            </xsl:if>
             </xsl:if>
              <xsl:if test="$Form1122Data/SubsidiaryCorpForeignAddress">
...
form and the information contained herein, and to the best of my knowledge and belief, it is true, correct, and complete.          
      ...
      <div style="width:187mm;padding-top:1mm;">
        <div style="width:90mm;float:left;clear:none;"/>

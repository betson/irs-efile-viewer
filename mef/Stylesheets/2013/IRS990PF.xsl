      ...
      Form<span class="styFormNumber">990-PF</span>
						...
						<div class="styFTBox" style="width:124mm;height:20mm;padding-top: 1.5mm">
							...
							<div class="styFBT" style="font-size: 7pt; font-weight: normal; margin-top: 0px; padding-top: 1mm">
								...
								<span class="styBoldText">Do not enter Social Security numbers on this form as it may be made public.  By law, the IRS cannot redact the information on the form.</span><br/>
...
<xsl:call-template name="LinkToLeftoverDataTableInline">
    ...
    Statements Regarding Activities 
      ...
      Are the requirements of section 508(e) (relating to sections 4941 through 4945) satisfied either:
					...
					<div style="width: 186.75mm; padding-left: 8mm;">
  ...
  1  <span style="width: 2mm"/> List all officers, directors, trustees, foundation managers and their compensation (see instructions).
    ...
    Minimum Investment Return <span class="styNormalText"> (All domestic foundations must complete this part. Foreign foundations,<br/>see instructions.)</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/AverageMonthlyFMVOfSecAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1a  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/AverageMonthlyCashBalancesAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1b -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/FMVAllOtherNoncharitableAstAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1c  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/TotalFMVOfUnusedAssetsAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1d  -->
    ...
    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/ReductionClaimedAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">.............</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/AcquisitionIndebtednessAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 2  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/AdjustedTotalFMVOfUnusedAstAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3  -->
    ...
    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/CashDeemedCharitableAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">.............................</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/NetVlNoncharitableAssetsAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 5  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox" style="border-bottom-width: 0px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnAmt/MinimumInvestmentReturnAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 6  -->
    ...
    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/ExpensesAndContributionsAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">..........</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/ProgramRelatedInvstTotalAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1b  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/CharitableAssetsAcquisPaidAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 2 -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/SetAsideSuitabilityTestAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3a  -->
    ...
    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/SetAsideCashDistriTestAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">.................</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/QualifyingDistributionsGrp"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 4  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/PctSect4940eOrgNetInvstIncmAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 5 -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QualifyingDistributionsGrp/AdjustedQualifyingDistriAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 6  -->
									...
									<tr>
										...
										<td colspan="3" rowspan="2" style="vertical-align:top;border-color: black; border-style: solid; border-right-width: 1px; border-left-width: 0px; border-top-width: 0px; border-bottom-width: 1px;">
											...
											<span class="styIRS990PFSignatureBox" style="width:72.75mm;height:14mm;border-bottom-width: 0px;border-right-width:0px;float:right;">
												<span style="width: 72.75mm; padding-top: 0mm; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px; border-bottom-width: 1px;">

<?xml version="1.0"?>
<!-- 11/27/2013 - Modified as per defect #38062 - Jeremy Nichols -->
	...
	<xsl:template match="/">
		<html>
            ...
            (under section 6046A)<br/>
								<img src="{$ImagePath}/8865SchP_Bullet.gif" alt="Arrow Bullet"/> Attach To Form 8865. See Instructions for Form 8865.<br/> 								 <img src="{$ImagePath}/8865SchP_Bullet.gif" alt="Arrow Bullet"/>Information about Schedule P (Form 8865) and its separate instructions is at <a href="http://www.irs.gov/form8865" title="Link to IRS.gov"><i>www.irs.gov/form8865</i></a>
          </div>
						</div>
          ...
          20<span class="stytycolor">13</span>
					...
					<tr>
					  <td style="width:90mm;font-size:6pt;vertical-align:top;border-right:1 solid black;border-bottom:1 solid black;">
							<b>Name of foreign partnership</b>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form8865SchedulePData/ForeignPartnershipName/BusinessNameLine1"/>
							</xsl:call-template>
							<xsl:if test="normalize-space($Form8865SchedulePData/ForeignPartnershipName/BusinessNameLine2)!=''">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form8865SchedulePData/ForeignPartnershipName/BusinessNameLine2"/>
								</xsl:call-template>
							</xsl:if>
						</td>
						<td style="width:26mm;font-size:6pt;vertical-align:top;padding-left:0.5mm;border-right:1 solid black;border-bottom:1 solid black;">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">																		  <xsl:with-param name="TargetNode" select="$Form8865SchedulePData/MissingEINReasonCd"/>
									</xsl:call-template>
								</xsl:otherwise>	 
							</xsl:choose>
						</td>
						<td style="font-size:6pt;vertical-align:top;padding-left:0.5mm;border-right:0 solid black;border-bottom:1 solid black;">
							...
							<xsl:if test="(count($Form8865SchedulePData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber) &lt;=1)">
								<br/>
							</xsl:if>
							<xsl:for-each select="$Form8865SchedulePData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber">
								<br/>
								<xsl:call-template name="PopulateText">

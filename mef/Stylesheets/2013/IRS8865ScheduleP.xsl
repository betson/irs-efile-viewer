...
<!-- 08/03/2015 - Changes made for defect 43693 - Jeremy Nichols -->
							...
							<table class="styDepTbl" style="font-size:7pt;width:187mm;">
								<thead class="styTableThead">
									<tr class="styDepTblHdr" align="center" style="height:11.7mm">
										<th class="styDepTblCell" style="width:65mm" scope="col">(a)<br/>Name, address, and identifying number of<br/>person from whom your interest was acquired</th>
					...
					<xsl:if test="($Print =$Separated) and (count($Form8865SchedulePData/DispositionInfo) &gt; $containerHeight)">
						...
						<div style="display:block;">
							<table class="styDepTbl" style="font-size:7pt">
								<thead class="styTableThead;">
									<tr class="styDepTblHdr" align="center" style="height:11.7mm">
										<th class="styDepTblCell" style="width:65mm" scope="col">(a)<br/>Name, address, and identifying number of<br/>person who acquired your interest</th>
										...
										<th class="styDepTblCell" style="width:20mm" scope="col">(e)<br/>% of interest<br/>before disposition</th>
										<th class="styDepTblCell" style="width:20mm">(f)<br/>% of interest<br/>after disposition</th>
									</tr>
								</thead>
								<tbody>
									<xsl:call-template name="p2Template">
		...
		<xsl:if test="$index &lt;= $max">
			<tr align="right" height="30">
              ...
              styDepTblRow2
				...
				<td class="styIRS8865SchedulePTblRB" align="left" style="width:65mm;font-size:7pt;">
...
<xsl:call-template name="PopulateText">
          ...
          <br/>
				...
				<td class="styIRS8865SchedulePTblRB" style="width:31mm'">

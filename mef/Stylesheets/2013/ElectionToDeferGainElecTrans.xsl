...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!--  Common Dependencies Form displays as - Election to Defer Gain From Qualifying Electric Transmission Transactions -->
  ...
  <xsl:template match="/">
	...
	<html>
      ...
      <body class="styBodyClass" style="width:187mm;">
		...
		<div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;">
			  <span class="styTopSectionLineLbl">Representation Indicating the Total Cost of Exempt Utility Property the Taxpayer Intends to Purchase:
			  </span>
		  </div>
          <div style="float:left;clear:none;">
            <xsl:call-template name="PopulateText">

...
<!DOCTYPE xsl:stylesheet [
  ...
  <!ENTITY nbsp "&#160;">
		...
		<xsl:template match="/">
					...
					<form style="font-family:Arial; font-size:8.5pt" name="Form8716">
						...
						<div class="styTBB" style="width:187mm">
							...
							<div class="styMainTitle" style="float:left; border-left:1 solid black; border-right:1 solid black; width:125mm; height:21.5mm; text-align:center; padding-top:4mm;  font-weight:bold">
								...
								Election To Have a Tax Year Other Than a<br/>Required Tax Year<br/><div><br/></div>

								<div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold; padding-bottom:4mm">

								<img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="Bullet"/>

             Information about Form 8716 and its instructions is at <i>

										<a href="http://www.irs.gov/form8716">www.irs.gov/form8716</a>.</i>
            ...
            <div style="float:right; width:48.5mm;border-left:1 solid black; text-align:center; height:8.5mm">
                  ...
                  <xsl:call-template name="PopulateYear">
                    ...
                    <xsl:with-param name="TargetNode" select="$Form8716Data/LastFiledReturnEndDt"/>
						...
						<div class="styBB" style="width:187mm">
							...
							<div style="float:right; width:48.5mm;border-left:1 solid black; text-align:center; height:12.5mm">

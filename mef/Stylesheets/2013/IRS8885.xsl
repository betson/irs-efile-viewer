					...
					<div class="styTBB" style="width:187mm;height:20mm;">
						<div class="styIRS8885LineItem" style="padding-top:1.5mm;padding-bottom:1mm;">
							...
							<div class="styIRS8885LNDesc" style="width:auto;height:100%;padding-top:6.5mm;">
								<b>Do not </b>complete this form if you can be claimed as a dependent on someone else's 2013 tax return.
							</div>
						</div>
					</div>
					<!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
					...
					<div class="styBB" style="width:187mm;height:75mm">
						...
						<div class="styIRS8885LineItem">
							...
							<div class="styIRS8885LNDesc" style="width:181mm;height:100%;">
								Check the boxes below for each month in 2013 that <b>all</b> of the following statements were <b>true</b> on the <b>first day</b> of that month.<br/>
								<span>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8885</span> (2013)
						</div>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="IRS944" style="font-family:arial;">
				   ...
				   <div class="styTYBox" style="width:43.7mm;height:10mm;border:0px;">
					...
					<div class="styBB" style="float:left;border:black solid 1px; padding-top:2mm; padding-left:1mm; padding-right:2mm; width:131mm;height:47.4mm;">
						...
						<div style="width:128mm;padding-bottom:2mm;padding-top:2mm;">
							...
							<span class="styLNCtrNumBox" style="width:95mm;border-top-width:1px;float:right;height:7mm;text-align:left;padding-left:1mm;">
								<xsl:call-template name="PopulateReturnHeaderFiler">
						...
						<div style="width:128mm;padding-bottom:0mm;">
							...
							<span style="float:right;">
								<span class="styLNCtrNumBox" style="width:116mm;border-top-width:1px;height:7mm;float:right;text-align:left;padding-left:1mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
								...
								<span style="width:118mm;font-size:6pt;padding-top:0mm;padding-bottom:1mm;">
									<span style="float:left;">
										<span style="width:11mm"/>Number<span style="width:26mm"/>Street
									</span>
									<span style="float:right;">	
										Suite or room number
									</span>
								</span>
								<span class="styLNCtrNumBox" style="width:24mm;border-top-width:1px;padding-top:2mm;height:6.3mm;float:right;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">ZIPCode</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:2mm;float:right;"/>
								<span class="styLNCtrNumBox" style="width:12mm;border-top-width:1px;padding-top:2mm;height:6.3mm;float:right;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">State</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:2mm;float:right;"/>
								<span class="styLNCtrNumBox" style="width:76mm;border-top-width:1px;padding-top:2mm;height:6.3mm;float:right;text-align:left;padding-left:1mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">City</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:118mm;font-size:6pt;padding-top:0mm;padding-bottom:1mm;">
									<span style="width:78mm;padding-left:11mm;">City</span><span style="width:16mm;text-align:center;">State</span><span style="width:23.9mm;text-align:center;">ZIP code</span>
								</span>
								<span class="styLNCtrNumBox" style="width:24mm;border-top-width:1px;padding-top:2mm;height:6.3mm;float:right;word-wrap:break-word;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
								...
								<span style="width:2mm;float:right;"/>
								<span class="styLNCtrNumBox" style="width:63.6mm;border-top-width:1px;padding-top:2mm;height:6.3mm;float:right;text-align:left;padding-left:1mm;word-wrap:break-word;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">Country</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:118mm;font-size:6pt;padding-top:0mm;padding-bottom:1mm;">
									<span style="width:66mm;padding-left:11mm;">Foreign country name</span><span style="width:28mm;text-align:center;">Foreign province/county</span><span style="width:23.9mm;text-align:center;">Foreign postal code</span>
									</span>
								</span>
							</div>
						</div>
						...
						<div style="float:right;padding-right:2mm;">
							<div class="styBB" style="width:51mm;height:30mm;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:1mm;padding-top:2mm;">
								...
								<div style="width:48.5mm;float:none;clear:both;padding-left:1mm;font-size:8pt;line-height:120%;">
									...
									notified you in<br/>writing.</b><br/>Instructions and prior-year forms are<br/>available at <i>
									www.irs.gov/form944</i>.
								</div>
							</div>
						</div>
					</div>
						
				<div class="styLNDesc" style="width:187mm;padding-top:0mm;padding-bottom:0mm;font-size:9pt;">
				...
				<div class="styBB" style="width:187mm;border-top-width:1px;">
					...
					<div class="styPartDesc" style="width:173.9mm;text-align:left;height:8mm;padding-left:2mm;font-size:9pt;">Answer these questions for this year. Employers in American Samoa, Guam, the Commonwealth of the Northern Mariana Islands, the U.S. Virgin Islands, and Puerto Rico can skip lines 1 and 2.</div>
				</div>
				...
				<div style="width:187mm;padding-left:0mm;padding-top:2mm;padding-bottom:0px;">
					...
					<div style="width:187mm;font-size:8pt;">
						...
						<div class="styLNDesc" style="width:187mm;font-style:italic;">
							<span style="width:67.5mm;"/><span style="width:35mm;text-align:center;">Column 1</span><span style="width:14mm;"/><span style="width:35mm;text-align:center;">Column 2</span>
						</div>
					</div>
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						...
						<div class="styLNDesc" style="width:53mm;font-weight:bold;padding-top:2mm;">
					...
					<div style="width:187mm;font-size:8pt;padding-bottom:2mm;">
						...
						<div class="styLNDesc" style="width:53mm;font-weight:bold;float:left;padding-top:0mm;">
							Taxable wages &amp; tips subject to<br/>
							Additional Medicare Tax<br/> withholding
							<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<span style="float:left;padding-top:2mm;">
							...
							<div class="styLNDesc" style="width:123mm;font-weight:bold;padding-top:0mm;">
								Add Column 2 from lines 4a, 4b, 4c and 4d
								<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<span style="float:left;padding-top:2mm;">
							...
							<div class="styLNDesc" style="width:130mm;padding-left:1mm;">
								<b>Total taxes before adjustments</b>. Add lines 2 and 4e
								<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<span style="float:left;padding-top:2mm;">
							...
							<div class="styLNDesc" style="width:130mm;padding-left:1mm;">
								<b>Current year’s adjustments</b> (see instructions)
								<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<span style="float:left;padding-top:2mm;">
							...
							<div class="styLNDesc" style="width:130mm;padding-left:1mm;">
								<b>Total taxes after adjustments.</b> Combine lines 5 and 6
								<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						...
						<span style="float:right;">
							<div class="styIRS944RightNumBox">9a</div>
							<div class="styLNCtrNumBox" style="width:43mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:right;padding-right:1mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<!--Line 9b-->
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<div class="styLNLeftNumBoxSD" style="width:8mm;padding-top:2.6mm;">9b</div>
						<div class="styLNDesc" style="width:128mm;padding-left:1mm;font-weight:bold;">
							<span style="float:left;padding-top:2mm;">
					...
					<div style="width:187mm;height:8mm;font-size:8pt;">
						<span style="float:left;padding-top:2mm;">
							...
							<div class="styLNDesc" style="width:130mm;padding-left:1mm;">
								<b>Balance due.</b> If line 7 is more than line 10, enter the difference and see instructions
								<span style="width:2px;"/>
								<span class="styBoldText">
									<span style="width:10px"/>.
									<span style="width:10px"/>.
					...
					<div style="width:187mm;height:8mm;">
						...
						<div class="styLNDesc" style="width:73mm;padding-left:1mm;padding-top:2.8mm;">
							<b>Overpayment.</b> If line 10 is more than line 7, enter the difference
						</div>
						<div class="styLNCtrNumBox" style="width:35mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:right;padding-right:1mm;">
							<xsl:call-template name="PopulateAmount">
						...
						<div class="styLNDesc" style="width:15mm;text-align:center;">
							Check one:
						</div>
						<input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
		...
		<div class="pageEnd" style="width:187mm;border-top-width:1px;padding-top:0mm;">
			...
			<span style="float:right;clear:none;">Form <span class="styBoldText" style="font-size:9pt;">944</span> (2013)</span>
		</div>
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
			...
			<div class="styPartDesc" style="width:173.9mm;text-align:left;height:6mm;padding-top:1mm;padding-left:2mm;font-size:9pt;">Tell us about your deposit schedule and tax liability for this year.</div>
		</div>
		
		<!--Line 13-->
		<div style="width:187mm;padding-bottom:1mm;padding-top:1mm;font-size:8pt;">
			<div class="styLNLeftNumBox" style="width:8mm;">13</div>
			<div class="styLNDesc" style="width:20mm;height:13mm;padding-left:1mm;">
				<b>Check one:</b>
			</div>
			<input type="checkbox" class="styCkbox">
				<xsl:call-template name="PopulateCheckbox">
			...
			<label style="padding-left:3mm;width:155mm;vertical-align:top;">
				...
				<b>Line 7 is less than $2,500. Go to Part 3.</b>
			</label>
			<br/><br/>
			<input type="checkbox" class="styCkbox">
				<xsl:call-template name="PopulateCheckbox">
			...
			<label style="padding-left:3mm;width:155mm;vertical-align:top;">
				...
				<span style="font-size:7pt;font-weight:bold;">Line 7 is $2,500 or more. Enter your tax liability for each month. If 
				you are a semiweekly depositor or you accumulate $100,000 or more of liability on any day during a deposit 
				period, you must complete Form 945-A instead of the boxes below.</span>
			</label>
		</div>
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">	
			...
			<div class="styPartDesc" style="width:173.9mm;text-align:left;height:6mm;padding-top:1mm;padding-left:2mm;font-size:9pt;">Tell us about your business. If question 14 does NOT apply to your business, leave it blank.</div>
		</div>
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">
			...
			<div class="styPartDesc" style="width:173.9mm;text-align:left;height:6mm;padding-top:1mm;padding-left:2mm;font-size:9pt;">May 
			we speak with your third-party designee?</div>
		</div>
		<div class="styLNDesc" style="width:187mm;padding-left:9mm;padding-right:6mm;font-size:8pt;">
		...
		<div style="width:187mm;float:none;clear:both;padding-bottom:2mm;font-size:8pt;">
			<div style="width:19mm;float:left;padding-top:2mm;">
			...
			<div style="width:167mm;float:right;font-size:8pt;padding-left:1mm;">
				<div style="width:166mm;height:6mm;">
					<div class="styLNDesc" style="width:50mm;float:left;padding-top:2mm;">
						Designee’s name and phone number
					</div>
					<div class="styLNCtrNumBox" style="width:60mm;border-top-width:1px;height:6mm;float:left;padding-top:1mm;text-align:left;padding-left:1mm;">
						<xsl:call-template name="PopulateText">
				...
				<div style="width:166mm;padding-top:5mm;">
					...
					<div style="float:left;">
						<div class="styLNCtrNumBox" style="width:36mm;border-top-width:1px;height:3mm;float:left;">
		...
		<!--Part 5-->
			...
			<div class="styPartDesc" style="width:173.9mm;text-align:left;height:6mm;padding-top:1mm;padding-left:2mm;font-size:9pt;">Sign Here. You MUST complete both pages of Form 944 and SIGN it.</div>
		</div>
		<div class="styLNDesc" style="width:187mm;padding-left:2mm;padding-right:2mm;font-size:7pt;padding-top:2mm;padding-bottom:4mm;">
		...
		<div style="width:187mm;float:none;clear:both;">
			<div style="float:left;padding-bottom:0px;width:47px;">
				<img src="{$ImagePath}/944_Signature.GIF" alt="Signature Image"/>
			</div>
			<div style="width:20mm;padding-top:3mm;font-weight:bold;font-size:10pt;float:left;">
				Sign your name here
			</div>
			<div class="styLNCtrNumBox" style="width:75mm;border-top-width:1px;height:14mm;float:left;word-wrap:break-word;padding-top:1mm;text-align:left;padding-left:1mm;padding-right:1mm;">
			...
			<div style="float:left;font-size:8pt;padding-left:10mm;padding-top:0mm;padding-right:3mm;">
				<div style="width:15mm;height:8mm;float:left;padding-top:0mm;">Print your name here</div>
				<div style="height:8mm;float:right;">
					<div class="styLNCtrNumBox" style="width:50mm;border-top-width:1px;height:6mm;float:right;text-align:left;padding-left:1mm;">
				...
				<div style="float:right;">
					<div class="styLNCtrNumBox" style="width:50mm;border-top-width:1px;height:6mm;padding-top:1mm;float:right;text-align:left;padding-left:1mm;">
		...
		<div class="styBB" style="width:187mm;padding-bottom:2mm;padding-top:0mm;padding-right:3mm;float:none;clear:both;">
			<div style="width:47px;float:left;"/>
			<div class="styLNDesc" style="width:20mm;text-align:right;padding-right:2mm;font-size:8pt;padding-top:2mm;">
				Date
			</div>
			...
			<div class="styLNDesc" style="width:28.6mm;font-size:8pt;padding-top:2mm;float:right;">
				Best daytime phone
			</div>
		</div>
				
		<div style="width:187mm;padding-bottom:4mm;">
			<div class="styLNDesc" style="width:46mm;font-size:9pt;font-weight:bold;float:left;padding-left:2mm;">
				Paid Preparer Use Only
			</div>
			<div class="styLNDesc" style="width:52mm;float:right;font-size:9pt;">
		...
		<div style="width:187mm;padding-bottom:2mm;padding-right:3mm;font-size:8pt;">
			<div class="styLNDesc" style="width:32mm;height:6mm;padding-left:2mm;padding-right:1mm;padding-top:1mm;">
				Preparer's name
			</div>
			...
			<div class="styLNDesc" style="width:20mm;height:6mm;padding-top:1mm;padding-left:8mm;">
				PTIN
			</div>
		...
		<div style="width:187mm;padding-bottom:2mm;font-size:8pt;">
			<div class="styLNDesc" style="width:32mm;height:6mm;padding-top:1mm;padding-left:2mm;padding-right:1mm;">
			...
			<div class="styLNDesc" style="width:21.1mm;height:6mm;padding-top:1mm;padding-left:8mm;">
				Date
			</div>
		...
		<div style="width:187mm;font-size:8pt;padding-bottom:2mm;padding-right:3mm;">
			<div class="styLNDesc" style="width:32mm;padding-left:2mm;padding-right:1mm;padding-top:0mm;">
				Firm's name (or yours if self-employed)
			</div>
			<div class="styLNCtrNumBox" style="width:90mm;border-top-width:1px;height:7mm;text-align:left;padding-left:1mm;">
				<xsl:call-template name="PopulateText">
		...
		<div style="width:187mm;padding-bottom:2mm;padding-right:3mm;font-size:8pt;">
			<div class="styLNDesc" style="width:32mm;height:6mm;padding-top:4mm;padding-left:2mm;padding-right:1mm;">
				Address
			</div>
			<div class="styLNCtrNumBox" style="width:90mm;border-top-width:1px;height:7mm;text-align:left;padding-left:1mm;">
			...
			<div class="styLNCtrNumBox" style="width:41mm;border-top-width:1px;height:6mm;padding-top:1mm;float:right;word-wrap:break-word;">
		...
		<div class="styBB" style="width:187mm;padding-bottom:4mm;border-bottom-width:2px;font-size:8pt;padding-right:3mm;">
			<xsl:choose>
				<xsl:when test="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress">
					...
					<div class="styLNCtrNumBox" style="width:46mm;border-top-width:1px;height:6mm;padding-top:1mm;text-align:left;padding-left:1mm;word-wrap:break-word;">
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="$RtnHdrData/PaidPreparerInformationGrp/PreparerForeignAddress/City"/>
						</xsl:call-template>
					</div>
					<div class="styLNDesc" style="width:12mm;height:6mm;padding-top:1mm;text-align:center;">
						Prov./St.
					</div>
				...
				<xsl:otherwise>
					...
					<div class="styLNDesc" style="width:15mm;height:6mm;padding-top:1mm;padding-left:5mm;">
						State
					</div>

            ...
            <thead class="styTableThead">
              <tr style="height:6mm;border-color:black;">
                ...
                <th class="styTableCellHeader" style="width:162mm;font-weight:normal;font-size:7pt;text-align:left;" scope="col">
                  Type of property—State whether rehabilitation, energy, reforestation, qualifying advanced coal project, qualifying gasification project, qualifying advanced energy project, or qualifying therapeutic discovery project property. (See the Instructions for Form 3468 for the year the investment
credit property was placed in service for definitions.) If rehabilitation property, also show type of building. If energy property, show type.
    ...
    <xsl:if test="not($Form4255Data/RecaptureOfInvstCrProperties) or ((count($Form4255Data/RecaptureOfInvstCrProperties) &gt; 4) and ($Print = $Separated))">
      ...
      <div class="styBB" style="width:187mm;">
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNDesc" style="width:141mm;">
            ...
            financing. Attach a seperate schedule (see instructions)
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNRightNumBox" style="height:10.5mm;;padding-top:5.5mm">
            12
          </div>
          <div class="styLNAmountBox" style="height:10.5mm;padding-top:5.5mm;">
            <xsl:call-template name="PopulateAmount">
      ...
      <div style="width:187mm; font-size:7pt;  border-top:1 solid black; padding-top:0.5mm">    
        ...
        Form <b style="font-size:9pt">4255</b> (Rev. 10-2010)
        </div>      
      </div> 

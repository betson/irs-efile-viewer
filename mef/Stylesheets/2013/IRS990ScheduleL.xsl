			...
			<body class="styBodyClass">
				<form name="Form990ScheduleL">
					...
					<div class="styTBB" style="width:187mm;height:auto;">
						...
						<div class="styFTBox" style="width:126mm;height:auto;">
        ...
        Complete if the organization answered "Yes" on Form 990-EZ, Part V, line 38a, or Form 990, Part IV, line 26; or if the organization reported an amount on Form 990, Part X, line 5, 6, or 22
					...
					<div class="styTableContainerNBB" id="IPRctn" style="height:auto;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:20mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:30mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(b)</span> Relationship with organization</th>
									<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:25mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(c)</span> Purpose of loan</th>
									<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:18mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(d)</span> Loan to or from the organization?</th>
									<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:32mm;font-weight:normal;text-align:center;vertical-align:top; ">
										<span style="font-weight:bold">(e)</span>Original principal amount </th>
								<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:32mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:1px;">
										<span style="font-weight:bold">(f)</span>Balance due</th>
									<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:8mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(g)</span> In default?</th>
									<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:8mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(h)</span> Approved by board or committee?</th>
								<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:16mm;font-weight:normal;border-right-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(i)</span>Written agreement?</th>
								</tr>
								<tr>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:9mm;font-weight:normal;">To</th>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:9mm;font-weight:normal;"> From</th>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:8mm;font-weight:bold;">Yes</th>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:8mm;font-weight:bold;">No</th>
								<th class="styTableCellHeader" style="height:auto;width:8mm;font-weight:bold;">Yes</th>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:8mm;font-weight:bold;">No</th>
								<th class="styTableCellHeader" style="height:auto;width:8mm;font-weight:bold;">Yes</th>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:8 mm;font-weight:bold;border-right:0px">No</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt;6">
									<xsl:for-each select="$FormData/LoansBtwnOrgInterestedPrsnGrp">
										<tr>
											<td class="styTableCellCtr" style="height:auto;width:40mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
													<xsl:when test="PersonNm">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="PersonNm"/>
												...
												<td class="styTableCell" style="height:auto;vertical-align:top;border-left:0px;text-align:left;width:20mm;padding-right:.5mm">
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCell" style="height:auto;text-align:center;width:9mm;vertical-align:top;padding-right:0.75mm;border-left:1px;border-right-width:1px;">
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCellCtr" style="height:auto;width:35mm;vertical-align:top;text-align:right;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
											...
											<td class="styTableCellCtr" style="height:auto;padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateYesBoxText">
											...
											<td class="styTableCellCtr" style="height:auto;padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:0px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="WrittenAgreementInd"/>
												</xsl:call-template>
											</td>
								...
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt;6)) ">
									<tr>
										<td class="styTableCellCtr" style="height:auto;width:40mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
								...
								<tr>
									<td class="styTableCellCtr" scope="col" colspan="6" style="height:auto;width:64mm;vertical-align:bottom;padding-right:0.5mm;border-right:0px">
									...
									<td class="styTableCell" style="height:auto;width:35mm;vertical-align:bottom;border-left:0px;font-size:5pt;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalBalanceDueAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCell" scope="col" colspan="6" style="height:auto;border-style: solid; border-color: black;width:88mm;vertical-align:bottom;border-top-width:1px;border-right-width:0px;background-color:lightgrey;">
					...
					<!-- End Part II -->
					<!-- Part III -->
					<div class="styBB" style="width:187mm;float:none;border-top:solid 1px;height:auto;">
						<div class="styPartName" style="float:left;width:14mm;">Part III</div>
						<div class="styPartDesc" style="width:172mm;height:auto;">Grants or Assistance Benefitting Interested Persons.<br/>
							<span style="font-size: 8pt;font-weight:normal;">
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
					...
					<div class="styTableContainerNBB" id="OActn" style="height:auto;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
								<th class="styTableCellHeader" scope="col" style="height:auto;width:37.2mm;font-weight:normal;border-top-width:1px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;">
										<span style="font-weight:bold;">(b)</span> Relationship between interested person and the organization</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:37.2mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:1px;border-right-width:1px">
										<span style="font-weight:bold">(c)</span> Amount of assistance</th>
										<th class="styTableCellHeader" scope="col" style="height:auto;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;border-right-width:1px">
										<span style="font-weight:bold">(d)</span> Type of assistance</th>
										<th class="styTableCellHeader" scope="col" style="height:auto;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;border-right-width:0px">
							...
							<tbody>
								...
								<xsl:for-each select="$FormData/GrntAsstBnftInterestedPrsnGrp">
										<tr>
											<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left;">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
													<xsl:when test="PersonNm">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="PersonNm"/>
											...
											<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RelationshipWithOrgTxt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right;">
													...
													<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-right-width:1px;text-align:left;">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="TypeOfAssistanceTxt"/>
														</xsl:call-template>
													
											</td>
											<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-right:0px;text-align:left;">
														<xsl:call-template name="PopulateText">
								...
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt;9)) ">
									...
									<tr>
										<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
										...
										<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right:0px">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right:0px">
											<span style="width:3px"/>
					...
					<div style="width:187mm;float:left;clear:both;border-top:solid 1px" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText" style="font-size:6pt">Schedule L (Form 990 or 990-EZ) 2013</span>
						</div>
					</div>
					 <p style="page-break-before: always"/> 
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Schedule L (Form 990 or 990-EZ) 2013</div>
            ...
            Complete if the organization answered "Yes" on Form 990, Part IV, line 28a, 28b, or 28c.
					...
					<div class="styTableContainerNBB" id="ROActn" style="height:auto;;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:60mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
								<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:32mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:1px;">
									<span style="font-weight:bold">(b)</span> Relationship between interested person and the organization</th>
									<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:30mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(c)</span> Amount of transaction </th>
								<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:45mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:1px;">
								...
								<tr>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:8mm;font-weight:bold;border-right-width:1px">Yes</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:8mm;font-weight:bold;border-right:0px">No</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/BusTrInvolveInterestedPrsnGrp) &lt;= 6">
									<xsl:for-each select="$FormData/BusTrInvolveInterestedPrsnGrp">
										<tr>
											<td class="styTableCellCtr" style="height:auto;width:60mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="NameOfInterested/BusinessName/BusinessNameLine1"/>
														</xsl:call-template>
														<br/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="NameOfInterested/BusinessName/BusinessNameLine2"/>
														</xsl:call-template>
													</xsl:otherwise>
												</xsl:choose>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:32mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RelationshipDescriptionTxt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:30mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="TransactionAmt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:45mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="TransactionDesc"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:1px;text-align:center;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="SharingOfRevenuesInd"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtr" style="height:auto;width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:0px;text-align:center;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="SharingOfRevenuesInd"/>
												</xsl:call-template>
											</td>
								...
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/BusTrInvolveInterestedPrsnGrp) &gt;6)) ">
									<tr>
										<td class="styTableCellCtr" style="height:auto;width:60mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/BusTrInvolveInterestedPrsnGrp/NameOfInterested/PersonNm"/>
											</xsl:call-template>
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;width:32mm;vertical-align:top;padding-right:0.75mm;border-left:0px">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;width:30mm;vertical-align:top;padding-right:0.75mm;border-left:0px">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;width:45mm;vertical-align:top;padding-right:0.75mm;border-left:0px">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:1px;text-align:center;">
											<span style="width:3px"/>
					...
					<div class="styBB" style="height:auto;width:187mm;clear:both;border-top-width:1px;height:auto;">
...
<span style="font-size:7pt;font-weight:normal;height:auto;">Provide additional information for responses to questions on Schedule L (see instructions).</span>
						...
						<span style="float:right;clear:none;height:auto;">
					...
					<div class="styTableContainer" style="height:auto;width: 187mm; border-bottom-width: 2px" id="SUPctn">
						<xsl:call-template name="SetInitialState"/>
          ...
          Additional Data        
					...
					<xsl:if test="($Print = $Separated) and count($FormData/DisqualifiedPersonExBnftTrGrp) &gt;= 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
								<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;width:55mm;font-weight:bold;border-right:0px;border-left:0px;text-align:center;vertical-align:top;">
										<span class="styLNLeftNumBox">1</span>
										<span style="font-weight:normal">
											<b>(a)</b> Name of disqualified person</span>
									</th>
								<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:55mm;font-weight:normal; text-align:center;border-right-width:1px;vertical-align:top;">
										<span style="font-weight:bold">(b)</span> Relationship between disqualified person and organization</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="height:auto;width:55mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:0px;">
										<span style="font-weight:bold">(c)</span> Description of transaction</th>
									<th class="styDepTblCell" colspan="2" scope="col" style="height:auto;width:25mm;font-weight:normal;border-right-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(d)</span> Corrected?</th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="height:auto;width:8mm;font-weight:bold;text-align:center">Yes</th>
									<th class="styDepTblCell" scope="col" style="height:auto;width:8mm;font-weight:bold;text-align:center">No</th>
								</tr>
							</thead>
							<tfoot/>
							<xsl:for-each select="$FormData/DisqualifiedPersonExBnftTrGrp">
								<tr>
									...
									<td class="styDepTblCell" style="height:auto;width:85mm;padding-right:0.75mm;border-right:1px;border-left:0px;vertical-align:top;text-align:left;border-bottom-width:1px">(<xsl:number value="position()" format="1"/>)
										<xsl:choose>
											<xsl:when test="PersonNm">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="PersonNm"/>
									...
									<td class="styTableCellCtr" style="height:auto;width:55mm;padding-right:0.75mm;border-left:0px;vertical-align:top;text-align:left">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RlnDisqualifiedPersonOrgTxt"/>
												</xsl:call-template>
											</td>
									<td class="styDepTblCell" style="height:auto;width:85mm;padding-right:0.75mm;border-right:1px;vertical-align:top;text-align:left;border-bottom-width:1px">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="TransactionDesc"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="height:auto;width:8mm;padding-right:0.75mm;border-right:1px;vertical-align:top;border-bottom-width:1px;text-align:center">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="TransactionCorrectedInd"/>
										</xsl:call-template>
									</td>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
						<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:20mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
						<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:40mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(b)</span> Relationship with organization</th>
						<th class="styTableCellHeader" scope="col" rowspan="2" style="height:auto;width:35mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(c)</span> Purpose of loan</th>
						<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:18mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(d)</span> Loan to or from the organization?</th>
						<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:30mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px; ">
										<span style="font-weight:bold">(e)</span>Original principal amount </th>
					<th class="styTableCellHeader" rowspan="2" scope="col" style="height:auto;width:30mm;font-weight:normal; text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(f)</span>Balance due</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(g)</span> In default?</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(h)</span> Approved by board or committee?</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="height:auto;width:16mm;font-weight:normal;border-right-width:1px;text-align:center;vertical-align:top;">
						...
						<xsl:for-each select="$FormData/LoansBtwnOrgInterestedPrsnGrp">
									...
									<td class="styDepTblCell" style="height:auto;width:40mm;padding-right:0.75mm;border-right:1px;border-left:0px;vertical-align:top;text-align:left;border-bottom-width:0px">(<xsl:number value="position()" format="1"/>)
										...
										<!--	<td class="styTableCellCtr" style="width:40mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)-->
												...
												<td class="styDepTblCell" style="height:auto;vertical-align:top;border-left:0px;text-align:left;width:20mm;padding-right:.5mm">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RelationshipWithOrgTxt"/>
												</xsl:call-template>
											</td>
											...
											<td class="styDepTblCell" style="height:auto;text-align:center;width:9mm;vertical-align:top;padding-right:0.75mm;border-left:1px;border-right-width:0px;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="LoanToOrganizationInd"/>
												</xsl:call-template>
											</td>
											...
											<!--<td class="styTableCellCtr" style="width:30mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right">-->
											<td class="styDepTblCell" style="height:auto;width:32mm;vertical-align:top;text-align:right;border-right-width:0px;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="OriginalPrincipalAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="height:auto;width:32mm;vertical-align:top;text-align:right;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="BalanceDueAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="height:auto;padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="height:auto;padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="height:auto;padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="BoardOrCommitteeApprovalInd"/>
												</xsl:call-template>
											</td>
											...
											<td class="styDepTblCell" style="height:auto;padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:0px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="WrittenAgreementInd"/>
												</xsl:call-template>
											</td>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
				<th class="styDepTblCell" scope="col" style="height:auto;width:62mm;font-weight:normal;border-top-width:1px;border-right:0px;border-left:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
				...
				<th class="styDepTblCell" scope="col" style="height:auto;width:62mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;border-right-width:0px">
							...
							<xsl:for-each select="$FormData/GrntAsstBnftInterestedPrsnGrp">
								<tr>
									...
									<td class="styDepTblCell" style="height:auto;width:62mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left;">(<xsl:number value="position()" format="1"/>)
										<xsl:choose>
											<xsl:when test="PersonNm">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="PersonNm"/>
									...
									<td class="styDepTblCell" style="height:auto;width:62mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="RelationshipWithOrgTxt"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell">
										<xsl:choose>
											<xsl:when test="CashGrantAmt">
												<xsl:attribute name="style">height:auto;width:62mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right:0px;text-align:right</xsl:attribute>
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="CashGrantAmt"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="style">height:auto;width:62mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right:0px;text-align:left</xsl:attribute>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="TypeOfAssistanceTxt"/>
												</xsl:call-template>
											</xsl:otherwise>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
							<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;width:60mm;font-weight:normal;border-right:0px;border-left:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="height:auto;width:32mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:0px;">
										<span style="font-weight:bold">(b)</span> Relationship between interested person and the organization</th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;width:30mm;font-weight:normal;border-right:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(c)</span> Amount of transaction </th>
									<th class="styDepTblCell" rowspan="2" scope="col" style="height:auto;width:45mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:0px;">
										<span style="font-weight:bold">(d)</span> Description of transaction</th>
									<th class="styDepTblCell" colspan="2" scope="col" style="height:auto;width:20mm;font-weight:normal;border-right-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(e)</span> Sharing of organization's revenues?</th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="height:auto;width:8mm;font-weight:bold;border-right-width:0px">Yes</th>
									<th class="styDepTblCell" scope="col" style="height:auto;width:8mm;font-weight:bold;border-right:0px">No</th>
								</tr>
							</thead>
							<tfoot/>
							<xsl:for-each select="$FormData/BusTrInvolveInterestedPrsnGrp">
								<tr>
									<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1Cell </xsl:when><xsl:otherwise>styDepTblRow2Cell </xsl:otherwise></xsl:choose></xsl:attribute>
									<td class="styDepTblCell" style="height:auto;width:60mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)
										<xsl:choose>
											<xsl:when test="NameOfInterested/PersonNm">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="NameOfInterested/PersonNm"/>
									...
									<td class="styDepTblCell" style="height:auto;width:32mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="RelationshipDescriptionTxt"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="height:auto;width:30mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="TransactionAmt"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="height:auto;width:45mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="TransactionDesc"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="height:auto;width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:1px;text-align:center;">
										<xsl:call-template name="PopulateYesBoxText">
											<xsl:with-param name="TargetNode" select="SharingOfRevenuesInd"/>
										</xsl:call-template>
									</td>
									<td class="styDepTblCell" style="height:auto;width:8mm;vertical-align:top;padding-right:0.75mm;border-left:0px;border-right-width:0px;text-align:center;">
										<xsl:call-template name="PopulateNoBoxText">
											<xsl:with-param name="TargetNode" select="SharingOfRevenuesInd"/>
										</xsl:call-template>
									</td>

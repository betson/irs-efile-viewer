						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" rowspan="2" style="width:25mm;font-weight:normal;text-align:center;vertical-align:top;">
									...
									<th class="styTableCellHeader" rowspan="2" scope="col" style="width:32mm;font-weight:normal;text-align:center;vertical-align:top; ">
								...
								<th class="styTableCellHeader" rowspan="2" scope="col" style="width:32mm;font-weight:normal; text-align:center;vertical-align:top;border-right-width:1px;">
									...
									<th class="styTableCellHeader" colspan="2" scope="col" style="width:8mm;font-weight:normal;text-align:center;vertical-align:top;">
							...
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt;6">
									<xsl:for-each select="$FormData/LoansBtwnOrgInterestedPrsnGrp">
										<tr>
											...
											<td class="styTableCellCtr" style="width:35mm;vertical-align:top;text-align:right;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt;6)) ">
									<tr>
										<td class="styTableCellCtr" style="width:40mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
								...
								<tr>
									<td class="styTableCellCtr" scope="col" colspan="6" style="width:64mm;vertical-align:bottom;padding-right:0.5mm;border-right:0px">
									...
									<td class="styTableCell" style="width:35mm;vertical-align:bottom;border-left:0px;font-size:5pt;">
										<xsl:call-template name="PopulateAmount">
							...
							<tbody>
								...
								<xsl:for-each select="$FormData/GrntAsstBnftInterestedPrsnGrp">
										<tr>
											...
											<td class="styTableCellCtr" style="width:37.2mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right;">
          ...
          Additional Data        
					...
					<xsl:if test="($Print = $Separated) and count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 6">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
						<th class="styTableCellHeader" scope="col" rowspan="2" style="width:20mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
						<th class="styTableCellHeader" scope="col" rowspan="2" style="width:40mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(b)</span> Relationship with organization</th>
						<th class="styTableCellHeader" scope="col" rowspan="2" style="width:35mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(c)</span> Purpose of loan</th>
						<th class="styTableCellHeader" colspan="2" scope="col" style="width:18mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(d)</span> Loan to or from the organization?</th>
						<th class="styTableCellHeader" rowspan="2" scope="col" style="width:30mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px; ">
										<span style="font-weight:bold">(e)</span>Original principal amount </th>
					<th class="styTableCellHeader" rowspan="2" scope="col" style="width:30mm;font-weight:normal; text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(f)</span>Balance due</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(g)</span> In default?</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-right:0px;">
										<span style="font-weight:bold">(h)</span> Approved by board or committee?</th>
					<th class="styTableCellHeader" colspan="2" scope="col" style="width:16mm;font-weight:normal;border-right-width:1px;text-align:center;vertical-align:top;">
						...
						<xsl:for-each select="$FormData/LoansBtwnOrgInterestedPrsnGrp">
									...
									<td class="styDepTblCell" style="width:40mm;padding-right:0.75mm;border-right:1px;border-left:0px;vertical-align:top;text-align:left;border-bottom-width:0px">(<xsl:number value="position()" format="1"/>)
										...
										<!--	<td class="styTableCellCtr" style="width:40mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:left">(<xsl:number value="position()" format="1"/>)-->
												...
												<td class="styDepTblCell" style="vertical-align:top;border-left:0px;text-align:left;width:20mm;padding-right:.5mm">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RelationshipWithOrgTxt"/>
												</xsl:call-template>
											</td>
											...
											<td class="styDepTblCell" style="text-align:center;width:9mm;vertical-align:top;padding-right:0.75mm;border-left:1px;border-right-width:0px;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="LoanToOrganizationInd"/>
												</xsl:call-template>
											</td>
											...
											<!--<td class="styTableCellCtr" style="width:30mm;vertical-align:top;padding-right:0.75mm;border-left:0px;text-align:right">-->
											<td class="styDepTblCell" style="width:32mm;vertical-align:top;text-align:right;border-right-width:0px;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="OriginalPrincipalAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="width:32mm;vertical-align:top;text-align:right;font-size: 5pt;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="BalanceDueAmt"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="padding-left:.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="DefaultInd"/>
												</xsl:call-template>
											</td>
											<td class="styDepTblCell" style="padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:1px;">
												<xsl:call-template name="PopulateYesBoxText">
													<xsl:with-param name="TargetNode" select="BoardOrCommitteeApprovalInd"/>
												</xsl:call-template>
											</td>
											...
											<td class="styDepTblCell" style="padding-left:0.50mm;width:8mm;vertical-align:top;border-left:0px;border-right-width:0px;">
												<xsl:call-template name="PopulateNoBoxText">
													<xsl:with-param name="TargetNode" select="WrittenAgreementInd"/>
												</xsl:call-template>
											</td>

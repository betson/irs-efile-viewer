...
<tr style="border-color:black;font-size:6pt;" valign="top">
	...
	<th class="styTableCellHeader" style="text-align:left;width:47mm;vertical-align:middle;" scope="col" rowspan="2">
		<div style="width:3mm;float:left;text-align:right;font-weight:bold;font-size:7pt;padding-bottom:17mm;"><br/><xsl:value-of select="$lineNumber"/></div>
		<div style="width:40mm;text-align:center;float:left;padding-top:7mm;">(a)<br/><span class="styNormalText">Description of property<br/><span style="font-family:Arial;">(Example: 100 sh. XYZ Co.)</span></span></div>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:20mm;vertical-align:middle;" scope="col" rowspan="2">
		<span class="styNormalText"><b>(b) </b><br/>Date acquired<br/> (Mo., day, yr.)</span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:20mm;vertical-align:middle;" scope="col" rowspan="2">
		<span class="styNormalText"><b>(c) </b><br/>Date sold or<br/>disposed<br/> (Mo., day, yr.)<br/></span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:31mm;vertical-align:middle;" scope="col" rowspan="2">
		<span class="styNormalText"><b>(d) </b><br/>Proceeds<br/>(sales price)<br/>(see instructions)</span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:30.8mm;vertical-align:middle;" scope="col" rowspan="2">
		<span class="styNormalText"><b>(e) </b><br/>Cost or other basis.<br/>See the <b>Note</b> below<br/>and see <i>Column (e)</i><br/>in the separate<br/>instructions</span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:44mm;border-bottom-width:1px;vertical-align:middle;" colspan="2">
		<span class="styNormalText" style="font-family:Arial Narrow"><b>Adjustment, if any, to gain or loss.</b><br/>If you enter an amount in column (g),<br/> enter a code in column (f).<br/><b>See the separate instructions.</b></span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:31mm;border-right-width:0px;vertical-align:middle;" scope="col" rowspan="2">
		<span class="styNormalText"><b>(h)</b><br/><b>Gain or (loss).</b><br/>Subtract column (e)<br/>from column (d) and<br/>combine the result<br/>with column (g)</span>
	</th>
</tr>
<tr style="border-color:black;font-size:6pt;" valign="top">
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:13mm;vertical-align:middle;" scope="col">
		<span class="styNormalText"><b>(f)</b><br/><span style="font-family:Arial Narrow">Code(s) from<br/>instructions</span></span>
	</th>
	<!-- +++++++++++++++++++++++++++++++++++-->
	<th class="styTableCellHeader" style="text-align:center;width:31mm;vertical-align:middle;" scope="col">
		<b>(g) </b><br/><span class="styNormalText" style="font-family:Arial;">Amount of<br/>adjustment</span>
	</th>
</tr>
</xsl:template>
	...
	<xsl:template name="SetPageEndFooter">
		...
		<div class="pageEnd" style="width:187mm;padding-top:.5mm;padding-bottom:2mm;float:none;clear:both;border: black solid 0px;border-top-width:2px;">
			...
			<div style="float:right;">
				...
				Form <span class="styBoldText" style="font-size:8pt;">8949</span> (2013)
			</div>
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="IRS8949">
						...
						<div class="styFTBox" style="width:129.8mm;padding-left:0px;padding-right:0px;">
							...
							<div class="styFST" style="height:5mm;font-size:7pt;margin-left:0mm;text-align:center;padding-right:0px;">
								<span style="width:129.8mm;text-align:center;">
									...
									<span class="styBoldText">Information about Form 8949 and its separate instructions is at <i>www.irs.gov/form8949.</i></span><br/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:104mm;height:8mm;font-weight:normal;font-size:7pt;">
							<span style="font-family:Arial;font-size:6pt;">Name(s) shown on return. (Name and SSN or taxpayer identification no. not required if shown on other side.)</span><br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
								<xsl:with-param name="TargetNode">BusinessNameLine1</xsl:with-param>
							</xsl:call-template>
							<xsl:if test="$RtnHdrData/Filer//BusinessNameLine2">
					...
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- Page Break and Footer-->
					<div class="pageEnd" style="width:187mm;padding-top:1mm;border:black solid 0px;border-top-width:2px;">
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8949</span> (2013)
						</div>
					</div>

...
<body class="styBodyClass">
  <form name="Form2439">
    ...
    <div class="styBB" style="width:187mm;height:30mm;">
      ...
      <div class="styIRS2439leftBox" style="width:87mm;height:30mm;padding-left:1mm">
 	...
 	<xsl:choose>
        ...
        <!-- US Address -->
          <xsl:when test="$Form2439Data/RICOrREITUSAddress">
            <xsl:if test="$Form2439Data/RICOrREITUSAddress/AddressLine1!='' ">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITUSAddress/AddressLine1"/>
                </xsl:call-template>            
       <span class="styTableCellPad"/>
            </xsl:if>              
            <xsl:if test="$Form2439Data/RICOrREITUSAddress/AddressLine2!=''">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITUSAddress/AddressLine2"/>
                </xsl:call-template>            
              <span class="styTableCellPad"/>
            </xsl:if>              
            <xsl:if test="$Form2439Data/RICOrREITUSAddress/City!=''">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITUSAddress/City"/>
                </xsl:call-template>,              
                <span class="styTableCellPad"/>
            </xsl:if>    
            <xsl:if test="$Form2439Data/RICOrREITUSAddress/State!=''">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITUSAddress/State"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if>
            <xsl:if test="$Form2439Data/RICOrREITUSAddress/ZIPCode!=''">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITUSAddress/ZIPCode"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if>            
          </xsl:when>
            <!-- Foreign Address -->             
          <xsl:otherwise>
            <xsl:if test="$Form2439Data/RICOrREITForeignAddress/AddressLine1!=''">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/AddressLine1"/>
                </xsl:call-template>            
              <span class="styTableCellPad"/>
            </xsl:if>  
            <xsl:if test="$Form2439Data/RICOrREITForeignAddress/AddressLine2!=''">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/AddressLine2"/>
                </xsl:call-template>            
              <span class="styTableCellPad"/>
            </xsl:if>              
            <xsl:if test="$Form2439Data/RICOrREITForeignAddress/City!=''">
            <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/City"/>
                </xsl:call-template>,              
                <span class="styTableCellPad"/>
            </xsl:if>
            <xsl:if test="$Form2439Data/RICOrREITForeignAddress/ProvinceOrState!=''">
               <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/ProvinceOrState"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if>
          <!-- foreign postal code -->                    
            <xsl:if test="$Form2439Data/RICOrREITForeignAddress/PostalCode!=''">
               <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/PostalCode"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if>
        <!-- foreign country -->    
               <xsl:if test="$Form2439Data/RICOrREITForeignAddress/Country!=''">
              <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/RICOrREITForeignAddress/Country"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if> 
         </xsl:otherwise>
      ...
      <div class="styIRS2439leftBox" style="width:25mm;height:30mm;text-align:center;">
        ...
        <span style="padding-top:4mm;height:11mm;">
          <div class="styTY" style="padding-top:1mm;font-size:26;">20<span class="styTYColor">13</span></div><br/>
        </span>
      ...
      <div class="styIRS2439rightBox" style="width:75mm;height:30mm;text-align:center;">
        <span style="width:4px;"/><span style="font-size: 9pt;padding-top:1mm;height:9.5mm;font-weight:bold;">Notice to Shareholder of Undistributed Long-Term Capital Gains</span><br/>
        For calendar year 2013, or other tax year of the <br/>regulated investment company (RIC) or the<br/> 
    ...
    <div style="width:187mm;height:40mm;">
      ...
      <div style="width:87mm;height:40mm;float:left;">
        <span class="styIRS2439leftBoxWithBottom" style="height:7mm;width:87mm;">
          <span style="width:4px;"/><span style="font-size: 6pt;">Identification number of RIC or REIT</span>
          <br/>
         <xsl:choose>
	 ...
	 <xsl:when test="$Form2439Data/MissingEINReasonCd">
           <span style="padding-left:1mm;vertical-align:bottom" valign="bottom"/>
                  <xsl:call-template name="PopulateText">
        ...
        <span class="styIRS2439leftBoxWithBottom" style="height:7mm;width:87mm;">
          <span style="width:4px;"/><span style="font-size: 6pt">Shareholder's identifying number</span>
          <br/>
      <xsl:choose>
        ...
        <span class="styIRS2439leftBoxWithBottom" style="height:26.5mm;width:87mm;padding-left:1mm">
          <span style="font-size: 6pt">Shareholder's name, address, and ZIP code</span>
          <br/>
       <xsl:choose>
             <xsl:when test="$Form2439Data/ShareholderBusinessName">
          	<xsl:call-template name="PopulateText">
          	  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderBusinessName/BusinessNameLine1"/>
          	</xsl:call-template>
          	<xsl:if test="$Form2439Data/ShareholderBusinessName/BusinessNameLine2 != ''">
            	   <br/>
            	   <xsl:call-template name="PopulateText">
            	     <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderBusinessName/BusinessNameLine2"/>
            	   </xsl:call-template>
          	</xsl:if>
              </xsl:when>
           <xsl:otherwise>
          ...
          <xsl:when test="$Form2439Data/ShareholderUSAddress">
            <xsl:if test="$Form2439Data/ShareholderUSAddress/AddressLine1!='' ">
              <br/><span style="vertical-align:bottom;" valign="bottom"/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderUSAddress/AddressLine1"/>
                </xsl:call-template>            
              <span class="styTableCellPad"/>
            </xsl:if>              
            <xsl:if test="$Form2439Data/ShareholderUSAddress/AddressLine2!='' ">
              <br/><span style="vertical-align:bottom;" valign="bottom"/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderUSAddress/AddressLine2"/>
                </xsl:call-template>            
              <span class="styTableCellPad"/>
            </xsl:if>   
            <xsl:if test="$Form2439Data/ShareholderUSAddress/City!=''">
              <br/>
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderUSAddress/City"/>
                </xsl:call-template>,              
                <span class="styTableCellPad"/>
            </xsl:if>
            ...
            <xsl:if test="$Form2439Data/ShareholderUSAddress/ZIPCode!=''">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form2439Data/ShareholderUSAddress/ZIPCode"/>
                </xsl:call-template>
                <span class="styTableCellPad"/>
            </xsl:if>            
          </xsl:when>          
      ...
      <div style="width:72mm;height:40mm;float:left;">
        ...
        <div style="width:72mm;;">
          <span class="styIRS2439leftBoxWithBottom" style="height:10mm;width:72mm;border-right-width:0px;">
            <span style="width:4px;"/><span style="font-size: 6pt;font-weight:bold;">1a</span>
            <span style="width:4px;"/><span style="font-size: 6pt;">Total undistributed long-term capital gains
              <!-- Push pin image -->
        ...
        <div style="width:72mm;float:left;">
          <span class="styIRS2439leftBoxWithBottom" style="height:10mm;width:72mm;float:left;">
            <span style="width:4px;"/><span style="font-size: 6pt;font-weight:bold;">1b</span>
            <span style="width:2px;"/><span style="font-size: 6pt;">Unrecaptured section 1250 gain</span>
            <br/>
        ...
        <div style="width:72mm;float:left;">
          <span class="styIRS2439leftBoxWithBottom" style="height:10mm;width:35.5mm;float:left;">
            <span style="width:4px;"/><span style="font-size: 6pt;font-weight:bold;">1c</span>
            <span style="width:4px;"/><span style="font-size: 6pt;">Section 1202 gain</span>
          ...
          <span class="styIRS2439leftBoxWithBottom" style="height:10mm;width:36.5mm;float:left;">
            <span style="width:4px;"/><span style="font-size: 6pt;font-weight:bold;">1d</span>
        ...
        <span class="styIRS2439leftBoxWithBottom" style="height:10mm;width:72mm;float:left;">
          <span style="width:4px;"/><span style="font-size: 6pt;font-weight:bold;">2</span>
            <span style="width:4px;"/><span style="font-size: 6pt;">Tax paid by the RIC or REIT on the box 1a gains</span>
            <br/>
    ...
    <div style="width:187mm;">
      ...
      <span style="width:59mm;font-size: 7pt;">Cat. No. 11858E</span>

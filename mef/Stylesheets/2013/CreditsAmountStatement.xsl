...
<!-- 09/10/2015 - Changes made for defect 44381 - Jeremy Nichols -->
        ...
        <tr>
          ...
          <td class="styDepTblCell" style="text-align:left;font-size:7pt;padding-left:2mm">
             <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="CreditsAmountExplanation"/>
             </xsl:call-template>
          </td>
          <td class="styDepTblCell" style="text-align:left;font-size:7pt;padding-left:2mm">
             <xsl:call-template name="PopulateText">
          ...
          <td class="styDepTblCell" style="text-align:left;font-size:7pt;padding-left:2mm">
             <xsl:call-template name="PopulateMonthDayYear">
                  <xsl:with-param name="TargetNode" select="DisposalReportingDate"/>
             </xsl:call-template>
          </td>
          <td class="styDepTblCell" style="text-align:right;font-size:7pt;padding-right:2mm">
             <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="DisposalReportingAmount"/>
             </xsl:call-template>
          </td>
        </tr>
      </xsl:for-each>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:112.5mm;padding-right:1mm;padding-top:6px;height:42px;">
						...
						<div class="styGenericDiv" style="width:18mm;border-right:2px solid black;height:42px;padding-top:7px;">
							<span class="styTaxYear">20<span class="styTYColor">13</span></span>
						</div>
						<div class="styOMB" style="width:31.5mm;height:42px;padding: 15px 1mm 1mm 1mm;float:left;border-width:0px 0px 0px 0px;vertical-align:bottom;">
							OMB No. 1545-0092
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:39.8mm;float:left;height:48mm;">
							<div class="styGenericDiv" style="width:39.8mm;padding-top:.50mm;padding-bottom:.5mm;height:6.6mm;"><b>A</b><span style="width:2mm" />Check all that apply:</div>
							<div class="styLNDesc" style="height:4mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
							...
							<div class="styLNDesc" style="height:4.5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:1mm;border-bottom:1px solid black;">
								<label>
									<xsl:call-template name="PopulateLabel">
									...
									<span style="width:1px;"/>Pooled income fund
									<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/PooledIncomeFundInd"/>
										</xsl:call-template>
								</label>
							...
							<br />
							<span style="width:4mm;" />instructions) <img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/ScheduleK1AttachedCnt"/>
							</xsl:call-template>
							</div>
						</div>
						<div class="styGenericDiv" style="width:146.9mm;float:left;border-left:1px solid black;">
						<div class="styBB" style="width:146.9mm;height:4mm;padding-left:1mm;">
							For calendar year 2013 or fiscal year beginning <span style="width:2mm;"/>
							<xsl:call-template name="PopulateReturnHeaderTaxPeriodBeginDate"/>
							, and ending <span style="width:2mm;"/>
							<xsl:call-template name="PopulateReturnHeaderTaxPeriodEndDate"/>
						</div>
						<div class="styBB" style="width:146.9mm;height:16mm;float:left;">
						<div class="" style="width:99mm;padding-left:1mm;float:left;height:16mm;border-right:1px solid black;">
								<span style="" />Name of estate or trust (If a grantor type trust, see the instructions.)<br />							
							...
							<div class="" style="width:47.6mm;height:10.8mm;;float:left;">
							...
							<div class="" style="width:99mm;padding-left:1mm;height:auto;float:left;border-right:1px solid black;">
								<span style="" />Name and title of fiduciary<br />
								<xsl:choose>
									<xsl:when test="$RtnHdrData/Filer/FiduciaryPersonName">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">PersonFirstName</xsl:with-param>
										</xsl:call-template>&#160;
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">PersonLastName</xsl:with-param>
										</xsl:call-template><br />
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="" style="width:47.6mm;height:auto;float:left;">
							...
							<div class="styBB" style="width:146.9mm;height:24mm;float:left;">
							<div class="" style="height:24mm;float:left;border-right:1px solid black;">
							<div class="styBB" style="width:98.7mm;padding-left:1mm;height:14.8mm;">
								<span style="" />Number, street, and room or suite no. <span style="font-size:6.5pt;">(If a P.O. box, see the instructions.)</span><br />
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="styBB" style="width:98.7mm;padding-left:1mm;height:10mm;border-bottom:0px solid black;">
							...
							<div class="" style="width:47.6mm;height:24mm;padding-bottom:.5mm;float:left;">
								...
								<span style="font-size:7.5pt;font-family:arial narrow;">Described in sec. 4947(a)(1). Check here</span></div><br /><div class="styGenericDiv">
								<span style="font-size:7.5pt;font-family:arial narrow;float:left;"><span style="width:1mm;" />if not a private foundation</span>
								...
								<span style="font-size:6pt;">Described in sec. 4947(a)(2)</span><br /></span>
							</div>
							</div>
							</div>
							<div class="styGenericDiv" style="width:146.7mm;padding-left:1mm;">
							<div class="" style="width:100mm;float:left;">
							...
							<label>
								...
								</label><span style="width:.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Initial return</span>
								<span style="width:1mm;"/>
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								</label><span style="width:.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Final return</span><span style="width:1mm;"/><br />
								...
								</label><span style="width:.5mm;height:4.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Change in trust's name</span><br />
							</span>
							<span style="float:right;padding-left:.5mm;padding-top:.5mm;">
								<label>									
									<xsl:call-template name="PopulateLabel">
								...
								</label><span style="width:.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Amended return</span>
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$FormData/AmendedReturnInd"/>
									</xsl:call-template>
								...
								</label><span style="width:.5mm;height:4.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Change in fiduciary</span>
								</span>
									<span style="float:left;padding-left:.5mm;padding-top:.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								</label><span style="width:.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Superseded Return</span>
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$FormData/SupersededReturnInd"/>
									</xsl:call-template><br />
									<label>
								...
								</label><span style="width:.5mm;height:4.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Change in fiduciary's name</span>
									</span>
									</div>
									<div class="" style="width:45mm;float:left;">	
								<span style="float:left;padding-left:1mm;padding-top:.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								</label><span style="width:1mm;" /><span style="font-family:arial narrow;font-size:6pt;">Net operating loss carryback</span>
								<br />
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								</label><span style="width:1mm;height:4.5mm;" /><span style="font-family:arial narrow;font-size:6pt;">Change in fiduciary's address</span><br />		
							</span>
							</div>							
							</div>						
						</div>
						<!--<div class="styGenericDiv" style="width:46.7mm;float:left;">
							<div class="styBB" style="width:46.7mm;height:10.8mm;">
								<b>C<span style="width:1mm;" />Employer identification number</b><br />
								<span style="width:46.6mm;text-align:center">
								<xsl:call-template name="PopulateReturnHeaderFiler">
									<xsl:with-param name="TargetNode">EIN</xsl:with-param>
							...
							<div class="styBB" style="width:46.7mm;height:21.6mm;padding-bottom:.5mm;">
								<b>E</b><span style="width:1mm;" />Nonexempt charitable and split-<br />
								<span style="width:3mm;" />interest trusts, check applicable<br />
								<span style="width:3mm;" />box(es), see instructions.<br />
								<div class="styGenericDiv">
							...
							<div class="styGenericDiv" style="width:46.7mm;height:10mm;padding-left:1mm;padding-top:.5mm;">
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$FormData/NetOperatingLossCarrybackInd"/>
										<xsl:with-param name="BackupName">$FormDataNetOperatingLossCarrybackInd</xsl:with-param>
								...
								</label><span style="width:1mm;" />Net operating loss carryback<br />
								...
								</label><span style="width:1mm;height:4.5mm;" />Change in fiduciary's address<br />								
							</div>
						</div>-->
						
						
					</div>
			<div style="width:187mm;border-bottom:1px solid black;height:5mm;">
				...
				<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/><span style="width:1mm;"/>
				<label>
									<xsl:call-template name="PopulateLabel">
								...
								Trust EIN<span style="width:2mm;"/><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/> 
								
								<xsl:choose>
								<xsl:when test="count($FormData/TrustEIN) &gt; 1">
									See Additional data
								</xsl:when>
								<xsl:otherwise>
		  ...
		  <!--Line 2b-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				...
				<span style="float:left;font-size:6pt;padding-left:1mm;padding-right:1mm;"><b>(1) </b>Beneficiaries</span>
				...
				<span style="float:left;font-size:6pt;padding-left:1mm;padding-right:1mm;"><b>(2) </b>Estate or trust</span>
		  ...
		  <!--Line 8-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				...
				<span style="border-bottom:1px dashed;float:left;height:3mm;width:85mm;">
		  ...
		  <!--Line 9-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><b>Total income.</b> Combine lines 1, 2a, and 3 through 8</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
					 <xsl:call-template name="DotLoop">						
		  ...
		  <div style="width:187mm;border-bottom:1px solid black;">			
			...
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				...
				<span style="float:left;"><span style="padding-left:1mm;padding-right:1mm;"><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>
					<label>
						<xsl:call-template name="PopulateLabel">
		  ...
		  <!--Line 12-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Fiduciary fees</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="24"/>
					</xsl:call-template>		  
		  ...
		  <!--Line 14-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Attorney, accountant, and return preparer fees</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="15"/>
					</xsl:call-template>			  
		  ...
		  <!--Line 15c-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">15c</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 21-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">21</div>
			  <div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 24a-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><b>Payments: a</b> 2013 estimated tax payments and amount applied from 2011 return
					<xsl:call-template name="LinkToLeftoverDataTableInline">
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24a</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; " >
			  <xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 24b-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24b</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 24c-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24c</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxPaymentsAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 24d-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24d</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 24e-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24e</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/FederalIncomeTaxWithheldAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 24h-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">24h</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 27-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">27</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 29-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Amount of line 28 to be: <b> a Credited to 2014 estimated tax</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
		...
		<!-- signature -->
					<div class="styBB" style="width:187mm;padding-top:0mm;float:none;clear:both;page-break-after:always;">
						<div style="width:15mm;float:left;clear:none;">
							<div style="width:10mm;float:left;clear:none;">
                        ...
                        Here
							...
							<div style="padding-top:9.7mm;padding-left:6px;padding-right:0px;float:left;clear:none;width:4mm;border-left:1px solid black;">
								<img src="{$ImagePath}/1040_Bullet_SuperLg.gif" alt="Right pointing arrowhead image" height="24" width="10"/>
							</div>
						</div>
						<div style="float:left;clear:none;width:172mm;">
                  ...
                  <div style="width:136mm;">
					  <div style="float:left;">
							<div class="styBB" style="width:136mm;padding-top:1.5mm;float:left;clear:none;font-size:6pt;">
								...
								<div class="styFNBox" style="width:18mm;float:left;clear:none;">									
									<div style="height:8mm;width:18mm;padding-top:1.5mm;text-align:center;float:left;clear:none;"><br />
										<xsl:call-template name="PopulateMonthDayYear">
								...
								<div class="styFNBox" style="width:46.5mm;float:left;clear:none;border-right:0px;">									
									<div style="height:8mm;width:46.5mm;padding-top:1.5mm;padding-left:2mm;float:left;clear:none;">
							...
							<div class="" style="width:136mm;float:left;clear:none;font-size:6pt;">
								<div style="width:71mm;float:left;clear:none;">
									<div style="width:71mm;float:left;clear:none;">
                        ...
                        Date
								...
								<div style="width:47mm;float:left;clear:none;">
									<div style="width:47mm;padding-left:2mm;float:left;clear:none;">
						...
						<div style="width:34.6mm;height:10mm;border:3px solid black;float:right;margin-left:1mm;margin-top:1mm;font-size:5pt;padding-left:1mm;padding-right:0.5mm;"><span style="float:left;">May the IRS discuss this return with the preparer shown below (see instr.)?		
							<!-- Checkbox -->
					...
					<div class="styBB" style="width:187mm;font-size:6pt;float:none;clear:both;">
						...
						<div style="width:164mm;float:left;clear:none;border-left:1px solid black;page-break-inside:avoid;">
							...
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:6mm;width:108.5mm;border-right:1px solid black;">
		...
		<div class="pageEnd" style="width:187mm;float:none;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2013)
            </span>
		</div>
		<!-- end page 1 footer -->
		<!-- page 2 -->
		<div class="styTBB" style="width:187mm;padding-top:.5mm;float:none;">
			<span class="" style="float:left;clear:none;">Form 1041 (2013)</span>
		...
		<div class="styBB" style="width:187mm;">
			...
			<div class="styPartDesc" style="width:165mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;">Charitable Deduction. <span style="font-weight:normal;">Do not complete for a simple trust or a pooled income fund.</span></div>
		</div>
		<!--Line 1-->
		  ...
		  <!--Line 4-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">4</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;font-size:6pt;">Capital gains for the tax year allocated to corpus and paid or permanently set aside for charitable purposes</span>
		  ...
		  <!--Line 6-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">6</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;font-family:arial narrow;font-size:8pt;">Section 1202 exclusion allocable to capital gains paid or permanently set aside for charitable purposes (see instructions)</span>				
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="1"/>
					</xsl:call-template>			  
		...
		<!--Line 1-->
		  ...
		  <!--Line 3-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Total net gain from Schedule D (Form 1041), line 15, column (1) (see instructions)</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="6"/>
					</xsl:call-template>			  
		  ...
		  <!--Line 6-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">6</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;font-family:arial narrow;font-size:8pt;">Enter any gain from page 1, line 4, as a negative number. If page 1, line 4, is a loss, enter the loss as a positive number</span>				
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="1"/>
					</xsl:call-template>			  
		  ...
		  <!--Line 8-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;margin-top:4mm;">8</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm;margin-top:4mm;" >
			  <xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/AccountingIncomeAmt" />
				</xsl:call-template>  
				</div>
			<div class="styLNRightNumBox" style="height:8mm;width:8mm;background-color:lightgray;"><br /><br /></div>
			  <div class="styLNAmountBox" style="height:8mm;width:31.2mm;border-bottom-width:0px;" ><br /><br /></div>
		  </div>
		  <!--Line 9-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">9</div>
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">
			...
			<div class="styPartDesc" style="width:165mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;font-weight:normal;"><b>Tax Computation</b> (see instructions)</div>
		</div>
		<!--Line 1a-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;width:8mm;">1</div>
			  <div class="styLNDesc" style="height:4mm;width:8.5mm;font-weight:bold;padding-left:0mm;"><span style="float:left;">Tax:</span><span style="float:right;">a</span></div>			  
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">1a</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/TaxAmt" />
				</xsl:call-template>     
			  </div>
			<div class="styLNRightNumBox" style="height:4.4mm;width:8mm;background-color:lightgray;border-bottom-width:0px;"></div>
			  <div class="styLNAmountBox" style="height:4.4mm;width:31.2mm;border-bottom-width:0px;" />
		  </div>
		  <!--Line 1b-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">1b</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/LumpSumDistributionTaxAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 1c-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">1c</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/AlternativeMinimumTaxAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 1d-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">1d</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 2b-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">2b</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/CYGenBusinessCreditAllowedAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 2c-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">2c</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/CYNonrefundableAMTCrAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 2d-->
			<div style="width:187mm;font-size:7pt;float:left;">
			 ...
			 <div class="styLNRightNumBox" style="height:4mm;width:8mm;">2d</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/CYBondCreditAllowedAmt" />
				</xsl:call-template>     
		  ...
		  <!--Line 2e-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;">2e</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 7-->
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">7</div>
			  <div class="styLNAmountBox" style="height:4mm;width:31.2mm;border-bottom-width:0px;" >
			  <xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$FormData/TotalTaxAmt" />
				</xsl:call-template>
				</div>
		...
		<!--Line 1-->
		  ...
		  <!--Line 1 Amount-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;"></div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;">Enter the amount of tax-exempt interest income and exempt-interest dividends</span>
				<span style="width:1mm;float:left;" /><span style="float:left;"><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>
				<span style="width:5px;float:left;" /><span style="float:left;">$</span><span style="width:5px;float:left;" />
				<span style="border-bottom:1px dashed;float:left;height:3mm;width:44mm;">
					<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;">At any time during calendar year 2013, did the estate or trust have an interest in or a signature or other authority</span>
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:8.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				<!-- Checkbox -->
				<br />
				<input type="Checkbox" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
		  ...
		  <!--Line 3 (2)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;"></div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;">See the instructions for exceptions and filing requirements for Form TD F 90-22.1. If “Yes,” enter the name of the</span>
				<span style="float:left;">foreign country</span>
		 ...
		 <!--Line 4-->
		  ...
		  <!--Line 8-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">8</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;padding-top:0mm;padding-bottom:0mm;">
				<span style="float:left;font-family:arial narrow;font-size:8pt;">If the decedent’s estate has been open for more than 2 years, attach an explanation for the delay in closing the estate, and check here</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="0"/>
					</xsl:call-template>
		...
		<!-- end page 2 footer -->
          ...
          <table class="styLeftOverTbl">
            ...
            <!-- Begin Separated Repeating data table for TrustEIN-->
					<xsl:if test="count($FormData/TrustEIN) &gt; 1">
						<span class="styRepeatingDataTitle">Line G - Trust EIN</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:91.5mm;">
							...
							<tbody>
								<xsl:for-each select="$FormData/OtherIncomeDescAndAmt">
									<tr style="border-color:black;height:6mm;">
										...
										<td class="styTableCellText" style="width:91.5mm;text-align:right;">
											<xsl:call-template name="PopulateAmount">

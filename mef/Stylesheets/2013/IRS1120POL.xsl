...
<!-- Updated 1/8/2014 fixed by diabling Template putting name in signature box. by Robert L Jones -->
       ...
       <xsl:with-param name="TargetNode" select="$FormData"/>
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div class="IRS1120POL_LineIndex">5</div>
					<div class="IRS1120POL_LineDescLong">Capital gain net income (attach Form 8849 and Schedule D (Form 1120))
             <xsl:call-template name="SetFormLinkInline">
...
<!-- END Signature Section -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2013)</div>
        </div>
        <!-- leftover data table -->
				<br/>
				<br/>

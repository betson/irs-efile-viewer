				...
				<div class="styIRS940SATableRow">
					...
					<div class="styIRS940SAAmtBoxRR" style="background-color:lightgrey;font-size:6pt;padding-top:3mm;">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:choose>
									<xsl:when test="$StateAbrv = 'AR' or $StateAbrv = 'CA' or $StateAbrv = 'CT' or $StateAbrv = 'GA' or $StateAbrv = 'KY' or $StateAbrv = 'MO' or $StateAbrv = 'NC' or $StateAbrv = 'NY' or $StateAbrv = 'OH' or $StateAbrv = 'RI' or $StateAbrv = 'WI'">
										<span style="text-align:left;">.009</span>
									</xsl:when>
									<xsl:when test="$StateAbrv = 'DE'">
										<span style="text-align:left;">.006</span>
									</xsl:when>
									<xsl:when test="$StateAbrv = 'IN' or $StateAbrv = 'VI'">

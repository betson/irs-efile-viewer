			...
			<body class="styBodyClass">
              ...
              <img src="{$ImagePath}/8275-R_Bullet.gif" alt="Bullet Image"/>
						...
						<div class="styUnderlineAmount" style="width:152mm;text-align:left">
							...
							<br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form8275RData/ForeignEntityName/BusinessNameLine2"/>
							</xsl:call-template>
						</div>
					</div>
					<div style="width:187mm;">
              ...
              <img src="{$ImagePath}/8275-R_Bullet.gif" alt="Bullet Image"/>
						...
						<div class="styLNDesc" style="width:129mm;text-align:left">
							<xsl:choose>
								<xsl:when test="count($Form8275RData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber) &gt; 1">
									See Additional Data Table
								</xsl:when>
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8275RData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
              ...
              <br/>
                ...
                <xsl:call-template name="LinkToLeftoverDataTableInline">
					...
					<xsl:if test="count($Form8275RData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber)  &gt; 1">
					<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
						...
						<tbody>
							<xsl:for-each select="$Form8275RData/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNumber">

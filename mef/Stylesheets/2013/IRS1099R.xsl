...
<!-- Last Modified by Eugenia McDonald on 9/29/2010 -->
			...
			<body class="styBodyClass">
				<form name="Form1099R">
					...
					<div class="styBB" style="width:187mm;height:67mm;border-top-width:0px;border-bottom:none;">
						...
						<div class="styIRS1099RleftBox" style="width:98mm;height:67mm; border-top:1px solid black; float:none;">
							<!-- PAYER'S Name and address box -->
							<div class="styIRS1099RleftBox" style="width:98mm;height:34.27mm;
                                  border-left:0px solid black;border-bottom:1px solid black;border-right:0px solid black">
								<span style="width:1mm;"/>
								<span style="font-size: 6.5pt">
									PAYER'S name, street address, city or town, province or state, country, and ZIP<br/>
							...
							<div class="styIRS1099RleftBox" style="width:48.7mm;height:16.5mm;border-top:0px solid black;
							...
							<!--RECIPIENT'S Name -->
							<span class="styIRS1099RleftBox" style="height:19mm;width:97.6mm;
                                 border-left:0px solid black;border-right:0px solid black;border-top:1px solid black;border-bottom:0px solid black;">
								<span style="width:1mm;"/>
						...
						<div class="styBB" style="float:right;width:89mm;height:67mm;border-bottom:none; ">
							...
							<div class="styBB" style="float:right;width:89mm;height:25mm;border-bottom:none; ">
								...
								<div class="styIRS1099RleftBox" style="width:27.6mm;height:25.2mm;text-align:center;
									...
									<span style="padding-top:3mm;height:auto;">
										<div class="styTY" style="font-size:30">
                                                 20<span class="styTYColor">13</span>
										</div>
									</span>
									<br/>
									<span style="padding-top:4mm;font-size:6pt;">Form </span>
									<span style="padding-top:4mm;font-size:8pt;font-weight:bold;">&#160;1099-R </span>
								</div>
								<!-- Distributions from Pensions, etc. -->
								<div class="styIRS1099RrightBox" style="width:30.1mm;height:25.2mm;text-align:right;
							...
							<div class="styIRS1099RrightBoxWithBottom" style="width:89mm;height:42mm;border-bottom:none;
                                 border-right:none;">
								<!-- Big box covers Box 2b, Box 3, Box 4, Box 5, Box 6 -->
								<div class="styIRS1099RrightBoxWithBottom" style="width:67.5mm;height:42mm;
                                      border-right:none;border-left:none;border-bottom:1px solid black; ">
									<!-- Big Box for Box 2b (Taxable Amount not determined and Total Distribution) -->
									<div style="width:68mm;height:9.5;border-right:0px solid black;
										...
										<span class="styIRS1099RrightBoxWithBottom" style="height:8.868mm;width:32mm;
											...
											<span style="width:25mm;font-size: 7pt">
												<label>
													<xsl:call-template name="PopulateLabel">
													...
													<span style="font-weight:bold;display:inline;"> 2b </span>
													<span style="font-size:6.5pt;display:inline;"> Taxable amount <br/><span style="width:4.75mm;"/> not determined</span>
												</label>
											</span>
										...
										<!--  Total Distribution -->
										<span class="styIRS1099RrightBoxWithBottom" style="height:9mm;width:35.5mm;
                                              border-bottom:0px solid black;border-left:0px solid black">
											<span style="width:25mm;font-size: 7.5pt">
												<label>
													<xsl:call-template name="PopulateLabel">
													...
													<span style="font-size:6.5pt; padding-left:11mm; padding-top:0.5mm;">Total<br/> distribution</span>
												</label>
											</span>
											<!--<span style="width:.5px;"/> -->
											<input type="checkbox" class="styCkbox" style="height:4mm;width:4mm;">
									...
									<div style="width:68.25mm;height:17mm;border-right:0px solid black">
										<!-- Box 3 Capital Gain included in box 2a -->
										<span class="styIRS1099RleftBoxWithBottom" style="width:31.5mm;
										...
										<span class="styIRS1099RrightBoxWithBottom" style="height:17.25mm;width:36mm;
                                              font-size:6.5pt;border-left:3px solid black;border-bottom:3px solid black;
                                              border-right:3px solid black;border-top:3px solid black;">
											<span style="width:4px;"/>
									...
									<div style="border-right:0px solid black">
										<!-- Box 5 Employee contributions / Designated Roth contributions or ins 
                                                premiums -->
										<span class="styIRS1099RleftBox" style="width:31.5mm; border-left:none;font-size:6pt">
											<span style="width:4px;"/>
											...
											<span style="width:29.3mm;text-align:right; padding-right:.5mm; padding-top: .5mm;">
												<span style="font-size: 9pt;float:left;padding-left:.7mm">$</span>
												<xsl:call-template name="PopulateAmount">
										...
										<span class="styIRS1099RleftBox" style="width:36mm; border-right:1px solid black;font-size:6.5pt">
											<span style="width:4px;"/>
											...
											<br/>
											<span style="width:32.2mm;text-align:right; padding-right:.5mm;font-size:6pt">
												<span style="font-size: 9pt;float:left;padding-left:.7mm">$</span>
												<xsl:call-template name="PopulateAmount">
								...
								<div class="styIRS1099RrightBox" style="width:20mm;height:42mm;text-align:right;
                                      border-right:none;border-top:none; border-left:none;font-size:6.5pt;
                                      font-weight:bold">
					...
					<!-- Big box for Recipient's Street Addr; City, State, zip; Boxes 7, 8, 9a, 9b and Box for This 
                          information....-->
					<div style="width:187mm;height:23mm; border-bottom: 1px solid black;">
						<!-- Big box for Recipient's Street Addr; City, state,zip,-->
						<div style="width:98mm;float:left;">
							<!--Recipient's street address -->
							<span class="styIRS1099RleftBox" style="height:13.6mm;width:98.05mm;border-top:0px;border-bottom:0px;font-size:6.5pt">
							...
							<span class="styIRS1099RleftBoxWithBottom" style="height:9.5mm;width:98mm;font-size:6.5pt;border-top:0px solid black;border-bottom:0px;">
						...
						<div style="width:68.5mm;height:22.6mm;float:left">
							...
							<div style="width:68.5mm;">
								...
								<span class="styIRS1099RleftBoxWithBottom" style="height:13.8mm;width:20.3mm;
                                         font-size:7pt">
									<span style="width:4px;"/>
								...
								<!--  IRA / SEP/ SIMPLE -->
								<span class="styIRS1099RrightBoxWithBottom" style="height:13.8mm;width:11.5mm;
									...
									<label>
										...
										<span style="width:4px;"/>
										<span style="padding-left:.6mm">SIMPLE</span>
										<br/>
									</label>
								...
								<!-- Box 8 Other -->
								<span class="styIRS1099RleftBoxWithBottom" style="height:13.8mm; width:23.5mm; border-right:1px solid black">
									<span style="width:4px;"/>
									<span style="font-size: 7.5pt;font-weight:bold;">8</span>
									<span style="width:6px;"/>
									<span style="font-size: 7.5pt;">Other</span>
									<span style="padding-top:6mm; width:23.5mm; text-align:left">
										<span style="font-size: 8.5pt;float:left;padding-left:.3mm;">$</span>
										<span style="font-size: 6pt;padding-top:1mm;">
											<xsl:call-template name="PopulateAmount">
								...
								<span class="styIRS1099RrightBoxWithBottom" style="height:13.8mm;width:12.5mm;
                                         border-bottom:1px solid black;border-right:1px solid black;
                                         border-left:0px solid black">
									<span style="width:100%; font-size:7pt; text-align:right; padding-top: 10mm;">
							...
							<!-- Boxes 9a and 9b (Your percentage of total distribution and Total Employee 
                                      contributions) -->
							<div style="width:68mm;height:9mm;">
								<!-- Box 9a Your percentage of total distribution -->
								<span class="styIRS1099RleftBoxWithBottom" style="height:9mm;width:31.8mm;
								...
								<span class="styIRS1099RleftBoxWithBottom" style="height:9mm;width:36mm;
                                         border-right-width:1px;border-bottom:0px;padding-top:.5mm">
									<span style="width:1px;"/>
									...
									<span style="font-size:6pt;width:35mm;padding-top:.5mm;float:bottom;
                                                 text-align:right">
										<span style="font-size: 9pt;float:left;padding-left:.5mm">$</span>
										<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1099RrightBoxWithBottom" style="height:22.5mm;width:20.5mm;
                             text-align:right;border-left-width:0;border-right-width:0;border-bottom:0px solid black; ">
							<span style="font-size: 6pt;">
								<br/>
					...
					<div style="width:187mm">
						...
						<div style="width:98mm;height:24mm;float:left">
							...
							<div style="width:98mm;height:12.2mm;float:left;border-top:0px; border">
								<!--Blank Box -->
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:4px;height:12.11mm; width:49mm;font-size: 7pt;">
									<span style="width:2px;"/>
									<span style="font-weight:bold;">10</span>
									<span style="width:6px;"/>
									Amt. alloc. to IRR within 5 years
									<br/>
									<span style="font-size:6pt;width:35mm;padding-top:4mm;text-align:right;">
										<span style="font-size: 9pt;float:left;padding-left:1mm">$</span>
										<xsl:call-template name="PopulateAmount">
								...
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:4px;height:12.11mm; width:49mm; font-size: 7pt;border-right:0px solid black">
									<span style="width:2px;"/>
									...
									<span style="padding-top:1mm;width:35mm;float:bottom;text-align:right">
										<xsl:call-template name="PopulateYear">
											<xsl:with-param name="TargetNode" select="$Form1099RData/DesignatedROTHActFirstYrDt"/>
										</xsl:call-template>
									</span>
								</span>
							</div>
							<!-- Box for Account number (see instructions) -->
							<span class="styIRS1099RleftBoxWithBottom" style="padding-left:2mm;height:12mm;
                                width:98mm;">
						...
						<div style="width: 89mm;height:auto;float:left;clear:none">
								    ...
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
								      <tbody>
									    <xsl:if test="($Print != $Separated) or 
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.7mm;width:31.9mm;
										      border-bottom:1px dashed black;font-size:6pt;border-right:1px solid black;
								    ...
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.5mm;float:left;">
								      <tbody>
									    <xsl:if test="($Print != $Separated) or 
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.9mm;width:31.5mm;
										      border-bottom:1px dashed black;font-size:6pt;border-right:1px solid black;
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.4mm;text-align:left;
								    ...
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25.53mm;float:left;">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or 
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.2mm;font-size:6pt;
                                              width:25.5mm;border-bottom:1px dashed black;border-right:0px solid black;">
                                              <!--valign="bottom">-->
						...
						select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.5mm;width:31.9mm;
										      font-size:6pt;border-bottom:1px solid black;border-right:1px solid black;
										      border-left:1px solid black" valign="bottom">
         									  <span style="font-size: 7.5pt;float:left;padding-left:1.5mm">$</span>
											  <xsl:for-each
                         ...
                         select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.5mm;width:31.5mm;
										      font-size:6pt; border-bottom:1px solid black; border-right:1px solid black;
										      text-align:left" valign="bottom">&#160;
                                              <xsl:for-each
                         select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
								    ...
								    <table cellpadding="0" cellspacing="0" style="width:25.53mm;float:left">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.8mm;width:25.3mm;
										      font-size:6pt;border-bottom:1px dashed black;border-right:0px solid black;"> 
										      <!--valign="bottom">-->
						 ...
						 select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
                          ...
                          <!-- See Additional Table Message when Boxes 10, 11, 12, 13, 14 and 15 are greater than 2 data items-->
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.5mm;float:left;">
								      <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.5mm;
										    border-bottom:1px dashed black;font-size:6pt;border-right:1px solid black;text-align:left" 
										    valign="bottom">&#160;
                                          </td>
									    </tr>
									    <tr>
								  ...
								  <!--<td colspan="3" class="styIRS1099R_tdRight">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25.3mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:25.5mm;
										    font-size:6pt;border-bottom:1px dashed black;border-right:0px solid black;">&#160;
										  </td>
									    </tr>
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;font-size:6pt;
										    border-top:0px;width:25.5mm;border-right:0px solid black;
									    ...
									    <xsl:if test="($Print != $Separated) or 
										  ...
										  <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp">
										    <xsl:choose>
											  <xsl:when test="position() = 1">
											    <tr>
												  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:31.5mm;
												    border-bottom:1px dashed black;font-size:6pt;border-right:1px solid black;
												    text-align:left" valign="bottom">
                                                    <xsl:call-template name="PopulateText">
													  <xsl:with-param name="TargetNode" select="StateAbbreviationCd"/>
											  ...
											  <xsl:otherwise>
											    <tr>
												  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;text-align:left;
												    border-top:0px;width:31.5mm;font-size:6pt;border-bottom:1px solid black;
												    border-right:1px solid black;" valign="bottom">
                                                    <xsl:call-template name="PopulateText">
												      <xsl:with-param name="TargetNode" select="StateAbbreviationCd"/>
									  ...
									  <tbody>
										  ...
										  <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
										    <xsl:choose>
											  <xsl:when test="position() = 1">
												<tr>
												  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;width:25.3mm;
												    font-size:6pt;border-bottom:1px dashed black;border-right:0px solid black;" valign="bottom">
													<span style="font-size:7.5pt;float:left;padding-left:.5mm">$</span>
													<xsl:call-template name="PopulateAmount">
													  <xsl:with-param name="TargetNode" select="LocalDistributionAmt"/>
													</xsl:call-template>
											  ...
											  <xsl:otherwise>
												<tr>
												  <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;font-size:6pt;
												    border-top:0px;width:25.3mm;border-bottom:1px solid black;
                                                    border-right:0px solid black;clear:none" valign="bottom">
													<span style="font-size:7.5pt;float:left;padding-left:.5mm">$</span>
										            <xsl:call-template name="PopulateAmount">
													  <xsl:with-param name="TargetNode" select="LocalDistributionAmt"/>

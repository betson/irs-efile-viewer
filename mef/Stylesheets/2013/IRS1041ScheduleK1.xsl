	...
	<xsl:template match="/">
		...
		<html>
			...
			<body class="styBodyClass">
				...
				<table width="187mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; 
			  font-size: 7pt;">
					<tr>
						<td width="187mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right;
						  width: 187mm; font-weight:bold;">661113</span>
						</td>
					</tr>
					<tr>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="width: 93mm;">
										<div style="width: 93mm;height:8.8mm;">
											...
											<span class="styFormNumber" style="font-size: 10pt;padding-top:0mm; float: left;
										  clear: none;">Schedule K-1<br/>(Form 1041)
										    <xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$FormData"/>
											</xsl:call-template>
											</span>
											<span class="styTY" style="float: right; clear: none; padding-right: 10mm;padding-top:0mm;font-size:22pt;">
									...
									<td style="font-size: 7pt;height:12.4mm;">
                                       <span style="float: left; clear: none;">Department of the Treasury<br/>
										...
										<span style="float: right; clear: none; padding-right: 1mm; padding-top:2mm;">
											For calendar year 2013,<br/>or tax year beginning
									...
									<td class="IRS1041ScheduleK1_tdLeft" style="height: 33mm;padding-top:0mm;">
										...
										<span style="padding-left: 5mm;height:100%;">
											<xsl:if test="$RtnHdrData/Filer/FiduciaryPersonName">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/FiduciaryPersonName/PersonFirstName"/>
												</xsl:call-template>&#160;
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/FiduciaryPersonName/PersonLastName"/>
												</xsl:call-template><br/>
											</xsl:if>
								...
								<tr>
									<td class="IRS1041ScheduleK1_tdLeft" style="height: 75.5mm;padding-top:0mm;">
										...
										<span style="width: 84mm;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/BeneficiaryDetail/BeneficiaryNm"/>
											</xsl:call-template>
											<br/>
								...
								<tr>
									<td valign="top" style="border-right:1px solid black;">
										<table width="46.5mm" border="0" cellpadding="0" cellspacing="0" style="">
											...
											<!-- Blank Region -->
											<tr>
												<td colspan="3" class="IRS1041ScheduleK1_tdRight" style="border-bottom-width:0px;background-color:lightgrey;height:29mm;"><br/></td>
											</tr>
										</table>
									</td>
...
float:none;border-top:1px dotted gray;width:41.40mm;font-size:6pt;padding-left:1mm;" valign="bottom">
					...
					<tr>
						...
						font-weight: bold; border-top: 1px solid black;">
							...
							<span style="width: 41mm;text-align:right;">Schedule K-1 (Form 1041) 2013</span>
						</td>
					</tr>
				</table>

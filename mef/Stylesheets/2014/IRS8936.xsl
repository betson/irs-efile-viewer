 ...
 <!--Title of Form -->    
  <div class="styBB" style="width:187mm;height: 22mm">
        ...
        <div style="margin-left: 1.5mm;">
          (Including Qualified Two- or Three-Wheeled Plug-in Electric Vehicles)<br/>
            ...
            <img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="Bullet"/>
             Information about Form 8936 and its instructions is at <i><a style="text-decoration:none;color:black;" href="http://www.irs.gov/form8936">www.irs.gov/form8936</a>.</i>  
             </div>
    </div>
  </div>
	<div class="styTYBox" style="width:31mm;height:22mm;border-left-width:1px;">
		...
		<div class="styTY">20<span class="styTYColor">15</span></div>
 ...
 <tr>
    ...
    <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;padding-left:6mm;">
      ...
      <tr style="font-size: 7pt">
        ...
        <!-- Line 4  -->
     <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:6mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px;border-style:solid">
			4
		</td>
        ...
        <td class="styTableCell" style="border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px;padding-left:15mm;padding-top:6mm;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="VehicleTentativeCreditAmt"/>
          </xsl:call-template>
        </td>
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px;padding-left:16mm;padding-top:6mm;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateAmount">
  ...
  <!-- Line 4  -->
     <tr>
		...
		<td class="sty8936LNDescTallShortest">
		 ...
		 <td class="sty8936HLNRightNumBoxTall" style="border-bottom-width:0px">
			4
		</td>     
...
<tbody>
       <!-- line 5  -->
     <tr style="width:187mm">
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-top:5mm;">
			5</td>
        ...
        <td class="styTableCell" style="padding-top:5mm;width:45.5mm;border-color:black;border-left-width:1px; border-right-width:1px; border-top-width:0px; border-bottom-width:1px; text-align:center;">
          <xsl:call-template name="PopulateText">
            <xsl:with-param name="TargetNode" select="BusinessInvestmentUsePct"/>
          </xsl:call-template>%
        <span class="styTableCellPad"/>
        </td>
        <td class="styTableCell" style="padding-top:5mm;width:45mm;border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; text-align:center;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateText">
  ...
  <!-- Line 6  -->
      <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:6.5mm;">
			6</td>
		<td class="sty8936LNDescTallShortest">
    <div style="float:left;">
      Multiply line 4 by line 5. If the vehicle has at least four wheels, leave lines 7 through 10 blank and enter this amount on line <br/>
   ...
   <!-- Line 7  -->
     ...
     <!-- Line 11  -->
      <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:4mm;">
			11</td>
		<td class="sty8936LNDescTallShortest">
...
<!--Line 12 -->  
  ...
  <div style="width: 187mm;">  
    ...
    <div class="sty8936HLNAmountBoxTall" style="height:8mm;padding-top:5mm;width:43.5mm;">
      <xsl:call-template name="PopulateAmount">
  ...
  <div  class="styBB" style="width: 187mm;height:11mm;">  
    ...
    <div class="sty8936HLNAmountBoxTall" style="height:11mm;padding-top:8mm;border-bottom-width:0px;width:43.5mm;">
      <xsl:call-template name="PopulateAmount">
 ...
 <!-- END PREPARER SIGNATURE SECTION -->
    ...
    <div class="styBB" style="width:187mm;padding-top:1mm;border-bottom-width:1px;">  
	 ...
	 <!-- End of page -->
          ...
          Form <span class="styBoldText">8936</span> (2015)
        </div>
  ...
  <!--   Part III header -->
		  ...
		  <div class="styBB" style="width:187mm;padding-top:.5mm;">
			<div style="float:left;">Form 8936 (2015)<span style="width:148mm;"/>
		  </div>
   ...
   <tfoot/>
	  ...
	  <tr>  
       ...
       <span class="styDotLn" style="float:right;padding-right:1mm;">.........</span> 
		 ...
		 <td class="sty8936HLNRightNumBoxTall" style="padding-top:0px;padding-left:0px;padding-right:0px;padding-bottom:0px">
			...
			<div style="height:4mm;padding-top:1mm;text-align:center">15</div>
		</td>   
        <td class="styTableCell" style="width:45mm;border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px;padding-top:9mm;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" select="TentativeCreditForPrsnlUseAmt"/>
          </xsl:call-template>
        </td>
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width:1px; padding-top:9mm;padding-left:12mm;">
          <span class="styTableCellPad"/>
          <xsl:call-template name="PopulateAmount">
    ...
    <tr style="font-size: 7pt">
		...
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:4mm;">
			18</td>
		<td class="sty8936LNDescTallShortest">
			<span style="float:left;white-space:nowrap;">If the vehicle is a two- or three-wheeled vehicle, enter the</span>
			<span style="float:left;white-space:nowrap;">smaller of line 16 or line 17</span>
			<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>  
		 </td>
		 <td class="sty8936HLNRightNumBoxTall">
			18
		</td>
        <td class="styTableCell" style="text-align:right;border-color: black; border-left-width: 1px; border-right-width: 1px;  border-bottom-width:1px; padding-left:14mm;padding-top:3mm;">
			<div class="styLNAmountBox" style="height:4mm;border-width:0px;">	
			    <span class="styTableCellPad"/>		
                    <xsl:call-template name="PopulateAmount">
        ...
        <td class="styTableCell" style="border-color: black; border-left-width: 0px; border-right-width: 0px; border-bottom-width:1px; padding-left:12mm;padding-top:3mm;">
         	<div class="styLNAmountBox" style="height:4mm;border-width:0px;">		
         	                    <xsl:call-template name="PopulateAmount">
   ...
   <table class="styTable" cellspacing="0" style="font-size: 7pt">
    ...
    <tr>
       ...
       <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span> 
        ...
        <xsl:choose>
          <!-- Display "Additional Data" message if Print is set to separated and there are more than 3 elements -->
          <xsl:when test="(($Print = $Separated) and (count($FormData/QlfyPlugInElecDriveMtrVehCrGrp) &gt; 2))">
            <td class="styTableCell" style="border-color: black; border-left-width: 1px; border-right-width: 1px; border-top-width: 0px; border-bottom-width:1px;width:47mm; text-align:center;padding-top:3mm;">
              <xsl:call-template name="PopulateAdditionalDataTableMessage">
                <xsl:with-param name="ShortMessage">true</xsl:with-param>
    ...
    <tr>
		<td class="sty8936LNLeftNumBoxTallDDTwoLines" style="padding-bottom:4mm;">
			18</td>
		<td class="sty8936LNDescTallShortest">
			<span style="float:left;">If the vehicle is a two- or three-wheeled vehicle, enter the</span>
...
<!--Line 23 -->  
  <div style="width: 187mm;height:10mm; border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">  
    ...
    <div class="styLNDesc" style="width:126.25mm;">
	    ...
	    and on Form 1040,  line 54, or Form 1040NR, line 51. 
        Check box <b>c</b> on that line and enter "8936" in the space next to that <span style="float:left;">box. If line 
        22 is smaller than line 19, see instructions </span> 
	    <span class="styDotLn" style="float:right;padding-right:1mm;">..............</span> 
    </div>    
	  ...
	  <!-- Page Break and Footer-->
		  <div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1 solid black;border-top-width:1px;clear:all;">
			...
			<div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8pt;">8936</span> (2015)
            </div>
		  </div>
		  <br/>
          <p style="page-break-before:always"/>

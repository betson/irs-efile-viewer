...
<!-- Last Modified by James Ganzy on 08/12/2014 -->
  ...
  <xsl:template name="Gain1045StkRplcdSchdTemp">
	...
	<!--          <td class="styDepTblCell" style="text-align:center;" >
			...
			<span style="font-size:6pt;">  
			  <td class="styDepTblCell" style="text-align:left;width:90mm;font-size:6pt;">
			  ...
			  <td class="styDepTblCell" style="text-align:right;width:28mm;font-size:6pt;">
			  <br/>
			  ...
			  <td class="styDepTblCell" style="text-align:center;width:42mm;font-size:6pt;">
			  <br/>
				<xsl:call-template name="PopulateMonthDayYear">
				  <xsl:with-param name="TargetNode" select="StockSoldDt"/>
				</xsl:call-template>
			  </td>
			  <td class="styDepTblCell" style="text-align:left;width:85mm;font-size:6pt;">
				<xsl:call-template name="PopulateText">
				  <xsl:with-param name="TargetNode" select="CorpThatIssueQSBStockName/BusinessNameLine1Txt"/>
				</xsl:call-template>
				<br/>
				<xsl:call-template name="PopulateText">
				  <xsl:with-param name="TargetNode" select="CorpThatIssueQSBStockName/BusinessNameLine2Txt"/>
				</xsl:call-template>
			  </td>
			  <td class="styDepTblCell" style="text-align:right;width:28mm;font-size:6pt;">
			  <br/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/TotalAssetsStatement"/>
  ...
  <xsl:template name="TotalAssetsStatementTemp">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="TotalAssetsStatementTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
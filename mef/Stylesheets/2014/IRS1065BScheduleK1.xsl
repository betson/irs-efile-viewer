...
<!-- Last Modified by James Ganzy on 04/22/2015 -->
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="Form1065BSchK1">
					...
					<!--copy start-->
					<div class="" style="height:101mm;width:187mm;border-style:solid;border-color:black;border-width: 0px 0px 1px 0px;">
						...
						<div style="width:187mm;height:61mm;">
							...
							<div style="width:29mm;height:auto;float:left;text-align:right;padding-bottom:0mm">
								<span class="styIRS1065BSchK1leftBox" style="height:75.5mm;width:29mm;float:left;padding-bottom:0mm;">
									...
									<span style="padding-top:3mm;padding-bottom:3mm;">
										<b>For Partner</b>
									</span>

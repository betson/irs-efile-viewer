...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/NontxUseFuelsCrCardUsersStmt"/>
   <!-- - Form 4136 displays as - Nontaxable Use of Fuels/Credit Card Users Statement - -->
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <div class="styDepTitleLine">
          <span class="styDepTitle" style="width:141mm">          
            <xsl:value-of select="$depDocTitle"/>  
          </span>
        </div>
    ...
    <table id="AOVSSTbl" class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" scope="col" style="width:120mm;">Explanation</th>        
          <th class="styDepTblCell" scope="col" style="width:33mm;">Line number</th>  
          <th class="styDepTblCell" scope="col" style="width:33mm;">Credit rate</th>             
        </tr>
      </thead>
      <tfoot/>
      <tbody>    
        <xsl:for-each select="$AOVSSData/NontaxableUseUsersStmt">  
          <tr>
            ...
            <!-- Second Column -->
            <td class="styDepTblCell" style="width:33mm;text-align:center;">
              <xsl:call-template name="PopulateText">

  ...
  <xsl:template match="/">
    <html lang="EN-US">
      <head>
        ...
        <meta name="Desc" content="IRS Form 4835"/>
        ...
        <form name="IRS4835" style="font-family:arial;">
                  ...
                  <div style="width:100%;height:5mm;padding-left:5px;">
                    <div style="width:100%;height:auto;">
                      ...
                      <br/>
                        ...
                        <img src="{$ImagePath}/4835_Bullet_Sm.gif" alt="SmallBullet"/> 
						  Information about Form 4835 and its instructions is at www.irs.gov/form4835.</b>
                    </div>
                  </div>
                </span>
              </div>
          ...
          <div class="styBB" style="width:187mm;height:16mm;">
            ...
            <div style="width:50mm;height:50%;padding:0px 0px 0px 2mm;font-size:7pt;border-width:0px 0px 1px 0px;border-color:black;border-style:solid;" class="styEINBox">
              ...
              <br/>
              <span style="font-weight:normal;text-align:left;width:100%;padding-top:2px;">
              ...
              <div class="styIRS4835CleanDiv" style="width:153mm;height:auto;padding:0px 0px 0px 0px;">
                <div class="styIRS4835LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
                  <div class="styIRS4835LNDesc" style="width:auto;height:100%;">
                    Did you actively participate in the operation of this farm during 2014 (see instructions)?
                  </div>
                ...
                <div class="styIRS4835CleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
                  <div class="styIRS4835CleanDiv">
                    <xsl:attribute name="style">
                      ...
                      <xsl:variable name="cnt" select="count($Form4835Data/OtherExpenseDetail)"/><xsl:choose><xsl:when test="($Print != $Separated) and ($cnt &gt;7)">height:<xsl:value-of select="5.25+($cnt - 7)*5"/>mm;border-top-width:1px;</xsl:when><xsl:otherwise>height:4mm;</xsl:otherwise></xsl:choose>
                    </xsl:attribute>
                    <xsl:call-template name="CreateBox">
                      <xsl:with-param name="Height">100%</xsl:with-param>
                      <xsl:with-param name="AmountBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;</xsl:with-param>
					  ...
					  <div class="styIRS4835LNDesc" style="width:47mm;height:5mm;">
						<span style="width:43mm;height:4mm;border-style:dashed;border-color:black;border-width:0px 0px 1px 0px;">
							<xsl:call-template name="PopulateAdditionalDataTableMessage">
							  <xsl:with-param name="TargetNode" select="$Form4835Data/OtherExpenseDetail"/>
							</xsl:call-template>
						</span>
					  </div>
...
-->
            ...
            <div class="styIRS4835LineItem" style="width:187mm">
              ...
              <div class="styIRS4835CleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
               ...
               <div class="styLNRightNumBox" style="font-size:8pt;padding:3px 0px 0px 0px;border-right-width:0px;height:5mm;border-left-width:0px;border-bottom-width:0px;">33</div>                
              <div class="styIRS4835CleanDiv" style="width:28.5mm;height:100%;padding-left:0mm;padding-top:1mm;padding-bottom:0;">
                <!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
                <span>
                  <input type="checkbox" class="styCkbox">
                    <xsl:call-template name="PopulateYesCheckbox">
            ...
            <div class="styIRS4835LineItem" style="width:187mm">
              ...
              <div class="styIRS4835CleanDiv" style="width:144mm;height:7mm;padding:0px 0px 0px 0px;">
                <div class="styIRS4835LNDesc" style="width:auto;height:7mm;padding-top:1.5mm;">
                  ...
                  <div class="styIRS4835LNDesc" style="width:auto;height:75%;text-align:right;float:right;padding:4px 3px 0px 0px;">
            ...
            <div class="styIRS4835LineItem" style="width:187mm;border-bottom:1px solid black">
              ...
              <div class="styIRS4835CleanDiv" style="width:37mm;height:100%;padding:0px 0px 0px 0px;float:right;">
                <div class="styIRS4835CleanDiv" style="width:100%;height:10.5mm;float:right;">
                  <xsl:call-template name="CreateBox">
                    <xsl:with-param name="Height">100%</xsl:with-param>
                    <xsl:with-param name="AmountBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;</xsl:with-param>
                    <xsl:with-param name="NumberBoxStyle">border-width:0px 0px 0px 1px;padding:0px 0px 0px 0px;background-color:lightgrey</xsl:with-param>
          ...
          <xsl:if test="($Print = $Separated) and (count($Form4835Data/OtherExpenseDetail) &gt; 7)">

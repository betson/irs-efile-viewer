    ...
    <html>
      ...
      <body class="styBodyClass">    
        ...
        <div class="styTopSectionLine" style="clear:both">
          ...
          <div style="float:left">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form5471Deps6Data/PriorBusinessName/BusinessNameLine1"/></xsl:call-template>     
            <xsl:if test="normalize-space($Form5471Deps6Data/PriorBusinessName/BusinessNameLine2) != ''">
              <br/><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form5471Deps6Data/PriorBusinessName/BusinessNameLine2"/></xsl:call-template>     
            </xsl:if>
          </div>                  
        </div>  

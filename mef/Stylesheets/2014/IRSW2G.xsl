      ...
      <body class="styBodyClass">
        <form name="FormW2G">
          ...
          <div class="styIRSW2GRowItem" style="width:187mm;height:90mm;padding:0px 0px 0px 0px;border-right-width:0px;border-left-width:0px;border-top-width:0px;border-bottom-width:0px;">
              ...
              <div class="styIRSW2GRowItem" style="78.4mm;float:left;">
                ...
                <div class="styIRSW2GRowItem" style="width:78.4mm;height:40mm;float:left;">
                  <div class="styIRSW2GDataTitleLeft">
                    ...
                    <span style="font-size:6pt;font-family:Arial;">PAYER'S name, street address, city or town, province or state, country, and ZIP or foreign postal code</span>
                  ...
                  <div class="styIRSW2GDataLTxtField">
                    ...
                    <xsl:choose>
                      <xsl:when test="$FormW2GData/PayerUSAddress">
                        <xsl:call-template name="PopulateText">
                ...
                <div class="styIRSW2GRowItem" style="width:78.4mm;float:left;border:0px solid black;border-top-width:1px;">
                    <div style="width:39.2mm;float:left;border:0px solid black;border-top-width:0px;border-right-width:1px;height:9mm">
                       <span style="width:3px;"/>
                ...
                <!-- WINNER'S name >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>-->
                <div class="styIRSW2GRowItem" style="width:79mm;float:left;border:0px solid black;border-top-width:1px;black;border-bottom-width:1px;">
                  <div class="styIRSW2GDataTitleLeft">
                    <span style="width:3px;"/>
                ...
                <div class="styIRSW2GRowItem"  style="width:79mm;float:left;border:0px solid black;border-top-width:0px;black;border-bottom-width:1px;">
                  <div class="styIRSW2GDataTitleLeft">
                    <span style="width:3px;"/>
                ...
                <div class="styIRSW2GRowItem" style="width:79mm;float:left;">
                  ...
                  <div class="styIRSW2GDataLTxtField">
                        <xsl:call-template name="PopulateCityStateInfo">
                          ...
                          <xsl:with-param name="ForeignAddressTargetNode" select="$FormW2GData/RecipientForeignAddress"/>
                        </xsl:call-template>
                        <span style="width:7px;"/>
                        <xsl:call-template name="PopulateText">
                ...
                <div class="styIRSW2GRowItem" style="width:79mm;height:17mm;float:left;background-color:lightgrey;border:0px black solid;border-top-width:1px;"/>
            ...
            <div class="styIRSW2GRightBottomFrame" style="width:31.5mm;height:25.5mm;border-top-width:1px;">
              <div style="width:100%;text-align:right;float:right;">
                <!--<div style="font-family:Arial;font-size:7.7pt;padding-top:4mm;float:left;background-color:red;">-->
				<b>	<div class="styBB" style="padding-top:4mm;width:31mm;height:10.5mm;">
				    	<xsl:call-template name="LinkToLeftoverDataTableInline">
					    ...
					    <span style="font-size:6.5pt;border-top-width:1px; solid black">File with Form 1096</span>
					</div></b>
                    <!--<span style="width:4px;"/>-->
                  <b>  <div style="width:31mm;height:10.5mm;" >
                          <span  style="height:4mm"> Copy A</span><br/>
                             <span  style="height:4mm"> For Internal Revenue</span><br/>Service Center
                          </div></b>
                        <!--<b>
					  <div
                      <xsl:call-template name="LinkToLeftoverDataTableInline">
                      ...
                      <span class="IRSW2GCell" style="font-size:6.5pt;border-top-width:1px; solid black">File with Form 1096</span><br/><br/>
              ...
              <span style="font-family:Arial;font-size:7pt;">
                <div class="pageEnd" style="width:187mm;padding-top:1mm;border-top-width:0px;">
                  ...
                  <div style="float:left;">
                    ...
                    Cat. No. 10138V<span style="width:20mm;"/>www.irs.gov/w2g
                  </div>

  ...
  <body class="styBodyClass">    
    <form style="font-family:arial; font-size:9pt" name="Form8621">      
      ...
      <div class="styTBB" style="width:187mm">
        ...
        <div class="styTYBox" style="font-size:7pt; width:27mm; height:18mm">
      ...
      <div class="styIRS8621BB" style="height:18mm;font-size:6.5pt">
        ...
        <div style="height:9mm;width:87mm;float:left; padding-bottom:1mm;padding-left:1mm;border-bottom:1px solid black;">
          ...
          <xsl:choose>
            ...
            <xsl:otherwise>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form8621Data/ForeignEntityIdentificationGrp/ForeignEntityReferenceIdNum"/>
              </xsl:call-template>
            </xsl:otherwise>
          </xsl:choose>
        </div>

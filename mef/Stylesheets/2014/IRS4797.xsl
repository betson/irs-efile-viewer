		...
		<html>
			...
			<body class="styBodyClass">
				<form name="Form4797">
					...
					<div class="styTBB" style="width:187mm;height:24.5mm;">
						<div class="styFNBox" style="width:31mm;">
							<div style="height:19mm;">Form
						...
						<div class="styTYBox" style="width:30mm;">
							...
							<div class="styTY" style="height:17.5mm;">20<span class="styTYColor">14</span>
							</div>
						    ...
						    <xsl:choose>
							  <xsl:when test="normalize-space($Form4797Data/BusinessName/BusinessNameLine1Txt) != ''">
								<xsl:call-template name="PopulateText">
								  <xsl:with-param name="TargetNode" select="$Form4797Data/BusinessNameLine1Txt"/>
								</xsl:call-template>
								<br/>
								<xsl:call-template name="PopulateText">
								  <xsl:with-param name="TargetNode" select="$Form4797Data/BusinessNameLine2Txt"/>
								</xsl:call-template>/
							  </xsl:when>
							  <xsl:otherwise>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:145mm;">
							...
							Enter the gross proceeds from sales or
						  exchanges reported to you for 2014 on Form(s) 1099-B or 
					...
					<!-- End Line 1 -->
					<!-- BEGIN PART I TITLE -->
					<div class="styBB" style="width:187mm;height:8mm;border-top:1 px solid black;">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody style="border:1px solid black;">
										...
										<tr>
											<td class="styTableCell" style="width:4mm;text-align:right;border-right:0;font-weight:bold;" scope="col">
												...
												<xsl:attribute name="style">
													border-bottom:0;width:4mm;text-align:right;border-right-width:0px;font-weight:bold;
												</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
											...
											<td class="styTableCell" style="text-align:left;width:30mm;">
												<xsl:if test="position() = last()">
												<xsl:attribute name="style">
													border-bottom:0;text-align:left;width:30mm;
												</xsl:attribute>
												</xsl:if>
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCell" style="width:30mm;border-right:0;">
												<xsl:if test="position() = last()">
												<xsl:attribute name="style">
													border-bottom:0;width:30mm;border-right:0;
												</xsl:attribute>
												</xsl:if>
												<xsl:call-template name="PopulateAmount">
								...
								<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 1 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="width:4mm;text-align:right;border-right:0;font-weight:bold;border-bottom:0;" scope="col">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:left;width:30mm;border-bottom:0;">
										...
										<td class="styTableCell" style="text-align:right;width:30mm;border-bottom:0;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:right;width:30mm;border-bottom:0;">
											<span class="styTableCellPad"/>
										...
										<td class="styTableCell" style="text-align:right;width:30mm;border-right:0;border-bottom:0;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 2 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="width:4mm;text-align:right;border-right:0;border-bottom:0;border-top:1px solid black;" scope="col">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:left;width:30mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:16mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:16mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:right;width:30mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:right;width:30mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										...
										<td class="styTableCell" style="text-align:right;width:30mm;border-right:0;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 3 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="border-top:1px solid black;width:4mm;text-align:right;border-right-width:0px;border-bottom:0;" scope="col">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="text-align:left;width:30mm;border-bottom:0;border-top:1px solid black;">
											<span class="styTableCellPad"/>
								...
								<xsl:if test="count($Form4797Data/PropertySaleOrExchange) &lt; 4 or ((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="border-top:1px solid black;width:4mm;text-align:right;border-right:0;border-bottom:0;" scope="col">
										<xsl:if test="((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:4mm;text-align:right;border-right:0;border-bottom:0;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="border-top:1px solid black;text-align:left;width:30mm;border-bottom:0">
										<xsl:if test="((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;text-align:left;width:30mm;border-bottom:0;
												</xsl:attribute>
										</xsl:if>										
											<span class="styTableCellPad"/>
										</td>
										...
										<xsl:if test="((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:16mm;border-bottom:0;
												</xsl:attribute>
										</xsl:if>										
											<span class="styTableCellPad"/>
										</td>
										...
										<xsl:if test="((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;text-align:right;width:30mm;border-bottom:0
												</xsl:attribute>
										</xsl:if>										
											<span class="styTableCellPad"/>
										</td>
										...
										<xsl:if test="((count($Form4797Data/PropertySaleOrExchange) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:30mm;border-right:0;border-bottom:0;
												</xsl:attribute>
										</xsl:if>										
											<span class="styTableCellPad"/>
										</td>
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody style="border:1px solid black;">
								...
								<xsl:if test="count($Form4797Data/OrdinaryGainLoss) &lt; 3 or ((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="width:34mm;text-align:left;border-bottom:0" colspan="2">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:16mm;border-bottom:0;">
											<span class="styTableCellPad"/>
										...
										<td class="styTableCell" style="width:30mm;text-align:right;border-bottom:0;">
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="width:30mm;text-align:right;border-bottom:0;">
											<span class="styTableCellPad"/>
										...
										<td class="styTableCell" style="width:30mm;text-align:right;border-right:0;border-bottom:0;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form4797Data/OrdinaryGainLoss) &lt; 4 or ((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="width:34mm;text-align:left;border-top:1px solid black;border-bottom:0;" colspan="2">
										<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:34mm;text-align:left;border-bottom:0;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
										...
										<td class="styTableCell" style="width:30mm;text-align:right;border-bottom:0;border-top:1px solid black;">
										<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:30mm;text-align:right;border-bottom:0;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
										...
										<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:30mm;width:30mm;text-align:right;border-bottom:0;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
										...
										<td class="styTableCell" style="width:30mm;text-align:right;border-right:0;border-bottom:0;border-top:1px solid black;">
										<xsl:if test="((count($Form4797Data/OrdinaryGainLoss) &gt; 4) and ($Print = $Separated))">
												<xsl:attribute name="style">
													border-top:0;width:30mm;text-align:right;border-right:0;border-bottom:0;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead" style="border:1px solid black;">
								<tr>
									...
									<th class="styTableCellHeader" style="width:16mm;border-right:0;" scope="col">(c)
							...
							<tbody style="border:1px solid black;">
									...
									<xsl:if test="($Print != $Separated) or (count($Form4797Data/PropertyDispositionGain) &lt;= 4) ">
										<tr>
											<td class="styTableCell" style="width:6mm;text-align:center;border-right:0;font-weight:bold;" scope="col">
												...
												<xsl:attribute name="style">
													border-bottom:0;width:6mm;text-align:center;border-right:0;font-weight:bold;
												</xsl:attribute>
												</xsl:if>
											...
											<td class="styTableCell" style="width:148mm;text-align:left;">
												<xsl:if test="(position() = last()) and (count($Form4797Data/PropertyDispositionGain) != 4)">
												<xsl:attribute name="style">
													border-bottom:0;width:148mm;text-align:left;
												</xsl:attribute>
												</xsl:if>
												<span class="styTableCellPad"/>
												<xsl:call-template name="PopulateText">
											...
											<td class="styTableCellText" style="width:16mm;border-right:0;">
												<xsl:if test="(position() = last()) and (count($Form4797Data/PropertyDispositionGain) != 4)">
												<xsl:attribute name="style">
													border-bottom:0;width:16mm;border-right:0;
												</xsl:attribute>
												</xsl:if>
												<span style="width:1px;"/>
												<xsl:if test="SoldDt">
								...
								<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 2 or ((count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated))">
									<tr>
										...
										<td class="styTableCell" style="width:16mm;border-right:0;border-top:1px solid black;border-bottom:0;">
											<span class="styTableCellPad"/>
										</td>
									</tr>
								</xsl:if>
								...
								<xsl:if test="count($Form4797Data/PropertyDispositionGain) &lt; 4 or ((count($Form4797Data/PropertyDispositionGain) &gt; 4) and ($Print = $Separated))">
									<tr>
										<td class="styTableCell" style="border-top:1px solid black;
										width:6mm;text-align:center;border-right:0;font-weight:bold;" scope="col">
										<xsl:if test="($Print = $Separated)">
												<xsl:attribute name="style">
													border-bottom:0;border-top:1px solid black;
										width:6mm;text-align:center;border-right:0;font-weight:bold;
												</xsl:attribute>
										</xsl:if>
										D</td>
										<td class="styTableCell" style="border-top:1px solid black;width:148mm;text-align:left;">
										<xsl:if test="($Print = $Separated)">
												<xsl:attribute name="style">
													border-bottom:0;border-top:1px solid black;width:148mm;text-align:left;
												</xsl:attribute>
										</xsl:if>										
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="border-top:1px solid black;width:16mm;">
										<xsl:if test="($Print = $Separated)">
												<xsl:attribute name="style">
													border-bottom:0;border-top:1px solid black;width:16mm;
												</xsl:attribute>
										</xsl:if>
											<span class="styTableCellPad"/>
										</td>
										<td class="styTableCell" style="border-top:1px solid black;width:16mm;border-right:0;">
										<xsl:if test="($Print = $Separated)">
												<xsl:attribute name="style">
													border-bottom:0;border-top:1px solid black;width:16mm;border-right:0;
												</xsl:attribute>
										</xsl:if>
										<span class="styTableCellPad"/>
										</td>
					...
					<div class="styBB" style="width:187mm;float:left;">
						<div class="styPartDesc" style="width:187mm;float:left;">Summary of Part III Gains. 

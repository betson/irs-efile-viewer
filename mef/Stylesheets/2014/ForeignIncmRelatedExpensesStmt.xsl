...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/ForeignIncmRelatedExpensesStmt"/>
		...
		<html>
			...
			<body class="styBodyClass">
				...
				<xsl:if test="$FormData/ExplanationTxt">
					<div class="styTopSectionLine" style="width: 187mm; clear: left; float: left; margin-top: 0px;">

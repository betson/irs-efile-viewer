...
<!-- Created by Doug Peterson 6-16-2006--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/OtherNetRentalActyIncmLossStmt"/>
    ...
    <table id="AOVSSTbl" class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" scope="col">Activity Type</th>        
          <th class="styDepTblCell" scope="col">Amount</th>   
        </tr>
      </thead>
      <tfoot/>
      <tbody>    
        <xsl:for-each select="$AOVSSData/OtherNetRntlActyIncmLoss">  
          <tr>

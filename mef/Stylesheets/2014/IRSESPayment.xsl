...
<!-- Last Modified by James Ganzy on 9/08/2010 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/IRSESPayment"/>
    ...
    <xsl:call-template name="AddOnStyle"/>    
      ...
      <body class="styBodyClass">
        <xsl:call-template name="DocumentHeaderDependency"/>    
          ...
          <div class="styExplanationLine" style="float:left; padding-top:4.4mm;">          
          ...
          <div class="styExplanationLine" style="float:left">          
             <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/EstimatedPaymentDueDt"/>
            </xsl:call-template>
            </div>                  
        </div>      

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/IncomeLossForeignPrtshpSch"/>
  
  <!-- Template to display Income Loss From Foreign Partnerships Schedule-->
  
  <xsl:template name="ShowDependencyData">
    <!-- Income Loss From Foreign Partnerships Schedule Data -->
    <table class="styDepTbl" style="font-size:6pt">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
           ...
           <th class="styDepTblCell" scope="col" style="width:13mm">EOY Profit-Sharing Pct</th>        
           <th class="styDepTblCell" scope="col" style="width:13mm">EOY Loss-Sharing Pct</th>   
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/IncmLossFromFrgnPrtshpItemGrp">
          <tr>

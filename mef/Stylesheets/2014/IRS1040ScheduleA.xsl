...
<!-- Last Modified by Eugenia McDonald on 09/08/2016 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <form name="Form1040ScheduleA">
          ...
          <div class="styTBB" style="width:187mm;height:19mm;">
            ...
            <div class="styTYBox" style="width:32mm;height:19mm;">
              ...
              <div class="styTY" style="height:6mm;font-size:20pt;padding-top:0mm;padding-bottom:0mm;line-height:100%;
                padding-left:1mm">
   ...
   Name(s) shown on Form 1040<br/>
        ...
        <xsl:call-template name="PopulateReturnHeaderFiler">
          ...
          <div class="styBB" style="width:187mm;height:24mm;">
            ...
            Medical and dental expenses (see instructions)
              ...
              <div class="styIRS1040ScheduleAleftBox" style="width:96.5mm; height:7.5mm;font-size:7pt;border-left-width:0px;
                ...
                <span style="font-size:7pt">born before January 2, 1950, multiply</span>
                <span style="font-size:7pt;">line 2 by 7.5% (.075) instead</span>
                <span style="width:.5mm"/> 
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styIRS1040ScheduleAleftBox" style="width: 96mm; height:27mm;font-size:7pt;border-right-width:0px;
              border-left-width:0px;">
          ...
          <div class="styBB" style="width:187mm;height:44.3mm;">
            ...
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:4.8mm;border-bottom-width:1px;padding-right:.5mm;
              font-size:6pt;padding-top:.8mm">
              <xsl:call-template name="SetFormLinkInline">
          ...
          <div class="styBB" style="width:187mm;height:7mm;">
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.9mm;border-bottom-width:0px;padding-top:2mm;">
              20</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:4.9mm;border-bottom-width:0px;font-size:6pt">
              <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$FormData/CasualtyOrTheftLossesAmt"/>
             </xsl:call-template>
            </div>
          ...
          <div class="styBB" style="width:187mm;height:45.5mm;">
            ...
            <!--Lines 21, 22, 23, 24, 25, 26 and 27 Verbiage.  Line 25 amount boxes included here 
                 because of location on form-->
            <div class="styIRS1040ScheduleAleftBox" style="width: 96mm; height:38.5mm;font-size:7pt; border-right-width:0px;
              border-left-width:0px;">
              ...
              <div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:12mm;font-size:7pt;border-left-width:0px;
                ...
                <span style="width:2mm"/>
                  Unreimbursed employee expenses<img src="{$ImagePath}/1040SchA_JobExp_Longdash.gif"
                   alt="JobExpLongdash Image"/>job travel, union  dues,
              <div class="styIRS1040ScheduleAleftBox" style="width: 95mm; height:3.9mm;font-size:7pt;border-left-width:0px;
                border-right-width:0px;border-bottom-width:0px;padding-left:.5mm;padding-top:.3mm">
                <span style="width:5.4mm"/>
              ...
              <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.9mm;padding-top:1.2mm;border-left-width:1px;
                border-bottom-width:1px;">
                 25</div>
              <div class="styIRS1040ScheduleAlnAmountBox" style="width:30mm;height:4.9mm;padding-top:2mm;padding-right:.5mm;
                font-size:6pt;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$FormData/TaxReturnAGIAmt"/>
                </xsl:call-template>
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:5.5mm;background-color:lightgrey;
              border-bottom-width:0px;"/>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:5.5mm;border-bottom-width:0px;"/> 
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:5.1mm;border-left-width:1px;border-bottom-width:1px;">26</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:5.1mm;padding-right:.5mm; border-bottom-width:1px;
              font-size:6pt">
              <xsl:call-template name="PopulateAmount">
          ...
          <div class="styBB" style="width:187mm;height:11mm;">
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:3.5mm;border-bottom-width:0px;">
              28</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:3.5mm;padding-right:.5mm;border-bottom-width:0px;
              font-size:6pt">
              <xsl:call-template name="PopulateAmount">
                <xsl:with-param name="TargetNode" select="$FormData/OtherMiscellaneousDedAmt"/>
              </xsl:call-template>
          ...
          <div class="styBB" style="width:187mm;height:28mm;">
            ...
            <div class="styIRS1040ScheduleAleftBox" style="width:131.5mm; height:28mm;font-size:7pt;border-left-width:0px;
              border-right-width:0px;">
              <!--Line 29 Verbiage-->             
            ...
            <div class="styIRS1040ScheduleAlnRightNumBox" style="height:4.2mm;border-bottom-width:1px;font-size:6.7pt;
             padding-top:0mm;">
              29</div>
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:4.2mm;padding-right:.5mm;               border-bottom-width:1px;
              font-size:6pt">
              <xsl:call-template name="PopulateAmount">
            ...
            <div class="styIRS1040ScheduleAlnAmountBox" style="height:11.9mm;background-color:lightgrey;border-bottom-width:0px"/>          </div>

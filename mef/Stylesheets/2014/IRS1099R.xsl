				...
				<form name="Form1099R">
					...
					<div class="styBB" style="width:187mm;height:67mm;border-top-width:0px;border-bottom:none;">
						...
						<div class="styIRS1099RleftBox" style="width:97.5mm;height:67mm; border-top:1px solid black;">
							...
							<div class="styIRS1099RleftBox" style="width:97.5mm;height:34.27mm;                                   border-left:0px solid black;border-bottom:1px solid black;border-right:0px solid black">
								<span style="width:1mm;"/>
								<span style="font-size: 6.5pt">
                                         PAYER'S name, street address, city or town, province or state, country, and ZIP or foreign postal code</span>
								<br/>
							...
							<div class="styIRS1099RleftBox" style="width:48.7mm;height:16.5mm;border-top:0px solid black;                              border-bottom:0px solid black;border-left:0px solid black;">
								<span style="width:1mm;"/>
							...
							<div class="styIRS1099RleftBoxWithBottom" style="height:16.5mm;width:48.5mm;                                  border-left:1px solid black;border-bottom:1px;border-right:0px solid black;">
								<span style="width:1mm;"/>
							...
							<!--RECIPIENT'S Name -->
							<span class="styIRS1099RleftBox" style="height:19mm;width:97.6mm;                                  border-left:0px solid black;border-right:0px solid black;border-top:1px solid black;border-bottom:1px solid black;">
								<span style="width:1mm;"/>
						...
						<div class="styBB" style="float:right;width:89mm;height:67mm;border-bottom:none; ">
							...
							<div class="styBB" style="float:right;width:89mm;height:25mm;border-bottom:none; ">
								...
								<div class="styIRS1099RleftBox" style="width:31.3mm;height:25mm;                                        border-top:1px solid black;">
									<!-- Box 1 Gross Distribution -->
									<span class="styIRS1099RleftBox" style="height:12.5mm;                                              border-left:2px solid black;border-top:2px solid black;                                              border-right:2px solid black;border-bottom:1px solid black;width:31.3mm;">
									...
									<span class="styIRS1099RleftBox" style="height:12.5mm;                                              border-left:2px solid black;border-right: 2px solid black;                                              border-bottom: 3px solid black; width:31.3mm;">
								...
								<div class="styIRS1099RleftBox" style="width:27.6mm;height:25.2mm;text-align:center;                                        border-top:1px solid black;border-right:1px solid black;                                        border-bottom: 1px solid black;">
								...
								<div class="styIRS1099RrightBox" style="width:29.7mm;height:25.2mm;text-align:right;                                       border-right:none;border-top:none;border-left:none;border-bottom:1px solid black;">
							...
							<div class="styIRS1099RrightBoxWithBottom" style="width:89mm;height:42mm;border-bottom:none;                                  border-right:none;">
								...
								<div class="styIRS1099RrightBoxWithBottom" style="width:68mm;height:42mm;                                       border-right:none;border-left:none;border-bottom:1px solid black; ">
									...
									<div style="width:68mm;height:8.87mm;border-right:0px solid black;                                            border-left:0px solid black;padding-top:.3mm">
										<!--  Taxable Amount not determined -->
										<span class="styIRS1099RrightBoxWithBottom" style="height:8.868mm;width:32mm;                                                 border-bottom:0px solid black;border-right:0px solid black;                                                 border-left:0px solid black">
										...
										<!--  Total Distribution -->
										<span class="styIRS1099RrightBoxWithBottom" style="height:8.87mm;width:35.7mm;                                               border-bottom:0px solid black;border-left:0px solid black">
									...
									<div style="width:68.25mm;height:16mm;border-right:0px solid black">
										...
										<span class="styIRS1099RleftBoxWithBottom" style="height:16mm;width:31.5mm;                                               border-top:1px solid black;border-left:0px solid black;font-size:6pt">
											<span style="width:4px;"/>
											...
											<br/>
											<span style="padding-top:4.3mm;width:29.3mm;float:bottom;text-align:right;                                                   font-size:6pt;padding-right:.5mm">
										...
										<span class="styIRS1099RrightBoxWithBottom" style="height:16.5mm;width:36.7mm;                                               font-size:6.5pt;border-left:3px solid black;border-bottom:3px solid black;                                               border-right:3px solid black;border-top:2 solid black;">
											<span style="width:4px;"/>
											...
											<br/>
											<br/>
											<span style="padding-top:3mm;width:32mm;float:bottom;text-align:right;                                                  font-size:6pt;padding-right:.7mm">
												<span style="font-size:9pt;float:left;padding-left:1mm">$</span>
												<xsl:call-template name="PopulateAmount">
									...
									<div style="width:68.25mm;height:18.09mm;border-right:0px solid black">
										<!-- Box 5 Employee contributions / Designated Roth contributions or ins 
                                                premiums -->
										<span class="styIRS1099RleftBox" style="height:18.09mm;width:31.5mm;                                                border-left:none;font-size:6pt">
											<span style="width:4px;"/>
											...
											<span style="padding-top:2.6mm;width:29.3mm;float:bottom;text-align:right;                                                    padding-right:.5mm">
												<span style="font-size: 9pt;float:left;padding-left:.7mm">$</span>
												<xsl:call-template name="PopulateAmount">
										...
										<span class="styIRS1099RleftBox" style="height:18.09mm;width:36.7mm;                                                 border-right:1px solid black;font-size:6.5pt">
											<span style="width:4px;"/>
											...
											<br/>
											<span style="width:32.2mm;padding-top:1.7mm;float:bottom;text-align:right;                                                       padding-right:.5mm;font-size:6pt">
												<span style="font-size: 9pt;float:left;padding-left:.7mm">$</span>
												<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;height:23mm;">
						...
						<div style="width:98mm;float:left;">
							...
							<span class="styIRS1099RleftBox" style="height:13.6mm;width:98.05mm;border-top:0px solid black;                                  font-size:6.5pt">
							...
							<span class="styIRS1099RleftBoxWithBottom" style="height:9.5mm;width:98mm;font-size:6.5pt;border-top:1px solid black;border-bottom:none;">
								<span style="width:.7mm;"/>City or town, province or state, country, and ZIP or foreign postal code<br/>
								<span style="width:1mm;"/>
								<xsl:call-template name="PopulateCityStateInfo">
						...
						<div style="width:68.5mm;height:22.6mm;float:left">
							...
							<div style="width:68.5mm;">
								...
								<span class="styIRS1099RleftBoxWithBottom" style="height:13.85mm;width:20.3mm;                                          font-size:7pt">
									<span style="width:4px;"/>
								...
								<!--  IRA / SEP/ SIMPLE -->
								<span class="styIRS1099RrightBoxWithBottom" style="height:13.8mm;width:11.3mm;                                          border-bottom:1px solid black;border-right:0 solid black;font-size:6.5pt;">
									<span style="width:1mm;"/>
									<label>
										<xsl:call-template name="PopulateLabel">
								...
								<!-- Box 8 Other -->
								<span class="styIRS1099RleftBoxWithBottom" style="height:13.8mm;width:24.9mm;border-right:1px solid black">
									<span style="width:4px;"/>
								...
								<span class="styIRS1099RrightBoxWithBottom" style="height:13.8mm;width:11mm;                                          border-bottom:1px solid black;border-right:1px solid black;                                          border-left:0px solid black">
									<br/>
									<br/>
									<br/>
									<span style="padding-bottom:.1mm;width:11mm;font-size:6pt;float:bottom;                                                   text-align:right">
							...
							<div style="width:68.8mm;height:9.2mm;">
								...
								<span class="styIRS1099RleftBoxWithBottom" style="height:9.2mm;width:31.7mm;                                          padding-top:.5mm;border-bottom:0px">
									<span style="width:3px;"/>
								...
								<span class="styIRS1099RleftBoxWithBottom" style="height:9.2mm;width:36.7mm;                                          border-right-width:1;border-bottom:0px;padding-top:.5mm">
									<span style="width:2px;"/>
									...
									<br/>
									<span style="font-size:6pt;width:35mm;padding-top:.5mm;float:bottom;                                                  text-align:right">
										<span style="font-size: 9pt;float:left;padding-left:1mm">$</span>
										<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;height:24mm">
						...
						<div style="width:98mm;height:24mm;float:left">
							...
							<div style="width:98.04mm;height:12.2mm;float:left;border-top:solid black 1px;">
								<!--Blank Box -->
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:4px;height:12.11mm;                                       width:49mm;">
									<span style="width:2px;"/>
									<span style="font-size: 7pt;font-weight:bold;">10</span>
									<span style="width:8px;"/>
									<span style="font-size: 6pt;">Amt. alloc. to IRR within 5 years</span>
									<br/>
									<span style="font-size:6pt;width:35mm;padding-top:4mm;float:bottom;text-align:right;">
										<span style="font-size: 9pt;float:left;padding-left:1mm">$</span>
										<xsl:call-template name="PopulateAmount">
								...
								<span class="styIRS1099RleftBoxWithBottom" style="padding-left:2px;height:12.11mm;                                       width:49mm;border-right-width:0px">
									<span style="width:2px;"/>
							...
							<span class="styIRS1099RleftBoxWithBottom" style="padding-left:2mm;height:12.09mm;                                 width:98.04mm;">
							    ...
							    <tr>
							      <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
								      <tbody>
									    <xsl:if test="($Print != $Separated) or                 (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp) &lt;= 2)">
										  <tr>
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.9mm;                 border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;                 border-left:1px solid black"><!--valign="bottom">-->
								    ...
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.5mm;float:left;">
								      <tbody>
									    <xsl:if test="($Print != $Separated) or                 (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp) &lt;= 2)">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:5mm;width:31.5mm;                 border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;                 text-align:left" valign="bottom">&#160;
                                              <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp">
											    <xsl:choose>
											      <xsl:when test="position() = 1">
												    <xsl:call-template name="PopulateText">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;text-align:left;                 border-top:0px;width:31.5mm;font-size:6pt;border-bottom:1px solid black;                 border-right:1px solid black;" valign="bottom">&#160;
                                              <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp">
											    <xsl:choose>
												  <xsl:when test="position() = 2">
												    <xsl:call-template name="PopulateText">
								  ...
								  <!--<td colspan="3" class="styIRS1099R_tdRight">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25.53mm;float:left;">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or              (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp) &lt;= 2)">
										  <tr>
										    <td scope="col" style="font-size:6.5pt;height:3.5mm;border-left-width:0px;padding-bottom:0mm;                                               border-right:0px solid black;border-top:1px solid black;">
											  <span style="width:.2mm"/>
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4mm;font-size:6pt;                                               width:25.5mm;border-bottom:1px solid black;border-right:0px solid black;">
                                              <!--valign="bottom">-->
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.4mm;font-size:6pt;                 border-top:0px;width:25.5mm;border-right:0px solid black;                 border-bottom-width:1px solid black;" valign="bottom">
											  <span style="font-size:7.5pt;float:left;padding-left:.5mm">$</span>
											  <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp">
											    <xsl:choose>
												  <xsl:when test="position() = 2">
							    ...
							    <tr>
								  <td colspan="3" class="styIRS1099R_tdRight" style="border-top-width:0px">
								    <table cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or       (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp) &lt;= 2)">
									      <tr>
								    ...
								    <table cellpadding="0" cellspacing="0" style="width:31.5mm;float:left;">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or             (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp)                                         &lt;= 2)">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.5mm;                 border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;                 text-align:left" valign="bottom">&#160;
                                              <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
											    <xsl:choose>
												  <xsl:when test="position() = 1">
												    <xsl:call-template name="PopulateText">
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.4mm;width:31.5mm;                 font-size:6pt;border-bottom-width:1px solid black;border-right:1px solid black;                 text-align:left" valign="bottom">&#160;
                                              <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
	                                            <xsl:choose>
												  <xsl:when test="position() = 2">
												    <xsl:call-template name="PopulateText">
									    ...
									    <xsl:if test="($Print != $Separated) or             (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp)              &lt;= 2)">
										  <tr>
										    <!--<div class="GenericDiv">-->
										      <td scope="col" style="font-size:6.5pt;height:3.3mm;border-left-width:0px;padding-bottom:0mm;                   border-right:0px solid black;">
											    <span style="width:.5mm"/>
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.0mm;width:25.3mm;                 font-size:6pt;border-bottom:1px solid black;border-right:0px solid black;"> 
										      <!--valign="bottom">-->
										  ...
										  <tr>
										    <td class="styIRS1099RLNAmountBoxNLB" style="height:4.37mm;font-size:6pt;                 border-top:0px;width:25.3mm;border-bottom-width:1px solid black;                                               border-right:0px solid black;clear:none" valign="bottom">
											  <span style="font-size:7.5pt;float:left;padding-left:.5mm">$</span>
											  <xsl:for-each select="$Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp">
											    <xsl:choose>
												  <xsl:when test="position() = 2">
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
								      <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.9mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;               border-left:1px solid black">
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.9mm;               font-size:6pt;border-bottom:1px solid black;border-right:1px solid black;               border-left:1px solid black">&#160;
   									      </td>
									    </tr>
									  </tbody>
								    </table>
								  ...
								  <!--<td colspan="3" class="styIRS1099R_tdRight">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25.3mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:25.5mm;               font-size:6pt;border-bottom:1px solid black;border-right:0px solid black;">&#160;
										  </td>
									    </tr>
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;font-size:6pt;               border-top:0px;width:25.5mm;border-right:0px solid black;               border-bottom-width:1px solid black;">&#160;
                                          </td>
									    </tr>
									  </tbody>
								    </table>
								  ...
								  <td colspan="3" class="styIRS1099R_tdRight" style="border-top-width:0px">
								    <table cellpadding="0" cellspacing="0" style="width:31.5mm;float:left;">
									  <tbody>
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.5mm;               border-bottom:1px solid black;font-size:6pt;border-right:1px solid black;               text-align:left">&#160;
                                          </td>
									    </tr>
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:31.5mm;               font-size:6pt;border-bottom-width:1px solid black;border-right:1px solid black;               text-align:left">&#160;
                                          </td>
									    </tr>
									  </tbody>
								    </table>
							    ...
							    <tr>
								  <!--<td colspan="3">-->
								    <table border="0" cellpadding="0" cellspacing="0" style="width:25.5mm;float:left;">
									  <tbody>
									    <tr>
										  <td scope="col" style="font-size:6.5pt;border-left-width:0px;padding-bottom:0mm;width:35.5mm;               border-right:0px solid black;">
										    <span style="width:.2mm"/>
										    <span style="font-weight:bold">17 </span>
										    <span style="width:.5mm"/>
										    <span style="font-size:6pt">Local distribution  </span> 
									    ...
									    <tr>
										  <td class="styIRS1099RLNAmountBoxNLB" style="height:4.6mm;width:25.5mm;                                             font-size:6pt;border-top:0px;border-bottom-width:1px solid black;                                             border-right:0px solid black;">&#160;
										  </td>
									    </tr>
									  </tbody>
								    </table>
							  ...
							  <table width="31.9mm" border="0" cellpadding="0" cellspacing="0" style="float:left">
							    <tr>
								  <td colspan="3" class="styIRS1099R_tdRight">
								    <table border="0" cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
									  <tbody>
									    <xsl:if test="($Print != $Separated) or                 (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp) &gt;= 3)">
									      <tr>
										    <td scope="col" style="font-size:6.5pt;padding-bottom:0mm;border-right:1px solid black;                 border-left:1px solid black">
											  <span style="width:1mm"/>
											  <span style="font-weight:bold">12</span>
							  ...
							  <table width="31.9mm" border="0" cellpadding="0" cellspacing="0" style="float:left">
								<tr>
								  <td colspan="3" class="styIRS1099R_tdRight" style="border-top-width:0px">
									<table cellpadding="0" cellspacing="0" style="width:31.9mm;float:left;">
									  <tbody>
										<xsl:if test="($Print != $Separated) or              (count($Form1099RData/F1099RStateLocalTaxGrp/F1099RStateTaxGrp/F1099RLocalTaxGrp)                                         &gt;= 3)">
										  <tr>
											<td scope="col" style="font-size:7pt;padding-bottom:0mm;border-top:0px;                                               border-right:1px solid black;border-left:1px solid black">
											  <span style="width:1mm"/>
											  <span style="font-weight:bold">15</span>
					...
					<span style="float:left;">
						...
						<span style="width:40mm;font-size: 6pt;">IRS.gov/form1099r</span>
						</span>

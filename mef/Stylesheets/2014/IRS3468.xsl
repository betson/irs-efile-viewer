            ...
            Form <span class="styFormNumber">3468</span>
						...
						<div class="styTYBox" style="width:30mm;height:22.5mm;line-height:110%;padding-top:0mm;">
							...
							<div style="text-align:left;padding-left:3mm;">
								<div class="styTY" style="height:9.5mm;">20<span class="styTYColor">14</span>
								</div>
...
<!--						<div class="styLNRightNumBox" style="height:8mm;padding-top:4mm;">8</div>
				...
				<!-- Page Break and Footer-->
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3468</span> (2014)</div>
					</div>
...
treated as incurred, during the period on line 11b above
        ...
        Pre-1936 buildings located in the Gulf Opportunity Zone
								...
								<span style="float:left;">
									...
									<span style="width:16mm;padding-top:0mm;font-size:6.3pt;">x 13% (.13)</span>
								</span>
							</div>
						</div>
						<div style="float:left;clear:none;">
						...
						<div style="float:left;clear:none;">
							<div style="width:146mm;">
								...
								<span style="float:left;">
									...
									<span style="width:16mm;padding-top:0mm;font-size:6.3pt;">x 10% (.10)</span>
								</span>
							</div>
						</div>
						<div style="float:left;clear:none;">
						...
						<div style="float:left;clear:none;">
							<div style="width:146mm;">
								...
								<div class="styLNDesc" style="width:138mm;font-size:7pt;">
									...
									<span style="width:2mm;">$</span><!--border-botom-width:0px;;-->
									<span class="styUnderlineAmount" style="float:none;width:32mm;padding-top:0px;padding-bottom:0px;"><!--height:3.5mm;-->
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form3468Data/GthrmlAndSolarEgyPropBssAmt"/>
										</xsl:call-template>
									</span>
									<span style="width:19mm;padding-top:0mm;padding-left:1mm;font-size:6.3pt">x 10% (.10)</span>
								</div>
							</div>
						</div>
						<div style="float:left;clear:none;">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
 						...
 						<span style="width:16px;"/>.
									...
									<span style="width:19mm;padding-top:0mm;padding-left:1mm;font-size:6.3pt">x 30% (.30)</span>
								</div>
							</div>
						</div>
						<div style="float:left;clear:none;">
            ...
            <!--Dotted Line-->
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText" style="font-size:8pt;">3468</span> (2014)</div>
					</div>
					<div style="width:187mm;padding-top:1mm;">
               Form 3468 (2014)
                          <span style="width:150mm;"/>
            ...
            Enter the smaller of line 12o or $4,000
					...
					<div style="width:187mm;">
						<div style="float:right;" class="styGenericDiv">Form
					       <span class="styBoldText" style="font-size:8pt;">3468</span> (2014)</div>
					</div>

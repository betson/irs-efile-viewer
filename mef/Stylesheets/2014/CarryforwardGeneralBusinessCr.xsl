    ...
    <table id="CFGBTbl" class="styDepTbl">
      <thead class="styDepTableThead">
        <tr class="styDepTblHdr" style="width:70mm;">
           ...
           <th class="styDepTblCell" scope="col" style="width:116mm;">Carry Amount Allowed</th>
        </tr>
      </thead>
      <tfoot/>
      <tbody>
    ...
    <xsl:call-template name="AddOnStyle"/>    
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine"><span class="styTopSectionLineLbl" style="vertical-align:top;">The Tax Year the Credit Originated:</span>
          <xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$DependencyData/CreditOriginatedTaxYr"/></xsl:call-template>
        </div>

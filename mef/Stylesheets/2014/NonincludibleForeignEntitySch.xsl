...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Start Dep -->
  <xsl:param name="DependencyData" select="$RtnDoc/NonincludibleForeignEntitySch"/>
  <!-- Share Common Dependency - Nonincludible Foreign Entity Schedule -->
  <xsl:param name="depDocTitle">
    <xsl:call-template name="PopulateDisplayName">
      <xsl:with-param name="TargetNode" select="$DependencyData"/>
    </xsl:call-template>
  </xsl:param>
  <xsl:template name="NonincludibleForeignEntitySchTemp2">
    <table id="NonincludibleForeignEntitySchTbl2" class="styDepTblLandscape" style="font-size: 8pt">
      ...
      <tfoot/>
      <tbody>
        <xsl:for-each select="$DependencyData/NonincludibleForeignEntityGrp">
          <!-- set row background -->
          <tr>
            ...
            <!-- EIN - Column 2 -->
            <td class="styDepTblCell" style="width: 30mm; text-align:center;padding-top:5mm">
            ...
            <td class="styDepTblCell" style="width:30mm; text-align:right;padding-top:5mm">
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="NonincludibleForeignEntitySchTemp2"/>
        <br/>
      </body>
    </html>
  </xsl:template>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
				<form name="Form7004">
					...
					<div class="styBB" style="width:187mm;height: 22.5mm">
						<div class="styFNBox" style="height:22.5mm; width:33mm;font-size: 9pt;padding-top:2mm;">Form <span class="styFormNumber">7004</span>
							<br/>
     		...
     		(Rev. December 2012)</span>
						...
						<div class="styFTBox" style="width:123mm; height: 22.4mm">
							<div class="styMainTitle" style="font:11pt;font-weight:bold">
        Application for Automatic Extension of Time To File <br/>
	    Certain Business Income Tax, Information, and Other Returns<br/>
							</div>
							<div class="styMainTitle" style="font:7pt;font-weight:normal;padding-top:3mm">
								<div class="styFBT" >
									<img src="{$ImagePath}/5471_Bullet_Title.gif" alt="bullet"/>
 File a separate application for each return.
 <br/>
									<img src="{$ImagePath}/5471_Bullet_Title.gif" alt="bullet"/>
 Information about Form 7004 and its separate instructions is at <a href="http://www.irs.gov/form7004">
             <i>www.irs.gov/form7004.</i></a>
    </div>
							</div>
						</div>
						<div class="styTYBox" style="width:31mm; height: 22.4mm">
 ...
 <span class="styItalicText" style="font-size:6pt;">File request for extension by the due date

  ...
  <xsl:template name="OtherClaimsStatementTemp">
    ...
    <table id="GeneralDependencyTbl" class="styDepTbl">
      <tr class="styDepTblHdr">
         ...
         <th class="styDepTblCell" style="width:40mm;">CRN</th>
      </tr>
      <xsl:for-each select="$DependencyData/OtherClaimsStmtDetail">
        <tr>
      ...
      <tr class="styDepTblHdr">
        <td class="styDepTblCell" style="width:55mm;text-align:center;font-weight:bold;border-top-width:2px"><br/>Total Number of Gallons</td>
        ...
        <td class="styDepTblCell" style="width:20mm;text-align:center;font-weight:bold;border-top-width:2px"><br/>Total Tax Amount</td>

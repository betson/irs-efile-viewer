...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="FormTitleText">
		<xsl:choose>
			  <xsl:when test="$SubType='940' and $Language='ENGLISH'">940 for 2014:</xsl:when>
			  <xsl:when test="$SubType='940PR' and $Language='ENGLISH'">&lt;span style="font-size:9pt;"&gt;940-PR (Eng) for 2014:&lt;/span&gt;</xsl:when>
			  <xsl:when test="$SubType='940' and $Language='SPANISH'">940 para 2014:</xsl:when>
			  <xsl:when test="$SubType='940PR' and $Language='SPANISH'">940-PR para 2014:</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="ReturnTypeCText">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">No payments to employees in 2014</xsl:when>
			  <xsl:otherwise>Ning&amp;#250;n pago hecho a los empleados en 2014</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="ReturnTypeInstructionsText">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Instructions and prior-year forms are available at </xsl:when>
	...
	<xsl:variable name="Part2Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Determine your FUTA tax before adjustments for 2014. If any line does NOT apply, leave it blank.</xsl:when>
			  <xsl:otherwise>&lt;span style="font-size:7pt;"&gt;Determine su contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; sin considerar ajustes para 2014. Si NO le corresponde una línea, d&amp;#233;jela en blanco.&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
...
en las instrucciones del Formulario 940, en ingl&amp;#233;s. Anote la cantidad de la l&amp;#237;nea &lt;b&gt;7&lt;/b&gt; de la hoja de trabajo.</xsl:otherwise>
	...
	<xsl:variable name="Part4Text">
		<xsl:choose>
			  <xsl:when test="$Language='ENGLISH'">Determine your FUTA tax and balance due or overpayment for 2014. If any line does NOT apply, leave it blank.</xsl:when>
			  <xsl:otherwise>Determine su contribuci&amp;#243;n &lt;i&gt;FUTA&lt;/i&gt; y saldo adeudado o cantidad pagada en exceso para 2014. Si NO le corresponde una línea, d&amp;#233;jela en blanco.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
			...
			<body class="styBodyClass" >
				<form name="Form940">
                    ...
                    <div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styBB" style="float:left;border:black solid 1px; padding-top:2mm; padding-left:2mm; padding-right:2mm;font-size:6pt;">
							<div style="width:118mm;padding-top:0mm;">
								<span style="float:left;">
									<b><xsl:value-of disable-output-escaping="yes" select="$EINText" /></b>
								</span>
							...
							<div style="width:118mm;padding-bottom:2mm;padding-top:2mm;">
								<span style="float:left;padding-top:3mm;">
							...
							<div style="width:118mm;padding-bottom:0mm;">
								<span style="float:left;padding-top:3mm;font-weight:bold;height:15mm;">
								...
								<span style="float:right;">
									...
									<span style="width:103mm;font-size:5pt;vertical-align:middle;padding-left:1mm;">
										...
										<span style="width:33mm;text-align:center;">
											<xsl:value-of disable-output-escaping="yes" select="$ForeignProvinceText" />
										</span>
										<span style="width:2mm;"/>
										<span style="width:27.6mm;text-align:center;">
						...
						<div style="float:right;">
							<div class="styBB" style="width:auto;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;padding-right:3mm;">
								<div class="styPartName" style="width:53mm;text-align:left;padding-left:1mm;padding-top:0.5mm;padding-bottom:0.8mm;padding-right:0.6mm;">
								...
								<div style="width:52mm;padding-bottom:0.8mm;float:none;clear:both;">
									...
									<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form940" title="Link to IRS.gov"><i>www.irs.gov/form940</i>.</a><br/>  
								</div>
							</div>
						</div>
					</div>						
					...
					<div style="width:187mm;padding-left:0mm;padding-top:2mm;padding-bottom:0px;">
						...
						<div class="styBB" style="width:187mm;border-top-width:1px;">
							<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:{$Part45Height}mm;padding-top:0mm;">
								<xsl:value-of disable-output-escaping="yes" select="$PartText" /> 4:
							</div>
							<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:{$Part45Height}mm;padding-top:0mm;padding-left:2mm;font-size:7.5pt;">
						...
						<div style="width:187mm;">
							...
							<span style="float:right;">
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<div style="width:30mm;text-align:right;padding-bottom:0mm;float:right;">
											<img src="{$ImagePath}/940SSPR_NextES.png" alt="Next Page Arrow Image"/>
										</div>
									</xsl:otherwise>
								</xsl:choose>
							</span>
					...
					<div style="width:187mm;">
						...
						<div class="styBB" style="width:187mm;font-size:7pt;border-top-width:2px;">
							...
							<b><xsl:value-of disable-output-escaping="yes" select="$EIN2Text" /></b><br/>
					...
					<!--Part 5-->
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						<div class="styPartName" style="width:{$PartNameWidth}mm;text-align:center;height:{$Part45Height}mm;padding-top:{$Part5Padding}mm;">
							<xsl:value-of disable-output-escaping="yes" select="$PartText" /> 5:
						</div>
						<div class="styPartDesc" style="width:{$PartDescWidth}mm;text-align:left;height:{$Part45Height}mm;padding-top:0mm;padding-left:2mm;">

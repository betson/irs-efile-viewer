...
<div class="stySmallText" style="width:40mm;">Cat. No. 11862M
						...
						<div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">2441</span> (2014)
        </div>
					</div>
					<!--End Footer-->
					<!-- Page Header -->
					<div style="width:187mm;padding-top:0.5mm;">
						<div style="float:left;">Form 2441 (2014)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;clear:all;">
						...
						you received in 2014. Amounts you<br/> received as an employee should be shown in box 10 of your Form(s) W-2. 
			...
			If you were self-employed or a partner, <br/> include amounts you received under a dependent care assistance program from your sole<br/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;">Enter the amount, if any, you carried over from 2013 and used in 2014 during the grace<br/> period. See instructions
       			 <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:16px"/>.
                                    <span style="width:16px"/>.
...
<div class="styLNRightNumBox" style="height:8.5mm;border-right-width:0px;padding-top:5mm;">13                    
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;">Enter the amount, if any, you forfeited or carried forward to 2015. See instructions
       			 <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:16px"/>.
                                    <span style="width:16px"/>.          
  ...
  All others, enter the amount from line 18.
      ...
      <div class="styLNRightNumBoxNBB" style="height:6mm;border-right-width:0px;background-color:lightgrey;border-top-width:1px;border-top-width:0px;"/>
					...
					<div style="width:187mm;">
						...
						You cannot take the credit. <br/><b>Exception.</b> If you paid 2013 expenses in 2014, see the instructions for line 9
       			 <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:16px"/>.
                                    <span style="width:16px"/>.

...
<!-- change -->    
  <xsl:param name="Form990DepsData" select="$RtnDoc/OtherNotesLoansRcvblShortSch" />
<!-- end change -->
...
<!-- change -->    
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Category/Name</th>
        <th class="styDepTblCell" scope="col" nowrap="nowrap">Amount</th>
      </tr>          
      <xsl:for-each select="$Form990DepsData/OtherNotesLoansRcvblShort">
<!-- end change -->
        <tr>
...
<!-- change -->    
          <td class="styDepTblCell" style="text-align:left">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="CategoryName" /></xsl:call-template>             
          </td>                                    

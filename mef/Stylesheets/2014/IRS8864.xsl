			...
			<body class="styBodyClass">
				<form name="Form8864" id="Form8864">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:29mm;height:21.5mm;">
						...
						<div class="styFTBox" style="width:127mm;height:13mm;">
							...
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:3mm;">
								<img src="{$ImagePath}/8864_Bullet_Line.gif" width="4" height="7" alt="Bullet Image"/>
								 ...
								 <br/>
								<img src="{$ImagePath}/8864_Bullet_Line.gif" width="4" height="7" alt="Bullet Image"/>
								 Information about Form 8864 and its separate instructions is at 
								<a href="http://www.irs.gov/form8864" title="Link to IRS.gov">
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="width:138.75mm;height:4mm;font-size:2.5mm;">
							<span style="float:left">Add lines 1 through 7. Include this amount in your income for 2014 (see instructions)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right: 2mm;">......</span>
						</div>
					...
					<div style="width:187mm;font-size:8pt;border-top-width:1px">
						...
						<div style="float:right">
							<span style="margin-right:32mm; font-size:7pt">Cat. No. 25778F</span>Form <b>8864</b> (2014)
                        </div>
					</div>

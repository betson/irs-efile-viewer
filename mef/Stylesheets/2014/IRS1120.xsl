	...
	<html lang="EN-US">
	  ...
	  <body class="styBodyClass">
		  ...
		  <div class="styBB" style="width:187mm;float:left;clear:left;border-bottom-width:.5mm">
			<div style="width:31mm;height:29mm;float:left;clear:left;">
			  ...
			  <div class="styComType" style="width:33mm;border-bottom:0px;border-right-width:1px;">
				...
				<div class="styBoldText" style="height:5mm;width:4mm;float:left;clear:none;">4</div>
			...
			<div style="width:154mm;height:29mm;float:left;">
			  ...
			  <div class="styLblNameAddr" style="width:106mm;height:24mm;">
				<div class="styUseLbl" style="width:12mm;height:24mm;border-right-width:0px;padding-top:40px;">TYPE OR PRINT </div>
			  ...
			  <div style="width:145mm; height:4mm;">
        ...
        <span class="styIRS1120VTImageBox" style="width:6mm;height:59mm;padding-top:23mm;text-align:center;">
		  ...
		  <div class="styBB" style="width:187mm;">
			<div class="styIRS1120VTImageBox" style="width:6mm;height:31.5mm;text-align:">
		  ...
		  <div style="width:187mm;">
			...
			<!-- BEGIN Schedule K Title -->
			  <div class="styBB" style="width:187mm;border-top-width:1px;">
					...
					<div style="height:4mm;width:164mm;" class="styPartDesc">Other Information
						<span class="styNormalText">continued (see instructions)</span>
					</div>
			  </div>
		  ...
		  <div style="width:187mm;clear:both;" class="styBB">
			...
			<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
			  <tr class="styGenericDiv">
				...
				<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;border-bottom:1 solid black;border-bottom-width:1px;">
				  <xsl:call-template name="PopulateAmount">
			  ...
			  <tr class="styGenericDiv">
				...
				<td class="styLNAmountBoxNBB" style="height:5mm;border-right-width:1px;">
				  <!--<xsl:call-template name="PopulateAmount">

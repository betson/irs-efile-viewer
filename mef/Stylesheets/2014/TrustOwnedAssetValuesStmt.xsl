					...
					<tr>
						...
						<td class="styDepTblCell" style="text-align:left;width:40mm;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="TrustNm/BusinessNameLine1Txt"/>
							</xsl:call-template>
							<xsl:if test="TrustNm/BusinessNameLine2Txt">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="TrustNm/BusinessNameLine2Txt"/>
								</xsl:call-template>
							</xsl:if>
						</td>

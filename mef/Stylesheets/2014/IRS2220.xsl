...
<br/>
					...
					<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
						<div class="styBB" style="width:187mm;">
							<b>Note: </b> <i> Generally, the corporation is not required to file Form 2220 (see Part II below for
...
<b>Caution: <i>
 If the tax is zero or the tax year was for less than 12 months, skip this line and enter the amount from line 3 on line 5 
</i>
								</b>
								<!--Dotted Line -->
								<span class="styDotLn" style="float:right;">..............................</span>
...
<b> must </b> file Form 2220 even if it does not owe a penalty (see instructions).
						</div>
					</div>
					<!-- END PART II TITLE -->
					<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:178mm;">
								<input type="checkbox" class="styCkbox" alt="Form 2220, line 6 checkbox">
...
The corporation is using the adjusted seasonal installment method.
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:178mm;">
								<input type="checkbox" class="styCkbox" alt="Form 2220, line 7 checkbox">
									<xsl:call-template name="PopulateCheckbox">
...
The corporation is using the annualized income installment method.
						...
						<div class="styBB" style="width:187mm;height:6mm;">
							...
							<div class="styLNDesc" style="width:178mm;">
								<input type="checkbox" class="styCkbox" alt="Form 2220, line 8 checkbox">
									<xsl:call-template name="PopulateCheckbox">
...
amounts to enter.  If none of these boxes are checked, enter 25% of line 5 above in each column
							<!--Dotted Line -->
								<span class="styDotLn" style="float:right;">......</span>
							</div>
								...
								<xsl:for-each select="$Form2220Data/PaymentPenaltyComputationTxt">
									...
									<xsl:if test="position() mod 4 = 1">
										...
										<div class="styBB"  style="border-bottom:0;border-top-width:1px;width:186.5mm; float:none; clear:both;">
											...
											<div style="width:187mm;">
												<div class="styLNLeftNumBox" style="height:16mm;">19</div>
												<div class="styIRS2220LNDescTbl" style="height:16mm;">
Enter the date of payment or the 15th day of the 3rd month after the close of
the tax year, whichever is earlier (see instructions).  <b>
														<i>(Form 990-PF and Form 990-T filers: </i>
													</b>
Use 5th month instead of 3rd month.)
											<!--Dotted Line -->
													<span class="styDotLn" style="float:right;">....</span>
												</div>
												<div class="styLNRightNumBox" style="height:16mm;padding-top:12mm;">19</div>
												<div class="styIRS2220Part3LNCell" style="height:16mm;padding-top:12mm;text-align:center;">
													<xsl:call-template name="PopulateMonthDayYear">
...
<span class="styDollarSpan"/>
											...
											<div style="width:187mm;">
												...
												<div class="styIRS2220LNDescTbl" style="height:8mm;">
Number of days on line 20 after 6/30/2015 and before 10/1/2015
											<!--Dotted Line -->
													<span class="styDotLn" style="float:right;">.......</span>
												</div>
...
-->
								<!--Line 38 -->
<!--								<div class="styBB" style="width:187mm;">
									<div class="styLNLeftNumBox" style="height:8mm;">38</div>
...
<span style="float:left;">comparable line for other income tax returns</span>
									...
									<div class="styLNRightNumBoxNBB" style="height:8mm;width:8mm;padding-top:4mm;">38</div>
									<div class="styIRS2220Part3LNCell" style="Border-bottom:0;height:8mm;padding-top:4mm;">
$
<span class="styDollarSpan"/>
										<xsl:call-template name="PopulateAmount">
...
<span class="styTableCellPad"/>
								...
								<div style="width:187mm;">
									<div class="styLNLeftNumBox" style="height:16mm;">19</div>
									<div class="styIRS2220LNDescTbl" style="height:16mm;">
Enter the date of payment or the 15th day of the 3rd month after the close of the tax year, whichever is earlier (see instructions).
<b>
											<i>(Form 990-PF and Form 990-T filers:</i>
										</b> Use 5th month instead of 3rd month.)
								<!--Dotted Line -->
										<span class="styDotLn" style="float:right;">.....</span>
									</div>
									<div class="styLNRightNumBox" style="height:16mm;padding-top:12mm;">19</div>
...
You can also call 1-800-829-4933 to get interest rate information.
					...
					<p style="page-break-after: always">
						<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
							<div style="float:right;">
								<span style="width:80px;"/> Form <span class="styBoldText">2220 </span> (2014)
							</div>
						</div>
					</p>
					<!--End Page 2 Footer -->
					...
					<p style="page-break-before: always"/>
							<div style="float:left;">Form 2220 (2014)<span style="width:148mm;"/>
						</div>
...
net passive income or the amount on which tax is imposed under section 1374(a), whichever applies. </i>
						...
						<div class="styBB" style="width:187mm;height:7mm;">
							<div class="styPartName" style="height:3.5mm;">Part I</div>
							<div class="styPartDesc" style="padding-left:1mm;float:left;clear:none;font-weight:normal;">
								<b>Adjusted Seasonal Installment Method (Caution:</b>
								<i> Use this method only if the base period percentage for any 6 consecutive months is at least 70%. See instructions.) </i>
							</div>
						</div>
						<!--a, b, c, d header Line -->
						<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
...
enter the amount from line 10, column (d) 
						...
						<div class="styBB" style="width:187mm;border-bottom-width: 0px;">
							...
							<div class="styIRS2220LNDescTbl" style="height:8mm;width:73mm;border-bottom-width: 0px;">
Enter any alternative minimum tax for each payment period (see instructions) 
							<!--Dotted Line -->
								<span class="styDotLn" style="float:right;">..........</span>
							</div>
...
(2014)
					...
					<p style="page-break-before: always">
						<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
							<div style="width:187mm;padding-top:.5mm;">
								<div style="float:left;">Form 2220 (2014)<span style="width:148mm;"/></div>

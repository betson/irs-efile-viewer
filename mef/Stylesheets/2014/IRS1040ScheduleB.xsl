         ...
         Internal Revenue Service (99)
						...
						<div class="styFTBox" style="width:127mm;height:18.2mm; ">
							...
							<div class="styFBT" style="height:3mm;margin-top:3mm;font:size:6pt;width:127mm;">
								<img src="{$ImagePath}/1040SchB_Bullet.gif" alt="Bullet Image"/> Attach to Form 1040A or 1040.
       <br/>
								<img src="{$ImagePath}/1040SchB_Bullet.gif" alt="Bullet Image"/>  Information about Schedule B (Form 1040A or 1040) and its instructions is at www.irs.gov/scheduleb.       
        </div>
						</div>
            ...
            Your social security number<br/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div  style="width:187mm;">
							<div style="width:25mm;float:left;clear:none;border-bottom-width: 0px;">
								<div class="styFMT" style="font-size:12pt;height:7mm;font-family:Arial;">Part l 
									<br/>Interest
                                </div>
                ...
                on back and the<br/>
								...
								<div id="part1ContainerId" class="stySchBLn1TblContainer" style="width:161.5mm;float:right">
									...
									<table class="styTable" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends " name="INORDtable" id="INORDtable">
										...
										<tr>											
											...
											<th class="styTableCell" scope="col" rowspan="2" style="width:118.4mm;border-bottom-width:0px;text-align:left;">
                        ...
                        List name of payer. If any interest is from a seller-financed mortgage and the
                          ...
                          interest first. Also, show that buyer&apos;s social security number and address
											...
											<th class="styTableCell" scope="col" rowspan="1" style="height:4mm;width:31mm;border-right:0px solid black;
											  border-left:0px solid black;border-bottom:1px solid black;vertical-align:bottom;text-align:center;">
												<div class="styBB" style="font-size:7pt;width:100%;border-left:0px solid black;border-right:0px solid black;
												   border-bottom:0px solid black;">              Amount
												</div>												
											</th>
										</tr>
										<tr>
											<th class="styTableCell" scope="col" rowspan="1" style="height:4mm;width:31mm;border-right:0px solid black;
											  border-left:0px solid black;text-align:center;border-bottom:0px solid black;">
										...
										<tbody>
											<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartIGroup1) &lt; 14) ">
												<xsl:for-each select="($FormData/Form1040SchBPartIGroup1) ">
													<tr>
														<!-- Column 1 -->
														<td class="styTableCell" style="font-size:7pt;width:4mm;height:4mm;border-right-width:0px;border-bottom-width:1px;">
														</td>
														<!-- Column 2 -->
														<td class="styTableCell" style="width:118.4mm;height:4mm;text-align:left;border-top-width:1px;
                               ...
                               ,								<span style="width:1mm;">
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup1) &lt; 5 or ((count($FormData/Form1040SchBPartIGroup1) &gt; 14) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:118.4mm;height:4mm;float:left;clear:none;border-right-width:1px;
													  border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
														</span>
													</td>
								...
								<br/>-->
								<!--End of toggle-->
								<div class="stySchBLn2TblContainer" id="part2ContainerId" style="width:161.5mm;float:right">
								<!-- print logic -->
									<xsl:call-template name="SetInitialState"/>
									<table class="styTable" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends " id="PAYORTable" name="PAYORtable">
										<thead class="styTableThead">
											...
											<th class="styTableCellHeader" scope="col" rowspan="1" style="width:118.4mm;height8mm;text-align:left;
                  ...
                  Payer
											...
											<th class="styTableCellHeader" scope="col" rowspan="1" style="text-align:center;width:31mm;height:8mm;border-left-width:0px;
											  border-right-width:0px;border-bottom:1px solid black;vertical-align:bottom;">
						...
						<!-- Line 2 -->
						<div class="styBB" style="width:161.5mm;border-bottom-width: 0px;float:right;clear:both;">
							<div class="styLNLeftNumBox" style="width:4.6mm;border-left:0px solid black;border-right:0px solid black;">2</div>
							<div class="styLNDesc" style="width:117.5mm;padding-left:1mm;">
								<span style="float:left;clear:none;">Add the amounts on line 1</span>
								<span class="styDotLn" style="padding-left:4mm;">..................</span>
							</div>
							<div class="styLNRightNumBox" style="border-top-width:0px;width:7.85mm;border-bottom-width: 1px;
							  border-left:1px solid black;border-right:1px solid black;">
                                    2
							   </div>
							<div class="styLNAmountBox" style="width:31.4mm;padding-right:0mm;border-top-width:1px;border-bottom-width: 1px;
						...
						<div class="styBB" style="width:161.5mm;border-bottom-width: 0px;padding-bottom:0mm;float:right;clear:both;">
							<div class="styLNLeftNumBox" style="width:4.6mm;">3</div>
							<div class="styLNDesc" style="width:117.5mm;padding-left:1mm;float:left;clear:none">
							...
							<div class="styLNRightNumBox" style="height:8mm;width:7.85mm;padding-top:4.8mm;border-right:1px solid black;">
                                      3
							</div>
							<div class="styLNAmountBox" style="height:8mm;width:31.4mm;padding-top:4.8mm;border-left:0px solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/ExcludableSavingsBondIntAmt"/>
					...
					<!-- Line 4 -->
					<div style="width:161.5mm;padding-top:0mm;border-bottom-width:0px;float:right;">
						<div class="styLNLeftNumBoxBB" style="width:4.6mm;height:8mm;border-bottom-width:1px;text-align:left;">4</div>
						<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:117.5mm;padding-left:1mm;border-bottom-width:1px;height:8mm;">
						...
						<div class="styLNRightNumBox" style="border-bottom-width:1px;width:7.85mm;height:8mm;padding-top:4mm;
						  border-right:1px solid black;">
                                  4
					    </div>
					...
					<!-- end line 4 -->
					<!-- Line 4 note -->
					<div class = "styBB" style="width:187mm;padding-bottom:0mm;border-bottom-width:1px;float:left;clear:none;"> 
						<!--<div class="styLNLeftNumBoxBB" style="padding-left:3mm;width:1mm;border-bottom-width:0px;border-top-width:0px;"></div>-->
						<div class="styLNLeftNumBoxBB" style="padding-left:26mm;width:8.8mm;height:5mm;border-bottom-width:1px;text-align:left;">
					  	  Note.</div>
							<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:114mm;padding-left:1mm;border-bottom-width:1px;height:5mm;">
								If line 4 is over $1,500, you must complete Part lll.
                            </div>
							<div class="styLNRightNumBox" style="border-bottom-width:1px;width:7.9mm;height:5mm;border-right:1px solid black;">          
                            </div>
							<div class="styLNAmountBox" style="border-bottom-width:1px;width:31.4mm;height:5mm;padding-bottom:0mm;
							  font-size:8pt;text-align:center;font-weight:bold;border-left:0px solid black;">
                ...
                on back and the<br/>
                  ...
                  on that form.
									...
									<table class="styTable" cellspacing="0" width="100%" style="font-size:7pt;padding-top:mm;" summary="Table displaying Ordinary Dividends" name="ODtable" id="ODtable">
										<thead class="styTableThead">
											<tr>
												...
												<th class="styTableCellHeader" scope="col" rowspan="1" style="width:119.2mm;border-right-width:1px;text-align:left;">
                        ...
                        List name of payer
												...
												<th class="styTableCellHeader" scope="col" rowspan="1" style="width:6.9mm;border-right-width:1px;border-bottom-width:0px;border-left:1px solid black;border-right:1px solid black;">
													<!-- uncomment and change table header literals here or use 'cellpad' -->
													<span class="styTableCellPad">
                        </span>
												</th>
												<th class="styTableCellHeader" scope="col" rowspan="1" style="width:31mm;border-bottom-width:1px;border-right-width:0px;border-top-width:1px;">
										...
										<tbody>
											<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartII) &lt;= 19) ">
												<xsl:for-each select="$FormData/Form1040SchBPartII">
													<tr>
														...
														<!-- Column 2 -->
														<td class="styTableCellText" style="width:119.2mm;height:4mm;font-size:7pt;border-right-width:1px;text-align:left;border-bottom:1px dashed black;">
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 1 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:31mm;height:4mm;float:left;clear:none;border-right-width:0px;border-bottom:1px solid black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
												</tr>
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 3 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:118.4mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom-width:1px;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:6.8mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom-width:0px;border-left:1px solid black;border-right:1px solid black;">
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 4 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr>
													...
													<td class="styTableCell" style="width:118.4mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:6.8mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom-width:0px;border-left:1px solid black;border-right:1px solid black;">
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 18 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												...
												<tr>
													<td class="styTableCell" style="width:6mm;height:7mm;float:left;clear:none;border-right-width:0px;border-bottom-width:0px;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:118.4mm;height:7mm;float:left;clear:none;border-right-width:1px;border-bottom:0px solid black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:6.8mm;height:7mm;float:left;clear:none;border-bottom-width:1px;border-left:1px solid black;border-right:1px solid black;border-bottom:0px solid black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:31mm;height:7mm;float:left;clear:none;border-right-width:0px;border-bottom:0px solid black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
												</tr>
								...
								<div style="border-bottom-width: 0px;width:187mm;">
									...
									<div class="styLNLeftNumBoxBB" style="padding-left:0mm;width:4mm;height:5mm;border-bottom-width:0px;
									  padding-bottom:3.3mm;border-top-width:0px;">6</div>
									<div class="styLNLeftNumBoxBB" style="width:116.2mm;padding-left:1mm;height:5mm;font-weight:normal;
									  border-bottom-width:0px;border-top-width:0px;padding-top:0mm;">
									...
									<div class="styLNRightNumBox" style="padding-top:3.2mm;border-bottom-width:0px;width:7.81mm;height:5mm;
									  border-top-width:0px;border-left:1px solid black;border-right:1px solid black;">
									  6
									</div>
									<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;height:5mm;padding-top:3.2mm;border-left:0px solid black;">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="styBB" style="width:187mm;float:left;clear:none;padding-bottom:0mm;border-bottom-width:1px;border-top-width:0px;">
										...
										<div class="styLNLeftNumBoxBB" style="padding-left:0mm;width:3mm;border-bottom-width:0px;"></div>
										<div class="styLNDesc" style="border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; 
										  border-left-width: 0px; border-right-width: 0px;width:120mm;">
											<span style="padding-right:2mm;float:left;clear:none;border-top-width:1px;">
												<span class="styBoldText">Note.</span> If line 6 is over $1,500, you must complete Part III.</span>
										</div>
										<div class="styLNRightNumBox" style="border-left-width:0px;border-bottom-width:0px;width:7.9mm;border-top-width:1px;">
										</div>
										<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;border-left-width:0px;border-top-width:1px;">
										</div>
									</div>
								</div>
								<!-- end Line 6 note -->
                ...
                You must complete this part if you<span class="styBoldText"> (a) </span>had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
							...
							<div class="styGenericDiv" style="padding-top:0mm;width:158mm;border-bottom-width:0px;height:10mm">
								...
								<div class="styLNDesc" style="width:135mm;height:10mm;">
									<span style="float:left;clear:none;">
										At any time during 2014, did you have a financial interest in or signature authority over a financial account (such as a bank account, securities account, or brokerage account) located in a foreign country?  See instructions
									   <xsl:call-template name="LinkToLeftoverDataTableInline">
							...
							<div class="styBB" style="padding-top:0mm;width:158mm;float:left;clear:none;border-bottom-width: 0px;padding-bottom:0mm;">
								...
								<div class="styBB" style="width:17mm;float:left;clear:none;border-bottom-width:0">
									<div class="styBB" style="float:left;clear:none;height:7mm;width:8.5mm;border-left-width:1px;border-bottom-width:0px;">
										<span style="padding-left:2mm;">
											<xsl:call-template name="PopulateYesBoxText">
					...
					<div style="width:187mm; border-top:1 solid black;border-top-width:1px;">
						...
						<div style="float:right;" class="styGenericDiv">
							<b>Schedule B (Form 1040A or 1040) 2014</b>
						</div>
					</div>
					<!-- end page 2 footer -->
					<br/>

          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styFNBox" style="width:30mm;height:20.7mm;">
              ...
              <div style="padding-top:0mm;">
                <span class="styAgency">(Rev. August 2014)</span><br/>
        ...
        <div class="styFTBox" style="width:125mm;height:12mm;">
          <div class="styMainTitle" style="height:8mm;padding-top:2mm;">
            Low-Income Housing Credit          
              ...
              <br/>
               <img src="{$ImagePath}/8586_Bullet_Title.gif" width="4" height="7" alt="Arrow Bullet"/>
		...
		<xsl:call-template name="PopulateReturnHeaderFiler">
          ...
          <div style="width:187mm">
              ...
              <div class="styLNDesc" style="width:139mm;">
                ...
                <span style="float:left;">this amount on Schedule K. All others, stop here and report this amount on Form 3800, 
                <span style= "float:left;">Part III, line 1d, column (c)</span>
                    <!--Dotted Line-->
                    <span style="letter-spacing:4mm;font-weight:bold;float:right;padding-right:1mm;skiplink:display:none;">.....................</span>
                </span>
              </div>
              <div class="styLNRightNumBox" style="height:11mm;padding-top:7mm;">5</div>
          ...
          <div style="width:187mm">
              ...
              <div class="styLNDesc" style="width:139mm;">
                ...
                <span style="float:left;">report this amount on Schedule K. All others, stop here and report this amount on Form 3800,
                <span style= "float:left;">Part III, line 4d, column (c)</span>
                    <!--Dotted Line-->
                    <span style="letter-spacing:4mm;font-weight:bold;float:right;padding-right:1mm;skiplink:display:none;">.....................</span> 
                </span>
            </div>
              <div class="styLNRightNumBox" style="height:11mm;padding-top:7mm;">12</div>
              <div class="styLNAmountBox" style="height:11mm;padding-top:7mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm">
              ...
              <div class="styLNRightNumBox" style="height:11mm;padding-top:7mm;">14</div>
              <div class="styLNAmountBox" style="height:11mm;padding-top:7mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="border-top:1 solid Black; font-size:7pt; width:187mm">
            ...
            <div style="float:right">
              ...
              <span style="width:45mm"/>
                Form <b style="font-size:9pt">8586</b> Rev. (8-2014)
            </div>
          </div>

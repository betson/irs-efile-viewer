...
<!-- Last Modified by Andrew Werner on 8/18/2011 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
				...
				<form name="Form1040 Schedule SE" style="font-size:7pt;">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styBB" style="width:102mm;height:8mm;border-bottom-width:0px">
							<div class="styNameBox" style="width:110mm;height:6mm;font-size:7.0pt;font-weight:normal;">
								Name of person with <b>self-employment</b> income <span style="font-size:6.3pt;">(as shown on Form 1040 or Form 1040NR)</span><br/>
							</div>
							<div class="styNameBox" style="width:110mm;height:1.9mm;padding-bottom:.7mm;font-size:7pt">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleSEData/PersonNm"/>
								</xsl:call-template>
							</div>
						</div>
						<div class="styEINBox" style="width:47mm;height:7.9mm;padding-left:2mm;font-size:7pt;        border-right-width:1px;padding-top:1mm;font-weight:normal;border-bottom-width:0px">
							Social security number of person with <b>self-employment </b>income
							<img src="{$ImagePath}/1040SchSE_Bullet_Md.gif" alt="MediumBullet"/>
						</div>
						<div class="styLNAmountBox" style="height:10mm;width:30mm;border-bottom-width:0px;        text-align:center;padding-top:5mm">
		...
		<div class="styBB" style="width:187mm;border-width:0px;">
         ...
         <!--Flowchart-->
        <div class="styGenericDiv" style="width:187mm;padding-top:2mm;clear:all;">
			<!--Start of first row-->
        ...
        <!--End of Flowchart--> 
         <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;">
               ...
               <div class="styLNRightNumBox" style="height:6mm;padding-top:3.4mm;                  border-bottom:0 solid black"/>
               <div class="styLNAmountBox" style="text-align:right;height:6mm;padding-top:3.4mm;                  border-bottom:0 solid black">
               </div>
            </div>
            <!--End of line 4 -->
            <!-- Line 5 -->
            ...
            <div style="width:187mm;">
               ...
               <div class="styLNAmountBox" style="height:10.5mm;border-bottom-width:0px;border-bottom-width:0px;                  background-color:lightgrey;border-left-width:0px;"/>
            </div>
            <!--End of line 6 -->
         </div>
         ...
         <div class="styBB" style="width:187mm;">
            <div class="styBB" style="width:102mm;height:8mm;border-bottom-width:0px;">
               <div class="styNameBox" style="width:110mm;height:6mm;font-size:7pt;font-weight:normal;">
                 Name of person with <b>self-employment</b> income <span style="font-size:6.3pt;">(as shown on Form 1040 or Form 1040NR)</span><br/>
               </div>
               <div class="styNameBox" style="width:110mm;height:1.9mm;padding-bottom:.9mm;font-size:7pt;">
                  <xsl:call-template name="PopulateText">
              ...
              1a</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139mm;height:12mm;">
							...
							orders, see instructions for types of income to report on this line. See instructions<br/> for other income to report.  <b>Note.</b> Skip this line if you use the nonfarm optional method (see instructions) <b>. </b>
						</div> 

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- - Form1120S Displays as - Itemized Excess Net Passive Income Tax Schedule - -->
  <xsl:template name="ShowENTS">
    <!-- Itemized Other Income Schedule Data -->
    <table id="ENTSTbl" class="styDepTbl">
      <thead class="styTableThead">
      <tr class="styDepTblHdr">         
         <th class="styDepTblCell" scope="col" style="width:12mm;">Line Number</th>  
         ...
         <th class="styDepTblCell" scope="col" style="width:12mm;">Excess Net<br/>Passive Investment<br/>Income Percent</th>     
      </tr>
      </thead>
        <tfoot/>
       <tbody>
      <xsl:for-each select="$ENTSData/ExcessNetPassiveIncomeTaxGrp">
        <tr>
          ...
          <td class="styDepTblCell" style="width:12mm;text-align:center;padding-top:5mm;">
          ...
          <td class="styDepTblCell" style="width:40mm;text-align:right;padding-top:5mm;" nowrap="yes">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="Amt"/>
            </xsl:call-template>
          </td>    
          <td class="styDepTblCell" style="width:12mm;text-align:center;padding-top:5mm;" nowrap="yes">
            <xsl:call-template name="PopulateText">

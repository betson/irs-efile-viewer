								...
								<xsl:if test="($Print != $Separated) or (count($Form8825Data/IdentifyPartnershipEstateTrGrp) &lt;= 3) ">
									<xsl:for-each select="$Form8825Data/IdentifyPartnershipEstateTrGrp">
										<tr>
											...
											style="font-size:6pt;width: 69mm;border-bottom:1 solid black; font-size: 7pt;">
												<xsl:call-template name="PopulateText">
											...
											<td style="width:35mm;padding-left:16.5mm;padding-top:0px;padding-bottom:0px;">
												<div class="styLNRightNumBoxNBB" 
												style="width:8.25mm;background-color:lightgrey;border-right-width:1px;padding-top:0px;padding-bottom:0px;height:13mm">
												</div>
											</td>
										</tr>
									</xsl:for-each>

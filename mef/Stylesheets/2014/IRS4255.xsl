          ...
          <div class="styMainTitle" style="height:8mm;padding-top:2mm;">
	       ...
	       <b>Attach to your tax return.</b>
              <div class="styFST" style="height:5mm;font-size:7pt;padding-top:.5mm;">
                <img src="{$ImagePath}/4255_Bullet.gif" width="4" height="7" alt="Bullet Image"/>
          Information about Form 4255 and its instructions is at <a href="http://www.irs.gov/form4255" title="Link to IRS.gov"><i>www.irs.gov/form4255</i></a>.
        </div>
        </div>
            ...
            <thead class="styTableThead">
              <tr style="height:6mm;border-color:black;">
                ...
                <th class="styTableCellHeader" style="width:162mm;font-weight:normal;font-size:7pt;text-align:left;" scope="col">
                  Type of property—State whether rehabilitation, energy, qualifying advanced coal project, qualifying gasification project, qualifying advanced energy project, or qualifying therapeutic discovery project property. (See the Instructions for Form 3468 for the year the investment
credit property was placed in service for definitions.) If rehabilitation property, also show type of building. If energy property, show type.
            ...
            <xsl:if test="count($Form4255Data/RecaptureOfInvstCrProperties) &lt; 1 or ((count($Form4255Data/RecaptureOfInvstCrProperties) &gt; 4) and ($Print = $Separated))">
              <tr style="height:6mm;font-size:7pt;">
            ...
            <xsl:if test="count($Form4255Data/RecaptureOfInvstCrProperties) &lt; 2 or ((count($Form4255Data/RecaptureOfInvstCrProperties) &gt; 4) and ($Print = $Separated))">
              <tr style="height:6mm;font-size:7pt;">
            ...
            <xsl:if test="count($Form4255Data/RecaptureOfInvstCrProperties) &lt; 3 or ((count($Form4255Data/RecaptureOfInvstCrProperties) &gt; 4) and ($Print = $Separated))">
              <tr style="height:6mm;font-size:7pt;">
                <td class="styTableCell" style="text-align:center;width:25mm;font-weight:bold;">C<span class="styTableCellPad"/></td>
                <td class="styTableCell" style="text-align:left;width:162mm;"><span class="styTableCellPad"/></td>
              </tr>
            </xsl:if>          
            <xsl:if test="count($Form4255Data/RecaptureOfInvstCrProperties) &lt; 4 or ((count($Form4255Data/RecaptureOfInvstCrProperties) &gt; 4) and ($Print = $Separated))">
              <tr style="height:6mm;font-size:7pt;">
          ...
          <div class="styTableContainerNBB" style="height:58mm;">
            <table class="styTable" cellspacing="0" style="border-color:black;">
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB " style="width:5mm;font-size:7pt;font-weight:bold;border-color:black;">1<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB " style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;">2<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB " style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;padding-top:3mm;">3<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;">4<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;padding-top:3mm;">5<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;padding-top:3mm;">6<span class="styTableCellPad"/></td>
                <td class="styTableCellSmall" style="font-size:6pt;border-style: solid; border-color: black;padding-top:3mm;">
                  <xsl:call-template name="PopulateAmount">
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;border-top-width: 1px;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;">7<span class="styTableCellPad"/></td>
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;font-size:7pt;font-weight:bold;border-style: solid; border-color: black;padding-top:3mm;">8<span class="styTableCellPad"/></td>
                <td class="styTableCellSmall" style="font-size:6pt;border-style: solid; border-color: black;padding-top:3mm;">
                  <xsl:call-template name="PopulateAmount">
          ...
          <div class="styIRS4255TableContainerNBB" style="height:57mm;">
            <table class="styTable" cellspacing="0">
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB" style="width:5mm;border-top-width: 1px;font-size:7pt;font-weight:bold;">7<span class="styTableCellPad"/></td>
      ...
      <div class="styBB" style="width:187mm;">
        <div style="width:187mm;">
          ...
          <div class="styLNAmountBox">        
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/TotalTentativeRecaptureTaxAmt"/>                    </xsl:call-template>
          </div>
        </div>
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNAmountBox" style="height:8mm;padding-top:4mm">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/NonqualifedFinanceRcptrTaxAmt"/>                    </xsl:call-template>
          </div>
        </div>
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNAmountBox">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/RecaptureTaxSubtotalAmt"/>                    </xsl:call-template>
          </div>
        </div>
        <div style="width:187mm;">
          <div class="styLNLeftNumBox" style="height:4mm;padding-left:0mm;width:5mm;">
          ...
          <div class="styLNRightNumBox" style="height:4mm;padding-top:1.5mm">
            12
          </div>
          <div class="styLNAmountBox" style="height:4mm;padding-top:1.5mm;">
            <xsl:call-template name="PopulateAmount">
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNAmountBox" style="height:8mm;padding-top:3.5mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/NetOfNonOffsetTxOriginalCrAmt"/>                      </xsl:call-template>
          </div>
        </div>
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNDesc" style="width:141mm;height:4mm;">
            Total increase in tax. Add lines 13 and 14. Enter here and on the appropriate line of your tax <br/>
            return 
            <span class="styBoldText">
              <span style="width:6px;"/>.
              <span style="width:16px;"/>.
          ...
          <div class="styLNAmountBox" style="height:8.5mm;padding-top:4.5mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/TotalIncreaseInTaxAmt"/>                    </xsl:call-template>
          </div>
        </div> 
      </div>
        ...
        <xsl:if test="position() mod 4 = 1">
            <table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
              <tr class="styDepTblHdr">
                ...
                <th class="styDepTblcell" style="width:8mm;;height:5mm;">                     <span class="styTableCellPad"/>
                </th>
              ...
              <tr class="styDepTblRow1">
                ...
                <td class="styDepTblCell" style="width:5mm;font-size:7pt;font-weight:bold;">3<span class="styTableCellPad"/></td>
                <td class="styDepTblCell" style="width:25mm;font-size:6pt;text-align:right;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="OriginalCreditAmt"/>
                  </xsl:call-template>
...
investment credit property
                ...
                <td class="styDepTblCell" style="width:5mm;font-size:7pt;font-weight:bold;">5<span class="styTableCellPad"/></td>
              ...
              <tr class="styDepTblRow2">
                ...
                <td class="styDepTblCell" style="width:5mm;font-weight:bold;">6<span class="styTableCellPad"/></td>

    ...
    <xsl:call-template name="AddOnStyle"/>    
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="DependencyTemplate">
          <xsl:with-param name="TargetNode" select="$DependencyData/PassiveGrp"/>
          <xsl:with-param name="ColName">Total Foreign Tax - Passive</xsl:with-param>
        </xsl:call-template>
        <br/>
        <xsl:call-template name="DependencyTemplate">
          <xsl:with-param name="TargetNode" select="$DependencyData/ListedCategoriesGrp"/>
          <xsl:with-param name="ColName">Total Foreign Tax - Listed Categories</xsl:with-param>
        </xsl:call-template>
        <br/>
        <xsl:call-template name="DependencyTemplate">
          <xsl:with-param name="TargetNode" select="$DependencyData/GeneralLimitationGrp"/>

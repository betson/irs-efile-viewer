...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/GeneralDependencySmall"/>
  <xsl:param name="depDocTitle">
    <!-- -  Common Form displays as - General Dependency Small -  -->
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:187mm;">          
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/AttachmentInformationSmllDesc"/>
            </xsl:call-template>
          </div>
        </div>
        <br/>

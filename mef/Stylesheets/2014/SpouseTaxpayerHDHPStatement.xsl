...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/SpouseTaxpayerHDHPStatement" />

	<xsl:template name="ShowDependencyData">
		<div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;" class="styTopSectionLineLbl">Archer MSA Employer Contribution Amount:</div>
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;" class="styTopSectionLineLbl">Archer MSA Contribution Amount:</div>
          <div class="styExplanationLine">
            <xsl:call-template name="PopulateText">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;" class="styTopSectionLineLbl">Archer MSA Contribution Limitation Amount:</div>
          <div class="styExplanationLine">
            <xsl:call-template name="PopulateText">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;" class="styTopSectionLineLbl">HDHP Employer Compensation Amount:</div>
          <div class="styExplanationLine">
            <xsl:call-template name="PopulateText">

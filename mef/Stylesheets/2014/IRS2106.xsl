...
<!-- Last Modified by James Garced, MSSE MBMS on 5/29/2014 -->
	...
	<xsl:template match="/">
				...
				<form name="Form2106">
					...
					<div class="styBB" style="width: 187mm; height: 22mm; padding-bottom: 0mm; clear: all; float: left;">
						<div class="styFNBox" style="width: 31mm; height: 22mm; padding-top: 0.5mm;">
							...
							<div style="width: 31mm; height: 14mm; padding: 6mm 0mm 0mm 0mm; font-size: 8pt;">
						...
						<div class="styFTBox" style="width: 125mm; height: 22mm;">
							<div class="styMainTitle" style="width: 125mm; height: 7.5mm; padding-top: 2mm;">
							Employee Business Expenses
						</div>
							<div class="styFBT" style="width: 125mm; height: 3mm; font-size: 6.5pt; margin-top: 1mm;">
								<img src="{$ImagePath}/2106_Bullet.gif" alt="Bullet"/> Attach to Form 1040 or Form 1040NR.
							 </div>
							 <div class="styFBT" style="width: 125mm; height: 8mm; padding-top: 0mm; font-size: 6.5pt; margin-top: 0mm;">
					...
					<div class="styBB" style="width: 187mm; height: 15mm; clear: all; float: left;">
    	               ...
    	               Step 1  <span style="width:3mm;"/>Enter Your Expenses
						...
						<div class="styPartDesc" style="width:38mm; height: 15mm; font-size:9pt; padding-top:1mm; padding-right:4mm; border-style:solid;border-right-width:1px; border-left-width:1px; border-top-width:0px; border-bottom-width:0px; border-color:black; float:left; clear:none;">
						   ...
						   Other Than Meals<br/>and Entertainment
						</div>
						</div>
						<!-- END Column A HEADER-->
		          ...
		          <!--Dotted Line-->
					...
					<div style="width:187mm; font-size:8pt; clear: all; float: left;">
		             ...
		             <!--Dotted Line-->
						...
						<div class="styIRS2106ColBox" style="height:9mm; padding-top:5mm;border-left-width:0px;border-right-width:0px; border-bottom-width:1px;border-top-width:0px;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm; font-size:8.5pt; clear: all; float: left;">
						<div class="styLNDesc" style="width:187mm; height:2mm; font-size:8pt; padding-left:8mm; padding-top:5mm; padding-bottom:4mm;">
							<b>Note: </b>
							<span style="font-style:italic;"> If you were not reimbursed for any expenses in Step 1, skip line 7 and enter the amount from line 6 on line 8.</span>
						</div>
					</div>
					<!-- END Step 1 Note -->
					<!-- BEGIN STEP 2 TITLE -->
					...
					<!-- END STEP 3 TITLE -->
					<!-- BEGIN Step 3.8 -->
					<div style="width: 187mm; height: 17mm; clear: all; font-size: 8pt; float: left;">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:6mm;">
						8
					</div>
		          ...
		          <!--Dotted Line-->
						...
						<div class="styIRS2106ColBox" style="padding-top: 13.4mm; height: 17mm; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 0px; padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form2106Data/UnreimbursedBusinessExpenseAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS2106ColBoxGrey" style="height 19mm; width: 5.2mm; padding-top: 16.8mm; border-bottom-width: 1px; border-left-width: 0px;"/>
						<div class="styIRS2106ColBox" style="padding-top: 13.4mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 0px; height: 17mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width: 187mm; height: 12mm; clear: all; font-size: 8pt; float: left;">
						...
						<div class="styIRS2106ColBox" style="padding-top: 3mm; border-right-width: 1px; border-bottom-width: 0px; border-left-width: 0px;"/>
					...
					<!-- BEGIN Step 3.10 -->
					<div class="styBB" style="width: 187mm; height: 15mm; clear: all; float: left;">
						<div class="styLNLeftNumBox" style="height: 15mm; padding-top: 1mm; font-size: 8pt;">
						10
					</div>
						...
						<div class="styLNRightNumBox" style="border-width: 0px 1px; border-style: solid; border-color: black; width: 5.5mm; text-align: center; padding-top: 11mm; height: 15mm;">
						10
					</div>
						<div class="styIRS2106ColBox" style="padding-top: 11mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; height: 15mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<!-- END Step 3.10 -->
					<!-- BEGIN Page 1 Footer -->
					<div style="width:187mm; padding-top:.5mm; padding-bottom:35mm; clear: all; float: left;">
						...
						Form <span class="styBoldText" style="font-size:8pt;">2106  </span>	(2014)
					</div>
					</div>
					<!-- END Page 1 Footer -->
					...
					<!-- BEGIN PART II TITLE -->
					<div class="styNBB" style="width:187mm; padding-bottom:0mm; clear: all; float: left;">
					...
					<xsl:for-each select="$Form2106Data/VehicleExpensesGrp">
						...
						(<xsl:number value="($pos+1)" format="a"/>) <span style="font-weight:normal;">Vehicle <xsl:number value="($pos+1)" format="1"/>
							...
							<div style="width: 187mm; height: 5.5mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left;">
								<div class="styLNLeftNumBox" style="height: 5.5mm; padding-top: 1.4mm;">
						11
					</div>
								<div class="styLNDesc" style="width: 107.5mm; height: 5.5mm; padding-top: 1.5mm;">
						...
						<!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 5.5mm; text-align: center; padding-top: 1.3mm;">
						11
					</div>
								<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; text-align: center; padding-top: 2mm; padding-right: 1mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
									<xsl:call-template name="PopulateMonthDayYear">
										<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/VehiclePlacedInServiceDt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBox" style="width: 31.5mm; height: 5.5mm; text-align: center; padding-top: 2mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
									<xsl:call-template name="PopulateMonthDayYear">
							...
							<div style="width: 187mm; height: 5.5mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left;">
								<div class="styLNLeftNumBox" style="height: 5.5mm; padding-top: 1mm;">
						12
					</div>
								<div class="styLNDesc" style="width: 107.5mm; height: 5.5mm; padding-top: 1mm;">
						...
						<!--Dotted Line-->
							<span class="styBoldText">
								...
								<div class="styLNRightNumBox" style="border-width: 0px 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 5.5mm; text-align: center; padding-top: 1mm;">
						12
					</div>
								<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
								...
								<div class="styIRS2106ColBox" style="width: 31.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
						...
						Business miles included on line 12 
						  <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height: 5.5mm; border-width: 0px 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; text-align: center; padding-top: 1mm;">
						13
					</div>
								<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
						...
						<!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height: 5.5mm; border-width: 0px 0px 1px 1.3px; border-style: solid; border-color: black; width: 7mm; text-align: center; padding-top: 0.8mm;">
						14
					</div>
								<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; padding-right: 1mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1.3px;">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/VehBusInvestmentUsePct"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBox" style="width: 31.5mm; height: 5.5mm; padding-top: 1.5mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1.3px;">
									<xsl:call-template name="PopulatePercent">
						...
						15
								...
								<div class="styIRS2106ColBox" style="border-width: 0px 0px 1px 1px; width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt;">
									<xsl:call-template name="PopulateAmount">
						...
						16
							...
							<div style="width: 187mm; height: 5.5mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left;">
								<div class="styLNLeftNumBox" style="border: 0px solid black; height: 5.5mm; padding-top: 1mm;">
						17
					</div>
								<div class="styLNDesc" style="border: 0px solid black; width: 107.5mm; height: 5.5mm; padding-top: 1mm;">
						...
						<!--Dotted Line-->
								...
								<xsl:choose>
									<xsl:when test="$pos = count($Form2106Data/VehicleExpensesGrp) or $pos = count($Form2106Data/VehicleExpensesGrp)-1">
										<div class="styLNRightNumBox" style="border-width: 0px 0px 1px 1px; border-style: solid solid solid; border-color: black; width: 7mm; height: 5.5mm; text-align: center; padding-top: 1mm;">
								17
							</div>
										<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-bottom-color: currentColor; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px; border-bottom-style: solid;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/OtherPersonalMilesCnt"/>
											</xsl:call-template>
											<span style="font-weight:normal;font-size:8pt;padding-left:1mm;padding-right:1mm;">miles</span>
										</div>
										<div class="styIRS2106ColBox" style="width: 31.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-bottom-color: currentColor; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px; border-bottom-style: solid;">
											<xsl:call-template name="PopulateAmount">
									...
									<xsl:otherwise>
										<div class="styLNRightNumBox" style="height:5.5mm; width:7mm; padding-top:1mm; text-align:center; border-style:solid; border-right-width:0px; border-left-width:1px; border-top-width:0px; border-bottom:0px; border-color:black;">
								17
							</div>
										<div class="styIRS2106ColBox" style="height:5.5mm; width:32.5mm; font-size:6pt; padding-top:1.5mm; border-left-width:1px; border-bottom-width:0px; border-right-width:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/OtherPersonalMilesCnt"/>
											</xsl:call-template>
											<span style="font-weight:normal;font-size:8pt;padding-left:1mm;padding-right:1mm;">miles</span>
										</div>
										<div class="styIRS2106ColBox" style="height:5.5mm; padding-top:1.5mm; font-size:6pt; width:31.5mm; border-left-width:1px; border-right-width:0px; border-bottom-width:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos + 1]/OtherPersonalMilesCnt"/>
											</xsl:call-template>
											<span style="font-weight:normal;font-size:8pt;padding-left:1mm;">miles</span>
					...
					<xsl:if test="(count($Form2106Data/VehicleExpensesGrp) &lt; 1)">
						...
						<div style="width:187mm; font-size:8pt; padding-bottom:0mm; clear: all; float: left;">
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7.2mm;padding-top:1.3mm;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">11</div>
							...
							<div class="styIRS2106ColBox" style="height:5.5mm;width:31.5mm;padding-top:2mm;           border-left-width:1px;border-right-width:0px;text-align:center;border-bottom-width:1px;">
								<xsl:call-template name="PopulateMonthDayYear">
									<xsl:with-param name="TargetNode" select="$Form2106Data    /VehicleExpensesGrp[$pos + 1]/VehiclePlacedInServiceDt"/>
								</xsl:call-template>
							</div>
						...
						<div style="width: 187mm; height: 5.5mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left;">
							<div class="styLNLeftNumBox" style="height: 5.5mm; padding-top: 1mm;">12</div>
							<div class="styLNDesc" style="width: 107.5mm; height: 5.5mm; padding-top: 1mm;">Total miles the vehicle was driven during 2014
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="border-width: 0px 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 5.5mm; text-align: center; padding-top: 1mm;">12</div>
							<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data    /VehicleExpensesGrp[$pos]/TotalMilesCnt"/>
								</xsl:call-template>
						...
						<div style="width: 187mm; height: 5.5mm; padding-bottom: 0mm; clear: all; font-size: 8pt; float: left;">
							<div class="styLNLeftNumBox" style="height: 5.5mm; padding-top: 1mm;">13</div>
							<div class="styLNDesc" style="width: 107.5mm; height: 5.5mm; padding-top: 1mm;">Business miles included on line 12 
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height: 5.5mm; border-width: 0px 0px 1px 1px; border-style: solid; border-color: black; width: 7.2mm; text-align: center; padding-top: 1mm;">13</div>
							<div class="styIRS2106ColBox" style="width: 32.5mm; height: 5.5mm; padding-top: 1.5mm; font-size: 6pt; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/BusinessMilesCnt"/>
								</xsl:call-template>
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7.2mm;padding-top:.8mm;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1.3px;border-top-width:0px;border-bottom-width:1px;border-color:black;">14</div>
							<div class="styIRS2106ColBox" style="height:2mm;width:32.5mm;padding-top:1.5mm;padding-right:1mm;border-left-width:1.3px;border-bottom-width:1px;   border-right-width:0px;">
								<xsl:call-template name="PopulatePercent">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/VehBusInvestmentUsePct"/>
								</xsl:call-template>%
										</div>
							<div class="styIRS2106ColBox" style="height:2mm;width:31.5mm;padding-top:1.5mm;border-left-width:1.3px;border-right-width:0px;    border-bottom-width:1px;">
								<xsl:call-template name="PopulatePercent">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos + 1]/VehBusInvestmentUsePct"/>
								</xsl:call-template>%
										</div>
						...
						<div style="width:187mm;f ont-size:8pt; padding-bottom:0mm; clear: all; float: left;">
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7.2mm;padding-top:1mm;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">15</div>
							<div class="styIRS2106ColBox" style="height:2mm;width:32.5mm;font-size:6pt;padding-top:1.5mm;border-top-width:0px;border-left-width:1px;   border-bottom-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/AverageDistanceCnt"/>
								</xsl:call-template>
								<span style="font-weight:normal;font-size:8pt;padding-left:1mm;padding-right:1mm;">miles</span>
							</div>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:1.5mm;font-size:6pt;width:31.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos + 1]/AverageDistanceCnt"/>
								</xsl:call-template>
								<span style="font-weight:normal;font-size:8pt;padding-left:1mm;">miles</span>
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7.2mm;padding-top:1mm;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">16</div>
							<div class="styIRS2106ColBox" style="height:2mm;width:32.5mm;font-size:6pt;padding-top:1.5mm;border-left-width:1px;border-bottom-width:1px;   border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/MilesCommutingCnt"/>
								</xsl:call-template>
								<span style="font-weight:normal;font-size:8pt;padding-left:1mm;padding-right:1mm;">miles</span>
						...
						<div style="width:187mm; font-size:8pt; padding-bottom:0mm; clear: all; float: left;">
							<div class="styLNLeftNumBox" style="height:4mm;padding-top:1mm;border-style:solid;border-right-width:0px;border-left-width:0px;      border-top-width:0px;border-bottom-width:0px;border-color:black;">17</div>
							<div class="styLNDesc" style="width:107.5mm;padding-top:1mm;border-style:solid;border-right-width:0px;border-left-width:0px;      border-top-width:0px;border-bottom-width:0px;border-color:black;">Other miles. Add lines 13 and 16 and subtract the total from line 12 
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7.2mm;padding-top:1mm;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1px;border-top-width:0px;border-bottom-width:.5px;border-color:black;">17</div>
							<div class="styIRS2106ColBox" style="height:2mm;width:32.5mm;font-size:6pt;padding-top:1.5mm;border-left-width:1px;border-bottom-width:.5px;   border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos]/OtherPersonalMilesCnt"/>
								</xsl:call-template>
								<span style="font-weight:normal;font-size:8pt;padding-left:1mm;padding-right:1mm;">miles</span>
							</div>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:1.5mm;font-size:6pt;width:31.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:.5px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/VehicleExpensesGrp[$pos + 1]/OtherPersonalMilesCnt"/>
								</xsl:call-template>
								<span style="font-weight:normal;font-size:8pt;padding-left:1mm;">miles</span>
					...
					<div class="styBB" style="width:187mm; height: 6.5mm; font-size:8pt; padding-bottom:0mm; clear: all; float: left;">
      ...
      Section B-Standard Mileage Rate <span style="font-weight:normal;">(See the instructions for Part II to find out whether to complete this section or Section C.)	</span>
					...
					<div class="styBB" style="width: 187mm; height: 6mm; font-size: 8pt;">
						...
						<div class="styLNDesc" style="width: 139mm; padding-top: 1.5mm;">Multiply line 13 by 56¢ (.56). Enter the result here and on line 1 
					...
					<xsl:for-each select="$Form2106Data/ActualExpensesGrp">
						...
						<xsl:if test="(position() mod 2)=1">
							...
							<div style="width:187mm; height:9mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height:9mm; padding-top:1mm; font-size:8pt;">23</div>
								<div class="styLNDesc" style="width: 44mm; height: 9mm; padding-top: 1mm; font-size: 8pt;">Gasoline, oil, repairs, vehicle insurance, etc.
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 9mm; text-align: center; padding-top: 4.5mm; font-size: 8pt;">23</div>
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 0px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/VehicleGasRepairsInsAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm; height: 4.5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4.5mm; font-size:7.5pt;">24a</div>
								<div class="styLNDesc" style="width:44mm; height: 4.5mm; font-size:8pt;">Vehicle rentals
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height: 4.5mm; width:7mm; padding-top:.5mm; font-size:8pt; text-align:center;border-style:solid; border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24a</div>
								<div class="styIRS2106ColBox" style="height: 4.5mm; padding-top:1.3mm; border-left-width:0px; border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section C 24b -->
							<div style="width:187mm; height: 4.5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4.5mm; padding-right:1mm;padding-bottom:0mm;padding-top:.5mm;font-size:8pt;text-align:right;">b</div>
								<div class="styLNDesc" style="padding-top:1mm;padding-bottom:0mm;width:44mm;height: 4.5mm;font-size:6.5pt;">Inclusion amount (see instructions)</div>
								<div class="styLNRightNumBox" style="height: 4.5mm;width:7mm;padding-top:.3mm;font-size:8pt;text-align:center;border-style:solid;    border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24b</div>
								<div class="styIRS2106ColBox" style="height: 4.5mm;padding-top:1mm;border-left-width:0px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/InclusionAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 4.5mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;"/>
								<div class="styIRS2106ColBox" style="height: 4.5mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section C 24c -->
							<div style="width:187mm; height: 4.5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4.5mm; padding-top:1mm;padding-right:1mm;font-size:7.5pt;text-align:right;">c</div>
								<div class="styLNDesc" style="width:44mm;height: 4.5mm;font-size:7.5pt;padding-top:1mm;">Subtract line 24b from line 24a</div>
								<div class="styLNRightNumBox" style="height: 4.5mm;width:7mm;padding-top:.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24c</div>
							...
							<!-- END Section C 24c -->
							<!-- BEGIN Section C 25 -->
							<div style="width:187mm; height: height: 17mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 17mm; padding-top:3mm;font-size:8pt;">25</div>
								<div class="styLNDesc" style="width:44mm; height: 17mm; font-size:7pt;padding-top:3mm;">Value<span style="width:1mm"/>of<span style="width:1mm"/> employer-provided vehicle (applies only if 100% 	of annual lease value was included <br/>
			on Form W-2-see instructions)
								...
								<div class="styLNRightNumBox" style="height: 17mm; width:7mm;padding-top:11.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">25</div>
								<div class="styIRS2106ColBoxGrey" style="height: 17mm; padding-top:12mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height: 17mm; padding-top:11mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/ValueEmplrProvidedVehicleAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 17mm; padding-top:12mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height: 17mm; padding-top:11mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section C 26 -->
							<div style="width:187mm; height:5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height:5mm; padding-top:.5mm;font-size:8pt;">26</div>
								<div class="styLNDesc" style="width:44mm;height:5mm;font-size:8pt;padding-top:.5mm;">Add lines 23, 24c, and 25
				          <!--Dotted Line-->
										<span class="styBoldText">
								...
								<div class="styLNRightNumBox" style="height:5mm;width:7mm;padding-top:.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">26</div>
								<div class="styIRS2106ColBoxGrey" style="height:5mm;padding-top:1.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:5mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/ActualVehicleExpenseAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height:5mm;padding-top:1.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:5mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:187mm; height:10mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height:10mm; padding-top:1mm;font-size:8pt;">27</div>
								<div class="styLNDesc" style="width:44mm; height:9mm; font-size:8pt;padding-top:1mm;">Multiply<span style="width:2mm"/>line<span style="width:2mm"/>26<span style="width:2mm"/>by<span style="width:2mm"/> the percentage on line 14
				          <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:4px"/>.
										<span style="width:4px"/>.
								...
								<div class="styLNRightNumBox" style="height:10mm; width:7mm;padding-top:4.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">27</div>
								<div class="styIRS2106ColBoxGrey" style="height:10mm; padding-top:5.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:10mm; padding-top:5.3mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/CalculatedBusinessExpenseAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height:10mm; padding-top:5.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:10mm; padding-top:5.3mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section C 28 -->
							<div style="width:187mm; height:4.5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height:4.5mm; padding-top:.5mm;font-size:8pt;">28</div>
								<div class="styLNDesc" style="width:44mm;height:4.5mm;font-size:7.5pt;padding-top:.5mm;">Depreciation (see instructions) .</div>
								<!--Dotted Line-->
								<div class="styLNRightNumBox" style="height:4.5mm;width:7mm;padding-top:.3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">28</div>
								<div class="styIRS2106ColBoxGrey" style="height:4.5mm;padding-top:1.3mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:4.5mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/DepreciationAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height:4.5mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
								<div class="styIRS2106ColBox" style="height:4.5mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- END Section C 28 -->
							<!-- BEGIN Section C 29 -->
							<div style="width:187mm; height:9mm; border-style:solid; border-color:black; border-width:0px 0px 1px 0px; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height:9mm;padding-top:.5mm;padding-bottom:0mm;font-size:8pt;">29</div>
								<div class="styLNDesc" style="width:44mm;height:9mm;font-size:8pt;padding-top:.5mm;padding-bottom:0mm;">Add lines 27 and 28. <span style="width:2mm"/>Enter total here and on line 1
				          <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:4px"/>.
										<span style="width:4px"/>.
								...
								<div class="styLNRightNumBox" style="height:9mm;width:7mm;padding-top:3.8mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:0px;border-color:black;">29</div>
								<div class="styIRS2106ColBoxGrey" style="height:9mm;padding-top:4.5mm;border-left-width:0px;border-right-width:0px;border-bottom-width:1px;"/>
								<div class="styIRS2106ColBox" style="height:9mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;border-bottom-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/TotalActualExpenseAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height:9mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;border-bottom-width:1px;"/>
								<div class="styIRS2106ColBox" style="height:9mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;">
									<xsl:call-template name="PopulateAmount">
					...
					<xsl:if test="count($Form2106Data/ActualExpensesGrp) &lt; 1 ">
						...
						<div class="styNBB" style="width:187mm;">
							<th scope="col" style="width:187mm;">
								...
								<!-- BEGIN Vehicle 1 Title  -->
								<div class="styPartDesc" style="width:64.35mm;font-size:8pt;padding-left:2mm;padding-right:2mm;text-align:center;         border-style:solid;border-left-width:1px;border-right-width:0mm;border-top-width:0mm;border-bottom-width:1px;border-color:black;float:left;         clear:none;">(<xsl:number value="($pos)" format="a"/>)  <span style="font-weight:normal;">Vehicle <xsl:number value="($pos)" format="1"/>
									</span>
								</div>
								<!-- END Vehicle 1Title -->
								<!-- BEGIN Vehicle 2 Title -->
								<div class="styPartDesc" style="width:64.1mm;padding-left:2mm;padding-right:2mm;text-align:center;       border-style:solid;border-left-width:1px;border-right-width:0mm;border-top-width:0mm;border-bottom-width:1px;border-color:black;float:left;       clear:none;">(<xsl:number value="($pos+1)" format="a"/>)  <span style="font-weight:normal;">Vehicle <xsl:number value="($pos+1)" format="1"/>
									</span>
								</div>
							</th>
						</div>
						<!-- END Vehicle 2 Tile-->
						<!-- BEGIN Section C 23 -->
						<div style="width:187mm; clear: all; float: left;">
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:8mm;width:7mm;padding-top:4.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">23</div>
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:1mm;width:7mm;padding-top:.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24a</div>
							<div class="styIRS2106ColBox" style="height:1mm;padding-top:1.3mm;border-left-width:0px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/VehicleRentalsAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:1mm;padding-top:1.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
						...
						<div style="width:187mm; clear: all; float: left;">
							...
							<div class="styLNRightNumBox" style="height:1mm;width:7mm;padding-top:.3mm;font-size:8pt;text-align:center;border-style:solid;    border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24b</div>
						...
						<div style="width:187mm; clear: all; float: left;">
							...
							<div class="styLNRightNumBox" style="height:1mm;width:7mm;padding-top:.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">24c</div>
							<div class="styIRS2106ColBoxGrey" style="height:1mm;padding-top:1.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:1mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/RentalMinusInclusionAmt"/>
								</xsl:call-template>
			...
			on Form W-2-see instructions)</div>
							<div class="styLNRightNumBox" style="height:8.5mm;width:7mm;padding-top:12.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">25</div>
							<div class="styIRS2106ColBoxGrey" style="height:8.5mm;padding-top:13.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:8.5mm;padding-top:13.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/ValueEmplrProvidedVehicleAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:8.5mm;padding-top:13.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:8.5mm;padding-top:13.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos + 1]/ValueEmplrProvidedVehicleAmt"/>
								</xsl:call-template>
						...
						<div style="width:187mm; clear: all; float: left;">
				          ...
				          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7mm;padding-top:.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">26</div>
							<div class="styIRS2106ColBoxGrey" style="height:2mm;padding-top:1.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/ActualVehicleExpenseAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:2mm;padding-top:1.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos + 1]/ActualVehicleExpenseAmt"/>
								</xsl:call-template>
						...
						<div style="width:187mm; clear: all; float: left;">
				          ...
				          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:6mm;width:7mm;padding-top:4.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">27</div>
							<div class="styIRS2106ColBoxGrey" style="height:6mm;padding-top:5.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:6mm;padding-top:5.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/CalculatedBusinessExpenseAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:6mm;padding-top:5.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:6mm;padding-top:5.3mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos + 1]/CalculatedBusinessExpenseAmt"/>
								</xsl:call-template>
						...
						<div style="width:187mm; clear: all; float: left;">
							...
							<div class="styLNDesc" style="width:44mm;height:1mm;font-size:7pt;padding-top:.5mm;">Depreciation (see instructions)
							<!--Dotted Line-->
							<span class="styBoldText">
									<span style="width:8px;"/>.
							</span>
							</div>
							<div class="styLNRightNumBox" style="height:1mm;width:7mm;padding-top:.3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">28</div>
							<div class="styIRS2106ColBoxGrey" style="height:1mm;padding-top:1.3mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:1mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/DepreciationAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:1mm;padding-top:1.3mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:1mm;padding-top:1mm;border-left-width:1px;border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos + 1]/DepreciationAmt"/>
								</xsl:call-template>
						...
						<!-- END Section C 28 -->
						<!-- BEGIN Section C 29 -->
						<div style="width:187mm; border-style:solid; border-color:black; border-width:0px 0px 1px 0px; clear: all; float: left;">
				          ...
				          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7mm;padding-top:3.8mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:0px;border-color:black;">29</div>
							<div class="styIRS2106ColBoxGrey" style="height:2mm;padding-top:4.5mm;border-left-width:0px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos]/TotalActualExpenseAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS2106ColBoxGrey" style="height:2mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:2mm;padding-top:4.5mm;border-left-width:1px;border-right-width:0px;    border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/ActualExpensesGrp[$pos + 1]/TotalActualExpenseAmt"/>
								</xsl:call-template>
						...
						<xsl:if test="(position() mod 2)=1">
							<div class="styIRS2106TableContainer" style="clear: all; float: left;" id="Spcctn">
								...
								<th scope="col" style="width:187mm;">
									...
									<!--END SECTION D TITLE -->
									<div class="styPartDesc" style="width:58.8mm;font-size:8pt;padding-left:0mm;border-style:solid;border-right-width:0px;       border-left-width:0px;border-top-width:0px;border-bottom-width:1px;       border-color:black"/>
									<!-- BEGIN Vehicle 1 Title  -->
									<div class="styPartDesc" style="width:64.3mm;padding-left:2mm;padding-right:2mm;text-align:center;       border-style:solid;border-left-width:1px;border-right-width:0mm;border-top-width:0mm;border-bottom-width:1px;border-color:black;float:left;       clear:none;">(<xsl:number value="($pos)" format="a"/>)  <span style="font-weight:normal;">Vehicle <xsl:number value="($pos)" format="1"/>
										</span>
									</div>
									<!-- END Vehicle 1Title -->
									<!-- BEGIN Vehicle 2 Title -->
							...
							<!-- BEGIN Section D 30 -->
							<div style="width:187mm; height: 9mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 9mm; padding-top:1mm;font-size:8pt;">30</div>
								<div class="styLNDesc" style="width:44mm; height: 9mm; font-size:8pt;padding-top:1mm;">Enter cost or other basis (see instructions)
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="height: 9mm; width:7mm;padding-top:4.3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">30</div>
								...
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; padding-top:5mm;border-left-width:1px;border-right-width:0px; "/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top:5mm;border-left-width:1px;border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section D 31 -->
							<div style="width:187mm; height: 9mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 9mm; padding-top: 1mm; font-size: 8pt;">31</div>
								<div class="styLNDesc" style="width: 44mm; height: 9mm; padding-top: 1mm; font-size: 8pt;">Enter section 179 deduction (see instructions)
										<!--Dotted Line-->
									<span class="styBoldText">
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 9mm; text-align: center; padding-top: 4.3mm; font-size: 8pt;">31</div>
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; font-size: 7.5pt; border-right-width: 0px; border-left-width: 0px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 2mm; border-right-width: 0px; border-left-width: 1px;">
								...
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; font-size: 7.5pt; border-right-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 2mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="SetFormLinkInline">
							...
							<!-- END Section D 31 -->
							<!-- BEGIN Section D 32 -->
							<div style="width: 187mm; height: 11mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 11mm; padding-top: 1mm; font-size: 8pt;">32</div>
								<div class="styLNDesc" style="width: 44mm; height: 11mm; padding-top: 1mm; font-size: 7pt;">Multiply line 30 by line 14 (see instructions if you 
		claimed the section 179 deduction)
		          <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:2px"/>.
										<span style="width:4px"/>.
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 11mm; text-align: center; padding-top: 7mm; font-size: 8pt;">32</div>
								<div class="styIRS2106ColBox" style="height: 11mm; padding-top: 7mm; border-right-width: 0px; border-left-width: 0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/DepreciationRecoveryAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 11mm; padding-top: 11mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 11mm; padding-top: 7mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos + 1]/DepreciationRecoveryAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 11mm; padding-top: 11mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px; background-color: lightgrey;"/>
							</div>
							<!-- END Section D 32 -->
							<!-- BEGIN Section D 33 -->
							<div style="width: 187mm; height: 9mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 9mm; padding-top: 2mm; font-size: 8pt;">33</div>
								<div class="styLNDesc" style="width: 44mm; height: 9mm; padding-top: 2mm; font-size: 7pt;">Enter depreciation method and percentage
		 (see instructions)
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 9mm; text-align: center; padding-top: 5.5mm; font-size: 8pt;">33</div>
								<div class="styIRS2106ColBox" style="height: 9mm; text-align: left; color: darkblue; padding-top: 3mm; font-size: 6.5pt; border-right-width: 0px; border-left-width: 0px;">
									<xsl:call-template name="PopulateText">
								...
								<div class="styIRS2106ColBox" style="height: 9mm; text-align: left; color: darkblue; padding-top: 3mm; font-size: 6.5pt; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateText">
							...
							<!-- BEGIN Section D 34 -->
							<div style="width: 187mm; height: 10mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 10mm; padding-top: 0mm; font-size: 8pt;">34</div>
								<div class="styLNDesc" style="width: 44mm; height: 10mm; padding-top: 0mm; font-size: 7.3pt;">Multiply line 32 by the percentage on line 33 <br/>
		 (see instructions)
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 10mm; text-align: center; padding-top: 6mm; font-size: 8pt;">34</div>
								<div class="styIRS2106ColBoxGrey" style="height: 10mm; padding-top: 3.3mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"/>
								...
								<div class="styIRS2106ColBoxGrey" style="height: 10mm; padding-top: 3.3mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 10mm; padding-top: 6.5mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section D 35 -->
							<div style="width: 187mm; height: 4.5mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 4.5mm; padding-top: 1mm; font-size: 8pt;">35</div>
								<div class="styLNDesc" style="width: 44mm; height: 4.5mm; padding-top: 1mm; font-size: 8pt;">Add lines 31 and 34
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 4.5mm; text-align: center; padding-top: 0.8mm; font-size: 8pt;">35</div>
								<div class="styIRS2106ColBoxGrey" style="height: 4.5mm; padding-top: 1.6mm; border-right-width: 0px; border-left-width: 0px;"/>
								<div class="styIRS2106ColBox" style="height: 4.5mm; padding-top: 1mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/DepreciationSubtotalAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 4.5mm; padding-top: 1.6mm; border-right-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 4.5mm; padding-top: 1mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- BEGIN Section D 36 -->
							<div style="width: 187mm; height: 11mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 11mm; padding-top: 1mm; font-size: 8pt;">36</div>
								<div class="styLNDesc" style="width: 44mm; height: 11mm; padding-top: 1mm; font-size: 8pt;">Enter the applicable limit explained in the line 36 <br/> instructions
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 11mm; text-align: center; padding-top: 6.5mm; font-size: 8pt;">36</div>
								<div class="styIRS2106ColBox" style="height: 11mm; padding-top: 7.5mm; border-right-width: 0px; border-left-width: 0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/LimitationAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 11mm; padding-top: 3.8mm; border-right-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 11mm; padding-top: 7.5mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos + 1]/LimitationAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 11mm; padding-top: 7.5mm; border-right-width: 0px; border-left-width: 1px;"/>
							</div>
							<!-- END Section D 36 -->
							<!-- BEGIN Section D 37 -->
							<div style="width: 187mm; height: 9mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 9mm; padding-top: 1mm; font-size: 8pt;">37</div>
								<div class="styLNDesc" style="width: 44mm; height: 9mm; padding-top: 1mm; font-size: 8pt;">Multiply<span style="width:1mm"/> line
		<span style="width:1mm"/> 36<span style="width:1mm"/> by<span style="width:1mm"/> the percentage on line 14
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 1px 1px; border-style: solid; border-color: black; width: 7mm; height: 9mm; text-align: center; padding-top: 4.5mm; font-size: 8pt;">37</div>
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; padding-top: 5.5mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/LimitationMultipliedByUseAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 9mm; padding-top: 5.5mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 9mm; padding-top: 5.3mm; border-right-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- END Section D 37 -->
							<!-- BEGIN Section D 38 -->
							<div style="border-width: 0px 0px 1px; border-style: solid; border-color: black; width: 187mm; height: 18mm; clear: all; float: left;">
								<div class="styLNLeftNumBox" style="height: 18mm; padding-top: 1mm; font-size: 8pt;">38</div>
								<div class="styLNDesc" style="width: 44mm; height: 18mm; padding-top: 1mm; font-size: 7.1pt;">Enter the <span class="styBoldText">smaller</span> of line 35 <br/>or line 37. 
		<span style="width:1mm"/> If you skipped lines<br/> 36 and 37,  enter the amount <br/>from line 35.<span style="width:1mm"/>Also enter this amount on line	28 above
		          ...
		          <!--Dotted Line-->
								...
								<div class="styLNRightNumBox" style="border-width: 0px 0px 0px 1px; border-style: solid; border-color: black; width: 6.8mm; height: 18mm; text-align: center; padding-top: 13.5mm; font-size: 8pt;">38</div>
								<div class="styIRS2106ColBoxGrey" style="width: 32.3mm; height: 18mm; padding-top: 14.3mm; border-right-width: 0px; border-bottom-width: 1px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 18mm; padding-top: 14.3mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/DepreciationOfVehicleAmt"/>
									</xsl:call-template>
								</div>
								<div class="styIRS2106ColBoxGrey" style="height: 18mm; width: 32.3mm; padding-top: 14.3mm; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;"/>
								<div class="styIRS2106ColBox" style="height: 18mm; width: 31.5mm; padding-top: 14.3mm; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;">
									<xsl:call-template name="PopulateAmount">
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7mm;padding-top:4.3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">30</div>
						...
						<div style="width:187mm; clear: all; float: left;">
							...
							<div class="styLNDesc" style="width:44mm;font-size:8pt;padding-top:1mm;">Enter section 179 deduction (see instructions)
										<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:8px"/>.
												<span style="width:8px"/>.
							...
							<div class="styLNRightNumBox" style="width:7mm;height:12mm;padding-top:4.3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">31</div>
		...
		claimed the section 179 deduction)
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:8mm;width:7mm;padding-top:10mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">32</div>
							...
							<div class="styIRS2106ColBoxGrey" style="height:14mm;padding-top:11mm;border-left-width:1px;border-right-width:0px;border-bottom-width:0px;   background-color:lightgrey;"/>
						</div>
						<!-- END Section D 32 -->
						<!-- BEGIN Section D 33 -->
						<div style="width:187mm; clear: all; float: left;">
		 ...
		 (see instructions)
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:8.5mm;width:7mm;padding-top:5.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">33</div>
							<div class="styIRS2106ColBox" style="height:9.8mm;font-size:6.5pt;padding-top:0mm;text-align:left;border-left-width:0px;border-right-width:0px;   color:darkblue;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos]/DepreciationMethodTypeTxt"/>
								</xsl:call-template>
								<br/>
							...
							<div class="styIRS2106ColBox" style="height:9.8mm;font-size:6.5pt;padding-top:0mm;text-align:left;border-left-width:1px;border-right-width:0px;   color:darkblue;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos + 1]/DepreciationMethodTypeTxt"/>
								</xsl:call-template>
								<br/>
		 ...
		 (see instructions)
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7mm;padding-top:2mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">34</div>
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:1.5mm;width:7mm;padding-top:.8mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">35</div>
				...
				<br/>in the line 36 instructions
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:2mm;width:7mm;padding-top:3mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">36</div>
		...
		<span style="width:1mm"/> 36<span style="width:1mm"/> by<span style="width:1mm"/> the percentage on line 14
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:4mm;width:7mm;padding-top:4.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:1px;border-left-width:1px;border-top-width:0px;border-bottom-width:1px;border-color:black;">37</div>
		...
		<span style="width:1mm"/> If you skipped lines<br/> 36 and 37,  enter the amount <br/>from line 35.<span style="width:1mm"/>Also enter this amount on line	28 above
		          ...
		          <!--Dotted Line-->
							...
							<div class="styLNRightNumBox" style="height:8.1mm;width:6.6mm;padding-top:13.5mm;font-size:8pt;text-align:center;border-style:solid;   border-right-width:0px;border-left-width:1px;border-top-width:0px;border-bottom-width:0px;border-color:black;">38</div>
							<div class="styIRS2106ColBoxGrey" style="height:8mm;width:32.3mm;padding-top:14.3mm;border-left-width:1px;border-right-width:0px;   border-bottom-width:0px;"/>
							...
							<div class="styIRS2106ColBoxGrey" style="height:8.1mm;padding-top:14.3mm;border-left-width:1px;border-right-width:0px;   border-bottom-width:0px;"/>
							<div class="styIRS2106ColBox" style="height:8.1mm;padding-top:14.3mm;border-left-width:1px;border-right-width:0px;border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form2106Data/DepreciationOfVehiclesGrp[$pos + 1]/DepreciationOfVehicleAmt"/>
								</xsl:call-template>
					...
					<!-- End signature part -->
					<div style="width:187mm; height: 65mm; padding-top:.5mm; padding-bottom:.5mm; text-align:right; clear: all; float: left;">Form <span class="styBoldText" style="font-size:8pt;">
      2106  </span>(2014)</div>
					<!-- END of Page 2 -->
					<p class="pageend"/>

...
Department of the Treasury</div>
						...
						<!-- Begin Form Tax Year -->
						<div class="styFNBox" style="width:30mm;font-size:7pt;height:20mm;border-left-width: 1px; border-right-width: 0px;">
...
The amount on Form 1040, line 38; Form 1040A, line 22; or Form 1040NR, line 37 is more than $30,000/$45,000 (if head of <br/>
household; $60,000 if married filing jointly).<br/>
								<br/>
								<img src="{$ImagePath}/8880_Bullet_Round.gif" alt="Arrow Bullet"/> 
The person(s) who made the qualified contribution or elective deferral 
<b>(a)</b> 
was born after January 1, 1997,  
<b>(b)</b> is claimed as a<br/> 
dependent on someone else's 2014 tax return, or
...
Traditional and Roth IRA contributions for 2014.  <b> Do not </b>  include rollover contributions
<!--Dotted Line-->
					...
					<div style="width:187mm;clear:all">
						...
						<div class="styLNDesc" style="width:95.2mm;font-size:8pt;font-family:Arial;">
Elective deferrals to a 401(k) or other qualified employer plan, voluntary employee contributions, and 501(c)(18)(D) plan contributions for 2014 (see instructions)
<!--Dotted Line-->
							<span class="styDotLn" style="float:right;">...................</span>
						</div>
...
<!--Dotted Line-->
					...
					<div style="width:187mm;clear:all">
						...
						<div class="styLNDesc" style=" width:95.2mm;font-size:8pt;font-family:Arial;">
Certain distributions received <span class="styBoldText">after</span> 2011 and 
<span class="styBoldText">before</span> the due date<br/>
(including extensions) of your 2014 tax return (see instructions). If<br/>
...
<br/> separately, or   <br/> Qualifying widow(er)                          
								...
								<tr class="styDataCell">
									...
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center;"> $18,000</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;border-right:1px solid black">.5</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$18,000 </td>
								...
								<tr class="styDataCell">
									...
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$27,000</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;border-right:1px solid black">.1</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center"> $27,000	</td>
								...
								<tr class="styDataCell">
									...
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$36,000</td>
									<td style="text-align:center;">.5</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$36,000 </td>
								...
								<tr class="styDataCell">
									...
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$45,000</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell">
									<td style="border-right:0px solid black;border-left:1px solid black;text-align:center">$45,000	</td>
									<td style="border-right:1px solid black;border-left:1px solid black;text-align:center">$60,000</td>
									<td style="text-align:center;">.1</td>
									<td style="text-align:center;">.0</td>
									<td style="text-align:center;border-right:1px solid black">.0</td>
								</tr>
								<tr class="styDataCell:">
									<td style="border-right:0px solid black;border-left:1px solid black;border-bottom:1px solid black;text-align:center">$60,000	</td>
...
<span class="styBoldText">smaller </span> of line 10 or line 11<br/> here and on Form 1040, line 51; Form 1040A, line 34; or Form 1040NR, line 47.
<!--Dotted Line-->
							<span class="styDotLn" style="float:right;">........</span>
						</div>
...
Form </span>
							...
							<span style="font-size:6pt;">(2014)</span>
						</div>
					</div>
					<!--<br class="pageEnd"/>-->
					<!--END Page Footer-->

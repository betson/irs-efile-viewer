...
Complete if the organization answered "Yes" on Form 990, Part IV, line 25a or 25b, or Form 990-EZ, Part V, line 40b.
					...
					<!-- BEGIN Part I Table -->
					<div class="styTableContainerNBB" style="width:187mm;display:table;" id="IOSctn">
						<!-- print logic -->
				...
				<th class="styTableCellHeader" scope="col" style="border-style: solid; border-color: black;width:9mm;font-weight:bold;text-align:center;border-right-width:0px;border-bottom-width:1px;">No</th>
							...
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/DisqualifiedPersonExBnftTrGrp) &lt;= 10">
						...
						<td class="styTableCellCtr" style="border-style: solid; border-color: black;width:75mm;padding-right:0.75mm;border-bottom-width:0px;vertical-align:top;text-align:left;border-bottom-width:1px;">(<xsl:number value="position()" format="1"/>)
								...
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/DisqualifiedPersonExBnftTrGrp) &gt;10)) ">
									<tr>
										<td class="styTableCellCtr" style="border-style: solid; border-color: black;width:75mm;vertical-align:top;padding-right:0.75mm;border-bottom-width:1px;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/DisqualifiedPersonExBnftTrGrp/PersonNm"/>
											</xsl:call-template>
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="border-style: solid; border-color: black;width:35mm;vertical-align:bottom;padding-right:0.75mm;border-bottom-width:1px;">
											<span style="width:3px"/>
										</td>
								...
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 2 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 3 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 4 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 5 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 6 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 7 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 8 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 9 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/DisqualifiedPersonExBnftTrGrp) &lt; 10 or ((count($FormData/DisqualifiedPersonExBnftTrGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartITableFillerRow"/>
								</xsl:if>
							</tbody>
						</table>
        ...
        Complete if the organization answered "Yes" on Form 990-EZ, Part V, line 38a, or Form 990, Part IV, line 26; or if the organization reported an amount on Form 990, Part X, line 5, 6, or 22
					...
					<!-- END Part II Title -->
					<!-- BEGIN Part II Table -->
					<div class="styTableContainerNBB" id="IPRctn" style="height:auto;display:table;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt;10">
								...
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt;10)) ">
									<tr>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:40mm;vertical-align:bottom;padding-right:0.75mm;border-left-width:0px;border-bottom-width:1px;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
								...
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 2 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 3 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 4 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 5 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt;10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 6 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 7 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 8 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 9 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LoansBtwnOrgInterestedPrsnGrp) &lt; 10 or ((count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIITableFillerRow"/>
								</xsl:if>
								<tr>
									<td class="styTableCellCtr" scope="col" colspan="6" style="height:auto;border-style: solid; border-color: black;width:64mm;vertical-align:bottom;padding-right:0.5mm;border-right-width:0px;border-top-width:1px;">
									...
									<td class="styTableCell" style="height:auto;border-style: solid; border-color: black;width:35mm;vertical-align:bottom;border-top-width:1px;font-size:7pt;">
										<xsl:call-template name="PopulateAmount">
					...
					<!-- End Part II -->
					<!-- Part III -->
					<div class="styBB" style="height:auto;width:187mm;float:none;border-top:solid 1px;">
						<div class="styPartName" style="float:left;width:14mm;">Part III</div>
						<div class="styPartDesc" style="width:172mm;height:auto;">Grants or Assistance Benefiting Interested Persons.<br/>
         ...
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
					...
					<div class="styTableContainerNBB" id="OActn" style="height:auto;display:table;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt;= 10">
								...
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt;10)) ">
								...
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 2 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 3 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 4 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 5 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 6 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 7 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 8 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 9 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/GrntAsstBnftInterestedPrsnGrp) &lt; 10 or ((count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIIITableFillerRow"/>
								</xsl:if>
        ...
        Business Transactions Involving Interested Persons.<br/>
            ...
            Complete if the organization answered "Yes" on Form 990, Part IV, line 28a, 28b, or 28c.
					...
					<!-- END Part IV Title -->
					<!-- BEGIN Part IVTable -->
					<div class="styTableContainerNBB" id="ROActn" style="height:auto;display:table;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:if test="($Print != $Separated) or count($FormData/BusTrInvolveInterestedPrsnGrp) &lt;= 10">
								...
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 1 or (($Print = $Separated) and (count($FormData/BusTrInvolveInterestedPrsnGrp) &gt;10)) ">
									<tr>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:60mm;vertical-align:bottom;padding-right:0.75mm;border-left-width:0px;">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/BusTrInvolveInterestedPrsnGrp/NameOfInterested/PersonNm"/>
											</xsl:call-template>
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:32mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:30mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:45mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;">
											<span style="width:3px"/>
										</td>
										<td class="styTableCellCtr" style="height:auto;border-style: solid; border-color: black;width:8mm;vertical-align:top;padding-right:0.75mm;border-left-width:0px;border-right-width:1px;text-align:center;">
											<span style="width:3px"/>
								...
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 2 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 3 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 4 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 5 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 6 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
									<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 7 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
									<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 8 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
									<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 9 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
									<xsl:if test="count($FormData/BusTrInvolveInterestedPrsnGrp) &lt; 10 or ((count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10) and ($Print = $Separated))">
									<xsl:call-template name="IRS990SchLPartIVTableFillerRow"/>
								</xsl:if>
							</tbody>
						</table>
...
<span style="font-size:7pt;font-weight:normal">Provide additional information for responses to questions on Schedule L (see instructions).</span>
					...
					<div class="styTableContainer" style="width: 187mm; border-bottom-width: 2px;height:auto;display:table;" id="SUPctn">
						<xsl:call-template name="SetInitialState"/>
          ...
          Additional Data        
					...
					<br/>
					<!-- SRD For Part I -->
					<xsl:if test="($Print = $Separated) and count($FormData/DisqualifiedPersonExBnftTrGrp) &gt;= 10">
					...
					<br/>
					<!-- SRD For Part II -->
					<xsl:if test="($Print = $Separated) and count($FormData/LoansBtwnOrgInterestedPrsnGrp) &gt; 10">
					...
					<br/>
					<!-- SRD for Part III -->
					<xsl:if test="($Print = $Separated) and count($FormData/GrntAsstBnftInterestedPrsnGrp) &gt; 10">
				...
				<th class="styDepTblCell" scope="col" style="height:auto;width:62mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;border-right-width:0px">
					...
					<br/>
					<!-- SRD for Part IV -->
					<xsl:if test="($Print = $Separated) and count($FormData/BusTrInvolveInterestedPrsnGrp) &gt; 10">

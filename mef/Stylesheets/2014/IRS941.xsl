			...
			<body class="styBodyClass">
				<form name="IRS941">
				   ...
				   <div class="styTYBox" style="width:43.7mm;height:10mm;border:0px;">
					  <div style="font-size:12pt;font-family:Courier New;font-weight:bold;text-align:right;">950114</div>
					  <div class="styOMB" style="font-size:7pt;text-align:right;border:0px;padding-top:1mm;">OMB No. 1545-0029</div>
							...
							<div style="width:122mm;padding-bottom:0mm;">
								...
								<span class="styLNCtrNumBox" style="width:34.6mm;border-top-width:1px;padding-top:1mm;padding-left:1mm;text-align:left;height:6mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">Country</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:2mm;float:left;"/>
								<span class="styLNCtrNumBox" style="width:34.6mm;border-top-width:1px;padding-top:1mm;height:6mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">ProvinceOrState</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:2mm;float:left;"/>
								<span class="styLNCtrNumBox" style="width:34.4mm;border-top-width:1px;padding-top:1mm;height:6mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">PostalCode</xsl:with-param>
									</xsl:call-template>
								</span>
								<span style="width:108mm;font-size:6pt;padding-left:1mm;">
									<span style="width:36.6mm;">Foreign country name</span><span style="width:36.6mm;text-align:left;">Foreign province/county</span><span style="width:30mm;">Foreign postal code</span>
								</span>
								</span>
							</div>
						</div>
						...
						<div style="float:right;width:56mm;padding-right:2mm;">
							<div class="styBB" style="width:54mm;height:43mm;border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:2mm;">
								<div class="styPartName" style="width:49mm;text-align:left;padding-left:1mm;padding-top:0.4mm;padding-bottom:0.4mm;font-family:Arial Narrow;font-size:10pt;">Report for this Quarter of 2014<br/><span style="font-size:7pt;">(Check one.)</span></div>

      ...
      <body class="styBodyClass">
        <form name="IRS8839">
          ...
          <div style="width:187mm;" class="styBB">
            ...
            <div class="styPartDesc" style="padding-left:3mm;"><span style="float:left;">
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 7 more than $197,880?<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  <span>
                  ...
                  <label>
                    ...
                    <span style="width:5px;"/>Subtract $197,880 from line 7
                      <!--Dotted Line-->
                    <span class="styBoldText">
                      <span style="width:10px"/>.
                        <span style="width:11px"/>.
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Credit carryforward, if any, from prior years. See your Adoption Credit Carryforward Worksheet in the<br/>2013 Form 8839 instructions
                  <!--Dotted Line-->
                  <span class="styBoldText">
                    <span style="width:11px"/>.
                    <span style="width:11px"/>.
              ...
              <div class="styIRS8839LNDesc" style="height:100%;width:37mm;float:right;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="height:auto;width:37mm;float:right;padding:0px 0px 0px 0px;">
                  <xsl:call-template name="CreateBox">
                    ...
                    <xsl:with-param name="AmountBoxStyle">border-bottom-width:0px;padding-top:4.4mm;</xsl:with-param>
                    <xsl:with-param name="NumberBoxStyle">border-bottom-width:0px;padding-top:4.4mm;padding-bottom:.5mm;</xsl:with-param>
                  </xsl:call-template>
                </div>
              </div>
            </div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;clear:all;">
            ...
            <div style="float:right;clear:all;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8pt;">8839</span> (2014)
            </div>
          ...
          <span class="styBoldText">
            ...
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Is line 23 more than $197,880?<br/>
                  <!-- ++++++++++++++ No Checkbox +++++++++++++ -->
                  ...
                  <label>
                    ...
                    <span class="styBoldText">Yes.</span>
                    <span style="width:4px;"/>Subtract $197,880 from line<br/>
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:88%;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You paid adoption expenses in 2013, those expenses were not fully reimbursed by your employer or otherwise, and<br/>
                  <span style="width:7px;"/>the adoption was not final by the end of 2013.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>The total adoption expenses you paid in 2014 were not fully reimbursed by your employer or otherwise, and the<br/>
                  <span style="width:7px;"/>adoption became final in 2014 or earlier.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 5px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/>You adopted a child with special needs and the adoption became final in 2014.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;clear:all;">
            <div style="float:right;">
              ...
              Form<span class="styBoldText" style="font-size:7pt;"> 8839 </span>(2014)
            </div>
          </div>
          <!-- END Page Break and Footer-->
  ...
  <xsl:template name="CreateTableHeaders">
    ...
    <tr>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        ...
        <br/>Check if<br/>adoption<br/>became final in 2014 or earlier</th>
    </tr>
    <tr>
      <xsl:if test="$AddColoredHeaders">
        <xsl:attribute name="class">styDepTblHdr</xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="2">
        ...
        <br/>born <b>before<br/>1997</b> and<br/>disabled</th>
      <th class="styTableCellHeader" scope="col" rowspan="2">
        <xsl:attribute name="style">
          border-color:black;width:8%;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="width:47mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          ...
          benefits you received in 2014.<br/>
          This amount should be shown<br/>
          in box 12 of your 2014 Form(s)<br/>
          W-2 with code <b>T</b>
          <!--Dotted Line-->
          <span class="styBoldText">
            <span style="width:14px"/>.
    ...
    <div class="styIRS8839LineItem">
      ...
      <div class="styIRS8839LNDesc" style="width:47mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          ...
          adoption became final in 2014,<br/>

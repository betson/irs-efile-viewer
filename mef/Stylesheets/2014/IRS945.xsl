			...
			<body class="styBodyClass">
				<form name="Form945">
					...
					<div class="styBB" style="width:187mm;height:20mm;">
						<div class="styFNBox" style="width:29mm;height:22mm;">Form <span class="styFormNumber">945</span>
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$FormData"/>
							</xsl:call-template>
							<br/>
							<div class="styAgency" style="font-size:7.5pt;vertical-align:bottom;padding-top:4mm;">Department of the Treasury<br/>Internal Revenue Service
							</div>
						</div>
						<div class="styFTBox" style="width:128mm;height:20mm; ">
							...
							<div class="styFBT" style="height:3mm;margin-top:2mm;font:size:6pt;width:128mm;">
								...
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/> For more information on income tax withholding, see Pub. 15 
									<br/>(Circ. E) and Pub. 15-A.<br/>
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/> Information about Form 945 and its separate instructions is at
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form945" title="Link to IRS.gov"><i>www.irs.gov/form945</i>.</a>
								<br/>
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:22mm;">
							<div class="styOMB" style="height:8mm;padding-top:2mm;">OMB No. 1545-1430 </div>
							<div class="styTY" style="padding-top:2mm;">20<span class="styTYColor">14</span>
							</div>
						</div>
					</div>
					<div class="styBB" style="width:187mm;">
						<div class="styGenericDiv" style="width:28.8mm;height:40mm;text-align:center;padding-top:10mm;font-weight:bold;font-size:10pt;">
						...
						<div class="styGenericDiv" style="width:128.5mm;border-right:1px solid black;border-left:1px solid black;">
							<div class="styGenericDiv" style="width:127.9mm;height:10mm;border-bottom:1px solid black;">
								<div class="styGenericDiv" style="width:70mm;height:10mm;padding-left:2mm;border-right:1px solid black;">Name (as distinguished from trade name)<br/>
								...
								<div class="styGenericDiv" style="width:55mm;height:10mm;padding-left:2mm;">Employer identification number (EIN)<br/>
									<br/>
						...
						<div class="styGenericDiv" style="width:29.5mm;height:30mm;padding-left:3mm;padding-top:3mm;">
							<span class="styBoldText">If address is<br/>different<br/>from prior<br/>return, check<br/>here. </span>
					...
					<div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom:2mm;">
						...
						<div class="styLNDesc" style="width:142.8mm;">
							...
							<span style="width:3mm;"/>
							<span style="">and enter date final payments made. </span>
							<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
						</div>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styLNDesc" style="width:138.8mm;">Total deposits for 2014, including overpayment applied from a prior year and overpayment applied from<br/>
					...
					<div style="width:187mm;padding-bottom:3mm;">
						...
						<div class="styGenericDiv" style="width:182mm;float:left;">
							<span style="float:left;padding-right:2mm;">
								<b>• Semiweekly schedule depositors:</b> Complete <b>Form 945-A</b> and check here </span>
							<!--Dotted Line-->
						...
						<div class="styGenericDiv" style="width:182mm;float:left">
							<span style="float:left;padding-right:2mm;">
								<b>• Monthly schedule depositors:</b> Complete <b>line 7, entries A through M,</b> and check here</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:left;padding-left:2mm;padding-right:1mm;">...............</span>
							<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;border:2px solid black;">
						...
						<div class="styGenericDiv" style="width:187mm;height:27mm;">
							...
							<div class="styIRS945MonthlyBGrp" style="width:62.8mm;float:right;">
								...
								<div class="styIRS945MonthCAmt" style="font-size:8px;text-align:center;padding-top:.75mm;">
									<b>Tax liability for month</b>
								</div>
								<div class="styIRS945MonthBNm" style="width:32.8mm;">
								...
								<div class="styIRS945MonthCAmt" style="border-bottom:0px;height:13.5mm;padding-top:10mm;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="height:9mm;float:left;clear:none;width:172mm;padding-top:2mm;">
							<div style="height:7mm;float:left;clear:none;width:18mm;padding-left:2mm;font-weight:bold;font-size:6pt;">Designee's name
								<span style="width:2px;"/>
							...
							<div style="float:right;clear:none;width:35mm;padding-left:.5mm;font-weight:bold;font-size:6pt;">Personal identification<br/>number (PIN)
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="height:15mm;float:left;clear:none;width:172mm;padding-top:2mm;">
							...
							<div style="height:5mm;width:25mm;float:right;clear:none;padding-top:9mm;">
							...
							<div style="float:right;clear:none;width:auto;padding-left:.5mm;font-weight:bold;font-size:6pt;padding-top:9mm;">Date
								<span style="width:2mm;"/>
								<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
							</div>
						</div>
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						...
						<div style="width:164mm;float:left;clear:none;">
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;border-leftright:1px;">
								...
								<div class="styLNDesc" style="height:6mm;width:46.5mm;padding-top:0mm;border-right:1 solid black;padding-left:1mm;">Preparer's signature 
								</div>
								...
								<div class="styLNDesc" style="height:6mm;width:26mm;padding-top:0mm;padding-left:1mm;">PTIN <br/>
									<span style="width:6mm;"/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText" style="font-size:8pt;">945 </span> (2014)
						</div>
						<div style="float:right;text-align:center;width:26mm;font-size:7pt;">Cat. No. 14584B </div>
					</div>

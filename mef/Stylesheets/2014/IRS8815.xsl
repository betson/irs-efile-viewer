				...
				<form name="Form8815">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:30mm;height:22.2mm;">
							<div class="styOMB" style="height:1mm;padding-bottom:4mm;">
								OMB No. 1545-0074
							</div>
					...
					<div class="styBB" style="width:187mm;float:none;clear:none;clear:all;">
						...
						<div class="styEINBox" style="width:50mm;height:4mm;padding-left:2mm;font-size:7pt;font-weight:bold;">
							...
							<span style="width:27mm;text-align:left;font-weight:normal;padding-top:2mm;">
						...
						<table style="width:182mm;border-collapse:collapse;font-size:7pt;">
							<thead>
								<th scope="col" style="width:91mm;font-weight:normal;border:1px solid black;border-left:none;border-top:none;">
									<div style="font-weight:bold;float:left;padding-left:2mm;">1</div><b>(a)</b><br/>Name of person (you, your spouse, or your dependent) who <br/>was enrolled at or attended an eligible educational institution
								</th>
							...
							<tbody>
								<tr>
									<td style="border:1px solid black;border-left:none;padding-top:8mm;">
										<xsl:choose>
									...
									<td style="border:1px solid black;border-right:none;height:4.5mm;padding-top:1mm;">
										<div style="border-bottom:1px dashed black;width:94mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">
												...
												<xsl:call-template name="LinkToLeftoverDataTableInline">
													<xsl:with-param name="Desc">Line1b-Qualified Tuition Program Code</xsl:with-param>
												...
												<xsl:call-template name="LinkToLeftoverDataTableInline">
													<xsl:with-param name="Desc">Line1b-Covered IIE Savings Account Code</xsl:with-param>
										...
										<div style="height:6.5mm;padding-top:1mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">
												<xsl:call-template name="PopulateText">
								...
								<tr>
									<td style="border:1px solid black;border-left:none;padding-top:7mm;">
										<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">
											<xsl:call-template name="PopulateText">
									...
									<td style="border:1px solid black;border-right:none;">
										<div style="border-bottom:1px dashed black;width:94mm;height:4.5mm;padding-top:1mm;">
											<xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/EligibleEducationInstnGrp) &lt; 4)">
												<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;">
						<div style="width:187mm;">
							...
							Enter the total qualified higher education expenses you paid in 2014 for the person(s) listed in
column (a) of line 1. See the instructions to find out which expenses qualify<span style="letter-spacing:3mm;">.................</span>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:141mm;height:8mm;">Enter the total of any nontaxable educational benefits (such as nontaxable scholarship or fellowship grants) received for 2014 for the person(s) listed in column (a) of line 1 (see instructions)<span style="letter-spacing:3mm;">.........</span></div>
...
after 1989</span> that you <span style="font-weight:bold">cashed during 2014</span><span style="letter-spacing:3mm;">..........................</span></div>
...
5. Enter the result as a decimal (rounded to at least three places)<span style="letter-spacing:3mm;">.................</span></div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:101mm;height:12mm;padding-right:4px;overflow:hidden;"><span style="font-weight:bold;">Note: </span> <i> If line 9 is $91,000 or more if single or head of household, or $143,950 or more if married filing jointly or qualifying widow(er) with dependent child, <b>stop</b>. You <b>cannot</b> take the exclusion.</i></div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:101mm;height:8mm;">Enter: $76,000 if single or head of household; $113,950 if married filing
...
<br/>places)<span style="letter-spacing:3mm;">.................................</span>
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt; border-top:1 solid black; padding-top:0.5mm;clear:all;">
						...
						Form <b style="font-size:9pt">8815</b> (2014)
						</div>
					</div>

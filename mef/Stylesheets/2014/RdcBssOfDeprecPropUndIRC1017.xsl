...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="FormData" select="$RtnDoc/RdcBssOfDeprecPropUndIRC1017"/>
  <!-- Display Name 982_Election to reduce the basis of depreciable property under Internal Revenue Code Section 1017--> 

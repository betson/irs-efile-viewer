...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ReconciledOtherAdjustmentsSch"/>
  
  <!-- Template to display Reconciled Other Adjustments Schedule  -->
  
  <xsl:template name="ShowDependencyData">
    <!-- Reconciled Other Adjustments Schedule Data -->
    <table class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/RecnclOtherAdjPrtshpItemGrp">
          <tr>

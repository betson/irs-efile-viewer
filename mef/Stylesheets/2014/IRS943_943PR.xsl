...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="FormDetailsText">
		<xsl:choose>
			...
			<xsl:otherwise>Puede encontrar informaci&amp;#243;n, sobre el Formulario 943-PR y sus&lt;br/&gt;instrucciones separadas en</xsl:otherwise>
	...
	<xsl:variable name="Line3Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Social security tax (multiply line 2 by 12.4% (.124))&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Contribuci&amp;#243;n al Seguro Social (multiplique la l&amp;#237;nea &lt;b&gt;2&lt;/b&gt; por el 12.4% (.124))&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line5Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Medicare tax (multiply line 4 by 2.9% (.029))&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Contribuci&amp;#243;n al &lt;i&gt;Medicare&lt;/i&gt; (multiplique la l&amp;#237;nea &lt;b&gt;4&lt;/b&gt; por el 2.9% (.029))&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line7Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Additional Medicare Tax withholding (multiply line 6 by 0.9% (.009))&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Retenci&amp;#243;n de la Contributi&amp;#243;n Adicional al &lt;i&gt;Medicare&lt;/i&gt;
				 (multiplique la línea &lt;b&gt;6&lt;/b&gt; por 0.9% (.009))&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line12Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2014, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2014, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<!-- 7/14/14 AM: Lines 13a,13b, and 14 shaded and reserved based on UWR 111271-->
	<xsl:variable name="Line13aText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Reservado&lt;/i&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Reservado&lt;/b&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line15Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;&lt;b&gt;Balance due.&lt;/b&gt; If line 11 is more than 12, enter the difference and see the instructions&lt;/span&gt;</xsl:when>
	...
	<xsl:variable name="CatNoText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Cat. No. 17029B</xsl:when>
			...
			<body class="styBodyClass">
				<form name="Form943">
						...
						<div class="styFNBox" style="width:128mm;border-left:0px solid black;border-right:0px solid black;">
							...
							<xsl:if test="$Language='ENGLISH'">
								<div class="styGenericDiv" style="width:128mm;height:5mm;padding-left:2mm;border-top:1px solid black;">
									<span style="float:left;padding-top:1.5mm;">If you do not have to file returns in the future, check here </span>
									<!--Dotted Line-->
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styLNAmountBox" style="font-size:6pt;background-color:lightgrey;width:30mm;"/>
						<div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;border-top-width:0px;"/>
						<div class="styLNAmountBox" style="background-color:lightgrey;border-bottom-width:0px; border-top-width:0px;width:30mm;"/>
					</div>
					<!-- END LINE 13b -->
					<!-- BEGIN LINE 14 -->
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styBB" style="width:187mm;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:84mm;float:left;font-size:6.5pt;">
								<span style="font-size:7pt;">
									<b>Overpayment.</b>
								</span> If line 12 is more than line 11, enter the difference 
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
								<span>$</span>
							</div>
						...
						<div class="styBB" style="width:187mm;padding-bottom:.5mm;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:141mm;float:left;">
								<span style="float:left;">
									<b>Cantidad pagada en exceso.</b> Si la línea <b>12</b> es mayor que la línea <b>11</b>, anote la diferencia</span>
								<!--Dotted Line-->
								<img style="float:right;padding-right:3.0mm;padding-top:.5mm;" src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
								<span class="styDotLn" style="float:right;">.....</span>
							</div>

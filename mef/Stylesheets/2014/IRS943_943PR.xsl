...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="AddressDifferentText">
		<xsl:choose>
			...
			<xsl:otherwise>Si su direcci&amp;#243;n no&lt;br/&gt;es la misma que&lt;br/&gt;apareci&amp;#243;&lt;br/&gt;en su planilla&lt;br/&gt;
				anterior, marque&lt;br/&gt;esta casilla</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line1Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Number of agricultural employees employed in the pay period that includes March 12, 2014</xsl:when>
			<xsl:otherwise>N&amp;#250;mero de empleados agr&amp;#237;colas durante el período de n&amp;#243;mina que incluye el 12 de marzo de 2014</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line7Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Retenci&amp;#243;n de la Contributi&amp;#243;n Adicional al &lt;i&gt;Medicare&lt;/i&gt;
				 (multiplique la línea &lt;b&gt;6&lt;/b&gt; por 0.9% (.009))&lt;/span&gt;&lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="4"/>
				</xsl:call-template>&lt;/span&gt;
			</xsl:otherwise>
	...
	<xsl:variable name="Line8Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;div style="float:left;width:98%;background-color:lightgrey"&gt;&lt;/div&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line12Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2014, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;
				&lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="4"/>
				</xsl:call-template>&lt;/span&gt;
			</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2014, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;
				&lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
	...
	<!-- 7/14/14 AM: Lines 13a,13b, and 14 shaded and reserved based on UWR 111271-->
	<xsl:variable name="Line13aText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved&lt;/span&gt;
						  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="26"/>
				</xsl:call-template>&lt;/span&gt;
			</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Reservado&lt;/i&gt;&lt;/span&gt;
						  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="26"/>
				</xsl:call-template>&lt;/span&gt;
	...
	<xsl:variable name="Line14Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Reservado&lt;/b&gt;&lt;/span&gt;
						  &lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="26"/>
				</xsl:call-template>&lt;/span&gt;
	...
	<xsl:variable name="Line15Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;&lt;b&gt;Balance due.&lt;/b&gt; If line 11 is more than 12, enter the difference and see the instructions&lt;/span&gt;
				&lt;span class="styBoldText" style="float:right;font-size:7pt;padding-right:10px;"&gt;
				<xsl:call-template name="DotLoop">					
					<xsl:with-param name="DotQty" select="5"/>
				</xsl:call-template>&lt;/span&gt;
			</xsl:when>
			<xsl:otherwise>&lt;b&gt;Saldo adeudado.&lt;/b&gt; Si la l&amp;#237;nea &lt;b&gt;11&lt;/b&gt; es mayor que la l&amp;#237;nea &lt;b&gt;12&lt;/b&gt;, anote la diferencia y vea las instrucciones</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="AllFilersText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;b&gt;All filers:&lt;/b&gt; If line 11 is less than $2,500, &lt;b&gt;do not&lt;/b&gt; complete line 17 &lt;b&gt;or&lt;/b&gt; Form 943-A.
			</xsl:when>
	...
	<xsl:variable name="SignHereText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="font-size:9pt;text-align:center;width:100%"&gt;Firme&lt;br/&gt;Aqu&amp;#237;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="EnglishPageBreakAfter">
		<xsl:choose>
			<xsl:when test="$Language='SPANISH'"></xsl:when>
			<xsl:otherwise>page-break-after:always;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>	
	<xsl:template match="/">
				...
				<form name="Form943">
					...
					<div class="styBB" style="width:187mm;height:21mm;float:none;clear:both;">
						<div class="styFNBox" style="width:29mm;height:21mm;">
							...
							<div class="styAgency" style="font-size:7.5pt;vertical-align:bottom">Department of the Treasury<br/>
								Internal Revenue Service
							</div>
						</div>
						<div class="styFTBox" style="width:128mm;height:21mm; ">
							<div class="styMainTitle" style="height:4mm;padding-top:2mm;">
								<xsl:value-of disable-output-escaping="yes" select="$FormNameText" />
							</div>
							<xsl:if test="$Language='ENGLISH'">      
								<div class="styFBT" style="height:3mm;margin-top:4mm;font:size:6pt;width:128mm;">
									<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
									<xsl:value-of disable-output-escaping="yes" select="$FormDetailsText" />
									<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form943" title="Link to IRS.gov"><i>www.irs.gov/form943</i>.</a><br/>                  
								</div>
							</xsl:if>
							<xsl:if test="$Language='SPANISH'">
								<div class="styFBT" style="height:3mm;margin-top:4mm;font:size:6pt;width:128mm;">
									<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
									<xsl:value-of disable-output-escaping="yes" select="$FormDetailsText" /><br/>
								</div>
							</xsl:if>
						</div>
					...
					<div class="styBB" style="width:187mm;float:none;clear:both;">
						<div class="styGenericDiv" style="width:28.8mm;height:{$PrintTypeHeight};padding-top:{$PrintTypePadding}mm;">
							<b><xsl:value-of disable-output-escaping="yes" select="$PrintTypeText" /></b>
						</div>
						<div class="styGenericDiv" style="width:128mm;border-right:1px solid black;border-left:1px solid black;">
							<div class="styGenericDiv" style="width:128mm;border-bottom:1px solid black;">
								<div class="styGenericDiv" style="width:70mm;height:9mm;padding-left:2mm;border-right:1px solid black;">
								...
								<div class="styGenericDiv" style="width:55mm;padding-left:2mm;">
									<xsl:value-of disable-output-escaping="yes" select="$EINText" /><br/><br/>
							...
							<div class="styGenericDiv" style="width:127.9mm;height:10mm;border-bottom:1px solid black;padding-left:2mm;">
								...
								<xsl:if test="$RtnHdrData/Filer/TradeName/BusinessNameLine2Txt"><br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/TradeName/BusinessNameLine2Txt"/>
									</xsl:call-template>
								</xsl:if>			
							</div>	
							<div class="styGenericDiv" style="width:127.9mm;height:10mm;padding-left:2mm;">
								<xsl:value-of disable-output-escaping="yes" select="$AddressText" /><br/>
							...
							<div class="styGenericDiv" style="width:127.7mm;height:10mm;padding-left:2mm;border-top:1px solid black;">
								<xsl:value-of disable-output-escaping="yes" select="$CityStateZipText" /><br/>
								<xsl:if test="$RtnHdrData/Filer/USAddress">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<xsl:if test="$Language='ENGLISH'">               
								<div class="styGenericDiv" style="width:127.7mm;height:11mm;padding-left:2mm;padding-top:4mm;border-top:1px solid black;">
									<span style="float:left;">If you do not have to file returns in the future, check here </span>
									<!--Dotted Line-->
						...
						<div class="styGenericDiv" style="width:29.4mm;height:{$PrintTypeHeight};padding-left:3mm;padding-top:3mm;">
					...
					<!-- END LINE 12 -->
					<!-- 7/14/14 AM: R9.5D3 - Lines 13a,13b, and 14 shaded and reserved based on UWR 111271-->
					<!-- BEGIN LINE 13a -->
					<xsl:if test="$Language='ENGLISH'">
						<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
							...
							<div class="styLNAmountBox" style="border-bottom-width:0px;background-color:darkgray"/>
						</div>                   
					</xsl:if>
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						<div class="styLNLeftNumBox">13a</div>
						<div class="styLNDesc" style="width:138.8mm;font-weight:bold">
							<xsl:value-of disable-output-escaping="yes" select="$Line13aText" />
						</div>
						<div class="styLNRightNumBox" style="height:4.4mm;">13a</div>
						<div class="styLNAmountBox" style="font-size:6pt;height:4.4mm;background-color:darkgray">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.85mm;font-weight:bold">
							<xsl:value-of disable-output-escaping="yes" select="$Line13bText" />
						</div>
						<div class="styLNRightNumBox">13b</div>
						<div class="styLNAmountBox" style="background-color:darkgray">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/COBRAAssistanceGrp/COBRAPremiumSubsidyRcpntCnt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="height:4.4mm;width:7.95mm;background-color:lightgrey;border-bottom-width:0px;border-top-width:0px;" />
						<div class="styLNAmountBox" style="height:4.4mm;border-bottom-width:0px; border-top-width:0px;background-color:darkgray" />
					</div>
					<!-- END LINE 13b -->
					<!-- BEGIN LINE 14 -->
					<xsl:if test="$Language='ENGLISH'">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styGenericDiv" style="padding-top:1mm;padding-right:2px;">
							<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
						</div>
					...
					<xsl:if test="$Language='ENGLISH'">           
						<div class="styBB" style="width:187mm;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:85mm;float:left;font-size:6pt;">
								<span style="font-size:7pt;"><b>Overpayment.</b></span> If line 12 is more than line 11, enter the difference 
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
								<span>$</span>
							</div>
							<div class="styLNDesc" style="width:20mm;text-align:right;float:left;font-size:6pt;padding-top:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/OverpaymentGrp/OverpaidAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNDesc" style="width:71mm;float:right;">
					...
					<xsl:if test="$Language='SPANISH'">              
						<div class="styBB" style="width:187mm;float:none;clear:both;">          
							...
							<div class="styLNDesc" style="width:141mm;float:left;">
								<span style="float:left;"><b>Cantidad pagada en exceso.</b> Si la línea <b>12</b> es mayor que la línea <b>11</b>, anote la diferencia</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:left;padding-left:2mm;padding-right:1mm;">.....</span>
								<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/> $
							</div>
							...
							<div class="styGenericDiv" style="width:95mm;float:left;padding-top:1mm;">
								...
								<div style="float:left;font-size:6pt;">
									...
									<span style="padding-left:2px;padding-right:2px;">
										...
										<!--Dotted Line-->
										<span style="font-weight:bold;letter-spacing:3.3mm;padding-right:1mm;padding-left:3mm;">.........</span>
										<img src="{$ImagePath}/1040PR_Bullet_Sm.gif"  alt="Bullet Image"/>
									</span>
									<input type="checkbox" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styGenericDiv" style="width:187mm;border:2px solid black;float:none;clear:both;"> 
						...
						<div class="styGenericDiv" style="width:187mm;height:27mm;">
							...
							<div class="styIRS943MonthlyGrp">
								...
								<div class="styIRS943MonthAmt" style="font-size:8px;text-align:center;padding-top:.75mm;">
									<b><xsl:value-of disable-output-escaping="yes" select="$TaxLiabilityMonthText" /></b>
								</div>
							...
							<div class="styIRS943MonthlyBGrp">
								...
								<div class="styIRS943MonthBAmt" style="font-size:8px;text-align:center;padding-top:.75mm;">
									<b><xsl:value-of disable-output-escaping="yes" select="$TaxLiabilityMonthText" /></b>
								</div>
							...
							<div class="styIRS943MonthlyBGrp" style="width:62.8mm;">
								...
								<div class="styIRS943MonthCAmt" style="float:right;font-size:8px;text-align:center;padding-top:.75mm;">
									<b><xsl:value-of disable-output-escaping="yes" select="$TaxLiabilityMonthText" /></b>
								</div>
								<div class="styIRS943MonthBNm" style="width:32.8mm;float:left;">
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="width:165.5mm;float:left;clear:none;border-left:1px solid black;">
							<div style="width:165.5mm;float:left;clear:none;padding-top:.5mm;">
								<div style="font-size:6pt;float:left;clear:none;padding-left:2mm;">
									<xsl:value-of disable-output-escaping="yes" select="$DiscussText" />
								</div>
								<div style="float:left;clear:none;padding-left:7mm;font-size:6pt;">
									<!--  Yes Checkbox -->
									<input type="Checkbox" class="styCkbox">
							...
							<div style="height:9mm;float:left;clear:none;width:165.5mm;padding-top:2mm;">
								<div style="height:7mm;float:left;clear:none;width:auto;padding-left:2mm;font-weight:bold;font-size:6pt;padding-top:3mm;">
								...
								<div style="width:41mm;float:left;clear:none;padding-top:2mm;">
									<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;{$SpanishPageBreakAfter};{$EnglishPageBreakAfter}">
						<div style="width:21mm;height:18mm;float:left;clear:none;padding-top:3.5mm;">
							<span class="styMainTitle" style="font-size:15pt;">
								<xsl:value-of disable-output-escaping="yes" select="$SignHereText" />
							</span>
						</div>
						<div style="float:left;clear:none;width:165.5mm;padding-top:.5mm;border-left:1px solid black;">
							<div style="float:left;clear:none;width:165.5mm;padding-top:.5mm;">
								<div style="font-size:6pt;float:left;clear:none;padding-left:2mm;">
									<xsl:value-of disable-output-escaping="yes" select="$PenaltiesText" />
								</div>				
							</div>
							<div style="height:2mm;float:left;clear:none;width:164.5mm;">
								<div style="height:2mm;float:left;clear:none;width:18mm;padding-left:2mm;font-weight:bold;font-size:6pt;padding-top:{$SignHere1Padding}mm;">
									<xsl:value-of disable-output-escaping="yes" select="$SignatureText" />
									<span style="width:2px;"/>
									<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
								</div>
								<div style="width:33mm;float:left;clear:none;padding-top:{$SignHere1Padding}mm;">
									<xsl:call-template name="PopulatePin">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div style="width:21mm;height:18.5mm;padding-top:1mm;float:left;clear:none;">
							<span class="styMainTitle" style="font-size:9.5pt;">
								<xsl:value-of disable-output-escaping="yes" select="$PaidPreparerText" />
							</span>
						</div>
						<div style="width:165.5mm;border-left:1px solid black;float:left;clear:none;">
							<div style="width:165.5mm;height:100%;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">							
								<div class="styLNDesc" style="height:100%;width:46.95mm;padding-top:0mm;border-right:1 solid black;padding-left:1mm;">
								...
								<div class="styLNDesc" style="height:100%;width:15mm;border-right:1 solid black;padding-top:0mm;padding-left:1mm;">
									<xsl:value-of disable-output-escaping="yes" select="$DateText" /> <br/>
									<xsl:call-template name="PopulateMonthDayYear">
								...
								<div class="styLNDesc" style="height:auto;width:25mm;border-right:1 solid black;padding-top:.5mm;padding-bottom:0mm;padding-left:1mm;">
									<label>
										...
										<span style="width:4.5px;"/><xsl:value-of disable-output-escaping="yes" select="$SelfEmployedText" />
									</label>
								</div>								
								<div class="styLNDesc" style="height:6mm;width:26mm;padding-top:0mm;padding-left:1mm;">
									...
									<xsl:if test="$Language='ENGLISH'">PTIN</xsl:if><br/>
							...
							<div style="width:165.5mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:6mm;width:108.5mm;border-right:1 solid black;padding-left:1mm;">
									...
									<div class="styGenericDiv" style="padding-right:.5mm;">
										...
										<xsl:if test="$RtnHdrData/PaidPreparerInformationGrp/PreparerFirmName/BusinessNameLine2Txt"><br/>
											<xsl:call-template name="PopulateText">
							...
							<div style="width:165.5mm;float:left;clear:none;">
								<div class="styLNDesc" style="width:108.5mm;padding-left:1mm;border-right:1 solid black;height:6mm;">
									<div class="styGenericDiv" style="padding-right:.5mm;">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							<xsl:value-of disable-output-escaping="yes" select="$RevText" />2014)
						</div>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/IncomeLossUSPartnershipsSch"/>
  
  <!-- Template to display Income Loss From US Partnerships Schedule -->
  
  <xsl:template name="ShowDependencyData">
    <!-- Income Loss From US Partnerships Schedule Data -->
    <table class="styDepTbl" style="font-size:6pt">
      <thead class="styTableThead">
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/IncmLossFromUSPrtshpItemGrp">
          <tr>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ItemizedOtherDecreasesSchedule"/>
  ...
  <xsl:template name="ItemizedOtherDecreasesScheduleTemp">
    <table id="ItemizedOtherDecreasesScheduleTbl" class="styDepTbl" style="font-size:7pt;">
      ...
      <xsl:for-each select="$DependencyData/ItemizedOtherDecreases">
        <tr>
    ...
    <html>
      ...
      <body class="styBodyClass">
        <xsl:call-template name="DocumentHeaderDependency"/>          
          ...
          <xsl:call-template name="ItemizedOtherDecreasesScheduleTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
					...
					<tr>
						<td style="width: 93mm;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td class="IRS1041ScheduleK1_tdLeft" style="height:11mm;border:black solid 1px; border-left-width:2px;border-right-width:0px;">
										<!-- PART II Line H -->
						...
						<td style="width: 94mm;" valign="top">
						  ...
						  border-right: 2px solid black;">
								...
								<tr>
									<td colspan="2" style="height:46.5mm;border-bottom:1px solid black;padding-top:2mm;">
										<!-- IRS Use Only box -->

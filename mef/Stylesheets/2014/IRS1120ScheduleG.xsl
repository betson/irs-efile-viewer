                ...
                power of all classes of the corporation’s stock entitled to vote (see instructions).
					...
					<div>
						...
						<div class="IRS1120ScheduleG_styTableContainer" id="EntityInformationTableContainer">
							...
							<table class="IRS1120ScheduleG_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 1 or                      ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 2 or                        ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
										<td class="IRS1120ScheduleG_styTableCellA">
											<span style="width: 4px"/>
										</td>
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 3 or                       ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
										<td class="IRS1120ScheduleG_styTableCellA">
											<span style="width: 4px"/>
										</td>
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 4 or                       ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
										<td class="IRS1120ScheduleG_styTableCellA">
											<span style="width: 4px"/>
										</td>
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 5 or                       ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
										<td class="IRS1120ScheduleG_styTableCellA">
											<span style="width: 4px"/>
										</td>
								...
								<xsl:if test="count($FormData/EntityInformation) &lt; 6 or                       ((count($FormData/EntityInformation) &gt; 6) and ($Print = $Separated))">
									<tr>
					...
					<div class="IRS1120ScheduleG_styTableContainer" id="IndividualInformationTableContainer">
						...
						<table class="IRS1120ScheduleG_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 1 or                        ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA">
										<span class="IRS1120ScheduleG_styLN" style="font-size:8pt"/>
										<xsl:call-template name="PopulateAdditionalDataTableMessage">
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 2 or                        ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA">
										<span style="width: 4px"/>
									</td>
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 3 or                        ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA">
										<span style="width: 4px"/>
									</td>
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 4 or                       ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA">
										<span style="width: 4px"/>
									</td>
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 5 or                       ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA">
										<span style="width: 4px"/>
									</td>
							...
							<xsl:if test="count($FormData/IndividualInformation) &lt; 6 or                       ((count($FormData/IndividualInformation) &gt; 6) and ($Print = $Separated))">
								<tr>
									<td class="IRS1120ScheduleG_styTableCellA" style="border-bottom-width:0px">
										<span style="width: 4px"/>
									</td>

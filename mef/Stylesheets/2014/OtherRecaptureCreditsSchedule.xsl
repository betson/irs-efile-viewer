...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/OtherRecaptureCreditsSchedule"/>
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl">
      ...
      <tr class="styDepTblHdr">         
         ...
         <th class="styDepTblCell" scope="col" style="width: 40mm">Amount of Income</th>  
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/OtherRecaptureCreditsInfo">
        <tr>

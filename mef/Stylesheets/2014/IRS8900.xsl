		...
		<html>
			...
			<body class="styBodyClass">
				<form id="Form8900" style="font-family:verdana; font-size:7pt">
					...
					<div class="styBB" style="width:187mm;clear:both;float:none;">
						<div class="styFNBox" style="width:31mm;height:23.7mm;">
            Form <span class="styFormNumber">8900</span>
						...
						<div class="styFTBox" style="width:125mm;">
							...
							<div class="styFST" style="padding-top:.5mm;font-weight:bold;">
								<img src="{$ImagePath}/8900_Bullet.gif" alt="bullet image"/>Information about Form 8900
								 and its separate instructions is at								
								<a href="http://www.irs.gov/form8900" title="Link to IRS.gov">
									<i>www.irs.gov/form8900.</i>
								</a>
							</div>
						</div>
						<div class="styTYBox" style="width:31mm;height:23.7mm;">
                  ...
                  lessee for purposes of this credit. See instructions for more 
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;padding-top: 0mm;padding-bottom:0mm;"/>
							<div class="styLNDesc" style="width:93mm;padding-top: 0mm;padding-bottom:0mm;">
								<span style="float:left;"> information, including required statement
                  <!--Push Pin image -Form to Form Link -->
									<xsl:call-template name="SetFormLinkInline">

...
">
        ...
        Name(s) shown on return<br/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Did you pay premiums during your tax year for employee health insurance coverage you provided through a Small Business Health Options Program
(SHOP) Marketplace (or do you qualify for an exception to this requirement)?  (see instructions)<br/>
  ...
  . Enter Marketplace Identifier (if any) 
							...
							<label>
								...
								<span class="styBoldText" style="padding-left:1mm;padding-right:1mm;">No</span>
							</label>
							<!-- CheckboxNoEnd -->
							                    							. Stop.  Do not file Form 8941 (see instructions for an exception that may apply to <br/>a partnership, S corporation, cooperative, estate, or trust).
						</div>
						<div class="styLNRightNumBox" style="height:21mm;width:6.3mm;border-right-width:1px;border-bottom-width:0px;padding-top:0mm;padding-bottom:0mm;">
                            </div>
					</div>
					<!-- End Line A -->
					<!-- Start Line B -->
					<div class="styBB" style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:4mm;padding-bottom:0mm;padding-top:0mm;">B
                            </div>
						<div class="styLNDesc" style="width:136mm;font size:7pt;padding-bottom:0mm;padding-top:0mm;">Enter the employer identification number (EIN) used to report employment taxes for individuals included on line 1 below if different from the identifying number listed above
							<span class="styFixedUnderline" style="width:20mm;float:none;padding-bottom:0mm;padding-top:0mm;">
								<xsl:call-template name="PopulateEIN">
									<xsl:with-param name="TargetNode" select="$Form8941Data/EmplmnTaxesReportEmployerEIN"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styLNRightNumBox" style="height:8mm;width:6.3mm;border-right-width:1px;border-bottom-width:0px;padding-top:0mm;padding-bottom:0mm;">
                            </div>
					</div>
					<!-- End Line 1b -->
					<!-- Start Caution Line-->
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Average annual wages you paid for the tax year (from Worksheet 3, line 3). If you entered $51,000 or more, skip lines 4 through 11 and enter -0- on line 12
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.

		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
              ...
              Form<span class="styFormNumber">6252</span>
				 ...
				 Information about Form 6252 and its instructions is at 
                ...
                <span style="float:left;">(see instructions).  Otherwise, enter -0- </span>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc" style="height:auto;">
						  <span class="styNormalText"><span class="styBoldText">Installment Sale Income.</span> Complete this part for the year of sale  <span class="styBoldText">and</span> 
						...
						<div style="width:187mm;">
							<div class="GenericDiv" id="STPctn" style="padding-left: 8mm;">
								...
								<div class="styForm6252UnderlineText" style="width:179mm;">
									...
									<xsl:if test="$Form6252Data/RelatedPartyName/BusinessNameLine1 != ''">
									...
									<xsl:if test="$Form6252Data/RelatedPartyName/BusinessNameLine2 != ''">
										<span style="width:8px;"/>
										<br/>
									</xsl:if>
	...
	<xsl:with-param name="BackupName">First Dispos Sale Exchange</xsl:with-param>								</xsl:call-template>
                ...
                Enter the <span class="styBoldText">smaller</span> of line 30 or line 31      
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Total payments received by the end of your 2014 tax year (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
							</div>
              ...
              <span style="width:16px;"/>
						...
						<span style="width:16px;"/>
						<span style="width:16px;"/>
                Form <span class="styBoldText">6252</span> (2014)
            </div>
					<br/>
					<br class="pageEnd"/>
							...
							<xsl:for-each select="$Form6252Data/RelatedParty">
								<tr>
									...
									<td class="styDepTblCell" style="text-align: left">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="RelatedPartyName/BusinessNameLine1Txt"/>
										</xsl:call-template>
										<span style="width:16px;"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="RelatedPartyName/BusinessNameLine2Txt"/>
										</xsl:call-template>
										<span style="width:8px;"/>
										--><!-- Choice of US and Foreign Address --><!--
										<xsl:choose>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/CodeUOtherCreditsStmt"/>
  
  <!-- Template to display Code U Other Credits Statement-->
  
  <xsl:template name="ShowDependencyData">
    <!-- Code U Other Credits Statement Data -->
    <table class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tfoot/>
       <tbody>
        <xsl:for-each select="$DependencyData/CodeUOtherCreditsGrp">
          <tr>

        ...
        <form name="Form4972">
          ...
          <div class="styBB" style="width:{$pageWidth}mm;">
            <div class="styFNBox" style="width:31mm;height:23mm;padding:bottom:0mm;">
			 ...
			 <div class="styTYBox" style="width:31mm;height:23mm;border-left-width:1px;">
				<div class="styOMB" style="height:2mm;font-size:7pt;">OMB No. 1545-0193</div>
          ...
          <div class="styBB" style="width:{$pageWidth}mm;">
            <div class="styFNBox" style="width:150mm; height:8mm;text-align:left;">
              Name of recipient of distribution<br/>
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="$Form4972Data/PersonNm"/>
              </xsl:call-template>
              <br/>
              <div style="line-height:100%;font-family:verdana;font-size:7.5pt;text-align:left;padding-top:2mm;"/>
            </div>
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div style="width:187mm;float:left;clear:none;">
				...
				<span class="styIRS4972LNYesNoBox" style="width:7.25mm;height:4.5mm;"/>
					<span class="styIRS4972LNYesNoBox" style="height:4.5mm;width:6mm;">Yes</span>  
				
			    <span class="styIRS4972LNYesNoBox" style="height:4.5mm;width:7.5mm;">No</span>
				<br/>
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:1.5mm;">1</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:1.5mm;font:normal;">
            ...
            <div style="width:187mm;float:left;clear:none;">
				...
				<span style="float:right;">
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:1.5mm;">2</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:1.5mm;font:normal;">
					<xsl:call-template name="PopulateYesBoxText">
            ...
            <div style="width:187mm;float:left;clear:none;">
				...
				<span style="float:right;">
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:1.5mm;">3</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:1.5mm;font:normal;">
					<xsl:call-template name="PopulateYesBoxText">
            ...
            <div style="width:187mm;float:left;clear:none;">
				...
				<span style="float:right;">
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:3.5mm;">4</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:3.5mm;font:normal;">
					<xsl:call-template name="PopulateYesBoxText">
                  <xsl:with-param name="TargetNode" select="$Form4972Data/QualifyingAge5YearMemberInd"/>
                </xsl:call-template>
                </span>
                <span class="styIRS4972LNYesNoBox" style="width:7.5mm;height:6mm;padding-top:3.5mm;font:normal">
					<xsl:call-template name="PopulateNoBoxText">
                  <xsl:with-param name="TargetNode" select="$Form4972Data/QualifyingAge5YearMemberInd"/>
                </xsl:call-template>
			</span>
            ...
            <div style="width:187mm;float:left;clear:none;">
				<span style="float:left;">
				<div class="styLNLeftNumBox" style="width:10mm;padding-left: 3.2mm;"/>
				...
				<span style="width:16.5mm;"/><span class="styIRS4972LNYesNoBox" style="width:7.2mm;height:4mm;background-color:white;border-bottom-width:0px;padding-left: 6.2mm"/>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:4mm;font:normal;background-color:white;border-bottom-width:0px;"/>
                <span class="styIRS4972LNYesNoBox" style="width:7.5mm;height:4mm;font:normal;background-color:white;border-bottom-width:0px;"/>
            ...
            <div style="width:187mm;float:left;clear:none;">
				<span style="float:left;">
				<div class="styLNLeftNumBox" style="width:10mm;padding-left: 3mm;">5a</div>
				<div class="styLNDesc" style="width:150.5mm;">
					<span style="float:left;">Did you use Form 4972 after 1986 for a previous distribution from your own plan? If "Yes," <b>do not</b> use this<br/>form for a 2014 distribution from your own plan
						<!--Dotted Line-->
					<span class="styBoldText" style="padding-left:1mm">
										<span style="width:2.6mm"/>.
										<span style="width:2.6mm"/>.
				...
				<span style="float:right;">
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:3.5mm;">5a</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:3.5mm;font:normal;">
					<xsl:call-template name="PopulateYesBoxText">
            ...
            <div style="width:187mm;float:left;clear:none;">
				<span style="float:left;">
				<div class="styLNLeftNumBox" style="width:10mm;padding-left: 4.5mm;">b</div>
				<div class="styLNDesc" style="width:150.5mm;">
					<span style="float:left;">If you are receiving this distribution as a beneficiary of a plan participant who died, did you use Form 4972<br/>for a previous distribution received as a beneficiary of that participant after 1986? If "Yes," <b>do not</b> use this form for this<br/>distribution
				<!--Dotted Line-->
					<span class="styBoldText" style="padding-left:1mm">
										<span style="width:2.6mm"/>.
										<span style="width:2.6mm"/>.
				...
				<span style="float:right;">
				<span class="styIRS4972LNYesNoBox" style="width:6.25mm;height:6mm;padding-top:6.75mm;border-bottom-width:0px;">5b</span>
				<span class="styIRS4972LNYesNoBox" style="width:7mm;height:6mm;padding-top:6.75mm;font:normal;border-bottom-width:0px">
					<xsl:call-template name="PopulateYesBoxText">
                  <xsl:with-param name="TargetNode" select="$Form4972Data/BeneficiaryDistributionInd"/>
                </xsl:call-template>
                </span>
                <span class="styIRS4972LNYesNoBox" style="width:7.5mm;height:6mm;padding-top:6.75mm;font:normal;border-bottom-width:0px">
					<xsl:call-template name="PopulateNoBoxText">
                  <xsl:with-param name="TargetNode" select="$Form4972Data/BeneficiaryDistributionInd"/>
                </xsl:call-template>
			</span>
          ...
          <!-- Part III - Body -->
          <div style="width:{$pageWidth}mm;height:0mm;border-style:solid; border-bottom-width:{$borderWidth}mm;border-top-width:0;           border-right-width:0;border-left-width:0;">
            <!-- Line 8-->
            <div class="styGenericDiv" style="width:187mm;height:7.5mm">
				...
				<div class="styLNDesc" style="height:7.5mm;width:138.5mm;">
					<span style="float:left;">
					If you completed Part II, enter the amount from Form 1099-R, box 2a minus box 3. If you did not complete Part II, enter the<br/>
          ...
          <div class="pageEnd" style="width:{$pageWidth}mm;padding-top:0mm;">
            ...
            <div style="float:right;width:80mm;text-align:right">
							...
							Form 
							<span class="styBoldText" style="font-size:8pt;">4972</span> (2014)
                           </div>
          </div>

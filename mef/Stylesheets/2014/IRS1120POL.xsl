...
<!-- Updated 6/29/2012 per Defect 39114 yellow screen which I couldn't duplicate but tester mentioned populatetemplate was not capitalized by Robert L Jones -->
<!-- Updated 1/8/2014 fixed by disabling Template putting name in signature box. by Robert L Jones -->
<!-- Updated 5/29/2014 per UWR 107551 and pdf dated 2/12/14 by Robert L Jones -->
<!-- Updated 6/23/2014 per IBM Defect 40574 by Robert L Jones -->
<!-- Updated 7/30/2014 per IBM Defect 41033 by Robert L Jones -->
<!-- Updated 9/04/2014 per UWR 117755 Drop 4 Rel 9.5 which changed element for line 5 to CapitalGainNetIncomeAmt by Robert L Jones -->
<!-- Updated 9/17/2014 Removed extra space between Bus line 1 and Bus line 2 under Firm name - by Robert L Jones -->
<!-- Updated 11/12/2014 per Kisams # IM01904720 by Robert L Jones -->
<!-- Updated 11/12/2014 per PDF Review by Robert L Jones -->
...
<span style="width:14px"/>.
        ...
        <!-- additional info line 1 -->
              ...
              At any time during the 2014 calendar year, did the organization have an interest in or a signature or other 
              </div>
 </div>
        ...
        <div class="IRS1120POL_LineContainer" style="border-left-width:1px">
					<div class="IRS1120POL_LabelSpaceWide" style="padding-bottom:2mm;border-right-width:1px;height:15.5mm"/>
					<div class="IRS1120POL_LineIndex" style="padding-bottom:2mm;padding-right:2mm;height:15.5mm">5a</div>
					<div class="IRS1120POL_GenericDesc" style="width:36mm;padding-bottom:2mm;height:15.5mm">The books are in care of </div>
					<div class="IRS1120POL_GenericDesc" style="width:4mm;padding-bottom:2mm;height:15.5mm">
            <img src="{$ImagePath}/1120POL_Bullet_Sm.gif" alt="right arrow"/>
          </div>
          <div class="IRS1120POL_GenericDesc" style="width:40mm;border-bottom-width:1px;border-style:solid;font-size:7pt;">
            <xsl:call-template name="PopulateText">
...
border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
					<div class="IRS1120POL_LabelSpaceWide" style="padding-bottom:2mm;height:20.5mm"/>
					<div class="IRS1120POL_SubLineIndex" style="padding-bottom:2mm;padding-left:2mm;height:20.5mm">c</div>
					<div class="IRS1120POL_GenericDesc" style="width:36mm;padding-bottom:2mm;height:20.5mm">The books are located at</div>
					<div class="IRS1120POL_GenericDesc" style="width:4mm;height:20.5mm">
    <img src="{$ImagePath}/1120POL_Bullet_Sm.gif" alt="right arrow"/>
  </div>
					<div class="IRS1120POL_GenericDesc" style="width:40mm;border-bottom-width:0px;font-size:7pt;">
    ...
    <!-- end address type -->
					...
					<div class="IRS1120POL_GenericDesc" style="width:8mm;font-weight:bold;padding-left:4mm;height:20.5mm">d</div>
					<div class="IRS1120POL_GenericDesc" style="width:20mm;height:20.5mm">Telephone No.</div>
					<div class="IRS1120POL_GenericDesc" style="width:4mm;height:20.5mm">
    <img src="{$ImagePath}/1120POL_Bullet_Sm.gif" alt="right arrow"/>
  </div>
...
<!-- END Signature Section -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2014)</div>
        </div>
        <!-- leftover data table -->
				<br/>
				<br/>

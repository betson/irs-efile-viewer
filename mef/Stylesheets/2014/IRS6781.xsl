	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form6781">
						...
						<table class="styTable" cellspacing="0" style="font-size:7pt;border-color:black;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:106mm;">
								...
								<xsl:if test="($Print != $Separated) or (count($Form6781Data/Section1256CntrctsAcctInfoGrp) &lt;= 3) ">
									<xsl:for-each select="$Form6781Data/Section1256CntrctsAcctInfoGrp">
										<tr>
											...
											<td class="styLNRightNumBoxNBB" style="width:35mm;height:4.5mm;background-color:lightgrey;"/>
										</tr>
									</xsl:for-each>
								</xsl:if>
								<!-- Table Filler Rows -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:76.7mm;height:4mm;">
							<span style="float:left;">Add the amounts on line 1 in columns (b) and (c)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
						</div>
						<div class="styLNRightNumBox" style="height:4.5mm;">2</div>
						<div class="styLNAmountBox" style="width:32.7mm;height:4.5mm;padding-right:1mm;">
							<xsl:call-template name="PopulateNegativeNumber">
								<xsl:with-param name="TargetNode" select="$Form6781Data/TotalSection1256CntrctsLossAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="width:34.5mm;height:4.5mm; padding-right:1.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form6781Data/TotalSection1256CntrctsGainAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBoxNBB" style="width:27mm;height:4.5mm;border-left-width:0px;background-color:lightgrey;border-bottom-width:1px;"/>
					</div>
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:134mm;padding-top:1mm;height:7.5mm;">
						  ...
						  <span style="float:left;">be carried back.  Enter the loss as a positive number. If you did not check box D, enter -0-</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
						</div>
      ...
      -->
					<div style="width:187mm;" class="styBB">
						...
						<div class="styLNDesc" style="width:141mm;height:8mm;">
						 Enter the long-term portion of losses from line 10, column (h), here and include on line 11of Schedule D
						  <span style="float:left;"> or on Form 8949 (see instructions)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.......................</span>
						</div>

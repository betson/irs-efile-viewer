...
<!-- 07/24/2015 - Changes made for defect 43461 - Jeremy Nichols -->
<!-- 08/05/2015 - Changes made for defect 43756 - Jeremy Nichols -->
<!-- 11/23/2015 - Changes made for defect 43801 - Jeremy Nichols -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="RowForHeight" select="count($Form1118ScheduleH/ResearchDevDedSalesMethod[2]/GrossSalesSection901jIncmAmt)"/>
	...
	<xsl:template match="/">
        ...
        Check only one box on each form.<br/>
          ...
          <span class="styItalicText" style="font-weight:normal">(Report all amounts in U.S. dollars. See<b> Specific instructions</b>.)</span>
					...
					<div class="styTableContainerLandscape" id="IBActn" style="width:256mm;height:auto;display:block inline;border-bottom-width:0px;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;height:auto;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellLtr" rowspan="3">
										<span style="width:8mm;height:27mm;"/>
									</th>
					...
					<div class="styBB" style="width:256mm;border-top:0px;">* For section 863(b) income, NOLs, income from RICs, and high-taxed income, use a single line (see instructions). </div>
					...
					<div class="styBB" style="width:256mm;height:5mm;text-align:center;padding-top:1mm;float:none;clear:none;">
						<div class="styGenericDiv" style="width:239.5mm;display:inline;"/>
					...
					<div class="styTableContainerLandscape" style="height:auto;width:256mm;display:block;" id="DEDctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="height:auto;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellLtr" style="width:17mm;" rowspan="4">
							...
							<tbody>
									...
									<xsl:for-each select="$Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp">
										<tr >
											<td class="styIRS1118TableCellLtr" style="width:17mm;">
												<span class="styTableCellPad" style="font-weight:bold;border-color:black;">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="RowId"/>
													</xsl:call-template>
												</span>
								...
								<xsl:choose>
									<xsl:when test="(count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &gt; 6) and ($Print = $Separated)">
										<tr >
											<td class="styIRS1118TableCellLtr" style="width:17mm;height:6mm;border-top:0px;">
												<span class="styTableCellPad" style="font-weight:bold">Totals</span>
											</td>
											<td class="styTableCell" style="width:32mm;">
												<span class="styTableCellPad" style=""/>
											</td>
											<td class="styTableCell" style="width:32mm;border-color:black;border-top:0px;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:32mm;border-color:black;border-top:0px;">
												<span class="styTableCellPad"/>
											...
											<td class="styTableCell" style="width:25mm;border-color:black;border-top:0px;">
												<span class="styTableCellPad"/>
											</td>
										</tr>
									</xsl:when>
									<xsl:otherwise>
										<tr >
											...
											<td class="styTableCell" style="width:25mm;padding-top:2.5mm;border-color:black;">
												<xsl:call-template name="PopulateAmount">
					...
					<xsl:if test="$Print = $Separated"><br/><br/></xsl:if>
					...
					<!--BEGIN FOOTER-->
					<div class="pageEnd" style="width:256mm;border-top:0px solid black;display:block inline;">
						...
						<div style="float:right">
							  ...
							  Form <b style="font-size:8pt;">1118</b> (Rev. 12-2014)
							</div>
					</div>
					<!--END FOOTER-->
					<!--BEGIN HEADER-->
					<div style="display:block;">
					<div class="styBB" style="width:256mm">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2014)</div>
						<div style="float:right">
          Page <span class="styBoldText" style="font-size: 8pt">2</span>
					...
					<div class="styBB" style="width:256mm;float:left;display:table-header-group;display:block;">
						...
						<div class="styGenericDiv" style="border-bottom-width:0px;width:3mm">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp"/>
								<xsl:with-param name="containerHeight" select="6"/>
					...
					<div class="styTableContainerLandscape" id="FTPctn" style="width:256mm;display:block;border-bottom-width:0px;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="height: 66mm;width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellLtr" style="width:8mm;height:22.5mm;" rowspan="3">
										<span class="styTableCellPad" style="font-weight:bold"/>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" scope="col" rowspan="2" colspan="2" style="width:32mm;height:15mm;">
										<br/>
								...
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:16mm;height:7.5mm;">
					...
					<div class="styBB" style="border-top-width:0px;width:256mm;">
						<div class="styIRS1118TitleDesc" style="border-top-width:0px;padding-left:0;">Part II—Separate Foreign Tax Credit
          ...
          Page <span class="styBoldText" style="font-size: 8pt">3</span>
					...
					<div class="styTableContainerLandscape" id="DIVDIPST1986ctn" style="width:256mm;display:block;border-bottom-width:0px;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" summary="Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings" cellspacing="0" style="height:auto;width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:81mm;font-size:5pt;" rowspan="2" scope="col">1a. <span class="styNormalText">Name of Foreign Corporation (identify DISCs and former DISCs)</span>
									</th>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:15mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;border-top-width:0;">
						<div class="styIRS1118TitleDesc" style="width:251.8mm;padding-left:0;border-top-width:0;">Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleC/DivAndDeemedInclsnPost1986"/>
					...
					<div class="styTableContainerLandscape" id="DIVDIPST1986ctnB" style="height:auto;width:256mm;display:block inline;border-bottom-width:0px;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" summary="Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings" cellspacing="0" style="height:auto;width:256mm;border-bottom-width:0px;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:40mm;font-size:5pt;" rowspan="2" scope="col">7. <span class="styNormalText">Post-1986 Foreign Income Taxes (add columns 5, 6(a), and 6(b))</span>
									</th>
							...
							<tbody>
								...
								<!-- End of filler rows -->
								<tr>
									<td class="styIRS1118TableCellNW" style="height:7mm;text-align:left;padding-top:1mm;border-top-width:0px;border-bottom-width:0px;" colspan="6">
										...
										<span>
										  ...
										  <span style="width:10px"/>.
											...
											<td class="styIRS1118TableCellSmallArial" style="height:6mm;padding-top:1mm;border-top-width:0px;border-bottom-width:0px;">
												<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:256mm;height:4mm;float:none;clear:none;padding-left:0;">
						<div class="styIRS1118TitleDesc" style="width:252mm;height:4mm;padding-left:0;">Part II—Dividends Paid Out of Pre-1987 Accumulated Profits</div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styTableContainerLandscape" style="width:256mm;height:auto;" id="DIVPRE1987ctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:13mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
							...
							<tbody>
								...
								<xsl:choose>
									<xsl:when test="(count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &gt; 6) and ($Print = $Separated)">
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellNW" style="text-align:left;border-right-width:1px;border-bottom-width:1px;" colspan="11">
									...
									<xsl:otherwise>
										<tr style="height:6mm;">
											<td class="styIRS1118TableCellNW" style="text-align:left;border-bottom-width:0px;" colspan="11">
												<span class="styBoldText">Total</span> (Add amounts in column 8b. Enter the result here and include on "Totals" line of Schedule B, Part I, column 3.)
												<!--Dotted Line-->
												<span>
												  <span style="width:10px"/>.
					...
					<div class="styTableContainerLandscape" id="DIPRE1987ctn" style="width:256mm;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;border-bottom:0px solid black;">
							<thead class="styTableThead">
								<tr>
							...
							<tbody>
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<tr >
											<td class="styIRS1118TableCellNW" style="text-align:left;border-bottom-width:0px;" colspan="10">
												<span class="styBoldText">Total</span> (Add amounts in column 8. Enter the result here and include on "Totals" line of Schedule B, Part I, column 3.)
												<!--Dotted Line-->
												<span>
												  <span style="width:10px"/>.
											...
											<td class="styIRS1118TableCellSmallArial" style="width:25mm;border-bottom-width:0px;">
												<xsl:call-template name="PopulateAmount">
					...
					<!--BEGIN HEADER-->
					<div style="display:block;border-top:0px solid black;">
					<div style="width:256mm;border-bottom:1px solid black;">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2014)</div>
						<div style="float:right">
          ...
          Section 902(b)
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;border-bottom:1px solid black;">
					...
					<div class="styTableContainerLandscape"  id="1TUEctn" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
					...
					<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="stySectionDesc" style="width:251.8mm;text-align:left;padding-left:0;">Section A—Dividends Paid Out of Post-1986 Undistributed Earnings
						  <span style="font-weight:normal">(Include the column 10 results in Schedule C, Part I, column 6(b).)</span>
					    </div>
						<div class="styGenericDiv" style="width:3.2mm;text-align:right">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styTableContainerLandscape"  id="1TUEctn2" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:75mm;font-size:5pt;" colspan="2" scope="col">6. <span class="styNormalText">Foreign Taxes Paid and Deemed Paid for Tax Year indicated</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:32mm;font-size:5pt;" rowspan="2" scope="col">7. <span class="styNormalText">Post-1986 Foreign Income Taxes (add columns 5, 6(a), and 6(b))</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:75mm;font-size:5pt;" colspan="2" scope="col">8. <span class="styNormalText">Dividends Paid (in functional currency)</span>
									</th>
								...
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:34.5mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">Taxes Paid</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:34.5mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Taxes Deemed Paid (see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:34.5mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">of Second-tier Corporation</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:34.5mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">of First-tier Corporation</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
					...
					<div class="styTableContainerLandscape" style="height:auto;width:256mm;display:block;" id="1TAPctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
					...
					<div class="styTableContainerLandscape" id="2TUEctn" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
					...
					<div class="styTableContainerLandscape" id="2TUEctn2" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:74mm;font-size:5pt;" colspan="2" scope="col">6. <span class="styNormalText">Foreign Taxes Paid and Deemed Paid for Tax Year Indicated</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;" rowspan="2" scope="col">7. <span class="styNormalText">Post-1986 Foreign Income Taxes (add columns 5, 6(a), and 6(b))</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:74mm;font-size:5pt;" colspan="2" scope="col">8. <span class="styNormalText">Dividends Paid (in functional currency)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" rowspan="2" scope="col">9. <span class="styNormalText">Divide column 8(a) by column 4</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" rowspan="2" scope="col">10. <span class="styNormalText">Tax Deemed Paid (multiply column 7 by column 9)</span>
								...
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">Taxes Paid</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Taxes Deemed Paid (from Schedule E, Part I, column 10)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">of Third-tier Corporation</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">of Second-tier Corporation</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
					...
					<div class="styTableContainerLandscape" id="2TAPctn" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
          ...
          Page <span class="styBoldText" style="font-size: 8pt">7</span>
					...
					<div class="styTableContainerLandscape" id="3TUEctn" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
...
<div class="styBB" style="width:256mm;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="height:8mm;width:251.8mm;text-align:left;padding-left:0;">Part I—Tax Deemed Paid by Third-Tier Foreign Corporations
						  <span style="font-weight:normal;display:inline;">(In general, include the column 10 results in Schedule D, Part II, Section A, column 6(b).
							However, see instructions for Schedule C, Part I, column 6(b) for an exception.)
						  </span>
						</div>
					...
					<!-- BEGIN SCHEDULE E PART I-->
					<div class="styTableContainerLandscape" id="3TUEctn2" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Taxes Deemed Paid (from Part II, column 10)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">Of Fourth-tier CFC</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Of Third-tier CFC</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
          ...
          Page <span class="styBoldText" style="font-size: 8pt">8</span>
					...
					<div class="styBB" style="height:8mm;width:256mm;border-bottom:1px solid black;float:none;clear:none;">
						<div class="styIRS1118TitleDesc" style="height:8mm;width:252mm;border-bottom:1px solid black;text-align:left;padding-left:0;">Part II—Tax Deemed Paid by Fourth-Tier Foreign Corporations
						...
						<div class="styGenericDiv" style="width:3.2mm;text-align:right;display:inline;">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styTableContainerLandscape" style="width;256mm;height:56mm;display:block;" id="4TUEctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:72mm;font-size:5pt;" rowspan="2" scope="col">1a. <span class="styNormalText">Name of Fifth-Tier Foreign Corporation and Its Related Fourth-Tier Foreign Corporation</span>
									</th>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:64mm;font-size:5pt;" rowspan="2" scope="col">1c. <span class="styNormalText">Reference ID number</span><br/><span class="styNormalText">(see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:17mm;font-size:5pt;" rowspan="2" scope="col">2. <span class="styNormalText">Tax Year End (Yr-Mo) (see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:17mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;" rowspan="2" scope="col">4. <span class="styNormalText">Post-1986 Undistributed Earnings (in functional currency—attach schedule)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;" rowspan="2" scope="col">5. <span class="styNormalText">Opening Balance in Post-1986 Foreign Income Taxes</span>
					...
					<!-- End Set Initial Height of Above Table -->
					<div class="styBB" style="height:6mm;width:256mm;border-bottom:1px solid black;text-align:right;;display:block;">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleE/TaxDeemedPaidBy4thTier"/>
								<xsl:with-param name="containerHeight" select="6"/>
					...
					<div class="styTableContainerLandscape" style="width:256mm;height:56mm;display:block;" id="4TUEctn2">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="height:6mm;width:74mm;font-size:5pt;" colspan="2" scope="col">6. <span class="styNormalText">Foreign Taxes Paid and Deemed Paid for Tax Year Indicated</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;font-size:5pt;" rowspan="2" scope="col">7. <span class="styNormalText">Post-1986 Foreign Income Taxes (add columns 5, 6(a), and 6(b))</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="height:6mm;width:74mm;font-size:5pt;" colspan="2" scope="col">8. <span class="styNormalText">Dividends Paid (in functional currency)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" rowspan="2" scope="col">9. <span class="styNormalText">Divide column 8(a) by column 4</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" rowspan="2" scope="col">10. <span class="styNormalText">Tax Deemed Paid (multiply column 7 by column 9)</span>
								...
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Taxes Deemed Paid (from Part III, column 10)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">Of Fifth-tier CFC</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Of Fourth-tier CFC</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
					...
					<div class="styBB" style="height:8mm;width:256mm;float:none;clear:none;display:block;">
						...
						<div class="styGenericDiv" style="width:3.2mm;text-align:right;display:block;">
							<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
					...
					<div class="styTableContainerLandscape" id="5TUEctn" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
					...
					<!-- End Set Initial Height of Above Table -->
					<div class="styBB" style="height:6mm;width:256mm;text-align:right;display:block;">
						<!-- button display logic -->
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" select="$Form1118ScheduleE/TaxDeemedPaidBy5thTier"/>
								<xsl:with-param name="containerHeight" select="6"/>
					...
					<div class="styTableContainerLandscape" id="5TUEctn2" style="width:256mm;display:block;">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="width:75mm;font-size:5pt;" rowspan="2" scope="col">6. <span class="styNormalText">Foreign Taxes Paid for Tax Year Indicated</span>
									</th>
								...
								<tr>
									<th class="styIRS1118TableCellHeaderSmall" style="height:6mm;width:37mm;font-size:5pt;" scope="col">(a) <span class="styNormalText">Of Sixth-tier CFC</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="height:6mm;width:37mm;font-size:5pt;" scope="col">(b) <span class="styNormalText">Of Fifth-tier CFC</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
          ...
          Page <span class="styBoldText" style="font-size: 8pt">9</span>
					...
					<div class="styBB" style="width:256mm;clear:both;border-bottom-width:0px;display:block;">
						<div class="styIRS1118ScheduleCell" style="border-bottom:0px;border-right-width:0px;">
							...
							<div class="styBB" style="width:127mm;">
								...
								<div class="styIRS1118TitleDesc" style="height:8mm;width:95mm;">Gross Income and Definitely Allocable Deductions for Foreign Branches </div>
							...
							<div class="styIRS1118TableContainerSchF" id="FGIctn" style="display:block;">
								<!-- print logic -->
								<xsl:call-template name="SetInitialState"/>
								<!-- end -->
									...
									<thead class="styTableThead">
										<tr>
											<th class="styIRS1118TableCellHeaderSmall" colspan="2" style="width:47mm;border-right-width:1px;;">
												...
												<span class="styNormalText"><b>1. </b> Foreign Country or U .S. Possession (Enter
										...
										<xsl:choose>
											<xsl:when test="(count($Form1118ScheduleF/ForeignGrossIncmAndAllcblDed) &gt; 6) and ($Print = $Separated)">
												<tr style="border-right-width:0;">
													<td class="styTableCellSmall" colspan="2" style="height:8mm;width:47mm;text-align:left;vertical-align:bottom;border-bottom-width:0px;border-color:black;">
														<span style="font-weight:bold;">Totals </span>(add lines A through F)* <span style="width:10mm;text-align:right;">
															<img src="{$ImagePath}/1118_Bullet_Line.gif" alt="bulletpoint"/>
														</span>
													</td>
													<td class="styTableCellSmall" style="height:8mm;width:39mm;vertical-align:bottom;border-bottom-width:0px;border-color:black;">
														<span class="styTableCellPad"/>
													</td>
													<td class="styTableCellSmall" style="height:8mm;width:37mm;vertical-align:bottom;border-bottom-width:0px;border-right-width:0;border-color:black;">
														<span class="styTableCellPad"/>
													</td>
												</tr>
											</xsl:when>
											<xsl:otherwise>
												<tr style="border-right-width:0;">
													<td class="styTableCellSmall" colspan="2" style="width:47mm;text-align:left;border-bottom-width:0px;border-color:black;">
														<span style="font-weight:bold;">Totals </span>(add lines A through F)* <span style="width:10mm;text-align:right;">
															<img src="{$ImagePath}/1118_Bullet_Line.gif" alt="bulletpoint"/>
														</span>
													</td>
													<td class="styTableCellSmall" style="width:39mm;border-bottom-width:0px;border-color:black;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$Form1118ScheduleF/TotalGrossIncomeAmt"/>
														</xsl:call-template>
														<span class="styTableCellPad"/>
													</td>
													<td class="styTableCellSmall" style="width:37mm;border-bottom-width:0px;border-right-width:0px;border-color:black;">
														<xsl:call-template name="PopulateAmount">
						...
						<div class="styIRS1118ScheduleCell" style="border-left-width:1px;border-right-width:0px;border-bottom-width:0px;display:block;">
							<div class="styBB">
					...
					<div class="pageEnd" style="width:256mm;border-top:1px solid black;">
						<div style="border-top:1px solid black;float:left;clear:none;">
						...
						<div style="width:106mm;border-top:1px solid black;float:right;">
							<div style="width:106mm;">
								<span style="width:62mm;"/>
								 Form <b style="font-size:8pt;">1118</b> (Rev. 12-2014)</div>
						</div>
					</div>
					
					<!--BEGIN HEADER-->
					<div style="display:block;">
					<div class="styBB" style="width:256mm;border-top-width:0px;border-bottom-width:1px;">
						<div style="float: left; clear: none">Form 1118 (Rev. 12-2014)</div>
						<div style="float:right">
					...
					<div style="width:256mm;display:block;">
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2014)</div>
						</div>
					</div>
					<div class="pageEnd" />
					<!--END FOOTER-->
            ...
            Additional Data        
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:6pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" rowspan="3" style="width:8mm;">
							...
							<tbody>
								<xsl:for-each select="$Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp">
									<tr style="height:6mm;">
										...
										<td class="styIRS1118TableCellLtr" style="text-align:left;padding-left:0.5mm;">
											<span class="styTableCellPad" style="font-weight:bold">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="RowId"/>
												</xsl:call-template>
					...
					<xsl:if test="((count($Form1118ScheduleA/IncmLossBfrAdjFrgnTxsPdAccrGrp) &gt; 6) and ($Print = $Separated))">
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:6pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" rowspan="4" style="width:8mm;">
              ...
              Net Operating Loss Deduction</span>
                ...
                1. <span class="styNormalText">Credit is Claimed for Taxes:</span>
					...
					<xsl:if test="((count($Form1118ScheduleC/DivAndDeemedInclsnPost1986) &gt; 7) and ($Print = $Separated))">
						...
						<table class="styDepTblLandscape" summary="Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings" cellspacing="0" style="font-size:5pt;width:256mm;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:13mm" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:6pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:13mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:6pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:15mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:5pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:12mm;font-size:5pt;" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
						...
						<table class="styDepTblLandscape" cellspacing="0" style="font-size:5pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" style="width:12mm" rowspan="2" scope="col">3. <span class="styNormalText">Country of Incorporation (enter country code from instructions)</span>
									</th>
...
and 1d from line 1a)</td>
	...
	<xsl:template name="AddRowsForSchAPartI">
		...
		<tr style="height:6mm;">
			...
			<td class="styTableCellSmall" style="width:29mm;border-color:black;">
				<span class="styTableCellPad" style="width:27.5mm;"/>
			</td>
			<td class="styTableCellSmall" style="width:25mm;border-color:black;">
				<span class="styTableCellPad" style="width:24mm;"/>
			</td>
	...
	<xsl:template name="AddRowsForSchAPartII">
		...
		<tr style="height:6mm;">
			...
			<td class="styTableCellSmall" style="width:32mm;border-color:black;">
				<span class="styTableCellPad" style="width:27mm;text-align:left;">
					<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
				</span>
			</td>
			<td class="styTableCellSmall" style="width:32mm;border-color:black;">
	...
	<xsl:template name="AddRowsForSchBPartI">
		...
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellLtr">
				...
				<span class="styTableCellPad" style="width:5.5mm;"/>
			</td>
			<td class="styTableCellSmall" style="width:16mm;border-color:black;">
	...
	<xsl:template name="AddRowsForSchCPartI">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:81mm;text-align:left;">
				<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
				<span class="styTableCellPad" style="width:81mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;">
				<span class="styTableCellPad" style="width:14mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:45mm;">
				<span class="styTableCellPad" style="width:45mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;">
				<span class="styTableCellPad" style="width:14mm;"/>
			</td>
			...
			<td class="styIRS1118TableCellSmallArial" style="width:20mm;">
				<span class="styTableCellPad" style="width:19mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:20mm;">
				<span class="styTableCellPad" style="width:19mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:20mm;border-right-width:1px;">
				<span class="styTableCellPad" style="width:19mm;"/>
			</td>
		</tr>
	</xsl:template>
	<xsl:template name="AddRowsForSchCPartIB">
		<xsl:param name="ShowMessage"/>
		<tr >
			<td class="styIRS1118TableCellSmallArial" style="height:6mm;border-right-width:1px;">
				<span class="styTableCellPad"/>
			</td>
	...
	<xsl:template name="AddRowsForSchCPartII">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:23mm;text-align:left;">
				<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
				<span class="styTableCellPad" style="width:23mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:14mm">
				<span class="styTableCellPad" style="width:13mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:45mm">
				<span class="styTableCellPad" style="width:45mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:13mm">
	...
	<xsl:template name="AddRowsForSchCPartIII">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:38mm;text-align:left;">
				<xsl:if test="$ShowMessage = 'true'">See Additional Data Table</xsl:if>
				<span class="styTableCellPad" style="width:38mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;">
				<span class="styTableCellPad" style="width:14mm;"/>
			</td>
	...
	<xsl:template name="AddRowsForSchDPartISecA">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:73mm;text-align:left;">
				<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
				<span class="styTableCellPad" style="width:73mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:17mm;font-family:arial;">
				<span class="styTableCellPad" style="width:17mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:65mm;font-family:arial;">
				<span class="styTableCellPad" style="width:64.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;font-family:arial;">
				<span class="styTableCellPad" style="width:14mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;font-family:arial;">
				<span class="styTableCellPad" style="width:14mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:35mm;">
				<span class="styTableCellPad" style="width:34mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:35mm;">
				<span class="styTableCellPad" style="width:34mm;"/>
			</td>
	...
	<xsl:template name="AddRowsForSchDPartISecA2">
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:34.5mm;">
				<span class="styTableCellPad" style="width:34.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:34.5mm;">
				<span class="styTableCellPad" style="width:34.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:36.5mm;">
				<span class="styTableCellPad" style="width:36.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:34.5mm;">
				<span class="styTableCellPad" style="width:34.5mm;"/>
			</td>
			...
			<td class="styIRS1118TableCellSmallArial" style="width:38mm;">
				<span class="styTableCellPad" style="width:38mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:38mm;">
				<span class="styTableCellPad" style="width:38mm;"/>
	...
	<xsl:template name="AddRowsForSchDPartISecB">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:21mm;text-align:left;">
				<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
			...
			<td class="styIRS1118TableCellSmallArial" style="width:45mm;">
				<span class="styTableCellPad" style="width:44mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:13mm;">
				<span class="styTableCellPad" style="width:12mm;"/>
			</td>
			...
			<td class="styIRS1118TableCellSmallArial" style="width:29mm;">
				<span class="styTableCellPad" style="width:27.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:20mm;">
				<span class="styTableCellPad" style="width:19.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:20mm;">
				<span class="styTableCellPad" style="width:19.5mm;"/>
			</td>
	...
	<xsl:template name="AddRowsForSchDPartIISecB">
		...
		<tr style="height:6mm;">
			...
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;">
				<span class="styTableCellPad" style="width:14.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:45mm;">
				<span class="styTableCellPad" style="width:44mm;"/>
			</td>
	...
	<xsl:template name="AddRowsForSchEPartIII">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styTableCellSmallArial" style="width:74mm;text-align:left;border-color:black;">
				<xsl:if test="$ShowMessage = 'true'">See Add'l Data</xsl:if>
				<span class="styTableCellPad" style="width:72.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:17mm;border-color:black;">
				<span class="styTableCellPad" style="width:16mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:65mm;border-color:black;">
				<span class="styTableCellPad" style="width:64mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;border-color:black;">
				<span class="styTableCellPad" style="width:15mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:15mm;border-color:black;">
				<span class="styTableCellPad" style="width:15mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:35mm;border-color:black;">
				<span class="styTableCellPad" style="width:34mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:35mm;border-color:black;">
				<span class="styTableCellPad" style="width:34mm;"/>
	...
	<xsl:template name="AddRowsForSchEPartIII2">
		<xsl:param name="ShowMessage"/>
		<tr style="height:6mm;">
			<td class="styIRS1118TableCellSmallArial" style="width:75mm;border-color:black;">
				<span class="styTableCellPad" style="width:73.5mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:33mm;border-color:black;">
				<span class="styTableCellPad" style="width:32mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:37mm;border-color:black;">
				<span class="styTableCellPad" style="width:36mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:37mm;border-color:black;">
				<span class="styTableCellPad" style="width:36mm;"/>
			</td>
			<td class="styIRS1118TableCellSmallArial" style="width:37mm;">
	...
	<xsl:template name="AddRowsForSchF">
		...
		<xsl:param name="TargetNode"/>
		<tr style="">
			<td class="styIRS1118TableCellLtr" style="height:8mm;width:8mm;text-align:center;font-weight:bold;">
				<xsl:value-of select="$TargetNode"/>
				<span class="styTableCellPad" style="width:8mm;"/>
			</td>
			<td class="styTableCellSmall" style="height:8mm;width:39mm;text-align:left;border-color:black;">
				<xsl:if test="$ShowMessage = 'true'">See Additional Data Table</xsl:if>
				<span class="styTableCellPad" style="width:38mm;"/>
			</td>
			<td class="styTableCellSmall" style="height:8mm;width:39mm;border-color:black;">
				<span class="styTableCellPad" style="width:39mm;"/>
			</td>
			<td class="styTableCellSmall" style="height:8mm;width:39mm;border-color:black;border-right-width:0;">
				<span class="styTableCellPad" style="width:39mm;"/>
			</td>
		</tr>
	</xsl:template>
			...
			<xsl:for-each select="$TargetNode">
				...
				<xsl:choose>
					<xsl:when test="$RowCount&gt;1 and position() &lt; $RowCount">
						<span class="styIRS1118UnderlinedText" style="width:100%;padding-right:1mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<xsl:otherwise>
						<span style="width:100%;padding-right:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="."/>
							</xsl:call-template>
						</span>

...
<!-- 07/20/2015 - Modified per defect 43155 - Jeremy Nichols-->
...
<!--                <xsl:choose>
       ...
       <img src="{$ImagePath}/8844_Bullet_Round.gif" alt="dot"/>    Individuals. Enter the sum of the amounts from Form 1040, lines 44 and 46; or the sum of the amounts from Form 1040NR, lines 42 and 44.<br/>
...
lines 1a and 1b, or the amount from the applicable line of your return.                   
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNRightNumBox" style="width:8mm;height:4.55mm;background-color:lightgrey; border-color:black;border-bottom-width: 0px"/>
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNRightNumBox" style="width:8.25mm;background-color:lightgrey;height:4.55mm;border-right-width:1px;border-bottom-width:0px;"/>
      </div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNDesc" style="width:105mm;height:18mm;padding-top:3mm;">
        ...
        <div class="styLNDesc" style="width:28mm; height:18mm;">                  
          <span class="styBoldText" style="width:28mm; height:4mm;padding-bottom:0mm;padding-top:9mm;">
            <span style="width:8px;"/>.    
            <span style="width:8px;"/>.  
            <span style="width:8px;"/>.    
            <span style="width:8px;"/>.
...
<span style="letter-spacing:4mm; font-weight:bold"> .........
  ...
  <div class="styLNRightNumBox" style="width:8.25mm;height:4.5mm;border-right-width:1px;border-bottom-width:0px;padding-top:0mm;background-color:lightgrey;"/>
     ...
     <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px" class="pageend">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">8834</span> (Rev. 10-2014)</div>
          </div>
          <div class="pageEnd"/>
          <!-- end of page 
          <div style="width:187mm;">

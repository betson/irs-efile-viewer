...
<!-- Rejected IBM Defect 43208 Pushpin bringing up yellow screen in RRD because we don't have access to RRD to verify.09/02/2015 by Robert Jones -->
<!-- Rejected IBM Defect 43213 .10/09/2015 by Robert Jones -->
<!-- IBM Defect 43208 yellow screen Part II when clicking toggle button. Turned it off .10/20/2015 by Robert Jones -->
<!-- IBM Defect 43213 disjointed lines10/20/2015 by Robert Jones -->
...
<xsl:call-template name="SetFormLinkInline">
	...
	<!-- ================ Begin changes for Table I ========================================== -->
			...
			<xsl:if test="count($FormData/DispositionOfAssetsDetail) &lt; 1 or             (($Print = $Separated) and (count($FormData/DispositionOfAssetsDetail) &gt; 9)) ">
										<tr>
								<td class="sty990ScheduleNLNCol" style="height:auto;border-style: solid; border-color: black;padding-top: 1mm;width:62mm;font-size:7pt;padding-left: 2.5mm;">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" select="$FormData/DispositionOfAssetsDetail"/>
												</xsl:call-template>
												<span style="width:3px"/>
											</td> 
							<!--		<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11)) ">
									<tr>
          ...
          <!--Dotted Line-->
					...
					<div style="width:256mm;display:table;">
						<div class="styLNLeftNumBoxSD">c</div>
						<div class="styLNDescLandscape" style="width:223mm;display:table;">If "Yes" to line 6b, describe in Part III how the organization defeased or otherwise settled these liabilities. If "No" to line 6b, explain in Part III.        
<!--Dotted Line-->
						</div>
						<br/>
						<!--   BEGIN HEADER   -->
      ...
      Additional Data        
					...
					<xsl:if test="($Print = $Separated) and count($FormData/DispositionOfAssetsDetail) &gt;= 9">
						...
						<table class="styLeftOverTblLandscape" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="sty990ScheduleNLNCol" scope="col" style="text-align: center;font-size: 7pt; height: auto; border-bottom-width: 1px; border-top-width:1px;padding-top:2mm;font-weight:normal;vertical-align:top;width:62mm;">
										<span style="text-align:left;float:left;padding-left:1mm">
											<b>1</b>
										</span>
										<b>(a)</b>Description of asset(s)<br/>distributed or transaction<br/>expenses paid</th>
										
									<th class="sty990ScheduleNColA" scope="col" style="text-align: center; height: auto; width:20mm;border-bottom-width: 1px;border-top-width:1px; font-size: 7pt; padding-top: 2mm;font-weight:normal;vertical-align:top">
										<b>(b)</b>Date of<br/>distribution</th>
										
									<th class="sty990ScheduleNColB" scope="col" style="border-top-width:1px;text-align: center; height: auto; width:32mm; padding-top: 0px;padding-right: 0px; font-size: 7pt; padding-top: 2mm;font-weight:normal;vertical-align:top">
										<b>(c)</b>Fair market value of<br/>asset(s) distributed or<br/>amount of transaction<br/>expenses</th>
										
									<th class="sty990ScheduleNColC" scope="col" style="border-top-width:1px;text-align: center; height: auto;width:31mm;  margin-top: 0mm;padding-top: 2mm;padding-right: 0px; font-size: 7pt;font-weight:normal;vertical-align:top">
										<b>(d)</b>Method of	<br/>determining FMV for<br/>asset(s) distributed or<br/>transaction expenses</th>
										
									<th class="sty990ScheduleNCol" scope="col" style="border-top-width:1px;text-align: center; height: auto; width:30mm; padding-top: 2mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear:   none; font-size: 7pt;font-weight:normal;vertical-align:top">
										<b>(e)</b>Ein of recipient </th>
										
									<th class="sty990ScheduleNCol" scope="col" style="border-top-width:1px;text-align: center; height: auto; width:50mm; padding-top: 2mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear:   none; font-size: 7pt;font-weight:normal;vertical-align:top">
										<b>(f)</b>Name and address of recipient</th>
										
									<th class="sty990ScheduleNCol" scope="col" style="border-top-width:1px;text-align:center; height: auto; width:30mm;padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear: none;   font-size: 6pt;font-weight:normal;vertical-align:top">
										<span style="text-align:left">
											<b>(g)</b>IRC Code section</span>
										<br/> recipient(s) (if<br/>
										<span style="text-align:left">tax-exempt) or type<br/>

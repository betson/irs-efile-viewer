...
<!-- This stylesheet was created by Sandy Cram and last modified on 11/25/2008 --><!-- This stylesheet was last modified by Sandy Cram on 1/8/2009  added shading for SRD --><!-- Last modified on 6/25/2009 by Sandy Cram  changed all references to 2008 to 2009 per BSP-091509OTH --><!-- Last modified on 9/10/2009 by Sandy Cram  Updates made per BSP-091865OTH --><!-- Last modified on 8/11/2010 by Robert Jones  Updates made per BSP-101319OTH --><!-- Updated 7/21/2011 per UWR 40502 by Robert L Jones --><!--Updated 03/02/2012 Kisams #298847 by Robert L Jones --><!--Updated 03/02/2012 To stop SRD's from Populating in Additional Table Section. Even though developed that way by IBM they seem to be on that kick this year.- by Robert L Jones --><!--Updated 05/30/2012 Defect #32229 by Robert L Jones No problem found as it was fixed in prior that apparently wasn't delivered--><!-- Updated 6/29/2012 per UWR 58215 by Robert L Jones --><!-- Last modified on 09/19/2012 by Robert Jones for UWR 58215 after getting the 2012 PDF's-->
...
<!-- Last modified on 6/23/2014 for IBM Dfect 40589 by Robert Jones-->
	...
	<!-- ================ Begin changes for Table I ========================================== -->
						...
						<div class="styTableContainerLandscape " id="p1TbCtnr">
							...
							<table cellspacing="0" style="font-size:7pt;margin-left:0mm">
								...
								<tr>
									<th class="sty990ScheduleNLNCol" scope="col" style="border-style: solid; border-color: black;text-align: center;font-size: 7pt; height: 15mm; border-bottom-width: 1px; border-top-width:1px;padding-top:1mm;font-weight:normal;vertical-align:top">
									...
									<th class="sty990ScheduleNColA" scope="col" style="border-style: solid; border-color: black;text-align: center; height: 15mm; width:20mm;border-bottom-width: 1px;border-top-width:1px; font-size: 7pt; padding-top: 1mm;font-weight:normal;vertical-align:top">
										<b>(b)</b>Date of<br/>distribution</th>
									<th class="sty990ScheduleNColB" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 15mm; width:32mm; padding-right: 0px; font-size: 7pt; padding-top: 1mm;font-weight:normal;vertical-align:top">
									...
									<th class="sty990ScheduleNCol" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 15mm; width:48mm; padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear:none; font-size: 7pt;font-weight:normal;vertical-align:top">
										<b>(f)</b>Name and address of recipient</th>
									<th class="sty990ScheduleNCol" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align:center; height: 15mm; width: 32m;padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear: none;font-size:6pt;font-weight:normal;vertical-align:top">
							...
							<xsl:if test="($Print != $Separated) or count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 10">
									<xsl:for-each select="$FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail">
										<tr>
											...
											<td class="sty990ScheduleNLNCol" style="border-style: solid; border-color: black;padding-top: 1mm;width:62mm;font-size:7pt;padding-left: 2.5mm;vertical-align:top">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="AssetsDistriOrExpnssPaidDesc"/>
												</xsl:call-template>
											</td>
											<!-- Date of Distribution col(b)-->
											<td class="sty990ScheduleNColA" style="border-style: solid; border-color: black;padding-top: 1mm;width:20mm;font-size:7pt;vertical-align:top;text-align:center">
												<xsl:call-template name="PopulateMonthDayYear">
													<xsl:with-param name="TargetNode" select="DistributionDt"/>
												</xsl:call-template>
											</td>
											<!-- Fair Market Value col(c)-->
											<td class="sty990ScheduleNColB" style="border-style: solid; border-color: black;padding-top: 1mm;width: 32mm;font-size:7pt;vertical-align:top">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="FairMarketValueOfAssetAmt"/>
												</xsl:call-template>
											</td>
											<!-- Method of determining FMV col(d)-->
											<td class="sty990ScheduleNColC" style="border-style: solid; border-color: black;padding-top: 1mm;width: 31.75mm;font-size:7pt;vertical-align:top;text-align:left">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="MethodOfFMVDeterminationTxt"/>
												</xsl:call-template>
											</td>
											<!-- EIN col(e)-->
											<td class="sty990ScheduleNCol" style="border-style: solid; border-color: black;padding-top: 1mm;width: 30mm;font-size:7pt;vertical-align:top;text-align:center">
												<xsl:call-template name="PopulateEIN">
													<xsl:with-param name="TargetNode" select="EIN"/>
												</xsl:call-template>
											</td>
											<!-- Name and Address col(f)-->
											<td class="sty990ScheduleNCol" style="border-style: solid; border-color: black; padding-top: 1mm;width: 47mm;font-size:7pt;vertical-align:top;text-align:left">
												<xsl:choose>
											...
											<!-- IRC Code  col(g)-->
											<td class="sty990ScheduleNCol" style="border-style: solid; border-color: black;padding-top: 1mm;width: 32mm;font-size:7pt;padding-right:2mm;vertical-align:top;text-align:left">
												<xsl:call-template name="PopulateText">
								...
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 9)) ">
									<tr>
										<td class="sty990ScheduleNLNCol" style="border-style: solid; border-color: black;border-right-width:1px;text-align:center">
								...
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 2 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 3 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 4 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 5 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 6 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 7 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
							<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 8 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 9 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
								<xsl:if test="count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &lt; 10 or ((count($FormData/LiquidationOfAssetsTableGrp/LiquidationOfAssetsDetail) &gt; 11) and ($Print = $Separated))">
									<xsl:call-template name="IRS990PartITableFillerRow"/>
								</xsl:if>
          ...
          <!--Dotted Line-->
            ...
            <span style="width:16px"></span>.
					...
					<div style="width:140mm;font-weight:bold; float: left; clear: none;">For Paperwork Reduction Act Notice, see the Instructions for Form 990 or Form 990-EZ.</div>
						...
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;">Schedule N (Form 990 or 990-EZ) (2014)</div>
					</div>
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
					<br/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left">Schedule N (Form 990 or 990-EZ) (2014)</div>
...
<span style="width:16px"/>.
					...
					<div style="width:256mm;">
						<div class="styLNLeftNumBoxSD">b</div>
						<div class="styLNDescLandscape" style="width:223mm; ">If "Yes" to line 6a, did the organization discharge or defease all of its tax-exempt bond liabilities during the tax year in accordance with the Internal Revenue Code and state laws?
          <!--Dotted Line-->
							<span class="styNoAudioRead" style="font-weight:bold;">
								<span style="width:16px"/>
					...
					<div style="width:256mm;">
						<div class="styLNLeftNumBoxSD">c</div>
						<div class="styLNDescLandscape" style="width:223mm">If "Yes" to line 6b, describe in Part III how the organization defeased or otherwise settled these liabilities. If "No" to line 6b, explain in Part III.        
<!--Dotted Line-->
						</div>
						<br/>
						<!--   BEGIN HEADER   -->
						...
						<div class="styTableContainerLandscape " id="p2TbCtnr">
							...
							<table cellspacing="0" style="font-size:7pt;margin-left:0mm">
								<thead class="styTableThead">
									<tr>
										<th class="sty990ScheduleNLNCol" scope="col" style="border-style: solid; border-color: black;text-align: center;font-size: 7pt; height: 14mm; border-   bottom-width: 1px; border-top-width:1px;padding-top:1mm;font-weight:normal;vertical-align:top">
											<span style="text-align:left;float:left;padding-left:1mm">
												<b>1</b>
											</span>
											<b>(a)</b> Description of asset(s)<br/>distributed or transaction<br/>expenses paid</th>
										<th class="sty990ScheduleNColA" scope="col" style="border-style: solid; border-color: black;text-align: center; height: 14mm; width:20mm;border-bottom-width: 1px;border-top-width:1px; font-size: 7pt; padding-top: 1mm;font-weight:normal;vertical-align:top">
											<b>(b)</b> Date of<br/>distribution</th>
										<th class="sty990ScheduleNColB" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 14mm; width: 32mm; padding-right: 0px; font-size: 7pt; padding-top: 1mm;font-weight:normal;vertical-align:top">
											<b>(c)</b> Fair market value of<br/>asset(s) distributed or<br/>amount of transaction<br/>expenses</th>
										<!--<span style="width:94.75mm; height: 8mm">-->
										<th class="sty990ScheduleNColC" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 14mm;width:31mm;  margin-top: 0mm;padding-top: 1mm;padding-right: 0px; font-size: 7pt;font-weight:normal;vertical-align:top">
											<b>(d)</b> Method of <br/>determining FMV for<br/>asset(s) distributed or<br/>transaction expenses</th>
										<th class="sty990ScheduleNCol" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 14mm; width:30mm; padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear: none; font-size: 7pt;font-weight:normal;vertical-align:top">
											<b>(e)</b> EIN of recipient </th>
										<th class="sty990ScheduleNCol" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 14mm; width:49mm; padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear:none; font-size: 7pt;font-weight:normal;vertical-align:top">
											<b>(f)</b> Name and address of recipient</th>
										<th class="sty990ScheduleNCol" scope="col" style="border-style: solid; border-color: black;border-top-width:1px;text-align: center; height: 14mm; width: 30m;padding-top: 1mm; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; float: none; clear: none;font-size:6pt;font-weight:normal;vertical-align:top">
											<span style="text-align:left">
												<b>(g)</b> IRC section</span>
											<br/>of recipient(s) (if<br/>
									...
									<xsl:if test="($Print != $Separated) or count($FormData/DispositionOfAssetsDetail) &lt; 10">
										<xsl:for-each select="$FormData/DispositionOfAssetsDetail">
											<tr>
												...
												<!-- Name and Address col(f)-->
												<td class="sty990ScheduleNCol" style="border-style: solid; border-color: black; padding-top: 1mm;width: 49mm;font-size:7pt;vertical-align:top;text-align:left;">
													<xsl:choose>
														<xsl:when test="PersonNm">
															<xsl:call-template name="PopulateText">
																<xsl:with-param name="TargetNode" select="PersonNm"/>
												...
												<!-- IRC Code col(g)-->
												<td class="sty990ScheduleNCol" style="border-style: solid; border-color: black;padding-top: 1mm;width: 30mm;font-size:7pt;padding-right:2mm;vertical-align:top;text-align:left">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="IRCSectionTxt"/>
													</xsl:call-template>
												</td>
 ...
 Also complete this part to provide any additional information.</span>
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule N (Form 990 or 990-EZ) (2014)</span>
						</div>
					</div>
					<!--END Page Footer-->
					<br/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/Section18842Td5Statement"/>
  ...
  <xsl:template name="Section18842Td5StatementTemp">
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="Section18842Td5StatementTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
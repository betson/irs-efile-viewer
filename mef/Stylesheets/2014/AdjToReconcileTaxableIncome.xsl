...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/AdjToReconcileTaxableIncome"/>
 <!-- Display Name is Other Adjustments To Reconcile Taxable Income Statement -->
  <!-- Main template begin -->
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body class="styBodyClass">
        ...
        <div class="styDepTitleLine">
          <span class="styDepTitle">
            <span style="width:154mm;"><xsl:value-of select="$depDocTitle"/></span>
          </span>
        </div>
	  ...
	  <!--table begin -->      
      	...
      	<xsl:for-each select="$DependencyData/AdjustmentsToReconcile">
        		<tr>

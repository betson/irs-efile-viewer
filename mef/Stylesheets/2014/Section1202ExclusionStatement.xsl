...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/Section1202ExclusionStatement"/>
  ...
  <xsl:template name="ShowDependencyData">
    ...
    <table id="DependencyDataTbl" class="styDepTbl" style="font-size:7pt;">
      ...
      <tr class="styDepTblHdr">         
         ...
         <th class="styDepTblCell" style="width: 36mm" scope="col">Share of Section 1202 Gain</th>  
       ...
       <tbody>
      <xsl:for-each select="$DependencyData/Section1202ExclusionGrp">
        <tr>
          ...
          <xsl:choose>
	       ...
	       <td class="styDepTblCell" style="text-align:center; width: 25mm">      		
	          <xsl:call-template name="PopulateText">
	            <xsl:with-param name="TargetNode" select="BoughtDt"/>
	          </xsl:call-template> 
		</td>  
	       <td class="styDepTblCell" style="text-align:center; width: 25mm">      		
	          <xsl:call-template name="PopulateText">

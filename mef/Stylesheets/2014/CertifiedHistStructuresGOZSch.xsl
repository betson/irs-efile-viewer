...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/CertifiedHistStructuresGOZSch"/>
	<!-- 3468- Certified Historical Structures GOZ Schedule -->
				...
				<table id="Tbl" class="styDepTblLandscape" style="font-size:7pt;">
					<thead class="styDepTableThead">
						<tr class="styDepTblHdr">
							<th class="styDepTblCell" scope="col" style="width:25mm;">Credit Amount</th>
							<th class="styDepTblCell" scope="col" style="width:30mm;">NPS Project Number</th>
							<th class="styDepTblCell" scope="col" style="width:25mm;">Date of NPS Approval</th>
							<th class="styDepTblCell" scope="col" style="width:20mm;">Rehabilitation Test Period Begin</th>
							<th class="styDepTblCell" scope="col" style="width:20mm;">Rehabilitation Test Period End</th>
							...
							<th class="styDepTblCell" scope="col" style="width:44mm;">Explanation</th>
							<th class="styDepTblCell" scope="col" style="width:30mm;">Prior Year Credit Date</th>
						</tr>
					</thead>
					<tfoot/>
					<tbody>
						<xsl:for-each select="$FormData/CertifiedHistStructuresGOZSch">
							<tr>

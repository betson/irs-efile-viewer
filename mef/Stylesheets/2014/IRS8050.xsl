...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		<html>
			...
			<body class="styBodyClass">
				<form style="font-family:arial; font-size:9pt" name="Form8050">
					...
					<div class="styBB" style="width:187mm; background-color:lightgrey;border-top:1 solid black; border-bottom:1 solid black;height:9mm;">
						<div style="float:left"/>
						<div style="height:8.5mm; background-color:white; width:50mm; font-size:8pt; border-left:1 solid black; padding-left:2mm; float:right;height:9mm">
							<div style="padding-bottom:0.5mm">Phone number (optional)</div>
							<xsl:choose>
								<xsl:when test="normalize-space($Form8050Data/PhoneNum)=''">(<span style="width:9mm"/>)
								</xsl:when>
								<xsl:otherwise>
        ...
        Form <b style="font-size:9pt">8050</b> (12-2009)

        ...
        <tr class="styDepTblRow2">  
          ...
          <td class="styDepTblCell" style="text-align:left">     
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="LenderNameGrp/BusinessName/BusinessNameLine1"/></xsl:call-template>
                <xsl:if test="LenderNameGrp/BusinessName/BusinessNameLine2">
                  <br/><xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="LenderNameGrp/BusinessName/BusinessNameLine2"/></xsl:call-template>
                </xsl:if>
              </xsl:otherwise>
            </xsl:choose>                
          </td>

    ...
    <html lang="EN-US">
      ...
      <body class="styBodyClass">
        <form name="FormW2">
          ...
          <div style="width:187mm;height:109mm;border-top:1px solid black;             border-bottom:0px solid black;border-left:1px solid black;border-right:1px solid black">
            ...
            <div class="styIRSW2leftBox" style="width:187mm;height:8.47mm;border-left:0px;                border-bottom:1px solid black;">
              ...
              <!-- Box 1 -->
              <div class="styIRSW2leftBox" style="width:41mm;height:8.47mm;border-left:1px solid black;                 border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black">
                <span style="width:1.5mm"/>
            ...
            <div class="styIRSW2leftBox" style="width:187mm;height:25.3mm;border-left:0px;                border-bottom:1px solid black;">
              ...
              <div class="styIRSW2leftBox" style="width:81.8mm;height:24.5mm;border-left:0px;                  border-right:0px solid black;">
                ...
                <div class="styIRSW2leftBox" style="width:81.8mm;height:8.33mm;                   border-left:0px solid black;border-right:0px solid black;                   border-bottom:1px solid black;">
                  <!-- Box 3 -->
                  <div class="styIRSW2leftBox" style="width:41mm;height:8.33mm;                     border-left:0px solid black;border-right:1px solid black;                     border-top:0px solid black;border-bottom:0px solid black">
                    <span style="width:1.5mm"/>
                ...
                <div class="styIRSW2leftBox" style="width:81mm;height:8.36mm;                    border-left:0px solid black;border-right:0px solid black;                   border-bottom:0px solid black;">
                  <!-- Box 7 -->
                  <div class="styIRSW2leftBox" style="width:41mm;height:8.6mm;                     border-left:0px solid black;border-right:1px solid black;                     border-top:0px solid black;border-bottom:0px solid black">
                    <span style="width:1.5mm"/>
            ...
            <div style="width:187mm;height:47mm;border-left:0px;               border-bottom:1px solid black;">
              <!-- Big Box covers Boxes e and f (Employee's first name and initial, last name, suff. and 
                    Employee's addr and zip) -->
              <div class="styIRSW2leftBox" style="width:105mm;height:47.3mm;border-left:0px solid black;                 border-right:0px solid black">
                <!-- Box e (Employee's first name and initial, last name, suff.) -->
                <div class="styIRSW2leftBox" style="width:105mm;height:22.2mm;                   border-left:0px solid black;border-right:0px solid black">
                  <span style="width:1.5mm"/>
              ...
              <div class="styIRSW2leftBox" style="width:81.5mm;height:47mm;border-left:0px;                 border-right:0px solid black;float:left;clear:none">
                <!-- Box covers Boxes 11, 13, 14 -->
                <div class="styIRSW2leftBox" style="width:40.5mm;height:47mm;border-left:0px;                   border-right:1px solid black;">
                  <!-- Boxes 11-->
                  <div class="styIRSW2leftBox" style="width:40.5mm;height:10.7mm;border-left:0px;                     border-left:1px solid black;border-right:0px;border-top:0px;border-bottom:1px solid black">
                    <span style="width:.5mm"/>
                  ...
                  <!-- Box 13 -->
                  <div class="styIRSW2leftBox" style="width:40.5mm;height:10.7mm;border-left:0px;                     border-right:0px;border-top:0px;border-bottom:1px solid black">
                     <div class="styIRSW2leftBox" style="width:14.5mm;height:10.7mm;border-left:1px solid black;                        border-right:0px;border-top:0px;border-bottom:0px">                     
                        <span style="width:.3mm"/>
                    ...
                    <div class="styIRSW2leftBox" style="width:12.7mm;height:10.7mm;border-left:0px;                        border-right:0px solid black;border-top:0px;border-bottom:0px solid black">                     
                       <span style="width:.5mm"/>
                       <label>
                          <xsl:call-template name="PopulateLabel">
                    ...
                    <div class="styIRSW2leftBox" style="width:13.3mm;height:10.7mm;border-left:0px;                        border-right:0px solid black;border-top:0px;border-bottom:0px solid black">                     
                       <span style="width:.5mm"/>
                       <label>
                          <xsl:call-template name="PopulateLabel">
                  ...
                  <xsl:if test="($Print = 'inline') and (count($FormW2Data/OtherDeductionsBenefitsGrp) &lt;1)">
                    <div class="styGenericDiv" style="width:40mm;height:22mm;font-size:7pt;                       border-left:1px solid black">
                    </div>
                  </xsl:if> 
                  ...
                  <xsl:if test="($Print != 'inline') and ($Print !=$Separated)">
                    <div class="styTableContainer" style="width:40.5mm;height:22.5mm;border-right:0px;                       border-bottom:0px solid black;border-left:1px solid black" id="othDedBen">
                      <!-- print logic -->
                      <xsl:call-template name="SetInitialState"/>
                      <!-- end-->
                      <table class="styTable" cellspacing="0">
                  ...
                  <xsl:if test="($Print = $Separated) and (count($FormW2Data/OtherDeductionsBenefitsGrp) &gt;2)">
                    <div class="styGenericDiv" style="width:40mm;height:22.7mm;font-size:7pt;                       border-left:1px solid black">
                      <tbody>
                        <tr>
                ...
                <xsl:if test="(count($FormW2Data/EmployersUseGrp) &lt;=4)">
                  <div class="styIRSW2leftBox" style="width:40.5mm;height:46.5mm;                      border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                    <!--<xsl:if test="($Print != $Separated) or (count($FormW2Data/EmployersUseGrp)&lt;= 4)">-->
                    <!-- Boxes 12a, 12b, 12c and 12d -->
                    <div class="styIRSW2leftBox" style="width:40.5mm;height:9.5mm;                       border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                      <!-- Left Box 12a -->
                      <div class="styIRSW2leftBox" style="width:40.5mm;height:2mm;                         border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                        <span style="width:1mm"/>
                        <span style="font-size: 6.5pt;font-weight:bold;">12a</span>
                        <span style="width:.8mm;"/>
                        <span style="font-size:7.5">See instructions for box 12</span>
                      </div>
                      <div class="styIRSW2leftBox" style="width:12mm;height:7.5mm;border-top:0px;                         border-left:0px;border-right:1px solid black;border-bottom:1px solid black">
                      ...
                      <!-- Right Box 12a -->
                      <div class="styIRSW2leftBox" style="width:28.4mm;height:7.5mm;border-top:0px;                         border-left:0px;border-right:0px;border-bottom:1px solid black">
                        <br/>
                      ...
                      <div class="styIRSW2leftBox" style="width:12mm;height:7.5mm;border-top:0px;                          border-left:0px;border-right:0px;border-bottom:1px solid black">
                        <div class="styUseLbl" style="font-size:5;width:2mm;padding-top:.1mm;                           border-right-width:0px;padding-bottom:.1mm">c o d e</div>
                        <span style="font-size:6pt;padding-top:1mm;width:7mm;float:bottom;">
                          <xsl:for-each select="$FormW2Data/EmployersUseGrp">
                            <xsl:choose>
                    ...
                    <!-- Grey box -->
                    <div class="styIRSW2leftBox" style="width:40.5mm;height:5.2mm;border-top:0px;                        background-color:lightgrey;border-left:0px;border-right:0px;border-bottom:0px">
                    </div><!-- Closes Grey Box-->
                ...
                <xsl:if test="($Print = $Separated) and (count($FormW2Data/EmployersUseGrp)&gt;4)">
                  ...
                  <div class="styIRSW2leftBox" style="width:40.5mm;height:46.5mm;                      border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                    <!-- Boxes 12a, 12b, 12c and 12d -->
                    <div class="styIRSW2leftBox" style="width:40.5mm;height:9.55mm;                       border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                      <!-- Left Box 12a -->
                      <div class="styIRSW2leftBox" style="width:40.5mm;height:2mm;                         border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                        <span style="width:1mm"/>
                        <span style="font-size: 6.5pt;font-weight:bold;">12a</span>
                      ...
                      <div class="styIRSW2leftBox" style="width:11mm;height:7.55mm;border-top:0px;                         border-left:0px;border-right:1px solid black;border-bottom:1px solid black">
                      ...
                      <!-- Right Box 12a -->
                      <div class="styIRSW2leftBox" style="width:29.4mm;height:7.55mm;font-size:6pt;border-top:0px;                         border-left:0px;border-right:0px;border-bottom:1px solid black">
                         <br/>
                      ...
                      <div class="styIRSW2leftBox" style="width:11mm;height:7.6mm;border-top:0px;                          border-left:0px;border-right:1px solid black;border-bottom:1px solid black">
                        <div class="styUseLbl" style="font-size:5;width:2mm;padding-left:.5mm;padding-top:.1mm;                           border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
                      </div><!-- Closes Left Box 12b-->
                      <!-- Right Box 12b -->
                      <div class="styIRSW2leftBox" style="width:29.4mm;height:7.6mm;border-top:0px;                         border-left:0px;border-right:0px;border-bottom:1px solid black">
                        <br/>
                      </div><!-- Closes Right Box 12b-->
                      <!-- Left Box 12c -->
                      <div class="styIRSW2leftBox" style="width:40.5mm;height:2mm;border-top:0px;                         border-left:0px;border-right:0px;border-bottom:0px">
                      ...
                      <div class="styIRSW2leftBox" style="width:11mm;height:7.5mm;border-top:0px;                         border-left:0px;border-right:1px solid black;border-bottom:1px solid black">
                        <div class="styUseLbl" style="font-size:5;width:2mm;padding-left:.5mm;padding-top:.1mm;                           border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
                      </div><!-- Closes Left Box 12c-->
                      <!-- Right Box 12c -->
                      <div class="styIRSW2leftBox" style="width:29.4mm;height:7.5mm;border-top:0px;                          border-left:0px;border-right:0px;border-bottom:1px solid black">
                        <br/>
                      </div><!-- Closes Right Box 12c-->
                      <!-- Left Box 12d -->
                      <div class="styIRSW2leftBox" style="width:40.5mm;height:2mm;border-top:0px;                         border-left:0px solid black;border-right:0px;border-bottom:0px">
                      ...
                      <div class="styIRSW2leftBox" style="width:11mm;height:7.5mm;border-top:0px;                          border-left:0px;border-right:0px;border-bottom:1px solid black">
                        <div class="styUseLbl" style="font-size:5;width:2mm;padding-left:.5mm;padding-top:.1mm;                           border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
                      </div><!-- Closes Left Box 12d-->
                      <!-- Right Box 12d -->
                      <div class="styIRSW2leftBox" style="width:29.4mm;height:7.5mm;border-top:0px                          border-left:0px;border-right:0px;border-bottom:1px solid black">
                      ...
                      <tbody>
                        <xsl:if test="($Print != $Separated) and (count($FormW2Data/EmployersUseGrp)&gt;4)">
                          ...
                          <tr>
                            <td class="styTableCellText" style="width:36mm;border-top:0px;                               border-left:0px;border-right:0px;border-bottom:1px solid black">              
                              <!-- Left Box 12a -->
                              <div class="styGenericDiv" style="width:11mm;height:8.3mm;border-top:0px;                                  border-left:0px;border-right:1px solid black;border-bottom:0px solid black">
                                <div class="styUseLbl" style="font-size:5;width:2mm;padding-top:.1mm;                                   border-right-width:0px;padding-bottom:.1mm">c o d e</div>
                                <span style="font-size:6pt;padding-top:1mm;width:5mm;float:bottom;">
                                  <xsl:for-each select="$FormW2Data/EmployersUseGrp">
                                    <xsl:choose>
                          ...
                          <tr>
                            ...
                            <td class="styTableCellText" style="width:36mm;border-top:0px;                               border-left:0px;border-right:0px;border-bottom:1px solid black">
                              ...
                              <!-- Left Box 12c -->
                              <div class="styGenericDiv" style="width:11mm;height:8.35mm;border-top:0px;                                  border-left:0px;border-right:1px solid black;border-bottom:0px solid black">
                                <div class="styUseLbl" style="font-size:5;width:2mm;padding-top:.1mm;                                   border-right-width:0px;padding-bottom:.1mm">c o d e</div>
                                <span style="font-size:6pt;padding-top:1mm;width:5mm;float:bottom;">
                                  <xsl:for-each select="$FormW2Data/EmployersUseGrp">
                                    <xsl:choose>
                          ...
                          <tr>
                            ...
                            <td class="styTableCellText" style="width:36mm;border-top:0px;                                border-left:0px;border-right:0px;border-bottom:1px solid black">
                              ...
                              <!-- Left Box 12d -->
                              <div class="styGenericDiv" style="width:11mm;height:8.4mm;border-top:0px;                                  border-left:0px;border-right:1px solid black;border-bottom:0px solid black">
                                <div class="styUseLbl" style="font-size:5;width:2mm;padding-top:.1mm;                                   border-right-width:0px;padding-bottom:.1mm">c o d e</div>
                                <span style="font-size:6pt;padding-top:1mm;width:5mm;float:bottom;">
                                  <xsl:for-each select="$FormW2Data/EmployersUseGrp">
                                    <xsl:choose>
                              ...
                              <xsl:when test="position()=5">
                                ...
                                <tr>
                                  ...
                                  <td class="styTableCellText" style="width:36mm;border-top:0px;                                     height:2mm;border-left:0px;border-right:0px;border-bottom:1px solid black">
                                    ...
                                    <!-- Left Box 12e -->                                  
                                    <div class="styGenericDiv" style="width:11mm;height:8.4mm;                                       border-left:0px;border-right:1px solid black;border-top:0px;                                       border-bottom:0px solid black">
                                      <div class="styUseLbl" style="font-size:5;width:2mm;                                         border-right-width:0px;padding-top:.1mm;padding-bottom:.1mm">c o d e</div>
                                      <span style="font-size:6pt;padding-top:1mm;width:5mm;float:bottom;">
                                        <span style="float:left">
                                          <xsl:call-template name="PopulateText">
                                  ...
                                  <xsl:when test="position()&gt;=6">
                                    ...
                                    <tr>
                                      ...
                                      <td class="styTableCellText" style="width:36mm;height:2mm;                                         border-left:0px;border-right:0px;border-top:0px;border-bottom:1px solid black">
                                        ...
                                        <!-- Left Boxes 12f and above -->
                                        <div class="styGenericDiv" style="width:11mm;height:8.4mm;                                           border-left:0px;border-top:0px;border-right:1px solid black;                                           border-bottom:0px solid black">
                                          <div class="styUseLbl" style="font-size:5;padding-top:.1mm;                                             width:2mm;border-right-width:0px;padding-bottom:.1mm">c o d e</div>
                                          <span style="font-size:6pt;padding-top:1mm; width:5mm;float:bottom;">
                                            <span style="float:left">
                                              <xsl:call-template name="PopulateText">

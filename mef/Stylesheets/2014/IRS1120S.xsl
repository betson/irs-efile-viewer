			...
			<body class="styBodyClass">
				<form name="Form1120S">
					...
					<div class="styBB" style="width:187mm;float:left;clear:left;">
						...
						<div class="styLblNameAddr" style="width:109mm;height:auto;">
							<div class="styUseLbl" style="text-align:center;width:12mm;height:auto;border-right-width:0px;font-size:7pt;font-weight:bold;padding-top:7mm;">
							TYPE<br/>
							OR<br/>
							PRINT
							</div>
							<div class="styNameAddr" style="width:95.4mm;height:auto;border-left-width:1px;">
								Name<br/>
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:95.4mm;height:auto;border-left-width:1px;float:right;">
						...
						<div class="styEINDateAssets" style="width:46.75mm;height:auto;">
						...
						<div class="styEINDateAssets" style="width:46mm;height:auto;border-bottom-width:0px;">
							...
							<xsl:choose>
								<xsl:when test="$Form1120SData/AmendedReturnInd">
									...
									<label style="font-size:6pt; padding-right:2mm;">
										...
										Selection termination or revocation          
									</label>
								</xsl:when>
								<xsl:otherwise>
					...
					<div class="styBB" style="width:187mm;font-size:6pt; float:none; clear:both;">
						...
						<div style="width:164mm;float:left;clear:none;">
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;border-leftright:1px;">
								...
								<div class="styLNDesc" style="height:7.5mm;width:18.1mm;border-right:1px solid black;;padding-top:0mm;padding-bottom:0mm;padding-left:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
							...
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:6mm;width:126.5mm;border-right:1px solid black;;border-left:1px solid black;;padding-left:1mm;height:auto;">
								...
								<div class="styLNDesc" style="height:6mm;width:32mm;padding-left:1mm;height:auto;">Firm's EIN
									<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="width:4px;"/>

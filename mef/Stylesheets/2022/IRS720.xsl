	...
	<xsl:call-template name="DocumentHeader"/>
		...
		<div class="styBB" style="width:187mm;height: 20mm">
			<div class="styFNBox" style="height: 20mm; width:31mm;font-size: 7pt">
				...
				<br/>
              <span class="styAgency" style="font-size: 7.5pt; font-weight:normal">(Rev. March 2021) </span>
				<br/>
      ...
      <td style="text-align: right; border-color: black; border-style: solid; border-top-width: 1px; border-right-width:0px; border-left-width:0px; border-bottom-width:0px; font-weight:normal; padding-right:1mm" >  
        ...
        Form <span class="styBoldText" style="font-size:8pt;">720</span> (Rev. 3-2021)
      </div>
						</td>
					</tr>
				</tbody>
				...
				<tbody>
					<tr>
						<td colspan="8" class="styBB" style="width:187mm">
							<div style="float: left; clear: none">Form 720 (Rev. 3-2021)</div>
...
taxed at $.219</td>
    ...
    Form <span style="font-size:8pt;font-weight:bold">720</span> (Rev. 3-2021)
  </div>
		<!-- End Footer -->
		<!-- ========================================================================= -->
		<!-- END PAGE 5  -->

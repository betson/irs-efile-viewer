        ...
        For calendar year 2018, or other tax year beginning
					...
					<xsl:call-template name="PopulateReturnHeaderTaxPeriodEndDate"/>
						...
						<div class="styTYBox" style="width:30mm;height:19mm; border-left-width: 1px;">
							...
							<br/>
							<div class="styTaxYear" style="height:10mm">20<span class="styTYColor">18</span>
							</div>
						</div>
					</div>
					<!--  End title of Form  -->
										...
										<tr>
											...
											<td style="width: 92mm;font-size:8pt;">
												<div style="width:92mm; padding-top:.5mm;">
													...
													<span class="styLNDesc" style="width:50mm;height:auto;font-size:7pt;">Estimate of total tax liability for 2018
                                    </span>
										...
										<tr>
											...
											<td style="width: 92mm;font-size:8pt;">
												<div style="width: 92mm;padding-top:.1mm; padding-bottom:.1mm;">
													...
													<span class="styLNDesc" style="width:30mm;height:auto;font-size:7pt;">Total 2018 payments</span>
                                   ...
                                   <span style="width:7px;"/>.
                                    ...
                                    <span style="width:7px;"/>.
                                     <span style="width:7px;"/>.
                                      <span style="width:7px;"/>.
                                     <span style="width:7px;"/>.-->
                                    <span style="width:35mm;border-bottom: 1px solid black;text-align:right;font-size:8pt">
															<xsl:call-template name="PopulateAmount">
										...
										<tr>
											...
											<td style="width: 92mm;font-size:8pt;">
												<div style="width: 92mm; padding-top: .5mm;border-bottom:1px  solid black">
													...
													<span class="styLNDesc" style="width:87mm;height:auto;font-size:7pt;">Amount you're paying <span style="font-size:6pt;">(see instructions)</span>
										...
										<tr>
											...
											<td style="width:92mm;font-size:8pt;">
												<div style="width:92mm; padding-top: .1mm;">
													...
													<div class="styLNDesc" style="width:80mm;height:4mm;font-size:7pt;">Check here if you're "out of the country" and a U.S.<br/>
														...
														<span class="styBoldText">
														 <span style="width:1.5mm;"/>
														<div class="styDotLn" style="float:none;padding-right:0mm;">.......</div>
                                 	<span style="width:0.5mm;padding-top:2mm;"/>
										...
										<img src="{$ImagePath}/4868_Bullet.gif" width="4" height="7" alt="Right arrow image" border="0"/>	-->
														...
														alt="Check here if you're out of the country and a U.S. citizen or resident (see instructions)">
												...
												<div style="width: 92mm; padding-top: .1mm;">
													...
													<div class="styLNDesc" style="width:80mm;height:auto;font-size:7pt;">
														<label>
															...
															<br/>Check here if you file Form 1040NR or 1040NR-EZ and didn't<br/>receive wages as an employee subject to U.S. income<br/>tax withholding
														</label>
														<span class="styBoldText">
														<div class="styDotLn" style="float:none;padding-right:0mm;">..............</div>
					...
					<div style="width: 187mm;font-size:7pt;">
						...
						<span style="font-size:7 pt;float:right;">Form <b>4868 </b>(2018)</span>
					</div>

	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
				...
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div style="width:187mm;height:14mm;">
							...
							<span class="styTaxYear">20<span class="styTYColor">18</span></span>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2018 or fiscal year beginning 
								<span style="width:2mm;"/>
								<xsl:call-template name="PopulateReturnHeaderTaxPeriodBeginDate"/>, 2018, and ending 
								<span style="width:2mm;"/>
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2018 net 965 tax liability paid from Form 965-A, Part II, column (k), line 2</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">
										<b>Payments: a</b> 2018 estimated tax payments and amount applied from 2017 return
										<xsl:call-template name="LinkToLeftoverDataTableInline">
		...
		<!--Line 25f-->
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2018 net 965 tax liability from Form 965-A, Part I, column (f), line 2</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
		  ...
		  <!--Line 26-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><b>Total payments.</b> Add lines 25c through 25f, and 25i</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="12"/>
					</xsl:call-template>
		  ...
		  <!--Line 28-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><b>Tax due.</b> If line 26 is smaller than the total of lines 23, 24, and 27, enter amount owed</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
		  ...
		  <!--Line 29-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;"><b>Overpayment.</b> If line 26 is larger than the total of lines 23, 24, and 27, enter amount overpaid</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="3"/>
					</xsl:call-template>			  
		  ...
		  <!--Line 30-->
			<div style="width:181.8mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:134.3mm;height:4mm;">
				<span style="float:left;">Amount of line 29 to be: <b> a Credited to 2019 estimated tax</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">30</div>
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2018)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2018)</span>

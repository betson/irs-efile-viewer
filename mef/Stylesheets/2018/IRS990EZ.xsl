	...
	<xsl:template match="/">
      ...
      20<span class="styTYColor">18</span>
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:auto;width:182mm;float:left;clear:none;">For the 2018
...
<!-- Section H -->
  ...
  Add lines 5b, 6c, and 7b to line 9 to determine gross receipts. If gross receipts are $200,000 or more, or if total assets (Part II, column (B)  
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span> (2018)
  </div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="width:187mm;padding-top:1mm;">
						<div style="float: left; clear: none">Form 990-EZ (2018)</div>
						<div style="float:right">
...
-->
	...
	<!-- </label> -->
					...
					<!--   BEGIN FORM FOOTER  -->
					<div style="width:187mm;">
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2018)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>

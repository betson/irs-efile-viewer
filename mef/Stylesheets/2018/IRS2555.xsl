          ...
          <div style="width:187mm;height:12mm">
            ...
            <div style="float:left;position:relative;">
              ...
              <div class="styLNDesc" style="font-size:7pt;width:131mm;height:3mm;padding-right:4mm;padding-left:5mm">
                <li>If line 38 and the number of days in your 2018 tax year (usually 365) are the same, enter "1.000."</li>
                <li>Otherwise, divide line 38 by the number of days in your 2018 tax year and enter the result as a decimal

	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2018 that would require you to file Form(s) 1099? (see instructions)</span>
...
<div style="width:187mm;float:none;clear:both; ">  
	...
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2018 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p style="page-break-before: always"/>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:all;">  
      <div style="float:left;">Schedule C (Form 1040) 2018 <span style="width:130mm;"/></div>
 ...
 <!--Line 41-->   
  ...
  <!--Line 48-->
    ...
    <div style="width:187mm;clear:all;">    
      ...
      <div class="stySmallText" style="width:46mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2018</span> </div>
    </div>
    <!--    </div> -->      

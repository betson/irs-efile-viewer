  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
            ...
            <div class="styFTBox" style="height: 18mm;width:122mm">
              ...
              <div class="styFST" style="font-size:7pt;margin-left:3mm;font-weight:bold"> 
               ...
               <div style="padding-top:1.5mm">
                  <img src="{$ImagePath}/8834_Bullet.gif" alt="MediumBullet"/>  
				  Go to <i>www.irs.gov/Form8834 for the latest information</i>.
				</div>
              </div>
            </div>
      ...
      Name(s) shown on return<br/>
       ...
       <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Individuals. Enter the sum of the amounts from Form 1040, lines 44 and 46; or the sum of the amounts from Form 1040NR, lines 42 and 44.<br/>
...
lines 1a and 1b, or the amount from the applicable line of your return.                   
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNDesc" style="width:117mm;height:18mm;padding-top:3mm;">
          Tentative minimum tax:            
        <li style="height:4mm; padding-top: .75mm" title="bullet" alt="bullet">Individuals. Enter the amount from Form 6251, line 33.</li>
        <li style="height: 4mm; padding-top: .75mm" title="bullet" alt="bullet">Corporations. Enter -0-.</li>
        <li style="height: 4mm; padding-top: .75mm" title="bullet" alt="bullet">Estates and trusts. Enter the amount from Schedule I (Form 1041), line 54.</li>                   
        </div>
...
<span style="letter-spacing:4mm; font-weight:bold"> .........
  ...
  <div class="styLNRightNumBoxNBB" style="width:8.25mm;height:4.5mm;border-right-width:1px;padding-top:0mm;background-color:lightgrey;"/>
     ...
     <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">8834</span> (Rev. 10-2018)</div>
          </div><br/><br/>

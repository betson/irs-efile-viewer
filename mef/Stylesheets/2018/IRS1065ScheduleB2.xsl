...
<!-- Last Modified by Steven Fook on 10/24/2018 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								...
								<xsl:for-each select="$NodeData/ShareholderGrp">
									...
									<xsl:if test="($Print != $Separated) or (count($NodeData/ShareholderGrp) &lt;=2)">
						...
						<table class="styTable" cellspacing="0">
							...
							<tbody>
								...
								<xsl:for-each select="$Form1065SchB2Data/PartnerListGrp">
									...
									<xsl:if test="($Print != $Separated) or (count($Form1065SchB2Data/PartnerListGrp) &lt;=2)">

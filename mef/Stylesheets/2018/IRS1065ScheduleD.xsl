...
<!--Created by Doug Peterson 6-27-2006 submitted for inspection 7-13-2006--><!-- Last Modified by Steven Fook on 9/6/2018 -->
         ...
         Employer identification number<br/>
					...
					<div class="styBB" style="width:187mm;height:auto;">
						...
						<div class="styPartDesc" style="float:left;width:167mm;font-size:9pt;height:auto;"> 
						 Short-Term Capital Gains and Losses (See instructions)</div>
					</div>
					<!-- END PART I TITLE -->
					<!-- BEGIN PART I TABLE -->
					...
					<!-- BEGIN PART 2 TITLE -->
					  ...
					  <div class="styBB" style="width:187mm;height:auto;border-top-width:1px;">
						...
						<div class="styPartDesc" style="float:left;width:167mm;font-size:9pt;height:auto;">
						  Long-Term Capital Gains and Losses (See instructions)</div>
					 </div>
					<!-- END PART II TITLE -->
					<!-- BEGIN PART II TABLE -->
					<div style="width:187mm;height:auto;">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;font-size:7pt">
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule D (Form 1065) 2018</span>
						</div>
					</div>
								...
								<tr>
									<td class="styLeftOverTableRowDesc" style="width:130mm;" scope="row">
										<label>
											...
											<xsl:text>Check the box if you have Like-Kind Exchange, or Related Party Exchange or Related Party Like-Kind Exchange</xsl:text>:</label>
									</td>

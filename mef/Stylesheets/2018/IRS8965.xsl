			...
			<body class="styBodyClass" style="margin-bottom:10px">
				<form name="Form8965">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:123mm;border-right:1px solid black;border-left:1px solid black;height:19mm;padding-top:3mm;">
							...
							<div class="styFBT" style="height:4mm;margin-top:0mm;">
								...
								<span>Attach to Form 1040, Form 1040A, or Form 1040EZ.</span><br/>
								<img src="{$ImagePath}/2106EZ_Bullet.gif" width="9" height="9" alt="Bullet"/>
								Go to <i><a style="text-decoration:none;color:black;" href="http://www.irs.gov/form8965">www.irs.gov/Form8965</a></i> for instructions and the latest information.
							</div>
						</div>
						<div class="styTYBox" style="width:32mm;border-left:none;">
							<div class="styOMB">OMB No. 1545-0074</div>
							<div class="styTaxYear" style="line-height:30px;">20<span class="styTYColor">18</span></div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:177mm;height:8mm;float:left;padding-top:3mm;padding-left:1mm;">
							<span style="float:left;">If you are claiming a coverage exemption because your household income or gross income is below the filing threshold, check here</span>
							<div style="height:8mm;font-size:7pt;float:right;">
								<span style="float:right;">						
									<input type="checkbox" class="styCkbox" alt="IRS8965IncmBelowFlngThresholdInd">
									...
									<xsl:if test="($Print != $Separated) or (count($Form8965Data/RequestExemptCvrTaxHsldGrp) &lt;=6)">
										<tr style="height:12mm;">
											...
											<td class="styTableCell" style="text-align:center;vertical-align:bottom;width:100%;border-left-width:1px;border-right-width:2px;border-bottom-width:0px;border-top-width:1px;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="FullYearInd"/>
												</xsl:call-template>
											</td>
											<!--January Indicator-->
											<td class="styTableCell" style="text-align:center;vertical-align:bottom;width:100%;border-bottom-width:0px;border-top-width:1px;">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:8pt;">8965</span> (2018)
						</div>						
					</div>

		...
		<form name="Form1120FScheduleP">
		  ...
		  <div class="styGenericDiv" style="width:187mm;">
			...
			<div class="styBB" style="width: 187mm">
			  <!-- Form Name -->
			  <div class="styFNBox" style="height: 20mm;width:28mm;">
			  ...
			  <!-- Form Title Box -->
			  <div class="styFTBox" style="height: 20mm;width:131mm;padding-top:3mm;">
			    <!-- Form Title -->
			  ...
			  <!-- Tax Year Box -->
			  <div class="styTYBox" style="height: 20mm;width:28mm;">
			    <!-- OMB No. -->
			  ...
			  <div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
						...
						<xsl:if test="($Print != $Separated) or (count($FormData/ForeignPartnerInformationGrp) &lt;= 4) ">
						  <xsl:for-each select="$FormData/ForeignPartnerInformationGrp">
                            ...
                            border-right:0;height:12mm;text-align:center;vertical-align:middle;border-bottom:0;</xsl:when>
								...
								<input type="checkbox" class="styCkbox" alt="DistributiveShareTreatedAsECI" name="DistributiveShareTreatedAsECIcheckbox">
								  <xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="DistributiveShareTreatedECIInd"/>
									<xsl:with-param name="BackupName">IRS1120FSchPDistributiveShareTreatedAsECI<xsl:value-of select="position()"/></xsl:with-param>
								  </xsl:call-template>
				...
				<div style="width:187mm;">
				  ...
				  <div style="width:187mm;padding-top:1mm">
					...
					<span style="font-weight:bold;float:right;">Schedule P (Form 1120-F) 2018</span>
				  </div>
				  <!-- end page break and footer  -->
				  <p class="pageEnd"/>
				  <!-- Begin Page 2 -->
				  <div style="width:187mm">
				    <span style="font-weigh:normal;float:left;">Schedule P (Form 1120-F) 2018</span>
					...
					<!-- Begin Part III Table -->
					  ...
					  <div style="width:187mm;padding-top:0.5mm;">
						...
						<div style="float:right;">
						  ...
						  <span class="styBoldText">Schedule P (Form 1120-F) 2018</span>
						</div>
					  </div>
					  <div class="pageEnd"/>
					  <!-- end page break and footer  -->

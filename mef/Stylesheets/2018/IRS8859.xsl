		...
		<html>
            ...
            Form <span class="styFormNumber">8859<br/>
						...
						<div class="styTYBox" style="width:31mm;height:22mm;">
							...
							<div class="styTY" style="height:7mm;font-size:22pt;padding-top:2mm;">20<span class="styTYColor">18</span>
							</div>
          ...
          Your social security number<br/>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc">
							<span class="styGenericDiv">
								Credit carryforward from 2017. Enter the amount from line 4 of your 2017 Form 8859 
								<xsl:call-template name="SetFormLinkInline">
					...
					<div  style="width:187mm; font-size:7pt;padding-bottom:2mm;">
						...
						Form <b style="font-size:9pt">8859</b> (2018)
						</div>
					</div>
					<!--END Page Footer-->

			...
			<body class="styBodyClass">
				<form name="IRS9465" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;">	
						<div class="styLNDesc" style="width:100mm;padding-right:0mm;font-family:Arial Narrow;">Enter tax year(s) or period(s) involved (for example, 2016 and 2017, or January 1, 2017 to June 30, 2017)
								<span style="width:4px;"/>
							<img src="{$ImagePath}/9465_Bullet_Sm.gif" alt="SmallBullet"/>
						</div>	

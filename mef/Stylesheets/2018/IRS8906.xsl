          ...
          <div class="styFST" style="height:4mm;font-size:7pt;padding-top:.5mm;">
            ...
            <a href="http://www.irs.gov/form8906" title="Link to IRS.gov">
				  ...
				  <div class="styTYBox" style="width:30mm;height:21mm;">
					...
					<div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">18</span></div>
				...
				<div class="styBB" style="width:187mm;">
				  ...
				  <div style="width:187mm;">
					...
					<span style="float:left;">Average tax-financing cost per case</span>
					  ...
					  <div class="styLNAmountBox" style="text-align:center;">0.12695 </div>
					</div>
					<!--End of line 2 -->
					<!--Line 3 -->
					<div style="width:187mm;">
					...
					<div style="width:187mm;text-align:right;">
					  ...
					  <span style="width:90mm;">Form <span class="styBoldText" style="font-size:9pt;">8906</span> (2018)</span>
					</div>
					<!--br class="pageEnd"/-->
					<!-- Adding page break -->
					<p class="pageend"/>

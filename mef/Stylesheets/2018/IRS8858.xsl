           ...
           or ($Print = $Separated) and (count($Form8858Data/DirectOwner) =1)">
							...
							<div style="float: left; clear:none; width: 187mm;border-top:1px solid #000000;">
								<table class="styTable" style="font-size: 7pt" cellspacing="0">
									...
									<tbody>
										<!-- Line 4 -->
										<tr>
											<td class="styTableCell" style="width:95mm;border-color:black;
              ...
              Name and address<br/>
                            ...
                            DirectOwner/DirectOwnerName"/>
											...
											<!-- Box 4b -->
											<td class="styNameBox" style="width:92mm;font-size:7pt; border-top-width: 0px; 
                    border-right-width:0px;border-bottom-width: 1px;" colspan="2">
                      ...
                      padding-right: 1.8mm">c</span>
                          ...
                          DirectOwnerUSIdNumberDetail/EIN"/>
											...
											<td class="styNameBox" style="width:35mm;height:10.8mm;font-size:7pt; 
				...
				<div style="width:187mm">
					<table cellpadding="0" cellspacing="0" class="styTable" style="width:187mm;font-weight:normal;font-size:7pt;border:1px solid black;">
						<thead class="stythead">
							<tr>
								<th style="width:23.3mm;border-color:black;font-weight:normal;vertical-align:top;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(a) </b><br/> Country or Possession
									</div>
								</th>
								<th style="width:23.5mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
								...
								<th style="width:23.3mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
								...
								<th style="width:23.5mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;border-right:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(h) </b><br/> Other
									</div>
								</th>
						...
						<tbody>
							...
							<tr>
								<!-- Column (a) -->
								<td class="styTableCellTextSmall" style="height:4mm;font-weight: bold;text-align:left;">Totals</td>
								<!-- Column (b) -->
								<td class="styTableCellSmall" style="height:4mm;background-color:lightgrey;"/>
								<!-- Column (c) -->
								<td class="styTableCellSmall" style="height:4mm;background-color:lightgrey;"/>
								<!-- Column (d) -->
								<td class="styTableCellSmall" style="height:4mm;">

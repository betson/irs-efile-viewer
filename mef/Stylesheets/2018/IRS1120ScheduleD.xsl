			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleD">
					...
					<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:.5mm;">
						...
						<div class="styTY" style="padding-top:1mm;height:14mm;">20<span class="styTYColor">18</span></div>
					</div>
				</div>
				<!-- END FORM HEADER -->
				<!-- BEGIN TAXPAYER INFO -->
				<div style="width:187mm;float:left;clear:left;border-top:1 solid black;">
					...
					<div class="IRS1120ScheduleD_styFormFooter">
						...
						<span style="width:42mm;text-align:right;float:right;">Schedule D (Form 1120) 2018</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>

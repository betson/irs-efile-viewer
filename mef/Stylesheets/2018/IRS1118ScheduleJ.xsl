...
<!-- BEGIN FORM HEADER -->
	...
	<div class="styFNBox" style="width:26mm;height:32mm;border-right-width:.5mm;">
      <span class="styFormNumber" style="font-size:10pt;">Schedule J 
            ...
            <br/>
            <div style="font-size:6pt;padding-top:2mm;padding-bottom:7mm;height:4mm;">(Rev. 9, 2018)</div>
...
<xsl:if test="($Print = $Separated) and                 
          ...
          <div class="IRS1118ScheduleJ_TableContainer" style="width:187mm;border-top-width:0px;border-bottom-width:0px;
	     ...
	     <tbody>
                <!-- Part I, line 1 for empty table for separated format-->
     	        <tr>
                  ...
                  <td class="IRS1118ScheduleJ_DescCell" style="font-size:10px;" scope="row"><b>Income or (loss) before adjustments</b></td>
                ...
                <tr>
                  ...
                  <b>Allocation of separate limitation losses:</b></td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="border-top-width:1px;border-right-width:0px;background-color:lightgrey;">
                    <span class="styTableCellPad"/>
                    <span style="width:16px;"/>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_DescCell" style="font-size:10px;" scope="row">
                    <span style="font-weight:bold;">Subtotal- Combine lines 6 and 7.</span></td>
                  <td class="IRS1118ScheduleJ_GenericCell" style="font-size:10px;">
                    <span class="styTableCellPad"/>
                    <span style="width:16px;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_DescCell" style="font-size:10px;" scope="row"><b>Recapture of overall domestic losses</b></td>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="font-size:10px;background-color:lightgrey; border-right-width:0px;border-bottom-width:0px;" 
					  valign="bottom">
                    <span class="styTableCellPad"/>
                    <span style="width:16px;"/>
                  </td>
				...
				<div style="width:187mm">
				    <div style="float: left; clear: none;">
						<span class="styBoldText" style="padding-right:1mm">* Important: See </span> <span class="styItalicText"> Computer-Generated Schedule J </span>
						 in instructions.
				    </div>
					  <span style="width:48mm;"/>						
					  <span class="styBoldText">Schedule J (Form 1118) (Rev. 9-2018)</span>
				</div>
					<div class="pageEnd"/>
          </div>
        </xsl:if>
            ...
            <table cellspacing="0" style="font-size:7pt;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="border-bottom-width:0px;border-top-width:0px;background-color:lightgrey;"/>
                </tr>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="border-right-width:1px;border-top-width:1px;font-size:10px;" valign="bottom">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" 
                ...
                <tr>
                  <td class="IRS1118ScheduleJ_IndexCell" scope="row" style="padding-left:2mm;">9</td>
                  <td class="IRS1118ScheduleJ_DescCell" colspan="7" 
					  style="width:99mm;font-size:10px;border-right-width:0px;" scope="row">Recharacterization of separate limitation income:
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="IRS1118ScheduleJ_GenericCell" style="border-bottom-width:0px;background-color:lightgrey;"/>
                </tr>
                ...
                <tr>
                  <td class="IRS1118ScheduleAdjSepLmtForeignBranchIncomeJ_IndexCell" scope="row" style="padding-left:2mm;" valign="top">5</td>
                  <td class="IRS1118ScheduleJ_DescCell" style="font-size:10px;" scope="row">Current year recapture (from Part I, line 10)</td>
                  <td class="IRS1118ScheduleJ_GenericCell" style="font-size:10px;" valign="bottom">
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" 
              ...
              id="adSeLmIn">
                <table cellspacing="0" style="font-size:7pt;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="IRS1118ScheduleJ_IndexCell" scope="row" valign="top">10</td>
                      <td class="IRS1118ScheduleJ_DescCell" scope="row" style="font-size:10px;"><b>Recapture of overall domestic losses</b></td>
                      <td class="IRS1118ScheduleJ_GenericCell" style="font-size:10px;" valign="bottom">
                        <!--Pen and ink image -->
                        <span style="padding-right:2mm">
                        <xsl:call-template name="LinkToLeftoverDataTableInline">

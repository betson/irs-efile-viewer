										...
										<tr>
											<td class="styIRS1042STableCell" style="width:93mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:93mm;height:6.5mm;border-width:0px 1px 0px 1px;">
													<span style="float-left;font-size:6pt;width:86mm;padding:0mm 0mm 0mm 0.5mm;">
														<span class="styIRS1042SBoxNumber">7b</span>
										Check if federal tax withheld was not deposited with the IRS because escrow procedures were applied (see instructions)
...
-->
  ...
  <span style="float:left;">DD) </span>
													...
													<table class="styGenericTable" cellpadding="0" cellspacing="0" style="float:left;border:1px solid black;font-size:8pt;height:5mm;width:40mm;">
														<tbody>
															<tr style="border:1px solid black;">
																<th>
...
-->												</span>
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:94mm;height:12.8mm;border-width:0px 1px 0px 0px;">
												</span>
											</td>
										</tr>
									</table>
					...
					<div class="styFormFooter" style="width:187mm;border-top-width: 1px;">
						...
						<span style="float:right;" class="styGenericDiv">Form <span class="styBoldText">1042-S</span> (2018)</span>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- <<<<<<<<<<<<<<<<<<< PJ END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->

      ...
      <body class="styBodyClass">
        <form name="Form990">
          ...
          <div style="width:187mm;font-weight:bold;">
            <span class="styBoldText" style="width:4mm;">A</span> For the 2019 calendar year, or tax year beginning
 ...
 <xsl:call-template name="PopulateText">
  ...
  <span style="width:15.5mm;"/>
           ...
           <!-- <input type="checkbox" alt="alt" class="styCkbox" name="Checkbox">Changed 4 508 Comp-->
                     <input type="checkbox" class="styCkbox" alt="GroupReturnForAffiliatesInd">
              ...
              <div class="styGenericDiv" style="width:67mm;padding-left:2mm;">
                ...
                <div class="styGenericDiv" style="width:22mm;padding-top:0.75mm;padding-left:2mm;">
                  ...
                  <!--  <input type="checkbox" class="styCkbox" name="Checkbox">Changed for 508 Comp-->
                    <input type="checkbox" class="styCkbox" alt="AllAffiliatesIncludedInd">
                      <xsl:call-template name="PopulateYesCheckbox">
                        <xsl:with-param name="TargetNode" select="$Form990Data/AllAffiliatesIncludedInd"/>
...
<td class="styLNDesc" style="padding-left:1.5mm;width:143mm;height:4.5mm;">
Total number of individuals employed in calendar year 2018 (<span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part V</span>, line 2a) 
<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">......</span>
</td>
...
<div class="styBB" style="width:187mm;"/>
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990 </span> (2018)
  </div>
					</div>
					<div class="pageEnd"/>
				<!--	<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px"/>
          ...
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2018)</div>
...
the prior Form 990 or 990-EZ? 
              ...
              <input type="checkbox" class="styCkbox" alt="SignificantNewProgramSrvcInd" id="dummyidexempt">
                <xsl:call-template name="PopulateYesCheckbox">
              ...
              <input type="checkbox" class="styCkbox" alt="SignificantNewProgramSrvcInd" onclick="return false;" id="dummyidnonexempt">
                <xsl:call-template name="PopulateNoCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantNewProgramSrvcInd"/>
                  <xsl:with-param name="BackupName">IRS990SignificantNewProgramSrvcInd</xsl:with-param>
                </xsl:call-template>
          ...
          Did the organization cease conducting, or make significant changes in how it conducts, any program<br></br> services? 
              ...
              <input type="checkbox" class="styCkbox" alt="SignificantChangeInd" onclick="return false;" id="dummyidexempt">
                <xsl:call-template name="PopulateYesCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantChangeInd"/>
              ...
              <input type="checkbox" class="styCkbox" alt="SignificantChangeInd" onclick="return false;" id="dummyidnonexempt">
                <xsl:call-template name="PopulateNoCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/SignificantChangeInd"/>
                  <xsl:with-param name="BackupName">IRS990SignificantChangeInd</xsl:with-param>
                </xsl:call-template>
...
-->
          ...
          <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px" class="pageEnd">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">990</span> (2018)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2018)</div>
...
<span class="styItalicText">  If "Yes," complete Schedule D, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part I</span></span>
                <span style="padding-left:1mm"/><xsl:call-template name="SetFormLinkInline">
...
<span class="styItalicText"> If "Yes," complete Schedule D, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part II</span></span>
        ...
        <span class="styItalicText"> If "Yes," complete Schedule D, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part III</span> </span>
                <span style="padding-left:1mm"/><xsl:call-template name="SetFormLinkInline">
...
-->
        ...
        Did the organization report an amount for land, buildings, and equipment in <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part X</span>, line 10?  <br/>
<span class="styItalicText"> If "Yes," complete Schedule D, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VI</span>.</span>
                 <span style="padding-left:1mm"/><xsl:call-template name="SetFormLinkInline">
...
<i> If “Yes,” answer lines 24b through 24d and complete Schedule K. If “No,” go to line 25a</i>
    ...
    Section 501(c)(3), 501(c)(4), and 501(c)(29) organizations. </span>
           <span class="styNormalText" style="padding-top:0.0mm;"> Did the organization engage in an excess benefit transaction with a disqualified person during the year?</span>
              <i> If "Yes," complete Schedule L, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part I</span></i>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............ </span>
       <xsl:call-template name="SetFormLinkInline">
...
<span class="styItalicText"> If "Yes," complete Schedule L, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part I</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...................</span>
              </span>
       <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:7.5mm;">
              <span class="styNormalText" style="padding-top:0.0mm;">
       Did the organization report any amount on <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part X</span>, line 5, 6, or 22 for receivables from or
...
<span class="styItalicText"> If "Yes," complete Schedule L, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part III</span></span>
<!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.........
                <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;float:none;">
            ...
            <div class="styLNDesc" style="width:150mm;height:auto;">
             A current or former officer, director, trustee, or key employee? <i> If "Yes," complete Schedule L, <br></br> <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IV</span> </i>
              <!--Dotted Line-->
    <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">........................</span>
       <xsl:call-template name="SetFormLinkInline">
...
<span class="styItalicText"> If "Yes," complete Schedule L, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IV</span></span>
    ...
    <span class="styItalicText"> If "Yes," complete Schedule N, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part II</span>
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">...........</span>
              </span>
       <xsl:call-template name="SetFormLinkInline">
...
Section 501(c)(29) qualified nonprofit health insurance issuers.</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:auto;padding-left:4mm;padding-top:3.0mm;">a</div>
            <div class="styLNDesc" style="width:150mm;height:auto;">
              <span class="styNormalText" style="padding-top:3.0mm;">
                Is the organization licensed to issue qualified health plans in more than one state? </span><br/>
...
Enter the amount of reserves on hand
 ...
 <span class="styItalicText"> If "No," provide an explanation in Schedule O</span>
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:6.5mm;">15</div>
            <div class="styLNDesc" style="width:150mm;height:6.5mm;">
...
Is the organization subject to the section 4960 tax on payment(s) of more than $1,000,000 in remuneration or excess parachute payment(s) during the year?  If "Yes," see instructions and file Form 4720, Schedule N
            ...
            <div class="styLNRightNumBox" style="height:6.5mm; padding-top: 3.0mm;">15</div>
            <div class="styIRS990LNYesNoBox" style="height:6.5mm; padding-top: 3.0mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <div style="width:187mm;float:none;">
            <div class="styLNLeftNumBox" style="height:6.5mm;">16</div>
            <div class="styLNDesc" style="width:150mm;height:6.5mm;">
Is the organization an educational institution subject to the section 4968 excise tax on net investment income?  <br/> If "Yes," complete Form 4720, Schedule O
              <!--Dotted Line-->
              <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt;">................</span>
            </div>
            <div class="styLNRightNumBox" style="height:6.5mm; padding-top: 3.0mm;">16</div>
            <div class="styIRS990LNYesNoBox" style="height:6.5mm;padding-top: 3.0mm;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;border-color:black" cellspacing="0">
            <tbody valign="top">
              ...
              <tr>
                ...
                <td class="styGenericDiv" colspan="4" style="width:101mm;height:auto;border-style: solid;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
                  <span class="styBoldText" style="float:left;">Total from continuation sheets to <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VII</span>, Section A</span>
                  <span style="float:left;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
                  <span style="float:right;padding-right:.5mm;">
                    <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                  </span>
...
<!--  Begin Part VIII Table -->
 ...
 512 - 514  
               ...
               <table class="styTable" style="border-bottom-width: 1px;border-top-width: 0px;border-right-width: 0px;border-left-width: 0px; border-style: solid; font-size:7pt;width:187mm;display:table;" cellspacing="0">
                         ...
                         <tr>
                <td class="styIRS990VTImageBox" rowspan="10" valign="top" style="width:0mm;font:6pt;padding-right:0mm;">
...
<td class="styLNAmountBox" style="height:7.5mm;width:22mm;font-size:6pt;padding-top:4mm;">
          ...
          <xsl:value-of select="count($Form990Data/ProgramServiceRevenueGrp) + 3"/>
             ...
             <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:1mm;padding-left:1mm;">2a</td>
                  ...
                  <xsl:if test="position()!=1">
                   ...
                   <td class="styLNDesc" colspan="2" style="width:57mm;">
                     <span style="width:61mm;height:5mm;font-size:6pt;padding-top:0mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;padding-left:0mm;">
                      <xsl:call-template name="PopulateText">
                        <xsl:with-param name="TargetNode" select="Desc"/>
                      </xsl:call-template>
                    </span>
                   ...
                   <td class="styTableCell" style="width:20mm;height:4.5mm;font-size:6pt;border-left-width:1px;padding-top:2.25mm;">
                    <span class="styTableCellPad"/>
                      <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="BusinessCd"/>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;padding-top:0mm;border-style: solid; border-color: black;border-top-width: 0px;">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="TotalRevenueColumnAmt"/>
                    </xsl:call-template>
                  </td>
                  <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;padding-top:0mm;">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
                  ...
                  <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;padding-top:0mm;border-style: solid;border-right-width: 0px;">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
            ...
            <xsl:if test="count($Form990Data/ProgramServiceRevenueGrp) &lt; 1">
                <tr>
                  ...
                  <td class="styTableCell" style="width:22mm;height:4.5mm;font-size:6pt;border-left-width:1px;">
                    <span class="styTableCellPad"/>
                  </td>
              ...
              <!-- 2f -->
              <tr>
                 <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:3mm;padding-left:1mm;">
   ...
   <span class="styTableCellPad"/>
              ...
              <!-- 2g -->
               <tr>
                 <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-top:3mm;padding-left:.5mm;">
                  <span style="width:1.5mm;padding-top:3.5mm;"/>g
    </td>
             <td class="styGenericDiv" colspan="3" style="width:66mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;padding-top:0mm;">
                ...
                <td class="styTableCell" style="width:25mm;height:4.5mm;border-style: solid;border-right-width: 0px;padding-top:2mm;">
                  <span class="styTableCellPad"/>
                  <span style="width:1mm;"/>
  ...
  Gain or (loss)   
              ...
              <tr>
                ...
                <td class="styLNDesc" colspan="2" style="width:51mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
 ...
 <span class="styFixedUnderline" style="float:none;width:20mm;text-align:right;font-size:6pt;">
  ...
  Gross income from gaming activities.<br/>
                  <span class="NormalText">See <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IV</span>, line 19  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">...</span>
                  </span>
                </td>
...
<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
       ...
       <!--@@@@@@@@@@@@@@@@OLD PART VIII@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
          ...
          <!--   BEGIN Part IX Title -->
          <div class="styBB" style="width:187mm;float:none;">
            <div class="styPartName" style="float:left;width:14mm;height:auto;border-color: black; border-bottom-width: 1px;"><span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IX</span></div>
            <div class="styPartDesc" style="width:70mm;height:auto;border-color: black; border-top-width: 1px;">Statement of Functional Expenses</div>
...
<input type="checkbox" class="styCkbox" alt="InfoInScheduleOPartIXInd">
    ...
    <xsl:call-template name="PopulateLabel">
            ...
            <thead>
              <tr>
                <th scope="col" colspan="2" align="center" style="width:83mm;height:auto;padding-top:0mm; border-bottom-width: 1px; border-top-width: 1px;">
                  ...
                  <br/>
                  <span class="styBoldText" style="float:left;font-size:7pt;font-weight:bold;height:auto;border-top-width: 1px;border-bottom-width: 1px;">7b, 8b, 9b, and 10b of <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VIII</span>.</span>
                </th>
        ...
        <xsl:call-template name="SetFormLinkInline">
          ...
          Grants and other assistance to foreign organizations, foreign governments, and foreign individuals. See <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IV</span>, line 15 and 16.       
...
<input type="checkbox" class="styCkbox" alt="InfoInScheduleOPartXInd">
   ...
   Loans and other receivables from current and former officers, directors, trustees, key employees, and highest compensated employees. Complete <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part II</span> of Schedule L
  ...
  Loans and other receivables from other disqualified persons (as defined under section 4958(f)(1)), persons described in section 4958(c)(3)(B), and contributing employers and sponsoring organizations of section 501(c)(9) voluntary employees' beneficiary organizations (see instructions) Complete <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part II</span> of Schedule L
            ...
            Loans and other payables to current and former officers, directors, trustees, key employees, highest compensated employees, and disqualified <span style="width:2px;"/>
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:100.2mm;height:4.5mm;" colspan="3">
            persons. <span class="styNormalText">Complete <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part II</span> of Schedule L</span>
                  <span style="width:2px;"/>
              ...
              <td class="styLNLeftNumBox" style="height:7.5;"/>
                <td class="styLNDesc" style="width:100.2mm;height:7.5;" colspan="3">
                  <span class="styBoldText">Organizations that follow SFAS 117 (ASC 958), <span>check here <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                      <span style="width:2mm;"/>
                      <input type="checkbox" class="styCkbox" alt="OrganizationFollowsSFAS117Ind">
                        <xsl:call-template name="PopulateCheckbox">
              ...
              <tr>
                ...
                <td class="styLNDesc" style="width:100.2mm;height:7.5mm;" colspan="3">
                  <span class="styBoldText">Organizations that do not follow SFAS 117 (ASC 958), <span>check here <img src="{$ImagePath}/990_Bullet_Md.gif" alt="MediumBullet"/>
                      <span style="width:2mm;"/>
                      <input type="checkbox" class="styCkbox" alt="OrgDoesNotFollowSFAS117Ind">
                        <xsl:call-template name="PopulateCheckbox">

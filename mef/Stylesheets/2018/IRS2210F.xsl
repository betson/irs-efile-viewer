	...
	<xsl:template match="/">
		...
		<div class="styFTBox" style="width:124mm;height:20mm;">           
			...
			<div class="styFBT" style="font-size:7pt;height:5mm;padding-top:0mm;margin-top:0mm;">
				<img src="{$ImagePath}/2210_Bullet.gif" alt="Right Arrow"/>  Attach to Form 1040, Form 1040NR, or Form 1041.<br/>
          ...
          border-right-width:0px;border-left-width:0px;float:left;">
					...
					<div class="styBB" style="width:187mm;border-bottom:2px solid black;">	
						...
						<div style="width:187mm;">
                        	...
                        	<div class="styLNDesc" style="font-size:7pt;width:135mm;padding-left:3.5mm;"><li>Form 1040 filers, enter the amount from line 16 on Form 1040, line 23.</li></div>

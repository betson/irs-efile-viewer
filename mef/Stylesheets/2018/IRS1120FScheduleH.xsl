      ...
      <body class="styBodyClass" style="width:187mm">
        <form name="Form1120FScheduleH">
          <!-- BEGIN WARNING LINE -->
			...
			<div class="styTYBox" style="width:31mm;height:20mm;border-left-width:1px;">
				...
				<div class="styTY" style="padding-top:2mm;">20<span class="styTYColor">18</span></div>
			</div>					
			</div>
			<!--End header-->
           <!--Begin Name/EIN-->
		...
		<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
		  ...
		  <div class="sty1120FSchHFooter">
            ...
            <div style="float:right;text-align:right;width:40mm" class="styGenericDiv"><b>Schedule H (Form 1120-F) 2018</b>
            </div>
          </div>
          <br/>
          ...
          <div>Schedule H (Form 1120-F) 2018</div>
          ...
          <div  class="styGenericDiv" style="width:187mm;clear:both;padding-top:2px">
            <div style="float:right;" class="styGenericDiv"><b>Schedule H (Form 1120-F) 2018</b>
            </div>
          </div>
          <!-- End Page 2 Footer-->

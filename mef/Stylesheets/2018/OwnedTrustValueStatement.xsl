...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/OwnedTrustValueStatement"/>
						...
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="text-align:center;font-size: 7pt; width:44mm;" scope="col">
										Trust Name
									</th>
									...
									<th class="styDepTblCell" style="text-align:center;font-size: 7pt; width:24mm;" scope="col">
							...
							<tbody>
								<xsl:for-each select="$FormData/AssetsHeldByTrSect671679Grp">
									<tr style="border-color:black;vertical-align:top;">
										...
										<td class="styDepTblCell" style="width:20mm;font-size: 6pt; text-align:center;">
										...
										<td class="styDepTblCell" style="width:24mm;font-size: 6pt; text-align:right;">
										...
										<td class="styDepTblCell" style="width:24mm;font-size: 6pt; text-align:right;">
											<span class="styDepTableCellPad" style="width:0px;"/>
											<xsl:call-template name="PopulateAmount">

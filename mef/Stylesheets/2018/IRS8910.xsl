				...
				<form name="Form8910">
					...
					<div class="styBB" style="width:187mm;height: 20.5mm">
						...
						<div class="styTYBox" style="width:30mm;height:20mm; border-left-width:1px;">
							...
							<div class="styTY" style="height:9mm">20<span class="styTYColor">18</span>
							</div>
					...
					<div style="width: 187mm">
						...
						<span style="width: 1mm"/>Use this form to claim the credit for certain alternative motor vehicles acquired in 2017 but not 
						placed in service until 2018 (see instructions).
					</div>
					...
					<div style="width:187mm; clear:all;">
						...
						<!--  Line 11 -->
							...
							<!--  Line 14a-->
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="width:5mm;text-align:center;font-weight:bold;border:none;padding-left:1.5mm;">14</div>
								<div class="styLNDesc" style="width: 124.8mm;padding-left:2mm;text-align:left;border:none;">
									Subtract line 13 from line 12.  If zero or less, enter -0- and stop here. You cannot claim the
								</div>
								<div class="styLNRightNumBox" style="width:8mm;border-bottom:0;"/>
							...
							<div style="width:187mm;">
								...
								<div class="styLNRightNumBox" style="width:8mm;;border:1px solid black; border-top:none;border-right:none;">14</div>
					...
					<div style="width:187mm;">
						...
						<span style="width:80px;"/>Form <span class="styBoldText">8910</span> (2018)
					</div>
					<br/>
					<div class="pageEnd"/>

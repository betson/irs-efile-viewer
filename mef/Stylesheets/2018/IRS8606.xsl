			...
			<body class="styBodyClass">
				<form name="IRS8606" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:137mm;height:8mm;font-weight:normal;font-size:7pt;">
							Name. If married, file a separate form for each spouse required to 2018 Form 8606. See instructions.<br/>
						...
						<div class="styIRS8606LineItem" style="height:27mm;">
							...
							<div class="styIRS8606LineItem" style="width:75%;float:left;height:27.2mm;">
								...
								<div class="styBB" style="width:140mm;height:11mm;">
								      ...
								      <span style="width:26mm;padding-top:2.5mm;padding-left:3mm;text-align:bottom">
								       If this is an amended return,
								       check here</span>
								       <img src="{$ImagePath}/8839_Bullet_Sm.gif" alt="SmallBullet"/> 
								       <input class="styCkbox" alt="Amended Return" type="checkbox" style="width:4mm;padding-top:1.5mm;padding-left:2mm;" >
													<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="newi-indd"/>
												<xsl:with-param name="BackupName">new-ind</xsl:with-param>
											</xsl:call-template>
										</input>
		                     	  								      <!--class="styIRS8606LineItem" style="width:17%;float:left;padding:26px 0px 7px 8px;border-right-width:1px;border-color:black;height:100%-->
								</div>
						<!--		<div class="styIRS8606LineItem" style="width:100%;border-bottom-width:1px;border-color:black;height:32%;">
									<div class="styIRS8606LineItem" style="width:107mm;height:100%;padding-left:4px;border-right:1px solid black;">
										City, town or post office, state, and ZIP code. <span style="font-family:Arial Narrow;">If you have a foreign address, also complete the spaces below.</span>
									...
									If this is an amended return
									<img src="{$ImagePath}/3800_Bullet.gif" alt="bullet image"/>hhhhh
								</div>-->
							...
							<span style="width:15mm"/>
								...
								<div class="styPartDesc" style="padding-left:18mm;padding-bottom:3px;height:auto;">
     								<span class="styNormalText" style="font-size:7pt;">
							            ...
							            <div style="padding-left:4mm;">You made nondeductible contributions to a traditional IRA for 2018.</div>
							    	...
							    	<span class="styNormalText" style="font-size:7pt;padding-bottom:1.5mm;">
							         ...
							         <span class="styNormalText" style="font-size:7pt;">
							            <img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/>
							            <div style="padding-left:4mm;">You converted part, but not all, of your traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2018  </div><br/>
							          
							            <div style="padding-left:6mm;"> <b>and</b> you made nondeductible contributions to a traditional IRA in 2018 or an earlier year.</div>
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter your nondeductible contributions to traditional IRAs for 2018, including those made for 2018 from January 1, 2019,
									<span style="float:left;">through April 15, 2019. See instructions</span>
									<!--Dotted Line-->
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="padding:0px 0px 0px 0px;width:55mm;height:13mm;border-width:2px 2px 2px 2px;border-color:black;">
								<span class="styBoldText" style="width:100%;height:100%;padding-left:4mm;padding-top:1.5mm;">
									In 2018, did you take a distribution<br/>
				...
				<!--					<span style="float:left;">instructions)</span>-->
						...
						<div class="styIRS8606LineItem"  style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									...
									<span style="float:left;">in 2018.  Also enter this amount on line 16</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
								</div>
							</div>
					...
					<!--	<div class="styIRS8606LineItem" style="padding-top:0mm;height:auto;">
						...
						<div class="styIRS8606LineItem"   style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:1mm 0 0 3mm;">
								<span style="float:left;">
									Subtract line 13 from line 3. This is <b>your total basis in traditional IRAs for 2018 and earlier years</b>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
							</div>
					...
					<div style="width:187mm;padding-top:1mm;clear:all;page-break-after:always;display:block;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8606</span> (2018)
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8606 (2018)<span style="width:148mm;"/>
						</div>
						<div style="float:right;">
					...
					<div style="width:187mm;height:auto;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;height:auto;">
							2018 Conversions From Traditional, SEP, or SIMPLE IRAs to Roth IRAs<br/>
							<span class="styNormalText">
					...
					<!-- Body -->
					<div class="styTBB" style="width:187mm;height:59mm;">
					<!-- (19) ////////////////////////////////////////////////////-->
					<div class="styIRS8606LineItem" style="height:auto;">
						...
						<b>Taxable amount.</b> Subtract line 25b from line 25a. If more than zero, also include this 
                            ...
                            <!-- <div class="styLNLeftNumBoxSD" style="padding-left:6mm;height:4mm;float:left;">b</div>
                             <div class="styLNDesc" style="width:142mm;padding-left:2mm;height:4.5mm;float:left;padding-bottom1mm;">
                                Enter the amount on line 25a attributable to qualified disaster distributions from Forms 8915A and 8915B (see instructions).   Also, enter this amount on 2017 Form 8915A, line 23,
                                 or 2017 Form 8915B, line 14, as applicable
                                <span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
                    ...
                    <!--     <div class="styLNLeftNumBoxSD" style="padding-left:6mm;height:4mm;float:left;">c</div>
                         <div class="styLNDesc" style="width:142mm;padding-left:2mm;height:3mm;float:left;">
                          <b>Taxable amount.</b> Subtract line 25b from line 25a. If more than zero, also include this 
                                  amount on 2017 Form 1040, line <b>15b;</b> 2017 Form 1040A, line <b>11b;</b> or 2017 Form 1040NR, line <b>16b</b>
                         </div>

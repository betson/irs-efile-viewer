...
<!-- Last Modified by Steven Fook on 11/6/2018 -->
				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana;        font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right;          width: 186mm;">651118</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2018, or tax year</span>
											...
											<xsl:when test="$FormData/DomesticPartnerInd">
												<div style="float:left;clear:none;">
													...
													<span style="width:35mm;height:4mm;">
														<input type="checkbox" class="styckbox" name="checkbox" id="dummyiddomestic">
															<xsl:call-template name="PopulateCheckbox">
												...
												<div style="float:right;clear:none;">
													<span style="width:45mm;height:4mm;">
														<input type="checkbox"  class="styckbox" name="checkbox" id="dummyidforeign">
															<xsl:call-template name="PopulateCheckbox">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<label>
											...
											<a style="font-size:6pt;">If this partner is a retirement plan (IRA/SEP/Keogh/etc.), check here</a>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 17.5mm;border-top-width:0;">
										...
										<table style="font-size:7pt;margin-left:5.3mm;" cellpadding="0" cellspacing="0">
											<tbody>
												...
												<tr>
													<td width="3" style="width:30mm;border:1px black solid;border-top:0px;border-left:0;border-right:0;font-size:6pt;">Qualified nonrecourse
															financing
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;font-size:7pt;text-align:right;">
														<span style="text-align:right;padding-top:2mm;">
															<xsl:call-template name="PopulateAmount">
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt;">
														<span style="font-size:7pt;padding-top:2mm;">$</span>	
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt;text-align:right;">
														<span style="text-align:right;padding-top:2mm;">
															<xsl:call-template name="PopulateAmount">
										...
										<!--<table style="font-size:7pt;margin-left:5mm;" cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													<th/>
													<th scope="col" style="width:30mm;">Beginning</th>
													<th scope="col" style="width:30mm;">Ending</th>
												</tr>
												-<tr>
                          ...
                          <span style="width:8px;"/>.
										...
										<input type="checkbox"  class="styCkbox" name="checkbox" id="dummyID1" onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												...
												<xsl:with-param name="BackupName">IRS1065ScheduleK1TaxBasis</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox"  class="styCkbox" name="checkbox" id="dummyID2" onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												...
												<xsl:with-param name="BackupName">IRS1065ScheduleK1AccountGrp/GAAP</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<span style="width:5mm;"/>
										<input type="checkbox"  class="styCkbox" name="checkbox" id="dummyID3" onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PartnersCapitalAccountGrp/Section704bBookInd"/>
												<xsl:with-param name="BackupName">IRS1065ScheduleK1Section704bBook</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<br/>
										<span style="width:5.9mm;"/>
										<input type="checkbox"  class="styCkbox" name="checkbox" id="dummyID4" onclick="return false;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PartnersCapitalAccountGrp/OtherInd"/>
												<xsl:with-param name="BackupName">IRS1065ScheduleK1Other</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
											<xsl:call-template name="PopulateLabel">
										...
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PropContriBuiltInGainLossInd"/>
												<xsl:with-param name="BackupName">IRS1065ScheduleK1PropContriWithBuiltInGainLoss</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
					...
					<tr>
					    ...
					    font-size: 6pt;font-weight: bold; border-top: 1px solid black;">
						   ...
						   Instructions for Form 1065.
							...
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2018</span>
						</td>
					</tr>
				</table>

        ...
        <form name="Form8926">
            ...
            <div class="styFTBox" style="width:122.5mm;height:20mm;">
              <div class="styMainTitle">Disqualified Corporate Interest Expense Disallowed </div>
				...
				<div class="styFBT" style="margin-top:1.25mm;font-weight:bold;">
                  <img src="{$ImagePath}/8926_Bullet.gif" alt="bullet image"/> 
					Go to 
					<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form8926" title="Link to IRS.gov">
					  <i>www.irs.gov/Form8926 </i>
					</a> 
          ...
          <div class="styBB" style="width:187mm">
            <div class="styNameBox" style="width:131mm;font-weight:normal;font-size:7pt;">
              ...
              <!-- Choice for 1120, and Parent/Subsidiary Return Header Filer info -->
          ...
          <!--Begin Check Line -->
          <!-- Add alt tab and comment out label -->
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style=";padding-top:4mm;padding-left:4mm;">e</div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="padding-top:4mm;padding-left:4mm;">f</div>
              <div class="styLNDesc" style="width:139mm;padding-top:4mm">
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
                Enter the interest paid or accrued by the corporation for the tax year (including any disqualified interest 
                <span style="float:left;">disallowed under section 163(j) in a prior year and carried forward to the current year)</span>
                <!--Dotted Line-->
                <span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
              </div>
            </div>
            <div style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form8926Data/IntPdOrAccruedIncld163jCfwdAmt"/>
                </xsl:call-template>
              </div>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBox" style="height:8mm;padding-top:4mm;padding-left:4mm;">b</div>
              <div class="styLNDesc" style="width:137mm;height:8mm;padding-top:4mm;">
                <span style="float:left;">Enter the corporation’s allowable net interest expense </span>
                <!--Dotted Line-->
                <span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
              </div>
            </div>
            <div style="float:right;clear:none;">
              ...
              <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form8926Data/AllowableNetInterestExpenseAmt"/>
                </xsl:call-template>
              </div>
            </div>
          </div>
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div style="float:right;">
              <span style="width:70px;"/>  
                Form <span class="styBoldText" style="font-size:8pt;">8926</span> (Rev. 12-2017)
            </div>
          </div>
          ...
          <!-- Header -->
          <div class="styTBB" style="width:187mm;">
            <div style="float:left;">Form 8926 (Rev. 12-2017) <span style="width:130mm;"/>
            </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;height:8mm;padding-top:4mm;">
                <span style="float:left;">Multiply line 3g by 50% (0.50) </span>
                <!--Dotted Line-->
                <span class="styDotLn" style="float:right;padding-right:1mm;">........................</span>
              </div>
            </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
                Enter any disqualified interest actually paid or accrued in the current year by the corporation to a related 
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
              <div class="styLNDesc" style="width:137mm;">
                Enter any disqualified interest actually paid or accrued in the current year by the corporation on indebtedness subject to a 
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
                Enter any interest actually paid or accrued in the current year by a taxable REIT subsidiary (as defined in section 856(l)) of a real 
          ...
          <!--L6 Table*************************************************************************************************************************** -->
          <div class="styTableContainerNBB" id="DIctn" style="width:187mm;">
                ...
                <xsl:if test="($Print != $Separated or count($Form8926Data/RelatedPersonInformation) &lt;= 5)">
                  <xsl:for-each select="$Form8926Data/RelatedPersonInformation">
                    <tr>
                      ...
                      <!-- L6, Column 2 -->
                      <td class="styTableCell" style="width:120mm;text-align:left;border-color:black;">
                      <xsl:if test="position() = last()">
                      <!--<xsl:attribute name="style">width:120mm;text-align:left;border-color:black;border-left-width:0px;border-bottom:0px;background-color:pink;</xsl:attribute>-->
                      </xsl:if>
                        <xsl:choose>
                      ...
                      <!-- L6, Column 3 -->
                      <td class="styTableCell" style="width:59mm;text-align:center;border-color:black;border-right-width:0px;">
                       <xsl:if test="position() = last()">
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              ...
              <div class="styLNDesc" style="width:137mm;">
				Enter the amount of interest deduction disallowed under section 163(j) and carried forward to the next tax year. See instructions				
                <!--Dotted Line-->
                <span class="styDotLn" style="float:right;padding-right:1mm;">........................</span>
              </div>
            </div>
          ...
          <div style="width:187mm;">
            <div style="float:left;clear:none;">
              <div class="styLNLeftNumBoxSD" style="padding-top:4mm;">8a</div>
              <div class="styLNDesc" style="width:97mm;padding-top:4mm;">
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div class="stySmallText" style="width:36mm;text-align:right;float;right;">
				Form <span class="styBoldText" style="font-size:8pt;">8926</span> (Rev. 12-2017)
 			</div>
          </div>
          <!--Page End-->

            ...
            <div style="width:187mm;">
              <div style="float:left;">
                ...
                <div class="styLNDesc" style="width:139mm;height:7.5mm;">
                 <span style="float:left;">Enter the total qualified empowerment zone wages paid or incurred during calendar year 2018 only (see instructions)<!-- Per DOW not PDF -->
...
instructions)  
          ...
          <div style="width:186mm;clear:both;padding-top:0mm;">
            ...
            <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8844</span> (2018)</div>
          </div>
          <br></br>
        <!--  <div class="pageEnd"/>-->

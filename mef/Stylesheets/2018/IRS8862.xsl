...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="CreateLine21ChildItem">
		...
		<div class="styIRS8862LineItem" style="padding-right:0px;height:auto;">
			...
			<div class="styIRS8862CleanDiv" style="width:162mm;height:auto;">
				<xsl:if test="$Position and ($Position = 4)">
					<div class="styIRS8862LNDesc" style="width:100%;height:auto;padding-left:0px;float:none;">
						If same as shown for Child 1, check this box.
						<span style="width:3mm;"/>
						<img src="{$ImagePath}/8862_Bullet_Sm.gif" alt="SmallBullet"/>
						<span style="width:3mm;"/>
						<xsl:call-template name="PopulateSpan">
							<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[4]/SameInformationChild1Ind"/>
						</xsl:call-template>
						<input type="checkbox" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[4]/SameInformationChild1Ind"/>
								<xsl:with-param name="BackupName">Form8862DataQlfyChildMoreThan1PersonGrp[4]SameInformationChild1Ind</xsl:with-param>
							</xsl:call-template>
						</input>
						<label>
						<xsl:call-template name="PopulateSpan">
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:4mm;">
					...
					<div class="styIRS8862LNDesc" style="width:134mm;height:4mm;font-size:7.25pt;padding-left:0mm;border-bottom-width:1px;border-color:black;border-style:dashed;">
						<xsl:if test="$TargetNode">
							...
							<xsl:if test="($Position = 4) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp/LiveWithChildAddrGrp) &gt; 1)">
								<span style="width:3px;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp/LiveWithChildAddrGrp"/>
								</xsl:call-template>
			...
			<div class="styIRS8862CleanDiv" style="width:129mm;height:auto;">
				...
				<div class="styIRS8862CleanDiv" style="width:100%;height:4mm;">
					...
					<div class="styIRS8862LNDesc" style="width:118mm;height:4mm;border-bottom-width:1px;border-color:black;border-style:dashed;float:right;">
						<xsl:if test="$TargetNode">
							<xsl:if test="($Position = 1) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[1]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) != ' ')">
								<span style="width:3px;"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/PersonNm"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 2) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[2]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) != ' ')">
								<span style="width:3px;"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/PersonNm"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 3) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[3]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) != '  ')">
								<span style="width:3px;"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/PersonNm"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 4) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[4]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) != ' ')">
								<span style="width:3px;"/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$TargetNode/PersonNm"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 1) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[1]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) &gt; 4)">
								<span style="width:3px;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[1]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 2) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[2]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) &gt; 4)">
								<span style="width:3px;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[2]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 3) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[3]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) &gt; 4)">
								<span style="width:3px;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[3]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="($Position = 4) and (count($Form8862Data/QlfyChildMoreThan1PersonGrp[4]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) &gt; 4)">
								<span style="width:3px;"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[4]/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp"/>
								</xsl:call-template>
							</xsl:if>
						</xsl:if>
					</div>
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS8862" style="font-family:arial;">
							...
							<div class="styIRS8862CleanDiv" style="width:158mm;">
								...
								<div class="styIRS8862CleanDiv" style="width:100%;height:auto;">
									...
									<div class="styIRS8862LNDesc" style="height:100%;width:187mm;padding-left:5mm;">
										Your EIC, CTC/ACTC/ODC, or AOTC was previously reduced or disallowed and you
								...
								<div class="styIRS8862CleanDiv" style="width:100%;height:auto;">
									...
									<div class="styIRS8862LNDesc" style="height:100%;width:auto;">
										You now want to claim the EIC, CTC/ACTC/ODC, or AOTC and you meet all the requirements
										for the credit.
									</div>
								</div>
							</div>
					...
					<span style="padding-left:7mm;">
							...
							<div class="styIRS8862LineItem" style="width:65mm;height:5mm;font-weight:bold;font-align:center;padding-left:20mm;padding-bottom:7mm;border-bottom-width: 0px;"> <label><xsl:call-template name="PopulateLabel">
								<xsl:with-param name="TargetNode" select="$Form8862Data/CTCACTCODCClaimedInd"/>
								<xsl:with-param name="BackupName">IRS8862CTCACTCODCClaimedInd</xsl:with-param></xsl:call-template> 
											<span style="width:60mm;padding-left:5mm;">Child Tax Credit/Additional Child Tax</span>
											<span style="width:60mm;padding-left:6.5mm;">Credit/Credit for Other Dependents</span></label>
							<div class="styIRS8862LineItem" style="width:40mm;font-weight:lighter;padding-left:15mm;border-bottom-width: 0px;"> <font color="gray">(Complete Part III)</font>
					<span style="width:15mm;"/>
					<span style="padding-left:7mm;">
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form8862Data/CTCACTCODCClaimedInd"/>
...
<!--						<div style="float:left;">
					...
					<div class="styIRS8862LineItem" style="width:187;height:12mm;padding-top:.5mm;padding-bottom:5mm;">
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;padding-bottom:7mm;">
							...
							<div class="styIRS8862LNDesc" style="width:80mm;height:6mm;">
								...
								<span style="width:4px;"/>
								<span style="width:65mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$CTCACTCChildInformationGrp &gt;= 4">
										<xsl:call-template name="PopulateText">
						...
						<xsl:otherwise>
					<div class="styIRS8862LineItem" style="width:187;height:10mm;padding-top:.5mm;padding-bottom:5mm;">
							<div class="styIRS8862LNLeftNumBox" style="text-align:center;padding-left:2mm;">12</div>
							<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
							Enter the name(s) of each child for whom you are claiming the CTC/ACTC. If you are claiming the CTC/ACTC 
							for more than four qualifying children, attach a statement also answering questions 12 and 14-17 for those children.
						</div>
					</div>
						<xsl:variable name="CTCACTCChildInformationGrp" select="count($Form8862Data/CTCACTCChildInformationGrp/ChildFirstAndLastName)"/>
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;">
							...
							<div class="styIRS8862LNDesc" style="width:80mm;height:6mm;">
								...
								<span style="width:65mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$CTCACTCChildInformationGrp &gt;= 1">
										See Additional Data Table for Lines 12-17
									</xsl:if>
								</span>
							</div>
						</div>
						...
						<div class="styIRS8862LineItem" style="width:187;height:10mm;padding-top:3.5mm;padding-bottom:7mm;">
							<div class="styIRS8862LNLeftNumBox" style="text-align:center;padding-left:2mm;">13</div>
									<div class="styIRS8862LNDesc" style="width:175mm;height:11mm;">
										Enter the name(s) of each person for whom you are claiming the credit for other dependents. 
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;">
							...
							<div class="styIRS8862LNDesc" style="width:75mm;height:6mm;font-family:arial narrow;font-size:7pt;">
								...
								<span style="width:50mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$ODCPersonInformationGrp &gt;= 1">
										<xsl:call-template name="PopulateText">
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;padding-bottom:7mm;">
							...
							<div class="styIRS8862LNDesc" style="width:75mm;height:6mm;font-family:arial narrow;font-size:7pt;">
								...
								<span style="width:4px;"/>
								<span style="width:50mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$ODCPersonInformationGrp &gt;= 2">
										<xsl:call-template name="PopulateText">
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;">
							...
							<div class="styIRS8862LNDesc" style="width:75mm;height:6mm;font-family:arial narrow;font-size:7pt;">
								...
								<span style="width:4px;"/>
								<span style="width:50mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$ODCPersonInformationGrp &gt;= 3">
										<xsl:call-template name="PopulateText">
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;padding-bottom:7mm;">
							...
							<div class="styIRS8862LNDesc" style="width:75mm;height:6mm;font-family:arial narrow;font-size:7pt;">
								...
								<span style="width:4px;"/>
								<span style="width:50mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$ODCPersonInformationGrp &gt;= 4">
										<xsl:call-template name="PopulateText">
						...
						<div class="styIRS8862LineItem" style="width:187mm;padding-left:9mm;padding-top:1.5mm;font-size:8.5pt;">
							...
							<div class="styIRS8862LNDesc" style="width:181mm;height:7mm;padding-left:9.5mm;padding-top:3mm;">
									<b>Caution:</b> If the answer is &#8220;No,&#8221; you cannot claim the CTC/ACTC for that child.
							</div>	
						<!-- (15) ////////////////////////////////////////////////////-->
						<xsl:choose>
					    <xsl:when test="count($Form8862Data/CTCACTCChildInformationGrp) &lt; 5">
						...
						<div class="styIRS8862LineItem" style="width:187;height:5mm;padding-top:3.5mm;padding-bottom:2mm;">
							<div class="styIRS8862LNLeftNumBox" style="text-align:center;padding-left:2mm;">16</div>
									<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
										Is each person claimed for the CTC/ACTC/ODC your dependent?
									</div>
						</div>
							<!-- (Line 16 Child 1) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem" style="width:187mm;padding-left:9mm;padding-top:1.5mm;font-size:8.5pt;">
						...
						<xsl:otherwise>
						<!-- (16) ///AREA FOR BLANK FORM WHEN MORE THAN 4 DEPENDENTS PRESENT////////////////////////-->
						<div class="styIRS8862LineItem" style="width:187;height:5mm;padding-top:3.5mm;padding-bottom:2mm;">
							<div class="styIRS8862LNLeftNumBox" style="text-align:center;padding-left:2mm;">16</div>
									<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
										Is each person claimed for the CTC/ACTC/ODC your dependent?
						...
						<xsl:otherwise>
						<!-- (Line 17) ///////BLANK AREA FOR MORE THAN 4/////////////////-->
						<div class="styIRS8862LineItem" style="width:187;height:12.5mm;padding-top:3.5mm;padding-bottom:2mm;">
							<div class="styIRS8862LNLeftNumBox" style="text-align:center;padding-left:2mm;">17</div>
									<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
										For each person claimed as a qualifying child or other dependent for the CTC/ACTC/ODC, is that person a
						...
						<div class="styIRS8862LineItem" style="width:187mm;padding-left:9mm;padding-top:1.5mm;font-size:8.5pt;height: 8mm;">
							...
							<div class="styIRS8862LNDesc" style="width:181mm;height:7mm;padding-left:9.5mm;padding-top:3mm;">
									<b>Caution:</b> You cannot claim the CTC/ACTC/ODC for a child or dependent who is not a citizen, national, or
										  resident of theUnited States.
							</div>	
							<div class="styIRS8862LNDesc" style="width:181mm;height:15mm;padding-left:9.5mm;padding-top:3mm;">
									Only one person can claim the child as a qualifying child for the CTC/ACTC. If the child meets the conditions to be 
                                    ...
                                    CTC/ACTC. If you are a noncustodial parent who is entitled to treat the child as a qualifying child, you do not need
                                    to complete Part V.
							</div>
					<br/>
					...
					<div class="styIRS8862CleanDiv" style="width:187mm;height:12mm;">
						...
						<div class="styIRS8862LineItem" style="width:93.5mm;float:left;padding-bottom:7mm;">
							...
							<div class="styIRS8862LNDesc" style="width:80mm;height:6mm;">
								...
								<span style="width:4px;"/>
								<span style="width:60mm;height:3.5mm;border-bottom:1px solid black;">
									<xsl:if test="$QlfyChildMoreThan1PersonGrp &gt;= 4">
										<xsl:call-template name="PopulateText">
						...
						<xsl:call-template name="CreateLine21ChildItem">
							...
							<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp[4]/LiveWithChildAddrGrp[4]"/>
						</xsl:call-template>
					<div class="styBB" style="width:187mm;padding:10px 0px 0px 0px;" ></div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					<!-- Page Break and Footer-->
					...
					<div style="width:187mm;padding:0px 0px 0px 0px;" class="styBB">
						...
						<xsl:call-template name="CreateLine22ChildItem">
							<xsl:with-param name="Number">1</xsl:with-param>
							<xsl:with-param name="Position">1</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form8862Data/QlfyChildMoreThan1PersonGrp"/>
						</xsl:call-template>
						<xsl:call-template name="CreateLine22ChildItem">
							<xsl:with-param name="Number">2</xsl:with-param>
							<xsl:with-param name="Position">2</xsl:with-param>
						...
						<table class="styDepTbl" cellspacing="0">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styIRS8862TableCell" scope="col" style="width:17%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Name</th>
									<th class="styIRS8862TableCell" scope="col" style="width:17%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Line 13</th>
									<th class="styIRS8862TableCell" scope="col" style="
									width:5%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Line 14</th>
									<th class="styIRS8862TableCell" scope="col" style="width:17%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Line 15</th>
									<th class="styIRS8862TableCell" scope="col" style="width:17%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Line 16</th>
									<th class="styIRS8862TableCell" scope="col" style="width:17%;border-color:black;font-size:6.5pt;text-align:center;font-family:arial;padding-top:3mm;padding-bottom:3mm;">Line 17</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
								<xsl:for-each select="$Form8862Data/CTCACTCChildInformationGrp">
									<tr style="font-size:7pt;font-family:arial;">
										...
										<td class="styIRS8862TableCell">
											<xsl:attribute name="style">width:45mm;text-align:left;border-left-width:1px;</xsl:attribute>
											<div class="styIRS8862LNDesc" style="width:45mm;height:auto;word-wrap:break-word;padding-left:2px;font-size:7pt;">
									...
									<!-- (Line 13 Qualifying Child) +++++++++++++++++++++++ -->
										<td class="styIRS8862TableCell">
											<xsl:attribute name="style">width:15mm;text-align:left;border-left-width:1px;</xsl:attribute>
											<div class="styIRS8862LNDesc" style="width:15mm;height:auto;word-wrap:break-word;padding-left:2px;font-size:7pt;">
									<xsl:if test="$Form8862Data/CTCACTCChildInformationGrp">
									<span>
										<xsl:call-template name="PopulateSpan">
						        ...
						        <div class="styIRS8862LNDesc" style="width:20mm;height:auto;word-wrap:break-word;padding-left:2px;font-size:7pt;">
								<b>Other dependent  </b>			
								<span style="width:2mm;"/>					
										<!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
									<span>
										<xsl:call-template name="PopulateSpan">
											<xsl:with-param name="TargetNode" select="$Form8862Data/ODCPersonInformationGrp/DependentInd"/>
										</xsl:call-template>
										<input type="checkbox" class="styCkbox">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8862Data/ODCPersonInformationGrp/DependentInd"/>
												<xsl:with-param name="BackupName">IRS8862ODCPersonInformationGrp/DependentInd</xsl:with-param>
											</xsl:call-template>
										</input>
									</span>
									<span style="width:1mm;"/>
...
<!--					--><!-- Separated Data for Part II - Line 6 (c) --><!--
					...
					<xsl:if test="count($Form8862Data/QlfyChildMoreThan1PersonGrp/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp) &gt; 1">
						<br/>
						<br/>
						<span class="styRepeatingDataTitle">
						...
						<table class="styDepTbl" cellspacing="0">
							...
							<tfoot/>
							<tbody>
								<xsl:for-each select="$Form8862Data/QlfyChildMoreThan1PersonGrp/OtherPersonLiveWithChildGrp/OtherPersonInformationGrp">
									<tr style="font-size:7pt;font-family:arial;">
										<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<td class="styIRS8862TableCell">
											<xsl:attribute name="style">width:5%;text-align:center;</xsl:attribute>

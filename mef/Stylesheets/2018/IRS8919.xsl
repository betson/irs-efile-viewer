			...
			<body class="styBodyClass" style="margin-bottom:10px">
				<form name="Form8919">
					...
					<!--			<span style="width:5.2mm;font-weight:bold;float:left;">F<br/></span>
								...
								<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC from this firm for 2018. The amount on Form 1099-MISC should have been included as wages on Form W-2. <b>(Don't file Form SS-8 if you select reason code H.)</b>
								</span>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
								<span style="float:left;">
									Multiply line 10 by 0.062 (social security tax rate for 2018)
								</span>
									<!--Dotted Line-->
								<span style="float:right;padding-right:3mm;letter-spacing:3.5mm;font-weight:bold;">..............</span>
							</div>									
					...
					<div style="float:left;">
								...
								<div style="float:right;">
								  ...
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2018)
								</div>						
					</div>

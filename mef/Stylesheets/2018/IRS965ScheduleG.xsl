...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:include href="IRS965ScheduleGStyle.xsl" />
	<xsl:output method="html" indent="yes" />
	<xsl:strip-space elements="*" />
	<xsl:param name="FormData" select="$RtnDoc/IRS965ScheduleG" />
	<xsl:template match="/">
		...
		<html lang="EN-US">
			<head>
				...
				<meta name="Description" content="IRS Form 965 Schedule G" />
				<script language="JavaScript" src="{$ScriptPath}/FormDisplay.js" type="text/javascript" />
				<xsl:call-template name="InitJS" />
				<style type="text/css">
					<xsl:if test="not($Print) or $Print=''">
						<xsl:call-template name="IRS965ScheduleGStyle" />
				...
				<form id="Form1040NR">
					...
					<div class="styStdDivLS">
						<div class="styFNBox" style="width:33mm;height:22.5mm;">
							<span class="styFN" style="font-size:9pt;">Schedule G<br />
						...
						<div class="styFTBox" style="width:190mm;height:22.5mm;">
							...
							<span style="font-weight:bold;font-size:8pt;padding-top:0.5mm;padding-bottom:1mm;">
								For tax years of foreign corporations whose last taxable year beginning before January 1, 2018, ends during the <br /> 
								U.S. shareholder's 2017 tax year<br />
							</span><br />
					...
					<div class="styStdDivLS pageEnd">
						...
						<span style="margin-left:25mm;">Cat. No. 71322Z</span>
						<span style="float:right;font-weight:bold;">Schedule G (Form 965) (1-2019)</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="styStdDivLS" style="">
						...
						<table class="styTbl" style="display:table;border-collapse:collapse;">
							...
							<tbody>
								...
								<tr style="height:8mm;vertical-align:top;">
									<td class="styTableCellCtrInherit" style="font-weight:bold;vertical-align:bottom;">17</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>

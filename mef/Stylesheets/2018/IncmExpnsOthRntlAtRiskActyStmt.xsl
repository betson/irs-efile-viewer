...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<table id="IEOARSTbl" class="styDepTbl">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">
					<th class="styDepTblCell" scope="col" style="width:65mm;">Name of trade/business</th>
			...
			<tbody>
				<xsl:for-each select="$IEOARSData/IncomeExpnsOtherRntlAtRiskActy">
					<tr>
						...
						<td class="styDepTblCell" style="text-align:left;font-family:verdana;width:65mm;">
	...
	<xsl:param name="depDocTitle">
		<xsl:call-template name="PopulateDisplayName">
			<xsl:with-param name="TargetNode" select="$IEOARSData"/>
		</xsl:call-template>
	</xsl:param>
	<!-- Main template -->
	<xsl:template match="/">

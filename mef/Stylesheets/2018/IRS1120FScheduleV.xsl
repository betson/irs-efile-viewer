...
<div class="styFTBox" style="width:125mm;height:12mm;">
      <div class="styMainTitle" style="height:8mm;padding-top:2mm;">List of Vessels or Aircraft, Operators, and Owners
       </div>
         ...
         <div class="styTYBox" style="width:31mm;height:19.5mm;">
             <div style="height:2mm;"/>
              <div class="styOMB">OMB No. 1545-0123
                ...
                <div class="styTY" style="height:8mm;padding-top:1mm;">20<span class="styTYColor">18</span>
                </div></div></div>
...
<div class="styEINBox" style="width:46mm;height:4mm;padding-left:2mm;font-size:7pt;font-weight:bold;">Employer identification number<br/>
      <br/>
...
<!-- End Names and Identifying number section -->
          <div style="width:187mm;padding-bottom:5mm;font-size:7pt;">Provide the information requested on lines 1 through 9 for each vessel or aircraft with respect to which the corporation is subject to a 4% rate of tax under section 887.
          </div>
<!-- *******first viewing ****** -->
			...
			<xsl:if test="position() mod 4 = 1">
				...
				<tr>
					...
					<td class="styTableCellSmall"
		     			 style="width:30mm;font-size:7pt;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;border-right-width:1px;border-left-width:1px;">
						  <xsl:number value="position()" format="A"/>
						<span class="styTableCellPad"/>
					</td>
					<td class="styTableCellSmall" style="width:30mm;font-size:7;text-align:center;font-weight:bold;border-color:black;
				...
				<tr>
				    ...
				    <td class="styTableCellSmall" 
			        	style="width:30mm;border-color:black;height:8mm;padding-top:4mm;border-left-width:1px;font-size:6pt;text-align:left">
			         	<xsl:call-template name="PopulateText">
				    ...
				    <td class="styTableCellSmall" 
			        	...
			        	<xsl:with-param name="TargetNode"
				          select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftIDNum"/>
			        	</xsl:call-template>
			    	    <span class="styTableCellPad"/>
			    	</td>
			    	<td class="styTableCellSmall" 
			         	...
			         	<xsl:call-template name="PopulateText">
				        <xsl:with-param name="TargetNode" 
				        select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrAircraftIDNum"/>
			        	</xsl:call-template>
		    		    <span class="styTableCellPad"/>
			    	</td>
		    		<td class="styTableCellSmall" style="width:30mm;border-color:black;height:8mm;		     		   padding-top:4mm;border-right-width:0px;font-size:6pt;text-align:left">
				...
				<tr>
			    	<td style="border:none;" scope="row">
		     		...
		     		<td class="styTableCellSmall"
		     		     style="width:30mm;font-size:6pt;border-style:solid;border-color:black;height:8mm;padding-top:4mm;border-left-width:1px;	     		          text-align:center;">
				    	...
				    	<input type="checkbox" alt="IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd"  class="styCkbox">
					    	<xsl:call-template name="PopulateYesCheckbox">
						     <xsl:with-param name="TargetNode" select="VesselOrAircraftCharteredInInd"/>
					     	<xsl:with-param name="BackupName">RS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd
					     	</xsl:with-param>
					    	</xsl:call-template>
				    	</input>
			     		<label>
				     		<xsl:call-template name="PopulateLabelYes">
					    		<xsl:with-param name="TargetNode" select="VesselOrAircraftCharteredInInd"/>
				    			<xsl:with-param name="BackupName">IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd
				    			</xsl:with-param>
			     			</xsl:call-template>
					     ...
					     <!-- per IBM to add PopulateSpan to boolean (yes/no) checkbox -->
					    <input type="checkbox" alt="IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd" 
					    class="styCkbox">
	    			...
	    			<td class="styTableCellSmall"  style="width:30mm;font-size:6pt;border-style: solid; 
		        		...
		        		<span>
				    	<xsl:call-template name="PopulateSpan">
			     			<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/
				    		 VesselOrAircraftCharteredInInd"/>
			     		</xsl:call-template>								
		    			<input type="checkbox" alt="four IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd"  class="styCkbox">
				    		<xsl:call-template name="PopulateYesCheckbox">
						...
						<xsl:call-template name="PopulateLabelNo">
							<xsl:with-param name="TargetNode"
							 select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftCharteredInInd"/>
							<xsl:with-param name="BackupName">
							IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd
                           </xsl:with-param>
						</xsl:call-template>
				...
				<tr>
			    	<td style="border:none;" scope="row">
			            ...
			            <div class="styGenericDiv"
			             style="width:5mm;font-size:7pt;padding-left:2mm;height:8mm;padding-top:4mm;"><b>4</b>
		        	    	</div>
			    	...
			    	<td class="styTableCellSmall" style="width:30mm;font-size:6pt;text-align:center; 
				    	...
				    	<!-- per IBM to add PopulateSpan to boolean (yes/no) checkbox -->
			    		<xsl:call-template name="PopulateSpan">
						<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/
				...
				<tr>
		    		...
		    		<td class="styTableCellSmall" style="width:30mm;font-size:6pt;text-align:left;border-style: solid;
		     		...
		     		<td class="styTableCellSmall" style="width:30mm;font-size:6pt;text-align:left;border-style: solid;border-color: black;height:8mm;
	         			padding-top:4mm;">
	        			<xsl:call-template name="PopulateText">
		        	    	<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/
				...
				<td class="styTableCellSmall" 
		    		...
		    		<xsl:if test="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/RegisteredOwnerSSN != ' '">
		        		<xsl:call-template name="PopulateSSN">
	            			<xsl:with-param name="TargetNode" 
		             		select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/RegisteredOwnerSSN"/>
		         		</xsl:call-template>
		        		<span class="styTableCellPad"/>
		    		</xsl:if>
	...
	<table class="styTable" cellspacing="0" style="border-color:black;width:187mm;">
		...
		<xsl:if test="position() mod 4 = 1">
			...
			<tr>
		    		...
		    		<td class="styTableCellSmall" style="width:30mm;text-align:center;font-weight:bold;border-color:black;border-top-width:
			...
			<tr>
				<td style="border:none;" scope="row">
					<div style="width:67mm;">
						<div class="styBoldText" style="width:5mm;float:left;font-size:7.5pt;padding-left:2mm;height:8mm;padding-top:3mm;">1
						 </div>
				...
				<td style="border:none;" scope="row">
					<div style="width:67mm;">
						<div class="styBoldText" 
			    			style="width:5mm;float:left;font-size:7.5pt;padding-left:2mm;height:8mm;padding-top:3mm;">2</div>
			...
			<tr>
				<td style="border:none;" scope="row">
					<div style="width:67mm;">
						<div class="styBoldText" 
						style="width:5mm;float:left;font-size:7.5pt;padding-left:2mm;height:8mm;padding-top:3mm;">4</div>
		    	...
		    	<td class="styTableCellSmall" style="width:30mm;font-size:6pt;text-align:center; border-style:solid;border-color:	         	    	black;black;height:8mm;padding-top:4mm">
		     	...
		     	<td class="styTableCellSmall" 
		           	 style="width:30mm;font-size:6pt;text-align:center;border-style: solid;border-color: 		           	 black;black;height:8mm;padding-top:4mm;border-right-width:0px;">
		         	<input type="checkbox" alt="Yes" class="styCkbox">
	        		</input>
	         		<label>
		             	<span style="font-size:6pt">    Yes</span>
			...
			<tr>
		    	...
		    	<td class="styTableCellSmall" 
	        	   	style="width:30mm;border-style: solid;border-color: lack;height:8mm;padding-top:4mm;border-left-width:1px;text-align:center;">
	        		<span class="styTableCellPad"/>
	    		</td>
	    		<td class="styTableCellSmall" style="width:30mm;text-align:center;border-style: solid;border-color: black;height:8mm;padding-top:4mm;">
	        		<span class="styTableCellPad"/>
			...
			<tr>
	    		...
	    		<td class="styTableCellSmall" style="width:30mm;font-size:6pt;border-style: solid;border-color: lack;height:8mm;padding-top:4mm;">
	        		<span class="styTableCellPad"/>
		     	</td>
	     		<td class="styTableCellSmall" style="width:30mm;font-size:6pt;border-style: solid;border-color:	         		black;height:8mm;padding-top:4mm;border-right-width:0px;">
        			<span class="styTableCellPad"/>
...
<!-- title row -->
         <tr>
				...
				<td class="styTableCellSmall"  style="width:30mm;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;border-left-width:1px;border-right-width:1px;">A<span class="styTableCellPad"/>
                </td>
                <td class="styTableCellSmall" 
                    style="width:30mm;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;                      border-left-width:0px;border-right-width:1px;">
...
<!-- line 3 -->
         <tr>
             <td style="border:none;" scope="row">
				<div>
				<div class="styGenericDiv"	style="font-size:7pt;width:5mm;padding-left:2mm;height:8mm;padding-top:4mm;"><b>3</b>
				</div>
				<div class="styGenericDiv" style="width:61mm;height:8mm;font-size:7pt;padding-top:4mm;">
				  <span style="float:left;">Was the vessel or aircraft chartered in?</span>
					<!--Dotted Line-->
...
<td class="styIRS1120FScheduleVTableCellSmall" style="font-size:7.5pt;" scope="row">
				<div>
				<div class="styGenericDiv" style="width:5mm;padding-left:2mm;height:8mm;padding-top:4mm;"><b>8</b>
				</div>
				<div class="styGenericDiv" style="width:61mm;height:8mm;padding-top:4mm;">
				  <span style="float:left;">EIN or SSN of operator</span>
				  <!--Dotted Line-->
...
<p>
	<div class="pageEnd" style="width:187mm;padding-top:0mm;">
		...
		<div style="float:right;">
			<span style="width:10px;"/><b>Schedule V (Form 1120-F) 2018</b>
		</div>
	</div>
</p>
		...
		<xsl:variable name="pos" select="position()"/>
			...
			<tr class="styDepTblRow1">
				...
				<td class="styTableCellSmall" style="width:30mm;border-color:black;height:8mm;padding-top:4mm;border-right-width:0px; 			font-size:6pt;text-align:left">
		    		<xsl:call-template name="PopulateText">
		         		<xsl:with-param name="TargetNode"
		         		 select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftNm"/>
		    		</xsl:call-template>
	     			<span class="styTableCellPad"/>
				</td>
			</tr>
			...
			<tr class="styDepTblRow1">
				<td style="border:none;" scope="row">
					<div style="width:67mm;">
						<div class="styBoldText" style="width:5mm;float:left;font-size:7.5pt;padding-left:2mm;height:8mm;padding-top:3mm;">3
						</div>
						<div class="styGenericDiv" style="width:60mm;font-size:7.5pt;padding-top:3mm;">
						 Was the vessel or aircraft chartered in?
							<!--Dotted Line-->
			...
			<!-- per IBM to add PopulateSpan to boolean (yes/no) checkbox -->
	     		<xsl:call-template name="PopulateSpan">
				<xsl:with-param name="TargetNode"
				 select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>
		    	</xsl:call-template>								
	    		<input type="checkbox" alt="IRS1120FScheduleVData/VesselAircraftInformation/VesselOrAircraftCharteredInInd" class="styCkbox">
	        		<xsl:call-template name="PopulateYesCheckbox">
	             		<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>

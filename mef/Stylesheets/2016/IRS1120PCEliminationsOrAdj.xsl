		...
		<div class="styBB" style="width:187mm;">
		  <!--Form box begin -->
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">16</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
...
<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
				  <input type="checkbox" class="styCkbox" alt="Consolidated return">
...
<div class="styGenericDiv" style="height:7mm;padding-top:2mm;">
				  <input type="checkbox" class="styCkbox" alt="Life-nonlife consolidated return">
					<xsl:call-template name="PopulateCheckbox">
...
<div class="styGenericDiv" style="height:9mm;padding-top:2mm;">
				  <input type="checkbox" class="styCkbox" alt="Schedule M-3 (Form 1120-PC)">
					<xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/ScheduleM3Form1120PCInd"/>
					  <xsl:with-param name="BackupName">IRS1120ScheduleM3Required</xsl:with-param>
					</xsl:call-template>
...
<div class="styNameAddr" style="width:94.5mm;height:8.5mm;border-left-width:1px;padding-left:2mm;">
                Name<br/>
...
<span style="padding-left:0.75mm"/>
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
			<div class="styIRS1120PCVTImageBox" style="height:147mm;padding-top:14mm;">
			<div style="width:2mm;height:35mm;"/>
				<img src="{$ImagePath}/1120PC_TaxComputation.gif" alt="Tax Computation and Payments" style="width:4.8mm;"/>
		  </div>
		  <!--line 1 -->
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div style="width:181mm;">
			  <div style="float:left; clear:none;">
				...
				<div class="styLNDesc" style="width:53mm;height:4.5mm;font-size:6pt;"> 2016 estimated tax payments (see instructions)</div>
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:91.5mm;height:4.5mm;">
				  <span style="float:left"> 2016 special estimated tax payments (Don't include on line 14f)</span>
				</div>
			  </div>
			  <div style="float:right;clear:none;">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:53mm;height:4.5mm;font-size:6pt;">2016 refund applied for on Form 4466
				  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
		  ...
		  <div class="styBB" style="width:187mm;font-size:6pt;">
			...
			<div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2016)
            </div>
		  </div>
		  ...
		  <div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
			<div style="float:left;">Form 1120-PC (2016)<span style="width:146mm;"/>
		  </div>
	  ...
	  <div style="float:left;clear:none;border-top:1px solid black;border:0px solid red;width:123mm;border-bottom:1px solid black;">
		<div class="styPartName" style="width:23mm;">Schedule C</div>
		  <div class="styPartDesc" style="width:70mm; height:8mm;">Dividends and Special Deductions <br /> <span style="font-weight:normal;">(see instructions) </span>
		  </div>	
		</div>
		<div style="float:right;clear:none;width:64mm;border:0px solid green;" >
		  <div class="styLNAmountBox" style="heigh:4mm;width:64mm;text-align:center;border-top:0px solid black;">Dividends-Received</div>
			...
			<div class="styLNAmountBox" style="height:8mm;text-align:center;float:right;width:32mm;border-right:none;border-top:none;border-bottom:none;border-left:1px solid black;">
	...
	<div class="styGenericDiv" style="width:187mm;">
	  ...
	  <div style="float:left;width:25.9mm;height:17mm;border-right:1px solid black;font-size:6pt;clear:none;text-align:right;padding-top:14mm;"><!--background-color:navy;-->
		<xsl:call-template name="PopulateAmount">
	  ...
	  <div style="float:left;width:24mm;height:17mm;font-size:6pt;border-right:0px solid black;clear:none;text-align:right;padding-top:14mm;"><!--background-color:green;-->
		<xsl:call-template name="PopulateAmount">
	...
	<div style="width:187mm;">
	  <div style="float:left;clear:none:">
		...
		<div class="styLNDesc" style="height:8.5mm;">
		  <b>Special deduction.</b> If you checked "No" on line 14 of Schedule I, enter -0- here, you can't take the special deduction.  All others subtract line 5 from line 4. If zero or less, enter -0-. Enter amount here and 
  ...
  <div class="styBB" style="width:187mm;hight:auto;border-bottom-width:1px;float:left;clear:left;">
		...
		<div class="styLNDesc" style="width:73mm;height:4.5mm;">
		  <span style="float:left">
			...
			<span style="width:50mm;border-bottom:1px solid black;">
			  ...
			  a U.S. Trade or Business. Enter number of Forms 5472 attached
			  <span style="width:3px;"/>
			  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
			  <span style="width:6px;"/>
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
			  ...
			  <span style="width:70mm;background-color:none;">
				...
				<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
				<span style="width:3px;background-color:none;"/>
				<span style="width:28mm;font-size:6pt;border-bottom:1px solid black;background-color:none;text-align:right;">
				  <xsl:call-template name="PopulateAmount">
		...
		<div class="styGenericDiv" style="width:93.5mm;">
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			  ...
			  <span class="styDotLn" style="padding-right:1mm;">............</span>
				  ...
				  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
				  <span style="width:2px;"/>
				<input type="checkbox" class="styCkbox" alt="NOLForegoCarryback">
				  <xsl:call-template name="PopulateCheckbox">
	...
	<div class="pageEnd" style="width:187mm;border-top: 2px solid black;float:none;">
	  ...
	  <div style="float:right;">
		<span style="width:40px;"/>  
        Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2015)
      </div>
	</div>
  ...
  <div style="width:187mm;">
	...
	<div style="width:129mm;float:right;">
	  <div class="styLNAmountBox" style="width:64.45mm;height:4.5mm;text-align:center;border-bottom-width:1px;">Beginning of tax year</div>
	  <div class="styLNAmountBox" style="width:64.55mm;height:4.5mm;text-align:center;border-bottom-width:1px;">End of tax year</div>
	</div>
  </div>
  <!-- END Schedule L Title -->
  ...
  <div style="width:187mm;">
	...
	<div class="styLNAmountBox" style="height:5mm;font-size:8pt;">
	  <xsl:call-template name="PopulateAmount">
	...
	<div style="width:187mm;">
	  ...
	  <div class="styLNAmountBoxFormLink" style="height:5.5mm;font-size:8pt;">
		<xsl:call-template name="PopulateAmount">
		  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleL/OtherCurrentAssetsBOYAmt"/>
		</xsl:call-template>
	  </div>
	...
	<div style="width:187mm;">
	  ...
	  <div class="styShadingCell" style="height:5.5mm;font-size:8pt;"/>
	  <div class="styLNFormLinkBox" style="height:5.5mm;">
		<!-- Form to Form Link -->
		<span style="width:2px;"/>
		<xsl:call-template name="SetFormLinkInline">
	...
	<div style="width:187mm;">
	  ...
	  <div class="styLNAmountBox" style="height:4.5mm;font-size:8pt;">
		<xsl:call-template name="PopulateNegativeNumber">
	...
	<div style="width:187mm;">
	  ...
	  <div style="width:187mm;">
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
		  ...
		  <div class="styShadingCell" style="height:5mm;"/>
		  <div class="styLNAmountBoxNBB" style="height:5mm;font-size:8pt;">
			<xsl:call-template name="PopulateAmount">
		...
		<div style="width:187mm;">
		  ...
		  <div class="styLNAmountBox" style="height:7.5mm;padding-top:3mm;font-size:8pt;">
			<xsl:call-template name="PopulateAmount">
		...
		<div style="width:187mm;">
		  ...
		  <div class="styLNAmountBoxFormLink" style="height:7.5mm;padding-top:3mm;font-size:8pt;">
			<xsl:call-template name="PopulateAmount">
			  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleL/RetainedEarningsApprBOYAmt"/>
			</xsl:call-template>
		  </div>
		...
		<div class="styBB" style="width:187mm;">
		  ...
		  <div class="styShadingCell" style="height:4.5mm;"/>
		  <div class="styLNAmountBoxNBB" style="height:4.5mm;font-size:8pt;">
			<xsl:call-template name="PopulateAmount">
		...
		<div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:none;clear:both;">
		 ...
		 <!-- Sch M-1 : Line 7a row 1 
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 4.25mm"></div>
			<div class="styLNDesc" style="width:53mm;height:4.5mm;">
			  <span class="styUnderlineAmount" style="width:53mm;text-align:right;">
				<xsl:call-template name="PopulateAmount">

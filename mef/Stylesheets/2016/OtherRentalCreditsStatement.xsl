		...
		<table id="OtherRentalCreditsStatementTbl" class="styDepTbl">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">
					<th class="styDepTblCell" scope="col" style="width:136mm;">Description</th>
					<th class="styDepTblCell" scope="col" style="width:50mm;">Amount</th>
				</tr>
			</thead>
			<xsl:for-each select="$DependencyData/OtherRentalCreditGrp">
				<tr>
					<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
					<td class="styDepTblCell" style="text-align:left;width:136mm;">

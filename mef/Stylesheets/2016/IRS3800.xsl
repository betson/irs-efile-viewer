			...
			<body class="styBodyClass">
               ...
               Form<span class="styFormNumber"> 3800</span>
                ...
                OMB No. 1545-0895
							...
							<div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">16</span>
							</div>
         ...
         <xsl:call-template name="PartIIITemplate"/>        
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credits allowed for 2016 (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">........</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Carryforward of general business credit to 2016. Enter the amount from line 2 of Part III with box C</span>
                    ...
                    <!--Dotted Line-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								...
								<span style="float:left;">Carryback of general business credit from 2017. Enter the amount from line 2 of Part III with box D</span>
             ...
             Tentative minimum tax: 
		      <span style="padding-left:4mm;width:85.8mm;">
                ...
                <!--Pen and ink image -->
						...
						<div style="width:187mm;clear:both;" class="styGenericDiv">
							...
							<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3800</span> (2016)</div>
						</div>
					</div>
					<p style="page-break-before: always"/>
					<!-- Page 2 Header -->
					<div style="width:187mm;clear:both;padding-bottom:.5mm;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Form 3800 (2016)</div>
              ...
              Passive activity credit from line 3 of all Parts III with box B checked 
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credit allowed for 2016 (see instructions)</span>
								<div class="styDotLn" style="float:right;">.........</div>
							</div>
              ...
              <!--<span style="float:left;">line 6 of all Parts III with box F check</span>-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryforward of business credit to 2016. Enter the amount from line 5 of Part III with box C checked 
              <span style="float:left;">and line 6 of Part III with box G checked. See instructions for statement to attach
                <!-- Push Pin image -->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryback of business credit from 2017. Enter the amount from line 5 of Part III with box D checked 
...
<!--						<label>
					...
					<span style="width:90mm;">
						...
						<span type="checkbox" class="styCkbox" style="background-color:lightgrey;border:1px solid black;" alt="IRS3800 Part III, checkbox H">
						</span>
						<span style="width:2mm;"/>Reserved
					</span>
					<div style="width:187mm;">
...
1065-B)) 
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Other.  Enhanced oil recovery (Form 8830) and certain other credits</span>
							<!--Dotted Line -->
							<div class="styDotLn" style="float:right;">.....</div>
						</div>
					</div>

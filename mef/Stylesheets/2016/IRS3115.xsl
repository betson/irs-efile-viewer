    ...
    <form style="font-family:arial; font-size:9pt" name="Form3115">      
      ...
      <div class="styTBB" style="width:187mm">
       ...
       <div class="styBB" style="width:187mm; font-size:8pt">
        <div style="float:left; width:110mm; height:16mm; border-right:1px solid black">
        ...
        <div style="float:left; padding-left:2mm; height:8mm;width:77mm;">
        ...
        <div style="float:left; padding-left:2mm; border-top:1px solid black;width:77mm;">
       ...
       <div class="styBB" style="width:187mm">
        <div style="float:left; font-size:8pt; width:110mm; height:10mm; border-right:1px solid black">
        ...
        <div style="float:left; font-size:8pt; padding-left:2mm; height:5mm;width:77mm;">
        ...
        <div style="float:left; font-size:8pt; padding-left:2mm; border-top:1px solid black; width:77mm; height: 5mm">
          <span style="float:left">
       ...
       <div class="styBB" style="width:187mm">
        ...
        <div style="width:77mm;float:left; font-size:8pt;padding-left:2mm; height:10mm">
     ...
     <!-- BEGIN Part I Line Items -->  
       <div style="width:187mm;height:auto;">
		...
		<xsl:choose>
			<xsl:when test="count($Form3115Data/DesignatedAccountingMthdChgNum) &lt;= 12">
				<div style="float:right">
				  <div class="styIRS3115DimYesBox" style="height:33mm"/>  
				  <div class="styIRS3115DimNoBox" style="height:33mm"/>  
				</div>
			</xsl:when>
			<xsl:otherwise>
				<div style="float:right">
				  <div class="styIRS3115DimYesBox" style="height:42mm"/>  
				  <div class="styIRS3115DimNoBox" style="height:42mm"/>  
				</div>
			</xsl:otherwise>
		</xsl:choose>
      </div>  
...
calculation of the section 481(a) adjustment. 
    ...
    <xsl:with-param name="BackupName">Yes Requesting Recur Item Exception</xsl:with-param> 
      ...
      <div style="width:187mm;">  
        <div class="styIRS3115LNLeftNumBox" style="text-align:center">4</div>
        <div style="float:left;width:181mm;padding-bottom:1mm;">
      ...
      <div style="width:187mm;">            
        ...
        <div style="float:left;padding-top:1.5mm;">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/IncludibleDisrgrdFrgnEntSch"/>
  ...
  <xsl:template name="IncludibleDisrgrdFrgnEntSchTemp">
  ...
  <table id="GeneralDependencyTbl" class="styDepTbl">
    ...
    <xsl:for-each select="$DependencyData/IncludibleDisrgrdFrgnEntity">
      <tr>
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <xsl:call-template name="IncludibleDisrgrdFrgnEntSchTemp"/>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/ExcludeUpTo10DaysPresenceStmt" />
	...
	<xsl:template name="ShowDependencyData">
		<div class="styTopSectionLine">
			...
			<div style="width:440px;font-size:10pt;float:left;"><br />
				...
				</xsl:call-template>  (<xsl:value-of select="document('CountriesList.xml')/countries/country[@id=$DependencyData/PassportIssuedGrp/CountryCd]"/>)
			</div>
		</div>
		<div class="styTopSectionLine">
		...
		<div class="styTopSectionLine">
			<div class="styTopSectionLineLbl" style="float:left;">Non US Residency Exclusion Dates:</div>
			<div style="width:440px;font-size:10pt;float:left;"><br />
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$DependencyData/USPresenceExclusionDtDesc"/>
				</xsl:call-template>
			</div>
		</div>
		<div class="styTopSectionLine">

				...
				<form name="Form1120LScheduleM3">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:125mm;height:19.5mm;">
							...
							<div class="styFST" style="height:5mm;">
								...
								Information about Schedule M-3 (Form 1120-L) and its instructions is at
								<br/>
								 <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1120L" title="Link to IRS.gov"><i>www.irs.gov/form1120l.</i></a><br/>
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:19.5mm;border-left-width:2px;">
							...
							<div class="styTY" style="height:11mm;padding-top:1.5mm;">20<span class="styTYColor">16</span>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (2)
							<input type="checkbox" alt="IRS1120LScheduleM3ConsolidatedReturn" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3Mixed1120LPCGroup">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" class="styCkbox" alt="IRS1120LScheduleM3DormantSubsidiariesSchAttached">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="CorpIncmStmtRestated5PrecIndYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="CorpIncmStmtRestated5PrecIndNo" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:130mm;padding-top:.5mm;">(1)
								...
								<label>
									...
									<span style="width:1.5mm;"/>
									<!-- A straight Line -->
									<span style="width:30mm;border-bottom:solid 1px;">
										<xsl:call-template name="PopulateText">
            ...
            <!-- Form Link -->
                ...
                <!--<span class="styDotLn" style="float:none;">..</span>-->
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-L) 2016</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
						<div style="float:left;">Schedule M-3 (Form 1120-L) 2016</div>
...
<!-- Form Link -->
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell">
							  <span style="float:left">Other income (loss) items with differences (attach 
							  statement)						    					 
							  <xsl:call-template name="SetFormLinkInline">
					...
					<!-- Page 2 END -->
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-L) 2016</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styTBB" style="width:187mm;float:none;">

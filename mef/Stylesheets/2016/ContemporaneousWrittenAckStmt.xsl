    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          <div style="float:left;clear:none;" class="styTopSectionLineLbl">Qualified Vehicle Donation Information:</div>
          <div class="styExplanationLine" style="padding-top:4.5mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/QualifiedVehicleDonationDesc"/>
            </xsl:call-template>
          </div>
        </div>
        <br/>

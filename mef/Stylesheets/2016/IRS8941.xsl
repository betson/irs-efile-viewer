...
<!-- Last Modified by Iskilu Lawal 09/13/2016 -->
...
(SHOP) Marketplace (or do you qualify for an exception to this requirement)?  (see instructions)<br/>
  ...
  Enter Marketplace Identifier (if any): 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:170mm;height:20mm;font size:7pt;">Does a tax return you (or any predecessor) filed for a tax year beginning in 2014 include a Form 8941 with line A checked "Yes" and line 12 showing a positive amount?<br/>
							<!-- CheckboxYesStart -->
							<input type="Checkbox" class="styCkbox">
								<xsl:call-template name="PopulateYesCheckbox">
...
3800,  Part III, line 4h
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Enter the amount you paid in 2016 for taxes considered payroll taxes for purposes of this credit <br/> (see instructions) 
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:8mm;font size:7pt">Tax-exempt small employers, enter the <b>smaller</b> of line 16 or line 19 here and on Form 990-T, <br/>line 45f
        <!--Dotted Line-->
							<span class="styBoldText">
							<span style="width:8px"/>. 
							<span style="width:8px"/>. 

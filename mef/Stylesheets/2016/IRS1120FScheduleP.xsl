						...
						<xsl:if test="count($FormData/ForeignPartnerInformationGrp)&lt; 1 or ((count($FormData/ForeignPartnerInformationGrp) &gt; 4) and ($Print = $Separated))">
						  <tr style="height:8mm;">
							...
							<td class="styTableCell" style="border-right:0;text-align:center;vertical-align:bottom;">
							  <input type="checkbox" class="styCkbox" alt="InitialReturn" name="InitialReturn">
								  <xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/ForeignPartnerInformationGrp/InitialReturnInd"/>
									<xsl:with-param name="BackupName">IRS1120FSchPInitialReturn</xsl:with-param>
								  </xsl:call-template>
							  </input>
							  <span style="width:2mm"/>Yes   
...
.							  </td>
				  ...
				  <div style="width:187mm;padding-top:1mm">
					...
					<span style="font-weight:bold;float:right;">Schedule P (Form 1120-F) 2016</span>
				  </div>
				  <!-- <div class="pageEnd"/>-->
				  ...
				  <!-- page break and footer-->
				  <!-- <div>
					<span class="styBoldText">Schedule P (Form 1120-F) 2016</span>

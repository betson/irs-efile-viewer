					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:125mm;">
							...
							<div style="height:3.5mm;font-size:7pt;padding-top:6mm;border:0px;" class="styFST">
								...
								<b>Information about Form 6781 and its instructions is at </b>
<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form6781" title="Link to IRS.gov">
										<i><b>www.irs.gov/form6781.</b></i>
									</a></span>
							</div><br/>
	...
	<th class="styTableCellHeader" scope="col" style="width:17mm;"> (b)<span class="styNormalText"> Date entered into or acquired</span>
</th>
...
<th class="styTableCellHeader" scope="col" style="width:24mm;border-right-width:0mm"> (h) Recognized loss.<span class="styNormalText">  If column (f) is more than (g), enter difference.  Otherwise, enter -0-</span>
</th>	
								</tr>
							</thead>
							<tfoot/>
         ...
         is in an expanded format. Therefore 5pt Verdana font is used for these amount boxes.
          -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:141.7mm;height:8mm;">
						...
						<div style="float:right;">
							...
							<div class="styLNAmountBox" style="height:8mm;width:29.3mm;font-size:6pt;padding-top:3mm;">
								<xsl:call-template name="SetFormLinkInline">
      ...
      -->
					<div style="width:187mm;" class="styBB">
						...
						<div style="float:right;">
							...
							<div class="styLNAmountBoxSmallNBB" style="height:8mm;width:29.3mm;font-size:6pt;padding-top:3mm;">
								<xsl:call-template name="SetFormLinkInline">
  ...
  <!-- Line 13a  -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138.5mm;height:8.2mm;">
						...
						<div style="float:right;">
							...
							<div class="styLNAmountBoxSmall" style="width:32.5mm;height:8.4mm;padding-top:4.2mm;">
								<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;" class="styBB">
						...
						<div style="float:right;">
							...
							<div class="styLNAmountBoxSmallNBB" style="width:32.5mm;height:8.2mm;padding-top:4.2mm;">
								<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
					   ...
					   <span style="width:40mm"/>  
						  Form <span class="styBoldText" style="font-size:8pt">6781</span> (2016)
					</div>
					<div class="pageEnd"/>

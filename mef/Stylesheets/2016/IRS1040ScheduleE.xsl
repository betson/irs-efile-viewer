				...
				<form id="IRS1040ScheduleE">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styBB" style="width:187mm;">
							<div class="styNameBox" style="width:138mm;height:10mm;font-weight:normal;font-size:7pt;">
                           ...
                           <!-- Name from 1041 Return Header -->
							...
							<div style="width:49mm;height:4mm;padding-left:2mm;font-size:7pt;" class="styEINBox">
                                ...
                                <span style="width:15mm;height:5mm;"/>
								<span style="font-weight:normal;">
						         <xsl:choose>
                          <!-- TIN from 1041 return headers-->
						...
						<div class="styBB" style="width:187mm;">
							...
							<div class="styLNDesc" style="width:171mm;padding-left:2mm;height:auto;padding-top:0mm;">
								<span style="font-size:8pt;">
									<b>lncome or Loss From Rental Real Estate and Royalties</b><span style="width:2mm"/>					
							...
							<div class="styBB" style="width:187mm;height:auto;display:block;border-width:0mm;"></div>
						</div>
						<!-- Start Prologue -->
						<div class="styBB" style="width:187mm;">
							...
							<div class="styGenericDiv" style="width:187mm;">
								...
								<div class="styGenericDiv" style="width:28mm;">
									...
									<input type="checkbox" class="styCkbox" alt="Required Forms 1099 Filed Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/RequiredForms1099FiledInd"/>
									...
									<span style="width:8px;"/>
									<input type="checkbox" class="styCkbox" alt="Required Forms 1099 Filed No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/RequiredForms1099FiledInd"/>
											<xsl:with-param name="BackupName">IRS1040ScheduleERequiredForms1099FiledInd</xsl:with-param>
										</xsl:call-template>
...
<!--																<xsl:attribute name="rowspan"><xsl:value-of select="$Line18Rows"/></xsl:attribute>
					...
					<div class="pageEnd" style="width:187mm;page-break-after:always;display:block;">
						...
						<span class="styBoldText" style="font-size:7pt;padding-top:.5mm;padding-left:10mm;float:right;">Schedule E (Form 1040) 2016</span>
						</span>
					</div>
					...
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2016</span>
                  ...
                  If you answered "Yes," see instructions before completing this section.                      
						...
						<div style="width:16mm;float:left;clear:none;padding-left:2mm;padding-top:3.5mm;">
							<xsl:call-template name="PopulateSpan">
						...
						<div style="width:13mm;float:left;clear:none;padding-left:2mm;padding-top:3.5mm;">
							<!-- No Checkbox -->
							<input type="Checkbox" class="styCkbox" alt="No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PriorYearsLossesInd"/>
                  ...
                  lncome or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
					...
					<div class="pageEnd" style="height:6mm;width:187mm;">
						...
						<div class="stySmallText" style="width:46mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2016</span>
						</div>
						</div>
					</div>
					<!-- end page 2 footer -->

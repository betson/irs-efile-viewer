			...
			<body class="styBodyClass">
				<form name="Form3468">
					...
					<!--		<div class="styFBT" style="padding-top:0mm;">
							...
							<div class="styFBT" style="padding-top:0mm;">
								<img src="{$ImagePath}/3468_Bullet.gif" alt="bullet image"/> Information on Form 3468 and its separate instructions is available 
								at	<a href="http://www.irs.gov/Form3468" title="Link to IRS.gov"><i>www.IRS.gov/Form3468</i></a>.
							</div>							
						</div>
						<div class="styTYBox" style="width:38mm;height:24mm;">
							...
							<div style="text-align:left;padding-left:3mm;">
								<div class="styTY" style="height:9.5mm;">20<span class="styTYColor">16</span>
								</div>
          ...
          Name(s) shown on return<br/>
					...
					<div style="width:187mm;font-size:8pt; float:left">
						...
						<div class="styLNDesc" style="height:7mm;width:130mm;padding-left:2mm">
	                           ...
	                           Qualified investment in advanced energy project property placed in</div>
...
<!--						<div class="styLNRightNumBox" style="height:8mm;padding-top:4mm;">8</div>
				...
				<!-- Page Break and Footer-->
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3468</span> (2016)</div>
					</div>
					<br/>
					<div class="pageEnd"/>
				...
				<!-- END Page Header -->			
                   ...
                   <!--               <span style="float:left;"></span>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="width:8mm;height:6mm;padding-top:2mm">11i</div>
						<div class="styLNAmountBox" style="height:6mm;padding-top:2mm">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;font-size:8pt; height:auto">
						<div style="float:left;clear:none;">
							<div style="width:138mm;">
								<div class="styLNLeftNumBox" style="text-align:right;">a</div>
								<div class="styLNDesc" style="width:130mm;padding-left:2mm">
                                         Basis of property using geothermal energy or solar energy (acquired before January 1, 2006, and the basis attributable 
                                         to constuction,
						...
						<div style="float:left;clear:none;">
							<div style="float:left;">
								<div class="styLNRightNumBox" style="height:14mm;padding-top:10mm;">12a</div>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                                  Basis of property placed in service during the tax year that was acquired  after December 31, 2005, and the basis
                                   attributable to construction, reconstruction, and erection by the taxpayer after December 31, 2005
                            <!--Dotted Line-->
							<span class="styDotLn" style="float:none;padding-left:2mm">........</span>
							<span style="float:right; font-size:6pt">										
            ...
            <!--Dotted Line-->
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;border-top:1px solid black" class="pageend">
						...
						<div style="float:right;font-size:8pt" class="styGenericDiv">Form <span class="styBoldText" style="font-size:8pt;">3468</span> (2016)</div>
					</div>
					...
					<span style="float:left">Form 3468 (2016)</span>
					...
					<div class="styBB" style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm">
			                Add lines 11e, 11f, 11i, 12a, 12b, 12e, 12h, 12k, 12n, 12p, 12q, 12r, 12s, 12t, and 13.  Report this amount on Form 3800, 
			                line 4a
                                <!--Dotted Line-->
								<span class="styDotLn" style="float:none;padding-left:2mm">.............</span>
						</div>
...
<!-- Adding page break -->
					<div style="width:187mm;">
						<div style="float:right;" class="styGenericDiv">Form
					       <span class="styBoldText" style="font-size:8pt;">3468</span> (2016)</div>
					</div>

...
instructions before completing this form.</span>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;height:5mm">
						<div class="styPartName" style="width:23mm;;height:4.5mm">Part I </div>
						<div style="width:164mm;font-size:8pt;"> <b>
							
						&#160;Automatic Extension&#160;for C corporations with Tax Years Ending December 31.</b>
						 See instructions.
 </div>
					</div>
					<!-- END Part I Title -->
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="width:171mm;height:5mm;">
							<span style="float:left;font-size:8pt;">Enter the form code for the return listed below
	...
	<span class="styDotLn">................</span>
					...
					<div style="width:187mm;clear:both;">
						...
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">Form 1120-ND (section 4951 taxes)
					...
					<div style="width:187mm;clear:both;">
						...
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">Form 1120-POL
					...
					<div style="width:187mm;clear:both;">
						...
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">Form 1120-RIC
					...
					<div style="width:187mm;clear:both;">
						...
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">
			      
							</span>
						</div>
						<div class="styLNAmountBox" style="height:5mm;width:13mm;border-top-width: 0px;border-left-width: 1px;
						border-bottom-width: 1px;padding-top:.5mm;padding-left:1mm;background-color:lightgrey;">
							<span style="font-size: 9pt;text-align:center;font-weight:bold;padding-right:4mm;clear: none;"></span>
						</div>
					</div>
					<!-- end table line7 -->
	<!-- BEGIN Part II Title -->
					<div class="styBB" style="width:187mm;border-top-width:1px;font-size:8pt">
						...
						<div style="width:164mm;"><b>
							
						&#160;Automatic Extension for Certain Estates and Trusts. </b>See instructions.
 </div>
					</div>
					<!-- END Part II Title -->
					<!-- line 1b -->
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="width:171mm;height:4mm;">
							<span style="float:left;font-size:8pt;">Enter the form code for the return listed below that this application 
	    	is for &#160;
        </span>
	<span class="styDotLn">................</span>
						</div>
						...
						height: 5mm;width:4mm;width:8mm;padding-left:2mm;padding-top:1.5mm">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Auto5HalfMnthExtensionReturnCd"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- end line 1b -->
					...
					<!-- Table line 1 -->
					<div style="width:187mm;clear:both;">
						<div class="styLNAmountBox" style="height:9mm;width:80mm;border-top-width: 0px;border-left-width:0px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">Form 1041 (estate other than a bankruptcy estate)</span>
						</div>
						<div class="styLNAmountBox" style="height:9mm;width:13mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 1px;border-bottom-width: 1px;padding-top:.5mm;padding-left:1mm;">
							<span style="font-size: 9pt;text-align:center;font-weight:bold;padding-right:4mm;clear: none">04</span>
						</div>
						<div class="styLNAmountBox" style="height:9mm;width:80mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
			...
			<b>
						...
						&#160;Automatic Extension for Entities Not Using Part I, II , or IV.</b>&#160;See instructions.
					</div>
					<!-- END Part II Title -->
					<!-- line 1c -->
					<div style="width:187mm">
...
<!-- END Page Break and Footer-->
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						...
						<div class="styPartName" style="width:23mm;height:4mm">Part IV</div>
						<div  style="width:164mm;font-size:8pt">&#160;<b>
							
						Automatic Extension&#160;for C corporations with Tax Years ending June 30.</b> 
						 See instructions.  
    </div>
					</div>
					<!-- END Part IV Title -->		
				<!-- line 1d -->
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:2mm">d</div>
						<div class="styLNDesc" style="width:171mm;height:4mm;">
							<span style="float:left;font-size:8pt;">Enter the form code for the return listed below that this application 
	    	is for &#160;
        </span>
	<span class="styDotLn">................</span>
						...
						height: 5mm;width:4mm;width:8mm;padding-left:2mm;padding-top:1.5mm">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Auto7MonthExtensionReturnCd"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- end line 1d -->
					...
					<div style="width:187mm;clear:both;">
						...
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top-width: 0px;border-left-width: 1px;border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;;background-color:lightgrey">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;"></span>
						</div>
						<div class="styLNAmountBox" style="height:5mm;width:13mm;border-top-width: 0px;border-left-width: 1px;border-bottom-width: 1px;padding-top:.5mm;padding-left:1mm;;background-color:lightgrey">
							<span style="font-size: 9pt;text-align:center;font-weight:bold;padding-right:4mm;clear: none;"></span>
						</div>
				...
				<!-- BEGIN Part V Title -->
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						<div class="styPartName" style="width:23mm;padding-top:.5mm">Part V</div>
						<div class="styPartDesc" style="width:164mm;padding-top:.5mm">All Filers Must Complete This Part
    </div>
					</div>
					<!-- END Part V Title -->	
 ...
 Tentative total tax</span>
	...
	<div class="styLNRightNumBox"  style="height:4.5mm;border-bottom-width:0pt">8</div>
					...
					<div style="width:187mm;clear:both;">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">7004</span> (Rev. 12-2016)</div>
					</div>
					<!-- br class="pageEnd"/ -->

				...
				<form id="Form1040">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:18mm;border-right-width:1px;height:42px;padding-top:7px;">
							<span class="styTaxYear">20<span class="styTYColor">16</span>
							</span>
						</div>
						<div class="styOMB" style="width:31.5mm;height:42px;padding:25px 1mm 1mm 1mm;float:left;
					...
					<div class="styTBB" style="width:187mm;display:block">
						...
						<div class="styIRS1040HeaderCell" style="width:141.8mm;height:4mm;">
							For the year Jan. 1&#8211;Dec. 31, 2016, or other tax year beginning <span style="width:2mm;"/>
						...
						<div class="styIRS1040HeaderCell" style="width:74.8mm;height:6.5mm">
							Last name <br/>
						</div>
						<div class="styIRS1040HeaderCell" style="width:45mm;border-right-width:0px;height:6.5mm">
						...
						<div class="styGenericDiv" style="width:187mm;">
							...
							<div class="styIRS1040HeaderCell" style="width:45mm;height:10mm;padding-top:6px;border-right-width:0px;">
								...
								<div class="styGenericDiv" style="text-align:center;width:35mm;font-family:arial;">Make sure the SSN(s) above 
								    <br/>and on line 6c are correct.</div>
							</div>
						</div>
						<!-- Line iv -->
						<div class="styIRS1040HeaderCell" style="width:141.8mm;height:7.9mm;">
						...
						<!-- Line v -->
						<div class="styIRS1040HeaderCell" style="width:64mm;height:8.4mm;border-bottom:0px">
						...
						<div class="styIRS1040HeaderCell" style="width:47mm;height:8.4mm;border-bottom:0px">
							Foreign province/state/county<br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
								<xsl:with-param name="TargetNode">ProvinceOrStateNm</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styIRS1040HeaderCell" style="width:30.8mm;height:8.4mm;border-bottom:0px">
					...
					<!-- End Entity Data -->
					<!-- Filing status area -->
					<div style="width:187mm; border-style:solid; border-color: black; border-width: 0px 0px 1px 0px;height:100%;
					  display:block">
						<div style="width:26mm;float:left;clear:none;height:21mm;">
						...
						<div style="width:160mm;float:left;clear:none;height:100%">
							<div style="width:80mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">1</div>
						    ...
						    <div style="width:80mm;float:right;clear:none;">
							    <div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">4</div>
							    <div style="float:left;clear:none;padding-top:.2mm;">
								    <input type="checkbox" class="styCkbox">
									    <xsl:call-template name="PopulateEnumeratedCheckbox">
										    <xsl:with-param name="TargetNode" select="$FormData/IndividualReturnFilingStatusCd"/>
									...
									<label>
									   ...
									   Head of household (with qualifying person). (See <br/> instructions.) If
									   the qualifying person is a child but not your <br/> 
									</label>
									...
									<div class="styBB" style="width:20mm;float:right;clear:none;">
							...
							<div style="width:80mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">2</div>
								<div style="float:left;clear:none;padding-top:.2mm;">
									<input type="checkbox" class="styCkbox">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/IndividualReturnFilingStatusCd"/>
						...
						<div style="width:160mm;float:left;clear:none;height:100%;">
							<div style="width:80mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">3</div>
								<div style="float:left;clear:none;padding-top:.2mm;">
									<input type="checkbox" class="styCkbox">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/IndividualReturnFilingStatusCd"/>
									...
									<label>
									   ...
									   Married filing separately. Enter spouse's SSN above<br/>
									...
									<div class="styNBB" style="width:35mm;float:right;clear:none;">
										<xsl:call-template name="PopulateText">
							...
							<div style="width:80mm;float:right;clear:none;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">5</div>
								<div style="float:left;clear:none;padding-top:.2mm;">
									<input type="checkbox" class="styCkbox">
										<xsl:call-template name="PopulateEnumeratedCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/IndividualReturnFilingStatusCd"/>
						...
						<div style="width:187mm; height:auto;border-style:solid; border-color: black; border-width: 0px 0px 1px 0px;
						  display:block;clear:both;">
							<div style="width:25.5mm;float:left;clear:none;height:auto;">
						...
						<div style="width:126.5mm;float:left;clear:none;display:block;height:auto">
							<div style="width:126mm;float:left;clear:none;height:auto">
								<div style="width:120mm;float:left;clear:none;height:auto;">
									<div style="width:123mm;height:4mm;float:left;clear:none;height:auto;">
										<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm">6a</div>
										<div style="float:left;clear:none;padding-top:.2mm;padding-left:2mm;">
											<input type="Checkbox" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
											...
											<span class="styDotLn" style="float:none;clear:none;padding-left:1mm;padding-right:0mm;
...
-->
									...
									<div class="sty1040DepdContainer" style="height:27mm;width:120mm;" id="depdContainerId">
										...
										<table class="styTable" cellspacing="0">
											<thead class="styTableThead">
												<tr>
													<th class="styTableCellHeader" scope="col" style="text-align:left;width:49.4mm;
													...
													<th class="styTableCellHeader" scope="col" style="width:21.2mm;border-right-width:1px;vertical-align:top;">
													...
													<th class="styTableCellHeader" scope="col" style="width:23.6mm;border-right-width:1px;vertical-align:top;">
													<!-- uncomment and change table header literals here or use 'cellpad' -->
														<span style="font-weight:normal;">
														    <b>(3)</b><span style="width:.5mm"/>Dependent's <br/>
														   relationship to you
													    </span>
													    <!-- span class="styTableCellPad"></span -->
													</th>
											...
											<tbody>
												<xsl:if test="($Print != $Separated) or (count($FormData/DependentDetail) &lt;= 4)">
													<xsl:for-each select="$FormData/DependentDetail">
														<tr>
															<!-- Column 1 -->
															<td class="styTableCell" style="width:51.4mm;height:3mm;
															  border-right-width:1px;">
																...
																<label>
																	...
																	<span style="width:25mm;text-align:left;">
																		<xsl:call-template name="PopulateText">
																	...
																	<span style="width:18mm;text-align:left;">
																		<xsl:call-template name="PopulateText">
																...
																<span style="width:4mm;align:left;">
																	<xsl:call-template name="LinkToLeftoverDataTableInline">
																		<xsl:with-param name="Desc">Line 6c - Dependent <xsl:number value="position()"/> 
														...
														<!-- Column 2 -->
														<td class="styTableCell" style="text-align:center;width:26.2mm;height:3mm;
														  border-right-width:1px;">
															<xsl:choose>
														...
														<!-- Column 3 -->
														<td class="styTableCell" style="width:18.6mm;height:3mm;text-align:left;
														 border-right-width:1px;">
															<xsl:call-template name="PopulateText">
														...
														<!-- Column 4 -->
														<td class="styTableCell" style="text-align:center;width:24.6mm;height:3mm;
											...
											<xsl:if test="count($FormData/DependentDetail) &lt; 1 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
												<tr>
													<td class="styTableCell" style="width:49.4mm;text-align:left;height:4mm;
													  border-right-width:1px;">
													...
													<td class="styTableCell" style="width:26.2mm;height:4mm;border-right-width:1px;">
														<span class="styTableCellPad"/>
													</td>
											...
											<xsl:if test="count($FormData/DependentDetail) &lt; 2 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
												<tr>
													<td class="styTableCell" style="width:49.4mm;height:4mm;border-right-width:1px;">
														<span class="styTableCellPad"/>
													</td> 
													<td class="styTableCell" style="width:26.2mm;height:4mm;border-right-width:1px;">
														<span class="styTableCellPad"/>
                ...
                <xsl:with-param name="containerID" select=" 'depdContainerId' "/>
							...
							<!--<div style="width:127mm;height:5mm;padding-top:5mm;">-->
								<div style="width:161mm;float:left;clear:none;padding-left:1mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:3mm;padding-left:2mm;">d</div>
									<div style="width:120mm;padding-left:0mm;float:left;clear:none;">
										<span style="float:left;padding-top:3mm;clear:none;padding-left:1.5mm">
										  Total number of exemptions claimed
										</span>
										<span class="styDotLn" style="padding-top:3mm;float:right;padding-right:2mm;">.................</span>
									</div>
									<div style="width:26mm;height:8mm;padding-top:0mm;padding-left:2mm;float:left;clear:none">
										<b>Add numbers on
							 lines above</b>
										<span style="width:1mm"/>
										<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
									</div>
									<div style="width:2mm;height:1mm;float:left;clear:none;padding-top:2mm;"></div>
									<div class="styDblBox" style="height:6.5mm;padding-top:1.5mm;text-align:right;float:right;clear:none;width:8mm;">
						...
						<!-- Boxes checked area -->
						<div style="width:34mm;height:6mm;float:left;clear:none;display:block">
							<div style="width:26mm;float:left;clear:none;">
								<b>Boxes checked<br/>on 6a and 6b</b>
							</div>
							<div class="styBB" style="height:6mm;padding-top:2mm;text-align:right;float:right;clear:none;width:8mm;">
								<xsl:call-template name="PopulateAmount">
							...
							<div style="width:26mm;height:9mm;float:left;clear:none;">
								<b>No. of children<br/>on 6c who:<br/>
							...
							<div style="width:26mm;height:11mm;float:left;clear:none;">
								<img src="{$ImagePath}/1040_Bullet_Round.gif" alt="Round bullet image"/>
								<span style="width:5px;"/>
								<b>did not live with
                        you due to divorce
                        ...
                        (see instructions)</b>
							...
							<div class="styBB" style="height:12mm;padding-top:8mm;text-align:right;float:right;clear:none;width:8mm;">
								<xsl:call-template name="PopulateAmount">
							...
							<div style="width:26mm;height:5mm;float:left;clear:none;padding-top:2mm;">
								<b>Dependents on 6c<br/>not entered above</b>
							</div>
							<div class="styBB" style="height:6.5mm;padding-top:3mm;text-align:right;float:right;clear:none;width:8mm;">
								<xsl:call-template name="PopulateAmount">
                     ...
                     see instructions.<br/>
						...
						<div style="width:162.5mm;float:left;clear:none;">
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:116.5mm;padding-top:.5mm;padding-left:3mm;">
							...
							<!-- Line 8b -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:4.25mm;padding-top:.5mm">b</div>
								<div style="width:76.4mm;padding-top:.5mm;padding-left:3mm;padding-top:.5mm">
									<b>Tax-exempt</b> interest. <b>Do not</b> include on line 8a
                           			<span class="styDotLn" style="float:right;padding-right:2mm;">..</span>
								</div>
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:18.8px;padding-bottom:0mm;padding-top:.7mm">8b</div>
									<div class="styLNAmountBox" style="height:18.8px;padding-bottom:0mm;border-right-width:0px;padding-top:.7mm">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="styShadingCell" style="height:18.8px;width:8mm;border-left-width:0px;border-left-width:1px"/>
									<div class="styLNAmountBox" style="height:18.8px;border-bottom-width:0px; border-left-width:1px;"/>
								</span>
							</div>
							<!--End Line 8b -->
							<!-- Line 9a -->
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:116.5mm;padding-top:.5mm;padding-left:3.5mm;">
									<div style="width:77mm;padding-left:0mm;">                           
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:76.4mm;padding-top:.5mm;padding-left:3.5mm;">
								  Qualified dividends 
                           			<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:19px;padding-bottom:0mm;padding-top:.5mm;">9b</div>
									<div class="styLNAmountBox" style="border-right-width:0px;height:19px;padding-bottom:0mm;
									  padding-top:.5mm;border-right-width:0px;">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="styShadingCell" style="height:19px;width:8mm;border-right-width:0px;border-left-width:1px;"/>
									<div class="styLNAmountBox" style="height:19px;border-left-width:0px;border-bottom-width:0px;
							...
							<!-- Line 13 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1mm;padding-left:1.1mm">13</div>
								<div style="width:117.8mm;padding-top:0mm;padding-left:3.2mm;font-size:6.5pt">
									...
									<label>
										...
										<span style="font-size:6.5pt;padding-left:.5mm">
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:116.2mm;padding-top:0mm;padding-left:2.3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span style="width:25.1mm;float:left;clear:none;padding-top:1.2mm">
										IRA distributions
										</span>
										<!-- Form to Form Link -->
										<!-- **** -->
										<span class="styDotLn" style="float:left;clear:none;padding-right:1mm;padding-top:.8mm">.</span>
										<div class="styLNRightNumBox" style="width:6mm;padding-bottom:0mm;padding-top:.8mm">15a</div>
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:116.2mm;padding-top:0mm;padding-left:2.3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span style="width:30.1mm;font-size:7pt;float:left;clear:none;padding-top:1mm">
									      Pensions and annuities
										</span>
										<div class="styLNRightNumBox" style="width:6mm;padding-bottom:0mm;padding-top:.5mm;">16a</div>
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:116.2mm;padding-top:0mm;padding-left:2.5mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										...
										<div class="styLNRightNumBox" style="width:6mm;padding-bottom:0mm;padding-top:0mm;height:3.5mm">20a</div>
										<div class="styLNAmountBox" style="border-right-width:1px;padding-bottom:0mm;padding-top:0mm;height:3.5mm">
											<xsl:call-template name="PopulateAmount">
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:117.8mm;padding-top:0mm;padding-left:3mm;float:left;clear:none;">
									...
									<span class="styUnderlineAmount" style="width:58mm;padding-top:3mm;padding-left:3mm;
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:117.8mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;padding-top:.6mm">
								      Combine the amounts 
										<span class="styAgency" style="font-size:8pt;">in the far right column for lines 7 through 21.</span> 
										  This is your <b> total income</b>
										<span style="width:4px;"/>
										<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
									</span>
								</div>
                     ...
                     Income
						...
						<div style="width:162.5mm;float:left;clear:none;display:block">
							...
							<div>
								...
								<div style="width:162.5mm;height:6mm">
									...
									<div style="width:76mm;float:left;clear:none;padding-top:.5mm;padding-left:3mm;">
										<span style="float:left;clear:none;font-size:7pt;font-family:Arial-Narrow">
                           ...
                           fee-basis government officials. Attach Form 2106 or 2106-EZ
							...
							<!-- Line 25 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:1.3mm;">25</div>
							...
							<!-- Line 26 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:1.2mm">26</div>
                           ...
                           <xsl:call-template name="SetFormLinkInline">
							...
							<!-- Line 27 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:.8mm;">27</div>
								<div style="width:77mm;padding-top:.3mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
							...
							<div style="width:162.5mm;height:3mm;">
								...
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:17px;padding-top:1mm;">30</div>
									<div class="styLNAmountBox" style="height:17px;padding-top:1mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<div style="width:162.5mm;height:3.5mm;">
								...
								<div style="width:76mm;padding-top:1.4mm;padding-left:2mm;float:left;clear:none;">
									...
									<div class="styUnderlineAmount" style="width:20mm;padding-top:0mm;padding-bottom:0mm;
										text-align:center;height:3mm;">
									...
									<span style="width:4mm;padding-top:0mm;padding-bottom:0mm;float:left;clear:none;">
										<xsl:if test="count($FormData/AlimonyAmountGrp) &gt; 1">
											<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:20px;padding-top:1.8mm;">31a</div>
									<div class="styLNAmountBox" style="height:20px;padding-top:1.8mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<div style="width:162.5mm;height:4mm">
								...
								<div style="width:77mm;float:left;clear:none;padding-top:.5mm;padding-left:3mm;">
									<div style="width:25mm;padding-left:0mm;padding-top:.6mm;float:left;clear:none;">
									  IRA deduction 
										<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">32</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 33 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:1.3mm">33</div>
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
								...
								<span style="float:right;">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">33</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 35 -->
									<div style="width:162.5mm;height:4mm">
										...
										<span style="float:right;">
											<div class="styLNRightNumBox" style="padding-top:.8mm;">35</div>
											<div class="styLNAmountBox" style="padding-top:.8mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$FormData/DomesticProductionActDedAmt"/>
												</xsl:call-template>
						...
						<div class="pageEnd" style="width:187mm;border-top:1px solid black;clear:both">
							...
							<!--<div style="width:187mm; font-size:6.5pt; border-top:1 solid black; padding-top:0.5mm">-->
								...
								<span style="width:14mm"/>Form <b style="font-size:8.5pt">1040</b> (2016)
							</div>
							<p style="page-break-before: always"/>
						<!-- end page 1 footer -->
					    <!-- page 2 -->
							<div class="styTBB" style="width:187mm;padding-top:.5mm;">
								<span class="" style="float:left;clear:none;">Form 1040 (2016)</span>
								<span style="float:right;clear:none;">Page <span class="styBoldText" style="font-size:8pt;">2</span>
								</span>
							</div>
							<!--<div style="width:187mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; 
							   border-left-width: 0px; border-right-width: 0px;float:left;clear:none;">
								<div style="padding-left:24.5mm;float:left;clear:none;">
									<div style="width:162.5mm;float:left;clear:none;">
								    </div>
							    </div>
						    </div>-->
						...
						<!-- end AGI -->
						<!-- tax and credits -->
						<div class="styBB" style="width:187mm;padding-top:0mm;padding-bottom:0mm;display:block">
							<div style="width:24.5mm;float:left;clear:none;">
								<div style="padding-top:36px;padding-bottom:10px;">
									<div class="styMainTitle" style="font-size:11pt;">
									  Tax and<br/>
									  Credits
									</div>
								</div>
								<div class="styGenericDiv" style="width:24.5mm;padding-left:8px;border-color:black;border-style:solid;
								  border-top-width:1px; border-left-width:1px;border-right-width:0px;border-bottom-width:0px;height:12px;
								  padding-bottom:0px;padding-top:4px">
									<b>Standard</b>
									<br/>
								</div>
								<div class="styGenericDiv" style="width:24.5mm;padding-left:8px;border-color:black;border-style:solid;
								  border-top-width:0px;border-left-width:1px;border-right-width:0px;border-bottom-width:0px;height:13px;
								  padding-bottom:0px;padding-top:0px;">
									<b>Deduction</b>
									<br/>
								</div>
								<div class="styGenericDiv" style="width:24.5mm;padding-left:8px;padding-top:0px;border-color:black;
								  border-style:solid;border-top-width:0px; border-left-width:1px;border-right-width:1px;border-bottom-width:0px;
								  height:16px;">
									<b>for&#8211;</b>
									<br/>
								</div>
								<div class="styGenericDiv" style="width:24.5mm;padding-left:8px;border-color:black;border-style:solid;
								  border-top-width:0px; border-left-width:1px;border-right-width:1px;border-bottom-width:1px;">
								  &#8226; People who<br/>
								  check any<br/>
								  box on line<br/>
								  39a or 39b <b>or</b>
							...
							<div style="width:162.5mm;float:left;clear:none;">
								...
								<!-- Line 39a -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:4.5mm;">39a</div>
									<div style="width:.2mm"/>
									<div style="width:117.2mm;padding-top:0mm;padding-left:2mm;font-size:6.5pt">
										<div style="width:7mm;">
											<div style="padding-top:0mm;">Check</div>
											<div style="padding-top:1mm;">if:</div>
										</div>
										<div style="padding-right:.2mm;">
											<img src="{$ImagePath}/1040_LeftBracket.gif" alt="Left bracket image"/>
										</div>
										<div style="width:57mm;padding-left:0mm">
											<div style="padding-top:1mm;padding-left:0mm;">
												<!-- Checkbox -->
												<input type="Checkbox" class="styCkbox" style="width:3mm">
													<xsl:call-template name="PopulateCheckbox">
												...
												<label>
													...
													<b>You </b> were born before January 2, 1952,
												</label>
											</div>
											<div style="padding-top:1mm;">
												...
												<label>
													...
													<b>Spouse </b> was born before January 2, 1952,
												</label>
											</div>
										</div>
										<div style="width:14mm;padding-left:0mm;">
											<div style="padding-top:1mm;padding-left:0mm">
												<!-- Checkbox -->
												<input type="Checkbox" class="styCkbox" style="width:3mm">
													<xsl:call-template name="PopulateCheckbox">
										...
										<div style="height:4mm;width:6mm;padding-top:1mm"><b>39a</b></div>
										<div class="styDblBox" style="height:8mm;width:6.3mm;float:none;clear:none">
											<div style="padding-top:2mm;text-align:center;padding-left:2mm">
												<xsl:call-template name="PopulateAmount">
								...
								<!-- Line 39b -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-left:4.25mm;border-color:black;border-style:solid;
									  border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:15px;
									  padding-top:1.2mm">b</div>
									<div style="width:117.25mm;padding-top:0mm;padding-left:3mm;">
										<div style="font-size:6.3pt;padding-top:0mm">
											<label>
												<xsl:call-template name="PopulateLabel">
									...
									<span style="float:right;">
										<div class="styShadingCell" style="height:21px;width:8mm;border-right-width:0px;"/>
										<div class="styLNAmountBox" style="height:21px;border-left-width:1px;border-bottom-width:0px;"/>
									</span>
								</div>
								<!--End Line 39b -->
								<!-- Line 40 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;border-width:1px 0px;
									  height:25px;padding-top:5px">40</div>
									<div style="width:117.8mm;font-size:6.3pt;padding-top:8px;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:25px;padding-top:10px">40</div>
										<div class="styLNAmountBox" style="height:25px;padding-top:10px">
											<xsl:call-template name="PopulateAmount">
								...
								<!-- Line 41 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;border-left-width:0px;
									  border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:4mm;">41</div>
								...
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;border-left-width:0px;
									  border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:4.4mm;">42</div>
									<div style="width:117.7mm;float:left;clear:none;padding-bottom:0mm;padding-top:.5mm;padding-left:3mm;">
										<div style="padding-left:0mm;float:left;clear:none;">
											<span style="float:left;clear:none;">
												<b>Exemptions.</b> 
												If line 38 is $155,650 or less, multiply $4,050 by the number on line 6d. Otherwise, see instructions
								...
								<!-- Line 43 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:1.4mm;border-color:black;border-style:solid;
									  border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:5.5mm;">43</div>
								...
								<!-- Line 44 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:1.2mm;width:4mm;border-color:black;
									  border-style:solid;border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;
									  height:4.5mm;">44</div>
									<div style="width:118.5mm;padding-top:0mm;padding-left:3mm;font-family:Arial Narrow;font-size:7pt">
										<b>Tax</b>
										<span style="width:3px;"/>
										<span style="font-family:Arial Narrow;font-size:7pt;">
											...
											<label>
												...
												<span style="width:1px;"/>
												<span class="styAgency">Form(s) 8814</span>
											</label>
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$FormData/Form8814Ind"/>
											</xsl:call-template>
											...
											<label>
												...
												<span class="styAgency">Form 4972</span>
											</label>
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$FormData/Form4972Ind"/>
											</xsl:call-template>
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:4.7mm">44</div>
								...
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;
									  ...
									  height:4.5mm;padding-top:1mm;">45</div>
									<div style="width:117.7mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
								...
								<!-- Line 46 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;width:4mm;border-color:black;border-style:solid;
									  border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:4.5mm;
									  padding-top:0.8mm;">46</div>
									<div style="width:117.7mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
								...
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;border-left-width:0px;
									  border-right-width:0px;border-top-width:0px;border-bottom-width:0px;height:4.4mm;">47</div>
									<div style="width:117.7mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
								...
								<!-- Line 48 -->
								<div style="width:162.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:.8mm;padding-left:1mm;width:4mm;
								...
								<!-- Line 51 -->
								<div style="width:162.5mm;height:4mm">
									<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:0.7mm;width:4mm;
									border-color:black;border-style:solid;border-left-width:0px;border-right-width:0px;border-top-width:0px;
									border-bottom-width:0px;height:3.9mm;">51</div>
									<div style="width:77mm;padding-top:1mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;font-size:6.5pt">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">51</div>
										<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/RtrSavingsContributionsCrAmt"/>
								...
								<div style="width:162.5mm;height:4mm">
									...
									<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;font-size:6.5pt;padding-top:0.6mm;">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">52</div>
										<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/ChildTaxCreditAmt"/>
								...
								<!-- Line 53 -->
								<div style="width:162.5mm;height:4mm">
									<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:1.5mm;width:4mm;
									border-color:black;border-style:solid;border-left-width:0px;border-right-width:0px;border-top-width:0px;
									border-bottom-width:0px;height:4.1mm;">53</div>
									<div style="width:77mm;padding-top:1.1mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:20px;padding-top:1.5mm;">53</div>
										<div class="styLNAmountBox" style="height:20px;padding-top:1.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/ResidentialEnergyCreditAmt"/>
											</xsl:call-template>
										</div>
								...
								<div style="width:162.5mm;height:7mm">
									<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:2.8mm;width:4mm;
									  border-color:black;border-style:solid;border-left-width:0px;border-right-width:0px;border-top-width:0px;
									  border-bottom-width:0px;height:4mm;">54</div>
									<div style="width:77mm;padding-top:1.60mm;padding-left:3mm;font-size:7.5pt;float:left;clear:none;">
										<span style="float:left;clear:none;">
											...
											<span style="width:1px;"/>
											<span class="styFixedUnderline" style="padding-top:0mm;padding-bottom:0mm;float:none;width:8mm;">
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="$FormData/SpecificOtherCreditsInd"/>
												</xsl:call-template>
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:27px;padding-top:2.5mm;">54</div>
										<div class="styLNAmountBox" style="height:27px;padding-top:2.5mm;">
											<xsl:call-template name="PopulateAmount">
										...
										<div class="styShadingCell" style="height:27px;width:8mm;padding-top:1.8mm;border-right-width:0px;"/>
										<div class="styLNAmountBox" style="height:27px;border-width:0px;text-align:left;border-left-width:1px;
								...
								<!--End Line 54 -->
								<!-- Line 55 -->
								<div style="width:162.5mm;height:2.8mm">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;
									  border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;
									  padding-top:0mm">55</div>
									<div style="width:117.7mm;padding-top:0mm;padding-left:3mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:4.5mm;">55</div>
										<div class="styLNAmountBox" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
								...
								<div style="width:162.5mm;height:4.5mm;">
									<div class="styLNLeftNumBox" style="width:4mm;border-color:black;border-style:solid;
									  border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;
									  padding-top:1mm">56</div>
									<div style="width:117.7mm;padding-left:3mm;padding-top:1mm;float:left;clear:none;">
										<span style="float:left;clear:none;">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:18px;border-bottom-width:0px;padding-top:1.5mm">56</div>
										<div class="styLNAmountBox" style="height:18px;border-bottom-width:0px;padding-top:1.5mm">
											<xsl:call-template name="PopulateAmount">
						...
						<!--Other taxes -->
						<div class="styBB" style="width:187mm;"/>
						<div class="styBB" style="width:187mm;height:33.5mm;">
							...
							<div style="float:left;clear:none;height:8mm;width:162.5mm;">
								...
								<div style="width:162.5mm;height:4mm">
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="padding-top:1mm;height:4.4mm">58</div>
										<div class="styLNAmountBox" style="padding-top:1mm;height:4.4mm">
											<xsl:call-template name="PopulateAmount">
								...
								<div style="width:162.5mm;height:4mm">
									...
									<div style="width:117.8mm;padding-top:.7mm;padding-left:3mm;float:left;clear:none;">
								...
								<div style="width:162.5mm;height:4mm">
									...
									<div style="width:116.2mm;padding-left:3mm;padding-top:1px;float:left;clear:none;">
										<span style="float:left;clear:none;">
								...
								<!--End Line 61 -->
								<!-- Line 62 -->
								<div style="width:162.5mm;height:2.5mm">
									<div class="styLNLeftNumBox" style="width:4mm;padding-top:1.5mm">62</div>
									<div style="width:117.8mm;padding-top:.3mm;padding-left:3mm;float:left;clear:none;">
										Taxes from: 
										<span style="width:2mm;"/>
										<span class="styBoldText">a</span>
										<span style="width:4px;"/>
										...
										<label>
											...
											<span class="styAgency" style="font-size:7pt;">Form 8959</span>
										</label>
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/Form8959Ind"/>
										</xsl:call-template>
										...
										<label>
											...
											<span class="styAgency" style="font-size:7pt;padding-right:1mm;">Form 8960</span>
										</label>
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/Form8960Ind"/>
										</xsl:call-template>
										...
										<label>
											...
											<span class="styAgency" style="font-size:7pt;padding-right:1mm;">
											  Instructions; enter codes(s)</span>
										</label>
										<span class="styFixedUnderline" style="width:12mm;float:none;padding-top:0mm;padding-left:0mm;
									...
									<span style="float:right;">
										<div class="styLNRightNumBox" style="height:5mm;padding-top:1.3mm">62</div>
								...
								<!--End Line 62 -->
								<!-- Line 63 -->
								<div style="width:162.5mm;height:1mm;padding-top:.3mm">
									<div class="styLNLeftNumBox" style="width:4mm;">63</div>
									<div style="width:117.8mm;float:left;clear:none;padding-left:3mm;">
										<div style="padding-left:0mm;">
											...
											<xsl:if test="count($FormData/Form8854DeferredAmountGrp) &gt; 1">
												<xsl:call-template name="LinkToLeftoverDataTableInline">
													<xsl:with-param name="Desc">Line 63 - Form 8854 Deferred Amount Grp</xsl:with-param>
										...
										...........
											<div style="padding-top:1mm;float:right;clear:none">
												<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>
											</div>
										</div>
									</div>
						...
						<!--End Other taxes -->
						<!-- Payments -->
						<div style="width:187mm;height:49.4mm;">
							<div style="width:24.5mm;padding-left:2.3mm;float:left;clear:none;">
								<div style="padding-top:0mm;padding-bottom:1mm;height:9.4mm;">
									<span class="styMainTitle" style="font-size:11pt;">
										Payments
									</span>
								</div>
								<div style="border-style:solid; border-color:black;border-width: 1px 0px 0px 1px;padding-top:8px;
								  padding-left:13px;width:22.2mm;">
								   If you have a</div>
							...
							<div style="width:162.5mm;">
								...
								<div style="width:77mm;padding-top:.8mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										...
										<span style="width:2px"/>
										<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;padding-top:.4mm">..</span>
									</span>
								</div>
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">64</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/WithholdingTaxAmt"/>
								...
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
										<span style="font-family:Arial Narrow;font-size:7.5pt;">
										  2016 estimated tax payments and amount applied from 2015 return</span>
										<xsl:call-template name="SetFormLinkInline">
							...
							<!--End Line 65 -->
							<!-- Line 66a -->
							<div style="width:162.5mm;height:4.2mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;border-color:black;border-style:solid;
								  border-width:1px 0px;padding-bottom:4mm">66a</div>
								<div style="width:76mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:4.4mm;padding-top:1mm;width:8mm;">66a</div>
									<div class="styLNAmountBox" style="height:4.4mm;padding-top:1mm;width:32mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/EarnedIncomeCreditAmt"/>
											<xsl:with-param name="BackupName">IRS1040EarnedIncomeCreditAmt</xsl:with-param>
										</xsl:call-template>
									</div>
									<div class="styShadingCell" style="height:4.4mm;width:8mm;padding-top:1.8mm;border-right-width:0px;"/>
									<div class="styLNAmountBox" style="height:4.4mm;border-bottom-width:0px;border-left-width:1px;"/>
								</span>
							</div>
							<!--End Line 66a -->
							<!-- Line 66b -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:4.5mm;padding-top:.8mm;">b</div>
								<div style="width:36.05mm;padding-top:.8mm;padding-left:3mm;float:left;clear:none;">
									<span class="styAgency" style="font-size:8pt;">Nontaxable combat pay election</span>
								</div>
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:4mm">66b</div>
									<div class="styLNAmountBox" style="height:4mm;border-right:0px;">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="styShadingCell" style="height:4mm;width:8.05mm;margin-bottom:0mm;border-top-width:1px"/>
									<div class="styShadingCell" style="height:4mm;border-bottom-width:1px;border-left-width:0px;
									  border-top-width:1px"/>
									<div class="styShadingCell" style="height:4mm;width:8mm;border-left-width:0px;"/>
							...
							<!-- Line 67 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1.2mm;padding-top:1.2mm;">67</div>
								<div style="width:77mm;padding-top:.8mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">67</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AdditionalChildTaxCreditAmt"/>
							...
							<!-- Line 68 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:1.2mm;padding-left:1.2mm;">68</div>
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">68</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/RefundableAmerOppCreditAmt"/>
							...
							<!-- Line 69 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1.2mm;padding-top:1mm">69</div>
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">69</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/ReconciledPremiumTaxCreditAmt"/>
							...
							<!-- Line 70 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1.2mm;padding-top:.8mm">70</div>
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
                                  Amount paid with request for extension to file 
									<span class="styDotLn" style="float:none;clear:none;">....</span>
								</div>
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">70</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 71 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:.6mm;padding-left:1.2mm;">71</div>
								<div style="width:77mm;padding-top:.5mm;padding-left:3mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">71</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 72 -->
							<div style="width:162.5mm;height:4mm">
								<div class="styLNLeftNumBox" style="width:4mm;padding-left:1mm;padding-top:1.2mm">72</div>
								<div style="width:77mm;padding-top:.5mm;padding-left:2.8mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
									...
									<span class="styDotLn" style="padding-left:2mm;float:none;">.</span>
								</div>
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="height:19px;padding-top:1.5mm;">72</div>
									<div class="styLNAmountBox" style="height:19px;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalFuelTaxCreditAmt"/>
							...
							<!-- Line 73 -->
							<div style="width:162.5mm;height:4mm;">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:.7mm;padding-left:1mm;">73</div>
								<div style="width:78.4mm;padding-top:0mm;padding-left:2.8mm;float:left;clear:none;font-size:6.5pt;font-family:Arial-Narrow;">
									<span style="float:left;clear:none;">
										Credits from Form:	
										<span style="width:1px;"/>									
										...
										<label>
											...
											<span class="styFixedUnderline" style="padding-top:0mm;padding-bottom:0mm;
											  float:none;clear:none;width:8mm;"/>
										</label>
									</span>
								</div>
								<span style="float:right;clear:none">
							...
							<!--End Line 73 -->
							<!-- Line 74 -->
							<div style="width:162.5mm;height:4mm;float:left;clear:none">
								<div class="styLNLeftNumBox" style="width:4mm;padding-top:.5mm">74</div>
								<div style="width:117.8mm;padding-top:0mm;padding-left:2.8mm;float:left;clear:none;">
									<span style="float:left;clear:none;">
								...
								<span style="float:right;clear:none">
									<div class="styLNRightNumBox" style="border-bottom-width:0px;padding-top:.5mm">74</div>
									<div class="styLNAmountBox" style="border-bottom-width:0px;padding-top:.5mm">
										<xsl:call-template name="PopulateAmount">
				...
				<!-- end Payments -->
				<!-- Refund -->
				<div style="width:187mm;height:21.2mm;float:left;clear:none;display:block">
					...
					<div style="width:165.5mm;height:4mm;float:left;clear:none;">
						...
						<div style="width:165.5mm;">
							<div class="styLNLeftNumBox" style="padding-left:4.1mm;padding-top:.5mm;">75</div>
							<div style="width:117.3mm;padding-left:2.5mm;float:left;clear:none;padding-top:.5mm">
						...
						<div style="width:165.5mm;height:5mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;padding-top:.9mm">76a</div>
						...
						<div style="width:165.5mm;height:4.2mm;float:left;clear:none">
							...
							<div style="height:4mm;width:77.3mm;padding-left:2.5mm;border-bottom-width:0mm;float:left;clear:none;">
								<span style="float:left;clear:none;padding-top:.3mm">
									<span class="styAgency" style="font-size:7.8pt;">Amount of line 75 you want<b> applied to your 2017 estimated tax</b>
									</span>
									<xsl:call-template name="SetFormLinkInline">
					...
					<!-- page 1 footer -->
					<!--<div style="width:187mm; font-size:6.5pt; border-top:1 solid black;">
						<div style="float:left; font-size:6.5pt;padding-top:4mm">
							<b>For Disclosure Privacy Act and Paperwork Reduction Act Notice, see separate instructions.</b>
						</div>
						<div style="float:right; padding-top:2mm">
						  Cat. No. 11320B
							<span style="width:15mm;padding-top:2mm"/>
							  Form <b style="font-size:9pt">1040</b> (2014)
						</div>
					</div>-->
					<!-- end page 1 footer -->
				</div>
				...
				<!--<div class="pageEnd">-->
					...
					<div class="styBB" style="width:187mm;display:block">
						...
						<!-- Line 78 -->
						<div style="width:162.5mm;">
							<div class="styLNLeftNumBox" style="width:4mm;border-style:solid;border-color:black;border-width:1px 0px 0px 0px;padding-left:1.2mm">78</div>
						...
						<!-- Line 79 -->
						<div style="width:162.5mm;height:4mm">
							<div class="styLNLeftNumBox" style="width:4mm;padding-left:1.2mm;">79</div>
				...
				<!-- 3rd party -->
				<div style="width:187mm;padding-top:.5mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;
				  float:none;clear:both;height:14mm;display:block">
					...
					<div style="height:9mm;float:left;clear:none;width:165mm;padding-top:0mm;">
			...
			<!-- paid preparer -->
			<div class="styBB" style="width:187mm;font-size:6pt;float:none;clear:both;height:100%">
				...
				<div style="width:164mm;float:left;clear:none;display:block">
					<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
						<div class="styFNBox" style="height:8mm;width:44.8mm;padding-top:0mm;border-right:1 solid black;">
						...
						<div class="styFNBox" style="height:8mm;width:65.5mm;padding-top:0mm;border-right:1 solid black;padding-left:1mm;">
							Preparer's signature
						</div>
						<div class="styFNBox" style="height:8mm;width:15mm;border-right:1 solid black;padding-top:0mm;padding-left:1mm;">Date <br/>
							<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
								<xsl:with-param name="TargetNode">DateSigned</xsl:with-param>
								<xsl:with-param name="BackupName">$RtnHdrDataPaidPreparerInformationDateSigned</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styFNBox" style="height:8mm;width:18mm;border-right:1 solid black;padding-top:.5mm;padding-bottom:0mm;
						  padding-left:1mm;">
							<label>
								<xsl:call-template name="PopulateLabel">
					...
					<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
						<div class="styFNBox" style="height:6mm;width:110.49mm;border-right:1 solid black;">
					...
					<div style="width:164mm;float:left;clear:none;">
						<div class="styFNBox" style="width:110.49mm;border-right:1 solid black;height:100%">
				...
				<div class="pageEnd" style="width:187mm;">
					<span style="float:left;">www.irs.gov/form1040</span>
					<span style="float:right;clear:none;">
					   Form <span class="styBoldText" style="font-size:8.5pt;">1040</span> (2016)
				   </span>
				</div>
				<!-- end page 3 footer -->
			<!--</div>-->
...
-->
							...
							<xsl:for-each select="$FormData/AlimonyAmountGrp">
								<tr>
									...
									<td class="styDepTblCell" style="width:91.5mm;float:right;clear:none;text-align:right;height:6.2mm;
									  padding-top:2mm;border-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
				...
				<xsl:if test="(count($FormData/Form8854DeferredAmountGrp) &gt; 1)">
					<span class="styRepeatingDataTitle">Form 1040 Line 63 - Total Tax Deferred Amount</span>
					<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
						<thead class="styTableThead">
							<tr class="styDepTblHdr">
				...
				<xsl:if test="(count($FormData/CreditRepaymentGrp) &gt; 1)">
					<span class="styRepeatingDataTitle">Form 1040 Line 73d - Credit For Repayment Amount</span>
					<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
						<thead class="styTableThead">
							<tr class="styDepTblHdr">
								<th class="styDepTblCell" scope="col" rowspan="2" style="width:93.5mm;border-bottom:0mm">

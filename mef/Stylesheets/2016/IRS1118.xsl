						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:17mm;font-size:5pt;border-top:1px solid black;" rowspan="2" scope="col">1b. <span class="styNormalText" style="display:inline;">EIN (if any) of sixth-tier foreign corporation</span>
									</th>

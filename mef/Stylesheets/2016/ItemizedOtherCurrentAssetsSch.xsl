...
<xsl:strip-space elements="*"/>
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/ItemizedOtherCurrentAssetsSch"/>
                            <!--Common-Itemized Other Current Assets Schedule-->   
    ...
    <table id="ItemizedOtherCurrentAssetsTbl" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" style="width:35mm;">Corporation Name</th>
          <th class="styDepTblCell" style="width:20mm;">Corporation EIN</th>
          <th class="styDepTblCell" style="width:60mm;">Other Current Assets Description</th>
          <th class="styDepTblCell" style="width: 30mm;">Beginning Amount</th>
          <th class="styDepTblCell" style="width: 30mm;">Ending Amount</th>
        </tr>
       </thead>
        <tfoot/>
        <tbody>
          ...
          <tr>
            ...
            <td class="styDepTblCell" scope="col" style="text-align:left;font-size: 7pt;width:35mm;">
              <xsl:attribute name="rowspan">
                <xsl:value-of select="count(OtherCurrentAssetLineItemGrp)"/>
              </xsl:attribute>
            ...
            <xsl:for-each select="OtherCurrentAssetLineItemGrp">

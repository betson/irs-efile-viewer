...
<!-- Created by Doug peterson 6-15-2006--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/OrdnryIncmLossOthPrtshpEtcStmt"/>
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        ...
        <div class="styDepTitleLine">
          <span class="styDepTitle" style="width:161mm">          
            <xsl:value-of select="$depDocTitle"/>  
          </span>
        </div>
    ...
    <table id="AOVSSTbl" class="styDepTbl">
      <thead class="styTableThead">
        ...
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" scope="col">Source Type</th>
          <th class="styDepTblCell" scope="col">Partnership's, estate's, or trust's name</th>
      ...
      <tfoot/>
      <tbody>    
        <xsl:for-each select="$AOVSSData/OrdnryIncmLossOthPrtshpEtc">  
          <tr>
            ...
            <!-- First Column -->
            <td class="styDepTblCell" style="text-align:left;width:20%;">
            ...
            <!--Second Column -->
            <td class="styDepTblCell" style="text-align:left;width:30%;">
            <xsl:call-template name="PopulateText">
			...
			<!-- Third Column -->
            <td class="styDepTblCell" style="text-align:left;font-size:6pt;width:20%" valign="top">
            ...
            <!-- Fourth Column -->
            <td class="styDepTblCell" style="text-align:center;width:12%">
              <xsl:call-template name="PopulateEIN">
                <xsl:with-param name="TargetNode" select="EIN"/>
              </xsl:call-template>
            </td>
            <!-- Fifth Column -->
            <td class="styDepTblCell" style="text-align:right;width:18%">

		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="FormSSA1042S">
					...
					<div class="styStdDiv" style="font-weight:bold;text-align:center;font-size:10pt;padding-top:2mm;padding-bottom:1mm;">
					...
					<div class="styStdDiv" style="border:1px solid black;padding-left:0.5mm;">
						<div style="font-size:20pt;font-weight:bold;width:22mm;float:left;">2016</div>
					...
					<div class="styStdDiv" style="border-style:solid;border-color:black;border-width:0px 1px 1px 1px;">
						<div style="width:62mm;float:left;border-right:1px solid black;padding-left:0.5mm;height:9mm;">
							Box 3. Benefits Paid in 2016<br />
						...
						<div style="width:62mm;float:left;border-right:1px solid black;padding-left:0.5mm;height:9mm;">
							Box 4. Benefits Repaid to SSA in 2016<br />
							<span style="float:right;padding-right:0.5mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:62.4mm;float:left;padding-left:0.5mm;border:1px solid black;height:9mm;">
							Box 5. Net Benefits for 2016 <span style="font-style:italic;font-size:6pt;">(Box 3 minus Box 4)</span><br />
							<span style="float:right;padding-right:0.5mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDiv">
						...
						<div style="width:93mm;border-left:1px solid black;float:left;">
							...
							<!-- Box 9 -->
							<div class="stySSA1042SBoxCell">
								Box 9. Net tax withheld during 2016 <span style="font-style:italic;display:inline;">(Box 7 minus Box 8)</span> <br />
								<span style="float:right;">
									<xsl:call-template name="PopulateAmount">
						...
						<div style="width:94mm;border-left:1px solid black;border-right:1px solid black;float:left;">
							...
							<div style="width:100%;height:60mm;padding:1mm;border-bottom:1px sold black;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SocSecBnftRepaidSSADesc"/>
								</xsl:call-template>
							</div>
							<!-- Box 10 -->
							<div class="stySSA1042SBoxCell" style="height:21mm;">
								Box 10. Address <br />
								<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<!-- Box 11 -->
							<div class="stySSA1042SBoxCell" style="height:14mm;">
					...
					<!-- End page and form -->
					<div class="styStdDiv" style="border-top:2px solid black;"> <!-- Removed class pageEnd -->
						Form <strong>SSA-1042S-SM </strong> (1-2015)
					</div>

            ...
            Your social security number<br/>
			 ...
			 <div class="styBB" style="width:187mm;height:auto;">
	             ...
	             <div  style="width:187mm;height:auto;">
						<!-- Part I Left margin -->
							<div style="width:25mm;height:60mm;border-bottom-width: 0px;">
								<div class="styFMT" style="font-size:12pt;height:14mm;font-family:Arial;">Part l 
									<br/>Interest
                                </div>
								...
								<div id="part1ContainerId" class="stySchBLn1TblContainer" style="width:161.5mm;float:right;">
									...
									<table class="styTable" cellspacing="0" style="font-size:7pt;" summary="Table displaying Interest and Ordinary Dividends " name="INORDtable" id="INORDtable">
										...
										<tr  style="width:161.5mm;float:right;">					
											...
											<th class="styTableCell" scope="col" rowspan="2" style="width:114mm;border-bottom-width:0px;text-align:left;padding-left:1mm;">
                        ...
                        List name of payer. If any interest is from a seller-financed mortgage and the
                          ...
                          interest first. Also, show that buyer&apos;s social security number and address 
											...
											<th class="styTableCell" scope="col" rowspan="1" style="height:4mm;width:31mm;border-right:0px solid black;
											  border-left:1px solid black;border-bottom:1px solid black;vertical-align:bottom;text-align:center;">
                               ...
                               ,								<span style="width:1mm;">
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup1) &lt; 1 or ((count($FormData/Form1040SchBPartIGroup1) &gt; 14) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;none;text-align:left;border-bottom:1px dashed black;">
													...
													<td class="styTableCell" style="width:31mm;height:4mm;border-right-width:0px;border-bottom:1px solid black;border-left:1px solid black;">
														<span class="styTableCellPad"> 
													    </span>
													</td>
												</tr>
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup1) &lt; 2 or ((count($FormData/Form1040SchBPartIGroup1) &gt; 14) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
														</span>
													</td>
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup1) &lt; 4 or ((count($FormData/Form1040SchBPartIGroup1) &gt; 14) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;border-right-width:1px;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
													    </span>
													</td>
													<td class="styTableCell" style="width:6.8mm;height:4mm;border-right-width:1px;border-bottom-width:0px;
...
<!--								<xsl:call-template name="SetInitialDynamicTableHeight">
                  ...
                  Payer
											...
											<th class="styTableCellHeader" scope="col" rowspan="1" style="text-align:center;width:31mm;height:8mm;border-left-width:1px;
											  border-right-width:0px;border-bottom:1px solid black;vertical-align:bottom;border-left:1px solid black;">
										...
										<tbody>
											<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartIGroup2) &lt;= 14) ">
												<xsl:for-each select="$FormData/Form1040SchBPartIGroup2">
													<tr style="width:161.5mm;float:right;">
														...
														<td class="styTableCell" style="width:114mm;text-align:left;border-bottom:1px dashed black;">
															<xsl:call-template name="PopulateText">
														...
														<td class="styTableCell" style="width:31mm;border-right-width:0px;vertical-align:bottom;border-bottom:1px solid black;border-left:1px solid black;">
															<xsl:call-template name="PopulateAmount">
											...
											<xsl:if test="count($FormData/Form1040SchBPartIGroup2) &lt; 1 or ((count($FormData/Form1040SchBPartIGroup2) &gt; 14) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;text-align:left;border-bottom:1px dashed black;">
														<xsl:call-template name="PopulateAdditionalDataTableMessage">
															<xsl:with-param name="TargetNode" select="$FormData/Form1040SchBPartIGroup2"/>
														</xsl:call-template>
														<span class="styTableCellPad">
	...
	<!--							<xsl:call-template name="SetInitialDynamicTableHeight">
						...
						<div class="styLNDesc" style="width:25.5mm;"/>
							...
							<div class="styLNDesc" style="width:114mm;padding-left:1mm;border-right:1px solid black;">
							...
							<div class="styLNAmountBox" style="width:31mm;padding-right:0mm;border-top-width:1px;border-bottom-width: 1px;
							  border-top-width:0px;border-left:1px solid black;">
								<xsl:call-template name="PopulateAmount">
						...
						<div class="styLNDesc" style="width:25.5mm;"/>
							...
							<div class="styLNDesc" style="width:114mm;height:8mm;border-right:1px solid black;padding-left:1mm;float:left;clear:none;">
							...
							<div class="styLNAmountBox" style="height:8mm;width:31mm;padding-top:4.8mm;border-left:1px solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/ExcludableSavingsBondIntAmt"/>
					...
					<!-- Line 4 -->
					    <div class="styBB" style="width:187mm;hight:auto;border-bottom-width: 0px;">
						<div class="styLNDesc" style="width:25.5mm;"/>
						<div class="styLNLeftNumBoxBB" style="width:4mm;height:8mm;border-bottom-width:0px;text-align:left;">4</div>
						<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:114mm;padding-left:1mm;border-bottom-width:0px;height:8mm;border-right:1px solid black;">
						...
						<div class="styLNRightNumBox" style="border-bottom-width:0px;width:6.8mm;height:8mm;padding-top:4mm;
						  border-right:1px solid black;">
                                  4
					    </div>
						<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;height:8mm;padding-top:4mm;border-left:1px solid black;">
							<xsl:call-template name="PopulateAmount">
					...
					<!-- Line 4 note -->
									<div class="styBB" style="width:181.5mm;hight:auto;border-bottom-width: 1px;">
						            <div class="styLNDesc" style="width:25.5mm;"/>
									<div class="styLNLeftNumBoxBB" style="width:4mm;border-bottom-width:0px;text-align:left;"></div>
										<div class="styLNDesc" style="border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; 
										  border-left-width: 0px; border-right-width: 1px;width:114mm;">
												<span class="styBoldText">Note:</span> If line 4 is over $1,500, you must complete Part III.
										</div>
										<div class="styLNRightNumBox" style="border-left-width:1px;border-bottom-width:0px;width:6.8mm;border-top-width:1px;border-right-width:1px;">
										</div>
										<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;border-top-width:1px;border-left:1px solid black;text-align:center;">
                  ...
                  on that form.
									...
									<table class="styTable" cellspacing="0" width="100%" style="font-size:7pt;padding-top:mm;" summary="Table displaying Ordinary Dividends" name="ODtable" id="ODtable">
										<thead class="styTableThead">
                                          ...
                                          <tr style="width:161.5mm;float:right;">
												...
												<th class="styTableCellHeader" scope="col" rowspan="1" style="width:114mm;border-right-width:1px;text-align:left;border-bottom-width:0px;">
                        ...
                        List name of payer
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														...
														<xsl:with-param name="TargetNode" select="$FormData/RestrictedStockAmt/@restrictedStockDivLiteralCd"/>
													</xsl:call-template>
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">Part II, Line 5 - Restricted Stock Dividend Amount</xsl:with-param>
														<xsl:with-param name="TargetNode" select="$FormData/RestrictedStockAmt"/>
													</xsl:call-template>
													<xsl:call-template name="LinkToLeftoverDataTableInline">
												...
												<th class="styTableCellHeader" scope="col" rowspan="1" style="width:31mm;border-bottom-width:0px;border-right-width:0px;border-top-width:0px;border-left:1px solid black;">
										...
										<tbody>
											<xsl:if test="($Print != $Separated) or (count($FormData/Form1040SchBPartII) &lt;= 19) ">
												<xsl:for-each select="$FormData/Form1040SchBPartII">
                                                      ...
                                                      <tr style="width:161.5mm;float:right;">
														...
														<!-- Column 2 -->
														<td class="styTableCellText" style="width:114mm;height:4mm;font-size:7pt;border-right-width:1px;text-align:left;border-bottom:1px dashed black;">
														...
														<!-- Column 4 -->
														<td class="styTableCell" style="width:31mm;height:4mm;border-right-width:0px;vertical-align:bottom;border-bottom:1px solid black;border-left:1px solid black;">
															<xsl:call-template name="PopulateAmount">
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 1 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
                                                  ...
                                                  <tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;border-right-width:1px;text-align:left;border-bottom-width:1px;border-bottom:1px dashed black;">
														<xsl:call-template name="PopulateAdditionalDataTableMessage">
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 3 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom-width:1px;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													...
													<td class="styTableCell" style="width:31mm;height:4mm;float:left;clear:none;border-right-width:0px;border-bottom:1px solid black;border-left:1px solid black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
												</tr>
											...
											<xsl:if test="count($FormData/Form1040SchBPartII) &lt; 4 or ((count($FormData/Form1040SchBPartII) &gt; 18) and ($Print = $Separated))">
												<tr style="width:161.5mm;float:right;">
													...
													<td class="styTableCell" style="width:114mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom:1px dashed black;">
														<span class="styTableCellPad"> 
                          </span>
													</td>
													<td class="styTableCell" style="width:6.8mm;height:4mm;float:left;clear:none;border-right-width:1px;border-bottom-width:0px;border-left:1px solid black;border-right:1px solid black;">
...
<!--								--><!-- Set Initial Height of Above Table --><!--
						        ...
						        <div class="styLNDesc" style="width:25.5mm;"/>
								<div class="styLNLeftNumBoxBB" style="width:4mm;height:8mm;border-bottom-width:0px;text-align:left;">6</div>
								<div class="styLNLeftNumBoxBB" style="font-weight:normal;width:114mm;padding-left:1mm;border-bottom-width:0px;height:8mm;border-right:1px solid black;">
									...
									<div class="styLNRightNumBox" style="padding-top:3.2mm;border-bottom-width:0px;width:6.8mm;height:8mm;border-top-width:0px;border-left:1px solid black;border-right:1px solid black;">
									  6
									</div>
									<div class="styLNAmountBox" style="border-bottom-width:0px;width:31mm;height:8mm;padding-top:4.2mm;border-left:1px solid black;
">
										<xsl:call-template name="PopulateAmount">
									...
									<!-- end line 6 -->
									<!-- Line 6 note -->
									<div class="styBB" style="width:181.5mm;border-bottom-width: 1px;">
						             <div class="styLNDesc" style="width:25.5mm;"/>
										<div class="styLNDesc" style="border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; 
					 ...
					 <div  style="width:187mm;">
							...
							<div style="width:25.5mm;float:left;">
								<div class="styFMT" style="padding-top:7mm;font-size:12pt;font-family:Arial">
                Part lll<br/>
                Foreign<br/>
                Accounts<br/>
                and Trusts
                </div>
								<div style="padding-top:1mm;width:25.5mm;">(See<br/> instructions on <br/>back)
                </div>
							</div>
							<!-- end left margin -->
							<!--Yes and No heading-->
                ...
                You must complete this part if you <span class="styBoldText"> (a) </span> had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
					...
					<div style="width:187mm; border-top:1 solid black;border-top-width:1px;">
						...
						<div style="float:right;" class="styGenericDiv">
							<b>Schedule B (Form 1040A or 1040) 2016</b>
						</div>
					</div>
					<!-- end page 2 footer -->
					<br/>
					...
					<table class="styLeftOverTbl">
						...
						<tr style="width:161.5mm">
								...
								<xsl:call-template name="PopulateLeftoverRow">
									<xsl:with-param name="Desc">Part II, Line 5 - Restricted Stock Dividend Literal</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$FormData/RestrictedStockAmt/@restrictedStockDivLiteralCd"/>
									<xsl:with-param name="BackupName">$FormData/RestrictedStockAmt@restrictedStockDivLiteralCd</xsl:with-param>
								</xsl:call-template>
								<xsl:call-template name="PopulateLeftoverRow">
									<xsl:with-param name="Desc">Part II, Line 5 - Restricted Stock Dividend Amount</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$FormData/RestrictedStockAmt"/>
									<xsl:with-param name="BackupName">$FormData/RestrictedStockAmt/</xsl:with-param>
								</xsl:call-template>
								<xsl:call-template name="PopulateLeftoverRow">
									<xsl:with-param name="Desc">Part II, Line 5 -  Nominee Dividend Literal</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$FormData/NomineeInterestAmt/@nomineeInterestLiteralCd"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="Line1Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Number of agricultural employees employed in the pay period that includes March 12, 2016</xsl:when>
			<xsl:otherwise>Número de empleados agrícolas durante el período de nómina que incluye el 12 de marzo de 2016</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line12Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2016, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2016, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="AllFilersText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;b&gt;All filers:&lt;/b&gt; If line 11 is less than $2,500, &lt;b&gt;don't&lt;/b&gt; complete line 17 or Form 943-A.
			</xsl:when>
			<xsl:otherwise>&lt;b&gt;Todos los contribuyentes:&lt;/b&gt; Si la l&amp;#237;nea &lt;b&gt;11&lt;/b&gt; es menos de $2,500, &lt;b&gt;no lo&lt;/b&gt; complete la l&amp;#237;nea &lt;b&gt;17 &lt;/b&gt;ni el Formulario 943A-PR.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="CatNoText">
		<xsl:choose>
			...
			<xsl:otherwise>Cat. No. 11252K</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
		...
		<html lang="{$HtmlLang}">
			...
			<body class="styBodyClass">
				<form name="Form943">
					...
					<!-- BEGIN LINE 13b -->
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						<div class="styLNLeftNumBox" style="padding-left:4.7mm;">b</div>
						<div class="styLNDesc" style="width:102.8mm;">

        ...
        <form name="Form6627">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:21mm;padding-top:2mm;">
              ...
              <br/>      
              <span class="styAgency" style="font-weight:normal;">(Rev. January 2016)</span><br/> 
          ...
          <!--Part II Table-->
          <div class="styTableContainer" style="height:auto;width:187mm;border-bottom-width:0px;" id="PSOctn">
          ...
          <div  style="width:187mm;border-bottom:1px black solid;">
            <span style="width:140mm;font-weight:normal;text-align:left;font-size:7pt;display:inline;"> 
              Form 6627 (Rev. 1-2016)<span style="width:140mm;"/>
            </span>
            ...
            <table class="styTable" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;">
              <tbody>
                ...
                <tr>
                  <td class="styTableCellText" colspan="5" style="width:159mm;font-size:7pt;border-color:black;border-bottom-width:0">
                    <xsl:choose>
                      <xsl:when test="($Print != $Separated) and (count($FormData/ODCTaxOnImportedProductsGrp) &gt; 3)">
                        <div style="width:4mm;font-size:7pt;text-align:center;font-weight:bold;padding-bottom:2mm;padding:left:1mm;float:left;clear:none;display:inline;">
                          <xsl:value-of select="(count($FormData/ODCTaxOnImportedProductsGrp) + 1)"></xsl:value-of>
                        </div>
                      </xsl:when>
                      <xsl:otherwise>
                        <div style="width:4mm;font-size:7pt;text-align:center;font-weight:bold;padding-bottom:2mm;padding:left:1mm;float:left;clear:none;display:inline;">4</div>
                      </xsl:otherwise>
                    </xsl:choose>
                    <div style="width:155mm;float:left;clear:none;display:inline;">
                  ...
                  <td class="styTableCell" style="height:8mm;width:28mm;border-color:black;border-right-width:0;border-bottom-width:0;padding-right:1mm;padding-top:3.5mm;">
                    <div style="width:2mm;float:left;clear:none;font-size:7pt;display:inline;">$</div>
                    <div style="width:26mm;font-size:7pt;padding-left:1mm;padding-right:0.3mm;display:inline;">
                      <xsl:choose>
          ...
          <!--Part IV Header-->
          <div class="styBB" style="width:187mm;border-top:1px black;border-bottom-width:0px;height:8mm;">
            <div class="styLNDesc" style="width:187mm;height:8mm;font-size:8pt;font-weight:bold;padding-top:1mm;">
              ...
              <span style="width:155mm ;font-size:8pt;float:inherit;display:inline;"><span style="width:4mm;"/>Tax on Floor Stocks of  ODCs, IRS No. 20</span>

...
<span style="width:2px;"/>
 ...
 <span style="width:2px;"/>
   ...
   2016 special estimated tax payments<i> (Do not include on line 29f)</i>
							</div>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:56mm;font-size:8pt;">
								<span style="float: left; clear: none;">Less 2016 refund applied for on 
    Form 4466</span>
							</div>
...
<input class="styCkbox" alt="Return Header May IRS Discuss Return With Prep Yes" type="checkbox" name="Checkbox" id="dummyidyes" style="width:3mm;">
 ...
 Form <span class="styBoldText" style="font-size:8pt;">1120-L</span> (2016)
</div>
					</div>
					<!--div class="pageEnd" /-->
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;float:none;">
						<div style="float:left;">Form 1120-L (2016)<span style="width:148mm;"/>
						</div>
...
<label>
												<xsl:call-template name="PopulateLabel">
													...
													<xsl:with-param name="BackupName">IRS1120LScheduleM OLD Forego Carryback</xsl:with-param>
												</xsl:call-template>
												<!-- Form to Form Link   -->
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="$IRS1120LScheduleM/OLDForegoCarrybackInd"/>
											...
											<span style="width:2px;"/>
											<input type="checkbox" alt="ScheduleM OLD Forego Carryback" class="styCkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$IRS1120LScheduleM/OLDForegoCarrybackInd"/>

			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleM3">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpFiledSECForm10K" class="styCkbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpPrepCertAuditedIncomeStmt" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpPrepIncomeStatement" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorporationPreparedIncmStmtInd"/>
										<xsl:with-param name="BackupName">IRS1120SchM3CorpPrepIncomeStatement</xsl:with-param>
									</xsl:call-template>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120FSchSCorpIncomeStatementRestated" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorporationIncmStmtRestatedInd"/>
										<xsl:with-param name="BackupName">IRS1120FSchSCorpIncomeStatementRestated</xsl:with-param>
									</xsl:call-template>
					...
					<div style="width:187mm;padding-bottom:1mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpIncomeStatementRestated" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorporationIncmStmtRestatedInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpIncmStmtRestated5Preceding" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="IRS1120SchM3CorpVotingCommonStockPubTraded" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleM3/CorporationVtngComStkPubTrdInd"/>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;height:auto;">
								<div class="styGenericDiv">
									...
									<input type="checkbox" alt="IRS1120SchM3GAAP" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styGenericDiv">
									...
									<input type="checkbox" alt="IRS1120SchM3IFRS" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styGenericDiv">
									...
									<input type="checkbox" alt="IRS1120SchM3Statutory" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styGenericDiv">
									...
									<input type="checkbox" alt="IRS1120SchM3TaxBasis" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styGenericDiv">
									...
									<input type="checkbox" alt="IRS1120SchM3Other" class="styCkbox">								
										<xsl:call-template name="PopulateCheckbox">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;clear:all;">
						<div style="float:left;">
							...
							<span style="width:7mm;"/>
							  Cat. No. 37961C 						
							<span class="styBoldText" style="float:right;padding-left:11mm;">Schedule M-3 (Form 1120) 2016</span>
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;clear:all;">
						<div style="float:left;">Schedule M-3 (Form 1120) 2016</div>
					...
					<div style="width:187mm;font-size:6pt;clear:all;">
						...
						<div class="styGenericDiv" style="padding-left:1px;;">
							...
							<input type="checkbox" alt="IRS1120SchM3Mixed1120LPCGroup2" class="styCkbox" >
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(6)</div>
							<input type="checkbox" alt="IRS1120SchM3Is1120Group2" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:1px;;">
						   <div class="styGenericDiv" style="font-weight:bold;padding-left:.5mm;padding-right:.5mm;">(7)</div>
							<input type="checkbox" alt="IRS1120SchM3Is1120Eliminations2" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="pageEnd" style="width:187mm;clear:all;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120) 2016</div>
					</div>
					</div>
					<p style="page-break-before: always"/>
					<!-- Page 3 -->

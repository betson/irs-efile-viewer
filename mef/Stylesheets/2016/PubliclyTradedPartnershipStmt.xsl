...
<!-- This form by Doug Peterson 6-20-2006 --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <body class="styBodyClass">
       ...
       <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/PubliclyTradedPartnershipTxAmt"/>
            </xsl:call-template>
          </div>
        </div>
        <br/>      
       ...
       <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/OverpaymentAmt"/>
            </xsl:call-template>
          </div>
        </div>
        <br/>  
       ...
       <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/BalanceDueAmt"/>
            </xsl:call-template>
          </div>
        </div>
        <br/> 
       ...
       <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$DependencyData/ZeroLiabilityAmt"/>
            </xsl:call-template>
          </div>
        </div>
        <br/>  
       ...
       <div style="float:left;clear:none;width:118mm;">
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/DataStreamForComputationTxt"/>
            </xsl:call-template>
          </div>
        </div>
        <br/> 

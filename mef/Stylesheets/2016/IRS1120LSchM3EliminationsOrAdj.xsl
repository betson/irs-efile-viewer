			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120LSchM3EliminationsOrAdj">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:125mm;height:19.5mm;">
							...
							<div class="styFST" style="height:5mm;">
								...
								Information about Schedule M-3 (Form 1120-L) and its separate instructions is at
								<br/>
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" alt="Dormant subsidiaries schedule" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:120mm;">
								<div class="styLNAmountBox" style="width:50mm;text-align:center;borde-left-width:1px;border-top-width:1px;font-size:7.5pt;">
									<b>Total Assets</b>
								</div>
								<div class="styLNAmountBox" style="width:50mm;text-align:center;borde-left-width:1px;border-top-width:1px;border-right-width:1px;font-size:7.5pt;">

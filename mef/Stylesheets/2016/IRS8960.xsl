			...
			<body class="styBodyClass" style="width:187mm;">
				<form id="IRS8960">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:126.6mm;">
							...
							<div class="styFBT">
								...
								<br/>
								<img alt="Bullet" src="{$ImagePath}/8867_Bullet.gif" height="9" width="9"/>
								Information about Form 8960 and its separate instructions is at <a href="http://www.irs.gov/form8960" title="Link to IRS.gov"><i>www.irs.gov/form8960.</i></a>
							</div>
						</div>
					...
					<div class="pageEnd" style="width:187mm;float:none;clear:both;">
						...
						<span style="float:right;clear:none;">Form <span style="font-weight:bold;font-size:9pt;">8960</span> (2016)</span>
					</div>

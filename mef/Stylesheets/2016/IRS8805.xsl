				...
				<form id="Form8805">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;">
						<div class="styFNBox" style="width:27.0mm;height:20mm;">
							Form <span class="styFN" style="display:inline;">8805</span> <br />
							<xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData"/></xsl:call-template> <br />
						...
						<div class="styFTBox" style="width:124mm;height:20mm;">
							<span class="styFST" style="font-size:12pt;">Foreign Partner's Information Statement <br />of Section 1446 Withholding Tax</span><br />
							<span class="styFBT">&#9658; Information about Form 8805 and its instructions is at <em>www.irs.gov/form8805</em>.</span><br/>
							<span style="margin-top:1mm;">
								For partnership's calendar year 2016, or tax year beginning 
								<span style="min-width:12mm;"><xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$FormData/TaxPeriodBeginDt"/></xsl:call-template></span>
								and ending 
								<span style="min-width:12mm;"><xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$FormData/TaxPeriodEndDt"/></xsl:call-template></span>
							</span>
						</div>
						<div class="styTYBox" style="width:35mm;height:20mm;">
							<div class="styOMB">OMB No. 1545-0123</div>
							<div class="styBB styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">16</span></div>
							<div class="styAgency" style="text-align:center;"><strong>Copy C </strong> for partner <br/>Attach to your Federal tax return.</div>
						</div>
					</div>
					<!-- Begin Form -->
					<div class="styStdDiv">
						...
						<div style="width:93.5mm;float:left;border-left:1px solid black;">
								...
								<div style="width:85mm;">
									...
									<xsl:choose>
										<xsl:when test="$FormData/Section1446WithholdingAgentGrp">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/Section1446WithholdingAgentGrp/BusinessNm/BusinessNameLine1Txt"/>
											</xsl:call-template><br />
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$FormData/Section1446WithholdingAgentGrp/BusinessNm/BusinessNameLine2Txt"/>
											</xsl:call-template>
										</xsl:when>
										<xsl:otherwise>
											<xsl:call-template name="PopulateText">
							...
							<div style="width:100%;border-top:1px solid black;">
								...
								<div style="width:85mm;">
									Withholding agent's U.S. employer identification number<br />
									<xsl:choose>
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="width:140mm;height:7.2mm;">
							Total tax credit allowed to partner under section 1446 (see instructions). <strong>Individual and coporate partners:</strong><br />
							Claim this amount as a credit against your U.S. income tax on Form 1040NR, 1120-F, etc.
							<span style="letter-spacing:3.3mm;font-weight:bold;padding-right:4px;float:right;">.....</span>
						</div>
						<div class="styLNRightNumBox" style="height:7.2mm;border-bottom:none;"><br />10</div>
						<div class="styLNAmountBox" style="width:30mm;height:7.2mm;border-bottom:none;"><br />
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:93.5mm;height:21.5mm;float:left;">
						...
						<div class="styGenericDiv" style="width:100%;">
							...
							<span style="width:85mm;">
								...
								<xsl:choose>
									<xsl:when test="$FormData/BeneficiaryInformationGrp/BeneficiaryBusinessNm">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/BeneficiaryInformationGrp/BeneficiaryBusinessNm/BusinessNameLine1Txt"/>
										</xsl:call-template><br />
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/BeneficiaryInformationGrp/BeneficiaryBusinessNm/BusinessNameLine2Txt"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
					...
					<div class="styStdDiv" style="border-top:2px solid black;margin-bottom:2mm;">
						<div style="float:right;">
							Form <span style="font-weight:bold;font-size:8pt;">8805</span> (2016)
						</div>
					</div>

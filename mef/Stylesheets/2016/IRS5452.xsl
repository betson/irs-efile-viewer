  ...
  <body class="styBodyClass">          
    <form style="font-family:arial; font-size:8pt" name="Form5452">      
        ...
        <div class="styFTBox" style="width:126mm">
            <div class="styMainTitle" style="height:8mm;">
             ...
             <div class="styFST" style="font-size:8pt;font-weight:bold;padding-top:2mm;">
              ...
              <br/>         
							<img src="{$ImagePath}/5452_Bullet.gif" alt="bullet image"/>
							Information about Form 5452 and its instructions is at   
         ...
         <table cellspacing="0" style="width:187mm;font-size:7pt;" cellpadding="0">
           <thead style="text-align:center;">
              <tr style="width:187mm;">
                ...
                <td rowspan="2" colspan="2" class="styIRS5452TabCell" style="width:27mm;height:16mm;">Total Amount Paid<br/>(Common (C),<br/>Preferred (P),<br/>Other(O))</td>
                <td rowspan="2" class="styIRS5452TabCellThick" style="width:24mm;height:16mm;">Amount<br/>Per<br/> Share</td>
                <td colspan="3" class="styIRS5452TabCell" style="width:72mm;">Amount Paid During Calendar Year From Earnings &amp; Profits<br/>Since February 28, 1913</td>
                <td rowspan="2" class="styIRS5452TabCellThick" style="width:13mm;height:16mm;">Percent<br/>Taxable</td>
                <td rowspan="2" class="styIRS5452TabCell" style="width:24mm;height:16mm;">Amount Paid During<br/>Calendar Year From<br/>Other Than Earnings<br/>&amp; Profits Since<br/>February 28, 1913</td>
      ...
      <span class="styBoldText" style="font-size:8pt;">For Paperwork Reduction Act Notice, see the instructions.</span> 
        ...
        Form <span class="styBoldText">5452</span>(Rev. 10-2016)

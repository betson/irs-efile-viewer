				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						<div class="styFNBox" style="width:28mm;height:23mm;">
							Form <span class="styFN" style="display:inline;">8843</span> <br />
							<xsl:call-template name="SetFormLinkInline"><xsl:with-param name="TargetNode" select="$FormData"/></xsl:call-template> <br /><br/><br/>
						...
						<div class="styFTBox" style="width:131mm;height:23mm;">
							<span class="styFST" style="font-size:10pt;">Statement for Exempt Individuals and Individuals <br /> With a Medical Condition</span><br />
							<span class="styFBT" style="margin-top:0px;margin-bottom:2mm;">
								For use by alien individuals only. <br />
								&#9658; Information about Form 8843 and its instructions is at <em>www.irs.gov/form8843</em>.
							</span><br/>
							<span>
								For the year January 1 &#8212; December 31, 2016, or other tax year<br />beginning 
								<span style="min-width:22mm;"><xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$FormData/TaxPeriodBeginDt"/></xsl:call-template></span>
								and ending 
								<span style="min-width:22mm;"><xsl:call-template name="PopulateMonthDayYear"><xsl:with-param name="TargetNode" select="$FormData/TaxPeriodEndDt"/></xsl:call-template></span>
							</span>
						</div>
						<div class="styTYBox" style="width:28mm;height:23mm;">
							<div class="styOMB">OMB No. 1545-0074</div>
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">16</span></div>
							<div style="width:100%;"><span class="stySequence" style="padding-left:1.5mm;">Attachment<br/>Sequence No.</span><span style="font-weight:bold;font-size:8pt;padding-left:2px;">102</span></div>
						</div>
					</div>
					<!-- Begin Form -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:90.5mm;float:left;">
								Current nonimmigrant status and date of change (see instructions) &#9658; 
							</span>
							<span style="width:88mm;border-bottom:1px dashed black;float:left;">
								<xsl:call-template name="PopulateText">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:75.5mm;">Of what country were you a citizen during the tax year?</span>
							<span style="border-bottom:1px dashed black;width:103mm;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm">
							<span style="width:50.5mm;">What country issued you a passport?</span>
							<span style="border-bottom:1px dashed black;width:128mm;">
								<xsl:choose>
					...
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD" style="padding-left:4.2mm;">b</div>
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:42.5mm;">Enter your passport number &#9658; </span>
							<span style="width:136mm;border-bottom:1px dashed black;">
								<xsl:choose>
									<xsl:when test="count($FormData/ExmptIndivOrMedicalGenInfoGrp/PassportIssuedGrp) &lt; 2">
										<xsl:call-template name="PopulateText">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:138.5mm;float:left;">
								Enter the number of days in 2016 you claim you can exclude for purposes of the substantial presence test &#9658; 
							</span>
					...
					<xsl:for-each select="$FormData/TeacherOrTraineeExemptIndivGrp">
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="width:20mm;height:3mm;border-bottom:1px dashed black;"></span><br />
					...
					<xsl:if test="count($FormData/TeacherOrTraineeExemptIndivGrp) = 0">
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="border-bottom:1px solid black;width:25mm;margin-right:4.5mm;text-align:center;">&#8194;</span>
								2015
								<span style="border-bottom:1px solid black;width:25mm;margin-right:4.5mm;text-align:center;">&#8194;</span><br />
								If the type of visa you held during any of these years changed, attach a statement showing the new visa type and the date it was acquired.
							</div>
						</div>
					</xsl:if>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							calendar years (2010 through 2015)? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........................</span>
					...
					<xsl:for-each select="$FormData/StudentExemptIndivGrp">
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								Enter the name, address, and telephone number of the director of the academic or other specialized program <br />
								<span style="width:48.5mm;float:left;">
									you participated in during 2016 &#9658; 
								</span>
								<span style="width:130mm;border-bottom:1px dashed black;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							During 2016, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status <br />
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						<div style="float:left;font-weight:bold;padding-top:1px;">For Paperwork Reduction Act Notice, see page 4.</div>
						<div style="float:right;">
							Cat. No. 17227H
							<span style="width:36mm;"/>
							Form <span style="font-weight:bold;font-size:8pt;">8843</span> (2016)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Enter the name of the charitable sports event(s) in the United States in which you competed during 2016 and the dates of <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							<span style="min-height:3mm;width:44mm;border-bottom:1px dashed black;float:left;">
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/MedicalConditionDesc"/>
								</xsl:call-template>
							</span><br />
							<span style="width:100%;border-bottom:1px dashed black;">
								<xsl:call-template name="PopulateText">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							<span style="width:40mm;border-bottom:1px dashed black;float:left;text-align:center;">
								<xsl:call-template name="PopulateMonthDayYear">
									<xsl:with-param name="TargetNode" select="$FormData/IntendedUSDepartureDt"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
					...
					<div class="styStdDiv" style="margin-top:3mm;margin-bottom:3mm;">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							<span style="width:40mm;border-bottom:1px dashed black;float:left;text-align:center;">
								<xsl:call-template name="PopulateMonthDayYear">
									<xsl:with-param name="TargetNode" select="$FormData/DepartedUSDt"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<strong>Physician's Statement:</strong><br /><br />
							I certify that <span style="width:162mm;height:3mm;border-bottom:1px solid black;"></span><br />
							<span style="padding-left:80mm;">Name of taxpayer</span><br /><br /><br />
							...
							described on line 17a and there was no indication that his or her condition or problem was preexisting.<br /><br />
							<span style="width:100%;height:4mm;border-bottom:1px solid black;"></span>
							<span style="width:100%;text-align:center;">Name of physician or other medical official</span><br /><br />
							<span style="width:100%;height:4mm;border-bottom:1px solid black;"></span>
							<span style="width:100%;text-align:center;">Physician's or other medical official's address and telephone number</span><br /><br />
							<span style="width:133mm;height:4mm;border-bottom:1px solid black;"></span>
							<span style="width:44.5mm;height:4mm;border-bottom:1px solid black;margin-left:1mm;"></span><br />
					...
					<table class="styLeftOverTbl">
						...
						<xsl:for-each select="$FormData/StudentExemptIndivGrp">
							<xsl:call-template name="PopulateLeftoverRow">
								...
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 6 years prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess6StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 6 years prior - Date</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess5StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDesc"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 5 years prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess5StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 5 years prior - Date</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess4StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDesc"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 4 years prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess4StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 4 years prior - Date</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess3StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDesc"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 3 years prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess3StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 3 years prior - Date</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess2StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDesc"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 2 years prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess2StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 2 years prior - Date</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess1StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDesc"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 1 year prior - Desc</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="TargetNode" select="CurrTYLess1StudentVisaGrp/VisaTypeChangeGrp/VisaChangeDt"/>
								<xsl:with-param name="Desc">Student <xsl:value-of select="position()"/> - Line 7 - Visa Type Change 1 year prior - Date</xsl:with-param>
							</xsl:call-template>
						</xsl:for-each>
					</table>

                ...
                <span style="font-family:Arial;font-size:8pt;">
                 ...
                 <!-- </div>-->
                  ...
                  <xsl:choose>
						...
						<xsl:otherwise>
						<span style="font-size:8.0px">
						         <div style="width:1.5mm;height:0mm;"/>
						    	 <xsl:call-template name="PopulateText">
                                <xsl:with-param name="TargetNode" select="$FormW2GData/RecipientForeignAddress/CityNm"/>
                                </xsl:call-template>,
                                 <xsl:if test="$FormW2GData/RecipientForeignAddress/ProvinceOrStateNm != ''">
							         <xsl:call-template name="PopulateText">
        ...
        <div class="styIRSW2GRowItem" style="width:37mm;float:left;">
                ...
                <!--<xsl:choose>
                  ...
                  <xsl:if test="((count($FormW2GData/W2GStateLocalTaxGrp) &gt; 1 or count($FormW2GData/W2GStateLocalTaxGrp/W2GLocalTaxGrp) &gt; 1) and 
                    ...
                    <!-- <xsl:choose>
							<xsl:when test="((count($FormW2GData/W2GStateLocalTaxGrp) &gt; 1 or count($FormW2GData/W2GStateLocalTaxGrp/W2GLocalTaxGrp) &gt; 1) and 
                             ($Print = $Separated))">
								<span style="width:4px"/>
                                <xsl:call-template name="PopulateAdditionalDataTableMessage">
                                 <xsl:with-param name="TargetNode" select="$FormW2GData/W2GStateLocalTaxGrp"/>
                  ...
                  <!-- (15) State income tax withheld >>>>>>>>>>>>>>>>>>>>>>>>-->
                    ...
                    <span style="font-size:6pt;font-family:Arial Narrow;">Local income tax withheld</span>                    	    
                  	     ...
                  	     <div class="styIRSW2GDataMRTxtFields" style="text-align:right;padding-right:3px;height:6.5mm;border-bottom-width:0px;">
					...
					<xsl:otherwise>
					     <xsl:if test="count($FormW2GData/W2GStateLocalTaxGrp) &lt; 2 and ($Print != $Separated)">
					             <div style="text-align:left;float:left;">$</div>
                                  <xsl:call-template name="PopulateAmount">
                                  <xsl:with-param name="TargetNode" select="$FormW2GData/W2GStateLocalTaxGrp/LocalIncomeTaxAmt"/>
                              </xsl:call-template>
						</xsl:if>
					 	</xsl:otherwise>
                  </xsl:choose>
                ...
                <div class="styIRSW2GRowItem" style="width:37mm;float:left;height:3.2mm;">
                  ...
                  <div class="styIRSW2GDataMRTxtFields" style="text-align:left;height:8mm;border-bottom-width:0px;border-right-width:1px;">
					...
					<xsl:otherwise>
					     <xsl:if test="count($FormW2GData/W2GStateLocalTaxGrp) &lt; 2 and ($Print != $Separated)">
                                  ...
                                  <xsl:call-template name="PopulateAmount">
                                  <xsl:with-param name="TargetNode" select="$FormW2GData/W2GStateLocalTaxGrp/LocalityNm"/>
                              </xsl:call-template>
						</xsl:if>
					 	</xsl:otherwise>
                  </xsl:choose>
...
<p style="page-break-before:always"/>
          ...
          <br/><br/>
			   <div style="float:left">
                  <span class="styRepeatingDataTitle" style="width:80mm"> Form W2G, Lines 13-18,</span>
                  <table class="styDepTbl" style="width:150mm; font-size:6pt;">
                    <thead class="styTableThead">
                      ...
                      <tr class="styDepTblHdr">
                        ...
                        <th class="styDepTblCell" scope="col" valign="baseline" style="font-weight:normal">
                          <b>14</b> State winnings</th>
                        <th class="styDepTblCell" scope="col" valign="baseline" style="font-weight:normal">
                          <b>15</b> State income tax withheld</th>
                         <th class="styDepTblCell" scope="col" valign="baseline" style="font-weight:normal">
                          <b>16</b> Local winnings</th>
                         <th class="styDepTblCell" scope="col" valign="baseline" style="font-weight:normal">
                          <b>17</b> Local income tax<br/> withheld</th>
                         <th class="styDepTblCell" scope="col" valign="baseline" style="font-weight:norma;">
                          <b>18</b>  Name of locality</th>
                        ...
                        <tr style="border-color:black;">
                          ...
                          <td class="styDepTblCell" align="right">
                            <div style="width:28mm;">
                                <xsl:if test="GamblingWinningAmt">
                                  <xsl:call-template name="PopulateAmount">
                                    <xsl:with-param name="TargetNode" select="GamblingWinningAmt"/>
                                  </xsl:call-template>
                                </xsl:if>

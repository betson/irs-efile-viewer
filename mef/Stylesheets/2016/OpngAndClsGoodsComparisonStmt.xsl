    ...
    <table id="OpngAndClsGoodsComparisonStmtTbl" class="styDepTbl" style="font-size: 8pt">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" style="width:62mm;" scope="col">Type/Category</th>
          <th class="styDepTblCell" style="width:62mm;" scope="col">Description</th>
          <th class="styDepTblCell" style="width:62mm;" scope="col">Unit of Measure</th>
        </tr>
      </thead>
      <xsl:for-each select="$DependencyData/TypeCategoryUsedGrp">
        <tr>
          ...
          <td class="styDepTblCell" style="width:62mm;text-align:left;">

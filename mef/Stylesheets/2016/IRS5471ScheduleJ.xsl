			...
			<body class="styBodyClass" style="width:256mm">
				<form name="IRS5471ScheduleJ">
					...
					<div class="styBB" style="width:256mm;height: 23mm;border-bottom-width:2px;">
						...
						<div class="styFTBox"
						 style="height: 23mm;width:175mm;padding-top:1mm;border-left-width:1px;
						 border-right-width:1px;">
							...
							<div style="padding-top:4mm;border:0px;width:175mm;font-size:8pt" class="styFST">
								<img src="{$ImagePath}/5471SchJ_Bullet.gif" 
								alt="Bullet Image"/>Information about Schedule J (Form 5471) and its instructions is at
						...
						style="width:120mm;height:9mm;">Name of foreign corporation
							...
							<span>
								...
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									select="$IRS5471ScheduleJData/
									ForeignCorporationName/BusinessNameLine2Txt"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="sty5471ScheduleJBusinessName" 
						style="width:64mm;height:9mm;border-right:0;">
					...
					<div class="styTableContainer" id="5471SchJctn" style="width:256mm;">
						...
						<th class="sty5471ScheduleJCellGeneric"
						 style="font-weight:normal;text-align: center; height: 20mm;
						   padding-top: 2mm;" rowspan="2"  scope="col">
							<b>(a) </b> Post-1986<br/>Undistributed Earnings<br/>
							(post-86 section<br/>	959(c)(3) balance)
						</th>
						<th class="sty5471ScheduleJCellGeneric"
						 style="font-weight:normal;text-align: center; height: 20mm;  padding-top: 2mm;"
						  rowspan="2"  scope="col">
							...
							<th class="sty5471ScheduleJCellGeneric" 
							style="font-weight:normal;width:96mm;text-align: center; height:10mm;" colspan="3"
							  scope="col">
								<b>(c) </b> Previously Taxed E&amp;P (see instructions)<br/>
					...
					<tr class="sty5471ScheduleJDescLine" style="height:11mm;">
						<td class="sty5471ScheduleJCellGeneric" style="width:64mm;font-size:8pt;">
							...
							Total current and accumulated E&amp;P not previously taxed 
							(line 1 plus line 2a <b> or </b> line 1 minus line 2b)
							</div>
						</td>
					...
					<tr class="sty5471ScheduleJDescLine" style="height:11mm;">
						<td class="sty5471ScheduleJCellGeneric" style="width:64mm;font-size:8pt;">
							...
							Amounts included under section <span style="width:4mm;"/>
							 951(a) or reclassified under section 959(c) in current year
							</div>
						</td>
						<td class="sty5471ScheduleJCellGeneric" style="height:11mm;padding-top: 8.5mm;">
							<xsl:call-template name="PopulateAmount">

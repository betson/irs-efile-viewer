...
<!-- 07-08-2011 - Changes made per UWR 40218 - Jeremy Nichols --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
				<form name="Form8697">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styEINBox" rowspan="2" 
							...
							<div style="width:55mm;font-weight:normal;text-align:left;padding-top:0.5mm;">
								<span style="width:3mm;"/>
								<!--Individual Checkbox -->
								<input type="checkbox" alt="Individual Checkbox" class="styCkbox" style="width:4mm;">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" alt="Partnership Checkbox" class="styCkbox" style="width:5mm;">
									<xsl:call-template name="PopulateCheckbox">
							...
							<div style="width:55mm;font-weight:normal;text-align:left;padding-top:0.5mm;">
								...
								<input type="checkbox" alt="Estate or Trust Checkbox" class="styCkbox" style="width:4mm;margin-left:none;">
									<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;" id="TPctn">
						...
						<table cellspacing="0" summary="Table displaying entity name or names and corresponding employer identification numbers" 
						style="font-size:7pt;" name="TYTable" id="TYTable">
							<tr>
								<th class="styTableCell" scope="col" rowspan="1" style="width:4mm;float:left;border:none;">
									<span style="width:1px;"/>
								</th>
								<th class="styTableCell" scope="col" rowspan="1" 
								...
								<th class="styTableCell" scope="col" rowspan="1" style="width:50mm;text-align:center;border-color:black;border-bottom:none;border-right:none;">
					...
					<xsl:choose>
							...
							<table style="width:187mm; " id="TP1ctn">
								...
								<table cellspacing="0" summary="Table located under line C, having four columns and eight rows" 
									...
									<tr>
										...
										<th class="styTableCell" scope="col" rowspan="1" style="width:80mm;text-align:left;border-color:black;border-bottom:none;">
											<span style="width:1px;"/>
										</th>
										<th class="styTableCell" scope="col" rowspan="1" 
										...
										<th class="styTableCell" scope="col" colspan="2" 
											style="width:67mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
									...
									<tr style="height:30mm">
										...
										<th class="styForm8697TableCellDescription" scope="col" rowspan="2" style="font-weight:normal;">
						...
						<xsl:otherwise>
							<table style="width:187mm;" id="TP1ctn">
								...
								border-bottom-width:0px;border-left-width:0px;border-right-width: 0px;page-break-inside: avoid">
									<tr>
										<th class="styTableCell" scope="col" rowspan="1" style="width:7mm;text-align:center;border-color:black;border-right:none;border-bottom:none;">
											<span style="width:1px;"/>
										</th>
										<th class="styTableCell" scope="col" rowspan="1" style="width:80mm;text-align:left;border-color:black;border-bottom:none;">
											<span style="width:1px;"/>
										...
										<th class="styTableCell" scope="col" colspan="2" style="width:67mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
											 Redetermination Years
										</th>
										<th class="styTableCell" scope="col" rowspan="1" 
										style="width:29mm;text-align:center;border-top-width:0px;border-color:black;border-right:none;border-bottom:none;">
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;clear:both;page-break-inside: avoid">
						<tr>
							...
							<td colspan="4" style="padding-left:1mm;padding-bottom:1mm;">Under penalties of perjury, I declare that I have examined this form, including accompanying 
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;border-bottom:1px solid black;page-break-inside: avoid">
						<tr>
							<!--row 1-->
							<td rowspan="3" 
							style="width:22mm;font-size:14pt;font-weight:bold;font-family:'arial narrow';border-right:1px solid black;border-bottom:1px solid black;text-align:left;">
							...
							<td style="width:19mm;border-right:1px solid black;border-bottom:1px solid black;padding-left:1mm;vertical-align:bottom;padding-bottom:.5mm;">
								...
								<input class="styCkbox" type="checkbox" alt="PreparerSelfEmployed" id="dummyid1" style="width:4mm;">
									<xsl:call-template name="PopulateReturnHeaderPreparer">
					...
					<!-- END Left Over Table -->
					<!-- Call to Create Part 1 Separated Additional Data Table -->
					...
					<!-- End of Call to Create Part 1 Separated Additional Data Table -->
								...
								<table class="styDepTbl" style="font-size:7pt;page-break-inside: avoid">
									<thead class="styTableThead">
										<tr class="styDepTblHdr">
											<th class="styDepTblCell" scope="col" rowspan="1" style="width:4mm;border-right:none;">
												<span style="width:1px;"/>
											</th>
											<th class="styDepTblCell" scope="col" rowspan="1" style="width:67mm;border-left:none">
												<span style="width:1px;"/>
											</th>
											<th class="styDepTblCell" scope="col" colspan="3" style="width:87mm;text-align:center;">
												Date of each prior year to which interest <br/>computation relates:
											</th>
											<th class="styDepTblCell" scope="col" colspan="1" style="width:29mm;">
												<span style="float:left;width:1px;"/>
											</th>
										</tr>
									</thead>
	...
	<!-- Part 1 Separated Additional Data Table -->
	<xsl:template name="Pt1AddlTbl">
		...
		<xsl:if test="$index &lt;= $Pt1AddlTblMax">
			...
			<table class="styDepTbl" style="width:187mm;" id="TP1ctn">
				<xsl:call-template name="SetInitialState"/>
				<table class="styDepTbl" cellspacing="0" summary="Table located under line C, having four columns and eight rows"
							style="width:187mm;border-top-width:1px;font-size:7pt;border-style: solid; border-color: black; border-bottom-width:0px;border-left-width:0px;
							border-right-width: 1px;page-break-inside: avoid">
					<tr>
						<th class="styDepTblCell" scope="col" rowspan="1" style="width:7mm;text-align:center;border-color:black;border-right:none;border-bottom-width:1px;border-top:none">
							<span style="width:1px;"/>
						</th>
						<th class="styDepTblCell" scope="col" rowspan="1" style="width:80mm;text-align:left;border-color:black;border-bottom-width:1px;border-top:none;border-right:none
								;border-left:none;">
							<span style="width:1px;"/>
						</th>
						<th class="styDepTblCell" scope="col" rowspan="1" style="width:29mm;height:7mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;
								border-right:none">
						  Filing Year
						</th>
						<th class="styDepTblCell" scope="col" colspan="2" style="width:67mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;
								border-right:none">
						  Redetermination Years
						</th>
						<th class="styDepTblCell" scope="col" rowspan="1" 
							style="width:29mm;text-align:center;border-top-width:0px;border-color:black;border-right:none;border-bottom-width:1px;">
							<!--<span style="float:left;width:1px;"/>-->
						</th>
					</tr>
					<!-- Part 1 Line 1 Dates -->
			...
			<table style="width:187mm;" id="TP1ctn">
				...
				border-right-width: 0px;page-break-inside: avoid;">
					<tr>
						...
						<th class="styTableCell" scope="col" rowspan="1" style="width:29mm;height:7mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
						  Filing Year
						</th>
						<th class="styTableCell" scope="col" colspan="2" style="width:67mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
						  Redetermination Years
						</th>
						<th class="styTableCell" scope="col" rowspan="1" style="width:29mm;text-align:center;border-top-width:0px;border-color:black;border-right:none;border-bottom:none;">
							<!--<span style="float:left;width:1px;"/>-->
						</th>
					</tr>
					<!-- Part 1 - Line 1 Years -->
	...
	<xsl:template name="part2Table">
		...
		<xsl:if test="$index &lt;= $Part2Max">
			<table style="width:187mm;" id="TP2ctn">
				<xsl:call-template name="SetInitialState"/>
				<table cellspacing="0" summary="Table located under Part 2, having four columns and eight rows" 
				style="width:187mm;border-top-width:0px;font-size:7pt;border-style: solid; border-color: black;border-bottom-width:0px;border-left-width:0px;
				border-right-width: 0px;page-break-inside: avoid; " name="TYTable" id="TYTable">				
					<tr>
						...
						<th class="styTableCell" scope="col" colspan="3" style="width:96mm;text-align:center;font-weight:normal;border-top-width:0px;border-color:black;">
							<span style="width:12mm;"/>Date of each prior year to which interest <br/>
							<span style="width:15mm;"/>computation relates:</th>
						<th class="styTableCell" scope="col" rowspan="1" style="width:29mm;text-align:center;border-color:black;border-right:none;border-top-width:0px;border-bottom:none;">
							<span style="float:left;width:1px;"/>
						</th>
					</tr>	
					<tr style="height:30mm">
						...
						<th class="styTableCell" scope="col" rowspan="2" style="width:80mm;text-align:left;font-weight:normal;border-color:black;border-bottom:none;padding-right:1mm;">
						  Adjustment to regular taxable income to reflect the
						  difference between: <span style="font-weight:bold;">(a)</span> the amount of such income required
						  to be allocated for post-February 1986 contracts
						  completed or adjusted during the tax year based on <span style="font-weight:bold;">actual</span>
					...
					<tr>
						<td class="styTableCell" rowspan="1" 
							style="width:7mm;text-align:left;vertical-align:top;font-weight:bold;border-color:black;border-right:none;border-bottom:none;padding-left:1.5mm;">4
						</td>
						<td class="styTableCell" rowspan="1" style="width:80mm;text-align:left;border-color:black;border-bottom:none;padding-right:1mm;">
							  Increase or decrease in alternative minimum tax (AMT) for
							  prior years. Multiply line 3 in each column by the applicable

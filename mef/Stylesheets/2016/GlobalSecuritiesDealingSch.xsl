    ...
    <table id="GlobalSecuritiesDealingSch" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">Brief Description of each Global Dealings Operation</th>
             <th class="styDepTblCell" scope="col" style="width:45mm;              padding-left:25mm">Foreign Currency that Constitutes a Separate Global Dealing Operation</th>         
        </tr>
      </thead>
        ...
        <tr>
          ...
          <xsl:choose>
            ...
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="GlobalSecuritiesDealingOprDesc"/> 
             </xsl:call-template>
             </td>                          
                      <td class="styDepTblCell" style="text-align:left;">
              <xsl:call-template name="PopulateText">
                <xsl:with-param name="TargetNode" select="ForeignCurrencyUsedTxt"/>
              </xsl:call-template>
            </td>
           </tr>
      </xsl:for-each>

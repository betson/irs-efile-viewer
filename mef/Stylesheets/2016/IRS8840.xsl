			...
			<body class="styBodyClass">
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styFTBox" style="width:131mm;height:20mm;">
							...
							<span class="styFBT">
								...
								&#9658; Information about Form 8840 and its instructions is at <em>www.irs.gov/form8840</em>.
							</span><br/>
							<span>
						...
						<div class="styTYBox" style="width:28mm;height:20mm;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							During 2016, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status in <br />
					...
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:56mm;">Where was your tax home during 2016?</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Enter the name of the foreign country to which you had a closer connection than to the United States during 2016 <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Where was your tax home on January 1, 2016?
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							After changing your tax home from its location on January 1, 2016, where was your tax home for the remainder of 2016?<br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							...
							10 during all of the 2016 or <strong>(b)</strong> both of the countries listed on lines 9 and 10 for the period during which you <br />
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Have you filed or will you file tax returns for 2016 in the countries listed on lines 9 and 10? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........</span>
							<span style="float:right;">
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8840</span> (2016)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;">
						...
						<div class="styPartDesc">Significant Contacts With Foreign Country or Countries in 2016</div>
					</div>
					<!-- Line 14 -->
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:120.5mm;float:left;">
								Where was your regular or principal permanent home located during 2016? See instructions.
							</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							If you had more than one permanent home available to you at all times during 2016, list the location of each and <br />
					...
					<xsl:for-each select="$FormData/PrsnlBankingActyLocCountryCd[(position() mod 2) = 1]">
						...
						<div class="styStdDiv">
							<div class="styLNLeftLtrBox" style="padding-left:4.5mm;"><xsl:number format="a" value="$pos * 2 - 1"/></div>
							<div style="width:85mm;border-bottom:1px solid black;text-align:center;float:left;">
								<xsl:call-template name="PopulateCountry8840">
									<xsl:with-param name="TargetNode" select="."/>
								</xsl:call-template>
							</div>
							<div class="styLNLeftLtrBox" style="padding-left:4.5mm;"><xsl:number format="a" value="$pos * 2"/></div>
							<div style="width:85mm;border-bottom:1px solid black;text-align:center;float:left;">
								<xsl:call-template name="PopulateCountry8840">
									<xsl:with-param name="TargetNode" select="$FormData/PrsnlBankingActyLocCountryCd[$pos * 2]"/>
								</xsl:call-template>
							</div>
						</div>
					</xsl:for-each>
					...
					<!--
					<xsl:variable name="PBALCrows" select="ceiling($PBALCct div 2)"/>-->
					<!-- Line 21 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:104mm;float:left;">
								From what country or countries did you derive the majority of your 2016 income?
							</span>

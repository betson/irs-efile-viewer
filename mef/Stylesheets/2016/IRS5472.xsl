							...
							<div class="styLNDesc" style="clear:none; width: 26mm">
								...
								<label>
									<xsl:call-template name="PopulateLabelYes">
										<xsl:with-param name="TargetNode" select="$Form5472Data/ImportGoodsForeignRltdPartyInd"/>
										<xsl:with-param name="BackupName">
											5472ImportGoodsForeignRelatedPartyLabelYes
										</xsl:with-param>
									</xsl:call-template>
									Yes
								</label>
								...
								<label>
									<xsl:call-template name="PopulateLabelNo">
										<xsl:with-param name="TargetNode" select="$Form5472Data/ImportGoodsForeignRltdPartyInd"/>
										<xsl:with-param name="BackupName">
											5472ImportGoodsForeignRelatedPartyLabelNo
										</xsl:with-param>
									</xsl:call-template>
									No
								</label>
						...
						<div style="float:right; margin-right:1mm">
							<div class="styLNDesc" style="float: right; clear:none; width: 26mm">
								<span>
									...
									<input type="checkbox" alt="5472GoodsCostGreaterThanCustomsValYes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form5472Data/GoodsCostGrtrThanCustomsVlInd"/>
											<xsl:with-param name="BackupName">
								...
								<span>
									...
									<input type="checkbox" alt="5472GoodsCostGreaterThanCustomsValNo" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form5472Data/GoodsCostGrtrThanCustomsVlInd"/>
											<xsl:with-param name="BackupName">
						...
						<div style="float:right; margin-right:1mm">
							...
							<div class="styLNDesc" style="clear:none; width: 26mm">
								<span>
									...
									<input type="checkbox" alt="5472SupportingDocInExistenceInUSYes" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form5472Data/SupportingDocumentsExstUSInd"/>
											<xsl:with-param name="BackupName">
								...
								<span>
									...
									<input type="checkbox" alt="5472SupportingDocInExistenceInUSNo" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form5472Data/SupportingDocumentsExstUSInd"/>
											<xsl:with-param name="BackupName">
		...
		<xsl:if test="$index &lt;= $max">
			<table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<th scope="col" align="left" style="font-weight:normal; width:120mm;border-right:1px solid black;padding-left:2mm;">
				...
				<tr>
					<th scope="row" nowrap="nowrap" valign="top" align="left" style="border-top:1px solid black; width:9mm; padding-left:2pt;">
						...
						<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 1 and b(2) -->
					</th>
				...
				<thead class="styTableThead">
					<tr style="line-height:120%;" >
						<th valign="top" scope="row" align="center" style="width:6mm;">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 1 and c-->
						</th>
						...
						<th scope="row" valign="top" align="center" style="width:6mm; border-left:1px solid black">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 1 and d -->
						</th>
						...
						<th valign="top" style="width:6mm; border-left:1px solid black;" align="center">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 1 and e -->
						</th>
			...
			<table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<th scope="row" nowrap="nowrap" valign="top" align="left" style="width:9mm; padding-left:2pt;">
						...
						<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 3 and 4 space b(1)-->
					</th>
					<th style="font-weight:normal" align="left" nowrap="nowrap"> U.S. identifying number, if any </th>
				</tr>
				...
				<tr>
					<th scope="row" nowrap="nowrap" valign="top" align="left" style="border-top:1px solid black; width:9mm; padding-left:2pt;">
						...
						<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 3 and 4 and b(2)-->
					</th>
					<th style="font-weight:normal;border-top:1px solid black;" valign="top" nowrap="nowrap"> Reference ID number (see instructions) </th>
				</tr>
				<tr>
				...
				<thead class="styTableThead">
					<tr style="line-height:120%">
						<th valign="top" scope="row" align="center" style="width:6mm">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 4 and c-->
						</th>
						<th scope="col" align="left" style="font-weight:normal" valign="top" nowrap="nowrap">
							Principal country(ies) where
							<br/>
						...
						<th scope="row" valign="top" align="center" style="width:6mm; border-left:1px solid black">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 4 and d-->
						</th>
						<th scope="col" align="left" style="font-weight:normal; width:40mm;" nowrap="nowrap" valign="top">
							Country of citizenship,
							<br/>
						...
						<th valign="top" style="width:6mm; border-left:1px solid black" align="center">
							...
							<!--Warning:a need to be after the closing if otherwise it will introduce a line break between 4 and e-->
						</th>

			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120X">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:31mm;height:22.5mm; border-right-width:2px;">
							...
							<div style="font-size:7pt">(Rev. November 2016)
								<br/>
						...
						<div class="styFTBox" style="width:118mm;height:19.5mm;">
							<br/>
							<div class="styMainTitle" style="height:8mm;">Amended U.S. Corporation Income Tax Return</div>
							<br/>
							<br/>
							<br/>
							<!-- Form Subtitle -->
							...
							<span style="font-size:7pt">
								...
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1120X" title="Link to IRS.gov">
									<i>www.irs.gov/form1120X</i>								
								</a>.
							</span> 
						  </div>
						</div>
						<div class="styTYBox" style="width:38mm;height:22.5mm;border-left-width:.5mm;">
							<div class="styOMB">OMB No. 1545-0123</div>
							<div class="styGeneric" style="font-weight:bold;font-size:8.5pt;">
								For tax year ending
							</div>
							<div class="styGeneric" style="padding-top:2mm;padding-bottom:2mm;">
								<span style="float:left;clear:none;padding-right:.5mm;padding-top:3mm;">
									<img src="{$ImagePath}/1120_Bullet_Md.gif" alt="MediumBullet"/>
								</span>								
								<span style="font-size:15pt;font-weight:bold;text-align:left;border-top-width:0mm;border-bottom-width:1px;border-style:dashed;border-color:black;padding-right:3mm;">
							...
							<div class="styGeneric" style="font-weight:bold;font-size:7pt;">
							...
							<!--<table style="width:45mm;cellspacing:0; cell-padding:0;border:1;text-align:bottom;font-size:7pt">
								<tbody>
									...
									<tr style="padding-top:2mm;">
										...
										<th style="width:4mm;background-color:yellow;"/>
									...
									<tr style="height:5mm;">
										...
										--><!-- column 2 --><!--
										<th>
											<span style="font-size:15pt;font-weight:bold;text-align:left;border-top-width:0mm;border-bottom-width:1px;border-style:dashed;border-color:black;">
												<xsl:call-template name="PopulateMonthYearForYearMonthType">
													<xsl:with-param name="TargetNode" select="$Form1120XData/TaxYearEndMonthYr"/>
												</xsl:call-template>
											</span>
					...
					<div style="width:187mm;float:left;clear:left;">
						...
						<div class="styLblNameAddr" style="width:145mm; height:26mm;border-right-width:0px;border-left-width:0px;border-top-width:0px;border-bottom-width:0px;">
							<div class="styUseLbl" style="width:12mm;height:21mm;border-right-width:0px;padding-top:8mm;text-align:center;font-size:8pt;">Please Type or Print</div>
						...
						<div class="styLblNameAddr" style="width:42mm;height:25mm;border-right-width:0px;border-left-width:0px;border-top-width:0px;border-bottom-width:0px;">
							...
							Employer identification number<br/>
								<br/>
								<div style="text-align:lef;font-weight:normal;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
					...
					<div class="styBoldText" style="height:8mm;font-size:8pt;width:187mm;border-top:1px solid black;border-bottom:1px solid black;padding-top:2mm;">Tax Due or Overpayment <span style="font-weight:normal"> (see instructions)</span>
					</div>
					<br/>
				...
				<span style="float:none;">States Treasury" </span>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;">
						<tr>
							<td rowspan="3" style="width:22.75mm;font-size: 11pt;font-weight:bold;border-right:1px solid black;border-bottom:1px solid black;">Sign <br/> Here</td>
                  ...
                  <br/>
					...
					<div class="pageEnd" style="width:187mm;clear:both;padding-top:1mm;" >
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">1120X </span> (Rev. 11-2016)</div>
					</div>
					<!-- END Page Break and Footer-->
					<!--Begin Page 2 -->
					<!-- Page Header -->
					<div style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120X (Rev. 11-2016)<span style="width:130mm;"/>
						</div>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px; border-bottom-width:0px;">
						...
						<div class="styPartDesc" style="width:170mm;height:4mm;">
							Explanation of Changes to Items in Part I <span style="font-weight:normal;"> (Enter the line number from Part I for the items you are changing, 							
							</span>
						</div>
                ...
                <span style="width:2mm;"/>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1 solid black;border-top-width1px;">
						...
						<div style="float:right;">
    					   ...
    					   Form <span class="styBoldText" style="font-size:8pt;">1120X </span>(Rev. 11-2016)   
   					 </div>
					</div>

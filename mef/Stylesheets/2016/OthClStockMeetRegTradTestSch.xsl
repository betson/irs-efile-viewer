			...
			<tbody>
				<xsl:for-each select="$DependencyData/OtherClassStockInformationGrp">
					<tr>
						...
						<td class="styDepTblCell" style="width:22mm;text-align:right;vertical-align:center;font-size:7pt">
							<!--Allow row to expand by column -->
							<xsl:attribute name="rowspan"><xsl:value-of select="count(TotalPctValueSharesOwnedGrp)"/></xsl:attribute>
							<xsl:call-template name="PopulateText">
						...
						<td class="styDepTblCell" style="width:32mm;text-align:left;vertical-align:center;font-size:7pt">
							<!--Allow row to expand by column -->
							<xsl:attribute name="rowspan"><xsl:value-of select="count(TotalPctValueSharesOwnedGrp)"/></xsl:attribute>
							<xsl:call-template name="PopulateText">

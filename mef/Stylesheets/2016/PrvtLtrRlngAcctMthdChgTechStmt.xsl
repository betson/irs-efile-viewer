...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- - Form 3115 displays as - Private Letter Ruling, Change in Accounting Method or Period, Technical Advice Request Statement - -->
        ...
        <table class="styDepTbl" style="margin-top:4mm; font-size:7pt; font-family:Verdana">
          <thead class="styTableThead">
            <tr class="styDepTblHdr">
              ...
              <th class="styDepTblCell" style="width:40mm;" scope="col">
                 Type of Request
              </th>
              <th class="styDepTblCell" style="width:100mm;" scope="col">       
                Specific Issue
              </th>
            </tr>
          </thead>
            ...
            <xsl:for-each select="$Form3115Deps38Data/RequestInfo">
              <tr>
                ...
                <td class="styDepTblCell" align="left">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="SpecificIssueTxt"/>
                  </xsl:call-template>
                </td>
              </tr>
            </xsl:for-each>

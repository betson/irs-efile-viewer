...
<!DOCTYPE xsl:stylesheet [<!ENTITY nbsp "&#160;">]><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/CompensationExplanation"/>
  ...
  <xsl:template name="DependencyTemplate">
    ...
    <table id="COETbl" class="styDepTbl" style="margin-top:4mm; font-size:8pt; font-family:Arial">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          <!--th class="styDepTblCell" scope="col">Item No.</th-->
          <th class="styDepTblCell" scope="col">Person Name</th>
    ...
    <tbody>
     <xsl:for-each select="$DependencyData/CompensationExplanationGrp">    
          <tr>
      ...
      <body class="styBodyClass">  
        ...
        <div class="styDepTitleLine">
          <div class="styDepTitle" style="width:85mm">
            <!--TY 2003 Compensation Explanation-->
            <xsl:value-of select="$depDocTitle"/>
          </div>
        </div>        

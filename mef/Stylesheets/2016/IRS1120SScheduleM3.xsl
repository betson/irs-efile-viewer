      ...
      <body class="styBodyClass" style="width:187mm;">
        <form name="Form1120SScheduleM3">
          ...
          <div class="styTBB" style="width:187mm;border-bottom-width: 1px;">
            ...
            <div class="styTYBox" style="width:30mm;height:22mm;border-left-width:1px;">
              ...
              <div class="styTY" style="height:11mm;padding-top:4mm;">20<span class="styTYColor">16</span>
              </div>
            </div>
          </div>
       ...
       the period ending with or within this tax year? (See instructions if multiple non-tax-basis income statements are prepared.)</div>
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120S) 2016</div>
          </div>
          <p style="page-break-before: always"/>
          <!-- Page 2 -->
          <!-- Page 2 Header -->
          <div class="styBB" style="width:187mm;border-bottom-width:1px">
            <div style="float:left;">Schedule M-3 (Form 1120S) 2016</div>
          ...
          <table class="styIRS1120ScheduleM3_styTable" id="IRS1120SScheduleM3PartIITable"  cellspacing="0" cellpadding="0" style="width:187mm;">
         ...
         Line 26, column (a), must equal Part I, line 11, and column (d) must equal Form 1120S, Schedule K, line 18.</div>
          ...
          <div style="width:187mm;">
          <!-- 05/02/2016 WT: Removed summary= code because JAWS read the summary text --> 
          <table class="styTable" id="IRS1120SScheduleM3PartIII"  cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;clear:all;">
            ...
            <tr>
              ...
              <td style="padding-top:.5mm;padding-left:2mm;border-style:solid;border-bottom-width:2px; border-top-width:0px; border-right-width:0px;border-left-width:0px;padding-top:0;">
				  <b>Total expense/deduction items.  </b> 
				   Combine lines 1 through 31. Enter here and on Part II, line 24, reporting positive amounts as negative and negative amounts as positive
				  <span class="styDotLn" style="float:right;padding-right:1mm;">..</span>          
              </td>

...
<!-- Last Modified by James Ganzy on 7/25/2017 -->
	...
	<xsl:template match="/">
				...
				<form name="Form1065B">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:34mm;height:18mm;">
							...
							<div class="styTY" style="height:11mm;padding-top:3mm;">20<span class="styTYColor">16</span>
							</div>
						</div>
					</div>
      ...
      Check accounting method: 
         ...
         Other (specify)
						...
						<div class="styFixedUnderline" style="width:45mm;padding-top:2mm;padding-bottom:0mm;border-style: dotted;">
							<xsl:call-template name="LinkToLeftoverDataTableInline">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2016)
                    </div>
					</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2016)<span style="width:148mm;"/>
						</div>
...
and 8813. (See instructions.)
						...
						<div style="width:187mm">
							...
							<div class="styLNDesc" style="width:167mm">At any time during calendar year 2016, did the partnership have an interest in or a signature 
    ...
    to this return.
					...
					<div  style="width:187mm;">
                        ...
                        <span class="styBoldText" style="font-size:8pt;">1065-B</span> (2016)
                    </div>
					</div>
					<p style="page-break-before: always"/> 
					<!-- END Page Break and Footer-->
      ...
      Form
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Form 1065-B (2016)

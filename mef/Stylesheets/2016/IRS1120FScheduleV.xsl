...
<div class="styTY" style="height:8mm;padding-top:1mm;">20<span class="styTYColor">16</span>
</div>
</div>
</div>
		...
		<xsl:for-each select="$Form1120FScheduleVData/VesselAircraftInformation">
			...
			<xsl:if test="position() mod 4 = 1">
				...
				<tr>
					...
					<td class="styTableCellSmall" style="width:30mm;font-size:7;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;border-left-width:0px;border-right-width:1px;">
					...
					<td class="styTableCellSmall" style="width:30mm;font-size:7;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;border-left-width:0px;border-right-width:0px;">
				...
				<span>
					...
					<input type="checkbox" alt="VesselOrAircraftCharteredIn" class="styCkbox">
				...
				<span>
					...
					<input type="checkbox" alt="VesselOrAircraftCharteredOut" class="styCkbox">
						<xsl:call-template name="PopulateYesCheckbox">
							<xsl:with-param name="TargetNode" select="VesselOrArcrftCharteredOutInd"/>
...
<tr>
					...
					</td><td class="styTableCellSmall" style="width:30mm;text-align:center;font-weight:bold;border-color:black;border-top-width:1px;border-left-width:1px;border-right-width:1px;">
...
<p>
	<div class="pageEnd" style="width:187mm;padding-top:0mm;">
		...
		<div style="float:right;">
			<span style="width:10px;"/><b>Schedule V (Form 1120-F) 2016</b>
		</div>
	</div>
</p>

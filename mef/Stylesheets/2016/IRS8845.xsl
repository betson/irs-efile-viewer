...
<!-- Last modified on 9/27/2017 by Harold Nadel for KISAM #  IM03083096 corrected the error in the Return Header-->
      ...
      <body class="styBodyClass">
		...
		<!--<xsl:call-template name="PopulateReturnHeaderFiler">
          ...
          <div class="styBB" style="width:187mm">
            ...
            <div style="width:187mm;">
              <div style="float:left;clear:none;">
                <div class="styLNLeftNumBoxSD" style="height:6mm;padding-top: 1mm;">3</div>
              ...
              <div style="float:right;clear:none;">
                <div class="styLNRightNumBox" style="height:6mm;padding-top: 1mm;">3</div>
            ...
            <div style="width:187mm;">
              <div style="float:left;clear:none;">
                ...
                <div class="styLNDesc" style="width:139mm;height:auto;padding-top: 1mm">
                  Multiply line 3 by 20% (.20). See instructions for the adjustment you must make to salaries and wages <br/>
		...
		5
          ...
          <div style="width:187mm;">
            ...
            Form <span class="styBoldText">8845</span> (2016)
          </div>
          <br/>
          <br class="pageEnd"/>

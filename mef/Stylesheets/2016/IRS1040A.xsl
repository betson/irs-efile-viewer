      ...
      <body class="styBodyClass" style="width:187mm;">
        <form name="Form1040A">
          ...
          <div style="width:187mm;border-bottom:2px solid black;position:relative;height:12mm;">
            ...
            <div class="styTaxYear" style="position:absolute;bottom:0;left:110mm;font-size:18pt;font-family:arial;font-weight:bold;text-align:center;padding-left:1mm;">2016</div>
									...
									<table class="styTable" cellspacing="0">
										...
										<tbody>
											...
											<xsl:if test="count($FormData/DependentDetail) &lt; 1 or ((count($FormData/DependentDetail) &gt; 6) and ($Print = $Separated))">
												<tr>
													<td class="styTableCell" style="width:64mm;text-align:left;height:4mm;float:left;clear:none;border-right-width:1px;">
													...
													<td class="styTableCell" style="width:18mm;height:4mm;border-right-width:0px;">
														<span class="styTableCellPad"/>
													</td>
												</tr>
											</xsl:if>
											<xsl:if test="count($FormData/DependentDetail) &lt; 2 or ((count($FormData/DependentDetail) &gt; 6) and ($Print = $Separated))">
												<tr>
													<td class="styTableCell" style="width:64mm;height:4mm;float:left;clear:none;border-right-width:1px;">
														<span class="styTableCellPad"/>
													</td>
													<td class="styTableCell" style="width:19mm;height:4mm;border-right-width:1px;">
														<span class="styTableCellPad"/>
          ...
          <div class="pageEnd" style="width:187mm; font-size:7pt;padding-top:0mm;">
            ...
            <div style="float:right;">
				<span style="width:4mm"/>
					Form <b style="font-size:7pt">1040A</b> (2016)
            </div>
          </div> 
   		  <p style="page-break-before: always"/>
          <!-- page 2 Header -->
          <div class="styTBB" style="width:187mm;padding-top:.5mm;">
            <span class="" style="float:left;clear:none;">Form 1040A (2016)</span>
        ...
        <!--          <span style="float:left;clear:none;">   
              ...
              <div class="sty1040ALongLine" style="width:125mm;margin-left:10px;border-bottom-width:0;">
                ...
                <div style="width:85mm;padding-top:.5mm;padding-left:5mm;float:left;clear:none;">
                  <span style="float:left;clear:none;">
                    2016 estimated tax payments and amount applied<br/>
                    from 2015 return.
                  </span>
                  <div style="float:left;clear:none;padding-left:1mm">
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
            ...
            <div style="width:162.5mm;float:left;clear:none;">
             ...
             <div style="width:162.5mm;">
              ...
              <div class="sty1040ALongLine" style="border-bottom:none;">
                ...
                <div style="width:85mm;padding-top:.5mm;padding-left:5mm;float:left;clear:none;">
                  <span style="float:left;clear:none;">
                     Amount of line 47 you want <b>applied to your<br/>2017 estimated tax.</b>
                  </span>
                  <div style="float:left;clear:none;padding-left:1mm">
                    <!-- Form to Form Link -->
                    <xsl:call-template name="SetFormLinkInline">

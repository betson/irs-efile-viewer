			...
			<body class="styBodyClass">
				<form name="IRS1040ScheduleH">
								...
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;">
										<div style="width:100mm;height:5mm;">
											...
											<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="SmallBullet"/> 
                                             Information about Schedule H and its separate instructions is at <i>www.irs.gov/scheduleh.</i>
										</div>
									</div>
								</span>
							</div>
					...
					<div class="styTBB" style="width:187mm;height:79mm;">
						<div style="width:187mm;height:auto;padding-top:4mm;">Calendar year taxpayers having no household employees in 2016 don't have to complete this form for 2016.</div>
						<!-- Spacer -->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:22mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                                Did you pay <span class="styBoldText">any one</span> household employee cash wages of $2,000 or more in 2016? (If any household employee was your<br/>
                ...
                answer this question.)
						...
						<div class="styIRS1040ScheduleHLineItem"  style="height:20mm;padding-top:4mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                                Did you withhold federal income tax during 2016 for any household employee?
                                <br/>
								<br/>
								<!-- Checkboxes -->
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;height:4mm;">
						...
						<div class="styIRS1040ScheduleHLineItem"  style="height:20mm;padding-top:4mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                               Did you pay <span class="styBoldText">total</span> cash wages of $1,000 or more in <span class="styBoldText">any</span> calendar <span class="styBoldText">quarter</span> of 2015 or 2016 to <span class="styBoldText">all</span> household employees?<br/>
                (<span class="styBoldText">Don't</span> count cash wages paid in 2015 or 2016 to your spouse, your child under age 21, or your parent.)
                                <br/>
								<br/>
								<!-- Checkboxes -->
                ...
                (<span class="styBoldText">Don't</span> count cash wages paid in 2015 or 2016 to your spouse, your child under age 21, or your parent.)
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;height:8mm;">
										...
										<label style="height:4mm;">
											...
											<span style="width:2mm;"/>
											<span class="styBoldText">No. Stop.</span> Include the amount from line 8 above on Form 1040, line 60a. If you aren't<br/>
											<span style="width:8mm"/>required to file Form 1040, see the line 9 instructions.
                                        </label>
									</div>
									<!-- Yes -->
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;height:4mm;">
					...
					<div  style="width:187mm;padding-top:1mm;clear:both;font-size:6.5pt;page-break-after:always;display:block;">
					    ...
					    <div style="float:right;">
								<span class="styBoldText">Schedule H (Form 1040) 2016</span>
					    </div>
					</div>
					</div>	
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Schedule H (Form 1040) 2016</div>
						<div style="float:right;">
						...
						<div style="width:187mm;" class="styNBB">
							...
							<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:153.5mm;height:5mm;">
								  Did you pay all state unemployment contributions for 2016 by April 18, 2017? Fiscal year filers see instructions
								</div>
...
<!--							--><!-- Amount Box --><!--
                    ...
                    <!--        </span>-->
						...
						<div style="height:auto;width:187mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:137mm;height:9mm;">
								...
								<span style="float:left;">								
									<span style="float:left;">(Employers in a credit reduction state must use the worksheet on page H-7 and check here)</span>
									<!--Dotted Line-->
							...
							<div class="styIRS1040ScheduleHLNDesc" style="height:9mm;width:41mm;float:right;padding:0px 0px 0px 0px;">
                                <div class="styLNRightNumBox" style="height:4.5mm;padding:0.6mm 0 0 0;">23</div>														
								<div class="styLNAmountBox" style="height:4.5mm;width:33mm;float:right;padding:0.6mm 0px 0px 0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<!-- (24) ////////////////////////////////////////////////////////////-->
						<div  class="styIRS1040ScheduleHLineItem" style="height:auto;border-bottom:1px;">
							<div class="styIRS1040ScheduleHLineItem">
					...
					<div>				
						<div class="styTBB" style="width:187mm;font-size:6pt;height:auto;">
							...
							<div style="width:164mm;float:left;clear:none;border-width:0px 0px 0px 1px; border-color:black;border-style:solid;">
								...
								<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
									<div class="styLNDesc" style="height:6mm;width:108.1mm;border-right:1 solid black;">
									...
									<div class="styLNDesc" style="height:6mm;width:32mm;padding-left:1mm;border-left:1px solid black;">Firm's EIN
										<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="Right pointing arrowhead image"/>
										<span style="width:4px;"/>
						...
						<div   style="width:187mm;">
							...
							<div class="stySmallText" style="width:46mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;">Schedule H (Form 1040) 2016</span>
							</div>
						</div>
					</div>
					</div>

		...
		<table id="NTSTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">
					...
					<th class="styDepTblCell" scope="col">Nongrantor Trust Interest Code</th>
				</tr>
			</thead>
			<tfoot/>
			<tbody>
				<xsl:for-each select="$NTSData/NongrantorTrustInterestGrp">
					<tr>
						...
						<td class="styDepTblCell" style="text-align:left;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="NongrantorTrustInterestCd"/>
							</xsl:call-template>
						</td>
					</tr>
				</xsl:for-each>

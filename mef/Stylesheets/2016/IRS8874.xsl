...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      Form <span class="styFormNumber">8874</span>
							<br/>
							<span style="font-size:6pt">(Rev. September 2016)</span>
							...
							<tbody>
								...
								<xsl:if test="count($Form8874Data/CurrentYearCreditInfo) &lt; 3 or          (($Print = $Separated) and (count($Form8874Data/CurrentYearCreditInfo)&gt;6)) ">
									<tr height="8mm">
										...
										<td class="styTableCell" rowspan="1" style="width:63mm;text-align:left;font-size:7pt;font-weight:normal;border-bottom-width:0px;">
											<span style="width:1px;"/>
										</td>
										<td class="styTableCell" style="width:25mm;text-align:center;font-size:7pt;font-weight:normal;border-bottom-width:0px;">
											<span style="width:1px;"/>
										</td>
										...
										<td class="styTableCell" style="text-align:right;width:30mm;border-right:none;font-size:7pt;font-weight:normal;border-bottom-width:0px;">
											<span style="width:1px;"/>
										</td>
									</tr>
								</xsl:if>
          ...
          2    
					...
					<div style="width:187mm;padding-bottom:1mm;border-top:1px solid black;">
						...
						<span style="width:120px;"/>                      
						  ...
						  Form <span class="styBoldText">8874</span> (Rev. 9-2016)    
				    </div>

				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; font-size: 7pt;">
							...
							<span style="width: 186mm;">
					            ...
					            <xsl:call-template name="PopulateCheckbox">
					              ...
					              <xsl:with-param name="backupName">IRS1120SScheduleK1FinalK1</xsl:with-param>
									...
									<input type="checkbox" alt="AmendedK1" class="styCkbox" name="checkbox" id="dummyID2" onclick="return false;">
                  ...
                  OMB No. 1545-0123
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 2px solid black;">
								...
								<tr>
									<td style="width: 93mm;">
										<div style="width: 93mm;">
											...
											<div class="styTY" style="float: right; clear: none; padding-right: 2mm;">20<span class="styTYColor">16</span>
											</div>
											<!-- 2012 -->
										</div>
									</td>
								...
								<tr>
									<td style="font-size: 7pt;">Department of the Treasury<br/>
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2016, or tax <br/>year beginning
					...
					<!-- Line F -->
								...
								<tr>
									<td class="IRS1120SScheduleK1_tdLeft" style="height:162mm; vertical-align: middle">
										<!-- IRS Use Only box -->
															...
															<tbody>
																...
																<xsl:if test="count($FormData/IRS1120SSchK1OtherIncmLossGrp) &lt; 4">
																	<xsl:call-template name="PrintBlanksLines">
																		...
																		select="4 - count($FormData/IRS1120SSchK1OtherIncmLossGrp)"/>
																	</xsl:call-template>
																</xsl:if>
               ...
               <!-- Line 12 -->
                        <tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													style="width:46.5mm;float:none;clear:both;" id="SchK12Ctn">
														<table cellpadding="0" cellspacing="0" style="auto;">
															<tbody>
																...
																<xsl:if test="count($FormData/IRS1120SSchK1OtherDedGrp) &lt; 7">
																	<xsl:call-template name="PrintBlanksLines">
																		...
																		<xsl:with-param name="numRows" 
																		select="7 - count($FormData/IRS1120SSchK1OtherDedGrp)"/>
																	</xsl:call-template>
																</xsl:if>
																...
																<xsl:if test="($Print != $Separated)  or (count($FormData/IRS1120SSchK1AMTItemsGrp) &lt;=4)">
																	...
																	<tr>
																		...
																		<td class="IRS1120SScheduleK1_amountBox"
																			 style="height:8mm;padding-top:5mm;border-top:gray dotted 1px; width:40.50mm;font-size:6pt;padding-left:1mm;text-align:right;">
																					<span style="float:left;padding-left:2px;">
																					<xsl:call-template name="PopulateText">

          ...
          <!-- BEGIN WARNING LINE -->
			...
			<div class="styFTBox" style="width:122.5mm;height:20mm;">
				...
				<div class="styFST">
				  ...
				  <a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1120f">www.irs.gov/form1120f</a>.
				</div>
			</div>
			<div class="styTYBox" style="width:31mm;height:20mm;border-left-width:1px;">
				...
				<div class="styTY" style="padding-top:2mm;">20<span class="styTYColor">16</span></div>
			</div>					
			</div>
			<!--End header-->
           <!--Begin Name/EIN-->
          ...
          <div class="styBB" style="width:187mm;height:11.5mm">
            ...
            <div class="styPartDesc">
              ...
              <span style="font-size:7pt;">Note. 
                ...
                <input type="checkbox" alt="USDollars" class="styCkbox">
		...
		<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
              ...
              <tbody>
               ...
               <!--L1b-->
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDesc" colspan="3" scope="row">
                    Remaining deductible expenses to be allocated and apportioned between ECI and non&#45;ECI. Subtract line 6 
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
              <tbody>
                <tr>
                  ...
                  <td class="sty1120FSchHLNDesc" colspan="3" scope="row">
                    Remaining deductible expenses on the books of the home office not definitely related solely to ECI or non&#45;ECI. 
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDesc" colspan="3" scope="row">
                    Remaining home office deductible expenses on line 15 allocated and apportioned under Regulations section
				...
				<!--End Part III Header-->                
				  <div class="styBB" style="width:187mm;height:14mm;">
					<div style="width:187mm">
                      ...
                      <input type="checkbox" alt="PriorMethodDiff" class="styCkbox">
                        <xsl:call-template name="PopulateCheckbox">
                          <xsl:with-param name="TargetNode" select="$FormData/MethodDifferentPriorYearInd"/>
                          <xsl:with-param name="BackupName">IRS1120FSchHPriorMethodDiff</xsl:with-param>
                        </xsl:call-template>
                    ...
                    <div style="clear:right;padding-top:1.5mm;">
                      ...
                      <label>
                        <xsl:call-template name="PopulateLabel">
                         ...
                         used to prepare Form 1120&#45;F, Schedule L, include the amount 
                      </label>
						<span style="padding-left:2.5mm;padding-top:1.5mm;">on Part IV, line 35 and check this box</span>
						<span class="styDotLn" style="float:right;">...............................
						  <input type="checkbox" alt="IsInterbranchAmount" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
							  <xsl:with-param name="TargetNode" select="$FormData/RecordedInterbranchAmountInd"/>
							  <xsl:with-param name="BackupName">IRS1120FSchHIsInterbranchAmount</xsl:with-param>
							</xsl:call-template>
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt;">
              <tbody>
                ...
                <tr>
                  ...
                  Did the corporation use any ratio&#45;based methods (other than those indicated on lines 21 through 23 above) in Parts I and II? If</td>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDescLong" scope="row">
                  Did the corporation use any other methods (e.g., time-spent analysis or estimates) in Parts I and II? If "Yes," attach statement
		  ...
		  <div class="sty1120FSchHFooter">
            ...
            <div style="float:right;text-align:right;width:40mm" class="styGenericDiv">
              <b>Schedule H (Form 1120-F) 2016</b>
            </div>
          </div>
          <br/>
          ...
          <div class="styTBB" style="width:187mm">
            ...
            <div>Schedule H (Form 1120-F) 2016</div>
          </div>
              ...
              <tbody>
                ...
                <tr>
                 ...
                 Interbranch expenses per books and records included on line 31 and not
                   <span style="float:left;"> included on line 32b (attach statement)
                    <span style="width:1.5mm"/>
                    <xsl:call-template name="SetFormLinkInline">
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDescTall" colspan="3" scope="row">
                  Deductible expenses on books and records allocated and apportioned to ECI or non&#45;ECI under Regulations
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDescTallShortest" scope="row">
                  Total deductible expenses definitely related to ECI or non&#45;ECI. Add
                   <span style="float:left;"> lines 38a and 38b</span>
                  <span class="styDotLn" style="float:right;">...............</span>
                  </td>
                ...
                <tr>
                  ...
                  allocated and apportioned to ECI  
                  <span style="float:left;">and non&#45;ECI (from line 37)</span>
                  <span class="styDotLn" style="float:right;">............</span>
                  </td>

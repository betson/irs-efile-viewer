...
<!--Created by Doug 6-26-2006--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="AOVSSData" select="$RtnDoc/OwnershipAnyInterestPrtshpStmt"/>
  ...
  <xsl:template name="ShowAOVSS">
    <table id="AOVSSTbl" class="styDepTbl">
      ...
      <tfoot/>
      <tbody>    
        <xsl:for-each select="$AOVSSData/EntityGrp">  
          <tr>

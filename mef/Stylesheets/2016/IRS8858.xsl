...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html>
			...
			<body class="styBodyClass" style="width:187mm">
               ...
               (Rev. December 2013)<br/>
						...
						<div class="styFTBox" style="width:130mm;height:21mm;">
                ...
                <br/>Respect To Foreign Disregarded Entities
						...
						<div class="styFBT" style="margin-top:0px;padding-bottom:1mm;">
							...
							<br/>
							<span style="text-align:left;font:size:10pt;float:left;padding-left:1mm;">Information furnished for
								the foreign disregarded entity’s annual accounting period  (see <br/> 
          ...
          City or town, state, and ZIP code
              ...
              U.S. dollars unless otherwise indicated.</i>
					...
					<div class="styGenericDiv" style="width:187mm;overflow:hidden;">
						<div class="styFNBox" style="width:100mm;height:30mm;border-right-width:1px;clear:none">
					<div class="styGenericDiv" style="padding-left:2mm;"><b>
							...
							<div style="margin-left:6mm;">
								...
								<xsl:if test="normalize-space($Form8858Data/ForeignDisregardedEntityName/BusinessNameLine2Txt)!=''">
									<br/>
									<xsl:call-template name="PopulateText">
								...
								<xsl:choose>
									<xsl:when test="$Form8858Data/FDEForeignAddress">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/AddressLine1Txt"/>
										</xsl:call-template>
										<xsl:if test="normalize-space($Form8858Data/FDEForeignAddress/AddressLine2Txt)!=''">
											<br/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/AddressLine2Txt"/>
											</xsl:call-template>
										</xsl:if>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/CityNm"/>
										</xsl:call-template>
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/ProvinceOrStateNm"/>
										</xsl:call-template>  
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/ForeignPostalCd"/>
										</xsl:call-template>
										<xsl:if test="normalize-space($Form8858Data/FDEForeignAddress/CityNm) != '' or normalize-space($Form8858Data/FDEForeignAddress/ProvinceOrStateNm) != '' or normalize-space($Form8858Data/FDEForeignAddress/ForeignPostalCd) != ''">
										<span style="width:4px;"/>
										</xsl:if>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/FDEForeignAddress/CountryCd"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:if test="$Form8858Data/FDEUSAddress">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8858Data/FDEUSAddress/AddressLine1Txt"/>
											</xsl:call-template>
											<xsl:if test="normalize-space($Form8858Data/FDEUSAddress/AddressLine2Txt)!=''">
												<br/>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form8858Data/FDEUSAddress/AddressLine2Txt"/>
												</xsl:call-template>
											</xsl:if>
											<br/>
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8858Data/FDEUSAddress/CityNm"/>
											</xsl:call-template>,
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8858Data/FDEUSAddress/StateAbbreviationCd"/>
											</xsl:call-template>  
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8858Data/FDEUSAddress/ZIPCd"/>
											</xsl:call-template>
										</xsl:if>
									</xsl:otherwise>
								</xsl:choose>
						...
						<xsl:choose>
							<xsl:when test="($Print = $Separated)">
								<tr>
									<td class="styTableCell" valign="top" style="width: 87mm;height: 12mm;border-left-width:1px;border-right: 0">
							...
							<xsl:when test="($Print != $Separated)">
								<div style="width:87mm;border-top:0 solid black;border-left:1px solid black;">
									...
									<div class="styIRS5472TableContainer" id="FEIdctn1" style="width:87mm;height:12mm;border-top:0;border-left:0px;">
											...
											<tbody>
												<xsl:choose>
													<xsl:when test="count($Form8858Data/ForeignEntityIdentificationGrp) = 0">
														<tr>
															<td class="styTableCell" style="vertical-align:bottom;height:10mm;border-right:0;">
																<span style="text-align:left;width:87mm;">
																	<br/>
																</span>
															</td>
															...
															<tr>
																<td class="styTableCell" style="vertical-align:bottom;height:10mm;border-right:0;">
																	...
																	<xsl:if test="(position() = last())">
																		<xsl:attribute name="style">vertical-align:bottom;height:10mm;border-right:0;border-bottom:0;</xsl:attribute>
																	</xsl:if>
																	<span style="text-align:left;width: 82mm;">
																		<xsl:call-template name="PopulateText">
            ...
            Effective date as foreign <br/>disregarded entity
						<br/>
              ...
              If benefits under a U.S. tax treaty were claimed with respect to income of
               the foreign disregarded entity, enter the treaty and article number<br/><br/>
								<xsl:call-template name="PopulateText">
            ...
            Provide the following information for the foreign disregarded entity&#39;s accounting period stated above.
					...
					<div class="styBB" style="width:187mm;float:none;clear:both;height:auto;">
						<div class="styBB" style="width:93mm;height:auto;border-bottom:0px solid black;">
							...
							<!-- Box 2a -->
							<div class="styGenericDiv" style="width:85mm;font-size:7pt;margin-left:-2.5mm;padding-right:2px;height:33mm;">
         ...
         <br/><br/>
						...
						<div id="TPctn" style="height:auto;" class="styIRS8858Ln2bTable">
							...
							<table class="styTable" cellspacing="0" name="TYTable" id="TYTable">
								<thead>
									<tr>
										<th class="styTableCellHeader" style="height:15mm;width:8mm;
                  ...
                  location of such books and records, if different
                   ...
                   and (count($Form8858Data/BooksAndRecords) &gt; 1))">
										<tr>
											...
											<td class="styTableCell" style="height:18mm;width:86mm;text-align:left;border-color:black;vertical-align:top;border:none;">
												<br/>
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" select="$Form8858Data/BooksAndRecords"/>
												</xsl:call-template>
					...
					<p style="page-break-before:always"/>
								<tr style="border-color: black">
									<td class="styTableCell" style="width: 187mm; text-align: left; border-right-width: 0px;border-bottom-width:0px" colspan="3">
										...
										<span style="width: 3mm;"/>
										<!-- Line 3 -->
                    For the <span class="styBoldText">tax owner</span> of the foreign disregarded entity (if different from the filer) provide the following (see instructions):
                  </td>
								</tr>
								<tr>
                    ...
                    <xsl:call-template name="PopulateText">
                     ...
                     U.S. identifying number, if any<br/><br/>
                            ...
                            TaxOwnerUSIdNumberDetail/MissingEINReasonCd"/>
										...
										<div style="height:9mm;width:98mm;float:left;border-top-width: 1px;
 ...
 including if the data field is empty -->
              ...
              Name and address<br/><br/>
												...
												<!-- Box 4b -->
												<td class="styNameBox" style="height:10mm;width:94mm;font-size:7pt; border-top-width:0px;
                    ...
                    border-right-width:0px;border-bottom-width: 1px;" colspan="2">
                      ...
                      padding-right: 1.8mm">c</span>
                          ...
                          DirectOwnerUSIdNumberDetail/EIN"/>
											...
											<td class="styNameBox" style="width:40mm;height:10.8mm;font-size:7pt; 
...
longer suspended?                                 
           ...
           &gt; 1) ">
               ...
               <!-- puch pen  -->
                      ...
                      recipients of remittances<br/> <span style="width:10mm"/>from the foreign disregarded entity.
                    </th>

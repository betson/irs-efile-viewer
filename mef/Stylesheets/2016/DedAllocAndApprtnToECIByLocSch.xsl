...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- - 1120F Schedule H displays - Deductions Allocated And Apportioned to ECI by Location Schedule - -->
    ...
    <table id="DedAllocAndApprtnToECIByLocSchTbl" class="styDepTbl">
      <thead class="styTableThead">
        <tr class="styDepTblHdr">
          <th class="styDepTblCell" style="width:140mm;text-align:center;" scope="col">Location of Deduction </th>
          <th class="styDepTblCell" style="width:46mm;text-align:center;" scope="col">Amount of Deduction </th>
        </tr>
      </thead>
